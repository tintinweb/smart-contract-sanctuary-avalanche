...
*/
    ...
    function cashoutSpecificReward(uint256 _amount) public {
      address sender = _msgSender();
...
*/
    ...
    function compound(uint256 amount) public {
    ...
    function renameNode(string memory oldName, string memory newName) public {
      require(
