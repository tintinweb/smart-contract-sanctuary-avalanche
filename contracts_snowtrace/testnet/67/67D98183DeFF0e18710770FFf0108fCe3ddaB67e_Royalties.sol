...
contract Royalties is Ownable {
    ...
    function claimCreator() external {
        ...
        ERC20(tokenFeesAddress).transfer(creatorAddress, balance.mul(50).div(100));
        ERC20(tokenFeesAddress).transfer(marketingAddress, balance.mul(50).div(100));
