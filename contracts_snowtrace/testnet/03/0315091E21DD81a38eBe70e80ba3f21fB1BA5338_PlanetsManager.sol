    ...
    LiquidityPoolManagerImplementationPointer
{
    ...
    Counters.Counter private _planetCounter;
    ...
    constructor () ERC721("Universe Ecosystem", "PLANET") {
        // Initialize contract
    ...
    function createPlanetWithTokens(
        ...
        require(
            bytes(planetName).length > 4 && bytes(planetName).length < 32,
            "Planets: Incorrect name length. Must be between 4 to 32"
        );
        require(
