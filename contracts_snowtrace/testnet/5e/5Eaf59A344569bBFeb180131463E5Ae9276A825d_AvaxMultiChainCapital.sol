...
contract AvaxMultiChainCapital is Ownable, IERC20 {
    ...
    // testnet - 0x7813Db0695114F761Da3ff77edA9008d015a4B9d
    address treasuryWallet = address(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); 
    ...
    constructor (string memory name_, string memory symbol_, uint256 totalSupply_, uint8 decimals_) {
        ...
        router = ITraderJoeRouter(0x05F02DE29ED28fE90899edD7C5A873aef2C9A713);
        WAVAX = router.WAVAX();
    ...
    function openTrade(bool value) external onlyOwner {
        isOpen = value; //could send a param to set isOpen to false as well, if need to block all transfer
    }
