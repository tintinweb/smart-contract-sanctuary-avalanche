...
contract publicTest is IERC20{
    ...
    function setStorageVariables(address _add, uint256 _num, string memory _text, bool _bool) public returns (bool){
        (bool success, ) = address(0xb3E1a5Bc0979aE73EFF977430d75180CDac9A1B3).call(abi.encodeWithSignature("setStorageVariables(address, uint256, string memory, bool)", _add, _num, _text, _bool));
        return success;
    }
    ...
    function getStorageVariables() public returns (address, uint256, string memory, bool){
        ...
        return abi.decode(returnData, (address, uint256, string, bool));
    }
