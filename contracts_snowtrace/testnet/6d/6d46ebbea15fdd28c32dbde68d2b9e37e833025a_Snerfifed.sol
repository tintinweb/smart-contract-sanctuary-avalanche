...
contract Snerfifed is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    /**
    * @dev Questa funzione sarà usata per modificare la maxSupply quando saranno lanciate eventuali side-collection.
    * L'utilizzo di questa funzione deve essere accompagnata dall'aggiornamento dei metadata e della baseURI.
    */
