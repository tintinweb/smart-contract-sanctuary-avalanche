...
// File contracts/s2/PantryS2.sol

pragma solidity ^0.8.4;



contract PantryS2 is ERC20("Staked Cookie", "sCOOKIE"), Ownable {
    using SafeMath for uint256;
    CookieS2 public cookie;

    uint256 public constant DELAYED_UNSTAKE_LOCKUP_PERIOD = 2 days;
    uint256 public constant QUICK_UNSTAKE_PENALTY_PERCENT = 90;
    ...
    function setAddresses(CookieS2 _cookie) external onlyOwner {
        require(!addressesFrozen, "Addresses are frozen");
        cookie = _cookie;
    }
    ...
    function stake(uint256 _amount) public {
        ...
        cookie.transfer(msg.sender, address(this), _amount);
    }
    ...
    function quickUnstake(uint256 _share) public {
        ...
        cookie.transfer(address(this), msg.sender, output);
    }
    ...
    function claimDelayedUnstake(uint256 _amount) public {
        ...
        cookie.transfer(address(this), msg.sender, _amount);
