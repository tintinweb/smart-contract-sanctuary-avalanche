...
contract ThortlesNFT is ERC721Enumerable, Ownable {
  ...
  */
    ...
    if (msg.sender != owner()) {
        ...
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount + _mintAmount <= maxMintAmount, "Max ThortlesNFT per address exceeded");
        }
  ...
  */
    // function getAllWhiteListedAddresses(bool getAddresses) public view onlyOwner returns (address[] memory) {
    //     getAddresses = true;
    //     if (getAddresses) {
