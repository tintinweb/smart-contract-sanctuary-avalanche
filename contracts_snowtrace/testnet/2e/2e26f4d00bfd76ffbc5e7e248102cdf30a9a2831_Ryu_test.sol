...
contract Ryu_test is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ERC2981PerTokenRoyalties {
    ...
    function initialize(
        address owner,
        address royaltyAddress) initializer public {
        ...
        ownerOfRoyalties = royaltyAddress;
    }
    ...
    function earlyMint(uint256 n) public payable {
        ...
        for (uint256 i = 0; i < n; i++) {
            ...
            _setTokenRoyalty(minted, ownerOfRoyalties, ROYALTY_VALUE);
    ...
    function setRoyaltyAddress(address _ownerOfRoyalties) external onlyOwner {
       ownerOfRoyalties = _ownerOfRoyalties;
    }
