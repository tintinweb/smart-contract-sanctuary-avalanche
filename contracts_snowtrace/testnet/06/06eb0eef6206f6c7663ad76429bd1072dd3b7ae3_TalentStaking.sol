...
contract TalentStaking {
    ...
    function stake(uint256 types, string memory uri, string memory category, string memory subCategory, string memory subSubCategory, string memory uid)public{ // types 1 = 30 days types 2 = 60 days types 3 = 90 days 
      ...
      require((nextStaking[msg.sender] <= block.timestamp) && (voterStaking.nextStaking(msg.sender)<= block.timestamp), "Need To Wait Atleast 30 days to stake again");
       ...
       userInfo[msg.sender].subSubCategory = subSubCategory;
