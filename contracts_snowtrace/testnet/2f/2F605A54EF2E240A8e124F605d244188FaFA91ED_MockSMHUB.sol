...
/**
 * A mock version of sMHUB, with an over-simplified rebase mechanism, for testing purposes only
 */
contract MockSMHUB is ERC20 {
    ...
    constructor(uint256 initialIndex_, uint256 rebasePct_) ERC20("Mock sMHUB", "sMHUB") {
