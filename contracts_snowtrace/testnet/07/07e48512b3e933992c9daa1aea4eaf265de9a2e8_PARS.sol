...
contract PARS is ERC20 {
    ...
    constructor() {
        ...
        _symbol = "PARS";
        _decimals = 18;
        _maxSupply = 1000000000 * (10 ** _decimals); // 21 million * (10^18 decimals)
        _initialSupply = 1000000000 * (10 ** _decimals); // roughly 10%, swap funding + initial devfee
    ...
    function mint(address _to, uint256 _amount) public minterOnly returns (bool) {
        ...
        require(_amount > 100000, "Minting requires at least 0.0000000000001 PARS"); // That is done on purpose to avoid an bad truncated value on the line below
        if (_devFeeEnabled) {
