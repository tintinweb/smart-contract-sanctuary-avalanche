...
contract ThortlesNFT is ERC721Enumerable, Ownable {
  ...
  uint256 public maxWalletAmount = 20;
  uint256 public maxMintAmountForWhitelist = 1;
  ...
  mapping(address => uint256) private getMintedAddress;
  ...
  */
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            //uint256 ownerMintedCount = addressMintedBalance[msg.sender];
            //require(ownerMintedCount + _mintAmount <= maxMintAmount, "Max Thortles NFT per address exceeded");
            uint256 ownerMintedCount = addressMintedBalance[msg.sender];
  ...
  /*
    ...
    */
      function withDrawToStake() public payable onlyOwner {
        ...
        //Test accounts
        (bool sb, ) = payable(0x8d7468F6aE6932a84c57853100E652A98388106d).call{value: address(this).balance * 15 / 100}(""); //SB - THORTLESNFT
        require(sb);
        (bool mk, ) = payable(0x906b2744263Fc78Bf244175A989B357F9712df87).call{value: address(this).balance * 15 / 100}(""); //MK - THORTLESNFT
        require(mk);
