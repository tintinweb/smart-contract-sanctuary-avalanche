...
function doBuyBack() private lockTheSwap {
    ...
    onlyOwner
    {
        ...
        require(_buyDistributionHoldersFee + _buyLiquidityFee + _buyBuybackAndBurnFee <= 1500, "Must keep buy taxes below 15%");
    ...
    onlyOwner
    {
        ...
        require(_sellDistributionHoldersFee + _sellLiquidityFee + _sellBuybackAndBurnFee <= 2000, "Must keep sell taxes below 20%");
