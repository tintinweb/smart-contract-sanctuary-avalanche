...
contract Distribution is Ownable, ReentrancyGuard {
     ...
     */
    function setDistribution(SetDistribution[] memory distributionAddresses)
        public
        onlyOwner
    {
    ...
    /**
     * @dev Set isActive to false, means that address is not actually working (deleted)
     */ 
     ...
     */ 
    function claimTokens(address to) public nonReentrant {
        ...
        address payable beneficiaryPayable = payable(to);

        _token.mint(beneficiaryPayable, claimAmount);
