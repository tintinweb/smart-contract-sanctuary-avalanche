...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x0f2A5D18aD37395266c0b59e3dfCFe790a0EE8E1);
...
contract SecretSauce1 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x0f2A5D18aD37395266c0b59e3dfCFe790a0EE8E1; // MIM
    ...
    string constant _name = "SecretSauce1";
