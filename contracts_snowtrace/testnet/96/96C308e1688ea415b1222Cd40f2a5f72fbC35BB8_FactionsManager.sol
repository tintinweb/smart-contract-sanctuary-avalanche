    ...
    LiquidityPoolManagerImplementationPointer
{
    ...
    uint256 public renameProcessingFee;
    ...
    function changeProcessingFee(uint8 _processingFee, uint8 _renameProcessingFee) public onlyOwner {
        require(_processingFee <= 30, "Cashout fee can never exceed 30%");
        require(_renameProcessingFee <= 15, "Rename fee can never exceed 15%");
        processingFee = _processingFee;
        renameProcessingFee = _renameProcessingFee;
    }
