    ...
    SpookyVerseImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d), // Treasury investments (65%)
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d) // Dev (35%)
    ];
    uint8[] public feePercentages = [65];
    ...
    constructor(
        ...
        changeSpookyVerseImplementation(address(leftSide));
