...
contract Chadmove is IERC20 {
    ...
    string constant private _name = "Chad Move";
    string constant private _symbol = "CHAD";
    ...
    address payable public marketingWallet = payable(0xf5bc309c8800247A27ef9517C6AF8967dD6557A1);
    address payable private rewardsPool = payable(0x87BeF7984C6c9727382211FEc8A2D6dC291a2384);
    address payable private treasuryWallet = payable(0x2773bBE2e5882c163f3e74a268F7c2b5Ab03ea0E);
    ...
    IERC20 staking = IERC20(0xFB4994Bc10892027F1F6dF5c5e982112D9714E66);
    ...
    constructor () {
        ...
        currentRouter = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921;
...
//===============================================================================================================
    ...
    function updatestakingAddress(IERC20 _staking) external onlyOwner {
        require(_staking != IERC20(address(this)), "staking address cannot be this address");
   ...
   //     if(staking.balanceOf(from) >= 1 &&
   //         staking.balanceOf(from) < 20 ){return vBuy1;}
   //     if(staking.balanceOf(from) >= 20 &&
   //         staking.balanceOf(from) < 50 ){return vBuy2;}
   //     if(staking.balanceOf(from) >= 50 &&
   //         staking.balanceOf(from) < 100 ){return vBuy3;}
   //     if(staking.balanceOf(from) >= 100) {return vBuy4;}
   //     else{
   //         return 0;
   //     }
