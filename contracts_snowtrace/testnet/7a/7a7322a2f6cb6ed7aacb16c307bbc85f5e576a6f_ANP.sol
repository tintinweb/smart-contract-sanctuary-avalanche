...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    ...
    function distributeDividend(address shareholder) internal {
        if(shares[shareholder].amount == 0){ return; } // shares[shareholder] is a token holder's address
...
// main token contract
contract ANP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address DEXROUTER = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // AVAX Contract address - THE AVAX TOKEN
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xC5DBc0115728861B0D369f848bbfd4A7517c5261;
    address public marketingFeeReceiverOne=0x7A15A8138b70734b3B0f56a3B02e99b6bf52eCB5;
    address public marketingFeeReceiverTwo;
    address public marketingFeeReceiverThree;

    address[] reflectionContracts; // set the token you want TODO::

    string constant _name = "ANP";
    string constant _symbol = "ANP";
    ...
    constructor (
        address _dexRouter, 
        address _marketingAddressOne,
        address _marketingAdressTwo,
        address _marketingAdressThree,
        address _wAVAX
    ) Auth(msg.sender) {
        ...
        // distributor contract instantiated
        distributor = new DividendDistributor(_dexRouter);
        
        // extract address of distributor contract
        ...
        marketingFeeReceiverOne = _marketingAddressOne;
        marketingFeeReceiverTwo = _marketingAdressTwo;
        marketingFeeReceiverThree = _marketingAdressThree;
    ...
    bool isSell=recipient== pair|| recipient == DEXROUTER;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        payable(marketingFeeReceiverOne).transfer(amountAVAXMarketing / 3);
        payable(marketingFeeReceiverTwo).transfer(amountAVAXMarketing / 3);
        payable(marketingFeeReceiverThree).transfer(amountAVAXMarketing / 3);
    ...
    function addReflectionTokenContract(address tokenContract) external onlyOwner {
        reflectionContracts.push(tokenContract);
    }
    ...
    function setFeeReceivers(
        ...
        address _marketingFeeReceiverOne,
        address _marketingFeeReceiverTwo,
        address _marketingFeeReceiverThree
    ) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiverOne = _marketingFeeReceiverOne;
        marketingFeeReceiverTwo = _marketingFeeReceiverTwo;
        marketingFeeReceiverThree = _marketingFeeReceiverThree;
    }
