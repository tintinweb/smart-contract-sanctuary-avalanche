...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x4B0c0ccFDf6Dfd0300257a35cA39a73176626c57); // reward address 
...
contract STEAMER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x4B0c0ccFDf6Dfd0300257a35cA39a73176626c57; // reward UNIV
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "STEAMER";
    string constant _symbol = "STEAMER";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(80); // 2.5%
    ...
    address public autoLiquidityReceiver=0xB045ac45d462FF3E11A2ceB765f75Bf47e2AA2c7; //liq address
    address public marketingFeeReceiver=0xB045ac45d462FF3E11A2ceB765f75Bf47e2AA2c7; // marketing address
