...
contract Prediction is Ownable, Pausable, ReentrancyGuard {
    ...
    function claim(uint256[] calldata epochs) external nonReentrant notContract {
        ...
        for (uint256 i = 0; i < epochs.length; i++) {
            ...
            if (rounds[epochs[i]].isClosedAndValid) {
     ...
     */
    function executeRound(int256 _price) external whenNotPaused onlyOperator {
        require(
        ...
        _safeLockRound(currentEpoch, _price);
        _safeEndRound(currentEpoch - 1, _price);
     ...
     * @dev Callable by operator
     */
    function genesisLockRound(int256 _price) external whenNotPaused onlyOperator {
