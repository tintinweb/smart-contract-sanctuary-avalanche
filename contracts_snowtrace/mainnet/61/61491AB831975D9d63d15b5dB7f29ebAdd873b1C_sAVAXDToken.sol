...
contract sAVAXDToken is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 2000000000 * 10**9;
    ...
    constructor() ERC20("Staked AVAXD", "sAVAXD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sAVAXD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAVAXD
