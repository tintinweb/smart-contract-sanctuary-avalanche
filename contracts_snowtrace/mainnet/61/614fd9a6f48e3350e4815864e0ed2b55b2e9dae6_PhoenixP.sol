...
// Earn some juicy phoenix community capital $FIRE rewards just by hodling
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xfcc6CE74f4cd7eDEF0C5429bB99d38A3608043a5);
...
contract PhoenixP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant COINMASK = type(uint128).max;
    address REWARDS = 0xfcc6CE74f4cd7eDEF0C5429bB99d38A3608043a5; // reflects
    ...
    string constant _name = "Phoenix Printer Capital";
    ...
    address public autoLiquidityReceiver=0x2005bCe4E1bCCa3818cd166c431E388B69FBDC48;
    address public marketingFeeReceiver=0x2005bCe4E1bCCa3818cd166c431E388B69FBDC48;
