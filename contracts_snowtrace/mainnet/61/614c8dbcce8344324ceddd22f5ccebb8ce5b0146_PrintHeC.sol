...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xEf5D02049Cfe1Bcc4c3B13C512bB0865C234b3dC); // reward address $HeC
...
contract PrintHeC is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xEf5D02049Cfe1Bcc4c3B13C512bB0865C234b3dC; // reward $HeC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PrintHeroesChainned";
    string constant _symbol = "PHC";
