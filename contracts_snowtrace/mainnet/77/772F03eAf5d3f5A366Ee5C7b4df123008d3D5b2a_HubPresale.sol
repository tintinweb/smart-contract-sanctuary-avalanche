...
contract HubPresale is Ownable {
    ...
    uint256 public price = 20 * 1e18; // 20 DAI per pHUB
    ...
    /**
     *  @notice set HUB Token
     *  @param _HUB: address of HUB
     */
    ...
    /**
     *  @notice set price for pHUB
     *  @param _price: price for pHUB
     */
    ...
    /**
     *  @notice it deposits pHUB to withdraw HUB from the sale
     */
