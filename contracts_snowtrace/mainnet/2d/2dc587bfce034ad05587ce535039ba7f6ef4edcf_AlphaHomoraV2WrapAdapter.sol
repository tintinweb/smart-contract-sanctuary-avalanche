...
// File contracts/interfaces/external/ICErc20.sol
...
// File contracts/interfaces/external/ISafeBox.sol
...
// File contracts/interfaces/external/ISafeBoxETH.sol
...
// File contracts/interfaces/external/IComptroller.sol
...
// File contracts/protocol/integration/lib/Compound.sol
...
library Compound {
    ...
    /**
     * Get enter markets calldata from CKToken
     */
     ...
     */
    function invokeEnterMarkets(ICKToken _ckToken, ICErc20 _cToken, IComptroller _comptroller) external {
        ( , , bytes memory enterMarketsCalldata) = getEnterMarketsCalldata(_cToken, _comptroller);

        uint256[] memory returnValues = abi.decode(_ckToken.invoke(address(_comptroller), 0, enterMarketsCalldata), (uint256[]));
        require(returnValues[0] == 0, "Entering failed");
    }

    /**
     * Get exit market calldata from CKToken
     */
     ...
     */
    function invokeExitMarket(ICKToken _ckToken, ICErc20 _cToken, IComptroller _comptroller) external {
        ( , , bytes memory exitMarketCalldata) = getExitMarketCalldata(_cToken, _comptroller);
        require(
            abi.decode(_ckToken.invoke(address(_comptroller), 0, exitMarketCalldata), (uint256)) == 0,
            "Exiting failed"
        );
    }

    /**
     * Get mint cEther calldata from CKToken
     */
    ...
    /**
     * Invoke mint cEther from the CKToken
     */
    function invokeMintCEther(ICKToken _ckToken, ICErc20 _cEther, uint256 _mintNotional) external {
        ( , , bytes memory mintCEtherCalldata) = getMintCEtherCalldata(_cEther, _mintNotional);

        _ckToken.invoke(address(_cEther), _mintNotional, mintCEtherCalldata);
    }

    /**
     * Get mint cToken calldata from CKToken
     */
    ...
    /**
     * Invoke mint from the CKToken. Mints the specified cToken from the underlying of the specified notional quantity
     */
    function invokeMintCToken(ICKToken _ckToken, ICErc20 _cToken, uint256 _mintNotional) external {
        ( , , bytes memory mintCTokenCalldata) = getMintCTokenCalldata(_cToken, _mintNotional);

        require(
            abi.decode(_ckToken.invoke(address(_cToken), 0, mintCTokenCalldata), (uint256)) == 0,
            "Mint failed"
        );
    }
    ...
    /**
     * Invoke redeem underlying from the CKToken
     */
    function invokeRedeemUnderlying(ICKToken _ckToken, ICErc20 _cToken, uint256 _redeemNotional) external {
        ( , , bytes memory redeemUnderlyingCalldata) = getRedeemUnderlyingCalldata(_cToken, _redeemNotional);

        require(
            abi.decode(_ckToken.invoke(address(_cToken), 0, redeemUnderlyingCalldata), (uint256)) == 0,
    ...
    /**
     * Invoke redeem from the CKToken
     */
    function invokeRedeem(ICKToken _ckToken, ICErc20 _cToken, uint256 _redeemNotional) external {
        ( , , bytes memory redeemCalldata) = getRedeemCalldata(_cToken, _redeemNotional);

        require(
            abi.decode(_ckToken.invoke(address(_cToken), 0, redeemCalldata), (uint256)) == 0,
            "Redeem failed"
        );
    }
    ...
    /**
     * Invoke repay cEther from the CKToken
     */
    function invokeRepayBorrowCEther(ICKToken _ckToken, ICErc20 _cEther, uint256 _repayNotional) external {
        ( , , bytes memory repayBorrowCalldata) = getRepayBorrowCEtherCalldata(_cEther, _repayNotional);
        _ckToken.invoke(address(_cEther), _repayNotional, repayBorrowCalldata);
    }
    ...
    /**
     * Invoke repay cToken from the CKToken
     */
    function invokeRepayBorrowCToken(ICKToken _ckToken, ICErc20 _cToken, uint256 _repayNotional) external {
        ( , , bytes memory repayBorrowCalldata) = getRepayBorrowCTokenCalldata(_cToken, _repayNotional);
        require(
            abi.decode(_ckToken.invoke(address(_cToken), 0, repayBorrowCalldata), (uint256)) == 0,
            "Repay failed"
        );
    }
     ...
     */
    function invokeBorrow(ICKToken _ckToken, ICErc20 _cToken, uint256 _notionalBorrowQuantity) external {
        ( , , bytes memory borrowCalldata) = getBorrowCalldata(_cToken, _notionalBorrowQuantity);
        require(
            abi.decode(_ckToken.invoke(address(_cToken), 0, borrowCalldata), (uint256)) == 0,
            "Borrow failed"
        );
    }
}
...
// File contracts/protocol/integration/wrap/AlphaHomoraV2WrapAdapter.sol
...
contract AlphaHomoraV2WrapAdapter {
    ...
    function validTokenPair(address _underlyingToken, address _wrappedToken) internal view returns(bool) {
        ...
        console.log("ISafeBox(_wrappedToken).uToken()", ISafeBox(_wrappedToken).uToken());
