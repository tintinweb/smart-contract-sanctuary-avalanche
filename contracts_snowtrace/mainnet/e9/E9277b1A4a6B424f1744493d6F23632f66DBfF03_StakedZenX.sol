...
contract StakedZenX is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked ZenX DAO", "sZENX", 9) ERC20Permit() {
    ...
    /**
        @notice increases StakedZenX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess StakedZenX
