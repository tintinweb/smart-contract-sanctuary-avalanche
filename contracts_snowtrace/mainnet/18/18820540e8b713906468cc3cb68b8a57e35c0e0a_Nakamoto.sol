...
| '--------------' || '--------------' || '--------------' || '--------------' |
'----------------'  '----------------'  '----------------'  '----------------'
1) 1% fee is collected and distributed to holders.
2) 5% buyback, 2% LP.

no audit, use at your own risk. degenitized 1.0
*/

// contracts/Nakamoto.sol
// SPDX-License-Identifier: another 2.0
...
contract Nakamoto is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 101010101010101010101 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Nakamoto";
    string private _symbol = "NAKAMOTO";
    ...
    uint256 public _maxTxAmount = 101010101010101010101 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1 * 10**1 * 10**1;
    uint256 private buyBackUpperLimit = 1 * 10**18;

    IPangolinRouter public immutable uniswapV2Router;
    ...
    constructor () {
        ...
        IPangolinRouter _uniswapV2Router = IPangolinRouter(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
        uniswapV2Pair = IPangolinFactory(_uniswapV2Router.factory())
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 1;
        _liquidityFee = 7;
        _maxTxAmount = 101010101010101010101 * 10**6 * 10**9;
    }
