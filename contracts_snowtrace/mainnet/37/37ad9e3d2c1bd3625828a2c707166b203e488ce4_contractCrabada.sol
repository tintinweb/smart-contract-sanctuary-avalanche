...
contract contractCrabada is Ownable, IERC721Receiver{
    ...
    function attackCrab(uint256 teamId, uint256 attackTeamId) onlyOwner external{
        
        (address owner, uint256 crabadaId1, uint256 crabadaId2, uint256 crabadaId3, uint16 battlePoint, uint16 timePoint, uint256 currentGameId, uint128 lockTo) = g.getTeamInfo(teamId);
        g.getTeamInfo(teamId);
        g.attack(currentGameId, attackTeamId);
    }
