...
interface IBoardroom {
    ...
    function getCreamPrice() external view returns (uint256);
...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x1723930C0920347A381F397C04567b20fc362304), // CreamGenesisRewardPool
        address(0x60f3555f64507106508Ee8d3a50E8bCd06FAaAfd) // CreamRewardPool
    ];
