...
abstract contract StrategyJoeRushFarmBase is StrategyBase {
    ...
    function _swapBaseToToken(uint256 _amount, address token1, address token2) internal {
        ...
        path[1] = wavax;
        path[2] = token2;
        IERC20(token1).safeApprove(joeRouter, 0);
        IERC20(token1).safeApprove(joeRouter, _amount);
...
// File contracts/strategies/traderJoe/strategy-joe-avax-gmx.sol
...
contract StrategyJoeAvaxGmx is StrategyJoeRushFarmBase {
    ...
    function harvest() public override onlyBenevolent {
        ...
        if(_joe > 0){    
            ...
            _swapBaseToToken(_joe.div(2), joe, gmx);
        }
