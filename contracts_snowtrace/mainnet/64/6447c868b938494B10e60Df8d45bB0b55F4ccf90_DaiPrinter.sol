...
// Dependency file: contracts/baby/DaiPrinterDividendTracker.sol
...
contract DaiPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DaiPrinter contract."
        );
    }
...
// Root file: contracts/baby/DaiPrinter.sol
...
// import "contracts/interfaces/IJoeFactory.sol";
// import "contracts/interfaces/IJoeRouter02.sol";
// import "contracts/baby/DaiPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract DaiPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = DaiPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require (
            ...
            "DaiPrinter: The dividend tracker already has that address"
        );

        DaiPrinterDividendTracker newDividendTracker = DaiPrinterDividendTracker(
            payable(newAddress)
        );

        require (
            newDividendTracker.owner() == address(this),
            "DaiPrinter: The new dividend tracker must be owned by the DaiPrinter token contract"
        );
    ...
    function updateJoeRouter(address newAddress) public onlyOwner {
        require(
            ...
            "DaiPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DaiPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != JoePair,
            "DaiPrinter: The PanDaiSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DaiPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DaiPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DaiPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialDaiBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
