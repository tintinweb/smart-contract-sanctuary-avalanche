...
/**
TG: https://t.me/playmatesmaker
Twitter : https://twitter.com/playmatesmaker
Make $PLAYMATES Rewards by holding this token! This is the number one maker in the history $PMAKER
**/
...
contract PlayMatesMaker is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PlayMatesMaker";
    string constant _symbol = "PMAKER";
    ...
    address public autoLiquidityReceiver=0xD56d8796E2FCC7Acf6CD0A17644B0198109f3076; //liq address
    address public marketingFeeReceiver=0xD56d8796E2FCC7Acf6CD0A17644B0198109f3076; // marketing address
