...
Let's show ETHP how it's really done.
...
contract ETHPrinterCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Ethereum Printer Capital";
    string constant _symbol = "ETHpC";
