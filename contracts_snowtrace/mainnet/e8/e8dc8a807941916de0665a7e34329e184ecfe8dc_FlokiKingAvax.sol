...
- Buy Tax / Sell Tax: 14%
    ...
    - 7% of each sell to treasury wallet
    - 2% to the liquidity pool.

Website:
https://kingflokiavax.capital/

Telegram:
https://t.me/FlokiKingAvax

Twitter:
https://twitter.com/FlokiKingAvax
...
contract FlokiKingAvaxDividendTracker is IDividendDistributor {
...
contract FlokiKingAvax is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0x34480B8cEFcE51e6648d9a0f07b499F6793fad35); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    FlokiKingAvaxDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new FlokiKingAvaxDividendTracker();
