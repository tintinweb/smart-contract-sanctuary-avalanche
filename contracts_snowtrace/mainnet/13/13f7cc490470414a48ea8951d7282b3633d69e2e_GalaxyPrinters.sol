...
//  Telegram: https://t.me/GalaxyPrinters
//  Reward: $UNIV , $PLAYMATES & Grimace who give you again $UNIV rewards ! 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x959b88966fC5B261dF8359961357d34F4ee27b4a); // Reward Universe
    IBEP20 BP = IBEP20(0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465); // Reward Playmates
    IBEP20 TP = IBEP20(0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8); // Reward Nodec
...
contract GalaxyPrinters is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; // Reward Universe
    address BP = 0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8; // Reward NodeC
    address TP = 0x6760f9fb100369810A1e12f59B7164C1deD7f271; // Reward Grimace
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Galaxy Printers";
    string constant _symbol = "GALAXYR";
    ...
    address public autoLiquidityReceiver=0x61f9107Db07a9927a1EB383B3341b67370cD4091; //liq address
    address public marketingFeeReceiver=0x61f9107Db07a9927a1EB383B3341b67370cD4091; // marketing address
