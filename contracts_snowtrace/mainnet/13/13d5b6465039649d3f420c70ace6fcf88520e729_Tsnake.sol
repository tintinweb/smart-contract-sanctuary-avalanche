...
contract Tsnake is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 TSNAKEs
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Snake Finance Shares", "TSNAKE") {
        _mint(msg.sender, 1 ether); // mint 1 Snake Finance Shares for initial pools deployment
