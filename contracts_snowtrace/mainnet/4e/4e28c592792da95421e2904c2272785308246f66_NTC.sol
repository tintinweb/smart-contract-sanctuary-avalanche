...
//Node Treasury Capital is both a reflective token of Universe and a FAAS project with a based dev and bullish pumpamentals! 

// We will use the treasury wallet to invest in nodes then take the profits and buyback and burn the supply
// https://t.me/NodeTreasuryCapital
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 usdc = IBEP20(0x959b88966fC5B261dF8359961357d34F4ee27b4a);
...
contract NTC is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address usdc = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Nodes Treasury Capital";
    ...
    address public autoLiquidityReceiver=0xc68a018f96F9639c1C858F9539da8DfB516c6990;
    address public marketingFeeReceiver=0xc68a018f96F9639c1C858F9539da8DfB516c6990;
