...
contract testing is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver =
        0xC8452b4FA4A719DeC7fAB220e8ce9146B4297B74; //liq address
    address public marketingFeeReceiver =
        0xC8452b4FA4A719DeC7fAB220e8ce9146B4297B74; // marketing address
    ...
    function updateEP(address _newContract) external onlyOwner {
        EP = _newContract;
    }

    function updateBP(address _newContract) external onlyOwner {
        BP = _newContract;
    }
