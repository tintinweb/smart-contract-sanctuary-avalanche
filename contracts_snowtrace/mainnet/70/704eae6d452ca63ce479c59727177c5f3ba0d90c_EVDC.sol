    ...
    ERC20PausableUpgradeable
{
    ...
    function initialize() public initializer {
        __Ownable_init();
        __ERC20_init("Electric Vehicle Direct Currency", "EVDC");
    ...
    uint256 private _tTotal = 60000000000 * 10**8;
    ...
    string private    _name = "Electric Vehicle Direct Currency";
	...
	address public _MarketingWalletAddress = 0x06cc7aF80E2d63b380eE6d4Ec7D55428cc1947F9;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x811D91A8D838690c70D970444911DdbC185A61eA);
    ...
    {         
     ...
     function _mint(address account, uint256 amount) override internal    
      {        
            ...
            _rOwned[msg.sender] = _rOwned[msg.sender].add(rMint);    
            _tTotal = _tTotal.add(rMint);         
            emit Transfer(address(0), account, amount);     }
