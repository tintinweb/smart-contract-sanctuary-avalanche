...
contract RND is Context, IBEP20, Ownable {
    ...
    string private _name = 'Redlight Node District';
    string private _symbol = 'Playmates';
    ...
    function _setNodeManagement(uint256 maxTxAmount) external onlyOwner() {
