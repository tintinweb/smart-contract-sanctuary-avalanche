...
Welcome to the place where you will receive nice rewards of $NODEC just by holding

Made by @UniversalMultichainLaunches
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8);
...
contract NODECp is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NODECprint";
    string constant _symbol = "NODECp";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);

    uint256 public _maxTxAmount = _totalSupply.div(30); // 
    uint256 public _maxWallet = _totalSupply.div(30); // 
    ...
    address public autoLiquidityReceiver = 0x1085B3065B6C471e4e8050Be999D01E4Ce760422;
    address public marketingFeeReceiver = 0x1085B3065B6C471e4e8050Be999D01E4Ce760422;
