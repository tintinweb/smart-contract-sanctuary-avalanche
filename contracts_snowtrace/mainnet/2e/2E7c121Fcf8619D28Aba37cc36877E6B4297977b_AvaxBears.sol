...
contract AvaxBears is Context, IERC20, Ownable {
    ...
    string private constant _name = "t.me/AvaxBears";
    string private constant _symbol = "AVXB";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xFfd8aD42Cf9D8e858cdd441D0C64d42CBC418c30);
        _feeAddrWallet2 = payable(0xFfd8aD42Cf9D8e858cdd441D0C64d42CBC418c30);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xFfd8aD42Cf9D8e858cdd441D0C64d42CBC418c30), _msgSender(), _tTotal);
    }
