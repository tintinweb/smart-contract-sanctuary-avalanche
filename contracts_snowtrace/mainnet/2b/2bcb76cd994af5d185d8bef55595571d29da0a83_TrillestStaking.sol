...
contract TrillestStaking is Ownable {
    ...
    /**
        @notice stake Trillest to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice forfeit MEMO in warmup and retrieve Trillest
     */
    ...
    /**
        @notice redeem MEMO for Trillest
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns contract Trillest holdings, including bonuses provided
        @return uint
     */
