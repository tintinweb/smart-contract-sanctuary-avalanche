...
/**
Sigma Only For Sigma : Let Build Berkshire Hathaway in Crypto.

Useful links : https://linktr.ee/SigmaNodes 
Discord is must to join click on Linktr
Telegram : https://t.me/SigmaNodes

Pls join before investing in launch tax will be brutal the intentions is to punish bots. 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address crea = 0xA4F5AfEA3EeB241527D04F8771636AE9Cf8b78a2;
    ...
    IBEP20 REW = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
...
contract SIGMA is IBEP20, Auth {
    ...
    address REW = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB;
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SIGMA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // LP dead address
        autoLiquidityReceiver = 0xA4F5AfEA3EeB241527D04F8771636AE9Cf8b78a2;
        marketingFeeReceiver = 0xA4F5AfEA3EeB241527D04F8771636AE9Cf8b78a2;
