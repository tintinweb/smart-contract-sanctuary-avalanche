...
// Telegram : https://t.me/KingWagmiAvax
// Website : still on development for the moment, will be release soon after the launch
// Twitter : https://twitter.com/KingWagmiAvax
...
contract KingWagmi is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "King Wagmi";
    string constant _symbol = "KWAGMI";
    ...
    address public autoLiquidityReceiver=0x386C2BCe0742EA2c041c7D409584a69eD5A9B375; //liq address
    address public marketingFeeReceiver=0x386C2BCe0742EA2c041c7D409584a69eD5A9B375; // marketing address
