...
// https://t.me/AVAXCASH_Official
// The very first cash outlet on AVAX Chain
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // USDC CASH
...
contract AVAXCash is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAX Cash";
    ...
    address public autoLiquidityReceiver=0x88a001E01FDd75B87479E18d7831CDee4b42Aa5A;
    address public marketingFeeReceiver=0x88a001E01FDd75B87479E18d7831CDee4b42Aa5A;
