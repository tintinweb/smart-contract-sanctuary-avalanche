...
contract NUCLEUSSale is Ownable {

    using SafeERC20 for ERC20;
    using Address for address;

    uint constant MIMdecimals = 10 ** 18;
    uint constant NUCLEUSdecimals = 10 ** 18;
    uint public constant MAX_SOLD = 350000 * MIMdecimals / 10 ** 9;
    uint public constant PRICE = 10**9 ;
    uint public constant MAX_SALE_PER_ACCOUNT = 800 * MIMdecimals / 10 ** 9;
    uint public constant MAX_PRESALE_PER_ACCOUNT = 1250 * MIMdecimals / 10 ** 9;
    ...
    function buyNUCLEUS(uint256 amount) public onlyEOA {
    ...
    function claimNUCLEUS() public onlyEOA {
      ERC20(NUCLEUS).transfer(msg.sender, 10**18 * 166054 * invested[msg.sender] / sold);
      owed -= invested[msg.sender];
      invested[msg.sender] = 0;

    }
    function setClaimingActive(address nucleus) public {
