...
contract MurkyFinance is ERC20Permit, Ownable {
    ...
    uint256 public minFloorPrice = 10 ** 18; // $1
    ...
    function getMintPrice() public view returns (uint256) {
      ...
      if (circulationSupply == 0) {
        ...
        mintPrice = (mintPrice > minFloorPrice) ? mintPrice : minFloorPrice;
      }
    ...
    function mintMKY(address _token, uint256 _amount) external {
      require(mintable, "Minting is stopped");
      ...
      IERC20(_token).transferFrom(msg.sender, treasuryWallet, _amount * treasuryFee / 100);
      IERC20(_token).transferFrom(msg.sender, buybackWallet, _amount * buyBackFee / 100);
