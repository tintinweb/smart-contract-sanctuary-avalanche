...
contract RewardDistributor is Ownable, ReentrancyGuard, DelayedActionGuard
{
	...
	uint256 constant DEFAULT_PENALTY_RATE = 0e16; // 0%
	uint256 constant DEFAULT_PENALTY_PERIODS = 0; // 0 weeks
	...
	address private immutable escrowOwnership;
	address private immutable boostOwnership;
