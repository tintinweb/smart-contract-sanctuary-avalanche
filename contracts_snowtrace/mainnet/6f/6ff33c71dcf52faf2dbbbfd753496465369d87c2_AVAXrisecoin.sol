...
/**  Welcome to our community, AVAXrisecoin! 
 
     AVAXrisecoin provides 8% AVAX reflections every hour
     Tokenomics: 
     Total Supply: 1.000.000.000.000.000 $AVAXRISE 
     AVAX Reflections: 8% 💵 
     Auto Liquidity: 2% 💦 
     marketing wallet:2%
 *
...
//  Telegram: https://t.me/AVAXrisecoin
//  Reward: $AVAX  
...
contract AVAXrisecoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AVAXrisecoin";
    string constant _symbol = "AVAXRISE";
