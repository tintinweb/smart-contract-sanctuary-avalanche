...
contract TestInu is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _liquidityWallet = payable(0x814f28C01cB2E281A5d9C7bEC1b988406EeED6e8);
        _rewardWallet = payable(0x814f28C01cB2E281A5d9C7bEC1b988406EeED6e8);
    ...
    function openTrading() external onlyOwner() {
        ...
        IJoeRouter02 _uniswapV2Router = IJoeRouter02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
        uniswapV2Router = _uniswapV2Router;
        _approve(address(this), address(uniswapV2Router), _tTotal);
        uniswapV2Pair = IJoeFactory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WAVAX());
