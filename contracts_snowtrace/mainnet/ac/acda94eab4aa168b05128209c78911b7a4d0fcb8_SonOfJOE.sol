...
contract SonOfJOE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0xCA38151D45eac097BB68FA75E893cb3dA57ac7a2;
    address public marketingFeeReceiver=0xCA38151D45eac097BB68FA75E893cb3dA57ac7a2;

    string constant _name = "Son Of Joe";
    string constant _symbol = "SOJ";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(80);
	uint256 public _maxWallet = _totalSupply.div(80); 
