...
/**
 ...
 Hello WELCOME to Community Token :

   🌟 Do Your Own Research (DYOR)
        Small BENQI ($sQI) : 1,000,000,000,000,000(Total Supply)

   🌟 Start yourselves a Telegram under - smallBENQI !!

   🌟 SAFU Contract ✅ 

   🌟 I will Lock LP 1 days after Listing (Buy after Lock Lp Done)✅

   🌟 I will extend lock lp if the target MC 30k ,Lets Goo!✅

   🌟 Antiwhell mechanis =   
                            --MAx Buy    = 10,000,000,000,000  (10000000000000)/Tx.
                            --Max Wallet = 20,000,000,000,000  (20000000000000)/wallet.

   🌟TAX :
                            --Rewards fee = 4% to Rewards, 
                            --Liquidity fee = 7% to Liquidity, 
                            --Marketing = 1% to marketing
     
   🌟 We only take 1% of the total fee, so you can control the group and this token more easily, 
   we will not change anything in the contract after listing, 
   if possible I will appear in your group later and receive suggestions and input to help you from behind the scenes. 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5); // reward address $Qi
...
contract smallBENQI is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5; // reward $Qi
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Small BenQI";
    string constant _symbol = "sQI";
    ...
    uint256 liquidityFee = 400; //4% LP
    uint256 buybackFee = 0;
    uint256 reflectionFee = 700; //7% Rewards
    uint256 marketingFee = 100; //1% marketing
    uint256 totalFee = 1200; //12% total Fee
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x5AA4ab69dF87878D5b752331836F4C3472158D5e; //liq address
    address public marketingFeeReceiver=0x5AA4ab69dF87878D5b752331836F4C3472158D5e; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.25%
    bool inSwap;
