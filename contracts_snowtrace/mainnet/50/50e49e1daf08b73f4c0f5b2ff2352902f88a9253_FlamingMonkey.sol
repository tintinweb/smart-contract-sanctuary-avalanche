...
//  Stealth Launch
//  Telegram: https://t.me/FlamingMonkey1
//  Reward: $THOR V2
...
contract FlamingMonkey is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79; // reward THOR V2
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FlamingMonkey";
    string constant _symbol = "FLAME";
