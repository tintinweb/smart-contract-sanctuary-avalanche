...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // rewards
...
contract BenAndNodes is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; //rewards  
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BenAndNodes";
    string constant _symbol = "BenNodes";
    ...
    address public autoLiquidityReceiver=0x0240621B01902675fdd1b7971a5b97b60E977833;
    address public marketingFeeReceiver=0x0240621B01902675fdd1b7971a5b97b60E977833;
