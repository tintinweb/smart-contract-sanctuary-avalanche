...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E);
...
contract reef is IBEP20, Auth {
    using SafeMath for uint256;

    address RWD =  0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
    address WBNB = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "reef";
    string constant _symbol = "reef";
    ...
    uint256 reflectionFee   = 0;  // WE CAN ADD REWARD IN THE FUTURE
    uint256 marketingFee    = 17; // MARKETING FEE SPLITTED WITH BUYBACK !
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x0032a0A67F43417AE10F5dd12d525FEb70abBfe4;
