...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465); // Reward
    IBEP20 BP = IBEP20(0x83a283641C6B4DF383BCDDf807193284C84c5342); // Reward
...
contract test098 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465; // Reward
    address BP = 0x83a283641C6B4DF383BCDDf807193284C84c5342; // Reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "test098";
    string constant _symbol = "test098";
