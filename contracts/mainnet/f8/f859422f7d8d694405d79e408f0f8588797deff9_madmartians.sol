...
// File: contracts/madmartians.sol
...
contract madmartians is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // PUBLIC:   Price : 100000000000000000   MaxTx : 5   MaxPerPerson : 10
    ...
    address public royaltyAddress = 0x268DefA1B16dC787e4a77935A088457943045D4b;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("madmartians","MADM") Randomizer(maxSupply) {
