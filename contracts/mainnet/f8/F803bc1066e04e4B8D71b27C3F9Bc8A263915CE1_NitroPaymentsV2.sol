...
contract NitroPaymentsV2 is Ownable, ReentrancyGuard {
    ...
    address internal constant NCASH = 0xc69Eba65e87889f0805dB717Af06797055A0BA07;
    ...
    function payWithStableCoins(
        ...
        require(allowedERC20[_erc20], "PayPending:: Unsupported ERC20");
        require(
            _erc20 == DAI || _erc20 == USDC || _erc20 == USDT || _erc20 == NCASH,
