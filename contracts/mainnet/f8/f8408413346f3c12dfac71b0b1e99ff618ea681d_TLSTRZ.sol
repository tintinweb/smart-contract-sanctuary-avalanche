...
/**
Twinkle Little Starnodz - 2 in 1 Token . Reward STRZ and Node.
Telegram: https://t.me/tlstrz
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x1D67454f6b393542290a7bBEeA32c66148909b34); // reward address strz
...
contract TLSTRZ is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x1D67454f6b393542290a7bBEeA32c66148909b34; // reward STRZ
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Twinkle Little Starnodz";
    string constant _symbol = "TLSTRZ";
    ...
    address public autoLiquidityReceiver=0x5018c3cB6748F747D7652b549114426F2822af2c; //liq address
    address public marketingFeeReceiver=0x00e4DC25E62980A1a3cc6127088b6b7438d0db5e; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // .02%
    bool inSwap;
