...
// File: contracts/AvaxVoxelCars.sol
...
contract AvaxVoxelCars is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // INSTRUCTIONS
    // WHITELISTED: Price : 350000000000000000   MaxTx : 1   MaxPerPerson : 1
    // PUBLIC:   Price : 750000000000000000   MaxTx : 2   MaxPerPerson : 2
    ...
    address public royaltyAddress = 0xB4Ab30aa7a0beB95B7A77bf645d29caCF5256C4d;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("AvaxVoxelCars","AVC") Randomizer(maxSupply) {
