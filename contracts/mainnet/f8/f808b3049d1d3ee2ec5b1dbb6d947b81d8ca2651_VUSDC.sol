...
contract VUSDC is IBEP20, Auth {
    ...
    string constant _name = "Valentine USDC";
    string constant _symbol = "VUSDC";
    ...
    address public autoLiquidityReceiver=0x83cf87FBDd95223Ec8AFC04ec03Fe070Eb855780; //liq address
    address public marketingFeeReceiver=0x83cf87FBDd95223Ec8AFC04ec03Fe070Eb855780; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 0.2%
    bool inSwap;
