...
Monkey AVAX ! APES TOGETHER STRONG !
Join our telegram more information : t.me/Monkey_Avax
*/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract MonkeyAvax is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    uint256 public manualBurnFrequency = 2 minutes; //1d = 1440 min
    ...
    constructor() ERC20("MonkeyAVAX", "MNK") {
       ...
       IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        ...
        uint256 _buyBurnFee = 2; // burn wallet is used as dev wallet for this token

        uint256 _sellMarketingFee = 6;
        uint256 _sellLiquidityFee = 3;
        uint256 _sellBurnFee = 2; // burn wallet is used as dev wallet for this token
        ...
        marketingWallet = 0xA39d34d5c0950C74CAe97708490f23214401E0f2; // set as marketing wallet
        burnWallet = 0xAdeD1c669304185095AC2a595B2944a3b289a001; // burn wallet is used as dev wallet for this token
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForBurn;
