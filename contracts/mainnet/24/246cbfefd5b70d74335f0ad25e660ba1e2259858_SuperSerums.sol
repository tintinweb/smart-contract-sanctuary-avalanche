    ...
    Pausable
{
    ...
    constructor() ERC721("Creatures Of The Cave SS", "COTCSS") {
        baseURI = "https://potlucklabs.mypinata.cloud/ipfs/QmY2LGTi7Pw3c3jiNVCgXhzHTogJ6jwVhJnCeYNVz7qH2o/";
        _pause();
    }
    ...
    function _baseURI() internal view override returns (string memory) {
     ...
     function splitFees(uint256 sentAmount) internal {
        ...
        uint256 septenaryDevFeeAmount = sentAmount.mul(septenaryDevFee).div(10000);
        ...
        devFees[septenaryDevAddress] += septenaryDevFeeAmount;
    ...
    function emergencyWithdraw() external onlyOwner {
        ...
        payable(msg.sender).transfer(amount);
        devFees[primaryDevAddress] = 0;
        devFees[secondaryDevAddress] = 0;
        devFees[tertiaryDevAddress] = 0;
        devFees[quaternaryDevAddress] = 0;
        devFees[quinaryDevAddress] = 0;
        devFees[septenaryDevAddress] = 0;
    }
}