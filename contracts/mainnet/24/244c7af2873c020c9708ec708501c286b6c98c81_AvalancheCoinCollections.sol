...
// Change Name
contract AvalancheCoinCollections is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "ipfs://bafybeiccozmex4niev4cj36ngijas6w5qqlkn4uqznmciqinbodlsepo2m/";
    ...
    constructor() ERC721A("Avalanche Coin Collections", "AVAXCOINCOLLECTIONS") {
        // Mint the first token to deployer address
        
        _mint(msg.sender, 124);
    }
