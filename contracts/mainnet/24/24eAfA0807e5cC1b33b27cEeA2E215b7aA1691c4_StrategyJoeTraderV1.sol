...
interface IStrategyMasterchefFarm {
...
contract StrategyJoeTraderV1 is Ownable, Pausable, IStrategyMasterchefFarm {
    ...
    function withdrawAll() external {
        (uint256 amountAll, ) = IMasterchefJoeTrader(baseParams.masterchef)
    ...
    function _swapIn() private {
        ...
        (, , uint256 amountLiquidity) = baseParams.joeV1Router.addLiquidity(
            token0ToToken1[0],
            token0ToToken1[1],
    ...
    function _swapOut() private {
        ...
        (uint256 amount0, uint256 amount1) = IJoeTraderPair(baseParams.want)
            .burn(address(this));
    }
