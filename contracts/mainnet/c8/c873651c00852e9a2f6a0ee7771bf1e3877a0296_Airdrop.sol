...
/// @title Contract for VTX rewards for vePTP holders
/// @author Vector Team
contract Airdrop is Ownable {
    ...
    /// @param _amounts amount of VTX for each eligible wallet
    ...
    /// @notice Get the claimable VTX amount of _user
    ...
    /// @notice Claim VTX and forfeit remaining allocation
    function claim() external {
        ...
        require(
            claimableAmount <= aidropToken.balanceOf(address(this)),
    ...
    function withdrawDust() external onlyOwner {
        require(
            block.timestamp > startTime + 7 * threeMonthsTime,
