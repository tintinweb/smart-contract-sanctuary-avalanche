...
interface IPizzeriaProgressionV4_3 {
...
contract PizzeriaV5 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Constants
    ...
    IPizzeriaProgressionV4_3 public pizzeriaProgression;
    IMafia_3 public mafia;
    ...
    function initialize(Chef _chef, Upgrade _upgrade, Pizza _pizza, Soda _soda, address _freezerAddress, address _pizzeriaProgression) public initializer {
        ...
        pizzeriaProgression = IPizzeriaProgressionV4_3(_pizzeriaProgression);
    ...
    function _claimRoni(address _owner) internal {
        ...
        uint256 fatigue = (claimFatiguePenalty - fatigueSkillModifier)*getFatigueAccrued(_owner)/100;
        if (fatigue > MAX_FATIGUE) {
            fatigue = MAX_FATIGUE;
        }
