...
// Telegram: t.me/avaxolam
// Get rewarded in love and compassion you big goofy boy.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 EP = IERC20(0x5947BB275c521040051D82396192181b413227A3); // reward address
...
contract AVAXOLAM is IERC20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5947BB275c521040051D82396192181b413227A3; // LINK
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAXOLAM";
    string constant _symbol = "XANAX";
    ...
    address public autoLiquidityReceiver = 0xCc2819Ebb85c9b4E0D9072c178DC81d1D399703D; //liq address
    address public marketingFeeReceiver = 0xCc2819Ebb85c9b4E0D9072c178DC81d1D399703D; // marketing address
