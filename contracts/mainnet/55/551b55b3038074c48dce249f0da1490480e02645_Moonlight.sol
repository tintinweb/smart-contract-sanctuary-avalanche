...
/**
 *
Moonlight aims to be a DaaS generating passive income through NFTs. 
Inspired by $UNIV 
...
2% fee Marketing 
100% lp locked for a week! 
Ownership will be renounced after launch
 
Feel free to shill this project wherever you want. 
The more people know about us, the more you will be rewarded.
website will be released 1 to 30 minutes hour after launch !!
*/
...
contract Moonlight is Context, IERC20, Ownable {
    ...
    string private _name = 'Moonlight';
    string private _symbol = 'MLIGHT';
