...
// $FBM Is The First Bull To Fuck Bears on $AVAX, Rewarding You With $UST On Each Sell. THE REPEG FIGHTER!
// Telegram: https://t.me/FBEARMARKET
// twitter: https://twitter.com/FBEARMARKET
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 usdc = IBEP20(0xb599c3590F42f8F995ECfa0f85D2980B76862fc1);
...
contract FBM is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address usdc = 0xb599c3590F42f8F995ECfa0f85D2980B76862fc1; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "F**K BEAR MARKET";
    string constant _symbol = "FBM";
    ...
    address public autoLiquidityReceiver=0xe9fd16A7017c261fb16777E5a5B8E121efAb3adc;
    address public marketingFeeReceiver=0xe9fd16A7017c261fb16777E5a5B8E121efAb3adc;
