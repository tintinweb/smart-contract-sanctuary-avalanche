...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract StarNodes is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("StarNodes", "STOD") {
        ...
        uint256 totalSupply = 4000 * 1e18;
        
        //maxTransactionAmount = totalSupply * 20 / 1000; // 0.2% maxTransactionAmountTxn
        maxTransactionAmount = 200 * 1e18;
        maxWallet = totalSupply /20; // 1% maxWallet
        swapTokensAtAmount = totalSupply /20; // 0.2% swap wallet
