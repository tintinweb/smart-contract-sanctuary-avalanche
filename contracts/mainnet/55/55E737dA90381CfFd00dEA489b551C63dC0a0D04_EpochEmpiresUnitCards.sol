...
// File: contracts/EpochEmpiresUnitCards.sol
...
pragma solidity >=0.7.0 <0.9.0;
  ...
  contract EpochEmpiresUnitCards is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  ) ERC721("Epoch Empires - Unit Cards", "EEUC") {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= maxSupply - wlSupply, "max Supply exceeded");
  ...
  function wlMint(uint256 _mintAmount) public payable {
    ...
    require(supply + _mintAmount <= wlSupply, "max Whitelist Supply exceeded");
    require(msg.value >= wlcost * _mintAmount, "insufficient funds");
    require(ownerTokenCount + _mintAmount <= Wlperwallet, "max NFT per wallet exceeded");
  ...
  function withdraw() public payable onlyOwner {
    (bool success, ) = payable(0x9c21347658B8655a03F9F5378ccB82fd19D852b9).call{value: address(this).balance}("");
    require(success);
  }
}