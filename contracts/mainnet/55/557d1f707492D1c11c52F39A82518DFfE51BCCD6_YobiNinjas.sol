...
contract YobiNinjas is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    uint256 public _price = 0.4 ether;
    uint256 public constant _WLprice = 0.3 ether;
    uint256 public _maxMintable = 1000; //1000
    uint256 public _maxWL_Mintable = 250; //250
    uint256 public _maxSupply = 1375; //1375
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(
            quantity <= _maxMintPerTx,
            "Cannot mint that many at once. max is 10 NFTs per mint"
        );
        ...
        payable(NFTsTransferWallet).transfer(totalCost);
    ...
    function airDropNFTsTo(address[] calldata addresses) external onlyOwner {
        require(airDropDone == false, "airDroped is done.");
