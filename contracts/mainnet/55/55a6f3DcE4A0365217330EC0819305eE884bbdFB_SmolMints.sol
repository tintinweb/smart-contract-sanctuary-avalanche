...
contract SmolMints is ERC721AQueryable, Ownable, ERC2981 {
    ...
    constructor(address receiver, uint96 feeNumerator) ERC721A("smol nanaz", "NANA") {
...
//  ▀▄▀ █ █▄▄ ▀▄▀▄▀
    ...
    function tokenURI(uint256 tokenId) public view override(ERC721A, IERC721A) returns (string memory) {
        ...
        return bytes(baseURI).length != 0 ? string(abi.encodePacked(baseURI, _toString(tokenId), ".json")) : _prerevealURI;
    }
...
//  █ ▀ █ █ █ ▀█  █ 
    ...
    function publicMint(uint256 _amount) external payable {
        ...
        if (_amount > maxPublic) revert WrongAmount();
...
//  █ ▀ █ █▀█ █ ▀█ █▀█ ▀▄█ █▄▄ █ ▀ █ █▄▄ █ ▀█  █ 
    ...
    function setMaxMint(uint256 _maxPublic) external onlyOwner {
