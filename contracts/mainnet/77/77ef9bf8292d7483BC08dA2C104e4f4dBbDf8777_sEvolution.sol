 ...
 */
contract sEvolution is ERC20, Ownable {
	...
	constructor() ERC20("Staked Evolution", "sEVOL") {
	...
	function init(address staking_) public {
		require(msg.sender == initializer, "sEvolution: Sender is not initializer");
		require(staking_ != address(0), "sEvolution: Staking cannot be address zero");
