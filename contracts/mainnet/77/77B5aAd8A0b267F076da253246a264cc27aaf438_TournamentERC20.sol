...
contract TournamentERC20 is Ownable, ITournament {
    ...
    uint256 public TICKET_SIZE = 50; // 10000th of pot
    ...
    constructor (address _wl, address _token) {
    ...
    function buy() external payable {
        ...
        require(rewardToken.transferFrom(msg.sender, address(this), ticketPrice), "Transfer of ticket price failed");
        require(oldBalance + ticketPrice == rewardToken.balanceOf(address(this)), "Dont be tricky");
        gladPotSize += ticketPrice * GLAD_SHARE / 10000;
        rewardToken.transfer(owner(), ticketPrice * (10000 - POT_SHARE - GLAD_SHARE) / 10000);
        winner = msg.sender;
    }
