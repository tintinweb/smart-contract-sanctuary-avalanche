    ...
    */
    ...
    function getAttributesDataUri(uint256 tokenId) internal view returns(bytes memory) {
        ...
        bytes memory first3 = abi.encodePacked(
            '{"trait_type":"Gender","value":', _textStore[0][_store[tokenId][0][0]], '},',
            '{"trait_type":"Background","value":', _textStore[1][_store[tokenId][0][1]], '},',
            '{"trait_type":"Hair","value":', _textStore[2][_store[tokenId][0][2]], '},'
        );
        bytes memory second3 = abi.encodePacked(
            '{"trait_type":"Hat","value":', _textStore[3][_store[tokenId][0][3]], '},',
            '{"trait_type":"Eyes","value":', _textStore[4][_store[tokenId][0][4]], '},',
            '{"trait_type":"Base","value":', _textStore[5][_store[tokenId][0][5]], '},'
        );
        bytes memory third3 = abi.encodePacked(
            '{"trait_type":"Staff","value":', _textStore[6][_store[tokenId][0][6]], '},',
            '{"trait_type":"Robe","value":', _textStore[7][_store[tokenId][0][7]], '},',
            '{"trait_type":"Mouth","value":', _textStore[8][_store[tokenId][0][8]], '},'
        );
        return abi.encodePacked(
            '"attributes":[',
                string(first3),
