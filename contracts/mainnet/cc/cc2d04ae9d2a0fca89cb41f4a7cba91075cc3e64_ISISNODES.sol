...
Just holding $ISNODE earns you BTC thanks to reflections (10% of every buy) + node dividends 
(once node goals are completed, about 15%, rewards will start pouring to holders) depending on how much of the supply you own.

https://twitter.com/IsisNodes

30 AVAX INITIAL LIQUIDITY
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
...
contract ISISNODES is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0x50b7545627a5162F82A992c33b87aDc75187B218;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Isis Nodes";
    string constant _symbol = "ISNODE";
    ...
    address public autoLiquidityReceiver = 0x15499811C997B5b75697756bAf9777E56b4bdbCE;
    address public marketingFeeReceiver = 0x15499811C997B5b75697756bAf9777E56b4bdbCE;
