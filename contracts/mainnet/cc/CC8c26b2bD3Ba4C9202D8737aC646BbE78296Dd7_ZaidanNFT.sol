...
contract ZaidanNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public PRESALE_PRICE = 4640000000000000000; //2.85 AVAX
    ...
    uint256 public SALE_START = 1663941600; // September 9, 2022, 02:00:00 GMT
    uint256 public PRESALE_START = 1663855200; // September 8, 2022, 02:00:00 GMT
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        _safeTransferNative(_multisig, address(this).balance);
    }
    ...
    function withdrawAll() external onlyOwner {
        ...
        require(balance > 0);
        _safeTransferNative(_multisig, balance);
    }
