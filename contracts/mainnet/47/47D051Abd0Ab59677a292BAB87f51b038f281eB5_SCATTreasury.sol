...
contract SCATTreasury is Ownable, ReentrancyGuard {
    ...
    // initial 1000x
    uint public fractionality = 10000000;
    ...
    uint public constant phaseOneDuration = oneDay * 8;
    ...
    function setFractionality( uint256 _fractionality ) external onlyManager() {
        require( _fractionality >= 10000 && _fractionality <= 10000000, "fractionality must be 1-1000x!" );
