...
contract StrategyTraderJoeLP is StratManager, FeeManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address public native = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    address public output = address(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd);
    address public want = address(0xA3A029224857bF467E896523E268a5fc005Ce810);
    address private lpToken0;
    address private lpToken1;

    // Third party contracts
    address public chef = address(0x188bED1968b795d5c9022F6a0bb5931Ac4c18F00);
    uint256 public poolId = 49;
    ...
    constructor(
        address _vault
            ...
            address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F), 
            address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F),
