...
contract CitiesManager is Ownable, HelperOwnable, IERC721, IERC721Metadata {
    ...
    IDistrictManager public DISTRICTS = IDistrictManager(0x008648122CF7E9c9b8DB02F82634f08ec27324B0);
    IMansionsHelper public MANSIONSHEPLER = IMansionsHelper(0x3e8eD0e33684a00F0091114dd95f3Eb05ac5beD5);
    address public REWARDS_POOL = 0xc8F1Baa85F4e3fc8CbC71c12706eC5C64640F0e6;
    ...
    function createNodeWithTokens(string memory _name, uint64[] memory userNodes) public {
        ...
        require(DISTRICTS.balanceOf(sender) >= nodeMansionPrice, "HELPER: District balance too low for creation.");
