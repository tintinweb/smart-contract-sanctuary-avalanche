...
contract NativeFarm is Ownable, ReentrancyGuard {
    ...
    // Token address
    address public constant NATIVE = 0x61580B7198aaE60c6e0caB3149B8f5c3e2690C72; //DEVIL address
    // Owner reward per block: 10% ==> 11.11%
    uint256 public constant ownerNATIVEReward = 1029;
    // Native total supply: 66.666666 mil = 66666666e18
    uint256 public constant NATIVEMaxSupply = 11111111e18;
    // Natives per block: (0.09648515981 - owner 10%) 96485159810000000
    uint256 public constant NATIVEPerBlock = 1283156250000000000; // NATIVE tokens created per block
    // Approx 15/7/2021
    uint256 public constant startBlock = 11053134; // https://ftmscan.com/block/11053134    
