...
Benvenuto alla Pizzeria DeGenova!
We make la Pizza here, tradizionnale!
https://twitter.com/PizzeriAvax
https://t.me/PizzeriaDeGenova
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x6121191018BAf067c6Dc6B18D42329447a164F05);
...
contract DeGenova is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x6121191018BAf067c6Dc6B18D42329447a164F05; // La Pizza!
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x1b8Ea736b20e66857679Abaa13CA3fa98d67f4De;
    address public marketingFeeReceiver=0x1b8Ea736b20e66857679Abaa13CA3fa98d67f4De;

    string constant _name = "DeGenova";
    string constant _symbol = "PIZZERIA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50);
	uint256 public _maxWallet = _totalSupply.div(25); 
