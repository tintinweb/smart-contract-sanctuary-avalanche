...
// @title  Stargate TVL Plunge Test (Avalanche)
// @notice Ante Test to check that assets in Stargate pools on Avalanche
//         (currently USDT, USDC) do not plunge by 90% from the time of test
//         deploy
contract AnteStargateAvalancheTVLPlungeTest is AnteTest("Stargate TVL on Avalanche does not plunge by 90%") {
