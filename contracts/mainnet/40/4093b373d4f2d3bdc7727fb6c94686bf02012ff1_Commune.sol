...
contract Commune is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("The Commune", "COMMUNE") KindaRandom(50) {
    _customBaseURI = "https://nfts.bpi.network/commune/";
    _maxMintable = 50; // 50 max supply
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 2;
    _price = 1 ether;
    _startTime = 1666238400;
    
    _artist = 0x396Af3FaA5bA57BD2bCdA53Cc640bb1c6E19eb4D;
