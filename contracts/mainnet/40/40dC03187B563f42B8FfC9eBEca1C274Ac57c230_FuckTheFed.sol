...
In honor of the Fed being useless and not raising rates, let's print some fucking bitcoin
https://twitter.com/FuckTheFedAvax
https://t.me/FuckTheFedAvax
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 WBTC = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
...
contract FuckTheFed is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address WBTC = 0x50b7545627a5162F82A992c33b87aDc75187B218; // wBTC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xC7bdCd466876C20909082B46556436E342CDA968;
    address public marketingFeeReceiver=0xC7bdCd466876C20909082B46556436E342CDA968;

    string constant _name = "FuckTheFed";
    string constant _symbol = "FTF";
