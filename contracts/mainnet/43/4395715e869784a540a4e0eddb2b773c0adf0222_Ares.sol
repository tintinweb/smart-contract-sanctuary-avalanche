...
Ares : Half Brother of Kratos

Ares is a Project Launched Under Kratos Inu Launchpad. 100% Safe, Rug Free & Organic Projects.
...
AntiDump :
      -Buy : 4% = 2% to marketing, 2% to liquidity
      -Sell : 12% = 6% to marketing, 6% to liquidity

AntiWhale :
      -3% max buy TRX (for first 30 minutes, will slowly be increased)
      -3% max Wallet (for first 30 mintues, will slowly be increased)
...
contract Ares is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x130966628846BFd36ff31a822705796e8cb8C18D; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ARES";
    string constant _symbol = "ARES";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 3000000000000; 
    uint256 public _maxWallet = 3000000000000;
    ...
    address public autoLiquidityReceiver=0x24EE0a7942b2E4a74157C28092ad91a8321b838a; //liq address
    address public marketingFeeReceiver=0x24EE0a7942b2E4a74157C28092ad91a8321b838a; // marketing address
