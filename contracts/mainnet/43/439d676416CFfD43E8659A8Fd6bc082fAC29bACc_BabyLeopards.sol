...
contract BabyLeopards is Ownable, ERC721A  {
    using Strings for uint256;

    bytes4 private constant _ERC2981_INTERFACE_ID = 0x2a55205a;

    uint256 public MAX_SUPPLY = 1330;

    string private _baseTokenURI = "ipfs://QmUEQDoRf3289Hw3V1qVbRQWqCxmnwkXPrAESGMQpULpGY/";
    string public baseExtension = ".json";
    
    uint96 private contractRoyalties = 1000; //10%
    address private royaltyReceiver = 0xE80AeA8E92B2c403e50A4CbEc44a52043d3415D0;

    constructor() ERC721A("Baby Leopards", "BABYLEO") {}
