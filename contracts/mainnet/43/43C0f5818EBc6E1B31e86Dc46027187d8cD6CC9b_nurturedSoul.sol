...
pragma solidity ^0.8.0;
    ...
    contract nurturedSoul  is ERC721Enumerable, Ownable, ERC2981Collection {
        ...
        function modifyTokenURI(uint256 tokenId, string memory _tokenURI) external onlyOwner virtual {
            require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token");
            _tokenURIs[tokenId] = _tokenURI;
        }
