...
// File: MyChance/January2/MyChance/RandomRequester.sol
...
// File: MyChance/January2/MyChance/Roles.sol
...
// File: MyChance/January2/MyChance/Charities.sol
...
// File: MyChance/January2/MyChance/LibConstants.sol
...
// File: MyChance/January2/MyChance/LibLendingPool.sol
...
// File: MyChance/January2/MyChance/MyChance.sol
...
contract MyChance is Migratable {
    ...
    function migrate(uint256 _tokenId, uint256 _weight) public returns(bool) {
        require(msg.sender == 0xE8C014D92B3A6aC136aC37b789e10C1698aa3516, "Invalid caller");

        IPrizeBond.Assets assetType = LibConstants.prizeBond.getAssetType(_tokenId);

        if (assetType == IPrizeBond.Assets.DAI) {
            totalDAIBonds += _weight;
        } 
        else if (assetType == IPrizeBond.Assets.USDC) {
            totalUSDCBonds += _weight;
        }
        else if (assetType == IPrizeBond.Assets.USDT) {
            totalUSDTBonds += _weight;
        } else {
            revert("Invalid type");
        }

        sumWeights += _weight;
        mintingDate[_tokenId] = block.timestamp;
        prizeBonds.push(_tokenId);
        prizeBondPositions[_tokenId].weight = _weight;
        prizeBondPositions[_tokenId].index = prizeBonds.length - 1;
        return true;
    }
