...
contract cryptoroulette1 is ERC721Enumerable, Ownable {
  using Strings for uint256;
...
function _checkPreMintRequirements(uint256 quantity) internal {
    require(quantity > 0 && quantity <= maxPERwallet, "invalid quantity: zero or greater than mint allowance");
    saleNumMinted[msg.sender] = saleNumMinted[msg.sender] + quantity;
    require(saleNumMinted[msg.sender] <= maxPERwallet, "Cannot mint more than your allowance");
}
