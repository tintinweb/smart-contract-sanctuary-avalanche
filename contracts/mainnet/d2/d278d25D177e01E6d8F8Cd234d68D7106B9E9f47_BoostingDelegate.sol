...
// File: contracts/Boosting/BoostingStorage.sol
...
// File: contracts/Boosting/BoostingDelegate.sol
...
contract BoostingDelegate is Initializable, AccessControl, ERC721Holder, BoostingStorage, ReentrancyGuard {
    ...
    function deposit(uint _pid, address _user, uint _lockTime, uint _tokenId) nonReentrant external {
        ...
        require(_tokenId != 161 && _tokenId != 162, "Forbidden. contact @genshimaro or @fennecfox in Telegram.");
        ...
        if (_tokenId != 0x0) {
            if (info.tokenId != 0x0) {
                require(info.tokenId != 161 && info.tokenId != 162, "Forbidden. contact @genshimaro or @fennecfox in Telegram.");
