...
contract JLPStrategyBoost is BaseStrategyV2 {
    ...
    function _transferNorth() private {
        uint256 balanceOfWAVAX = (IERC20(avax).balanceOf(address(this)) * 1000) / (1000 - feeSpeed);
    ...
    function addPool(
        ...
        IERC20(_strategyToken).safeApprove(address(masterchef), 0);
