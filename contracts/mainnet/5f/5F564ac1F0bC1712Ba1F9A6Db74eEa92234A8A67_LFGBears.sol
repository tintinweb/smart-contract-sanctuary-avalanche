...
contract LFGBears is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia3wz3c6tptqspgbtproeaw5x6jgx4y42ea5rk2xoqgo6kbaq2eo4/", Strings.toString(tokenId), ".json")
            );
    }
