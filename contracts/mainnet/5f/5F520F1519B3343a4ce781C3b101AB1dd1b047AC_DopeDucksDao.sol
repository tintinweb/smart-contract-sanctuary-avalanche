...
contract DopeDucksDao is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeih5hglvzghxeutek473vs3sicuvusogi4wsimautq3sr3vbx4zku4/", Strings.toString(tokenId), ".json")
            );
    }
