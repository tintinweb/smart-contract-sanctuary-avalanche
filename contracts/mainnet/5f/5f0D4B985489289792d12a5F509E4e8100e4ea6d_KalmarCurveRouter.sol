...
// File: contracts/interfaces/ICurve2P.sol
...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve1
    ICurve2P public constant curvePool = ICurve2P(0x93004D8477f117eA359b71ec02f2706c8175c55c);
    IERC20 public constant usdc = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); // 0
    IERC20 public constant ust = IERC20(0xb599c3590F42f8F995ECfa0f85D2980B76862fc1); // 1
