...
contract MAP is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = " MAP Protocol ";
    string private constant _symbol = " MAP ";
