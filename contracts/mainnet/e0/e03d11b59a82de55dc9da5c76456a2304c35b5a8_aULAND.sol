...
contract aULAND is ERC20, ERC20Burnable, Ownable {
  ...
  uint256 constant MAXIMUMSUPPLY=720000000*10**18;

  constructor() ERC20("ULAND+", "aULAND") { 
      _mint(msg.sender, 360000000 * 10 ** 18);
