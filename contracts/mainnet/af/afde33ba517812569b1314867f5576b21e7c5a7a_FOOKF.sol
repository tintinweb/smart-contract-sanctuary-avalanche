...
contract FOOKF is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        maxAmountPerBuy = totalSupply_.div(100); // 1%

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        dividendTracker = FOOKFDividendTracker(
            payable(Clones.clone(dividendTrackerAddress))
        );
    ...
    function removeMaxAmountPerBuy() external onlyOwner {
        maxAmountPerBuy = totalSupply();
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "FOOKF: amount larger than allowed"
        );
