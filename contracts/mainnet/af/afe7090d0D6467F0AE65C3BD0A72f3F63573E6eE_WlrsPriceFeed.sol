...
contract WlrsPriceFeed is Ownable {

    IOracle public Oracle = IOracle(0x99654324B6ECAddAc4387DE13300F5B861Fd0cF3);
    IPriceFeed public PriceFeed = IPriceFeed(0xF096872672F44d6EBA71458D74fe67F9a77a23B9);
    address public WLRS = 0x395908aeb53d33A9B8ac35e148E9805D34A555D3;
    ...
    function latestPrice() external view returns (uint256) {
        ...
        uint256 price = Oracle.consult(WLRS, 1e18);
    ...
    function setWLRS(address wlrs) external onlyOwner {
        WLRS = wlrs;
    }
}
