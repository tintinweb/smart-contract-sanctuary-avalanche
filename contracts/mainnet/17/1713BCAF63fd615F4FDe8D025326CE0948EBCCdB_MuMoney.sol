...
contract MuMoney is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20FlashMint {
    ...
    function _flashFee(address token, uint256 amount) internal view virtual override returns (uint256) {
        // silence warning about unused variable without the addition of bytecode.
        require(token == address(this), "Can only flashmint this token");
        //applies a 1.5% fee
        return amount.mul(15).div(1000);
    }
