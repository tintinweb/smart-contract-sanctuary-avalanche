...
contract SimpleLockerHelper {
    using SafeERC20 for IERC20;
    address public constant locker = 0xF99264cbf9652824B3412FA21E8cBEB69c3ea0a7;
    address public constant depositToken = 0x5817D4F0b62A59b17f75207DA1848C2cE75e7AF4;
    ...
    function depositFor(uint256 _amount, address _for) external {
        ...
        IERC20(depositToken).approve(locker, _amount);
        ILockerV2(locker).depositFor(_for, _amount);
    }
}
