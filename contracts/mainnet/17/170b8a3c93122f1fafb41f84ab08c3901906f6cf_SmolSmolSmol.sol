...
// File: contracts/SmolSmolSmol.sol
...
contract SmolSmolSmol is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // CONSTANTS
    uint public constant MAX_SUPPLY = 70;
    ...
    uint public price = 1500000000000000000;
    address private royaltyAddress = 0x53DF3eD43D4A9874E79520cf3454b918c104FeB6;
    uint private royalty = 1000;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("SmolSmolSmol","SmolSmolSmol") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(amount > 0 && amount <= maxPerTx, "Error:  ! Only 15 per Tx");
