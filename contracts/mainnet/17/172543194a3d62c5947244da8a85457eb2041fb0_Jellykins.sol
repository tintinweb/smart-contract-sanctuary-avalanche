...
contract Jellykins is ERC721URIStorage, Ownable, Pausable
{
  ...
  uint256 public maxMintable = (150);//no more than this many nfts can be minted (about the current supply of egg tokens
  ...
  constructor() ERC721("Jellykins", "JELLYKIN") {
    baseURI = "ipfs://QmYMFxZYGsXDpYBj3f1cq44M8TsnN6hU6Vf1DACS9TzMBj/";//add in ipfs location info for the json metadata test 
  }//End of constructor
