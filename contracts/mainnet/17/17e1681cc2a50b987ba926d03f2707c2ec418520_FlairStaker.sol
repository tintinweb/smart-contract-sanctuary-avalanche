...
contract DyFLAIRManager is OwnableUpgradeable, PausableUpgradeable {
  /**
   * @dev Dyson Contracts:
  ...
  function __DyFLAIRManager_init(address _keeper, address _voter) public initializer {
    __DyFLAIRManager_init_unchained(_keeper, _voter);
  }

  function __DyFLAIRManager_init_unchained(address _keeper, address _voter) internal initializer {
    keeper = _keeper;
    voter = _voter;
  }
...
contract FlairStaker is DyFLAIRManager, ReentrancyGuardUpgradeable, ERC20Upgradeable {
  ...
  function __SolidLizardStaker_init(
    ...
    __DyFLAIRManager_init(_keeper, _voter);
    __Ownable_init();
