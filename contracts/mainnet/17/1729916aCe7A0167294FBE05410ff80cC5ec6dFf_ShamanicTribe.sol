...
contract ShamanicTribe is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    uint public constant START_ID = 750;

    string public baseURI;
    // VARIABLES
    bool public whitelistedOnly;
    bool public rewardMintEnabled;
    uint public rewardMintThreshold;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Shamanic Tribe", "STRB") ClampedRandomizer(maxSupply) {
