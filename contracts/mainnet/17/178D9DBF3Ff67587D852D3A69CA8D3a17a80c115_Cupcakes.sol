...
constructor(address signer_, uint256 maxSupply_) ERC721("Cupcakes", "CUPCAKE") KindaRandom(maxSupply_) {
    ...
    _maxPerWallet = 3;
    _signer = signer_;
    _artist = 0x0e70A0A23f889C1E1490B443Bc5e6C7ac989ED61;
  }
  ...
  function signatureMint(uint256 quantity, bytes32 _salt, uint256 maxGas, bytes memory _signature) public payable {
    ...
    require(_numberMinted[msg.sender] <= _maxPerWallet);
