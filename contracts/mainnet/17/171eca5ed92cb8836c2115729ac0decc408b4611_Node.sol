...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0x1a877B68bdA77d78EEa607443CcDE667B31B0CdF);
    uint256[] public tierAllocPoints = [1 ether, 2.1 ether, 4.3 ether];
    uint256[] public tierAmounts = [10 ether, 20 ether, 40 ether];
    struct User {
    ...
    function compound(uint256 nodeTier) public {
      uint256 rewardsPending = getTotalRewards(msg.sender);  
      require(rewardsPending >= tierAmounts[0], "Not enough to compound");  
      uint256 numPossible = rewardsPending.div(tierAmounts[nodeTier]);
      claim();
      _compound(nodeTier, numPossible);
    }
