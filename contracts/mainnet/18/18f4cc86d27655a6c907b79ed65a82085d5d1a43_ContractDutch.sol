...
contract ContractDutch is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 3037; // 3037 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant MAX_CLAIM_PER_WALLET = 10;
    uint256 public STARTING_NFT_PRICE = 2 ether; // 10 avax for this launchpad
    uint256 public constant ROYALTY_VALUE = 1000; // 100 = 1%, 200 = 2% etc...  7% for this launchpad
    uint256 public constant MIN_PRICE = 0.3 ether;
    uint256 public constant DURATION_STEP = 126; // 126 sec for this launchpad
    uint public immutable discountRate = 0.0595 ether;  // 0.5 avax for this launchpad
    uint public startAt;
...
//
    function claim(uint256 n) public payable {
        ...
        require(publicMintedAmount[msg.sender] < MAX_CLAIM_PER_WALLET, "exceeds the public minting limit");
        require(n + publicMintedAmount[msg.sender] <= MAX_CLAIM_PER_WALLET, "you can't early claim that much");
