...
/**
     ...
     */
    function getRewardClaimable(uint256 campaignId) public view  returns(uint256[] memory, uint256, uint256, uint256, uint256) {
        
        return (getXTicektedIDs(campaignId),totalUserXTickets[msg.sender][campaignId], campaigns[campaignId].startTime, campaigns[campaignId].endTime, rewardsReceived[msg.sender][campaignId]);
    }
     ...
     * @return userXticketsIds
     */
    function getRewardClaimableCount(uint256 campaignId) public view  returns(uint256, uint256, uint256) {
         uint256 rangeStart = userXTicketRange[msg.sender][campaignId].start;
       uint256 rangeEnd =  userXTicketRange[msg.sender][campaignId].end;
       uint256[] memory _winningTicketIds = winningTicketIds[campaignId];
       uint256 count;
        ...
        return (count, campaigns[campaignId].startTime, campaigns[campaignId].endTime );
    }
