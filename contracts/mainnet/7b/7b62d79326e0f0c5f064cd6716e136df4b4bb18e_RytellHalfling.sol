...
/// @title Rytell Halfling
contract RytellHalfling is ERC721Metadata {
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell Halfling: All minted");
        require(counts_ > 0, "Rytell Halfling: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell Halfling: sale already ended"); 
        require(!paused, "Rytell Halfling: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell Halfling: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell Halfling: max supply reached");
    ...
    function pause(bool state_)
     ...
     function randomGiveaway(address[] memory winners_)
        ...
        require(
            ...
            "Rytell Halfling: overflow giveaways");
