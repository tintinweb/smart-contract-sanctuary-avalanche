...
contract LeopardQueens is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Leopard Queens", "QUEENS") KindaRandom(50) {
    _customBaseURI = "https://nfts.bpi.network/leopard_queens/";
    _maxMintable = 50; // 50 max supply
    _royaltyAmount = 800; // 8% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 1;
    _price = 5 ether;
    _startTime = 1660845600;
    
    _artist1 =  0x294D8CE9f4cD5B150da5786D0d256175a07e13DB;
    _artist2 =  0x73AF430b3Ba5aBB336E835Ede31702d7330b3169;

    _wavaxAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;

    _privateMint(0x767dC13B7C297b214489d7324652830570A5A108);
    _privateMint(0x767dC13B7C297b214489d7324652830570A5A108);
    _privateMint(0x767dC13B7C297b214489d7324652830570A5A108);
    _privateMint(0x767dC13B7C297b214489d7324652830570A5A108);
    _privateMint(0x767dC13B7C297b214489d7324652830570A5A108);

    _privateMint(0x129F339Fe72Abfb12af07b446ec6576920e1B759);
    _privateMint(0x129F339Fe72Abfb12af07b446ec6576920e1B759);
    _privateMint(0x129F339Fe72Abfb12af07b446ec6576920e1B759);
    _privateMint(0x129F339Fe72Abfb12af07b446ec6576920e1B759);
    _privateMint(0x129F339Fe72Abfb12af07b446ec6576920e1B759);
