...
// Change Name
contract BeanBaristas is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "https://metadata-api.masongary.repl.co/api/uri/";
    ...
    uint256 public royalty = 700; // (500 / 100 = 5% royalty)
    // Change Max Per TX
    ...
    constructor() ERC721A("Bean Baristas", "bBean") {
