...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xE5460C55FEdED67a0Bb48c5cD25f5513742Ea0cA];
  address public erc20Payable = 0xE5460C55FEdED67a0Bb48c5cD25f5513742Ea0cA;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 20, 1555) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeic6u2g6qieybrfbage3e6csqwlps2xsbi356qtgmosckm5lskbq24/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 1555");
    ...
    */
    function mintTo(address _to) public payable {
        ...
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1555");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1555");
...
// File: contracts/AvaxKiraContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AvaxKiraContract is RamppERC721A {
    constructor() RamppERC721A("Avax Kira", "AKA"){}
}
