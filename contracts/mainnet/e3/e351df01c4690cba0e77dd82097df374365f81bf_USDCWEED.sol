...
contract USDCWEED is Initializable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function initialize() public initializer {
        __Ownable_init();
        USDC = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; /* Centre: USDC Stablecoin */
        USDCinterface = IERC20(USDC);
        min = 1 * 1e6; // 1 USDC
        max = 100000 * 1e6; // 100k USDC
        roi = 25;
        fee = 3;
        withdraw_fee = 3;
        ref_fee = 15;
    ...
    function deposit(address _ref, uint256 _amount) public nonReentrant {
        require(
            ...
            "Amount must be between 1 and 100000 USDC"
        );
        ...
        if (!checkAlready()) {
            ...
            USDCinterface.transferFrom(msg.sender, dev, total_fee);
            USDCinterface.transferFrom(
                msg.sender,
                address(this),
                total_contract
            );
    ...
    function withdrawal() public nonReentrant {
        ...
        USDCinterface.transfer(msg.sender, totalAmountToWithdraw);
        USDCinterface.transfer(dev, wFee);
    ...
    function unStake() external nonReentrant {
        ...
        USDCinterface.transfer(msg.sender, UnstakeValueCore);
    ...
    function Ref_Withdraw() external nonReentrant {
        ...
        USDCinterface.transfer(msg.sender, value);
    ...
    function getBalance() public view returns (uint256) {
        return USDCinterface.balanceOf(address(this));
    }

    function getUserBalance(address _user) public view returns (uint256) {
        return USDCinterface.balanceOf(_user);
    }
}