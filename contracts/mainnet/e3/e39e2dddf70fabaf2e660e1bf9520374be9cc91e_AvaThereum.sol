...
Following the Avax Reborn, let's kill it ! 

Twitter & Telegram will be done just after the launch.

Lp will be locked on pinksale.

Twitter who will be used will be the last twitter we used for a 8 months ago launch 
on avax to attract more & more.

Reflections contract (eth : 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // reward address 
...
contract AvaThereum is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaThereum";
    string constant _symbol = "AvaThereum";
    ...
    address public autoLiquidityReceiver=0xf353005ACa86F21C41473dbe1961D26C4e7328f0; //liq address
    address public marketingFeeReceiver=0xf353005ACa86F21C41473dbe1961D26C4e7328f0; // marketing address
