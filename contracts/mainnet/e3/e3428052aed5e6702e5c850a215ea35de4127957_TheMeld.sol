...
contract TheMeld is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 MAX_MINT_AVALANCHE = 800;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_AVALANCHE, "Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint tokenId) public payable {
        ...
        require(msg.value >= messageFee, string(abi.encodePacked("You have to send some/more AVAX to cover traversal gas fee estimate. You will be refunded the difference. Estimate: ", Strings.toString(messageFee))));
