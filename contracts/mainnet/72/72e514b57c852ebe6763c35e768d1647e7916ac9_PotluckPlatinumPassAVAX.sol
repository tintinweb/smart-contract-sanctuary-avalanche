...
contract PotluckPlatinumPassAVAX is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x6e1dc6e70a3722BA259a9D86F102699Dc854eCF5;
    ...
    uint256 public maxPerPerson = 455;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Potluck Platinum Pass", "PLPP") ClampedRandomizer(maxSupply) {     
