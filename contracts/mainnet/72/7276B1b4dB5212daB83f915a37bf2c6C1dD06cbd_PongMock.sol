...
// File src/omni/remote/lz/libraries/ExcessivelySafeCall.sol
...
contract PongMock is NonblockingLzApp {
    ...
    function _nonblockingLzReceive(
        ...
        (uint256 nativeFee, ) = ILayerZeroEndpoint(lzEndpoint).estimateFees(_srcChainId, msg.sender, callbackPayload, false, callbackAdapterParams);
