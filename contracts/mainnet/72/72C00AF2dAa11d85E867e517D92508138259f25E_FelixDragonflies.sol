...
contract FelixDragonflies is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 147; //  147 total for this launchpad
...
//
    ...
    function airdropTo(User[] memory users) external onlyOwner {

        for (uint256 i = 0; i < users.length; i++) {
            _safeMint(users[i].recipient, minted);
