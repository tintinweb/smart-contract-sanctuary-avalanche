...
contract MAKER is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("testMAKER", "TMAKER") {
    ...
    function transferFrom(
        ...
        if (autoCalculateTax) {
            uint256 currentMakerPrice = _getMakerPrice();
            currentTaxRate = _updateTaxRate(currentMakerPrice);
            if (currentMakerPrice < burnThreshold) {
                burnTax = true;
            }
        }
