...
contract PinupsAndCocktails is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Pinups & Cocktails", "PINUPS") KindaRandom(27) {
    _customBaseURI = "https://nfts.bpi.network/pinups/";
    _maxMintable = 27; // 27 max supply
    _royaltyAmount = 800; // 8% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 2;
    _price = 2 ether;
    _startTime = 1679695200;
    
    _artist =  0x22bDF80fc958d49e85eB207Ac114a28862349B18;
  ...
  function mint(uint256 quantity) public payable {
    ...
    uint256 actualPrice = priceFor(msg.sender);

    require(msg.value >= (quantity * actualPrice), "Not enough AVAX sent.");
  ...
  function priceFor(address account) public view returns (uint256) {
    ERC721 nft = ERC721(0x2b8812a0E018351711d419E2eD3aa044E0355F52);
