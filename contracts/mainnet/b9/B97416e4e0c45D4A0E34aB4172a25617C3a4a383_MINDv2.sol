...
contract MINDv2 is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function createNodeWithTokens(string memory name) public {
        ...
        uint256 referralFee = _processReferralFee(_msgSender(), nodeRewardManager.nodePrice(), referralRateForNodeCreation);
        // validator
        uint256 processFee;
        ...
        IERC20Upgradeable(address(this)).safeTransferFrom(_msgSender(), address(this), 
            nodeRewardManager.nodePrice() - referralFee - processFee);
    ...
    // ensures referral fulfills requirements to receive referral income
