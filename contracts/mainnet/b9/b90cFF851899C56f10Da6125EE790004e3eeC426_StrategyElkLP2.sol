...
contract StrategyElkLP2 is StratManager, FeeManager {
    ...
    // Tokens used
    address private native = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7 );
    address private output = address(0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C);
    address public want = address(0x2612dA8fc26Efbca3cC3F8fD543BCBa72b10aB59);
    address private lpToken0;
    address private lpToken1;

    // Third party contracts
    address public rewardPool = address(0x9ec3ca469F415a7e55A21Dc662D427d59e8De8F6);

    // Routes
    address[] private outputToNativeRoute = [output, native];
    ...
    constructor(
        address _vault
    ) StratManager(address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F), address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F), address(0x9E4AAbd2B3E60Ee1322E94307d0776F2c8e6CFbb), _vault, address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F)) public {
        ...
        if (lpToken0 == native) {
            outputToLp0Route = outputToNativeRoute;
        } else if (lpToken0 != output) {
            outputToLp0Route = [output, native, lpToken0];
        }

        if (lpToken1 == native) {
            outputToLp1Route = outputToNativeRoute;
