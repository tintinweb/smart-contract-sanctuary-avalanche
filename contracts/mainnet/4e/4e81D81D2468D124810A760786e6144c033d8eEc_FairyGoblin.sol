...
// File: contracts/FairyGoblin.sol
...
contract FairyGoblin is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmSTweGfgKEjaCV1p767aS1kXCtAZcRCRuZwfcE3bUgbtE/';
  ...
  constructor() ERC721A("FairyGoblin", "FG") {
  }
