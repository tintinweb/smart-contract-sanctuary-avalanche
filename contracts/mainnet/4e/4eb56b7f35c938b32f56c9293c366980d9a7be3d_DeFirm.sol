...
contract DeFirm is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY =
        100 * 10**4 * 10**DECIMALS;

    uint256 public constant liquidityFee = 50;
    uint256 public constant treasury1Fee = 50;
    uint256 public constant treasury2Fee = 50;
    ...
    address public warchestReceiver;
    ...
    constructor() ERC20Detailed("DeFirm", "DEFIRM", uint8(DECIMALS)) Ownable() {
        ...
        warchestReceiver = 0xfcC2Cb83653E36A1BEbF12DB8b72B03d68ad1972;
    ...
    function takeFee(
        ...
        _gonBalances[treasuryReceiver1] = _gonBalances[treasuryReceiver1].add(
            gonAmount.mul(treasury2Fee).div(feeDenominator)
        );
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(_treasury1Fee).div(feeDenominator)
        );
    ...
    function setFeeReceivers(
        ...
        address _warchestReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver1 = _treasuryReceiver1;
        warchestReceiver = _warchestReceiver;
    }
