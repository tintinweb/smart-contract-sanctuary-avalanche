...
contract HotelEmpire is IERC20 {
    ...
    uint256 constant private startingSupply = 42_000_000_000_000;

    string constant private _name = "HotelEmpire";
    string constant private _symbol = "$HOTEL";
    uint8 private _decimals = 9;

    uint256 private _tTotal = startingSupply * (60 ** _decimals);
    ...
    address payable public marketingWallet = payable(0x44E19c4e10E947Fb76B1Ed4c1eAeB8ca7652dbb4);
    address payable private rewardsPool = payable(0x44E19c4e10E947Fb76B1Ed4c1eAeB8ca7652dbb4);
    address payable private treasuryWallet = payable(0x44E19c4e10E947Fb76B1Ed4c1eAeB8ca7652dbb4);

    uint256 private _maxTxAmount = (_tTotal * 1) / 5;
    uint256 private _maxWalletSize = (_tTotal * 5) / 5;
    ...
    bool public hasLiqBeenAdded = true;
