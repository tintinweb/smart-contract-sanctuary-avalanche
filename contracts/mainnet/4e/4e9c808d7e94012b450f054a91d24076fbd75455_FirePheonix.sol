...
/**
 *
Firepheonix earn 7% reflections by
holding this is a moon token do you
see the pheonix on the left thats what
we will ride to the moon contract will
be locked for 2 months and renounced
cg and coinmarketcap will be aplied for
make sure to be early to this moonride
to the moon
website - https://firepheonix.net/
twitter - https://twitter.com/FirePheonix___
telegram - https://t.me/FirePheonix
*/
...
contract FirePheonix is Context, IERC20, Ownable {
    ...
    string private _name = 'FirePheonix';
    string private _symbol = 'FIREP';
