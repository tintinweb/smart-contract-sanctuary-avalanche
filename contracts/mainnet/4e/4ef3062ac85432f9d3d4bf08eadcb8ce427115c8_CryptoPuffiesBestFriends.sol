...
contract CryptoPuffiesBestFriends is Ownable {
    struct Stats {
        uint16 bestFriend;
        uint16 nemesis;
    }
    uint256 constant public MAX_TOKENS = 8888;
    uint256 public amountAssigned;
    ...
    function assignBestFriends(uint256 amountToAssign) external onlyOwner {
        require(amountAssigned + amountToAssign <= MAX_TOKENS);
