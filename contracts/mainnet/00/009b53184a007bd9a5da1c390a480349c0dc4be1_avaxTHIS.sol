...
Inspired by recent ethereum token $THIS

$aTHIS isn’t just a cool name with a pretty face.
There’s a pretty innovative thing about $aTHIS:
$aTHIS rewards people for talking about it.

And aTHIS is how it happens:
5% of all the transaction volume is sent as AVAX to a wallet we call the Engagement Fund.
The Fund will be used as a reward pot in a weekly engagement contest for tweets mentioning $aTHIS.

More information ar our Telegram - https://t.me/AvaxTHIS
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // ETH Reward
...
contract avaxTHIS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ZSHARE = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // ETH Reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "aTHIS";
    string constant _symbol = "$aTHIS";
    ...
    address public autoLiquidityReceiver=0xE1ff668D47E358910d1E16b5618893b2F0458999; // Wallet
    address public marketingFeeReceiver=0xE1ff668D47E358910d1E16b5618893b2F0458999; //  Wallet
