...
contract Ai_Centaurians is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public allowListCost = 0.25 ether;
    uint256 public publicCost = 0.5 ether;
    ...
    function updatePublicCost(uint256 _newAmount) public onlyOwner {
        publicCost = _newAmount;
    }

    function updateAllowListCost(uint256 _newAmount) public onlyOwner {
        allowListCost = _newAmount;
    }
