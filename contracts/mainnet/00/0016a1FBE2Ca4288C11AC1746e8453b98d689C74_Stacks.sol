...
contract Stacks is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Stacks", "STACKS") KindaRandom(100) {
    _customBaseURI = "https://nfts.bpi.network/stacks/";
    ...
    _earlyAccessMax = 5;
    _price = 2 ether;
    _startTime = 1668045600;
    
    _artist = 0x9260CA0a2B6e551D9b2255DCDC9F007837462637;

    _earlyAccessDuration = 3600; // 1hr
