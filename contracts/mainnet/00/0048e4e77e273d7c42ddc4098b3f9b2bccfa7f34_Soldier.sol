...
contract Soldier is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        futurUsePool = addresses;
        distributionPool = addresses;
        uniswapV2Router = IUniswapV2Router02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4
);
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(WAVAX, address(this));

        totalFees = rewardsFee.add(liquidityPoolFee).add(futurFee);
        _mint(addresses, 1000000 * (10**18));
