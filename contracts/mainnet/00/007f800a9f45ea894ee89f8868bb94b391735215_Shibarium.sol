...
// File @openzeppelin/contracts/token/ERC20/presets/ERC20Pres[email protected]
...
contract Shibarium  is ERC20PresetFixedSupply {
   constructor() ERC20PresetFixedSupply("Shibarium.Games", ".Games", 1000000 ether, msg.sender) {}
}