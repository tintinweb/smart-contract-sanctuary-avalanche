...
contract SmwcHallOfFame is ERC721 {
    ...
    constructor()
        ERC721("Smol World Cup - Hall of Fame", "SMWCHOF")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigxuzmrne77uv2esir6cz7ni6snu75klwvk7bcnzsvdpo3njzloai/", Strings.toString(tokenId), ".json")
            );
    }
