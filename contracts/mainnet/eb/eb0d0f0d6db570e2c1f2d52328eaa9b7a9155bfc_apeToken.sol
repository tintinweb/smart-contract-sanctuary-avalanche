...
/**    apeToken my fellow apes ape for a 1000X
*      https://twitter.com/apeToken3    /    https://t.me/apeToken1
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x223370B121b7208cf2fFE8F47441D05ed589a492); // $ATM 
...
contract apeToken is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ATM  = 0x223370B121b7208cf2fFE8F47441D05ed589a492;   
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "apeToken";
    ...
    address public autoLiquidityReceiver=0x76Fc199C5fef2d18C435823e0cc0133A08708C64; //liq address
    address public marketingFeeReceiver=0x76Fc199C5fef2d18C435823e0cc0133A08708C64; // marketing address
