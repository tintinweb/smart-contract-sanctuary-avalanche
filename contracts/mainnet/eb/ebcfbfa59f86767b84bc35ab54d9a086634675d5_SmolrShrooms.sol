...
contract SmolrShrooms is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://QmXnJZniwx8RHT966fBmgiAQErhGNXJ6fc5qjfL74cZAbd/", Strings.toString(tokenId), ".json")
            );
    }
