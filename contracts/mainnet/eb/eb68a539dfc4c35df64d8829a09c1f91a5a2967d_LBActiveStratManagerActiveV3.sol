...
contract LBActiveStratManagerActiveV3 is Ownable, AutomationCompatibleInterface {
    ...
    constructor(address _strategyAddress, uint256 _binOffset, uint256 _centerOffset) {
    ...
    function checkUpkeep(bytes calldata) external view override returns (bool upkeepNeeded, bytes memory performData) {
        ...
        else if ((isPendingRebalance && activeId >= minBin + binOffset && activeId <= maxBin - binOffset)) {
            upkeepNeeded = true;
        }
        ...
        else if (activeId <= minBin + binOffset || activeId >= maxBin - binOffset) {
            upkeepNeeded = true;
