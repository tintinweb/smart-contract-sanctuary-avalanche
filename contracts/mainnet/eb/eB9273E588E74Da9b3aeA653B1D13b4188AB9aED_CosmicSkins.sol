...
ERC1155URITokenJSON, ERC1155Soulbound, ERC1155Metadata {
    ...
    function initialize() initializer public {
        ...
        __ERC1155URITokenJSON_init("https://images.cosmicuniverse.io/cosmic-skins/");
        __ERC1155AttributeStorage_init();
        __ERC1155Metadata_init("Cosmic Skins", "SKINS");
    ...
    function uri(uint256 tokenId) public view override(ERC1155Upgradeable, ERC1155URITokenJSON) returns(string memory) {
        ...
        // IDs: 0 - Profession | 1 - Tool | 2 - Set
        Attribute[] memory attributes = new Attribute[](3);
        attributes[0] = Attribute('Profession', '', getAttributeName(tokenId, 0));
        attributes[1] = Attribute('Tool', '', getAttributeName(tokenId, 1));
        attributes[2] = Attribute('Set', '', getAttributeName(tokenId, 2));

        return _makeBase64(_makeJSON(tokenId, name, description, attributes));
    }

    function bridgeExtraData(uint256, uint256) external pure returns(bytes memory) {
        return "";
    }
...
interface IBridgeableERC1155 is IERC165Upgradeable, IERC1155Upgradeable {
