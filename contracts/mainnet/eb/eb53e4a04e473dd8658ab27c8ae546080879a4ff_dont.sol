...
contract dont is Context, IERC20, Ownable {
    ...
    string private _name = "dont";
    string private _symbol = "dnt";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xB085b75D8f1062A034f9008cCCb4e9FF2A894399);
    address payable public devWalletAddress = payable(0xB085b75D8f1062A034f9008cCCb4e9FF2A894399);
    address payable public teamWalletAddress =  payable(0xB085b75D8f1062A034f9008cCCb4e9FF2A894399);
