...
contract Tomb is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("SNO", "SNO Token") {
    ...
    function operatorBurn(address account, uint256 amount) public onlyOperator {
