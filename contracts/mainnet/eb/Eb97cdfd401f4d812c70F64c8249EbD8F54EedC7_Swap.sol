  ...
  ERC1155HolderUpgradeable
{
   ...
   * @param _pooledTokenId an array of ids this pool will accept
  ...
  ) public virtual initializer returns (address) {
   ...
   */
  function getToken() external view virtual returns (uint256) {
