...
contract PangolinYieldFarmVault is ERC20, Ownable, ReentrancyGuard, Pausable {
  ...
  uint256 public lastFeeCollected;
   // Manager contract
  IPangolinYieldFarmManager public manager;
  // Reader contract
  ...
  event UpdateManager(IPangolinYieldFarmManager _manager);
  event UpdateReader(IPangolinYieldFarmReader _reader);
  ...
  */
  function updateManager(IPangolinYieldFarmManager _manager) external onlyOwner {
