...
/*
    Your first Cat token on Avalanche Chain! ($AVAXCAT)
    Check our website for further information and join our TG!
    
    Website:  https://avaxcat.space/
    Telegram: https://t.me/Avax_Cat
...
contract AVAXCAT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaxCat";
    string constant _symbol = "AVAXCAT";
    ...
    address public marketingFeeReceiver=0x4db3c2A1E02cEC2BD434Cb17DC094AcBF76a32Bb;
