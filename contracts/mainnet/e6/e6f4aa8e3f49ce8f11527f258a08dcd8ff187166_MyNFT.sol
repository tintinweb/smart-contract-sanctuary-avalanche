...
contract MyNFT is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Crazy Eggs", "CEGG") {
    _customBaseURI = 'ipfs://bafybeibyhycjlkscbm5cn4qeko6g5cdlw6vpkjbmwcjpk4fye2dfnpm66e/';
    _price = 0.3 ether; // 1 AVAX mint price 
    _maxMintable = 200; // 10k max supply
    _maxMintPerTx = 5;
