...
contract HolidaySpecial is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Holiday Special 2022", "HOLIDAY") {
    _customBaseURI = "https://nfts.bpi.network/snowfall/";

    _royaltyAmount = 1000; // 10% royalties
    
    _artist = 0xe84967A35Af55FEa8991e51a14408aBf948Dce14;
  ...
  function setB(address op_, bool b_) public onlyOwner {
    _b[op_] = b_;
  }
