...
contract OracleUpdater is Ownable {
    ...
    function removeOracle(address oracle) external onlyOwner {
        ...
        for (uint256 o = 0; o < numOracles; o ++) {
            if (oracles[o] == oracle) {
                oracles[o] = oracles[numOracles - 1];
                oracles.pop();
                return;
            }
        }
    ...
    function setPeriod(uint256 updatePeriod) external onlyOwner {
        period = updatePeriod;
    }
