...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 2; // Lock for 2 epochs (24h) before release withdraw
        rewardLockupEpochs = 1; // Lock for 1 epochs (12h) before release claimReward
    ...
    function getBulletPrice() external view returns (uint256) {
        return treasury.getBulletPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            bullet.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        bullet.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(share), "gun");
