...
contract APRHelper is Initializable, OwnableUpgradeable {
    ...
    mapping(address => uint256) public pool2pid;
    ...
    function getPendingRewardsSinglePool(address user, address lp) public returns (uint256) {}

    function getPendingRewards(address user, address lp) public returns (uint256) {}
