...
contract Plinko is GameBase, GameBet, GameChainlink {
    ...
    constructor(
        ...
        bucketProbabilities[7] = [16105, 170653, 346304, 653696, 829347, 983895, 1000000];
        ...
        bucketProbabilities[9] = [5248, 29978, 159639, 354130, 645870, 840361, 970022, 994752, 1000000];
...
bucketProbabilities[12] = [1228, 5526, 23543, 123849, 274308, 499997, 725692, 876151, 976457, 994474, 998772, 1000000];
        ...
        bucketProbabilities[13] = [1142, 4400, 21779, 37079, 157016, 351606, 648394, 842984, 962921, 978221, 995600, 998858, 1000000];
    }
