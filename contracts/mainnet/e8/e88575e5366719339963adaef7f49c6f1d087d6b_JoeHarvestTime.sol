...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x0F6f4E2616445DD28C21fDD1E15FbC38821FD295); // reward $Joe
...
contract JoeHarvestTime is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x0F6f4E2616445DD28C21fDD1E15FbC38821FD295; // reward $Joe
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Joe's Harvest Time";
    string constant _symbol = "JHT";
    ...
    address public autoLiquidityReceiver=0xA60a5D180Be4fd44aABAfc6fdf8C5B36333bc8F4; //liq address
    address public marketingFeeReceiver=0xA60a5D180Be4fd44aABAfc6fdf8C5B36333bc8F4; // marketing address
