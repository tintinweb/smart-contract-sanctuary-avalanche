...
// File: MyChance/January/MyChance/RandomRequester.sol
...
// File: MyChance/January/MyChance/Roles.sol
...
// File: MyChance/January/MyChance/Charities.sol
...
// File: MyChance/January/MyChance/IPrizeBond.sol
...
// File: MyChance/January/MyChance/LibConstants.sol
...
library LibConstants {
    IPrizeBond constant prizeBond = IPrizeBond(0x98E01F6C487E1C6068efb7FE5Ca359dF1a206c7c);
...
// File: MyChance/January/MyChance/DataTypes.sol
...
// File: MyChance/January/MyChance/IPoolAddressesProvider.sol
...
// File: MyChance/January/MyChance/IPool.sol
...
// File: MyChance/January/MyChance/LibLendingPool.sol
...
// File: MyChance/January/MyChance/LibMyChance.sol
...
// File: MyChance/January/MyChance/MyChance.sol
...
abstract contract Lottery is Charities, RandomRequester, Pausable, AutomationCompatibleInterface {
    ...
    function claim(uint256 _tokenId, uint256 _percentage, address _charity) external {
        ...
        if (totalDAI > 0) {  
            ...
            require(IERC20(LibConstants.daiToken).transfer(_charity, claimVariables.totalToCharityDAI), 'Transfer failed');
        }
        ...
        if (totalUSDT > 0) {
            ...
            require(IERC20(LibConstants.usdtToken).transfer(_charity, claimVariables.totalToCharityUSDT), 'Transfer failed');
        }
        ...
        if (totalUSDC > 0) {
            ...
            require(IERC20(LibConstants.usdcToken).transfer(_charity, claimVariables.totalToCharityUSDC), 'Transfer failed');
        }
