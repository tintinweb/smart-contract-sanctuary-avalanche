...
contract Cloudheadz is ERC721URIStorage, Ownable {
  ...
  constructor(address artist_) ERC721("Cloudheadz", "CLOUDZ") {
    _customBaseURI = 'https://cloudheadz.campfire.exchange/nfts/';
    _price = 1 ether;
    _maxMintable = 10000;
    _royaltyAmount = 700;
    _contractURI = ''; // TODO: Set this up after deploy
    _mintActive = false;
    _artist = artist_;
  ...
  function mint(uint256 quantity) public payable {
    ...
    require(quantity <= 15, "Can't mint more than 15 at a time.");
