...
contract TESTIWU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESTIWU";
    string private _symbol = "$TEST";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x7bcD6E5a0B159335D8202297F7c843F1bB3590Fb);
    address payable public devWalletAddress = payable(0xE8106aEd863152E066aAdb65755a6128C9df494C);
    address payable public teamWalletAddress =  payable(0xAa5ea25196Ca1999EF8Af312D443CEF7437f17fd);
    ...
    uint256 _devShare = 30;
    uint256 _teamShare = 30;
