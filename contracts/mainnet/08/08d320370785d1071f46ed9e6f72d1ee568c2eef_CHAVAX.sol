...
contract CHAVAX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Chinese AVAX", "CHAVAX") {
        ...
        uint256 _buyMarketingFee = 88; // initial taxes for antisnipe mechanics
        uint256 _buyLiquidityFee = 1;  // dev will rollback the tax with 16% after 2 minutes
        uint256 _buyDevFee = 1; 

        uint256 _sellMarketingFee = 17; // antijeet mex | dev will decrease to 16% after 24 hours
        uint256 _sellLiquidityFee = 11;
        uint256 _sellDevFee = 1;
        
        uint256 totalSupply = 1 * 1e12 * 1e18;
        
        //maxTransactionAmount = totalSupply * 2 / 1000; // 0.1% maxTransactionAmountTxn
        maxTransactionAmount = 20000000000 * 1e18; // 2%
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        buyDevFee = _devFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        require(buyTotalFees <= 95, "Anti-Snipe");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external onlyOwner {
        ...
        sellDevFee = _devFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;
        require(sellTotalFees <= 30, "Anti-Jeet");
    }
