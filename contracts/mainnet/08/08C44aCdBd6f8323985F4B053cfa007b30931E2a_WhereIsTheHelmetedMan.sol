...
contract WhereIsTheHelmetedMan is ERC721, ERC721Enumerable, ERC2981, ReentrancyGuard, Ownable {
    ...
    constructor(address _receiver) ERC721("Where is the Helmeted Man", "WITHM") {
        maxCap = 300;
