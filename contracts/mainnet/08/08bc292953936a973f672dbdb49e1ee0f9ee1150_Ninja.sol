...
contract Ninja is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 80,000 NINJA
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 65000 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 6500 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 6500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Ninja Shares", "NINJA") {
        _mint(msg.sender, 1 ether); // mint 1 KATANA Share for initial pools deployment
