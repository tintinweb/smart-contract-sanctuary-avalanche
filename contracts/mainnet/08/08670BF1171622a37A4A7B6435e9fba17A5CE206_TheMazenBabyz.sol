...
contract TheMazenBabyz is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidru5o7bljjzixaa3g6yt4v3wk7etheg77n7issqb7jr46l2y4nnu/", Strings.toString(tokenId), ".json")
            );
    }
