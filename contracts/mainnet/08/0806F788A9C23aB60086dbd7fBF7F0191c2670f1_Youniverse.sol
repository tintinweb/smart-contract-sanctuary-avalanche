...
/**
Youniverse is an AVAX Chain token that rewards $UNIV upon holding the token. A moonshot is expected to reach the $UNIV Token!
Telegram: https://t.me/youniverseavax
Website Coming Soon
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x959b88966fC5B261dF8359961357d34F4ee27b4a); // $UNIV
...
contract Youniverse is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; //  $UNIV
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "YOUNIVERSE";
    string constant _symbol = "YVRS";
    ...
    address public autoLiquidityReceiver=0x382A1D7b11F3910CFdC44a2b4F9F07a0F8FDdb5d; //liq address
    address public marketingFeeReceiver=0x382A1D7b11F3910CFdC44a2b4F9F07a0F8FDdb5d; // marketing address
