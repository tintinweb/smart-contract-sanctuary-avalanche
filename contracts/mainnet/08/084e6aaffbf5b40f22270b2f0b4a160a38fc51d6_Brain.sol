...
contract Brain is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 BRAIN
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Brain Shares", "BRAIN") {
        _mint(msg.sender, 1 ether); // mint 1 SKILL Share for initial pools deployment
