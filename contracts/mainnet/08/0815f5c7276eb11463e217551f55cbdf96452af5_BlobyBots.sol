    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x1588c55956Ea79702164fA55EEDb98923f562F2c;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Bloby Bots", "BLBT") ClampedRandomizer(maxSupply) {     
