...
// File contracts/core/IBOTKiller.sol
...
contract IBOTKiller is Context, IERC20, IERC20Metadata, Ownable {
    ...
    modifier onlyIMON() {
        require(_imonMinters[msg.sender] == true, "IBOTToken: Only IMON contracts can call this function");
        _;
    }
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _blackList[0x3b09e7eAC6510307726FE19eD346Fa00D6e5C37A] = true;
        _blackList[0x7d28AE8e6d7B1C8d28Af9Cc72a474210Acdd8a97] = true;
    }
