...
contract TroveManager is TroveManagerBase, ITroveManager, ReentrancyGuardUpgradeable {
     ...
     *  Called from borrower operations and ticks interest. Different function called from liquidation,
     *  redemption, etc. 
     * @param _borrower The address of the Trove
     */
     ...
     * @param _borrower The address of the Trove
     * @return pendingYUSDDebtReward The pending debt only from redistributions
     * @return pendingYUSDInterest The pending interest accrued from the YUSD loan
     */
