...
contract BondMarket is OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function _burnPeg(uint nativeAmount) internal {
        ...
        IUniswapV2Router router = IUniswapV2Router(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        address peg = 0x6ca558bd3eaB53DA1B25aB97916dd14bf6CFEe4E;
        address[] memory path = new address[](2);
        path[0] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
        path[1] = peg;
        router.swapExactAVAXForTokens{value: nativeAmount}(0, path, address(this), block.timestamp);
