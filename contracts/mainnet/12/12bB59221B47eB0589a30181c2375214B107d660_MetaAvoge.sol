...
// https://t.me/metaAvoge
// https://twitter.com/metaAvoge
// META AVOGE - AVOGE REWARDS TOKEN
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x779595F212B53e4f1F51b0875405Bf21B5e4D805); //Rewards
...
contract MetaAvoge is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    
    address EP = 0x779595F212B53e4f1F51b0875405Bf21B5e4D805; // REWARDS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MetaAvoge";
    string constant _symbol = "MAVOGE";
    ...
    address public autoLiquidityReceiver=0x23caCa0C4B42857a9adb98CE21721A3F0c309C23; //liq address
    address public marketingFeeReceiver=0x23caCa0C4B42857a9adb98CE21721A3F0c309C23; // marketing address
