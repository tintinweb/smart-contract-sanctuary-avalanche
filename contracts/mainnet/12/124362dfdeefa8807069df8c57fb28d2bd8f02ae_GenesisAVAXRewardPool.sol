...
// File contracts/distribution/GenesisAVAXRewardPool.sol
...
contract GenesisAVAXRewardPool {
    using SafeMath for uint256;
    ...
    // MAINNET
    uint256 public tokenPerSecond = 0.075810185 ether; //
    uint256 public runningTime = 1 days; // 1 days
    uint256 public constant TOTAL_REWARDS = 6550 ether;
    // END MAINNET
