...
contract MuPriceOracle{
    ...
    function get_mu_usd_price() public  view returns(uint256 mu_price){
        //MU-USDC.e TJ LP Pool token0 is USDC.e (6) and token1 is MU Coin (18)
        (uint112 reserve0, uint112 reserve1) =  _getLPreserves(_mu_usdc_lp);
        return (reserve0 * 10**30)/reserve1;
