...
contract RavenPresale is Ownable {
    ...
    uint256 public maxinvestPrivate;
    uint256 public maxinvestPublic;
    ...
    function invest(uint256 investAmount) public {
        ...
        if (whitelistSale) {
            require(amountInvested[msg.sender] + investAmount <= maxinvestPrivate, "above cap");
            require(whitelisted[msg.sender] == true, 'msg.sender is not whitelisted');
        } else {
            require(amountInvested[msg.sender] + investAmount <= maxinvestPublic, "above cap");
        }
    ...
    // -- admin functions --
    function setTotalRaised(uint256 _totalRaised) public onlyOwner {
