...
Buy/Sell tax: 15% split up into;
Liquidity 4%
Reflections of USDC 5%
Marketing 6%
Telegram: @PanthaAvax
WEB: TBA
*/
...
contract PanthaAvax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PanthaAvax";
    string constant _symbol = "$PAVAX";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(20); // 1%
    uint256 public _maxWallet = _totalSupply.div(10); // 2%
    ...
    address public autoLiquidityReceiver=0x1A506d25591dE373b2F0Ca08ee1f0eCD19002349;
    address public marketingFeeReceiver=0x1A506d25591dE373b2F0Ca08ee1f0eCD19002349;
