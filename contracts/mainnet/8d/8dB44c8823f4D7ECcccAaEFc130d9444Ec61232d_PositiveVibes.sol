...
contract PositiveVibes is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 52; //  52 total for this launchpad
    ...
    uint256 public constant NFT_EARLY_PRICE = 5 ether; //
