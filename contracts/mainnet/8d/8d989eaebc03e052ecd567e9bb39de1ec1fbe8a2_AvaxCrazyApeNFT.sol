...
contract AvaxCrazyApeNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.75 ether;
    uint256 public presaleCost = 0.65 ether;
    uint256 public whitelistCost = 0.50 ether;
        ...
        if (msg.sender != owner()) {
            if (whitelisted[msg.sender] != true) {
                if (presaleWallets[msg.sender] != true) {
                 ...
                 //whitelist
                    require(_mintAmount <= maxWhitelistAmount);
