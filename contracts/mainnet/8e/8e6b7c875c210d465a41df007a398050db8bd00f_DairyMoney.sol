...
Dairy.Money has been designed to open the doors of DeFi to anyone, through a fun multi-chain Yield Processing Node.

To put it in a nutshell, we aim to do DeFi-as-a-Service. Instead of navigating blindly between the 300 different protocols (and scams) in DeFi, you would just have to use one token and one platform : Dairy.Money and $MILK.

Basically the idea behind this project is to enable noders to invest into more than 30 DeFi high-yield protocols, without having to find the best ones all by themselves. No need to run any software or pay insane for the network fees. All the manual swapping, bridging, staking, bonding, etc. is done by us.
...
contract DairyMoney is IERC20 {
    ...
    string constant private _name = "MILK TOKEN";
    string constant private _symbol = "$MILK";
    ...
    address payable public MarketingTreasury = payable(0xB4cdd0DBfaDeF59bBe649fC77Bac087Fa7ab4898);
    address payable private rewardsPool = payable(0xB4cdd0DBfaDeF59bBe649fC77Bac087Fa7ab4898);
    address payable public NodeTreasury = payable(0xB4cdd0DBfaDeF59bBe649fC77Bac087Fa7ab4898);
    ...
    IERC20 MANSION = IERC20(0xB4cdd0DBfaDeF59bBe649fC77Bac087Fa7ab4898);
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable treasury, address payable rewards) external onlyOwner {
        MarketingTreasury = payable(marketing);
        NodeTreasury = payable(treasury);
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        if(address(this).balance > 0){
            ...
            NodeTreasury.transfer((amountAVAX * _ratios.treasury) / (_ratios.treasury + _ratios.marketing));
            MarketingTreasury.transfer(address(this).balance);
        }
    }
