...
contract SShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accBSharePerShare; // Accumulated SShares per share, times 1e18. See below.
    ...
    uint256 public sSharePerSecond = 0.0045 ether; // 70000 bshare / (180 days * 24h * 60min * 60s)
    ...
    // Safe bshare transfer function, just in case if rounding error causes pool to not have enough SShares.
