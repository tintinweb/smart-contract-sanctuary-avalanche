...
contract UserHelper is Ownable {
    ...
    uint256 public distributionAmount = 1 * 1e18; // ok
    ...
    function compoundNode(string memory _name) public isEnable {
        ...
        uint256 rewardableAmount = management.calculateAvailableReward(account);

        require(rewardableAmount >= nodePrice, "USER HELPER: INSUFFICIENT REWARD AMOUNT");
