...
contract SaleNFT is ReentrancyGuard, Ownable, ERC721Holder {
    ...
    IERC20 public constant USD = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    
    IERC721Enumerable public constant banksyNFT = IERC721Enumerable(0x942d791ab07e33Fe4B780Fc0b3874a24Ac3da433); 

    uint256 public nftCardPerAccountMaxTotal = 9; // 9 cards
    
    uint256 public salePrice = 30 * (10 ** 6); // 30 usd
