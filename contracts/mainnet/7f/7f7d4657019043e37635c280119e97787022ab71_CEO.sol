...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x15c841043e13fFAA9a99FabEa236D40F45615623);
...
contract CEO is IBEP20, Auth {
    ...
    address BUSD = 0x15c841043e13fFAA9a99FabEa236D40F45615623; // BUSINESS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xe5Dffab0AD62c8EA3e98FEb0Cf21313566CDcf4C;
    address public marketingFeeReceiver=0xe5Dffab0AD62c8EA3e98FEb0Cf21313566CDcf4C;

    string constant _name = "Tycoon CEO";
    string constant _symbol = "CEO";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(199);
