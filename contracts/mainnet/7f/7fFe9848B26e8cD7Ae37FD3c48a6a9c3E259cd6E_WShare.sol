...
contract WShare is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_AIRDROP_COMMUNITY_FUND = 500 ether;
    uint256 public constant INITIAL_AIRDROP_DEV_FUND = 360 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("WSHARE", "WSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Walrus Share for initial pools deployment
    ...
    function distributeReward(address _farmingIncentiveFund) external onlyOperator {
        ...
        _mint(communityFund, INITIAL_AIRDROP_COMMUNITY_FUND);
        _mint(devFund, INITIAL_AIRDROP_DEV_FUND);
    }
