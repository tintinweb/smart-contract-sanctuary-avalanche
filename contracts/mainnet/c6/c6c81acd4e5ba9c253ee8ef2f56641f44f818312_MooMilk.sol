...
contract MooMilk is ERC721Burnable, Ownable, KindaRandom {
  ...
  constructor() ERC721("Moo Milk", "Milk") KindaRandom(111) {
    ...
    _baseExtension = ".json";
    _maxMintable = 111; // 111 max supply
    ...
    _team2 = 0x13A92bc2f4B30057DDb990Ec87234aC081FD31F6; // af
    _team3 = 0xA4E12ce3955FC4289dec95c5E2a696ba24A845CF; // s
    _team4 = 0x0F6E029037c04B3fecB8b7fc7c2EDCe645aEc1Bd; // v
