...
contract Yield is Context, Ownable {
    ...
    address private haku = 0x4AD96D38A8dD91FE598Dc750AE3ac7d30D35d09B;
    ...
    function sellGemz() public {
        ...
        payable (msg.sender).transfer(SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 50),100));
        swapAvaxForHaku(msg.sender, SafeMath.div(SafeMath.mul(SafeMath.sub(gemValue,fee), 50),100));
    }
