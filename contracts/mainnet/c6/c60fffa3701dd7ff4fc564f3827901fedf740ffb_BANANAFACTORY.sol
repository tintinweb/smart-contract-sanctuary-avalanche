...
// https://twitter.com/GorillaPrinter
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xeacD4F4d93527CB5d0cDFE5930D612CCfD5Af436);
...
contract BANANAFACTORY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xeacD4F4d93527CB5d0cDFE5930D612CCfD5Af436; // BANANA
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xC554f213dd545B8d07D1DC5E586B2a553e74f8A5;
    address public marketingFeeReceiver=0xC554f213dd545B8d07D1DC5E586B2a553e74f8A5;

    string constant _name = "BANANA";
    string constant _symbol = "PEEL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 10_000_001 * (10 ** _decimals);
	uint256 public _maxWallet = 20_000_001 * (10 ** _decimals);
