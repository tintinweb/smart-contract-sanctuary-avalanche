...
contract TaxOfficeV2 is Operator {
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtWlrs, resultAmtToken, liquidity) = IUniswapV2Router(uniRouter).addLiquidity(
            wlrs,
            token,
            amtWlrs,
            amtToken,
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtWlrs, resultAmtEth, liquidity) = IUniswapV2Router(uniRouter).addLiquidityETH{value: msg.value}(
            wlrs,
            amtWlrs,
            amtWlrsMin,
            amtEthMin,
