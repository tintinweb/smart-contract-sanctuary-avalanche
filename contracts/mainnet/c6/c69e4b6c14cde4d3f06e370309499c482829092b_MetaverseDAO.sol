...
#MetaverseDAO features:
Total fee
6% fee auto add to the liquidity pool
2% fee auto distribute to all holders
5% fee auto Manketing
100% lp locked 2 days
add 20 AVAX + 98% token
#minieverdome fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes minieverdome!
...
contract MetaverseDAO is Context, IERC20, Ownable {
    ...
    string private _name = 'MetaverseDAO';
