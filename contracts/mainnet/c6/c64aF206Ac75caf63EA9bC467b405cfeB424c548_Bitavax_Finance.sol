...
/*
            ...
            __        __    __                                                   ______   __                                                   
        /  |      /  |  /  |                                                 /      \ /  |                                                  
        $$ |____  $$/  _$$ |_     ______   __     __  ______   __    __     /$$$$$$  |$$/  _______    ______   _______    _______   ______  
        $$      \ /  |/ $$   |   /      \ /  \   /  |/      \ /  \  /  |    $$ |_ $$/ /  |/       \  /      \ /       \  /       | /      \ 
        $$$$$$$  |$$ |$$$$$$/    $$$$$$  |$$  \ /$$/ $$$$$$  |$$  \/$$/     $$   |    $$ |$$$$$$$  | $$$$$$  |$$$$$$$  |/$$$$$$$/ /$$$$$$  |
        $$ |  $$ |$$ |  $$ | __  /    $$ | $$  /$$/  /    $$ | $$  $$<      $$$$/     $$ |$$ |  $$ | /    $$ |$$ |  $$ |$$ |      $$    $$ |
        $$ |__$$ |$$ |  $$ |/  |/$$$$$$$ |  $$ $$/  /$$$$$$$ | /$$$$  \  __ $$ |      $$ |$$ |  $$ |/$$$$$$$ |$$ |  $$ |$$ \_____ $$$$$$$$/ 
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IJoeSwapRouter(_router)
        : IJoeSwapRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        _token = msg.sender;
    }
...
contract Bitavax_Finance is ERC20Detailed, Ownable {
    ...
    uint256 public bitavaxDividendFee = 60;
    uint256 public sellFee = 30;
    uint256 public blueHole = 0;

    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(bitavaxDividendFee).add(
            blueHole
        );
    ...
    address public bitavaxDividendReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 21000000 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Bitavax Finance", "testBITAVAX", uint8(DECIMALS)) Ownable() {

        //testnet
        //router = IJoeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); 
        ...
        autoLiquidityReceiver = 0x7Bf1499f035776186b8bD6A8f2a952e529B2C209;
        treasuryReceiver = 0x7Bf1499f035776186b8bD6A8f2a952e529B2C209;   
        ...
        distributor = new DividendDistributor(0x7Bf1499f035776186b8bD6A8f2a952e529B2C209);

        

        //distributor = new DividendDistributor(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);

        bitavaxDividendReceiver = address(distributor);
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (4 * 365 days)) {
            ...
            rebaseRate = 150;
        } else if (deltaTimeFromInit >= (12 * 365 days)) {
            rebaseRate = 50;
        }
    ...
    function takeFee(
        ...
        uint256 _bitavaxDividendFee = bitavaxDividendFee;
        uint256 _liquidityFee = liquidityFee;
        uint256 _sell = 10;

        if (recipient == pair) {
            _totalFee = totalFee.add(sellFee);
            _bitavaxDividendFee = bitavaxDividendFee.add(_sell);
            blueHole = 20;
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(_bitavaxDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(bitavaxDividendFee)
            ),
            gas: 30000
        }("");
        if(success){}
        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(bitavaxDividendFee).div(treasuryFee.add(bitavaxDividendFee))
        } () {} catch {}        
    }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no BITAVAX token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WAVAX();
        router.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
