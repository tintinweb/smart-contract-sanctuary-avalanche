...
import "../Dependencies/Ownable_8.sol";
 ...
 */
contract CollateralGate is Ownable, ICollateralGate {
    ...
    function setAddresses(IveYETI _veYETI, ITroveManager _troveManager, address _AP, address _CSP, address _DP, address _SP, address _BOps) external onlyOwner {
        require(address(veYETI) == address(0));
        require(address(troveManager) == address(0));
        veYETI = _veYETI;
