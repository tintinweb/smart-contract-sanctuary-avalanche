...
contract StrategyAaveLP is StratManager, FeeManager, SlippageManager, ReentrancyGuard {
    ...
    constructor(
        ...
        native = AddressUtils.validateOneAndReturn(_native);

        dataProvider = AddressUtils.validateOneAndReturn(_dataProvider);
        lendingPool = AddressUtils.validateOneAndReturn(_lendingPool);
        incentivesController = AddressUtils.validateOneAndReturn(_incentivesController);
    ...
    function setHarvestOnDeposit(bool _harvestOnDeposit) external onlyOwner {
        ...
        emit OwnerOperation(msg.sender, "StrategyAaveLP.setHarvestOnDeposit");
    }
    ...
    function panic() external onlyOwner {
        ...
        emit OwnerOperation(msg.sender, "StrategyAaveLP.panic");
    }
    ...
    function pause() public onlyOwner {
        ...
        emit OwnerOperation(msg.sender, "StrategyAaveLP.pause");
    }
    ...
    function unpause() external onlyOwner {
        ...
        emit OwnerOperation(msg.sender, "StrategyAaveLP.unpause");
    }
    ...
    function _swapNativeToWant() internal {
        uint256 nativeBal = IERC20(native).balanceOf(address(this));
        IUniswapRouterETH(unirouter).safeSwapExactTokensForTokens(slippage, nativeBal, nativeToWantRoute, address(this), now);
    }
