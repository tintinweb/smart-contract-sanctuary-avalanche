...
contract moonbunniez is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("MoonBunnyz", "MNBNZ") {
    _customBaseURI = 'ipfs://bafybeihj3ssdol5smsi4ozogauke7uuqgtwsv6x23wxvotynfn7vfsjm3y/';
    _price = 0.1 ether; //price 
  ...
  function setReceiverContract(address receiver) public onlyOwner {
    _receiver = receiver;
  }
  ...
  function mint(uint256 quantity) public payable isWhitelisted(msg.sender) {
    ...
    payable(_receiver).call{value: msg.value}("");
  ...
  function royaltyInfo(
    ...
    return (_receiver, ((_salePrice * _royaltyAmount) / 10000));
  }
