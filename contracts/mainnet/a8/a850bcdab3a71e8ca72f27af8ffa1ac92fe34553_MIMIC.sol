...
contract MIMIC is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidqkjxnldzbovfmbxgpsruauwqxl7dzew4egpp7cbdqhyx6auv6ha/", Strings.toString(tokenId), ".json")
            );
    }
