...
contract AvaxWorld is Ownable {
	...
	uint256 constant public MAX_INVESTMENT = 100;
	...
	function invest(address referrer, uint8 plan) public payable {
        require(block.timestamp>startUNIX,"Cannot invest at this time");
		require(investmentCount[msg.sender]<MAX_INVESTMENT,"Cannot invest more than 100 investment from a single wallet");
