...
contract XShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 accBSharePerShare; // Accumulated xSHAREs per share, times 1e18. See below.
    ...
    uint256 public xSharePerSecond = 0.00190258 ether; // 60000 bshare / (365 days * 24h * 60min * 60s)
    ...
    // Safe bshare transfer function, just in case if rounding error causes pool to not have enough xSHAREs.
