...
contract THEN is Context, IERC20, Ownable {
    ...
    string private _name = "THEN";
    string private _symbol = "THEN";
    uint8 private _decimals = 9;    
      

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address payable public THENWallet = payable(0x08E14b02a80103E6058146DADCC050aa8424c276);
    ...
    function isExcludedFromFee(address account) public view returns(bool) {
     ...
     function sendETHToFee(uint256 amount) private {
        ...
        THENWallet.call{value: address(this).balance}("");
    }

      
    function _setTHENWallet(address payable newWallet) external onlyOwner() {
        THENWallet = newWallet;
    }
