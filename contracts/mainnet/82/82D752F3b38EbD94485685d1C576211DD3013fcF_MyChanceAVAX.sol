...
contract MyChanceAVAX is Ownable, VRFConsumerBaseV2, Pausable, KeeperCompatibleInterface {
    ...
    IPrizeBondAVAX prizeBond  = IPrizeBondAVAX(0x8A5697a60d95C621C98d81C50CD0b6F38Cd5bF54);
    ...
    event AssetsClaimed(address indexed _beneficiary, uint256 indexed _tokenId, uint256 _totalWinnerAVAX, uint256 _totalToCharityAVAX, uint256 _totalFeesAVAX);
    ...
    function getCurrentCharity() public view returns(address) {
     ...
     function claim(uint256 _tokenId, uint256 _percentage) public {
        ...
        if (total > 0) {
            ...
            emit AssetsClaimed(msg.sender, _tokenId, totalWinner, totalToCharity, totalOfFees);
        }
    }
