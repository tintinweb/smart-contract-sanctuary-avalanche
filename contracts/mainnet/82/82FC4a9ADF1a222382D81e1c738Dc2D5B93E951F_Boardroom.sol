...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getSubzeroPrice() external view returns (uint256) {
        return treasury.getSubzeroPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            subzero.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        subzero.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(share), "ZShare");
