...
contract FriendlyGhosts is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihs3y5pfijoqflh2sxfn6luufeblctg4i352bls7qmwc6oevhhpey/", Strings.toString(tokenId), ".json")
            );
    }
