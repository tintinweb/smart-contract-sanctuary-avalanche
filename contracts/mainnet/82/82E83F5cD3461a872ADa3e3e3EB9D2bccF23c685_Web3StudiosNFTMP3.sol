/**
 *Submitted for verification at snowtrace.io on 2023-01-24
*/
...
contract Web3StudiosNFTMP3 is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Young Barid - On My Own - NFT MP3", "YBOMOMP3") KindaRandom(5) {
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmbhVpbWKRLfD3vruVWw6tbDY59bwVC9LwZuJakKG3TEhk/';
    _customBaseExtension = '.json';
    _maxMintable = 5; // 5 max supply - PROD
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _startTime = 1674799200; //unix timestamp of start time (Fri Jan 27 2023 00:00:00 GMT-0600 (Central Standard Time))
    _maxMintPerTx = 1;
    _price = 1.0 ether;
