    ...
    */
    ...
    function _lzProcess(uint16 chainId, RouteCall memory params, bool isRedirect, bool isRedirected) internal {
        ...
        if (isRedirected) {
            ...
            lzEndpoint.send{value : messageFee}(chainId, this.getTrustedRemote(chainId), bytes(""), payable(params.user), lzConfig.zroPaymentAddress, params.adapterParams); // params.payload
            return;
        }
