...
Decentranode lets you use your nodes to buy actual NFTs that you will forever own on Opensea, that you can even resell later down the road 
- these nodes can give you back DECENTRA everyday - essentially passive farming 

we have been working for weeks on this. enjoy.

Nodes controlled by the user for the user.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
...
contract DecentraNode is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "Decentranode";
    string constant _symbol = "DECENTRA";
    ...
    address public autoLiquidityReceiver = 0xe043552C9aD0E7C324a1E76C6372F6F49754C575;
    address public marketingFeeReceiver = 0xe043552C9aD0E7C324a1E76C6372F6F49754C575;
