...
contract AvaxBridgeContract is Ownable {
    ...
    WrappedToken public awFTM;
    address payable public system = payable(0x7F74EaAf7de0E11Ba2421D10D7F9Ec648762F1F3);
    ...
    constructor() {
        ...
        WrappedToken _awFTM = new WrappedToken(
            "Apex wrapped FTM",
            "awFTM",
            18
        );
        ...
        // chainID Fantom Mainnet = 250
        _processFees[250] = 0; // transaction cost is negligible
        supportedTargetChains[250] = true;

        emit TargetChainAdded(250, block.timestamp);
    }
    ...
    function bridge(
        ...
        awFTM.burnFrom(msg.sender, _amount);
    ...
    function bridgeBack(
        ...
        if(serviceFee > 0) {
            awFTM.mint(bridgeFeesAddress, serviceFee);
        }
        awFTM.mint(_receiver, transferAmount);
