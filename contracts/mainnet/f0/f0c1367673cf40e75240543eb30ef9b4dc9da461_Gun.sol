...
contract Gun is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund) public ERC20("Gun", "GUN") {
        _mint(msg.sender, 3 ether); // mint 3 GUN for initial pools deployment
