...
contract shillyyetis is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 150; //  150 total for this contract
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 500; // 100 = 1%, 200 = 2% etc...
