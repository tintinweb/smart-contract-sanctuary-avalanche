...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0xD9FF12172803c072a36785DeFea1Aa981A6A0C18); //fudge token
    ...
    address public dev;
    address public treasury = 0x36cd24412aaF614F33BD3C5A7f859db0Befb8575;//protocol dao
    ...
    uint256 public lastDripTime = 1662735600;

    uint256 public totalAllocPoints = 0;
    uint256 public dripRate = 2000000;
