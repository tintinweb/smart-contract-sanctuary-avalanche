...
contract Titanus is ERC20Detailed, Ownable {
    ...
    string public _name = "Titanus";
    string public _symbol = "Titan";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 2500 * 10**4 * 10**DECIMALS;
    ...
    uint256 private constant MAX_SUPPLY = 2500 * 10**8 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Titanus", "Titan", uint8(DECIMALS)) Ownable() {
        ...
        auraInsuranceFundReceiver = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92;
