...
pragma solidity 0.8.13;
    ...
    contract AIDystopia is ERC721Enumerable, Ownable, IERC2981Royalties {
        using Strings for uint256;
        
        string public baseURI = "ipfs://QmRvK6zJ2sx8N4167CUBNmekNunhD7er6amRM3dhUUhpGF/";
        string public baseExtension = ".json";
        uint256 public whitelistSupply = 85;
        uint256 public publicSupply = 14;
        ...
        constructor () ERC721("Ai Dystopia", "AIDYSTOPIA") {
                _safeMint(0x66215E345cA63f100a8eb9Eb277c08210f3578BF, 1);
            ...
            function mint(uint256 amount) public {
                ...
                if (isWhitelisted(msg.sender) == true) {
                    require(block.timestamp > 1658634300);
                    require(whitelistMinted < 85, "Too late!");

                    _safeMint(_msgSender(), supply + 1);
                    hasMinted[_msgSender()] = true;
                    whitelistMinted++;
                } else {
                    require(block.timestamp > 1658635200);
                    require(publicMinted < 14, "Too late!");
