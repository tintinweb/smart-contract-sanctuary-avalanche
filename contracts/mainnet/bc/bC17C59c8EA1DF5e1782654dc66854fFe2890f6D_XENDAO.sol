...
contract XENDAO is ERC20("Xen DAO", "XD"), ReentrancyGuard {
    ...
    function getMaturationDate(uint256 _id) public view returns (uint256) {
        (, , uint256 maturation, , , ) = IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).userMints(address(contractAddress(_id)));
        return maturation;
    }

    function getMaturationDateDisposable(uint256 _id) public view returns (uint256) {
        (, , uint256 maturation, , , ) = IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).userMints(address(contractAddressDisposable(_id)));
        return maturation;
    }
...
contract XENBatchMint {
    ...
    constructor (address _owner, uint256 term) {
        owner = _owner;
        IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).claimRank(term);
    }

    function mint() external {
        IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).claimMintReward();
        IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).transfer(owner, IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).balanceOf(address(this)));
    }

    function claim(uint256 _term) external {
        require(tx.origin == owner);
        IXEN(0xC0C5AA69Dbe4d6DDdfBc89c0957686ec60F24389).claimRank(_term);
    }
}
