...
/**
 #MetaMEMO - #LIQ+#RFI+#SAFEMOON, combine together to #MetaMEMO. 
   ...
   I make this #MetaMEMO to hand over to the community.
   Create the community by yourself if you are interested.   

   Great features:
   2% fee auto add to the liquidity pool to locked when selling
   ...
   I will lock liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #MetaMEMO to the community, make sure it's 100% safe.

   I will add 10 AVAX and all the left 49% total supply to the pool
   Can you make #MetaMEMO 1000X? 
...
contract MetaMEMO is Context, IERC20 {
