...
contract Dovens is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeic4vtkragmy23ezaar4aqcvwefthdufnebi2eok27g3ovsanl6rti/", Strings.toString(tokenId), ".json")
            );
    }
