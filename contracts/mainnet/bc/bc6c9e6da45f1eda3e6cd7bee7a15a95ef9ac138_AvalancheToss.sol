...
/**
AntiDump :
      -Buy : 10% = 4% to all holder, 3% to marketing, 3% to liquidity
      -Sell : 18% = 8% to all holder, 5% to marketing, 5% to liquidity
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79); 
...
contract AvalancheToss is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79; // Thor
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avalanche Toss";
    string constant _symbol = "Avatoss";
    ...
    address public autoLiquidityReceiver=0x7cCA21b2c17fd69a63de6B0bd2D68cC0427d1dBc; //liq address
    address public marketingFeeReceiver=0x7cCA21b2c17fd69a63de6B0bd2D68cC0427d1dBc; // marketing address
