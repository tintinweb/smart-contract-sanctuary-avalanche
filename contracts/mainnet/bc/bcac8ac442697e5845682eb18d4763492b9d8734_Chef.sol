...
contract Chef is ERC721Enumerable, Ownable, Pausable {
    ...
    uint256 public constant CHEF_PRICE_WHITELIST = 1.2 ether;
    uint256 public constant CHEF_PRICE_AVAX = 1.6 ether;
    ...
    uint256 public constant SHINOBI_TYPE = 2;
     ...
     */
    constructor(Sushi _sushi, address _chefTypeOracleAddress, string memory _BASE_URI) ERC721("Sushi Game Chefs", "SUSHI-GAME-CHEF") {
