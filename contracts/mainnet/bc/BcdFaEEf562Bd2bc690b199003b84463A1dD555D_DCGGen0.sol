...
contract DCGGen0 is ERC721, IERC2981, ReentrancyGuard, Ownable {
  ...
  function mint() public nonReentrant {
    ...
    require(_isWhiteListOnly, "Allowlisted only. You need to find the keys.");
    require(_whiteList[msg.sender], "You have not completed \nthe steps needed to mint. \nYou need to find the keys");
    require(_whiteListAllocated[msg.sender] > 0, "You have exceeded your allowlist minting allocation.");
