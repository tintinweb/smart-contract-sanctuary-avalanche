...
// File: contracts/TiddyGuppyToken.sol
...
contract TiddyGuppyToken is ERC20Votes, Administrable {



    uint256 MaxTokenCap = 690690690000000000000000000;



    constructor() ERC20("TiddyGuppy", "TIDDY") ERC20Permit("TIDDY") {

          _mint(_msgSender(), 690690690000000000000000000);

    }



    // Mint amount of TIDDY to account



    function mint(address account, uint256 amount) external onlyAdmin {

        require(MaxTokenCap > (amount + totalSupply()), "ERC20: mint amount exceeds Max Token Cap allowance");
    ...
    // Burn TIDDY from account with approval
    ...
    function getMaxTokenCap() public view returns (uint256){
