...
// File: contracts/interfaces/ITundraToken.sol


pragma solidity ^0.8.0;


interface ITundraToken is IERC20 {
...
// File: contracts/TundraToken.sol
...
/**
 * @title TundraMarket Token (TUNDRA)
 * @notice
 */
contract TundraToken is ERC20, Ownable, ITundraToken {
    ...
    constructor(
        ...
        uint256 _cap
    ) ERC20("Tundra Market", "CHILL") {
        require(_cap > _premintAmount, "CHILL: Premint amount is greater than cap");
