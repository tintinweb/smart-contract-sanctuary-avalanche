...
contract Doodls is ERC721  {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 190) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeig337e5mysutk4fju3h7e4l6oyckapk2epai65na3riauwlxiwr3u/", Strings.toString(tokenId), ".json")
            );
    }
