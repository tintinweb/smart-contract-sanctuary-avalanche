...
contract HighPointFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    function swapBack() internal swapping {
        ...
        _buyFeeBalance = 0;
        _sellFeeBalance = 0;
        _gonBalances[address(this)] = _excessBuyFeeLiquidityBalance.add(_excessSellFeeLiquidityBalance);
    }
    ...
    function contractGonBalance() public view returns (uint256) {
        return _gonBalances[address(this)];
    }
    ...
    function buyFeeBalance() public view returns (uint256) {
        return _buyFeeBalance;
    }
    
    function sellFeeBalance() public view returns (uint256) {
        return _sellFeeBalance;
    }
    
    function excessBuyFeeLiquidityBalance() public view returns (uint256) {
        return _excessBuyFeeLiquidityBalance;
    }
    
    function excessSellFeeLiquidityBalance() public view returns (uint256) {
        return _excessSellFeeLiquidityBalance;
    }
