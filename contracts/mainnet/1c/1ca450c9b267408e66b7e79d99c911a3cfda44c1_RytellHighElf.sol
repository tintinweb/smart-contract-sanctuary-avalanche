...
/// @title Rytell High Elf
contract RytellHighElf is ERC721Metadata {
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell High Elf: All minted");
        require(counts_ > 0, "Rytell High Elf: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell High Elf: sale already ended"); 
        require(!paused, "Rytell High Elf: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell High Elf: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell High Elf: max supply reached");
    ...
    function pause(bool state_)
     ...
     function randomGiveaway(address[] memory winners_)
        ...
        require(
            ...
            "Rytell High Elf: overflow giveaways");
