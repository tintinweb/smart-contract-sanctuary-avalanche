...
contract SmolCars is ERC721, Ownable {
    ...
    constructor() ERC721("Smol Cars", "SmolCars") {      
        BASE_URI_EXTENDED = "ipfs://QmcqwLd1CqeqSVryues7eCrN5PKvAgKvfCi1FjofDsViM6/";
        _totalSupply = 50;
    ...
    function mintSPOT(uint256 tokenAmount) external payable returns (bool) {
        ...
        require(msg.value >= (MINT_NFT_FEE * tokenAmount), "Not enough AVAX sent.");
        require(tokenAmount <= 4, " Max limit exceed !");
