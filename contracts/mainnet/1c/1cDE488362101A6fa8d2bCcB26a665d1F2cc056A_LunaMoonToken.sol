...
contract LunaMoonToken is Context, IERC20, Ownable {
    ...
    address WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; //addr wavax
    // address WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c; // tesnet
    ...
    string private _name = "LunaMoon Token";
    string private _symbol = "LunaMoon";
    ...
    IDEXRouter router;
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _tTotal * 3 / 100000; 
    uint256 public _maxWalletToken = ( _tTotal * 3 ) / 100000; 


    constructor () {
        _rOwned[owner()] = _rTotal;

        // router = IDEXRouter(0x7E3411B04766089cFaa52DB688855356A12f05D1); //tesnet

        router = IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //trader joe router
    ...
    // Check for maxTX
    function checkTxLimit( uint256 amount, address recipient, bool isBuy) internal view {
        if ( recipient != owner() && recipient != pair && !_isExcludedFromFee[recipient]){
            if(isBuy){
              require(amount <= _maxBuyTxAmount, "TX Buy Limit Exceeded");
            } 
        }
    }
    ...
    function checkMaxWallet(address sender, address recipient, uint256 amount) internal view {
        if (!_isExcludedFromFee[recipient] && sender != owner()  && recipient != owner() && recipient != pair && recipient != _RndWalletAddress){
