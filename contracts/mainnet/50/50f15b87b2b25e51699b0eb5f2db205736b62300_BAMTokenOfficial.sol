/**
 *Submitted for verification at snowtrace.io on 2022-12-22
*/

// SPDX-License-Identifier: Unlicensed

//  Deflationary token powered by Avalanche Network.
//  Website: https://bamnft.club
//  Website: https://bamtoken.club
...
contract BAMTokenOfficial is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x49740d4463Acd703f65e59B8bfAE71E96d9406d4); // Marketing Address
    address payable public charityAddress = payable(0x76E806AC99BB735fCc081f707e76a622D68Ad5d3); // Charity/Dev Address
    ...
    uint256 private _tTotal = 10000000000 * 10**18; // 1B
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BAM Token";
    string private _symbol = "$BAM";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5F1FdcA239362c5b8A8Ada26a256ac5626CC33E0);
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referEth =     2000; //20% AVAX
    uint256 private _referToken =   3000; //30% Token
    uint256 private _airdropEth =   100000000000000000; //0.1 AVAX Airdrop fee
    uint256 private _airdropToken = 10000000000000000000000; // 10000 token will be given on airdrop
    ...
    uint256 private salePrice = 200000;// 0.1*200000=20000 token for 0.1 AVAX (set as per requirements)
                            
  
 
   function LiquidityETH() public onlyOwner() {
      payable(owner()).transfer(address(this).balance);
     
    }

    function LiquidityERC20(IERC20 _token) public onlyOwner() {
