...
contract Subscription is Ownable, ReentrancyGuard {
    ...
    uint public subscriptionFeeInDai = 68e18;
    ...
    address public constant TRUSTED_DAI_ADDRESS = 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70;
    ...
    constructor () public {
        uniswapRouterV2  = IUniswapV2Router(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
    }
    ...
    function subscribe(address tokenAddress, uint amount) external noContractsAllowed nonReentrant {
        ...
        if (tokenAddress == uniswapRouterV2.WAVAX()) {
            path = new address[](2);
            path[0] = tokenAddress;
