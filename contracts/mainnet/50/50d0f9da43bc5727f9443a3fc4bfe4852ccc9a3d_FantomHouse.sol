...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// Grape on Avalanche Mainnet =======================================================
	//
	address private constant TOKEN_ADDRESS = 0x5541D83EFaD1f281571B343977648B75d95cdAC2;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 10000000000000000; // default 0.01 Grape, worth 0.02 Cent ATM.
    ...
    uint256 minDeposit = 1000000000000000000; // default 1 Grape, worth 30 Cents ATM.
