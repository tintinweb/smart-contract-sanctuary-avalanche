...
// File contracts/BIFI/interfaces/common/0.8.0/IUniswapRouter.sol
...
// File contracts/BIFI/interfaces/traderjoe/0.8.0/IMasterChef.sol
...
contract StrategySicleDual is StratFeeManager {
    ...
    function withdraw(uint256 _amount) external payable {
        ...
        if (wantBal < _amount) {
            IPopsMasterChef(chef).withdraw(poolId, _amount - wantBal);
