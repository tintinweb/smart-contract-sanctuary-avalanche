...
// Telegram : t.me/magma_printer
// Twitter : https://twitter.com/MAGMAprinter_
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); // trader joe
        _token = msg.sender;
    }
...
contract MAGMA is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // usdc <3
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MAGMAP";
    string constant _symbol = "MAGMA";
    ...
    address public autoLiquidityReceiver=0x1bbE0c7305968aE578f77059560173901C31Af8B; //liq address
    address public marketingFeeReceiver=0x1bbE0c7305968aE578f77059560173901C31Af8B; // marketing address
    ...
    constructor () Auth(msg.sender) {
        address _router = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // trader joe
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // trader joe
