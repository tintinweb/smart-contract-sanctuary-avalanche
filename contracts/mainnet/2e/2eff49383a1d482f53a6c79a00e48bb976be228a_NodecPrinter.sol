...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8);
...
contract NodecPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x224DB37f1745a2F5D49E06a204aD6a38bA827fA8; // MIM
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x266afA73B6db46f98D7d2192935D7c9751812CcA;
    address public marketingFeeReceiver=0x266afA73B6db46f98D7d2192935D7c9751812CcA;

    string constant _name = "Nodec Printer";
