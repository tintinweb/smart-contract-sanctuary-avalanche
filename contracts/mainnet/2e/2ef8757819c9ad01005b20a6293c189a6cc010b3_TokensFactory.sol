...
contract TokensFactory{
  ...
  address public theOwner = 0x06329cE9F8a5F25063b26e56951130Bc424397e9;
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    constructor (address cOwner, address marketingWallet, string memory name, string memory symbol, uint256 totalSupply, uint256 taxFee) Ownable(cOwner) {
        ...
        // uniswap
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
