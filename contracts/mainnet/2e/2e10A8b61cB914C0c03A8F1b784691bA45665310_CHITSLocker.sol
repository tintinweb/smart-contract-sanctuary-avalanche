...
contract CHITSLocker is ReentrancyGuard {
    uint256 _releaseAmount = 500000 * 10**18; // 500k CHITS
    ...
    constructor(address chitsAddress) {
        _bc = IBCash(chitsAddress);
    }
