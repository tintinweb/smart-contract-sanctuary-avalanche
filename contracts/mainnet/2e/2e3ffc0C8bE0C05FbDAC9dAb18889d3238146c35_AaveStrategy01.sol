...
contract AaveStrategy01 is Funding {
    ...
    // ETH
    address public AAVE_LENDING_POOL = 0x4F01AeD16D97E3aB5ab2B501154DC9bb0F1A5A2C; // PROXY
    address public AAVE_STAKED_TOKEN = 0x01D83Fe6A10D2f2B7AF17034343746188272cAc9; // MATIC STAKE
    address public AAVE_DATA_PROVIDER = 0x65285E9dfab318f57051ab2b139ccCf232945451; // AaveProtocolDataProvider

    IAaveProtocolDataProvider AaveDataProvider = IAaveProtocolDataProvider(AAVE_DATA_PROVIDER);

    IERC20 public WMATIC = IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // WAVAX

    string public AAVE_BASE_COIN;

    /* ADMIN IS UExecutor */
    constructor(string memory _AAVE_BASE_COIN) Admin(0x520aDc06455a663D17f7a8F10c7a74956AdaA435) {
    ...
    function _init_aave() private {
        _aave_add_coin(
            ...
            0x686bEF2417b6Dc32C50a3cBfbCC3bb60E1e9a15D, // amWBTC
            0x2dc0E35eC3Ab070B8a175C829e23650Ee604a9eB, // variableDebtmWBTC
            6000,
            7500
        );
        _aave_add_coin(
            ...
            0x47AFa96Cdc9fAb46904A55a6ad4bf6660B53c38a, // amDAI
            0x1852DC24d1a8956a0B356AA18eDe954c7a0Ca5ae, // variableDebtmDAI
            7500,
            8000
        );
        _aave_add_coin(
            ...
            0x46A51127C3ce23fb7AB1DE06226147F446e4a857, // amUSDC
            0x848c080d2700CBE1B894a3374AD5E887E5cCb89c, // variableDebtmUSDC
            7500,
            8000
        );
        _aave_add_coin(
