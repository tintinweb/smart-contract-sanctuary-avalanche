 ...
 *   - Basic interest rate: +3% every 24 hours - only for new deposits
...
contract cryptoPumpAvaxV1 {
	...
	uint256 constant public PERCENT_STEP = 30;
	...
	constructor(address payable marketing, address payable project, uint256 startDate)  {
		...
		startUNIX = startDate; // 1649098800 // Date and time (GMT): Monday, 4 April 2022 19:00:00
