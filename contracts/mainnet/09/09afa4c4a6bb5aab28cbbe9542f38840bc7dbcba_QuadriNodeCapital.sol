...
/* WELCOME TO QUADRI NODE CAPITAL $QNC

OUR TELEGRAM IS PRIVATE FOR 10 MINUTES POST LAUNCH

WE HAVE 15 DIAMOND HAND CHADS IN OUR TELEGRAM

T.ME/QUADRINODECAPITAL */
...
contract QuadriNodeCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Quadri Node Capital";
    string constant _symbol = "QNC";
