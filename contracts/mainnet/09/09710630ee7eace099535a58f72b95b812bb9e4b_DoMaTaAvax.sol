...
/** DoMaTaAvax REWARDS TIME
    STEALTH LAUNCH
    https://t.me/DoMaTaAvax
    https://twitter.com/DoMaTa_Avax
...
contract DoMaTaAvax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DoMaTa Avax REWARDS";
    string constant _symbol = "DTA";
