...
contract StratX2_PCS is StratX2 {
    constructor(
        ...
        bool _isAutoComp,
        address[] memory _earnedToSISHIPath,
        ...
        sishiFarmAddress = _addresses[2];
        SISHIAddress = _addresses[3];
        ...
        earnedToSISHIPath = _earnedToSISHIPath;
        ...
        transferOwnership(sishiFarmAddress);
    }
}
...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-SISHI staking vault.
    ...
    address public sishiFarmAddress;
    address public SISHIAddress;
    ...
    address[] public earnedToSISHIPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(sishiFarmAddress, _wantAmt);
