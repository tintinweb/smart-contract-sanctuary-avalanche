...
// File: contracts/MultiverseSuperPowersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract MultiverseSuperPowersContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Multiverse Super Powers";
    string public symbol = "SuperPower";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/OnNf96glMb6KRgOHC987/contract-metadata";
  }
