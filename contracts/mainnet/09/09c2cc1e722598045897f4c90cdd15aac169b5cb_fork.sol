...
contract fork is ERC20Detailed, Ownable {
    ...
    uint256 public forkInsuranceFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public firePitFee = 25;
    uint256 public totalFee = 
        liquidityFee.add(treasuryFee).add(forkInsuranceFundFee).add(firePitFee);
    ...
    address public forkInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("fork", "fork", uint8(DECIMALS)) {
        router = IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //Sushi 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506 // Cake 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        pairAddress = pair;
        autoLiquidityReceiver = 0x9B7E9e226aA13d4526d51585359d683B5463D7B6;
        treasuryReceiver = 0x9B7E9e226aA13d4526d51585359d683B5463D7B6;
        forkInsuranceFundReceiver = 0x9B7E9e226aA13d4526d51585359d683B5463D7B6;
        firePit = 0x9B7E9e226aA13d4526d51585359d683B5463D7B6;
        ...
        internal 
    {
        ...
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
        _lastRebasedTime = _lastRebasedTime + epoch;
        pairContract.sync();
        ...
        returns (uint256)
    {
        ...
        uint256 amountToSwap = gonAmount
            .mul(_treasuryFee.add(forkInsuranceFundFee))
            .div(feeDenominator)
        ...
        
        {
            ...
            uint256 amountETHToTreasury = amountETHToTreasuryAndSIF
                .mul(_treasuryFee)
                .div(_treasuryFee.add(forkInsuranceFundFee));
            uint256 amountETHToSIF = amountETHToTreasuryAndSIF
                .mul(forkInsuranceFundFee)
                .div(_treasuryFee.add(forkInsuranceFundFee));
            ...
            (success, ) = payable(forkInsuranceFundReceiver).call{
    ...
    function setFeeReceivers(
        ...
        address _forkInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        forkInsuranceFundReceiver = _forkInsuranceFundReceiver;
        firePit = _firePit;
    }
