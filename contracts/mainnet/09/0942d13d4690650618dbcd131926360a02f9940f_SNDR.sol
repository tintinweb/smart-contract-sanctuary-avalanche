...
contract SNDR {
	...
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 1M = 100K
	uint256 constant private MIN_FREEZE_AMOUNT = 0; // 0

	string constant public name = "SNDR";
	string constant public symbol = "SNDR";
