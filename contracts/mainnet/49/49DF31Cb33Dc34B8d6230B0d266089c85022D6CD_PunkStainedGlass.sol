...
contract PunkStainedGlass is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihb5f2xzk4qqdu325ggf5dq6kkjkz7oulwxvi3s4pywkpq2rlzq4a/", Strings.toString(tokenId), ".json")
            );
    }
