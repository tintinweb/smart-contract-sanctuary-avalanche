...
contract ShareTokenRewardPool is ContractGuard, Initializable {
    ...
    uint256 public constant TOTAL_USER_REWARDS = 552500 ether; // (85% of 700000)

    uint256 public constant DAO_FUND_REWARDS = 48750 ether;
    uint256 public constant shareTokenPerSecondForDaoFund = 0.001546 ether;
    uint256 lastDaoFundRewardTime;
    uint256 public constant DEV_FUND_REWARDS = 48750 ether;
    uint256 public constant shareTokenPerSecondForDevFund = 0.001546 ether;
    ...
    function __Upgradeable_Init(
        ...
        if (_token != address(0)) shareToken = IERC20Upgradeable(_token);
        totalAllocPoint = 0;
