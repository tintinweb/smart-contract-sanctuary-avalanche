...
contract SPVnet is ERC20Permit, Ownable {
    ...
    constructor() ERC20("SPVnet", "sPVnet", 9) ERC20Permit() {
    ...
    /**
        @notice increases SPVnet supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SPVnet
