...
/*
    ...
    ____                                 __  __                       ____                                
   / __ \ ____  _      __ ___   _____   / / / /____   __  __ _____   / __ \ ____ _ _____ _____ ___   _____
  / /_/ // __ \| | /| / // _ \ / ___/  / /_/ // __ \ / / / // ___/  / /_/ // __ `// ___// ___// _ \ / ___/
 / ____// /_/ /| |/ |/ //  __// /     / __  // /_/ // /_/ // /     / ____// /_/ /(__  )(__  )/  __/(__  ) 
/_/     \____/ |__/|__/ \___//_/     /_/ /_/ \____/ \__,_//_/     /_/     \__,_//____//____/ \___//____/  
                                                                                                          
                                                                                                      
*/

contract PowerHourPasses is ERC721URIStorage, Ownable {
    ...
    constructor(
        ...
        address royaltyAddr
    ) ERC721("Power Hour Passes", "PWRHR") {
    ...
    function setMintDone(bool status) public onlyOwner {
        mintingDone = status;
    }

    function mint(uint256 quantity) public payable {
        require(_mintActive, "Minting is not active.");
        require(mintingDone == false, "Minting is Finished.");
    ...
    function _internalMint(address recipient) private {
        ...
        require(
            ...
            "Public mint is finished ot mint amount is over the limit"
        );
    ...
    function splitFunds(uint256 mintValue) private {
        uint256 amountA = (mintValue * 40) / 100;
        uint256 amountB = (mintValue * 30) / 100;
        uint256 amountC = (mintValue * 30) / 100;
        payable(walletFundsA).transfer(amountA);
        payable(walletFundsB).transfer(amountB);
        payable(walletFundsC).transfer(amountC);
    }

    function setNFTsTransferWallets(address _walletFundsA, address _walletFundsB ,address _walletFundsC)
        external
        onlyOwner
    {
        walletFundsA = _walletFundsA;
    ...
    function updateMintPriceByWeiUnit(uint256 price) public onlyOwner {
        _price = price;
    }
