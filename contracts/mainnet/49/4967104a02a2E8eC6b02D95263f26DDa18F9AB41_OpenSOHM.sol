...
contract OpenSOHM is IOpenSOHM, ERC20Permit {
    /* ========== DEPENDENCIES ========== */
    ...
    mapping(address => uint256) private _balances; // OVERRIDE
    uint256 private _totalSupply; // OVERRIDE
    ...
    IOpenGOHM public gOHM; // additional staked supply (governance token)

    Rebase[] public rebases; // past rebase data

    uint256 private constant MAX_UINT256 = type(uint256).max;
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10_000_000 * 10**9; // changed from 5_000_000
    ...
    // OVERRIDES DUE TO OVERRIDING _totalSupply, _balances:
