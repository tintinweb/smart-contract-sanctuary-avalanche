...
Website:
https://flokiavoge.com/

Telegram:
https://t.me/flokiavoge
...
contract FlokiavogeDividendTracker is IDividendDistributor {
...
contract Flokiavoge is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0xD1612668B83021D684366421bAcdfbfF7c0D4895); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    FlokiavogeDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new FlokiavogeDividendTracker();
