...
contract MasterChef is Ownable {
    ...
    function setTripPerBlockEmissionRate(uint256 _tripPerBlock) public onlyOwner {
        // This MUST be done or pool rewards will be calculated with new trip per block.
