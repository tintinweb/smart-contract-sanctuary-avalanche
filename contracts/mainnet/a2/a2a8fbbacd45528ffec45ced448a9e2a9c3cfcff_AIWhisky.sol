...
pragma solidity 0.8.13;
    ...
    contract AIWhisky is ERC721Enumerable, Ownable, IERC2981Royalties {
        using Strings for uint256;
        
        string public baseURI = "ipfs://QmYU6CUCg4TZFjnsxzdP97wfv4nMQVxdLsZnQbaPnKDxwA/";
        ...
        constructor () ERC721("Ai Whisky", "AIWHISKY") {
                _safeMint(_msgSender(), 1);
                setRoyalties(0x66215E345cA63f100a8eb9Eb277c08210f3578BF, 1000);
            }
            
            function mint(uint256 amount) public {
                uint256 supply = totalSupply();
                require(supply + 1 <= maxSupply, "Minted out!");
                require(amount == 1, "You can only mint 1!");
                require(hasMinted[_msgSender()] == false, "You have already minted.");
                require(block.timestamp > 1657512000, "It's early!");
