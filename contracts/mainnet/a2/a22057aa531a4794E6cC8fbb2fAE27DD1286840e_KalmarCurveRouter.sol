...
// File: contracts/interfaces/IKalmarTradingRoute.sol
...
// File: contracts/routes/KalmarCurveRouter.sol
...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve1
    ICurveRouterV2 public constant curvePool = ICurveRouterV2(0x58e57cA18B7A47112b877E31929798Cd3D703b0f);
    IERC20 public constant dai = IERC20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70); // 0
    IERC20 public constant usdc = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); // 1
    IERC20 public constant usdt = IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118); // 2
    IERC20 public constant wbtc = IERC20(0x50b7545627a5162F82A992c33b87aDc75187B218); // 3
    IERC20 public constant weth = IERC20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // 4
