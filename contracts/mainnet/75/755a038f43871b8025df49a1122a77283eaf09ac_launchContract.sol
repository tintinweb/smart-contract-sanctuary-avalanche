...
contract launchContract is Ownable {
    ...
    uint256 public startBlock = 11672134 ; // set start block
    uint256 public minimum_deposit = 1*10**6; //minimum deposit
    uint256 public endBlock =   116721600 ;  // set end block
    ...
    uint256 private firstMonthBlockPeriod = 0; //30days block = 836129.0323, we use 864000
    uint256 private unlockblockperiod = 0; //15days block = 418064.5161, we use 432000
    ...
    uint256 public lastRewardBlock = 11672134;  // should be same as start block at the beginning
