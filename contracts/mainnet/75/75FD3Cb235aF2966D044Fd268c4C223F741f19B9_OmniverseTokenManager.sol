...
contract OmniverseTokenManager is Ownable {
    ...
    address public avaxPair;
    address public stablePair;
        ...
        returns (address[] memory pairs)
    {
        ...
        avaxPair = 0xab563dEab77362A7F393Bd2f0909c176ae7AF67a;
        stablePair = 0xB1532CB9Fb365255Ab76424037565A2f6b0CB9f8;
        ...
        omniversePairs.push(avaxPair);
        omniversePairs.push(stablePair);
        pairsCreated = true;
