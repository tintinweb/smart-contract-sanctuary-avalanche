...
contract OnChainNFTContract is ERC721Base {
        ...
        )
    {
        ...
        return (patient, description, medication, dosage, quantity);
    }

    function mintNFT(address _to) public {
        // _safeMint(_to, 1, s_tokenCounter);
        _safeMint(_to, 1);
        s_tokenCounter = s_tokenCounter + 1;
    }
    ...
    function tokenURI(
        ...
        parts[
            0
        ] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><style>.base { fill: black; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="#b3ccff" /><text x="10" y="20" class="base">';
        ...
        parts[3] = getDescription();

        parts[4] = '</text><text x="10" y="60" class="base">';

        parts[6] = getMedication();
        ...
        //         string(
        //             abi.encodePacked(
        //                 '{"name": "Unique Rx Number: ',
        //                 toString(tokenId),
        //                 '", "description": "OnChain Rx Service 2023", "image": "data:image/svg+xml;base64,',
    ...
    function getPatient() public view returns (string memory) {
        // return patient;
        string memory patientTitle = "Patient: ";
        return string(abi.encodePacked(patientTitle, patient));
    }

    function getDescription() public view returns (string memory) {
        // return description;
        string memory descriptionTitle = "sig: ";
        return string(abi.encodePacked(descriptionTitle, description));
    }

    function getMedication() public view returns (string memory) {
        // return medication;
        string memory medicationTitle = "Medication: ";
        return
            string(
                abi.encodePacked(medicationTitle, medication, dosage, quantity)
            );
    }

    // function getDosage() public view returns (string memory) {
    //     return dosage;
    //     string memory dosageTitle = "Dosage: ";
    //     return string(abi.encodePacked(dosageTitle, dosage));
    // }

    // function getQuantity() public view returns (string memory) {
    //     return quantity;
    //     string memory quantityTitle = "Qty: ";
    //     return string(abi.encodePacked(quantityTitle, quantity));
    // }

    function getPatientInput() public view returns (string memory) {
        return patient;
    }

    function getDescriptionInput() public view returns (string memory) {
        return description;
    }

    function getMedicationInput() public view returns (string memory) {
        return medication;
    }

    function getDosageInput() public view returns (string memory) {
        return dosage;
    }

    function getQuantityInput() public view returns (string memory) {
        return quantity;
    }
