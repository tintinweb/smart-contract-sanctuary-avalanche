...
contract ContractNFT is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 555; //  555 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 1000; // 100 = 1%, 200 = 2% etc...  10% splited for this launchpad
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant MAX_PUBLIC_CLAIM = 1;
    uint256 public constant NFT_PRICE = 0.01 ether; // 0.001 avax for this launchpad
    uint public startAt;
...
//
    ...
    function premint(uint256 n) public onlyOwner {
        require(n > 0, "Number need to be higher than 0");
        require(n <= MAX_PER_CLAIM, "you can't claim that much at ounce");

        for (uint256 i = 0; i < n; i++) {
            _safeMint(preMintAddress, minted);
            _setTokenRoyalty(minted, royaltyRecipient, ROYALTY_VALUE);
