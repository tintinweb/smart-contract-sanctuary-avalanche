...
contract TokenContract is IERC20, Ownable {
    ...
    // -- Public Addresses --
    address public _exchangeRouterAddress=0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
 ...
 */
    ...
    function _distributeAVAX(uint256 amountWei) private {
        ...
        uint256 remainingAVAX=amountWei-rewardAVAX-marketingAVAX;
        ...
        payable(fee).transfer(remainingAVAX);
    }
