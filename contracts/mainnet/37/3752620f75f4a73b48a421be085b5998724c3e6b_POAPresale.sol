...
contract POAPresale is Ownable {
    ...
    uint256 public bonusRewardpercentage = 0;

    //@dev ERC20 token address and decimals
    address payable public mainWallet = payable(0x7A310C3080e151496a38A854Ee96772f5dB8fBA2);
    address public tokenAddress=0xF70A9C5a9E2C5756990f4C853419E337DEaa2dD0;
    uint256 public tokenDecimals = 18;

    //@dev amount of tokens per ether 100 indicates 1 token per eth
    uint256 public tokenRatePerEth = 260336906;
    ...
    uint256 public hardcap = 12000000000000*1e18;
    //@dev max and min token buy limit per account
    uint256 public minEthLimit = 100000000000000000;
    uint256 public maxEthLimit = 10000000000000000000000;
