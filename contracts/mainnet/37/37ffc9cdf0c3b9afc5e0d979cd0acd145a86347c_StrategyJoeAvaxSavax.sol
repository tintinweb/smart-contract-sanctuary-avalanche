...
// File contracts/strategies/traderJoe/strategy-joe-avax-savax.sol
...
contract StrategyJoeAvaxSavax is StrategyJoeRushFarmBase {
    ...
    function harvest() public override onlyBenevolent {
        ...
        /// @notice Check token balances, calculate and take fees for each token, then update balances
