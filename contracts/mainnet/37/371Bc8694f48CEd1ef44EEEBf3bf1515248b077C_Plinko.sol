...
contract Plinko is GameBase, GameBet, GameChainlink {
    ...
    constructor(
        ...
        bucketProbabilities[8] = [7508, 57511, 218415, 499997, 781585, 942489, 992492, 1000000];
        ...
        bucketProbabilities[10] = [2039, 15505, 117503, 270500, 499996, 729500, 882497, 984495, 997961, 1000000];
