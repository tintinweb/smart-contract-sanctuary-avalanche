...
contract MetaverseVirtuaLife is Context, ERC20 {
     ...
     */
    constructor() ERC20("MetaverseVirtuaLife", "MVRLToken") {
        /**
         * @dev first and final minting of tokens to owner wallet
         * no new minting in the future will be ever possible again
         */
        _mint(_msgSender(), 1111111111 * 10 ** decimals());
    }

    /**
     * @dev anyone can burn the token, token will be transferred to dead wallet
     */
