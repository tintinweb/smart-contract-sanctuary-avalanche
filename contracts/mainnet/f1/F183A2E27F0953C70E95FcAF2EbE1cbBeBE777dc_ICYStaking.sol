...
contract ICYStaking is Ownable {
    ...
    constructor(IBEP20 _stakeToken, IBEP20 _weth) {
        ...
        WETH = IBEP20(_weth);
        initRewards();
        AVAX = IBEP20(0x79f62b9A045F14aB525d54a6b22D7600E484d111);
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        AvaxWethPairAddress = JoeLPToken(0x9627773521A71c9fB45933857a589625F0220255);
        ICYAvaxPairAddress = JoeLPToken(0x936a693BE119AfE8e3cd9AB4E721b8d2Aa61ad65);
    }
