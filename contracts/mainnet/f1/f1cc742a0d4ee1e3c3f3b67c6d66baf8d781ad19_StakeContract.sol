...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 13740851 ; // set start block
    uint256 public minimum_deposit = 1; //minimum deposit
    uint256 public endBlock =   99999999999 ;  // set end block
    uint256 public rewardperblock = 0.0015*10**18; // set block reward
    uint256 private unlockblockperiod = 0; 
    address public rewardaddress = 0xA33fAc40f62B7Aa975d8835EAa8a4df8b74161bd;  //reward
    address public stakeaddress = 0x29488375275eBB2dFB09C1E5D6119D677606da7B;   //staked token
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 13740851;  // set start block/*  */
    ...
    function changeEndBlock(uint256 _end) public updatePool onlyOwner {
            require(changed == false, "Can only change once");
            require(block.number < _end, "Cannot set lower than current block");
            endBlock = _end;
            changed = true;
        }
    
    function ownerToogleChanged(bool toogle) public onlyOwner {
        changed = toogle;
        }
