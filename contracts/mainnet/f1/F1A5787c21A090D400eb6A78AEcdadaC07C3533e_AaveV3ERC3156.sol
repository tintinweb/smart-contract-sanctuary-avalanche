...
import "../interfaces/aave/v3/library/types/DataTypes.sol";

/**
 * @author Alberto Cuesta Cañada
 * @dev ERC-3156 wrapper for Aave flash loans.
 */
contract AaveV3ERC3156 is IERC3156FlashLender {
    using SafeERC20 for IERC20;

    bytes32 public constant CALLBACK_SUCCESS =
        keccak256("ERC3156FlashBorrower.onFlashLoan");
    ILendingPoolV3 public lendingPool = ILendingPoolV3(0x794a61358D6845594F94dc1DB02A252b5b4814aD);
        ...
        returns (uint256)
    {
        ...
        return
            (amount * uint256(lendingPool.FLASHLOAN_PREMIUM_TOTAL())) / 10000; // lendingPool.FLASHLOAN_PREMIUM_TOTAL()
    }
    ...
    function executeOperation(
        ...
        require(
            ...
            "Callbacks only allowed from Lending Pool"
        );
        require(
            sender == address(this),
            "Callbacks only initiated from this contract"
        );
        ...
        IERC20(token).safeApprove(address(lendingPool), amount + fee);
