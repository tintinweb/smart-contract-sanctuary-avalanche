...
contract AINU is ERC20, Ownable {
    ...
    constructor() ERC20("Amazon Inu", "AINU") {
        ...
        marketingWallet = address(0x30467e8E915104878103a47f1beDb6B0600c5257); // AINU Marketing Wallet
        devWallet = address(0x30467e8E915104878103a47f1beDb6B0600c5257); // Dev Wallet
