...
contract AvaGoats is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifhgkbrjuvlqoygpenmpaubueppzfm3fo5nc72cvzihjieya5z7va/", Strings.toString(tokenId), ".json")
            );
    }
