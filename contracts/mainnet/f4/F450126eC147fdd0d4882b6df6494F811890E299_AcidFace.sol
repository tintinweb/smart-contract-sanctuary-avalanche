...
contract AcidFace is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 333; //  333 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 1500; // 100 = 1%, 200 = 2% etc...  
    ...
    uint256 public constant limitPreMint = 50;
