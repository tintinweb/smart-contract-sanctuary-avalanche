...
contract SmoelGUME is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihiljcz6qnu3im3t7h7saekobvvbnmzp2ctbedrfgqoyxgwv47uze/", Strings.toString(tokenId), ".json")
            );
    }
