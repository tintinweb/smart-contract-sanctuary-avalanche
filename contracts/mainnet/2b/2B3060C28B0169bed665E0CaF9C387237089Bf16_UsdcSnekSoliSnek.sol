...
// File contracts/UsdcSnekSoliSnek.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract UsdcSnekSoliSnek  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        uint256 t1Bal = IERC20(snek).balanceOf(address(this));
        uint256 t2Bal = IERC20(usdc).balanceOf(address(this));

        ISoliSnekRouter(router).addLiquidity(snek, usdc, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
