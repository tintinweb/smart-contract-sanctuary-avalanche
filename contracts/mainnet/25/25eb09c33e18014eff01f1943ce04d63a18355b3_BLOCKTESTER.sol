...
contract BLOCKTESTER is IERC20 {
    ...
    string constant private _name = "Blocktest";
    string constant private _symbol = "BLCKTST";
    ...
    address payable public marketingWallet = payable(0x04853Ccd547e51DC2C597BcA939cBed9DA6f833E);
    address payable private rewardsPool = payable(0x0000000000000000000000000000000000000000);
    address payable private treasuryWallet = payable(0x04853Ccd547e51DC2C597BcA939cBed9DA6f833E);
    ...
    IERC20 mansion = IERC20(0x0000000000000000000000000000000000000000);
...
//===============================================================================================================
    ...
    function enableTrading(bool toggle) public onlyOwner{
        if(!toggle)
        {
