    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x1f2f7c7394A7C9776C8Cf73FcA0936feec8F6B85;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("DoodleLanterns", "DODLTN") ClampedRandomizer(maxSupply) {     
