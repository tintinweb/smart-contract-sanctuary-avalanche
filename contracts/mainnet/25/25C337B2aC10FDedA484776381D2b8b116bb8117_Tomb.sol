...
contract Tomb is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 4500 ether;
    // Initial distribution for the day 0-2 TOMB-WFTM LP -> TOMB pool
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 35000 ether;
    // Distribution for airdrops wallet
    uint256 public constant INITIAL_AIRDROP_WALLET_DISTRIBUTION = 0 ether;
    // Initial minted for liquidity
    uint256 public constant INITIAL_MINTED = 1 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("DEMO", "DEMO") {
        ...
        _mint(msg.sender, INITIAL_MINTED);
        taxRate = _taxRate;
