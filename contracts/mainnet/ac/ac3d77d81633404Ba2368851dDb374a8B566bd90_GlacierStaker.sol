...
contract GlacierStaker is DyVARAManager, ReentrancyGuardUpgradeable, ERC20Upgradeable {
  using SafeERC20Upgradeable for IERC20Upgradeable;

  uint256 public constant MAX_TIME = 12 * 7 * 86400;
  uint256 public constant MAX_LOCK = (12 weeks);
