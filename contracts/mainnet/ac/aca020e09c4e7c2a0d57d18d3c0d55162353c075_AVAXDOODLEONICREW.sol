    ...
    ClampedRandomizer
{
    ...
    uint256 public maxPerPerson = 350;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("AVAX Doodle Oni Crew", "ADOC") ClampedRandomizer(maxSupply) {     
