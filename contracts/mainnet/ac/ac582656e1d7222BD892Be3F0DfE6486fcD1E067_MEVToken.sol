...
contract MEVToken {
    ...
    uint256 public constant MAX_TRANSFER_WITHOUT_PENALTY = 1e16; // 0.1% of total supply
   ...
   constructor(address payable penaltyFundAddress) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (!_whitelist[sender] && !_whitelist[recipient] && amount > MAX_TRANSFER_WITHOUT_PENALTY) {
            uint256 penaltyAmount = amount.mul(penaltyRate).div(100);
