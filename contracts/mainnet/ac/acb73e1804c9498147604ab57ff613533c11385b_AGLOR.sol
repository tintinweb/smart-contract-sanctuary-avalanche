...
contract AGLOR is ERC721 {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 4) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibiusuzyjxwob7rkd7eoygu6uc6el6o5ksrzinapuakaoyibmqyuy/", Strings.toString(tokenId), ".json")
            );
    }
