...
import "./BaseUpgradeableMinterPauserCappedERC20.sol";

contract PGX is BaseUpgradeableMinterPauserCappedERC20 {
    /* Constants */
    string private constant NAME = "PolyientX Games";
    string private constant SYMBOL = "PGX";
    uint8 private constant DECIMAL = 18;
    uint256 private constant CAP = 10_000_000_000 * (10**DECIMAL);
    bytes32 public constant TOKEN_PAUSED = "TokenPaused";

    /* Constructor */
    function initialize(address settingsAddress) public override initializer {
        super.initialize(settingsAddress, NAME, SYMBOL, CAP);
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            _getPlatformSettingsValue(address(this), TOKEN_PAUSED) == 0,
            "TOKEN_PAUSED"
        );
    }
}
 ...
 */
contract BaseUpgradeableMinterPauserCappedERC20 is
    BaseUpgradeable,
    Initializable,
    ContextUpgradeable,
    ...
    ERC20CappedUpgradeable
{
    function initialize(
        ...
        __ERC20PresetPauser_init(settingsAddress, name, symbol, cap);
    }

    function __ERC20PresetPauser_init(
        address settingsAddress,
        string memory name,
        string memory symbol,
        uint256 cap
    ...
    /*
     * 50-slot gap to increase the contract's storage by that amount (provided we also remove the same slots from the gap) with no clashing issues.
     * More info here:
     * https://github.com/OpenZeppelin/openzeppelin-contracts-upgradeable/issues/47
     */
...
abstract contract BaseUpgradeable {
    ...
    function initialize(address settingsAddress) public virtual {
