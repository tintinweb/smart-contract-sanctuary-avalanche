...
contract MINDv2 is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _joeRouter, address _treasury, address[] memory addresses, 
        ...
        bool _swapAndLiquifyEnabled) public initializer 
    {
        ...
        uniswapV2Router = IJoeRouter02(_joeRouter);
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        //sell
        if (!isExcludedFromFee[from] && (to == address(uniswapV2Router) || to == address(uniswapV2Pair))) {
        ...
        //buy
        if (!isExcludedFromFee[to] && (from == address(uniswapV2Router) || from == address(uniswapV2Pair))) {
            fee = buyFee;
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        ...
        address _uniswapV2Pair = IJoeFactory(uniswapV2Router.factory()).getPair(address(this), uniswapV2Router.WAVAX());
        if (_uniswapV2Pair == address(0)) {
            uniswapV2Pair = IJoeFactory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WAVAX());
        } else {
