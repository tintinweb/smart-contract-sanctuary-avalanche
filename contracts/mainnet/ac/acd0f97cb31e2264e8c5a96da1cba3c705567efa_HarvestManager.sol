...
contract HarvestManager {
    ...
    /// @notice The owner of the contract. It can be changed by calling changeOwner() function.
    address public owner;
    /// @notice The address of the active swap strategy. It can be changed by calling updateSwapStrategy() function.
    address public activeSwapStrategyAddress;
    /// @notice The address of the active distributing strategy. It can be changed by calling updateDistributeStrategy() function.
    ...
    /// @notice The function to update the address of the active swap strategy.
