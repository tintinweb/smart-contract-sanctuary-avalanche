...
contract MemoExchange is IMemoExchabge {
    ...
    function exchangeForAssets(address account, uint256 amount, bytes32[] calldata merkleProof) external notTimedOut returns (uint256 USDCtoReceive, uint256 BSGGtoReceive) {
