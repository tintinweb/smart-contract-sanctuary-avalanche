...
contract SaitaMAX is Context, IERC20, Ownable {
    ...
    string private _name = "SAITAMAX";
    string private _symbol = "STMX";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x0aF0932b1d0Dd60De4FeceDa38Fb14bB6D3d8e70);
    address payable public devWalletAddress = payable(0xC43fF0b351676E8C0F47E6Fa49269B15275B4e83);
    address payable public teamWalletAddress =  payable(0xC43fF0b351676E8C0F47E6Fa49269B15275B4e83);
