...
contract SalesFactory is Ownable {
    ...
    function deploySale(address sellingTokenAddress) external onlyOwner {
        ...
        Sale sale = new Sale(msg.sender, _signatory, address(stakingAddress), address(farmLensV2Address), sellingTokenAddress, _appendStrings(sellingTokenSymbol, " Avata Sale"), _appendStrings("iAVAT-", sellingTokenSymbol));
