...
interface IERC2612Permit {
     ...
     *
     * ISCATORTANT: The same issues {IERC20-approve} has related to transaction
...
contract xSCAT is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked SnowCat", "xSCAT", 9) ERC20Permit() {
    ...
    /**
        @notice increases xSCAT supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess xSCAT
