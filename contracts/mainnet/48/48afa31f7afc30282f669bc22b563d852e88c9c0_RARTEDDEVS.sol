...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 0.00000000001 * (10 ** 18);
...
contract RARTEDDEVS is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xa55fE5d37a5226028f1d14C28B69FB0510713207;
    address public marketingFeeReceiver=0xa55fE5d37a5226028f1d14C28B69FB0510713207;

    string constant _name = "RARTED DEVS";
    string constant _symbol = "DEVSlol";
