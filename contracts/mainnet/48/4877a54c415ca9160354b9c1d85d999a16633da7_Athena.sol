...
Athena : Mentor and Ally of Kratos

Athena is a Project Launched Under Kratos Inu Launchpad. 100% Safe, Rug Free & Organic Projects.

Telegram : https://t.me/KratosInuAvax
Discord : https://discord.gg/PNmuUwDS
Twitter : https://twitter.com/KratosInu
Website : https://wwww.kratos-inu.com/launchpad

AntiDump :
      -Buy : 4% to all holder, 2% to marketing, 2% to liquidity
      -Sell : 16% = 8% to all holder, 4% to marketing, 4% to liquidity

AntiWhale :
      -1% max buy TRX (for first 30 minutes, will slowly be increased)
      -1% max Wallet (for first 30 mintues, will slowly be increased)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x3a3d8628D095A897DaADDfe37F882871cE6D3036); 
...
contract Athena is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x3a3d8628D095A897DaADDfe37F882871cE6D3036; // Kratos
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ATHENA";
    string constant _symbol = "ATHENA";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); 
    uint256 public _maxWallet = _totalSupply.div(100);
    ...
    address public autoLiquidityReceiver=0xfcfD991c941c2797BAA09dD4e123B2085bE05dC8; //liq address
    address public marketingFeeReceiver=0xfcfD991c941c2797BAA09dD4e123B2085bE05dC8; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 500; // 0.25%
    bool inSwap;
