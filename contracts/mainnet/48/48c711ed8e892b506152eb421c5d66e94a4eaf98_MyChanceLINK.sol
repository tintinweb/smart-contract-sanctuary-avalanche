...
// File: MyChance/January/MyChanceLink/RandomRequester.sol
...
// File: MyChance/January/MyChanceLink/DataTypes.sol
...
// File: MyChance/January/MyChanceLink/IPoolAddressesProvider.sol
...
// File: MyChance/January/MyChanceLink/IPool.sol
...
// File: MyChance/January/MyChanceLink/LibLendingPool.sol
...
// File: MyChance/January/MyChanceLink/IPrizeBondLINK.sol
...
interface IPrizeBondLINK is IERC721 {
...
// File: MyChance/January/MyChanceLink/LibConstants.sol
...
library LibConstants {
    IPrizeBondLINK constant prizeBond = IPrizeBondLINK(0xAFDEaB14d9E8e7b0811CA628F44a644f09309E17);
...
// File: MyChance/January/MyChanceLink/LibMyChanceLink.sol
...
library LMyChance {
    ...
    function mint (IPrizeBondLINK prizeBond, uint weight, mapping(uint256 => uint256) storage mintingDate, uint256[] storage prizeBonds, mapping(uint256 => PrizeBondPosition) storage prizeBondPositions) external {
...
// File: MyChance/January/MyChanceLink/Roles.sol
...
// File: MyChance/January/MyChanceLink/Charities.sol
...
// File: MyChance/January/MyChanceLink/MyChanceLINK.sol
...
abstract contract Lottery is Charities, RandomRequester, Pausable, AutomationCompatibleInterface {
    ...
    function claim(uint256 _tokenId, uint256 _percentage, address _charity) external {
        ...
        if (totalLINK > 0) {  
            ...
            require(IERC20(LibConstants.linkToken).transfer(_charity, claimVariables.totalToCharityLINK), 'Transfer failed');
