...
contract ChadDogeLab is Ownable {
    ...
    address constant public vialAddress = 0x6E665f0C69BFa5494284F5240D92CA0616530282;
    address constant public chadDogeAddress = 0x357928B721890Ed007142e45502A323827caF812;
    ...
    function claimSuper(uint256 _vialID, uint256 _chadDogeID) external requireLabOpen {
        ...
        if (vialFIds[_vialID] == 1) {
            unchecked {
                ...
                uint256 totalF = (vialFMetadataRange.max - minFID) + 1;
