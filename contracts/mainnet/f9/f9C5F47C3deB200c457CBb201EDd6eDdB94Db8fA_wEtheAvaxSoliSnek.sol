...
// File contracts/wEtheAvaxSoliSnek.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract wEtheAvaxSoliSnek  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        ISoliSnekRouter(router).swapExactTokensForTokens(snekHalf, 0, snekToAvaxPath, address(this), block.timestamp);
        ...
        uint256 t2Bal = IERC20(wethe).balanceOf(address(this));

        ISoliSnekRouter(router).addLiquidity(wavax, wethe, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
