...
contract MICROMACHINES is IBEP20, Ownable
{
    using Address for address;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    uint256 public tokenToSwapAmount = 10;
    ...
    //Token Info
    string private constant _name = 'MICROMACHINES';
    string private constant _symbol = 'MMAC';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals;//equals 100M tokens
    ...
    address public walletTwo=payable(0xa119144A2371Ea0f4e51b423aFa44Bc8767022A4);
    //TestNet
    ...
    address private constant PancakeRouter = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // TRADER JOE
    //variables that track balanceLimit and sellLimit,
    //can be updated based on circulating supply and Sell- and BalanceLimitDividers
    uint256 private _circulatingSupply =InitialSupply;
    uint256 public  balanceLimit = _circulatingSupply;
    uint256 public  sellLimit = _circulatingSupply;
	uint256 private antiWhale = 12 * 10**_decimals;
    ...
    constructor () {
        ...
        _pancakePairAddress = IPancakeFactory(_pancakeRouter.factory()).createPair(address(this), _pancakeRouter.WAVAX());
    ...
    function setTaxes ( uint8 buytax, uint8 selltax, uint8 transfertax ) public onlyOwner{
         _buyTax=buytax;
         _sellTax=selltax;
    ...
    function claimXRP(address addr) private{
        ...
        path[0] = _pancakeRouter.WAVAX(); //BNB
        path[1] = xrptoken;  //Binance-Peg XRP Token

        _pancakeRouter.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: amount}(
        0,
        path,
        addr,
        block.timestamp);
    ...
    function _swapTokenForBNB(uint256 amount) private {
        ...
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = _pancakeRouter.WAVAX();

        _pancakeRouter.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
            amount,
            0,
            path,
            address(this),
    ...
    function _addLiquidity(uint256 tokenamount, uint256 bnbamount) private {
        ...
        _pancakeRouter.addLiquidityAVAX{value: bnbamount}(
            address(this),
            tokenamount,
            0,
            0,
    ...
    function TeamRemoveLiquidity(bool addToStaking) public onlyOwner{
        ...
        uint256 initialBNBBalance = address(this).balance;
        _pancakeRouter.removeLiquidityAVAXSupportingFeeOnTransferTokens(
            address(this),
            amount,
            0,
            0,
