...
contract CorkToken is ICorkToken, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function balanceOf(address account)
        ...
        view
        virtual
        override(ERC20Upgradeable, ICorkToken)
        returns (uint256)
    {
    ...
    function transferFrom(
        ...
        address to,
        uint256 amount
    ) public virtual override(ERC20Upgradeable, ICorkToken) returns (bool) {
