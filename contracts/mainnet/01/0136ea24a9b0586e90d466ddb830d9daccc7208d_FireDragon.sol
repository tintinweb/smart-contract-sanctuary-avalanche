...
//  Stealth Launch   
//  Telegram: https://t.me/FireDragonWETH
//  Reward: $WETH 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB); // reward address WETH
...
contract FireDragon is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address WETH = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // rewards WETH
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FireDragon";
    string constant _symbol = "FDRAGON";
    ...
    address public autoLiquidityReceiver=0x61B239dCF6cf81f976ed717B0D6b980107A3b953; //liq address
    address public marketingFeeReceiver=0x61B239dCF6cf81f976ed717B0D6b980107A3b953; // marketing address
