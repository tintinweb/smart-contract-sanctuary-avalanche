...
contract StrategyAlphaHomora is BaseStrategy {
    ...
    constructor(
        ...
        vault = _vault;
        slippage = PRECISION / 50; // 2% slippage allowance
    ...
    function balanceOfPool() public view override returns (uint256) {
        ...
        uint256 supply0 = (r0 * collateral) / totalSupply;
        uint256 supply1 = (r1 * collateral) / totalSupply;
   ...
   function requireAmmCheckPass() internal view {
    ...
    /// @dev Get price of token from liquidity pool in terms of USDC
...
abstract contract BaseStrategy is Pausable, SettAccessControl {
    ...
    function deposit() public virtual whenNotPaused {
        ...
        uint256 _usdcToken = IERC20Upgradeable(stableToken).balanceOf(address(this));
        if (_usdcToken > 0) {
            _deposit();
        }
        _postDeposit();
    ...
    function withdraw(uint256 _amount) external virtual whenNotPaused {
        ...
        uint256 _postWithdraw = IERC20Upgradeable(stableToken).balanceOf(address(this));
    ...
    function _transferToVault(uint256 _amount) internal {
        ...
        IERC20Upgradeable(stableToken).safeTransfer(_vault, _amount);
    }
