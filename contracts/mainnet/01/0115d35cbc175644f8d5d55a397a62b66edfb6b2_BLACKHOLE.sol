...
contract BLACKHOLE is ERC20Detailed, Ownable {
    ...
    string public _name = "Black Hole Protocol";
    string public _symbol = "HOLE";
    ...
    uint256 public holeVaultFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public firePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(holeVaultFundFee).add(
            firePitFee
        );
    ...
    address public holeVaultReceiver;
    ...
    constructor() ERC20Detailed("Black Hole Protocol", "HOLE", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xC00135FcEC32688e73694ec94B582f89d3655E61;
        treasuryReceiver = 0x2368418fF22866BdD1971a9587A5D5A27Fe27FCe; 
        holeVaultReceiver = 0x84512212128260C27e2cbF5FD6159c8F5A707249;
        firePit = DEAD;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(holeVaultFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountAVAXToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(holeVaultFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(holeVaultReceiver).call{
            value: amountAVAXToTreasuryAndSIF.mul(holeVaultFundFee).div(
                treasuryFee.add(holeVaultFundFee)
            ),
            gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no HOLE token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WAVAX();
        router.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _holeVaultReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        holeVaultReceiver = _holeVaultReceiver;
        firePit = _firePit;
    }
