...
lets earn some $CAESAR (TITANO fork)
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x42d047534eef46FD68fAD3d74726Fe51be4eeb8F);
...
contract CaesarPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0x42d047534eef46FD68fAD3d74726Fe51be4eeb8F;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "Caesar Printer";
    string constant _symbol = "CAESARp";
    ...
    address public autoLiquidityReceiver = 0x872EBaAA1f6d0e52E6D063aeAeAcd4bAD7459686;
    address public marketingFeeReceiver = 0x872EBaAA1f6d0e52E6D063aeAeAcd4bAD7459686;
