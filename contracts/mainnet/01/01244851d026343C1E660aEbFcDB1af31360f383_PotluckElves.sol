...
contract PotluckElves is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    modifier onlyDevs() {
    ...
    address public royaltyAddress = 0xa9A68d6EBD298Ec227fB00D6b6Ba685aaD2762a8;

    string public baseURI;

    // VARIABLES
    uint public maxSupply = 351;
    uint public maxPerTx = 5;
    uint public maxPerPerson = 351;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Potluck Elves", "PLEV") ClampedRandomizer(maxSupply) {
    ...
    function internalMint(address to) internal {
        uint tokenId = _genClampedNonce() + 700;
