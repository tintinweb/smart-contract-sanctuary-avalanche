...
contract Utils is Ownable, BlindboxStorage{
    ...
    function init() public {
         MATIC = IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); //for eth chain wrapped ethereum 
        USD = IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118);
        platform = 0x9c427ea9cE5fd3101a273815Ff8530f2AC75Db37;
        nft = INFT(0x7C4bD5a216db48dAac6d1427D638DF290F7cce94);
        dex = IDEX(0x23f1E33F614345cAac21C24d05DfBFbda0b0aAF6);
        LPMATIC = LPInterface(0xe28984e1EE8D431346D32BeC9Ec800Efb643eef4);
...
/** 
    ...
    */
    ...
    function _openNonGenBoxOffchain(uint256 boxId, address collection) private {
        ...
        uint256 from;
        uint256 to;
      (from, to) =dex.mintBlindbox(collection, msg.sender, boxesNonGen[boxId].countNFTs, bankAddress[sId], nonGenseriesRoyalty[sId], sId);
