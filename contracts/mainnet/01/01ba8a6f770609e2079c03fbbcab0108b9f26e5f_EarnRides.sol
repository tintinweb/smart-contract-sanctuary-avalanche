...
/**
*
* Earn rewards by holding EarnRides
*
* Telegram - https://t.me/EarnRides
* Website - https://EarnRides.io
* 
* Tokenomics
*
* Total Supply - 1 000 000 000 000 000
* 
* 10% - Rides reward from every transaction
* 2% - Development
* 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x73F2aF605eA8A3D8410B83Ee05b8D6fc0Da1Aca4);
...
contract EarnRides is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x73F2aF605eA8A3D8410B83Ee05b8D6fc0Da1Aca4; // Rides Reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EarnRides";
    string constant _symbol = "EarnRides";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 3
	uint256 public _maxWallet = _totalSupply.div(1); // 3
    ...
    address public autoLiquidityReceiver=0x5c745362B7fa86e20735925f980eBcD979188327;
    address public marketingFeeReceiver=0x5c745362B7fa86e20735925f980eBcD979188327;
