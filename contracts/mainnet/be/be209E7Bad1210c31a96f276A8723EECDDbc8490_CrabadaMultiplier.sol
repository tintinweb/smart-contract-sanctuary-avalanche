...
// 
// https://t.me/cramavax
// https://twitter.com/CRAmultiplier
// $CRA Multiplier/Printer
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed); //$CRA Rewards
...
contract CrabadaMultiplier is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    
    address EP = 0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed ; // $CRA REWARDS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CrabadaMultiplier";
    string constant _symbol = "CRAM";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 2.50%
    uint256 public _maxWallet = _totalSupply.div(20); // 5.00%
    ...
    address public autoLiquidityReceiver=0xB9BbD721717791Bb53534B8DB132632d90C4685b;
    address public marketingFeeReceiver=0xB9BbD721717791Bb53534B8DB132632d90C4685b;
