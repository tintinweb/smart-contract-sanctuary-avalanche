...
/**  In honor of Number0 providing us with the best calls and tokens we will make this token
 *   for him he and for everyone who loves him launching soon
*/
// SPDX-License-Identifier: MIT
  
//  Twitter  : https://twitter.com/Numer0Token
//  Telegram : https://t.me/Numer0Token
//  Rewards  : $TLSTRZ 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xF8408413346f3C12dfac71B0b1E99ff618eA681d); // reward address TLSTRZ 
...
contract Numer0Token is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $TLSTRZ  = 0xF8408413346f3C12dfac71B0b1E99ff618eA681d; // reward $TLSTRZ  
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Numer0Token";
    string constant _symbol = "NUMER0";
    ...
    address public autoLiquidityReceiver=0x0643834111852f40478b33b7181F02A26B7Df78a; //liq address
    address public marketingFeeReceiver=0x0643834111852f40478b33b7181F02A26B7Df78a; // marketing address
