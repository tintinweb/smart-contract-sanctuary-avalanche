...
interface IBoardroom {
    ...
    function getJuicePrice() external view returns (uint256);
...
contract Treasury is ContractGuard {
    ...
    modifier checkOperator() {
        require(
            IBasisAsset(juice).operator() == address(this) &&
                ...
                IBasisAsset(juicer).operator() == address(this) &&
    ...
    function initialize(
        ...
        juicePriceOne = 10**18; // This is to allow a PEG of 1 JUCIE per MIM
