...
contract LendingPool is ERC20, ReentrancyGuard, Pausable, Ownable {
  ...
  */
  function withdrawNative(uint256 _ibTokenAmount) external nonReentrant whenNotPaused {
    ...
    if (_ibTokenAmount > maxWithdraw(msg.sender)) _ibTokenAmount = balanceOf(msg.sender);
  ...
  */
  function borrow(uint256 _assetAmount, address _vault) external nonReentrant whenNotPaused onlyBorrower {
    ...
    require(_assetAmount <= totalLiquidity(), "Not enough lending liquidity to borrow");
