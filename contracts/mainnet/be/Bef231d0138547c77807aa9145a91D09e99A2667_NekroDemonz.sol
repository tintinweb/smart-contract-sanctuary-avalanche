...
contract NekroDemonz is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    modifier onlyDevs() {
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("NekroDemonz", "NKDZ") ClampedRandomizer(maxSupply) {
    ...
    function internalMint(address to) internal {
        uint tokenId = _genClampedNonce() + 889;
