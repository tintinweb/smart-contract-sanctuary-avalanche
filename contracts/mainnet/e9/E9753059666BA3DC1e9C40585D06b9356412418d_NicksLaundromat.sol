...
contract NicksLaundromat {
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 10000000000 * 1e6; /** 10000000000 USDC  **/

	uint256 public COMPOUND_BONUS = 3; /** 3% **/
    ...
    constructor(address _dev1, address _mkt) {
