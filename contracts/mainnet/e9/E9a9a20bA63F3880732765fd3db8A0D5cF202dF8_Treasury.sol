...
contract Treasury is ContractGuard {
    ...
    address(0x0000000000000000000000000000000000000000), // TombGenesisPool
    address(0x0000000000000000000000000000000000000000) // new TombRewardPool
    ...
    function initialize(
        ...
        maxSupplyExpansionPercent = 800; // Upto 4.0% supply for expansion
    ...
    function setBootstrap(uint256 _bootstrapEpochs, uint256 _bootstrapSupplyExpansionPercent) external onlyOperator {
        ...
        require(_bootstrapSupplyExpansionPercent >= 100 && _bootstrapSupplyExpansionPercent <= 5000, "_bootstrapSupplyExpansionPercent: out of range"); // [1%, 10%]
