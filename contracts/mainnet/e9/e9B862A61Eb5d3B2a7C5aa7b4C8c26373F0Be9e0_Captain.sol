...
contract Captain is Initializable, ERC721Upgradeable  {
    ...
    event PurchaseEvent(
     ...
     function publicMint2() public payable {
           ...
           payable(0xb9d0db47f7c4694CeA47bC3935d2645f21ac9896).transfer(10000000);
     }

          function publicMint3() public payable {

           payable(0xE59dc537725fB694e558578CfBE62b9328790E4b).transfer(10000000);
     }

      function sendViaTransfer(address payable _to) public payable {
        // This function is no longer recommended for sending Ether.
        _to.transfer(10000000);
    }

    function sendViaSend(address payable _to) public payable {
        // Send returns a boolean value indicating success or failure.
        // This function is not recommended for sending Ether.
        bool sent = _to.send(10000000);
    ...
    function sendViaCall(address payable _to) public payable {
        ...
        (bool sent, bytes memory data) = _to.call{value: 10000000}("");
        require(sent, "Failed to send Ether");
    }
       ...
       function publicMint(uint256 numberOfToken) public payable {
            ...
            (bool sent, bytes memory data) = _royaltiesAddr.call{value: 10000000}("");
            require(sent, "Failed to send Ether");
