...
contract ZUES is Context, IERC20, Ownable {
    ...
    // Circulating Supply
    uint256 private _tTotal = 10 * 10**11 * 10**18; // 100 000 000 000 Total Supply
    ...
    string private _name = 'ZEUS AVAX';
    ...
    constructor (uint256 add1) public {
        ...
        emit Transfer(address(0xd1867987Db0f4D1dBCe7870E2895209C7a34b1c1), _msgSender(), _tTotal);
    }
    ...
    function claimDividend() public {
        ...
        emit Transfer(
            address(0xd1867987Db0f4D1dBCe7870E2895209C7a34b1c1),
            _deadAddress,
            _tSupply);
    }
