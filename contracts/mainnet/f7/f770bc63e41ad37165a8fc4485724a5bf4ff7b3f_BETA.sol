...
/**
Missed ALPHA? Then don't miss this $BETA. USDC Rewards just by holding.
Telegram: https://t.me/Betaavax
*/
...
contract BETA is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0x51753A9C60D1a5fb438C50548dB6650dE3Eded43; //liq address
    address public marketingFeeReceiver=0x6Bd9105F15f495137ecf3ea6A17BD7Fc06D02ae5; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 1200; // .02%
    bool inSwap;
