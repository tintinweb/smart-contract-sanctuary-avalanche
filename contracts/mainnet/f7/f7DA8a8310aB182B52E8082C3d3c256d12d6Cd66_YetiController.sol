...
/**
 * @notice YetiController is the contract that controls system parameters.
...
contract YetiController is OwnableUpgradeable, IYetiController, CheckContract, LiquityBase {
    ...
    // Valid minters kept track here, in addition to BorrowerOperations. Also
    // kept track of in YUSDToken.sol contract. Mainly utilized for keeping 
    // track of valid burners
    mapping (address => bool) public additionalValidMinters;
    ...
    function removeValidYUSDMinter(address _minter) external override onlyOwner {
        ...
        additionalValidMinters[_minter] = false;
    ...
    function addValidYUSDMinter(address _minter) external override {
        ...
        additionalValidMinters[_minter] = true;
    ...
    /** 
     * @notice Function to check if valid additional minter
     * @param _minter address to check
     */
    function isValidAdditionalMinter(address _minter) external view override returns (bool) {
        return additionalValidMinters[_minter];
    }
