...
/**
Terraform the moon, print some cheap Luna!
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0x70928E5B188def72817b7775F0BF6325968e563B);
...
contract TerraFormer is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDT = 0x70928E5B188def72817b7775F0BF6325968e563B; // Luna
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x7Fcc20BD98D648D8F3efF651CAc70996473918Da;
    address public marketingFeeReceiver=0x7Fcc20BD98D648D8F3efF651CAc70996473918Da;

    string constant _name = "TerraFormer";
    string constant _symbol = "TerraP";
