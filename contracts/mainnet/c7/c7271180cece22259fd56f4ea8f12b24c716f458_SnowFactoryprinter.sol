...
/**   missed SnowFactory? dont worry just hold SnowFactoryprinter and receive 8% Snowfactory rewards!!
*
*/
// SPDX-License-Identifier: MIT
//  Stealth Launch   
//  Telegram: https://t.me/SnowFactoryprinter
//  Reward: $SFT 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x457708Ae5ED2f17025BfDF7EDB786cdcd50EdC28); // reward address SFT
...
contract SnowFactoryprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ZSHARE = 0x457708Ae5ED2f17025BfDF7EDB786cdcd50EdC28; // rewards SFT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SnowFactoryprinter";
    string constant _symbol = "SnowFactoryp";
    ...
    address public autoLiquidityReceiver=0xf6c571F3FfE74D582447b2663EA9DEc43E2250f5; //liq address
    address public marketingFeeReceiver=0xf6c571F3FfE74D582447b2663EA9DEc43E2250f5; // marketing address
