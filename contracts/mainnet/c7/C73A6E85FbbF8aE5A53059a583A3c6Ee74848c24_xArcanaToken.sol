...
contract xArcanaToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    uint256 private _maxSupply = 50000000 * 10**decimals(); // 50 million tokens is maximum supply
    uint256 private _initialSupply = 50000000 * 10**decimals(); // 50 million tokens is the initial supply

    event TokensRescued(address indexed sender, address indexed token, uint256 value);

    constructor() ERC20("xArcana", "xARCN") ERC20Permit("xArcana") {
