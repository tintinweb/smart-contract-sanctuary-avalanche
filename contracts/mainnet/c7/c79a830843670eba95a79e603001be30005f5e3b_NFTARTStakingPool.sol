...
// Pool distributes the ERC20 rewards based on staked tokens to each user.
contract NFTARTStakingPool is Ownable {
    ...
    function fund(uint256 _amount) public {
        ...
        if (endBlock <= block.number) {
            endBlock = block.number + _amount.div(rewardPerBlock);
        } else {
