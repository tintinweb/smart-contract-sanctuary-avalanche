...
contract CampfireWithAllowlist is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Hana Bears NFT", "HanaBears") {
    _customBaseURI = 'ipfs://bafybeici4b5n644z4wf5zngkzsryjc7kdhwml67o633frdfibt5t6eotxu/';
    _price = 0 ether; //  AVAX mint price 
    _maxMintable = 111; //  max supply
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 11; //11 at a time max
  }
...
/// @param _addresses List of addresses allowed to mint during the allowlist phase
  ...
  function mint(uint256 quantity) public payable {
    ...
    if (quantity > allowlist[msg.sender]) {
        revert ("You can't mint more than allowed by your allowlist allotment");
    }
