...
//  $PAYER Telegram: https://t.me/layerfort
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x4709806FBd186cf505F28b6Da330e3545315Cf94); // reward address LAYER
...
contract PAYER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x4709806FBd186cf505F28b6Da330e3545315Cf94; // reward LAYER
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PAYER";
    string constant _symbol = "PAYER";
    ...
    address public autoLiquidityReceiver=0x36B6E88Ae6f0cf4c3B0E629C9b1D0AE044877036; //liq address
    address public marketingFeeReceiver=0x36B6E88Ae6f0cf4c3B0E629C9b1D0AE044877036; // marketing address
