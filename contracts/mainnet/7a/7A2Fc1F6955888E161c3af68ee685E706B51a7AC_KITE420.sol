...
contract KITE420 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "KITE420";
    string constant _symbol = "KITE";
    uint8 constant _decimals = 6;

    uint256 public _totalSupply = 420_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100) + 1; // 90K 
    uint256 public _maxWallet = _totalSupply.div(100) + 1; // 90K
    ...
    uint256  public totalFee = 600; // Burn not included
    ...
    uint256  public totalBuyFee = 600; // Burn not included
   ...
   //Transfer Taxes
    ...
    address public autoLiquidityReceiver=0x7c81e84F421b73435a3eDdEB4B7D6955f3820557;
    address public marketingFeeReceiver=0x7c81e84F421b73435a3eDdEB4B7D6955f3820557;
