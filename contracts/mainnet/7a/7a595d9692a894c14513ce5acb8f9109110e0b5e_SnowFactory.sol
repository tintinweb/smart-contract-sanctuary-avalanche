...
contract SnowFactory {
	...
	address erctoken = 0x457708Ae5ED2f17025BfDF7EDB786cdcd50EdC28; 
    ...
    function sellEggs() public{
        ...
        token_1.transfer(msg.sender, eggsPayout);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_1.transfer(project, projectFee);
		token_1.transfer(partner1, partnerFee);
		token_1.transfer(partner2, partnerFee);
    ...
    function payFeesSell(uint256 eggValue) internal returns(uint256){
        ...
        token_1.transfer(project, prj);
		token_1.transfer(marketing, mkt);
