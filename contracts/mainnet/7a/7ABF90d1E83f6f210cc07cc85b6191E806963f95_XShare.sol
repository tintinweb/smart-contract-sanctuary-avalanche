...
contract XShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("XSHARE Token", "XSHARES") {
        _mint(msg.sender, 1 ether); // mint 1 XOMB Share for initial pools deployment
