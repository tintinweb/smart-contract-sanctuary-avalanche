...
// File contracts/Janus.sol

pragma solidity ^0.8.0;


contract Janus is IERC20, Ownable {
    ...
    string public constant name = "Janus Network";
    string public constant symbol = "JNS";
    uint8 public constant decimals = 18;

    uint256 private _totalSupply = 10E6 * 1E18;
    ...
    function mint(address _to, uint256 _amount) public {
        require(msg.sender == owner() || msg.sender == minterAddress, "Only owner or minter can use this!");
        _mint(_to, _amount);
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "Janus: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "Janus: transaction fee percentage equals 0");
    ...
    function _transfer(
        ...
        if (!tradingEnabled) {
            ...
            require(sender == owner() || recipient == owner(), "Trading is disabled!");
        }
