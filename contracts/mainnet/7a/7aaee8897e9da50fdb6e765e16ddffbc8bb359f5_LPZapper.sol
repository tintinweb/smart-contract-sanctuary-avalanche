...
contract LPZapper {
    ...
    IJoeRouter01 public constant joeRouter = IJoeRouter01(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
    ...
    function zapWithAvax(uint256 minOut) external payable {
        ...
        _pairLiquidity(XGRAPE, GRAPE, msg.sender);
    ...
    function _convertTokenIntoTokensForLP(address token_) internal {
        ...
        if ( token_ == MIM) {
            ...
            // swap entire balance into MIM
            joeRouter.swapExactAVAXForTokens{
