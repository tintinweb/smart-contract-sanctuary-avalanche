...
contract BShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BerrySHARE", "BSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 BERRY Share for initial pools deployment
