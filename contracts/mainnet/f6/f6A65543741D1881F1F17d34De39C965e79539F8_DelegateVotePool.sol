...
contract DelegateVotePool is Initializable, OwnableUpgradeable {
    ...
    // SETTINGS
    function setVoterStatus(address voter, bool _isVoter) external onlyOwner {
        isVoter[voter] = _isVoter;
    }
    ...
    function updateWeight(address lp, uint256 weight) external onlyVoter {
