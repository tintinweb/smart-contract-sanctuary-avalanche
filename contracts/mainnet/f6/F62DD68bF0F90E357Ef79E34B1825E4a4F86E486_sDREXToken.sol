...
contract sDREXToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked DREX", "sDREX", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDREX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDREX
