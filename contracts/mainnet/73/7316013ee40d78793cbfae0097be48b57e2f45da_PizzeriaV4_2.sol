...
interface IPizzeriaProgressionV4_2 {
...
contract PizzeriaV4_2 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Constants
    ...
    IPizzeriaProgressionV4_2 public pizzeriaProgression;
    IMafia_2 public mafia;
    ...
    function initialize(Chef _chef, Upgrade _upgrade, Pizza _pizza, Soda _soda, address _freezerAddress, address _pizzeriaProgression) public initializer {
        ...
        pizzeriaProgression = IPizzeriaProgressionV4_2(_pizzeriaProgression);
    ...
    function _claimPizza(address _owner) internal {
        ...
        uint256 taxAmountMafia = totalClaimed * mafia.getPlayerPenalty(_owner) / 100;
