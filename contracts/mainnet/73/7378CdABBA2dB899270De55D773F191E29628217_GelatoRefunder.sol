...
import {ITaskTreasuryAvax} from "../interfaces/external/ITaskTreasuryAvax.sol";
...
contract GelatoRefunder is IGelatoRefunder, ManageableUpgradeable {
  ...
  address public constant RECEIVER = 0x8aB6aDbC1fec4F18617C9B889F5cE7F28401B8dB; //address
  //	that registers the resolver
  address public constant GAS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE; //address
  //	Gelato uses for gas

  IWrappedNative public constant NATIVE =
    IWrappedNative(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
  ITaskTreasuryAvax public constant TASK_TREASURY =
    ITaskTreasuryAvax(0xe167199A490b04042414aFD71830bBF165f44C09);
