...
contract PunksOfAvaxGenesis is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibcght45nacinxrk3cbbi2ezidjlazl3m3n74ii6xixe4pllvipwy/", Strings.toString(tokenId), ".json")
            );
    }
