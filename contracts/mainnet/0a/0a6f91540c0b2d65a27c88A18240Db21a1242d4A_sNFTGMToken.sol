...
contract sNFTGMToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked NFTGM", "sNFTGM", 9) ERC20Permit() {
    ...
    /**
        @notice increases sNFTGM supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sNFTGM
