...
contract BTCPrint is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x152b9d0FdC40C096757F570A51E494bd4b943E50; // EP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Bitcoin Printer 2.0";
    string constant _symbol = "BTCP2";
    ...
    address public autoLiquidityReceiver=0xAAC3D413095eB642346f278b6240B7B742787B1E;
    address public marketingFeeReceiver=0xAAC3D413095eB642346f278b6240B7B742787B1E;
