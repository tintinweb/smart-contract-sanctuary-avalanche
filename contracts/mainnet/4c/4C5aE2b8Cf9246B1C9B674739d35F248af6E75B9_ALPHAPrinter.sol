...
contract ALPHAPrinter {
    ...
    address public ALPHANodes = 0x1f193488738e888aFBE8BFAc271C12F1bE49629D; 
    address public USDC = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public pair = 0xcc2a026f4A1DEbdFe1E04C9BDdc2f2FfC919F2AD;
    ...
    function printToken() external {
        ...
        ALPHATEST4(payable(ALPHANodes)).transfer(msg.sender, 1); //Workaround to claim dividend contractually triggered by a single with a single wei transfer.
        ...
        emit Log("collected usdc for swap : ");
    ...
    function printNative() external {
        uint256 before = IBEP20(USDC).balanceOf(msg.sender); //Gets the current balance of USDC
        ALPHATEST4(payable(ALPHANodes)).transfer(msg.sender, 1); //Workaround to claim dividend contractually.
        uint256 available = IBEP20(USDC).balanceOf(msg.sender) - before; //Gets the new balance of USDC after dividend payout, but subtracts any previously held USDC.
...
contract ALPHATEST4 is IBEP20, Auth {
    ...
    /** Token constants */
    string constant _name = "ALPHATEST4";
    string constant _symbol = "ALPHATEST4";
    ...
    address public autoLiquidityReceiver = 0x618711478689a68aA547480c2D9ba72FBFC31774;
    address public treasuryFeeReceiver = 0x618711478689a68aA547480c2D9ba72FBFC31774;
    ...
    function setTreasuryReciever(address _treasuryFeeReceiver) external authorized {
