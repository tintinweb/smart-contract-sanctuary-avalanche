...
contract TransferToBank {
    ...
    function transferToBank(
        ...
        if (IERC721(collection).supportsInterface(type(IERC721).interfaceId)) {
            (bool success,) =    collection.delegatecall(abi.encodeWithSelector( IERC721.setApprovalForAll.selector, address(this), true));
            require(success);
            ...
            revert("Your collection is not supported");
        }
    }
}
