...
contract Token is ERC20Detailed, Auth, MinterRole {
    ...
    uint256 private maxSellTransactionAmount = 1500 * 10 ** 18;
    ...
    address private constant usdcToken = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
    
    address public liquidityReceiver = 0x6807615e8b99E92886Bf349D3932c2D1BFC1E94b;
    address public treasuryReceiver = 0x6807615e8b99E92886Bf349D3932c2D1BFC1E94b;
    address public riskFreeValueReceiver = 0x6807615e8b99E92886Bf349D3932c2D1BFC1E94b;
    address public TestReceiver = 0x6807615e8b99E92886Bf349D3932c2D1BFC1E94b;
    ...
    constructor() ERC20Detailed("Test", "Test", uint8(DECIMALS)) Auth(msg.sender) {
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 ftmAmount) private {
        router.addLiquidityAVAX{value: ftmAmount}(
            address(this),
            tokenAmount,
            0,
            0,
