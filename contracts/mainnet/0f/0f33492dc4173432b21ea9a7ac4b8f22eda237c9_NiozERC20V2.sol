...
contract NiozERC20V2 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    modifier onlyAllowedAddress() {
        require(
            msg.sender == address(ERC721TokenAddress) || msg.sender == address(ConstructTokenAddress),
     ...
     * - msg.sender must be owner of printer token.
     *
     * Emits a {StakeInFoundary} event.
     */
    function stakeInFoundary(
        uint256 _amount
    ) external virtual {
        ...
        virtual
    {
        ...
        require(!isUnProcessedPartSold[_order.partId], "NiozERC20: Already sold");
     ...
     * - only owner of contract can call this method
     * 
     * Emits a {MintWeeklyTokens} event.
     */
    ...
    function burnTokens(uint256 _amount) external virtual {
        require(balanceOf(msg.sender) >= _amount, "NiozERC20: Exceeds balance amount");
        _burn(msg.sender, _amount);
     ...
     * - only owner of tokens can burn the tokens
     */
    function burnTokensAuth(address _address, uint256 _amount) external virtual onlyOwner {
        require(balanceOf(_address) >= _amount, "NiozERC20: Exceeds balance amount");
...
interface IERC721Upgradeable {
    ...
    /**
     * @dev burns the NFT token on sale
     */
    function unprocessedOnSell(uint256 _tokenId, address _owner) external;
...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _transfer(
        ...
        require(!blacklistAddresses[from] && !blacklistAddresses[to], "ERC20: Blacklisted address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(!blacklistAddresses[account], "ERC20: Blacklisted address");
