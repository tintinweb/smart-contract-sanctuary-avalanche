...
/**
The Multiverse has no limits
Thanks to our investment projects, Play2Earn but also compatibility between different blockchains (Binance Smart Chain, Ethereum), the future of Multiverse promises to be bright. An infinite number of different universes are available to us, and we will exploit them all, together. Many other projects are likely to come. You are witnessing the birth of the Multiverse.
Our goal is to create a long-term DeFi protocol

Play2Earn
We are working on developing an even more fun and interactive blockchain game that will take the Nodes experience to the next level.

No more scams
No need to invest in dozens of suspicious projects, once your investment is made, you will receive a passive income for life without having to look for new projects.

Durability
Our goal is to last as long as possible. To do this, we will not only rely on our protocol: the sell tax (which will amount to 5%) will allow us to finance investments chosen by a team of experts in DeFi. The revenues generated by these investments in parallel Universes will be reinvested in Multiverse, and will allow to increase the price.
...
contract MULTIVERSE is IERC20 {
    ...
    uint256 private startingSupply = 9_999_999_999;

    string constant private _name = "Multiverse";
    string constant private _symbol = "$MULTI";
    ...
    address payable public marketingWallet = payable(0x5f072803d39D528384bF0431CBEE1bCE06DBde5F);
    address payable private rewardsPool = payable(0x5f072803d39D528384bF0431CBEE1bCE06DBde5F);
    address payable private treasuryWallet = payable(0x5f072803d39D528384bF0431CBEE1bCE06DBde5F);
    ...
    IERC20 MANSION = IERC20(0x5f072803d39D528384bF0431CBEE1bCE06DBde5F);
