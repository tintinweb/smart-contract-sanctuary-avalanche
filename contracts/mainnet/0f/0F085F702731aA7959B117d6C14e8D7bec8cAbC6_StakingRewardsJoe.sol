...
// File contracts/StakingRewardsJoe.sol



pragma solidity ^0.8.9;
contract StakingRewardsJoe is Ownable {
    ...
    address public masterChefJoe = 0x0000000000000000000000000000000000000000;
    bool public isSuper = false;
    ...
    function withdraw(uint256 amountShares) external onlyApprovedContractOrEOA updateReward(msg.sender) {
        ...
        stakingToken.safeTransfer(msg.sender, amountShares);
        emit Withdrawn(msg.sender, amountShares);
    }

    // Withdraw without caring about rewards. EMERGENCY ONLY.
    function emergencyWithdraw() public onlyApprovedContractOrEOA{
        stakingToken.safeTransfer(address(msg.sender), _balances[msg.sender]);
        emit EmergencyWithdraw(msg.sender, _balances[msg.sender]);
