...
contract AvaxProfit {
	...
	constructor(address payable wallet, address payable _developer) public {
		...
		plans.push(Plan(14, 80)); // 13.7% per day for 14 days (at the end)
        plans.push(Plan(21, 65)); // 13.1% per day for 21 days (at the end)
        plans.push(Plan(28, 50)); // 10.4% per day for 28 days (at the end)
	}
