...
contract NODERewardManagementV2 is Ownable {
    ...
    function _transferNode(address from, address to, string memory nodeName) public onlyAdmin returns (bool) {
        uint256 index;
        bool found;
    ...
    function _renameNode(address account, string memory oldName, string memory newName) external onlyAdmin {
    ...
    function addRewardToNode(address account, string memory name, uint256 amount) external onlyAdmin {
