...
contract pAVAXLiquidity is IWrappedERC20Events, OwnableUpgradeable, TokensRecoverableUpg//, IERC1155ReceiverUpgradeable
{
    ...
    function initialize(IWrappedERC20 _wrappedToken, address _vaultContract) public initializer {
        ...
        burnPercent = 25000; // 25%
        treasuryPercent = 25000; // 25%
