...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 time = IBEP20(0xbfb8DD604B903f30da21354ab41B91dE3f1C94e5);
...
contract OBREFAG is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address time = 0xbfb8DD604B903f30da21354ab41B91dE3f1C94e5; // time
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "OBREFAG";
    string constant _symbol = "OBF";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(100); // 0.55%
    ...
    address public autoLiquidityReceiver=0x0fC4E3cA1257b9c526B472e9Cc42E5C017E00008;
    address public marketingFeeReceiver=0x0fC4E3cA1257b9c526B472e9Cc42E5C017E00008;
