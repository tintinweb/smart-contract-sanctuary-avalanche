 ...
 */
contract PeonToken is ERC721Upgradeable, Ownable2StepUpgradeable, ERC2981Upgradeable, IPeonToken {
     ...
     * @param _collectionSize The size of the collection
     */
    constructor(string memory _name, string memory _symbol, address _royaltyReceiver, uint256 _collectionSize)
        initializer
    {
        __ERC2981_init();
        ...
        nextTokenToMint[PeonTokenType.REGULAR] = MAX_DIAMOND_TOKEN_AMOUNT + MAX_GOLDEN_TOKEN_AMOUNT;
        nextTokenToMint[PeonTokenType.GOLDEN] = MAX_DIAMOND_TOKEN_AMOUNT;
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC2981Upgradeable, ERC721Upgradeable, IPeonToken)
        returns (bool)
    {
