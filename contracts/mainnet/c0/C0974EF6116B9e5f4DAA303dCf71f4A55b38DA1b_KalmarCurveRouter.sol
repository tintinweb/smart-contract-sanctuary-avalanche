...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve-mim-usdt-usdc
    ICurveRouter public constant curvePool = ICurveRouter(0xAEA2E71b631fA93683BCF256A8689dFa0e094fcD);
    IERC20 public constant mim = IERC20(0x130966628846BFd36ff31a822705796e8cb8C18D); // 0
    IERC20 public constant usdt = IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118); // 1
        ...
        returns(uint256 _destAmount)
    {
        ...
        curvePool.exchange(int128(i), int128(j), _srcAmount, 0, address(this));
