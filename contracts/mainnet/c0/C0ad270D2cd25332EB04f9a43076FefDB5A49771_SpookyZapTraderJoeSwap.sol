...
contract SpookyZapTraderJoeSwap is Ownable, ReentrancyGuard {
    ...
    ZapInfo[] public zaps;
    ISpookyChef public spookyChef;
    IUniswapV2Router02 public uniRouter;

    address public constant wethAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX

    constructor(address _spookyChef, address _uniRouter) {
        require(_spookyChef != address(0), "Zap::constructor: Invalid address");
        require(_uniRouter != address(0), "Zap::constructor: Invalid address");
        spookyChef = ISpookyChef(_spookyChef);
    ...
    function zap(
        ...
        address _lp = address(spookyChef.lpToken(_info.pid));
        ...
        approveToken(_lp, address(spookyChef), _liquidity);
        spookyChef.deposit(_info.pid, _liquidity, msg.sender);
