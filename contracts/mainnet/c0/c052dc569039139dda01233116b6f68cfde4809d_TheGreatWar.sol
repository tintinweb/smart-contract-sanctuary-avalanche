...
contract TheGreatWar is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    ...
    uint256 public constant NFT_EARLY_PRICE = 0.25 ether; //
    uint256 public constant NFT_PRICE = 0.25 ether; //
