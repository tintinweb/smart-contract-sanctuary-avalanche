...
contract Olympia is ERC20Detailed, Ownable {
    ...
    string public _name = "Olympia";
    string public _symbol = "OLY";
    ...
    constructor() ERC20Detailed("Olympia", "OLY", uint8(DECIMALS)) Ownable() {
    ...
    function setFees(
        ...
        uint256 _OlyInsuranceFundFee,
        uint256 _treasuryFee,
        uint256 _sellFee,
        uint256 _feeDenominator
    ) external onlyOwner {
        liquidityFee = _liquidityFee;
        OlyInsuranceFundFee = _OlyInsuranceFundFee;
        treasuryFee = _treasuryFee;
        sellFee = _sellFee;
        totalFee = liquidityFee.add(treasuryFee).add(OlyInsuranceFundFee);
