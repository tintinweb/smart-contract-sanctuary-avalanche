...
// File: contracts/AVAX_NEON_CLUB.sol
...
contract AVAX_NEON_CLUB is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("AVAX_NEON_CLUB", "NEON") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(amount > 0 && amount <= maxPerTx, "Error: Only 1 per Tx");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: Max 3 per Wallet");
        if (price > 0) require(msg.value == price * amount, "Error:  Not Enought money Sir !");
