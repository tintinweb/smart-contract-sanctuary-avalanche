...
contract PriceFeed is IPriceFeed {
    ...
    // --- Dependency setters ---
    bool private paramsSet = false;
    function setParams(address _priceAggregatorAddress, string memory _name) external {
        require(paramsSet == false, "Addresses already set");
        paramsSet = true;
        name = _name;
