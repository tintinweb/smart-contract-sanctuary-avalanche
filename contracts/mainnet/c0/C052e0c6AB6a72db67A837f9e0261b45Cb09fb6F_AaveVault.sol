...
contract AaveVault is BaseBuildingBlock, IAaveVault {
    ...
    function initialize(bytes memory _data) public initializer {
        ...
        require(
            ...
            "AaveVault::intialize: id must be greater than 0"
        );
     ...
     */
    function closePosition(bytes memory _data) public override {
     ...
     **/
    function claimAllRewards(bytes memory _data) public override  {
