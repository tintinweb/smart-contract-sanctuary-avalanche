...
contract SmolDevils is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Smol Devils", "SMDVL") KindaRandom(300) {
    _customBaseURI = "https://nfts.bpi.network/smol_devils/";
    _maxMintable = 300; // 300 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 5;
    _price = 0.15 ether;
    _startTime = 1666918800;
