...
// File: contracts/MyDigitalCity.sol
...
contract MyDigitalCity is ERC721, ERC721Enumerable, Ownable, ERC721Burnable, ERC2981, RoyaltiesAddon {
    ...
    uint256 private royaltiesFees = 10; // 10% 2nd hand market royalties
    ...
    ERC721("My Digital City", "MDC")
    {
        super._setRoyaltiesAddress(royaltiesAddress);
        _royaltiesAddress = royaltiesAddress;
        newURI = "ipfs://QmbUP2PT36iTXY9KSMab4JniAFotwqtS5oJpx4v83EsSwd/";
    ...
    function mint(address to, uint256 _mintAmount) public payable{
        ...
        require(_mintAmount + supply <= MAX_SUPPLY, "All minted out");
