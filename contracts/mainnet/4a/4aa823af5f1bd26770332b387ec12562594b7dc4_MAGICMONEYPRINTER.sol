...
6% USDC auto distribute to all holders
3% fee auto Marketing
100% lp locked
17 AVAX + 100% tokens

Twitter: @MagicMoneyPrint
*/
...
contract MAGICMONEYPRINTER is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Magic Money Printer";
    string constant _symbol = "MMP";
