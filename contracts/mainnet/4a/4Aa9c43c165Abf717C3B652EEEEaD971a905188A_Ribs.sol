...
contract Ribs is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 Ribss
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("RIBS Token", "RIBS") {
        _mint(msg.sender, 1 ether); // mint 1 HEAD Share for initial pools deployment
