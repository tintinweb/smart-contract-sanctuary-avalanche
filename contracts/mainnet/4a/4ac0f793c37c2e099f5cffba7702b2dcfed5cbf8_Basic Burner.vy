...
"""
@title Basic Burner
@notice Converts any coin to USDC if a capable swap is registered
"""
...
USDC: constant(address) = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E
...
def burn(_coin: address) -> bool:
    ...
    min_amount: uint256 = 990000 * amount / 10 ** IERC20(_coin).decimals()
    RegistrySwap(registry_swap).exchange_with_best_rate(_coin, USDC, amount, min_amount, self.receiver)
