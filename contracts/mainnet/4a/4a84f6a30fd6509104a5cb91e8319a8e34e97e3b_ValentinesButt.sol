...
// Telegram : https://t.me/ValentinesButt  
// IF YOU SEE THIS YOU ARE EARLY ! JOIN THE TG TO KNOW WHEN LAUNCH.
// Twitter : https://t.me/ValentinesButt
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // 
...
contract ValentinesButt is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0xa70468E5e40d0ca9525711b608750925a1e2b81a; 
    address public marketingFeeReceiver=0xa70468E5e40d0ca9525711b608750925a1e2b81a;

    string constant _name = "Valentine's Butt";
    string constant _symbol = "VB";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(8); // 
    uint256 public _maxWallet = _totalSupply.div(5); //
