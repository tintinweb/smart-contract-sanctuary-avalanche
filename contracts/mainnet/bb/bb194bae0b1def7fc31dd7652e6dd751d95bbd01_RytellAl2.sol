...
/// @title Rytell Al 2
contract RytellAl2 is ERC721Metadata {
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell Al2: All minted");
        require(counts_ > 0, "Rytell Al2: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell Al2: sale already ended"); 
        require(!paused, "Rytell Al2: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell Al2: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell Al2: max supply reached");
