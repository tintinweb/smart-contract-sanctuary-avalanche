...
// File: contracts/interfaces/IKalmOraclePrice.sol
...
// File: contracts/PriceFeedData.sol
...
contract PriceFeedData is Ownable {
    ...
    function _getLpPrice(address lp) internal view returns(uint256)
    {
      ...
      uint256 totalOtherPrice = fairReserveOther.mul(_otherTokenPrice(other));
