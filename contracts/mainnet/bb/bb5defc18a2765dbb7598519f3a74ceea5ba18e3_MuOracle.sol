...
contract MuOracle{
    ...
    //timestamp taken
    //pool address
    function internalMU_USDCe_pool_info() internal view returns(address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1,uint32 _blockTimestampLast){
        ...
        return (0xfacB3892F9A8D55Eb50fDeee00F2b3fA8a85DED5, _token0, _token1, __reserve0 * 10**12, __reserve1, __blockTimestampLast);
    }

    function get_MU_USDCe_pool_info() public view returns (address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1,uint32 _blockTimestampLast){
