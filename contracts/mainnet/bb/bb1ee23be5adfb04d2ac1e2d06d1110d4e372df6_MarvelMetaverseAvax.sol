...
#MarvelMetaverseAvax fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MarvelMetaverseAvax!
...
contract MarvelMetaverseAvax is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = " Marvel Metaverse Avax";
