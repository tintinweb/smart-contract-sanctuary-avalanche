...
contract Plinko is GameBase, GameBet, GameChainlink {
    ...
    constructor(
        ...
        bucketProbabilities[12] = [1006, 5306, 23331, 123682, 274208, 499997, 725792, 876318, 976669, 994694, 998994, 1000000];
        bucketMultipliers[13] = [7000, 1600, 300, 200, 90, 60, 40, 60, 90, 200, 300, 1600, 7000];
        bucketProbabilities[13] = [879, 3652, 21058, 36381, 156499, 351383, 648617, 843501, 963619, 978942, 996348, 999121, 1000000];
    }
