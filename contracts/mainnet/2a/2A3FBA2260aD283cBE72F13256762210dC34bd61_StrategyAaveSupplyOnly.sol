...
// File: contracts/MERMAID/interfaces/aave/IDataProvider.sol
...
// File: contracts/MERMAID/interfaces/aave/IIncentivesController.sol
...
// File: contracts/MERMAID/interfaces/aave/ILendingPool.sol
...
// File: contracts/MERMAID/interfaces/common/IUniswapRouterETH.sol
...
// File: contracts/MERMAID/strategies/Common/StratManager.sol
...
contract StratManager is Ownable, Pausable {
    ...
    address public mermaidFeeRecipient;
     ...
     * @param _mermaidFeeRecipient address where to send Mermaid's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
        address _unirouter,
        address _vault,
        address _mermaidFeeRecipient
    ) public {
        keeper = _keeper;
        strategist = _strategist;
        unirouter = _unirouter;
        vault = _vault;
        mermaidFeeRecipient = _mermaidFeeRecipient;
    }
    ...
    /**
     * @dev Updates mermaid fee recipient.
     * @param _mermaidFeeRecipient new mermaid fee recipient address.
     */
    function setMermaidFeeRecipient(address _mermaidFeeRecipient) external onlyOwner {
        mermaidFeeRecipient = _mermaidFeeRecipient;
    }
...
// File: contracts/MERMAID/strategies/Common/FeeManager.sol
...
abstract contract FeeManager is StratManager {
    ...
    uint public mermaidFee = MAX_FEE - STRATEGIST_FEE - callFee;

    function setCallFee(uint256 _fee) public onlyManager {
        require(_fee <= MAX_CALL_FEE, "!cap");
        
        callFee = _fee;
        mermaidFee = MAX_FEE - STRATEGIST_FEE - callFee;
    }
...
// File: contracts/MERMAID/strategies/Aave/StrategyAaveAvalanche.sol
...
contract StrategyAaveSupplyOnly is StratManager, FeeManager {
    ...
    constructor(
        ...
        address _strategist,
        address _mermaidFeeRecipient
    ) StratManager(_keeper, _strategist, _unirouter, _vault, _mermaidFeeRecipient) public {
        want = _want;
        native = _native;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 mermaidFeeAmount = nativeFeeBal.mul(mermaidFee).div(MAX_FEE);
        IERC20(native).safeTransfer(mermaidFeeRecipient, mermaidFeeAmount);
