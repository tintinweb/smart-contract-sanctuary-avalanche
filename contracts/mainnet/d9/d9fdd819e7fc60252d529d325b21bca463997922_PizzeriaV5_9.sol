...
interface IPizzeriaProgressionV4_12 {
...
contract PizzeriaV5_9 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Constants
    ...
    IPizzeriaProgressionV4_12 public pizzeriaProgression;
    IMafia_12 public mafia;
    ...
    function initialize(Chef _chef, Upgrade _upgrade, Pizza _pizza, Soda _soda, address _freezerAddress, address _pizzeriaProgression) public initializer {
        ...
        pizzeriaProgression = IPizzeriaProgressionV4_12(_pizzeriaProgression);
    ...
    function resetFatigue() public {
        ...
        uint256 costToReset = getTotalPPM(_owner) * sodaResetCost * pizzeriaProgression.getMasterChefSkillModifier(_owner, masterChefNumber) * (100 + masterChefNumber * masterChefMultiplicationBonus)/10000;
