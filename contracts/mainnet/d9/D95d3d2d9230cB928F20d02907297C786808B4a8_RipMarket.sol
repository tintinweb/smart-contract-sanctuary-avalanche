...
/**
 The only way to get into the chat is to be a holder. Buy minimum of 0.5 AVAX and send a transaction hash to @ripmarketdev on Telegram to get access to the private chat. I'll respond in 6hours max so just be patient.  Thank you
*/
...
contract RipMarket is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x515CE9d5Ed6cC93cd9edE2362A88231A51a2bBfD; //liq address
    address public marketingFeeReceiver=0x67A49807eB4B1eB2e733B8E4D0A041448f5CC55C; // marketing address
