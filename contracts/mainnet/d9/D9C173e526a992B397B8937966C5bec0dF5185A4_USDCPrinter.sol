...
// Dependency file: contracts/baby/USDCPrinterDividendTracker.sol
...
contract USDCPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main USDCPrinter contract."
        );
    }
...
// Root file: contracts/baby/USDCPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/USDCPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract USDCPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    USDCPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = USDCPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "USDCPrinter: The dividend tracker already has that address"
        );

        USDCPrinterDividendTracker newDividendTracker = USDCPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "USDCPrinter: The new dividend tracker must be owned by the USDCPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "USDCPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "USDCPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "USDCPrinter: The PanUSDCSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "USDCPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "USDCPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "USDCPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialUSDCBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );
    ...
    function withdrawStuckTokens(address stuckTokenAddress) external onlyOwner {
        uint256 amount = IERC20(stuckTokenAddress).balanceOf(address(this));
        IERC20(stuckTokenAddress).transfer(owner(), amount);
    }
}