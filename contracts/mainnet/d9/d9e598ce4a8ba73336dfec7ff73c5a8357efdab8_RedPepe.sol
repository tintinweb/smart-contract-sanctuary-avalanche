...
//Welcome to Red Pepe - memecoin fun on Avax 
//https://t.me/+EQgWrvKSLco1NGVk
...
contract RedPepe is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 69420 * 10 **12 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'RedPepe';
    string private _symbol = 'RPEPE';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 8;
    uint256 private _maxTxAmount = 69420 * 10 **12 * 10**18;
