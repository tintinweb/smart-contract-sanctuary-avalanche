...
contract ETHBondDepositoryV2 is Ownable {
    ...
    function deposit( 
        ...
        require( payout >= 1000, "Bond too small" ); // must be > 0.01 BIG ( underflow protection )
    ...
    function bondPrice() public view returns ( uint price_ ) {        
        price_ = terms.controlVariable.mul( debtRatio() ).add(1000000000) / 1e5;
    ...
    function bondPriceInUSD() public view returns ( uint price_ ) {
        price_ = bondPrice().mul( 10 ** IWETH9(principle).decimals() ) / 100;
    }
