...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xE634406Ac50073132E905b12f67953Ba5f813ce2);
    address WAVAX = 0xE634406Ac50073132E905b12f67953Ba5f813ce2;
    IDEXRouter router;
...
contract Arial is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xE634406Ac50073132E905b12f67953Ba5f813ce2; // avax
    address public WAVAX = 0xE634406Ac50073132E905b12f67953Ba5f813ce2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Arial";
    string constant _symbol = "Arial";
    ...
    address public autoLiquidityReceiver=0xE634406Ac50073132E905b12f67953Ba5f813ce2;
    address public marketingFeeReceiver=0xE634406Ac50073132E905b12f67953Ba5f813ce2;
