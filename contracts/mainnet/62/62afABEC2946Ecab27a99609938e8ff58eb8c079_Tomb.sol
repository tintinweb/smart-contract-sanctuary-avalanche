...
contract Tomb is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 5000 ether;
    uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 17000 ether;
    ...
    function setMaxTxAmount(uint256 _amount) public onlyOperator {
        _setMaxTxAmount(_amount);
    }

    /**
     * @notice Constructs the TOMB ERC-20 contract.
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("EWAND", "EWAND") {
