...
//| $$  | $$  \  $$$/  | $$  | $$ /$$/\  $$  | $$  | $$  | $$| $$  | $$| $$     | $$      | $$| $$  | $$  | $$ /$$
//| $$  | $$   \  $/   | $$  | $$| $$  \ $$ /$$$$$$| $$  | $$|  $$$$$$/| $$     | $$      | $$| $$  | $$  |  $$$$/
//|__/  |__/    \_/    |__/  |__/|__/  |__/|______/|__/  |__/ \______/ |__/     |__/      |__/|__/  |__/   \___/  
                                                                                                                                                                                                                                                                                                                                        
//  Stealth Launch
//  Telegram: https://t.me/AvaxInuPrint
//  Website: avaxinuprint.xyz (Coming soon)
//  Reward: $USDC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // reward address ETHP
...
contract AVAXInuPrint is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // reward ETHP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAXINUPrint";
    string constant _symbol = "AVAXIP";
    ...
    address public autoLiquidityReceiver=0xa4B9D095aDBa6B09b7C19562c06f34C3bddE11e4; //liq address
    address public marketingFeeReceiver=0xa4B9D095aDBa6B09b7C19562c06f34C3bddE11e4; // marketing address
