...
/**
 *#KOIDAO
Total fee buy/sell : 12%

 Telegram: https://t.me/KOIDAOAVAX

 twitter: https://twitter.com/KOIDAOAVAX
*/
...
contract KOIDAOAVAX is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = " KOI DAO AVAX";
    string private constant _symbol = " KoiDao ";
