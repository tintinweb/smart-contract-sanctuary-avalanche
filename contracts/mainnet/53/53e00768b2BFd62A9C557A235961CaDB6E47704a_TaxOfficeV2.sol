...
contract TaxOfficeV2 is Operator {
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtMoka, resultAmtToken, liquidity) = IJoeRouter02(uniRouter).addLiquidity(
            moka,
            token,
            amtMoka,
            amtToken,
        ...
        )
    {
        ...
        uint256 liquidity;
        (resultAmtMoka, resultAmtEth, liquidity) = IJoeRouter02(uniRouter).addLiquidityAVAX{value: msg.value}(
            moka,
            amtMoka,
            amtMokaMin,
            amtEthMin,
