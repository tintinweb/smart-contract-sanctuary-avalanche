...
// File contracts/message/apps/SwapBase.sol
...
// File contracts/message/apps/TransferSwapV2.sol
...
// File contracts/message/apps/TransferSwapV3.sol
...
// File contracts/message/apps/TransferSwapInch.sol
...
// File contracts/message/apps/SwapMain.sol
...
contract SwapMain is TransferSwapV2, TransferSwapV3, TransferSwapInch {
    ...
    function executeMessageWithTransferFallback(
        ...
        bytes32 id = SwapBase._computeSwapRequestId(m.receiver, _srcChainId, uint64(block.chainid), _message);
        if (m.swap.version == SwapVersion.v3) {
            _sendToken(address(_getFirstBytes20(m.swap.pathV3)), _amount, m.receiver, false);
        } else {
