...
contract ScrewCancer is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Screw Cancer", "SCRW") KindaRandom(21) {
    _customBaseURI = "https://nfts.bpi.network/screw_cancer/";
    _maxMintable = 21; // 21 max supply
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 1;
    _price = 1 ether;
    _startTime = 1670354100;
    
    _artist = 0xBed26007f534FBCaA5aB217f4Eda1d33b3BbF958; // royalty wallet

    _privateMint(0x9cC0e70F1acd736aA0f75d1Da46493FFE101F6c5);
  }
