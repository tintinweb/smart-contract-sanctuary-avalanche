...
contract Testgoat is ERC721 {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 2) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibaappvbmkthgwbqts6vrujgvctq5xzadz7yz6nr5dofvwruvedq4/", Strings.toString(tokenId), ".json")
            );
    }
