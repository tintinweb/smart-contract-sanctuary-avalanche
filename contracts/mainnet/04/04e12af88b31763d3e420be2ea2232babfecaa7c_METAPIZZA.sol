...
telegram group is private for 15 minutes post launch
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x6121191018BAf067c6Dc6B18D42329447a164F05);
...
contract METAPIZZA is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0x6121191018BAf067c6Dc6B18D42329447a164F05;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MetaPizza";
    string constant _symbol = "METAPIZZA";
    ...
    address public autoLiquidityReceiver = 0x317fdaeA9F6C9366a384e706ED849F85FAFe55fe;

    address public marketingFeeReceiver = 0x317fdaeA9F6C9366a384e706ED849F85FAFe55fe;
