...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract ApeBurn is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ApeBurn", "APEB") {
      ...
      //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7E3411B04766089cFaa52DB688855356A12f05D1); // huricane swap test net
        ...
        marketingWallet = 0xb2f6B463cdbF31febfbEE37C53eBdBF3c7BC1694; // set as marketing wallet
        burnWallet = 0x30bF29f235eBA9C0BDCAf46831A1887e4817d82a; // set as burn wallet
