...
contract StakePumpskin is Ownable, PermissionsEnumerable, ReentrancyGuard {
    ...
    uint256 public BASE_HOLDER_PIES = 40000000000000000000;
    ...
    // Constructor
    // constructor(address _pumpskinContract) ERC20(TOKEN_NAME, TOKEN_SYMBOL) {
    //     PUMPSKIN_CONTRACT = _pumpskinContract;
    // }
    ...
    constructor(IERC721 _pumpskinCollection, TokenERC20 _pieToken) {
        ...
        _setupRole(TRANSFER_ROLE, address(0));
        // pumpskinCollection = _pumpskinCollection;
        // pieToken = _pieToken;
        ...
        returns (uint256[] memory)
    {
        ...
        for (uint256 i = 0; i < stakedPumpskins.length; i++) {
            ...
            if (pumpskin.kg > 0 && pumpskin.staker == user) {
                tokenIds[counter] = i;
                counter++;
            }
        }
