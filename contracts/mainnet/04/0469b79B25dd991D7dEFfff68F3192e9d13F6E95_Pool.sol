...
contract Pool is Ownable, ReentrancyGuard {
    ...
    uint256 public priceTarget = 1e16; // = 1; 1 TAvax pegged to the value of 0.01 ETH
    uint256 public priceBand = 5e13; // = 0.00005; CR will be adjusted if TAvax > 0.01005 ETH or TAvax < 0.00995 ETH
    ...
    uint256 public constant pegRatio = 100;
        ...
        )
    {
        ...
        _xTokenOut = _ethIn * pegRatio - ((_ethIn * mintingFee * pegRatio) / PRECISION);
    }
        ...
        )
    {
        ...
        _requiredEthBalance = (_xTokenIn * collateralRatio) / PRECISION / pegRatio;
