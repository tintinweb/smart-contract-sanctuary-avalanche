...
contract NexusERC20 is ERC20, Ownable {
    ...
    bool public useAntiWhale;

    uint256 public antiWhaleAmount = 100 * (10**decimals());
    ...
    function toggleUseAntiWhale() external onlyOwner {
        useAntiWhale = !useAntiWhale;
    }

    function setAntiWhaleAmount(uint256 amount) external onlyOwner {
        ...
        whenNotBlacklisted(recipient)
    {
        ...
        if (useAntiWhale) {
            require(
                ...
                "NexusERC20: anti-whale mechanism in use"
            );
        }
        ...
        if ((recipient == pair) && !isTaxFree[sender] && taxEnabled) {
            if (useAntiBot) {
                ...
                require(
                    ...
                    "NexusERC20: anti-bot mechanism in use"
                );
            }

            require(
                taxReceiver != address(0),
                "NexusERC20: tax receiver not set"
            );
