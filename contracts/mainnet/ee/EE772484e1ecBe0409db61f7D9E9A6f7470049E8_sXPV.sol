...
contract sXPV is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sXPV", "sXPV", 9) ERC20Permit() {
    ...
    /**
        @notice increases SXPV supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess SXPV
