...
import "./interfaces/IAvaxburn.sol";
...
contract FeesManagerLogic is Ownable {
    ...
    IAvaxburn public avaxburnContract;
    address public avaxburnAddress;
    ...
    function estimateFees(
        ...
        require(_msgSender() == avaxburnAddress, "Not Avaxburn contract");
    ...
    function updateAvaxburnAddress(address _newAddr) external onlyOwner {
        avaxburnContract = IAvaxburn(_newAddr);
        avaxburnAddress = _newAddr;
    }
}
