    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xa5Fdf937529B682EeB0b239FCb2Eaf0D558B53bf;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("AVAX Potluck Realm Necromancers", "PRNC") ClampedRandomizer(maxSupply) {     
