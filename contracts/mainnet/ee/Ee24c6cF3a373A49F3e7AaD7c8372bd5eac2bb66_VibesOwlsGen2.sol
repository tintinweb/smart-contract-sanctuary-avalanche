...
// File: contracts/VibesOwlsGen2.sol
...
contract VibesOwlsGen2 is ERC721A, Ownable, ReentrancyGuard {

  using Strings for uint256;

  string public uriPrefix = 'ipfs://QmfZoLwFzypjxTjRMip9DEDceR667PYnNw942s8dAq7TDn/';
  ...
  constructor() ERC721A("VibesOwlsGen2", "owls") {
  }
