...
contract CoyotesSpecials is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeierlilmlhk7w2wrb6krmvbv4tdhycee44mwdtknl5ofpuosobbbj4/", Strings.toString(tokenId), ".json")
            );
    }
