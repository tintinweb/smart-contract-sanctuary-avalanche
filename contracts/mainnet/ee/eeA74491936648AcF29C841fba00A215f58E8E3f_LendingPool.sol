...
contract $LendingPool is LendingPool {
    ...
    constructor(string memory _name, string memory _symbol, IERC20 _asset, bool _isNativeAsset, uint256 _protocolFee, uint256 _maxCapacity, ILendingPoolConfig _lendingPoolConfig, address _treasury) LendingPool(_name, _symbol, _asset, _isNativeAsset, _protocolFee, _maxCapacity, _lendingPoolConfig, _treasury) {}
    ...
    function $_to18ConversionFactor() external view returns (uint256 ret0) {
        (ret0) = super._to18ConversionFactor();
    }
