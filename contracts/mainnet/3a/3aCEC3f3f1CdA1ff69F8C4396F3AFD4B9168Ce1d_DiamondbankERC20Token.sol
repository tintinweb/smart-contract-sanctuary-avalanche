...
contract DiamondbankERC20Token is ERC20Permit, VaultOwned {
    ...
    constructor(address _treasury, address uniV2Router) ERC20("DiamondBank", "DB", 9) {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "FNFT: Account is already the value of 'excluded'");
    ...
    function updateuniV2RouterAddr(address _uniV2Router) public onlyOwner {
        IJoeRouter02 _uniswapV2Router = IJoeRouter02(_uniV2Router);
        address _uniswapV2Pair = IJoeFactory(_uniswapV2Router.factory())
        .createPair(address(this), _uniswapV2Router.WAVAX());
