...
contract StormWAVE is IERC20, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    // token data
    string private constant _name = "Storm.Money WAVE";
    string private constant _symbol = "stormWAVE";
