...
//in this function mu is token0
    ...
    function get_mu_avax_usdc_pool_info() public view returns (address LPpool, address avax_token0, address usdc_token1, uint112 _reserve0,uint112 _reserve1, uint256 avaxUSDC, uint32 _blockTimestampLast){
