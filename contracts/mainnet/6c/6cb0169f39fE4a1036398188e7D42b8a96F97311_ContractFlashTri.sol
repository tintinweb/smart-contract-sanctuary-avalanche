...
contract ContractFlashTri {
    ...
    address private constant MIM = 0x130966628846BFd36ff31a822705796e8cb8C18D;
    address private constant JOE = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd;
    address private constant HUSKY = 0x65378b697853568dA9ff8EaB60C13E1Ee9f4a654;
    ...
    function triangularArbitrage(
        ...
        if (_tokens[0] != WAVAX && _tokens[1] != WAVAX && _tokens[2] != WAVAX) {
            ...
            _tokens[0] != MIM && _tokens[1] != MIM && _tokens[2] != MIM
        ) {
            dummyToken = MIM;
        } else if (
            _tokens[0] != HUSKY && _tokens[1] != HUSKY && _tokens[2] != HUSKY
        ) {
            dummyToken = HUSKY;
        } else if (
            _tokens[0] != DAIE && _tokens[1] != DAIE && _tokens[2] != DAIE
        ) {
            dummyToken = DAIE;
        } else if (
        ...
        // Passing data triggers panHUSKYCall as this is what constitutes a loan
