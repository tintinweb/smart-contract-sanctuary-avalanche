...
// Welcome to AVAXp, the AVAX Printer on AVAX Blockchain
// Earn USDC by holding AVAXp
// Tokenomics : USDC reflection : 6% 
//              liquidity : 2%
//              marketing and buyback wallet : 2%
// Telegram : https://t.me/AVAXPRINTERBRRR
// Twitter :  https://twitter.com/DAvaxprinter
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // USDC
...
contract AvaxPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVAXPrinter";
    string constant _symbol = "AVAXp";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(15); // 6.66%
    uint256 public _maxWallet = _totalSupply.div(15); // 6.66%
    ...
    address public autoLiquidityReceiver=0x3DC49B7f3c8Ae18730cab39e9ed27F688AACc141; //liq address
    address public marketingFeeReceiver=0x3DC49B7f3c8Ae18730cab39e9ed27F688AACc141; // marketing address
