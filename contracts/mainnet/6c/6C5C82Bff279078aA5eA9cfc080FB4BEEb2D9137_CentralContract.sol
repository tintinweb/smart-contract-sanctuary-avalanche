...
interface IOriginalTokenVault {
	 ...
	 * @param _nonce user input to guarantee unique depositId
	 */
	function depositNative(uint256 _amount, uint64 _mintChainId, address _mintAccount, uint64 _nonce) external payable;
...
contract CentralContract is MessageApp {
	...
	function sendUserIntent(
		...
		emit IntentUser(from, to, token, dstChainId, amount, value, data);
	}
