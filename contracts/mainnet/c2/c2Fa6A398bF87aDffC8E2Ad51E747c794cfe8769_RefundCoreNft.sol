...
contract RefundCoreNft is Ownable {
    //Deploy todo: go to wavax contract address and approve 479~ wavax to be used by this contract FROM the treausury
    uint private totalWavaxToRefund = 479454381600000000000;

    uint public seedRefundAmount = 467658250000000000; //0.468~
    uint public saplingRefundAmount = 935316499000000000; //0.935~
    uint public treeRefundAmount = 2338291249000000000; //2.338~
