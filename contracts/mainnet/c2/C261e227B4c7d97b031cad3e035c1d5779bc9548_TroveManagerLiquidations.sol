...
contract TroveManagerLiquidations is TroveManagerBase, ITroveManagerLiquidations {
    ...
    event InterestApplied(address _borrower, uint256 _YUSDFromInterest);
    ...
    function _liquidateNormalMode(
        ...
        uint256 pendingYUSDInterestReward;
        (
        ...
        troveManager.removeStakeAndCloseTrove(_borrower, 3);
    ...
    function _movePendingTroveRewardsToActivePool(
        IActivePool _activePool,
        IDefaultPool _defaultPool,
        uint256 _YUSDFromDefaultPool,
        uint256 _YUSDFromInterest,
        address[] memory _tokens,
        uint256[] memory _amounts,
        address _borrower
    ) internal {
        emit InterestApplied(_borrower, _YUSDFromInterest);
        _defaultPool.decreaseYUSDDebt(_YUSDFromDefaultPool);
        _activePool.increaseYUSDDebt(_YUSDFromDefaultPool.add(_YUSDFromInterest));
