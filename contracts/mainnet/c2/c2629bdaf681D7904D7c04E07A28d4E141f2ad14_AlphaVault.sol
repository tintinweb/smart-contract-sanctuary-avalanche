...
contract AlphaVault is ERC20, Ownable {
    ...
    function deposit(uint256 _amount, bytes calldata _signature) external {
        ...
        require((_amount >= 1 * 10**6) && (_amount <= 50000 * 10**6), "Out of limits");
        ...
        require(verify(signedMessage, _signature, signer), "Not allowed");
    ...
    function stop(uint16 fromChainId, bool forceAsync) external payable onlyManagerOwner {
