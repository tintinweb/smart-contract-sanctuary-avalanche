...
contract LegitimatePhygitalNFTv3 is ERC721Royalty, ERC721Enumerable, AccessControl {
    ...
    constructor() ERC721("LGTOPSumoLegendaryDrop", "OPSumoLegendary") {
    ...
    // IPFS folder using an HTTP gateway or other HTTP server that holds NFT metadata in the form of
