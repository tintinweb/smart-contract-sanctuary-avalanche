...
contract Token is ERC20Burnable, Operator {
    ...
    function _transfer(
        ...
        require(sender != address(0), "PegHub: transfer to the zero address");
        require(recipient != address(0), "PegHub: transfer to the zero address");
...
// File contracts/Tokens/SnowLINKToken.sol

pragma solidity 0.6.12;

contract SnowLINKToken is Token {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
        ...
        // Initial distribution for the first 24h genesis pools
        INITIAL_GENESIS_POOL_DISTRIBUTION = 21000 ether;
