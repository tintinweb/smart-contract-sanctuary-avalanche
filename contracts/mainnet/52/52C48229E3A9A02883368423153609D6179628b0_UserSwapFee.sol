...
// File: contracts/interfaces/IPriceFeedData.sol
...
// File: contracts/UserSwapFee.sol
...
contract UserSwapFee is Ownable {
    ...
    function userStakingPriceUSD(address _pool, address _user) external view returns (uint256)
    {
        uint256 price = _userStakingPriceUSD(_pool, _user);
        return price;
    }
