...
contract contractRandom is Ownable, IERC721Receiver{
    ...
    function getRandomised() public view returns (uint256) {
        return _randomised;
    }
    ...
    function enoughRandom() onlyOwner external{
    ...
    function getRandom(uint256 timestamp, address sender) public view returns (uint256) {
