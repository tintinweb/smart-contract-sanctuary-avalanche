...
contract WETHAVAXVTX is CoreStrategyAave {
    using SafeERC20 for IERC20;

    // Find rewarder farmMasterChef -> masterVtx.addressToPoolInfo(farmMasterChef.stakingToken).rewarder
    address constant rewarder = 0x086D2B19d5701Dcc42335Fc98d7350B8b07Cee86;
    address incentives = 0x929EC64c34a17401F460460D4B9390518E5B473e; // Aave Rewards Controller
