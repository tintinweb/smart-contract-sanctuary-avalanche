...
OUR TELEGRAM IS SET TO PRIVATE AT 100 MEMBERS TO SUSTAIN A HEALTHY PRICE FLOOR

EVERYONE IN OUR TELEGRAM MUST REVEAL WHICH WALLET BELONGS TO THEM. 

THOSE WHO SELL WILL BE REMOVED FROM THE GROUP 

TELEGRAM GOES PUBLIC IN 1 HOUR

t.me/PolarNodeCapital
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
...
contract PolarNodeCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address REWARDS = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB; // reflects
    ...
    string constant _name = "Polar Node Capital";
    string constant _symbol = "PNC";
    ...
    address public autoLiquidityReceiver = 0x94de78A4725a544529284447ae7596F7c977Da36;
    address public marketingFeeReceiver = 0x94de78A4725a544529284447ae7596F7c977Da36;
