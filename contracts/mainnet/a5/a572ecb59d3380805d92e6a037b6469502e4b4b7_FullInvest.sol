...
// SPDX-License-Identifier: MIT 
 ...
 /*   Fullinvest.io - investment platform based on Polygon blockchain smart-contract technology. Safe and legit!
 ...
 *   2) Choose one of the tariff plans, enter the MATIC amount to stake (5 MATIC minimum) using our website's "Invest Now" button in any of the plans
 *   3) Wait for your earnings
 *   4) Withdraw earnings any time using our website's "Withdraw" button
 *
 *   [INVESTMENT CONDITIONS]
 *
 *   - Basic interest rate: +0.5% every 24 hours (~0.02% hourly) - only for new deposits
 *   - Minimal deposit: 5 MATIC, no maximum limit
...
contract FullInvest {
	...
	uint256[] public REFERRAL_PERCENTS = [80, 10, 5];
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(180, 7));
        plans.push(Plan(360, 10));
        plans.push(Plan(540, 15));
	}

	function invest(address referrer, uint8 plan) public payable {
		require(block.timestamp > startUNIX, "***** NOT LAUNCHED YET *****");
		require(msg.value >= INVEST_MIN_AMOUNT, "***** THE MIN AMOUNT IS 1 AVAX *****");
