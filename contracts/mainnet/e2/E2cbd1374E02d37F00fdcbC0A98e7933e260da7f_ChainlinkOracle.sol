...
contract $ChainlinkOracle is ChainlinkOracle {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor() {}

    function $_chainlinkIsBroken(ChainlinkOracle.ChainlinkResponse calldata _currentResponse,ChainlinkOracle.ChainlinkResponse calldata _prevResponse,address _token) external view returns (bool ret0) {
        (ret0) = super._chainlinkIsBroken(_currentResponse,_prevResponse,_token);
    }

    function $_badChainlinkResponse(ChainlinkOracle.ChainlinkResponse calldata _response) external view returns (bool ret0) {
        (ret0) = super._badChainlinkResponse(_response);
    }

    function $_chainlinkIsFrozen(ChainlinkOracle.ChainlinkResponse calldata _response,address _token) external view returns (bool ret0) {
        (ret0) = super._chainlinkIsFrozen(_response,_token);
    }

    function $_badPriceDeviation(ChainlinkOracle.ChainlinkResponse calldata _currentResponse,ChainlinkOracle.ChainlinkResponse calldata _prevResponse,address _token) external view returns (bool ret0) {
        (ret0) = super._badPriceDeviation(_currentResponse,_prevResponse,_token);
    }

    function $_getChainlinkResponse(address _feed) external view returns (ChainlinkOracle.ChainlinkResponse memory ret0) {
        (ret0) = super._getChainlinkResponse(_feed);
    }

    function $_getPrevChainlinkResponse(address _feed,uint80 _currentRoundId) external view returns (ChainlinkOracle.ChainlinkResponse memory ret0) {
        (ret0) = super._getPrevChainlinkResponse(_feed,_currentRoundId);
    }
