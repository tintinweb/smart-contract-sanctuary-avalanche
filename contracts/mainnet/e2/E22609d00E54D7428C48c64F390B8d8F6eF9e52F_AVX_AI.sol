...
contract AVX_AI is ERC20, ERC20Burnable, Ownable {
    ...
    constructor()
        ERC20(unicode"AVX AI", unicode"AVAAI") 
    {
        address supplyRecipient = 0x844fFf7bBc62837B04889070Ff3649e08EFF4a11;
        
        autoBurnFeesSetup(50, 50, 0);

        updateSwapThreshold(55000 * (10 ** decimals()));
        ...
        _mint(supplyRecipient, 710000000 * (10 ** decimals()));
        _transferOwnership(0x844fFf7bBc62837B04889070Ff3649e08EFF4a11);
    }
