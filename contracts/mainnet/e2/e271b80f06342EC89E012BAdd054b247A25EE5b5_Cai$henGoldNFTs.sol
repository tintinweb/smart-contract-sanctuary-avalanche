...
/*
   _____      _     _                  ______ _                            
  / ____|    (_)   | |                |  ____(_)                           
 | |     __ _ _ ___| |__   ___ _ __   | |__   _ _ __   __ _ _ __   ___ ___ 
 | |    / _` | / __| '_ \ / _ \ '_ \  |  __| | | '_ \ / _` | '_ \ / __/ _ \
 | |___| (_| | \__ \ | | |  __/ | | | | |    | | | | | (_| | | | | (_|  __/
  \_____\__,_|_|___/_| |_|\___|_| |_| |_|    |_|_| |_|\__,_|_| |_|\___\___|
...
contract Cai$henGoldNFTs is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
...
// ================== Variables Start =======================
  ...
  uint256 public wlsupplyLimit = 50;
  uint256 public maxMintAmountPerTx = 50;
  uint256 public wlmaxMintAmountPerTx = 50;
  ...
  address royaltyAddress = 0x98Caf54EE33D9Ee625344eA5c3929536146bE704;  
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("Cai$hen Gold NFT", "CGNF")  {
    seturi(_uri);
    setRoyaltyInfo(royaltyAddress, royaltyFraction);
  }
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
      ...
      payable(0x98Caf54EE33D9Ee625344eA5c3929536146bE704 ).transfer(balance * 85 / 100); // 1
      payable(0x98Caf54EE33D9Ee625344eA5c3929536146bE704 ).transfer(balance * 15 / 100); // 2
  }
...
// ================== Read Functions Start =======================
  ...
  event avaxReceived(address, uint);
    receive() external payable {
        emit avaxReceived(msg.sender, msg.value);
    }
