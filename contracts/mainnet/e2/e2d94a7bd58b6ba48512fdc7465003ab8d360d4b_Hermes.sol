...
Hermes : Half Brother of Kratos

Hermes is a Project Launched Under Kratos Inu Launchpad. 100% Safe, Rug Free & Organic Projects.
...
AntiWhale :
      -2% max buy TRX (will slowly be increased to 5%)
      -2% max Wallet (will slowly be increased to 5%)
...
contract Hermes is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x7dde1b5A34E4dF47d1C48f05DF09Cf70CbDa462d; //liq address
    address public marketingFeeReceiver=0x7dde1b5A34E4dF47d1C48f05DF09Cf70CbDa462d; // marketing address
