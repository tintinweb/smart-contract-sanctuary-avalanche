...
contract XEQ is ERC20, ERC20Permit, ERC20Burnable, ERC20Snapshot, ExternalAccessible, Ownable, Pausable, ERC20Votes, ERC20FlashMint {
    constructor(address _accessContract) ERC20("XEQ", "aXEQ") ERC20Permit("XEQ") {
    ...
    function mint(address to, uint256 amount) public hasAccess {
        _mint(to, amount);
    }
...
library FixedPointMath {
  ...
  function maximumValue() internal pure returns (FixedDecimal memory) {
    return FixedDecimal(uint256(115792089237316195423570985008687907853269984665640564039457584007913129639935));
  }
