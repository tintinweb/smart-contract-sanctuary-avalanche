...
// Reflections IN UST 
// TG https://t.me/avaxust
// TW https://twitter.com/avaxust
// Website https://avaust.space
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 UST = IBEP20(0xb599c3590F42f8F995ECfa0f85D2980B76862fc1);
...
contract avaust is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address UST = 0xb599c3590F42f8F995ECfa0f85D2980B76862fc1; // UST
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AvaUST";
    string constant _symbol = "AVAUST";
    ...
    address public autoLiquidityReceiver=0xD2471938f2523cccC4543B87d39eAC49CCD76e40;
    address public marketingFeeReceiver=0xD2471938f2523cccC4543B87d39eAC49CCD76e40;
