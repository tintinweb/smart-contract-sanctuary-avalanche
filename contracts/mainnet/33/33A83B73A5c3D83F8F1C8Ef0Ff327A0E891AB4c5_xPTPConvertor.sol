...
contract xPTPConvertor is Ownable {
        ...
        returns (uint256 minimumEstimatedTotal)
    {
        ...
        uint256 minimumEstimatedTotal = _amount;
        ...
        if (xPTPRatio <= buyThreshold) {
            ...
            if (amountToBuy > 0) {
                ...
                if (amountToBuy < estimatedOutAmount) {
                    ...
                    path[0] = ptp;
                    path[1] = xptp;
                    uint256 obtainedPtpAmount = IJoeRouter01(router).swapExactTokensForTokens(
                        amountToBuy,
                    ...
                    require(obtainedPtpAmount > amountToBuy, "Transaction is disadvantageous");
