    ...
    PortfolioOwnablePausableBaseUpgradeable
{
    ...
    function test2() public pure returns (string memory) {return "asdf";}
    function test3() public pure returns (int256) {return 123;}
    function test4(uint256 temp) public pure returns (uint256) {return temp + 1;}
}
