...
*/
  constructor() ERC721("BlindCollections", "BCN")  public {
      _setOwner(msg.sender);
    _allowAddress[msg.sender] = true;
    _allowAddress[0x23f1E33F614345cAac21C24d05DfBFbda0b0aAF6] = true;
    // baseURI = "https://testapi.xanalia.com/xanalia/get-nft-meta?tokenId=";
    baseURI = "https://api.xanalia.com/blindBox/get-nft-metaData?chain=avalanche&collectionId=";
  }
modifier isValid() {
