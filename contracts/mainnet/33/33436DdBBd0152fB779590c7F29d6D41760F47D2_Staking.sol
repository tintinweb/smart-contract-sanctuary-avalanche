...
abstract contract GlobalsAndUtils {
    ...
    modifier allowedClaim() {
        require(ON_COOLDOWN == true || campaigns[latestCampaignId].startTime > block.timestamp, "Campaign on going");
...
/**
    ...
    function _unStake(uint256 _stakeId) private {
        ...
        emit UnstakeEvent(unStakes[msg.sender][_stakeId], _stakeId);
    }
    ...
    /************* Events **************/
    /**********************************************************/
    event UnstakeEvent(UnStake unstakeDetail, uint256 stakeId);
