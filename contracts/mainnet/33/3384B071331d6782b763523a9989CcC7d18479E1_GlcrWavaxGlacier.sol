...
// File contracts/GlcrWavaxGlacier.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract GlcrWavaxGlacier  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IGlacierRouter(router).addLiquidity(glcr, wavax, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
