...
// File: contracts/NativeRockCollection.sol
    ...
    contract NativeRock is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 1000000000000000000; // 1.00 ETH 
      uint256 public constant maxTokenPurchase = 66;
      uint256 public constant MAX_TOKENS = 6666;
    
      string public baseURI = ""; // IPFS URI WILL BE SET AFTER 66 TOKENS SOLD OUT
      ...
      uint256 public presaleMaxMint = 66;
      uint256 public devReserve = 66;
    
      event NativeMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("NativeRock", "NR") {}
      ...
      function mintNative(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit NativeMinted(id, msg.sender);
          }
        }
      }
    
      function presaleNative(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmW2eGAAH4LmLCqFaSR4NdHWNcUN6RNGFMTidyLwu8egaK/hidden.json";
        }
