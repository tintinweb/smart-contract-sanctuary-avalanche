...
library UniswapV2OneSidedUsingUniV2 {
        ...
        )
    {
        ...
        if (oneSideTokenAmount > 0) {
            ...
            (uint256 _idealAmount0, uint256 _idealAmount1, uint256 _liquidity) = _addLiquidityFromSingleToken(
    ...
    function _addLiquidityFromSingleToken(AddLiquidityFromSingleTokenParams memory params, bool ignoreErrors)
        internal
        returns (
            uint256 amountA,
            uint256 amountB,
    ...
    {
        return _addLiquidityFromSingleToken(params, false);
    }
}
