  ...
  function create(
    ...
    */
    ...
    function uri(
        ...
        require(_currentTokenID>_id, "NONEXISTENT_TOKEN");
...
library Strings {
  ...
  function strConcat5(string memory _a, string memory _b, string memory _c, string memory _d, string memory _e) internal pure returns (string memory) {
    ...
    function strConcat2(string memory _a, string memory _b) internal pure returns (string memory) {
        return strConcat5(_a, _b, "", "", "");
    }
