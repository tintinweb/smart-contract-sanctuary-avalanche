...
contract AstroToken is ERC20Detailed {
    ...
    address public convertTo = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
    ...
    */
    ...
    constructor(address _router, address _usdcAddress) ERC20Detailed("100 Days Ventures", "preASTRO", uint8(DECIMALS)) {
        ...
        //address pairUSDC = IDEXFactory(router.factory()).createPair(address(this), convertTo);
    ...
    function _swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        uint256 newBalance = IERC20(usdcAddress).balanceOf(address(this)) - (initialBalance);
    ...
    function swapBack() internal swapping {
        ...
        IERC20 toToken = IERC20(usdcAddress);
        ...
        toToken.transfer(operationsReceiver, amountToOperation);
        toToken.transfer(xASTROReceiver, amountToxASTRO);
        toToken.transfer(futureEcosystemReceiver, amountToEcosystem);
