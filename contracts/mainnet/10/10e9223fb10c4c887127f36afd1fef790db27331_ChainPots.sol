...
contract ChainPots {
    ...
    uint256 public dailyPotEntryPrice = 0.1 ether;
    ...
    uint256 public silverLotteryEntryPrice = 0.25 ether;
    uint256 public silverLotteryPotMaxAmount = 2.5 ether;
    uint256 public silverLotteryMaxEntries = 10;
    bool public silverLotteryIsLive = true;

    address payable[] public playersGoldLottery;
    uint256 public goldLotteryEntryPrice = 1 ether;
    uint256 public goldLotteryPotMaxAmount = 10 ether;
    uint256 public goldLotteryMaxEntries = 10;
    bool public goldLotteryIsLive = false;

    address payable[] public playersDiamondLottery;
    uint256 public diamondLotteryEntryPrice = 5 ether;
    uint256 public diamondLotteryPotMaxAmount = 50 ether;
    ...
    uint256 public silverBattleEntryPrice = 0.5 ether;
    uint256 public silverBattlePotMaxAmount = 1 ether;
    uint256 public silverBattleMaxEntries = 2;
    bool public silverBattleIsLive = true;

    address payable[] public playersGoldBattle;
    uint256 public goldBattleEntryPrice = 1 ether;
    uint256 public goldBattlePotMaxAmount = 2 ether;
    uint256 public goldBattleMaxEntries = 2;
    bool public goldBattleIsLive = false;

    address payable[] public playersDiamondBattle;
    uint256 public diamondBattleEntryPrice = 5 ether;
    uint256 public diamondBattlePotMaxAmount = 10 ether;
