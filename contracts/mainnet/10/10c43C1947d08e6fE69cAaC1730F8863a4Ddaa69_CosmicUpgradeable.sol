...
*/
contract CosmicUpgradeable is Initializable, ERC20Upgradeable, PausableUpgradeable, AccessControlUpgradeable,
ERC20PermitUpgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable, TokenConstants {
    ...
    function initialize() initializer public {
        __ERC20_init("Cosmic", "COSMIC");
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("Cosmic");
