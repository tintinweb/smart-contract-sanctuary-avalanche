...
contract PXTV9 is ERC20Upgradeable, IBridgeToken {
    // STRINGS
    ...
    mapping(address => uint32) public lastTimestampSell; // Last time to sell for auto rated claim
    ...
    function _beforeTransferCheck(
        ...
        // records last timestamp to sell
        if(automatedMarketMakerPairs[to]) {
            lastTimestampSell[from] = uint32(block.timestamp);
        }
