...
// File: contracts/interface/INFTMarketplaceRoyalty.sol


pragma solidity =0.8.9;

interface INFTMarketplaceRoyalty {
    ...
    // Who can set: ERC721 owner and NFTMarketplace owner
    event SetRoyalty(
        address indexed erc721Address,
...
// File: contracts/NFTMarketplaceRoyalty.sol


pragma solidity =0.8.9;


contract NFTMarketplaceRoyalty is INFTMarketplaceRoyalty, Ownable {
 ...
 * Note: Payment tokens usually is the chain native coin's wrapped token, e.g. WAVAX
 */
contract NFTMarketplace is
    INFTMarketplace,
    Ownable,
    NFTMarketplaceRoyalty,
    ReentrancyGuard
{
    using Address for address;
    ...
    /**
     * @dev See {INFTMarketplace-listToken}.
    ...
    /**
     * @dev See {INFTMarketplace-delistToken}.
    ...
    /**
     * @dev See {INFTMarketplace-buyToken}.
    ...
    /**
     * @dev See {INFTMarketplace-enterBidForToken}.
    ...
    /**
     * @dev See {INFTMarketplace-withdrawBidForToken}.
    ...
    /**
     * @dev See {INFTMarketplace-acceptBidForToken}.
    ...
    /**
     * @dev See {INFTMarketplace-isTradingEnabled}.
     */
    ...
    /**
     * @dev See {INFTMarketplace-getTokenListing}.
     */
    function getTokenListing(address erc721Address, uint256 tokenId)
        public
        view
    ...
    /**
     * @dev See {INFTMarketplace-numTokenListings}.
     */
    function numTokenListings(address erc721Address)
        public
        view
    ...
    /**
     * @dev See {INFTMarketplace-getTokenListings}.
     */
    function getTokenListings(
        address erc721Address,
        uint256 from,
    ...
    /**
     * @dev See {INFTMarketplace-getBidderTokenBid}.
     */
    function getBidderTokenBid(
        address erc721Address,
        uint256 tokenId,
    ...
    /**
     * @dev See {INFTMarketplace-getTokenBids}.
     */
    function getTokenBids(address erc721Address, uint256 tokenId)
        external
        view
    ...
    /**
     * @dev See {INFTMarketplace-getTokenHighestBid}.
     */
    function getTokenHighestBid(address erc721Address, uint256 tokenId)
        public
        view
    ...
    /**
     * @dev See {INFTMarketplace-numTokenWithBids}.
     */
    function numTokenWithBids(address erc721Address)
        public
        view
    ...
    /**
     * @dev See {INFTMarketplace-getTokenHighestBids}.
     */
    function getTokenHighestBids(
        address erc721Address,
        uint256 from,
    ...
    /**
     * @dev See {INFTMarketplace-actionTimeOutRangeMin}.
     */
    ...
    /**
     * @dev See {INFTMarketplace-actionTimeOutRangeMax}.
     */
    ...
    /**
     * @dev See {INFTMarketplace-paymentToken}.
     */
    ...
    /**
     * @dev See {INFTMarketplace-serviceFee}.
     */
