...
SafePlutoClassic is a SafeMoon fork.
It is a community based token.
I will add 15 AVAX and 98% total supply to the pool.
Tax: 13% 
 6% reflection
 4%  Marketing
 3% dev
It will be locked for 5 days.
...
contract SafePlutoClassic is Context, IERC20, Ownable {
    ...
    string private _name = 'SafePluto Classic';
