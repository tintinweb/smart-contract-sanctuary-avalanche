...
/** 
✨ Welcome to Cupid Tiger Avax $CUTA REWARDS $TIME✨

The first DeFi token with an adaptive and elastic tax system. Our token heavily focus on rewarding holders with giveaways and creating hype to drive the success of our token.

Adopting an elastic tax, allows us to adjust our taxes according to the community needs and market trends. We allocate our taxes to these three areas: 
🌟 AVAX Rewards Pool
🌟 Liquidity Pool
...
✨ Tokenomics:
     ...
     * Marketing Tokens 3,000,000,000 (3%)
     * Liquidity Tokens 97,000,000,000 (97%)
...
🌟 Initial  Liquidity: 20 Avax +  97% token 
🚀 Maximum Contribution: 2.5% each transaction for the first buy.

💬Telegram: https://t.me/CupidTigerAvax

🔍Twitter: https://twitter.com/CupidTigerAvax
...
contract CupidTigerAvax is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cupid Tiger Avax";
    string constant _symbol = "CUTA";
    ...
    address public autoLiquidityReceiver=0xcE3B0B0dFd85e6bBFD57b069d8dC8ab0baFF4cd4;
    address public marketingFeeReceiver=0xcE3B0B0dFd85e6bBFD57b069d8dC8ab0baFF4cd4;
