...
contract VestingFactoryAVAX is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;
    ...
    IUniswapV2Router02AVAX public uniV2Router;
    ...
    function setFeeParams(
        ...
        uniV2Router = IUniswapV2Router02AVAX(_uniV2Router);
        uniV2Pair = IUniswapV2Pair(_uniV2Pair);

        feesInUSD = _feesInUSD;
        companyWallet = _companyWallet;

        isWethFirst = uniV2Pair.token0() == uniV2Router.WAVAX();
