...
contract TerrificZapTraderJoeSwap is Ownable, ReentrancyGuard {
    ...
    ZapInfo[] public zaps;
    ITerrificChef public terrificChef;
    IUniswapV2Router02 public uniRouter;

    address public constant wethAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX

    constructor(address _terrificChef, address _uniRouter) {
        require(_terrificChef != address(0), "Zap::constructor: Invalid address");
        require(_uniRouter != address(0), "Zap::constructor: Invalid address");
        terrificChef = ITerrificChef(_terrificChef);
    ...
    function zap(
        ...
        address _lp = address(terrificChef.lpToken(_info.pid));
        ...
        approveToken(_lp, address(terrificChef), _liquidity);
        terrificChef.deposit(_info.pid, _liquidity, msg.sender);
