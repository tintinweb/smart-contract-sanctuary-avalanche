...
contract colorado_kids is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Colorado Kids", "CKS") {
    _customBaseURI = 'ipfs://QmWBS7ohuVRJT9fmTyiTDQuhzCUiJD15GwY9tjy553r59P/';
    _price = 1 ether; // 1 AVAX mint price 
    _maxMintable = 50 ; // 50 supply
  ...
  function _privateMint(address recipient) private {
    _tokenIds.increment();
    require(_tokenIds.current() <= _maxMintable, "Colorado kids finished minting.");
