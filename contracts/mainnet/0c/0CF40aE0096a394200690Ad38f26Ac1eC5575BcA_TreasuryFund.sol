...
contract TreasuryFund is Ownable {
    ...
    constructor(IYToken _yToken) {
        require(address(_yToken) != address(0), "TreasuryFund::constructor: Invalid address");
        yToken = _yToken;
        (ALLOCATION, VESTING_DURATION, VESTING_START) = yToken.setTreasuryFund(address(this));
    }
