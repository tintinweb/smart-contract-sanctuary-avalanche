...
// File contracts/vaults/SteakHutVaultV1Native.sol
 ...
 */
contract SteakHutVaultV1Native is ERC20, Ownable, ReentrancyGuard {
    ...
    /**
     * @dev It initializes the vault's own 'synthetic' token.
    ...
    /**
     * @dev Alternative entry point into the strat. You can send native AVAX,
     ...
     */
    function withdrawAllAVAX() external {
        withdrawAVAX(balanceOf(msg.sender));
    }
     ...
     * but the funds arrive in native AVAX.
     */
    function withdrawAVAX(uint256 _shares) public {
        uint256 r = (balance().mul(_shares)).div(totalSupply());
        _burn(msg.sender, _shares);
