...
import "./modules/whitelist/WhitelistV2.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";

contract TheGhosts is TimeCop
                    , ERC2981
                    , PaymentSplitterV2
                    , Llamas
                    , ERC1412
  ...
  constructor() ERC1412("Fallen Ghosts", "GHSTs") {}
...
abstract contract WhitelistV2 is MaxAccess
  ...
  function addBatchWhitelist(
    ...
    override
    onlyDev() {
    _addBatchWhitelist(newAddresses);
  }
...
interface IWhitelistV2 is IWhitelist {
...
abstract contract ERC1412 is EIP1412
  ...
  function safeBatchTransferFrom(
    ...
    for(uint x = 0; x < len;) {
      require(_isApprovedOrOwner(_msgSender(), tokenIds[x]), "ERC721: caller is not token owner or approved");
