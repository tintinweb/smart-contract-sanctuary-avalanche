 ...
 */
 contract OPresale is Owned{
    ...
    uint public immutable RATE_DECIMALS = 1000000;

    uint256 public minBusdLimit = 500 * (10 ** 6);
    uint256 public maxBusdLimit = 3500 * (10 ** 6);
    ...
    function buy(uint _amount, address _referrer) public {
        ...
        if (isWhitelist == true){
            require(
                ...
                "Presale: not registered on whitelist"
            );
        }
    ...
    function addWhitelist(address[] memory accounts) public onlyOwner {
        for (uint256 index = 0; index < accounts.length; index++) {
            isUserWhitelisted[accounts[index]] = true;
        }
    }
