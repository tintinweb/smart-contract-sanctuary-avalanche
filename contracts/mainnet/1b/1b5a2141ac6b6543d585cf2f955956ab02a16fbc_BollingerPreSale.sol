...
contract BollingerPreSale {
    ...
    uint256 public tokenAmount = 500;
    ...
    constructor(address _farmingToken, address _dev, uint256 _total) {
    ...
    function deposite() public payable onlyEOA {
        ...
        uint256 avaxAmount = PRICE * tokenAmount;
        require(msg.value >= avaxAmount, "Value below price");
    ...
    function claim() public onlyEOA {
        ...
        IERC20(farmingToken).transfer(msg.sender, tokenAmount * 10 ** (ERC20(farmingToken).decimals()));
        emit Claim();
    }
