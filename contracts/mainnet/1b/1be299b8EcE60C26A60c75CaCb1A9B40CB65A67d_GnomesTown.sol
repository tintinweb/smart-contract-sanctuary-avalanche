...
contract GnomesTown is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeif533ypbxrnncvplsn7xhqvsswptqmdr7xn6i6pnbcv6iyepsrxgm/", Strings.toString(tokenId), ".json")
            );
    }
