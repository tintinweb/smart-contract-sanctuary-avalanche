...
contract LDRS is ERC721 , DefaultOperatorFilterer {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 20) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidratnr3svqi7zqmz3sb6lu6r2qxydgfewgqslq2tk2ro2vzc77we/", Strings.toString(tokenId), ".json")
            );
    }
