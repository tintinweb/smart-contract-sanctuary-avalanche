...
contract KingAvax is Context, IERC20 {
    ...
    string constant private _name = "KINGAVAX";
    string constant private _symbol = "KAVAX";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x96b33C6C8Bbdc330d1037958BF6E0cF7b0f57292),
        development: payable(0x7c5612450ee5Cd8Bf4704CFA98e1a7C78C6F012a)
        });
    
    bool inSwap;
    bool public contractSwapEnabled = false;

    uint256 private _maxTxAmountBuy = (_tTotal * 4) / 1000;
...
//===============================================================================================================
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 toSwapForAVAX = contractTokenBalance - toLiquify;
        ...
        uint256 liquidityBalance = (address(this).balance * toLiquify) / toSwapForAVAX;
        ...
        if (address(this).balance > 0) {
            _taxWallets.development.transfer((address(this).balance * _ratios.development) / (total - liquidity));
    ...
    function _getValues(address from, address to, uint256 tAmount, bool takeFee) private returns (ExtraValues memory) {
        ...
        if(takeFee) {
            uint16 currentReflect;
            uint16 currentSwap;
            uint16 divisor = staticVals.masterTaxDivisor;
