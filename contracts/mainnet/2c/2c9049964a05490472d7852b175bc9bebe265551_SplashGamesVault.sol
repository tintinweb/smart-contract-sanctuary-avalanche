...
// File contracts/SplashGamesVault.sol

pragma solidity 0.8.13;

contract SplashGamesVault is UUPSUpgradeable, OwnableUpgradeable {
    /* ========== INITIALIZER ========== */
    function _authorizeUpgrade(address) internal override onlyOwner {}
    ...
    function withdraw(uint256 _amount) external onlyOwner {
        TransferHelper.safeTransferAVAX(msg.sender, _amount);
    }

    function withdrawAll() external onlyOwner {
        TransferHelper.safeTransferAVAX(msg.sender, address(this).balance);
    }
