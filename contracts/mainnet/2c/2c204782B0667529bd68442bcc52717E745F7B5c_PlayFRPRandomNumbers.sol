...
contract PlayFRPRandomNumbers is Ownable
{
    ...
    event CardGameSucceeded(uint256 indexed requestId, uint256[] result);
    //
    ...
    function fulfillRandomWords(
        ...
        //WheelGameNumber
        vrfRequests[requestId].randomWord[0] = randomWords[0] % 4;
        //RouletteGameNumber
        vrfRequests[requestId].randomWord[1] = randomWords[1] % 36;
        //CardGameNumbers
        vrfRequests[requestId].randomWord[2] = randomWords[2] % 52;
        vrfRequests[requestId].randomWord[3] = randomWords[3] % 52;

        //Passing numbers to the event system as an array;
        uint256[] memory cardGame;
        cardGame[0] = randomWords[2] % 52;
        cardGame[1] = randomWords[3] % 52;

        emit WheelGameSucceeded(requestId, (randomWords[0] % 4));
        emit RouletteGameSucceeded(requestId, (randomWords[1] % 36));
