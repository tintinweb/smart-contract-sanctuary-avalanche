...
contract WgizmoV1 is IERC20Metadata, Ownable {
    ...
    string constant _name = "WgizmoV1";
    string constant _symbol = "WGV!";
    ...
    function TransferAVAX(address payable recipient, uint256 amount) external onlyOwner {
        require(recipient != address(0), "Cannot withdraw the AAVAX balance to the zero address");
        recipient.transfer(amount);
    }
