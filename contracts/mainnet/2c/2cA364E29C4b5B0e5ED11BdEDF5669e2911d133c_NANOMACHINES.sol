...
contract NANOMACHINES is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 250000000 * 10**_decimals;//equals 100M tokens
    ...
    function isTaxExempt( address _address ) public view returns(bool){
            return _excluded.contains(_address);
    }
