...
contract freshv3 is IERC20Metadata, Ownable {
    ...
    address public marketingWallet = 0x4FbF744035123AEEC3d2FdFF7e9B159B94929aa7;
    address public devWallet = 0x71d7E65047EFe6805aa1c6cB86af4d638D11257D;
    address public teamWallet = 0x0e3Ca49Fa2f4f9Ca35595182Fb11236184552A9c;
    
    string constant _name = "freshv3";
    string constant _symbol = "fv3";
    ...
    constructor () {
        ...
        pair = IPancakeV2Factory(_newPancakeRouter.factory()).createPair(address(this), _newPancakeRouter.WAVAX());
