 ...
 * a SLOT/AVAX or STOMB/AVAX liquidity pair. And breaks a liquidity pair to single assets
 *
 */
contract Zapper is Ownable, IZapper, Pausable, ContractWhitelisted {
	...
	function zapTokenToLP(
		...
		// SLOT, STOMB, AVAX to create SLOT-AVAX or STOMB-AVAX will hit this if
	 ...
	 * Not very useful for our current use case as bolt input currencies will only be AVAX, WAVAX, STOMB, SLOT
	...
	function _swap(
		...
		if (intermediate != address(0) && (_from == WAVAX || _to == WAVAX)) {
			// E.g. [WAVAX, AVAX, SLOT/STOMB] or [SLOT/STOMB, AVAX, WAVAX]
			path = new address[](3);
			path[0] = _from;
			path[1] = intermediate;
			path[2] = _to;
			...
			// E.g. [AVAX, SLOT/STOMB] or [SLOT/STOMB, AVAX]
			path = new address[](2);
			path[0] = _from;
			path[1] = _to;
		} else if (
			...
			// E.g. [STOMB, AVAX, SLOT] or [SLOT, AVAX, STOMB]
			path = new address[](3);
			path[0] = _from;
			path[1] = intermediate;
			path[2] = _to;
			...
			// [SLOT/SLOT, AVAX, WAVAX, xRoute, xToken]
			path = new address[](5);
			path[0] = _from;
			...
			// E.g. [SLOT/STOMB, AVAX, WAVAX, xTokenWithWAVAXLiquidity]
			path = new address[](4);
			path[0] = _from;
			path[1] = intermediate;
			path[2] = WAVAX;
			...
			// E.g. [xTokenWithWAVAXLiquidity, WAVAX, AVAX, SLOT/STOMB]
			path = new address[](4);
			path[0] = _from;
			path[1] = WAVAX;
			path[2] = intermediate;
