...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xb781f72d359B5F469169B554941a3B4870888DE8); // 
...
contract PTCLP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xb781f72d359B5F469169B554941a3B4870888DE8; // 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PTCL PRINTER";
    string constant _symbol = "PTCLP";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(120); //
    uint256 public _maxWallet = _totalSupply.div(60); // 
    ...
    address public autoLiquidityReceiver=0xdcB45F976Dc10fF941E4fb4a66992334f1D8d3A2; //
    address public marketingFeeReceiver=0xdcB45F976Dc10fF941E4fb4a66992334f1D8d3A2; // 
