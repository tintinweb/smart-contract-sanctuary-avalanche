...
/*
// Stealth launch with Pangolin rewards!
// Join us at https://t.me/pangolinprinter
// Anti Whale
// Max wallet 2%
// Max TX 0.5%
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc7E2792E1896039B409e944735CB48c66A685feb); // PANGO
...
contract PangolinPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7E2792E1896039B409e944735CB48c66A685feb; // PANGO
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PangolinPrinter";
    string constant _symbol = "PangoPrinter";
    ...
    address public autoLiquidityReceiver=0xba434c896F9852f71F2b2f0764B1D0eFB5b5C0b6;
    address public marketingFeeReceiver=0xba434c896F9852f71F2b2f0764B1D0eFB5b5C0b6;
