...
contract Presale is Ownable {
    ...
    constructor(
        ...
        uint256[3] memory _pricesInDoller = [
            uint256(2342468962286250000), // Price in avax for condo
            4099320684000937000, // Price in avax for House
            5856172405715625000 // Price in avax for Mansion
        ];
        uint256[3] memory _maxSupplies = [
            uint256(150), // maxSupply for Condo
            100, // maxSupply for House
            150 // maxSupply for Mansion
        ];
