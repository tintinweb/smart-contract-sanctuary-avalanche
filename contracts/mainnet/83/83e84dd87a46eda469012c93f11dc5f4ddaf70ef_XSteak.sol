 ...
 * If holder has a STEAK.JPEG allows for a reduced burn fee %. (can also whitelist future collections)
 */
    ...
    IXSteakToken
{
    ...
    function _deallocate(
        ...
        // burn corresponding STEAK and xSTEAK (stuck in this contract)
