    ...
    ERC721Burnable
{
    ...
    address  public router = 0x1FbBc7dBa1eF75ff43F955a5B9CeeC3Cc1692Cd8;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Dead Family", "DEAD") {     
        ...
        require(totalFee == 10000,"Error: invalid total fee");
         baseURI = "ipfs://QmervfiMMbpG1CMwuyvi4NWVZuGZp8xta4CajTTKMzvSVE/";
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        if(whitelistedOnly)
        require(whiteListed[msg.sender] == true,"Error: you are not whitelisted");
