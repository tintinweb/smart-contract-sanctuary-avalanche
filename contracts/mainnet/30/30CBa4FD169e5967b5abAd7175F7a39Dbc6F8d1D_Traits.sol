    ...
    function tokenURI(uint256 tokenId) public view returns(string memory) {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                s.isRanger ? "Ranger #" : "Skeleton #",
                tokenId.toString(),
                '", "description": "Yield Hunt - Chapter 2 | Rangers and Skeletons are fighting for a miraculous plant called $GLOW, found in an Underground Forest, hidden under a Temple. All the metadata and images are generated and stored 100% on-chain. No IPFS. NO API. Just the Avalanche blockchain.", "image": "data:image/svg+xml;base64,', 
