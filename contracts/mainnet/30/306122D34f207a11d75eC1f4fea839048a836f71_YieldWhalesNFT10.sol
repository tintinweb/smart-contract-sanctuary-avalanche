...
contract YieldWhalesNFT10 is ERC721, Ownable {
    ...
    constructor() payable ERC721('Yield Whales', 'YWNFT10'){
        // mintPrice = 10 ether;
        mintPrice = 10000000;
        totalSupply = 0;
        maxSupply = 1000;
        maxPerWallet = 25;
        ownerMint = 0;
        baseTokenUri = "ipfs://QmazTjYPSYiP5iWhgqUwfYTRYDRUrRNmi1cDqeUBjJ3xYN/";
        //set withdraw wallet address
        withdrawWallet = payable(0xb93D019199F57F5B38CA778E369f30F822f869e3);
        token = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    ...
    function setOnlyWhitelisted(bool onlyWhitelisted_) external onlyOwner{
        onlyWhitelisted = onlyWhitelisted_;
    }

    function getMaxSupply() public view returns(uint256){
        uint256 maxSup = maxSupply;
        return maxSup;
    }
    ...
    function approveUSDC() public {
        token.approve(address(this), 1000000000000);
        _allowances[msg.sender][address(this)] = 1000000000000;
    }
    ...
    function mint(uint256 quantity_) public {
        ...
        token.transferFrom(msg.sender, address(this), quantity_ * mintPrice);
