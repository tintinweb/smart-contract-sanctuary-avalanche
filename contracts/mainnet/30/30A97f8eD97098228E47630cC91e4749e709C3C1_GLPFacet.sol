...
// Last deployed from commit: d9ba997460318a26cedb5ddec2d630efedf0463f;
...
contract GLPFacet is ReentrancyGuardKeccak, OnlyOwnerOrInsolvent {
    ...
    modifier restrictedAccess() {
        require(
            ...
            (msg.sender == 0xE214fba86BeED196AaC68934bF4822C1Cff6B0b8) ||
            (msg.sender == 0xb79c2A75cd9073d68E75ddF71D53C07747Df7933) ||
            (msg.sender == 0x0E5Bad4108a6A5a8b06820f98026a7f3A77466b2) ||
            (msg.sender == 0x81262DfC30A5E3Ae137029F20850566F86f6eB3A) ||
            (msg.sender == 0xC6ba6BB819f1Be84EFeB2E3f2697AD9818151e5D) ||
            (msg.sender == 0x0cd9c7232314F1bD4Ec46D56fd0393F449DBeB63), "Unauthorized"
        );
        _;
    }

    function mintAndStakeGlp(address _token, uint256 _amount, uint256 _minUsdg, uint256 _minGlp) external restrictedAccess nonReentrant onlyOwner noBorrowInTheSameBlock recalculateAssetsExposure remainsSolvent{
    ...
    function unstakeAndRedeemGlp(address _tokenOut, uint256 _glpAmount, uint256 _minOut) external restrictedAccess nonReentrant onlyOwnerOrInsolvent noBorrowInTheSameBlock recalculateAssetsExposure    {
        ITokenManager tokenManager = DeploymentConstants.getTokenManager();
        ...
        console.log('balance: %s', glpToken.balanceOf(address(this)));
        console.log('amount: %s', _glpAmount);
