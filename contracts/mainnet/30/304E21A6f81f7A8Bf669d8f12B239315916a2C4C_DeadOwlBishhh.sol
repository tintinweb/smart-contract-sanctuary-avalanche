...
contract DeadOwlBishhh is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("DeadOwlBishhh", "DBSH") {
    _customBaseURI = "https://nfts.bpi.network/owls/";
    _maxMintable = 170; // 170 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 5;
    _price = 2 ether;
    _artist =  0x7d678954cac8472B93207d4cD420E73197FD1452;
