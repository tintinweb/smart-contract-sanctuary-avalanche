...
contract RandoData is Ownable {
    ...
    event RequestProcessed ( uint256 _request, address indexed _caller,  uint256 _result );
    event RequestMade (uint256 _request,  address indexed _caller, uint8 _type, uint8 _numberofdie, uint8 _diesides );
    ...
    function process ( uint256 _request, uint256 _result ) public onlyEngine{
        ...
        requestsProcessed++;
        emit RequestProcessed ( _request,  Requests[_request]._caller,    _result );
    }
    ...
    function requestDice( address _caller, uint8 _type, uint8 _numberofdie, uint8 _diesides ) public onlyEngine returns ( uint256) {
        ...
        emit RequestMade ( requests, _caller,  _type, _numberofdie,  _diesides );
        return requests;
    }
