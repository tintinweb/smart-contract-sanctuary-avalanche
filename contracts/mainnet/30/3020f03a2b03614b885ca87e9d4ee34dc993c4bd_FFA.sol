...
// Telegram: https://t.me/flyingflokiavax
// Twitter: https://twitter.com/flyingflokiavax
...
contract FFA is ERC20, Ownable {
    ...
    constructor() ERC20("Flying Floki Avax", "FFA") {
        ...
        uint256 _buyDevFee = 2; // for ironmandev

        uint256 _sellMarketingFee = 8;
        uint256 _sellLiquidityFee = 5;
        uint256 _sellDevFee = 2; // for ironmandev
        
        uint256 totalSupply = 1 * 1e12 * 1e18;
        
        //maxTransactionAmount = totalSupply * 3 / 100; // 1.5% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x194bb39fC1E23D02a869946c47112Aca10F73ebd); // set as marketing wallet
        devWallet = address(0x57c821C730af691d12a17ac7d066c527309D53eF); // Iron Man DEV FEE
