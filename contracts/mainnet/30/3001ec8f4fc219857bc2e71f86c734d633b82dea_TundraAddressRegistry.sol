...
// File: contracts/TundraAddressRegistry.sol
...
contract TundraAddressRegistry is Ownable {
    bytes4 private constant INTERFACE_ID_ERC721 = 0x80ac58cd;

    /// @notice Artion contract
    address public artion;

    /// @notice TundraAuction contract
    address public auction;

    /// @notice TundraMarketplace contract
    address public marketplace;

    /// @notice TundraBundleMarketplace contract
    address public bundleMarketplace;

    /// @notice TundraNFTFactory contract
    address public factory;

    /// @notice TundraNFTFactoryPrivate contract
    address public privateFactory;

    /// @notice TundraArtFactory contract
    address public artFactory;

    /// @notice TundraArtFactoryPrivate contract
    address public privateArtFactory;

    /// @notice TundraTokenRegistry contract
    address public tokenRegistry;

    /// @notice TundraPriceFeed contract
    ...
    /**
     @notice Update TundraAuction contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraBundleMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraNFTFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraNFTFactoryPrivate contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraArtFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update TundraArtFactoryPrivate contract
     @dev Only admin
     */
