...
/**
MAX 1% BUY / MAX WALLET 2%

Tokenomics:
Total Supply : 1,000,000,000,000
Buy/Sell tax: 18% split up into;
Liquidity 4%
Reflections of (Choosen Token) 9%
Marketing 5%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 fire = IBEP20(0xfcc6CE74f4cd7eDEF0C5429bB99d38A3608043a5); // fire reflection
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = fire.balanceOf(address(this));
        ...
        uint256 amount = fire.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            fire.transfer(shareholder, amount);
...
contract FIREPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address fire = 0xfcc6CE74f4cd7eDEF0C5429bB99d38A3608043a5; // fire
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FIREPRINTER";
    string constant _symbol = "$FIREPRINTER";
    ...
    address public autoLiquidityReceiver=0xc1D4a5fcD5FAcCc3deEC8AFf0C56f1B182f3700F;
    address public marketingFeeReceiver=0xade86B64886cA295f89bedDDc5CB5B6DC3a91E40;
