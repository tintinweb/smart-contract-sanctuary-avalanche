...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0x186B8Bd6Cfa6e0aaF9F6fe6Df71Bf58824C6E339);
    uint256[] public tierAllocPoints = [1 ether, 1 ether, 1 ether];
    uint256[] public tierAmounts = [5 ether, 50 ether, 500 ether];
    struct User {
    ...
    constructor(uint256 _startTime) public {
        maxReturnPercent = 250; 
        dripRate = 4320000; // 2% of contract balance will get dripped each day
        treasuryFeePercent = 0; 
