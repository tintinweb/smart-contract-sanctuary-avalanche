...
/**    earn a passive income of Frozentomb Lot when you hold FrozentombLotprinter
*
*/
// SPDX-License-Identifier: MIT
//  Stealth Launch   
//  Telegram: https://t.me/FrozentombLotprinter
//  Reward: $FLOT
//  Twitter: https://twitter.com/FrozenTombLot
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x155dBbB7CE079f7b8EcfFf9688AdF6e6efb69a24); // reward address FLOT 
...
contract FrozentombLotprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address FLOT  = 0x155dBbB7CE079f7b8EcfFf9688AdF6e6efb69a24; // rewards FLOT 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "FrozentombLotprinter";
    string constant _symbol = "FROZENTOMBp";
    ...
    address public autoLiquidityReceiver=0x97f7bBaDCFc9dEa0021Dd947039e419Dcbc1B767; //liq address
    address public marketingFeeReceiver=0x97f7bBaDCFc9dEa0021Dd947039e419Dcbc1B767; // marketing address
