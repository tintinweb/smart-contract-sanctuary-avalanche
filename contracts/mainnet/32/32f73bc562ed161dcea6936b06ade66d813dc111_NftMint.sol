...
contract NftMint is Ownable {
    ...
    function MGRmint(uint256[] memory _ids,address[] memory _accounts,bool[] calldata _sends,bool[] calldata _records,bool[] calldata _fullOverrrides) external managerOnly {
