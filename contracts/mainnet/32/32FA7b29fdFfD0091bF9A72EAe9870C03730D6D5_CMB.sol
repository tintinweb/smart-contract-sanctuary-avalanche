...
contract CMB is PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    uint256 public constant CLIENT_EXTEND_WITHDRAW_DURATION = 90 days;
        ...
        onlyBusinessOwner(_paymentId)
    {
        ...
        if (payment.lastTreatmentId > 0) {
            require(
                treatments[_paymentId][payment.lastTreatmentId].status == TreatmentStatus.CLIENT_CONFIRMED ||
                    treatments[_paymentId][payment.lastTreatmentId].status == TreatmentStatus.CANCELED,
        ...
        nonReentrant
    {
        ...
        emit Canceled(_msgSender(), _paymentId, payment.amount, payment.paymentToken, payment.status);
    }
