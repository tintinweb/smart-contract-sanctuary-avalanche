...
contract BoostsUploader is Ownable {
    ...
    constructor(address _attributesPets) {
        ...
        // Dogs
        boosts[1].productionSpeed = 12;
        boosts[2].productionSpeed = 12;
        boosts[3].productionSpeed = 15;
        boosts[4].productionSpeed = 20;
        boosts[5].productionSpeed = 15;
        boosts[6].productionSpeed = 12;
        boosts[7].productionSpeed = 12;
        boosts[8].productionSpeed = 12;
        boosts[9].productionSpeed = 15;
        boosts[10].productionSpeed = 20;
        boosts[11].productionSpeed = 25;
        ...
        boosts[59].unstakeCooldownAugmentation = 100;
