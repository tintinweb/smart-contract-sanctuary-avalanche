    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x09415070b2663eCBd94509e357288CE05233F862;
    ...
    uint256 public maxPerTx = 120;
    uint256 public maxPerPerson = 120;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("AVAX Doodle Crew", "ADC") ClampedRandomizer(maxSupply) {     
