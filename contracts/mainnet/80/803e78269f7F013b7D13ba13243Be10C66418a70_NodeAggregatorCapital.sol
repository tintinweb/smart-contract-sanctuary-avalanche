...
contract NodeAggregatorCapital is IERC20 {
    ...
    Ratios public _ratios = Ratios({
        ...
        nodeTreasury: 9,
        dev: 3,
        total: 31 // Too lazy to open my calculator, too tired to mental math
        });
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        dev: payable(0xc4302B2d6D9205acF6350A0C30A781BD6b286Bf1)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 node, uint16 dev) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.nodeTreasury = node;
        _ratios.dev = dev;
        _ratios.total = rewards + liquidity + marketing + node + dev;
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal swapping {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + nodeBalance + devBalance);
