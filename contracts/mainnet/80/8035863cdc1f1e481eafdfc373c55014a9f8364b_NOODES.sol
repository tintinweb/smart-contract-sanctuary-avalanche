...
contract NOODES is ERC20, Ownable {
    ...
    constructor() ERC20("Send Noodes", "NOODES"){

        uint256 swapAmount;
        address _boosternftaddress;
        addressess = [0xD5cC0108A139d7B3839DD8b871B5649A34F95b8E, 0x486721225Af21d83972553d20E9f52763e611280, 0x007fe952F872b8e79ce4482149257F9Dd3d76eEf];
        swapAmount = 1;
        _boosternftaddress = 0x886f1045a20BA587B57c671Dc0e5a5bF69A8208c;
        ...
        require(
            addressess[0] != address(0) && addressess[1] != address(0) && addressess[2] != address(0),
            "CONSTR:1"
        );
        teamPool = addressess[0];
        rewardsPool = addressess[1];
        nodeManager = INodeManager(addressess[2]);
        ...
        feess = [1,1,1,1,1];
        require(
            feess[0] != 0 && feess[1] != 0 && feess[2] != 0 && feess[3] != 0,
            "CONSTR:3"
        );
        teamPoolFee = feess[0];
        rewardsFee = feess[1];
        liquidityPoolFee = feess[2];
        cashoutFee = feess[3];
        rwSwap = feess[4];
