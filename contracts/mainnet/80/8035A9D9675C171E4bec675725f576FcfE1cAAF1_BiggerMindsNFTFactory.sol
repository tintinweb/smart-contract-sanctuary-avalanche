...
import "./BiggerMindsNFTTradable.sol";

contract BiggerMindsNFTFactory is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice BiggerMinds auction contract address;
    address public auction;

    /// @notice BiggerMinds marketplace contract address;
    address public marketplace;

    /// @notice BiggerMinds bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new BiggerMindsNFTTradable contract
        ...
        returns (address)
    {
        ...
        BiggerMindsNFTTradable nft = new BiggerMindsNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing BiggerMindsNFTTradable contract
    ...
    /// @notice Method for disabling existing BiggerMindsNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title BiggerMindsNFTTradable
 * BiggerMindsNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract BiggerMindsNFTTradable is ERC721, Ownable {
    /// @dev Events of the contract
    event Minted(
        uint256 tokenId,
        address beneficiary,
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist BiggerMinds contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist BiggerMinds auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist BiggerMinds contracts to enable gas-less listings.
     */
