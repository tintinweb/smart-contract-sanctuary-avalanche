...
contract CryptoLottery is CrowdSale, Lending {
    ...
    */
    ...
    uint private constant _ico_price = 1000000000000; // one token price
    uint private constant _ico_soft_cap = 1000 * 10 ** 18;
    uint private constant _interval = 86400;
    uint private constant _ticket_p = 50000000000000000;
