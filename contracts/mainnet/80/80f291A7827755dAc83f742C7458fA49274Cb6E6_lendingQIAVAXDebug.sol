...
contract superQiAvax is superQiToken {
    ...
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,
        ...
        underlying = IERC20(address(WAVAX));
    }
    ...
    function withdraw(address account,uint256 _amount)internal virtual override returns(uint256){
        ICEther(address(stakeToken)).redeemUnderlying(_amount);
...
contract lendingQIAVAX is superQiAvax,lendingSuperToken {
    ...
    address payable _swapHelper,address payable _FeePool,address leverageFactory)
        superQiAvax(multiSignature,origin0,origin1,_stakeToken,_swapHelper,_FeePool)
...
contract lendingQIAVAXDebug is lendingQIAVAX,debugger {
    ...
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,
    address payable _swapHelper,address payable _FeePool,address leverageFactory)
        lendingQIAVAX(multiSignature,origin0,origin1,_stakeToken,_swapHelper,_FeePool,leverageFactory){
