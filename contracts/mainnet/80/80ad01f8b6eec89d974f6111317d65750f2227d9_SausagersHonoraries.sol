...
contract SausagersHonoraries is ERC721, Ownable {
    ...
    uint96 private contractRoyalties = 690; // 6.9%
    address private royaltyReceiver = 0x2F5a2Ffd54194f99da6C75d43213f5D8DC5DBf03;

    constructor() ERC721("Sausagers++", "MEATHONOR") {}

    function mint(address to, string memory uri) public onlyOwner {
        _supply.increment();
        _mint(to, _supply.current());
        tokenURIs[_supply.current()] = uri;
    }
