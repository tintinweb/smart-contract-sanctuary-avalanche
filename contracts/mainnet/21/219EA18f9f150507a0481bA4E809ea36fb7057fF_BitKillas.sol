...
contract BitKillas is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    uint public maxPerPerson = 400;
    uint public price = 350000000000000000;
    address public royaltyAddress = 0xf00dB167862080062345b3ef5eA6A987B0c74365;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Bit Killas", "BTKZ") ClampedRandomizer(maxSupply) {
