...
contract LoveX is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigyuxxbb5r2hv5wy4wgskuozc5djp4pu5fzjqrxnfl5cbu3nnypy4/", Strings.toString(tokenId), ".json")
            );
    }
