...
contract VMShips is Initializable, ERC721EnumerableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
	...
	function initialize() public initializer {
		...
		vmnAddress = 0xBbD9786f178e2AEBb4b4329c41A821921ca05339; //replace in mainnet
	...
	function royaltyInfo(uint256, uint256 value) external view returns(address receiver, uint256 royaltyAmount) {
		...
		royaltyAmount = value * (royalties) / PERCENTAGE_MULTIPLIER;
	}
	...
	function withdrawWavax() public onlyOwner { 
		...
		wavaxContract.transfer(msg.sender, balance);
    }
}
