...
contract Underdogs is ERC721  {
    uint256 public totalSupply;
    uint256 public cost = 0.55 ether;
    uint256 public maxMints = 23;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeieauvk6pth6mqkyuhab6vjialypp2epzrejo4wo2fsdhlsvlgfr7y/", Strings.toString(tokenId), ".json")
            );
    }
