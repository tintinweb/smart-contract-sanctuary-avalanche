...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C); // reward address 
...
contract DoloElk is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C; // reward 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DoloElk";
    string constant _symbol = "DOLO";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(200); // 2.5%
    ...
    address public autoLiquidityReceiver=0xA810C197dcD193FaB2AcbbBDcaF61adabbFd2840; //liq address
    address public marketingFeeReceiver=0xA810C197dcD193FaB2AcbbBDcaF61adabbFd2840; // marketing address
