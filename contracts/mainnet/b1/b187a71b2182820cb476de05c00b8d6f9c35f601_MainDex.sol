...
contract MainDex is Ownable, DexStorage {
  ...
  function init() public {
    ...
    XNFT = INFT(0x7C4bD5a216db48dAac6d1427D638DF290F7cce94); 
    ...
    LPBNB=LPInterface(0xe28984e1EE8D431346D32BeC9Ec800Efb643eef4); //LPETH
    ...
    countCopy = 0;
    ownerInit();
   factory = IFactory(0x11C97C30628043219cb2D6043546A41DE2bCF160);
   _supportNft[0x7C4bD5a216db48dAac6d1427D638DF290F7cce94] = true;
   emit CollectionsConfigured(0x7C4bD5a216db48dAac6d1427D638DF290F7cce94, 0x11C97C30628043219cb2D6043546A41DE2bCF160);
    BUSD = IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118);
    BNB= IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
