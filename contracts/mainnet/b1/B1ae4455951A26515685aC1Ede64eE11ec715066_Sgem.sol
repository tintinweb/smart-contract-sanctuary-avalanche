...
contract Sgem is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 35,000 sGEM
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 29750 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund1) public ERC20("SGEM", "SGEM") {
    ...
    function claimRewards() external {
        ...
        if (_pending > 0 && devFund1 != address(0)) {
            _mint(devFund1, _pending);
