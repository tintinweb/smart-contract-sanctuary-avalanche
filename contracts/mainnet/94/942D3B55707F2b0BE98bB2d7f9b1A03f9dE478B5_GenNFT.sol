...
contract GenNFT is ERC721Burnable, ERC721Rentable, ERC721URIStorage, ERC721Permit, IGenesisNFT, Beneficiary, Creator, NonFungibleType, Withdrawable, ReentrancyGuard {
    ...
    constructor(string memory name_, string memory symbol_) payable ERC721Rentable(name_, symbol_) Signable(type(GenNFT).name, "1") {
        address sender = _msgSender();
        _setBeneficiary(sender);
        _setCreator(sender);
        _setType(1, 0x0000000000000000000000000000000000000000, 10000000000000000, 35, 1);
        _setType(2, 0x0000000000000000000000000000000000000000, 20000000000000000, 15, 1);
        _idCounter = 1;
    }
