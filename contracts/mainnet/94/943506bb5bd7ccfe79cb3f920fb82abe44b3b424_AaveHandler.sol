...
contract AaveHandler is IDepositExecute, HandlerHelpers, Ownable, ERC20Safe {
    address public constant AAVE_AVAX_LP_ADDR = 0x4F01AeD16D97E3aB5ab2B501154DC9bb0F1A5A2C;
    address public constant AAVE_FUJI_LP_ADDR = 0x76cc67FF2CC77821A70ED14321111Ce381C2594D;
    ...
    function executeProposal(
        ...
        IERC20(tokenAddress).approve(AAVE_AVAX_LP_ADDR, amount);
        ILendingPool(AAVE_AVAX_LP_ADDR).deposit(tokenAddress, amount, amTokenHandler, 0x0);
