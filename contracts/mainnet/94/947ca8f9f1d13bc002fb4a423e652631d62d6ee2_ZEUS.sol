...
/**
 *Submitted for verification at snowtrace.io 
*/

// SPDX-License-Identifier: MIT
/**
ZEUS FINANCE!
TWITTER: https://twitter.com/Zeusnode
WEBSITE: https://zeusnode.finance/
TELEGRAM: https://t.me/zeusnodes
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x1D67454f6b393542290a7bBEeA32c66148909b34); // 
...
contract ZEUS is IBEP20, Auth {
    ...
    address EP = 0x1D67454f6b393542290a7bBEeA32c66148909b34; // 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ZEUS NODE FINANCE";
    string constant _symbol = "ZEUS";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(250); // 
    uint256 public _maxWallet = _totalSupply.div(200); // 
    ...
    address public autoLiquidityReceiver=0x0e8010D0a0ac8CCbA2672F439C95592eA74b37c5; //
    address public marketingFeeReceiver=0x0e8010D0a0ac8CCbA2672F439C95592eA74b37c5; // 
