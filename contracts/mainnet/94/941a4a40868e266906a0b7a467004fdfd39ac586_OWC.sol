...
contract OWC is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**10 * (10**18);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x523d2beFeF0fdE2Db8bE3B4afe91a6CD45f82b12); // Team Wallet
    address public _projectWalletAddress = address(0xeEC5621683007b8bcb0CA04E48546477e8B45470); //Project Wallet
    ...
    constructor() ERC20("One World Coin", "OWC") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // DEX ROUTER
        ...
        buyFee.projectFee = 22; // 0.022% Project fee
        buyFee.teamFee = 49;  // 0.049% team fee
        totalBuyFee = buyFee.projectFee + buyFee.teamFee;

        sellFee.projectFee = 22; // 0.022% project fee
        sellFee.teamFee = 49;   // 0.049% team fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "OWC: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "OWC: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "OWC: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        if(takeFee) {
        	...
        	uint256 fees = amount.mul(totalFee).div(100000);
