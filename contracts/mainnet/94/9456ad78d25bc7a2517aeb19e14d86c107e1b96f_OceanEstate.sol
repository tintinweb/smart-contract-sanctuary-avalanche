...
// Change Name
contract OceanEstate is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "https://metadata-api.oceanestate.repl.co/api/uri/";
    ...
    constructor() ERC721A("Ocean Estate", "OCEST") {
