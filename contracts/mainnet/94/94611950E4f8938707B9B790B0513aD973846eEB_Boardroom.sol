...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    /* ========== GOVERNANCE ========== */
    // redalert token, rshare token, treasury address
    function initialize(
        IERC20 _redalert,
        IERC20 _share,
        ITreasury _treasury
    ...
    function getRedAlertPrice() external view returns (uint256) {
        return treasury.getRedAlertPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            redalert.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        redalert.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(redalert), "redalert");
