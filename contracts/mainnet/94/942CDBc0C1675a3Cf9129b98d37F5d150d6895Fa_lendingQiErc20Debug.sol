...
// File: contracts/superToken/benqiSuperToken/superQiErc20.sol
...
contract superQiErc20 is superQiToken {
    ...
    function withdraw(address account,uint256 _amount)internal virtual override returns(uint256){
        uint256 amount = ICErc20(address(stakeToken)).redeemUnderlying(_amount);
    ...
    function lendTo(address account,uint256 amount) internal virtual override {
        amount = ICErc20(address(stakeToken)).redeemUnderlying(amount);
        underlying.safeTransfer(account, amount);
    }
...
// File: contracts/superToken/benqiLendingToken/lendingQiErc20.sol
