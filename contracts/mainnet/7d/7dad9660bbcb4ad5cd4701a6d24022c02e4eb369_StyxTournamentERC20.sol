/**
 *Submitted for verification at snowtrace.io on 2023-05-19
*/
...
contract StyxTournamentERC20 is Ownable, ITournament {
    //Created by Veloce - Grave Finance
    address public winner;
    bool public claimed;
    uint256 public lastTs;
    uint256 public ROLLOVER = 7000;
    uint256 public INITIALPERIOD = 4320;
    uint256 public PERIOD = 5220;
    uint256 public DECAYPERIOD = 900;
    uint256 public DECAYSTOP = 1800;
    uint256 public ROUNDEND = 0;
    uint256 public TICKET_SIZE = 100; // 10000th of pot
    uint256 public BURN_SHARE = 8000; // 10000th
    ...
    function setDecayStop(uint256 _DECAYSTOP) external onlyOwner {
    ...
    function setRollover(uint256 _ROLLOVER) external onlyOwner {
        ROLLOVER = _ROLLOVER;
    }

     function setBurnshare(uint256 _BURNSHARE) external onlyOwner {
        BURN_SHARE = _BURNSHARE;
    }

     function setTicketSize(uint256 _TICKETSIZE) external onlyOwner {
