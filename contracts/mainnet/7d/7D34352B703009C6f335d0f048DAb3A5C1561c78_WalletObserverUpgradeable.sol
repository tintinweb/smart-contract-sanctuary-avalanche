    ...
    PlanetsManagerImplementationPointerUpgradeable
{
        ...
        returns (bool)
    {
        ...
        // USDC.e
        if (
            _sender == address(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664) &&
            from == address(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664)
        ) {
            return true;
        }
        ...
        returns (bool)
    {
        ...
        if (isPair(_sender, from)) {
            ...
            int256 newBoughtTokenValue =  int256(amount);
