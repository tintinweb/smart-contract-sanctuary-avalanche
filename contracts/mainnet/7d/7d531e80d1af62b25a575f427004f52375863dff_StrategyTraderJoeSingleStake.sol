...
// File contracts/strategies/TraderJoe/StrategyTraderJoeSingleStake.sol.sol
...
contract StrategyTraderJoeSingleStake is StratManager, FeeManager {
    ...
    function chargeFees(address callFeeRecipient) internal {
        uint256 toNative = IERC20(output).balanceOf(address(this)).mul(25).div(1000);
    ...
    function _giveAllowances() internal {
        _removeAllowances();
        IERC20(want).safeApprove(rewardPool, uint256(MAX_INT));
