...
contract Plinko is GameBase, GameBet, GameChainlink {
    ...
    constructor(
        ...
        bucketProbabilities[8] = [8380, 68700, 225536, 499999, 774464, 931300, 991620, 1000000];
        bucketMultipliers[9] = [2050, 400, 90, 60, 40, 60, 90, 400, 2050];
        bucketProbabilities[9] = [5162, 29512, 159301, 353985, 646015, 840699, 970488, 994838, 1000000];
