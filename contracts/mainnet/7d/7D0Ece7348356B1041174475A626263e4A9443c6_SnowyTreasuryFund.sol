...
contract SnowyTreasuryFund is Ownable {
    ...
    constructor(SnowyCentralFund _centralFund) {
        require(address(_centralFund) != address(0), "TreasuryFund::constructor: Invalid address");
        centralFund = _centralFund;
        centralFund.setTreasuryFund(address(this));
    }
