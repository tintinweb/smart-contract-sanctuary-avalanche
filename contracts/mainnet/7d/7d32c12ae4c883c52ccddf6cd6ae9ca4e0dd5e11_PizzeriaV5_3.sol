...
interface IPizzeriaProgressionV4_6 {
...
contract PizzeriaV5_3 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Constants
    ...
    IPizzeriaProgressionV4_6 public pizzeriaProgression;
    IMafia_6 public mafia;
    ...
    function initialize(Chef _chef, Upgrade _upgrade, Pizza _pizza, Soda _soda, address _freezerAddress, address _pizzeriaProgression) public initializer {
        ...
        pizzeriaProgression = IPizzeriaProgressionV4_6(_pizzeriaProgression);
