...
contract ContractFlashTri {
    ...
    address private constant SUSHI = 0x37B608519F91f70F2EeB0e5Ed9AF4061722e4F76;
    ...
    function triangularArbitrage(
        ...
        if (_tokens[0] != WAVAX && _tokens[1] != WAVAX && _tokens[2] != WAVAX) {
            ...
            _tokens[0] != SUSHI && _tokens[1] != SUSHI && _tokens[2] != SUSHI
        ) {
            dummyToken = SUSHI;
        } else if (
            ...
            _tokens[0] != JOE && _tokens[1] != JOE && _tokens[2] != JOE
        ) {
            dummyToken = JOE;
        } else if (
        ...
        // Passing data triggers panSUSHICall as this is what constitutes a loan
