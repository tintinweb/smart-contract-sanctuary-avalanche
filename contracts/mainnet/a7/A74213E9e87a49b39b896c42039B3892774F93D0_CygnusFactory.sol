...
library CygnusPoolAddress {
    ...
    bytes32 internal constant COLLATERAL_INIT_CODE_HASH =
        0x6325ef039dcfeef64483fcf4b029a42ce63569ff89ed9a33316d345116846f29;
    ...
    bytes32 internal constant BORROW_INIT_CODE_HASH =
        0x9b24a3bf2520a417da2386ab95098f96a61218571a706652483fa8c5aca9f37e;
...
contract CygnusFactory is ICygnusFactory, Context, ReentrancyGuard {
     ...
     *  @inheritdoc ICygnusFactory
     */
    address public immutable override cygnusDAI; // DAI

    /**
     *  @inheritdoc ICygnusFactory
     */
    address public immutable override nativeToken; // weth/ftm/avax etc.
     ...
     *  @param _cygnusDAI Address of the DAI contract on this chain (different for mainnet, c-chain, etc.)
    ...
    function deployShuttle(
        ...
        _cygnusAlbireo = borrowDeployer.deployAlbireo(
            cygnusDAI,
            _collateral,
            baseRate,
            multiplier,
        ...
        getShuttles[lpTokenPair].borrowToken = cygnusDAI;
        ...
        emit NewShuttleLaunched(lpTokenPair, allShuttles.length, _cygnusDeneb, _cygnusAlbireo, cygnusDAI);
    }
