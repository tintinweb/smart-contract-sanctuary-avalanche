...
contract snekView is Initializable, AccessControlEnumerableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _admin, address _proxyAdmin, IVoter _voter, address _router) initializer external {
