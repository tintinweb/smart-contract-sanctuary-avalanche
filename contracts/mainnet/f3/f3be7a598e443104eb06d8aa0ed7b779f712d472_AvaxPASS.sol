...
contract AvaxPASS is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    uint public price = 2500000000000000000;
    address public royaltyAddress = 0xeA32564939dBD092F1981D9A2e3d9cc17E5E51f2;
    uint public royalty = 250;
    ...
    ) ERC721("AvaxPASS", "PASS") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(supply + amount - 1 < maxSupply, "Error: Supply reached");
        require(amount > 0 && amount <= maxPerTx, "Error:  5 Max per Tx");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: Max 5 per Wallet");
        if (price > 0) require(msg.value == price * amount, "Error: Not enough Avax");
