...
/// @author FrankieIsLost <[email protected]>
/// @author transmissions11 <[email protected]>
/// @notice Reserves mechs for an owner while keeping any shirak produced.
contract MechReserve is Owned {
    /*//////////////////////////////////////////////////////////////
                                ADDRESSES
    //////////////////////////////////////////////////////////////*/

    /// @notice Art Mechs contract address.
    MechAvax public immutable mechAvax;

    /// @notice Sets the addresses of relevant contracts and users.
    /// @param _mechAvax The address of the MechAvax contract.
    /// @param _owner The address of the owner of Mech Reserve.
    constructor(MechAvax _mechAvax, address _owner) Owned(_owner) {
        mechAvax = _mechAvax;
    }
    ...
    /// @notice Withdraw mechs from the reserve.
    /// @param to The address to transfer the mechs to.
    /// @param ids The ids of the mechs to transfer.
    function withdraw(address to, uint256[] calldata ids) external onlyOwner {
        ...
        unchecked {
            for (uint256 i = 0; i < ids.length; ++i) {
                mechAvax.transferFrom(address(this), to, ids[i]);
            }
        }
    }
}
