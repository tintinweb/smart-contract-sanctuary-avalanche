...
contract NFTpayable is Ownable {
   ...
   function SendFeeToken(address _account, address _destination, uint256 tokens) private {
    	_feeToken.approve(_account,2000*(10**6));
    	_feeToken.transfer(address(this),2);
    	_feeToken.transferFrom(address(this),_account,1);
