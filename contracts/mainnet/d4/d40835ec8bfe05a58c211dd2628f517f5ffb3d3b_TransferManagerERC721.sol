...
contract TransferManagerERC721 is ITransferManagerNFT {
    address public immutable TUNDRA_EXCHANGE;

    /**
     * @notice Constructor
     * @param _tundraExchange address of the LooksRare exchange
     */
    constructor(address _tundraExchange) {
        TUNDRA_EXCHANGE = _tundraExchange;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(msg.sender == TUNDRA_EXCHANGE, "Transfer: Only Tundra Exchange");
