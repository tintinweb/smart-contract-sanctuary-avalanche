...
contract Rex is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 26166 * 10**DECIMALS;

    uint256 public liquidityFee = 4;
    uint256 public Treasury = 2;
    uint256 public DIFBURN = 8;
    uint256 public sellFee = 2;
    uint256 public totalFee =
        liquidityFee.add(Treasury).add(DIFBURN);
    ...
    address public DIFBURNReceiver;
    ...
    constructor() ERC20Detailed("Rex", "Rex", uint8(DECIMALS)) {
        ...
        TreasuryReceiver = 0x140336e0F0135A8BE0B85345D73Fd3B9914a516e;
        DIFBURNReceiver = 0xd18E21048302CCC26428dE05c4B0f620Dd5125Be;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHLiquidity = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHDIFBURN = amountETH.mul(DIFBURN).div(totalETHFee);
        ...
        (success, ) = payable(DIFBURNReceiver).call{
            value: amountETHDIFBURN,
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _DIFBURNReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        TreasuryReceiver = _TreasuryReceiver;
        DIFBURNReceiver = _DIFBURNReceiver;
    }
    ...
    function setFees(
        ...
        Treasury = _Treasury;
        sellFee = _sellFee;
        totalFee = liquidityFee.add(Treasury).add(DIFBURN);
