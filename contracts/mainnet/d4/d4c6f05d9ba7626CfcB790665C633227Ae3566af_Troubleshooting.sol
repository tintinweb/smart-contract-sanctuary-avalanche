...
contract Troubleshooting is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 18; //  300 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 500; // 100 = 1%, 200 = 2% etc...
    uint256 public constant NFT_PRICE = 3 ether; //
