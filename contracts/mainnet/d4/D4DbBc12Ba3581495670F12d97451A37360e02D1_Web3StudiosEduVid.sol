/**
 *Submitted for verification at snowtrace.io on 2023-02-03
*/
...
contract Web3StudiosEduVid is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Web3 Studios Education Series - Campfire Mint Page", "W3ESCMP") {
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmSWYTSnuDGg3kumGvQcoWjsnd9ZBGvAeAk2qQDpL7XqYx/';
    _customBaseExtension = '.json';
    _maxMintable = 1; // 100 max supply - PROD
...
function setBaseExtension(string memory customBaseExtension_) public onlyOwner {
  ...
  function mintActive() public view returns (bool) {
    return _mintActive; // use timer w/ability to override
  }
