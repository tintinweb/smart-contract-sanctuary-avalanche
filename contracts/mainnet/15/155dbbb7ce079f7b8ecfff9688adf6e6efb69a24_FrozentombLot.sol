...
contract FrozentombLot is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 65,000 FLOTs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Frozentomb Lot", "FLOT") {
