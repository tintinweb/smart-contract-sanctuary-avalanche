...
contract FantomHouseGrape is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
    VRFCoordinatorV2Interface COORDINATOR;
    using SafeERC20 for IERC20;

    // ChainLink VRF configs
    uint64 private s_subscriptionId = 55;
    address vrfCoordinator = 0xd5D517aBE5cF79B7e95eC98dB0f0277788aFF634;
    bytes32 keyHash = 0x83250c5584ffa93feb6ee082981c5ebe484c865196750b39835ad4f13780435d; // 200 gwei
    uint32 callbackGasLimit = 1500000;
    uint16 requestConfirmations = 3;
    uint32 numWords = 1;

    uint256 maxBetPercent = 1000000000000000000; // default 1%
    uint256 minBet = 1000000000000000000; // default $1.00
    ...
    uint256 minHouseDeposit = 500000000000000000000; // default $500
    ...
    address private constant GRAPE_ADDRESS = 0x5541D83EFaD1f281571B343977648B75d95cdAC2;
    IERC20 private grape = IERC20(GRAPE_ADDRESS);
    ...
    function depositHouse(uint256 _amount, address _referral) external {
        ...
        grape.safeTransferFrom(_sender, address(this), _amount);
    }
    ...
    function withdrawHouse(uint256 _amount) external nonReentrant {
        ...
        grape.safeTransfer(msg.sender, _amount);
    }
    ...
    function bet(uint256 _betAmount, uint256 _faceSide, address _referral) external nonReentrant {
        ...
        grape.safeTransferFrom(_sender, address(this), _betAmount);
    ...
    function returnDepositAndRemoveDepositor(uint256 _length, bool _shouldRemoveDepositor) internal {
        for (uint i = 0; i < _length; i++) {
            ...
            grape.safeTransfer(_depositor, _depositAmount);
