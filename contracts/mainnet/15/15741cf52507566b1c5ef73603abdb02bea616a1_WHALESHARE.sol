...
//Farming Whales Finance (WHALESHARE) - Avalanche Mainnet
...
// ToxicDeer Finance
contract WHALESHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 WhaleShare
    ...
    ) public ERC20("Farming Whales Share", "WHALESHARE") {
        _mint(msg.sender, 1 ether); // mint 1 WHALESHARE for initial liquidity deployment
