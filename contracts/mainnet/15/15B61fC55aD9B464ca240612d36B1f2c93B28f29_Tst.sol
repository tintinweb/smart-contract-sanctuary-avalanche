    ...
    WalletObserverImplementationPointer
{
    ...
    constructor(address _playersManager,address _treasury) ERC20("TSTTT", "TSTTT") {
        require(
     ...
     function setFeesAmount(uint _sellFeesAmount) public onlyOwner {
        require(_sellFeesAmount <= 750, "fees too high");
        ...
        onlyPlayersManager
    {
        require(
            ...
            "BBALL: Use liquidityReward to reward liquidity"
        );
    ...
    // return true if the "_recipient" address is a BBALLL liquidity pool
