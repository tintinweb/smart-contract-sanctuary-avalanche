...
contract LBsAVAXStratManager is Ownable, AutomationCompatibleInterface {
    ...
    /// @notice executes a harvest of the underlying strategy
    ...
    /// @param callFeeRecipient address of address to be credited as gasCaller
    ...
    /// @notice 4. @dev should we also protect against a rebalance if the price is not within a range ?
    ...
    function performUpkeep(bytes calldata performData) external override {
        ...
        //we dont want to rebalance if the nav is falling so ignore
        //we only harvest when a reblance is called
