...
telegram - MultiNodeCapital (kept on private until 15 minutes post launch for our private investors)
...
contract MultiNodeCapital is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Multi Node Capital";
