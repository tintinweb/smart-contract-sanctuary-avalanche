...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x43C4b25EB0d20F3E344c5dBb3ffFFb7a6D4a0301;
...
contract TrimToken is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x324b33982754D8Bf2db04eF817a1443ef67F5EE5;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**8; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Tourism";
    string private _symbol = "TRIM";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**8; //Max tx amount
    uint256 private numTokensSellToAddToLiquidity = 5000 * 10**8; //Fee threshold for LP acquisition
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x74736d9fA31B1AB76e0bd726FA5Da1bE00736c46, 'We can not exclude Uniswap router.');
