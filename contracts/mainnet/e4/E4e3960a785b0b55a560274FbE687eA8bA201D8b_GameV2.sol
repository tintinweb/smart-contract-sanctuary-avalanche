...
//    }
    ...
    function _beforeTokenTransfer(address sender, address recipient, uint256 amount) internal nonReentrant override {
        ...
        //UPGRADE 2. Fix in the case of minting.
        ...
        if(gameLinkedToCreditsOfSender > 0 && !creditWhitelist[sender] && !creditWhitelist[recipient])
        {
            ...
            if(recipientIsGamePair)
            {
                ...
                pendingMintLink[recipient] = pendingMintLink[recipient].add(amount >= gameLinkedToCreditsOfSender ? gameLinkedToCreditsOfSender : amount);
            }
