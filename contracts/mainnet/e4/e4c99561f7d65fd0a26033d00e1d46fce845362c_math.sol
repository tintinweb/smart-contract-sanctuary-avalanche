  ...
  Authorizable
{
 ...
 uint256 low_perc = 30;
  ...
  address swap_add;
  address stable_swap_add = 0xf4003F4efBE8691B60249E6afbD307aBE7758adb;
  address token_add;
  address main_add = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
  address stable_add = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
  ...
  function getStablePrice() public view returns (uint)
   {
    ...
    uint256 stable_now_val = (10000*_stable).div(_main*100);
  ...
  function getTokenPrice() public view returns(uint) {
    ...
    uint256 _main = vals[1].div(10**vals[3]);
    uint256 now_val = (10000*_token).div(_main*100);
    if (stableOn) {
