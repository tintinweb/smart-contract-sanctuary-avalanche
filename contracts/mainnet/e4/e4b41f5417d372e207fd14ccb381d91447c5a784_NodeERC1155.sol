...
contract NodeERC1155 is INodeERC1155, ERC1155, Ownable, ReentrancyGuard {
    ...
    function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) public virtual override {
        ...
        for (uint256 i = 0; i < ownedNodes[from].length; i++) {
            if (nodeState[ownedNodes[from][i]].nodeType == id) {
                ...
                uint256 claimableCork = (snowballRewardCork + mainRewardCork - nodeState[ownedNodes[from][i]].claimedAmount);
                nodeState[ownedNodes[from][i]].claimedAmount = mainRewardCork;
    ...
    function claimPartial(uint256 amountMax, uint256 id) external payable nonReentrant {
        ...
        uint256 claimAmount = snowballRewardCork + mainRewardCork - nodeState[id].claimedAmount;
        ...
        nodeState[id].claimedAmount = mainRewardCork * patialRatio / _percentRate;
