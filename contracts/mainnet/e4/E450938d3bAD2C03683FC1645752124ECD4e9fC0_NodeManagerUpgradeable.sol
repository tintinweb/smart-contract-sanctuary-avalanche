...
// File: 1. NodeManager/ILiquidityPoolManager.sol
...
// File: 1. NodeManager/LiquidityPoolManagerImplementationPointerUpgradeable.sol
...
// File: 1. NodeManager/NodeImplementationPointerUpgradeable.sol
...
abstract contract NodeImplementationPointerUpgradeable is OwnableUpgradeable {
    INode internal wind;
        ...
        onlyOwner
    {
        ...
        wind = INode(newImplementation);
        emit UpdateWind(oldImplementation, newImplementation);
    }

    uint256[49] private __gap;
}
// File: 1. NodeManager/OwnerRecoveryUpgradeable.sol
...
// File: 1. NodeManager/NodeManagerUpgradeable.sol
...
contract NodeManagerUpgradeable is
    ...
    NodeImplementationPointerUpgradeable,
