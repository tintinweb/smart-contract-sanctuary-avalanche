...
contract TheTapV3d is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function addToAccount(
        ...
        _setUpline(_addr, _upline);
        (uint256 gross_payout, , , ) = payoutOf(_addr);
        users[_addr].accumulatedDiv = gross_payout;
        users[_addr].deposits += _depositAmount;
