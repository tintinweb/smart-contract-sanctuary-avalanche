    ...
    UUPSUpgradeable
{
    ...
    IFactory factory; // soliSnek pool factory
    ...
    function setAddresses(address _weth, IFactory poolFactory, address _neadSnekWeth, address _snekWeth) external onlyRole(SETTER_ROLE) {
        weth = _weth;
        factory = poolFactory;
