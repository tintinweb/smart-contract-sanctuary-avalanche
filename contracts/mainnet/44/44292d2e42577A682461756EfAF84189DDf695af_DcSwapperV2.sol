 ...
 */
contract DcSwapperV2 is OwnableUpgradeable, BaseBuildingBlock {
     ...
     * @param actionPoolDcRouter_ address of action pool
    ...
    function initialize(
        ...
        _actionPoolDcRouter = IActionPoolDcRouter(actionPoolDcRouter_);
    ...
    modifier onlyActionPoolDcRouter(){
        require(_msgSender() == address(_actionPoolDcRouter),
            "SwapperV2 BB: Caller isn't deCommas Action Pool Router");
            _;
    }

    /**
    * @notice Assets must be deposited or bridged before calling any swap
    */
    function deposit(address _token, uint256 _amount) external returns(bool){
        require(_token != address(0), "SwapperV2 BB: Invalid Token address");
        require(_amount > 0, "SwapperV2 BB: Zero amount");
        require(IERC20(_token).transferFrom(_msgSender(),address(this),_amount),"SwapperV2 BB: Deposit Failed");
    }
    ...
    */
    function swapExactTokensForTokens(
        ...
        require(IERC20(_tokenIn).balanceOf(address(this)) >= _amountIn,"SwapperV2 BB: Insufficient asset balance, bridge or deposit assets");
    ...
    */
    function swapExactETHForTokens(
        ...
        address _recipient
            ...
            require(msg.value == _amountIn, "UniswapperV2/amount-mismatch");
            address[] memory _path = new address[](2);
            _path[0] = _weth;
            _path[1] = _tokenOut;
