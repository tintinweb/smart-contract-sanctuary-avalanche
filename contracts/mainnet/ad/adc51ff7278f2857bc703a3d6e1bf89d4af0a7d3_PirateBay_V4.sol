...
// File: contracts/PirateBay_V4.sol
...
contract PirateBay_V4 is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // MODIFIERS
    modifier onlyDevs() {
        require(devFees[msg.sender].percent > 0, "Dev Only: caller is not the Captain");
        _;
    }
    ...
    // INSTRUCTIONS
    // WHITELISTED: Price : 250000000000000000   MaxTx : 5   MaxPerPerson : 20
    // PUBLIC:   Price : 750000000000000000   MaxTx : 1   MaxPerPerson : 1
    ...
    uint public maxPerPerson = 20;
    uint public price = 250000000000000000;
    address public royaltyAddress = 0x9561E0f9520d006Ad1812be22090b4f398ba99FF;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("PirateBay_V4","SHIP") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(supply + amount - 1 < maxSupply, "Error: AARARHGR ! TotalSupply reached");
        require(amount > 0 && amount <= maxPerTx, "Error: AARARHGR ! Only 1 per Tx");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: AARARHGR ! Max 20 per Wallet");
        if (price > 0) require(msg.value == price * amount, "Error: AARARHGR ! It's Free why do you want pay?!");
        if (whitelistedOnly) require(whiteListed[msg.sender] >= amount, "Error: AARARHGR ! No whitelist here ");
