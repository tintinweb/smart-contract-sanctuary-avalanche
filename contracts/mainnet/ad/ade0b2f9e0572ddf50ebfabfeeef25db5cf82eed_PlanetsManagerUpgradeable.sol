...
LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    function initialize() external initializer {
        ...
        // Initialize contract
        changeRewardPerDay(11574); // 4% per day = 46299 // 1% per day = 46299 / 4 = 11574
        changeNodeMinPrice(150_000 * (10**18)); // 150,000 PABLO
    ...
    function migrateToV2(uint256 value) external nonReentrant universeSet {
        IERC20 oldUniverse = IERC20(0x68d19e3Ff9319470575b9CA78Fa39538a3C1245d);
