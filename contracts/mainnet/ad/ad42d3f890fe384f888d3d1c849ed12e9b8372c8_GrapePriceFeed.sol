...
contract GrapePriceFeed is Ownable {
    ...
    IOracle public Oracle = IOracle(0x583523a9d2eE61c846A210756e61610ffA628ce4);
    ...
    function latestAnswer() external view returns (int256) {
        int256 mimPrice = PriceFeed.latestAnswer();
        int256 price = int256(int144(Oracle.consult(GRAPE, 1e8)));
        return (price * mimPrice) / 10**8;
    }
