...
contract wildfucks is ERC721URIStorage,Ownable{
  ...
  constructor() ERC721("WildFucks", "WLDFCK") {
    _customBaseURI = 'ipfs://bafybeifymjnrmw2xataf3mxibczqdncb5mqdxc5mkuvm4r4iocxoymm63q/';
    ...
    _mintActive = false; 
    _privateSale = false;
    address1 = payable(0x6720cbE3724ecE86B111DdEB7911aacdDC1a251B);
  ...
  function setAddresses(address payable _address1, address royalty) public onlyOwner{
	  address1 = _address1;
