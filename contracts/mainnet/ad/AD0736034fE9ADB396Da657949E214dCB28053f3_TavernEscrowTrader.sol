...
contract TavernEscrowTrader is Initializable, OwnableUpgradeable, ERC721HolderUpgradeable {
    ...
    function buyOrderWithUSDC(uint256 orderId, uint256 amount) external {
        ...
        IERC20Upgradeable(mead).safeTransferFrom(msg.sender, settings.tavernsKeep(), taxAmountUSDC);
        IERC20Upgradeable(mead).safeTransferFrom(msg.sender, order.seller, orderAmountUSDC - taxAmountUSDC);
