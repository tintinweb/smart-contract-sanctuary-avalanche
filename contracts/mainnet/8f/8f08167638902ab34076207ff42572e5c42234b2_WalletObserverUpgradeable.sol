    ...
    PlanetsManagerImplementationPointerUpgradeable
{
    ...
    function totalSupply() external view returns (uint256) {
        ...
        _totalSupply -= universe.balanceOf(
            0x17a3695c2e4F182E8E42C0BE8387e367D603b3bE
        );

        // pswole wallets that still contains UNIV
        // root wallet: 0xAD808e43E9df338B8aF0B5cf72732783c26778A8
        _totalSupply -= universe.balanceOf(
            0xb7e6228D8c37626C6AcF8410248E1559819aa092
        );
        _totalSupply -= universe.balanceOf(
            0xABdAfad5df04c728FfF5F58589079B0D1B49F200
        );
        _totalSupply -= universe.balanceOf(
            0xE366cBAb8026e60bcEB77A670b6110C599c57719
        );
        _totalSupply -= universe.balanceOf(
            0x275baB159E26871e143e9C7813fe7BE409C15177
        );
        _totalSupply -= universe.balanceOf(
        ...
        _totalSupply -= universe.balanceOf(
            0xa14D614677992dbFfA064B7E0bB2EA19d76AED7e
        );
        _totalSupply -= universe.balanceOf(
            0x6dd0a50316e382Ddd1BaeDF20C151396615306bD
        );
        _totalSupply -= universe.balanceOf(
            0xE023F1f55db3d48970073c18f830cD61E6B4371d // 3,460,478.562662940718444142 UNIV
        );
        _totalSupply -= universe.balanceOf(
            0xE366cBAb8026e60bcEB77A670b6110C599c57719 // 38,408,286.786346561952976459 UNIV
        );
        _totalSupply -= universe.balanceOf(
            0x7448dB1e46E33F41568886fA9A44fE01D39De4c7 // 85,341,829.925396321375141539 UNIV
        );
        _totalSupply -= universe.balanceOf(
            0x039057f6a5C8ca56734F23E040696d233e308BB1 // 95,969,074.41007022817535168 UNIV
        );
