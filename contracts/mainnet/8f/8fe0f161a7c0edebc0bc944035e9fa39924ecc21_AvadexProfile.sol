...
*/
contract AvadexProfile is AccessControl, ERC721Holder {
     ...
     * and sends AVEX to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer AVEX tokens to this contract
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer AVEX token to this address
        cakeToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberCakeToUpdate
    ...
    /**
     * @dev Update the number of AVEX to register
     * Callable only by owner admins.
     */
