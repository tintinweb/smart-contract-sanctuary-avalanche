...
contract Abstract is ERC721, Ownable, KindaRandom {
  ...
  constructor() ERC721("ABSTRACT", "ABS") KindaRandom(30) {
    _baseTokenURI = "ipfs://QmfRN9R4VdDXPD9x1QGZRgFsV7kjZuqnkeAsjZbwr17QBw/";
    _baseExtension = ".json";
    ...
    _maxMintPerTx = 1;
    _price = 10 ether;
    _startTime = 1663020000; // Sept 12, 10pm UTC
    
    _artist1 =  0x7EF2e213607A0eE2a35b3C274bc2c6b3E6e2A8e3; // j
    _artist2 =  0xcf50b23A09Fb51E0262A609a0FeE723639F705a2; // s
    _dev     =  0xfE4E7eAf4398f2D36f98081888CC6894c9822ad1;

    _royaltyReceiver = 0x3E19bA7eAcC410950f863746ED08757D5345ABE3;

    _privateMint(0xcf50b23A09Fb51E0262A609a0FeE723639F705a2);
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    payable(_artist1).transfer((msg.value * 450) / 1000);
    payable(_artist2).transfer((msg.value * 450) / 1000);
    payable(_dev).transfer((msg.value * 100) / 1000);
