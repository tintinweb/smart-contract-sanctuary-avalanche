...
contract NeFiFeeManager is Ownable{
	...
	function INTupdateProtoTotalPayable(address _account,uint256 _x) internal {
		...
		uint256 _time =block.timestamp;
		totalfees[address(this)].totalPayable -=protoowners[_account][_x].protoTotalPayable;
		totalfees[address(this)].futureFees -= protoowners[_account][_x].protoFutureFees;
