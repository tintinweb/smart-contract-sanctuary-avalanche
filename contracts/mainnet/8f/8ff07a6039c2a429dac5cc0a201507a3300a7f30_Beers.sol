...
contract Beers is ERC721URIStorage, Ownable, Randomize {
  ...
  constructor() ERC721("Beers", "BEER") Randomize(55) {
    _customBaseURI = "ipfs://bafybeiggacl5pptu2rl2wv5iswttv5f5dtp7beiy5qut6nmh572mooncue/";
    _maxMintable = 54; // 55 max supply, 1 initial mint
    _royaltyAmount = 700; // 7% royalties
    _mintActive = true;
    _maxMintPerTx = 10;
    _price = 0.1 ether;
    _artist = 0xCB636b0C0C21778E1d910Ee28F9DcBC4B412884D;
    _startTime = 1660640400;
