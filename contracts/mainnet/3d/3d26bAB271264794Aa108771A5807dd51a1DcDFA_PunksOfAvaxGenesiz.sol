...
contract PunksOfAvaxGenesiz is ERC721  {
    ...
    constructor()
        ERC721("Punks of Avax: Genesis", "PNKXG")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibq4y7p44626guxq7n7ro4lo6fjmhnlkrg7brvujfwwauppgwkmyi/", Strings.toString(tokenId), ".json")
            );
    }
