...
contract COINBIRD_TOKEN_LOCKER {
    ...
    constructor() {
        USDC_Accessor = SOLIDITY_CONTRACT(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // USDC
    }
    ...
    function createNewLock(address SolidityContract, uint amount, uint time) public {
        ...
        COINBIRD_LOCKS memory newLock = COINBIRD_LOCKS(SolidityContract, contractBIRD.name(), contractBIRD.symbol(), contractBIRD.decimals(), amount, block.timestamp+time*86400);
