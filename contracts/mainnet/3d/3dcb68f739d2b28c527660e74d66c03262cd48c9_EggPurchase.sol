...
contract EggPurchase is Ownable, IERC1155Receiver {
    ...
    constructor(address _eggAddress, uint256 _nftid, address payable _devWallet, uint256 _eggPrice) public {
    ...
    function setPrice(uint256 _eggPrice) public onlyOwner {
        eggPrice = _eggPrice;
    }
    ...
    function purchase(uint256 amount) public payable {
        ...
        require(amount <= 10, "You cannot buy more than 5 Eggs at once");
        require(IERC1155(eggAddress).balanceOf(address(this), nftid) >= amount, "Not enough eggs.");
