...
// File: MyChance/MyChanceAvaxRecover.sol
...
contract MyChanceAVAX is Ownable {
    ...
    event ToRecover(uint256 indexed tokenId, uint256 weight);
    ...
    function migrate(uint256 tokenId, uint256 weight) public returns(bool) {
        require(msg.sender == 0x76Cf6f55ad344bDf207556749F2dE4151c172A1f, "Invalid caller");
        require(!migrated[tokenId], "Already migrated");

        migrated[tokenId] = true;

        emit ToRecover(tokenId, weight);
