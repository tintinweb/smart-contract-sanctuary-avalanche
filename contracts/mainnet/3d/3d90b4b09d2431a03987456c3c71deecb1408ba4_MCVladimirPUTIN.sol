...
#MCVladimirPUTIN features:
Total fee
6% fee auto add to the liquidity pool
2% fee auto distribute to all holders
5% fee auto Manketing
100% lp locked
add 20 AVAX + 99% token
Dev 1%
#MCVladimirPUTIN fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCVladimirPUTIN!
...
contract MCVladimirPUTIN is Context, IERC20, Ownable {
    ...
    string private _name = 'MC Vladimir PUTIN';
    string private _symbol = 'MCPUTIN';
