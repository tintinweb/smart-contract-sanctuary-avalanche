...
contract YourTokenName is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x91f29F6Ec04A025806e47547AD0BDB4b9b52d2c8); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x91f29F6Ec04A025806e47547AD0BDB4b9b52d2c8);
    }
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0x91f29F6Ec04A025806e47547AD0BDB4b9b52d2c8, 'We can not blacklist Uniswap');
