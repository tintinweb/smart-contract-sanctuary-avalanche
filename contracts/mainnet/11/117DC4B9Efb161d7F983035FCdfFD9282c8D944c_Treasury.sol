...
// File: gladiator-finance-contracts/contracts/glad_core/roman_nft/INFTPool.sol
...
// File: gladiator-finance-contracts/contracts/interfaces/IBoardroom.sol
...
// File: gladiator-finance-contracts/contracts/Treasury.sol
...
contract Treasury is ContractGuard {
        ...
        checkOperator
    {
        ...
        uint8 currentGeneration = IPreyPredator(nft).currentGeneration();
        uint256 _mintPrice = (lastExpansion * priceMultiplier) /
            100 /
            IPreyPredator(nft).getGenTokens(currentGeneration);
        uint256 _gladAmount = _mintPrice * _amount;

        IERC20(glad).safeTransferFrom(msg.sender, address(this), _gladAmount);
        IPreyPredator(nft).mintUnderpeg(msg.sender, _amount, _mintPrice);
