...
contract Astronauts is ERC721URIStorage, Ownable, Randomize {
  ...
  constructor() ERC721("Astronauts", "AST") Randomize(45) {
    _customBaseURI = "ipfs://bafybeifiytfxvj5h3yoemwgokrt7p44lajxoev3s23alsdoy5whdzkoxay/";
    _maxMintable = 45; // 45 max supply
    _royaltyAmount = 750; // 7.5% royalties
    _mintActive = true;
    _maxMintPerTx = 10;
    _price = 0.1 ether;
    _artist = 0xCB636b0C0C21778E1d910Ee28F9DcBC4B412884D;
    _startTime = 1661020981;
