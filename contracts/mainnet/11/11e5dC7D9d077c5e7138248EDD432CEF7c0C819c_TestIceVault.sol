...
// contract IceVaultStakingFixedAPR is Ownable {
contract TestIceVault is Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 popsRequiredForLP = _getPopsForLP(totalStaked);
    ...
    function _getPopsForLP(uint256 amount) private view returns(uint256) {
        ...
        return amount * popsReserve / stakingReserve / 2;
    }
