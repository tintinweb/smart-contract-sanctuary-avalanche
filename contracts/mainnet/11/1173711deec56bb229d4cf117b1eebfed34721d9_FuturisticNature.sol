...
// File: contracts/FuturisticNature.sol
...
contract FuturisticNature is ERC721URIStorage, Ownable, Randomize {
  ...
  constructor() ERC721("Futuristic Nature", "FTNT") Randomize(23) {
    _customBaseURI = "ipfs://bafybeicxiahiwqyonx4lgsppbo3o62cwrsqksnujpamczgzarlmjvqpxua/";
    _maxMintable = 23; // 23 max supply
    _royaltyAmount = 750; // 7.5% royalties
    _mintActive = true;
    _maxMintPerTx = 10;
    _price = 0.1 ether;
    _artist = 0xCB636b0C0C21778E1d910Ee28F9DcBC4B412884D;
    _startTime = 1661068200; // gmt 07:50 21th Aug 2022
  ...
  function mint(uint256 quantity) public payable {
    ...
    //require(!_hasMinted[msg.sender]); // Only 1 per wallet allowed
