...
contract DoodleKids is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibuogfnbdlsopwso6364jiwpbyueuoeyo346xpfwrdzqfv4dllmqe/", Strings.toString(tokenId), ".json")
            );
    }
