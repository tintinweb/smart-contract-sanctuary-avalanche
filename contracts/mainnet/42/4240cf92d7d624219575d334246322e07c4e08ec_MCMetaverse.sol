...
liquidity: 70% + 30 avax
#MCMetaverse fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCMetaverse!
...
contract MCMetaverse is Context, IERC20, Ownable {
    ...
    string private _name = 'MC Metaverse';
    string private _symbol = 'MC Metaverse';
