...
// File: contracts/superToken/superAaveToken/superAaveToken.sol
...
// File: contracts/superToken/superAaveToken/superAaveAVAX.sol
...
//
// This contract handles swapping to and from superToken.
contract superAaveAVAX is superAaveToken {
    using SafeERC20 for IERC20;
    // Define the qiToken token contract
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,
    address payable _swapHelper,address payable _feePool)
...
//        authorizedAccounts[leverageFactory] = 1;
        ...
        assetCeiling = uint(-1);
        _setInterestInfo(8e22,3600,1e30,1e27);
    } 
    /**
...
// File: contracts/superToken/lendingAaveToken/lendingAaveAVAX.sol
...
//
// This contract handles swapping to and from superToken.
contract lendingAaveAVAX is superAaveAVAX,lendingSuperToken {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    // Define the qiToken token contract
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,
    address payable _swapHelper,address payable _feePool,address leverageFactory)
        superAaveAVAX(multiSignature,origin0,origin1,_stakeToken,_swapHelper,_feePool)
...
// File: contracts/debug/lendingAaveAVAXDebug.sol
...
//
// This contract handles swapping to and from superToken.
contract lendingAaveAVAXDebug is lendingAaveAVAX,debugger {
    // Define the qiToken token contract
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,
    address payable _swapHelper,address payable _feePool,address leverageFactory)
        lendingAaveAVAX(multiSignature,origin0,origin1,_stakeToken,_swapHelper,_feePool,leverageFactory){
