...
contract MagpieStargateBridge is IMagpieStargateBridge, Ownable {
    ...
    function clearSwap(
        ...
        try IStargateRouter(settings.routerAddress).clearCachedSwap(srcChainId, srcAddress, nonce) {
            return true;
    ...
    function withdraw(WithdrawArgs calldata withdrawArgs) external onlyMagpieAggregator returns (uint256 amount) {
        bool isCleared = clearSwap(withdrawArgs.srcChainId, withdrawArgs.nonce, withdrawArgs.srcAddress);

        amount = deposits[withdrawArgs.networkId][withdrawArgs.senderAddress][withdrawArgs.tokenSequence][
        ...
        deposits[withdrawArgs.networkId][withdrawArgs.senderAddress][withdrawArgs.tokenSequence][
            withdrawArgs.assetAddress
        ] = 0;
    ...
    function sgReceive(
        ...
        deposits[networkId][senderAddress][tokenSequence][assetAddress] += amount;
    }
}
