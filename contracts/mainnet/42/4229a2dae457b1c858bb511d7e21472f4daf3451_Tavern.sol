...
contract Tavern is VRFConsumerBaseV2, Ownable, Pausable, ReentrancyGuard {
    ...
    function setPreyAddress(address _preyAddress) external onlyOwner {
        require(_preyAddress != address(0), "Invalid address");
        preyContract = IRewardToken(_preyAddress);
    }

    function setNFTAddress(address _nftAddress) external onlyOwner {
        require(_nftAddress != address(0), "Invalid address");
        nftContract = AEPNFT(_nftAddress);
    }
