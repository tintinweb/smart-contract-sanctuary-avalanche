...
contract HShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 hSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund) public ERC20("HEROSHARE", "HSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 HERO Share for initial pools deployment
