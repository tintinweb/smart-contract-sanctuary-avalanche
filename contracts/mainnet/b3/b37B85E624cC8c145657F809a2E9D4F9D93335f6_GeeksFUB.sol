...
contract GeeksFUB is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidocq3m3mko6xtq3qala2v3fg2q3qjybsj6diny4564sybgs5kb5y/", Strings.toString(tokenId), ".json")
            );
    }
