...
//  Telegram: https://t.me/LancheToken

// Discord: https://discord.gg/qnvfvMdc
...
contract Lanche is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // rewards in
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Lanche";
    string constant _symbol = "Lanche";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(150); // 1.5%
    uint256 public _maxWallet = _totalSupply.div(200); // 2.0%
    ...
    address public autoLiquidityReceiver=0x26544cC995fabF54Eb5a08690FDEE0C76eAAAF59; //liq address
    address public marketingFeeReceiver=0x26544cC995fabF54Eb5a08690FDEE0C76eAAAF59; // marketing address
