...
// File: contracts/mightyducks.sol
...
contract Mightyducks is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x3E21aF56042C35853f0c191c856bD754f51820ed).call{value: address(this).balance * 50 / 100}("");
    require(hs);
