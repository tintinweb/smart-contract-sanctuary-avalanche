...
// File contracts/RoyaltyDeterminers/MinterRoyaltyDeterminer.sol
...
/**
 * @title MinterRoyaltyDeterminer
 * @author 0xLostArchitect
 *
 * @dev Determines royalty to go to the minter
 */
contract MinterRoyaltyDeterminer is IRoyaltyDeterminer, UUPSUpgradeableBase {
    /**
     * @notice Initiailization function called from the Proxy pattern
     */
    ...
    function determineRoyalty(bytes calldata, address minter)
        external
        pure
        returns (address)
    {
