...
contract OnlyFans is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "OLF";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 2.5%
    uint256 public _maxWallet = _totalSupply.div(1); // 5%
    ...
    address public autoLiquidityReceiver=0xaC2F398Fe1F649E8ACc9524378EF6632f561b51f; //liq address
    address public marketingFeeReceiver=0xA3c200Ae9969c75674CE46f505C8d772283E5Cdd; // marketing address
