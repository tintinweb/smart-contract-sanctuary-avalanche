/**
 *Submitted for verification at snowtrace.io on 2022-06-05
*/
...
contract RoyalCrows is ONFT721, ReentrancyGuard {
    ...
    uint256 public wlPrice = 3 ether;
    uint256 public publicPrice = 4.6 ether;
    uint256 public wlLimit = 2;
        ...
        ONFT721("RoyalCrows", "RC", 0x3c2269811836af69497E5F486A85D7316753cf62)
    {
        setBaseURI("");
        setNotRevealedURI(
            "ipfs://QmeRcKYX5QXEM4aS7Q9afCkUx2hGqHjxefZRp7f8rdLoxo/avax.json"
        );
        nextMintId = 4400;
        maxMintId = 4878;
    }
    ...
    function wlMint(bytes32[] calldata merkleProof, uint256 amount)
        external
        payable
        nonReentrant
    {
