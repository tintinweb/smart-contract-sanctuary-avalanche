...
// - Allow 18 d.p. feeds
contract ChainlinkProxyPriceProviderV3 is IPriceOracleGetterV3, Ownable {
    ...
    /// returns price and decimals of the price feed
    function getAssetPrice(address asset) public view override returns (uint256, uint256) {
