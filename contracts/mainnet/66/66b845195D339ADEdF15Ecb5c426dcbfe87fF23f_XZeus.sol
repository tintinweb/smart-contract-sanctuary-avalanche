...
contract XZeus is Ownable, VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    // emission rate
    uint256 rewardPerBlockNew;
    uint256 rewardActiveTimestamp;
     ...
     * @param _subscriptionId subscript id
     */
    constructor(
        ...
        rewardPerBlockNew = _rewardPerBlockNew;
        ...
        rewardActiveTimestamp = block.timestamp;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) public payable {
        ...
        uint256 feeAmount = getPenalty(_amount);
    ...
    function withdraw(uint256 _pid, uint256 _amount) public {
        uint256 requestId = requestRandomNumbers();
    ...
    /**
     * @notice Request random numbers
     */
    function requestRandomNumbers() public returns (uint256) {
        ...
        override
    {
        ...
        if (pending > 0) {
            rewardToken.safeTransferFrom(rewardHolder, requester, pending);
        }
        ...
        if (withdrawalAmount > 0) {
            ...
            pool.stakingToken.safeTransfer(requester, withdrawalAmount);
    ...
    /**
     * @notice Check Upkeep condition
     * @return upkeepNeeded true if upkeep is needed
     * @return performData perform data
     */
    ...
    {
        upkeepNeeded = block.timestamp > rewardActiveTimestamp + 604800;
    }

    /**
     * @notice Perform Upkeep action
     */
    function performUpkeep(
        bytes calldata /* performData */
    ) external override {
        if (rewardPerBlock != rewardPerBlockNew) {
            rewardPerBlock = rewardPerBlockNew;
        }
    }
