/**
 *Submitted for verification at snowtrace.io on 2022-11-02
*/
...
contract theUdderSide is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("theUdderSide", "UDDERSIDE") {
    _customBaseURI = "ipfs://bafybeia74vmahyzi2kyqgaqgyxdql5qsp2koj6ewtepwizk3tis4i5plyi/";
    _maxMintable = 365; // 365 max supply
    _royaltyAmount = 800; // 8% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 25;
    _price = .5 ether;
    _artist =  0x0075a0D026b60847A89D1B12BE554BA0fA168821;
