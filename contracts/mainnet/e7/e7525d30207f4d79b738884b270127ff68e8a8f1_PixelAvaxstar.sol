...
// File: contracts/PixelAvaxstar.sol
...
contract PixelAvaxstar is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // PUBLIC:   Price : 450000000000000000   MaxTx : 5   MaxPerPerson : 20
    ...
    address public royaltyAddress = 0xb5C5392ae89B3EfAa39110278B0f399f83fd9Ee7;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("PixelAvaxstar","PAVX") Randomizer(maxSupply) {
