...
// Stealth Launch   
// https://twitter.com/Oneverseavax
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x325a98F258a5732c7b06555603F6aF5BC1C17F0a);  
...
contract Oneverse is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $oneverse  = 0x325a98F258a5732c7b06555603F6aF5BC1C17F0a;  
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Oneverse";
    string constant _symbol = "ONEVERSE";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(120); // 7.5%
    uint256 public _maxWallet = _totalSupply.div(120); // 7.5%
    ...
    uint256 liquidityFee = 1250;
    uint256 buybackFee = 0;
    uint256 reflectionFee = 1250;
