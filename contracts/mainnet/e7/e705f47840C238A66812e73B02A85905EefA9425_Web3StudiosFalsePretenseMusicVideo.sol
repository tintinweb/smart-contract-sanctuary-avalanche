...
// File: contracts/Web3StudiosFPMVFINAL.sol
...
contract Web3StudiosFalsePretenseMusicVideo is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("False Pretense Web3 Music Video", "FPW3MV") {
    //_customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmSBDw1xBkeGsia3hzJrB5FtCpYMM9u265h9dCp3Z6L5y8/'; //TEST-URI
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmeHnNEzm5bMCWCL6coKY9w2V2m6kF2NtARMPFxmkTqgRA/'; //PROD-URI
