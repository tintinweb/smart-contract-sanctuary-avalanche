...
contract SpookyChef is Ownable {
    ...
    ISpookyStaking public rewardMinter;
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "SpookyChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(
            ...
            "SpookyChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND"
        );
        massUpdatePools();
    ...
    function setRewardMinter(ISpookyStaking _rewardMinter) external {
        require(
            address(rewardMinter) == address(0),
            "SpookyChef::setRewardMinter: Cannot redefine rewardMinter"
        );
