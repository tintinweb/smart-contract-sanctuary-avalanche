...
// File: gladiator-finance-contracts/contracts/IWhitelistMinimal.sol
...
// File: gladiator-finance-contracts/contracts/interfaces/IOracle.sol
...
// File: gladiator-finance-contracts/contracts/glad_core/Glad.sol
...
// File: gladiator-finance-contracts/contracts/glad_core/PGladRedeemer.sol
...
contract PGladRedeemer is Ownable {
    ...
    constructor (address _glad, address _wl, uint256 _startTime, address[] memory _users) {
        startTime = _startTime;
        wl = IWhitelistMinimal(_wl);
        glad = Glad(_glad);

        _blacklistUsers(_users);
    }
    ...
    function claim() public {
        ...
        glad.mint(msg.sender, amount);
    }

    function blacklistUsers(address[] memory users) external onlyOwner {
        _blacklistUsers(users);
    }

    function _blacklistUsers(address[] memory users) internal {
