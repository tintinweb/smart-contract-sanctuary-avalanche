...
// AReceiptMaster is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterChimpy.
contract AReceiptMaster {
    using SafeMath for uint256;
    ...
    // Info of each user that stakes Liana tokens.
    ...
    // Deposit Liana tokens to AReceiptMaster for Reward allocation.
    ...
    // Withdraw Liana tokens from AReceiptMaster.
