...
contract Management is Ownable {
    ...
    returns (string memory)
  {
    ...
    for (uint256 i = 1; i < nodesCount; i++) {
      ...
      returnValue = string(abi.encodePacked(returnValue, separator, node.name));
    }
    return returnValue;
  }
    ...
    returns (string memory)
  {
    ...
    for (uint256 i = 1; i < nodesCount; i++) {
      ...
      returnValue = string(
        abi.encodePacked(returnValue, separator, uint2str(node.createTime))
      );
    }
    return returnValue;
  }
    ...
    returns (string memory)
  {
    ...
    for (uint256 i = 1; i < nodesCount; i++) {
      ...
      returnValue = string(
        abi.encodePacked(returnValue, separator, uint2str(node.lastClaimTime))
      );
    }
    return returnValue;
  }
    ...
    returns (string memory)
  {
    ...
    for (uint256 i = 1; i < nodesCount; i++) {
      ...
      returnValue = string(
        abi.encodePacked(returnValue, separator, uint2str(node.rewardPerDay))
      );
    }
    return returnValue;
  }
