...
pragma solidity 0.8.13;
    ...
    contract AIMetaDoors is ERC721Enumerable, Ownable, IERC2981Royalties {
        using Strings for uint256;
        
        string public baseURI = "ipfs://QmPiMxwkynwNQGNntUirEH1xrAhPzxVFpsSaF4pNfjsgcy/";
        ...
        constructor () ERC721("Ai MetaDoors", "AIMETADOOR") {
            ...
            function mint(uint256 amount) public {
                ...
                require(amount == 1);
                require(block.timestamp > 1659974400);
