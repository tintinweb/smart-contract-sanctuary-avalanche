...
contract EmeraldNodeV2 is EmeraldNodeStorageV2 {
    ...
    */
    ...
    function buyNode(Order memory order, bytes memory signature) payable isBlacklistedAddress nonReentrant external returns(bool){
        uint256 _tier;
        uint256 nodeId;
        ...
        require(updatedTierDetails[_tier].rewardRate != 0 && updatedTierDetails[_tier].tierEMnodePrice <= EmeraldCoin.balanceOf(msg.sender) && updatedTierDetails[_tier].tierAVAXnodePrice == msg.value, "EmeraldNodeV1: Invalid price or Insufficient balance");
...
contract EmeraldNodeStorageV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
