...
contract MgmGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.11574074 ether; // 25000 TOMB / (72h * 60min * 60s)
    uint256 public runningTime = 2 days; // 2 days
    uint256 public constant TOTAL_REWARDS = 20000 ether;
    // END MAINNET

    address public treasury = 0x7c16C1928484D6c675B86b23C2902f41F428f488;
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint256 depositFee, uint256 _setEndTime) public onlyOperator {
        massUpdatePools();
