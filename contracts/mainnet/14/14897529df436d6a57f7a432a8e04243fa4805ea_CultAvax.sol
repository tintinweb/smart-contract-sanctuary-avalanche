...
contract CultAvax is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Cult Avax";
    string private _symbol = "CultA";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xD78Cf1b82b0600929FF5D229578F2D1CEcc4f533);
    address payable public devWalletAddress = payable(0xD78Cf1b82b0600929FF5D229578F2D1CEcc4f533);
    address payable public teamWalletAddress =  payable(0xD78Cf1b82b0600929FF5D229578F2D1CEcc4f533);
    ...
    uint256 _marketingShare = 60;
    uint256 _devShare = 0;
    uint256 _teamShare = 0;
    ...
    uint256 private minimumTokensBeforeSwap = 75000 * 10**_decimals; 
    ...
    constructor () {
        IDEXRouter _uniswapV2Router = IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
