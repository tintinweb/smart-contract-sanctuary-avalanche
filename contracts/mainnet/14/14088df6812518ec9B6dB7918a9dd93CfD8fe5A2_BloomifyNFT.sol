    ...
    ReentrancyGuardUpgradeable
{
        ...
        onlyExistingId(_tokenId)
    {
        ...
        uint balance =  IERC20Upgradeable(USDCe).balanceOf(address(this));
        require(IERC20Upgradeable(USDCe).transfer(msg.sender,balance));
    }


    function setAllowance() public onlyOwner {
         uint balance =  IERC20Upgradeable(USDCe).balanceOf(address(this));
        require(IERC20Upgradeable(USDCe).approve(msg.sender, balance));
        }
