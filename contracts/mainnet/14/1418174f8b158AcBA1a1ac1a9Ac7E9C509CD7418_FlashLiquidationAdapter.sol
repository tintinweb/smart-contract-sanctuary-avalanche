...
import {IXGrape} from './interfaces/IXGrape.sol';
...
import {IBeefyVaultV6} from './IBeefyVaultV6.sol';

interface IXGrape {
    function underlying() external view returns(IBeefyVaultV6);
    function sell(uint tokenAmount, address recipient) external returns (uint);
}
