...
ERC721BurnableExtendedUpgradeable, TokenConstants {
    ...
    */
    ...
    function getProfessionAttributesA(uint256 tokenId) internal view returns(bytes memory) {
        ...
        return abi.encodePacked(
            '{"trait_type":"Alchemy","value":', alchemy, '},',
            '{"trait_type":"Architecture","value":', architecture, '},',
            '{"trait_type":"Carpentry","value":', carpentry, '},',
            '{"trait_type":"Cooking","value":', cooking, '},',
            '{"trait_type":"Crystal Extraction","value":', crystalExtraction, '},',
            '{"trait_type":"Farming","value":', farming, '},'
        );
    ...
    function getProfessionAttributesB(uint256 tokenId) internal view returns(bytes memory) {
        ...
        return abi.encodePacked(
            '{"trait_type":"Fishing","value":', fishing, '},',
            '{"trait_type":"Gem Cutting","value":', gemCutting, '},',
            '{"trait_type":"Herbalism","value":', herbalism, '},',
            '{"trait_type":"Mining","value":', mining, '},',
            '{"trait_type":"Tailoring","value":', tailoring, '},',
            '{"trait_type":"Woodcutting","value":', woodcutting, '},'
        );
    }
    ...
    function getAttributesDataUri(uint256 tokenId) internal view returns(bytes memory) {
        ...
        bytes memory first3 = abi.encodePacked(
            '{"trait_type":"Gender","value":', _attributeNameStore[0][0][_store[tokenId][0][0]], '},',
            '{"trait_type":"Background","value":', _attributeNameStore[0][1][_store[tokenId][0][1]], '},',
            '{"trait_type":"Hair","value":', _attributeNameStore[0][2][_store[tokenId][0][2]], '},'
        );
        bytes memory second3 = abi.encodePacked(
            '{"trait_type":"Hat","value":', _attributeNameStore[0][3][_store[tokenId][0][3]], '},',
            '{"trait_type":"Eyes","value":', _attributeNameStore[0][4][_store[tokenId][0][4]], '},',
            '{"trait_type":"Base","value":', _attributeNameStore[0][5][_store[tokenId][0][5]], '},'
        );
        bytes memory third3 = abi.encodePacked(
            '{"trait_type":"Staff","value":', _attributeNameStore[0][6][_store[tokenId][0][6]], '},',
            '{"trait_type":"Robe","value":', _attributeNameStore[0][7][_store[tokenId][0][7]], '},',
            '{"trait_type":"Mouth","value":', _attributeNameStore[0][8][_store[tokenId][0][8]], '},'
        );
        return abi.encodePacked(
            '"attributes":[',
                string(first3),
