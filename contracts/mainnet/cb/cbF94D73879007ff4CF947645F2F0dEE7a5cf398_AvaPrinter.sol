...
contract AvaPrinter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaPrinter";
    string constant _symbol = "$Avaprinter";
    ...
    address public autoLiquidityReceiver=0x39ccbf73e649eb8715698C52c89F2136F202890b; //liq address
    address public marketingFeeReceiver=0x49bFF439a645E6fd04C369E09e35cbFd06657648; // marketing address
