...
// File contracts/veRockVoter.sol
...
contract veRockVoter is Ownable{
    ...
    function setListingFeeWeight(uint _listingFeeWeight) public onlyOwner {
        listingFeeWeight = _listingFeeWeight;
    }
    ...
    function listing_fee() public view returns (uint) {
        return ((erc20(base).totalSupply() - erc20(_ve).totalSupply()) / 200) * listingFeeWeight / 10000;
    }
