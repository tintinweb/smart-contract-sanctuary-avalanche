/**
 *Submitted for verification at snowtrace.io on 2023-06-16
*/
...
// File contracts/contracts-upgradable/interfaces/ILayerZeroUserApplicationConfigUpgradeable.sol
...
// File contracts/contracts-upgradable/interfaces/ILayerZeroEndpointUpgradeable.sol
...
// File contracts/contracts-upgradable/interfaces/ILayerZeroReceiverUpgradeable.sol
...
// File contracts/contracts-upgradable/lzApp/LzAppUpgradeable.sol
...
// File contracts/contracts-upgradable/lzApp/NonblockingLzAppUpgradeable.sol
...
abstract contract NonblockingLzAppUpgradeable is Initializable, LzAppUpgradeable {
    ...
    function nonblockingLzReceive(uint16 _srcChainId, bytes calldata _srcAddress, uint64 _nonce, bytes calldata _payload) public virtual {
        ...
        require(_msgSender() == address(this), "caller not LzApp");
...
// File contracts/contracts-upgradable/token/oft/v2/IOFTV2.sol
...
// File contracts/contracts-upgradable/token/oft/v2/ICommonOFTUpgradable.sol
 ...
 * @dev Interface of the IOFT core standard
 */
interface ICommonOFTUpgradable is IERC165 {
...
// File contracts/contracts-upgradable/token/oft/v2/IOFTReceiverV2Upgradable.sol



pragma solidity >=0.5.0;

interface IOFTReceiverV2Upgradable {
    /**
...
// File contracts/contracts-upgradable/token/oft/v2/OFTCoreV2Upgradable.sol
...
abstract contract OFTCoreV2Upgradable is NonblockingLzAppUpgradeable {
    using BytesLib for bytes;
    using ExcessivelySafeCall for address;
    ...
    function __OFTCoreV2Upgradable_init(uint8 _sharedDecimals, address _lzEndpoint) internal onlyInitializing {
    ...
    function callOnOFTReceived(uint16 _srcChainId, bytes calldata _srcAddress, uint64 _nonce, bytes32 _from, address _to, uint _amount, bytes calldata _payload, uint _gasForCall) public virtual {
        ...
        // call
        IOFTReceiverV2Upgradable(_to).onOFTReceived{gas: _gasForCall}(_srcChainId, _srcAddress, _nonce, _from, _amount, _payload);
    }
...
// File contracts/contracts-upgradable/token/oft/v2/BaseOFTV2Upgradable.sol
...
abstract contract BaseOFTV2Upgradable is OFTCoreV2Upgradable, ERC165, IOFTV2 {
    function __BaseOFTV2Upgradable_init(uint8 _sharedDecimals, address _lzEndpoint) internal onlyInitializing {
...
// File contracts/contracts-upgradable/token/oft/v2/ProxyOFTV2Upgradable.sol
...
contract ProxyOFTV2Upgradable is Initializable, BaseOFTV2Upgradable, Proxied {
     ...
     * public functions
     ************************************************************************/
    function __ProxyOFTV2Upgradable_init(address _token, uint8 _sharedDecimals, address _lzEndpoint) internal {
...
// File contracts/HatchyPocket/HatchyTokenProxy.sol
...
contract HatchyTokenProxy is ProxyOFTV2Upgradable {
    ...
    // function setInnerToken(address _address) external onlyOwner {
    //     innerToken = IERC20(_address);
    // }
}