...
interface IDividendDistributor {
    ...
    function depositEP() external payable;
    function depositBP() external payable;
    function depositTP() external payable;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 TP = IBEP20(0x4123C9A65D4B7B415E472b1eD64635472A344BA8); // Reward Diamond Bank DAO
    ...
    function setShare(address shareholder, uint256 amount) external override onlyToken {
     ...
     function depositEP() external payable override onlyToken {
    ...
    function depositBP() external payable override onlyToken {
    ...
    function depositTP() external payable override onlyToken {
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            EP.transfer(shareholder, amount.div(3));
            BP.transfer(shareholder, amount.div(3));
            TP.transfer(shareholder, amount.div(3));
...
contract Test1234 is IBEP20, Auth {
    ...
    address EP = 0x75EcfC5825DC0f1b346dB945D5c463d212CDf2a3; // Reward Nobelium
    address BP = 0x39912D83acb4A373321387300f4FBE88Aa5d6F14; // Reward MidasDAO
    address TP = 0x4123C9A65D4B7B415E472b1eD64635472A344BA8; // Reward Diamond Bank DAO
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Test1234";
    ...
    address public autoLiquidityReceiver=0x834DA41DdeBd0666047da7abe0B25f8097F70142; //liq address
    address public marketingFeeReceiver=0x834DA41DdeBd0666047da7abe0B25f8097F70142; // marketing address
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        try distributor.depositEP{value: amountAVAXReflection}() {} catch {}
        try distributor.depositTP{value: amountAVAXReflection}() {} catch {}
        try distributor.depositBP{value: amountAVAXReflection}() {} catch {}
