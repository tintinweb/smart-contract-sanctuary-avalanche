...
contract mambo is ERC721EnumerableUpgradeable, OwnableUpgradeable, ERC2981Upgradeable, UUPSUpgradeable, ClampedRandomizer {
    ...
    function initialize() public initializer {
        __ERC721_init("Mambo", "MAMBO");
        __ERC721Enumerable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __ClampedRandomizer_init(36);
        __Context_init();
        __ERC165_init();
        __ERC2981_init();
        customBaseURI = "ipfs://bafybeiezybdoam5nvu6astcgqtzcfvhsh7e4cuu3cqhqbq27uv7inec2gy/";
        unrevealedURI = 'ipfs://bafybeidb6qlexaxd75mvuot4c73jqh6bme5i3t6aeauhhrrv6kbsch7xzu/1.json';
    ...
    function setWhitelist(address[] memory addresses, bool status) public onlyOwner {
    ...
    function mint() public {
        ...
        require(totalSupply() + 1 <= maxMintable);
        ...
        returns (string memory)
    {
        ...
        if(revealed){
        return string.concat(customBaseURI, tokenId.toString(), '.json');
        }else{
...
contract ClampedRandomizer is Initializable {
    ...
    function __ClampedRandomizer_init(uint256 scopeCap) internal initializer {
        _scopeCap = scopeCap;
        _scopeIndex = 0;
    }
