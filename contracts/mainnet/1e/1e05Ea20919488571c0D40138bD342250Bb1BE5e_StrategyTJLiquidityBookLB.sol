...
contract StrategyTJLiquidityBookLB is StratManager {
    ...
    returns (uint256[] memory depositIds, uint256[] memory liquidityMinted)
    {
        ...
        console.log("active id: %s", activeId);
        console.log("balance X: %s", tokenX.balanceOf(address(this)));
        console.log("balance Y: %s", tokenY.balanceOf(address(this)));

        console.log("try to deposit X: %s", amountX);
        console.log("try to deposit Y: %s", amountY);
    ...
    function _removeLiquidity(
        ...
        console.log("X: %s, slippage X: %s", totalXBalanceWithdrawn, minTotalXBalanceWithSlippage);
