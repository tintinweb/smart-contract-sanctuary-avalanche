...
// Reflections IN BTC 
// TG https://t.me/ava1play
// TW https://twitter.com/ava1play
// Website https://ava1play.xyz *Coming Soon*
...
4% Reflections in BTC B (Native Avax)
4% Marketing
1% Liquidity

1st Hour - 5% Tax in BTC B Reflections - 0% Marketing - 0% Liquidity
2nd Hour - 5% Tax in BTC B Reflections - 4% Marketing - 1% Liquidity
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTC = IBEP20(0x152b9d0FdC40C096757F570A51E494bd4b943E50);
...
contract Ava1Play is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BTC = 0x152b9d0FdC40C096757F570A51E494bd4b943E50; // BTC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ava 1 Play";
    string constant _symbol = "1PLAY";
    uint8 constant _decimals = 5;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(25); // 0.55%
    uint256 public _maxWallet = _totalSupply.div(20); // 2,5%
    ...
    address public autoLiquidityReceiver=0xF69369072c7C92673424e13824c12A0caEc44fF5;
    address public marketingFeeReceiver=0xF69369072c7C92673424e13824c12A0caEc44fF5;
