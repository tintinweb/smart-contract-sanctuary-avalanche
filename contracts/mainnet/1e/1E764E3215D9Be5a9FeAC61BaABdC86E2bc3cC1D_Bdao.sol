...
contract Bdao is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BDAO", "BDAO") {
        _mint(msg.sender, 1 ether); // mint 1 BAM Share for initial pools deployment
