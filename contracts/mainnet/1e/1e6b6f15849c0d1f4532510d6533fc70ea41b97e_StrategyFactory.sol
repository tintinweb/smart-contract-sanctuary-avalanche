...
contract StrategyFactory {
    ...
    constructor(address _asset, string memory _name, uint16 _stakingID, address _openflowInstance) {
        newStrategy(_asset, _name, _stakingID, _openflowInstance, msg.sender, msg.sender, msg.sender);
    }
    ...
    function newStrategy(
        ...
        IStrategy _newStrategy = IStrategy(
            address(new Strategy(_asset, _name, _stakingID, _openflowInstance))
        );
