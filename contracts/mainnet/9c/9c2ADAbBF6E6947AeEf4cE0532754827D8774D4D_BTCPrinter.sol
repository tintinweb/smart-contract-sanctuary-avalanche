...
contract BTCPrinter is IBEP20, Auth {
    ...
    address WBTC = 0x50b7545627a5162F82A992c33b87aDc75187B218; // btc
    ...
    constructor (
        address _dexRouter, address _marketingAddress, address _wAVAX, address _receiver
    ) Auth(_receiver) {
        ...
        isTxLimitExempt[_receiver] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        buyBacker[_receiver] = true;
