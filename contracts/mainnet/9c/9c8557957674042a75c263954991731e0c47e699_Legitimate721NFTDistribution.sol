...
// File: contracts/Legitimate721NFTDistribution.sol
...
contract Legitimate721NFTDistribution is ERC721Psi, AccessControl {
    ...
    // METADATA
    string public nftTitle = "WhiteMoon Dreams @ Comic-Con 2023"; // Title of the NFT collection
    string public nftDescription = "WhiteMoon Dreams is a video game studio founded in 2007 and has been creating games for console and VR titles for first party publishers such as Sony."; // Description in string or markdown format
    string public nftAnimationUri = ""; // IPFS or HTTP URL
    string public nftImageUri = "https://ipfs.legitimate.tech/ipfs/Qmc8SePSy9Xkam6sF9e6a7nbFbtSiQbfcgzGLr1xvuFSjd"; // IPFS or HTTP URL
    ...
    constructor() ERC721Psi("WhiteMoonDreamsSDCC23", "WhiteMoonDreamsSDCC23") {
