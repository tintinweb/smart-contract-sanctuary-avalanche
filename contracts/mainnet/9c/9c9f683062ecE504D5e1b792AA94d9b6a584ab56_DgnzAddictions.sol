...
contract DgnzAddictions is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    // CONSTANTS
    uint public constant MAX_SUPPLY = 1700;
    ...
    uint public maxPerPerson = 2200;
    uint public price = 2000000000000000000;
    uint public whiteListPrice = 1500000000000000000;
    address public royaltyAddress = 0x0dA947bE36330D35cCCa6BFE1ba679D5E91e0eF0;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Dgnz Addictions", "DEGN") ClampedRandomizer(maxSupply) {
