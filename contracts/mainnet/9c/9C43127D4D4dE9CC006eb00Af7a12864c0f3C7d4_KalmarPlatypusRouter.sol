...
// File: contracts/interfaces/IPlatypus.sol
...
// File: contracts/routes/KalmarPlatypusRouter.sol
...
contract KalmarPlatypusRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve-mim-usdt-usdc
    IPlatypus public constant platypusPool = IPlatypus(0xAEA2E71b631fA93683BCF256A8689dFa0e094fcD);
        ...
        returns(uint256 _destAmount)
    {
        ...
        if (!isAvailableToken(address(_src)) || !isAvailableToken(address(_dest))) {
            return 0;
        }
