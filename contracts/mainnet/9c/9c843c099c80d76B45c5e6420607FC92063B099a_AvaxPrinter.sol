...
contract AvaxPrinter is IERC20 {
    ...
    string constant private _name = "Avax Printer";
    string constant private _symbol = "$APRINT";
    ...
    constructor () payable {
        ...
        developmentWallet = payable(_owner);
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 rewards, uint16 development) external {
        require(msg.sender == developmentWallet || msg.sender == _owner, "Caller =/= Owner.");
        ...
        _ratios.total = _ratios.liquidity + _ratios.marketing + _ratios.development + _ratios.rewards;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.total <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable development) external {
        require(msg.sender == developmentWallet || msg.sender == _owner, "Caller =/= Owner.");
        if (msg.sender == developmentWallet) {
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        try dexRouter.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
            swapAmt,
            0,
            path,
            address(this),
        ...
        if (toLiquify > 0) {
            try dexRouter.addLiquidityAVAX{value: liquidityBalance}(
                address(this),
                toLiquify,
                0,
                0,
