...
contract BakumiAVAX is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifvvvlumocebxc3qhkyk3dj5mxiptkt4326e3rbh6akdqylwxpyei/", Strings.toString(tokenId), ".json")
            );
    }
