...
contract Ukrainu is IERC20, Ownable
{
    ...
    constructor () {
        ...
        _UniswapPairAddress = IJoeFactory(_UniswapRouter.factory()).createPair(address(this), 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    ...
    function Politburo_getTaxes() public view returns(uint256 treasuryTax, uint256 growthTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
    ...
    function KGB_SetClaimer(address addy) public onlyTeam {
        claimAddress = addy;
    }
    ...
    function Politburo_ActivateGasSaver(bool booly) public onlyTeam {
        gasSaver = booly;
    }
    ...
    function Politburo_SetTaxes(uint8 treasuryTaxes, uint8 growthTaxes, uint8 liquidityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyTeam{
    ...
    function Politburo_ChangeTreasuryShare(uint8 newShare) public onlyTeam{
    ...
    function Soviet_EnableTrading(bool booly) public onlyTeam{
        tradingEnabled = booly;
    }

    
    function Soviet_LiquidityTokenAddress(address liquidityTokenAddress) public onlyTeam{
