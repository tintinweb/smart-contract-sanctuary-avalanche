...
contract MuOracle{
    ...
    function internal_MU_USDCe_pool_info() internal view returns(address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1, uint256 muUSDe, uint32 _blockTimestampLast){
    ...
    function get_MU_USDCe_pool_info() public view returns (address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1, uint256 muUSDe, uint32 _blockTimestampLast){
        return internal_MU_USDCe_pool_info();
    }


    function internal_mu_daie_traderjoes_pool_info() internal view returns(address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1, uint256 muUSDe, uint32 _blockTimestampLast){
    ...
    function get_mu_daie_traderjoes_pool_info() public view returns (address LPpool, address token0, address token1, uint112 _reserve0,uint112 _reserve1, uint256 muUSDe, uint32 _blockTimestampLast){
