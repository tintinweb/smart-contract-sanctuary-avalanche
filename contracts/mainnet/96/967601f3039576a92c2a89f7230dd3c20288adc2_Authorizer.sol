...
// File @rumble-finance/solidity-utils/contracts/helpers/[email protected]
...
function _revert(uint256 errorCode) pure {
    ...
    assembly {
        ...
        // With the individual characters, we can now construct the full string. The "RUMBLE#" part is a known constant
        // (0x52554d424c4523): we simply shift this by 24 (to provide space for the 3 bytes of the error code), and add the
        // characters to it, each shifted by a multiple of 8.
        // The revert reason is then shifted left by 200 bits (256 minus the length of the string, 7 characters * 8 bits
        // per character = 56) to locate it in the most significant part of the 256 slot (the beginning of a byte
        // array).

        let revertReason := shl(200, add(0x52554d424c4523000000, add(add(units, shl(8, tenths)), shl(16, hundreds))))
...
// File @rumble-finance/solidity-utils/contracts/openzeppelin/[email protected]
