...
DemonSlayerInus is a community driven token that rewards in $Joe . DemonSlayerInus Plan on creating a long term token where are as holders will be able to change the course of the Anime Demon Slayer.

This will be a native token. That will hit millions of marketCap. We plan on changing the Japanese industry. If  holders doesn't like the way DemonSlayer is going . They will be able to vote via how many tokens they hold. And if they like the movement of DemonSlayer , a tax will be deducted from the devs which will be used to support the DemonSlayer Anime.

Sounds Crazy??
It's broken Down below

We plan on changing the Japanese system of Anime Production. This token will be a voting and rewarding token. Top 5 holders will always be able to get early access to the release of DemonSlayer Anime. Holders will also be rewarded in $Joe. 


Taxes ?
8% Marketing . So expect A moonshot
6% Liquidity to attain a stable price floor
4% Rewards in $Joe


Telegram : https://t.me/DemonSlayerInus
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd); // reward address JOE
...
contract DemonSlayerInus is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; // reward JOE
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DemonSlayerInus";
    ...
    address public autoLiquidityReceiver=0xD39eC8d7AA6F9a412f161CaCd8d1e4C278E43Bc5; //liq address
    address public marketingFeeReceiver=0x526E6Af15c395cEaff6d7f8564dfb1cD8b1EcEEF; // marketing address
