...
contract Clausina is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxPerWallet = 10;              // Max amount of tokenIDs allowed to be minted by single wallet
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if(whitelistedOnly)
    require(whiteListed[msg.sender] >= 1,"Error: you are not whitelisted or amount is higher than limit");
