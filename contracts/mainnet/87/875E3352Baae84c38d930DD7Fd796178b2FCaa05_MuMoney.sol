...
contract MuMoney is ERC20, ERC20Burnable, Ownable, Pausable {
    ...
    //allows to recover any token sent to this smart contract, sends  the funds to the Mu Bank
    function recoverTokens(address tokenAddress) external onlyOwner {
		IERC20 token = IERC20(tokenAddress);
		token.transfer(muBank, token.balanceOf(address(this)));
	}
}