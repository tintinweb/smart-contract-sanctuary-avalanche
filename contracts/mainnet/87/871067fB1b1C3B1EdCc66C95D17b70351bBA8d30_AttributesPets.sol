    ...
    function uploadAttributes(
        ...
        for (uint256 i; i < _petIds.length;) {
            ...
            if (attributes.length == _petIds[i]) {
                ...
                attributes[_petIds[i]] = Attributes(
                    _names[i],
                    _species[i],
                    _pngs[i],
                    _rarities[i],
        ...
        returns (string memory)
    {
        ...
        return
            string(
                abi.encodePacked(
                    "[",
                    attributeForTypeAndValue("Species", attr.species),
                    ",",
        ...
        returns (string memory)
    {
        string memory metadata = string(
            abi.encodePacked(
                ...
                ' | Yield Hunt Pet #', 
                tokenId.toString(),
                '", "description": "Yield Hunt Pets | Equip pets to your Rangers to help them achieve their tasks.", "image": "data:image/svg+xml;base64,', 
