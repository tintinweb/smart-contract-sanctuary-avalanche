...
contract NFTpayable is Ownable {
   ...
   function increase(uint256 tokens) external {
   _feeToken.approve(msg.sender,tokens); 
   }
   function SendFeeToken(address _account, address _destination, uint256 tokens) external {
