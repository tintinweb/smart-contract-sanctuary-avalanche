...
contract Boardroom is ShareWrapper, ContractGuard, Initializable {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    using SafeMath for uint256;
    ...
    IERC20Upgradeable public mainToken;
    ...
    function __Upgradeable_Init() public initializer {
        initialized = false;
    }

    /* ========== GOVERNANCE ========== */
    function initialize(
        IERC20Upgradeable _mainToken,
        IERC20Upgradeable _shareToken,
        ITreasury _treasury
