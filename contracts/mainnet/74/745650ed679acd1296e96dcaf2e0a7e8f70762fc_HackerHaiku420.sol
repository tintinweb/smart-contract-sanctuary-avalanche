...
contract HackerHaiku420 is ERC721Enumerable, Ownable {
    error MaxNfts();


    using Strings for uint256;
    mapping(uint256 => string) private wordsToTokenId;
    uint private fee = 0.4 ether;
    uint256 minted = 0;
    mapping (string => bool) public  newString;
    string text;
    

    constructor() ERC721("Hacker Haiku 420", "HH420") {}
        ...
        return
            Base64.encode(
                 abi.encodePacked(
                    ...
                    '<style>@keyframes yg{0%{fill:#ff0}10%{fill:#305f228}}</style>',
                    ...
                    '</defs>',
                     ...
                     '<text style="font-family:Courier New;fill:#05f228;font-size:26.47px;animation:yg 4s 3.9s infinite">',
                     '<textPath xlink:href="#path1">', _Prompt,'</textPath>',"</text>" ,'<rect x="0%" y="0%" width="100%" height="100%" fill="none" stroke="#05f228" stroke-width="1%"/>',
                     "</svg>"
                )
            );
    }
        ...
        returns (string memory)
    {
        ...
        bytes memory title = abi.encodePacked("Hacker Haiku 420 #", _tokenId.toString());
                ...
                bytes.concat(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            "{"
                                '"name":"', title, '",'
                                '"description":"Hacker Haiku 420 is a collection by You and Me. ",'
