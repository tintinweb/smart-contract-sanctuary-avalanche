...
contract CraftersAnimals is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 80; //  80 total for this launch
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 1500; // 100 = 1%, 200 = 2% etc...  15% for this launch
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant MAX_PUBLIC_CLAIM = 1;
    uint256 public constant NFT_PRICE = 2 ether; // 2 avax for this launch 
    uint public startAt;
