...
contract CompounderPTP is Initializable, OwnableUpgradeable, ERC20Upgradeable {
    ...
    function _withdraw(uint256 _amount, uint256 _minAmount) internal {
    ...
    function withdraw(uint256 amount, uint256 minAmount) external {
        ...
        _withdraw(amount, minAmount);
        uint256 withdrawnAmount = depositToken.balanceOf(address(this)) - previousBalance;
    ...
    function convertDust() public {
        _swapToWavax(address(depositToken), depositToken.balanceOf(address(this)));
    }
}
