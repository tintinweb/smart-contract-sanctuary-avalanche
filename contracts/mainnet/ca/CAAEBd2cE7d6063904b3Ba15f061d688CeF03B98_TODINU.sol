...
contract TODINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TOD Inu";
    string private _symbol = "TOD";
    ...
    address payable public devWalletAddress = payable(0x0000000000000000000000000000000000000000);
    address payable public teamWalletAddress =  payable(0x0000000000000000000000000000000000000000);
    address payable public uWalletAddress =  payable(0x0000000000000000000000000000000000000000);
    ...
    uint256 _liquidityShare = 85;
    uint256 _marketingShare = 5;
    uint256 _devShare = 5;
    uint256 _teamShare = 5;
    uint256 _uShare = 0;
    ...
    uint256 private _totalSupply =  444200* 10**_decimals;
