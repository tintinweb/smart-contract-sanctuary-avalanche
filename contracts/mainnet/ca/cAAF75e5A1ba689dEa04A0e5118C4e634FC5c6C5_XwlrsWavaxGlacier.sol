...
// File contracts/XwlrsWavaxGlacier.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract XwlrsWavaxGlacier  is Ownable, Pausable {
    ...
    address public constant xwlrs = address(0x2dc3Bb328000553D1D64ec1BEF00572F62B5Ec7C);
    address public want;
    ...
    IGlacierRouter.Routes[] public glcrToXwlrsPath;
    ...
    constructor(
        ...
        IGlacierRouter.Routes[] memory _glcrToXwlrsPath,
        ...
        for (uint i; i < _glcrToXwlrsPath.length; ++i) {
            glcrToXwlrsPath.push(_glcrToXwlrsPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IGlacierRouter(router).swapExactTokensForTokens(glcrHalf, 0, glcrToXwlrsPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wavax).balanceOf(address(this));
        uint256 t2Bal = IERC20(xwlrs).balanceOf(address(this));

        IGlacierRouter(router).addLiquidity(wavax, xwlrs, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(xwlrs).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(xwlrs).safeApprove(router, type(uint).max);
    }
