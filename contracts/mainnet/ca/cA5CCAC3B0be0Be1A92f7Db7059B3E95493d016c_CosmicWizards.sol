    ...
    */
    ...
    function getProfessionAttributesA(uint256 tokenId) internal view returns(bytes memory) {
        bytes memory a = abi.encodePacked(
            '{"trait_type":"Alchemy","display_type":"number","value":"', _store[tokenId][1][0].toString(), '"},',
            '{"trait_type":"Architecture","display_type":"number","value":"', _store[tokenId][1][1].toString(), '"},',
            '{"trait_type":"Carpentry","display_type":"number","value":"', _store[tokenId][1][2].toString(), '"},'
        );
        bytes memory b = abi.encodePacked(
            '{"trait_type":"Cooking","display_type":"number","value":"', _store[tokenId][1][3].toString(), '"},',
            '{"trait_type":"Crystal Extraction","display_type":"number","value":"', _store[tokenId][1][4].toString(), '"},',
            '{"trait_type":"Farming","display_type":"number","value":"', _store[tokenId][1][5].toString(), '"},'
        );
    ...
    function getProfessionAttributesB(uint256 tokenId) internal view returns(bytes memory) {
        bytes memory a = abi.encodePacked(
            '{"trait_type":"Fishing","display_type":"number","value":"', _store[tokenId][1][6].toString(), '"},',
            '{"trait_type":"Gem Cutting","display_type":"number","value":"', _store[tokenId][1][7].toString(), '"},',
            '{"trait_type":"Herbalism","display_type":"number","value":"', _store[tokenId][1][8].toString(), '"},'
        );
        bytes memory b = abi.encodePacked(
            '{"trait_type":"Mining","display_type":"number","value":"', _store[tokenId][1][9].toString(), '"},',
            '{"trait_type":"Tailoring","display_type":"number","value":"', _store[tokenId][1][10].toString(), '"},',
            '{"trait_type":"Woodcutting","display_type":"number","value":"', _store[tokenId][1][11].toString(), '"},'
        );
        return abi.encodePacked(string(a), string(b));
    }
    ...
    function getRewardsClaimedAttributes(uint256 tokenId) internal view returns(bytes memory) {
        return abi.encodePacked(
            '{"trait_type":"Chests Claimed","display_type":"boost_number","value":"', _store[tokenId][2][0].toString(), '"}'
        );
    }
