...
contract TrippyTriangles is ERC721 {
    ...
    uint256 public whitelistCost = 0.80 ether;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeic6tfolg52rlgkouplkaipwwe4hnkf5bbhdryswk3u5gslswysi64/", Strings.toString(tokenId), ".json")
            );
    }
