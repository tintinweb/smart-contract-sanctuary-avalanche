...
contract AvaxSkeletons is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    uint256 public _price = 1 ether;
    uint256 public _price_Public = 1.2 ether;
    uint256 public _maxMintable = 150;
    ...
    constructor(
        ...
        address _walletFundsA_70,
        address _walletFundsB_20,
        address _walletFundsC_10,
        address royaltyAddr
    ) ERC721("Avax Skeletons", "ASKL") {
        walletFundsA = _walletFundsA_70;
        walletFundsB = _walletFundsB_20;
        walletFundsC = _walletFundsC_10;
    ...
    function splitFunds(uint256 mintValue) private {
        uint256 amountA = (mintValue * 70) / 100; // Artist 
        uint256 amountB = (mintValue * 20) / 100;
        uint256 amountC = (mintValue * 10) / 100;
