...
contract ParrotMan is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeido47oc7eu3nsjc3jhiu7s7r5u4i2nxxdgfyvq74aoqo5kggjojee/", Strings.toString(tokenId), ".json")
            );
    }
