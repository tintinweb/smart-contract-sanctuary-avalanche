...
contract ChungusAmongUs is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigqqv2ukzlz4osvucxsb2tqvyq5rfx74qscmfe5zeqxzjmhnzonce/", Strings.toString(tokenId), ".json")
            );
    }
