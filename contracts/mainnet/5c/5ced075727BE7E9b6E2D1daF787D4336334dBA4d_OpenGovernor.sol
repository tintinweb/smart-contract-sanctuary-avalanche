...
// base generated via https://wizard.openzeppelin.com/#governor
...
contract OpenGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction {
    constructor(IVotes _token, uint256 _initialVotingPeriod)
        Governor("OpenGovernor")
        GovernorSettings(1 /* 1 block */, _initialVotingPeriod /* in blocks */, 1e18 /* proposal threshold: 1 */)
