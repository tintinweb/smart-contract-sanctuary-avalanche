...
contract ThiefUpgrading is Ownable, Pauseable {
    ...
    function getTraitsAndLevel(uint256 tokenId) public view returns (IPoliceAndThief.ThiefPolice memory _t, uint256 level) {
...
interface IPoliceAndThief is IERC721 {
