...
contract CRYPTOWINX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "CRYPTOWINX";
    string private _symbol = "WINX";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**9; //Max tx amount
