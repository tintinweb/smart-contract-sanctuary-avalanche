...
With recent King token success, we offer you a chance to earn King by holding KingPrinter token.

10% Buy/Sell tax

You will earn 8% King from buy/sell tax

No team tokens.

More information in our telegram channel

Tg - https://t.me/KingPrinterToken
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xf3EC49ACb3084618121741e4BBB20996D383E9b2);
...
contract KingPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xf3EC49ACb3084618121741e4BBB20996D383E9b2; // King
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KingPrinter";
    string constant _symbol = "KingPrinter";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(15); // 3 %
	uint256 public _maxWallet = _totalSupply.div(15); // 3 %
    ...
    address public autoLiquidityReceiver=0xAAc67165b6747eD89a4e10849Fd6116e0D30fE46;
    address public marketingFeeReceiver=0xAAc67165b6747eD89a4e10849Fd6116e0D30fE46;
