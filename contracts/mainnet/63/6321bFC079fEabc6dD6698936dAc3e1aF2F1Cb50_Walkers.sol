 ...
 * @title Walkers WALK
 *
 * @dev walkers.io governance token.
 */
contract Walkers is ERC20Burnable, ERC20VotesComp {
    constructor() ERC20("Walkers", "WALK") ERC20Permit("Walkers") {
        _mint(_msgSender(), 2e9 * 1e18);
    }
