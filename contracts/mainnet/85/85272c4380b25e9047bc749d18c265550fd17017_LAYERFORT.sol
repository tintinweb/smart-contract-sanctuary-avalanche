...
contract LAYERFORT is ERC20, Ownable {
    ...
    address public operationsWallet = 0x36B6E88Ae6f0cf4c3B0E629C9b1D0AE044877036;
    ...
    Taxes public buyTaxes = Taxes(5, 5, 1, 1, 1, 1);
    Taxes public sellTaxes = Taxes(5, 5, 1, 1, 1, 1);
    ...
    function setUpDividendTracker(address payable _dividendTracker) external onlyOwner {
        dividendTracker = LayerFortDividendTracker(_dividendTracker);
    ...
    function swapAndLiquify(uint256 tokens, uint256 swapTax) private {
        ...
        uint256 avaxToAddLiquidityWith = unitBalance * sellTaxes.liquidity;
