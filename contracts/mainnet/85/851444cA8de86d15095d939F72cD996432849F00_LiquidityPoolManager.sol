...
contract LiquidityPoolManager is Ownable, OwnerRecovery, PyramidPointer {
  ...
  address[] public feeAddresses = [
    address(0xF9CF5479100fBFBdCe2Dc729dDe2dF0B0D8d538A), // Treasury investments (30%)
    address(0xd90ac8ABb32444F01D344c818eA7182572Bd4797), // Marketing (40%)
    address(0xDf4EdeC50442bb9Eb757157878D1467959e609dC) // Dev (30%)
  ];
  uint8[] public feePercentages = [30, 40]; // Last address receives the remaining percentage
