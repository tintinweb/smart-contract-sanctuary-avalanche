...
https://discord.gg/TTrHj5HAFX

https://bunnyfinance.xyz
...
contract Bshare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("Bunny Shares", "BSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 Snowtomb Lot for initial pools deployment
