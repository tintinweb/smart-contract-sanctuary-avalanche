...
// File contracts/interfaces/ISoliSnekStrat.sol



pragma solidity 0.8.17;
interface ISoliSnekStrat {
...
contract GrimVaultV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    ISoliSnekStrat public strategy;
    ...
    function balance() public view returns (uint) {
        return want().balanceOf(address(this)) + ISoliSnekStrat(strategy).balanceOf();
    }
    ...
    function proposeStrat(address _implementation) public onlyAdmin {
        require(address(this) == ISoliSnekStrat(_implementation).vault(), "!Valid proposal");
    ...
    function upgradeStrat() public onlyAdmin {
        ...
        strategy = ISoliSnekStrat(stratCandidate.implementation);
