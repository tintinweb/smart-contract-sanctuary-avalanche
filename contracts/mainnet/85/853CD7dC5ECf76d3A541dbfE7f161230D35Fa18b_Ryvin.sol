...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Ryvin is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ryvin", "RYV") {
        ...
        uint256 totalSupply = 600000 * 1e18;
        
        //maxTransactionAmount = totalSupply * 20 / 1000; // 
        maxTransactionAmount = 600000 * 1e18;
        maxWallet = totalSupply * 600000 / 1000; // 6% maxWallet
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x60aE616a2155Ee3d9A68541Ba4544862310933d4) &&
                !swapping
            ){
                if(!tradingActive){
