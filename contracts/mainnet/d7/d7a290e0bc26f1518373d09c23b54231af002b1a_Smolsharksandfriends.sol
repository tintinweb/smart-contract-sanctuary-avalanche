...
// File: contracts/smolsharksandfriends.sol
...
contract Smolsharksandfriends is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // INSTRUCTIONS
    // WHITELISTED: Price : 100000000000000000   MaxTx : 10   MaxPerPerson : 10
    // PUBLIC:   Price : 100000000000000000   MaxTx : 10   MaxPerPerson : 10
    ...
    address public royaltyAddress = 0x0996442A50ba70a708CDA5d55b5955085b70A520;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Smolsharks and friends","SMSF") Randomizer(maxSupply) {
