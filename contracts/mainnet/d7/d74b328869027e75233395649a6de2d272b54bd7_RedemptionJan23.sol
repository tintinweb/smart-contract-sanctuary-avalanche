...
interface IRedemptionJan23 {
    function exchangeForAssets(uint256 amountIn, address account, uint256 amount, bytes32[] calldata merkleProof) external returns (uint256 USDCtoReceive);
}

contract RedemptionJan23 is IRedemptionJan23 {
    using SafeTransferLib for ERC20;

    event Claimed(address indexed claimer, uint256 amountIn, uint256 amount);

    address DEAD = 0x0009ac20ABDf6113A3F71B1dFc87dC7128DA0000;
    ...
    uint256 public constant USDC_EXCHANGERATE = 27318 * USDC_PRECISION;
    ...
    function exchangeForAssets(uint256 amountIn, address account, uint256 amount, bytes32[] calldata merkleProof) external notTimedOut returns (uint256 USDCtoReceive) {
