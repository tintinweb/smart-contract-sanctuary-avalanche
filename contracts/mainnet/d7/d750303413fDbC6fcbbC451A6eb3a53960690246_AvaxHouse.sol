...
contract AvaxHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {

    using SafeERC20 for IERC20;
	// MIM on Avalanche Mainnet =========================================================
	//
	address private constant TOKEN_ADDRESS = 0x130966628846BFd36ff31a822705796e8cb8C18D;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 100000000000000; // default 0.0001 MIM
    ...
    uint256 minDeposit = 10000000000000000; // default 0.01 MIM
	...
	uint256 vrfFee= 10000000000000000; // default 0.01 AVAX. 12 Cents ATM
