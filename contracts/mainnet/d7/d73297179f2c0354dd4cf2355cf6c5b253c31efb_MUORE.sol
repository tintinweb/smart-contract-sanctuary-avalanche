...
interface IERC20Wrapper{
    function getHoldersArray() external returns(address[] memory);
}


contract MUORE is ERC20, ERC20Wrapper, IERC20Wrapper{
    constructor()
    ERC20("Mu Ore", "MUO")
    ERC20Wrapper(IERC20(0xF7ed17f0Fb2B7C9D3DDBc9F0679b2e1098993e81))
    {}

    function getHoldersArray() public virtual override returns(address[] memory){
        return holders;
    }
}