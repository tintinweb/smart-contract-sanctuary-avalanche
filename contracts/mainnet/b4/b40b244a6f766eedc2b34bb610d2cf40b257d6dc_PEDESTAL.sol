...
/**
 *Submitted for verification at snowtrace.io on 2022-19-03
 */
...
contract PEDESTAL is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    ) ERC20("Pedestal Node Finance", "PEDESTAL") PaymentSplitter(payees, shares) {
