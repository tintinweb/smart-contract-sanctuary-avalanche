    ...
    ERC721Pausable
{
    ...
    function awardItem(address recipient, string memory tokenHash)
        ...
        returns (uint256)
    {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC721NFT: must have minter role to mint");
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721NFT: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "ERC721NFT: must have pauser role to unpause");
        _unpause();
    }
...
contract AcademyNFT is NFT {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor() ERC721("Autonolas Agent Developer Academy Graduates", "AUTONOLAS-ACADEMY-GRADS") {
...
contract CommunityNFT is NFT {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor() ERC721("Autonolas Community Recognition Avatars", "AUTONOLAS-RECOGNITION-AVATARS") {
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
        _setupRole(MINTER_ROLE, _msgSender());
        _setupRole(PAUSER_ROLE, _msgSender());
    }
