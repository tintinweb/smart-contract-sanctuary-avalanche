...
contract LEAFTEST is ERC20Detailed, Ownable {
    ...
    string public _name = "LEAFTEST";
    string public _symbol = "LEAFTEST";
    ...
    address public devWallet = 0x2F0d6ca3Edf0e703577dcC7759b353934F7d1F3b;
    ...
    constructor() ERC20Detailed("LEAFTEST", "LEAFTEST", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x2F0d6ca3Edf0e703577dcC7759b353934F7d1F3b; //0xDaf768d6b128A352670776d638583ac872aacDf6; 
    ...
    function takeFee(
        ...
        require(state[0], "state 0 passed!");
