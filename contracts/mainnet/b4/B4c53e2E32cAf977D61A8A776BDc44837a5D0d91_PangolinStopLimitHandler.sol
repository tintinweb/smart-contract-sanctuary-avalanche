...
contract PangolinStopLimitHandler is UniswapV2Router02StopLimitHandlerAvax {
    constructor(address _pangolinRouter, address _wrappedNative)
        UniswapV2Router02StopLimitHandlerAvax(_pangolinRouter, _wrappedNative)
