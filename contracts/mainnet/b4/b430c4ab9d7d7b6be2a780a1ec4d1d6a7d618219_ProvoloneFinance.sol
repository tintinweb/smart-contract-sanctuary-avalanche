...
cheese meta ; earn BTC rewards

making tg now --> provolonefinance
*/
...
contract ProvoloneFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Provolone Finance";
    string constant _symbol = "PRVLN";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 15_000_000_000 * (10 ** _decimals);
