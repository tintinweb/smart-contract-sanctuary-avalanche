...
contract GMXAVAXLongReader {
  ...
  IGMXAVAXLongManager public immutable manager;
  // Chainlink oracle
  ...
  */
  function additionalCapacity() public view returns (uint256) {
    IGMXAVAXLongVault.VaultConfig memory _vaultConfig = vault.vaultConfig();
