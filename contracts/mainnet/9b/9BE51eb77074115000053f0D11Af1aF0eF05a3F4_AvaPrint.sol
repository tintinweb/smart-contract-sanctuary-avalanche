...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //Trader Joe's
        _token = msg.sender;
    }
...
contract AvaPrint is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaNodes";
    string constant _symbol = "AVN";
    ...
    address public autoLiquidityReceiver=0x19dC21a99D4832eC2DD620A7aFBb3796add31cFc;
    address public marketingFeeReceiver=0x19dC21a99D4832eC2DD620A7aFBb3796add31cFc;
