...
contract SilverStreamTokenUpgradeableV3 is Initializable, ERC20Upgradeable, AccessControlEnumerableUpgradeable {
    ...
    event CallOptionTriggered();
    
    function initialize(address _owner) public initializer {
        __ERC20_init("Silver Stream Token", "SST");
        __Context_init();
