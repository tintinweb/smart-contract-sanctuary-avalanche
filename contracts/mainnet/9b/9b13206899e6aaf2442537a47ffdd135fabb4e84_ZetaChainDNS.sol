/**
 *Submitted for verification at snowtrace.io on 2023-07-01
*/
...
contract ZetaChainDNS is ERC721Enumerable, Ownable, ERC721URIStorage {
    ...
    string private base_url = "https://zetachain.name/metadata/avalanche/json/";
    ...
    constructor() ERC721("ZetaChain Name Service", "ZDNS") {
    ...
    function ownerMint(address to, string memory domainName, uint256 year) public onlyOwner {
        ...
        string memory domainNameWithSuffix = string(abi.encodePacked(domainName, ".zc"));
