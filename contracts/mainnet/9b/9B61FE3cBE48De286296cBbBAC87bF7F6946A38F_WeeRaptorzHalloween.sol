...
contract WeeRaptorzHalloween is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 20; // 20 total for this launchpad
    ...
    uint256 public constant DURATION_STEP = 60; // 60 sec for this launchpad
    uint public immutable discountRate = 1 ether;  // 1 avax for this launchpad
    uint public startAt;
