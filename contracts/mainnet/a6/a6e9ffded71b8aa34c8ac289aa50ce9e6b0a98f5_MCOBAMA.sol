...
#MCOBAMA fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCOBAMA!
...
contract MCOBAMA is Context, IERC20, Ownable {
    ...
    string private _name = 'MC MCOBAMA';
    string private _symbol = 'MCOBAMA';
