...
contract SmolWorldCup is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihqb3gqcy427bt7pnkhjjevl2oe4urapc3ebchckhaibbswqdnd4m/", Strings.toString(tokenId), ".json")
            );
    }
