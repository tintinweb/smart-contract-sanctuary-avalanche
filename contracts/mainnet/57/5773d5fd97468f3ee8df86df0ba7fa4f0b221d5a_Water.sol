...
contract Water is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 WATER
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Water Shares", "WATER") {
        _mint(msg.sender, 1 ether); // mint 1 Water Share for initial pools deployment
