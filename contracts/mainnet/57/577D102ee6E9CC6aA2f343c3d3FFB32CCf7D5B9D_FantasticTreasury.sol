...
/*  FantasticTreasury.sol ============================================
    ...
    These strategy contracts can be used to Allocate fee,
    Convert reserve to Protocol Owned Liquidity, Recollateralize, etc
==================================================================== */
contract FantasticTreasury is Ownable {
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(
            ...
            "FantasticTreasury::requestFund: Only strategies can request fund"
        );
        require(
            _amount <= balanceOf(_token),
            "FantasticTreasury::requestFund: Request more fund than balance"
        );
    ...
    function addStrategy(address _strategy) external onlyOwner {
        ...
        require(
            ...
            "FantasticTreasury::addStrategy: strategy was previously added"
        );
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(
            ...
            "FantasticTreasury::allocateFee:Fee distributor not set"
        );
