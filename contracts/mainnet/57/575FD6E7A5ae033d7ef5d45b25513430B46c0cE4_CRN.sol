...
contract CRN is ERC20, AI {
    ...
    address public RewardPool = 0x2710b9382b63ad58d339785d67220FEa4177daD5;
    address public TransitWallet = 0x85cA166c59c3a93877Aaad4D03B6529aAF7664aF;
    address public PresaleWallet = 0x796C32B13a0Fa143ff8F1406f7E7077768f7afD3;
    address public TeamWallet = 0xBCd7d36B4a8583e7d04772374c2A61bA31194fD6;
    address public InvestorWallet = 0xFbAb19b753a52E5E609e2BAb6B31CBb77D51a6dd;
    address public MarketingWallet = 0xAEC25CF5F993Cd9f38F8F8Bd46d5C9143f399517;
    address public TreasuryWallet = 0xa0390Ecf9db5f9b78774ac97AcB043bb42cc5952;
    ...
    constructor(address _owner) ERC20("Test Coin", "ABC") {   // TODO: CHANGE!!! Before deploy
        Owner = _owner;
//        _mint(msg.sender, 100000 * 10**_decimals); //TODO: Used for debugging. Remove before deploy
    ...
    function transfer(address recipient, uint256 amount)
        ...
        returns (bool)
    {
        require(balanceOf(msg.sender) >= amount, "You do not have enough CRN");
