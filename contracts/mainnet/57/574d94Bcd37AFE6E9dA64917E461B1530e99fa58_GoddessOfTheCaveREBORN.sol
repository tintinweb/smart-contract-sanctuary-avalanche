...
contract GoddessOfTheCaveREBORN is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    IERC2981,
    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("GoddessOFTheCaveREBORN", "GOTC") ClampedRandomizer(maxSupply) {     
