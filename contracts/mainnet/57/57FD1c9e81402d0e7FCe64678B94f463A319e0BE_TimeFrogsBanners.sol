    ...
    ERC2981PerTokenRoyalties
{
    ...
    uint256 public maxMintForTx = 1;
    uint256 private contractRoyalties = 400;
    bool public paused = true;

    mapping(uint => bool) private minted_;
  ...
  */
    function mint(uint256 tokenId) public payable {
        ...
        require(tokenId <= maxSupply, "ERROR: Frog doesnt exists");
        require(msg.sender == IERC721(timeFrogsNFTAddress_).ownerOf(tokenId), "ERROR: Not the frog hodler!");
        require(!minted_[tokenId], "ERROR: Already minted!");
