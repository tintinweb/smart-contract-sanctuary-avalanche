...
contract AirDropFund is Ownable, Initializable {
    ...
    function transfer(address _receiver, uint256 _amount) external {
        ...
        require(_amount <= claimableBalance(), "> balance");
        claimedAmount = claimedAmount + _amount;
        staking.mint(_receiver, _amount);
    }
    ...
    function setStaking(IFantasticStaking _staking) external onlyOwner {
        require(address(staking) == address(0), "Can redefine staking");
        staking = _staking;
    }
