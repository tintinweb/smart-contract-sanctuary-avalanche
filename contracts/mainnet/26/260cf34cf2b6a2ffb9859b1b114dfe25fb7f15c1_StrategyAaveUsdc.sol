...
// File contracts/strategies/aave/strategy-aave-usdc.sol
...
contract StrategyAaveUsdc is StrategyBase, Exponential {
    address public constant avusdc = 0x625E7708f30cA75bfd92586e17077590C60eb4cD;
    address public constant usdc = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
    address public constant variableDebtUsdc = 0xFCCf3cAbbe80101232d343252614b6A3eE81C989;
    ...
    uint256 public constant usdc_COLFACTOR = 82500000000000000000;
    ...
    */
    ...
    /**
     * @notice Deposits USDC tokens inside the lendingPool 
     */
    function deposit() public override {
        uint256 _usdc = IERC20(usdc).balanceOf(address(this));
        if (_usdc > 0) {
            IERC20(usdc).safeApprove(lendingPool, 0);
            IERC20(usdc).safeApprove(lendingPool, _usdc);
