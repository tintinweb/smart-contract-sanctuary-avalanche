...
/*
Based in: https://t.me/WatcherGuru/4132
*/
...
contract AmazonAvaxInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Amazon Avax Inu";
    string constant _symbol = "AAI";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 100%
    uint256 public _maxWallet = _totalSupply.div(50); // 100%
    ...
    address public autoLiquidityReceiver=0xD4532c6dc15Cd302AFD9d06C450b8FD2A500537A;
    address public marketingFeeReceiver=0xD4532c6dc15Cd302AFD9d06C450b8FD2A500537A;
    ...
    uint256 public swapThreshold = _totalSupply / 5000; // 0.5%
    bool inSwap;
