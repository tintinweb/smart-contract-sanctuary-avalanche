...
contract StakedHentai is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sHentai", "sHentai", 9) ERC20Permit() {
    ...
    /**
        @notice increases sHentai supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sHentai
