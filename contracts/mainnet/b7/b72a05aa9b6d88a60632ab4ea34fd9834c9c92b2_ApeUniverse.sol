...
//  our link : https://linktr.ee/Ape_Universe
...
contract ApeUniverse is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $WAVAX  = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // rewards $WAVAX  
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Ape Universe";    
    ...
    address public autoLiquidityReceiver=0xCC058Ab0DEce16370e57e9b248738bE3F8F552c7; //liq address
    address public marketingFeeReceiver=0xCC058Ab0DEce16370e57e9b248738bE3F8F552c7; // marketing address
