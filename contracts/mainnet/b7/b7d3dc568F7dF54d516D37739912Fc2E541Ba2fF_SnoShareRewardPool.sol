...
contract SnoShareRewardPool {
    ...
    uint256 public tSharePerSecond = 0.023148 ether; // 60000 SNOSHARE / (30 days * 24h * 60min * 60s)
    uint256 public runningTime = 30 days; // 370 days
