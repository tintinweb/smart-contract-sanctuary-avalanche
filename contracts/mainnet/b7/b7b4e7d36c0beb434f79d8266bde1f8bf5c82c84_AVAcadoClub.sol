...
contract AVAcadoClub is ERC721, Ownable {
    ...
    string public uriPrefix = "ipfs://QmQpjKfqyfbwGfQ1CLpsm2JNQ23udTpNmWqZTAg1P7UFmH/";
    string public uriSuffix = ".json";
    
    uint256 public presaleCost = 1 ether;
    uint256 public publicsaleCost = 1.25 ether;
    ...
    constructor() ERC721("AVAcadoClub", "AVAC") {}
