...
contract lzCore is Ownable, ERC721Enumerable, NonblockingReceiver {
    ...
    AggregatorInterface internal avaxUSDAPI;
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721("Layer Zero Name Service", "LZNM") { 
        ...
        baseURI = baseURI_;
        avaxUSDAPI = AggregatorInterface(0x0A77230d17318075983913bC2145DB16C7366156);
    }
    ...
    function avaxUSD() public view returns (int256) {
        return avaxUSDAPI.latestAnswer()*10**10;
    }
    ...
    function domainPrice(string memory domainName) public view returns(uint256){
        ...
        if (lenCount <= 3){
            return (threeLetter / avaxUSD()).toUint256();
        }
        else if(lenCount == 4){
            return (fourLetter / avaxUSD()).toUint256();
        }
        else if(lenCount >= 5){
            return (fiveLetter / avaxUSD()).toUint256();
        }
    }
