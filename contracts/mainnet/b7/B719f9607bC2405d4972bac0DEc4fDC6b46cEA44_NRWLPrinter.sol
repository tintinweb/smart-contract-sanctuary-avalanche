...
// Dependency file: contracts/baby/NRWLPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeNRWLDividends(uint256 amount) public onlyOwner {
...
contract NRWLPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NRWLPrinter contract."
        );
    }
...
// Root file: contracts/baby/NRWLPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/NRWLPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract NRWLPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    NRWLPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = NRWLPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "NRWLPrinter: The dividend tracker already has that address"
        );

        NRWLPrinterDividendTracker newDividendTracker = NRWLPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "NRWLPrinter: The new dividend tracker must be owned by the NRWLPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "NRWLPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "NRWLPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "NRWLPrinter: The PanNRWLSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "NRWLPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "NRWLPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "NRWLPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialNRWLBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForNRWL(tokens);
    ...
    function swapTokensForNRWL(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeNRWLDividends(dividends);
