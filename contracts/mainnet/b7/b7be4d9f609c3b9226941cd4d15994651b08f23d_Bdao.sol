...
contract Bdao is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 BDAO
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("BDAO TOKEN", "BDAO") {
        _mint(msg.sender, 1 ether); // mint 1 BDAO for initial pools deployment
