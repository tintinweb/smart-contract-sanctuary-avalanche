...
PornLife is a community token based on Avalanche Network. 
If you too you think porn, you live porn this one is for you.
On our road-map , at 20k / 50k / 100k and more we are going to send you some nice pics specially for you ! 

Website will be release the day after the launch and are still on development.

No big calls the first day, no marketing at start, only strong holders who believe on us.

Calls at small MC will be only pump and dump with 1h duration. We want to build our floor and after that we are going
to make marketing to pump your bags.
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract PornLife is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PORNLIFE", "PORNLIFE") {
