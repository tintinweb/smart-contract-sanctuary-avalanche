...
// File contracts/fBombSnekSoliSnek.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract fBombSnekSoliSnek  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        ISoliSnekRouter(router).addLiquidity(snek, fbomb, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
