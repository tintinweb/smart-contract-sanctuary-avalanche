...
contract Tricks is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using Counters for Counters.Counter;

    string public baseURI = "ipfs://bafybeih7pbuzftgl6kcjmkxf4jpmmtuzivnpez7qyaanlatmesojg6tzie/";
    string public baseExtension = ".json";

    uint256 public cost = .1 ether;
    uint256 public maxMintable = 750;
    ...
    constructor() ERC721("Tricks", "TRICKS") {
        proceedsWallet = 0x3242CB2b8c12F799444b4B5360379327975E437B;
    }
