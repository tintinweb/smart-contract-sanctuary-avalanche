    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xFcF8Df5Fbc253057410059351f5f536aE422c9d4;
    ...
    uint256 public maxPerPerson = 333;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("AVAXADSC", "AADSC") ClampedRandomizer(maxSupply) {     
