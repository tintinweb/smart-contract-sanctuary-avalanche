 ...
 */
contract AaveHandler is IDepositExecute, HandlerHelpers, UpgradableOwnable, ERC20Safe {
    ...
    function executeProposal(
        ...
        address aTokenAddress = ILendingPool(AAVE_AVAX_LP_ADDR).getReserveData(tokenAddress).aTokenAddress;
        ...
        IBridge(_bridgeAddress).internalDeposit(LACHAIN_ID, aaveTokenResources[resourceID], newAmount, recipientAddress);
