...
import "./PXT.sol";
contract PXTV2 is PXT {

    mapping(address => bool) public usersAirdropv2;

    function tokenAirdropv2() external virtual {
        ...
        require(usersAirdropv2[msg.sender] == false, "already airdrop balance");
        super._transfer(airdropAddress, msg.sender, userBalance);
        usersAirdropv2[msg.sender] = true;
    }
}
...
contract PXT is ERC20Upgradeable, IBridgeToken {
    // STRINGS
    ...
    function initialize() public virtual initializer {
        ...
        address currentRouter = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
        ...
        returns (uint256)
    {
        ...
        uint256 usdtAmount = getOutEstimatedTokensForTokens(
            dexRouter,
            contractAddress,
            usdtAddress,
            amount
    ...
    function contractSwap() internal virtual swapping {
        ...
        } else if (compareStrings(currentNetwork, "bsc")) {
            swapTokensForBNB(
                dexRouter,
                contractAddress,
                (numTokensToSwap * swapTokensPercent) / 100,
