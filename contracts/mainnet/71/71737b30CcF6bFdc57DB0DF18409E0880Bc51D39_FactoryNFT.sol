...
contract FactoryNFT is ERC721, Ownable {
    ...
    function mintToken(uint256 _quantity) public {
        ...
        uint mintPrice = (_quantity * 10 ** 6) * 100;

        usdc.approve(address(this), mintPrice);
        usdc.transferFrom(msg.sender, address(this), mintPrice);
    ...
    function withdrawFunds() external onlyOwner {
        usdc.approve(contractOwner, usdc.balanceOf(address(this)));
