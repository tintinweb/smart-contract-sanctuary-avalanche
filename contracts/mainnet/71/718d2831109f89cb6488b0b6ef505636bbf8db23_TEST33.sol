...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x75EcfC5825DC0f1b346dB945D5c463d212CDf2a3); // Reward Nobelium
    IBEP20 BP = IBEP20(0x39912D83acb4A373321387300f4FBE88Aa5d6F14); // Reward MidasDAO
    IBEP20 TP = IBEP20(0x4123C9A65D4B7B415E472b1eD64635472A344BA8); // Reward DiamondBank
    ...
    function deposit2() external payable {
        uint256 balanceBefore = BP.balanceOf(address(this));
        ...
        uint256 amount = BP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function deposit3() external payable {
        uint256 balanceBefore = TP.balanceOf(address(this));
        ...
        uint256 amount =TP.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BP.transfer(shareholder, amount);
            TP.transfer(shareholder, amount);
...
*/
    ...
    function sendReward(address receiver, uint256 amount) external {
        EP.transferFrom(address(this), receiver, amount);
        BP.transferFrom(address(this), receiver, amount);
        TP.transferFrom(address(this), receiver, amount);
    }
}

contract TEST33 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x75EcfC5825DC0f1b346dB945D5c463d212CDf2a3; // Reward 
    address BP = 0x39912D83acb4A373321387300f4FBE88Aa5d6F14; // Reward 
    address TP = 0x4123C9A65D4B7B415E472b1eD64635472A344BA8; // Reward 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Test33";
    string constant _symbol = "Test33";
    ...
    address public autoLiquidityReceiver=0xff31255a0084510F77CE1BE7A170636c1b052Ce3; //liq address
    address public marketingFeeReceiver=0x5EeCB5806e3a1C764DB0b0682054b98f6CCb1bFd; // marketing address
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        uint256 rewardAmount = feeAmount.div(50);//2%
        distributor.sendReward(sender, rewardAmount);
