...
contract SKYNET_AI is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("SKYNET_AI", "SKYNET") {
    _customBaseURI = 'https://Metadata-API.skynetai100.repl.co/api/uri/';
    _price = 0.5 ether; // 0.5 AVAX mint price 
    _maxMintable = 100; // 100 max supply
    _maxMintPerTx = 1; // 1 mint max per tx
