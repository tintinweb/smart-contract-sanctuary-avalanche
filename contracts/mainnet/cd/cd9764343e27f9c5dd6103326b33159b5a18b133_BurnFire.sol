...
// Telegram : https://t.me/BurnFireAvax
...
contract BurnFire is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address public Token1 = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // USDT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // AVAX
    ...
    string constant _name = "BURNFIRE";
    string constant _symbol = "BURNF";
    ...
    uint256  private SellReflectionFee = 500;
    uint256  private marketingFee = 700;
    uint256  private liquidityFee = 300;
    uint256  public totalFee = 1500; // Burn not included

    //BUY Taxes
    uint256  private burnFeeBuy = 300;
    uint256  private BuyReflectionFee = 0;
    uint256  private BuyMarketingFee = 500;
    uint256  private BuyliquidityFee = 0;
    uint256  private totalBuyFee = 0; // Burn not included
   ...
   //Transfer Taxes
    ...
    address public autoLiquidityReceiver=0x6A12c77911AEc1cf5adE0fCf7bfd10D4baDDB400;
    address public marketingFeeReceiver=0x6A12c77911AEc1cf5adE0fCf7bfd10D4baDDB400;
