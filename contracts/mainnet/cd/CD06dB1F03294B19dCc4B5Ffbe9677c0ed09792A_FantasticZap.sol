...
contract FantasticZap is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        require(_pool != address(0), "Zap::constructor: Invalid address");
    ...
    function zap(uint256 _zapId, uint256 _minLiquidity) external payable nonReentrant {
...
interface IPool {
    ...
    function mint(uint256 _minXTokenOut) external payable;
