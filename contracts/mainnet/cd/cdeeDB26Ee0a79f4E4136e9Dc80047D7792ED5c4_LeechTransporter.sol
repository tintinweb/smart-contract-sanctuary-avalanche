...
contract LeechTransporter is OwnableUpgradeable, ILeechTransporter {
    ...
    mapping(uint256 => address) public chainIdToBaseToken;
    ...
    */
    ...
    function _bridgeOutStargate(
        ...
        require(_bridgedToken == chainIdToBaseToken[chainID], "wrong base token input");

        uint256 _srcPoolId = getStargatePoolIdFromToken[chainIdToBaseToken[chainID]];
        uint256 _dstPoolId = getStargatePoolIdFromToken[chainIdToBaseToken[_destinationChainId]];
