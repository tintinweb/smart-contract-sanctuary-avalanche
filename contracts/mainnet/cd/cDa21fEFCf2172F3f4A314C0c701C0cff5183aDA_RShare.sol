...
contract RShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("RShare", "RShare") {
        _mint(msg.sender, 1 ether); // mint 1 REDALERT Share for initial pools deployment
