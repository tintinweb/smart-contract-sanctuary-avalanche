...
If you make the biggest buy (in tokens) you become the TaxCollector, and collect 5% fees (in AVAX) the same way marketing does. 
If you sell any tokens at all at any point you can never be the TaxCollector. 
If someone beats your record, they become the TaxCollector. 
If you sell while the TaxCollector, the marketing wallet becomes TaxCollector and the record is reset to 0, this way no one can buy a ton and then sell and keep collecting tax fees.
The TaxCollector is set via biggest buy in tokens.
...
The point is to reward big buys. There are no punishments other than disallowing sellers to be the TaxCollector.
*/
...
contract BabyTaxCollector is IBEP20, Auth {
    using SafeMath for uint256;
 
    string constant _name = "BabyTaxCollector";
    string constant _symbol = "BabyTAX";
    ...
    uint256 public TaxCollectorFee = 1;
    ...
    constructor () Auth(msg.sender) {      
        ...
        autoLiquidityReceiver = 0xA1e793B0a051a2CD5e6893780A61aE58dF4e3162; //LP receiver
        marketingWallet = 0xA1e793B0a051a2CD5e6893780A61aE58dF4e3162;  //marketing wallet
        taxCollector = 0xA1e793B0a051a2CD5e6893780A61aE58dF4e3162;  //tax collector wallet
