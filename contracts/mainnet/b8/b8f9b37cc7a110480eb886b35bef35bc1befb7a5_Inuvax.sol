...
Telegram:
https://t.me/shibainuvax

Twitter:
https://twitter.com/Shibainuvax
...
contract InuvaxDividendTracker is IDividendDistributor {
...
contract Inuvax is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    string _name = "Shibainuvax";
    string _symbol = "$INUVAX";
    ...
    address treasuryWallet = address(0x9975E6DA98D9d3aeE58aa308854C34289b0229cA); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    InuvaxDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new InuvaxDividendTracker();
