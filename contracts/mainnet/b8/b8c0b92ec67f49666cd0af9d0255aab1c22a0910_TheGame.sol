...
/**
Welcome to The Game
The rules are easy, if there are no transactions during a full hour, the rug will be pulled.
Holders will be rewarded with wBNB tokens, to reward their foolishness.
Do not expect the liquidity to be locked.
Do not expect marketing. No caller will shill a 99% rug coin. Shill your own bag, and save your funds.

https://twitter.com/TheGameAvax
https://t.me/TheGameAvax
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BNB = IBEP20(0x70928E5B188def72817b7775F0BF6325968e563B);
...
contract TheGame is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BNB = 0x264c1383EA520f73dd837F915ef3a732e204a493; // BNB
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xdB2aA9e31d3CAF2e01c2253bcB8b28D700486d26;
    address public marketingFeeReceiver=0xdB2aA9e31d3CAF2e01c2253bcB8b28D700486d26;

    string constant _name = "TheGame";
