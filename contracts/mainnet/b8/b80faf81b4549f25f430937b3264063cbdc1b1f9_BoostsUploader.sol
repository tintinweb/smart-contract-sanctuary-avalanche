...
contract BoostsUploader is Ownable {
    ...
    constructor(address _attributesPets) {
        ...
        // Cats
        boosts[12].claimTaxReduction = 7;
        boosts[13].claimTaxReduction = 7;
        boosts[14].claimTaxReduction = 7;
        boosts[15].claimTaxReduction = 20;
        boosts[16].claimTaxReduction = 7;
        boosts[17].claimTaxReduction = 10;
        boosts[18].claimTaxReduction = 15;
        boosts[19].claimTaxReduction = 7;
        boosts[20].claimTaxReduction = 15;
        boosts[21].claimTaxReduction = 10;
