...
We're the first #VIRUS based token with a twist.. BTC reflections and wallets can only sell IF they have 10.000 $ANTIVIRUS

https://twitter.com/AntivirusAVAX
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
...
contract AntiVirus is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address RWD = 0x50b7545627a5162F82A992c33b87aDc75187B218;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AntiVirus";
    string constant _symbol = "ANTIVIRUS";
    ...
    address public autoLiquidityReceiver = 0x431d7685f64EeBf173C382251f219A79C6bCE563;
    address public marketingFeeReceiver = 0x431d7685f64EeBf173C382251f219A79C6bCE563;
