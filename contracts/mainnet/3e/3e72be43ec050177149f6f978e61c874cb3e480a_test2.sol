...
contract test2 is IBEP20, Auth {
    ...
    address usdc = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; // usdc
    ...
    address public treasuryFeeReceiver=0x04E8d3af4F597185E77B1AA3Be5947fa480Db809;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _treasuryFee, uint256 _feeDenominator) external authorized {
        ...
        totalFee = _liquidityFee.add(_buybackFee).add(_reflectionFee).add(_marketingFee).add(treasuryFee);
