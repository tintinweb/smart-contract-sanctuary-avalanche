...
contract ScribbleCustoms is ERC721URIStorage, IERC721Receiver, ReentrancyGuard, Ownable {
  ...
  address public adminWallet = 0xcf50b23A09Fb51E0262A609a0FeE723639F705a2;  //For funds if any
  ...
  address private nftContract7Address = 0xd9145CCE52D386f254917e481eB44e9943F39138; //Mind Matter
  ...
  constructor() ERC721("SCRIBBLE CARDS - CUSTOMS", "SCRIBBLECARDSCUSTOMS") {
       _totalSupply = 250;
       _royaltyAmount = 1000;
  }
  ...
  function mint(uint256 _tokenID, string memory uri, address _contractAddress) public payable nonReentrant {
    ...
    function withdraw() external onlyOwner {
        ...
        require(balance > 0, "Gravedigger: Nothing to withdraw");
    ...
    function setNftContract1Address(address _nftContract1Address) external onlyOwner{
        nftContract1Address = _nftContract1Address;
    }
  
    function setNftContract2Address(address _nftContract2Address) external onlyOwner{
        nftContract2Address = _nftContract2Address;
    }

    function setNftContract3Address(address _nftContract3Address) external onlyOwner{
        nftContract3Address = _nftContract3Address;
    }

    function setNftContract4Address(address _nftContract4Address) external onlyOwner{
        nftContract4Address = _nftContract4Address;
    }

    function setNftContract5Address(address _nftContract5Address) external onlyOwner{
