/**
 *Submitted for verification at snowtrace.io on 2023-02-14
*/
...
contract Web3StudiosNFTMP3 is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Web3 Studios - Q1 - MP3", "W3Q1MP3") KindaRandom(5) {
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmeQRm8ENKzBAiw8fseFthbMU22EK4dwRqU49iDNFwTCAH/';
    _customBaseExtension = '.json';
    _maxMintable = 5; // 5 max supply - PROD
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _startTime = 1676613600; //unix timestamp of start time (Fri Feb 17 2023 00:00:00 GMT-0600 (Central Standard Time))
    _maxMintPerTx = 1;
    _price = 1.0 ether;
