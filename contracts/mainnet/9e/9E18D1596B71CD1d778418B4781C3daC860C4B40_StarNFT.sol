    ...
    ERC721URIStorageUpgradeable
{
    ...
    function initialize(
        ...
        _setTreasury(0xeB994692B35f54d979c8eE50Cc1040F9286E5954);
        _grantRole(DEFAULT_ADMIN_ROLE, 0xe2d540570d2780D5f5F065D5a0D05807826246Ed);
        _grantRole(UPGRADER_ROLE, 0xe2d540570d2780D5f5F065D5a0D05807826246Ed);
        _grantRole(OPERATOR_ROLE, 0xeB994692B35f54d979c8eE50Cc1040F9286E5954);
        _grantRole(MINTER_ROLE, 0xDBc3eD0cDB601a5cf56e6635762DbF7b6eEE3890);
        _grantRole(MINTER_ROLE, 0x6Dd2065501B8a90843eAAEB53C0a0F0588B65C4a);
    ...
    function createStore(
        ...
        IERC20Burnable(paymentToken_).burnFrom(_msgSender(), amount);
        _createStore(store_.uid, store_.account, store_.metadata);
    }
