...
contract contractHoppers is Ownable, IERC721Receiver{
    ...
    function getFlyPerDay(uint256 tokenId, address user) public view returns (uint256 actual, uint256 pond, uint256 stream, uint256 swamp, uint256 river, uint256 forest, uint256 lake) {
        ...
        uint32[] memory infosHopper = getInfos(tokenId);
        ...
        if(actualOwner == _addressPond){
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[2];
            rewards[1] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
        }

        if(actualOwner == _addressStream){
            Ihoppers z = Ihoppers(_addressStream);
            uint256[] memory zoneInfos;
            zoneInfos[0] = z.emissionRate();
            zoneInfos[1] = z.baseSharesBalance(user);
            zoneInfos[2] = z.totalBaseShare();
            ...
            zoneInfos[4] = z.totalVeShare();
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[3];
            rewards[0] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            rewards[2] = rewards[0];
        }
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[3];
            rewards[2] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
        }

        if(actualOwner == _addressSwamp){
            Ihoppers z = Ihoppers(_addressSwamp);
            uint256[] memory zoneInfos;
            zoneInfos[0] = z.emissionRate();
            zoneInfos[1] = z.baseSharesBalance(user);
            zoneInfos[2] = z.totalBaseShare();
            ...
            zoneInfos[4] = z.totalVeShare();
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[4];
            rewards[0] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            rewards[3] = rewards[0];
        }
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[4];
            rewards[3] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
        }
        
        if(actualOwner == _addressRiver){
            Ihoppers z = Ihoppers(_addressRiver);
            uint256[] memory zoneInfos;
            zoneInfos[0] = z.emissionRate();
            zoneInfos[1] = z.baseSharesBalance(user);
            zoneInfos[2] = z.totalBaseShare();
            ...
            zoneInfos[4] = z.totalVeShare();
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[2]*infosHopper[5];
            rewards[0] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            rewards[4] = rewards[0];
        }
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[2]*infosHopper[5];
            if(infosHopper[0] > 10 && infosHopper[2] > 5 && infosHopper[5] > 5){
                rewards[4] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            }
            else{
                rewards[4] = 0;
            }
        ...
        if(actualOwner == _addressForest){
            Ihoppers z = Ihoppers(_addressForest);
            uint256[] memory zoneInfos;
            zoneInfos[0] = z.emissionRate();
            zoneInfos[1] = z.baseSharesBalance(user);
            zoneInfos[2] = z.totalBaseShare();
            ...
            zoneInfos[4] = z.totalVeShare();
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[3]*infosHopper[4]*infosHopper[5];
            rewards[0] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            rewards[5] = rewards[0];
        }
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[3]*infosHopper[4]*infosHopper[5];
            if(infosHopper[0] > 15 && infosHopper[3] > 5 && infosHopper[4] > 5 && infosHopper[5] > 5){
                rewards[5] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4])); 
            }
            else{
                rewards[5] = 0;
            }
        ...
        if(actualOwner == _addressGreatLake){
            Ihoppers z = Ihoppers(_addressGreatLake);
            uint256[] memory zoneInfos;
            zoneInfos[0] = z.emissionRate();
            zoneInfos[1] = z.baseSharesBalance(user);
            zoneInfos[2] = z.totalBaseShare();
            ...
            zoneInfos[4] = z.totalVeShare();
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[2]*infosHopper[3]*infosHopper[4]*infosHopper[5];
            rewards[0] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            rewards[6] = rewards[0];
        }
            ...
            zoneInfos[5] = z.veSharesBalance(user);
            uint32 hopperShare = infosHopper[0]*infosHopper[2]*infosHopper[3]*infosHopper[4]*infosHopper[5];
            if(infosHopper[0] > 20 && infosHopper[2] > 5 && infosHopper[3] > 5 && infosHopper[4] > 5 && infosHopper[5] > 5){
                rewards[6] = (hopperShare*zoneInfos[0]*60*60*24/zoneInfos[2])+((hopperShare/zoneInfos[1])*zoneInfos[3]*60*60*24*(zoneInfos[5]/zoneInfos[4]));
            }
            else{
                rewards[6] = 0;
            }
        }
        return (rewards[0], rewards[1], rewards[2], rewards[3], rewards[4], rewards[5], rewards[6]);
    }
