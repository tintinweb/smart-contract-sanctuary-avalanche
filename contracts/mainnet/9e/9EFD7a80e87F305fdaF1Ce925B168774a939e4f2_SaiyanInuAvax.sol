...
Tokenomics:
- Buy Tax / Sell Tax: 14%
    - 2% of each buy goes to AVAX reflections
...
Telegram:
https://t.me/SaiyanInuAvax

Twitter:
https://twitter.com/saiyaninuavax
*/
...
contract SaiyanInuAvaxDividendTracker is IDividendDistributor {
...
contract SaiyanInuAvax is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    address treasuryWallet = address(0x32228598E06e1FDf483dcE50E230053afEAEf754); 
    address liquidityWallet;

    ITraderJoeRouter public router; //trader joe
    address pair; 

    SaiyanInuAvaxDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new SaiyanInuAvaxDividendTracker();
