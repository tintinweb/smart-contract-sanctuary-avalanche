...
contract TJLendingRewardsBridge is ReentrancyGuard {
    ...
    //constant dueto calling claimRewardsInTargetToken with delegatecall
    IExchangeBridge private constant exchangeBridge = IExchangeBridge(0x2498d70E4a2ED018EEB092101A24827fdfCE7C13);
    TJRewardDistributor private constant tjRewardsDistributor = TJRewardDistributor(0x45B2C4139d96F44667577C0D7F7a7D170B420324);
    IERC20 private constant joeToken = IERC20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd);
