...
// File: contracts/ThePassport.sol
...
contract ThePassport is Ownable, ERC721AQueryable, ReentrancyGuard, IERC721ABurnable {
    using Address for *;
    string private _baseTokenURI;
    uint256 public immutable maxSupply = 10000;
    uint256 public reserved = 100;
    uint256 public immutable buyLimit = 500;
    uint256 public immutable price = 0.075 ether;
    mapping(address => uint256) public userCount;
    string public contractURI; /// @dev collection metadata

    constructor() ERC721A("ThePassport", "PASS") {}
    ...
    function getPrice(address user, uint256 quantity) public view returns (uint256){
        ...
        if (userCount[user] == 0) totalPrice = totalPrice;
        return totalPrice;
    }
