...
// Sources flattened with hardhat v2.9.3 https://hardhat.org - 4/28/22
...
contract NODERewardManager is PaymentSplitter {
    ...
    modifier onlySentry() {
        require(msg.sender == _gemTokenAddress || msg.sender == _gateKeeper, "You Are Not Authorized");
        _;
    }
