...
contract BeautyPageantVotr is Ownable, ReentrancyGuard 
{
...
///
  ...
  uint public maxNumberOfIDs = 27;//max number of contestants can vote on
...
////public functions:
  ...
  function checkMsgSenderEggVoteAllowance() private returns(uint){ //check how much of user egg this contract can spend
...
////main vote code:
  ...
  function voteOneEggForEachCandidate() public returns(bool){
    ...
    require (_eggsAllowance >= (27000000000000000000), "Must approve more egg first. Bgok");
