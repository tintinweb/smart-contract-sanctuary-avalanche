...
// File: contracts/interfaces/IPlanetsManager.sol
...
// File: implementations/output/PlanetsManagerImplementationPointerUpgradeable.sol
...
// File: contracts/WalletObserverUpgradeable.sol
...
// Read more about Smart Daily Limits @ https://medellin-city.gitbook.io/medellin-city/technical-details/smart-daily-limits
...
PlanetsManagerImplementationPointerUpgradeable
{
    ...
    {
        require(
            from == address(0x0000000000000000000000000000000000000000) // DealersManager Claim token
            || from == address(0xc77CA905b4Cd72EC008C415f4Eaa7a34286Add70) // DealersManager
            || to == address(0xc77CA905b4Cd72EC008C415f4Eaa7a34286Add70) // DealersManager
            || from == address(0xd261f23aD71bd9b15CfE010d6f37d647F70Da869) // Dev wallet
            || to == address(0xd261f23aD71bd9b15CfE010d6f37d647F70Da869),  // Dev wallet
            "WalletObserverUpgradeable: Only allowed wallet"
        );
        ...
        // Do not observe private and public presale
        if (from == address(0x7218AC85B7130DF0E7abfdA99a82f4afB6Bb1818) || from == address(0xFc514909aeecE5D9ba26372ca47EA626599D44aB)) {
            return true;
        }
