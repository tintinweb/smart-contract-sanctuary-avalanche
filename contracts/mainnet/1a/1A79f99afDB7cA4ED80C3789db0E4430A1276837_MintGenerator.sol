...
interface IMintFactory {
    function registerToken (address _tokenOwner, address _tokenAddress, string memory name, string memory symbol, uint8 decimals, uint256 totalSupply) external;
...
contract MintGenerator is Ownable {
    ...
    function createToken (
      ...
      uint256 totalSupply
        ...
        MINT_FACTORY.registerToken(msg.sender, address(newToken), name, symbol, decimals, totalSupply);
    }
}