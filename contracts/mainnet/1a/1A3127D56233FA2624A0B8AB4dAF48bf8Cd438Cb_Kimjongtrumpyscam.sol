...
// Telegram : https://t.me/kimjongtrumpyscam  
...
contract Kimjongtrumpyscam is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kim jong trumpy scam";
    string constant _symbol = "KJTS";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(2); // 
    uint256 public _maxWallet = _totalSupply.div(2); //
    ...
    address public autoLiquidityReceiver=0xb2AeB11349654878a1cE615456136992b9A007fC; //liq address
    address public marketingFeeReceiver=0xb2AeB11349654878a1cE615456136992b9A007fC; // marketing address
