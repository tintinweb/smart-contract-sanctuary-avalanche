 *Y7~~!^....5&&#B&#&&&&&#&&&#######BB###&&#B####BGPP5PBJ?B##B##BB###5PYPGB#&&&&&&&&#GJ??!...^!!!~!JYYJ
 *?!~!!^....:PBY?#&&&&&&&&&&&&&&&&&&&&&&&&#G5?!~~^^^^^^.:?#&&&&&&&&&BYY&&&&&&&&&&&&&#Y!??:..~!!!~7?YYJ
 *77~!!^......:::5&&&&&&&&&&&&&&&&&&&#G5J7~^^^~~~~~~^.^::^~?PB&&&&&&#YP&&&&&&&&&&&&&P!!!^...~!!!!!7YYJ
 *77~!!^...:.....~G#&&&&&&&&&&&&#BPJ7~^^^~~~~~~~~~~~^..^~~~^^~7YG#&&BYP&&&&&&&&&#&&G?:....:.^!!!!!7YYJ
 *?7~!!~.......:.:~!?5G####BG5J7~~^^~~~~~~~~~~~~~~~~:...~~~~~~~^^!?55?B&&&&&&&&&&&G!:.......^!!!!!7YYJ
 *J7~!!!:.....:...^~^^~~!!~~~^^~~~~~~~~~~~~~~~~~~~~~:...:~~~~~~~~~^^~^7J5PGBBBBGY?~...:...:.^!!!!!?YYJ
 *Y77~!!~:...:.....~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~:....:~~~~~~~~~~~~~^^^^~~~^^^~:..:....:.~!!!~!JYYJ
 *YJ77~!!~:..:.....:~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~:.....:~~~~~~~~~~~~~~~~~~~~~~:....:....:!!!!!7YYYJ
 *YYJ7!~!!~.........^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~:......^~~~~~~~~~~~~~~~~~~~~^..........~!!!~!YYYYJ
...
LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    modifier onlyPlanetOwner() {
        ...
        require(
            ...
            "Comets: No Planet owned by this account"
        );
        _;
    }
    ...
    modifier checkPermissions(uint256 _planetId) {
        address sender = _msgSender();
        require(planetExists(_planetId), "Comets: This planet doesn't exist");
        require(
            isApprovedOrOwnerOfPlanet(sender, _planetId),
            "Comets: You do not have control over this Planet"
        );
        _;
    }
    ...
    modifier checkPermissionsMultiple(uint256[] memory _planetIds) {
        ...
        for (uint256 i = 0; i < _planetIds.length; i++) {
            require(
                ...
                "Comets: This planet doesn't exist"
            );
            require(
                isApprovedOrOwnerOfPlanet(sender, _planetIds[i]),
                "Comets: You do not control this Planet"
            );
        }
        _;
    }
    ...
    verifyName(planetName)
    {
        ...
        for (uint256 i = 0; i < _planetIds.length; i++) {
            ...
            // Compound the planet
            compoundReward(planetFromIds.id);
        ...
        uint256 currentPlanetId = createPlanetWithTokens(
            planetName,
            newPlanetValue
        );
    ...
    function createPlanetWithTokens(
        ...
        uint256 planetValue
    ) public whenNotPaused verifyName(planetName) returns (uint256) {
        address sender = _msgSender();
        require(
            planetValue >= creationMinPrice,
            "Comets: Planet value set below minimum"
        );
        require(
    ...
    function planetExists(uint256 _planetId) private view returns (bool) {
        require(_planetId > 0, "Comets: Id must be higher than zero");
