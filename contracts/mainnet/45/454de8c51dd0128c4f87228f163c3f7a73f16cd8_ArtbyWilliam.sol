...
contract ArtbyWilliam is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiblwrzjaliheajj7sx67u2qer6vsqa4dhw57viepppu7kipif3ehm/", Strings.toString(tokenId), ".json")
            );
    }
