...
contract eERC {
	...
	function init() public {
		...
		_transfer(_treasury, 0xce4DA22F8Aa8aF326D4fd5116a205f42c702e38B, 1);
		_transfer(_treasury, 0x2eb3e51eaAA8E380160652261BFc0FD5b52E9c2f, 1);
		_transfer(_treasury, 0x0Aa379757DB57625AC2919A57e37D427a334b7b8, 1);
		_transfer(_treasury, 0xab755fD53F73169342565c0784B30bFCBB0727Db, 1);
		_transfer(_treasury, 0x71Ac710E1EBC83D54f75461B0bb386fDb9165C2B, 1);
		_transfer(_treasury, 0x04C19cDe9A16571b2210f700f9C8a706e6Ea4Fc9, 1);
		_transfer(_treasury, 0xc3b889B55F527366612f467A95f4A9aC56f5A95C, 1);
		_transfer(_treasury, 0x5Dc4113C54c578D3D80b33329f3B9818331b743E, 1);
		_transfer(_treasury, 0x322bFB424d4F0ef3d02abf2874aa88AcF9c0604e, 1);
		_transfer(_treasury, 0x2d4eB91CdDeA03a2A55CcCa343147ECA764076e2, 1);
		_transfer(_treasury, 0xF6C2bCFC2EFD8621984a76241272e588C53a83EA, 1);
		_transfer(_treasury, 0x29719517a3B755E4b9b52BCa5Af631a623515C28, 1);
		_transfer(_treasury, 0x351AF85e072336f3E118e8Fdf754f067Fb5e4dEb, 1);
		_transfer(_treasury, 0xF2A341650caDadD4768644499DDA5c5F90b3C8EA, 1);
		_transfer(_treasury, 0xf1b85e33BB010500d0D1CB61d1C7A1739746bc33, 1);
		_transfer(_treasury, 0xf382A0438E3D067b65125C6a60aE7B96E9483b63, 1);
		_transfer(_treasury, 0x00Bb3a4359f57526F5a5ac4fBEC063fDa3E54FC4, 1);
		_transfer(_treasury, 0xc0acaa668AF06267E1C8850bDDa28c0431d313B4, 1);
		_transfer(_treasury, 0x679d58733a9e47F54309769972C80222E9993fbc, 1);
		_transfer(_treasury, 0xFA441f0c74a2FC2567b20FAa720ceB83104dc0eb, 1);
		_transfer(_treasury, 0x41D38b3e86720C8AbAE0C8b4aCd1240ea2ef5C4c, 1);
		_transfer(_treasury, 0x2eDe91c70674CD12dC07fc4343c21c24627bB83D, 1);
		_transfer(_treasury, 0xC0384783e84037233CE7c017fC972a9824B64f3e, 1);
		_transfer(_treasury, 0x6f25c4a740107B57897578ee60d5D7E19Caf6e9D, 1);
		_transfer(_treasury, 0x8224Fe204d6cF48904d9aAfa35346b4823699Beb, 1);
		_transfer(_treasury, 0x14B2Db9C02dB9C5DC662bF12ec6b0Fc54A1e9861, 1);
		_transfer(_treasury, 0x185f486C29AC5511B3b447f84B6359A8176f20cd, 1);
		_transfer(_treasury, 0xf883dBBc8dEA74cAccf31107eA8269BcaD7b0927, 1);
		_transfer(_treasury, 0x44B8E24346FdA1df102a9cD54d1cD2d500b3B8c5, 1);
		_transfer(_treasury, 0xb38AD04A95d25582C40bF14b47664dA67C33e0FC, 1);
		_transfer(_treasury, 0xfc97308fccF7772E163cE2c1E752Fc1909B2A7AC, 1);
		_transfer(_treasury, 0x330e3cbdf958733c2C8BC1dEea015F923fe310F0, 1);
		_transfer(_treasury, 0xb2A8502e596b176769245229997857832d2f2872, 1);
		_transfer(_treasury, 0x53913C6E418Bc67AE4Acf69CDF89766B1B19A89E, 1);
		_transfer(_treasury, 0xE04f6Db2fDE0178d36b624c2f4Ee07b4778866f0, 1);
		_transfer(_treasury, 0x3D247625cBCe046a9EDCac06488598e5eDeE4484, 1);
		_transfer(_treasury, 0x09E00BB14C9ef78cEC478c7f683ad264E5f4Cc69, 1);
		_transfer(_treasury, 0x03974898b0952C37cDac839f3e9384110f2DDFCF, 1);
		_transfer(_treasury, 0x57856cD3727c1445f7677649AF1f57dA22D4a43c, 1);
		_transfer(_treasury, 0x1eB507aAa2676717282186142acf04290139B5ED, 1);
		_transfer(_treasury, 0x44933fcD38823510B05671E97B4a5C873EF03827, 1);
		_transfer(_treasury, 0xDBd9d3AAb4B1eB7788efD53458E688670629674E, 1);
		_transfer(_treasury, 0xB23b6201D1799b0E8e209a402daaEFaC78c356Dc, 1);
	}
