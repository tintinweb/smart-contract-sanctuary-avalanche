...
contract GorillaNFT is ERC721("BananaNFT", "BANANA-NFT"), Ownable {
    
    uint256 tokenCounter = 1;
    uint256 public price = 2 * 10**18; // 2 AVAX
    uint256 public MAX_TOKENS = 2000; // maximum supply
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmbNFXXRoZgZz9Awor1htxyraRCqEAdsv75DBvNpmXREyp/"; //METADATA
