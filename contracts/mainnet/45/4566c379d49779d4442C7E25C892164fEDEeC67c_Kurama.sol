...
contract Kurama is Context, IERC20, Ownable {
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            development: 2, // development team fee in %
            treasury: 5, // treasury fee in %
            lp: 2, // lp rate in %
            toSwap: 9 // treasury + development + lp
        });
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            lp: 2, // lp rate in %
            toSwap: 14 // treasury + development + lp
        });
    ...
    event TreasuryAndDevFeesAdded(uint256 developmentFee, uint256 treasuryFee);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // we give the remaining tax to development & treasury wallets
        uint256 remainingBalance = address(this).balance;
        uint256 developmentFee = (remainingBalance * appliedRates.development) /
            (denominator - appliedRates.development);
        uint256 treasuryFee = (remainingBalance * appliedRates.treasury) /
            (denominator - appliedRates.treasury);
        developmentAddress.sendValue(developmentFee);
    ...
    function setBuyFees(
        ...
        buyRates.development = _development;
        buyRates.lp = _lp;
        buyRates.toSwap = _treasury + _development + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.development = _development;
        sellRates.lp = _lp;
        sellRates.toSwap = _treasury + _development + _lp;
    }
    ...
    function setDevAddress(address payable _developmentAddress) external onlyOwner {
