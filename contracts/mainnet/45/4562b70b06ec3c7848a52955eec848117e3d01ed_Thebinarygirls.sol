...
contract Thebinarygirls is ERC721 {
    ...
    constructor()
        ERC721("The Binary Girls", "Binary")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeie4fxvdmkxs3wmts6vmqdloiwtie5v5rctx5v4sz4q5fgdpvugiem/", Strings.toString(tokenId), ".json")
            );
    }
