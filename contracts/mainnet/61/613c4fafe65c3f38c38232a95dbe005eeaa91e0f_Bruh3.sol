/**
 *Submitted for verification at snowtrace.io on 2023-05-07
*/
...
contract Bruh3 is ERC20 {
 ...
 address private owner;
    ...
    constructor(
        ...
        require(cap_ > 0, "Bruh3: cap must be greater than zero");
        _cap = cap_;
        owner = msg.sender;
        _mint(0xc0C5aDd66125cb059DcE3Aa5018cC512ced1E367, cap_);
    }

    // Get the maximum token supply cap
    ...
    function airdrop(address[] memory recipients, uint256 amount) public {
        require(
            amount * recipients.length <= balanceOf(msg.sender),
            "Bruh3: insufficient balance"
        );
