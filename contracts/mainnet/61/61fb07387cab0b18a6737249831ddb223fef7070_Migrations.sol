...
contract Migrations is ReentrancyGuard, Ownable, Pausable {
  ...
  function migrateFighters(uint256[] calldata v1TokenIds) external nonReentrant {
   ...
   function mergeFighters(uint256 v1TokenId1, uint256 v1TokenId2) external nonReentrant {
    //format v1Fighter to v2 format
  ...
  function migrateRingAmulet(uint256[] calldata tokenIds, bool isRing) public {
