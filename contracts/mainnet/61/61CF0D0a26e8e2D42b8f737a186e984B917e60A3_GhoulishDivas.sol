...
contract GhoulishDivas is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    uint public constant START_ID = 433;
    ...
    uint public maxPerPerson = 433;
    uint public price = 900000000000000000;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Ghoulish Divas", "GSDV") ClampedRandomizer(maxSupply) {
