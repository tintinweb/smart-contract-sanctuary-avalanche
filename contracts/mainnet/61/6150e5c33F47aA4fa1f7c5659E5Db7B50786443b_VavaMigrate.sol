...
library UniswapV2Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'5c40ed22da7ba47d919474b567b40b029798533d293b9c25da854aa9f0a0742f' // init code hash
            ))));
    }
...
// File: contracts/VavaMigrate.sol
...
// VavaMigrate helps your migrate your existing TraderJoe LP tokens to Vavalon LP ones
contract VavaMigrate {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, 'VavaMigrate: EXPIRED');
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'VavaMigrate: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'VavaMigrate: INSUFFICIENT_B_AMOUNT');
    }
