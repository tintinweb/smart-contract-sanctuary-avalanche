    ...
    FactionsManagerImplementationPointer
{
    ...
    function getMaxTokenPerWallet() public view returns (uint256) {
        // 1% - variable
        return (SpookyVerse.totalSupply() * maxTokenPerWalletPercent) / 200;
    }
    ...
    function liquidityRouter(address sender) public view returns (bool){
        return liquidityPoolManager.isRouter(sender);
    }
