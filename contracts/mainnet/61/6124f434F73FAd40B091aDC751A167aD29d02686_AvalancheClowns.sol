...
contract AvalancheClowns is ERC721, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    uint16 public constant maxSupply = 789;
    uint256 public nftRemaining = maxSupply;
    uint128 public nftPrice = 1000000000000000000; // 1 AVAX
    uint8 public maxToMint = 9; // Per transaction
    uint8 public whitelistedIndex = 0;
    uint8 public maxWhitelistedAmount = 100;
    bool public saleHasStarted = false;

    address private dev1 = 0xFb36165009A38E5eF9b9cfaCE4cD003CbC2c5457;
    address private dev2 = 0xC30f422Ad507fec69582b2E654129A7B6ac602fA; 
    ...
    constructor() ERC721("AVALANCHECLOWNS", "AVAXCLOWN") {
        setBaseURI("https://ipfs.io/ipfs/QmQj6p5z8DT4fVXex95EqmsurdWRGVP5nJPoXtAjCuFqb9/");
    }
    ...
    * @notice Pause sale if any error occurred
    ...
    function withdraw() public payable onlyOwner {
        ...
        payable(dev1).transfer(contractBalance.mul(7000).div(10000));
        payable(dev2).transfer(contractBalance.mul(3000).div(10000));
    }
