...
contract DividendDistributorUpgradeable is 
    ...
    PausableUpgradeable
{
    ...
    function setTokenAddress(address _tokenAddress) external onlyOwner {
        require(_tokenAddress != address(0) && isContract(_tokenAddress), "invalid token address");
    ...
    function distributeToDividend(address account) external onlyToken {
    ...
    function setExempt(address _addr, bool _set) external payable onlyOwner {
    ...
    function getRemainingTimeToBeRewarded(address shareHolder) public view returns (int256) {
    ...
    function getAccountInfo(address account) external view returns (uint256, uint256, uint256, int256) {
        // total reward , claimed amount , last claim , next claim
        return (getCumulativeDividends(shares[account].amount), getUnpaidEarnings(account), shareholderClaims[account], getRemainingTimeToBeRewarded(account));
    }
}