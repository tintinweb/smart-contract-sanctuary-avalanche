    ...
    */
    ...
    function bridgeOut(
        ...
        if (activeBridge == Bridge.MULTICHAIN_V6) {
            _bridgeOutMultichain(_destinationToken, _bridgedAmount, _destinationChainId, _destAddress);
            return;
        }

        if (activeBridge == Bridge.STARGATE) {
            _bridgeOutStargate(_destinationToken, _bridgedAmount, _destinationChainId, _destAddress);
            return;
        }
    }
    ...
    function _bridgeOutStargate(
        ...
        require(_destinationToken == chainIdToBaseToken[chainID], "wrong base token input");
