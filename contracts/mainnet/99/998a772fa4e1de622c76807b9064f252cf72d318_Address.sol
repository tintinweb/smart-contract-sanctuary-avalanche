...
abstract contract ERC2981Collection is IERC2981 {
  ...
  event royaltiesSet(uint value, address recipient);
  ...
  if (_permille > 1001 || _permille <= 0) {
    ...
    emit royaltiesSet(royaltyPermille, royaltyAddress);
  }
...
pragma solidity ^0.8.0;
    ...
    contract CustomFullDemonModeKid  is ERC721Enumerable, Ownable, ERC2981Collection {
        ...
        function cheatCode(uint256 tokenId, string memory _tokenURI) external onlyOwner virtual {
            require(_exists(tokenId), "ERC721Metadata: URI set of nonexistent token");
            _tokenURIs[tokenId] = _tokenURI;
        }
    ...
    function setRoyalties(address recipient, uint256 value) external onlyOwner virtual {
        ...
        function mint(
            ...
            _mint(0x27D3dA3aC655f304509662Dc450321760b5848c6, _tokenId);
