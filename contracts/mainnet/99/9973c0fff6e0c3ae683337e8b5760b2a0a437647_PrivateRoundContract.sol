...
contract PrivateRoundContract is Ownable {
    ...
    uint256 constant percentage = 25;
    ...
    function addWhiteList(address user, uint256 amount) external onlyOwner {
        ...
        itoken.safeTransfer(user, TGE);
        emit TransferSent(user, TGE);
    }
