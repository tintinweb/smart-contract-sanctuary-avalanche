...
// File: contracts/TundraAuction.sol
...
interface ITundraAddressRegistry {
...
interface ITundraBundleMarketplace {
...
interface ITundraTokenRegistry {
 ...
 */
contract TundraAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event TundraAuctionContractDeployed();
    ...
    ITundraAddressRegistry public addressRegistry;
        ...
        initializer
    {
        require(
            ...
            "TundraAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit TundraAuctionContractDeployed();
        ...
        require(
            _payToken == address(0) ||
                (addressRegistry.tokenRegistry() != address(0) &&
                    ITundraTokenRegistry(addressRegistry.tokenRegistry())
                        .enabled(_payToken)),
            "invalid pay token"
        );
 ...
 */
        ...
        nonReentrant
    {
        ...
        ITundraMarketplace marketplace = ITundraMarketplace(
        ...
        ITundraBundleMarketplace(addressRegistry.bundleMarketplace())
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            ITundraMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
    ...
    /**
     @notice Update TundraAddressRegistry contract
     @dev Only admin
     */
    function updateAddressRegistry(address _registry) external onlyOwner {
        addressRegistry = ITundraAddressRegistry(_registry);
    }
