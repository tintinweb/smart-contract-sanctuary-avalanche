...
contract Ryusaurs is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 999; //  999 total for this launchpad
...
//
    function claim(uint256 n) public {
        ...
        require(publicMintedAmount[msg.sender] < 2, "exceeds the public minting limit");
        require(n + publicMintedAmount[msg.sender] <= 2, "you can't early claim that much");
