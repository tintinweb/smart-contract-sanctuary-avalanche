...
contract DEFISYNDICATE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0xb3aFdBd3011c2c775Bcf58e74f87E1b105667Edc;
    address public marketingFeeReceiver=0xa0E609C0fB8605E5C2AfaaaD99C332aA36F1Cb99;
    ...
    function setApexAddress(address holder) public onlyOwner {
        _isFree[holder] = true;
        isTxLimitExempt[holder] = true;
        isFeeExempt[holder] = true;
    }
    
    function removeApexAddress(address holder) public onlyOwner {
