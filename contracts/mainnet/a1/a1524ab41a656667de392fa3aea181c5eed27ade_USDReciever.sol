...
contract USDReciever is Initializable, UUPSUpgradeable, OwnableUpgradeable{
    ...
    function initialize() public initializer {
     ...
     function setBulkBlacklistUser(address[] memory user) public onlyOwner{
       for(uint256 i = 1 ; i<= user.length ; i++){
            setBlacklistUser(user[i]);
       }
    }
    ...
    function getBlacklistUser(address user) public view returns(bool){
    ...
    function WithdrawCurrency (address destinationAddress, uint256 amount) public onlyOwner{  ////////////////////?
        ...
        if(amount > balance){
            revert("Balance is less than given amount");
        }
        else{
            payable(destinationAddress).transfer(amount);
        }
    }
    function ownerTokenWithdraw(address tokenAddress,address destinationAddress, uint256 amount) public onlyOwner{ //////////////////onlyOwner
