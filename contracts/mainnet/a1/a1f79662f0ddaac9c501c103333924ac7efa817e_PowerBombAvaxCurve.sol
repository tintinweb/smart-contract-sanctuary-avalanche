...
contract PowerBombAvaxCurve is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    IERC20Upgradeable constant lpToken = IERC20Upgradeable(0x1337BedC9D22ecbe766dF105c9623922A27963EC);
    // IERC20Upgradeable public lpToken;
    IERC20Upgradeable public rewardToken;

    IRouter constant router = IRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); // Trader Joe
    IMinter constant minter = IMinter(0xabC000d88f23Bb45525E447528DBF656A9D55bf5); // Curve
    IPool public pool;
    IGauge public gauge;
    ...
    function _harvest(bool isDeposit) internal virtual {
        ...
        gauge.claim_rewards(); // to claim WAVAX
        ...
        if (WAVAXAmt > 0.1 ether || CRVAmt > 1 ether) {
            // Swap CRV to WAVAX
