...
contract Upgrade is ERC721Enumerable, Ownable, Pausable {
    ...
    constructor(Cocaine _cocaine, Diesel _diesel, string memory _BASE_URI) ERC721("Cartel Game Farmer Tools", "COCAINE-GAME-FARMER-TOOL") {
        ...
        levels[0] = Level({ supply: 0, maxSupply: 2500, priceCocaine: 9000 * 1e18, priceDiesel: 30 * 1e18, yield: 1 });
        levels[1] = Level({ supply: 0, maxSupply: 2200, priceCocaine: 22500 * 1e18, priceDiesel: 50 * 1e18, yield: 3 });
        levels[2] = Level({ supply: 0, maxSupply: 2000, priceCocaine: 35000 * 1e18, priceDiesel: 75 * 1e18, yield: 5 });
        currentLevelIndex = 2;
    }
