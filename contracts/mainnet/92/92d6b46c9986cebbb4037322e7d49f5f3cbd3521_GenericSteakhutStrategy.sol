...
// yAxis Steakhut Strategy: WETH-AVAX
...
// File: interfaces/IHarvester.sol
...
// File: interfaces/IStableSwap3Pool.sol
...
// File: contracts/AvaxBaseStrategy.sol
...
// File: interfaces/ExtendedIERC20.sol
...
interface ISteakhut {
    ...
    function userInfo(uint256 pid, address user) external view returns (uint256, uint256); // Steakhut
    function deposit(uint256 pid, uint256 amount) external;
    function withdraw(uint256 pid, uint256 amount) external;
    function poolInfo(uint256 pid) external view returns (address, uint256, uint256, uint256, bool); // Steakhut
}
// File: contracts/GenericSteakhutStrategy.sol
...
contract GenericSteakhutStrategy is AvaxBaseStrategy {
    ...
    ISteakhut public immutable steakhut;
        ...
        AvaxBaseStrategy(_name, _controller, _manager, _want, _wavax, _routerArray)
    {
        ...
        steakhut = ISteakhut(_steakhut);
        (address _lpToken,,,,) = ISteakhut(_steakhut).poolInfo(_pid);
        require(_want == _lpToken, "Wrong poolId");        
        pid = _pid;
        ...
        IERC20(_want).approve(_steakhut, type(uint256).max);
    ...
    function balanceOfPool()
        ...
        returns (uint256)
    {
        (uint256 _balance,) = steakhut.userInfo(pid, address(this));
        return _balance;
    }
