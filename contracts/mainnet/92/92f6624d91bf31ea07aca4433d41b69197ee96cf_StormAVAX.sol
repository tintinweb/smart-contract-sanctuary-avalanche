...
contract StormAVAX is IERC20, ReentrancyGuard, Ownable {
    using SafeMath for uint256;

    // token data
    string private constant _name = "Storm.Money AVAX";
    string private constant _symbol = "stormAVAX";
    ...
    function mintWithNative(
        ...
        return _mintWithNative(recipient, msg.value);
    }
    ...
    */
    ...
    function _mintWithNative(
        ...
        uint256 received = _purchaseUnderlyingWithNative(nativeAmount);
    ...
    function _purchaseUnderlyingWithNative(
        ...
        // Wrap AVAX
        IWAVAX(router.WAVAX()).deposit{value: nativeAmount}();
    ...
    */
    ...
    receive() external payable {
        _mintWithNative(msg.sender, msg.value);
        _checkGarbageCollector(address(this));
        _checkGarbageCollector(DEAD);
    }
