...
contract MagiaSale is Ownable {
    using SafeERC20 for ERC20;
    using Address for address;

    uint MIMdecimals = 10 ** 18;
    uint MAGIAdecimals = 10 ** 9;
    uint public MAX_SOLD = 50000 * MAGIAdecimals; // MIM
    uint public PRICE = 850000000;
    uint public MIN_PRESALE_PER_ACCOUNT = 1 * MAGIAdecimals;
    uint public MAX_PRESALE_PER_ACCOUNT = 1500 * MAGIAdecimals;

    address public dev;
    ERC20 MIM;

    uint public sold;
    address public MAGIA;
    bool canClaim;
    ...
    constructor() {
        ...
        dev = 0xCD4792e7F560EbC597cF992B30c21D6B3aA877C3;
        sold = 0;
    }
    ...
    /* allow non-blacklisted users to buy MAGIA */
    ...
    function buyMAGIA(uint256 amount) public {
    ...
    function owner_buyMAGIA(uint256 amount, address _to/*, bool _activateclaim*/) public onlyOwner {
    ...
    // set MAGIA token address and activate claiming
    function setClaimingActive(address magia) public {
        require(msg.sender == dev, "!dev");
        MAGIA = magia;
        canClaim = true;
    }

    // claim MAGIA allocation based on old + new invested amounts
    function claimMAGIA() public {
        require(canClaim, "cannot claim yet");
        require(!claimed[msg.sender], "already claimed");
        require(!blacklisted[msg.sender], "blacklisted");
        if ( invested[msg.sender] > 0 ) {
            ERC20(MAGIA).transfer(msg.sender, invested[msg.sender]);
