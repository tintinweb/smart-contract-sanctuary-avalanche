...
contract TeamQuesoERC20 is ERC20 {
    address immutable private whitelist;

    constructor(address _whitelist) ERC20("TQO", "TQO") {
        whitelist = _whitelist;
        _mint(msg.sender, 5830 * 10**18);
    }

    function _beforeTokenTransfer(address /*from*/, address to, uint256 /*amount*/) internal virtual override {
        require(IWhitelist(whitelist).isWhitelisted(to), "SecurityERC20: NotWhitelisted");
    }
}
