...
//  Telegram: https://t.me/RoyalsToken1
//  reflections : $KWAGMI 
...
contract RoyalsToken is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6c3996663Af6Cd0D4a43EE246d14c4D673282970; // reflections : $KWAGMI 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "RoyalsToken";
    string constant _symbol = "ROYALS";
