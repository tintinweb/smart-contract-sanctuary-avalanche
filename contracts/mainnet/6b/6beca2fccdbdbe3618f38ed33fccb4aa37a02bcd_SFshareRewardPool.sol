...
contract SFshareRewardPool {
    ...
    uint256 public tSharePerSecond = 0.01157407407 ether; // 60000 SFSHARE / (30 days * 24h * 60min * 60s)
    uint256 public runningTime = 60 days; // 370 days
