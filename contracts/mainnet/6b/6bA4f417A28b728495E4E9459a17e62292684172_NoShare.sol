...
contract NoShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 57500 tSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, uint256 _taxRate, address _taxCollectorAddress) public ERC20("NOSHARE", "NOSHARE") {
        require(_taxRate < 400, "tax equal or bigger to 4%");
        require(
        ...
        _mint(msg.sender, 50 ether); // mint 1 TOMB Share for initial pools deployment
