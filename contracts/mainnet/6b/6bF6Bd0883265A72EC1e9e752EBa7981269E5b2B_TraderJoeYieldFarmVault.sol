...
import "../../interfaces/vaults/trader-joe/ITraderJoeYieldFarmManager.sol";
import "../../interfaces/vaults/trader-joe/ITraderJoeYieldFarmReader.sol";
import "../../interfaces/oracles/IChainLinkOracle.sol";
import "../../interfaces/tokens/IWAVAX.sol";
import "../../enum/ManagerAction.sol";
import "../../enum/VaultStrategy.sol";

contract TraderJoeYieldFarmVault is ERC20, Ownable, ReentrancyGuard, Pausable {
  ...
  // Manager contract
  ITraderJoeYieldFarmManager public manager;
  // Reader contract
  ITraderJoeYieldFarmReader public reader;
  // Chainlink contract
  ...
  */
  function deposit(uint256 _amt, bool _isNative) external payable nonReentrant whenNotPaused {
    ...
    IERC20(token).safeTransfer(address(manager), _amt);
  ...
  */
  function updateReader(ITraderJoeYieldFarmReader _reader) external onlyOwner {
    reader = _reader;
  }
  ...
  */
  function updateManager(ITraderJoeYieldFarmManager _manager) external onlyOwner {
    manager = _manager;
  }
  ...
  */
  function updateCapacity(uint256 _capacityValue) external onlyOwner {
    capacityValue = _capacityValue;
  }
...
interface ITraderJoeYieldFarmManager {
...
interface ITraderJoeYieldFarmReader {
...
import "../../../../contracts/interfaces/vaults/trader-joe/ITraderJoeYieldFarmManager.sol";

abstract contract $ITraderJoeYieldFarmManager is ITraderJoeYieldFarmManager {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
...
import "../../../../contracts/interfaces/vaults/trader-joe/ITraderJoeYieldFarmReader.sol";

abstract contract $ITraderJoeYieldFarmReader is ITraderJoeYieldFarmReader {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";
...
import "../../../contracts/vaults/trader-joe/TraderJoeYieldFarmVault.sol";

contract $TraderJoeYieldFarmVault is TraderJoeYieldFarmVault {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    event return$_deposit(uint256 ret0);

    constructor(string memory _name, string memory _symbol, VaultStrategy _strategy, address _tokenA, address _tokenB, IChainLinkOracle _priceOracle, TraderJoeYieldFarmVault.VaultConfig memory _vaultConfig, uint256 _capacityValue, uint256 _mgmtFeePerSecond, uint256 _perfFee, address _treasury) TraderJoeYieldFarmVault(_name, _symbol, _strategy, _tokenA, _tokenB, _priceOracle, _vaultConfig, _capacityValue, _mgmtFeePerSecond, _perfFee, _treasury) {}
