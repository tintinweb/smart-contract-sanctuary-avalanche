...
contract unnamedNFT is ERC721, Ownable {
    using Strings for uint256; 
    ...
    uint256 public constant MINT_NFT_FEE = 0 ether;
    address public treasuryWallet; 

    // Base URI
    string private BASE_URI_EXTENDED;
    uint256 _totalSupply;
    mapping(address => uint256) public NFT_MINTED_PER_TX;
    mapping(address => uint256) public _numberMinted;
    uint256 public walletMaxMint = 10;

    address public ADMIN_WALLET = 0x9023ee16D7Ed53d0C2BCb4d2F70AD4381a63E4dB;
    bool public revealed = false;
    //total nft's are 3000 and nft id is starting from 0
    constructor() ERC721("unnamedNFT", "UNFT") {      
        BASE_URI_EXTENDED = "ipfs://QmZ15xmZEnV7t5QuuPmXuat6qmztyXYE762Cv3FZaEzKqg/";
        _totalSupply = 3000;
    }
    ...
    function mintNFT(uint256 tokenAmount) external payable returns (bool) {
        ...
        require(
            _numberMinted[msg.sender] + tokenAmount <= walletMaxMint,
    ...
    function royaltyInfo(uint256, uint256 value) external view returns(address, uint256) {
        return (treasuryWallet, value * 2000 / 10000);
    } 
