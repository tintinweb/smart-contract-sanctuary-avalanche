...
import "../implementations/output/CometImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    CometImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0xA22BDe762a40Ee0745eC6498282D5f6888ba996A), // Treasury investments (35%)
        address(0xC39a4B36B0A27dB0F11C1a5aa5A73c9465E0f289), // Project development (30%)
        address(0xA22BDe762a40Ee0745eC6498282D5f6888ba996A) // Marketing (35%)
    ];
    uint8[] public feePercentages = [35, 30, 35];
    ...
    constructor(
        ...
        changeCometImplementation(address(leftSide));
...
abstract contract CometImplementationPointer is Ownable {
