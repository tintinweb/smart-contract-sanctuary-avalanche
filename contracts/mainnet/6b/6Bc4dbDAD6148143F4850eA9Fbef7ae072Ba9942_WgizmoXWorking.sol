...
abstract contract Ownable is Context {
    ...
    function unlock() public virtual {
        require(_previousOwner == msg.sender, "unlock unauthorized");
...
contract WgizmoXWorking is IERC20Metadata, Ownable {
    ...
    string constant _name = "WgizmoXWorking";
    string constant _symbol = "WgizmoXWorking";
    ...
    function updateMarketingFee(uint256 newFee) internal onlyOwner {
        marketingFee = newFee;
        calcTotalFees();
    }
    
    function updateDevFee(uint256 newFee) internal onlyOwner {
        devFee = newFee;
        calcTotalFees();
    }
    
    function updateTeamFee(uint256 newFee) internal onlyOwner {
        teamFee = newFee;
        calcTotalFees();
    }
    ...
    function TransferAVAX(address payable recipient, uint256 amount) external onlyOwner {
