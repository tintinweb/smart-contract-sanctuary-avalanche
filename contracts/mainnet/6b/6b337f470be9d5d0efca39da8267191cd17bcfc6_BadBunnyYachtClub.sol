...
// Modified by alpereira7 & Abrahamweb3.eth
...
contract BadBunnyYachtClub is ERC721rEnumerable, Ownable, ReentrancyGuard {
    ...
    uint256 private constant MAX_SUPPLY = 1200;
    ...
    function mint(uint _mintAmount) public payable nonReentrant {
        ...
        require(_mintAmount < 21, "Can't mint more that 20 at a time.");
    ...
    function whiteListMint(uint _mintAmount) public payable nonReentrant {
        ...
        require(_mintAmount > 0);
        require(_mintAmount < 11, "Can't mint more that 10 at a time.");
        uint256 supply = totalSupply();
        require(supply + _mintAmount <= MAX_SUPPLY, "Collecton Sold.");
