...
contract VaultOwned is Ownable {
  ...
  modifier onlyVault() {
    require( _vaults[msg.sender], "VaultOwned: caller is not the Vault" );
    _;
  }

}

contract SabERC20Token is ERC20Permit, VaultOwned {

    using LowGasSafeMath for uint256;

    constructor() ERC20("Sab", "SAB", 9) {
        _mint(address(this), 250000000000000);
        _approve(address(this), msg.sender, 250000000000000);
    }
