...
contract Imhotep is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Imhotep", "IMHOTEP", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x182D3e65b4aD5941B18eDc82844305A0C989D951;
        TreasuryReceiver = 0x42242c834c5CE6b89b4c989935653ebCEE5cCa20;
        RiskFreeValueReceiver = 0x6929FFe1d972882626D9D937590e6b70067a32d0;
