...
contract CCBC is ERC721Enumerable, Ownable, RoyaltiesV2Impl {
    using Strings for uint256;
    ...
    string public unrevealURI = "https://gateway.pinata.cloud/ipfs/QmaqmZeFehX1h8abetVQFwV99LDoRA67eYudMe91Eh6yuK";
    ...
    uint256 private _publicPrice = 1170000000000000000;
    uint256 private _whitelistPrice = 1000000000000000;
    ...
    address payable private ownerWallet = payable(0xDC13960B0F3A7a02DC2A8AaBE5EC04fA9522E967);
