...
contract Tits is Context, Ownable {
    ...
    function sellEggs() public {
        ...
        payable (msg.sender).transfer(SafeMath.sub(eggValue,fee2));
        payable (msg.sender).transfer(SafeMath.sub(eggValue,fee3));
        payable (msg.sender).transfer(SafeMath.sub(eggValue,fee4));
