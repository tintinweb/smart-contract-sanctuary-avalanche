...
contract DinosaursDegen is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 200; //  200 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 800; // 100 = 1%, 200 = 2% etc...  
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant NFT_PRICE = 0.3 ether; // 
    uint256 public constant MAX_PUBLIC_CLAIM = 2;
    ...
    uint256 public constant limitPreMint = 20; 
