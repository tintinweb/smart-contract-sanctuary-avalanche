...
// Easy Nodes
// https://twitter.com/EasyNodesFi
// https://easy-nodes.io/
// https://docs.easy-nodes.io/
// https://www.easy-nodes.io/dapp
...
contract EasyNodes is ERC20, Ownable, Pausable {
 ...
 //   address public usdce;
    ...
    constructor(
        ...
        rewardPool = 0x1DC4a4DE7360FB1AdDf1BBcba5908b35992d1468;
        treasury = 0x1DC4a4DE7360FB1AdDf1BBcba5908b35992d1468;
...
//    }
    ...
    function setTaxes(
        ...
        require(_blSalesTax <= 10000, "Cannot be more than 20%");
        transferTax = _transferTax;
        salesTax = _salesTax;
        blSalesTax = _blSalesTax;
    }
    ...
    function _transferFrom(
        ...
        if (antiBotEnabled && blacklisted[to] == 0 && (lpPairs[from] && !whitelisted[to])) {
