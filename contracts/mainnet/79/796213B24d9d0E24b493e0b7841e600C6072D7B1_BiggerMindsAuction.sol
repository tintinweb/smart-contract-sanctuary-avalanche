...
interface IBiggerMindsMarketplace {
 ...
 */
contract BiggerMindsAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event BiggerMindsAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "BiggerMindsAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit BiggerMindsAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IBiggerMindsMarketplace marketplace = IBiggerMindsMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IBiggerMindsMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
