...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x88784DC627F0a1ebdd6B470524719c089D18E55e); // 
...
contract GokuInu is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address VEGETA = 0x88784DC627F0a1ebdd6B470524719c089D18E55e; // 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Goku Inu";
    ...
    address public autoLiquidityReceiver=0x5a599a61C75D1F443Ff6b91139dc710151539320; //liq address
    address public marketingFeeReceiver=0x5a599a61C75D1F443Ff6b91139dc710151539320; // marketing address
