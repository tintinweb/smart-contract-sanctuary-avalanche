...
/**
 *
We understand that the task of keeping the token's price and increasing it's value is the most important for a project, so we have installed an automatic buyback mechanism using a tax on the buyback wallet. Join the Mad Meta Avax project you will gain huge profits and become future millionaires. Let's enjoy the feeling of being a millionaire with the $MMA in our wonderful metaverse

Token Economics
⚡️ Total Supply: 1,00,000,000,000 $MMA
⚡️Add liquidity :  97%
⚡️ Marketing:        3%
...
Anti Bot Features 
Max TX: 5% of total Supply for each TX, at Launch!
Max Wallet: No limit
Initial Liquidity: 20 AVAX + 97% $MMA supply

✈️ 3D Metaverse where you can create your own NFT
✈️ Secondly BuyBack.
✈️ Amazing Calling on famous channels
✈️ Further on the roadmap: Coingecko, CMC listing
 

💬 Telegram: https://t.me/MadMetaAvax

🔍 Twitter:https://twitter.com/MadMetaAvax
*/
...
contract MadMetaAvax is Context, IERC20, Ownable {
    ...
    string private _name = 'Mad Meta Avax';
