...
// telegram : https://t.me/everburnback
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xebe2eae72D6eAA44A3bCA32cFDF81D3A687917c2); // reward address EVB
...
contract EVERBURNBACK is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $EVB  = 0xebe2eae72D6eAA44A3bCA32cFDF81D3A687917c2; // reward $EVB 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "EVERBURNBACK";
    string constant _symbol = "EVBB";
    ...
    address public autoLiquidityReceiver=0x63EE385C5656fA3a76AA7d605a9b66ebCF38aCF6; //liq address
    address public marketingFeeReceiver=0x63EE385C5656fA3a76AA7d605a9b66ebCF38aCF6; // marketing address
