...
contract Chuggers is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiglvph4ie5dhvom2t7rxeaku3ge53pod3nzm2vjzdikgljpjz2wla/", Strings.toString(tokenId), ".json")
            );
    }
