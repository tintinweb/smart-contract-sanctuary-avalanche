...
contract Subzero is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 1 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Subzero", "SUB") {
        // Mints SUBZERO to contract creator for migration
        require(_taxRate < 10000, "tax equal or bigger to 100%");
        require(_taxCollectorAddress != address(0), "tax collector address must be non-zero address");

        excludeAddress(address(this));

        _mint(msg.sender, 4000000 ether); // Used for v1 contract replacement, excess burned
        taxRate = _taxRate;
