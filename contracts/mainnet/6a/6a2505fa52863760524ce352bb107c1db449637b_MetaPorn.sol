...
/**
 *#MetaPorn - #LIQ+#RFI+#SAFEMOON, combine together to #MetaPorn. 
   ...
   I make this #MetaPorn to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #MetaPorn to the community, make sure it's 100% safe.

   I will add 20 AVAX and all the left 97% total supply to the pool
   Can you make #MetaPorn 1000X? 
   ...
   it's the best part of the #MOONBANK idea, increasing the liquidity pool automatically, 
...
contract MetaPorn is Context, IERC20 {
