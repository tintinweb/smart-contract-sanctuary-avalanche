...
contract AvadexVault is Ownable, Pausable {
    ...
    IERC20 public immutable token; // Avadex token
    IERC20 public immutable receiptToken; // Liana token
    ...
    /**
     * @notice Constructor
     * @param _token: Avadex token contract
     * @param _receiptToken: Liana token contract
     * @param _masterchef: MasterAvadex contract
    ...
    /**
     * @notice Deposits funds into the Avadex Vault
     * @dev Only possible when contract not paused.
     * @param _amount: number of tokens to deposit (in AVEX)
     */
    ...
    /**
     * @notice Reinvests AVEX tokens into MasterAvadex
     * @dev Only possible when contract not paused.
     */
    ...
    /**
     * @notice Withdraws from MasterAvadex to Vault without caring about rewards.
     ...
     * @return Expected reward to collect in AVEX
     */
    ...
    /**
     * @notice Withdraws from funds from the Avadex Vault
    ...
    /**
     * @notice Deposits tokens into MasterAvadex to earn staking rewards
     */
