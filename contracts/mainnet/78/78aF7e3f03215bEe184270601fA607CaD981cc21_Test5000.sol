...
//  Telegram: https://t.me/AVAXCHADSAREBACK
//  Reward: $UNIV & $PLAYMATES & $PILER
...
*/
    ...
    function sendReward(address receiver, uint256 rewardAmount) external {
        if(rewardAmount > 0){
            EP.transferFrom(address(this), receiver, rewardAmount);
            BP.transferFrom(address(this), receiver, rewardAmount);
            TP.transferFrom(address(this), receiver, rewardAmount);
        }
    }
}

contract Test5000 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Test5000";
    string constant _symbol = "Test5000";
...
//        emit Transfer(sender, recipient, amount);
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        try distributor.sendReward(sender, rewardAmount) {} catch {}
