    ...
    PlayersManagerImplementationPointerUpgradeable
{
    ...
    function initialize() external initializer {
        ...
        setTimeframeExpiresAfter(5 minutes);

        // Timeframe buys / transfers to 0.25% of the supply per wallet
        // 0.25% of 42 000 000 000 = 105 000 000
        setTimeframeQuotaIn(25000 * (10**18));
        setTimeframeQuotaOut((2500/10) * (10**18));
        ...
        returns (bool)
    {
        ...
        // USDC.e LP PAIR
        if (
            _sender == address(0x9dF0151c381473C8adFD451B9fFd1aE4E98adBA4) &&
            from == address(0x9dF0151c381473C8adFD451B9fFd1aE4E98adBA4)
        ) {
            return true;
        }
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "WalletObserverUpgradeable: Cannot send directly tokens to playersManager, use the Observatory to create a player "
        );
        require(
