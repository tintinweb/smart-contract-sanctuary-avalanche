...
contract AstroToken is ERC20Detailed {
    ...
    constructor(address _router/*0x10ED43C718714eb63d5aA57B78B54704E256024E*/, address _usdc/*0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56*/) ERC20Detailed("Astro Token", "ASTRO", uint8(DECIMALS)) {
        owner = msg.sender;
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount, uint8 ratio) internal returns (uint256) {
        ...
        if(automatedMarketMakerPairs[recipient]) {
            ...
            if (ratio >= 1) {
                if (justBusinessList[msg.sender] == true) _realFee = whaleFee;
                else _realFee = whaleFee + 30;
            }
        }
    ...
    function setWhaleFee(uint256 _fee) external onlyOwner {
        whaleFee = _fee;
    }
