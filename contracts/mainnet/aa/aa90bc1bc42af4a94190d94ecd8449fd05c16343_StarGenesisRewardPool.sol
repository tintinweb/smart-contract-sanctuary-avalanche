...
contract StarGenesisRewardPool {
    using SafeMath for uint256;
    ...
    // MAINNET
     uint256 public tombPerSecond = 0.11574074 ether; // 20000 TOMB / (48h * 60min * 60s) 0.11574074
    ...
    // Safe TOMB transfer function, just in case if rounding error causes pool to not have enough TOMB.
