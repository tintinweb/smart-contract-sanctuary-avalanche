...
contract InvestorLp is Ownable, ReentrancyGuard {
    ...
    function depositAvaxLp(
        ...
        (bool successLiquidity, ) = investorHelper.delegatecall(
            abi.encodeWithSignature(
                "addAvaxPairLiquidity(address,address,address,address,uint256)",
                _tokenAddress,
                _avaxAddress,
                _routerAddr,
                _avaxAddress,
    ...
    function withdrawAvaxLp(
        ...
        /*
         *
         * 4. Reinvest Rewards Back Into LP
         *
         */
        (bool successReinvest, bytes memory dataReinvest) = investorHelper
            .delegatecall(
                abi.encodeWithSignature(
                    "reinvestAvaxLP(address,address)",
                    _routerAddress,
                    _avaxAddress
                )
            );
        ...
        /*
         *
         * 6. Debit Withdrawal from Depositor via StakingManager
         *
         */
