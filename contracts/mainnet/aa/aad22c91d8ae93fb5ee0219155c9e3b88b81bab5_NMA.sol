...
💥 Welcome Napoleon Money Avax $NMA💥
$NMA is an anime themed Avalaunche token that will be launching SOON on the Avax blockchain , aiming to build great community around this project. $NMA will generate a permanent passive income that will benefit all holders by creating a treasury wallet which will be use form different investment to generate profit from where the holders will benefit from

Token Economics
⚡️ Total Supply: 100% $NMA
⚡️ Add liquidity : 98%
⚡️ Marketing:       2%

👉Tax: 13% Total for buy/sell
🌟 6% Buyback Wallet
...
Max Wallet: 5%
Initial Liquidity: 15 AVAX + 98%$NMA

💬 Telegram: https://t.me/NapoleonMoneyAvax

🔍 Twitter:https://twitter.com/NapoleonMoneyA
*/
...
contract NMA is Context, IERC20, Ownable {
    ...
    string private _name = 'Napoleon Money Avax';
    string private _symbol = 'NMA';
