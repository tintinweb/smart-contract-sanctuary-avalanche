...
contract LendingManager is ILendingManager, Ownable, Modifier {
     ...
     */
    function supply(uint256 amount) external onlyCore {
     ...
     */
    function borrowMax() external onlyCore returns (uint256) {
     ...
     */
    function repay(uint256 amount) external onlyCore {
    ...
    @param amount The amount of USDC to repay
     */
    function repayBorrowInterest(uint256 amount) external onlyCore {
     ...
     */
    function harvest() external onlyCore returns (uint256) {
