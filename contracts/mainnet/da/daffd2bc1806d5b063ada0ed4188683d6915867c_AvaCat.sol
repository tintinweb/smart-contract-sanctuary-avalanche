...
contract AvaCat is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AvaCat";
    string constant _symbol = "AVACAT";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 1%
    ...
    address public autoLiquidityReceiver=0x06D17d229874184740b3f685B2D25F78049B6C64;
    address public marketingFeeReceiver=0x06D17d229874184740b3f685B2D25F78049B6C64;
