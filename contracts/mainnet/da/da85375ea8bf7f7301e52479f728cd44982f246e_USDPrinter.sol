...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDT = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
...
contract USDPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDT = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDCe
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xb13bE5be352De60804b080C9fe7477FD2057df3e;
    address public marketingFeeReceiver=0xb13bE5be352De60804b080C9fe7477FD2057df3e;

    string constant _name = "USDPrinter";
    string constant _symbol = "USDC.e.p";
