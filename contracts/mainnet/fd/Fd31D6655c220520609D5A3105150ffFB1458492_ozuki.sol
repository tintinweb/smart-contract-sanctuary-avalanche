...
// File: contracts/ozuki-avax.sol

pragma solidity ^0.8.7;

contract ozuki is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 6500;
    uint256 MAX_MINT_AVALANCHE = 8000;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "ozuki: Max 2 NFTs per transaction");
        require(
            nextTokenId + numTokens <= MAX_MINT_AVALANCHE,
            "ozuki: Mint exceeds supply"
        );
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "ozuki: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "ozuki: Failed to withdraw Ether");
    }
