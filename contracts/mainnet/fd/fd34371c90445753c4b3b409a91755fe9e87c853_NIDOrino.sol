...
/**
 * telegram : https://t.me/NIDOrino1     info : get NIDO rewards by holding NIDOrino stealthlaunching soon!   20% NIDO rewards every hour
*/   
...
contract NIDOrino is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; // reward $CROWN
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NIDOrino";
    string constant _symbol = "NIDORINO";
