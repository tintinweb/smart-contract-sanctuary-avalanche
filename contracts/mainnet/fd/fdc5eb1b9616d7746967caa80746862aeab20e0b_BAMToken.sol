...
contract BAMToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000 * 10**18; // 1B
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 20000000000000000000000; // 20000 token will be given on airdrop
    ...
    uint256 private salePrice = 300000;// 0.1*300000=30000 token for 0.1 AVAX (set as per requirements)
