...
contract Token is ERC20, Ownable {
    ...
    function initialize(string memory name_, string memory symbol_) public initializer {
        ...
        _moveDelegates(address(0), msg.sender, 50 * 1e6 * 1e18);
        _moveDelegates(address(0), address(adLockToken), 30 * 1e6 * 1e18);
        _moveDelegates(address(0), address(teamLockToken), 20 * 1e6 * 1e18);
    }
