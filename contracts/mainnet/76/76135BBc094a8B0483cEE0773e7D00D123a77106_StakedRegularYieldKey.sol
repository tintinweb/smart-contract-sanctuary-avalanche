...
/**
 * @title Staked Regular YieldKey Contract / NFT Smart Contract ERC721
 * @custom:a ValiFi
 */
    ...
    PausableUpgradeable
{
    ...
    function initialize(address regularYieldKey, string memory _initURI)
        public
        initializer
    {
    ...
    /**
     * @dev Allows to stake Regular YieldKeys
     * @param wallet address of Regular YieldKey holder
    ...
    /**
     * @dev Allows to unStake Regular YieldKeys
     * @param wallet address of Regular YieldKey holder
        ...
        whenNotPaused
    {
        ...
        for (uint256 i; i < tokenIds.length; i++) {
            ...
            maintFee.setResetMaintenanceFee(
                tokenIds[i],
                valifiRYK.capacityAmount(tokenIds[i])
            );
            _capacityAmount[i] = valifiRYK.capacityAmount(tokenIds[i]);
        }
