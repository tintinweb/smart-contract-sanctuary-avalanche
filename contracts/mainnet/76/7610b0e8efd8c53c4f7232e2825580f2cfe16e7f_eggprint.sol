...
/**
Tokenomics:
5% reflections paid in $APE
3% allocated to liquidity
7% allocated to treasury

Telegram: https://t.me/EGGPRINT

Twitter: https://twitter.com/EGG__Print

Website: https://www.eggprint.xyz/
*/
...
contract eggprint is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  address EP = 0x7761E2338B35bCEB6BdA6ce477EF012bde7aE611; // egg
  ...
  string constant _name = 'EggPrint';
  string constant _symbol = 'PEGG';
  uint8 constant _decimals = 18;

  uint256 _totalSupply = 1_000_000_000_000_000 * (10**_decimals);
  uint256 public _maxTxAmount = _totalSupply.div(100); // 1% - anti-bot measures, increase later
  ...
  address public autoLiquidityReceiver =
    0x9FdE35b985c1e5C597bf94C2cEe8eF2Da6013036;
