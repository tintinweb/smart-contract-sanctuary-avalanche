...
contract SwapStrategyPOL is ISwapStrategy {
    ...
    /// @notice Add liquidity for YToken/WETH with the current balance and Move LP to Reserve
    function addLiquidity() internal {
        require(reserve != address(0), "SwapStrategyPOL::addLiquidity:Invalid reserve address");
