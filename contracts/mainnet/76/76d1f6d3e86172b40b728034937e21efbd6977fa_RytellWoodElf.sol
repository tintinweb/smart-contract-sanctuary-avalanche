...
contract RytellWoodElf is ERC721Metadata {
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell Jotun: All minted");
        require(counts_ > 0, "Rytell Jotun: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell Jotun: sale already ended"); 
        require(!paused, "Rytell Jotun: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell Jotun: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell Jotun: max supply reached");
    ...
    function addTOGiveawayMax(uint256 giveawayMax_)
     ...
     function randomGiveaway(address[] memory winners_)
        ...
        require(
            ...
            "Rytell Jotun: overflow giveaways");
