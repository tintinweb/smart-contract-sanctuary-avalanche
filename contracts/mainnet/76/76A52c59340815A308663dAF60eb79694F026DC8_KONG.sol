...
// KONG PROTOCOL COPYRIGHT (C) 2022 
...
contract KONG is ERC20Detailed, Ownable {
    ...
    string public _name = "KONG Protocol";
    string public _symbol = "KONG";
    ...
    uint256 public kongVaultFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public firePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(kongVaultFundFee).add(
            firePitFee
        );
    ...
    address public kongVaultReceiver;
    ...
    constructor() ERC20Detailed("KONG Protocol", "KONG", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x0C5AC0c6955dcb54A3c55C99Ff85d39d371A5fBE;
        treasuryReceiver = 0xD9a4D606E53d443575cfd13e08d2668a9bec779b; 
        kongVaultReceiver = 0xc927B88834ec0ae988A157ce25a6aBdAfDcCb54e;
        firePit = DEAD;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(kongVaultFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountAVAXToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(kongVaultFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(kongVaultReceiver).call{
            value: amountAVAXToTreasuryAndSIF.mul(kongVaultFundFee).div(
                treasuryFee.add(kongVaultFundFee)
            ),
            gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no KONG token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WAVAX();
        router.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _kongVaultReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        kongVaultReceiver = _kongVaultReceiver;
        firePit = _firePit;
    }
