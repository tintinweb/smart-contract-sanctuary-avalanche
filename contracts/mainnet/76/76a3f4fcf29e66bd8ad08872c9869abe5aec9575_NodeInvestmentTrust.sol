...
contract NodeInvestmentTrust is Context, IBEP20, Ownable {
    ...
    string private _name = 'Node Investment Trust';
    string private _symbol = 'NIT';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 100 * 10**7 * 10**18;
    ...
    function _setTreasuryFee(uint256 TreasuryFee) external onlyOwner() {
        require(TreasuryFee >= 0 && TreasuryFee <= 100, 'TreasuryFee should be in 0 - 100');
        _taxFee = TreasuryFee;
    }
