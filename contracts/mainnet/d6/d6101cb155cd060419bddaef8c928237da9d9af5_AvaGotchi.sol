...
contract AvaGotchi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "AvaGotchi";
    string private _symbol = "AVAG";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xC18B3f30310e77810d0174573abe08724e56227f);
    address payable public devWalletAddress = payable(0xf25baD2eE625be48829B2Ac5F8F910cF20ECef82);
    address payable public teamWalletAddress =  payable(0xf25baD2eE625be48829B2Ac5F8F910cF20ECef82);
