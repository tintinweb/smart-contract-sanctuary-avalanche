...
contract PelGators is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihofhrlrsqalxbzhwwhfk52cakixetalkwnq67ghdbroopbmtjv4i/", Strings.toString(tokenId), ".json")
            );
    }
