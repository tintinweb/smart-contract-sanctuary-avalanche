...
contract Torrent is Initializable, OwnableUpgradeable {
    ...
    function initialize(address _mintAddress, address _BR34PTokenAddress, address _dripTokenAddress, address _vaultAddress) public initializer {
        __Ownable_init();
    ...
    function setBr34pAddress(IToken _newBr34pAddress) public onlyOwner {
        br34pToken = _newBr34pAddress;
    }
