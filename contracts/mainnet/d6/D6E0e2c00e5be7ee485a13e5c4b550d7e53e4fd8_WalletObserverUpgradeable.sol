    ...
    PlanetsManagerImplementationPointerUpgradeable
{
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "WalletObserverUpgradeable: Buy or sell must be at least 100K NRGY"
        );
        //}
    ...
    function getMaxTokenPerWallet() public view returns (uint256) {
        // 1% - variable
        return (universe.totalSupply() * maxTokenPerWalletPercent) / 200;
    }
    ...
    function totalSupply() external view returns (uint256) {
        ...
        _totalSupply -= universe.balanceOf(
            0x3dEFE318367922E6Cb9F348e67Dee9C19A58E605 // Donations
        );
        _totalSupply -= universe.balanceOf(
            0x3dEFE318367922E6Cb9F348e67Dee9C19A58E605 // Dev
        );
        _totalSupply -= universe.balanceOf(
            0x3dEFE318367922E6Cb9F348e67Dee9C19A58E605 // Treasury Invest
        );
