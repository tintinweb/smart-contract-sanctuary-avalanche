...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7); // AVAX REWARDS
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xa1d34A693198F1785595322857dfaa36709b5C97);
        _token = msg.sender;
    }
...
contract TESTXX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TESTXX";
    string constant _symbol = "TESTXX";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xa1d34A693198F1785595322857dfaa36709b5C97);
        ...
        marketingFeeReceiver = 0xE5b19713D092F5C68ADC7f88966576Dd0483CeD2;
        devFeeReceiver = 0xE5b19713D092F5C68ADC7f88966576Dd0483CeD2;
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(marketingFeeReceiver).transfer(amountAVAX * amountPercentage / 100);
    }
    ...
    function clearStuckBalance_sender(uint256 amountPercentage) external authorized {
        uint256 amountAVAX = address(this).balance;
        payable(msg.sender).transfer(amountAVAX * amountPercentage / 100);
    }
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountAVAXDev, gas: 30000}("");
        ...
        if(amountToLiquify > 0){
            ...
            emit AutoLiquify(amountAVAXLiquidity, amountToLiquify.div(rate));
        }
    }
