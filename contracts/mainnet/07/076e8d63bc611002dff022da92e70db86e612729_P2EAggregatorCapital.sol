...
//  Twitter : https://twitter.com/p2eaaSfinance
//  A new and innovative service in the avalanche chain “p2eaaS”
//  We will be using marketing/treasury to invest in p2e and reinvesting back into p2eaaS
...
contract P2EAggregatorCapital  is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "P2E Aggregator Capital";
    string constant _symbol = "p2eaaS";
    ...
    address public autoLiquidityReceiver=0xeE85f6afDD1a0092331aA34c4891144D3638415F; //liq address
    address public marketingFeeReceiver=0xeE85f6afDD1a0092331aA34c4891144D3638415F; // marketing address
