...
contract KalmarCurveRouter is IKalmarTradingRoute, WhitelistedRole, ReentrancyGuard {
    ...
    // curve1
    ICurve2P public constant curvePool = ICurve2P(0x3a43A5851A3e3E0e25A3c1089670269786be1577);
    IERC20 public constant usdce = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664); // 0
    IERC20 public constant usdc = IERC20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E); // 1
