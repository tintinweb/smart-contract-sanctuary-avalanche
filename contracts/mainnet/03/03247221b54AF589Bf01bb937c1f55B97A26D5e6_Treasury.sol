...
contract Treasury is ContractGuard, Initializable, OwnableUpgradeable {
    ...
    function setPERIOD(uint256 _PERIOD) public onlyOwner disable { 
            PERIOD = _PERIOD;
        }
    ...
    function setMaxSupplyExpansionPercents(uint256 _maxSupplyExpansionPercent) external onlyOperator {
        require(_maxSupplyExpansionPercent >= 1 && _maxSupplyExpansionPercent <= 1000, "_maxSupplyExpansionPercent: out of range"); // [0.1%, 10%]
