...
contract Zap is OwnableUpgradeable {
    ...
    address public constant BULLUSD = 0x186B8Bd6Cfa6e0aaF9F6fe6Df71Bf58824C6E339;
    address public constant BULLSHARE = 0x08E226793Bb9593c88CfdAc0BbaF4ef79eAE1221;
    ...
    function _swap(
        ...
        } else if (_from == BULLUSD || _to == BULLUSD) {
            // [USDC.e, bullUSD] or [bullUSD, USDC.e]
            path = new address[](2);
            path[0] = _from;
            path[1] = _to;
            
        } else if (_from == BULLSHARE || _to == BULLSHARE) {
            // [USDC.e, bShare] or [bShare, USDC.e]
            path = new address[](2);
            path[0] = _from;
            path[1] = _to;
