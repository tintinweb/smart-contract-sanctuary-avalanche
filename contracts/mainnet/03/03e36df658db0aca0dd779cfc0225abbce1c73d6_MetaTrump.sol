...
/**
 *
 Welcome to Meta Trump Avax $ MTP 

With the metaverse virtual universe already has many competing projects in it. Let's escape with the super spaceship Meta Trump to that virtual universe. Let's explore what's beyond the Metaverse? Can our charismatic president create a unified virtual universe and lead the virtual universe in search of treasures beyond space?

 Tokenomic:
🌟 1,000,000,000,000 $MTP
🌟 97% add liquidity and locked
...
💰 3% for Dev wallet
 ...
 Telegram : https://t.me/MetaTrump_Avax

 Twitter : https://twitter.com/MetaTrump_Avax
...
contract MetaTrump is Context, IERC20, Ownable {
    ...
    string private _name = 'Meta Trump Avax';
