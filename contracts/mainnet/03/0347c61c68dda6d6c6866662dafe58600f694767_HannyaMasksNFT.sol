    ...
    Ownable
{
    ...
    uint256 public constant WL_MINT_DURATION = 5 minutes;
    ...
    uint256 public constant MANAGER_CUT = 7000;
    address public constant CURATOR =
        0x8fE4E9cD42c09d71c3CB590F7C2949ca94065001;
    uint256 public constant CURATOR_CUT = 2000;
    ...
    constructor() ERC721("HANNYA MASKS", "HANNYAMASKS") {
        mintStartTimestamp = 1669998600;
        mintPrice = 1.5 ether;
        baseURI = "ipfs://bafybeibsurb6kpwzavc3l7ar4227nfmvgjwcs6uzt7unczaibnss5t4ir4/"; // unrevealed metadata
        ...
        super._setDefaultRoyalty(address(ROYALTY_PAYMENT_SPLITTER), 700);

        _mint(MANAGER);

        RESERVED_SUPPLY = totalSupply();
        maxWhitelistSupply = MAX_SUPPLY - RESERVED_SUPPLY;
    }
    ...
    function _whitelistMint() private {
        ...
        if (totalSupply() - RESERVED_SUPPLY >= maxWhitelistSupply) {
    ...
    function setMaxWhitelistSupply(uint256 _maxWhitelistSupply)
        public
        onlyOwner
    {
