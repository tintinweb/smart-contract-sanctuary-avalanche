...
contract Pool is Ownable, ReentrancyGuard {
    ...
    function mint(uint256 _minXTokenOut) external payable nonReentrant {
        ...
        require(_xTokenOut >= _minXTokenOut, "Pool::zap: slippage");
    ...
    function collect() external nonReentrant {
        ...
        if (_sendYToken) {
            yToken.mint(_sender, _yTokenAmount);
        }
    ...
    event Mint(address minter, uint256 amount, uint256 ftmIn, uint256 fee);
