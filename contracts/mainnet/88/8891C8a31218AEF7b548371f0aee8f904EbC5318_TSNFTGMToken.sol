...
contract TSNFTGMToken is BEP20, MinterRole {
    ...
    uint256 public minBuyBackAmount = 100000000000;   //10 PAL tokens
    // Trading bool
    ...
    bool public buyBackEnabled = true; // INMUTABLE
     ...
     */
    constructor() public BEP20("TsNFTGamingDAO", "TSNFTGM") {
        operator = _msgSender();
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        bool canBuyBack  = contractBalance >= minBuyBackAmount;
        if( 
            tradingOpen == true
            && buyBackEnabled == true 
            && _inBuyBack == false
    ...
    function buyBackTokens() private lockTheBuyBack {
        uint256 contractTokenBalance = balanceOf(address(this));
        transfer(BURN_ADDRESS, contractTokenBalance);
    }
    ...
    function updateMinBuyBackAmount(uint256 _minBuyBackAmount) public onlyOperator {
        minBuyBackAmount = _minBuyBackAmount;
    }

    function enableBuyBack(bool _enabled) public onlyOperator {
