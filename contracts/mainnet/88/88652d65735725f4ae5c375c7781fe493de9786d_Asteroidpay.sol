...
//  Stealth Launch
//  Telegram: https://t.me/Asteroidpay
//  Twitter: https://twitter.com/Asteroidpay1
//  Reward: $AST
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x196d5d8F4ec51af5F4f48C7fE65e0dFD4baC6aEB); // reward address $AST
...
contract Asteroidpay  is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AST = 0x196d5d8F4ec51af5F4f48C7fE65e0dFD4baC6aEB; // reward AST
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Asteroidpay";
    string constant _symbol = "ASTP";
    ...
    address public autoLiquidityReceiver=0x462A2c9a3bac4F520043aBF37891fEF6066A53D3; //liq address
    address public marketingFeeReceiver=0x462A2c9a3bac4F520043aBF37891fEF6066A53D3; // marketing address
