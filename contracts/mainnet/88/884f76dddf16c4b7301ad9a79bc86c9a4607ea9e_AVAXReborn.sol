...
contract AVAXReborn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "AVAXRe";
    string constant _symbol = "AVAxRe";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 5%
    uint256 public _maxWallet = _totalSupply.div(50); // 5%
    ...
    address public autoLiquidityReceiver=0x989d1E413339815c14d15455FFF3FFe2e0E2CF8a;
    address public marketingFeeReceiver=0x989d1E413339815c14d15455FFF3FFe2e0E2CF8a;
