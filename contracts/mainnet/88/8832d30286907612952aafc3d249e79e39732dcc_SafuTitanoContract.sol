...
contract SafuTitanoContract is ERC20Detailed, Ownable {
    ...
    string public _name = "SafuTitano";
    string public _symbol = "ASAFTI";
    ...
    uint256 public SafutitanoRiskFreeFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public supplyControlFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(SafutitanoRiskFreeFundFee).add(
            supplyControlFee
        );
    ...
    address public SafutitanoRiskFreeFund;
    ...
    constructor() ERC20Detailed("SafuTitano", "ASAFTI", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0xB5708db66B88f2FC006953008A0275591dC537d0;
        treasuryFund = 0x0fa39Ea67Fa2bFF4d3581c1EE83269fdA6C422a1;
        SafutitanoRiskFreeFund = 0x9c5345a3C7B5fab558eE1ed2779D3c3d3942C639;
        supplyControl = 0x4D69f806EA93222474cd82750BCcCB5ecBcb5A7b;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(SafutitanoRiskFreeFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndRRFF.mul(treasuryFee).div(
                treasuryFee.add(SafutitanoRiskFreeFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(SafutitanoRiskFreeFund).call{
            value: amountETHToTreasuryAndRRFF.mul(SafutitanoRiskFreeFundFee).div(
                treasuryFee.add(SafutitanoRiskFreeFundFee)
            ),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _SafutitanoRiskFreeFund,
        address _supplyControl
    ) external onlyOwner {
        autoLiquidityFund = _autoLiquidityFund;
        treasuryFund = _treasuryFund;
        SafutitanoRiskFreeFund = _SafutitanoRiskFreeFund;
    ...
    function withdrawFund() public onlyOwner returns(bool){
        uint balance = address(this).balance;
        (bool success, ) = SafutitanoRiskFreeFund.call{value:balance}("");
        return success;
    }
}