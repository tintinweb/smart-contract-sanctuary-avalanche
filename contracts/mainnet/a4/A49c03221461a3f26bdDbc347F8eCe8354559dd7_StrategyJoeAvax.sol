...
// File contracts/strategies/bankerJoe/strategy-joe-avax.sol

// SPDX-License-Identifier: MIT
pragma solidity ^0.6.2;

contract StrategyJoeAvax is StrategyBankerJoeFarmBase {
    address public constant jAVAX = 0xC22F01ddc8010Ee05574028528614634684EC29e; //lending receipt token
