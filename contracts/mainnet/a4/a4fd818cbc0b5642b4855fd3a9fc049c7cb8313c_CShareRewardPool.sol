...
contract CShareRewardPool {
    ...
    uint256 public cSharePerSecond;
    ...
    constructor(
        ...
        require(_cShare != address(0), "_cShare");
        require(_daoFund != address(0), "_daoFund");
        cShare = IERC20(_cShare);
        daoFund = _daoFund;
        cSharePerSecond = TOTAL_REWARDS.div(365).div(24).div(60).div(60);   
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 10 days) {
            // do not allow to drain core token (cSHARE or lps) if less than 10 days after pool ends
