...
contract FANSTOSEE is owned, TokenERC20 {

    uint256 internal initialSupply = 138000000;
    string internal tokenName = "FANSTOSEE";
    string internal tokenSymbol = "FANS";
