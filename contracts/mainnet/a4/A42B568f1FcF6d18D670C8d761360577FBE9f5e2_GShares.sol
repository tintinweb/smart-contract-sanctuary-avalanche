...
contract GShares is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _team1Fund) public ERC20(" Glamour Shares", "GShares") {
        _mint(msg.sender, 10 ether); // mint 1  Glamour Share for initial pools deployment
        uint256 _startTime;
