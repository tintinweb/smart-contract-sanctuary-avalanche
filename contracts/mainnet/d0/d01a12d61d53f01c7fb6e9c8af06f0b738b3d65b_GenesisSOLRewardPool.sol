...
// File contracts/distribution/GenesisSOLRewardPool.sol
...
contract GenesisSOLRewardPool {
    ...
    // MAINNET
    uint256 public tokenPerSecond = 0.048032407 ether; //
    uint256 public runningTime = 1 days; // 1 days
    uint256 public constant TOTAL_REWARDS = 4150 ether;
    // END MAINNET
