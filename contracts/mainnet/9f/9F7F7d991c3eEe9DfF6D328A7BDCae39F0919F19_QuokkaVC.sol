 ...
 ********************************************************************************************                                                                                                 
                      ...
                      #@@7!!!^ :@@@#  [email protected]@@#  :@@@@Y  [email protected]@B^^[email protected]@?^[email protected]@#~~.                        
                      [email protected]@&&&#B:[email protected]@&@&[email protected]@@@B  &@[email protected]@7 [email protected]@[email protected]@7   @@5                           
                      .^[email protected]@[email protected]@[email protected]@B.&@B #@@&[email protected]@@:[email protected]@&Y#@@5   [email protected]@P                           
                      P##&&&@&~.&&7     #&5?&&~...B&B:&&7  P&B.  .&&J                           
                                                                                                
           .!J5YY57 ~YYYYYJ~  JY?   JY.?5YJJYY5^~YJYYYJ!.   .JY?    ^?YYYYY?55YJJY5J            
           &@&[email protected]@[email protected]@? @@@# [email protected]@[email protected]@&JY:[email protected]@[email protected]@&   &@@@5  [email protected]@GJJJJ7JJ&@@5J?            
          [email protected]@P     [email protected]@   [email protected]@Y @@@@&[email protected]@~   @@G   [email protected]@^..&@@  [email protected]&[email protected]@7 [email protected]@.       [email protected]@               
           @@G     [email protected]@.  [email protected]@5 @@5^@@@@~   @@G   [email protected]@[email protected]@&^ [email protected]@&[email protected]@@:[email protected]@.       [email protected]@.              
           [email protected]@&&#&P^@@&&&&@@^ @@Y .&@@~   &@P   [email protected]&  [email protected]@!^@@5:^^[email protected]&~&@&&&#&^  [email protected]@.              
             .....   ......    .     .     .              .       .  ......    .                
         .....   ......    .       .     .. ........ ....   ......    .    ..    .....          
      ~&@&##&B .&@&##&@@[email protected]@Y     [email protected]&   [email protected]@^#&&@@&&&J&@@@Y #@&###@@J &@@7 [email protected]@!.&@&###&.         
      [email protected]@?!!~: [email protected]@^   @@[email protected]@5     [email protected]@   [email protected]@.  ^@@?   :@@5 [email protected]@!   &@& @@@@[email protected]@[email protected]@Y~!~:          
      .PB##[email protected]@[email protected]@.   &@[email protected]@Y     [email protected]@   [email protected]@.  :@@?   [email protected]@J [email protected]@^   &@& @@[email protected]&@@7 YB##B&@#         
      [email protected]@B^@@[email protected]@[email protected]@#7???:[email protected]@J?7#@@.  ^@@?  [email protected]@#^:@@[email protected]@B @@G [email protected]@@7.J???7#@@         
...
mapping (uint64 => mapping (uint64 => address)) public _investorID;
    ...
    constructor() {
       routerAddress = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4;  //AVAX traderjoe Router
...
*/
    ...
    distributeAtUSDDeposit = true;
    USDdecimals = 6;
    maxGoalExceedance = 500 * 10 ** USDdecimals; //USD value
    AutoSwapEnabled = true;
//All control given to the contract creator
   ...
   //TestNet BSC BUSD
       ...
       //Fantom Mainnet USDC
       // USDContract = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;

       //BSC Mainnet USDC 
       // USDContract = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;

       //Polygon Mainnet USDC 
       // USDContract = 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174;

        //Avalanche Mainnet USDC.e 
        USDContract = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664;
        ...
        uint256 InvestmentGoalUSD, address PayoutTokenAddr, address BankWalletAddr, uint256 DelaybeforeStart_h, uint256 Duration_h) public onlyMain()
   {
    ...
    minInvestment[ProjectID] = minimumInvestmentUSD * 10 ** USDdecimals; //USD value
    maxInvestment[ProjectID] = maximumInvestmentUSD * 10 ** USDdecimals; //USD value
    InvestmentGoal[ProjectID] = InvestmentGoalUSD * 10 ** USDdecimals; //USD value
...
function updateRouterAddress(address newRouterAddress) public onlyMain()
{
...
{   
    uint256 Tokens;
    uint256 Balance = getPayoutTokenBalance(ProjectID);
 //   require(Balance > 0,"Token Balance = 0");  also possible to use bankwallet balance

    //if(MaxTotalTokens[ProjectID]==0)
     if(ClaimStartTime[ProjectID]==0) //new project
    {
