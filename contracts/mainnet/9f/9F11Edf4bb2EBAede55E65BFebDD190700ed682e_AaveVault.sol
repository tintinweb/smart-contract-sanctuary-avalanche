 ...
 */
contract AaveVault is PausableUpgradeable, BaseBuildingBlock {
    ...
    function initialize(bytes memory _data) public initializer {
        (
            ...
            IRewardsController rewardsControllerAddress
                ...
                _data,
                (IPoolAddressesProvider, IWETHGateway, IRewardsController)
            );
     ...
     */
    function setUserEMode(bytes memory _data) public whenNotPaused {
     ...
     */
    function setCollateralAsset(bytes memory _data) public whenNotPaused {
     ...
     */
    function openPosition(bytes memory _data) public whenNotPaused {
     ...
     */
    function borrow(bytes memory _data) public whenNotPaused {
        (
            IERC20 borrowAsset,
            uint256 amount,
            uint16 borrowRate,
     ...
     */
    function repay(bytes memory _data) public payable whenNotPaused {
     ...
     */
    function closePosition(bytes memory _data) public whenNotPaused {
     ...
     **/
    function claimAllRewards(bytes memory _data) public whenNotPaused {
