    ...
    PlayersManagerImplementationPointerUpgradeable
{
        ...
        returns (bool)
    {
        ...
        // USDC.e
        if (
            _sender == address(0xD79C9E1c0087e9327a462850De5Cb5C63c231c42) &&
            from == address(0xD79C9E1c0087e9327a462850De5Cb5C63c231c42)
        ) {
            return true;
        }
        ...
        returns (bool)
    {
        ...
        if (
            from == address(0x460B6855E8A9533E0168ecE11f218AF055b7cE2F) ||
            to == address(0x460B6855E8A9533E0168ecE11f218AF055b7cE2F)
        ) {
            return true;
        }
