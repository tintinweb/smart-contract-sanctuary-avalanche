...
contract NFTGMToken is BEP20, MinterRole {
    ...
    uint256 public sellFee = 7;   // default 10%
    // Trading bool
     ...
     */
    constructor() public BEP20("NFTGamingDAO Presale Token", "TPNFTGM") {
        operator = _msgSender();
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if (sender == owner() || recipient == owner() || isExcludedFromFee[sender] || isExcludedFromFee[recipient]) {
            ...
            require(!isBlacked[sender], "sender is blacked to transfer");
    ...
    function updateBuyFee(uint16 _buyFee) public onlyOperator {
        require( _buyFee <= 100, "PAL:: Buy Fee can't exceed 100%" );
