...
contract NormalCats is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 1069; //  2222 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant NFT_PRICE = 0.069 ether; // 1.6 avax for this launchpad
    uint256 public constant EARLY_NFT_PRICE = 0.069 ether; //1.6 avax for this launchpad
...
//
    function claim(uint256 n) public payable {
        ...
        require(publicMintedAmount[msg.sender] < 3, "exceeds the public minting limit");
        require(n + publicMintedAmount[msg.sender] <= 3, "you can't claim that much");
