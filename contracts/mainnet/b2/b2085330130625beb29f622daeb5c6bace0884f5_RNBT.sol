...
contract RNBT is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    uint public maxPerPerson = 1;
    uint public price = 0;
    address public royaltyAddress = 0xe0EffF750de86089AddCED3B770473440ef06560;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("RNBT","RNBT") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: Max 1 per Wallet");
        if (price > 0) require(msg.value == price * amount, "Error: ! It's Free why do you want pay?!");
