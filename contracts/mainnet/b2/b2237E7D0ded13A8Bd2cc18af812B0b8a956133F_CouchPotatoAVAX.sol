...
//  Telegram: https://t.me/CouchPotatoAVAX 
//  Reward: $NOBEL
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 Nobel = IBEP20(0x75EcfC5825DC0f1b346dB945D5c463d212CDf2a3);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Nobel.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(Nobel);
        ...
        uint256 amount = Nobel.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Nobel.transfer(shareholder, amount);
...
contract CouchPotatoAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address Nobel = 0x75EcfC5825DC0f1b346dB945D5c463d212CDf2a3; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CouchPotatoAVAX";
    string constant _symbol = "ASPUD";
    ...
    address public autoLiquidityReceiver=0x9993eE8eD9dF6D741D1bD01417f50B06514061a9;
    address public marketingFeeReceiver=0x9993eE8eD9dF6D741D1bD01417f50B06514061a9;
