...
contract KlardaAggregator_Avalanche is KlardaAuth {
    ...
    address private usdt =  0xc7198437980c041c805A1EDcbA50c1Ce5db95118;
    ...
    constructor() KlardaAuth(msg.sender) {
        ...
        initHash: hex"0bbca9af0511ad1a1da383135cf3a8d2ac620e549ef9f6ae3a4c33c2fed0af91",
        fee: 9980,
        enabled: true
        });
    }
    ...
    function getETHPrice() public view returns (uint256 reserveETH, uint256 reserveUSDT) {
        // get reserves 
        (reserveETH, reserveUSDT) = getReserves(0, wavax, usdt);
        ...
        for(uint256 i=0; i<dexCount; i++){
            ...
            for(uint256 n=0; n<baseTokens.length; n++) {
                ...
                if(nextPair != address(0)) {
                    if (n == 0) {
                        uint256 bnbAmount = IBEP20(wavax).balanceOf(nextPair);
