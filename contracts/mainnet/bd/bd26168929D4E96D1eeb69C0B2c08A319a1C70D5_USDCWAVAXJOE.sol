...
contract USDCWAVAXJOE is CoreStrategyAave {
    ...
    function balancePendingHarvest() public view override returns (uint256) {
        uint256 pending = countLpPooled().add(farmToken.balanceOf(address(this)));
    ...
    function countLpPooled() internal view override returns (uint256) {
        return IFarmMasterChef(farmMasterChef).userInfo(farmPid, address(this)).amount;
    }
