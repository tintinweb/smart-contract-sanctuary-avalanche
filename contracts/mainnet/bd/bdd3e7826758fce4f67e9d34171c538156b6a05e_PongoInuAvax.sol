...
/**
 *
 💥Welcome Pongo Inu Avax $PINA💥
$PINA is an anime themed Avalaunch token that will be launching SOON on the Avax blockchain , aiming to build great community around this project. $PINA will generate a permanent passive income that will benefit all holders by creating a treasury wallet which will be use form different investment to generate profit from where the holders will benefit from

Token Economics
⚡️ Total Supply: 1,000,000,000,000 $PINA
⚡️Add liquidity :  97%
⚡️ Marketing:        3%
...
💬 Telegram: https://t.me/PongoInuAvax1
🔍 Twitter: https://twitter.com/PongoInuAvax
*/
...
contract PongoInuAvax is Context, IERC20, Ownable {
    ...
    string private _name = 'Pongo Inu Avax';
