...
contract AVARMY is ERC20 {
    ...
    function mint(address _to, uint256 _amount) public minterOnly returns (bool) {
        ...
        require(_amount > 100000, "Minting requires at least 0.0000000000001 AVARMY"); // That is done on purpose to avoid an bad truncated value on the line below
        if (_devFeeEnabled) {
