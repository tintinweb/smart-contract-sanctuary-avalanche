...
ERC721BurnableExtendedUpgradeable, TokenConstants {
    ...
    */
    ...
    function tokenURIJSON(uint256 tokenId) public view returns(string memory) {
        ...
        // professions
        attributes[11] = TokenMetadata.Attribute("Alchemy", 'number', _store[tokenId][1][0].toString(), true);
        attributes[12] = TokenMetadata.Attribute("Architecture", 'number', _store[tokenId][1][1].toString(), true);
        attributes[13] = TokenMetadata.Attribute("Carpentry", 'number', _store[tokenId][1][2].toString(), true);
        attributes[14] = TokenMetadata.Attribute("Cooking", 'number', _store[tokenId][1][3].toString(), true);
        attributes[15] = TokenMetadata.Attribute("Crystal Extraction", 'number', _store[tokenId][1][4].toString(), true);
        attributes[16] = TokenMetadata.Attribute("Farming", 'number', _store[tokenId][1][5].toString(), true);
        attributes[17] = TokenMetadata.Attribute("Fishing", 'number', _store[tokenId][1][6].toString(), true);
        attributes[18] = TokenMetadata.Attribute("Gem Cutting", 'number', _store[tokenId][1][7].toString(), true);
        attributes[19] = TokenMetadata.Attribute("Herbalism", 'number', _store[tokenId][1][8].toString(), true);
        attributes[20] = TokenMetadata.Attribute("Mining", 'number', _store[tokenId][1][9].toString(), true);
        attributes[21] = TokenMetadata.Attribute("Tailoring", 'number', _store[tokenId][1][10].toString(), true);
        attributes[22] = TokenMetadata.Attribute("Woodcutting", 'number', _store[tokenId][1][11].toString(), true);
        // rewards
