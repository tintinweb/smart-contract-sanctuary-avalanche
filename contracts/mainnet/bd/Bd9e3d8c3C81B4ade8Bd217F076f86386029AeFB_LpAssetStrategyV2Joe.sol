...
contract LpAssetStrategyV2Joe is Ownable, Pausable {
    using SafeERC20 for IERC20;

    // Tokens
    address public constant wrapped = address(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    ...
    function callReward() public view returns (uint256) {
        uint256 outputBal = IMasterChef(masterchef).pendingTokens(poolId, address(this));
        uint256 nativeOut;
