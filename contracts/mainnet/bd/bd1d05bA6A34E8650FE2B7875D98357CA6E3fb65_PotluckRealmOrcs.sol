...
contract PotluckRealmOrcs is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, Pausable {
  ...
  address  public quinaryDevAddress = 0xA6F29Ab1Bf8c731Bc99E5CBacDF4F46409BABa49;
  ...
  constructor() ERC721 ("Potluck Realm Orcs", "PLRO") {
  ...
  function mintWhitelisted(uint8 amount) public payable whenNotPaused {
    require(whitelistedAddress[msg.sender] == true, "The address can no longer pre-order");
    ...
    function whiteList(address[] memory addressList) public onlyOwner {
      ...
      whitelistedAddress[addressList[i]] = true;
    }

    function removeWhiteList(address[] memory addressList) public onlyOwner {
      require(addressList.length > 0,"No List");
      for(uint256 i = 0;i<addressList.length;i++)
      whitelistedAddress[addressList[i]] = false;
    }
