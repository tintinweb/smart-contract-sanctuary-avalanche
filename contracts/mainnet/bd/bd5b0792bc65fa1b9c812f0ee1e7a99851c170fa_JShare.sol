...
contract JShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 jSHAREs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("JettTestSHARE", "JSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 JETT Share for initial pools deployment
