...
contract GMXPerpetualDEXLongVault is ERC20, Ownable, ReentrancyGuard, Pausable {
  ...
  */
  function withdraw(uint256 _shareAmt) external nonReentrant whenNotPaused {
    _mintMgmtFee();
  ...
  */
  ...
  /**
    * Follow-on function from _withdraw(), called after manager does work(); withdraws balance of token/B to user
  */
  function _withdraw(
    address _token,
