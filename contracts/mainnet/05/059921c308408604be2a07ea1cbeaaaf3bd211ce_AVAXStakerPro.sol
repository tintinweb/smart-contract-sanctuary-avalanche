...
contract AVAXStakerPro {
	...
	uint256 constant public PROJECT_FEE = 150; // 5% allocated towards the devs | 5% allocated towards marketing | 2.5% allocated towards XPRO Token liquidity | 2.5% allocated towards XPRO DAO Treasury.
