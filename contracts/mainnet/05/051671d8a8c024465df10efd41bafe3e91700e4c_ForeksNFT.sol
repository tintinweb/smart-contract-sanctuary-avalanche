...
// File: ForeksNFT_flat.sol


// File: contracts/ForeksNFT.sol
...
contract ForeksNFT is ERC721Enumerable, Ownable {
    ...
    event congratsForYourForeksNFT(uint256 indexed id);

    constructor() ERC721('FOREKS', 'FOREKS') {
    ...
    function mintToken(address _to, uint numberOfTokens) public payable {
          ...
          for(uint i = 0; i < numberOfTokens; i++) {
              ...
              emit congratsForYourForeksNFT(mintIndex);
          }
    }
