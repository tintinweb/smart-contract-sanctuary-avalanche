...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1672336800;
  ...
  */
  ...
  uint256 public allowlistDropTime = 1672335900;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xBEe6D477A0ba8E8cb358f290B05A9B993A34850c];
  address public erc20Payable = 0xBEe6D477A0ba8E8cb358f290B05A9B993A34850c;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeifltzfawpjfwf3viu35avjq7ezmlumr2zrvkpm3v7ma6ngbbpep5i/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/cNY4e6VTszbhoeIkDNbE/contract-metadata";
  }
...
// File: contracts/WolfGenesisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WolfGenesisContract is RamppERC721A {
    constructor() RamppERC721A("Wolf Genesis", "WolfG"){}
}
