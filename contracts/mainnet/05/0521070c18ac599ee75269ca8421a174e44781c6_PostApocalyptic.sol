...
// File: contracts/PostApocalyptic.sol
...
contract PostApocalyptic is ERC721URIStorage, Ownable, Randomize {
  ...
  constructor() ERC721("Post Apocalyptic", "PACP") Randomize(62) {
    _customBaseURI = "ipfs://bafybeih25vw4xntpiawh2ipvlxyvpvosuqyok6viaeoqq4u4tfien5spx4/";
    _maxMintable = 21; // 62 max supply, 41 for holders
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = true;
    _maxMintPerTx = 1;
    _price = 0 ether;
    _artist = 0xCB636b0C0C21778E1d910Ee28F9DcBC4B412884D;
    _startTime = 1660502100;
