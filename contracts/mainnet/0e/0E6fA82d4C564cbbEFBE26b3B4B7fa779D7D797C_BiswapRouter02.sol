...
// File contracts/periphery/contracts/libraries/TransferHelper.sol
...
// File contracts/periphery/contracts/interfaces/IBiswapRouter02.sol
...
// File contracts/core/contracts/interfaces/IBiswapPair.sol
...
// File contracts/periphery/contracts/libraries/SafeMath.sol
...
// File contracts/periphery/contracts/libraries/BiswapLibrary.sol
...
library BiswapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'74b945683f3f10d8bc75dcbb48177073919a15ff32290d4bd3293d210f272214' // init code hash
            ))));
    }
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut, uint swapFee) internal pure returns (uint amountOut) {
        ...
        uint amountInWithFee = amountIn.mul(uint(10000).sub(swapFee));//TODO 10000
        uint numerator = amountInWithFee.mul(reserveOut);
        uint denominator = reserveIn.mul(10000).add(amountInWithFee);//TODO 10000
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut, uint swapFee) internal pure returns (uint amountIn) {
        ...
        require(reserveIn > 0 && reserveOut > 0, 'BiswapLibrary: INSUFFICIENT_LIQUIDITY');
        uint numerator = reserveIn.mul(amountOut).mul(10000);//TODO 10000
        uint denominator = reserveOut.sub(amountOut).mul(uint(10000).sub(swapFee));//TODO 10000
...
// File contracts/periphery/contracts/interfaces/IERC20.sol
...
// File contracts/periphery/contracts/interfaces/IWETH.sol
...
// File contracts/periphery/contracts/libraries/Babylonian.sol
...
// File contracts/periphery/contracts/libraries/FullMath.sol
...
// File contracts/periphery/contracts/BiswapRouter02.sol
