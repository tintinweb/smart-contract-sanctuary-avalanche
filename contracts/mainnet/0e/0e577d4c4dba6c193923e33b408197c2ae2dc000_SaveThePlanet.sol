...
TODAY IS A NEW DAY, the Earth Day ! 

We are Making Save The Earth so that more and more people
open their eyes and realize that we must take care of our planet.

Half of the tax collected will be used to make donations
for the oceans, global warming, and other causes we care about.

Buy Tax : 10%
Sell Tax : 10%

Ownership will be renounced after the launch and LP will be locked

https://t.me/SaveThePlanetAvax


CHAT WILL BE OPEN AT LAUNCH WHEN LP WILL BE LOCKED & OWNERSHIP RENOUNCED.
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract SaveThePlanet is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SaveThePlanet", "PLANET") {
