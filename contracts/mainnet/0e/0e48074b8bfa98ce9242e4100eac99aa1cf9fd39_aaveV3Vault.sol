...
import {IAaveRewardControllerV3} from "src/interfaces/IAaveRewardController.sol";
...
contract aaveV3Vault is Vault {
    ...
    function initialize(
        ...
        rewardController = IAaveRewardControllerV3(_rewardController);
        assetArr = new address[](1);
        assetArr[0] = _underlying;
    }
    ...
    function _pullRewards() internal override {
        rewardController.claimAllRewardsToSelf(assetArr);
    }
