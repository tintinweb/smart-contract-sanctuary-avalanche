...
contract faces_nft is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("non_familiar_faces", "NFF") {
    _customBaseURI = 'ipfs://QmYtcVzBXRzy8GkVS81xXhHuJDo8hY2PyepHuC31JDEsp6/';
    _price = 0 ether; // 0 AVAX mint price 
    _maxMintable = 90 ; // 10k max supply
    _royaltyAmount = 700; // 7% royalties
    _mintActive = true; // start paused
    _maxMintPerTx = 2;
  }
