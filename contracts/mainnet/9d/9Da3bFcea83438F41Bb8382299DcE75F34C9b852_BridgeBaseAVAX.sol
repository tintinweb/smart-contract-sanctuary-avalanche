...
contract BridgeBaseAVAX is Ownable{
    ...
    constructor(string memory _network) {
        ...
        // Update Token
        updateAuthorizationForToken(0xc7198437980c041c805A1EDcbA50c1Ce5db95118,true); //USDT 
        updateAuthorizationForToken(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E,true); //USDC
        updateAuthorizationForToken(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB,true); //WETH
        updateAuthorizationForToken(0x408D4cD0ADb7ceBd1F1A1C33A0Ba2098E1295bAB,true); //WBTC
