...
contract MyNFT is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Deez Nutz", "DEEZNUTZ") {
    _customBaseURI = 'ipfs://bafybeidfrqhrf6inuawejrfhhko54qpiiodduqyo2of2s2nvxyrrpdomfq/';
    _price = 0 ether; // 1 AVAX mint price 
    _maxMintable = 70; // 10k max supply
    _royaltyAmount = 0; // 7% royalties
