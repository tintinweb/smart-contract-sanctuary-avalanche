...
contract BOBAFETTAVAX is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BOBAFETTAVAX", "BOBAFETTA") {
        ...
        marketingWallet = address(0xf4971b15C43a7Af6ba16cF6f219c2f567332Ce81);
        devWallet = address(0x6ec7344D0d8450257E72E4ff746e3210F9895Cc6);
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 100 / 1000, "Swap amount cannot be higher than 10% total supply.");
