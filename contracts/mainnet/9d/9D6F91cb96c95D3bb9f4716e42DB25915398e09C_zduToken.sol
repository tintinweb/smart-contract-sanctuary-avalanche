// contracts/zduToken.sol
// SPDX-License-Identifier: MIT
pragma solidity 0.8.11;

import "@openzeppelin/contracts/token/ERC20/ERC20.sol";

contract zduToken is ERC20 {
    /*
    ...
    */
    // Addresses
    address ecosystemTreasury = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    ...
    address partners = 0x7DE52e513C36060C400EDcD9380cc9213B90a2E7;
    uint256 partnersAmount = 60000000 * 10**18;

    address advisors = 0x7DE52e513C36060C400EDcD9380cc9213B90a2E7;
    uint256 advisorsAmount = 60000000 * 10**18;

    address markHackathonEvents = 0x7DE52e513C36060C400EDcD9380cc9213B90a2E7;
    uint256 markHackathonEventsAmount = 50000000 * 10**18;

    address zduFund = 0x7DE52e513C36060C400EDcD9380cc9213B90a2E7;
    uint256 zduFundAmount = 110000000 * 10**18;
    ...
    constructor() ERC20("ZDUToken", "Zzdu") {
        mintAll();
    }
