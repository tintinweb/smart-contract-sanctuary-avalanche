...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465); // reward address playmates
...
contract Test21 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465; // reward ETHP
    ...
    address public autoLiquidityReceiver=0x999b6919Db3343227d1f6f1e0fA2D0F05d2335df; //liq address
    address public marketingFeeReceiver=0x999b6919Db3343227d1f6f1e0fA2D0F05d2335df; // marketing address
