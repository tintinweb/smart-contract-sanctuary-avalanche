...
contract AvaxPrinter is IERC20 {
    ...
    string constant private _name = "EverGrow Coin";
    string constant private _symbol = "EGC";
    ...
    address payable public marketingWallet = payable(0x4cAA6B7A37cF2424A58582531Fe07105A8B67c13);
    address payable constant private devWallet = payable(0x4cAA6B7A37cF2424A58582531Fe07105A8B67c13);

    uint256 private _maxTxAmount = (_tTotal * 50) / 1000;
...
//===============================================================================================================
    ...
    function contractSwap(uint256 contractTokenBalance) internal swapping {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + devBalance);
