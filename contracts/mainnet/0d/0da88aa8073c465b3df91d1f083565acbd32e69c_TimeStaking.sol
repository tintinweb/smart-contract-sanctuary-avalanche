...
contract TimeStaking is Ownable {
	...
	/**
	 * @notice set maximal token for allowed unstaking at once
	 * @param _unstakeMaxAmount uint
	 */
	...
	/**
	 * @notice set how long to wait until reset Max Amount Tokens to Unstake
	 * @param _unstakeMaxTimer uint32
	 */
	...
	/**
	 * @notice get maximum unstakable for staker
	 * @return uint
	 */
