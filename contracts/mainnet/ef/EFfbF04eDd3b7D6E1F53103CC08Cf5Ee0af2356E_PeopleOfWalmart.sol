/**
 *Submitted for verification at snowtrace.io on 2023-01-16
*/
...
contract PeopleOfWalmart is ERC721AQueryable, Ownable, ReentrancyGuard, ERC2981 {
    ...
    uint256 public tokenPrice = .05 ether; // 0.05 avax
    string public baseURIExtended;
    string public extension = ".json"; // configurable extension
    bool public saleIsActive = false;
    uint96 public tokenRoyalties = 6969; // 10% royalty

    address royaltyPayout = 0x9802FFC6447d963700F664Be53672b5b907085e4;

    // CONSTRUCTOR

    constructor() ERC721A("People of Walmart", "POW") {
        _setDefaultRoyalty(royaltyPayout, tokenRoyalties); // set intial default royalties
        baseURIExtended = "ipfs://bafybeibrt6wimnsflhnoxohha35ja74ezbd4ailqnvxzq5s4wc7wurdeuy/";
    }
    ...
    modifier callerIsUser() {
        require(
            ...
            "pow: The caller is another contract"
        );
        _;
    }
    ...
    function mint(
        ...
        require(saleIsActive, "pow: Sale is not active");
        require(numberOfTokens > 0, "pow: Minimum mint is 1 token");
        require(
            totalSupply() + numberOfTokens <= MAX_SUPPLY,
            "pow: Purchase would exceed MAX_SUPPLY"
        );
        require(
            tokenPrice * numberOfTokens <= msg.value,
            "pow: AVAX amount is not sufficient"
        );
    ...
    function tokenURI(
        ...
        require(_exists(tokenId), "pow: Token does not exist");
    ...
    function withdraw() external onlyOwner {
        ...
        require(balance > 0, "pow: Nothing to withdraw");
