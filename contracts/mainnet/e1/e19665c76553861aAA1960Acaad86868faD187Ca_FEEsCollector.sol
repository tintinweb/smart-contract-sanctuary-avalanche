...
https://t.me/FEEsCOLLECTOR
💵 Total Supply: 10,000
💵 Max Wallet: Incremental
 
Rules:
 
If you make the biggest buy (in tokens) you become the FEEsCollector, and collect 5% fees (in AVAX) the same way marketing does. 
If you sell any tokens at all at any point you can never be the FEEsCollector. 
If someone beats your record, they become the FEEsCollector. 
If you sell while the FEEsCollector, the marketing wallet becomes FEEsCollector and the record is reset to 0, this way no one can buy a ton and then sell and keep collecting tax fees.
The FEEsCollector is set via biggest buy in tokens.
...
The point is to reward big buys. There are no punishments other than disallowing sellers to be the FEEsCollector.
*/
...
contract FEEsCollector is IBEP20, Auth {
    using SafeMath for uint256;
 
    string constant _name = "FEEsCollector";
    string constant _symbol = "FEE";
