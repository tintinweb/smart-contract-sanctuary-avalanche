...
//  Stealth Launch
//  Telegram: https://t.me/ZeusNodeprinter
//  Twitter : https://twitter.com/ZeusNodeprinter
//  Reward: $ZEUS
//
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x4156F18bF7C1ef04248632C66Aa119De152D8f2E); // reward address ZEUS
...
contract ZeusNodeprinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ZEUS = 0x4156F18bF7C1ef04248632C66Aa119De152D8f2E; // reward ZEUS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ZeusNodeprinter";
    string constant _symbol = "ZEUSNp";
    ...
    address public autoLiquidityReceiver=0xC68aE63bf3c1B7dbcc38a472021028059b2b88Cc; //liq address
    address public marketingFeeReceiver=0xC68aE63bf3c1B7dbcc38a472021028059b2b88Cc; // marketing address
