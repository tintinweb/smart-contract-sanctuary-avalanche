...
// Adapted from LandOwnerJoeV2 and Police And Thieves Vault
// Added a variable reward rate based on the total LP staked
contract Cow is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public initialLPValue; // Initial number of LP tokens of AVAX-CROP
    ...
    // Deposit LP tokens to LandOwner for Reward allocation.
    ...
    // Withdraw LP tokens from LandOwner.
