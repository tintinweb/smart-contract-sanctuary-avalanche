...
contract TNRWL is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 100_000 ether;

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the NRWL ERC-20 contract.
     */
    constructor() public ERC20("TNRWL", "TNRWL") {
        // Mints 1 NRWL to contract creator for initial pool setup
        _mint(msg.sender, 1 ether);
    }

    /**
     * @notice Operator mints NRWL to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of NRWL to mint to
