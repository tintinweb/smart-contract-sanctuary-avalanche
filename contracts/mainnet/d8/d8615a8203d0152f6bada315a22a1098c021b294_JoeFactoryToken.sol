...
contract JoeFactoryToken is Context, IERC20, Ownable {
    ...
    function setMaxTx(uint256 maxTxNum, uint256 maxTxDen) public onlyOwner {
        _maxTxAmount = maxTxNum * _tTotal / maxTxDen;
    }

    function setMaxWallet(uint256 maxWalletNum, uint256 maxTxDen) public onlyOwner {
        _maxWalletAmount = maxWalletNum  * _tTotal / maxTxDen;
    }
