...
contract Avaxxary is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5e5455a99bbde0E177d4984816a5AE7876FF27a2; // avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avaxxary";
    string constant _symbol = "Avaxxary";
    ...
    address public autoLiquidityReceiver=0x5e5455a99bbde0E177d4984816a5AE7876FF27a2;
    address public marketingFeeReceiver=0x5e5455a99bbde0E177d4984816a5AE7876FF27a2;
