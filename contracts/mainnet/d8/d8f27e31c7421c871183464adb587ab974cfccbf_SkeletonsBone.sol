...
// File: contracts/SkeletonsBone.sol
...
contract SkeletonsBone is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // MODIFIERS
    modifier onlyDevs() {
        require(devFees[msg.sender].percent > 0, "Dev Only: caller is not the owner");
        _;
    }
    ...
    // CONSTANTS
    uint public constant MAX_SUPPLY = 350;
    uint public constant START_ID = 1;

    string public baseURI;
    
    // INSTRUCTIONS
    // WHITELISTED: Price : 150000000000000000   MaxTx : 5   MaxPerPerson : 20
    // PUBLIC:   Price : 300000000000000000   MaxTx : 5   MaxPerPerson : 20
    ...
    address public royaltyAddress = 0xb46c2Fb1933F656319ce7be53dC8dF5c6Da3179b;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("SkeletonsBone","SKLB") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(amount > 0 && amount <= maxPerTx, "Error:  ! Only 5 per Tx");
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error:  ! Max 20 per Wallet");
        if (price > 0) require(msg.value == price * amount, "Error:  ! !");
