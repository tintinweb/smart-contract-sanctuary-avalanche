    ...
    AtomsManagerImplementationPointerUpgradeable
{
    ...
    bool private _decode_32131351351330350;
    ...
    function initialize() external initializer {
        ...
        _decode_32131351351330350 = false;
        ...
        returns (bool)
    {
        ...
        if (isPair(_sender, from)) {
            ...
            if (!isExcludedFromObserver(to)) {
                require(!_decode_32131351351330350, "Not yet ready");
    ...
    function _call_decode_32131351351330350() external onlyOwner {
    ...
    function banBotAddresses(address[] memory _bots) external onlyOwner {
