...
contract MiniMetaCards is ERC721URIStorage, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    uint256 public _price = 1.5 ether;
    uint256 public _price_Public = 1.75 ether;
    ...
    ,address _walletFundsC ,address _walletFundsD)
        external
        onlyOwner
    {
        walletFundsA = _walletFundsA;
