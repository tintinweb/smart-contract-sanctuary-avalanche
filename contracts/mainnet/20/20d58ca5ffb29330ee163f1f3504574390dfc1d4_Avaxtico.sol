/**
 *Submitted for verification at snowtrace.io on 2023-01-22
*/

// SPDX-License-Identifier: MIT

/*
    Tired of increasingly complex and obfuscated tokens taking over the space?
    Want a simple, safe and moonable meme coin again?
    Welcome to Avoge. 

    https://t.me/Avaxtico

    8% taxes on buy and sell!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98);
...
contract Avaxtico is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6adeC0dC107a507e8F9675a13A92894845da21D5; // avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avaxtico";
    string constant _symbol = "Avaxtico";
    ...
    uint256 marketingFee = 500;   // 2% of this will be allocated to DEV wallet
    uint256 totalFee = 300;
    uint256 feeDenominator = 10000;

    address public autoLiquidityReceiver=0x6adeC0dC107a507e8F9675a13A92894845da21D5;
    address public marketingFeeReceiver=0x6adeC0dC107a507e8F9675a13A92894845da21D5;
