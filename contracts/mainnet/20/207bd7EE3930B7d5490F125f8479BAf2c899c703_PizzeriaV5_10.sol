...
import "./PizzeriaRobot.sol";

interface IPizzeriaProgressionV4_13 {
...
contract PizzeriaV5_10 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    // Constants
    ...
    IPizzeriaProgressionV4_13 public pizzeriaProgression;
    IMafia_13 public mafia;
    ...
    function initialize(Chef _chef, Upgrade _upgrade, Pizza _pizza, Soda _soda, address _freezerAddress, address _pizzeriaProgression) public initializer {
        ...
        pizzeriaProgression = IPizzeriaProgressionV4_13(_pizzeriaProgression);
    ...
    function energyDrink(uint256 _qty) public {
        ...
        uint256 costToReset = _qty * getTotalPPM(_owner) * energyDrinkCost;
    ...
    PizzeriaRobot public pizzeriaRobot;
    function setPizzeriaRobot(PizzeriaRobot _pizzeriaRobot) external onlyOwner {
        pizzeriaRobot = _pizzeriaRobot;
    }
