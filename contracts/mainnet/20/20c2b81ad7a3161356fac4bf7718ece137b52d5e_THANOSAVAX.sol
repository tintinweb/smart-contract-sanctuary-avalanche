...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x959b88966fC5B261dF8359961357d34F4ee27b4a); // reward address 
...
contract THANOSAVAX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "THANOSAVAX";
    string constant _symbol = "THANOSAX";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(12); // 8.3%
    uint256 public _maxWallet = _totalSupply.div(12); // 8.3%
    ...
    address public autoLiquidityReceiver=0x3b6b7ba55d381b7003675aB5a2447AC1d8FF1d28; //liq address
    address public marketingFeeReceiver=0x3b6b7ba55d381b7003675aB5a2447AC1d8FF1d28; // marketing address
