...
/**
 * @title AnyCallV7Gateway
 * @notice The contract implementing the cross-chain messaging logic specific to AnyCall v7
 */
...
abstract contract SystemVersionId {
     ...
     */
    uint256 public constant SYSTEM_VERSION_ID = uint256(keccak256('2023-03-10'));
}