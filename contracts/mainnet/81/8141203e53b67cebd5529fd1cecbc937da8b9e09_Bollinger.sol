...
contract Bollinger is IERC20 {
    ...
    address payable public marketingWallet = payable(0xde9f48a30fd245DdD434AD3e0d5EBD61fd445AAd);
    address payable private rewardsPool = payable(0x1f8B1b4F91CA1C06512FA23bC3E0A37930E5811d);
    address payable private treasuryWallet = payable(0x9988d417b01526B2ee3592d78F3387FE0C797553);
    address public presale_contract;
    ...
    uint256 vBuy3 = 1500;
    uint256 vBuy4 = 2500;
    IERC20 mansion = IERC20(0x1f8B1b4F91CA1C06512FA23bC3E0A37930E5811d);
...
//===============================================================================================================
    ...
    function setPreslaeContract(address _presale_Contract) external onlyOwner {
        presale_contract = _presale_Contract;       
    }
