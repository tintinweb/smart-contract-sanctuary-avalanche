...
contract ipSHARE is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Interest-Paired Shares", "ipSHARE") {
