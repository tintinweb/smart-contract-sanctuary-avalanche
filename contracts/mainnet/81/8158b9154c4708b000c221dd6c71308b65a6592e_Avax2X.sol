...
/*   AVAX2x - Yield Farming Smart Contract built on Avalanche c Chain.
 *   The only official platform of original AVAX2x team! All other platforms with the same contract code are FAKE!
 *
 *   [OFFICIAL LINKS]
 * 
 *   ┌────────────────────────────────────────────────────────────┐
 *   │   Website: https://avax2x.org                              │
 *   │                                                            |
 *   │   Twitter: https://twitter.com/avax2x                      │
 *   │   Telegram: https://t.me/avax2x                            │
 *   │                                                            │
 ...
 *
 *      - Deposit - Transfer AVAX you want to double to contract address, use msg.data to provide referrer address
 *      - Withdraw earnings - Transfer 0 AVAX to contract address
 *      - Reinvest earnings - Withdraw and Deposit manually
 *
 *   2) Using website UI
 *
 *      - Connect web3 wallet
 *      - Deposit - Enter AVAX amount you want to double, click "Double Your AVAX" button and confirm transaction
 *      - Reinvest earnings - Click "Compound Earnings" button and confirm transaction
 *      - Withdraw earnings - Click "Withdraw Earnings" button and confirm transaction
 *
 *   [DEPOSIT CONDITIONS]
 *
 *   - Minimal deposit: 0.5 AVAX, no max limit
 *   - Total income: 210% per deposit
...
contract Avax2X {
	uint256 constant INVEST_MIN_AMOUNT = 0.5 ether; // 0.5 AVAX
	uint256 constant REFERRAL_PERCENT = 11;
	uint256 constant PROJECT_FEE = 10;
	uint256 constant ROI = 210;
