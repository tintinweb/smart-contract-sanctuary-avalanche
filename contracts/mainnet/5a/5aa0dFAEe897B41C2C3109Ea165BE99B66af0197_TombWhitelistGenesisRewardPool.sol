...
// File: gladiator-finance-contracts/contracts/glad_core/TombWhitelistGenesisRewardPool.sol
...
contract TombWhitelistGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 8000 ether / uint256(1 days); // 8000 TOMB / (24h * 60min * 60s)
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        require(
            wl.isWhitelisted(_sender),
            "Deposit: only whitelisted addresses can participate"
        );
        PoolInfo storage pool = poolInfo[_pid];
