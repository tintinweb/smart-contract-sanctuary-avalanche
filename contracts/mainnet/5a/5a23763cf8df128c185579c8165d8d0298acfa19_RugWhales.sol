...
contract RugWhales is ERC721A, Ownable, ERC2981 {
    ...
    /*
    @function pickRandomRugWhale(seed)
    @description - Picks a random rug token for giveaways
    @param <uint> seed - seed to help with randomness
    */
    function pickRandomRugWhale( uint seed ) public onlyOwner returns(uint256) {
        uint256 winningToken = rand(msg.sender, seed);
        address winnerAddress = ERC721A.ownerOf(winningToken);
    ...
    */
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory metadata = string(abi.encodePacked(
                ...
                'Rugmie Whale #',
                toString(tokenId),
                '", "description": "This absolute legend bought into Rugmies early", "image": "ipfs://QmT8ZnSKSZi5cnAYLsF1mkNoRanTyihXbTjPqPB22vnZ8G/rugWhale.png',
