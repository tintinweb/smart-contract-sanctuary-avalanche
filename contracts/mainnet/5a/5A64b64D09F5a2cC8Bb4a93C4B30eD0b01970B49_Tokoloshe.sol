...
contract Tokoloshe is ERC721  {
    ...
    constructor()
        ERC721("Tokoloshe Genesis", "TLSHE")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeiacl3r4qji2lek4e7iexshmxafg74w3wzts2vpanbu2ralhpv64ri/", Strings.toString(tokenId), ".json")
            );
    }
