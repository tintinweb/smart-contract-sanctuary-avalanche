...
import "@thirdweb-dev/contracts/drop/DropERC1155.sol"; // For my collection of Elixirs!
...
contract Lumbermill is ReentrancyGuard, ERC1155Holder {
    ...
    // Mapping of player addresses to their current Elixirs!
    // By default, player has no Elixirs!. They will not be in the mapping.
    // Mapping of address to Elixirs is not set until they stake a one.
    // In this example, the tokenId of the Elixirs! is the multiplier for the reward.
    ...
    function stake(uint256 _tokenId) external nonReentrant {
        ...
        require(
            ...
            "You must have at least 1 of the Elixirs you are trying to stake"
        );

        // If they have a Elixirs already, send it back to them.
        ...
        // Transfer the Elixirs to the contract
        pickaxeNftCollection.safeTransferFrom(
            msg.sender,
            address(this),
            _tokenId,
            1,
            "Staking your Elixirs!"
        );
    ...
    function withdraw() external nonReentrant {
        // Ensure the player has a Elixirs.
        require(
            playerPickaxe[msg.sender].isData,
            "You do not have a Elixirs to withdraw!"
        );
