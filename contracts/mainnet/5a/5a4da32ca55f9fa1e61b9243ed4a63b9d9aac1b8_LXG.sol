...
contract LXG is ERC721URIStorage,Ownable{
  ...
  constructor() ERC721("Last X Gen", "LXG") {
    _customBaseURI = 'ipfs://bafybeibbawbkwauxplsb3k27eyfsmrbv3d6qrrnxykmdqndrl7sqjhjbim/';
    _price = 50 * 1000000000000000;  //price in wei 
    _maxMintable = 100; 
    _royaltyAmount = 1000;
    _maxPerWallet = 1000;
    _maxMintPerTx = 10; 
    ...
    address2 = 0x7A8Cf20EDD41d7d7f58DC61558c7Bc846D11D545;
    royaltyAddress = 0x6720cbE3724ecE86B111DdEB7911aacdDC1a251B;
    share1 = 40;
    share2 = 60;
  ...
  function setAddresses(address _address1, address _address2) public onlyOwner{
	  address1 = _address1;
	  address2 = _address2;
  }
  function setShares(uint256 _share1, uint256 _share2) public onlyOwner{
	  share1 = _share1;
	  share2 = _share2;
  }
  function mint(uint256 quantity) public payable {
    require(verifyUser(msg.sender), "not whitelisted, wait until public sale");
    require(quantity+balanceOf(msg.sender) <= _maxPerWallet, "are minting more than the max amount per wallet");
    ...
    require(msg.value >= (_price * quantity), "Not enough AVAX sent.");
  	payable(address1).transfer(msg.value * share1/100);
    payable(address2).transfer(msg.value * share2/100);
