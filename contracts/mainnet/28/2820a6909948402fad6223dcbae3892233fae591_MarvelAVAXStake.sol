...
contract MarvelAVAXStake {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [100, 80, 50, 20, 10]; // 10%, 8%, 5%, 2%, 1%
    ...
    constructor(address payable wallet) {
        ...
        m_wallet = msg.sender;
        d_wallet = 0x00BaeDAb111C0A74b8390a89379cB616Ffa70E4f;
        owner = address(0);

        uint8 tarifPercent = 168;
        for (uint8 tarifDuration = 14; tarifDuration <= 28; tarifDuration++) {
