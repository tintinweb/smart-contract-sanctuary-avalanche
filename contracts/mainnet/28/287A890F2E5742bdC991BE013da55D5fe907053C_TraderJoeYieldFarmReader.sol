...
contract TraderJoeYieldFarmReader {
  ...
  ITraderJoeYieldFarmManager public immutable manager;
  // WAVAX
  ...
  */
  constructor(
    ...
    ITraderJoeYieldFarmManager _manager
  ) {
  ...
  */
  function additionalCapacity() public view returns (uint256) {
    ITraderJoeYieldFarmVault.VaultConfig memory _vaultConfig = vault.vaultConfig();
