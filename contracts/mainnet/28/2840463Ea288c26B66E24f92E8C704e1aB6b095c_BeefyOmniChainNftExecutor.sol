...
// Executor contract for cross-chain execution of voting claims. 
contract BeefyOmniChainNftExecutor is NonblockingLzApp {
    using SafeERC20 for IERC20;
    
    // All the nftHandlers we need to execute on this chain.
    ...
    function _claimAndLock() private {
