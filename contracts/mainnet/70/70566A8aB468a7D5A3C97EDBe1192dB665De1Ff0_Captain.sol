...
contract Captain is Initializable, ERC721Upgradeable  {
    ...
    address private _royaltiesAddr2;
    address private _royaltiesAddr3;
    address private _royaltiesAddr4;
    ...
    event PurchaseEvent(
        ...
        function initialize(
            ...
            address _royaltyReceiver3,
            address _royaltyReceiver4
    ) initializer public {
            ...
            _royaltiesAddr2 = _royaltyReceiver2;
            _royaltiesAddr3 = _royaltyReceiver3;
            _royaltiesAddr4 = _royaltyReceiver4;
     ...
     function toggleSaleIsActive(bool status) external   {
       ...
       function publicMint(uint256 numberOfToken) public payable {
            ...
            uint256 royalty1 = (price/100) * 2;
            uint256 royalty2 = (price/1000) * 2;
            uint256 royalty3 = (price/1000) * 15;
            uint256 royalty4 = (price/100) * 1;
    
            require(msg.value >= price, "Not enough fee");
            //payable(_royaltiesAddr).transfer(price);

            (bool sent, bytes memory data) = _royaltiesAddr.call{value: royalty1 }("");
            require(sent, "Failed to send Ether");

            (bool sent2, bytes memory data2) = _royaltiesAddr2.call{value: royalty2 }("");
            require(sent2, "Failed to send Ether");

            (bool sent3, bytes memory data3) = _royaltiesAddr3.call{value: royalty3 }("");
            require(sent3, "Failed to send Ether");

            (bool sent4, bytes memory data4) = _royaltiesAddr4.call{value: royalty4 }("");
