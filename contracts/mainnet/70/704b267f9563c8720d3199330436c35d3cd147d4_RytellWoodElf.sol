...
// ipfs://QmWzSkc5zurgEXzt7iJXMcb3LgonRhRrGESX3QXKg7aJb9/
...
/// @title Rytell Wood Elf
contract RytellWoodElf is ERC721Metadata {
    ...
    uint256 private _giveawayMax = 5;

    uint256 private _totalSupply;
    uint256[101] private _pendingIDs;

    // Giveaway/airdrop winners
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell Wood Elf: All minted");
        require(counts_ > 0, "Rytell Wood Elf: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell Wood Elf: sale already ended"); 
        require(!paused, "Rytell Wood Elf: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell Wood Elf: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell Wood Elf: max supply reached");
    ...
    function pause(bool state_)
     ...
     function randomGiveaway(address[] memory winners_)
        ...
        require(
            ...
            "Rytell Wood Elf: overflow giveaways");
