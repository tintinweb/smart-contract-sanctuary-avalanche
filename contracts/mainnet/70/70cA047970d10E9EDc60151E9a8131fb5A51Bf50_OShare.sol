...
contract OShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 OSHARE
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 59500 ether; // 85%
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 4900 ether; // 7%
    uint256 public constant TEAM_FUND_POOL_ALLOCATION = 2800 ether; // 4%
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 2800 ether; // 4%
    ...
    ) public ERC20("Olympic Shares", "OSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 OLYMPIC Share for initial pools deployment
    ...
    /**
     * @dev Claim pending rewards to community, team and dev fund
     */
