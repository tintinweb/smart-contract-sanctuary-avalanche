...
/*===================================================
    Versa Estate Contract
=====================================================*/

contract VersaEstate is Context, Ownable {
    ...
    * @dev Rent module.
    */
    function rentModule(address _addr, uint256 _index, uint256 _count) external onlyOwner {
        require(_index < moduleTypes.length, "err: invalid module index");

        for (uint256 i = 0; i < _count; i++)
        {
            users[_addr].modules.push(
                UserModule({
                    moduleIndex: _index,
                    startTime: block.timestamp
                })
