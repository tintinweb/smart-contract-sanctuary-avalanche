...
contract CombatApes is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidbnwdz3xqu2eq5urmt34vueruby5uola43n3owzv6fbpd6d6m2du/", Strings.toString(tokenId), ".json")
            );
    }
