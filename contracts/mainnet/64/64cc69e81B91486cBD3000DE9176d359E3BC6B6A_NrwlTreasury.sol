...
*/
contract NrwlTreasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x079866997f3bD4466008b982b16dFC9286413928),    // NRWL-YUSD Genesis pool
        address(0x94A8ED3DD9d02af3F69A06482ec3E0A2BB530dD4),    // WLRS-USDC.e Genesis pool
        address(0xD9441dACeB8e94cE7ff67db2138481C92114449d),    // WSHARE-USDC.e Genesis pool
        address(0x0D7F14e9eE39e661E714677F37e831Aa7b11d2f8)     // WSHARE Genesis pool
    ];
    ...
    uint256 public mintingFactorForPayingDebt; // print extra NRWL during debt phase
    ...
    function getWlrsPrice() public view returns (uint256 wlrsPrice) {
        try IOracle(wlrsOracle).consult(wlrs, 1e18) returns (uint144 price) {
            ...
            revert("Treasury: failed to consult NRWL price from the oracle");
        }
    }
    ...
    function initialize(
        ...
        wlrsPriceOne = 10**18; // This is to allow a PEG of 1 NRWL per YUSD
        ...
        maxSupplyContractionPercent = 300; // Upto 3.0% supply for contraction (to burn NRWL and mint wBOND)
    ...
    function buyBonds(uint256 _wlrsAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        require(wlrsPrice == targetPrice, "Treasury: NRWL price moved");
        require(
    ...
    function getExpansionPercent() public view returns (uint256) {
        ...
        if (fixedExpansion != 0) {
            return fixedExpansion.mul(1e14);
        }
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochWlrsPrice > wlrsPriceCeiling) {
                // Expansion ($WLRS Price > 1 $YUSD): there is some seigniorage to be allocated
