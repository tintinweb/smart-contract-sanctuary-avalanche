...
//changeWallets-----------------------------------------------------------------------------------------------
    function updateFeeManager(address _account) external onlyOwner(){
    		feeMGR = feeManager(_account); 
    }
    function updateBoostManager(address _account) external onlyOwner(){
    		boostMGR = boostManager(_account); 
    }
    function updateTreasury(address payable _account) external onlyOwner(){
    		treasury = _account; 
    }
