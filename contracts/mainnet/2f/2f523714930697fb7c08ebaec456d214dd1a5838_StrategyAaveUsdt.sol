...
// File contracts/strategies/aave/strategy-aave-usdt.sol
...
contract StrategyAaveUsdt is StrategyBase, Exponential {
    address public constant avusdt = 0x6ab707Aca953eDAeFBc4fD23bA73294241490620;
    address public constant usdt = 0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7;
    address public constant variableDebtUsdt = 0xfb00AC187a8Eb5AFAE4eACE434F493Eb62672df7;
    ...
    uint256 public constant usdt_COLFACTOR = 75000000000000000000;
    ...
    */
    ...
    /**
     * @notice Deposits USDT tokens inside the lendingPool 
     */
    function deposit() public override {
        uint256 _usdt = IERC20(usdt).balanceOf(address(this));
        if (_usdt > 0) {
            IERC20(usdt).safeApprove(lendingPool, 0);
            IERC20(usdt).safeApprove(lendingPool, _usdt);
