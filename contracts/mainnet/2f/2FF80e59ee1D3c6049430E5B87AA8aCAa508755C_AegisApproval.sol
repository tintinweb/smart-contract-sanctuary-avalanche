...
contract AegisApproval is ERC721URIStorage {
    ...
    constructor() ERC721("Aegis Approval", "AEGIES") {}
    ...
    function mintNFT(
        ...
        require(msg.sender == 0x87D606a55a756c2b47c5d807c9EdBDBd11b38865);
        require(
        ...
        _collectableName[newCollectableId] = projectName;
        ...
        _collectableAssetName[newCollectableAssetId] = projectCountry;
        ...
        _transfer(msg.sender, toAddress, newItemId);
        setApprovalForAll(contractAddress, true); 
        emit MintNFT(newItemId, "Avalanche", projectCountry, "CreateToken");
        return newItemId;
    }
}