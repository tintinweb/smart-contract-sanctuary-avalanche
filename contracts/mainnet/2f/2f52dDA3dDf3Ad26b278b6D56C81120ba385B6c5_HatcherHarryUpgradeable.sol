...
*/
contract HatcherHarryUpgradeable is Initializable, IEvoStructsUpgradeable, PausableUpgradeable,
AccessControlEnumerableUpgradeable, ChainlinkVRFConsumerUpgradeableV2, NpcConstants {
    ...
    IEvoEggUpgradeable private _egg;
    ...
    function initialize() initializer public {
        ...
        _egg = IEvoEggUpgradeable(0x75dDd2b19E6f7BEd3Bfe9D2D21dd226C38C0CbC4);
    ...
    function hatch(address _address) public onlyRole(CONTRACT_ROLE) {
        _evo.batchMint(_address, _hatch(_address));
    ...
    function _hatch(address _address) internal view returns(Evo[] memory evo) {
        ...
        bool[] memory treated = _egg.checkTreated(pending.ids);
        ...
        for (uint256 i = 0; i < pending.ids.length; i++) {
            ...
            uint256[] memory randomChunks = chunkWord(pending.words[i], 10_000);
