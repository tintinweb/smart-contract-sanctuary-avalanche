...
contract Boneheads is ERC721 {
    ...
    constructor()
        ERC721("The Official bone heads", "BONEHEAD")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihfjasm5icswaflj3xtlvwelbd4bcrmxbkdthg2ei6t3dglpest2y/", Strings.toString(tokenId), ".json")
            );
    }
