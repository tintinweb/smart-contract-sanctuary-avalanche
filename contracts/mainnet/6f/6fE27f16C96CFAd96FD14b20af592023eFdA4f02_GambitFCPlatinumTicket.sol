...
contract GambitFCPlatinumTicket is ERC721 {
    ...
    constructor()
        ERC721("Gambit Founders Club Platinum Ticket", "GFCPT")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifcnepfftc55f4x4ouv7oeqikmaz4fyjzlipejtynobkawmqizcai/", Strings.toString(tokenId), ".json")
            );
    }
