...
//
// Aqua PROTOCOL COPYRIGHT (C) 2022 
...
contract Aquarius is ERC20Detailed, Ownable {
    ...
    string public _name = "Aquarius";
    string public _symbol = "Aqua";
    ...
    uint256 public AquaInsuranceFundFee = 100;
    uint256 public sellFee = 25;
    uint256 public blackholeFee = 25;
    uint256 public nftFee = 15;
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(AquaInsuranceFundFee).add(blackholeFee);
    ...
    address public AquaInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Aquarius", "Aqua", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xB735A4C0618Ec3C90b667aacB8Dbddf80507fEc6;
        treasuryReceiver = 0xB735A4C0618Ec3C90b667aacB8Dbddf80507fEc6; 
        AquaInsuranceFundReceiver = 0xB735A4C0618Ec3C90b667aacB8Dbddf80507fEc6;
        blackhole = 0xB735A4C0618Ec3C90b667aacB8Dbddf80507fEc6;
        nftFeeReceiver = 0xB735A4C0618Ec3C90b667aacB8Dbddf80507fEc6;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(AquaInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        IERC20(USDC).transfer(treasuryReceiver, amountUSDCToTreasuryAndAIF.mul(treasuryFee).div(treasuryFee.add(AquaInsuranceFundFee)));
        IERC20(USDC).transfer(AquaInsuranceFundReceiver, amountUSDCToTreasuryAndAIF.mul(AquaInsuranceFundFee).div(treasuryFee.add(AquaInsuranceFundFee)));
    }

    function withdrawAllToTreasury() external swapping onlyOwner {

        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Aqua token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = USDC;
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _AquaInsuranceFundReceiver,
        address _blackhole,
        address _nftFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        AquaInsuranceFundReceiver = _AquaInsuranceFundReceiver;
