/**
 *Submitted for verification at snowtrace.io on 2023-05-23
*/
...
contract psyopsreserve is IERC20 {
    using SafeMath for uint256;

    address private _owner;

    string public constant name = "psyops";
    string public constant symbol = "psyops";
    uint8 public constant decimals = 18;
    uint256 public WAITING_PERIOD_BLOCKS = 1;
    uint256 public MAX_TRANSACTION_LIMIT = 1e17; // 0.1% of total supply
    uint256 public constant MAX_TRANSFER_AMOUNT = 1e19; // 1% of total supply
    ...
    uint256 public MAX_TRANSFER_WITHOUT_PENALTY = 1e17; // 0.1% of total supply
    ...
    constructor(address payable penaltyFundAddress) {
        _mint(msg.sender, 7100000000 * (10 ** uint256(decimals)));
