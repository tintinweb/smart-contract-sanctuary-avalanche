...
contract KingDoNotBuy is IBEP20, Auth {
    using SafeMath for uint256;

    string constant _name = "KingDoNotBuy";
    string constant _symbol = "KingDoNotBuy";
    ...
    constructor () Auth(msg.sender) {
        ...
        King = msg.sender;  //tax collector wallet
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 amountAVAXTaxMan = amountAVAX.mul(KingFee).div(totalAVAXFee);
        ...
        (bool tmpSuccess2,) = payable(King).call{value: amountAVAXTaxMan, gas: 30000}("");
