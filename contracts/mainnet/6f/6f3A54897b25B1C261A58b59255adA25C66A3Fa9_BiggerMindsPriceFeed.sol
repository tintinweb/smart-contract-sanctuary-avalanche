...
interface IBiggerMindsAddressRegistry {
    function tokenRegistry() external view returns (address);
}

interface IBiggerMindsTokenRegistry {
...
contract BiggerMindsPriceFeed is Ownable {
    ...
    function registerOracle(address _token, address _oracle)
        ...
        onlyOwner
    {
        IBiggerMindsTokenRegistry tokenRegistry = IBiggerMindsTokenRegistry(
            IBiggerMindsAddressRegistry(addressRegistry).tokenRegistry()
        );
