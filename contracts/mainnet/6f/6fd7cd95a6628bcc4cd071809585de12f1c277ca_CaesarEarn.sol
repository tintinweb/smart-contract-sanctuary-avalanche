...
* Earn Caesar in rewards by Holding EarnCaesar Token
* High reward token - 10% from Buy/Sell tx goes to Earn Caesar holders.

* Telegram: https://t.me/EarnCaesar
...
* Initial liquidity - 100 / 50 AVAX Vote at telegram.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x42d047534eef46FD68fAD3d74726Fe51be4eeb8F); // Caesar reward
...
contract CaesarEarn is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ZSHARE = 0x42d047534eef46FD68fAD3d74726Fe51be4eeb8F; // Caesar Reward
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "CaesarEarn";
    string constant _symbol = "CaesarEarn";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1); // 4 %
    uint256 public _maxWallet = _totalSupply.div(1); // 4 %
    ...
    address public autoLiquidityReceiver=0xd95771B99db8b7cF8eFbc76A421F6F4f800aEE02; //Marketing Wallet
    address public marketingFeeReceiver=0xd95771B99db8b7cF8eFbc76A421F6F4f800aEE02; // Marketing wallet
