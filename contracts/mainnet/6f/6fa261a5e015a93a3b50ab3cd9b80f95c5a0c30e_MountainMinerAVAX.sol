...
contract MountainMinerAVAX is Ownable{
    ...
    uint256 public MIN_DEPOSIT_LIMIT = 0.033 ether;
    uint256 public MAX_WITHDRAW_LIMIT = 33.6 ether;
    uint256[5] public ROI_MAP = [1_668 ether, 3_339 ether, 16_500 ether, 33_000 ether, 165_000 ether];
