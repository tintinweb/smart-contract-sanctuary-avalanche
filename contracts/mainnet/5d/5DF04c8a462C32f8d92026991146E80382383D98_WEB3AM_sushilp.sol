...
contract WEB3AM_sushilp is Ownable, ReentrancyGuard {
    ...
    event liquidityadded(address indexed user, address indexed token1, address indexed address2, uint tokenAamount, uint tokenBamount);
    event liquidityremove(address indexed user, address indexed pairAddress, uint lptoken);
    event liquidityaddedETH(address indexed user, address indexed token, uint amountToken, uint amountETH);
    event liquidityremoveETH(address indexed user, address indexed pairAddress, uint lptoken);

     // @dev Add Liquidity Function ,if user has both the tokens 
    function addLiquidity (address _tokenA, address _tokenB, uint _amountA, uint _amountB,uint _amountAmin,uint _amountBmin,uint _timestamp) nonReentrant public {
    ...
    function addLiquidityETH(address _tokenA,uint _amountA,uint _amountAmin,uint _amountBmin,uint _timestamp) nonReentrant public payable {
        require(_amountA > 0, "Less TokenA Supply");
    ...
    function removingLiquidity(address _tokenA, address _tokenB,uint lpamount,uint tokenAmin,uint tokenBmin,uint timestamp) nonReentrant public {
        require(_tokenA != address(0), "DeAd address not allowed");
        require(_tokenB != address(0), "DeAd address not allowed");
    ...
    function removingLiquidityETH(address _tokenA,uint lpamount,uint tokenAmin,uint tokenBmin,uint timestamp) nonReentrant public payable {
        require(_tokenA != address(0), "DeAd address not allowed");
