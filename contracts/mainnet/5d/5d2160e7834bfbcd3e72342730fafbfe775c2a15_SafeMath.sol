...
// File: Shibread.sol
     ...
     // TG: https://t.me/ShibreadAvax
     // Inspired by Shibax and Avoge
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118);
...
contract Shibread is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // USDT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Shibread";
    string constant _symbol = "$SHIBREAD";
    ...
    address public autoLiquidityReceiver=0xDb28Ad348923072d6a9938577e191e128dBcD564;
    address public marketingFeeReceiver=0xDb28Ad348923072d6a9938577e191e128dBcD564;
    ...
    uint256 public swapThreshold = _totalSupply * 3 / 1000; // 0.3%
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBot[sender], "Address is a bot");
...
//        emit Transfer(sender, recipient, amount);
    ...
    function manualSend() external {
        ...
        payable(autoLiquidityReceiver).transfer(contractBalance);
    }
