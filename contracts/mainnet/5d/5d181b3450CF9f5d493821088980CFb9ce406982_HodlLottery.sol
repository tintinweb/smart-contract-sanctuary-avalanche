...
contract HodlLottery is Ownable, ReentrancyGuard {
    ...
    event SelectWinner (LOTTERY_TYPE lottery_type, uint256 lottery_id, uint256 time, address addr);
    ...
    function selectWinner(LOTTERY_TYPE _lotteryType, uint256 _lotteryID) external nonReentrantSelectWinner onlyOwner returns(uint16) {
        ...
        emit SelectWinner(_lotteryType, _lotteryID, lottoInfo.lotteryTimeStamp, lottoInfo.members[lottoInfo.winnerID]);
    ...
    function givePriceToWinner(LOTTERY_TYPE _lotteryType, uint256 _lotteryID) external nonReentrantGivePriceToWinner payable returns(bool) {
        ...
        emit GivePriceToWinner(_lotteryType, _lotteryID, msg.sender, block.timestamp, lottoInfo.winnerTicketID, lottoInfo.winnerPrize);
        return true;
    }
