...
// File: contracts/PirateBay_V1.sol
...
contract PirateBay_v3 is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("PirateBay_v3","CAPTAIN") Randomizer(maxSupply) {
    ...
    function mint(uint amount) public payable whenNotPaused {
        ...
        require(balanceOf(msg.sender) + 1 <= maxPerPerson, "Error: AARARHGR ! Max 3 per Wallet");
