...
// File: contracts/BlackDiamondSCIncWallet.sol
...
contract BlackDiamonSCIncWallet is Ownable {
    ...
    function swapDarkVirgo(uint256 amount) public {
        swappedDarkVirgo = swappedDarkVirgo.add(amount);
...
contract BlackDiamondSCIncGlobal {
    ...
    function Car ( 
        ...
        string memory __BlackDiamondSCIncWallet,
    ...
    function ImportBlackDiamondSCInc1Token ( 
        string memory __ImportBlackDiamondSCInc1Token,
        string memory __BlackDiamondSCIncWallet
    )
    public {
    }
    ...
    function Send ( 
        string memory __BlackDiamondSCWallet
    )
    public {
    }
    ...
    function ConversionRate ( 
        string memory __BDSCI1Wallet
    )
    public {
    }

    function GetBDSCI1Price ( 
        string memory __BDSCI1Bank,
        string memory __BlackDiamondSCIncWallet,
        string memory __ImportBlackDiamondSCInc1Token
    )
    ...
    function SwapWBTCToBDSCI1 ( 
        string memory __BDSCI1Bank
    )
    public {
    }

    function PaperWalletImport ( 
        string memory __BlackDiamondSCIncWallet
    )
    public {
    }

    function BDSCI1IsTheNativeToken ( 
        string memory __BlackDiamondSCIncWallet
    )
    public {
    }

    function TenPercentAutomaticToBDSCI1LiqudityPool ( 
        string memory __BDSCI1Bank,
        string memory __BlackDiamondSCIncWallet,
        string memory __ImportBlackDiamondSCInc1Token
    )
