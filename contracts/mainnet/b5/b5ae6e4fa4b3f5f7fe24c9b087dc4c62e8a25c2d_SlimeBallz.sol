...
contract SlimeBallz is ERC721URIStorage, Ownable, Pausable
{
  ...
  uint256 public maxMintable = (113);//no more than this many nfts can be minted (about the current supply of egg tokens
  ...
  constructor() ERC721("Jelly SlimeBallz", "SlimeBallz") {
    baseURI = "ipfs://QmU3qvbyRhArbP2ZVzVhX3F5hCpfpRWuVPvmQDjVN2zn7Q/";//add in ipfs location info for the json metadata test 
  }//End of constructor
