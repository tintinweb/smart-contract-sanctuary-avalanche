...
/**
*
* Earn DiamondBank Token by holding DiamondBankPrinter
*
* Telegram - https://t.me/DiamondBankPrinter
* 
* Tokenomics
*
* Total Supply - 1 000 000 000 000 000
* 
* 8% - DiamoindBank reward from every transaction
* 2% - Development
* 
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x4123C9A65D4B7B415E472b1eD64635472A344BA8);
...
contract DiamondBankPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x4123C9A65D4B7B415E472b1eD64635472A344BA8; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "DiamondBankPrinter";
    string constant _symbol = "DiamondBankPrinter";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(20); // 0.55%
    ...
    address public autoLiquidityReceiver=0x424705332096445cE4F19A6025220cc9aE6de9a8;
    address public marketingFeeReceiver=0x424705332096445cE4F19A6025220cc9aE6de9a8;
