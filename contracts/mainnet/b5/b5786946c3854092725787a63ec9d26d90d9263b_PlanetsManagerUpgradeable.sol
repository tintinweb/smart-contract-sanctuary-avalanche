...
LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    function migrateToV2(uint256 value) external nonReentrant whenNotPaused universeSet {
        ...
        require(value * 11 / 10 <= universe.balanceOf(address(this)), "Dealers: not enough $PABLO V2 to migrate");
        oldUniverse.transferFrom(msg.sender, address(this), value);
        universe.transferFrom(address(this), msg.sender, value * 11 / 10);
    }
}