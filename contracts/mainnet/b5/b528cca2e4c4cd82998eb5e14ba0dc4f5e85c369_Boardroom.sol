...
interface ITreasury {
    ...
    function getCirclePrice() external view returns (uint256);
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getCirclePrice() external view returns (uint256) {
        return treasury.getCirclePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            circle.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        circle.safeTransferFrom(msg.sender, address(this), amount);
