...
contract NativeToken is ERC20 {
    ...
    // This transfer tax token template is to be used only for yield farming purposes.
    ...
    // The operator can call all functions except of minting NativeToken
     ...
     */
    constructor(address _to, uint256 _initialSupply, uint256 _maxSupply) ERC20("Watchpoint", "WATCH") {
    ...
    // This function triggers the burn function of the ERC20 implementation to take out tokens from circulation.
    ...
    /// @dev overrides transfer function to meet tokenomics of native
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        transferTaxRate == 0 ) {
            ...
            require(amount == sendAmount + taxAmount, "Native::transfer: Tax value invalid");
    ...
    function updateTransferTaxRate(uint16 _transferTaxRate) external onlyOperator {
        require(_transferTaxRate <= maxTaxRate, "Native::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate.");
    ...
    function transferOperator(address newOperator) external onlyOperator {
        require(newOperator != address(0), "Native::transferOperator: new operator is the zero address");
