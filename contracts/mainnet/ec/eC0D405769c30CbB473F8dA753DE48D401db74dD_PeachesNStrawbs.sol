...
contract PeachesNStrawbs is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Peaches N Strawbs", "PNS") KindaRandom(51) {
    _customBaseURI = "https://nfts.bpi.network/peaches_and_strawberries/";
    _maxMintable = 51; // 51 max supply
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 3;
    _price = 5 ether;
    _startTime = 1666047600;
    
    _artist = 0x728B158Cefede30973123c8034BbdBF29D2e23Df;

    _earlyAccessDuration = 1800; // 30 minutes

    _privateMint(_artist);
    _transferOwnership(0xcf50b23A09Fb51E0262A609a0FeE723639F705a2);
  }
  ...
  function hasEarlyAccess(address account) public view returns (bool) {
    ERC721 pact = ERC721(0x0CFC4549D649737e4e251e2a05ca415FB06bD6B9);
    uint256 balance = pact.balanceOf(account);
    return balance > 0;
  }
