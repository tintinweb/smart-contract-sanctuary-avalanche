...
/// @title RainiMintpeg Contract
/// @author Raini, modified from Mintpeg Contract by Trader Joe
/// @notice ERC721 contracts for artists to mint NFTs
contract RainiMintpeg is
    ...
    AccessControl
{
    ...
    /// @notice RainiMintpeg initialization
    /// @param _collectionName ERC721 name
    /// @param _collectionSymbol ERC721 symbol
    /// @param _royaltyReceiver Royalty fee collector
    /// @param _feePercent Royalty fee numerator; denominator is 10,000. So 500 represents 5%
    ...
    function supportsInterface(bytes4 _interfaceId)
        ...
        view
        virtual
        override(ERC721Upgradeable, ERC2981Upgradeable, AccessControl)
        returns (bool)
    {
        return
