...
contract NodePool is ContractGuard, Initializable {
    ...
    uint256 public constant shareTokenPerSecond = 0.00134766 ether; // 42500 tokens / (365 days * 24h * 60min * 60s)
    uint256 public constant runningTime = 365 days; // 365 days
    uint256 public constant TOTAL_USER_REWARDS = 42500 ether;

    uint256 public  constant maxPercentToStake = 21; //21%

    uint256 public constant DAO_FUND_REWARDS = 3750 ether;
    uint256 public constant shareTokenPerSecondForDaoFund = 0.00011891 ether;
    uint256 public lastDaoFundRewardTime;
    uint256 public constant DEV_FUND_REWARDS = 3750 ether;
    uint256 public constant shareTokenPerSecondForDevFund = 0.00011891 ether;
    ...
    function __Upgradeable_Init(
        ...
        if (_shareToken != address(0)) shareToken = IERC20Upgradeable(_shareToken);
    ...
    function add(
        ...
        checkPoolDuplicate(_token, _lockTime);
        if (_withUpdate) {
            massUpdatePools();
        }
