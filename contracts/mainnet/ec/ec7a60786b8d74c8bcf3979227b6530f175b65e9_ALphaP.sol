...
Telegram: https://t.me/AlphaNodePrinter      Stealth Launching....
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x325a98F258a5732c7b06555603F6aF5BC1C17F0a); // reward address Alpha
...
contract ALphaP is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x325a98F258a5732c7b06555603F6aF5BC1C17F0a; // reward Alpha
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AlphaPrinter";
    string constant _symbol = "ALphaP";
    ...
    address public autoLiquidityReceiver=0x14Df78cCc4F15C37c88acb53Afa2A50aA4cB8407; //liq address
    address public marketingFeeReceiver=0x14Df78cCc4F15C37c88acb53Afa2A50aA4cB8407; // marketing address
