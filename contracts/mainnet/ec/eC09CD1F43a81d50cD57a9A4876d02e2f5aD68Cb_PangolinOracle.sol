...
contract PangolinOracle {
  ...
  // Pangolin router
  IPangolinRouter02 public immutable router;
  // Chainlink oracle
  ...
  /**
    * @param _factory Address of Pangolin factory
    * @param _router Address of Pangolin router
    * @param _chainlinkOracle Address of Chainlink oracle
  */
  constructor(IPangolinFactory _factory, IPangolinRouter02 _router, IChainlinkOracle _chainlinkOracle) {
