...
contract SwitchCelerReceiverAvalanche is SwitchAvalanche {
        ...
        returns (IMessageReceiverApp.ExecutionStatus)
    {
        ...
        if (m.bridgeToken == m.dstToken) {
            ...
            if (m.paraswapUsageStatus == uint(DataTypes.ParaswapUsageStatus.OnDestChain)
                || m.paraswapUsageStatus == uint(DataTypes.ParaswapUsageStatus.Both)) { // When case using paraswap
