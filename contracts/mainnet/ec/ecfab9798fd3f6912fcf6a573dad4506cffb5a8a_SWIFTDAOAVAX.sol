...
/** 
 The war between Russia and Ukraine is spreading. The SWIFT system has prevented some countries from being able to transact money for political reasons. This is a great opportunity for cryptocurrencies to gradually replace cash. We created SWIFTDAO $SWIFT also for the above purpose. Anonymous and completely transparent money circulation make the world fairer. Let's create a boom for $SWIFT today guys

✈️Tokenomic:
🧚‍♀️ 1,000,000,000,000 $SWIFT
🧚‍♀️ 98% add liquidity 
🧚‍♀️ 2% Marketing

🏆 Tax: 12% total for buy/ sell
🔐 4% locked in LP
⚙️ 4% manually bought back 
🚀 4% used for market making


🚀 Liq Locked   - 100% Community Driven
...
📬 Telegram : https://t.me/SWIFTDAOAVAX

🌍 Twitter : https://twitter.com/SwiftDaoAvax
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xCE1bFFBD5374Dac86a2893119683F4911a2F7814);
...
contract SWIFTDAOAVAX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xCE1bFFBD5374Dac86a2893119683F4911a2F7814; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SWIFT DAO AVAX";
    string constant _symbol = "SWIFT";
    ...
    address public autoLiquidityReceiver=0x7CBc9f2C4911AAdbD50Db500557c47B39d5c2D70;
    address public marketingFeeReceiver=0x7CBc9f2C4911AAdbD50Db500557c47B39d5c2D70;
