...
contract V2TraderJoe {
    ...
    function _swapNativeExactOutput(
        ...
        uint256[] memory amounts = swapRouter.swapAVAXForExactTokens{value: msg.value}(
            amountOut,
            path,
            address(this),
            block.timestamp
        ...
        if (amountIn < msg.value) {
            ...
            require(sent_, "V2Swap: can't refund avax");
        }
    }
    ...
    function _swapExactNativeInput(
        ...
        uint256[] memory amounts = swapRouter.swapExactAVAXForTokens{value: msg.value}(
            amountOutMinimum,
            path,
            address(this),
            block.timestamp
