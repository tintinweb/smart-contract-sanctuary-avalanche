...
contract L1NFTBridge is iL1NFTBridge, CrossDomainEnabled, ERC721Holder, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function emergencyWithdraw(address _NFTAddress, address _targetAddress, uint256 _tokenId)
        public
        onlyOwner()
        onlyInitialized()
    {
        IERC721(_NFTAddress).safeTransferFrom(address(this), _targetAddress, _tokenId);
    }
