...
contract PlayFRPRandomNumbers is Ownable
{
    ...
    event RandomNumberResults(
        uint256 indexed requestId, 
        uint256 FairWheelResult,
        uint256 FairRouletteResult,
        uint256 FairCardBankerResult,
        uint256 FairCardPlayerResult
    );
    ...
    function fulfillRandomWords(
        ...
        emit RandomNumberResults(requestId, randomWords[0],randomWords[1],randomWords[2],randomWords[3]);
    }
    //
    ...
    //Admin
    function GetRandomNumbers() public onlyOwner returns (uint256 requestId)
    {
