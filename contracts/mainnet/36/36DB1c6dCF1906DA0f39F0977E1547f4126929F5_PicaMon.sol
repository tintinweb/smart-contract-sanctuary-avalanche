...
/*
 ______   _                _______               
(_____ \ (_)              (_______)              
 _____) ) _   ____  _____  _  _  _   ___   ____  
|  ____/ | | / ___)(____ || ||_|| | / _ \ |  _ \ 
| |      | |( (___ / ___ || |   | || |_| || | | |
...
contract PicaMon is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;

    uint256 public _price = 1.5 ether;
    uint256 public _price_Public = 1.5 ether;
    uint256 public _maxMintable = 55;
    ...
    ///////// WL /////////
    uint256 public _price_WL = 1.5 ether;
    ...
    constructor(
        ...
        address _walletFundsA_80,
        address _walletFundsB_20,
        address royaltyAddr
    ) ERC721("PicaMon", "PM") {
        walletFundsA = _walletFundsA_80;
        walletFundsB = _walletFundsB_20;
    ...
    function splitFunds(uint256 mintValue) private {
        uint256 amountA = (mintValue * 80) / 100; 
        uint256 amountB = (mintValue * 20) / 100;
        payable(walletFundsA).transfer(amountA);
        payable(walletFundsB).transfer(amountB);
    }

    function setNFTsTransferWallets(address _walletFundsA, address _walletFundsB)
        external
        onlyOwner
    {
