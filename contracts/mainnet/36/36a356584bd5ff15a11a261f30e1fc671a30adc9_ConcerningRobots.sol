...
// File: contracts/ConcerningRobots.sol
...
contract ConcerningRobots is ERC721URIStorage, Ownable, Randomize {
  ...
  constructor() ERC721("Concerning Robots", "CRB") Randomize(13) {
    _customBaseURI = "ipfs://bafybeihx5x4dwpwoufnq4zt7jx3h5oy6pmr4wejd5ipgqm7wclxvp6egmy/";
    _maxMintable = 13; // max supply
    _royaltyAmount = 750; // 7.5% royalties
    _mintActive = true;
    _maxMintPerTx = 10;
    _price = 0.15 ether;
    _artist = 0xCB636b0C0C21778E1d910Ee28F9DcBC4B412884D;
    _startTime = 1661864840;
