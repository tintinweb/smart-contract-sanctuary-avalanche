...
contract GasThrottler {
    ...
    address public gasprice = address(0x28D43539776d1698c85b68193e1FB5Bae7bF41E2);
...
contract FroyoStrategyLP is StratManager, FeeManager {
    ...
    function _harvest(address callFeeRecipient) internal whenNotPaused {
        ...
        uint256 toBurn = nativeBal.mul(burnRate).div(1000); //use fee and set aside enough according to burn rate
...
contract StrategyCommonChefLP is FroyoStrategyLP, GasThrottler {
