// 2b9239fdff1c6d397063a793aac4fbcc2c194575
...
contract TraderJoeACL is DEXBase {
    
    string public constant override NAME = "TraderJoeACL";
    uint256 public constant override VERSION = 1;

    function _commonCheck(address to, address[] memory tokenPath) internal view {
        checkRecipient(to);
        swapInOutTokenCheck(tokenPath[0], tokenPath[tokenPath.length - 1]);
    }

    // https://snowtrace.io/address/0xe3ffc583dc176575eea7fd9df2a7c65f7e23f4c3#code 
    // ILBRouter.sol
