...
contract HunnySwapHandler is UniswapV2Router02Handler {
    constructor(IUniswapV2Router02 _hunnyswapRouter, address _weth)
        UniswapV2Router02Handler(_hunnyswapRouter, _weth)
...
import {IWETH} from "../interfaces/standard/IWETH.sol";
import {
    _swapExactXForX,
    _swapTokensForExactETH
} from "../uniswap/FUniswapV2.sol";
...
import {GelatoString} from "../libraries/standard/GelatoString.sol";
import {
    IUniswapV2Router02
} from "../interfaces/IUniswapV2Router02.sol";
import {ETH} from "../constants/Tokens.sol";
