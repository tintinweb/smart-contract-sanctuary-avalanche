...
// File contracts/interfaces/IGlacierRouter.sol
...
// File contracts/interfaces/IGlacierGauge.sol
...
// File contracts/UsdteWavaxGlacier.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract UsdteWavaxGlacier  is Ownable, Pausable {
    ...
    address public constant usdte = address(0xc7198437980c041c805A1EDcbA50c1Ce5db95118);
    address public want;
    ...
    IGlacierRouter.Routes[] public glcrToUsdtePath;
    ...
    constructor(
        ...
        IGlacierRouter.Routes[] memory _glcrToUsdtePath,
        ...
        for (uint i; i < _glcrToUsdtePath.length; ++i) {
            glcrToUsdtePath.push(_glcrToUsdtePath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        IGlacierRouter(router).swapExactTokensForTokens(glcrHalf, 0, glcrToUsdtePath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(wavax).balanceOf(address(this));
        uint256 t2Bal = IERC20(usdte).balanceOf(address(this));

        IGlacierRouter(router).addLiquidity(wavax, usdte, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
    ...
    function _subAllowance() internal {
        ...
        IERC20(usdte).safeApprove(router, 0);
    }
    ...
    function _addAllowance() internal {
        ...
        IERC20(usdte).safeApprove(router, type(uint).max);
    }
