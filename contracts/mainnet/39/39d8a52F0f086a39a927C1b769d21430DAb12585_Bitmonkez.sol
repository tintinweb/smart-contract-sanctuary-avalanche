...
contract Bitmonkez is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicpyeigtvezwwu6664hshm3xj3brl6is6t2v2mpkyql5pjpnjeg7a/", Strings.toString(tokenId), ".json")
            );
    }
