...
contract WShareRewardPool {
    ...
    uint256 public wSharePerSecond = 0.00158548 ether; // 50000 wShare / (365 days * 24h * 60min * 60s)
    ...
    constructor(
        ...
        if (_daoFund != address(0)) daoFund = daoFund;
    ...
    function governanceRecoverUnsupported(IERC20 _token, uint256 amount, address to) external onlyOperator {
        if (block.timestamp < poolEndTime + 90 days) {
            // do not allow to drain core token (wSHARE or lps) if less than 90 days after pool ends
