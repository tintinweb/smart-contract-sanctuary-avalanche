...
contract VShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 vSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 64500 ether;
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 5499 ether;
    ...
    constructor(uint256 _startTime, address _communityFund) public ERC20("VILLAINSHARE", "VSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 VILLAIN Share for initial pools deployment
