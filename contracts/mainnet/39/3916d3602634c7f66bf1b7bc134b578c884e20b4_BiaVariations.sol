...
contract BiaVariations is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 50; //  100 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 1;
    uint256 public constant ROYALTY_VALUE = 500; // 100 = 1%, 200 = 2% etc...  5%
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant MAX_PUBLIC_CLAIM = 1;
    uint256 public constant NFT_PRICE = 2 ether; // 2 avax for this launchpad
    uint public startAt;   
