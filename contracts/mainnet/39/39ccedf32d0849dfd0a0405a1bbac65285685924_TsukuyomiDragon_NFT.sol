...
// File: contracts/ERC_721_Mint_Avx.sol
...
contract TsukuyomiDragon_NFT is ERC721, Ownable, Pausable
{
    ...
    //Mint value
    uint256 public sWhitelistMintValue = 0.56 ether;    // 1 USD = 0.056 AVAX, 10 x 0.056 = 0.56 x ether = 560000000000000000 (wei) - 1 ether = 1000000000000000000 (or 10^18) wei
    uint256 public sLimitedMintValue = 1.12 ether;     // 1120000000000000000 (wei) - 1 ether == 1000000000000000000 (or 10^18) wei

    string public sBaseURI = "https://bafybeige7sirg7yzrmutotlgrn6shad2t3guwzrup2dgmlpxytztswkwae.ipfs.nftstorage.link/";
