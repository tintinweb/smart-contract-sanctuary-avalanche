...
contract FoxGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.23148148148 ether; // 25000 TOMB / (72h * 60min * 60s)
    uint256 public runningTime = 1 days; // 1 days
    uint256 public constant TOTAL_REWARDS = 20000 ether;
    // END MAINNET

    address public treasury = 0x7776f755900afd52Db79CA32201BB368126b9DDf;
