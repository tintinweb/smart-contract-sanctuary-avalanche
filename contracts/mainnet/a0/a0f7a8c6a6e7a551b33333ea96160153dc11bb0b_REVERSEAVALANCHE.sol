...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x9F7FAaa8e2E54bD951CBB9C397a462AF31c275C3;
...
contract REVERSEAVALANCHE is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x9F7FAaa8e2E54bD951CBB9C397a462AF31c275C3;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**8; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "REVERSE AVALANCE";
    string private _symbol = "RAVAX";
