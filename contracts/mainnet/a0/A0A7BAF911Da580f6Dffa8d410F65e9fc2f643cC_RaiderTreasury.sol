...
/**
 * @dev Treasury holds the balance of fees accuulated by the system.
 * Only accesible by the contract owner.
 */
contract RaiderTreasury is Ownable {
  ...
  function withdrawWNATIVE(address payable _to, uint256 _amount)
    external
    onlyOwner
  {
