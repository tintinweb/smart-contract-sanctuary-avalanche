...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(address => string) public balancesDetailed;
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            _balances[to] += 1;
            balancesDetailed[to] = string.concat(balancesDetailed[to],"+",Strings.toString(tokenId));
        }
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            _balances[owner] -= 1;
            balancesDetailed[owner] = string.concat(balancesDetailed[owner],"-",Strings.toString(tokenId));
        }
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        ...
        unchecked {
            ...
            _balances[from] -= 1;
            _balances[to] += 1;
            balancesDetailed[from] = string.concat(balancesDetailed[from],"-",Strings.toString(tokenId));
            balancesDetailed[to] = string.concat(balancesDetailed[to],"+",Strings.toString(tokenId));
        }
        _owners[tokenId] = to;
...
contract LayerZeroMultichainPowerXL is UniversalONFT721 {
    ...
    constructor(
        ...
        uint _startMintId, 
        uint _endMintId
        ) UniversalONFT721("LayerZero Multichain Power XL", "LZPOWERXL", 
        _minGasToStore, 
        _layerZeroEndpoint, 
        _startMintId, 
        _endMintId) {
