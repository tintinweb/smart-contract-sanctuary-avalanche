...
contract UnderpegNFTPoolNGv6 is Controllable, IERC721Receiver, MyPausable {
    ...
    UnderpegNFTPoolNGv6 public oldPool;
    ...
    constructor(
        ...
        oldPool = UnderpegNFTPoolNGv6(_oldpool);
    ...
    function _claimPreyFromBarn(uint256 tokenId) internal {
        ...
        address vault = IERC721Metadata(preyPredator).ownerOf(tokenId);
        require(vault == address(this) || vault == address(oldPool), "NFT not in pool");
        IERC721Metadata(preyPredator).safeTransferFrom(
            vault,
            owner,
            tokenId,
