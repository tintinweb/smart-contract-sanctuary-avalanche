...
contract NFTPoolNGv2 is Controllable, IERC721Receiver, MyPausable {
    ...
    function sendBackToken(uint256 tokenId, address to) internal {
        if (address(oldPool) == preyPredator.ownerOf(tokenId)) {
