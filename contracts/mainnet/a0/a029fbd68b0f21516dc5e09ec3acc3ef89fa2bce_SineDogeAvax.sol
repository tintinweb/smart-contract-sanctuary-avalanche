...
/**
 *#SineDogeAvax - #LIQ+#RFI+#SAFEMOON, combine together to #SineDogeAvax. 
   ...
   I make this #SineDogeAvax to hand over to the community.
   ...
   I will renounce the ownership to burn addresses to transfer #SineDogeAvax to the community, make sure it's 100% safe.

   I will add 30 AVAX and all the left 49% total supply to the pool
   Can you make #SineDogeAvax 1000X? 
...
contract SineDogeAvax is Context, IBEP20, Ownable {
