...
// File contracts/distribution/GraveGenesisRewardPool.sol
...
contract GraveGenesisRewardPool {
    ...
    // TESTNET
    // uint256 public gravePerSecond = 3.0555555 ether; // 11000 GRAVE / (1h * 60min * 60s)
    // uint256 public runningTime = 24 hours; // 1 hours
    // uint256 public constant TOTAL_REWARDS = 11000 ether;
    // END TESTNET

    // MAINNET
    uint256 public gravePerSecond = 0.11574 ether; // 10000 GRAVE / (24h * 60min * 60s)
