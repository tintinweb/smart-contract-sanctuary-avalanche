...
// File: contracts/avalance/gmd.sol
...
contract GMD is ERC20("aGMD", "GMD"), Ownable , ReentrancyGuard{ 
    ...
    uint256 public mintPrice = 10000;
    uint256 public mintCap = 70000e18;
    uint256 public maxRasie = 300000e6;
    ...
    function setMintPrice(uint256 _amount) internal {
        mintPrice = mintPrice.add(_amount.mul(40000 - mintPrice).div(maxRasie));
    }
