...
// File contracts/interfaces/ecd.sol
...
// File contracts/strategies/bases/strategy-ecd-stable-farm-base.sol
...
abstract contract StrategyStableFarmBase is StrategyJoeBase {
    ...
    // **** Setters ****
    /// @notice deposits ecdPTP to ecdPTP and stakes for ecd
    function deposit() public override {
        ...
        if(_stablewant > 0){
            ...
            IERC20(want).approve(booster, _stablewant);
            IBooster(booster).deposit(poolId, _stablewant);
        }      
    }

    /// @notice withdraws stablecoin into the lp
...
// File contracts/strategies/echidna/strategy-ecd-usdte.sol
