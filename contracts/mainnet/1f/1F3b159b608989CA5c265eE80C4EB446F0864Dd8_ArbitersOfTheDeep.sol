...
contract ArbitersOfTheDeep is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    // CONSTANTS
    uint public constant MAX_SUPPLY = 556;
    uint public constant START_ID = 556;
    ...
    uint public maxPerPerson = 556;
    uint public price = 450000000000000000;
    address public royaltyAddress = 0x6BE36207A798aD72f32238a220a79B0b9F033888;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Arbiters Of The Deep", "AOTD") ClampedRandomizer(maxSupply) {
