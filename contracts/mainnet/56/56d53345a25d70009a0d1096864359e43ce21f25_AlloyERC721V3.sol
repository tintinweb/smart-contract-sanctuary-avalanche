...
contract AlloyERC721V3 is AlloyERC721V2
{
    ...
    function sellAlloyConstruct(
        ...
        require(!isConstructSold[_order.Id] && !isConstructMintable[_order.Id], "AlloyERC721: Already sold");
     ...
     *
     * Requirements:
     * - msg.sender must have contract owner.
     */
    function burnTokens(
...
interface IERC20Upgradeable {
    ...
    function isUnProcessedPartSold(uint256 _tokenId) external view returns(bool);
}
