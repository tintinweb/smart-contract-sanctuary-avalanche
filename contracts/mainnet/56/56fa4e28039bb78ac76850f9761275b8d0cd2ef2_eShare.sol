...
contract eShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 70,000 eSHAREs
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4995 ether;
    ...
    constructor(uint256 _startTime, address _devFund, address _communityFund) public ERC20("eDollar Shares", "eSHARE") {
        _mint(msg.sender, 5 ether); // mint 1 Snowtomb Lot for initial pools deployment
