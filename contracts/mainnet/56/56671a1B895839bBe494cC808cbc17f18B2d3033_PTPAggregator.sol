...
/**
PTP-Ag is the first veAAS protocol on the Avalanche chain. Marketing/Reflection tax will be used
to purchase PTP and acquire a liquidity pool to farm.
Join us on :
Telegram: https://t.me/PlatypusAggregator
Twitter: https://twitter.com/PlatypusAggreg
Discord: https://discord.gg/KV9KFPpA2y
*/
...
contract PTPAggregator is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // Avax rewards
    ...
    string constant _name = "Platypus Aggregator";
    string constant _symbol = "PTP-Agg";
