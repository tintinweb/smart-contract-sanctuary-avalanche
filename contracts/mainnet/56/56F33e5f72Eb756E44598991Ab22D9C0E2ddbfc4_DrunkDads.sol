...
contract DrunkDads is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Drunk Dads", "DRUNK") KindaRandom(50) {
    _customBaseURI = "https://nfts.bpi.network/drunk_dads/";
    _maxMintable = 50; // 50 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 2;
    _price = 2.5 ether;
    _startTime = 1664647200;
    
    _artist =  0x1bB94832c6B6B54931E043b266b193918E3599D8;
