...
contract TempStrategyStargate is ReentrancyGuard, Ownable {
    ...
    address public inputTokenAddress = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E;
    ...
    address[] public baseTokenToInputTokenPath = [0x2F6F07CDcf3588944Bf4C42aC74ff24bF56e7590, 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7, 0xd586E7F844cEa2F87f50152665BCbc2C279D8d70, 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E];
    ...
    address stargateLpTokenAddress = 0x1205f31718499dBf1fCa446663B532Ef87481fe1; // USDC
    ...
    uint256 liquidityPoolId = 1;
    uint256 stakingPoolId = 0;
    uint256 baseTokenSellingPrice = 375;
    ...
    function triggerStop() public nonReentrant {
        ...
        lzTxParams.dstGasForCall = 0;
        lzTxParams.dstNativeAmount = 0;
        lzTxParams.dstNativeAddr =  abi.encodePacked(address(this));
        // IStargateRouter(stargateRouterAddress).redeemLocal{ value: gasForTriggerStop }(12, liquidityPoolId, liquidityPoolId, payable(address(this)), stakedLpBalance, abi.encodePacked(address(this)), lzTxParams);
