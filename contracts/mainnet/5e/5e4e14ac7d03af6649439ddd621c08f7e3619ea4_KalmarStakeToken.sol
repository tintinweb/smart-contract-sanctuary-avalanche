...
// File: contracts/KalmarStakeToken.sol
...
contract KalmarStakeToken is ERC20("vKalmar Token", "vKALM"), Ownable {
    ...
    function burn(address owner, uint amount) onlyAdmin external {
        _burn(owner, amount);
    }
