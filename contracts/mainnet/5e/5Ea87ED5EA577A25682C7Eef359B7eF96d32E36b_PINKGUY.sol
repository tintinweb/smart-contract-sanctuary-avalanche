...
// File contracts/Vegeta.sol
pragma solidity ^0.8.0;

contract PINKGUY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pink Guy";
    string private constant _symbol = "PINKGUY";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            charity: 6, // charity team fee in %
            treasury: 1, // treasury fee in %
            lp: 5, // lp rate in %
            toSwap: 12 // treasury + charity + lp
        });
    ...
    constructor() {
        ...
        treasuryAddress = payable(0x15A418Cb34aAa6311F633Ff9771E82b399622398);
        charityAddress = payable(0x15A418Cb34aAa6311F633Ff9771E82b399622398);
