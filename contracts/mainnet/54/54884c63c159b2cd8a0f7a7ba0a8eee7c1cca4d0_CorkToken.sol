...
contract CorkToken is ICorkToken, ERC20, Ownable {
     ...
     */
    constructor(uint256 initialSupply) ERC20("Corkscrew", "Cork") {
    ...
    function transferTax(address from, address to, uint256 amount) external override {
        require (msg.sender == swapAddress, "You are not allowed to!");
