...
contract PixelWizardGuild is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeigfrtadhvy56lhllq5e6tqdmiackfwdufa7hsce2v7k5b7tmmm7ci/", Strings.toString(tokenId), ".json")
            );
    }
