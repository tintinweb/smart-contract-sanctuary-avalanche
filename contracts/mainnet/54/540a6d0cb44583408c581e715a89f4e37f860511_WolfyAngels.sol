...
// File: contracts/JoePunks/WolfyAngels.sol
...
// ipfs://QmNwBBDmH2EvNcXn5e5w55W4dKetVNZCWRHfWrp6Hsnapg/
...
/// @title Wolfy Angels
contract WolfyAngels is ERC721Metadata {
    ...
    uint256 private _giveawayMax = 2; 
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Wolfy Angels: All minted");
        require(counts_ > 0, "Wolfy Angels: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Wolfy Angels: sale already ended"); 
        require(!paused, "Wolfy Angels: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Wolfy Angels: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Wolfy Angels: max supply reached");
    ...
    function pause(bool state_)
     ...
     function randomGiveaway(address[] memory winners_)
        ...
        require(
            ...
            "Wolfy Angels: overflow giveaways");
