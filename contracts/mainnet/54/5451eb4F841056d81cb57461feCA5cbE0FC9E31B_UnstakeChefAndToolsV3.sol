...
import "./Chef.sol";
import "./Upgrade.sol";
import "./PizzeriaV3.sol";
import "./Pizza.sol";

contract UnstakeChefAndToolsV3 is Ownable {

    Chef public chef;
    Upgrade public upgrade;
    PizzeriaV3 public pizzeria;
    Pizza public pizza;

    address public pizzeriaAddress;

    uint256 public additionalPizza = 1000*1e18;
    ...
    constructor(Chef _chef, Upgrade _upgrade, Pizza _pizza, address _pizzeriaAddress) {
        ...
        pizzeria = PizzeriaV3(_pizzeriaAddress);
    }
