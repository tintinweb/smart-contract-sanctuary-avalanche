...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB);
    IDEXRouter router;
...
contract Avazon is IBEP20, Auth {
    using SafeMath for uint256;

    address RWRD = 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Avazon";
    string constant _symbol = "AVAZON";
    ...
    uint256 totalFee = liquidityFee + rewardsFee + marketingFee + developmentFee;
    
    address private marketingFeeReceiver = msg.sender;
    address private developmentFeeReceiver = 0x09675a955eeE8ED396b81944453BC798cfcEC78B;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee-3).div(totalBNBFee);
        uint256 amountBNBDevelopment = amountBNB - amountBNBLiquidity - amountBNBRewards - amountBNBMarketing;
        ...
        require(success, "receiver reject transfer");
        (bool success2, /* bytes memory data */) = payable(developmentFeeReceiver).call{value: amountBNBDevelopment, gas: 30000}("");
        require(success2, "receiver reject transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardsFee, uint256 _marketingFee, uint256 _developmentFee) external authorized {
        liquidityFee = _liquidityFee;
        rewardsFee = _rewardsFee;
        marketingFee = _marketingFee;
        developmentFee = _developmentFee;
        totalFee = _liquidityFee.add(_rewardsFee).add(_marketingFee).add(_developmentFee);
    }
