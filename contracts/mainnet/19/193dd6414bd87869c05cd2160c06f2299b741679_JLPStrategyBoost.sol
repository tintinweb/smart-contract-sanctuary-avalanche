...
contract JLPStrategyBoost is BaseStrategyV2 {
    ...
    function addPool(
        ...
        require(poolInfo.pid == 0, "JLPStrategyBoost: already added");
    ...
    function withdrawAll(address _strategyToken) external onlyExecutor {
        _exit(_strategyToken);
        IERC20(_strategyToken).safeTransfer(bentoBox, IERC20(_strategyToken).balanceOf(address(this)));
    }
