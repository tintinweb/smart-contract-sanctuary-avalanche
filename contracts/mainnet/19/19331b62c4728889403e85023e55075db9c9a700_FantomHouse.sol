...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// Wine on Avalanche Mainnet ========================================================
	//
	address private constant TOKEN_ADDRESS = 0xC55036B5348CfB45a932481744645985010d3A44;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 100000000000000; // default 0.0001 Wine, worth 0.15 Cent ATM.
    ...
    uint256 minDeposit = 10000000000000000; // default 0.01 Wine, worth 15 Cent  ATM.
