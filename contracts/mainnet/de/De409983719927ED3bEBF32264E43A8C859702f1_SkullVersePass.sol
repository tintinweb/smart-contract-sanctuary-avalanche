...
contract SkullVersePass is ERC721  {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicfklsljtdxflfnyla5gzc26udn2spnproq4kmpf4fpmhxfgjkjnm/", Strings.toString(tokenId), ".json")
            );
    }
