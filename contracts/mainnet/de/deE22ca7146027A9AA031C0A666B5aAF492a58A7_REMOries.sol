...
contract REMOries is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5000000000000 * 10**9;
    ...
    constructor() ERC20("REMOries", "REMO", 9) ERC20Permit() {
