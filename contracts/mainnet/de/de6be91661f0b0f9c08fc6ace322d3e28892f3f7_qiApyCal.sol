...
contract qiApyCal {
    ...
    address[] public qiTokens = [
                                    ...
                                    0xc9e5999b8e75C3fEB117F6f73E664b9f3C8ca65C, //Benqi USDT (qiUSDT)
                                    0x4e9f683A27a6BdAD3FC2764003759277e93696e6, //Benqi LINK (qiLINK)
                                    0x835866d37AFB8CB8F8334dCCdaf66cf01832Ff5D, //Benqi DAI (qiDAI)
                                    0xBEb5d47A3f720Ec0a390d04b4d41ED7d9688bC7F, //Benqi USDC (qiUSDC)
                                    0x35Bd6aedA81a7E5FC7A7832490e71F757b0cD9Ce, //Benqi QI (qiQI)
                                    0xB715808a78F6041E46d61Cb123C9B4A27056AE9C, //Benqi USDCn (qiUSDCn)
                                    0xd8fcDa6ec4Bdc547C0827B8804e89aCd817d56EF, //Benqi USDTn (qiUSDTn)
                                    0xF362feA9659cf036792c9cb02f8ff8198E21B4cB, //Benqi sAVAX (qisAVAX)
                                    0x89a415b3D20098E6A6C8f7a59001C67BD3129821	//Benqi BTC.b (qiBTC.b)	
                                ];
    ...
    address[] public qiTokenUnderlyings = [ address(0), //AVAX
                                            ...
                                            0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664,//UDSC.E,decimal 6 
                                            0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5,//QI，decimal 18;
                                            0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E, //USDC,decimal 6;
                                            0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7,//usdt，decimal 6
                                            0x2b2C81e08f1Af8835a78Bb2A90AE924ACE0eA4bE,//savax,decimal 18  
                                            0x152b9d0FdC40C096757F570A51E494bd4b943E50 //btc.b,decimal 8  
                                           ];
    ...
    uint256 constant internal rayDecimals = 1e27;
     ...
     constructor(address amdin) public {
        owner = amdin;
    }

    function addQiTokenPair(address _qiToken,address _underlying,uint256 _underlyingDecimal) external {
        require(owner==msg.sender,"wrong sender!");

        qiTokens.push(_qiToken);
        qiTokenUnderlyings.push(_underlying);
        underlyingDecimal.push(_underlyingDecimal);
    }

    function remove(address _qiToken) external {
        require(owner==msg.sender,"wrong sender!");

        for(uint256 i=0;i< qiTokens.length;i++){
            if(qiTokens[i]==_qiToken) {
                qiTokens[i] = address(0);
                break;
            }
        }
    }
