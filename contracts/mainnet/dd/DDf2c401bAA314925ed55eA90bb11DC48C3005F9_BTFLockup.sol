/**
 *Submitted for verification at snowtrace.io on 2023-03-25
*/
...
contract BTFLockup is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 365, 10, 10, 0, 0, 0, 0, true));
        lockups.push(Lockup(1, 365 * 2, 10, 10, 0, 0, 0, 0, true));
        lockups.push(Lockup(2, 365 * 3, 10, 10, 0, 0, 0, 0, true));
        lockups.push(Lockup(3, 365 * 4, 10, 10, 0, 0, 0, 0, true));
    ...
    function _addStake(
        ...
        uint256 end = block.timestamp.add(_duration.mul(1 days)); // should be 1 days. Need to update on mainnet
