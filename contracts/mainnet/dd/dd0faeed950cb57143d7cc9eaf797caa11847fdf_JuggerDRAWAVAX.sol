...
contract JuggerDRAWAVAX is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerDRAWAVAX", "DRAWAVAX") {
		_setBaseMetadataURI("https://nftapi.jgnnft.com/api10/");
	}

	function contractURI() public view returns (string memory) {
		return "https://nftapi.jgnnft.com/api10/contract/jgn";
	}
}