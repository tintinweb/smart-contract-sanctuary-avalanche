...
contract the_Saudis is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("The Saudis", "SDS") {
    _customBaseURI = 'ipfs://bafybeicnctc4abaloz5vecioxa4dpxx4c4oqzuzufk32fua64hsfnpofsu/';
    _price = 0.35 ether; // 0.35 AVAX mint price 
    _maxMintable = 502 ; // 502 supply
 ...
 function updateMintPriceByWeiUnit(uint256 price) public onlyOwner {
  ...
  function totalSupply() public view returns (uint256) {
   ...
   function current_price_inWEI() public view returns (uint256) {
    return _price;
  }
  ...
  function _privateMint(address recipient) private {
    _tokenIds.increment();
    require(_tokenIds.current() <= _maxMintable, "The Saudis finished minting");
