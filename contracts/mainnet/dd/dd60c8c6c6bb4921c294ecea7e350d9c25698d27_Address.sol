...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6c38d21798727304e1a0fBe70746c0F0Aa3E2c1A;
...
contract MultiChainApe is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0Ca42a666c3Af311e3b53a609aC3A7067C77AA60;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MultiChainApe";
    string private _symbol = "MCA";
