...
contract MuOracle{
    ...
    */
     ...
     function internal_mu_usdce_traderjoes_pool_info_struct() internal view returns(LPpoolStruct memory){
        LPpoolStruct memory mu_usdce_pool_struct;
        ...
        return mu_usdce_pool_struct;

        //return (0xfacB3892F9A8D55Eb50fDeee00F2b3fA8a85DED5, _token0, _token1, __reserve0 * 10**12, __reserve1, muUSD, __blockTimestampLast);
    }
     function get_mu_usdce_traderjoes_pool_info_struct() public view returns (LPpoolStruct memory){
        return internal_mu_usdce_traderjoes_pool_info_struct();
    }
