...
contract CosmicFrens is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    uint public constant START_ID = 1112;
    ...
    uint public maxPerPerson = 1111;
    uint public price = 450000000000000000;
    address public royaltyAddress = 0xf1736364640EE8Fe42c945a3a5cb2b1fb8B5B8E0;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Cosmic Frens", "CSFR") ClampedRandomizer(maxSupply) {
