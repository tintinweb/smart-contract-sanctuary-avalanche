...
*/
// Telegram: https://t.me/KFCAVAX
// https://twitter.com/KFCAVAX
// Website with DAPP release in 30K MC 
//
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    require(newAmount >= totalSupply() * 10 / 100000, "Swap amount cannot be lower than 0.001% total supply.");
  	    require(newAmount <= totalSupply() * 50 / 1000, "Swap amount cannot be higher than 0.5% total supply.");
