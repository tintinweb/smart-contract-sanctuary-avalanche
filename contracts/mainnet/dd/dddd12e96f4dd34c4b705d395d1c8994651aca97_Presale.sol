...
contract Presale is Ownable {
    ...
    address immutable property;
    uint256 public immutable precisionValue;
        ...
        payable
    {
        ...
        // Mint property.
        ITheProperty _property = ITheProperty(property);
        _property.presaleMint(_propertyTypeIndex, _name, _tokenURI, msg.sender);
    ...
    constructor(
        ...
        uint256[3] memory _pricesInDoller = [
            uint256(0.01 ether), // Price in avax for condo
            0.02 ether, // Price in avax for House
            0.03 ether // Price in avax for Mansion
        ];
        uint256[3] memory _maxSupplies = [
            uint256(806), // maxSupply for Condo
            614, // maxSupply for House
            650 // maxSupply for Mansion
        ];
