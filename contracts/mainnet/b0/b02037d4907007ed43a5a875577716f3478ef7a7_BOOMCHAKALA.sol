...
contract BOOMCHAKALA is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x959b88966fC5B261dF8359961357d34F4ee27b4a; // Reward Universe
    address BP = 0x490bf3ABcAb1fB5c88533d850F2a8d6D38298465; // Reward Playmates
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "BOOMCHAKALA";
    string constant _symbol = "BOOMCHAKALA";
