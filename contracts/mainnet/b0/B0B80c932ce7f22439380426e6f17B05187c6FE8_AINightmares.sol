...
contract AINightmares is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("AI Nightmares", "AINMS") {
  ...
  uint256 public constant PRICE = 1200000000000000000;
  ...
  function mint(uint256 count) public payable nonReentrant {
    ...
    require(
      msg.value >= PRICE * count, "Insufficient payment, 1.2 ETH per item"
    );
  ...
  address private constant payoutAddress1 =
    0x0FEcC8A1A66860b9Ac409AEC5795c8bc03a263b6;
