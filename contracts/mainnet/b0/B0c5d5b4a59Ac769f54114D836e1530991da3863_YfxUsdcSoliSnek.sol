...
// File contracts/YfxUsdcSoliSnek.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract YfxUsdcSoliSnek  is Ownable, Pausable {
    ...
    address public constant yfx = address(0x8901cB2e82CC95c01e42206F8d1F417FE53e7Af0);
    ...
    ISoliSnekRouter.Routes[] public snekToYfxPath;
    ...
    constructor(
        ...
        ISoliSnekRouter.Routes[] memory _snekToYfxPath,
        ...
        for (uint i; i < _snekToYfxPath.length; ++i) {
            snekToYfxPath.push(_snekToYfxPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        ISoliSnekRouter(router).swapExactTokensForTokens(snekHalf, 0, snekToYfxPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(usdc).balanceOf(address(this));
        uint256 t2Bal = IERC20(yfx).balanceOf(address(this));

        ISoliSnekRouter(router).addLiquidity(usdc, yfx, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
