...
contract SpaceBotAvax is Ownable {
    using SafeERC20 for IERC20;

    IRouter public constant ROUTER =
        IRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
    IERC20 public immutable TOKEN_1;
    IERC20 public immutable TOKEN_2;
    SpaceBotStationAvax public immutable STATION;
    ...
    constructor(address token1, address token2, SpaceBotStationAvax station) {
        ...
        teamWalletAddr = 0xE9E36a2524b7ea4BE96bB3e11e458704a36d070e;
    ...
    function swapTrade(
        ...
        require(
            tokenOutDiff >= minAmountsOut[minAmountsOut.length - 1],
...
contract SpaceBotStationAvax is ReentrancyGuard, Ownable {
    using SafeERC20 for IERC20;
    ...
    function addVault(
        ...
        require(msg.sender == adminDelegator, "Not approved to call");
        SpaceBotAvax newPair = new SpaceBotAvax(_token1address, _token2address, this);
