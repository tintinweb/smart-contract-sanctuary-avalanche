...
/*
   ...
   GMX Dividend Paying Token - Use ~15% slippage. 
   Rewards are autodistributed, but can be claimed manually on the contract (and soon, dashboard).                                                                        
   https://t.me/gmxprinteravax
   https://twitter.com/gmxprinteravax
...
// Dependency file: contracts/baby/GMXPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeGMXDividends(uint256 amount) public onlyOwner {
...
contract GMXPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GMXPrinter contract."
        );
    }
...
// Root file: contracts/baby/GMXPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/GMXPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract GMXPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    GMXPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = GMXPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "GMXPrinter: The dividend tracker already has that address"
        );

        GMXPrinterDividendTracker newDividendTracker = GMXPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "GMXPrinter: The new dividend tracker must be owned by the GMXPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "GMXPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "GMXPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "GMXPrinter: The PanGMXSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "GMXPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "GMXPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "GMXPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialGMXBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForGMX(tokens);
    ...
    function swapTokensForGMX(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeGMXDividends(dividends);
