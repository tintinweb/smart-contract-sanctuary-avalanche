...
contract AvaxSkull is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihyvm3qfwwvegb4womuwiypz7vqqmvmuh36hvgspbzap6ilnlohzq/", Strings.toString(tokenId), ".json")
            );
    }
