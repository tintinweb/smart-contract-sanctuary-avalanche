...
contract YetiGLPMinter is IYetiGLPMinter, Initializable {
    ...
    /**
     * @notice Updates the GMX Reward Router address after the GMX team changes. This new address is
     *  required to mint new GLP. 
     */
    function updateGLPGMXRewardRouter() external {
        GMXRewardRouter = IGMXRewardRouter(0xB70B91CE0771d3f4c81D87660f71Da31d48eB3B3);
    }
}
