...
// File contracts/distribution/XShareRewardPool.sol
...
contract XShareRewardPool {
    ...
    uint256 public xSharePerSecond = 0.003825874 ether; // 59500 xshare / (180 days * 24h * 60min * 60s)
    ...
    function pendinxShare(uint256 _pid, address _user) external view returns (uint256) {
        PoolInfo storage pool = poolInfo[_pid];
