    ...
    ClampedRandomizer
{
    ...
    address public royaltyAddress = 0xF47155770fCf8e426CD992Ae0F6c1dc23cB521D9;
    ...
    constructor(
        ...
        address _lzEndpoint
    ) ERC721("Sewer Rat Crew", "SRC") ClampedRandomizer(maxSupply) {
    ...
    function internalMint(address to) internal {
        uint256 tokenId = _genClampedNonce() + startFrom;
        mintedSupply += 1;
        _safeMint(to, tokenId);
    }
    ...
    function safeMintMany(address to, uint256 quantity) public onlyOwner {
