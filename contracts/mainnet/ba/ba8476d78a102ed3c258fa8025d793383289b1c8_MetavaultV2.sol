...
contract MetavaultV2 is IBEP20, Ownable
{
    ...
    uint256 currentAmountToSwap = 15000000 * 10**_decimals; // 0.15%
    ...
    address public TeamWallet2=payable(0x2e0fF83A64373e13179e307523fBe3D08e04a4d8);
    //TestNet
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        //Swapping AutoLP and MarketingAVAX is only possible if sender is TraderJoe pair, 
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        //distributes remaining AVAX to Marketing
        marketingBalance+=distributeAVAX;
    }
    ...
    function _addLiquidity(uint256 tokenamount, uint256 AVAXamount) private returns (uint256 tAmountSent, uint256 AVAXAmountSent) {
        totalLPAVAX+=AVAXamount;
        uint256 minAVAX = (AVAXamount*50) / 100;
        ...
        AVAXAmountSent = AVAXamount;
        return (tAmountSent, AVAXAmountSent);
    }
    ...
    function TeamWithdrawALLMarketingAVAX() external onlyOwner{
    ...
    function TeamWithdrawXMarketingAVAX(uint256 amount) external onlyOwner{
    ...
    function TeamSwitchManualAVAXConversion(bool manual) external onlyOwner{
    ...
    function TeamCreateLPandAVAX() external onlyOwner{
    _swapContractToken();
    }
    ...
    function TeamRemoveLiquidity() external onlyOwner returns (uint256 newBalance) {
        ...
        newBalance=newAVAXBalance;
        return newBalance;
    }
    //Releases all remaining AVAX on the contract wallet, so AVAX wont be burned
    function TeamRemoveRemainingAVAX() external onlyOwner{
        require(block.timestamp >= _liquidityUnlockTime, "Not yet unlocked");
