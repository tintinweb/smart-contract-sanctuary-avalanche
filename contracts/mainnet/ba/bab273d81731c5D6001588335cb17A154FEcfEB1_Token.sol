...
uint256 private constant TOTAL_SUPPLY = 6 * (10**9) * (10**DECIMALS);

  constructor(string memory _name, string memory _symbol,address owner, address recipient) Ownable(owner) {
    NAME = _name;
    SYMBOL = _symbol;
...
contract Token is ERC20 {
  ...
  constructor(address owner, address marketing, address rewards) ERC20("PKT","PKT",owner, marketing) {
