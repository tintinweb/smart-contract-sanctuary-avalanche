...
contract Rainy is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial distribution for the first 48h genesis pools
    uint256 public constant INITIAL_GENESIS_POOL_DISTRIBUTION = 11500 ether;
    // Initial distribution for the day 2-5 RAINY-WETH LP -> RAINY pool
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Rainy", "RAINY") {
        // Mints 1 RAINY to contract creator for initial pool setup
    ...
    function transferFrom(
        ...
        if (autoCalculateTax) {
            uint256 currentRainyPrice = _getBombPrice();
