...
contract EvilFamily is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    uint public constant START_ID = 800;
    ...
    uint public maxPerPerson = 1300;
    uint public price = 450000000000000000;
    address public royaltyAddress = 0x3A5aca5fc2a891C4911eE326E551C767825A07FC;
    ...
    constructor(
        ...
        uint[] memory _fees,
        address _lzEndpoint
    ) ERC721("Evil Family", "EVFM") ClampedRandomizer(maxSupply) {
