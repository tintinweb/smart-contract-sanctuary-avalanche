...
contract FeedVaultBaseV4 is FeedVault {
    ...
    /**
     * @dev Get entry fees to token path length
     */
    function entryFeesToTokenPathLength() external view returns (uint256) {
        return entryFeesToTokenPath.length;
    }

    /**
     * @dev Get exit fees to token path length
     */
    function exitFeesToTokenPathLength() external view returns (uint256) {
        return exitFeesToTokenPath.length;
    }
