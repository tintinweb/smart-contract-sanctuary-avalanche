...
contract Legitimate1155NFTDistribution is ERC1155, AccessControl {
    ...
    string public name = "DokyoPopNFT";

    // METADATA
    string public nftTitle = "Yuki's Badge of Approval"; // Title of the NFT collection
    string public nftDescription = "This serves as Yuki's stamp of approval, verifying your encounter with a proud owner of #002 - GACHAPOP Dokyo collectible."; // Description in string or markdown format
    string public nftAnimationUri = ""; // IPFS or HTTP URL
    string public nftImageUri = "https://ipfs.legitimate.tech/ipfs/QmYXBUoCKz6wrtA8MoLWBpiqSfkEB5mG6Ac4A4CGMXVxvc"; // IPFS or HTTP URL
