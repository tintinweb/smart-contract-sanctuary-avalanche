...
// Change Name
contract AVAXOLOTL is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "ipfs://bafybeid7egb5sxsvcphnejuhft5cjc2m26nojrv32tuuzfi4r6cy5aqjqe/";
    ...
    uint256 public royalty = 200; // (500 / 100 = 5% royalty)
    ...
    ) ERC721A("AVAXOLOTL", "AVXO") {
            ProceedsWallet = 0x572AE992032AF498B1eF0Da78C3489fb4a162689;
            RoyaltyAddress = 0x572AE992032AF498B1eF0Da78C3489fb4a162689;
    }
