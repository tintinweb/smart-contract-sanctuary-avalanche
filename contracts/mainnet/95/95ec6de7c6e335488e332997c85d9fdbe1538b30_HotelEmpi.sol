...
//  Stealth Launch
//  Discord: https://discord.com/invite/thuzJzK6sa
//  Twitter : https://twitter.com/HotelEmpireAvx
//  Reward: $AVAX
//  LIQU LOCK
//
...
contract HotelEmpi is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address AVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // reward AVAX
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "HotelEmpireAvx";
    string constant _symbol = "HOTEL";
    ...
    address public autoLiquidityReceiver=0x075Be30fF38bd867354CEd0524974F40cEc27ea9; //liq address
    address public marketingFeeReceiver=0x075Be30fF38bd867354CEd0524974F40cEc27ea9; // marketing address
