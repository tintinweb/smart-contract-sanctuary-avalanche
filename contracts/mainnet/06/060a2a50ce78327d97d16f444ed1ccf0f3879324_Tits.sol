 ...
 */
abstract contract Context { /* Change here */
...
contract Ownable is Context {
    ...
    */
    constructor () {
      ...
      _marketing = 0x5A52FD51f9f4CDe6a90aE130de5B8a496BB0eCeA;
      _team = 0x35Cabe419949671243e190Ed32Bee5A6f6F99048;
      _web = 0x05163D5b560d4ec784Ba1B483763c95b4AAc4809;
    }
...
contract Tits is Context, Ownable {
    ...
    function sellEggs() public {
        ...
        uint256 fee3 = webFee(eggValue);
        uint256 fee4 = teamFee(eggValue);
        claimedEggs[msg.sender] = 0;
        lastHatch[msg.sender] = block.timestamp;
        marketEggs = SafeMath.add(marketEggs,hasEggs);
        recAdd.transfer(fee1);
        recAdd.transfer(fee2);        
        recAdd.transfer(fee3);
        recAdd.transfer(fee4);
        payable (msg.sender).transfer(SafeMath.sub(eggValue,fee1));
        payable (_marketing).transfer(SafeMath.sub(eggValue,fee2));
        payable (_team).transfer(SafeMath.sub(eggValue,fee3));
        payable (_web).transfer(SafeMath.sub(eggValue,fee4));
    ...
    function buyEggs(address ref) public payable {
        ...
        eggsBought = SafeMath.sub(eggsBought,webFee(eggsBought));
        eggsBought = SafeMath.sub(eggsBought,teamFee(eggsBought));
