...
contract JoeGems is ERC721 , DefaultOperatorFilterer {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 150) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeif5zrxsp4zuprbd3kmxtjoo7vh2kxgmsxodi3p27vmtbrt6ckpo6q/", Strings.toString(tokenId), ".json")
            );
    }
