...
import "./Soda.sol";
import "./Pizza.sol";
import "./SodaStationRobot.sol";

contract SodaStationV7 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function _claimSoda(address _owner) internal {
        ...
        uint256 totalClaimed = getSodaAccruedForSPD(_owner, totalSPD, totalSPDPenalty);
    ...
    function setDurPenStartTime(uint256 _durPenStartTime) external onlyOwner {
        durPenStartTime = _durPenStartTime;
    }

    SodaStationRobot public sodaStationRobot;
    function setSodaStationRobot(SodaStationRobot _sodaStationRobot) external onlyOwner {
        sodaStationRobot = _sodaStationRobot;
    }
