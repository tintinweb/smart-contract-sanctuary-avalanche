...
/**
 * @title AvalanchePredictionMain
 */
contract AvalanchePredictionMain is Ownable, Pausable, ReentrancyGuard {
   ...
   * @dev Callable by operator
   */
  function forceExecuteRound() external whenNotPaused onlyAdmin {
    require(
      genesisStartOnce && genesisLockOnce,
      "Can run after Start and Lock"
    );
