...
contract CampfireAvaissance is ERC721, Ownable {
  using Counters for Counters.Counter;
  Counters.Counter private _tokenIds;

  uint256 private _maxMintable;
  string private _globalURI;
  ...
  constructor() ERC721("Campfire Avaissance Explorer", "CAMPEXPLORER") {
    _globalURI = "https://nfts.bpi.network/campfire_avaissance_explorer";
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 1;
    _price = 0;
    _startTime = 1681142400;
  ...
  function tokenURI(uint256 _tokenId_) public override view returns (string memory) {
    return _globalURI;
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    payable(_artist).transfer(msg.value); // should not be any
