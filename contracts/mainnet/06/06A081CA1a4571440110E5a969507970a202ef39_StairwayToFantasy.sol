...
contract StairwayToFantasy is ERC721OnChainMetadata, Ownable, ERC2981 {
    ...
    string public baseURI =
        "https://nftstorage.link/ipfs/bafybeifk342qljgekloxg6vyzvebzq6h6bfiptcmu5z5z762piayvbelwy/";
    uint256 public MAX_SUPPLY = 100;
    uint256 private _totalSupply = 0;
    uint256 public publicMintTime = 1659813300;
    uint256 public whitelistMintTime = 1659812400;
    ...
    function changeDescription(uint256 tokenId, string calldata description)
        external
    {
        require(
