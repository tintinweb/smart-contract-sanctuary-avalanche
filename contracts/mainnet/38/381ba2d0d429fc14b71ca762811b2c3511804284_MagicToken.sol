...
// File: contracts/mgm.sol

pragma solidity 0.6.12;

contract MagicToken is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Magic Money Token", "MGM") {
