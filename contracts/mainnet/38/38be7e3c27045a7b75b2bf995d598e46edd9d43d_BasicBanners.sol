...
// Change Name
contract BasicBanners is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "https://metadata-api.anthonybautist2.repl.co/api/uri/";
    ...
    uint256 public royalty = 500; // (500 / 100 = 5% royalty)
    // Change Max Per TX
    ...
    constructor() ERC721A("Basic Banners", "BBAN") {
    }
