...
contract GalaxyAlchemyContract is ERC1155LazyMint {
    constructor(
        string memory _name,
        string memory _symbol
    ...
    function verifyClaim(
     ...
     require(_tokenId == 0, "Only Amulet is claimable");
     require(_quantity == 3, "Only Amulet is Claimed");

     require(_tokenId == 1, "Only Precious Amulet is claimable");
     require(_quantity == 3, "Only Precious Amulet is Claimed");  

     require(_tokenId == 2, "Only Natural Amulet is claimable");
     require(_quantity == 3, "Only Natural Amulet is Claimed");

     require(_tokenId == 3, "Only Expanding Star Amulet is claimable");
     require(_quantity == 3, "Only Expanding Star Amulet is Claimed"); 
     require(_tokenId == 4, "Only Draconic Gemstone is claimable");
     require(_quantity == 3, "Only Draconic Gemstone is Claimed"); 

     require(_tokenId == 5, "Only Galaxy Soulstone is claimable");
     require(_quantity == 3, "Only Galaxy Soulstone is Claimed"); 

     require(_tokenId == 6, "Only Nebula Gemstone is claimable");
     require(_quantity == 3, "Only Nebula Gemstone is Claimed");  

     require(_tokenId == 7, "Only Golden Trinket Amulet is claimable");
     require(_quantity == 3, "Only Golden Trinket Amulet is Claimed"); 

     require(_tokenId == 8, "Only Dimensional Gemstone is claimable");
     require(_quantity == 3, "Only Dimensional Gemstone is Claimed");    

     require(_tokenId == 9, "Only Gemstone Of Destiny is claimable");
     require(_quantity == 3, "Only Gemstone of Destiny is Claimed");   

     require(_tokenId == 10, "Only Void Power Stone is claimable");
     require(_quantity == 3, "Only Void Power Stone is Claimed");     

     require(_tokenId == 11, "Only Resurrection Gemstone is claimable");
     require(_quantity == 3, "Only Resurrection Gemstone is Claimed");    

     require(_tokenId == 12, "Only Destruction Gemstone is claimable");
     require(_quantity == 3, "Only Destruction Gemstone is Claimed"); 

     require(_tokenId == 13, "Only Restoration Gemstone is claimable");
     require(_quantity == 3, "Only Restoration Gemstone is Claimed"); 

     require(_tokenId == 14, "Only Shattered Power Gemstone is claimable");
     require(_quantity == 3, "Only Shattered Power Gemstone is Claimed");   
    }
