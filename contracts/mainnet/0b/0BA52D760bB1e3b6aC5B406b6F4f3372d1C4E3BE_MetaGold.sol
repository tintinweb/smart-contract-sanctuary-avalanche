...
contract MetaGold is ERC721Burnable, Ownable, KindaRandom {
  ...
  constructor() ERC721("Meta Gold", "MGOLD") KindaRandom(250) {
    _baseTokenURI = "https://metacardsclub.io/mgold/json/";
    _baseExtension = ".json";
    _maxMintable = 250; // 250 max supply
    ...
    _team1 =  0xd8936E602E38dfEe5d6466865068b94b1943DEBF; // f
    _team2 =  0xA4E12ce3955FC4289dec95c5E2a696ba24A845CF; // s
    _team3 =  0x0F6E029037c04B3fecB8b7fc7c2EDCe645aEc1Bd; // v
    _dev   =  0xfE4E7eAf4398f2D36f98081888CC6894c9822ad1;

    _royaltyReceiver = 0xd8936E602E38dfEe5d6466865068b94b1943DEBF;

    _privateMint(0xd8936E602E38dfEe5d6466865068b94b1943DEBF);
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    payable(_team1).transfer((msg.value * 300) / 1000);
    payable(_team2).transfer((msg.value * 250) / 1000);
    payable(_team3).transfer((msg.value * 250) / 1000);
    payable(_dev).transfer((msg.value * 200) / 1000);
