...
contract SellTax is Ownable {
     ...
     *
     * - A hardcoded maximum of 50 percentage is set for safety, meaning this contract can never take all the tokens of a transfer.
     */
