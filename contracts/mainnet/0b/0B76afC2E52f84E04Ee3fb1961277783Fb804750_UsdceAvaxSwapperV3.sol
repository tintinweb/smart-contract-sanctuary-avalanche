...
contract UsdceAvaxSwapperV3 is ISwapperGeneric {
    ...
    function swap(
        ...
        uint256 usdceFromAvax = _getAmountOut(avaxAmount, reserve1, reserve0);
        WAVAX.transfer(address(USDCEAVAX), avaxAmount);
        USDCEAVAX.swap(usdceFromAvax, 0, address(this), new bytes(0));
        usdceAmount += usdceFromAvax;
