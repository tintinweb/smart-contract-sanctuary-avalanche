...
contract MuBank is Context, Ownable{
    ...
    function bond(uint256 _amount) public onlyOwner{
        MuMoneyMinter(_MuMoney).mint(_msgSender(), _amount);
    }
    ...
    function mu_bond(uint256 amount) public view returns (uint256 mu_bond_amount){

        Router router = Router(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
        //IERC20 _stable = IERC20(token);
        ...
        uint256 amountIN = router.getAmountIn(amount, reserve0, reserve1);
        uint256 amountOUT = router.getAmountOut(amount, reserve1, reserve0);
    ...
    */
        ...
        return  mu_coin_amount;   
        //mucoin.transfer(msg.sender, mu_coin_amount);
        //mint the corresponding amount of Mu Money and send to the mubank
