...
contract YieldYakFacet is ReentrancyGuardKeccak, SolvencyMethods, OnlyOwnerOrInsolvent {
    ...
    **/
    function stakeGLPYak(uint256 amount) public restrictedAccess onlyOwner nonReentrant remainsSolvent {
    ...
    **/
    function unstakeGLPYak(uint256 amount) public restrictedAccess onlyOwnerOrInsolvent nonReentrant {
