 ...
 */
contract DexanceVaultNative is ERC20, Ownable, ReentrancyGuard {
    ...
    // Wrapped token version of Native.
    ...
    /**
     * @dev It initializes the vault's own 'liDexance' token.
    ...
    /**
     * @dev Alternative entry point into the strat. You can send native Token,
    ...
    function withdraw(uint256 _shares) public {
        ...
        require(userBalance >= _shares,"Bad shares");
     ...
     * but the funds arrive in native token.
     */
