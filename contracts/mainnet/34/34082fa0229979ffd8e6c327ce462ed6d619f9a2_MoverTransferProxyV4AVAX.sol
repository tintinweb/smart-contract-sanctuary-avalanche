...
*/
contract MoverTransferProxyV4AVAX is AccessControlUpgradeable, SafeAllowanceResetUpgradeable, ITransferProxyV2 {
    using SafeMathUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    function bridgeAssetDirect(address _token, uint256 _amount, bytes memory _bridgeTxData, address _relayTarget) internal {
        ...
        require(targetAddress == 0x0EF812f4c68DC84c22A4821EF30ba2ffAB9C2f3A, "unknown bridge");
