...
contract ZEUS is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Zeus v10", "ZEUS") PaymentSplitter(payees, shares) {
    ...
    function updateDistributionWallet(address distributionAddress_) external onlyOwner {
        distributionWallet = distributionAddress_;
    }
    ...
    modifier onlyAuthorized() {
        require(msg.sender == owner() || msg.sender == distributionWallet, "Unauthrorized");
        _;
    }
}