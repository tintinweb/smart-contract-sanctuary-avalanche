...
contract tesFronk is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 840000000000*10**18;
    string public _name = "tesFronk";
    string public _symbol= "FRONK";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0xeb9F788A56Ec5cd71d578d7Db198C159AF6B5427);
