...
contract StrategyElkLP2 is StratManager, FeeManager {
    ...
    // Tokens used
    address private native = address(0x6c6D9856C44B2A2248D093f3797Db66a706225D6 );
    ...
    address public rewardPool = address(0x79Eafcee9e02ca70A9D34cC356e744D3718fDa84);
    ...
    constructor(
        address _vault
    ) StratManager(address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F), address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F), address(0x9a5De8C973c2f64f0f518DE581BcC2aa2dF8A621), _vault, address(0xD28731F314357B40b1AE1e12e5CDEf6bd33Fe63F)) public {
