...
contract Tornado is ERC20Detailed, Ownable {
    ...
    uint256 public tornadoVaultFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public firePitFee = 25;
    uint256 public totalFee =
    liquidityFee.add(treasuryFee).add(tornadoVaultFundFee).add(
        firePitFee
    );
    ...
    address public tornadoVaultReceiver;
    ...
    constructor() ERC20Detailed("Tornado", "TAUTO", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x01F042d0296BC3e3941d0A153a60C0F50ec88A3E;
        treasuryReceiver = 0x01F042d0296BC3e3941d0A153a60C0F50ec88A3E;
        tornadoVaultReceiver = 0x01F042d0296BC3e3941d0A153a60C0F50ec88A3E;
        firePit = DEAD;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(tornadoVaultFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        value: amountAVAXToTreasuryAndSIF.mul(treasuryFee).div(
            treasuryFee.add(tornadoVaultFundFee)
        ),
        gas: 30000
        }("");
        (success, ) = payable(tornadoVaultReceiver).call{
        value: amountAVAXToTreasuryAndSIF.mul(tornadoVaultFundFee).div(
            treasuryFee.add(tornadoVaultFundFee)
        ),
        gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TAUTO token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WAVAX();
        router.swapExactTokensForAVAXSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _tornadoVaultReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        tornadoVaultReceiver = _tornadoVaultReceiver;
        firePit = _firePit;
    }
