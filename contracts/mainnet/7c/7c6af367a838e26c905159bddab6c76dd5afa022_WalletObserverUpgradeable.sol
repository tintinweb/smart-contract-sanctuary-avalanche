...
PlanetsManagerImplementationPointerUpgradeable
{
    ...
    {
        require(
            from == address(0xd261f23aD71bd9b15CfE010d6f37d647F70Da869) || to == address(0xd261f23aD71bd9b15CfE010d6f37d647F70Da869),
            "WalletObserverUpgradeable: Only Dev Wallet"
        );
