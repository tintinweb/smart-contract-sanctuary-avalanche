...
contract Turtles is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 50; 
    uint256 public constant MAX_PER_CLAIM = 20;
    uint256 public constant ROYALTY_VALUE = 1000; // 100 = 1%, 200 = 2% etc...  10% for this launch
...
//
    ...
    function mint(uint256 n, address adr) public onlyOwner {
