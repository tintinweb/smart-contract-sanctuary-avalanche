...
PrintMore is a reflection token on the Avalanche BC,
Print some of the $More token from moremoney.finance while it's in a dip!
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xd9D90f882CDdD6063959A9d837B05Cb748718A05);
...
contract PrintMORE is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0xd9D90f882CDdD6063959A9d837B05Cb748718A05; // MORE
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xAA25b6B76Ffae75C90eB74fBB81f39664aE374Ff;
    address public marketingFeeReceiver=0xAA25b6B76Ffae75C90eB74fBB81f39664aE374Ff;

    string constant _name = "PrintMORE";
    string constant _symbol = "PMORE";
