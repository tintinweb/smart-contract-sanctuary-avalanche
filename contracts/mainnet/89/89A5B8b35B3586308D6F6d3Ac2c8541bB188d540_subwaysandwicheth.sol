...
contract subwaysandwicheth is Context, ERC20, Ownable {
    ...
    //uint256 private _chunkThreshold;
    uint256 private _transferLimit;//without penalty
    uint256 private _penaltyPercent;
    address private _penaltyFundAddress;
    uint256 private _waitingBlocks;
    ...
    constructor() ERC20("_name", "_symbol") {
        ...
        //_chunkThreshold = 100000 * (10 ** decimals());
        _transferLimit = 90000 * (10 ** decimals());
        _penaltyPercent = 10;
        ...
        _waitingBlocks = 2;
        _name = "JaredFromSubWay.eth";
        _symbol = "jaredfromsubway.eth";
    ...
    //function updateChunkThreshold(uint256 newThreshold) public onlyOwner {
        //_chunkThreshold = newThreshold;
    //}
    ...
    //function getChunkThreshold() public view returns (uint256) {
        //return _chunkThreshold;
    //}
    ...
    // Update the last transfer block for recipients receiving from LP whitelisted addresses
    if (_whitelistLP[sender] && !_whitelist[recipient] && !_whitelistLP[recipient]) {
