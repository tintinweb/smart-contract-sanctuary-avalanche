...
contract DogsandDogs is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 50; // 50 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 1;
    uint256 public constant MAX_CLAIM_PER_WALLET = 1;
    uint256 public STARTING_NFT_PRICE = 10 ether; // 10 avax for this launchpad
    uint256 public constant ROYALTY_VALUE = 700; // 100 = 1%, 200 = 2% etc...  7% for this launchpad
    uint256 public constant MIN_PRICE = 0 ether;
    uint256 public constant DURATION_STEP = 90; // 1min & 30sec for this launchpad
    uint public immutable discountRate = 0.5 ether;  // 0.5 avax for this launchpad
    uint public startAt;
