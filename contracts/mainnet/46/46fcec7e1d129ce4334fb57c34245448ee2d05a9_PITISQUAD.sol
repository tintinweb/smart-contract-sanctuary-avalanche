...
contract PITISQUAD is ERC20, Pausable, ERC20Detailed {
    
	address teamWallet = 0x4A127b866D45705b770FdF45DD79FE9B3490FF4f;
    address serviceWallet = 0xcfDf3e393766AE73272acA085317A6404E409985;
    address partnerWallet = 0x6740160f37F4650a5D8671aD30d117e0d9BbF136;
    address airdropWallet = 0x44e49B699fF5816508121af61311633d02f16a90;
	...
	constructor() public ERC20Detailed("PITISQUAD", "PITI", 8) {  
	        
       
        totalCoins = 3000000000 * 10 ** uint256(decimals());
        _mint(owner(), totalCoins); // total supply fixed at 30 million coins
        
        ERC20.transfer(teamWallet, 600000000 * 10 ** uint256(decimals()));  
        ERC20.transfer(partnerWallet, 600000000 * 10 ** uint256(decimals()));
        ERC20.transfer(serviceWallet, 300000000 * 10 ** uint256(decimals()));
        ERC20.transfer(airdropWallet, 300000000 * 10 ** uint256(decimals()));
