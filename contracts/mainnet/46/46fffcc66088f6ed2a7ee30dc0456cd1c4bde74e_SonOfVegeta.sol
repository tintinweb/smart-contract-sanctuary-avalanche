...
//  Telegram: https://t.me/SonOfVegeta
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x88784DC627F0a1ebdd6B470524719c089D18E55e); // reward address VEGETA
...
contract SonOfVegeta is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x88784DC627F0a1ebdd6B470524719c089D18E55e; // reward VEGETA
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SonOfVegeta";
    string constant _symbol = "SOV";
    ...
    address public autoLiquidityReceiver=0x63F39a3BF0F1b868A4a7197f866278558b449117; //liq address
    address public marketingFeeReceiver=0x63F39a3BF0F1b868A4a7197f866278558b449117; // marketing address
