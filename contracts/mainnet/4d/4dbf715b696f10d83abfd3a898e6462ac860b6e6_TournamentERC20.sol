...
interface ITournament {
    ...
    function ROUNDEND() external view returns (uint256); // lastTs + PERIOD value
...
contract TournamentERC20 is Ownable, ITournament {
    ...
    address public xwlrs = 0x2dc3Bb328000553D1D64ec1BEF00572F62B5Ec7C;
    bool public claimed;
    ...
    function getBurnShare() public view returns (uint256) {
        return BURN_SHARE;
    }
    ...
    function buy() external payable {
        ...
        if (BURN_SHARE >  0) {
            xwlrsmint(xwlrs).mint(ticketPrice * BURN_SHARE / 10000);
            TOTALBURN = TOTALBURN + (ticketPrice * BURN_SHARE / 10000);
        }
        winner = msg.sender;
        if (PERIOD > DECAYSTOP) 
