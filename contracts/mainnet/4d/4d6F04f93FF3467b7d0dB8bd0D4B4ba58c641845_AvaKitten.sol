...
contract AvaKitten is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "AvaKitten";
    string private constant _symbol   = "AVAKITTEN";
