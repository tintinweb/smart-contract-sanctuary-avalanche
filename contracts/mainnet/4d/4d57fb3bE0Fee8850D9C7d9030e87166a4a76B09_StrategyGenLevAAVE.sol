...
contract StrategyGenLevAAVE is BaseStrategyInitializable {
    ...
    IProtocolDataProvider private constant protocolDataProvider = IProtocolDataProvider(0x65285E9dfab318f57051ab2b139ccCf232945451);
    IAaveIncentivesController private constant incentivesController = IAaveIncentivesController(0x01D83Fe6A10D2f2B7AF17034343746188272cAc9);
    ILendingPool private constant lendingPool = ILendingPool(0x4F01AeD16D97E3aB5ab2B501154DC9bb0F1A5A2C);

    address private constant rewardToken = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address private constant wrappedNative = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    ...
    // SWAP routers
    IUniLikeSwapRouter private PRIMARY_ROUTER = IUniLikeSwapRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4);
    IUniLikeSwapRouter private SECONDARY_ROUTER = IUniLikeSwapRouter(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
