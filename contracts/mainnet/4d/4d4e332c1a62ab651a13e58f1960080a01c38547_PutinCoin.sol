...
/**  earn Platypus rewards by holding putinCoin the sky is the limit but not for us we go beyond 
 *   big calls in the lineup big marketing plan to make this coin moon liq will be locked right after launch 
*/   
// SPDX-License-Identifier: MIT
//  Twitter  : https://twitter.com/PutinCoin1   
//  Telegram : https://t.me/PutinCoin1
//  Rewards  : $PTP
//  how will we make this coin moon? we will use calls in the beginning and then contact influencers to work with us we 
//  already have a few onboard but they want to promote us when we reach 10k so thats our first milestone we will 
//  be working really hard to reach everyone expectations we are not going for 100/1000/10000X we are going for unlimited
//  we will not go to the moon but way beyond the moon come and join our telegram im sure our community will be awesome 
//  when we launch come and join our awesome community and be quick this will be a really big launch
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x22d4002028f537599bE9f666d1c4Fa138522f9c8); // rewards PTP 
...
contract PutinCoin is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $PTP   = 0x22d4002028f537599bE9f666d1c4Fa138522f9c8; // reward $PTP  
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "PutinCoin";
    string constant _symbol = "PUTIN";
    ...
    address public autoLiquidityReceiver=0x19b484f54f39Ff2650B1BC7f49BfB5D184a2b193; //liq address
    address public marketingFeeReceiver=0x19b484f54f39Ff2650B1BC7f49BfB5D184a2b193; // marketing address
