    ...
    PausableUpgradeable
{
    ...
    function initialize() external initializer {
        __ERC20Detailed__init("FuseProtocol", "FUSE", uint8(DECIMALS));
        __Ownable_init();
        __Pausable_init();
        ...
        autoLiquidityReceiver = 0x4933d8D0490eCbFf64b1F9aE0947e759f4139B85;
        treasuryReceiver = 0x910F7B36b6C5325F25Bf7A37F8987D0524508148;
        InsuranceFundReceiver = 0xfbf7CD7fC472dff3045b3406C51EBEa077b94e1E;
        firePit = 0xCD8D69a8705EcA56D163ce32355b44e6b7c939e7;
        ...
        firePitFee = 15;
        totalFee = liquidityFee.add(treasuryFee).add(InsuranceFundFee).add(firePitFee).add(metisFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _treasuryFee, uint256 _InsuranceFundFee, uint256 _metisFee,
                                uint256 _treasuryExtraSellFee, uint256 _firePitFee) public onlyOwner {
