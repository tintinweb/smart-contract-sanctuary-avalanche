...
contract LEGENDSPIXEL is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeidvgkl7zpan7yots7vjddc54pvm3fmkhruqouqzmktbsoqympogce/", Strings.toString(tokenId), ".json")
            );
    }
