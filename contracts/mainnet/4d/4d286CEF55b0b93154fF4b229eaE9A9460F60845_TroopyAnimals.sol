...
contract TroopyAnimals is ERC721Enumerable, ERC2981, Ownable {
  using Strings for uint256;

  address public royalties = 0x450fbdc04f114Ca610A710a62348812e018a6BC3;
  ...
  constructor(
    ...
    _setDefaultRoyalty(royalties, 1000);
  }
