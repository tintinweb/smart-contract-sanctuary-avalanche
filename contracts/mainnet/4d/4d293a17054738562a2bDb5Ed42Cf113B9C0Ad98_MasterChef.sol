...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function initializePools(address _nativeLP) external onlyOwner {
        ...
        add(200, IERC20(_nativeLP), 0, true, false);                                        // Native LP pool
        add(175, IERC20(native), 0, true, false);                                           // Native pool
        add(30, IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7), 400, false, false);     // wAVAX pool
        add(25, IERC20(0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB), 400, false, false);     // wETH.e pool
        add(25, IERC20(0x50b7545627a5162F82A992c33b87aDc75187B218), 400, false, false);     // wBTC.e pool
        add(25, IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664), 400, false, false);     // USDC.e pool
        add(25, IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118), 400, false, false);     // USDT.e pool
        add(25, IERC20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70), 400, false, false);     // DAI.e pool
        add(10, IERC20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd), 400, false, false);     // JOE pool
        ...
        returns (uint256)
    {
        ...
        if (
            ...
            uint256 nativeReward = multiplier
                ...
                if (totalRewards > native.maxSupply()) {
                nativeReward = native.maxSupply().sub(native.totalSupply());
            }
            accNativePerShare = accNativePerShare.add(
                nativeReward.mul(1e18).div(pool.lpSupply)
            );
        }
        return user.amount.mul(accNativePerShare).div(1e18).sub(user.rewardDebt);
    }
