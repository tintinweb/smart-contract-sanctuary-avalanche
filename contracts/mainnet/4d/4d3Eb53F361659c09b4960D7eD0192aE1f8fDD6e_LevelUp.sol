...
contract LevelUp is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 1990; //  1990 total for this contract
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 250; // 100 = 1%, 200 = 2% etc...
    uint256 public constant MAX_EARLY_CLAIM = 10;
