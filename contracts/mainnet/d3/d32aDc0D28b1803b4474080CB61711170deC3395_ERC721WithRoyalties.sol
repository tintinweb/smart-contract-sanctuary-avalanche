...
// File: contracts/ERC721WithRoyalties.sol
...
contract ERC721WithRoyalties is ERC721URIStorage, ERC2981ContractWideRoyalties, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() ERC721("BattleTonks", "BTONK") {}
    ...
    // @notice Mint one token to owner()
    // @param the tokenURI
