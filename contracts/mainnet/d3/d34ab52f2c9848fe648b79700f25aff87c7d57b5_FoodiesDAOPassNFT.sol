    ...
    Ownable
{
    ...
    address public constant MANAGER =
        0xD84C67BB9d8C77FF1B1EbAB4e4a3bAABC1442c77;
    ...
    constructor() ERC721("Foodies DAO Pass", "FDAO") {
        mintStartTimestamp = 1685120400; // 2023-05-26T17:00:00Z
        mintPrice = 0;
        baseURI = "ipfs://bafybeicrw5zs6o6fuilwlrlgug5plryef7vbrj7w2aeijeqd543oazbgr4";

        super._setDefaultRoyalty(MANAGER, 1000); // 10%
