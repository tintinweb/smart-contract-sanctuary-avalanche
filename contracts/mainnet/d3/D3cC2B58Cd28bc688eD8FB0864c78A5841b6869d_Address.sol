...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9230A2dCD4E9e4991E4A819172336d3ba68049ef;
...
contract ViDioT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x30945E7C8E4122aFb3363bf362EC2339EF1d9D5C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ViDioT";
    string private _symbol = "Vido";
