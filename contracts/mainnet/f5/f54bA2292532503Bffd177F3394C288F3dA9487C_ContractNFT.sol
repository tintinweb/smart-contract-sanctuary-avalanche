...
contract ContractNFT is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    ...
    uint256 public constant MAX_MINTABLE = 6666; // 6666 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant NFT_PRICE = 1.1 ether; // 1.1 avax for this launchpad
    uint256 public constant EARLY_NFT_PRICE = 1 ether; // 1 avax for this launchpad
