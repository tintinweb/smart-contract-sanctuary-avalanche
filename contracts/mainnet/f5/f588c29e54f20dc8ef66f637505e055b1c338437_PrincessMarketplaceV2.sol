...
interface INFTKEYMarketplaceV2 {
     ...
     * @param tokenId erc721 token Id
     */
    function buyToken(address erc721Address, uint256 tokenId, uint256 _approved, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) external;
 ...
 */
contract PrincessMarketplaceV2 is
    ...
    ReentrancyGuard
{
     ...
     */
    function buyToken(address erc721Address, uint256 tokenId, uint256 _approved, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s)
        external
        override
        nonReentrant
    {
