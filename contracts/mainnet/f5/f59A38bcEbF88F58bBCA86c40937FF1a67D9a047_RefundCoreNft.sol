...
contract RefundCoreNft is Ownable {
    ...
    function getEligibleTreeNfts(address _address) public view {}
        ...
        public onlyOwner
    {
        ...
        EligibleNfts storage eligibleNfts = addressToEligibleNfts[_address];
        ...
        for (uint i = 0; i < treeNftIdsToAdd.length; i++) {
            ...
            if(exists == false) {
                eligibleNfts.treeNfts.push(treeNftIdsToAdd[i]);
            }
        }
    }
