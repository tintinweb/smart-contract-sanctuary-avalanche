...
//
//
// SteakPrinter is a meme token on Avalanche that rewards holders with $STEAK dividends gathered from buy/sell taxes.
// Recommended slippage: 15-20%
//
// Thanks to the SteakHut team for their great dApp!
//
...
// Dependency file: contracts/baby/SteakPrinterDividendTracker.sol
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function distributeSteakDividends(uint256 amount) public onlyOwner {
...
contract SteakPrinterDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SteakPrinter contract."
        );
    }
...
// Root file: contracts/baby/SteakPrinter.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/SteakPrinterDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract SteakPrinter is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    SteakPrinterDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = SteakPrinterDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "SteakPrinter: The dividend tracker already has that address"
        );

        SteakPrinterDividendTracker newDividendTracker = SteakPrinterDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "SteakPrinter: The new dividend tracker must be owned by the SteakPrinter token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "SteakPrinter: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SteakPrinter: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "SteakPrinter: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SteakPrinter: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SteakPrinter: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SteakPrinter: Cannot update gasForProcessing to same value"
        );
    ...
    function swapAndSendToFee(uint256 tokens) private {
        uint256 initialSteakBalance = IERC20(rewardToken).balanceOf(
            address(this)
        );

        swapTokensForSteak(tokens);
    ...
    function swapTokensForSteak(uint256 tokenAmount) private {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (success) {
            dividendTracker.distributeSteakDividends(dividends);
