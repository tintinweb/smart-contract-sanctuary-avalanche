...
contract Vibe is FloorToken, TransferTripleTaxToken {
    constructor() FloorToken(ERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7), ILBFactory(0x8e42f2F4101563bF679975178e880FD87d3eFd4e), 8388608, 100, 6969e18) TransferTripleTaxToken("Vibe", "VIBE", 0x7E53502b0D6C1efC21689ECe63BBB3658DbeC274) {}
...
abstract contract FloorToken is Ownable2Step, IFloorToken {
        ...
        nonReentrant
    {
        ...
        (, uint256 tokenYProtocolFees) = _pair.getProtocolFees();
