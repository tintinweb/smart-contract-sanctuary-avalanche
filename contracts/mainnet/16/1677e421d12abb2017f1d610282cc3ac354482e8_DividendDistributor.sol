...
// File: CoreNodes Final Draft/CoreNodesFD.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
...
contract Kunjus is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDC
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Kunjus2";
    string constant _symbol = "AK";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 2,5%
    uint256 public _maxWallet = _totalSupply.div(20); // 5,0%
    ...
    address public autoLiquidityReceiver=0x458280EC191c3D041e509682CbfA6FfD303491Fd;
    address public marketingFeeReceiver=0x90c25F55d5349950Cebec08575CBa3F4CAC8B6D2;
    ...
    //    bool isBuy=sender== pair|| sender == routerAddress;
        ...
        uint256 amountReceived = (isSell && shouldTakeFee(sender)) ? takeFee(sender, recipient, amount) : amount;
