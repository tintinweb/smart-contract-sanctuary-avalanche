...
contract VapeShiller is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x43f90f6a1E49701FCED958a915515BfC5E5F8AdA;
    address public marketingFeeReceiver=0x3754486c9401beFA48a901a0bCd048D0Cdb318a5;

    string constant _name = "VapeShiller";
    string constant _symbol = "VPSH";
