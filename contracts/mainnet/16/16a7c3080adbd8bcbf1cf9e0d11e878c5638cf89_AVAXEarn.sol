...
contract AVAXEarn {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.1 ether; //0.1 Avax Deposit
	uint256[] public REFERRAL_PERCENTS = [50, 30, 20];
	uint256 constant public PROJECT_FEE = 150; 
	uint256 constant public PERCENT_STEP = 6; //0.6% Daily Growth
	...
	constructor(address payable wallet, uint256 startDate) public {
        ...
        plans.push(Plan(14, 130));
        plans.push(Plan(21, 120));
        plans.push(Plan(28, 110));
        plans.push(Plan(14, 150));
        plans.push(Plan(21, 140));
        plans.push(Plan(28, 130));
	}
