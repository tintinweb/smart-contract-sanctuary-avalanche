...
contract MysticalTarotPixelArt is ERC721 , DefaultOperatorFilterer {
    ...
    constructor()
        ERC721("Mystical Tarot in Pixel Art", "MTPA")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeifo2wjsfenwlxlpuet6tk6zyn5kqm4prkbbrrklhgxxvaw7dj2yq4/", Strings.toString(tokenId), ".json")
            );
    }
