...
/**
RugMachine
This is a test for contract functions, please don't buy as you will 99% lose money
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x260Bbf5698121EB85e7a74f2E45E16Ce762EbE11);
...
contract RugMachine is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x260Bbf5698121EB85e7a74f2E45E16Ce762EbE11; // UST
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0x875281b3fBa3F542Cb1375CaE7FD2184b62Eb782;
    address public marketingFeeReceiver=0x875281b3fBa3F542Cb1375CaE7FD2184b62Eb782;

    string constant _name = "RugMachine";
