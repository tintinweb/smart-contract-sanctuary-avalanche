...
contract XPANZPublicPresale is ReentrancyGuard {
    ...
    uint256 public minimumDepositAmount = 200 * 10 ** 18;
    uint256 public maximumDepositAmount = 5000 * 10 ** 18;
	...
	function buy(uint256 _amount) public nonReentrant {
        ...
        require(_amount + (tokensOwned[msg.sender] * USDCperToken) <= maximumDepositAmount, "high amount than max");
