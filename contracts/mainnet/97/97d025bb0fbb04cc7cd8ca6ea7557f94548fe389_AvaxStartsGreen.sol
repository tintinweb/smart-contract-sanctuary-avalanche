...
//Fairlaunch at 50 member, Don't miss it
//DEGEN PLAY
//Telegram: https://t.me/projectasg
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6D10bf95d21a1ffbD6524c1A40e0D2b37254FBD8); // reward $usdt
...
contract AvaxStartsGreen is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6D10bf95d21a1ffbD6524c1A40e0D2b37254FBD8; // reward $USDT
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avax Starts Green";
    string constant _symbol = "ASG";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 100_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10); 
    uint256 public _maxWallet = _totalSupply.div(10);
    ...
    address public autoLiquidityReceiver=0xd789e8A80B564798AEf3C7F3565392Dcf0E70d61; //liq address
    address public marketingFeeReceiver=0xd789e8A80B564798AEf3C7F3565392Dcf0E70d61; // marketing address
