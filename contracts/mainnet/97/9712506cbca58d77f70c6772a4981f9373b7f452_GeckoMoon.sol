...
twitter : https://twitter.com/GeckoMoon1

🦎GeckoMoon🦎 - Charity Token - Huge Potential - Locked LP - Low Market Cap - Bonus For First 100 followers on twitter

AVAX Charity token - a percentage of every trade goes to help a Selected Wildlife Charity Organisation.

Each month the community votes to select the Charity of their choice. All donations are public and verifiable.

Coinhunt and Coingecko will be applied for as soon as we launch. With further, larger marketing planned aswell. 

The safety of all investors is paramount to the developers, the development team will be renouncing ownership, locking liquidity, having no wallets of their own, with only a 1% marketing wallet which will also be used for donations. 

This means the team behind GeckoMoon will be purchasing at the same time as investors.

Automatic Liquidity Generation and Token Redistribution on each trade.
...
contract GeckoMoon is Context, IERC20, Ownable {
    ...
    string private _name = 'GeckoMoon';
