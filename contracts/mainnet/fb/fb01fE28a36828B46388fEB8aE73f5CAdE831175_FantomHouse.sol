...
contract FantomHouse is VRFConsumerBaseV2, Ownable, ReentrancyGuard {
	...
	// Zombie on Avalanche Mainnet ======================================================
	//
	address private constant TOKEN_ADDRESS = 0x431bDC9975D570da5eD69C4E97e27114BCd55a86;
	...
	//
    // AVAX mainnet KeyHash
	//  > 200 gwei 0x83250c5584ffa93feb6ee082981c5ebe484c865196750b39835ad4f13780435d
	//  > 500 gwei 0x89630569c9567e43c4fe7b1633258df9f2531b62f2352fa721cf3162ee4ecb46
	//  > 1000 gwei 0x06eb0e2ea7cca202fc7c8258397a36f33d88568d2522b37aaa3b14ff6ee1b696

	VRFCoordinatorV2Interface COORDINATOR;
    uint64 private s_subscriptionId = 47;
    ...
    uint16 requestConfirmations = 1; // Minimum is 1 on AVAX
    uint32 numWords = 1;
	...
	// Minimum Bet & Deposit=============================================================
    //
	uint256 minBet = 100000000000000; // default 0.0001 Token
    ...
    uint256 minDeposit = 10000000000000000; // default 0.01 Token
	...
	uint256 vrfFee= 10000000000000000; // default 0.01 AVAX. 17 Cents ATM
   ...
   function refund(uint256 _betId) external nonReentrant {
        ...
        // 100 Block is about 5 minutes in FTM
