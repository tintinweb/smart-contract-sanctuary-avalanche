...
Viravax the origins
A virusDAO fork on AVAX

Join our social medias
Twiter https://twitter.com/VIRAVAXORIGINS
Tg https://t.me/viravax

To get instruction on how to get FREE infection in your wallet

Only 50 original infected at the same time 

1st hour taxes 15% buy/sell
After 1 hour 10% buy/sell
...
contract Viravax is IBEP20, Auth {
    ...
    string constant _name = "Viravax";
    string constant _symbol = "VAX";
    ...
    address private marketingFeeReceiver = 0xadbf8CBbD1268f78557FB809085D4EbcA5aadd97;
    address private devFeeReceiver = 0x276eD7A24f9b3B9Ba666FE88d948F0F2d543845C;
