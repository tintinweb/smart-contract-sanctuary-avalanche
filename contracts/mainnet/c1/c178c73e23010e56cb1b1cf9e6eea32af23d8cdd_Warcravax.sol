...
5% fee auto Marketing
100% lp locked
add 1 AVAX + 70% token into 6 months LOCKED LP on DxLock , rest to buy
#minieverdome fork, code is audited and can be checked by anyone.
...
- Spread your favorite community everywhere =)
...
contract Warcravax is Context, IERC20, Ownable {
    ...
    string private _name = 'WARCRAVAX';
