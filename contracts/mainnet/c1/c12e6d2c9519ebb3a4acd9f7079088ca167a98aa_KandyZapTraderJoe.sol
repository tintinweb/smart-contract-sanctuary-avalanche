...
/*
    KandyZap is a ZapperFi's simplified version of zapper contract which will:
    1. use ETH to swap to target token
    2. make LP between ETH and target token
    3. add into KandyChef farm
*/
contract KandyZapTraderJoe is Ownable, ReentrancyGuard {
    ...
    function zap(
        ...
        address _lp = address(kandyChef.lpToken(_info.pid));
        ...
        approveToken(_lp, address(kandyChef), _liquidity);
        kandyChef.deposit(_info.pid, _liquidity, msg.sender);
