...
//CHEEMS INU AVAX CONTRACT 

contract CHEEMSAVAX is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 6200000000 * 10**_decimals;

    //Amount to Swap variable
    uint256 currentAmountToSwap = 6300000 * 10**_decimals;
    ...
    address public TeamWallet2=payable(0x468A4DCf9611981F7A367bA550841d8a0C9c325c);
    //TestNet
    address private PancakeRouter=0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
    //MainNet
	...
	uint256 private antiWhale = 100000000 * 10**_decimals;
    ...
    function TeamWithdrawALLMarketingBNB() external onlyOwner{
        ...
        emit Transfer(address(this), TeamWallet2, (amount-(amount*50) / 100));
    } 
    ...
    function TeamChangeTeamWallet2(address newTeamWallet2) external onlyOwner{
      require(newTeamWallet2 != address(0),
      "Error: Cannot be 0 address.");
      TeamWallet2=payable(newTeamWallet2);
      emit ContractChangedAddress(TeamWallet2);
    }
