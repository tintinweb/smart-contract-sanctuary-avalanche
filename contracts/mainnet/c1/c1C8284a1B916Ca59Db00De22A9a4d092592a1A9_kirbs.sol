...
abstract contract BatchReveal {
    uint constant public TOKEN_LIMIT = 475;
    uint constant public REVEAL_BATCH_SIZE = 25;
    ...
    Ownable
{
    ...
    uint256 public maxMintable = 475;
    ...
    constructor() ERC721A("Kirbs", "KIRB") {
        customBaseURI = "ipfs://bafybeidkrutppiasxiwuuhf3qggn3els26skyanvhxeofehsodk7yucqim/";
        unrevealedURI = "ipfs://bafybeicmsb4cem4hfwzzqonqodkyznc647g5gh753rorbypcsavmshbqia/1.json";
        maxPerWallet = 5;
        paused = true;
    }
    ...
    modifier publicRequirements(uint256 quantity) {
        ...
        require(
            quantity + publicMints[msg.sender] <= maxPerWallet,
    ...
    function mintByOwner(address to, uint256 count) public onlyOwner {
        require(totalSupply() + count <= maxMintable, "minting more than max");
        royaltyReceiver[totalSupply()] = to;
        royaltyAmounts[totalSupply()] = 750;
        _safeMint(to, count);
    ...
    function setPrivateAndPublicSale(uint256 publicTime_) public onlyOwner {
