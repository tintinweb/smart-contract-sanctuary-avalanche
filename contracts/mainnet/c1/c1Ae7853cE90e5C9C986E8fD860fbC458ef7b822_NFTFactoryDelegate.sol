...
contract NFTFactoryDelegate is Initializable, AccessControl, ERC721Holder, NFTFactoryStorage {
    ...
    bytes32 public constant GOLDEN_PRICE_SYNC_OP = keccak256("GOLDEN_PRICE_SYNC_OP");
    ...
    function configChestPrice(uint _golden) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || hasRole(GOLDEN_PRICE_SYNC_OP, msg.sender), "ACCESS FORBIDDEN");
