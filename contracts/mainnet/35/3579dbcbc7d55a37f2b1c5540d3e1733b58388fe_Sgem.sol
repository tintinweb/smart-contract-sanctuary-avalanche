...
contract Sgem is ERC20Burnable, Operator {
    ...
    function setTreasuryFund(address _communityFund) external {
        require(msg.sender == devFund1, "!dev");
        require(msg.sender == devFund2, "!dev");
        require(msg.sender == devFund3, "!dev");
        require(msg.sender == devFund4, "!dev");
        require(msg.sender == devFund5, "!dev");

        communityFund = _communityFund;
    }

    function setDevFund(uint parameter, address _devFund) external {
