...
contract AXEFISH is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeicjugkwh3bqqv3j6sj6i3wq72xgygszy7nfrw3hvgwfvdccsla2ti/", Strings.toString(tokenId), ".json")
            );
    }
