...
contract StormNFT is ERC721("StormNFT", "STORM-NFT"), Ownable {
    
    uint256 tokenCounter = 0;
    uint256 public price = 2 * 10**18; // 2 AVAX
    uint256 public MAX_TOKENS = 2000; // maximum supply
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmWGcDS6S7fKy6k5rGWwhDyeFpGajNx2gwBfEBSJW8Wc9o/"; //METADATA
