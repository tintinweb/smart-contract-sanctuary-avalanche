...
contract GambitFCGoldenTicket is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibusczc52c3lqsxdnweqm76enym765igiegtv2rb35zi633hy3tk4/", Strings.toString(tokenId), ".json")
            );
    }
