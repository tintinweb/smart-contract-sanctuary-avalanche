...
contract HighPointFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public constant sellLaunchFeeAdded = 20;
    ...
    function updateLaunchPeriodFee() private {
        ...
        //multiply by 5 to remove 5% everyday
    ...
    function swapBack() internal swapping {
        ...
        uint256 sellFeeAmountToLiquidityWithoutExcess = _sellFeeBalance
            .div(_gonsPerFragment)
            .mul(liquidityFee.add(sellFeeLiquidityAdded).add(sellLaunchFeeAdded - sellLaunchFeeSubtracted))
            .div(totalSellFee);
