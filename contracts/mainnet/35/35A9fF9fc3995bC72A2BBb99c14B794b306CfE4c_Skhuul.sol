...
contract Skhuul is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public constant baseExtension = ".json";
    string public baseURI = "";
    string public constant unrevealedURI =
        "https://ipfs.io/ipfs/bafybeicvfcedwvxd5cwiwqpdn6z2b467wsfunkfmanh3drhnh5kimkxrmq/unrevealed.json";
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        if (msg.sender != owner()) {
            ...
            if (onlyAllowList) {
                ...
                require(amount <= 5, "max mint per session exceeded");
    ...
    function devMint(uint256 amount, address devAddress) public onlyOwner nonReentrant {
        require(totalSupply() + amount <= MAX_SUPPLY, "Amount exceeds supply!");
