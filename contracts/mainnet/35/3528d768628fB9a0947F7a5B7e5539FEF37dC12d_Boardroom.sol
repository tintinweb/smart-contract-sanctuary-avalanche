...
contract ShareWrapper {
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        require(memberShare >= amount, "Boardroom: withdraw request greater than staked amount bruh");
...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getElectronPrice() external view returns (uint256) {
        return treasury.getElectronPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            Electron.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        Electron.safeTransferFrom(msg.sender, address(this), amount);
