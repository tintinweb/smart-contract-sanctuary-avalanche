...
// Venom-Finance final version 3.0
...
import "./supportContracts/FixedPoint.sol";
import "./supportContracts/IUniswapV2Pair.sol";
import "./supportContracts/UniswapV2OracleLibrary.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/utils/Context.sol";
import "./supportContracts/Operator.sol";
import "./supportContracts/Epoch.sol";

// fixed window oracle that recomputes the average price for the entire period once every period
// note that the price average is only guaranteed to be over at least 1 period, but may be over a longer period

contract OracleV3 is Epoch {
