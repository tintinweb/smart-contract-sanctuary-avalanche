...
// Butterfly Cash Early Supporter NFT by xrpant
...
// Change Name
contract bCASHEarlySupporter is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public baseURI = "ipfs://bafybeibuj2ibpe2vkxy7ovmlskjmnoctdomm4sxb5c3seoololohx35obu/bCash.json";
    ...
    constructor() ERC721A("bCASH Early Supporter", "bCASHES") {
        // Mint the first token to deployer address
        _mint(msg.sender, 1);
        bc = IBCash(0x4BA16DaF8ed418deD920C66e45cc3eaFFDE53Ac7);
    }
    ...
    function mint(uint256 amount) public payable nonReentrant {
        ...
        if (msg.sender != owner()) { 
            require(amount <= maxPerTx, "You can't mint that many!");
