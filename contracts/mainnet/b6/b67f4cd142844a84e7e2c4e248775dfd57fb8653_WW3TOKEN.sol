...
MAX buy upon launch will be 1%.
Max Wallet size of 2%.

Socials:
t.me/WW3Portal
Twitter.com/WW3_Token
WW3Token.info
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REFLECTIONS = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218);
...
contract WW3TOKEN is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REFLECTIONS = 0x50b7545627a5162F82A992c33b87aDc75187B218;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "WW3 Token";
    string constant _symbol = "WW3";
    ...
    address public autoLiquidityReceiver = 0xcA58E3A3c5c7246dB8eE8A3793486a504E1004F0;
    address public marketingFeeReceiver = 0xcA58E3A3c5c7246dB8eE8A3793486a504E1004F0;
