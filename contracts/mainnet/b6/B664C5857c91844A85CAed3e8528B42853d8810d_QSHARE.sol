...
contract QSHARE is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 100.000 QSHARE
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _treasuryFund) public ERC20("Quiznos Share", "QSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 QSHARE for initial pools deployment
