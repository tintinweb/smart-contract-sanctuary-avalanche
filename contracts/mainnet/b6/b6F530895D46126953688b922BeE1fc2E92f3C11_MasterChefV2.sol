...
// File contracts/BanksyTokenV2.sol
...
contract TreasuryDAO is AccessControl {
    ...
    // Set distribution time frame for usd distribution. Only The Gnosis Safe Multisig wallet administrator can run it
 ...
 */
contract MasterChefV2 is Ownable, ReentrancyGuard, ERC721Holder {
    using SafeERC20 for IERC20;
