...
contract SodaStationV9 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function getSodaAccruedForSPD(address _owner, uint256 _spd, uint256 _spdPenalty) internal view returns (uint256) {
        if(ownedCupsBalance[_owner] > getSizeSkillModifier(_owner) + sodaStationRobot.getExtraCups(_owner)){
            return 0;
        }
