...
contract METAVAX is IERC20 {
    ...
    string constant private _name = "METAVAX";
    string constant private _symbol = "MVAX";
    ...
    address payable public marketingWallet = payable(0x34bb6e57e7D498a8637252871926e08634e14DcA);
    address payable constant private devWallet = payable(0x05EaCd6FbdF878bfAaFe0001851c2F139676f9D8);
...
//===============================================================================================================
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing) external onlyOwner {
        require(rewards + liquidity + marketing + 25 == 100);
