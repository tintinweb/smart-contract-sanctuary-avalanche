...
contract Avaliens is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 1000; //  1000 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 800; // 100 = 1%, 200 = 2% etc...  10%
    uint256 public constant MAX_EARLY_CLAIM = 1;
    uint256 public constant NFT_PRICE = 0.1 ether; // 
    uint256 public constant HARDCAPWL = 500; //500
...
//
    function earlyClaim(uint256 n, bytes32[] calldata _proof) public {
        ...
        require(n + totalSupply() <= HARDCAPWL, "Not enough left to mint during the pre sale.");
