...
contract BruiseBros is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("The Hated Prelude : Bruise Bros", "BRUISE") KindaRandom(666) {
    _customBaseURI = "https://nfts.bpi.network/bruise_bros/";
    _maxMintable = 666; // 666 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 5;
    _price = 0.5 ether;
    _startTime = 1679623200;
    
    _artist =  0xa0bC0DfD012d80d9DAA0da0694B2511B475a2eA1;
