...
contract PreSale is Ownable {
    ...
    IARC20 public PTOKEN = IARC20(0x945bD92Df21d833af83405640B10FEc6601FB822);
    address public Recipient = 0xe7b763452185813bEf65c8748Daf8F443Ca6C4Ff;

    uint256 public tokenRatePerEth = 900; // 900 * (10 ** decimals) PTOKEN per eth
    uint256 public pTokenRatePerEth = 960; // 960 * (10 ** decimals) PTOKEN per eth
