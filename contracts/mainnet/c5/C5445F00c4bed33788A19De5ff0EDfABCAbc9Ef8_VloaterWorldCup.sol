...
contract VloaterWorldCup is Ownable, ERC721A  {
    using Strings for uint256;

    string private _baseTokenURI = "ipfs://QmNpSt5hgavYgZqqAAoWahqJWZVCUagHMNZxXWD9wwWD9C/";
    string private _unrevealedURI = "";
    string public baseExtension = ".json";
    
    constructor() ERC721A("Vloaters: World Cup", "VLOATWC") {}
    ...
    */
    function airdrop(address to, uint256 numberOfTokens)
        ...
        onlyOwner
    {
        require(numberOfTokens > 0, "Must drop at least 1");
