...
contract LendingPoolConfig is Ownable {
  ...
  */
  function updateInterestRateModel(
    ...
    require(_jumpMultiplier > _multiplier, "jumpMultiplier should be > multiplier");
    require(baseRate >= 0, "baseRate should be >= 0");
    require(_kink1 <= _kink2, "kink1 must less than or equal to kink2");
...
import "../../contracts/lending/LendingPoolConfig.sol";

contract $LendingPoolConfig is LendingPoolConfig {
    bytes32 public __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(uint256 _baseRate, uint256 _multiplier, uint256 _jumpMultiplier, uint256 _kink1, uint256 _kink2) LendingPoolConfig(_baseRate, _multiplier, _jumpMultiplier, _kink1, _kink2) {}

    function $_calculateInterestRate(uint256 _debt,uint256 _floating) external view returns (uint256 ret0) {
        (ret0) = super._calculateInterestRate(_debt,_floating);
    }
