...
contract StabilityPool is PoolBase, ReentrancyGuardUpgradeable, IStabilityPool {
     ...
     */
    function claimRewardsSwap(uint256 _yusdMinAmountTotal, bool _reinvest)
        external
        override
        nonReentrant
...
interface IStabilityPool is ICollateralReceiver {
    ...
    function claimRewardsSwap(uint256 _yusdMinAmountTotal, bool _reinvest) external returns (uint256 amountFromSwap);
