...
contract NODEC is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xd0110e3CF180de90A9903ADD6065B5785A4Ee7De); // NODECTEAM
    ...
    string private _name = "NODE COMPILER";
    string private _symbol = "NODEC";
