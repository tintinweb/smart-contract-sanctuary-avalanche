...
{
    /**
     * @dev blacklist the user from transfering and minting.
     *
    ...
    /**
     * @dev checks and counter before transfer
     */
    function _beforeTokenTransfer(
        ...
        require(!isBlackListed[from] && !isBlackListed[to], "AlloyERC721: User is blacklisted");
    }
}
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function mintPrinterARC(
        ...
        require(
            SignatureCheckerUpgradeable.isValidSignatureNow(
                ...
                !(ConstructAddress.isVerified(_signature)),
    ...
    function sellProcessedPart(
        ...
        require(isUnProcessedPartSold[_order.partId], "AlloyERC721: Already sold");
