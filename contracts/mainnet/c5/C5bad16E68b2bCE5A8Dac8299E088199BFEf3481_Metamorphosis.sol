...
contract Metamorphosis is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("Metamorphosis", "MORPH") KindaRandom(199) {
    _customBaseURI = "https://nfts.bpi.network/metamorphosis/";
    _maxMintable = 199; // 199 max supply
    _royaltyAmount = 500; // 5% royalties
    _mintActive = false; // start paused
    _maxMintPerTx = 5;
    _price = 1 ether;
    _startTime = 1665608400;
    
    _artist =  0x3b8dd5E9565d0F2242affe65e698663a51f02573;
