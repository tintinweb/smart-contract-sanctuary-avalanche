...
contract zapper is Ownable, IZap {
    ...
    function SetToken(IERC20 _token, address _sender, address _receiver) external returns (bool) {
    ...
    function transferFee(IERC20 _token, address _sender, address _receiver, uint256 _amount) external returns (bool) {
        require(msg.sender == operator, "access denied");
