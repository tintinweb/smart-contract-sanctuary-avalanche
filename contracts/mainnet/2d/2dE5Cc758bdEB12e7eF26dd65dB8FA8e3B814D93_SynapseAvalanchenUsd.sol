...
contract SynapseAvalanchenUsd is Defii, DefiiWithCustomExit {
    IERC20 constant USDCe = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    IERC20 constant DAIe = IERC20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70);
    ...
    IERC20 constant SYN = IERC20(0x1f1E7c893855525b303f99bDF5c3c05Be09ca251);

    ISwapFlashLoan constant swapFlashLoan =
        ISwapFlashLoan(0xED2a7edd7413021d440b09D654f3b87712abAB66);
    IMiniChefV2 constant miniChef =
        IMiniChefV2(0x3a01521F8E7F012eB37eAAf1cb9490a5d9e18249);
    ...
    function _enter() internal override {
        ...
        USDCe.approve(address(swapFlashLoan), usdcBalance);
