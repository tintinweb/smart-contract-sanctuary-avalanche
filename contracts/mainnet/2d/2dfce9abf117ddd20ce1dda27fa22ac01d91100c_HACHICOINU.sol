...
100% lp locked
add 20 AVAX + 97% token
#HACHICOINU fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes HACHICOINU!
...
contract HACHICOINU is Context, IERC20, Ownable {
    ...
    string private _name = 'HACHICO INU';
    string private _symbol = 'HACHICO';
