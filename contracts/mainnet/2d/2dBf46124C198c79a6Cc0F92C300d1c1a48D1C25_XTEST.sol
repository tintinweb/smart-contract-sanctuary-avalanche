...
contract XTEST is IERC20 {
    ...
    string constant private _name = "XTEST";
    string constant private _symbol = "XTEST";
    ...
    address constant public USDCE = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664;
    ...
    function initialize() external onlyOwner {
        require(!initialized);
        address avaxPair = IFactoryV2(dexRouter.factory()).createPair(dexRouter.WAVAX(), address(this));
...
//===============================================================================================================
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        antiSnipe.withdraw(address(this), amtBalance - liquidityBalance);
    ...
    function withdrawUSDCEFromLiquidityHolder(uint256 amount) external onlyOwner {
        ...
        antiSnipe.withdraw(msg.sender, amount);
    }
...
// ==================================================================================================================================================
//                                                              DEV STUFF
//                                         EVERYTHING BELOW HERE WILL BE REMOVED BEFORE MAINNET DEPLOYMENT
