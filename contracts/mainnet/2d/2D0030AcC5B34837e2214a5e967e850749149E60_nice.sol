...
contract nice is ERC721 {
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 22) revert SoldOut();
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeia7fsansmfwwsfmzw23mmms7vq4klmtet425kmlu7kissxxgg5f5y/", Strings.toString(tokenId), ".json")
            );
    }
