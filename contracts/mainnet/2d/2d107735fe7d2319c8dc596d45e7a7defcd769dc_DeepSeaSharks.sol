...
contract DeepSeaSharks is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, Randomizer {
    ...
    constructor(
        ...
        uint[] memory _fees
    ) ERC721("3DeepSeaSharks", "3DeepSeaSharks") Randomizer(maxSupply) {
