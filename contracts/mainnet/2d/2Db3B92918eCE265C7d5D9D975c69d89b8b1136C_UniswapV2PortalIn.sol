...
import "../libraries/openzeppelin/0.8.0/access/Ownable.sol";
    ...
    function collect(address[] calldata tokens) external {
        ...
        for (uint256 i = 0; i < tokens.length; i++) {
            ...
            if (tokens[i] == address(0)) {
                ...
                SafeTransferLib.safeTransferETH(payable(collector), qty);
            } else {
...
contract UniswapV2PortalIn is PortalBaseV1 {
    ...
    /// @param buyToken The quantity of sellToken to Portal in
    /// @param buyAmount The quantity of sellToken to Portal in
    /// @param fee The fee in BPS
    /// @param sender The sender msg.sender
    ...
    function portalIn(
        ...
        amount = _execute(sellToken, intermediateToken, amount, target, data);
