...
Earn BWA (BearsWarAvax) *hottest token on avax right now!!


// Ownership Renounced / Lp Lock 7 Days / Max Buy 2% / Dev SAFU
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x6e3fa74b4303E0FE24D3F6662DA5b6af0a87b42e);
...
contract BEARSWARPRINT is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REWARDS = 0x6e3fa74b4303E0FE24D3F6662DA5b6af0a87b42e;
    ...
    string constant _name = "BEARSWARPRINT";
    string constant _symbol = "BWAP";
    ...
    address public autoLiquidityReceiver = 0x53548ddE11BB3B5c0Da7e4BbbAB141c7e146F986;
    address public marketingFeeReceiver = 0x53548ddE11BB3B5c0Da7e4BbbAB141c7e146F986;
