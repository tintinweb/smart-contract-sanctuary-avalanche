...
contract veYETI is IveYETI {
    ...
    */
    ...
    address contractController; // controls adding and removing updateable rewarders
    ...
    */
    ...
    function getUpdateableRewarders() external view returns (address[] memory) {
    ...
    function addUpdateableRewarder(address _rewarder) external {
        require(msg.sender == contractController, "veYETI: invalid caller");
        require(!isUpdateableRewarder[_rewarder], "veYETI: rewarder already added");
