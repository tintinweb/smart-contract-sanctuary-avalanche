...
#*MetaConvoy - #LIQ+#RFI+#SAFEMOON, combine together to #MetaConvoy. 
   ...
   I make this #MetaConvoy to hand over to the community.
   Create the community by yourself if you are interested.   

   Great features: fee 13%
   3% fee auto add to the liquidity pool to locked when selling
   5% fee auto distribute to all holders
   5% burn to the black hole, with such big black hole and 5% fee, the strong holder will get a valuable reward

   I will lock liquidity LPs to burn addresses to lock the pool 2 days.
   I will renounce the ownership to burn addresses to transfer #MetaConvoy to the community, make sure it's 100% safe.

   I will add 15 AVAX and all the left 99% total supply to the pool
   Can you make #MetaConvoy 1000X? 
   ...
   it's the best part of the #MetaConvoy idea, increasing the liquidity pool automatically, 
