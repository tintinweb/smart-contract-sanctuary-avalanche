 ...
 */
contract RaiderDivest is ADivestStrategy {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint256;

  IMasterChef public poolContract;
  ...
  function poolBalance(address _address)
    ...
    returns (uint256)
  {
    (uint256 _amount, ) = poolContract.userInfo(poolId, _address);
    return _amount;
  }
}
