...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd); // reward address playmates
...
contract Miakhalifainu is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; // reward playmates
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Miakhalifainu";
    string constant _symbol = "MKI";
    ...
    address public autoLiquidityReceiver=0xF2278387489581bD334bA9f6A98ED27146bd3e62; //liq address
