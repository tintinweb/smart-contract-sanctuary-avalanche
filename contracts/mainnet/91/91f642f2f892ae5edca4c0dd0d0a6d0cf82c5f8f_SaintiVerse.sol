...
contract SaintiVerse is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, Randomizer {
    ...
    address public royaltyAddress = 0x21FC738371A2ddD2E8fC9ca7F3273C186BC1AEE0;
    ...
    constructor(
        ...
        uint[] memory _fees
    ) ERC721("SaintiVerse", "SaintiVerse") Randomizer(maxSupply) {
