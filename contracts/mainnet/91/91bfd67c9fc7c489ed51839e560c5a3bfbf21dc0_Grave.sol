...
contract Grave is ERC20Burnable, Operator {
    ...
    // Initial distribution for the day 2-5 GRAVE-WETH LP -> GRAVE pool
    // uint256 public constant INITIAL_GRAVE_POOL_DISTRIBUTION = 140000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("grave.finance", "GRAVE") {
