...
// File contracts/fBombWavaxGlacier.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract fBombWavaxGlacier  is Ownable, Pausable {
    ...
    function addLiquidity() internal {
        ...
        IGlacierRouter(router).addLiquidity(wavax, fbomb, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
