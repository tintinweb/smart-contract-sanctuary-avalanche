...
//
// Tbank PROTOCOL COPYRIGHT (C) 2022 
...
contract Tbank is ERC20Detailed, Ownable {
    ...
    string public _name = "Tbank";
    string public _symbol = "Tbank";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 7500 * 10**4 * 10**DECIMALS;

    uint256 public liquidityFee = 40;
    uint256 public treasuryFee = 25;
    uint256 public TbankInsuranceFundFee = 100;
    uint256 public sellFee = 25;
    uint256 public blackholeFee = 25;
    uint256 public nftFee = 15;
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(TbankInsuranceFundFee).add(blackholeFee);
    uint256 public feeDenominator = 1000;

    uint256 public startTime;
    uint256 public sellLimit = 75;
    uint256 public holdLimit = 15;
    ...
    address public TbankInsuranceFundReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 7500 * 10**8 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Tbank", "Tbank", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92;
        treasuryReceiver = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92; 
        TbankInsuranceFundReceiver = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92;
        blackhole = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92;
        nftFeeReceiver = 0xe43FC5e73694DC35BC977511cbbD0D130ab84E92;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(TbankInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        IERC20(USDC).transfer(treasuryReceiver, amountUSDCToTreasuryAndAIF.mul(treasuryFee).div(treasuryFee.add(TbankInsuranceFundFee)));
        IERC20(USDC).transfer(TbankInsuranceFundReceiver, amountUSDCToTreasuryAndAIF.mul(TbankInsuranceFundFee).div(treasuryFee.add(TbankInsuranceFundFee)));
    }

    function withdrawAllToTreasury() external swapping onlyOwner {

        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Tbank token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = USDC;
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _TbankInsuranceFundReceiver,
        address _blackhole,
        address _nftFeeReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        TbankInsuranceFundReceiver = _TbankInsuranceFundReceiver;
