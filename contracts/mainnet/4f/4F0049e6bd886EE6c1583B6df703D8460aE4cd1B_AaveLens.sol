...
contract AaveLens is IAaveLens {
    ...
    /**
     * @notice  The currentVariableDebt value is pegged to the value of the corresponding supplied asset at a 1:1 ratio
     * @param _assets list of token addresses supplied as collateral
     * @return usdcPositions - balance of currentVariableDebt pegged to each asset in terms of USDC
     */
        ...
        returns (uint256[] memory usdcPositions)
    {
        ...
        for (uint256 i; i < _assets.length; i++) {
            ...
            usdcPositions[i] = currentVariableDebt;
        }
    }
