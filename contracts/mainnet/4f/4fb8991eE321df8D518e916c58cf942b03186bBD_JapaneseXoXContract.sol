/**
 *Submitted for verification at snowtrace.io on 2023-01-21
*/
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0xc63a41dCF3f110054242BfDEAbc97F9db763E756];
  address public erc20Payable = 0xc63a41dCF3f110054242BfDEAbc97F9db763E756;
...
abstract contract Feeable is Teams {
  uint256 public PRICE = 1e-7 ether;
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 2, 6000) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeif42khjwrwy5mlkkilw2ngzfslmfk6cuypdy4fxrvknikm5oouuyi/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/hfOVTVXDLKVQq0nofhQv/contract-metadata";
  }
...
// File: contracts/JapaneseXoXContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JapaneseXoXContract is RamppERC721A {
    constructor() RamppERC721A("Japanese XoX", "HZG"){}
}
