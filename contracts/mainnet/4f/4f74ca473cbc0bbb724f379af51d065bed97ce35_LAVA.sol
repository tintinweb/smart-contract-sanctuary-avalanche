...
contract LAVA is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "Lava Financial";
    string private _symbol = "LAVA";
    uint256 private _initSupply = 10000000*10**18;
    
    uint256 public dexTaxFee = 1500; //take fee while sell token to dex - resolution *100
