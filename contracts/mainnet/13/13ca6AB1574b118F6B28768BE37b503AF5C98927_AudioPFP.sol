...
// Audio PFP by xrpant for Smolrun
...
contract AudioPFP is ERC721A, Ownable {
    using Strings for uint256;

    string public baseURI = "ipfs://QmRshqJogqU7sokXtd9JHDWY4MtPGen67KirWUqyWk1wP2/";
    string public baseExtension = ".json";

    uint256 public constant MAX_SUPPLY = 14;
    uint256 public cost = 0.2 ether;

    constructor() ERC721A("Audio PFP", "aPFP") {
    }
    ...
    function mint(uint256 amount) public payable {
        ...
        require(amount == 1, "You can only mint 1 per tx!");
    ...
    function updateBaseExtension(string calldata _newExtension) public onlyOwner {
