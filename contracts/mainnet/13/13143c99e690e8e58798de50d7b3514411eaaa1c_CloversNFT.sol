...
contract CloversNFT is ERC721ABurnable, ERC721AQueryable, Ownable, ReentrancyGuard {
    ...
    uint256 public maxMintAmountForTX = 6;
    uint256 public MintCap = 10;
    uint256 public MintCapPlatinumMember = 6;
    bool public paused = true;
    bool public onlyWhitelisted = false;
    bool public onlyPlatinumMember = true;
    bool public MintCapState = true;
    ...
    address public Treasury = 0xBFe691bF973ECf07cd03bC6e7B1E74DeA2DEF539;
    ...
    function getMaxSupplyAndCurrentSupply(string calldata _ClovesType) public view returns (uint256 MaxSupply, uint256 CurrentSupply){
         ClovesInfo memory cloves = ClovesType[_ClovesType];
         MaxSupply = cloves.maxsupply;
         CurrentSupply = cloves.supply;
