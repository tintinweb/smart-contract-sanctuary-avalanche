...
contract RothschildWinery {
    ...
    uint256 public COMPOUND_STEP = 48 * 60 * 60; /** 48 Hours Compound Timer **/
	...
	uint256 public CUTOFF_STEP = 72 * 60 * 60; /** 72 Hours Rewards Accumulation Cut-Off **/
