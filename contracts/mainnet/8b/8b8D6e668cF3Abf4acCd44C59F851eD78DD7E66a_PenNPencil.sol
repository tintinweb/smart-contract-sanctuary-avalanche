...
contract PenNPencil is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeib64p32rph3aqaibo6ejqr3cahkplluaxnxbu3svznpgvavhhfrym/", Strings.toString(tokenId), ".json")
            );
    }
