...
#MCDONALDTRUMP features:
Total fee
6% fee auto add to the liquidity pool to locked forever when selling
2% fee auto distribute to all holders
5% fee auto Manketing
50% Supply is burned at start.
#MCDONALDTRUMP fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCDONALDTRUMP!
