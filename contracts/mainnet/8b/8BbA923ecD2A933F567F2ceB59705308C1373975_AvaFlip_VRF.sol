...
contract AvaFlip_VRF is Ownable, VRFConsumerBaseV2 {
    event GameResult(
        address player,
        uint playedAmount,
        uint wonAmount,
    ...
    mapping(address => uint) public selectedFace;
    ...
    function fulfillRandomWords(
        ...
        s_randomWords[requestId] = (randomWords[0] % 2) + 1;
    }

    function playFlip(uint8 flip) external payable {
