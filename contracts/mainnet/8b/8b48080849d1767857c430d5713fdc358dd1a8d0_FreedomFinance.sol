...
contract FreedomFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 3 * 10**9 * 10**DECIMALS;
    ...
    ) ERC20Detailed("Freedom Finance", "FDM", uint8(DECIMALS)) {
