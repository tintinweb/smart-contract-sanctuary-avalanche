...
$$ |      $$   ____|$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |
$$ |      \$$$$$$$\ \$$$$$$$ |$$ |  $$ |\$$$$$$  |$$$$$$$  |
\__|       \_______| \____$$ |\__|  \__| \______/ \_______/ 
                    $$\   $$ |                              
                    \$$$$$$  |                              
                     \______/                               
*/
...
*/
contract SnowShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 58400 ether;

    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 7300 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 7300 ether;
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("SnowPEGS SHARE", "snowSHARE") {
