...
abstract contract BaseModule is IYieldModule, UUPSUpgradeable, OwnableUpgradeable, Rescuable {
    ...
    modifier onlySmartFarmooor() {
        require(msg.sender == smartFarmooor, "BaseModule: only smart farmooor");
        _;
    }
...
contract BenqiYieldModule is CompoundV2Module {
    ...
    function initialize(
        ...
        _initializeCompoundV2(_smartFarmooor, _manager, _baseToken, _executionFee, _dex, _rewards, _comptroller, _cToken);
    }
}
...
contract CompoundV2Module is BaseModule, ExponentialNoError {
    ...
    function _initializeCompoundV2(
        ...
        _initializeBase(_smartFarmooor, _manager, _baseToken, _executionFee, _dex, _rewards);
