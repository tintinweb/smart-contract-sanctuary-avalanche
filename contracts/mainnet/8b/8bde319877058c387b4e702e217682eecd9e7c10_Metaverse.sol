...
dev 1%
add 69% token
#Metaverse fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes Metaverse!
...
contract Metaverse is Context, IERC20, Ownable {
    ...
    string private _name = 'Meta verse Avax';
    string private _symbol = 'MVA';
