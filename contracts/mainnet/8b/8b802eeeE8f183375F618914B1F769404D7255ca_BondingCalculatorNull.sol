...
// File: contracts/BondingCalculatorNull.sol
...
contract BondingCalculatorNull is IBondingCalculator {
    ...
    function valuation( address _pair, uint amount_ ) external pure override returns ( uint _value ) {
        _pair;
        amount_;
        return 0;
    }
