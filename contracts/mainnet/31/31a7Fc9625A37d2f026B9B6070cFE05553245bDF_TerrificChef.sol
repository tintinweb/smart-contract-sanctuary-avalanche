...
contract TerrificChef is Ownable {
    ...
    ITerrificStaking public rewardMinter;
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "TerrificChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardMinter(ITerrificStaking _rewardMinter) external {
        require(
