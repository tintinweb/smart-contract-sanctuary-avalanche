...
contract esGM is ERC20("Escrowed Good Morning", "esGM"), Ownable {
  using EnumerableSet for EnumerableSet.AddressSet;

  /* ========== STATE VARIABLES ========== */

  ITokenManager public tokenManager;
  EnumerableSet.AddressSet private _transferWhitelist; // addresses allowed to send/receive esSteady
  ...
  function mint(address to, uint256 amount) external {
    require(msg.sender == address(tokenManager) || msg.sender == owner(), "Only TokenManager or Owner");
      _mint(to, amount);
  }
  ...
  function updateTransferWhitelist(address account, bool add) external onlyOwner {
    require(account != address(this), "updateTransferWhitelist: Cannot remove esSteady from whitelist");
