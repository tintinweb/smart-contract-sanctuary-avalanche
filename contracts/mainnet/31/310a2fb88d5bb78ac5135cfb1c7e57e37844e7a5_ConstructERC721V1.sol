    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() public initializer {
        __ERC721_init("Alloy Constructs", "AC");
        __Ownable_init();
        __ReentrancyGuard_init();

        baseUri = "https://assets.alloy.space/token-uri-s3/";
        baseExtension = "-token-uri-s3.json";

        tokenCounter = 0;

        MerchantWallet = 0x4F68437579a7077010290e6b713076495fEe37E6;
        ARCAddress = Mintpeg(0x6BC174805568608e7092D554Ba5FeFD5461b5194);
        ARFtokenAddress = Mintpeg(0xfD1B2d7323B305806fD40F76b2CF3975a2cD72b6);
        NiozERC20Address = IERC20Upgradeable(0x07B057133d28d44Fc1C917D8F77A5a8099f01A97);
    }
    ...
    function sellAlloyConstruct(
        ...
        require(
            NiozERC20Address.recoverSigner(
                _order.messageHash,
                _signature
            )  == owner() &&
                !isVerified[_signature] &&
    ...
    function convertConstruct(
        ConvertConstruct memory _order,
        bytes memory _signature
    ) external virtual nonReentrant {
        require(
            SignatureCheckerUpgradeable.isValidSignatureNow(
...
interface IERC20Upgradeable {
    ...
    function recoverSigner(bytes32 _msg_hash, bytes memory _signature) external returns(address);
}
