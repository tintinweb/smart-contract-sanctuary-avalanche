...
contract daysofHaldun is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 21; // 21 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 1;
    uint256 public constant MAX_CLAIM_PER_WALLET = 1;
    uint256 public STARTING_NFT_PRICE = 8 ether; // 8 avax for this launchpad
    uint256 public constant ROYALTY_VALUE = 500; // 100 = 1%, 200 = 2% etc...  5% for this launchpad
    uint256 public constant MIN_PRICE = 2 ether; // 2 avax floor price
    uint256 public constant DURATION_STEP = 90; // 1min & 30sec for this launchpad
    uint public immutable discountRate = 0.3 ether;  // 0.5 avax for this launchpad
    uint public startAt;
