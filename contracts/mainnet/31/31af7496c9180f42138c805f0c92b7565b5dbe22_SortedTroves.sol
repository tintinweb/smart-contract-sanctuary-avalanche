...
contract SortedTroves is ISortedTroves {
     ...
     */
    function updateUnderCollateralizedTrove(address _id, bool _isUnderCollateralized) external override {
        _requireCallerIsTroveManager();
        require(contains(_id), "SortedTroves: Id not found");
     ...
     */
    function getUnderCollateralizedTrovesSize() external view override returns (uint256) {
