...
/**
* This smart contract handles the transactions for the Booza wager games.
*/
contract BoozaWagerGame {
    ...
    */
    ...
    mapping(string => Game) private games; // active wager games the initiator used as the key for the active game
    ...
    * This utilises "basis points" for the calculation.
    */ 
