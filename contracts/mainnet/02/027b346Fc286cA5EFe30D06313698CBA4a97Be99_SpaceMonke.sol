...
contract SpaceMonke is ERC721 {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeibsr4jjvecdl7kde75ier5cum2rbzoxrz2tkj4h3pz4yrb5qxbhse/", Strings.toString(tokenId), ".json")
            );
    }
