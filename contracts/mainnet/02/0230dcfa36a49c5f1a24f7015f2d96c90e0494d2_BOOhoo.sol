...
contract BOOhoo is ERC721URIStorage,Ownable{
  ...
  ERC721Enumerable contract1 = ERC721Enumerable(0x27445b5F0f97dB4729A6cACE3A52ac42080Df8c9);
  ERC721Enumerable contract2 = ERC721Enumerable(0x27445b5F0f97dB4729A6cACE3A52ac42080Df8c9);
  constructor() ERC721("Pixel BOOhoos", "pBOO") {
    _customBaseURI = 'ipfs://bafybeiczzvt4dkcdvnx5xevxdglgd5rpysxbeww63fkecxqvarjduz3m34/';
    _price = 0;  
    _maxMintable = 1234; 
    _royaltyAmount = 750;
    _maxMintPerTx = 10; 
  ...
  function mint(uint256 quantity) public payable {
    require(isHolder(msg.sender), "not a holder of qualifying collections, wait until public sale");
