...
contract Kevin is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 KEVIN
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Kevin Shares", "KEVIN") {
        _mint(msg.sender, 1 ether); // mint 1 STUART Share for initial pools deployment
