...
contract PangolinYieldFarmReader {
  ...
  IPangolinYieldFarmManager public immutable manager;
    // WAVAX
  ...
  */
  constructor(
    ...
    IPangolinYieldFarmManager _manager
  ) {
  ...
  */
  function additionalCapacity() public view returns (uint256) {
    IPangolinYieldFarmVault.VaultConfig memory _vaultConfig = vault.vaultConfig();
