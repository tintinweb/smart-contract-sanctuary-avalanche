...
contract XShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("XSHARE", "XSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 PHOENIX Share for initial pools deployment
