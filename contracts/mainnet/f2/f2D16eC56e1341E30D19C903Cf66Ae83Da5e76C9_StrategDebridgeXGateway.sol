...
contract StrategDebridgeXGateway is Ownable, IStrategXGateway {
    ...
    function migrateToXChainVault(
        ...
        IERC20(_fromAsset).approve(address(deBridgeGate), _fromAmount);
    ...
    function xReceive(
        ...
        _receiveXChainMigration(_receiver, _vault, asset, _amount);
    ...
    function _receiveXChainMigration(
        ...
        IERC20(_asset).approve(_vaultTargeted, _amount);
        IStrategVault(_vaultTargeted).deposit(_amount, _receiver);
    }
