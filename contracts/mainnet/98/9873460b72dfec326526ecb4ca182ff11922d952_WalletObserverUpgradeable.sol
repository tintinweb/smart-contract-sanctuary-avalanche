    ...
    PlanetsManagerImplementationPointerUpgradeable
{
    ...
    function outOfCirculatingSupply() external view returns (uint256) {
        uint256 _out = 0;

        // launch snipers
        _out += universe.balanceOf(0x17a3695c2e4F182E8E42C0BE8387e367D603b3bE);

        // pswole wallets that still contains UNIV
        _out += universe.balanceOf(0xb7e6228D8c37626C6AcF8410248E1559819aa092);
        _out += universe.balanceOf(0xABdAfad5df04c728FfF5F58589079B0D1B49F200);
        _out += universe.balanceOf(0xE366cBAb8026e60bcEB77A670b6110C599c57719);
        _out += universe.balanceOf(0x275baB159E26871e143e9C7813fe7BE409C15177);
        _out += universe.balanceOf(0xAbf89da69B86d261755a2629967ef71da53b20D2);
        _out += universe.balanceOf(0x7eF506214e327e41060B3f01d0ffb90288372CE7);
        _out += universe.balanceOf(0xAD808e43E9df338B8aF0B5cf72732783c26778A8);
        _out += universe.balanceOf(0xa14D614677992dbFfA064B7E0bB2EA19d76AED7e);
        _out += universe.balanceOf(0x6dd0a50316e382Ddd1BaeDF20C151396615306bD);
