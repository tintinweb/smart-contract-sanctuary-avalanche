...
contract DistrictManager is Ownable, HelperOwnable, IERC721, IERC721Metadata {
    ...
    ITaxManager public taxManager = ITaxManager(0x69E3D6ecCE4584e71E2CfF4ab3C0e2A9B8Cee327);
    ...
    function compoundAndCreateNode(string memory _name, uint64[] memory userNodes, bool useBalance) public {
        ...
        uint256 nodePrice = nodePlaymatePrice * 10 ** 18;
        require(nodePrice > 0, "error");
        uint256 availableRewards = manager.getAddressRewards(sender) * manager.getUserMultiplier(sender);
        ...
        if (availableRewards >= nodePrice) {
          ...
          MANSIONSHEPLER.claimUtility(userNodes, REWARDS_POOL, nodePrice, address(taxManager));
          ...
          MANSIONSHEPLER.claimUtility(userNodes, REWARDS_POOL, availableRewards, address(this));
        }
        createNode(sender, _name);
    }
