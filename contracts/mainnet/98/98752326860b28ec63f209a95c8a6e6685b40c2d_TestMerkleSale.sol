...
// File contracts/TestMerkleSale.sol
...
contract TestMerkleSale is AccessControl{
    ...
    function publicMint(uint256 _mintAmount) public payable {
        ...
        require(publicSale, "Publicsale isn't active.");
        ...
        payable
    {
        ...
        require(!publicSale, "Publicsale is active.");
    ...
    function setPresale(bool _state) public onlyRole(OPERATOR_ROLE) {
        presale = _state;
    }

    function setPublicSale(bool _state) public onlyRole(OPERATOR_ROLE) {
        publicSale = _state;
    }

    function setPresaleCost(uint256 _presaleCost) public onlyRole(OPERATOR_ROLE) {
        presaleCost = _presaleCost;
    }

    function setPublicCost(uint256 _publicCost) public onlyRole(OPERATOR_ROLE) {
        publicCost = _publicCost;
    }

    function setPublicMaxPerTx(uint256 _publicMaxPerTx) public onlyRole(OPERATOR_ROLE) {
        publicMaxPerTx = _publicMaxPerTx;
    }

    function setPresaleMaxPerWallet(uint256 _presaleMaxPerWallet) public onlyRole(OPERATOR_ROLE) {
    ...
    function _withdraw(address withdrawAddress, uint256 amount) public onlyRole(OPERATOR_ROLE) {
