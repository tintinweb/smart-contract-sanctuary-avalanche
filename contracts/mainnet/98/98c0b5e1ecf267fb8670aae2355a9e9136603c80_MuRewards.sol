...
contract MuRewards{
    ...
    IERC20 _muOre;
    constructor(){
        _iMuOre = IMuOre(0x34CDfD9bCa85a42665aCDfb29B745173941D083E);
        _muOre = IERC20(0x34CDfD9bCa85a42665aCDfb29B745173941D083E);
    }


    //this function allows the current owner to withdrawl any tokens that have been sent to this contract address
    function withdrawl(address token) public virtual  {
        IERC20 tokenContract = IERC20(token);
        //tokenContract.transfer(_treasury, amount);
        uint256 total_payment = tokenContract.balanceOf(address(this)) * 10**18;
        ...
        for(uint256 i = 0; i < payees.length; i++){
            ...
            reward_payment = (payment_shares * payment_sliver)/10**18;
