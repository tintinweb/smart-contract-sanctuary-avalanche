...
contract TournamentERC20 is Ownable, ITournament {
    ...
    constructor (address _wl, address _token, uint256 _periodSeconds, uint256 _roundSeconds, uint256 _breakevenSeconds, uint256 _ticketSize, uint256 _potShare, uint256 _gladShare, uint256 _burnShare, bool _nonBurnable, bool _deadress, address _treasury) {
