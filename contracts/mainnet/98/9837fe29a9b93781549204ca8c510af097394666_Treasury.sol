...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x1F9CEE7FDa6C4AE645e9034EA286470cBb4e639B), // GraveGenesisPool
        address(0x1c3B6f06D1830Dc93E3156E81A758989184F5D90) // new GraveRewardPool
    ];
    ...
    function initialize(
        ...
        gravePriceOne = 10**18; // This is to allow a PEG of 1 GRAVE per wAVAX
