...
contract ENC is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("ENC", "ENC") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 500000e18, "CONSTR: totalSupply must equal 500,000");
    ...
    function updateNodeRequired(bool newValue) external onlyOwner {
        nodeRequired = newValue;
    }
    ...
    function _transfer(
        ...
        if(nodeRequired && to == uniswapV2Pair && from != liquidityPool && from!=futurUsePool && from!=distributionPool && from!=address(this)) {
            require(nodeRewardManager._isNodeOwner(from),"NO NODE OWNER");
        }
