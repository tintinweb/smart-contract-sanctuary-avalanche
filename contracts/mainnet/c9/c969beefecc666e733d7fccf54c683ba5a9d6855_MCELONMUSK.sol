...
liquidity: 50% + 45 avax
#MCMetaverse fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCELONMUSK!
...
contract MCELONMUSK is Context, IERC20, Ownable {
    ...
    string private _name = 'MC ELON MUSK';
    string private _symbol = 'MC ELON';
