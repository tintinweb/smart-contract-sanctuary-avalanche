 ...
 */
contract BACKBENCHERS is IERC20, Ownable {
  using SafeMath for uint256;

  string private constant _name = "BACKBENCHERS";
  ...
  uint256 private constant MAX_SUPPLY = 10000000 * 10**_decimals;
  ...
  uint256 public stashInsuranceFundFee = 0;
