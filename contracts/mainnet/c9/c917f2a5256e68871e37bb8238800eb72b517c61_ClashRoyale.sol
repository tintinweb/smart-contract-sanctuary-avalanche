...
/**  btc is down right now thats why its good if you have some for when it goes up right ? well we will help you with that
 *   earn 6% btc rewards by holding Clash Royale we also made a clan in calshroyale make sure to join ours its in our TG!
*/
// SPDX-License-Identifier: MIT
  
//  Twitter  : https://twitter.com/ClashRCoin  
//  Telegram : https://t.me/ClashRoyale664
//  Rewards  : $WBTC
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x50b7545627a5162F82A992c33b87aDc75187B218); // reward address WBTC
...
contract ClashRoyale is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address $WBTC  = 0x50b7545627a5162F82A992c33b87aDc75187B218; // reward $WBTC 
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Clash Royale";
    string constant _symbol = "CLASH";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(40); // 6%
    uint256 public _maxWallet = _totalSupply.div(40); // 6%
    ...
    address public autoLiquidityReceiver=0xfae467EFAdC230851a8463E4b67EcceFC341AE0a; //liq address
    address public marketingFeeReceiver=0xfae467EFAdC230851a8463E4b67EcceFC341AE0a; // marketing address
