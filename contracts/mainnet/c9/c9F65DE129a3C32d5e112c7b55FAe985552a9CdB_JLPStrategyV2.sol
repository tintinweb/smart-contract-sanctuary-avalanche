...
contract JLPStrategyV2 is BaseStrategy {
    ...
    function baseApr() public view returns (uint256 joeDay) {
        ...
        uint256 joe = (masterchef.joePerSec() * allocPoint * 1e18 * 86400 * (10000 - veJoeShareBp)) /
            (masterchef.totalAllocPoint() * totalLpSupply * 10000);

        /*uint256 joeSpeed = (masterchef.joePerSec() * allocPoint * 1e18 * 86400 * veJoeShareBp) /
            (masterchef.totalAllocPoint() * totalFactor * 10000);*/

        joeDay = (joe * joeToUSD) / lpToUSD;
    }
