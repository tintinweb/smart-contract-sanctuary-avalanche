...
contract nftsimple is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("Po-ta-toes", "POTATOES") {
    _customBaseURI = 'https://my-nft-api.com/nfts/';
    _price = .5 ether; // 1 AVAX mint price 
    _maxMintable = 50; // 10k max supply
    _royaltyAmount = 500; // 7% royalties
