...
contract Peach is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 40,000 PEACH
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 32000 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Peach Shares", "PEACH") {
        _mint(msg.sender, 1 ether); // mint 1 PEACH Share for initial pools deployment
