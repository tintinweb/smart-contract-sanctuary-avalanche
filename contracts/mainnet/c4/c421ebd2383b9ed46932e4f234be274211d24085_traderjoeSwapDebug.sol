...
// File: contracts/interfaces/IDSOracle.sol
...
// File: contracts/swapHelper/traderjoeSwap.sol
...
contract traderjoeSwap is ImportOracle {
    ...
    function swapToken_exactOut(address token0,address token1,uint256 amountMaxIn,uint256 amountOut,address to) internal returns (uint256){
    ...
    function swapToken_exactOut_oracle(address token0,address token1,uint256 amountOut,uint256 slipRate,address to) internal returns (uint256){
...
// File: contracts/debug/traderjoeSwapDebug.sol
