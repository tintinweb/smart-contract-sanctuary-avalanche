/**
 *Submitted for verification at snowtrace.io on 2023-05-25
*/
...
// Change Name
contract Synthorix is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "ipfs://bafybeige6mqlodtoanxnitwsggax7ipizcuh6jkmgvfgfietfzvtpfitsa/";
    ...
    constructor() ERC721A("Synthorix", "SYNTHORIX") {
        // Mint the first token to deployer address
        
        _mint(msg.sender, 202);
    }
