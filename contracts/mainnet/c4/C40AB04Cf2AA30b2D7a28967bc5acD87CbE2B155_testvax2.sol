...
contract testvax2 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA7A47a8403e54dcB598BC7E1b26090b42051A007; // avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "TestVax2";
    string constant _symbol = "TVAX2";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(1000); // 
    uint256 public _maxWallet = _totalSupply.div(1000); // 
    ...
    address public autoLiquidityReceiver=0x9911B070e9208892e7135Fd47b5Fd5af2242155c;
    address public marketingFeeReceiver=0x47493c03113B0eE01FF4A1012bF0B5D1215A546B;
