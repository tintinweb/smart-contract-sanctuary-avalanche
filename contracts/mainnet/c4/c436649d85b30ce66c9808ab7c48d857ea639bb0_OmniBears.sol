...
contract OmniBears is Ownable, ERC721, NonblockingReceiver {
    ...
    uint256 MAX_MINT_AVAX = 2400;
    uint256 public mintPrice = 1.6 ether;
    ...
    // first 100 NFTs for free then for 1.6 AVAX ( MAX 3 NFT PER WALLET)
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens <= MAX_MINT_AVAX, "Mint exceeds supply");
        if (nextTokenId + numTokens > 2100) {
            require(
