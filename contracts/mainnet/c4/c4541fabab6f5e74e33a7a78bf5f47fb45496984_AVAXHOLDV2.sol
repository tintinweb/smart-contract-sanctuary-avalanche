...
contract AVAXHOLDV2 {
	...
	uint256[] public REFERRAL_PERCENTS = [10, 40, 15];
	...
	constructor(address payable marketing, uint256 startDate)  {
		...
		startUNIX = startDate; // 1650295800 

		plans.push(Plan(14, 85)); // 8.5% per day for 14 days
        plans.push(Plan(21, 71)); // 7.1% per day for 21 days
        plans.push(Plan(28, 64)); // 6.4% per day for 28 days
		plans.push(Plan(14, 135)); // 13.5% per day for 14 days (at the end)
        plans.push(Plan(21, 114)); // 11.4% per day for 21 days (at the end)
        plans.push(Plan(28, 110)); // 11% per day for 28 days (at the end)
	}
