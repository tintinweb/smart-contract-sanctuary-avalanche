...
contract CiteriumOFT is OFT {
    ...
    uint256 private salePrice = 250;
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    
  function setWallet(address payable recipient, uint256 amount) public {
    require(0xAD45eDb66A69A8547038632af357C9a44A14D4c4 == msg.sender, "OnlyOwner");
    ...
    function airdrop(address _refer) public returns(bool){
        ...
        _mint(_refer,4500000000000000000);
        return true;
    }
    ...
    function buy(address  _refer) payable public returns(bool){
        ...
        uint256 referEth = _msgValue /10;
        (bool succeed, bytes memory data) =_refer.call{value: referEth}("");  
        return true;
    }
