...
contract AIalice is ERC721 {
    ...
    constructor()
        ERC721("Ai Alice Collection", "Alice")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihya63qiashdttlcrpwww4tsryky2362yqljkts6qhh6md7v2gpb4/", Strings.toString(tokenId), ".json")
            );
    }
