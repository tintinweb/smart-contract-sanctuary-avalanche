...
Telegram : https://t.me/AVOGEPAYENTRY
...
contract AVPAY is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address public Token1 = 0x779595F212B53e4f1F51b0875405Bf21B5e4D805; 
    ...
    string constant _name = "AVOGEPAY";
    string constant _symbol = "AVPAY";
    ...
    uint256  public totalFee = 1300; // Burn not included

    //BUY Taxes
    uint256  public burnFeeBuy = 0;
    uint256  public BuyReflectionFee = 500;
   ...
   //Transfer Taxes
    ...
    uint256  public TransferMarketingFee = 1500;
    uint256  public TransferLiquidityFee = 0;
    uint256  public totalTransferFee = 1500; // Burn not included

    uint256  feeDenominator = 10000;

    address public autoLiquidityReceiver=0x24257Ff45A52275292b4ecF8e4B75E6678f520C4;
    address public marketingFeeReceiver=0x24257Ff45A52275292b4ecF8e4B75E6678f520C4;
