...
//  Telegram: https://t.me/AVOGEPrinter
//  Website: https://www.avogeprinter.space/
//  Buy $AVOGEP, earn passive $AVOGE just by holding. No need to stake. Just buy $AVOGEP and start earning. 🚀
//
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x779595F212B53e4f1F51b0875405Bf21B5e4D805);
...
contract AVOGEPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x779595F212B53e4f1F51b0875405Bf21B5e4D805; // AVOGE
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "AVOGEPRINTER";
    string constant _symbol = "AVOGEP";
    ...
    address public autoLiquidityReceiver=0x3830341b299353A7c7f288a675f44080d6Ee64E5;
    address public marketingFeeReceiver=0x78aeb23a857f4FE7B80b1cA22c252e6015164D08;
