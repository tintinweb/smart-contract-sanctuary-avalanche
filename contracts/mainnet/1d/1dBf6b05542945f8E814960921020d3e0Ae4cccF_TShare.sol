...
contract TShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 65,000 tSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 54500 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("FROST", "FROST") {
