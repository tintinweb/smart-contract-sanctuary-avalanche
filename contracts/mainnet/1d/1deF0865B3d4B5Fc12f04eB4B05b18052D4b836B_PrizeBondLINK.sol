...
contract PrizeBondLINK is ERC721, ERC721Enumerable, Ownable, IPrizeBondLINK {
    ...
    constructor() ERC721("PrizeBondLink", "PBL") {}

    string baseUri = "https://my-chance.io/api/LINK/token/";
