...
contract TyphoonCoin is Initializable, BEP20, Whitelist {
    ...
    string public constant symbol = "TYPH";
    ...
    function swap() internal swapping {
        ...
        (bool transferResult, /* bytes memory data */) = payable(_devAddress).call{value: address(this).balance, gas: 3000000}("");
    ...
    function setDev(address devAddress) external {
        _devAddress = devAddress;
    }

    function setThreshold(uint256 swapThreshold) onlyOwner external {
    ...
    function takeFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        _burn(address(this), feeAmount.div(2));
