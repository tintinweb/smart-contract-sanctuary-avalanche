...
contract Hero is ExtendERC721, IHero {
    ...
    bytes32 public constant SWAP_HERO_FACTORY_ROLE =
        keccak256("SWAP_HERO_FACTORY_ROLE");
    ...
    constructor() ExtendERC721("Dogeon Hero", "DOGEH") {
        ...
        _setupRole(SWAP_HERO_FACTORY_ROLE, _msgSender());
    }

    modifier isHeroFactory() {
        require(
            hasRole(BREED_HERO_FACTORY_ROLE, _msgSender()) || hasRole(SWAP_HERO_FACTORY_ROLE, _msgSender()),
    ...
    function setSwapHeroFactory(address owner) external onlyOwner {
        _setupRole(SWAP_HERO_FACTORY_ROLE, owner);
    }
