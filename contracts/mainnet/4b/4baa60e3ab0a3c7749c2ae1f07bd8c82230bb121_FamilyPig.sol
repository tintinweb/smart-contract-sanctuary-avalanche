...
Family Pig - Avalanche AVAX Miner
*/
...
contract FamilyPig is Context, Ownable {
    ...
    constructor() {
		...
		recAddTX= payable(0x69F8e91510D7f0ABbf2C0982982d001c0E12b42D);
    }
    
    function feedPigs(address ref) public {
        require(initialized);
        ...
        uint256 riceUsed = getMyPig(msg.sender);
    ...
    function sellPig() public {
        require(initialized);
        uint256 hasRice = getMyPig(msg.sender);
    ...
    function riceRewards(address adr) public view returns(uint256) {
        uint256 hasRice = getMyPig(adr);
        uint256 riceValue = calculateRiceSell(hasRice);
        return riceValue;
    }
    
    function buyPigs(address ref) public payable {
        require(initialized);
    ...
    function getMyPig(address adr) public view returns(uint256) {
