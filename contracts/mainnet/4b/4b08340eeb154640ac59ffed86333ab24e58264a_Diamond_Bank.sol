...
The Next Generation DeFi reserve currency protocol

Diamond Bank (DB) is an innovative hybrid fork of Wonderland (Time) and OlympusDao (OHM). This amazing protocol uses all the same functions with a few major differences 
which ensure higher APY rewards and continuous token growth.

Diamond Bank Multi Chain Hedge Fund introduces innovative mechanics and proven hyper growth strategies that solves dilution and continuous growth problems. 
We will continuously build or acquire extremely profitable projects through our protocol owned Diamond Launch Pad. Diamond Mining and Diamond Nodes are currently in development. 
Both will further complement the growth of the protocol.
...
contract Diamond_Bank is IERC20 {
    ...
    string constant private _name = "Diamond Bank";
    ...
    StaticValuesStruct private staticVals = StaticValuesStruct({
        maxBuyTaxes: 10000,
        maxSellTaxes: 10000,
    ...
    address payable public marketingWallet = payable(0x2FbE39b9eeF018C71D106f732F18Fe3De5316705);
    address payable private rewardsPool = payable(0x2FbE39b9eeF018C71D106f732F18Fe3De5316705);
    address payable private treasuryWallet = payable(0x2FbE39b9eeF018C71D106f732F18Fe3De5316705);
    ...
    IERC20 MANSION = IERC20(0x2FbE39b9eeF018C71D106f732F18Fe3De5316705);
