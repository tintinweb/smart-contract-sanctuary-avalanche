...
liquidity: 30% + 30 avax
#MCPUTIN fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes MCPUTIN!
...
contract MCPUTIN is Context, IERC20, Ownable {
    ...
    string private _symbol = 'MC PUTIN';
