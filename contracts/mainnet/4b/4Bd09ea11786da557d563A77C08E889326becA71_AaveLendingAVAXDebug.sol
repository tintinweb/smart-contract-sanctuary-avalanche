...
// File: contracts/superToken/AAVELendingToken/AaveLendingAVAX.sol
...
//
// This contract handles swapping to and from superToken.
contract AaveLendingAVAX is AaveSuperAVAX,lendingSuperToken {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    // Define the qiToken token contract
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,address _wavax,
...
// File: contracts/debug/AaveLendingAVAXDebug.sol
...
//
// This contract handles swapping to and from superToken.
contract AaveLendingAVAXDebug is AaveLendingAVAX,debugger {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    // Define the qiToken token contract
    constructor(address multiSignature,address origin0,address origin1,address _stakeToken,address _wavax,
    address payable _swapHelper,address payable _FeePool,address leverageFactory)
        AaveLendingAVAX(multiSignature,origin0,origin1,_stakeToken,_wavax,_swapHelper,_FeePool,leverageFactory){
