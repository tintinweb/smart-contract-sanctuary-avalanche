...
// File contracts/LqdrUsdcSoliSnek.sol

//SPDX-License-Identifier: MIT

pragma solidity 0.8.17;
contract LqdrUsdcSoliSnek  is Ownable, Pausable {
    ...
    address public constant lqdr = address(0x5fE80d2CD054645b9419657d3d10d26391780A7B);
    ...
    ISoliSnekRouter.Routes[] public snekToLqdrPath;
    ...
    constructor(
        ...
        ISoliSnekRouter.Routes[] memory _snekToLqdrPath,
        ...
        for (uint i; i < _snekToLqdrPath.length; ++i) {
            snekToLqdrPath.push(_snekToLqdrPath[i]);
        }
    ...
    function addLiquidity() internal {
        ...
        ISoliSnekRouter(router).swapExactTokensForTokens(snekHalf, 0, snekToLqdrPath, address(this), block.timestamp);

        uint256 t1Bal = IERC20(usdc).balanceOf(address(this));
        uint256 t2Bal = IERC20(lqdr).balanceOf(address(this));

        ISoliSnekRouter(router).addLiquidity(usdc, lqdr, stable, t1Bal, t2Bal, 1, 1, address(this), block.timestamp);
    }
