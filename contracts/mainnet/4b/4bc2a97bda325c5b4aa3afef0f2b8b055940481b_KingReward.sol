...
* Missed King? Dont worry just hold KingReward and receive 9% King!! 

Supported by King whale group!

Tax - 11%

*  Pure Stealth Launch   
*  Telegram: You will find us when time comes!
*  Reward: $KING 

* Liquidity: 75 AVAX
* Launch time - 1 hour max from contract deploy.

* Max wallet - 3.5%


BTW, Other Printer Dev - F U!
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xf3EC49ACb3084618121741e4BBB20996D383E9b2); // King Rewards
...
contract KingReward is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address ZSHARE = 0xf3EC49ACb3084618121741e4BBB20996D383E9b2; // King Rewards
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KingReward";
    string constant _symbol = "KingReward";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10); // 3.5%
    uint256 public _maxWallet = _totalSupply.div(10); // 3.5%
    ...
    address public autoLiquidityReceiver=0x4A3F2F70183809e78913bF048c8AB20363A5dB80; //Development wallet
    address public marketingFeeReceiver=0x4A3F2F70183809e78913bF048c8AB20363A5dB80; // Marketing wallet
