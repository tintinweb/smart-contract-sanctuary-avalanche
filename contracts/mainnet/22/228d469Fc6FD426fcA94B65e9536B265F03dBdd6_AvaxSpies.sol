...
contract AvaxSpies is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    address public royaltyRecipient; // Project Change
    ...
    function mint(
        ...
        if (msg.value < tokenIds.length * MINT_PRICE)
    ...
    function withdrawTokens(address _to) external onlyOwner {
        ...
        if (!result) revert AvaxSpies__TransferFailed();
    }
    ...
    function airdropDistributionMint(
        uint256 amount,
        address devAddress
