...
/** 
 *  SourceUnit: d:\GitHub\AvaDice\AvaDice_DiceGame\contracts\AVAX\GordionStrongboxAvaDice_v2.sol
*/
...
contract GordionStrongbox_v2 {
    ...
    function claimRewards() external {
        ...
        for (uint i = 0; i < count; i++) {
            ...
            require(isRegistered[tokenId], "Token is not registered. Please contact support.");
