...
contract flashSwap{
    ...
    function getReserves(address pool0,address pool1) internal view returns (uint112 a1,uint112 b1,uint112 a2, uint112 b2){
    ...
    function joeCall(
        ...
        uint256 ethBefore = IERC20Joe(WAVAX).balanceOf(address(this));
        ...
        require(IERC20Joe(WAVAX).balanceOf(address(this)) >= ethBefore, "ETH not enough"); 
    }
