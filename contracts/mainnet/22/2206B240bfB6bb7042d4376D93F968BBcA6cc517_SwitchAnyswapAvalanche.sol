...
contract SwitchAnyswapAvalanche is SwitchAvalanche {
    ...
    function transferByAnyswap(TransferArgsAnyswap calldata transferArgs) external payable {
        ...
        (address underlyingToken, bool isNative) = _getUnderlyingToken(transferArgs.bridgeSrcToken, anyswapRouter);
        ...
        if (isNative) {
            ...
            if (transferArgs.bridgeSrcToken != underlyingToken) {
