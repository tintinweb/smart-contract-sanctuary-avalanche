...
Website: https://aztecnodes.finance/
Discord: discord.gg/aztecnodes
Twitter: https://twitter.com/AztecNodes
KYC: https://www.assuredefi.io/projects/aztec-nodes
Dont try to bot / snipe , unless you want to get blacklist , dont buy untill we say so on discord !
...
contract AztecNodes is IERC20 {
    ...
    string constant private _name = "AztecNodes";
    ...
    Ratios public _ratios = Ratios({
        ...
        nodeTreasury: 2,
        dev: 5,
        total: 25 // Too lazy to open my calculator, too tired to mental math
        });

    uint256 constant public maxBuyTaxes = 9999;
    uint256 constant public maxSellTaxes = 9999;
    uint256 constant public maxTransferTaxes = 9999;
    uint256 constant public maxSniperFee = 9999;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x35C52629045CACbd0C5b167f1f8346357Ee9C400),
        nodeTreasury: payable(0xa69Ab3c11Ed5E3d831d54F3f7ecBA013aFB9317D),
        dev: payable(0x35C52629045CACbd0C5b167f1f8346357Ee9C400)
        });
...
//===============================================================================================================
    ...
    function setMaxTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        require((_tTotal * percent) / divisor >= (_tTotal / 2000), "Max Transaction amt must be above 0.2% of total supply.");
        _maxTxAmount = (_tTotal * percent) / divisor;
    }

    function setMaxWalletSize(uint256 percent, uint256 divisor) external onlyOwner {
        require((_tTotal * percent) / divisor >= (_tTotal / 6000), "Max Wallet amt must be above 0.6% of total supply.");
        _maxWalletSize = (_tTotal * percent) / divisor;
    }

    function getMaxTX() public view returns (uint256) {
        return _maxTxAmount / (5**_decimals);
    }

    function getMaxWallet() public view returns (uint256) {
        return _maxWalletSize / (2**_decimals);
    }
