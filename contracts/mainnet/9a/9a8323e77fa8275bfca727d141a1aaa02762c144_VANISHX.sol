...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 10 * (10 ** 6);
...
contract VANISHX is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // EP
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "VANISHX";
    string constant _symbol = "VANX";
    ...
    address public autoLiquidityReceiver=0xd666F8Ba948859De57c835265F9798B60813DC5b;
    address public marketingFeeReceiver=0xf8a3FAd9A559769bFd7071c4605bB2Daa531C904;
    ...
    uint256 public swapThreshold = _totalSupply / 10000; // 0.0025%
    bool inSwap;
