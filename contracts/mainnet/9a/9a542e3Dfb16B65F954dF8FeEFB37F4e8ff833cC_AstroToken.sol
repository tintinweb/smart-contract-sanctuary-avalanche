...
contract AstroToken is ERC20Detailed {
    ...
    address public liquidityReceiver = 0x1e856b6e73004426030808E826d739a0B88F04fE; 
    address public treasuryReceiver = 0x8073696eC1b7D647520ccdDa10760Be8B14Dd0B1;
    address public riskFreeValueReceiver = 0xa9f0b40d48E2B6de49f3824C70662D0F2ca470AA;
    address public operationsReceiver = 0x173c61b754d32634a44f1f41bD4E250b5b6a589B;
    address public xASTROReceiver = 0x7D079c899a085fdD3660e527DC34aD9139BEe20f;
    address public futureEcosystemReceiver = 0x19725b5e021DAEb5f84E8228da3FD0a34FF4Bad6;
    address public burnReceiver = 0x041BEaD68498A623d3759559149B2A4E9D9AA331;
    ...
    */
    ...
    modifier onlyOwner {
        require(msg.sender == owner, "AstroToken: Caller is not owner of the contract.");
        _;
    }
    ...
    constructor(address _router, address _usdcAddress) ERC20Detailed("100 Days Ventures", "ASTRO", uint8(DECIMALS)) {
        owner = msg.sender;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (
            ...
            require (_userSellInfos[sender].sellAmount + onceUSC <= maxSellTransactionAmount, "User can't sell more than maxSellAmount");
