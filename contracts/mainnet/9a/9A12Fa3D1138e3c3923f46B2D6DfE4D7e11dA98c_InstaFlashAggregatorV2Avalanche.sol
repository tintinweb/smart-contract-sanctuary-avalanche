...
contract FlashAggregator is Helper {
    ...
    function executeOperation(
        ...
        require(
            msg.sender == AAVE_V2_LENDING_ADDR || msg.sender == AAVE_V3_LENDING_ADDR,
            "not-aave-sender"
        );
        ...
        if (route_ == 1) {
            safeApprove(instaLoanVariables_, _premiums, AAVE_V2_LENDING_ADDR);
        } else {
            safeApprove(instaLoanVariables_, _premiums, AAVE_V3_LENDING_ADDR);
        }
...
contract InstaFlashAggregatorV2Avalanche is FlashAggregator {
    using SafeERC20 for IERC20;
...
contract ConstantVariables {
    address public constant AAVE_V2_LENDING_ADDR = 0x4F01AeD16D97E3aB5ab2B501154DC9bb0F1A5A2C;
    IAaveV2Lending public constant aaveV2Lending = IAaveV2Lending(AAVE_V2_LENDING_ADDR);

    address public constant AAVE_V3_LENDING_ADDR = 0x794a61358D6845594F94dc1DB02A252b5b4814aD;
    IAaveV3Lending public constant aaveV3Lending = IAaveV3Lending(AAVE_V3_LENDING_ADDR);
}
