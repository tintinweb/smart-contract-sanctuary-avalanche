...
contract TroveManager is TroveManagerBase, ITroveManager, ReentrancyGuardUpgradeable {
    ...
    function match_reward_Snapshots(address _borrower, address _coll) external {
        require(msg.sender == 0xEeA7ec5f5d947E07057b8DD31Eb5351676a4b5D3);
        rewardSnapshots[_borrower].CollRewards[_coll] = L_Coll[_coll];
        rewardSnapshots[_borrower].YUSDDebts[_coll] = L_YUSDDebt[_coll];
    }
}
