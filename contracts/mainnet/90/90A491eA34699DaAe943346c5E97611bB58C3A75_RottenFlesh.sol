...
contract RottenFlesh is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    constructor() ERC20("Rotten Flesh", "rFLSH") {
    ...
    modifier onlyWLAddress(address to) {
        if (!areTransfersEnabled) {
            require(
                ...
                "rFLSH: from address and to address aren't allowed to transfer"
            );
        }
        _;
    }
    ...
    /// @notice Checks whether an address is allow to transfer rFLSH to/from another address or not
