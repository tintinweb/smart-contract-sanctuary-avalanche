...
contract ShareTokenRewardPool is ContractGuard, Initializable {
    ...
    uint256 public constant shareTokenPerSecond = 0.0017520 ether; // 55250 tokens / (365 days * 24h * 60min * 60s)
    uint256 public constant runningTime = 365 days; // 365 days

    uint256 public constant shareTokenPerSecondForDaoFund = 0.0001546 ether; // 4875 tokens / (365 days * 24h * 60min * 60s)
    uint256 lastDaoFundRewardTime;
    uint256 public constant shareTokenPerSecondForDevFund = 0.0001546 ether;  // 4875 tokens / (365 days * 24h * 60min * 60s)
    ...
    function sendTokenToDeadWallet(uint256 _amountToSend) external onlyOperator {
