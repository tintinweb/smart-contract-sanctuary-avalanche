...
contract ipSHARERewardPool {
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "ipSHARERewardPool: caller is not the operator");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _token) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].token != _token, "ipSHARERewardPool: existing pool?");
        }
    }
