...
// File contracts/distribution/GenesisLINKRewardPool.sol
...
contract GenesisLINKRewardPool {
    using SafeMath for uint256;
    ...
    // MAINNET
    uint256 public tokenPerSecond = 0.243055556 ether; //
    uint256 public runningTime = 1 days; // 1 days
    uint256 public constant TOTAL_REWARDS = 21000 ether;
    // END MAINNET
