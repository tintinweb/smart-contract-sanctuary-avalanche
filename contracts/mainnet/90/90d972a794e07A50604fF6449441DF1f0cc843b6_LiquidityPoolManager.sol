...
import "../implementations/output/ParticleImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    ParticleImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x5CB0d6c2833F3127665c2b949AD6E70d4968f32D), // Treasury investments (30%)
        address(0xeDA6d83a9Bb35A163054A0DbDDa375D698A201F4), // Dev (35%)
        address(0x24b9f6fA04283434C0120a36f94b25F090f20F14) // Marketing (35%)
    ];
    uint8[] public feePercentages = [30, 35, 35];
    ...
    constructor(
        ...
        changeParticleImplementation(address(leftSide));
...
abstract contract ParticleImplementationPointer is Ownable {
