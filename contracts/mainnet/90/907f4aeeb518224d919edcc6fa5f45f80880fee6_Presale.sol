...
contract Presale is Ownable {
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        if(weiRaised < 500) {
            return weiAmount.mul(135_000);
        } else if(weiRaised < 1000) {
            return weiAmount.mul(120_000);
        } else if(weiRaised < 1500) {
            return weiAmount.mul(105_000);
        } else if(weiRaised < 2000) {
            return weiAmount.mul(100_000);
        } else {
            return weiAmount.mul(90_000);
        }
    }
