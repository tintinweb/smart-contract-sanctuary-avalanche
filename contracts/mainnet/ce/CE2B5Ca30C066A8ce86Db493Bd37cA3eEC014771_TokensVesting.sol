...
contract TokensVesting is Ownable {
    ...
    uint256 public phaseSequence = 3 * 30 days;         //3 months of phase sequence
    ...
    constructor(address _token, address _crowdsaleAddress) {
        require(
            _token != address(0),
    ...
    function startTheVesting() public onlyOwner {
        require(startTime == 0, "TokensVesting: already started!");
        startTime = block.timestamp;
        firstUnlock = 1670428762;    //unix time 7 dec 2022
    }
