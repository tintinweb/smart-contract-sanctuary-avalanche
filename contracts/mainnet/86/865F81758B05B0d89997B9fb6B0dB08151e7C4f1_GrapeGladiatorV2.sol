...
contract GrapeGladiatorV2 is Ownable {
    ...
    function tournamentsToPwn() public view returns (IERC20[] memory) {
        IERC20[] memory result = new IERC20[](tokens.length - 1);
    ...
    function fireSatelliteCannons(IERC20[] memory _tokens) public {
        for (uint256 i = 0; i < _tokens.length; i++) {
