...
TG @AVOSHIB
STEALTH LAUNCH ON AVAX TRADE ON JOETRADER
TOKENOMICS 
4% liquidity
6% marketing
...
contract AVOSHIB is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x5bf1cD8a63f60E6301cCBFe3b8765664775638F3; // avax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Avoshib";
    string constant _symbol = "AVOSHIB";
    ...
    address public autoLiquidityReceiver=0x08941F51165671c4d1276fe9d4bF994315EFd2C5;
    address public marketingFeeReceiver=0xc698044976454A8dD6a2b4F6DDAa0Df078cf2e9E;
