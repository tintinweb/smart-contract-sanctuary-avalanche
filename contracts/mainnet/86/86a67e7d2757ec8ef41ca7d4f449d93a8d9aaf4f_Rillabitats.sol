...
// Rillabitats by xrpant - Modified from Campfire's Leopard Queens contract
...
contract Rillabitats is ERC721, Ownable, ReentrancyGuard, KindaRandom {
    ...
    constructor() ERC721("Rillabitats", "RLBT") KindaRandom(150) {
        _customBaseURI = "ipfs://bafybeieacfv6nxkkth7xi5iljrudmmuojdek77amgw7dh7zvjvgv37j2li/";
        _customURIExtension = ".json";
        _maxMintable = 150; 
        _royaltyAmount = 500;
        _startTime = 1666123200;
        _maxMintPerTx = 2;
        _apePrice = 0.8 ether;
        _publicPrice = 1 ether;

        _apes = IERC721(0x6d5087B3082f73D42a32D85e38BC95dcceDe39Bb);
        _rillaz = IERC721(0x16B48d4577c43949b824C7FB2c01C2DdB2aEFd45);

        // mint for costo
        _privateMint(0xd00d20D6182D016788f96C3b3Dd35603D4cB67Dc);
        _privateMint(0xd00d20D6182D016788f96C3b3Dd35603D4cB67Dc);
        _privateMint(0xd00d20D6182D016788f96C3b3Dd35603D4cB67Dc);
        _privateMint(0xd00d20D6182D016788f96C3b3Dd35603D4cB67Dc);
        ...
        // mint for gerhard
        _privateMint(0xE10985548E2B45724F2304428FB0B8f644C45206);
        _privateMint(0xE10985548E2B45724F2304428FB0B8f644C45206);
        _privateMint(0xE10985548E2B45724F2304428FB0B8f644C45206);
    }
    ...
    function setApePrice(uint256 newAmount_) public onlyOwner {
        _apePrice = newAmount_;
    }

    function setPublicPrice(uint256 newAmount_) public onlyOwner {
        _publicPrice = newAmount_;
    }

    function setStartTime(uint256 newAmount_) public onlyOwner {
        _startTime = newAmount_;
    }

    function airdropToRillaz(uint256 start, uint256 end) public onlyOwner {
        for(uint256 i = start; i <= end; i++) {
            address rilla = _rillaz.ownerOf(i);
            _privateMint(rilla);
        }
    }
    ...
    function mint(uint256 quantity) public payable nonReentrant {
        if (msg.sender != owner()) {
            require(block.timestamp >= _startTime, "Minting is not active.");
            require(quantity <= _maxMintPerTx, "Cannot mint that many.");
            require(msg.value == (quantity * priceFor(msg.sender)), "Incorrect amount of AVAX sent.");
        }
    ...
    function priceFor(address account) public view returns (uint256) {
        if (_apes.balanceOf(account) > 0 ||
            _rillaz.balanceOf(account) > 0) {
                return _apePrice;
            } else {
                return _publicPrice;
            }
