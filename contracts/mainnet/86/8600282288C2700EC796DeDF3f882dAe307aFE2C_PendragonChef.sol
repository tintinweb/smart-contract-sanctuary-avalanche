...
contract PendragonChef is Ownable {
    ...
    address public PLATFORM_ADDRESS = 0x5f51bbA72634A1cD9435C1d06D2886189F08DE94;
    ...
    function setRewardMinter(IPendragonStaking _rewardMinter) external {
        require(address(rewardMinter) == address(0), "PendragonChef::setRewardMinter: Cannot redefine rewardMinter");
