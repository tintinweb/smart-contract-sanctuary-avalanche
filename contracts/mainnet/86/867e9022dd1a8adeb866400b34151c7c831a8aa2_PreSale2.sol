...
contract PreSale2 is Ownable {
    ...
    address public Recipient = 0x879414F750F4975e76c8AC6A2133aacddAD8e22C;
    ...
    uint256 public totalRaisedAmountFromPB = 0; // total USDC raised by sale
    uint256 public totaltokenSold = 0;

    uint256 public startTime = 1660932000;
    uint256 public endTime = 1661018400;
    ...
    function openPublic() external onlyOwner {
        ...
        isPrivate = false;
        startTime = 1661025600;
        endTime = 1661198400;
        hardCap = 400000 * 10 ** RCTOKEN_DECIMAL;
        tokenPrice = 16;
    }
    ...
    function deposit(uint256 amount) public checkIfPaused {
        ...
        if(!isPrivate){
            totalRaisedAmountFromPB = totalRaisedAmountFromPB.add(amount);
        }
