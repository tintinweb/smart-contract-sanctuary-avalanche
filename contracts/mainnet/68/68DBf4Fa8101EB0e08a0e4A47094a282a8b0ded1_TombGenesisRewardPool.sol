...
// Note that this pool has no minter key of MYSTIK (rewards).
// Instead, the governance will call MYSTIK distributeReward method and send reward to this pool at the beginning.
contract TombGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.14467 ether; //  TOMB / (48h * 60min * 60s)
