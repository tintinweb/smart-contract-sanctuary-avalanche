...
contract Shibtama is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shibtama Inu";
    string private constant _symbol = "SHIBTAMA";
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            buyback: 1, // buyback team fee in %
            marketing: 5, // marketing fee in %
            lp: 4, // lp rate in %
            toSwap: 10 // marketing + buyback + lp
        });
    ...
    feeRatesStruct public sellRates =
        feeRatesStruct({
            ...
            lp: 4, // lp rate in %
            toSwap: 15 // marketing + buyback + lp
        });
    ...
    event MarketingAndBuybackFeesAdded(uint256 buybackFee, uint256 marketingFee);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // we give the remaining tax to buyback & marketing wallets
    ...
    function setBuyFees(
        ...
        buyRates.lp = _lp;
        buyRates.toSwap = _marketing + _buyback + _lp;
    }
    ...
    function setSellFees(
        ...
        sellRates.lp = _lp;
        sellRates.toSwap = _marketing + _buyback + _lp;
    }
