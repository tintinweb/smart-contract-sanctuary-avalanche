...
contract TombGenesisRewardPool {
    ...
    struct PoolInfo {
        ...
        bool isStarted;
        bool isTaxed;// if lastRewardBlock has passed
    }
    ...
    // MAINNET
    uint256 public tombPerSecond = 0.02604 ether; // 4500 TOMB / (48 * 60min * 60s)
    uint256 public runningTime = 2 days; // 2 days
    uint256 public constant TOTAL_REWARDS = 4500 ether; //old: 25000
    // END MAINNET
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (_amount > 0) {
            ...
            if (pool.isTaxed) {
                depositDebt = _amount.mul(50).div(10000); //Calculate tax 0.5%
