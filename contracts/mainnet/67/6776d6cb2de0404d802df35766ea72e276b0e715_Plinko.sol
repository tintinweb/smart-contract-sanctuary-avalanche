...
contract Plinko is GameBase, GameBet, GameChainlink {
    ...
    constructor(
        ...
        bucketProbabilities[8] = [7091, 52640, 215316, 499999, 784684, 947360, 992909, 1000000];
        ...
        bucketProbabilities[10] = [1848, 13373, 115820, 269491, 499997, 730509, 884180, 986627, 998152, 1000000];
        ...
        bucketMultipliers[12] = [6500, 1700, 400, 90, 60, 40, 40, 60, 90, 400, 1700, 6500];
        bucketProbabilities[12] = [984, 5284, 23310, 123665, 274198, 499997, 725802, 876335, 976690, 994716, 999016, 1000000];
