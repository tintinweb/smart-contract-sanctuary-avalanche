...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x9e20Af05AB5FED467dFDd5bb5752F7d5410C832e); 
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //TraderJoe router
        _token = msg.sender;
    }
...
contract KittenCoinAvax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x9e20Af05AB5FED467dFDd5bb5752F7d5410C832e;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "KITTENCOINAVAX";
    string constant _symbol = "$KITTENCOIN";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 1_000_000_000_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(50); // 2%
    uint256 public _maxWallet = _totalSupply.div(25); // 4%
    ...
    address public autoLiquidityReceiver=0x7CD0C968d3fF4CFB1209Fe4eA3316342342c9105; //liq address
    address public marketingFeeReceiver=0xC55e7E18FFd9830E653F7cCADF1F9920561e1659; // marketing address
