...
// File contracts/core/contracts/interfaces/IBiswapERC20.sol
...
// File contracts/core/contracts/libraries/SafeMath.sol
...
// File contracts/core/contracts/BiswapERC20.sol
...
// File contracts/core/contracts/libraries/Math.sol
...
// File contracts/core/contracts/libraries/UQ112x112.sol
...
// File contracts/core/contracts/interfaces/IERC20.sol
...
// File contracts/core/contracts/interfaces/IBiswapFactory.sol
...
// File contracts/core/contracts/interfaces/IBiswapCallee.sol
...
// File contracts/core/contracts/BiswapPair.sol
...
contract BiswapPair is IBiswapPair, BiswapERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        ...
        uint balance0Adjusted = balance0.mul(10000).sub(amount0In.mul(_swapFee)); //TODO 10000
        uint balance1Adjusted = balance1.mul(10000).sub(amount1In.mul(_swapFee)); //TODO 10000
        require(balance0Adjusted.mul(balance1Adjusted) >= uint(_reserve0).mul(_reserve1).mul(10000**2), 'Biswap: K'); //TODO 10000
        }
