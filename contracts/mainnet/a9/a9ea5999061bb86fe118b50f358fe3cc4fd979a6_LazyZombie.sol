...
/*
 ...
 __                                 ________                      __                    
/\ \                               /\_____  \                    /\ \      __           
\ \ \         __     ____    __  __\/____//'/'    ___     ___ ___\ \ \____/\_\     __   
 \ \ \  __  /'__`\  /\_ ,`\ /\ \/\ \    //'/'    / __`\ /' __` __`\ \ '__`\/\ \  /'__`\ 
  \ \ \L\ \/\ \L\.\_\/_/  /_\ \ \_\ \  //'/'___ /\ \L\ \/\ \/\ \/\ \ \ \L\ \ \ \/\  __/ 
   \ \____/\ \__/.\_\ /\____\\/`____ \ /\_______\ \____/\ \_\ \_\ \_\ \_,__/\ \_\ \____\
    \/___/  \/__/\/_/ \/____/ `/___/> \\/_______/\/___/  \/_/\/_/\/_/\/___/  \/_/\/____/
                                 /\___/                                                 
                                 \/__/                                                  


*****************************   FINAL VERSION   *************************
correction of a supply error on the previous deployment, everything is in order now
*****************************   FINAL VERSION   *************************
...
contract LazyZombie is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, Randomizer {
    ...
    // MODIFIERS
    modifier onlyDevs() {
        require(devFees[msg.sender].percent > 0, "Dev Only: caller is not the ZombieBoss");
        _;
    }
    ...
    address public royaltyAddress = 0x51C3AFa10Cc98672D6E81eb0e64775661BFA11c6;
    ...
    ) ERC721("LazyZombie", "LZ") Randomizer(maxSupply) {
