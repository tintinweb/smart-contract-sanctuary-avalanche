...
/**
V2 of the PTP-Aggregator, veAGG
The issue with reflecting Avax has been circumvented and fucked HARD.
Join the gamechanger:
https://t.me/veAggregator
https://discord.gg/w5fQmt9qzd
https://twitter.com/veAggregator
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 savax = IBEP20 (0x2b2C81e08f1Af8835a78Bb2A90AE924ACE0eA4bE);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = savax.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WAVAX;
        path[1] = address(savax);
        ...
        uint256 amount = savax.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            savax.transfer(shareholder, amount);
...
contract veAggregator is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address savax = 0x2b2C81e08f1Af8835a78Bb2A90AE924ACE0eA4bE; // sAvax
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;
    address public autoLiquidityReceiver=0xDC6a06a689a0DCf8C3B49B65B209271914b54E5b;
    address public marketingFeeReceiver=0xDC6a06a689a0DCf8C3B49B65B209271914b54E5b;

    string constant _name = "veAggregator";
    string constant _symbol = "veAGG";
