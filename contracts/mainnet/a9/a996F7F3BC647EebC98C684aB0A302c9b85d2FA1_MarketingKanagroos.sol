...
contract MarketingKanagroos is ERC721A, IERC2981, ReentrancyGuard, Ownable {
    uint256 maxMints = 10;
    uint256 maxFreeMints = 2;

    uint16 MAX_SUPPLY = 1130;
    uint256 public mintRate = 400000000000000000;
    
    bool public freeMintEnabled = false;
    uint public royaltyFeeInBips = 500;
    address royaltyAddress;
    bool public saleActive = false;
    string baseURI = "ipfs://Qmf9bA9f37P9WsKdKz6U5mNxZ5aQSKhxfoefKKEksBKzVK/";

    constructor() ERC721A("Marketing Kangaroos", "MAK") {
    ...
    function mint(uint8 quantity) external payable nonReentrant{
        ...
        if(freeMintEnabled){
            require(quantity + balance <= maxFreeMints, "Exceeded the limit");
            _safeMint(msg.sender, quantity);
        } else{
            require(quantity + balance <= maxMints, "Exceeded the limit");
