...
contract ALPHATEST2 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd; // JOE
    ...
    string constant _name = "ALPHATEST2";
    string constant _symbol = "ALPHATEST2";
    ...
    uint256 public swapBackTimeLock = 0 minutes;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function shouldSwapBack() internal view returns (bool) {
        ...
        && !inSwap
        && swapEnabled
        && block.timestamp >= lastSwapBack + swapBackTimeLock
    ...
    function setSwapBackTimeLock(uint256 numMinutes) public onlyOwner {
        swapBackTimeLock = numMinutes * 1 minutes;
    }
