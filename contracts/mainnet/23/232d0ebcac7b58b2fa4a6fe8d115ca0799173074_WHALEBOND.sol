...
//Farming Whales Finance (WHALEBOND) - Avalanche Mainnet
...
// P FINANCE
contract WHALEBOND is ERC20Burnable, Operator {
    uint256 private totalBurned_;

    /**
     * @notice Constructs the P Bond ERC-20 contract.
     */
    constructor() public ERC20("Farming Whales Finance Bond", "WHALEBOND") {}
