...
Auto generating "SNO Token" rewards.

6% reflections
5% liquidity
3% marketing

OLD TELEGRAM WAS DELETED 

New telegram --> t.me/snoprinterr
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REFLECTIONS = IBEP20(0x1fE4869f2C5181b9CD780a7E16194FA2c4C4293D);
...
contract SNOprintr is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;

    address REFLECTIONS = 0x1fE4869f2C5181b9CD780a7E16194FA2c4C4293D;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SNO Printr";
    string constant _symbol = "SNOp";
    ...
    address public autoLiquidityReceiver = 0xE3E9F8ea1231a5aE4B938B5aFA71Eec183C423Ae;
    address public marketingFeeReceiver = 0xE3E9F8ea1231a5aE4B938B5aFA71Eec183C423Ae;
