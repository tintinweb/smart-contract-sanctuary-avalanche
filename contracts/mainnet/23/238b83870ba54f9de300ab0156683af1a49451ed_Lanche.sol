...
/* Token contract */
contract Lanche is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x26544cC995fabF54Eb5a08690FDEE0C76eAAAF59;
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 250 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 125 / 10000; // 1.25%
    ...
    uint256 reflectionFeeBuy = 900;
    uint256 marketingFeeBuy = 900;
    uint256 devFeeBuy = 0;
    uint256 totalFeeBuy = 1800;      

    // Sell fees
    uint256 liquidityFeeSell = 0;
    uint256 buybackFeeSell = 0;
    uint256 reflectionFeeSell = 900;
