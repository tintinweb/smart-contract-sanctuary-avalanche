...
contract Starship is IERC20 {
    ...
    uint256 constant private startingSupply = 42_000_000_000;

    string constant private _name = "Starship";
    ...
    address payable public marketingWallet = payable(0xEB2836f3e069A271C4e399EF566608657d222C94);
    address payable private rewardsPool = payable(0xEB2836f3e069A271C4e399EF566608657d222C94);
    address payable private treasuryWallet = payable(0xEB2836f3e069A271C4e399EF566608657d222C94);
