...
contract RATS is ERC721 , DefaultOperatorFilterer {
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeid47ypvfk6s25oz2w3qa54fy72ne6pxskbtjwxcuwbv6vz4sdbmgu/", Strings.toString(tokenId), ".json")
            );
    }
