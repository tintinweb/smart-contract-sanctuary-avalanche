...
contract PoolHelperAvax {
    ...
    function depositFor(uint256 amount, address _for) external _harvest {
    ...
    /// @dev performs a harvest of PTP just before depositing
    /// @param amount the amount of stables to deposit
    function deposit(uint256 amount) external payable nonReentrant _harvest {
    ...
    /// @dev performs a harvest of PTP just before depositing
    /// @param amount the amount of stables to deposit
    function _depositFor(uint256 amount, address _for) internal {
    ...
    /// @dev performs a harvest of PTP just before depositing
    function depositAVAXFor(address _for) external payable _harvest {
        _depositAVAXFor(_for);
    }

    /// @dev performs a harvest of PTP just before depositing
    function depositAVAX() external payable _harvest {
    ...
    /// @param amount the amount of stables to deposit
    function withdraw(uint256 amount, uint256 minAmount) external nonReentrant _harvest {
