...
contract RefundCoreNft is Ownable {
    ...
    function getSizeOfElibigleSeedNfts() public view returns (uint) {
        return eligibleSeedNfts.length;
    }

    function getSizeOfElibigleSaplingNfts() public view returns (uint) {
        return eligibleSaplingNfts.length;
    }

    function getSizeOfElibigleTreeNfts() public view returns (uint) {
