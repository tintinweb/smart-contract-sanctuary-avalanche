...
contract FeedVaultBaseV4LP is FeedVault {
    ...
    /**
     * @dev Token0 to Buyback path length
     */
    function token0ToBuybackPathLength() external view returns (uint256) {
        return token0ToBuybackPath.length;
    }

    /**
     * @dev Token1 to Buyback path length
     */
    function token1ToBuybackPathLength() external view returns (uint256) {
        return token1ToBuybackPath.length;
    }
}
