...
contract GambitFoundersClub is ERC721 {
    ...
    constructor()
        ERC721("Gambit Founders Club", "GFC")
    {}
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked("ipfs://bafybeihkrfonwdev4d3bci742lkd7u2ynyyzw2msbpphzmlmez4qvodmty/", Strings.toString(tokenId), ".json")
            );
    }
