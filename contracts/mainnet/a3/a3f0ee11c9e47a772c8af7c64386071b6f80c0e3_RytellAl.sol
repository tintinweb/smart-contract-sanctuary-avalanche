...
// ipfs://QmYz5J3rbMrjs6ZYWzoidKweBRTHPwzHkJomGjL69W93oS/
...
/// @title Rytell Al
contract RytellAl is ERC721Metadata {
    ...
    function mint(uint256 counts_)
        external payable {
        require(pendingCount > 0, "Rytell Al: All minted");
        require(counts_ > 0, "Rytell Al: Counts cannot be zero"); 
        require(totalSupply().add(counts_) <= MAX_NFT_SUPPLY,
            "Rytell Al: sale already ended"); 
        require(!paused, "Rytell Al: The contract is paused"); 
    ...
    function _randomMint(address to_)
        ...
        require(to_ != address(0), "Rytell Al: zero address");

        require(totalSupply() < MAX_NFT_SUPPLY,
            "Rytell Al: max supply reached");
