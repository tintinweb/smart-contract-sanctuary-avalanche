...
import "../interfaces/IPendragonStaking.sol";

/*  PendragonTreasury.sol ============================================
    The contract is to store the reserve of Pendragon Protocol
...
==================================================================== */
contract PendragonTreasury is Ownable {
    using SafeERC20 for IERC20;
    using Address for address;

    mapping(address => bool) public strategies;
    address[] public strategiesArray;
    IPendragonStaking public staking;

    constructor(IPendragonStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of PendragonTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the PendragonTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "PendragonTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "PendragonTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "PendragonTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "PendragonTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "PendragonTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "PendragonTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "PendragonTreasury::allocateFee: invalid amount");
