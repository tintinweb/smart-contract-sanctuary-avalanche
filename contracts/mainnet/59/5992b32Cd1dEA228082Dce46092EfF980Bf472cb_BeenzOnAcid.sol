...
contract BeenzOnAcid is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, VRFConsumerBaseV2 {
    ...
    uint public constant START_ID = 2223;
    ...
    uint public price = 0;
    address public royaltyAddress = 0xa0bC0DfD012d80d9DAA0da0694B2511B475a2eA1;
    uint public royalty = 750;
    uint private mintedTokens;
    ...
    constructor(
        ...
        bytes32 gasLine,
        uint64 subId
    ) ERC721("Beenz On Acid", "BENZ") VRFConsumerBaseV2(_vrfConsumer) {
    ...
    function fulfillRandomWords(uint requestId, uint[] memory randomWords) internal override {
        uint256 amount = randomWords.length;
        ...
        for (uint8 i = 0; i < amount; ++i) {
            ...
            uint newTokenId = useAvailableTokenAtIndex(randomIndex) + START_ID;
