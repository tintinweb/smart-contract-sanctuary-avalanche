    ...
    NonblockingLzAppUpgradeable
{
    ...
    receive() external payable onlyAaveVault {}
        ...
        returns (uint256 amountOut)
    {
        ...
        if (address(path[0]) == address(0x0)) {
            ...
            if (_getChainID() == 43114) {
                ...
                console.log("Chain id is not avax");
     ...
     */
    function marginShort(bytes memory _data) public override  {
    ...
    function _internalLzReceive(bytes memory _payload) internal {
        ...
        require(success, "AaveStrategy:call to strategy failed");
    }
