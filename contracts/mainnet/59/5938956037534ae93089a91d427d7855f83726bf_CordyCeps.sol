...
contract CordyCeps is IBEP20, Auth {
    ...
    string constant _name = "CordyCeps";
    string constant _symbol = "$CORDY";
    ...
    uint256 referralFee = 7;

    uint256 public minSupplyForReferralReward = (_totalSupply * 1) / 1000;
    
    address private marketingFeeReceiver = 0xC65196C1F5c1ccEbcA473828cFc3a14a4F35597D;
    address private devFeeReceiver = 0x819fF311825c69A4C1e290084aa974975f76eb04;
