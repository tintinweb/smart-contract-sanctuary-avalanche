...
contract ShamanTribeChant is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer {
    ...
    //MODIFIERS
    modifier onlyMinter() {
        require(minters[msg.sender], "Minter Only: caller is not the minter");
        _;
    }
    ...
    uint public constant START_ID = 250;

    string public baseURI;
    // VARIABLES
    uint public maxSupply = MAX_SUPPLY;
    address public royaltyAddress = 0x434C0d4e68871be14FCbFD3bdc64426dF4ffcB55;
    ...
    constructor(
        address _lzEndpoint
    ) ERC721("Shaman Tribe Chant", "STRBC") ClampedRandomizer(maxSupply) {
    ...
    function rewardUser(uint256 quantity, address to) external onlyMinter {
        uint supply = totalSupply();
        require(supply + quantity - 1 < maxSupply, "Error: cannot mint more than total supply");
