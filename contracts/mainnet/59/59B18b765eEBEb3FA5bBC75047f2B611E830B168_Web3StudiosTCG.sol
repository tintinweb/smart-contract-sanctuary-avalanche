...
contract Web3StudiosTCG is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor() ERC721("NFT TCG: Knights and Mages", "NFTTCGKMV1") KindaRandom(1000) {
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmV4bcQx6mk23W8HR3gGswN6QLRG33ieZ8Mo6SUeDF7w4V/';
    _customBaseExtension = '.json';
    _maxMintable = 1000; // 1000 max supply - PROD
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _startTime = 1670266800; //unix timestamp of start time - (Mon Dec 05 2022 13:00:00 GMT-0600 (Central Standard Time))
    _maxMintPerTx = 10;
    _price = 0.1 ether;
