...
contract Bank is Ownable, IERC721Receiver, Pausable {
    ...
    function _claimPPFromBank(
        ...
        IPHvH.TraitStruct memory t = game.getTokenTraits(tokenId);
    ...
    function isPP(uint256 tokenId) public view returns (bool) {
        IPHvH.TraitStruct memory s = game.getTokenTraits(tokenId);
...
contract PHvH is IPHvH, ERC721Enumerable, Ownable, Pausable {
    ...
    function mintGenZero(uint256 amount) external nonReentrant whenNotPaused {
        ...
        IERC20(usdc).transferFrom(msg.sender, address(this), realCost * amount);
...
contract HODL is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public routerAddress = 0x60aE616a2155Ee3d9A68541Ba4544862310933d4; // traderJoe
    address public usdc = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDC.e
