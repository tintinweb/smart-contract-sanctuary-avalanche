...
Crabada is a crab-themed play-to-earn NFT game on Avalanche, where players assemble a team of three crabada to earn the in-game currency Treasure Under Sea (TUS).
Being an idle game, players deploy their Mining Party consisting of three crabada to mine treasure. Each mining expedition takes four hours and returns 3.75 CRA and 303.75 TUS. Players can also engage in looting missions to try to take over another player’s mining party. 
Moreover, idle crabada can be lent to other players and deployed as mercenaries.
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed);
...
contract CRABADAPRINTER is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xA32608e873F9DdEF944B24798db69d80Bbb4d1ed; // REWARDS
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Crabada Printer";
    string constant _symbol = "CRABP";
    ...
    address public autoLiquidityReceiver=0x48657d0a6E67Ae828DE972e84d12036Dab5744De;
    address public marketingFeeReceiver=0x48657d0a6E67Ae828DE972e84d12036Dab5744De;
