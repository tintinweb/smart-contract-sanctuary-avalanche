...
// DALL-E Heads by xrpant for Smolrun
...
// File: contracts/Rillabitats.sol
...
contract DALLEHeads is ERC721, Ownable, ReentrancyGuard, KindaRandom {
    ...
    uint256 private _freeForAllTimestamp;
    ...
    constructor() ERC721("DALL-E Heads", "DHEADS") KindaRandom(96) {
        _customBaseURI = "ipfs://bafybeicpwtgp7crer56lv3klhizxjp3oq6ub4rnupx3wdq776mqumy2xne/";
        _customURIExtension = ".json";
        _maxMintable = 96; 
        _royaltyAmount = 500;
        _ssb = IERC721(0x84404952344E7380574F40F6cb7B15d8fD17471D);
        _freeForAllTimestamp = block.timestamp + 2 days;
        _royaltyAddress = 0x92e3F8D7a727FEEc02c348b4eae66F86FA1Bc5Bd;
    ...
    function mint() public payable nonReentrant {
        require(_ssb.balanceOf(msg.sender) > 0, "You got no soul!");

        if (block.timestamp < _freeForAllTimestamp) {
