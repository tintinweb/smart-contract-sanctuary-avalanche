/**
 *Submitted for verification at snowtrace.io on 2023-02-04
*/
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x6d0f2459CEB067C3e092Ba72868a739C876b5629];
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "https://metadata.mintfoundry.xyz/c/WoRQtYSxcC4tEgbZFmoh/token/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/v3paDUszPo40Vx9VZydd/contract-metadata";
  }
