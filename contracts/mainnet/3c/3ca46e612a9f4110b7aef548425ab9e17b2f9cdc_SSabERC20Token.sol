...
contract SSabERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("stakedSAB", "SSAB", 9) ERC20Permit() {
    ...
    /**
        @notice increases aSAB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSAB
