...
contract MoonShadow is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 300; // 300 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 3;
    uint256 public constant MAX_CLAIM_PER_WALLET = 3;
    uint256 public STARTING_NFT_PRICE = 5 ether; // 5 avax for this launchpad
    uint256 public constant ROYALTY_VALUE = 500; // 100 = 1%, 200 = 2% etc...  5% for this launchpad
    uint256 public constant MIN_PRICE = 0 ether;
    uint256 public constant DURATION_STEP = 90; // 1min et 30sec for this launchpad
    uint public immutable discountRate = 0.25 ether;  // 0.25 avax for this launchpad
    uint public startAt;
