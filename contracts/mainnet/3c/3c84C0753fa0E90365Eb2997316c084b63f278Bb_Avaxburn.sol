...
Telegram: https://t.me/avax_burn
Twitter: https://twitter.com/AvaxBurn
Website: https://avaxburn.xyz/
...
contract Avaxburn is ERC20, Ownable {
    ...
    constructor(address _feesManagerAddress) ERC20("AvaxBurn", "AVAXb") {
        ...
        joeV2Router = _joeRouter;

        joeV2Pair = IJoeFactory(_joeRouter.factory())
            .createPair(address(this), _joeRouter.WAVAX());
        excludeFromMaxTransaction(address(joeV2Pair), true);
        _setAutomatedMarketMakerPair(address(joeV2Pair), true);
        ...
        _approve(owner(), address(joeV2Router), totalSupply);
        ...
        if (limitsInEffect) {
            if (
                ...
                if (transferDelayEnabled) {
                    if (
                        to != owner() &&
                        to != address(joeV2Router) &&
                        to != address(joeV2Pair)
                    ) {
                        require(
    ...
    function swapTokensForAvax(uint256 tokenAmount) private {
        // generate the joe pair path of token -> avax
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0x8F05CBD88472dB32724ca6a9ebDafe4bB8CdC1c3 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
