...
interface ICurveFactory {
    ...
    function get_meta_n_coins(address _pool)
        external
        view
    ...
    function get_metapool_rates(address _pool)
        external
        view
    ...
    function get_implementation_address(address _pool)
        external
        view
        returns (address);
    ...
    function set_plain_implementations(
        uint256 _n_coins,
        address[10] calldata _implementations
    ) external;
    ...
    function plain_implementations(uint256 arg0, uint256 arg1)
        external
        view
        returns (address);
