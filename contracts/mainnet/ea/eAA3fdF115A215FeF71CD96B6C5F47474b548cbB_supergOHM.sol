...
// File: contracts/superVaultV2/supergOHM.sol
...
contract supergOHM is ERC20,proxyOwner,ReentrancyGuard {
    ...
    function getStakeTokenPrice() public view virtual returns (uint256) {
        ...
        uint256 price1 = SafeMath.mul(uint256(price),uint256(index));
        return price1.mul(10);
    }
