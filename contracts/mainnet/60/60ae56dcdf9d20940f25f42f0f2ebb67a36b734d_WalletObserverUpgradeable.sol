    ...
    PlanetsManagerImplementationPointerUpgradeable
{
        ...
        returns (bool)
    {
        ...
        if (!isExcludedFromObserver(from)) {
            ...
            require(
                block.number > _lastSellOf[from] + 60 || _lastSellOf[from] == 0,
                "WalletObserverUpgradeable: You must either be an arbitrage bot, front-running bot or pswole!"
            );
    ...
    function totalSupply() external view returns (uint256) {
        ...
        _totalSupply -= universe.balanceOf(
            0xE023F1f55db3d48970073c18f830cD61E6B4371d
        );
