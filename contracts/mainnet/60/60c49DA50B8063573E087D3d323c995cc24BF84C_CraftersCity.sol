...
contract CraftersCity is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 614; //  614 total for this contract
    ...
    uint256 public constant NFT_PRICE = 1.2 ether; //
