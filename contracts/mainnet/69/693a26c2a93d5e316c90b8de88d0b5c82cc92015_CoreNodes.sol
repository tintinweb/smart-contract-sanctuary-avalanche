...
// File: CoreNodesv2/interfaces/IDEXAVAXRouter.sol
...
// File: CoreNodesv2/interfaces/IDividendDistributor.sol
...
// File: CoreNodesv2/interfaces/IDEXRouter.sol
...
// File: CoreNodesv2/interfaces/IBEP20.sol
...
// File: CoreNodesv2/DEXAVAXRouter.sol
...
// File: CoreNodesv2/DividendDistributor.sol
...
// File: CoreNodesv2/interfaces/IDEXFactory.sol
...
// File: CoreNodesv2/CoreNodes.sol

/**
Core Nodes: $CORE
- 6% reflections paid in USDC

Tokenomics:
(On sell)
6% reflections paid in USDC
4% tax for marketing/operations
0% allocated to auto-liquidity
...
contract CoreNodes is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  address USDC = 0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664; // USDC.e
  ...
  string constant _name = 'CNTv2';
  string constant _symbol = 'CNTv2';
  ...
  address public autoLiquidityReceiver =
    0x458280EC191c3D041e509682CbfA6FfD303491Fd;
  address public marketingFeeReceiver =
    0x90c25F55d5349950Cebec08575CBa3F4CAC8B6D2;
  ...
  constructor() Auth(msg.sender) {
    ...
    WAVAX = router.WETH();
    distributor = new DividendDistributor(address(router), WAVAX, USDC);
