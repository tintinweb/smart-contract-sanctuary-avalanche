...
import "./EmeraldNodeStorageV1.sol";

contract EmeraldNodeV1 is EmeraldNodeStorageV1 {
    ...
    */
    ...
    function initialize() public initializer {
        ...
        EmeraldCoin = IERC20(0x97E7044ab98B7891546485f5f66EDcc2F58be106);
        nodeIds = [0, 500, 1700, 9200, 24200, 49200];
        
        count = 2;
        communityAddress = 0xE469b1Fa56cf04b0D9BEc7f0D9EA351B081C0e30; 
    ...
    modifier isBlacklistedAddress() {
        require(
            ...
            "EmeraldNodeV1: You are blacklisted"
        );
        _;
    }
    ...
    */
    ...
    function buyNode(Order memory order, bytes memory signature) isBlacklistedAddress nonReentrant external returns(bool){
        uint256 _tier;
        uint256 nodeId;
        require(owner() == ECDSAUpgradeable.recover(order.key, signature) && nodeStatus == true, "EmeraldNodeV1: ERROR");
        ...
        require(tierDetails[_tier].rewardRate != 0, "EmeraldERC20V1: Rate is not set yet");

        EmeraldCoin.safeTransfer(msg.sender, communityAddress, tierDetails[_tier].tierNodePrice);
        ...
        emit nodeCreated(nodeId, _tier, order.ReferenceId, msg.sender, order.NodeName);
...
contract EmeraldNodeStorageV1 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
