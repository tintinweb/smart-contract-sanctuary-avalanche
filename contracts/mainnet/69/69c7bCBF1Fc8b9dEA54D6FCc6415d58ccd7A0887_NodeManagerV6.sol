...
contract NodeManagerV6 is Initializable {
    ...
    function migrateRewardsFromOldVersion() public {
        ...
        require(
            ...
            "Wallet reward have been migrated"
        );
    ...
    function setRewardMigrated(address add, bool value) public onlyOwner {
        rewardMigrated[add] = value;
    }
    
    function setARM(address[] memory add, bool value) public onlyOwner {
        for (uint8 i = 0; i < add.length; i++) {
            rewardMigrated[add[i]] = value;
        }
    }
}
