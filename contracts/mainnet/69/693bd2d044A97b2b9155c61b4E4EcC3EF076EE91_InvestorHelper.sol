...
contract InvestorHelper is Ownable, ReentrancyGuard {
    ...
    function addAvaxPairLiquidity(
        ...
        //How to communicate when parts of the code have been accomplished?
        //Emit an event on how much of token1 was bought so you can make sure u are coming in with JOE
        //You may need to program slippage controls into both swaps and adding liquidity bc that
        //could be the issue
     ...
     * @param _avaxAddr - ERC20 WAVAX Address
     * @param _avaxAmount - Amount of Avax to convert to LP token
     * @param _token0Amount - Includes an amount for token0
