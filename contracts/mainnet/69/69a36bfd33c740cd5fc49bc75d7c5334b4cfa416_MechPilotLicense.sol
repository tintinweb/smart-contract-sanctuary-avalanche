...
contract MechPilotLicense is ERC721, Ownable, ERC2981 {
   ...
   constructor() ERC721("Mechavax Pilot License", "MAPL") {
   ...
   function mint(address _to, uint256 _id) external returns (bool) {
