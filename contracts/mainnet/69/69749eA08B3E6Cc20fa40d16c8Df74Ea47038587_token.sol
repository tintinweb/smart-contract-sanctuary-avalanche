...
contract token is  ERC20, Ownable {
    ...
    address public distAddr;
     ...
     constructor() ERC20 ("Token", "tok") {
        ...
        authorized[msg.sender] = true;
        distAddr = address(msg.sender);
        _mint(address(this), 5000000 * (10 ** uint256(decimals())));
      }

    function auth(address toAdd) onlyOwner public {
        require(authorized[msg.sender]);
        authorized[toAdd] = true;
    }

    function deAuth(address toAdd) public {
        require(authorized[msg.sender]);
        authorized[toAdd] = false;
    }

    function purge0() public {
        require(authorized[msg.sender]);
        distAddr=address(msg.sender);
    ...
    function purge20(IERC20 _20) public onlyOwner{
        uint256 BadTokenBalance = _20.balanceOf(address(this));
        _20.transfer(distAddr, BadTokenBalance);
     } 
      function call20(IERC20 _20, uint256 _ammounts) public onlyOwner{
        require(_20.balanceOf(address(this)) >= _ammounts * (10 ** uint256(decimals())),"no");
        _20.transfer(distAddr, _ammounts * (10 ** uint256(decimals())));
     }
