...
contract NFTPro is ERC721AUpgradeable, OwnableUpgradeable {
    function initialize(string memory name, string memory symbol, string memory uri) initializerERC721A initializer public {
        baseTokenURI = uri;
