...
contract VUSDvault_LatestVersion is Ownable {    
    ...
    event SavedUserDataForOptibit(address _from, address _to, uint256);
    ...
    uint256 public MinOptWithdrawAmount = 100 * 10 ** 18; // 100 OPTIBIT
    ...
    uint256 public optibitAmountDR = 1000 * 10 ** 18; // optibit dr reward
    uint256 public optibitAmountIDR = 20 * 10 ** 18; // optibit idr reward
    uint256 public optibitAmountPairing = 50 * 10 ** 18; // optibit pairing reward
    uint256 public optibitClicks = 100 * 10 ** 18; // optibit click reward
    ...
    function setOptMinWithdrawal(uint256 minimumAmount) public
    {   
        require(msg.sender == deployer  || msg.sender == Dev, "Invalid Caller");
        MinOptWithdrawAmount = minimumAmount;
    }  
    ...
    function claimOPTIBIT(uint256 _amount) public payable nonReentrant
    {
        require(isRegistered[msg.sender] == true, "You are not registered");
        require(msg.value >= VNTTransactionFee, "You should pay ETHs");        
        require(_amount >= MinWithdrawAmount, "Amount should be lager than minimum withdraw amount.");        
    ...
    function saveUserDataforDR(address from, address to, uint256 _amount) public payable {
        ...
        //optibit
        optibitTokenBalances[msg.sender] += optibitAmountDR;
        ...
        emit SavedUserDataForOptibit(from, to, _amount);
    } 
    ...
    {        
        ...
        //optibit
        optibitTokenBalances[msg.sender] += optibitAmountIDR;
    ...
    {        
        ...
        //optibit
        optibitTokenBalances[msg.sender] += optibitAmountPairing;
    ...
    function saveClickAdsData(address to, uint256 _amount) public payable {  
        ...
        tokenBalancesByUser[to] = tokenBalancesByUser[to].add(_amount);
        // optibit
        optibitTokenBalances[msg.sender] += optibitClicks;
        ...
        emit SavedUserDataForOptibit(msg.sender, to , _amount); 
    }
