...
contract USBLiquidityPool is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function sellUSB(uint256 usPeggedTokenIndex, uint256 inputUSBAmount) external {
        ...
        uint256 usPeggedTokenAmount = (inputUSBAmount- sellingFees) / (10 ** (usbDecimal - usPeggedDecimal));
        require(usPeggedTokenAmount > 0, "P.A!=0");
        ...
        _lockReward(usPegCoinInfo.coinAddress, msg.sender, usPeggedTokenAmount, usPegCoinInfo.vestingDuration);

        emit SellUSB(msg.sender, inputUSBAmount, usPeggedTokenAmount);
    }
