...
contract NowUnitedTheMusicalTier1 is ERC1155, DefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory _baseURI, address _primaryRecipient) ERC1155(string(abi.encodePacked(_baseURI, "{id}.json"))) {
        currentTokenId = 1;
        maxSupply = 60000;
    ...
    function mintToAddressWithoutPayAmount(uint256 _quantity, bytes32[] memory _proof) external {
