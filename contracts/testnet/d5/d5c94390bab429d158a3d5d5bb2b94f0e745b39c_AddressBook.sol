...
contract AddressBook is AddressBookInterface {
    ...
    // get update contract address proposal detail
    function getUpdateContractAddressProposalDetail(uint256 proposalIndex_) external view returns(UpdateContractAddressProposal memory) {
        return _updateContractAddressProposal[proposalIndex_];
    }
    
    // Is update contract address proposal approver
    function IsUpdateContractAddressProposalApprover(uint256 proposalIndex_, address account_) external view returns (bool) {
        return _updateContractAddressApprovers[proposalIndex_][account_];
    }
