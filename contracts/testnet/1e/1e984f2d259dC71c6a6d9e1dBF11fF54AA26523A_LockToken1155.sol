...
contract LockToken1155 is OwnableUpgradeable, IERC1155 {
                ...
                if (
                    ...
                    if (
                        ...
                        for (
                            uint256 l;
                            l <
                            startTimeToBatchLock[startTimes[i]].ids[j].length;
                            l++
                        ) {
                            if (
                                startTimeToBatchLock[startTimes[i]].ids[j][l] ==
                                id
                            ) {
                                if (
                                    ...
                                    restAmount =
                                        amount -
                                        startTimeToBatchLock[startTimes[i]]
                                            .amounts[j][l];
        ...
        returns (uint256[] memory, uint256[] memory)
    {
                    ...
                    if (
                        ...
                        for (
                            ...
                            if (
                                checkId(
                                    ids,
                                    startTimeToBatchLock[startTimes[i]].ids[j][
                                        l
                                    ]
                                ) == 0
                            ) {
                                ids[init] = startTimeToBatchLock[startTimes[i]]
                                    .ids[j][l];
                                //ids.push(startTimeToBatchLock[startTimes[i]].ids[j][l]);
                                amount[init] += startTimeToBatchLock[
                                    startTimes[i]
                                ].amounts[j][l];

                                init++;
                            } else {
                                //adrIdAmount[msg.sender][startTimeToBatchLock[startTimes[i]].ids[j][l]] += startTimeToBatchLock[startTimes[i]].amounts[j][l];
                                amount[
                                    checkId(
                                        ids,
                                        startTimeToBatchLock[startTimes[i]].ids[
                                            j
                                        ][l]
                                    ) - 1
                                ] += startTimeToBatchLock[startTimes[i]]
        ...
        for (uint256 i; i < ids.length; i++) {
            amount[i] = adrIdAmount[msg.sender][ids[i]];
        }
        return (ids, amount);
    }
        ...
        returns (uint256[] memory, uint256[] memory)
    {
        ...
        uint256[] memory amount;
        uint256 init;
        //mapping(uint => uint) memory idToAmount;
        ...
        for (uint256 i; i < startTimes.length; i++) {
            for (
                ...
                if (
                    ...
                    for (
                        uint256 l;
                        l < startTimeToBatchLock[startTimes[i]].ids[j].length;
                        l++
                    ) {
                        if (
                            checkId(
                            ...
                            ids[init] = startTimeToBatchLock[startTimes[i]].ids[
                                j
                            ][l];
                            amount[init] += startTimeToBatchLock[startTimes[i]]
                                .amounts[j][l];
                            init++;
                        } else {
                            amount[
                            ...
                            ] += startTimeToBatchLock[startTimes[i]].amounts[j][
                                    l
                                ];
                        }
                    }
    ...
    {
        return (
            startTimeToBatchLock[startTime].ids,
            startTimeToBatchLock[startTime].amounts
        );
    }
