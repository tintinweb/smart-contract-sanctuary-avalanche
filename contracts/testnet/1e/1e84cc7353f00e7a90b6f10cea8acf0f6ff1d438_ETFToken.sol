...
contract ETFToken is OperatorUpgradeable, ERC20Upgradeable, IETFToken, BNum {
    uint256 public constant MIN_BALANCE = 1e6; // $1
    uint256 public constant INIT_POOL_SUPPLY = 1e18; // INIT_POOL_SUPPLY = 1;
        ...
        public
    {
        ...
        _transfer(address(this), exitFeeRecipient, _exitFee);
        _burn(address(this), pAiAfterExitFee);
