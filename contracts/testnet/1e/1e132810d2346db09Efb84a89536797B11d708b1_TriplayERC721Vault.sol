...
abstract contract TriplayVault is EIP712, ReentrancyGuard, Pausable {
    ...
    event SetMerkleRoot(address indexed sender, uint256 indexed rootId, bytes32 merkleRoot, string dataUri);
    ...
    function setMerkleRoot(
        ...
        dataUri = _dataUri;
        emit SetMerkleRoot(msg.sender, rootId, _merkleRoot, _dataUri);
    }
...
contract TriplayERC721Vault is TriplayVault, ERC721Holder {
    ...
    function allowNfts(IERC721[] memory nfts, bool allowed) external {
        require(msg.sender == policy.owner(), "not a policy owner");
    ...
    function cancelUnstake(
        ...
        policy.verifyCancelUnstake(signatures, paramsHash);
