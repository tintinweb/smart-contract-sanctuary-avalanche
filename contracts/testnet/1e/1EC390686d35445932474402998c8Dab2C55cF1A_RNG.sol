...
contract RNG {
        ...
        returns (uint256[] memory, uint256[] memory)
    {
        ...
        require(choosedEvent.owner == msg.sender, "Event: Must be owner  of event");
        require(
        ...
        uint256[] memory tempWinnerArray = winnerPosition;
        ...
        return (tempWinnerArray, choosedEvent.numbersArray);
    }
