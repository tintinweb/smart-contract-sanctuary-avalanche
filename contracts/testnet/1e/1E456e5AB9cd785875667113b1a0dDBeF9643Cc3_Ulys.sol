...
contract Ulys is ERC20Burnable, Operator {
    ...
    function setLP(address _lpAddress) public onlyOperatorOrTaxOffice {
    ...
    function _transferWithTax(
        ...
        if (sender == lpAddress && !(excludedAddresses[sender] || excludedAddresses[sender])) {
            // SENDER == LP ADDRESS MEANS BUYING - REMOVING LIQUIDITY
            // require(this.approve(address(router), amount), "bruhProve");
