...
// 
    ...
    contract AvaxCars is ERC721, Ownable, ERC721Enumerable {
      ...
      function mintAvaxCars(uint256 numberOfTokens) external payable {
      ...
      function presaleAvaxCars(uint256 numberOfTokens) external payable {
