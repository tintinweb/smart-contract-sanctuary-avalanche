...
// File contracts/IterableNodeTypeMapping.sol
...
// File contracts/NODERewardManager.sol
...
contract NODERewardManager is PaymentSplitter {
	...
	bool private openCreate = true; //default: false;
...
// File contracts/GemNodesTestV3.sol


pragma solidity ^0.8.0;

contract GemNodesTestV3 is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        uint256 swapAmount
        //address uniV2Router
    ) ERC20("GemNodesTestV3", "GEM") PaymentSplitter(payees, shares) {
    ...
    /*function cashoutReward(uint256 blocktime) public {
        ...
        if (swapLiquify) {
            ...
            if (cashoutFee > 0) {
                ...
                swapAndSendToFee(treasuryUsePool, feeAmount);
            }
            rewardAmount -= feeAmount;
        }
