...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xF5f08Ba7F46e2a86b5ef3BFD56c2097C9f4276D7];
  address public erc20Payable = 0xF5f08Ba7F46e2a86b5ef3BFD56c2097C9f4276D7;
    ...
    
{
  constructor(
  ...
  ) ERC721A(tokenName, tokenSymbol, 5, 3141) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://rithm.art/";
     ...
     */
     function mintToAdminV2(address _to, uint256 _qty) public onlyTeamOrOwner{
         ...
         require(currentTokenId() + _qty <= collectionSize, "Cannot mint over supply cap of 3141");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3141");
    ...
    function mintToMultipleERC20(address _to, uint256 _amount, address _erc20TokenContract) public payable {
      require(_amount >= 1, "Must mint at least 1 token");
      require(_amount <= maxBatchSize, "Cannot mint more than max mint per transaction");
      require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3141");
      require(mintingOpen == true, "Minting is not open right now!");
...
contract MyMintplexProjectContract is RamppERC721A {
    constructor() RamppERC721A("My Mintplex Project", "RithmDAO"){}
}
