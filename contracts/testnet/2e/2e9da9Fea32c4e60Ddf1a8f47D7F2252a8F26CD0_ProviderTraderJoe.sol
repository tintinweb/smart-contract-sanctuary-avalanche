...
// File contracts/interfaces/IFujiMappings.sol
...
// File contracts/interfaces/compound/IGenCToken.sol
...
// File contracts/fuji/libraries/LibUniversalERC20AVAX.sol
...
// File contracts/fuji/providers/ProviderTraderJoe.sol
...
contract HelperFunct {
  function _isAVAX(address token) internal pure returns (bool) {
  ...
  function _getMappingAddr() internal pure returns (address) {
    return 0xB17583362fcCFFf195323D10aB0ad3C9E3dcf8e7; // Benqi fantom mapper
  }

  function _getComptrollerAddress() internal pure returns (address) {
    return 0x7AF3e8B6be5855ab1Ccd9cfDedb54c8aA7962687; // Benqi fantom
  }

  function _getUnwrapper() internal pure returns(address) {
    return 0x5e3843c7922e2905260122c968Ca307Df24D3452;
  }
...
contract ProviderTraderJoe is IProvider, HelperFunct {
  ...
  /**
   * @dev Deposit '_asset'.
   * @param _asset: token address to deposit. (For AVAX: 0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
  ...
  /**
   * @dev Withdraw '_asset'.
   * @param _asset: token address to withdraw. (For AVAX: 0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
  ...
  function withdraw(address _asset, uint256 _amount) external payable override {
    ...
    if (_isAVAX(_asset)) {
      // Transform WAVAX to AVAX
      address unwrapper = _getUnwrapper();
      IERC20(WAVAX).univTransfer(payable(unwrapper), _amount);
  ...
  /**
   * @dev Borrow '_asset'.
   * @param _asset token address to borrow.(For AVAX: 0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
   ...
   * @param _asset token address to payback.(For AVAX: 0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF)
