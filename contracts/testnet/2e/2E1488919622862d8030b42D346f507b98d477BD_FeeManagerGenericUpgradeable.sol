...
contract FeeManagerGenericUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable {
    ...
    function setFee(
        ...
        require(feeTokenAddress != address(0), "FeeManagerGeneric: feeTokenAddress can't be null");
        require(feeFactor != 0, "FeeManagerGeneric: feeFactor cannot be zero");
        ...
        emit FeeUpdated(destinationChainID, feeTokenAddress, feeFactor, bridgeFee, accepted);
    }
    ...
    function getFeeSafe(uint8 destChainId, address feeToken)
        public
        view
        virtual
        returns (
