...
contract CATERC20 is Context, ERC20, CATERC20Governance, CATERC20Events {
    ...
    function initialize(uint16 chainId, address wormhole, uint8 finality, uint256 maxSupply) public onlyOwner {
...
contract CATRelayer is CATRelayerGovernance {
    ...
    */
    function deployToken(
        ...
        CATERC20(tokenAddress).initialize(chainId(), address(wormhole()), 1 , totalSupply);
