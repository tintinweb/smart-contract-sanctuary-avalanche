...
contract EggPurchase is Ownable, IERC1155Receiver {
    ...
    function purchase(uint256 amount) public payable {
        ...
        require(userBought24h(msg.sender).add(amount) <= 5, "You cannot purchase more than 5 Eggs in 24h");
        require(IERC1155(eggAddress).balanceOf(address(this), nftid) >= amount, "Eggs sold out.");
