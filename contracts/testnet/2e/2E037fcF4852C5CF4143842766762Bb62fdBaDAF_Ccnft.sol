...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x0D6b8aAA07eF5CF9d5AeAF09452db5188C09050b);
	}
...
contract Ccnft is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public constant TIME_FOR_GROWN = 1687906260000;
	address public founder = 0x0D6b8aAA07eF5CF9d5AeAF09452db5188C09050b;
	...
	string private _name = "ccnft";
	string private _symbol = "CCC";
	string private _baseTokenURI = "https://lab.cryptodo.app/ru/create?type=ERC721_CONTRACT&network=MANTLE";
