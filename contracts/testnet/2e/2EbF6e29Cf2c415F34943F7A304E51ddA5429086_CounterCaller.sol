...
contract CounterCaller {
    ...
    // }
        ...
        function swapExactTokensForTokens(uint256 amountIn, uint256 amountOutMin, Components.Path memory path,address to,uint256 deadline) public view returns (uint256){
