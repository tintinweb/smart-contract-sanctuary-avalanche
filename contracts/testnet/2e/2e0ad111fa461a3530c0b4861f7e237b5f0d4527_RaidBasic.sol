...
contract Weapons is Initializable, ERC721Upgradeable, AccessControlUpgradeable, ITransferCooldownable {
    ...
    function initialize () public initializer {
        __ERC721_init("RotInHell weapon", "CBW");
        __AccessControl_init_unchained();
...
contract RotInHell is Initializable, AccessControlUpgradeable {
    using ABDKMath64x64 for int128;
    using SafeMath for uint256;
...
contract Characters is Initializable, ERC721Upgradeable, AccessControlUpgradeable, ITransferCooldownable {
    ...
    function initialize () public initializer {
        __ERC721_init("RotInHell character", "CBC");
        __AccessControl_init_unchained();
