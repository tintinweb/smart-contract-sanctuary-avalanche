...
contract StandartStaking is Ownable, ReentrancyGuard {
    ...
    function _harvest(address harvester, uint256 _pid) internal {
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function _deposit(address userAddress,uint256 _pid,uint256 _amount, bool isPoolTransfer)internal{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function transferPoolNativeToOther(uint256 _pid,uint256 _newPid) external nonReentrant{
        ...
        uint256 _amount = user.amount + pending;
         user.amount = 0;
        _deposit(msg.sender, _newPid, _amount, true);
