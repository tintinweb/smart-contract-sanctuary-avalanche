...
contract JamesStory is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("JamesStory", "XJS") {}
    ...
    function safeMintNTimes(address to, uint N, string memory uri) public onlyOwner {
        require(N > 0 && N <= 500, "N must be between 1 and 500");
