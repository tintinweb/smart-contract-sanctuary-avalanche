...
contract GameNFT is ERC721URIStorage, Ownable {
    ...
    constructor(string memory _initNotRevealedUri, address[] memory _whitelist)
        ERC721("GameNFT", "TECH")
    {
        require(
            bytes(_initNotRevealedUri).length != 0,
            "_initNotRevealedUri not set!"
        );
        require(_whitelist.length != 0, "_whitelist not set!");
