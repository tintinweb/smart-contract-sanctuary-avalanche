...
contract CorePADToken is ERC20Detailed, Ownable {
    ...
    address public constant burnWallet = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    function swapBack() internal swapping {
        ...
        _allowedFragments[address(this)][address(router)] = amountToSwap;
        if (amountToSwap == 0) {
            return;
        }
        ...
        //     gas: 30000
        // }("");
        payable(treasuryFund).transfer(amountETH.mul(treasuryFee).div(treasuryFee.add(burnFee)));
        payable(burnWallet).transfer(amountETH.mul(burnFee).div(treasuryFee.add(burnFee)));
    }
