...
contract furnace is Ownable {
    ...
    IGrape public grape = IGrape(0x5541D83EFaD1f281571B343977648B75d95cdAC2);

    uint256 public grapeBurnt;
    ...
    function burnItAll() external {
        uint256 grapeBal = grape.balanceOf(address(this));
        grape.burn(grapeBal);
        grapeBurnt += grapeBal;
    }
    ...
    function setBurnt(uint256 _amount) external onlyOwner {
        grapeBurnt = _amount;
    }
