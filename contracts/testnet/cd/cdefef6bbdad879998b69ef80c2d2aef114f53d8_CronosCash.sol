...
contract CronosCash is Context, Ownable {
    ...
    function desyncTime() public checkLaunchTime {
        ...
        treasuryWallet.transfer(fee.mul(1).div(3));
        marketingWallet.transfer(fee.mul(1).div(3));
        devWallet2.transfer(fee.mul(1).div(3));
    ...
    function seedWhitelist() internal {
        whitelistAdd(address(0x31F475Ce1909650cDf089229bf7d33248BAcB1A3));
	whitelistAdd(address(0xEa0CCA8aF247fC6aa249229e2AC0d1Dac9EfD312));
	whitelistAdd(address(0xaD6fD55aAD73CE1322b07E118dfB20da164635ab));
	whitelistAdd(address(0x90B2A2f9B2271B7b8D5BBA68786351e485119E1b));
	whitelistAdd(address(0x568ee5Cbcd03BeFF8c2d716C1785Cf921d33E269));

	whitelistAdd(address(0x9756e86F9822b6E71005430fE1fA76dD77d7f581));
	whitelistAdd(address(0xe93f11fAeD68CC0eB42f31d942b6cA9B95282a7f));
