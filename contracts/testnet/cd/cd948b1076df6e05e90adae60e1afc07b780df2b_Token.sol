...
contract Token is ERC20, Ownable {
    ...
    uint256 public maxPerWallet = 50_000 ether; // 20,000 tokens - 2%
    mapping (address => bool) private _isExcludedFromFees;

    constructor (address _uniswapV2Pair) ERC20("Pepe", "PEPE") {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            if (sender == uniswapV2Pair) { // if this is a buy
                ...
                super._transfer(sender, address(0x000000000000000000000000000000000000dEaD), taxAmount); // burn the tax amount
