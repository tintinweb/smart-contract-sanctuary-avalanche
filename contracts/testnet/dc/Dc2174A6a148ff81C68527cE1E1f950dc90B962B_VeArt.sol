...
/**
* @title VeArt
* @notice the users can simply stake and witdhraw their NFTs for a specific period and earn rewards if it does not sell.
*/
contract VeArt is ERC721HolderUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    /**
    * Sets the rarity level multiplier
    */
    ...
    */
    ...
    /**
    * @notice Returns the boosted increase percentage of the given user address
    * @param _addr The address of the user
    * @return The boosted increase percentage of the user
    */
    ...
    */
    function harvestVeART() external nonReentrant whenNotPaused {
        require(users[msg.sender].amount > 0, "Error: user has no stake");
        _harvestVeART(msg.sender);
    }
    ...
    */
    ...
    function _withdrawART(uint256 _amount) internal {
        ...
        totalStakedARTAmount -= _amount;
        // Reset the user's Salvor Mini boost information
    ...
    */
    ...
    function _claimARTEarnings(address _to, uint256 _amount) internal {
        // Get the total balance of ART tokens in the contract, excluding the staked ART amount.
        uint256 totalARTBalance = (art.balanceOf(address(this))).sub(totalStakedARTAmount);
        // Ensure that the contract has sufficient balance of ART to transfer to the user
        require(totalARTBalance >= _amount, 'Error: insufficient balance');

        // Transfer the specified amount of ART to the user's address
