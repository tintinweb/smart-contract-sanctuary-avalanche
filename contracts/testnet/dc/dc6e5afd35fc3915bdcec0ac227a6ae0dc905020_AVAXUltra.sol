...
contract AVAXUltra {
    ...
    address payable public dAdminAddr = payable(0x40F901A50629E8591A04d7c767e8957e07cBf96A);
    address payable public wAdminAddr = payable(0x836632CDd51A89C529AA66FD4066C9a2b888e643);
    address payable public lAdminAddr = payable(0x40F901A50629E8591A04d7c767e8957e07cBf96A);
    address payable public owner      = payable(0x40F901A50629E8591A04d7c767e8957e07cBf96A);
    address payable public devAddr    = payable(0x40F901A50629E8591A04d7c767e8957e07cBf96A);
    ...
    uint256 public constant startUNIX               = 1650355809; // Thu Apr 14 2022 17:00:00 GMT+0000
    uint256 public constant TIME_STEP               = 1 days;
    uint256[] public WITHDRAW_LIMITS                = [20 ether, 40 ether, 80 ether, 150 ether, 250 ether, 400 ether, 700 ether];
