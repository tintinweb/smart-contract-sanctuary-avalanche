    ...
    HasRouter
{
    ...
    function bond(
        ...
        LpToken.safeApprove(address(MedalToken), lpTokenAmount);
    ...
    function _addLPFromSideToken(
        ...
        MainToken.safeApprove(address(ROUTER), mainTokenAmount);
        SideToken.safeApprove(address(ROUTER), sideTokenAmount);
