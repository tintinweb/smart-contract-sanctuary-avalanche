    ...
    IApplication
{
    ...
    function depositReserveToken(
        ...
        (uint64 nonce, bool isUsdcDeposit) = _depositReserveToken(swapDetails);
        ...
        returns (uint64, bool)
    {
        ...
        bool isUsdcDeposit = _handleDepositForReserveToken(_depositNonce, swapDetails);
        return (_depositNonce, isUsdcDeposit);
    }
    ...
    function depositNonReserveToken(
        ...
        (uint64 nonce, bool isUsdcDeposit) = _depositNonReserveToken(swapDetails);
        executeDetails.depositNonce = nonce;
