...
contract LyoChild is  Initializable , ERC20Upgradeable , UUPSUpgradeable , OwnableUpgradeable   {
...
__Ownable_init();
   ...
   function changeBridge (address _bridge) public  onlyOwner{
    ...
    function burn( uint256 _amount) public virtual onlyBridge {
