...
contract PresaleUpgradeable is Initializable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable{
    ...
    function initialize() initializer public {
        _tokenSeller = 0x8dDb6225f44376c055daB3ae389e05892F06b3d3;
        _tokenContract = 0xa69a18251c4B8f96cdA921AF7edDaED2cA5cDe18;
    ...
    function remainingTokensToSale() external view returns (uint256 _tokenValueInWei){
        return IERC20Upgradeable(_tokenContract).allowance(_tokenSeller, address(this));
    }
