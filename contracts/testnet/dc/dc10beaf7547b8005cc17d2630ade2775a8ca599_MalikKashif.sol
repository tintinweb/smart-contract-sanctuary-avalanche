...
contract MalikKashif is ERC721A, Ownable {

    uint256 _currentIndex = 1; //Make first tokenId = first json file.
    string baseExtension = ".json";
    uint256 _mintamount = 500; //It will be equal to quantity.
    ...
    constructor(
        string memory _MalikKashif,
        string memory _MK,
        string memory _baseUri
    ) ERC721A(_MalikKashif, _MK) {
