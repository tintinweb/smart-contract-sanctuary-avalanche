...
contract MeshMobile is Ownable, ReentrancyGuard {
    ...
    event LogProviderRegistered(address registrant, bytes32 identifier, bytes32 endpoint, bytes8 mcc_mnc);
    ...
    uint256 public operatingFee = 1000000000; // Operating cost collected by ****
    ...
    // Need to check this for duplicate identifiers
    function registerDevice(
        ...
        emit LogDeviceRegistered(owner, identifier);
    }

    // Need to check this for duplicate identifiers/endpoint/mcc_mnc
    function registerProvider(
        ...
        emit LogProviderRegistered(owner, identifier, endpoint, mcc_mnc);
    }
    ...
    // add validity checking for idp
    function deposit(address idp) public payable {
    ...
    // Pending validations data
    function getPendingValidationCount() public view returns (uint count) {
