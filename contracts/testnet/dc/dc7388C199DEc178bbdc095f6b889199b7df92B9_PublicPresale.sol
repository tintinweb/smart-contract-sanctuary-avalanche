...
contract PublicPresale is Owned {
    ...
    function buy(uint256 paidAmount) public {
        require(isPresaleOpen, "Presale is not open yet");
        require(paidAmount > minTokLimit, "You need to sell at least some min amount");
        require(_paidTotal[msg.sender] + paidAmount <= maxTokLimit);
