...
/* .        .               .        --==*  .                          .                            . 
    ...
    ░░███     ███ ░███ ░███ ░███ ░███ ░███ ░███  ░███ ░███  ░░░░███              .             *⠀
     ...
     Contract then converts the stables to more LP Token and puts back in pool, accruing interest and
     compounding on any interaction.
     ...
     is only 1 borrower and there can be many lenders. There is NO interest rates between these parties, lenders 
     earn from the yield generated. Borrowers are still subject to liquidations in these pools.
    ...
    These contracts are a fork of impermax / tarot, with some minor differences. 
...
// xlllwppxxxxx-License-Identifier: Unlicense
...
//xlllwppxxxxx-License-Identifier: Unlicensed
pragma solidity >=0.8.4;
...
// xlllwppxxxxx-License-Identifier: MIT
...
// xlllwppxxxxx-License-Identifier: GPL-3.0
pragma solidity >=0.8.4;
...
contract CygnusDeneb is ICygnusDeneb {
    ...
    /**
     *  @notice This is the Collateral Deployer contract which starts the collateral in every lending pool.
     *  @notice Contract bytecode wouldn't fit in Factory.
