...
contract Oracle is Base {
	...
	/// @param addr Address of the OneInch contract
...
contract ProtocolDAO is Base {
	...
	/// @return The protocol setting for legth of time a minipool cycle is in days
	function getMinipoolCycleDuration() public view returns (uint256) {
		return getUint(keccak256("ProtocolDAO.MinipoolCycleDuration"));
	}

	/// @notice The duration of a mibnipool's cycle delay tolorance
	...
	/// @return The protocol setting for the average rewards rate a node recieves for beign a validator
