...
contract Bleavers is ERC721A, Ownable, ERC2981 {
    ...
    mapping(uint256 => string) public contactInfo;
    mapping(address => uint256) private whitelistMintAmount;
    ...
    constructor(address receiver, uint96 feeNumerator, uint256 reserveAmount) ERC721A("Bleavers", "BLEAVER")
    {
        _setDefaultRoyalty(receiver, feeNumerator);
        ownerMint(msg.sender, reserveAmount);
    }
    ...
    function mint(uint256 quantity) external payable {
      ...
      require(
        quantity <= maxPerTx, 
        "Amount is more than max per TX."
      );
