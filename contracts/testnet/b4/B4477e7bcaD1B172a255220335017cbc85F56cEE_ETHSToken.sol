...
contract ETHSToken is IBEP20, Auth {
    ...
    uint256 internal swapThreshold = 500 * 10 ** _decimals;
    ...
    constructor() Auth(msg.sender) {
        ...
        launchEndTime = launchStartTime + (20 * 1 minutes);
    ...
    function swapBack() internal swapping islaunchTime
    {
        ...
        ETHwToAVAX(amountToSwap + treasuryTax + marketingTax);
