    ...
    ERC721BurnableUpgradeable 
{
    ...
    // events
    event NFTMinted( address receiver, uint256 tokenId); 

    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}

    function initialize() external initializer {
        __ERC721_init("ActiveNFT", "ActiveNFT");
    ...
    function safeMint(address to, string memory uri) external whenNotPaused onlyOwner returns (uint256) {
    ...
    function renounceOwnership() public onlyOwner whenNotPaused override view {
        revert("can't renounceOwnership");
    }
    
    function destroySmartContract(address payable to) external onlyOwner {
        selfdestruct(to);
    }
}