...
/// @author Rulo benini
/// @dev This is deployed as a facet of RangoV2
contract RangoCbridgeCCTPFacet is IRango, ReentrancyGuard, IRangoCbridgeCCTP {
    ...
    /// @param _addresses The contracts addresses related to cbridge proxy for interaction with CCTP
        ...
        internal
    {
        ...
        require(
            ...
            "Requested cbridge proxy for cctp not whitelisted"
        );
        ICbridgeCCTP cbridgeProxy = ICbridgeCCTP(
            request.cbridgeProxyAddress
        );
        LibSwapper.approveMax(token, request.cbridgeProxyAddress, amount);
