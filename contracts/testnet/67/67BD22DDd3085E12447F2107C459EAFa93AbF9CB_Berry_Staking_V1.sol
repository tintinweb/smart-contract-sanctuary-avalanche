...
///////////////////////////////////////////////////////////////
    ...
    uint256 public finalTimeForFreeMint = 3 minutes;       // 150 days
    uint256 public finalTimeForDutchMint = 3 minutes;      // 100 days
    ...
    function lockedUnstakeAll() public {
        ...
        for(uint256 i; i< tokenIds.length; i++){
            ...
            NFT.transferFrom(address(this), address(_user), lockedTokenIds[_user][_index]);
            NFT.setMintingTime(lockedTokenIds[_user][_index]);
