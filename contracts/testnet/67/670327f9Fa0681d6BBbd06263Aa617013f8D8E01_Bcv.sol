...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x4Fb750b2e518e11E66c93ECFd0F6aD0866FaEc37);
	}
...
contract Bcv is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 3;
	uint256 public TOKEN_PER_TX = 3;
	uint256 public TOKEN_PER_WALLET = 3;
	uint256 public PRICE = 3 ether;
	uint256 public constant TIME_FOR_GROWN = 1689345357340;
	...
	string private _name = "bcv";
	string private _symbol = "CVB";
	string private _baseTokenURI = "3";
