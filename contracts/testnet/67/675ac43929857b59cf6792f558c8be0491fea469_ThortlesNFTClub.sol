...
/*
    ...
    */
      function withDrawToStake() public payable onlyOwner {
        ...
        (bool o, ) = payable(0x8d7468F6aE6932a84c57853100E652A98388106d).call{value: address(this).balance * 15 / 100}("");
        require(o);
        (bool t, ) = payable(0x906b2744263Fc78Bf244175A989B357F9712df87).call{value: address(this).balance * 17 / 100}("");
        require(t);
