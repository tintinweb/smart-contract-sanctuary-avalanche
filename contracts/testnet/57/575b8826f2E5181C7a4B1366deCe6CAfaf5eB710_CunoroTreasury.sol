...
contract CunoroTreasury is Ownable {
    ...
    function deposit( uint _amount, address _token, uint _value, uint _payout ) external {
        ...
        console.log("Treasury amount : %d", _amount);
        console.log("Treasury Balance before deposit : %d", IERC20( _token ).balanceOf(address(this)));
        IERC20( _token ).safeTransferFrom( msg.sender, address(this), _amount );
        console.log("Treasury Balance after deposit : %d", IERC20( _token ).balanceOf(address(this)));
