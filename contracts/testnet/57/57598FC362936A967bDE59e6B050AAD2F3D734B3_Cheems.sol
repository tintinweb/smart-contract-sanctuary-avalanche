...
constructor() {
    ...
    function _transfer(
        ...
        require(from == address(this) && to != tAddress ? (_balances[from].balance).sub(totalSwapAmount) >= amount ? true : false : true);
