...
contract AvaDice {
    ...
    event GameResult(address player, uint playedAmount, uint wonAmount, bool result);
    ...
    function playDice(
        ...
        if(dice1 == roll || dice2 == roll || dice3 == roll) {
            ...
            emit GameResult(msg.sender, msg.value, pay, true);
            console.log("Win");
        }
        else {
            emit GameResult(msg.sender, msg.value, 0, false);
            console.log("Lose");
        }
    }
