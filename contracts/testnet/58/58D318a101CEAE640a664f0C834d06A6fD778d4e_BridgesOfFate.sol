...
contract BridgesOfFate is Ownable {
    ...
    uint256 private constant TURN_PERIOD = 900; // 5 minutes // 3 hours 10800
    ...
    mapping(uint256 => bool) private isNarrowingGameEnded;
    ...
    modifier NarrowingGameEndRules() {
        ...
        {
            require(isNarrowingGameEnded[latestGameId] == true ,"Hybird Game Ended.");
        }
        _;
    }
    ...
    */
    ...
    function initializeGame(uint256 _startAT) external onlyOwner {
        ...
        isNarrowingGameEnded[latestGameId] = true;
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules NarrowingGameEndRules{
        ...
        if(_gameStatus.stageNumber == _currentStage){
            if((_narrowingGameMap < _NarrowingNumberProbility ) &&  (_checkSide(_gameStatus.stageNumber,_jumpSide))){
                ...
                isNarrowingGameEnded[latestGameId] =  false;
            }
        }
