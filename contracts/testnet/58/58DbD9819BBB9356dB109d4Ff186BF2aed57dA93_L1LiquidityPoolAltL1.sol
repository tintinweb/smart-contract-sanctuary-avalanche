 ...
 */
contract L1LiquidityPoolAltL1 is CrossDomainEnabledFast, ReentrancyGuardUpgradeable, PausableUpgradeable {
        ...
        whenNotPaused()
    {
        ...
        if (_tokenAddress == address(0)) {
            ...
            L1StandardBridgeAltL1(L1StandardBridgeAddress).depositNativeTokenTo{value: _amount}(
            ...
            L1StandardBridgeAltL1(L1StandardBridgeAddress).depositERC20To(
                _tokenAddress,
                pool.l2TokenAddress,
                L2LiquidityPoolAddress,
                _amount,
