...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        token.mint(address(stoker), tokenReward);
    ...
    function enterStaking(uint256 _amount) public {
        ...
        stoker.mint(msg.sender, _amount);
    ...
    function leaveStaking(uint256 _amount) public {
        ...
        stoker.burn(msg.sender, _amount);
    ...
    function safeTokenTransfer(address _to, uint256 _amount) internal {
        stoker.safeTokenTransfer(_to, _amount);
    }
...
// sToken with Governance.
contract sToken is ERC20("sToken Token", "sTOKEN") {
    ...
    constructor(TokenToken _token) public {
        token = _token;
    }
