    ...
    BRTERC20Upgradeable
{
    ...
    modifier onlyWhitelisted() {
        require(whitelisted[msg.sender] || owner() == msg.sender);
        _;
    }
    ...
    function deposit(uint256 _amount, address _user) public onlyWhitelisted {
    ...
    function withdraw(uint256 _amount) public onlyWhitelisted {
        ...
        if (_amount > 0) {
            ...
            emit Withdraw(msg.sender, bavaPid, _amount);
        }
    }
