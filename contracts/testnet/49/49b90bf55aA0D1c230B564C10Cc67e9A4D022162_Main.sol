...
contract Main is Ownable, CloneFactory {
    ...
    mapping(bytes32 => FNFTBuyerInfo[10]) public buyerInfo;
    ...
    function refundFromFNFT(bytes32 _key) external {
        ...
        IERC1155(listInfo[_key].collectionId).safeTransferFrom(msg.sender, marketFactory, listInfo[_key].tokenId, 1, "");
    }

    function withDrawFromFNFT(bytes32 _key) external {
        require(listInfo[_key].maker == msg.sender, "Main: not owner");
