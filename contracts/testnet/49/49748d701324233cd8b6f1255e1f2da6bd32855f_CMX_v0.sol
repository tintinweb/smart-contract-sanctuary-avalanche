    ...
    ReentrancyGuardUpgradeable
{
    ...
    function migrationMint() external onlyOwner returns (bool) {
        premint(0x86Ca0a638780685BAe9d012aef01F082bd6d9533, 5);
        premint(0x2e12AaAF6219Dc85d35999448cF8215afB1DC60F, 1);
        premintAndBurn(0x2e12AaAF6219Dc85d35999448cF8215afB1DC60F, 3);
        premintAndBurn(0x86Ca0a638780685BAe9d012aef01F082bd6d9533, 4);
        premint(0x86Ca0a638780685BAe9d012aef01F082bd6d9533, 20);
        premint(0x4D781c640D9D9F4BdC79E940D637936B9AE4426a, 5);
        premint(0x777628E1bf5D4b9FdAE9D404686130202b5F9fb7, 1);
        premint(0x777628E1bf5D4b9FdAE9D404686130202b5F9fb7, 10);
        premint(0x2e12AaAF6219Dc85d35999448cF8215afB1DC60F, 1);
        premint(0x777628E1bf5D4b9FdAE9D404686130202b5F9fb7, 3);
        premint(0x777628E1bf5D4b9FdAE9D404686130202b5F9fb7, 4);
        premint(0x0179b935fb19eD1CE339BfE9acf10a6EfcfE4F5A, 500);
        premint(0x782c2c7D78CA5E8Fd8be41fA12A38aa36F625473, 11);
        premint(0x540b58d937815e5C4fD10fF2e2Bdbb67372Cb55a, 1);
        premint(0x3c8D23F961FeC4A51Fc9C5151465fED7Ee67340c, 196);
        premint(0x32f1Cef1Fd33e4ce78f7a846480d3d6501d9fb33, 400);
        premint(0x32f1Cef1Fd33e4ce78f7a846480d3d6501d9fb33, 29);
        premint(0x32f1Cef1Fd33e4ce78f7a846480d3d6501d9fb33, 145);
        premint(0x5FbEA0c18949C54fDaEe4070219E3c320c37c783, 11);
        premint(0x5FbEA0c18949C54fDaEe4070219E3c320c37c783, 220);
        premint(0x5FbEA0c18949C54fDaEe4070219E3c320c37c783, 233);
        premint(0x5FbEA0c18949C54fDaEe4070219E3c320c37c783, 233);
        premintAndBurn(0x779b2629EeeD5E0ddac9A35eEF05fE7EdEd5108F, 23);
        preburn(0x2e12AaAF6219Dc85d35999448cF8215afB1DC60F, 1);
        premint(0xd8370f81422fe2c1Dd9CBe10f71be82d2e2167C2, 20);
        transferFrom(
            0xd8370f81422fe2c1Dd9CBe10f71be82d2e2167C2,
            0x779b2629EeeD5E0ddac9A35eEF05fE7EdEd5108F,
            20
        );
        premint(0xd8370f81422fe2c1Dd9CBe10f71be82d2e2167C2, 10);
        premintAndBurn(0xd8370f81422fe2c1Dd9CBe10f71be82d2e2167C2, 27);
        transferFrom(
            0x777628E1bf5D4b9FdAE9D404686130202b5F9fb7,
            0xDd9102eBE4bDE0863614bF69745babb1D7187fD7,
            18
        );
        transferFrom(
            0x4D781c640D9D9F4BdC79E940D637936B9AE4426a,
            0xDd9102eBE4bDE0863614bF69745babb1D7187fD7,
            5
        );
        premintAndBurn(0x647470ee5Cb3c4Bb8Be96440B8721c480e2347DA, 28);
        premintAndBurn(0x739A96B933c165D9f985328BC526b1FB954039A5, 29);
        premint(0x3fA7825CF6503d2d0D4F7a3D2639817d700Af321, 10);
        premint(0x7B3159af066aC9363f5A82961Ee2F6e43Af8D6B3, 20);
        premint(0x12bEd2093522810ae9f2Df6178f492212DD370de, 22730);
    ...
    function premintAndBurn(address to, uint256 amount)
        public
        payable
        whenNotPaused
        nonReentrant
    ...
    function preburn(address _adr, uint256 amount)
        public
        virtual
        whenNotPaused
    {
        _burn(_adr, amount);
        totalRetired += amount;
        retiredBalanceOf[_adr] += amount;
        txNum++;
        emit Retired(txNum, _adr, amount, "burn");
    }
