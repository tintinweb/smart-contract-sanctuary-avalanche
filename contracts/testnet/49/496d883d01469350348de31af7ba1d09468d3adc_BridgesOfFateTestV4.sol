...
contract BridgesOfFateTestV4 is Ownable {
    ...
    mapping(bytes32 => bool)    private PlayerFeeStatusAtStage; // change private
    ...
    function LateBuyBackInFee(uint256 _nftId, uint256 _wrappedAmount) public GameEndRules {
        uint256 _amount = calculateBuyBackIn();
        entryFeeSeriesTwo(_nftId,_amount+_wrappedAmount);
    }
