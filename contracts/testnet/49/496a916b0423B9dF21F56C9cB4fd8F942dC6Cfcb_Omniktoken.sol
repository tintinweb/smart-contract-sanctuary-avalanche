...
contract Omniktoken is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 4000;
	uint256 public TOKEN_PER_TX = 100;
	uint256 public TOKEN_PER_WALLET = 10;
	uint256 public PRICE = 10 ether;
	uint256 public constant TIME_FOR_GROWN = 1686380747000;
	...
	string private _name = "omniktoken";
	string private _symbol = "OMNIK";
