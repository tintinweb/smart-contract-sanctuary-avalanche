...
import {IPawnProxyAdmin} from "../interfaces/IPawnProxyAdmin.sol";
import {MultipleUpgradeableProxy} from "../proxy/MultipleUpgradeableProxy.sol";
 ...
 * @author 0xkongamoto
 */
contract MultipleUpgradeableProxy {
    //
    ...
    // ======== Constructor =========
    constructor(
        IPawnProxyAdmin _multipleProxyAdmin,
        bytes32 _multipleProxyKey,
        bytes memory _initializationCalldata
    ) {
        multipleProxyAdmin = _multipleProxyAdmin;
        multipleProxyKey = _multipleProxyKey;
        // Delegatecall into the logic contract, supplying initialization calldata
        address _impl = multipleProxyAdmin.getMultipleProxyImplementation(
            multipleProxyKey
        );
        (bool _ok, bytes memory returnData) = _impl.delegatecall(
            _initializationCalldata
        );
