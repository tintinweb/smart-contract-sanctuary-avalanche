...
interface IJoePair {
    ...
    function mint(address to) external returns (uint256 liquidity); // TIMELOCK remove this?
...
contract Caesar is ERC20Detailed, Ownable {
    ...
    function mint(address recipient, uint256 amount) external onlyWrapped { // TIMELOCK
