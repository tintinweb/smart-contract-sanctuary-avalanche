 ...
 *proxy: https://snowtrace.io/token/0x9702230a8ea53601f5cd2dc00fdbc13d4df4a8c7
 *logic: https://snowtrace.io/address/0xba2a995bd4ab9e605454ccef88169352cd5f75a6#code
*/

// SPDX-License-Identifier: MIT

import "./TetherTokenAvaxFlattenedUpgrade.sol";

pragma solidity ^0.8.0;

contract TetherTokenAvaxFlattenedInherit is TetherTokenAvaxFlattenedUpgrade{

  function dummy_function() public pure override returns (uint8)
  {
    return 2;
  }
}
...
contract TetherTokenAvaxFlattenedUpgrade is Initializable, ERC20PermitUpgradeable, OwnableUpgradeable, WithBlockedList {
  ...
  function dummy_function() public pure virtual returns (uint8)
  {
    return 1;
  }
