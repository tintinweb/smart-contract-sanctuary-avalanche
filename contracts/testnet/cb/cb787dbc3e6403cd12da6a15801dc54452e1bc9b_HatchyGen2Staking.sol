...
// File contracts/IHatchyRewarder.sol
...
// File contracts/HatchyGen2Staking.sol
    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _hatchyGen2) public initializer {
        __Ownable_init();
    ...
    function setHatchyGen2(address gen2) external onlyOwner {
        hatchyGen2 = gen2;
    }
}