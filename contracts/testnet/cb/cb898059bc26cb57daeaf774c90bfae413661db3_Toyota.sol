...
contract Toyota is ERC20Burnable, Operator {
    ...
    uint256 public constant INITIAL_BOMB_POOL_DISTRIBUTION = 100000 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("Car Finance", "Toyota") {
