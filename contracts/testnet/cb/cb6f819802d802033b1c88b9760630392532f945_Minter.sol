...
contract Minter is Ownable {
     ...
     *  count WACEO amounts by request total amount and percentages from distributor addresses,
     *  check for ERC20 allowance and transfer tokens from request sender to LP_helper address,
     *  distribute WACEO tokens to recipient addresses
     *  update request updateDate and change isApproved/isDeclined status
     *  @return bool
     */
    ...
    /**
     *  @dev Updates distribution addresses and percentage amounts
     *  @return bool
     */
    ...
    /**
     *  @dev converts 'Token' amount to WACEO value 
    ...
    /**
     *  @dev converts WACEO amount to BASE value
