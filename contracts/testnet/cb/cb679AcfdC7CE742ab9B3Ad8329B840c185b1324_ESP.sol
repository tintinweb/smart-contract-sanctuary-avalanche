...
contract ESP is ERC20, ERC20Snapshot, Ownable, Pausable {
    using SafeMath for uint256;

    string private constant _name = "SpyFinancial";
    ...
    address public ExtensionAddress2;
    ...
    constructor() ERC20(_name, _symbol) {
        //inital value
        //_mint(address(this), SafeMath.mul(100, _OneESP));
    }
    ...
    function setExtensionAddress2(address _address) external onlyOwner {
        require(_address != address(0), "address is not correct");
        ExtensionAddress2 = _address;
    }
