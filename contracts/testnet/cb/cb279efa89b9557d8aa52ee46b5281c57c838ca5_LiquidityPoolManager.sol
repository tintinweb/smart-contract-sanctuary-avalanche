    ...
    UniverseImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x2775D1174C73aD1AC158b9FB9B2571a1a214f110), // Treasury investments (40%)
        address(0x4e7329B45BB5f919616c099A652FCF1313c0a7B8), // Dev (30%)
        address(0x8F5E20fFAA83ca221b3d60f5F2E2d2C719e6E1b2) // Marketing (30%)
    ];
    ...
    {
        ERC20 token = ERC20(this.getLeftSide());
        (uint Res0, uint Res1,) = pair.getReserves();

        // decimals
        uint res0 = Res0 * (10 ** token.decimals());
