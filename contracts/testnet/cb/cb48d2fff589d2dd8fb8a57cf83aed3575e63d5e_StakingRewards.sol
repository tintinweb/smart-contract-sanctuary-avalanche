...
contract StakingRewards is Ownable, AccessControl, Pool {
    ...
    event AddStake(address owner, uint _stakeID, uint256 amount);
    ...
    function addStakeRc (uint period) external payable {
        ...
        emit AddStake(msg.sender, userStakeRecordIndex, msg.value);
    }
