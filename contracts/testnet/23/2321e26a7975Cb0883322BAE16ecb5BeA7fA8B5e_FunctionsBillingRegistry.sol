  ...
  AuthorizedReceiver
{
  ...
  function fixEthFeedAddress() onlyOwner public {
    // The right LINK/AVAX price feed
    LINK_ETH_FEED = AggregatorV3Interface(address(0x79c91fd4F8b3DaBEe17d286EB11cEE4D83521775));
  }
