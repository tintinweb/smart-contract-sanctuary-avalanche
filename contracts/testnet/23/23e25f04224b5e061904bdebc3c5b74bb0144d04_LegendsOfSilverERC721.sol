...
contract LegendsOfSilverERC721 is Initializable, ERC721Upgradeable, AccessControlEnumerableUpgradeable {
    ...
    uint256 public constant TOKEN_EQUIVALENCE = 31 * 1e18;
    ...
    function initialize(string memory name_, string memory symbol_, address _owner, address _token, string memory baseURI_) public initializer {
