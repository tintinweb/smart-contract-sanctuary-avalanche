...
import "./claw-prize2.sol";
import "./claw-prize3.sol";
import "./claw-prize4.sol";
    ...
    ClampedRandomizer
{
    ...
    uint256 private _maxRandomizer = 4100;
    ...
    {
        contract1 = prize1(_prize1);
        contract2 = prize2(_prize2);
        contract3 = prize3(_prize3);
        contract4 = prize4(_prize4);
