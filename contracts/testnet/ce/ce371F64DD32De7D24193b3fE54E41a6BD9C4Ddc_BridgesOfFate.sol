...
contract BridgesOfFate is Ownable {
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules NarrowingGameEndRules{
        ...
        if (GameMap[_currentUserStage] <= 0) {
             ...
             */
            bool  previousJumpSide = GameMap[_gameStatus.stageNumber ] >= 50e9;
            bytes32[] memory _totalNFTlength = _selectSuccessSidePlayerId(getStagesData(_gameStatus.stageNumber ),previousJumpSide,currentDay);
