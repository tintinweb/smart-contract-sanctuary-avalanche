  ...
  Authorizable
{
  ...
  uint main_dec = 18;
  uint token_dec = 18;
  address swap_add = 0x843814aF5229F4627FfEA5fC4cDd4208a25577c3;
  address stable_add;
  bool stableOn = false;
  ...
  function getTokenPrice() public view returns(uint[7] memory)
   {
    ...
    uint _main = main.div(10**main_dec).mul(doll_pr);
    ...
    function getEm() public view returns (uint) {
    	...
    	uint a = res[3]; // return amount of token0 needed to buy token1
    	return a;
    }
}