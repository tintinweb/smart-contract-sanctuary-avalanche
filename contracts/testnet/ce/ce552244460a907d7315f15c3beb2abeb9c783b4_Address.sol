...
// File: full_not_splited_code.sol
...
contract Orion is ERC20, Ownable, PaymentSplitter {
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) ERC20("Orion", "OIN") PaymentSplitter(payees, shares) {
        ...
        //350000e18
        require(totalSupply() == 350000, "CONSTR: totalSupply must equal 350,000 (350k short)");
