...
//SubzeroFundsContract

contract SubzeroFundsContract is Ownable {

  //token attributes
  string public constant NAME = "Subzero Launchpad"; //name of the contract
  uint public  maxCap; // Max cap in SUBZERO
  uint256 public immutable saleStartTime; // start sale time
  uint256 public immutable saleEndTime; // end sale time
  uint256 public totalSUBZEROReceivedInAllTier; // total bnd received
  uint256 public totalSUBZEROInTierOne; // total SUBZERO for tier one
  uint256 public totalSUBZEROInTierTwo; // total SUBZERO for tier Tier
  uint256 public totalSUBZEROInTierThree; // total SUBZERO for tier Three
  uint256 public totalSUBZEROInTierFour;  // total SUBZERO for tier Four
  uint256 public totalSUBZEROInTierFive;  // total SUBZERO for tier Five
  uint256 public totalSUBZEROInTierSix;  // total SUBZERO for tier Six
  uint256 public totalSUBZEROInTierSeven;  // total SUBZERO for tier Seven
  uint256 public totalSUBZEROInTierEight;  // total SUBZERO for tier Eight
  uint256 public totalSUBZEROInTierNine;  // total SUBZERO for tier Nine
  uint public totalparticipants; // total participants in 
 ...
 //add the address in Whitelist tier Four to invest
  ...
  // send SUBZERO to the contract address
  receive() external payable {
     ...
     require(totalSUBZEROReceivedInAllTier + msg.value <= maxCap, "buyTokens: purchase would exceed max cap");
     
    if (getWhitelistOne(msg.sender)) { 
      require(totalSUBZEROInTierOne + msg.value <= tierOneMaxCap, "buyTokens: purchase would exceed Tier one max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierOne += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    } else if (getWhitelistTwo(msg.sender)) {
      require(totalSUBZEROInTierTwo + msg.value <= tierTwoMaxCap, "buyTokens: purchase would exceed Tier two max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierTwo += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    } else if (getWhitelistThree(msg.sender)) { 
      require(totalSUBZEROInTierThree + msg.value <= tierThreeMaxCap, "buyTokens: purchase would exceed Tier three max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierThree += msg.value;
      sendValue(projectOwner, address(this).balance);
    
    } else if (getWhitelistFour(msg.sender)) { 
      require(totalSUBZEROInTierFour + msg.value <= tierFourMaxCap, "buyTokens: purchase would exceed Tier Four max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierFour += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    }else if (getWhitelistFive(msg.sender)) { 
      require(totalSUBZEROInTierFive + msg.value <= tierFiveMaxCap, "buyTokens: purchase would exceed Tier Five max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierFive += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    }else if (getWhitelistSix(msg.sender)) { 
      require(totalSUBZEROInTierSix + msg.value <= tierSixMaxCap, "buyTokens: purchase would exceed Tier Six max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierSix += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    }else if (getWhitelistSeven(msg.sender)) { 
      require(totalSUBZEROInTierSeven + msg.value <= tierSevenMaxCap, "buyTokens: purchase would exceed Tier Seven max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierSeven += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    }else if (getWhitelistEight(msg.sender)) { 
      require(totalSUBZEROInTierEight + msg.value <= tierEightMaxCap, "buyTokens: purchase would exceed Tier Eight max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierEight += msg.value;
      sendValue(projectOwner, address(this).balance);
      
    }else if (getWhitelistNine(msg.sender)) { 
      require(totalSUBZEROInTierNine + msg.value <= tierNineMaxCap, "buyTokens: purchase would exceed Tier Nine max cap");
      ...
      totalSUBZEROReceivedInAllTier += msg.value;
      totalSUBZEROInTierNine += msg.value;
      sendValue(projectOwner, address(this).balance);
