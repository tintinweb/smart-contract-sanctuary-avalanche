...
contract Satoverse is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("My NFT Collection", "MYNFT") {
    _customBaseURI = 'ipfs://bafybeiaqrjeifdhxtytu4avk23lkn64srhizanrnm6ckah672bjhv3i6n4/';
    _price = 1 ether; // 1 AVAX mint price 
    _maxMintable = 100; // 10k max supply
