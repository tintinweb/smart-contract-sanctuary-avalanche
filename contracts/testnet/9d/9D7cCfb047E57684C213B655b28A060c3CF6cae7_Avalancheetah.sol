...
contract Avalancheetah is ERC721 {
...
return
string(
abi.encodePacked("ipfs://bafybeigpp447intwhmg2bhochdmz4g3ihxl7ijc6jl3obegbcxhp7mtp4y/", Strings.toString(tokenId), ".json")
);
}
