...
contract CablesMaster is ReentrancyGuard {
    ...
    **/
    function createAndFillTakerBuyOrder(
        ...
        uint24[8] memory gasCompensationCorrections = [116522, 146710, 176898, 207075, 237264, 267454, 297640, 372431];
    ...
    **/
    function createAndFillTakerSellOrder(
        ...
        uint24[8] memory gasCompensationCorrections = [116543, 146731, 176919, 207096, 237284, 267475, 297661, 372453];
