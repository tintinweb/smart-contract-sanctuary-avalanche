...
abstract contract ERC1238 is IERC1238 {
    ...
    function userExist(address user) external view virtual returns (bool) {
        if (_owners[user].isOwner) {
            return true;
        }
        return false;
    }
    ...
    function _burn(address from) internal virtual {
        ...
        require(_owners[from].isOwner, "ERC1238: address doesnt own the badge");
