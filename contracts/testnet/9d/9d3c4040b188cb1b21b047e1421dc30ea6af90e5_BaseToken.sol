...
/**
 ...
 | |  | |/ _ \  _/ /\ \   | |   | | |_ |  | |  |  ___/ 
 | |__| |  __/ |/ ____ \ _| |_  | |__| |  | |  | |     
 |_____/ \___|_/_/    \_\_____|  \_____|  |_|  |_|     
...
contract BaseToken is ERC20, Ownable {
    ...
    address public developmentWallet = 0x9C133049d3840cDdD27a54677613d49Af59D1c9d;
    uint private constant PERCENT_DIVIDER = 100;
    uint public constant SELLTAX = 4;


    event changeLiquidityPoolStatus(address lpAddress, bool status);


    constructor() ERC20("DeFAi GTP Token", "DefAI") {
