...
contract MiniMillionaires is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Mini Millionaires", "MMIL") {
    setBaseURI("https://nftstorage.link/ipfs/bafybeidggnmowdb4qameet2wdyjpb2d7pyp6lqcza45qer46dlat3zhyru/");
    royaltyFeesInBips = 800;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
            ...
            if(onlyWhitelisted == true){
                ...
                require(_mintAmount <= maxPerWalletWhitelist);
                require (getMywhiteListMintCount() < maxPerWalletWhitelist);
  ...
  function isWhitelisted(address _user) public view returns (bool){
    ...
    function getMywhiteListMintCount() public view returns (uint256) {
        return whiteListMintCount[msg.sender];
    }
