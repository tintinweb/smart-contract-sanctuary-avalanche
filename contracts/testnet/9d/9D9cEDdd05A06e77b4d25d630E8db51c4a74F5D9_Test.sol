...
contract Test is ERC721, ERC721Enumerable, Ownable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.filebase.io/ipfs/Qmewc1X4iTArgVkysZSxLdCLfr2DaSqqxGvYJFmVL4ShD5/";
    }
    ...
    function safeMint() public {
        ...
        require(checkEligibility(msg.sender) == true,"Nft already exist in wallet");
    ...
    return string(
        abi.encodePacked(
            "https://ipfs.filebase.io/ipfs/Qmewc1X4iTArgVkysZSxLdCLfr2DaSqqxGvYJFmVL4ShD5/",
            Strings.toString(id),".json"
            )
        );
    }

    function checkEligibility(address addr) public view returns (bool){
        uint256 noOfNfts = balanceOf(addr);
        if(noOfNfts > 0){
            return false;
        }
        return true;
