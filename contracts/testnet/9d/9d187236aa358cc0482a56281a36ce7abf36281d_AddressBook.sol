        ...
        onlyGreaterThanZero(expiration_)
    {
        ...
        if (
            ...
            if (
                ...
                // update contract address        
                // update in ERC20
                ERC20Interface(_ERC20ContractAddress).updateAddressBookContractAddress(contractAddress_);

                // update in Fee Management
                FeeManagementInterface(_FeeManagementContractAddress).updateAddressBookContractAddress(contractAddress_);
                ...
                SupplyManagementMultiSigInterface(_SupplyManagementMultiSigContractAddress).updateAddressBookContractAddress(contractAddress_);
                
                // update in Fee Management Multi-Sig
                FeeManagementMultiSigInterface(_FeeManagementMultiSigContractAddress).updateAddressBookContractAddress(contractAddress_);

                // update in Asset Protection Multi-Sig
                AssetProtectionMultiSigInterface(_AssetProtectionMultiSigContractAddress).updateAddressBookContractAddress(contractAddress_);

                // update in KYC Contract
                KYCInterface(_KYCContractAddress).updateAddressBookContractAddress(contractAddress_);

                // update in KYC Multi-Sig
                KYCMultiSigInterface(_KYCMultiSigContractAddress).updateAddressBookContractAddress(contractAddress_);
