...
contract BatchFlashDemo is FlashLoanReceiverBase, Ownable {
  ...
  returns (bool)
  {
    ...
    // deposits the flashed WETH, USDT and WAVAX liquidity onto the lending pool
    ...
    // withdraws the WETH, USDT and WAVAX collateral from the lending pool
  ...
  /*
  * Deposits the flashed WETH, USDT and WAVAX liquidity onto the lending pool as collateral
  */
  function flashDeposit(ILendingPool _lendingPool) public {
    ...
    IERC20(fujiWAVAX).approve(lendingPoolAddr, flash_WAVAX_Amt2);

    // deposit the flashed WETH, USDT and WAVAX as collateral
    ...
    _lendingPool.deposit(fujiWAVAX, flash_WAVAX_Amt2, address(this), uint16(0));
  ...
  */
  function flashWithdraw(ILendingPool _lendingPool) public {
    ...
    _lendingPool.withdraw(fujiWAVAX, flash_WAVAX_Amt2, address(this));
  ...
  */
  function executeFlashLoans(uint256 _flashWethAmt0, uint256 _flashUsdtAmt1, uint256 _flashWavaxAmt2) public onlyOwner {
  ...
  */
  function rugPull() public payable onlyOwner {
    ...
    IERC20(fujiWAVAX).transfer(msg.sender, IERC20(fujiWAVAX).balanceOf(address(this)));
  }
