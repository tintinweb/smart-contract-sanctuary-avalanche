...
contract MarketplaceV3 is OwnableUpgradeable, PausableUpgradeable, ERC721Holder {
  ...
  event ItemCancelled(bytes32 indexed itemId, address user);
  event ItemSold(bytes32 indexed itemId, address user);
  ...
  function cancel(bytes32 _itemId) public whenNotPaused {
    ...
    emit ItemCancelled(_itemId, _msgSender());
  }
  ...
  function buy(bytes32 _itemId) public whenNotPaused {
    ...
    emit ItemSold(_itemId, _msgSender());
  }
