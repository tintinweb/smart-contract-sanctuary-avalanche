...
contract NGInitialize is WithStorage {
    ...
    function init(
        ...
        gameConstants().BASE_CASH_PER_HOUR = 100;
        gameConstants().BASE_WOOD_PER_HOUR = 60;
        gameConstants().BASE_STONE_PER_HOUR = 40;
        gameConstants().BASE_OIL_PER_HOUR = 20;
        gameConstants().BASE_STEEL_PER_HOUR = 10;
