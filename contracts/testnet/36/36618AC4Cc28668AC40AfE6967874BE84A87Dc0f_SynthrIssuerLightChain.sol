...
contract SynthrIssuerLightChain is Owned, MixinSystemSettings {
    ...
    function resolverAddressesRequired() public view override returns (bytes32[] memory addresses) {
        ...
        newAddresses[3] = CONTRACT_SYNTHR_BRIDGE;
        newAddresses[4] = CONTRACT_WRAPPED_SYNTHR;
    ...
    function burnForRedemption(address deprecatedSynth, address account, uint256 balance) external onlySynthRedeemer {
    ...
    function burnSynths(
        ...
        require(synths[_synthKey].balanceOf(_account) >= _amount, "Insufficient synt amount to burn");
    ...
    function destIssue(address _account, bytes32 _synthKey, uint256 _synthAmount) external onlySynthrBridge {
    ...
    event BurnSynthForBridge(address indexed account, bytes32 currencyKey, uint256 synthAmount, uint16 destChainId);
}