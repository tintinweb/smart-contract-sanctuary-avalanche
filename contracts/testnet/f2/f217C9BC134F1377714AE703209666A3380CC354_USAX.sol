...
contract USAXStorage {
    ...
    string public constant name = "USAX Testing";
    string public constant symbol = "USAXT";
...
contract LibraryLock is USAXStorage {
...
contract USAX is USAXStorage, Context, IERC20, Proxiable, LibraryLock {	
