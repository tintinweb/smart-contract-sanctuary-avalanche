...
interface IContractNFTtwo {
    function claim(uint256 n, address _sender) external;
}
...
//
//
contract ContractNFT is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ERC2981PerTokenRoyalties {
    using StringsUpgradeable for uint256;

    uint256 public constant MAX_MINTABLE = 5000; // 5000 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant NFT_PRICE = 0.01 ether; // 2.5 avax for this launchpad
    uint256 public constant EARLY_NFT_PRICE = 0.01 ether; // 2.5 avax for this launchpad
    ...
    bool public earlyMint;
    uint256 gross;
    mapping(address => bool) admins;
    address royaltyRecipient;

    address contractTwoADR;
    ...
    function initialize(
        ...
        contractTwoADR = _contractTwoADR;
...
//
    function earlyClaim(uint256 n) public payable {
        ...
        require(n <= earlyMintAddresses[msg.sender], "Not enough early mint");
        require(
        ...
        /////////////////////
        IContractNFTtwo(contractTwoADR).claim(n, msg.sender);
        /////////////////////
    }
...
function claim(uint256 n) public payable {
        ...
        require(n > 0, "Number need to be higher than 0");
        require((mainMintCount[msg.sender] + n ) <= 10, "Max claim per address is 10");
...
//
    ...
    function mainMintCountResult(address addr)
        public
        view
        returns (uint256)
    {
