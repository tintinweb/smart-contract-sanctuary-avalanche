 ...
 * @author Aave
 **/
contract RewardsControllerAaveMock is RewardsDistributor, VersionedInitializable, IRewardsControllerAave {
...
abstract contract RewardsDistributor is IRewardsDistributor {
  ...
  // asset => AssetData
  mapping(address => RewardsDataTypes.AssetData) public _assets;
