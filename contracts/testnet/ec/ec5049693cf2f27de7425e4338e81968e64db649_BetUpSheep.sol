...
contract BetUpSheep is Initializable, UUPSUpgradeable, AccessControlUpgradeable, ERC721AUpgradeable  {
    ...
    function remainingMintAmount(address _sender) external view returns(uint256) {
        IBetStruct.PlayerRecord memory pr = IBetUpCore(betContract).playerRecords(_sender);
    ...
    */
    ...
    /*
        ...
        result = min(n1, n2);
    */
    function _calTotalMintOf(IBetStruct.PlayerRecord memory _pr) private pure returns(uint256){
    ...
    function _getAvailableAmount(address _sender,  IBetStruct.PlayerRecord memory _pr) internal view returns(uint256) {
