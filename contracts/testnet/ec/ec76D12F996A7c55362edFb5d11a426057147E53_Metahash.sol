...
contract Metahash is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address uniV2Router,
        uint256 snipeBlkAmt
    ) ERC20("Metahash", "MHS") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 100000000e18, "CONSTR: totalSupply must equal 100 Million");
        swapTokensAmount = 50 * (10**18);
    }
