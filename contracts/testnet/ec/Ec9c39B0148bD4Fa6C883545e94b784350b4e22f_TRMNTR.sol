...
contract TRMNTR is ERC721Enumerable, Ownable, ERC2981, ClampedRandomizer{
    
    uint public maxSupply = 250;
    uint public wlPrice = 0;
    uint public price = 0.3 ether;
    address public devAddress = 0xc0e12AF01B0bf0a4Cdc2667AbB353B7b3B0b8F42;
    address public artistAddress = 0xd8936E602E38dfEe5d6466865068b94b1943DEBF;
    uint public publicTimestamp = 1677873600; 
    uint public wlTimestamp = 1677787200;
    mapping(address => uint) public whitelist;
    string public baseURI ='https://metacardsclub.io/rotm/json/';

    constructor() ERC721("Rise of the Machines", "TRMNTR") ClampedRandomizer(maxSupply) {
