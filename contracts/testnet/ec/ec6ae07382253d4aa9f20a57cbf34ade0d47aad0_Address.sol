...
contract ArtInSociety is ERC721Enumerable, ReentrancyGuard, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    string public _cid;
    string public _nonRevealedURI = "https://gateway.pinata.cloud/ipfs/QmVTtCkMGDPPG914WVmhB6DMWbMvmDVJXWYouGWUYT4AX1";
    ...
    uint96 public tokenRoyalties = 10000; // 10% royalty
    address public royaltyPayout = 0xD99A90A855C376C567A32dC698D2394C030A1F56;

    constructor() ERC721("Art In Society", "AISN") {
        internalMint(0xD99A90A855C376C567A32dC698D2394C030A1F56); // s
        internalMint(0xD99A90A855C376C567A32dC698D2394C030A1F56); // a
        internalMint(0xD99A90A855C376C567A32dC698D2394C030A1F56); // x
        internalMint(0xD99A90A855C376C567A32dC698D2394C030A1F56); // mf
    ...
    function mint(uint256 count) external callerIsUser nonReentrant {
        ...
        require(totalSupply() <= maxSupply, "All ARTs have been minted");
