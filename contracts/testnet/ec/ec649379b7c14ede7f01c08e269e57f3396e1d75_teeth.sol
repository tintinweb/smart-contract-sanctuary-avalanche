...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x5db0735cf88F85E78ed742215090c465979B5006);
        _token = msg.sender;
    }
...
contract teeth is IBEP20, Auth {
    ...
    string constant _name = "TEETH";
    string constant _symbol = "TEETH";
    ...
    address public autoLiquidityReceiver=0x829684Df1B3EC28aDBaCd5b60c6E9d5377Db64FC;
    address public marketingFeeReceiver=0x829684Df1B3EC28aDBaCd5b60c6E9d5377Db64FC;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0x5db0735cf88F85E78ed742215090c465979B5006;
