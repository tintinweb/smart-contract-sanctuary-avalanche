...
contract OzDeployer is Initializable {
    ...
    function getbyte() public pure returns (bytes memory bytecode) {
    ...
    function deployProxies(
        ...
        require(salts.length == logics.length, "length not right");
    ...
    function _getProxyBytes(address logic, address admin) public pure returns (bytes memory bytecode) {
