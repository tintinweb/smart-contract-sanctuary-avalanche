...
contract Vesting is Ownable {
    ...
    constructor(
        ...
        require(startTimestamp_ >= block.timestamp, 'Vesting: startTimestamp incorrect');
        token = token_;
    ...
    function initRounds(Round[] memory rounds_) external onlyOwner {
        require(!isInitRound, 'Vesting: already init');
        require(rounds_.length > 0, 'Vesting: rounds empty');
