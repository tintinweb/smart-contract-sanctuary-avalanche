...
contract PantokenStableSwapLP is ERC20 {
    address public minter;

    constructor() ERC20("Pantoken StableSwap LPs", "Stable-LP") {
        minter = msg.sender;
    }
...
import "./PantokenStableSwapLP.sol";

contract PantokenStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(PantokenStableSwapLP).creationCode;
        ...
        PantokenStableSwapLP(lpToken).setMinter(_minter);
