...
//                emit ChangeState(s_raffleState, RaffleState.DRAW_PENDING, 140);
    ...
    )
    {
        ...
        if (upkeepNeeded) {
//            emit ChangeState(s_raffleState, RaffleState.DRAW, 182);
            s_raffleState = RaffleState.DRAW_PENDING;
        }
...
//        s_lastTimeStamp = block.timestamp;
//        emit ChangeState(s_raffleState, RaffleState.DRAW, 205);
...
//                    emit ChangeState(s_raffleState, RaffleState.OPEN, 240);
                    s_raffleState = RaffleState.OPEN;
                    s_lastTimeStamp = block.timestamp;
                } else {
//                    emit ChangeState(s_raffleState, RaffleState.MAINTENANCE, 244);
                    s_raffleState = RaffleState.MAINTENANCE;
                }
            } else {
//                emit ChangeState(s_raffleState, RaffleState.MAINTENANCE, 248);
                s_raffleState = RaffleState.MAINTENANCE;
            }
        } else {
//            emit ChangeState(s_raffleState, RaffleState.MAINTENANCE, 252);
            s_raffleState = RaffleState.MAINTENANCE;
        }
