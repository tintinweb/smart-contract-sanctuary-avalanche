...
contract ARNTreasuryFund is Fund {
...
abstract contract Fund is Ownable, Initializable {
    ...
    function initialize(address _ARN) external initializer {
        require(_ARN != address(0), "Fund::constructor: Invalid address");
        ARN = IERC20(_ARN);
    }
    ...
    function currentBalance() public view returns (uint256) {
        return ARN.balanceOf(address(this));
    }
    ...
    function transfer(address receiver, uint256 amount) external onlyOwner {
        ...
        ARN.safeTransfer(receiver, amount);
    }
}
