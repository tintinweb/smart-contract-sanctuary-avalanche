...
//  Stealth Launch
//  Reward: $Usdt.e
//  Twitter : https://twitter.com/BTC1generator
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118); // reward address Usdt.e
...
contract SquidPrinter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xc7198437980c041c805A1EDcbA50c1Ce5db95118; // reward USDT.E
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "SquidPrinter";
    string constant _symbol = "SQPT";
    ...
    address public autoLiquidityReceiver=0x6ED45d5997715275DA3bf7e4BfE5010649598656; //liq address
    address public marketingFeeReceiver=0x6ED45d5997715275DA3bf7e4BfE5010649598656; // marketing address
