...
contract Amm is IAmm, IfnxFiOwnableUpgrade, BlockContext {
    ...
    function calcBaseAssetAfterLiquidityMigration(
        ...
        return newBaseAsset.mulScalar(isPositiveValue ? int256(1) : int256(-1));
    }
    ...
    function implShutdown() internal {
        ...
        SignedDecimal.signedDecimal memory positionNotionalValue = lastInitQuoteReserveInNewCurve
