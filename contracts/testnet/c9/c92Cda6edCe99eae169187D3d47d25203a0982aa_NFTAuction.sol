...
contract NFTAuction {
    ...
    mapping(uint256=>uint256) public nftAuctionRecord;
    ...
    function _doesBidMeetBidRequirements(
        ...
        if (
            buyNowPrice > 0 && _tokenAmount >= buyNowPrice
        ) {
            return true;
        }
    ...
    function _transferNftAndPaySeller(
        ...
        nftAuctionRecord[_tokenId]+=1; //incrementing the record of tokenID being transferred
        IERC721(_nftContractAddress).transferFrom(
            address(this),
            _nftRecipient,
            _tokenId
