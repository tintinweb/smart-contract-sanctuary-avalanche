  ...
  AccessControl
{
  ...
  function _transfer(
    ...
    uint256 fromBalance = ERC721.balanceOf(from);
    uint256 toBalance = ERC721.balanceOf(to);
    ...
    require(
      ERC721.balanceOf(from) == fromBalance - 1,
      'ERC721: incorrect balance after transfer'
    );
    require(
      ERC721.balanceOf(to) == toBalance + 1,
      'ERC721: incorrect balance after transfer'
    );
