...
contract Savings {
    ...
    event Deposit(uint256 amount, uint256 timestamp, address user);

    event Redeem(uint256 amount, uint256 timestamp, address user);
    ...
    function depositToken(address _tokenAddress, uint256 _tokenAmount) public {
        ...
        emit Deposit(_tokenAmount, block.timestamp, msg.sender);
    }
