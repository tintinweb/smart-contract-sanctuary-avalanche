...
contract NoblyWorld is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint _reservedTokens = 511;
    uint256 _mintPrice = 0.001123 * 1e18;

    uint256 _totalClaimable = 0;
    uint256 _marketplaceVolume = 0;
    uint256 _minterFee = 30;
    uint256 _marketFee = 20;
    ...
    constructor() ERC721("Nobly World", "NoblyWorld") {
        _notRevealedUri = "https://gateway.pinata.cloud/ipfs/QmU8n644yyMCP6MEkvmk6oMK3rcN4uC1qMpaNsmPUSjg6F/24";
        baseURI = "https://gateway.pinata.cloud/ipfs/QmU8n644yyMCP6MEkvmk6oMK3rcN4uC1qMpaNsmPUSjg6F/";
    }
