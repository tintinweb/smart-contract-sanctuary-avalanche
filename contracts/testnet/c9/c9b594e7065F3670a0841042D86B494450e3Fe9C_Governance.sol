...
contract Governance is Dcarb {
    ...
    function getProposalList() external view returns (ProposalToReturn[] memory) {
    ...
    function state(uint256 proposalId) public view returns (ProposalState) {
        ...
        if (
            ...
            console.log(_getQuorum(proposal));
            console.log(_getMinForVotes(proposal));
            console.log("Failed", proposal.forVotes);
