...
contract Claimable is Ownable {
   ...
   */
  function transferOwnership(address newOwner) virtual override public onlyOwner {
...
contract OwnableContract is CanReclaimToken, Claimable {
  function transferOwnership(address newOwner) virtual override(Claimable, Ownable) public onlyOwner {
...
contract WBTC is StandardToken, DetailedERC20("Wrapped BTC", "WBTC", 8),
    ...
    function approve(address _spender, uint256 _value) override(ERC20, StandardToken, PausableToken) public returns (bool) {
      PausableToken.approve(_spender, _value);
    }

    function increaseApproval(address _spender, uint256 _value) override(StandardToken, PausableToken) public returns (bool) {
      PausableToken.increaseApproval(_spender, _value);
    }

    function decreaseApproval(address _spender, uint256 _value) override(StandardToken, PausableToken) public returns (bool) {
      PausableToken.decreaseApproval(_spender, _value);
    }

    function transfer(address _to, uint256 _value) override(BasicToken, ERC20Basic, PausableToken) public returns (bool) {
      PausableToken.transfer(_to, _value);
    }

    function transferFrom(address _from, address _to, uint256 _value) override(ERC20, StandardToken, PausableToken) public returns (bool) {
      PausableToken.transferFrom(_from, _to, _value);
    }

    function transferOwnership(address newOwner) override(OwnableContract, Ownable) public onlyOwner {
