...
contract SmolrJoes is ERC721Enumerable, ReentrancyGuard, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    string public _cid;
    string public _nonRevealedURI = "https://smolr.mypinata.cloud/ipfs/QmQj5RgyAR8M6v7i2LpvXFCRy157bmjt7eREXWmK75WToQ";
    ...
    address public royaltyPayout = 0xA3d5ADa94Bb423F7c7Cbf83403D63aAB8278F8cF; // TODO: change this for royalty payout

    constructor() ERC721("Smolr Joes", "SMOLR") {
        _tokenIds.increment(); // increment so token ids are 1 - 69
        internalMint(0x745C1C48c34D743fe83cD8Ae259D9989b67B6C34); // s
    ...
    function mint(uint256 count) external callerIsUser nonReentrant {
        ...
        require(totalSupply() <= maxSupply, "All Smolr Joes have been minted");
    ...
    //     require(totalSupply() <= _supply, "All Smolr Joes have been minted");
