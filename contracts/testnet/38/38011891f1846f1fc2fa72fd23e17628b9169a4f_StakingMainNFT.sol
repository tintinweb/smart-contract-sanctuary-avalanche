...
contract StakingMainNFT is Ownable {
    ...
    constructor () {
        ...
        // stakingToken = IERC20(0x8783F9077f46589Bd73d6E31F50FE40F54F83D68);
        // NFToken = IGuarantNFT(0x68ab32b69B5f1312608eA701cabBf069bB4A130f);      // // NFT token address
        // treasureWallet = 0xc0e8cae5df04D577C0E3126F75F2645ECE7B2D42;
        // rewardWallet = 0xA74FC7DCe423a96F45f430Ff24045FEe22e1fD9a;
        ...
        // this is for main net
        stakingToken = IERC20(0x8783F9077f46589Bd73d6E31F50FE40F54F83D68);       // cheemsx test token
        NFToken = IERC721Metadata(0x68ab32b69B5f1312608eA701cabBf069bB4A130f);      // // NFT token address
        treasureWallet = 0xc0e8cae5df04D577C0E3126F75F2645ECE7B2D42;   
        rewardWallet =  0xA74FC7DCe423a96F45f430Ff24045FEe22e1fD9a;    
        USDC = IERC20(0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160);
        IJoeRouter _newJoeRouter = IJoeRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
