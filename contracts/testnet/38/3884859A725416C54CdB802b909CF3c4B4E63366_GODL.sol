...
contract GODLDividendTracker is DividendPayingToken, Ownable {
    ...
    function _approve(
        ...
        require(false, "GODL_Dividend_Tracker: No approvals allowed");
    }
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "GODL_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GODL contract."
        );
    }
...
contract GODL is ERC20, Ownable {
    ...
    string private constant _name = "GODL";
    string private constant _symbol = "GODL";
    ...
    IJoeRouter02 private uniswapV2Router =
        IJoeRouter02(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
    ...
    function openTrading(uint256 _launchTime, uint256 _minutesForPrivateSale)
        ...
        onlyOwner
    {
        require(!tradingOpen, "GODL: Trading is already open");
        require(_launchTime > block.timestamp, "GODL: Invalid timestamp");
    ...
    function _claim(address payable _account, bool _reinvest) private {
        ...
        require(
            ...
            "GODL: Claimer has no withdrawable dividend"
        );
        uint256 ethAmount;
        uint256 tokenAmount;
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "GODL: Private and public sale is not open"
            );
            if (
                privateSaleTimestamp <= block.timestamp &&
        ...
        if (!automatedMarketMakerPairs[_to] && !isExludeFromWalletLimit[_to]) {
            ...
            require(
                ...
                "GODL: Wallet balance limit reached"
            );
        }
    ...
    function _setAutomatedMarketMakerPair(address _pair, bool _value) private {
        require(
            ...
            "GODL: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[_pair] = _value;
