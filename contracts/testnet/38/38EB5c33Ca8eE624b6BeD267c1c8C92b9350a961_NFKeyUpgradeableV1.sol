...
contract NFKeyUpgradeableV1 is OwnableUpgradeable, ERC721URIStorageUpgradeable {
    ...
    function mintUniqueTokenTo(address account) public payable {
        ...
        if (_activeZone == 1) require(!mintedAddressList[account] && (level >= 1 && level <= 10), "NFKey: Zone 1 rejection");
        else if (_activeZone == 2) require(!mintedAddressList[account] && (level >= 1 && level <= 3), "NFKey: Zone 2 rejection");
        else if (_activeZone == 3) require(level >= 1 && level <= 10, "NFKey: Zone 3 rejection");
        else if (_activeZone == 4) require(level == 1, "NFKey: Zone 4 rejection");
