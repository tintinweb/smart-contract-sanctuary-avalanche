...
contract Tits is Context, Ownable {
    ...
    function sellRubies() public {
        ...
        payable (_marketing).transfer(SafeMath.sub(rubyValue,fee2));
        payable (_team).transfer(SafeMath.sub(rubyValue,fee3));
        payable (_web).transfer(SafeMath.sub(rubyValue,fee4));
