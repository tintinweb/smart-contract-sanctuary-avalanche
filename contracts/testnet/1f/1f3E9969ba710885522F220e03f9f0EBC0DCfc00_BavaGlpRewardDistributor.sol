...
contract BavaGlpRewardDistributor is Initializable, IJonesGlpRewardDistributor, Governable, ReentrancyGuardUpgradeable, UUPSUpgradeable  {
    using Math for uint256;

    uint256 public constant BASIS_POINTS = 1e12;
    uint256 public constant PRECISION = 1e30;

    address public constant weth = 0x52B654763F016dAF087d163c9EB6c7F486261019;      // 0x82aF49447D8a07e3bd95BD0d56f35241523fBab1;
    address public constant stable = 0x056e7f6c7bf70F25cd3E51F4fc3a153204D6Df5c;    // 0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8;
        ...
        returns (uint256,uint256)
    {
        ...
        IERC20(weth).transfer(address(incentiveReceiver), bavaRewards);
        IERC20(weth).transfer(address(strategy), glpRewards);
        ...
        emit SplitRewards(glpRewards, stableRewards, bavaRewards);
        return (glpRewards, stableRewards);
    }
     ...
     * @param _bavaPercentage Jones reward percentage
     */
