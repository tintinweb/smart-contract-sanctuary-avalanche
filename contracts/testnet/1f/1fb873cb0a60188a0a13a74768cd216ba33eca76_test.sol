...
contract test is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x33Fb2CFC3098d641F284219c7E616F87469f88e2);
    address payable public devWalletAddress = payable(0x33Fb2CFC3098d641F284219c7E616F87469f88e2);
    address payable public teamWalletAddress =  payable(0x33Fb2CFC3098d641F284219c7E616F87469f88e2);
    ...
    constructor () {
        IDEXRouter _uniswapV2Router = IDEXRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
        uniswapPair = IDEXFactory(_uniswapV2Router.factory())
            .createPair(address(this), 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921;
