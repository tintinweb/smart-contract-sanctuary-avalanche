...
contract PantokenStableSwapTwoPool is Ownable, ReentrancyGuard {
...
import "../openzeppelin/contractsV4.8.1/access/Ownable.sol";
import "./PantokenStableSwapTwoPool.sol";

contract PantokenStableSwapTwoPoolDeployer is Ownable {
    uint256 public constant N_COINS = 2;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(PantokenStableSwapTwoPool).creationCode;
        ...
        PantokenStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
