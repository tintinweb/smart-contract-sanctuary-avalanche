...
contract BridgesOfFateV1Test is Ownable, ReentrancyGuard {
    ...
    uint256 private constant TURN_PERIOD = 180; //Now we are use 3 minute //86400; // 24 HOURS
    ...
    mapping(uint256 => mapping(uint256 => uint256)) public RandomNumber;
    ...
    */
        ...
        After24Hours(playerId)
    {
        ...
        if (_gameStatus.GameLevel == 1) {
            ...
            if (randomNumber <= 0) {
                ...
                RandomNumber[dayCounter][_gameStatus.day] = randomNumber;
                _gameStatus.lastJumpAt = block.timestamp; // Use this time to Resume Players
            }
            // }
    ...
    modifier After24Hours(bytes32 playerId) {
        ...
        // Jump after 24 hours.
        require(calTimer >= 180, "Jump after 3 mintues.");
        _;
    }
