...
interface IGuilderFi {
    ...
    function setLrfAddress (address _address) external;
    function setAutoLiquidityAddress (address _address) external;
    function setSafeExitFundAddress (address _address) external;
    function setPreSaleAddress (address _address) external;
