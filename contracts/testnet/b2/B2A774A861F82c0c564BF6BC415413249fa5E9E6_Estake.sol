...
contract Estake is esAvax{
    ...
    function _withdraw(uint256 amount) internal whenNotPaused {
        require(amount <= sharesOf(msg.sender), "WITHDRAW_EXCEEDS_OWNED_SHARES");
        
        require(
            amount <= address(this).balance,
            "AMOUNT_SURPASSES_CURRENT_HOLDINGS"
        );
...
contract esAvax is Initializable, ERC20Upgradeable, PausableUpgradeable {
    using SafeMath for uint256;
    using UnstructuredStorage for bytes32;
