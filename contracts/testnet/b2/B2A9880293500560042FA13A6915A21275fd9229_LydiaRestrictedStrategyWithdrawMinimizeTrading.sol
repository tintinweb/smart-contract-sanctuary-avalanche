...
contract LydiaRestrictedStrategyWithdrawMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  function execute(
    ...
    require(
      lpToken.approve(address(bento), uint256(-1)),
      "LydiaRestrictedStrategyWithdrawMinimizeTrading::execute:: failed to approve LP token"
    );
    ...
    require(
      lpToken.approve(address(bento), 0),
      "LydiaRestrictedStrategyWithdrawMinimizeTrading::execute:: unable to reset lp token approval"
    );
