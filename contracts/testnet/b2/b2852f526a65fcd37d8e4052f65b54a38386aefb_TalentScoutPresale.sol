...
contract TalentScoutPresale is ReentrancyGuard, Ownable {
    ...
    mapping (address => uint256) public  _avaxDeposit;
        ...
        // avax deposit list array
    address[] public avaxDepositList;
    ...
    /* EXTERNAL OR PUBLIC */
        ...
        function buy() public payable nonReentrant {
            ...
            //     avaxDepositList.push(msg.sender);

            bool contains = false;

            for(uint i; i<avaxDepositList.length; i++){
                
                if(avaxDepositList[i] == msg.sender){
                    contains = true;
                }
    ...
    /* INTERNAL */
        ...
        function transferAvaxToAdmin() public onlyOwner {
            ...
            for(uint i =0; i< avaxDepositList.length; i++) {
                _avaxDeposit[avaxDepositList[i]] = 0;
            }
