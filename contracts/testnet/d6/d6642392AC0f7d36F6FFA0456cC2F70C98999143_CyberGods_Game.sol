...
contract CyberGods_Game is Ownable, Pausable {
    ...
    mapping(address => uint256) public attackPowerToOwner; // owner => attack power
    ...
    function unstakeWarriorNFTs(
        ...
        for (uint256 i = 0; i < _cyborgsLength; i++) {
            ...
            for (uint256 y = 0; y != stakedCyborgsToOwner[_owner].length; y++) {
        ...
        attackPowerToOwner[_owner] -= _cyborgsLength;
    }
