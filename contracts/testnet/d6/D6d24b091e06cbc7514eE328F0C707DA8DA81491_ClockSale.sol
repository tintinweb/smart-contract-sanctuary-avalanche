...
// File: hexagon_marketplace/Addresses.sol
...
// File: hexagon_marketplace/ClockSaleBase.sol
...
contract ClockSaleBase {
    ...
    */
    ...
    event SaleCreated(address contractAddr, uint256 tokenId, uint256 price);
    ...
    event AuctionCreated(address contractAddr, uint256 tokenId, uint256 price);
    ...
    function _addSale(
        ...
        emit SaleCreated(contractAddr, uint256(_tokenId), uint256(_sale.price));
    }
    ...
    function _createOffer(
        ...
        offers[contractAddr][tokenId].push(Offer(address(0), 0));
        uint256 length = offers[contractAddr][tokenId].length;
        uint256 i;
        for (
            i = length - 1;
        ...
        offers[contractAddr][tokenId][i] = Offer(offerer, price);
        emit OfferCreated(contractAddr, tokenId, offerer, price);
    }
    ...
    function _bid(
        ...
        bids[contractAddr][tokenId].push(Bid(bidder, price));
        emit BidCreated(contractAddr, tokenId, bidder, price);
    }
...
// File: hexagon_marketplace/ClockSale.sol
