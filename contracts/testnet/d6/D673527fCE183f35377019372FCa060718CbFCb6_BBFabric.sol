...
contract BBFabric is NonBlockingNonUpgradableBaseApp, IBBFabric {
    ...
    function _notifyRegistry(
        ...
        bytes memory oldTrustedRemote = trustedRemoteLookup[registryChainId];
        ...
        emit RegistryNotified(_strategyId, _implAddress, _newProxyAddress, registryAddress, registryChainId);
    }
