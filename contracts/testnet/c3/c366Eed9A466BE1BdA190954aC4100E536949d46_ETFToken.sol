...
contract ETFToken is Operator, ERC20, IETFToken, BNum {
    ...
    function initialize(
        ...
        require(len >= MIN_BOUND_TOKENS, "ETFToken: Min bound tokens overflow");
        require(len <= MAX_BOUND_TOKENS, "ETFToken: Max bound tokens overflow");
        ...
        onlyOperator
    {
        ...
        require(minimumBalance >= MIN_BALANCE, "ETFToken: Min balance overflow");
        records[token] = Record({
            bound: true,
            ready: false,
        ...
        public
    {
        ...
        for (uint256 i = 0; i < minAmountsOut.length; i++) {
            ...
            if (record.ready) {
                ...
                emit ExitPool(caller, t, tokenAmountOut, exitFee);
