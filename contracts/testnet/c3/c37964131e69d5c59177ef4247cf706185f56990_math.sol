...
using SafeMath for uint256;
    ...
    uint256 public all4;
    uint256[] public all_new1;
    uint256[] public all_new2;
    uint256[] public all_new3;
    constructor(
    uint256 _one,
    uint256 _last,
    ...
    boostMultiplier = [25,50,75];
    rewards_ = addFee(rewardsTMul,0);
    rewards1 = rewards_[0];
    boost1 = rewards_[1];
    all1  = rewards_[0]+rewards_[1];
    rewards_2 = addFee(rewardsTMul, boostMultiplier[0]);
    rewards2 = rewards_2[0];
    boost2 = rewards_2[1];
    all2 = rewards_2[0]+rewards_2[1];
    rewards_3 = addFee(rewardsTMul, boostMultiplier[1]);
    rewards3 = rewards_3[0];
    boost3 = rewards_3[1];
    all3  = rewards_3[0]+rewards_3[1];
    boost3 = rewards_3[1];
    rewards_4 = addFee(rewardsTMul, boostMultiplier[2]);
    rewards4 = rewards_4[0];
    boost4 = rewards_4[1];
    all4 =  rewards_4[0]+rewards_4[1];
    all_new1 = getWholeRewards(0);
    all_new2 = getWholeRewards(1);
    all_new3 = getWholeRewards(2);
    }
    function getWholeRewards(uint256 _boostIt) public view returns (uint256[3] memory){
    	return calcReward(dailyRewardsPerc,lastClaimTime,timeStep, boostMultiplier[_boostIt]);
    	}
    function calcReward(uint256 _dailyRewardsPerc, uint256 _lastClaimTime, uint256 _timeStep, uint256 _boost) public view returns (uint256[3] memory){
	    //dailyRewardsPerc = 10;
	    uint256 _timeStep = 24 hours;
	    //lastClaimTime = block.timestamp - last;
