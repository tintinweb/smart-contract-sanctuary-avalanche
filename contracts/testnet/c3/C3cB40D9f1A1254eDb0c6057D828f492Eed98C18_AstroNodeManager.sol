...
contract AstroNodeManager is Ownable, Pausable {
    ...
    function getTotalClaimable() public view returns (uint256) {
        ...
        uint256 pendingRewards = astronauts[msg.sender].nodes * nodeBase * dailyInterest * (time - timerFrom) / 8640000;
        uint256 pendingDonatedRewards = astronauts[msg.sender].donatedNodes * nodeBase * dailyInterest * (time - timerFrom) / 8640000;
