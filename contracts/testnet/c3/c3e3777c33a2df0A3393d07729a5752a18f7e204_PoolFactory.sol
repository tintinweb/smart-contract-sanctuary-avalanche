...
contract PoolFactory is OwnableUpgradeable,ReentrancyGuardUpgradeable{
    ...
    function initialize() external initializer {
        __Ownable_init();
        presaleAddress = 0x990e24c6465eE55806Ea1193Eb2341C75734D895;
        PrivatesaleAddress = 0x6A3EFEe881795433b69D2b9ea14F24C70973FBba;
        fairlaunchAddress = 0x92e41f5377fe8F3B0fCaCb9570A197084573a2c2;
    ...
    modifier _checkPreRequirement(uint _id){
        ...
        require(poolOwner != address(0) , "Currently on hold , try again after sometime!!");
