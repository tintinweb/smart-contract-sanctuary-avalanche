...
contract TokenExchange is Ownable {
    ...
    function deposit(address variant, uint256 amount) public payable {
        ...
        uint256 tokenBAmount = amount.mul(10**tokenADecimals).div(
            10**tokenBDecimals
        );
        uint256 tokenAReceived = tokenBAmount.mul(exchangeRate).div(
            10**tokenADecimals
        );
    ...
    function claim() public {
        ...
        IERC20(tokenA).safeTransfer(sender, vestedAmount);
