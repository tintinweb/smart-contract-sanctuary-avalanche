...
// Arg [1] : _reasonableGasPrice (uint32): 60
// Arg [2] : _microLinkPerEth (uint32): 227409551
// Arg [3] : _linkGweiPerObservation (uint32): 91399120
// Arg [4] : _linkGweiPerTransmission (uint32): 548391831
...
// Arg [11] : description (string): FEI / USD
    ...
    returns (bool sufficientGas)
  {
    ...
    assembly {
      ...
      if iszero(lt(g, CALL_WITH_EXACT_GAS_CUSHION)) {
        ...
        // If g - g//64 <= _gasAmount, we don't have enough gas. (We subtract g//64wwwwww
        // because of EIP-150.)
