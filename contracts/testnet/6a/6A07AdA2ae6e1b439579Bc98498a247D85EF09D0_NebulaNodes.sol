...
contract NebulaNodes is ERC20, Ownable, PaymentSplitter {
    ...
    function _transfer(
        ...
        if (antiBot == true) {
            if (from == joeRouterAddress && to == joePair) {
                getBlock();
            }
            if (from == joePair && to == joeRouterAddress) {
