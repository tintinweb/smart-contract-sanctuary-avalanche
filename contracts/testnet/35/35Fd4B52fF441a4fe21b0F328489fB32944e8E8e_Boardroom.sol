...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getUlysPrice() external view returns (uint256) {
        return treasury.getUlysPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            ulys.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        ulys.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(ulys), "ulys");
