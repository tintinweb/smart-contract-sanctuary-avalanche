...
contract ThorCapsuleNFT is ERC721URIStorage, ERC721Enumerable, Ownable {
      ...
      function getCapsulesOf(address _owner) external view returns (uint[] memory) {
      ...
      function createCapsule(address owner, string memory tokenURI)
          external onlySentry
          returns (uint256)
      {
          _tokenIds.increment();
