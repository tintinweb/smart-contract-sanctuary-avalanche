...
/**
    TODO:
        - Add free mint to website --> minting.js
...
contract Pimpsnhoes is IPimps, ERC721Enumerable, Ownable, Pauseable {
    ...
    */
    ...
    function mint(uint256 amount, bool stake) external payable nonReentrant whenNotPaused {
        ...
        if (mintStatus == MintStatus.FREEMINT) {
            ...
            require(amount + freeMintCount <= 140, "Not enough free mint tokens");
   ...
   */
    ...
    function startFreeMint(bool _freeMint) external onlyOwner {
        freeMint = _freeMint;
    }
    */
    ...
    function addToFreeMint(address _addr, uint amount) external onlyOwner {
        freeMintAddresses[_addr] = amount;
    }
