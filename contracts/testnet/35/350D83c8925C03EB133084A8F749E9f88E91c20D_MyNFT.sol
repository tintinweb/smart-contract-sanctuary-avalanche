...
contract MyNFT is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("My NFT Collection", "MYNFT") {
    _customBaseURI = 'https://amanda.mypinata.cloud/ipfs/QmRpW4rVNfUxTo3CcNo8HPWHvyiF34mt8y2Mcx31qHaTbt/';
    _price = .01 ether; // 1 AVAX mint price 
    _maxMintable = 1; // 10k max supply
