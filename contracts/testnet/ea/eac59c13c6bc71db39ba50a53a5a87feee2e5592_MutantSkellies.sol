...
contract MutantSkellies is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant FOR_SALE_TOKENS = 1111;
    ...
    uint256 public tokenPricePresale = 3.00 ether;
    uint256 public tokenPricePublicSale = 4.00 ether;

    uint256 public maxTokensPerAddressPresale = 5;
    uint256 public maxTokensPerAddress = 10;
    uint256 public maxTokensPerTransaction = maxTokensPerAddress;

    uint256 public presaleTotalLimit = 1111;

    bytes32 public whitelistRootOG;
    bytes32 public whitelistRoot;

    string public tokenBaseURI = "ipfs://QmVYx4VZhXSKy3g6jkre6cYTNHDBDvZyupNAvKnbKj4r8F/";

    uint256 public soldAmount = 0;
    mapping(address => uint256) public purchased;

    constructor() ERC721A("Mutant Skellies", "MutantS") {
    ...
    function mint(uint256 amount, bytes32[] memory proof) external payable {
        require(msg.value >= tokenPrice() * amount, "Incorrect AVAX sent");
