...
contract TraderJoeRouterFunctions {
    ...
    function swapExactTokensForTokens(uint256 _amountIn, uint256 _amountOutMin, Components.Path memory path, address _to, uint256 _deadline) public returns(uint256 amountOut){
        return amountOut;
    }
