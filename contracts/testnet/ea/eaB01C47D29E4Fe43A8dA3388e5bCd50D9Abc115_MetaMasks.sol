...
contract MetaMasks is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
...
// ================== Variables Start =======================
  ...
  uint256 public supplyLimit = 5916;
  ...
  address royaltyAddress = 0xfd9fAD108ecAcE337bA3463d20B56D44aCB1Be6A;  
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
      ...
      payable(0xfd9fAD108ecAcE337bA3463d20B56D44aCB1Be6A ).transfer(balance * 85 / 100); // 1
      payable(0xfd9fAD108ecAcE337bA3463d20B56D44aCB1Be6A ).transfer(balance * 15 / 100); // 2
  }
