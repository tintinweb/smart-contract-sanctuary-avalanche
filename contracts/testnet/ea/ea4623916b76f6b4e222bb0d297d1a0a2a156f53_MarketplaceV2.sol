...
contract Marketplace is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    modifier HasTransferApproval(address tokenAddress, uint256 tokenId) {
        IERC721Upgradeable tokenContract = IERC721Upgradeable(tokenAddress);
        require(tokenContract.getApproved(tokenId) == address(this), "Token does not have transfer approval");
        _;
    }
    ...
    /**
      ...
      */
    function addItem(uint256 tokenId, address tokenAddress, uint256 price, address eligibleBuyer) 
    HasTransferApproval(tokenAddress, tokenId)
    OnlyTokenOwner(tokenAddress, tokenId)
    virtual external {
        require(openSales[tokenAddress][tokenId].tokenId != tokenId, "Item is already up for sale");
    ...
    /**
      ...
      * @param tokenAddress - Address of the NFT contract
      */
    function buyItem(uint256 tokenId, address tokenAddress) payable external ItemExists(tokenAddress, tokenId)
    HasTransferApproval(tokenAddress, tokenId) {
        ...
        uint256 sellerAmount = saleItem.price - commissionAmount - royaltyAmount;
    ...
    /**
      ...
      * @param tokenAddress - Address of the NFT contract
      */
    function withdrawItem(uint256 tokenId, address tokenAddress) external ItemExists(tokenAddress, tokenId)
    OnlyTokenOwner(tokenAddress, tokenId) {
        MarketItem memory saleItem = openSales[tokenAddress][tokenId];
        delete openSales[tokenAddress][tokenId];
    ...
    /**
      ...
      */
    function updateItem(uint256 tokenId, address tokenAddress, uint256 newPrice, address newEligibleAddress) external ItemExists(tokenAddress, tokenId)
    OnlyTokenOwner(tokenAddress, tokenId) {
        MarketItem memory saleItem = openSales[tokenAddress][tokenId];
