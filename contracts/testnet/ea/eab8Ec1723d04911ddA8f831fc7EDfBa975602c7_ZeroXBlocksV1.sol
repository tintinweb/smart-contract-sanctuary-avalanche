...
contract ZeroXBlocksV1 is Initializable, ERC20Upgradeable, OwnableUpgradeable, PaymentSplitterUpgradeable {
    ...
    uint256 public mintNodesLimit = 100;
    ...
    function initialize(
        ...
        require(
            ...
            && rewardsPool != address(0), "POOL ZERO FOUND");
    ...
    function setNodeManagement(address nodeManagement) external onlyOwner {
        _nrm = NODERewardManagement(nodeManagement);
    }
    ...
    function mintNodes(string[] memory names, ContractType _cType) public {
        ...
        for (uint256 i = 0; i < names.length; i++) {
            require(
                ...
                "NODEMINT: improper character count"
            );
        }
        ...
        require(
            nodeCount + names.length <= mintNodesLimit,
            "NODEMINT: reached mint limit"
        );
