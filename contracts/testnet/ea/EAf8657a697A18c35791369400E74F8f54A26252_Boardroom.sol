...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getGlamourPrice() external view returns (uint256) {
        return treasury.getGlamourPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            Glamour.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        Glamour.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(share), "GShare");
