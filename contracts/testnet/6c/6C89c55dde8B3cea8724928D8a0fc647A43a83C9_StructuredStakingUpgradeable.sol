    ...
    ValidationNodesProviderFactoryC2Upgradable
{
    struct StakingPool {
        ...
        uint256 maxAccountCumulativeRewardPerStake;
    }
        ...
        onlyExistingPool(poolId)
    {
        ...
        if (stakingPool.totalStaked > 0) {
            ...
            require(
                stakingPool.cumulativeRewardPerStake >=
                    stakingPool.maxAccountCumulativeRewardPerStake,
                "Staking: Reward Amount too low"
            );
        } else {
        ...
        onlyExistingPool(poolId)
    {
        ...
        if (
            ...
            stakingPool.maxAccountCumulativeRewardPerStake = stakingPool
                .accountCumulativeRewardPerStake[_msgSender()];
        }
