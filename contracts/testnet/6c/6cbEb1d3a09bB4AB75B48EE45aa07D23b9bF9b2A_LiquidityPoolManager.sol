...
contract LiquidityPoolManager is Ownable, OwnerRecovery, PyramidPointer {
  ...
  constructor() {
    ...
    address[2] memory path=[0xecaE6dB9f0F6562B3aa595266E3b2b5A5356F763,0x1C4645e0cC67E3853F41f49feAcF132A2174a840];
    pair = createPairWith(path);
    leftSide = IERC20(0xecaE6dB9f0F6562B3aa595266E3b2b5A5356F763);
    rightSide = IERC20(0x1C4645e0cC67E3853F41f49feAcF132A2174a840);
