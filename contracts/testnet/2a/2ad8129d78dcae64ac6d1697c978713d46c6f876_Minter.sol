...
contract Minter is Ownable {
    ...
    constructor( 
        ...
        LP_Helper = 0xb6885E6acE101564A4a612142B13976fAC5C25AA;
        Base = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
        Base_Waceo_LP = 0x3F34ac42d4729A292f662D87E6b86c2B70d10C81;
    ...
    function distribute_double_mint(address _address, bool _approve) external onlyOwner returns(bool){
        ...
        if(_approve){ 
            ...
            IERC20(request.token).transferFrom(msg.sender, LP_Helper, request.amount);
