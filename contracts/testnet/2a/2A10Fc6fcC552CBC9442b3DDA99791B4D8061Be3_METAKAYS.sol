...
// string memory tokenIdString = toString(_tokenId);
    Features memory feature = features[_tokenId];
      ...
      string memory imageURI = string(abi.encodePacked("data:image/svg+xml;base64, ", Base64.encode(bytes(string(abi.encodePacked('<svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="800.000000pt" height="1600.000000pt" viewBox="0 0 800.000000 1600.000000" preserveAspectRatio="xMidYMid meet" xmlns:xlink="http://www.w3.org/1999/xlink"> <defs> <polygon id="tri" style="" points="0 0, 100 100, 200 0" transform="scale(.5,.5)"/> </defs> <defs> <polygon id="tri2" style="" points="0 100, 200 100, 100 0" transform="scale(.5,.5)"/> </defs> <g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M0 8000 l0 -8000 4000 0 4000 0 0 8000 0 8000 -4000 0 -4000 0 0 -8000z" fill="',svgBackgroundColor2[2], '</g>', CREATE(artData, colorData, feature.colorSelectors[0], feature.colorSelectors[1], feature.colorSelectors[2]), finality[_tokenId] == false ? '<g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M7270 660 l0 -50 -55 0 -55 0 0 -49 0 -50 53 -3 52 -3 3 -102 3 -103 49 0 50 0 0 105 0 105 50 0 50 0 0 50 0 50 -50 0 -50 0 0 50 0 50 -50 0 -50 0 0 -50z M7620 660 l0 -50 -50 0 -50 0 0 -50 0 -50 50 0 50 0 0 -105 0 -105 50 0 49 0 3 103 3 102 53 3 52 3 0 50 0 49 -55 0 -55 0 0 50 0 50 -50 0 -50 0 0 -50z"/> </g></svg>' : '<g transform="translate(0.000000,1600.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none"> <path d="M7250 665 l0 -55 -55 0 -55 0 0 -55 0 -55 55 0 55 0 0 -110 0 -110 55 0 55 0 0 110 0 110 55 0 55 0 0 55 0 55 -55 0 -55 0 0 55 0 55 -55 0 -55 0 0 -55z m100 -10 l0 -55 55 0 55 0 0 -45 0 -45 -55 0 -55 0 0 -110 0 -110 -45 0 -45 0 0 110 0 110 -55 0 -55 0 0 45 0 45 55 0 55 0 0 55 0 55 45 0 45 0 0 -55z M7270 645 l0 -55 -55 0 -55 0 0 -35 0 -35 55 0 55 0 0 -110 0 -110 35 0 35 0 0 110 0 110 55 0 55 0 0 35 0 35 -55 0 -55 0 0 55 0 55 -35 0 -35 0 0 -55z m60 -10 l0 -55 55 0 c52 0 55 -1 55 -25 0 -24 -3 -25 -55 -25 l-55 0 0 -110 0 -110 -25 0 -25 0 0 110 0 110 -55 0 c-52 0 -55 1 -55 25 0 24 3 25 55 25 l55 0 0 55 c0 52 1 55 25 55 24 0 25 -3 25 -55z M7290 625 l0 -55 -55 0 c-42 0 -55 -3 -55 -15 0 -12 13 -15 55 -15 l55 0 0 -110 c0 -91 3 -110 15 -110 12 0 15 19 15 110 l0 110 55 0 c42 0 55 3 55 15 0 12 -13 15 -55 15 l-55 0 0 55 c0 42 -3 55 -15 55 -12 0 -15 -13 -15 -55z m78 -67 l57 -2 -57 -3 -58 -4 -2 -112 -2 -112 -3 113 -4 112 -57 2 -57 2 58 3 57 4 2 57 2 57 3 -57 4 -58 57 -2z M7640 665 l0 -55 -55 0 -55 0 0 -55 0 -55 55 0 55 0 0 -110 0 -110 55 0 55 0 0 110 0 110 55 0 55 0 0 55 0 55 -55 0 -55 0 0 55 0 55 -55 0 -55 0 0 -55z m100 -10 l0 -55 55 0 55 0 0 -45 0 -45 -55 0 -55 0 0 -110 0 -110 -45 0 -45 0 0 110 0 110 -55 0 -55 0 0 45 0 45 55 0 55 0 0 55 0 55 45 0 45 0 0 -55z M7660 645 l0 -55 -55 0 -55 0 0 -35 0 -35 55 0 55 0 0 -110 0 -110 35 0 35 0 0 110 0 110 55 0 55 0 0 35 0 35 -55 0 -55 0 0 55 0 55 -35 0 -35 0 0 -55z m60 -10 l0 -55 55 0 c52 0 55 -1 55 -25 0 -24 -3 -25 -55 -25 l-55 0 0 -110 0 -110 -25 0 -25 0 0 110 0 110 -55 0 c-52 0 -55 1 -55 25 0 24 3 25 55 25 l55 0 0 55 c0 52 1 55 25 55 24 0 25 -3 25 -55z M7680 625 l0 -55 -55 0 c-42 0 -55 -3 -55 -15 0 -12 13 -15 55 -15 l55 0 0 -110 c0 -91 3 -110 15 -110 12 0 15 19 15 110 l0 110 55 0 c42 0 55 3 55 15 0 12 -13 15 -55 15 l-55 0 0 55 c0 42 -3 55 -15 55 -12 0 -15 -13 -15 -55z m78 -67 l57 -2 -57 -3 -58 -4 -2 -112 -2 -112 -3 113 -4 112 -57 2 -57 2 58 3 57 4 2 57 2 57 3 -57 4 -58 57 -2z"/> </g> </svg>'))))));
...
function CREATE(bytes memory artData, bytes memory colorData, uint256 color1, uint256 color2, uint256 color3) internal view returns (string memory) {
...
//  uint8 colorByte2 = uint8(colorData2[i/8]);
  ...
  uint256 y = uint256(i / 16);
    uint256 x = uint256(i % 16);
...
for (uint256 ii=0; ii < 8; ii++) {
    ...
    if ((workingByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
              toString(y*50),'" fill="',svgBackgroundColor2[color1]));//'" fill="', svgBackgroundColor2[colorByte]));
  } else {
        if ((colorByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
              toString(y*50),'" fill="',svgBackgroundColor2[color2]));//'" fill="', svgBackgroundColor2[colorByte]));
        } else {
            rects.appendSafe(abi.encodePacked('<use xlink:href="#tri2" x="',toString((x*50) + (ii*50)),'" y="',
              toString(y*50),'" fill="',svgBackgroundColor2[color3]));//'" fill="', svgBackgroundColor2[colorByte]));
        }
  }
    } else {
if ((workingByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*50) + (ii*50)),'" y="',
              toString(y*50),'" fill="',svgBackgroundColor2[color1]));//'" fill="', svgBackgroundColor2[colorByte]));
  } else {
        if ((colorByte >> (7 - ii)) & 1 == 1) {
          rects.appendSafe(abi.encodePacked('<use xlink:href="#tri" x="' ,toString((x*50) + (ii*50)),'" y="',
