...
contract Tapeenft is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 250;
	uint256 public TOKEN_PER_TX = 25;
	uint256 public TOKEN_PER_WALLET = 50;
	uint256 public PRICE = 50 ether;
	uint256 public constant TIME_FOR_GROWN = 1685484944707;
	...
	string private _name = "tapeenft";
	string private _symbol = "TAPEE";
