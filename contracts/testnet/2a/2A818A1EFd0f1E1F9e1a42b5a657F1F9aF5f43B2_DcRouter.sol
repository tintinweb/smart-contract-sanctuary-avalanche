...
contract DcRouter is NonBlockingNonUpgradableBaseApp, IDcRouter {
    ...
    constructor(
        ...
        require(
            _deCommasTreasurer != address(0),
            "DcRouter:treasures is zero address"
        );
        ...
        require(
            ...
            "DcRouter:endpoint is zero address"
        );
    ...
    function deposit(uint256 _strategyId, uint256 _stableAmount)
        ...
        override
    {
        require(_stableAmount > 0, "DcRouter:zero amount");
        require(
    ...
    function transferDeposits(bytes memory _payload)
        public
        payable
        override
        onlySelf
    {
        ...
        require(pendingTotal == amountsSum, "DcRouter:users amount mismatch");
    ...
    function approveWithdraw(
        ...
        //lastPendingWithdrawalId[_strategyId] = _withdrawalId;
...
abstract contract BaseAppStorage {
    ...
    function getActionPool() public view returns (address) {
        return _actionPool;
    }
