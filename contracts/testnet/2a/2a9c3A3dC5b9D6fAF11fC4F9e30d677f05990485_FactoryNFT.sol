...
contract FactoryNFT is ERC721, Ownable {
    ...
    constructor(
        ...
        address avaxContractAddress
    ) ERC721("FactoryNFT", "FTN") {
        contractOwner = msg.sender;
        setBaseURI(baseURI);
        avax = AVAX(avaxContractAddress);
    }
    ...
    function mintToken(uint256 _quantity) public {
        ...
        avax.transferFrom(msg.sender, address(this), _quantity / 10);
    ...
    function withdrawFunds() external onlyOwner {
        avax.transfer(contractOwner, address(this).balance);
    }
