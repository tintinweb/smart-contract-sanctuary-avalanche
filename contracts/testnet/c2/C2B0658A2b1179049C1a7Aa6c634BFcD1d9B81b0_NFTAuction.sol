...
contract NFTAuction {
        ...
        returns (bool)
    {
     ...
     function getHighestBidder(address _nftContractAddress, uint256 _tokenId)
        internal
        view
        returns (address)
    {
    ...
    function getHighestBid(address _nftContractAddress , uint256 _tokenId) public returns (uint128) {
        return nftContractAuctions[_nftContractAddress][_tokenId].nftHighestBid;
    }
