...
contract FrozenWalrusNFT is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    using Address for address;

    // Token name
    string private constant _name = "Frozen NFT";

    // Token symbol
    string private constant _symbol = "FNFT";
    ...
    */
    ...
    function _distribute() internal {
        ...
        uint256 remainder = mintToken.balanceOf(address(this));
        if (remainder > 0) {
