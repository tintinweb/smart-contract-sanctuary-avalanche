...
contract Gambit {
    ...
    function claimWin(string memory _matchId) external {
        ...
        if (matchesBets[_matchId].betsByAddress[msg.sender].isMatchWinner && matchesBets[_matchId].betsByAddress[msg.sender].isPerfectScoreWinner){
            ...
            emit ClaimBetEvent(msg.sender, _matchId, _prizeMatchWinner, _perfectScoreWinnerPrize, _totalPrize);
            ...
            emit ClaimBetEvent(msg.sender, _matchId, _prizeMatchWinner, 0, _prizeMatchWinner);
        } 
