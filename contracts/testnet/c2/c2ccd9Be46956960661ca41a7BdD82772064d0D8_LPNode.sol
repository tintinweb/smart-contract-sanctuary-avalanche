...
contract LPNode is ERC20, Operator {
    ...
    event SetLastResetTime(uint256 lastResetTime);
    ...
    function setLastResetTime(uint256 _resetTime) public onlyOperator {
        lastResetTime = _resetTime;
        emit SetLastResetTime(lastResetTime);
    }
    ...
    function resetRewards() external {
        ...
        require(// sub 5 second for schedule deplay
            _now >= lastResetTime.add(rollingDuration).sub(5),
            "LPNode: TOO_EARLY"
        );
