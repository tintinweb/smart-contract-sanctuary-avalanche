...
// functions
    ...
    // create an auction
    function createAuction(uint _endTime, uint _minIncrement, uint _directBuyPrice,uint _startPrice,address _nftAddress,uint _tokenId, uint _fee) external returns (bool)
        {
            ...
            if (Collections[_nftAddress].id == 0){
                    collectionCounter += 1;
                    Collections[_nftAddress].id = collectionCounter;
                }
