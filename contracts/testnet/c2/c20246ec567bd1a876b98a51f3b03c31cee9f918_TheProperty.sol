    ...
    AvaxToDollerUtils
{
    ...
    function getPool() view public returns (PoolLib.pool memory) {
        return pool;
    }
    ...
    function getPropertyType(uint _propertyTypeIndex) view public returns (PropertyTypeLib.propertyType memory) {
