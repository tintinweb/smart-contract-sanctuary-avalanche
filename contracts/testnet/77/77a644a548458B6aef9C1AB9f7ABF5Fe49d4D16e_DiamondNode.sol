...
contract DiamondNode is ERC721Enumerable, Ownable {
    ...
    uint256 constant GATE_1 = 30;
    uint256 constant GATE_2 = 60;
    ...
    function mintNode() public  {
        ...
        require(
           DAIToken.balanceOf(msg.sender) > diamondNodePrice * DECIMAL_MULTIPLIER,
           "Insuffucient DAI balance"
        );

        DAIToken.transferFrom(msg.sender, address(this), diamondNodePrice * DECIMAL_MULTIPLIER);
        supply.increment();
