...
contract TokenV1 is ERC20Upgradeable {
    ...
    function initialize() public initializer {
        ...
        _taxRates = Fees({buyFee: 0, sellFee: 1800, transferFee: 0});
        _ratios = Ratios({operationRatio: 75, treasuryRatio: 25, total: 100});
    ...
    */
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        // swap
        address[] memory path = getPathForTokensToTokens(
            address(this),
            swapTokenAddress
        );
    ...
    function sendToPools() internal {
        ...
        if (newBalance > 0) {
            uint256 treasuryAmount = (newBalance * _ratios.treasuryRatio) /
                (_ratios.total);
            if (treasuryAmount > 0) {
            ...
            uint256 operationAmount = (newBalance * _ratios.operationRatio) /
                (_ratios.total);
