...
contract SafuuTEST is ERC20Detailed, Ownable {
    ...
    string public _name = "SafuuTEST";
    string public _symbol = "SAFTT";
    ...
    constructor() ERC20Detailed("SafuuTEST", "SAFTT", uint8(DECIMALS)) Ownable() {

        router = IPancakeSwapRouter(0xc9C6f026E489e0A8895F67906ef1627f1E56860d); 
        ...
        safuuInsuranceFundReceiver = 0x2d54944E74C2fE717AbB0d4FCf051ee9ACcfB54d;
        firePit = 0x49f0B42A9835CB83AE6F1625d28Ca9f3f39dF423;
