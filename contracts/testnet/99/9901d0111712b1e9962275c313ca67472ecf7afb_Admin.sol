...
contract Admin {
	...
	event AdminSet(string message);
	event NotAdminSet(string message);


    function adminSet() external {
        emit AdminSet("Admin Set");
    }

    function notAdminSet() external {
        emit NotAdminSet("Not Admin Set");
    }
}

// deploy admin to goerli
