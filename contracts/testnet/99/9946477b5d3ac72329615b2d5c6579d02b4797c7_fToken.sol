...
contract fToken is Initializable
  ...
  function depositToken(
    ...
    token20.mint(msg.sender, amount * 99 / 100 * 1 ether);
    emit Transfer(address(0), msg.sender, amount * 99 / 100 * 1 ether);
    return true;
  }
  ...
  function depositWToken(
    ...
    token20.mint(msg.sender, amount * 99 / 100);
    emit Transfer(address(0), msg.sender, amount * 99 / 100);
    return true;
  }
