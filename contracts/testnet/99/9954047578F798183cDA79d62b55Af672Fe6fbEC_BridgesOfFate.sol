...
contract BridgesOfFate is Ownable {
    ...
    uint256 private constant TURN_PERIOD = 420; //Now we are use 5 minute //86400; // 24 HOURS
    ...
    constructor(IERC20 _wrappedEther,address _owner,address _commuinty) {
        ...
        _pioneerPushBackBankingNumberProbility = 15;
    }
    ...
    function pushBack(bytes32 playerfrom,bytes32 playerto) external GameEndRules PushBackBankingGameEndRules  {
        ...
        _memberto.stage =  _memberto.stage - 1; 
         if (GameMap[_memberto.stage] >= 50e9) {
