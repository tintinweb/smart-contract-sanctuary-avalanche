...
contract dogeIncubator is Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    uint256 internal linkFee = 0.0005 ether;
    ...
    uint32 internal callbackGasLimit = 10000000;
    ...
    function buyDoge(uint32 amount) payable public {
        ...
        if(subscriptionBalance < amount * linkFee) {
            require(LINKTOKEN.balanceOf(address(this)) >= 1 ether, "Not enough LINK to execute transaction");
            topUpSubscription(1 ether);
        }
