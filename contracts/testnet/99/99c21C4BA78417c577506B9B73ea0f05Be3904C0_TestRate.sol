...
contract TestRate is ERC20Burnable, Operator {
    using SafeMath8 for uint8;
    using SafeMath for uint256;

    // Initial presale distribution
    uint256 public constant INITIAL_PRESALE_DISTRIBUTION = 400e6 ether;
    uint256 public constant INITIAL_LIQUIDITY_DISTRIBUTION = 600e6 ether;

    bool public rewardPoolDistributed = false;

    constructor() public ERC20("TestRate", "TRATE") {
        _mint(msg.sender, 1e26);
    }

    /**
     * @notice Operator mints TestRATE to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of TestRATE to mint to
