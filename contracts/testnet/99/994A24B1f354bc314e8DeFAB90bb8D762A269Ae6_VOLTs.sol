...
contract VOLTs is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked VOLT", "VOLTs", 9) ERC20Permit() {
    ...
    /**
        @notice increases VOLTs supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess VOLTs
