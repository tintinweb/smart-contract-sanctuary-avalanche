...
contract TalentScoutPresale is ReentrancyGuard, Ownable {
    ...
    /* GETTERS */
        ...
        function computeTokensAmount(uint256 funds) public view returns (uint256, uint256) {
            ...
            uint256 tokensToBuy = funds.div(salePrice).mul(1e18); // convert to tokens
            uint256 newMinted = distributed.add(tokensToBuy); // new total amount of tokens
