...
contract Metadata is Ownable, IMetadata {
    ...
    uint256 private levelTypeIndex = 21;
    ...
    bool reveal = false ;
    string waitingRevealImage = "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";
    ...
    function uploadWaitingRevealImage(string calldata _waitingRevealImage) external onlyOwner {
...
function withdraw() external onlyOwner {  
    ...
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        ...
        return string(abi.encodePacked(
                '<svg id="FoxAndChicken" width="100%" height="100%" version="1.1" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">',
                svgString,
                "</svg>"
            ));
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        string memory metadataGame = string(abi.encodePacked(
                ...
                s.isSlave ? 'Chicken #' : 'Fox #',
                tokenId.toString(),
                '", "description":  "Fox & Chicken Game is the next-generation NFT game on AVAX that incorporates likelihood-based game derivatives in addition to NFT. Fox & Chicken Game promises to generate an exciting and inquisitive community as each individual adopts different strategies to outperform the others and come out on top. The real question is: Are you #Fox or #Chicken?", "image": "data:image/svg+xml;base64,',
