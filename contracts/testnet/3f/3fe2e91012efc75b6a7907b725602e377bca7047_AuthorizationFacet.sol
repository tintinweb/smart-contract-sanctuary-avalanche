...
contract AuthorizationFacet {
    ...
    /// @param _account ...
    /// @return ...
    function authorized(address _account) external view returns (bool) {
        return s.authorized[_account];
    }
    ...
    function authorize(address _account) external {
        ...
        LAuthorization.updateAuthorized(s, _account, true);
    }

    /// @notice ...
    /// @param _account ...
    function unauthorize(address _account) external {
        /// Revert if owner
        LDiamond.enforceIsContractOwner();
        LAuthorization.updateAuthorized(s, _account, false);
    }
}
