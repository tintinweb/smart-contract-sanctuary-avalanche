...
contract BitLegends is ERC721, ERC721Enumerable,  Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    string public baseURI;
    ERC20 POTION = ERC20(0x21459bad1747d1edFb8a2a8bf085b4d44cfD1A30);//ERC20(0x3edA36088b931098e8E472748840b3dF78268c72);
    uint256 public _mintPrice = 120 ether;
    uint256 public _potionMintPrice = 10;
    uint256 public maxSupply = 140;
    string public fileExtension = ".json";

    constructor() ERC721("BitLegends", "Legend") {
    ...
    function summonWithPotion() public {
        require(
    ...
    function summonWithFantom() public payable {
        if (msg.sender != owner()) {
