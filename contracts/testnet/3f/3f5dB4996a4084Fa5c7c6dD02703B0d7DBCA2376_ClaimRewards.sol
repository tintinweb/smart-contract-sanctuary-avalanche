...
contract ClaimRewards is ReentrancyGuard, Ownable {
    ...
    function uploadRewards(address[] calldata _holders, uint256[] calldata  _rewardAmounts, uint256 _totalRewards) external onlyOwner() {
    ...
    function claimRewards(uint256 _amount) external {
        ...
        claimedRewards[msg.sender] = claimedRewards[msg.sender].add(_amount); 
