...
contract ARYStakingPresale is Ownable {
    bool public paused;  
    address payable private fundWallet = payable(0xf4756d3A6Bba86aF3D166DB23D49f7bCC1af99F4) ;
    ...
    function contribute() payable public validUser checkPaused {
        ...
        (bool success, ) = fundWallet.call{ value: msg.value }("");
        ...
        token.transferFrom(address(this), msg.sender, totalToken);
