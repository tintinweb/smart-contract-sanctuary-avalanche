...
/**
 * @title CoInvestProxy Contract for GeekzWolf CoInvest v1.2.0

 * @dev This contract provided functionality to update the core GeekzWolf CoInvest contracts.
 */
contract CoInvestProxy is OwnableUpgradeable {
    /*******************************************************************************
    ...
    /**
     * @notice Initialize all the GeekzWolf CoInvest contract in the correct sequential order and generate upgradable proxy for them.

     * @dev Can only be called by CoInvestProxy owner.
     * @dev modifier initializer
     * @dev if more contract are added in GeekzWolf CoInvest, then their entry can be done here.

     * @param _implementations the implementation address of GeekzWolf CoInvest smart contract in correct sequence.
     */
    function initiateCoInvest(address[] calldata _implementations)
        external
        initializer
    {
        // Initialize ownable
        ...
        // allContractNames.push("GP"); // GamePool
        // allContractNames.push("GZ"); // GeekzPass
        // allContractNames.push("RP"); // RewardPool
        allContractNames.push("BX"); // BOX
    ...
    /**
     * @notice Adds a new contract type/implementation to GeekzWolf CoInvest
    ...
    /**
     * @notice Allows CoInvestProxy owner to change the owner of proxyAdmin contract.
     * This can be useful when trying to deploy new version of CoInvestProxy

     * @dev modifier onlyOwner
     * @dev modifier nonZero with _newAdmin

     * @param _newAdmin address of new proxyAdmin owner / new version of CoInvestProxy
     */
