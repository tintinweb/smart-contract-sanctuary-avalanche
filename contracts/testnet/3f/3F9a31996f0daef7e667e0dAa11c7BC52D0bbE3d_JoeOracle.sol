...
contract JoeOracle {
  ...
  */
  ...
  /**
    * Get token A and token B's LP token value from amount
    * @param _amount Amount of LP token, expressed in 1e18
    * @param _tokenA Token A address
    * @param _tokenB Token B address
    * @param _pair LP token address
  ...
  */
  function getLpTokenValue(
    ...
    // TODO: NOTE: Should we probably use ChainLink here for the assets?
  ...
  */
  function getLpTokenAmount(
    ...
    uint256 lpTokenAmount = _value * SAFE_MULTIPLIER / lpTokenValue
                            * IJoePair(_pair).totalSupply() / SAFE_MULTIPLIER;
