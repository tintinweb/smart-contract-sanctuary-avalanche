...
contract Router is ConvertAvax{
    ...
    constructor() ConvertAvax(LINK_TOKEN)  {
        ...
        upkeepRegistration = address(0xDb8e8e2ccb5C033938736aa89Fe4fa1eDfD15a1d); //TODO: change on the address: UPKEEP_REGISTRATION;
        keeperRegistry = AutomationRegistryExecutableInterface(address(0x02777053d6764996e594c3E88AF1D58D5363a2e6)); // TODO: change on the address: KEEPERS_REGISTRY
    }
