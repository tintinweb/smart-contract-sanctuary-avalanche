...
// Type imports
import {UpgradeRequirements, HeroRequirements, BuildingRequirements, ResourceRequirements} from "../NGTypes.sol";
...
contract NGResourceRequirementsFacet is WithStorage {
    ...
    function getResourceRequirementsHero() public view notPaused resourceAddresses returns(UpgradeRequirements[7] memory upgradeRequirements ) {
        
        // to Level 2
        upgradeRequirements[0].resourceRequirements.cash = 100;
        upgradeRequirements[0].resourceRequirements.wood = 0;
        upgradeRequirements[0].buildingRequirements.lumberYard = 0;
        upgradeRequirements[0].heroRequirements.heroLevel = 0;

        // to Level 3
        upgradeRequirements[1].resourceRequirements.cash = 200;
        upgradeRequirements[1].resourceRequirements.wood = 100;
        upgradeRequirements[1].buildingRequirements.lumberYard = 1;
        upgradeRequirements[1].heroRequirements.heroLevel = 0;

        // to Level 4
        upgradeRequirements[2].resourceRequirements.cash = 300;
        upgradeRequirements[2].resourceRequirements.wood = 200;
        upgradeRequirements[2].resourceRequirements.stone = 100;
        upgradeRequirements[2].buildingRequirements.lumberYard = 2;
        upgradeRequirements[2].buildingRequirements.stoneMine = 1;
        upgradeRequirements[2].heroRequirements.heroLevel = 0;

        // to Level 5
        upgradeRequirements[3].resourceRequirements.cash = 400;
        upgradeRequirements[3].resourceRequirements.wood = 300;
        upgradeRequirements[3].resourceRequirements.stone = 200;
        upgradeRequirements[3].resourceRequirements.oil = 100;
        upgradeRequirements[3].buildingRequirements.lumberYard = 3;
        upgradeRequirements[3].buildingRequirements.stoneMine = 2;
        upgradeRequirements[3].buildingRequirements.oilRefinery = 1;
        upgradeRequirements[3].heroRequirements.heroLevel = 0;

        // to Level 6
        upgradeRequirements[4].resourceRequirements.cash = 500;
        upgradeRequirements[4].resourceRequirements.wood = 400;
        upgradeRequirements[4].resourceRequirements.stone = 300;
        upgradeRequirements[4].resourceRequirements.oil = 200;
        upgradeRequirements[4].resourceRequirements.steel = 100;
        upgradeRequirements[4].buildingRequirements.lumberYard = 4;
        upgradeRequirements[4].buildingRequirements.stoneMine = 3;
        upgradeRequirements[4].buildingRequirements.oilRefinery = 2;
        upgradeRequirements[4].buildingRequirements.steelMill = 1;
        upgradeRequirements[4].heroRequirements.heroLevel = 0;

        // to Level 7
        upgradeRequirements[5].resourceRequirements.cash = 600;
        upgradeRequirements[5].resourceRequirements.wood = 500;
        upgradeRequirements[5].resourceRequirements.stone = 400;
        upgradeRequirements[5].resourceRequirements.oil = 300;
        upgradeRequirements[5].resourceRequirements.steel = 200;
        upgradeRequirements[5].buildingRequirements.lumberYard = 5;
        upgradeRequirements[5].buildingRequirements.stoneMine = 4;
        upgradeRequirements[5].buildingRequirements.oilRefinery = 3;
        upgradeRequirements[5].buildingRequirements.steelMill = 2;
        upgradeRequirements[5].heroRequirements.heroLevel = 0;

        // to Level 8
        upgradeRequirements[6].resourceRequirements.cash = 700;
        upgradeRequirements[6].resourceRequirements.wood = 600;
        upgradeRequirements[6].resourceRequirements.stone = 500;
        upgradeRequirements[6].resourceRequirements.oil = 400;
        upgradeRequirements[6].resourceRequirements.steel = 300;
        upgradeRequirements[6].buildingRequirements.lumberYard = 6;
        upgradeRequirements[6].buildingRequirements.stoneMine = 5;
        upgradeRequirements[6].buildingRequirements.oilRefinery = 4;
        upgradeRequirements[6].buildingRequirements.steelMill = 3;
        upgradeRequirements[6].heroRequirements.heroLevel = 0;

        return (upgradeRequirements);
    }

    
    function getResourceRequirementsLumberYard() public view notPaused resourceAddresses returns(UpgradeRequirements[7] memory upgradeRequirements ) {

        // to Level 1
        upgradeRequirements[0].resourceRequirements.cash = 200;
        upgradeRequirements[0].resourceRequirements.wood = 0;
        upgradeRequirements[0].resourceRequirements.stone = 0;
        upgradeRequirements[0].resourceRequirements.oil = 0;
        upgradeRequirements[0].resourceRequirements.steel = 0;
        upgradeRequirements[0].buildingRequirements.lumberYard = 0;
        upgradeRequirements[0].buildingRequirements.stoneMine = 0;
        upgradeRequirements[0].buildingRequirements.oilRefinery = 0;
        upgradeRequirements[0].buildingRequirements.steelMill = 0;
        upgradeRequirements[0].heroRequirements.heroLevel = 2;

        // to Level 2
        upgradeRequirements[1].resourceRequirements.cash = 300;
        upgradeRequirements[1].resourceRequirements.wood = 200;
        upgradeRequirements[1].resourceRequirements.stone = 0;
        upgradeRequirements[1].resourceRequirements.oil = 0;
        upgradeRequirements[1].resourceRequirements.steel = 0;
        upgradeRequirements[1].buildingRequirements.lumberYard = 0;
        upgradeRequirements[1].buildingRequirements.stoneMine = 1;
        upgradeRequirements[1].buildingRequirements.oilRefinery = 0;
        upgradeRequirements[1].buildingRequirements.steelMill = 0;
        upgradeRequirements[1].heroRequirements.heroLevel = 3;

        // to Level 3
        upgradeRequirements[2].resourceRequirements.cash = 400;
        upgradeRequirements[2].resourceRequirements.wood = 300;
        upgradeRequirements[2].resourceRequirements.stone = 200;
        upgradeRequirements[2].resourceRequirements.oil = 0;
        upgradeRequirements[2].resourceRequirements.steel = 0;
        upgradeRequirements[2].buildingRequirements.lumberYard = 0;
        upgradeRequirements[2].buildingRequirements.stoneMine = 2;
        upgradeRequirements[2].buildingRequirements.oilRefinery = 1;
        upgradeRequirements[2].buildingRequirements.steelMill = 0;
        upgradeRequirements[2].heroRequirements.heroLevel = 4;

        // to Level 3
        upgradeRequirements[3].resourceRequirements.cash = 400;

        // to Level 3
        upgradeRequirements[4].resourceRequirements.cash = 400;

        // to Level 3
        upgradeRequirements[5].resourceRequirements.cash = 400;

        // to Level 3
        upgradeRequirements[6].resourceRequirements.cash = 500;


        return (upgradeRequirements);
    }

    // function getResourceRequirementsStoneMill() public view notPaused resourceAddresses returns(UpgradeRequirements[3] memory upgradeRequirements ) {

    //     // to Level 1
    //     upgradeRequirements[0].resourceRequirements.cash = 300;
    //     upgradeRequirements[0].resourceRequirements.wood = 200;
    //     upgradeRequirements[0].resourceRequirements.stone = 0;
    //     upgradeRequirements[0].resourceRequirements.oil = 0;
    //     upgradeRequirements[0].resourceRequirements.steel = 0;
    //     upgradeRequirements[0].buildingRequirements.lumberYard = 1;
    //     upgradeRequirements[0].buildingRequirements.stoneMine = 0;
    //     upgradeRequirements[0].buildingRequirements.oilRefinery = 0;
    //     upgradeRequirements[0].buildingRequirements.steelMill = 0;
    //     upgradeRequirements[0].heroRequirements.heroLevel = 2;
    ...
    //     // to Level 2
    //     upgradeRequirements[1].resourceRequirements.cash = 400;
    //     upgradeRequirements[1].resourceRequirements.wood = 300;
    //     upgradeRequirements[1].resourceRequirements.stone = 200;
    //     upgradeRequirements[1].resourceRequirements.oil = 0;
    //     upgradeRequirements[1].resourceRequirements.steel = 0;
    //     upgradeRequirements[1].buildingRequirements.lumberYard = 2;
    //     upgradeRequirements[1].buildingRequirements.stoneMine = 0;
    //     upgradeRequirements[1].buildingRequirements.oilRefinery = 0;
    //     upgradeRequirements[1].buildingRequirements.steelMill = 0;
    //     upgradeRequirements[1].heroRequirements.heroLevel = 3;

    //     // to Level 3
    //     upgradeRequirements[2].resourceRequirements.cash = 500;
    //     upgradeRequirements[2].resourceRequirements.wood = 400;
    //     upgradeRequirements[2].resourceRequirements.stone = 300;
    //     upgradeRequirements[2].resourceRequirements.oil = 0;
    //     upgradeRequirements[2].resourceRequirements.steel = 0;
    //     upgradeRequirements[2].buildingRequirements.lumberYard = 3;
    //     upgradeRequirements[2].buildingRequirements.stoneMine = 0;
    //     upgradeRequirements[2].buildingRequirements.oilRefinery = 0;
    //     upgradeRequirements[2].buildingRequirements.steelMill = 0;
    //     upgradeRequirements[2].heroRequirements.heroLevel = 4;
...
// Type imports
import {Hero, NFTCurrentSales, Resources, CashResource, WoodResource, StoneResource, OilResource, SteelResource} from "../NGTypes.sol";
...
// contract NGHeroFacet is WithStorage, ERC721 {
    ...
    function stakeHero(uint256 tokenId) public notPaused {
        ...
        require(gs().stakedTokenId[msg.sender] == uint256(0), "you can not stake two heros");
        ...
        gs().stakedTokenId[msg.sender] = tokenId;
    ...
    function unstakeHero(uint256 tokenId) public notPaused {
        ...
        (bool success, bytes memory result) = address(this).delegatecall(
            abi.encodeWithSignature("collectAllResources()")
        );
        ...
        gs().stakedTokenId[msg.sender] = uint256(0);
    ...
    function getHero(uint256 tokenId) public view returns (Hero memory, bool _istStaked) {
        _istStaked = bool(gs().stakedTokenId[msg.sender] == tokenId);
    ...
    function getStakedTokenId() public view returns (uint256 tokenId) {
    ...
    function getPlayerHeroIds() public view returns (uint256[] memory, bool[] memory) {
        ...
        if (gs().stakedTokenId[msg.sender] != uint256(0))
        {
            uint256[] memory results = new uint256[](balance + 1);
            bool[] memory staked = new bool[](balance + 1);
            ...
            results[balance] = gs().stakedTokenId[msg.sender];
            staked[balance] = true;
...
// Type imports
import {Hero, WhitelistType, NFTCurrentSales} from "../NGTypes.sol";
...
// Type imports
import {Hero, Resources, CashResource, WoodResource} from "../NGTypes.sol";
import {UpgradeRequirements, HeroRequirements, BuildingRequirements, ResourceRequirements} from "../NGTypes.sol";
...
contract NGResourcesFacet is WithStorage {
    ...
    function _getAllResources(uint256 tokenId) public view notPaused resourceAddresses returns(Resources memory resources) {
        ...
        // CASH
        uint256 cashRes = (block.timestamp - hero.cashResource.lastCollectedTime) * gameConstants().BASE_CASH_PER_HOUR * hero.cashResource.level / 3600;
        
        resources.cashPending = cashRes + hero.cashResource.unclaimedAmount;
        resources.cashPerHour = gameConstants().BASE_CASH_PER_HOUR * hero.cashResource.level;
        resources.cashPendingMax = resources.cashPerHour * 12;
        ...
        // WOOD
        uint256 woodRes = (block.timestamp - hero.woodResource.lastCollectedTime) * gameConstants().BASE_WOOD_PER_HOUR * hero.woodResource.level / 3600;

        resources.woodPending = woodRes + hero.woodResource.unclaimedAmount;
        resources.woodPerHour = gameConstants().BASE_WOOD_PER_HOUR * hero.woodResource.level;
        resources.woodPendingMax = resources.woodPerHour * 12;
        ...
        // STONE
        uint256 stoneRes = (block.timestamp - hero.stoneResource.lastCollectedTime) * gameConstants().BASE_STONE_PER_HOUR * hero.stoneResource.level / 3600;

        resources.stonePending = stoneRes + hero.stoneResource.unclaimedAmount;
        resources.stonePerHour = gameConstants().BASE_STONE_PER_HOUR * hero.stoneResource.level;
        resources.stonePendingMax = resources.stonePerHour * 12;
        ...
        // OIL
        uint256 oilRes = (block.timestamp - hero.oilResource.lastCollectedTime) * gameConstants().BASE_OIL_PER_HOUR * hero.oilResource.level / 3600;

        resources.oilPending = oilRes + hero.oilResource.unclaimedAmount;
        resources.oilPerHour = gameConstants().BASE_OIL_PER_HOUR * hero.oilResource.level;
        resources.oilPendingMax = resources.oilPerHour * 12;
        ...
        // STEEL
        uint256 steelRes = (block.timestamp - hero.steelResource.lastCollectedTime) * gameConstants().BASE_STEEL_PER_HOUR * hero.steelResource.level / 3600;

        resources.steelPending = steelRes + hero.steelResource.unclaimedAmount;
        resources.steelPerHour = gameConstants().BASE_STEEL_PER_HOUR * hero.steelResource.level;
        resources.steelPendingMax = resources.steelPerHour * 12;
    ...
    function getAllResources() public view notPaused resourceAddresses returns(Resources memory resources) {
        uint256 tokenId = gs().stakedTokenId[msg.sender];
        
        if (tokenId != uint256(0)) {
            resources = _getAllResources(tokenId);
        }
        else
        {
            resources.cashWallet = gs().cashResource.balanceOf(msg.sender) / 1 ether;
    ...
    function collectAllResources() public notPaused resourceAddresses {
        uint256 tokenId = gs().stakedTokenId[msg.sender];

        //  = NGHeroFacet(address(this)).getStakedTokenId(msg.sender);
        require(tokenId != uint256(0), "Nothing staked, can not collect");
        ...
        Resources memory resources = _getAllResources(tokenId);
    ...
    function _checkAndSpendResources(Hero memory hero, UpgradeRequirements[7] memory upgradeRequirements, uint16 upgradeLevel) private {

        Resources memory resources = _getAllResources(hero.id);
        
        require(upgradeRequirements.length >= upgradeLevel, "can noy upgrade any more, max level");
        
        require(resources.cashTotal >= upgradeRequirements[upgradeLevel].resourceRequirements.cash, "You do not have enough cash");
        require(resources.woodTotal >= upgradeRequirements[upgradeLevel].resourceRequirements.wood, "You do not have enough wood");
        require(resources.stoneTotal >= upgradeRequirements[upgradeLevel].resourceRequirements.stone, "You do not have enough stone");
        require(resources.oilTotal >= upgradeRequirements[upgradeLevel].resourceRequirements.oil, "You do not have enough oil");
        require(resources.steelTotal >= upgradeRequirements[upgradeLevel].resourceRequirements.steel, "You do not have enough steel");

        require(hero.lumberYardLevel >= upgradeRequirements[upgradeLevel].buildingRequirements.lumberYard, "Lumber yard building level not high enough");

        require(hero.level >= upgradeRequirements[upgradeLevel].heroRequirements.heroLevel, "Hero level is not high enough");

        // Now let's spend the reources
        if (resources.cashPending >= upgradeRequirements[upgradeLevel].resourceRequirements.cash)
        {
            hero.cashResource.unclaimedAmount = resources.cashPending - upgradeRequirements[upgradeLevel].resourceRequirements.cash;
        } else {
            gs().cashResource.burn(msg.sender, (upgradeRequirements[upgradeLevel].resourceRequirements.cash - resources.cashPending) * 1 ether);
        }
        if (resources.woodPending >= upgradeRequirements[upgradeLevel].resourceRequirements.wood)
        {
            hero.woodResource.unclaimedAmount = resources.woodPending - upgradeRequirements[upgradeLevel].resourceRequirements.wood;
        } else {
            gs().woodResource.burn(msg.sender, (upgradeRequirements[upgradeLevel].resourceRequirements.wood - resources.woodPending) * 1 ether);
        }
        if (resources.stonePending >= upgradeRequirements[upgradeLevel].resourceRequirements.stone)
        {
            hero.stoneResource.unclaimedAmount = resources.stonePending - upgradeRequirements[upgradeLevel].resourceRequirements.stone;
        } else {
            gs().stoneResource.burn(msg.sender, (upgradeRequirements[upgradeLevel].resourceRequirements.stone - resources.stonePending) * 1 ether);
        }
        if (resources.oilPending >= upgradeRequirements[upgradeLevel].resourceRequirements.oil)
        {
            hero.oilResource.unclaimedAmount = resources.oilPending - upgradeRequirements[upgradeLevel].resourceRequirements.oil;
        } else {
            gs().oilResource.burn(msg.sender, (upgradeRequirements[upgradeLevel].resourceRequirements.oil - resources.oilPending) * 1 ether);
        }
        if (resources.steelPending >= upgradeRequirements[upgradeLevel].resourceRequirements.steel)
        {
            hero.steelResource.unclaimedAmount = resources.steelPending - upgradeRequirements[upgradeLevel].resourceRequirements.steel;
        } else {
            gs().steelResource.burn(msg.sender, (upgradeRequirements[upgradeLevel].resourceRequirements.steel - resources.steelPending) * 1 ether);
        }
    ...
    function upgradeHero(uint256 tokenId) public notPaused resourceAddresses {
        (Hero memory hero, bool _isStaked) = NGHeroFacet(address(this)).getHero(tokenId);
        require(NGHeroFacet(address(this)).ownerOf(tokenId) == address(this), "NFT is not staked");
        require(hero.owner == msg.sender, "You do not own this NFT");

        // Get required resource to upgrade
        UpgradeRequirements[7] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsHero();

        _checkAndSpendResources(hero, upgradeRequirements, hero.cashResource.level - 1);
     ...
     function upgradeLumberYard(uint256 tokenId) public notPaused resourceAddresses {
        (Hero memory hero, bool _isStaked) = NGHeroFacet(address(this)).getHero(tokenId);
        require(NGHeroFacet(address(this)).ownerOf(tokenId) == address(this), "NFT is not staked");
        require(hero.owner == msg.sender, "You do not own this NFT");

        // Get required resource to upgrade
        UpgradeRequirements[7] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsLumberYard();

        _checkAndSpendResources(hero, upgradeRequirements, hero.woodResource.level);
    ...
    //  function upgradeStoneMill(uint256 tokenId) public notPaused resourceAddresses {
    //     (Hero memory hero, bool _isStaked) = NGHeroFacet(address(this)).getHero(tokenId);
    //     require(NGHeroFacet(address(this)).ownerOf(tokenId) == address(this), "NFT is not staked");
    //     require(hero.owner == msg.sender, "You do not own this NFT");

    //     // Get required resource to upgrade
    //     UpgradeRequirements[7] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsStoneMill();
