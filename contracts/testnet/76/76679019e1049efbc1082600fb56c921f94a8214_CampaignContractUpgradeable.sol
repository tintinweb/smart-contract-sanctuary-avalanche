...
contract CampaignContractUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable, Blacklistable {
     ...
     *
     */
    function initialize(IArkiusAttentionSeekerToken attentionSeekerNFTAddress,
    ...
    function addCampaign(uint256       timestamp,
                         ...
                         uint96        target,
                         uint96        arkiusPayPerAdClick) external onlyAttentionSeeker notBlacklisted {
    ...
    function setPaused(uint256 campaignID, bool pause) external onlyCampaignOwner(campaignID) notBlacklisted {
     ...
     */
    function fundCampaign(uint256[] memory id, uint256[] memory replenish) external onlyAttentionSeeker nonReentrant notBlacklisted {
    ...
    function withdrawFunds(uint256 campaignID, uint256 amount) external onlyCampaignOwner(campaignID) notBlacklisted {
     ...
     */
    function deleteCampaign(uint id) external onlyCampaignOwner(id) nonReentrant notBlacklisted {
    ...
    function editCampaign(uint id,
        ...
        string memory imageUrl,
        string memory destinationUrl,
        string memory metadata) external onlyAttentionSeeker onlyCampaignOwner(id) notBlacklisted {
     ...
     */
    function adClicked(uint256 campaignID) external onlyMarketplaceController nonReentrant notBlacklisted {
    ...
    function adServed(uint256 campaignID) external onlyMarketplaceController nonReentrant notBlacklisted {
