...
contract BetUpEvents is Initializable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    */
    ...
    function getRewardOf(
        ...
        /*
          resolutionAt   uint64 :  1668779583
          creator   address :  0xc71E2DAf619f23B580dc1975FFd20b1023fbf275
          resolverQty   uint32 :  1
          endStackAt   uint64 :  1668779580
          chip   address :  0x86a18cFF52664f0FA5B65F8370C66C89160ff137
          optionsQty   uint8 :  3
          creationRatio   uint16 :  5000
          paused   bool :  false
          claimedReward   bool :  true
          claimedToVault   bool :  true
        */
        Pair memory pair = pairs[_pairID];

        bytes32 playerID = keccak256(abi.encodePacked(_pairID, _resultID, _receiver)); // 1000000，1000000
        (uint256 refund, uint256 reward) = _getReward(
            _pairID, // 136
            _maxLevel, // 1
            _receiver, // 0x986d74c796BdCBb83f0EAA3242A6335cf54080F4
            _resultID, // 2
            pair,
            players[playerID] // 1000000,1000000
        );
