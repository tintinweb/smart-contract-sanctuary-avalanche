...
contract ZOARouterV1 is Initializable, TokenHelper, Router, ITrustedForwarder, IZOARouterV1 {
    // TODO delete this
    // solhint-disable
    ...
    function createProfile(
        uint256 avatarShopId,
        bytes32 username
        // TODO сделать create profile с переводом на контракте
    ) external returns (uint256 profileId_) {
        ...
        // buy an avatar
        {
            ...
            // approve
            bytes memory approveCall = abi.encodeWithSelector(IERC20Upgradeable.approve.selector, gameFiShops(), shopDetails.tokenInOffer.amount);
