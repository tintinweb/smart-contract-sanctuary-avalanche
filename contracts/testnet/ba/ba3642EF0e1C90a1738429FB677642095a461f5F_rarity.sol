...
contract rarity is ERC721 {
    ...
    function adventure(uint _summoner) external {
        require(_isApprovedOrOwner(msg.sender, _summoner), "ApproveError");
        require(block.timestamp > adventurers_log[_summoner], "still resting");
    ...
    function level_up(uint _summoner) external {
        ...
        require(xp[_summoner] >= _xp_required, "Xp not enough");
