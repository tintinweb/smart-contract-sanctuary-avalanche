    ...
    ERC721
{
    ...
    function tokenURI(uint256 tokenId) public view validToken(tokenId) returns (string memory) {
    ...
    function getApproved(
        uint256 tokenId
    ) public view override validToken(tokenId) returns (address operator) {
