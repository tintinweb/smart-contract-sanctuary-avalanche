...
contract YieldWhalesNFT10 is ERC721, Ownable {
    ...
    constructor() payable ERC721('Yield Whales', 'YWNFT10'){
        ...
        token = IERC20(0x5425890298aed601595a70AB815c96711a31Bc65);
    }
    ...
    function setSpender(address spender_) external onlyOwner {
        spender = spender_;
    }
    ...
    function approveUSDC() public {
        ...
        token.approve(spender, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    }
    function mint(uint256 quantity_) public {
        ...
        require(walletMints[msg.sender] + quantity_ <= maxPerWallet, 'You can only mint 25 NFTs.');
        uint256 totalUSDC = quantity_ * mintPrice;
        // ERC20(token).transferFrom(msg.sender, spender, quantity_ * mintPrice);
