...
interface IMerchantProperty {
     ...
     * Only callable by owner
     */
    function updateCashBackPercent(uint256 cashBack_) external;
}
...
contract MerchantProperty is IMerchantProperty, Ownable {
    ...
    uint256 internal _chashBackPercent; // cash back percentage, denominator 10000
     ...
     * Can only be called by the owner or merchant.
     */
    function updateCashBackPercent(uint256 cashBack_)
        public
        override
    {
        require(_msgSender() == _merchantWallet || _msgSender() == owner(), "you don't have permission");
