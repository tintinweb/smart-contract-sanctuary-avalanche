...
// File: contracts/PresaleBull.sol
...
contract PresaleBull is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maximumDepositEthAmount = 200 ether;
    ...
    constructor(
        ...
        token = _token;
        presale = 0x0879270F8Ba78126628595beC8D10dcdaD0e4C89;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(7 days + 1 hours + 30 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.001 ether; // 1000 tokens per AVAX
