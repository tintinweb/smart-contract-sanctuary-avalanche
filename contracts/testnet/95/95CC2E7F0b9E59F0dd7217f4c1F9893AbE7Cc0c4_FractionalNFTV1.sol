    ...
    OwnableUpgradeable
{
    ...
    function mint(address _to, uint256 fractionalSupply) public onlyOwner {
        fractionalizations[totalSupply + 1] = Fractionalization({
    ...
    function setFractionalization(
        uint256 tokenId,
        uint256 totalFractionalSupply
    ) public onlyOwner {
        fractionalizations[tokenId] = Fractionalization({
            isFractionalized: false,
            totalFractionalSupplied: totalFractionalSupply
        });
    }
