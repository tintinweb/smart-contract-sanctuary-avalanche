...
contract SalientYachtsSYONE_v07 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint256 private constant NFT_MINT_PRICE_USD     = 1 * (10 ** NFT_PRICE_DECIMALS); //mint price fixed at $100
    uint256 private constant NFT_MINT_PRICE_ETH     = 1000000000000000; //0.0010 BNB
    ...
    event CreateStream(uint256 _streamId, address _owner, uint256 _tokenId );
    ...
    constructor(address _rewardContractAddress) ERC721("Salient Yachts", "SYONE") {
        ...
        priceFeedAddr = 0x3dD3b0b1910E797471d04919C24076f809bE5cc6;
    ...
    function buyYachtNFT(uint256 numberOfTokens, NFTType nftType, string memory affiliateId) public payable {
        ...
        for(uint i = 0; i < numberOfTokens; i++) {
            ...
            emit CreateStream(streamId, msg.sender, tokenId );
        }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) internal override(ERC721, ERC721Enumerable) {
        ...
        if (from != address(0) && to != address(0) && from != to) {
            ...
            emit CreateStream(toStreamId, to, tokenId );
        }
    }
