...
//updateNums--------------------------------------------------------------------------------------------------
    ...
    function updateCashoutRed(uint256[3] memory _percs) external onlyOwner{
    	cashoutRed = [uint256(0),NeFiLib.sendPercentage(cashoutFee,uint256(100).sub(_percs[0])),NeFiLib.sendPercentage(cashoutFee,uint256(100).sub(_percs[1])),NeFiLib.sendPercentage(cashoutFee,uint256(100).sub(_percs[1]))];
