...
contract MasterContractsRegistry is IMasterContractsRegistry, RoleManagedRegistry {
    string public constant MASTER_DAO_REGISTRY = "MASTER_DAO_REGISTRY";
    string public constant MASTER_DAO_FACTORY = "MASTER_DAO_FACTORY";
    ...
    function getMasterDAOFactory() public view override returns (address) {
        return getContract(MASTER_DAO_FACTORY);
    }

    function getMasterDAORegistry() public view override returns (address) {
        return getContract(MASTER_DAO_REGISTRY);
    }
}
...
interface IMasterContractsRegistry {
    ...
    function getMasterDAOFactory() external view returns (address);

    function getMasterDAORegistry() external view returns (address);
}