...
contract shapes is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("golls", "shapes") {
    _customBaseURI = 'https://gateway.pinata.cloud/ipfs/QmQFo2RtnzB5wqSRitaXMQ9exFJAkhqzz3FSQ51CUrWmLi';
  ...
  function mint(uint256 quantity) public payable {
    ...
    require(quantity <= 10, "Cannot mint that many at once.");
