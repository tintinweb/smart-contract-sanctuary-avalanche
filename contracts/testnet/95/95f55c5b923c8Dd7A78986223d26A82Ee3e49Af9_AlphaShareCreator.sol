...
contract AlphaShareCreator is ReentrancyGuard, AuthContract {
    ...
    address public _mediumOfExchange; // ERC20 Alpha
    ...
    * @dev Transfer payment safely between users
        ...
        nonReentrant 
    {
        ...
        IERC20(_mediumOfExchange)
            .transferFrom(msg.sender, payable(address(_alphaShareERC20PaymentSplitter)), totalCostERC20);
        ...
        nonReentrant
    {
        ...
        _mediumOfExchange = erc20Address;
    }
