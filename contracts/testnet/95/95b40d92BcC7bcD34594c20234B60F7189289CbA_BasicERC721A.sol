...
// Basic ERC721A by xrpant for Smolrun
...
// Change Name
contract BasicERC721A is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "https://ENTER-API-URL-HERE/";
    ...
    uint256 public royalty = 1000; // (500 / 100 = 5% royalty)
    ...
    ) ERC721A("Basic ERC721A", "BASIC") {
            ProceedsWallet = 0xdbA6fF32A8b0ec56EbfeD537280Db9f8ee85be09;
            RoyaltyAddress = 0x944f952Ba6E837970Ba093d3fcB84A2211B12257;
    }
    ...
    function royaltyInfo(uint256, uint256 value) external view returns(address, uint256) {
        return (RoyaltyAddress, (value * royalty) / 10000);
    } 
