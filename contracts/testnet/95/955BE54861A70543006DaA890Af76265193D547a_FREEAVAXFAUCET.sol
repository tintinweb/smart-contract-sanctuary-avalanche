...
contract FREEAVAXFAUCET {
    ...
    uint256 public AVAX_MIN_WITHDRAW = 1; //minimum payout is 0.1 AVAX
   ...
   constructor() {
    ...
    function claimFaucet(address) public returns (bool) {
        ...
        uint256 payout = (payout_multiplier[msg.sender] * AVAX_BASE_AMOUNT) / 100;
    ...
    receive() external payable {
        uint newMulti = msg.value * 100000;
