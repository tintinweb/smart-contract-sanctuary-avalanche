...
contract penguinMaker is Ownable, Pausable{
    ...
    function mint(uint256[] memory traits) public whenNotPaused{
        ...
        require(1000 < traits[2] && traits[2] <= 1500, "invalid trait 2");
        require(1500 < traits[3] && traits[3] <= 2000, "invalid trait 3");
        require(2000 < traits[4] && traits[4] <= 2500, "invalid trait 4");
        require(2500 < traits[5] && traits[5] <= 3000, "invalid trait 5");
        require(3000 < traits[6] && traits[6] <= 3500, "invalid trait 6");
