...
contract Nouns is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ILayerZeroReceiver, ILayerZeroUserApplicationConfig {
    ...
    returns (string memory)
  {
    ...
    function sendNoun(
        ...
        bytes memory payload = abi.encode(noun_id);

        // encode adapterParams to specify more gas for the destination
        uint16 version = 1;
        uint gasForDestinationLzReceive = 300000;
        ...
        layerZeroEndpoint.send{value: msg.value}(       // {value: messageFee} will be paid out of this contract!
    ...
    function lzReceive(
        ...
        uint noun_id = abi.decode(_payload, (uint));

        _safeMint(owner(), noun_id);
