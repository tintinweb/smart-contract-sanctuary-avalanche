...
import {IEvidenzRevealable} from './IEvidenzRevealable.sol';
import {ERC721URIGenerator} from '../token/ERC721/extensions/ERC721URIGenerator.sol';

abstract contract EvidenzRevealable is
    Evidenz,
    ERC721URIGenerator,
    IEvidenzRevealable
{
    ...
    function _getImage(
        ...
        else return string(defaultImage);
    }
    ...
    function _requireClaimed(uint256 tokenId) internal view {
        require(ownerOf(tokenId) != owner(), 'EvidenzRevealable: not claimed');
    }
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC721, ERC721URIGenerator, IERC165)
        returns (bool)
    {
        return
            interfaceId == type(IEvidenzRevealable).interfaceId ||
            super.supportsInterface(interfaceId);
    }
    ...
    function tokenURI(
        ...
        view
        virtual
        override(ERC721, ERC721URIGenerator)
...
interface IEvidenzRevealable is IERC165 {
    ...
    function setDefaultImage(string memory newDefaultImage) external;
}
...
import {IERC721URIGenerator} from './IERC721URIGenerator.sol';
import {Issuer} from '../../../domain/Issuer.sol';
import {Environment} from '../../../utils/Environment.sol';

abstract contract ERC721URIGenerator is ERC721, Evidenz, IERC721URIGenerator {
    using Environment for Environment.Endpoint;
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(IERC721URIGenerator).interfaceId ||
            super.supportsInterface(interfaceId);
    }
    ...
    function setIssuer(Issuer memory issuer_) external onlyOwner {
        issuer = issuer_;
    }
}
...
interface IERC721URIGenerator is IERC165, IERC721 {
    function setIssuer(Issuer memory issuer_) external;
}
    ...
    EvidenzRevealable
{
    ...
    function supportsInterface(
        ...
        view
        virtual
        override(ERC721, ERC5484, EvidenzRevealable)
        returns (bool)
    {
    ...
    function tokenURI(
        ...
        view
        virtual
        override(ERC721, EvidenzRevealable)
        returns (string memory)
    {
        return super.tokenURI(tokenId);
    }
