 ...
 */
contract vWINR_Calcul is Ownable{
    using SafeMath for uint256;
    uint256 private constant PRECISION = 1e18;
    uint256 private constant minMultiplier = 5e17;
    uint256 private constant maxMultiplier = 2e18;
    mapping(uint256 => uint256) public dailyVolumes;

    function setVolume(uint256 day, uint256 volume) external onlyOwner(){
        dailyVolumes[day] = volume;
    }
    ...
    function getMultiplier(uint256 day, uint256 currentMultiplier) external view returns (uint256) {

		// Get the volume of the previous day and the current day
		uint256 prevDayVolume_ = getVolumeOfDay(day - 2);
		uint256 currentDayVolume_ = getVolumeOfDay(day - 1);
		...
		newMultiplier = newMultiplier > maxMultiplier
			? maxMultiplier
			: newMultiplier;
		newMultiplier = newMultiplier < minMultiplier
			? minMultiplier
			: newMultiplier;
