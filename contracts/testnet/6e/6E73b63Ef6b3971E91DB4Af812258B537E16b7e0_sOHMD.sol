...
contract sOHMD is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sOHMD", "sOHMD", 9) ERC20Permit() {
    ...
    /**
        @notice increases sOHMD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sOHMD
