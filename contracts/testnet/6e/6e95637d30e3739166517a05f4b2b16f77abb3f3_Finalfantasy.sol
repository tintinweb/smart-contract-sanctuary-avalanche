...
contract Finalfantasy is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Finalfantasy";
    string constant _symbol = "FFS";
