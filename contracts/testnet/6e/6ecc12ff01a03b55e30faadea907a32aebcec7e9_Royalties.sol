...
contract Royalties is Ownable {
    ...
    function setDeveloperAddress(address _developerAddress) external onlyOwner {
		require(_developerAddress!=address(0), "Invalid new address");
        developerAddress = _developerAddress;
    }
    ...
    function claim() external onlyOwner{
        ...
        ERC20(tokenFeesAddress).transfer(developerAddress, developerShare);
        ERC20(tokenFeesAddress).transfer(msg.sender, balance - developerShare);
        claimedAmount = claimedAmount + balance;
