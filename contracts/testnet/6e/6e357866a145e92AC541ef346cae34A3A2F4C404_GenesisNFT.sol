...
contract GenesisNFT is ERC721Burnable, ERC721Rentable, ERC721URIStorage, IGenesisNFT, Creator, NonFungibleType, Withdrawable, ReentrancyGuard, Signable {
    ...
    function permit(
        ...
        if (_owner == spender_) revert GenesisNFT__SelfPermit();
        _verify(sender, _hashTypedDataV4(keccak256(abi.encode(_PERMIT_TYPE_HASH, spender_, tokenId_, _nonces[sender], deadline_))), signature_);
