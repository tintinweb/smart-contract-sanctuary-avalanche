...
contract SegMintNFTLocking is  ERC721Holder, ERC1155Holder{ //ERC20Holder,
    ...
    event EndStakingAndTransferNFTEvent(address sender, address contractAddress, uint256 tokenId);
    ...
    event FractionerUnlockAndTransferNFTEvent(address sender, address to, address contractAddress, uint256 tokenId);
   ...
   ////    Staking Specific TokenID   ////
    ...
    function stakerUnlockAndTransfer(address contractAddress, uint256 tokenId) public returns(bool){
        ...
        IERC721(contractAddress).safeTransferFrom(address(this), _ownerWalletAddress, tokenId);
        ...
        // emit event
        emit EndStakingAndTransferNFTEvent(msg.sender, contractAddress,tokenId);
    ...
    function fractionerUnlockAndTransfer(address contractAddress, uint256 tokenId, address _transferToAddress) public returns(bool){
        ...
        // emit event
        emit FractionerUnlockAndTransferNFTEvent(msg.sender, _transferToAddress, contractAddress, tokenId);
