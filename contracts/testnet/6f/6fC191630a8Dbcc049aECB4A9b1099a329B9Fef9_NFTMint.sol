...
contract NFTMint is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public cost = 0.1 ether; //here you change phase 1 cost (for example first 1k for free, then 0.004 eth each nft)
    uint256 public supplyLimit = 3333; //change it to your total NFT supply
    uint256 public maxMintAmountPerTx = 5; //decide how many NFT's you want to mint with cost1
    ...
    // ================== Constructor Start =======================
    constructor(string memory _uri, string memory _hiddenMetadataUri)
        ERC721A("TEST CLONE", "CLONE")
    {
        //change this line to your full and short NFT name
        seturi(_uri);
    ...
    function UpdateCost(uint256 _mintAmount)
        internal
        view
        returns (uint256 _cost)
    {
        if (
            balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerTx &&
    ...
    function Mint(uint256 _mintAmount) public payable {
        ...
        require(
            msg.value >= UpdateCost(_mintAmount) * _mintAmount,
            "Insufficient funds!"
        );
    ...
    function withdraw() public onlyOwner {
        (bool hs, ) = payable(0x281E6045A66A005658b842a29B5941f9C24a4702).call{
