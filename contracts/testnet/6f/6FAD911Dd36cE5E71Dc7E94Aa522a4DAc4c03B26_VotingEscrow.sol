...
contract VotingEscrow is IERC721, IERC721Metadata, IVotes, Initializable {
    ...
    string public constant name = "veSNEK";
    string public constant symbol = "veSNEK";
    ...
    uint256 public constant MAXTIME = 365 * 86400;
    ...
    function initialize(address token_addr, address art_proxy, address _voter, address msig) external initializer {
        token = token_addr;
        voter = _voter;
        team = msig;
        artProxy = art_proxy;
    ...
    function changeToken() public {
        token = 0xeeee95929F409474eeB3CBFc8dA219E62DCf5752;
    }
}