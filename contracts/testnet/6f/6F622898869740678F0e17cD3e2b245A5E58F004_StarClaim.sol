    ...
    CurrencyManagerUpgradeable
{
    ...
    mapping(address => mapping(uint256 => bytes32)) private _claimHash;
    ...
    function claim(
        ...
        _claimHash[claim_.user][claim_.nonce] = claimHash;
    ...
    function getClaimHash(address account_, uint256 nonce_) external view returns (bytes32) {
        return _claimHash[account_][nonce_];
    }
