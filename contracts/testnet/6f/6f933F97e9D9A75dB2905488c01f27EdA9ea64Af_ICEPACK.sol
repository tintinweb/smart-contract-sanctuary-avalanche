...
contract ICEPACK is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor(
    ...
    ) ERC20Detailed("Icepack", "ICEPACK", uint8(DECIMALS)) {
        ...
        _allowedFragments[address(this)][address(_autoLiquidityReceiver)] = ~uint256(0);
