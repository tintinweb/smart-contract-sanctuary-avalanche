...
*/
contract SmolrJoes is ERC721Enumerable, Ownable, ERC2981 {
    
    string private _cid;
    uint256 private _nextTokenId;
    uint256 private _maxMint = 69;

    constructor(string memory cid, uint96 royaltyBasisPts, address royaltyAddress) ERC721("Smolr Joes", "SMOLR"){
       _cid = cid;
