...
//*********************************************************************//
//
//    ___          __  __         ______     __  _______     _         ___                 ____  _       
//   / _ \_______ / /_/ /___ __  / ___(_)___/ / / ___/ /__ _(_)_ _    / _ \___  __ _____ _/ / /_(_)__ ___
//  / ___/ __/ -_) __/ __/ // / / (_ / / __/ / / /__/ / _ `/ /  ' \  / , _/ _ \/ // / _ `/ / __/ / -_|_-<
// /_/  /_/  \__/\__/\__/\_, /  \___/_/_/ /_/  \___/_/\_,_/_/_/_/_/ /_/|_|\___/\_, /\_,_/_/\__/_/\__/___/
//                      /___/                                                 /___/                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x7A1775083811D07c7Ab368efFfbB00E2C9F38a94];
...
// File: contracts/PrettyGirlClaimRoyaltiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract PrettyGirlClaimRoyaltiesContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Pretty Girl Claim Royalties";
    string public symbol = "PMTR";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/YVYqssHMVAcxWhujbGH4/contract-metadata";
  }
