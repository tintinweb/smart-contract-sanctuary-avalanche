...
contract BKSVesting2Public is BKSVesting {
    constructor(address _token, bytes32 _mercleRoot, uint256 _tgeTimestamp) {
        require(_token != address(0), "BKSVesting2Public: zero token address");
        require(_mercleRoot != bytes32(0), "BKSVesting2Public: zero mercle root");
        require(_tgeTimestamp >= block.timestamp, "BKSVesting2Public: wrong TGE timestamp");
