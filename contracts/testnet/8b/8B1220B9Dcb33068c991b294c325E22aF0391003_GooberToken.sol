...
contract GooberToken is Ownable, ERC20 {
    ...
    uint256 public maxTxAmount = 7000000000 * 10 ** decimals(); //1.0% 7B
    uint256 public maxWalletAmount = 7000000000 * 10 ** decimals(); //1.0% 7B
    uint256 public numTokensSellToAddToETH = 70000000 * 10 ** decimals(); //0.01% 70M
    uint256 public numTokensSellToAddToLiquidity = 140000000 * 10 ** decimals(); //0.02% 140M
    uint256 public claimReserve;
    uint256 private supply = 700000000000 * 10 ** decimals(); //700B
