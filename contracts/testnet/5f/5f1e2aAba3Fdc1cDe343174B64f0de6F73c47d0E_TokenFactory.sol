...
contract TokenFactory is AccessControl, Initializable{
    ...
    function deployAdminIdentity(address _initialManagementKey, uint256 executionBuffer, uint256 reqSig, address tokenizationAgent , address _token) public onlyRole(Owner_Role) returns (address) {
        ...
        (success,) = adminIdentityProxy.call(abi.encodeWithSelector(0x7a1ac61e, _initialManagementKey, executionBuffer, reqSig));
        ...
        require(success, "Addkey failure");
    ...
    function addMultiSigSigner(address _multiSig, address _signer)public onlyRole(Owner_Role){
        //Add AdminIdentity.addKey
    }
