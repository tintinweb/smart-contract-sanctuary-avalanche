...
contract Marketingplace is ReentrancyGuard {
    ...
    function setMarketFee(uint256 newMarketFee) public virtual {
        require(owner == msg.sender, "Marketplace: Caller is not owner of the contract.");
        require(newMarketFee <= 5000, "Marketplace: Market fee value cannot be higher than 5000.");
     ...
     */
    function PutSaleNFT(address nftContract, uint256 tokenId, uint256 price) public nonReentrant {
     ...
     */
    function Resale(uint256 itemId, uint256 price) public nonReentrant {
        require(idToMarketItem[itemId].itemId > 0, "Marketplace: itemId does not exist. Use createMarketItem function.");
        require(!idToMarketItem[itemId].onSale, "Marketplace: This item is already on sale.");
        require(price > 0, "Marketplace: Price must be greater than 0.");
    ...
    function BuyNFT(address nftContract, uint256 itemId) public payable nonReentrant {
        ...
        require(msg.sender != idToMarketItem[itemId].seller, "You are Seller");
        require(idToMarketItem[itemId].onSale, "Marketplace: This item is not currently on sale.");
        require(msg.value == price, "Marketplace: Value of transaction must be equal to sale price.");
        ...
        require(successFee, "Marketplace: Market fee transfer failed.");
        ...
        (successTx, "Marketplace: Seller payment transfer failed.");
    ...
    function _deduceRoyalties(address nftContract, uint256 tokenId, uint256 grossSaleValue, address payable seller) 
        ...
        if (royaltiesAmount > 0) {
            ...
            require(success, "Marketplace: Royalties transfer failed.");
        }
