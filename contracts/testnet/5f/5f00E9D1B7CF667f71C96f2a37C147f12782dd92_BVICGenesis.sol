...
contract BVICGenesis is ContractGuard, Ownable {
    ...
    uint256 public constant TOTAL_REWARD_POOL_5_NEXT_PHASE = 0.675 ether; // 60% of (75% of 2.25 * 2/3) BVIC-BTC.b
    ...
    uint256 public constant TOTAL_REWARD_POOL_0_NEXT_PHASE = 0.05625 ether; // 5% of (75% of 2.25 * 2/3) BTC.b
