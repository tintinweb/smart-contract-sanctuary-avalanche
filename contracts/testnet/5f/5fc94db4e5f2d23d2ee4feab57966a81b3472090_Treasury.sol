...
contract Treasury is ContractGuard, Initializable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        HOSTPriceOne = 1 * 1e18; // This is to allow a PEG of 1 HOST per ETH
    ...
    function buyBonds(uint256 _HOSTAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            if (previousEpochHOSTPrice > HOSTPriceCeiling) {
                // Expansion ($HOST Price > 1 $ETH): there is some seigniorage to be allocated
