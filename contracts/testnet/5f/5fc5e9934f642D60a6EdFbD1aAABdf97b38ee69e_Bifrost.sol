...
contract Bifrost is Ownable, PaymentSplitter {
    ...
    function changeCashOutFeeTax(uint256 tax1, uint256 tax2, uint256 tax3, uint256 tax4)
        public
        onlyOwner
    {
    ...
    function changeCashOutFeeDue(uint256 dueTime1, uint256 dueTime2, uint256 dueTime3, uint256 dueTime4)
        public
        onlyOwner
    {
