...
contract CygnusBorrowControl is ICygnusBorrowControl, CygnusTerminal {
     ...
     */
    uint8 public immutable borrowTokenIndex;
    ...
    {
        (, , collateral, borrowTokenIndex) = ICygnusAlbireo(_msgSender()).borrowParameters();
    }
...
/*  ═══════════════════════════════════════════════════════════════════════════════════════════════════════
        ...
        https://cygnusdao.finance - BORROW DEPLOYER                                                           
        ═══════════════════════════════════════════════════════════════════════════════════════════════════════  */
...
contract CygnusAlbireo is ICygnusAlbireo, Context {
    ...
    /**
     *  @notice These parameters get passed to all Cygnus Borrow contracts
     *  @custom:struct factory The address of the Cygnus factory
     *  @custom:struct underlying The address of the underlying borrow token (address of DAI, USDc, etc.)
     *  @custom:struct collateral The address of the Cygnus collateral
     *  @custom:struct borrowTokenIndex The index of the borrow token for this shuttle (0 or 1)
     */
    ...
    /**
     *  @dev Must initialize struct as public for borrow constructor to pick up parameters
