...
// File contracts/WarrantyToken.sol

pragma solidity ^0.8.0;


contract CarWarranty is ERC721, Ownable {
    struct Warranty {
        string vinNumber;
        uint256 startDate;
        uint256 endDate;
    ...
    constructor() ERC721("CarWarranty", "CW") {}
    ...
    function createWarranty(
        ...
        uint256 warrantyId = warranties.length - 1;
        _safeMint(msg.sender, warrantyId);
    ...
    {
        require(_exists(warrantyId), "Warranty does not exist");

        Warranty memory warranty = warranties[warrantyId];
        return (
            warranty.vinNumber,
            warranty.startDate,
            warranty.endDate,
