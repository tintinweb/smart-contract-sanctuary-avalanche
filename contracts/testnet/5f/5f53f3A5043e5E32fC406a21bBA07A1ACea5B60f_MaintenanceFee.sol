    ...
    AccessControlUpgradeable
{
    ...
    /**
     * @dev This function is used to pay the YieldBox Maintenance fee
    ...
    function payMaintenanceFee(
        ...
        require(
            ...
            "Token Ids and paid days must have the same array length"
				...
				console.log("getYieldBoxAttached: ", getYieldBoxAttached(_yieldKey, _type, _tokenIds));
        require(
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            require(
                ...
                "At least one YieldBox has minimal (free) rewards pending to be claimed"
            );
            require(
    ...
    /**
     * @dev This function is used to check if a Token address is valid.
    ...
    /**
     * @dev This Method permit set the Value in Stable Coin for Pay Maintenance Fee.
    ...
    /**
     * @dev Function to retrieve the available slots per YieldKey
     * @param _yieldKey YieldKey Token Id
     * @param _type YieldKey type
    ...
    /**
     * @dev Function to retrieve the Amount of YieldBox Actually Attach to the YieldKey
     * @param _yieldKey YieldKey Token Id
     * @param _type YieldKey type
    ...
    /**
     * @dev Function to Get Payable Days
    ...
    /**
     * @dev This function allows to set the LIMITS_DAYS payable by a YieldBox
    ...
    /**
     * @dev This function allows to reset the Maintenance fee
     * @param _yieldKey YieldKey Token Id
    ...
    /**
     * @dev Function to set the Maintenance fee price per YieldKey Type
