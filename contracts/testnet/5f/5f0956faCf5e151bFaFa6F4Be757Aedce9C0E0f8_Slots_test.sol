...
contract Core_test is ReentrancyGuard, Ownable {
    ...
    function _requestRandomWords(
        uint32 numWords
    ) internal returns (uint256 s_requestId) {//TEST INTERNAL
    ...
    returns (uint256 requestId)
    {
        ...
        requestId = VRFCoordinatorV2Interface(ChainLinkVRF)
        .requestRandomWords(
            0x354d2f95da55398f44b7cff77da56283d9c6c829a4bdf1bbcaf2ad6a4d081f61,
            582,
            3,
...
contract Slots_test is Core_test {
    ...
    uint16 public entryCounter;//TEST
