...
contract CollectionsRepository is ICollectionsRepository {
    ...
    function setDetails(IOmniERC721 collection, string memory fileURI, string[] memory metadataURIs, uint256 from, uint256 to, string memory assetName) external override {
        require(msg.sender == collectionFactory || msg.sender == collection.getCreator());
        collection.setAsset(assetName);
...
contract OmniERC721 is IOmniERC721, ERC721URIStorage {
    ...
    function setAsset(string memory _assetName) onlyRepository external override {
