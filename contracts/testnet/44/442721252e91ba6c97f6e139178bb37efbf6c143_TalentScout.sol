...
// File: contracts/talentscout4.sol
...
contract TalentScout is ERC20, AccessControl, Ownable {
 ...
 event DeployError(bytes reason);
        ...
        ERC20(_name, _symbol, _totalSupply)
    {
        ...
        // Locked in Liquidity
        _mint(address(msg.sender), initialLiquidity);
    ...
    function distributedReflectionAmount() public onlyOwner {
        ...
        function distributedTalentAwardAmount() public onlyOwner {
        uint256 distributedAmount = 0;
    ...
    function userReflectionRewards(address _holder) public view returns(uint256, uint256) {
        uint256 circultingSupply = getCirculatingSupply();
