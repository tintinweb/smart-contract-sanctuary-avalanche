...
//  __    __   ______   _______   __    __  ________  ______   __     __   ______   __    __         ______    ______   ______  __    __ 
// /  \  /  | /      \ /       \ /  |  /  |/        |/      \ /  |   /  | /      \ /  |  /  |       /      \  /      \ /      |/  \  /  |
// $$  \ $$ |/$$$$$$  |$$$$$$$  |$$ |  $$ |$$$$$$$$//$$$$$$  |$$ |   $$ |/$$$$$$  |$$ |  $$ |      /$$$$$$  |/$$$$$$  |$$$$$$/ $$  \ $$ |
// $$$  \$$ |$$ |__$$ |$$ |__$$ |$$ |  $$ |   $$ |  $$ |__$$ |$$ |   $$ |$$ |__$$ |$$  \/$$/       $$ |  $$/ $$ |  $$ |  $$ |  $$$  \$$ |
// $$$$  $$ |$$    $$ |$$    $$< $$ |  $$ |   $$ |  $$    $$ |$$  \ /$$/ $$    $$ | $$  $$<        $$ |      $$ |  $$ |  $$ |  $$$$  $$ |
...
// http://www.narutavax.eu
// https://twitter.com/NarutAvax
// https://t.me/narutavax

// IF YOU SEE THIS YOU ARE EARLY ! JOIN THE TG TO KNOW WHEN LAUNCH.
// MAX BUY 2% AND MAX WALLET 4%
// REFLECTION = 5% AND MARKETING FEE = 12%
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
...
contract NarutAvax is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
    address public WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "NarutAvax Coin";
    string constant _symbol = "NVAX";
