 ...
 */
contract Risitest is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = "ipfs://QmRX6dujYTUeUFZDtrJTgwcNG9sTkoqTBEeDEz4zABTT5z/";
    string public uriSuffix = ".txt";
