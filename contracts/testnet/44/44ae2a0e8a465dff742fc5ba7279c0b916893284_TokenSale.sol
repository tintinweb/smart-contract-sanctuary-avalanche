...
contract TokenSale {
    ...
    constructor(address _usdcAddress, address _tokenAddress, uint _price, uint256 _buyLimit) {
        owner = msg.sender;
    ...
    function buyTokens(uint _amount) public {
        ...
        require(usdc.balanceOf(msg.sender) + _amount <= buyLimit, "Exceeded buy limit");
