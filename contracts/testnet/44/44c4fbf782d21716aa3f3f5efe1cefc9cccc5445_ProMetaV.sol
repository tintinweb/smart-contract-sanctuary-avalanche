...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract ProMetaV is ERC20, Ownable {
        ...
        //  uint8 constant decimals() = 18;
         ...
         uint256 public maxSupply = 3_000_000_000 * (10**decimals());
        ...
        constructor(address _adminAddress) ERC20("Prometav", "PMV") {
        ...
        function mint(address account, uint256 amount) public onlyOwner {
            ...
            require(account != address(0), "ERC20: mint to the zero address");
            require(maxSupply > totalSupply() , "ERC20: totalSupply is already at maxSupply");
