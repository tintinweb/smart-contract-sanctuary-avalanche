...
import "../implementations/output/AtomProtocolImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    AtomProtocolImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x3a0aef9108DE8a2437d883147Ed13d14dAC3B2d1), // Treasury investments (45%)
        address(0x05aCf31aB0E5c125Ceb004A6da1bB549E3f16972), // Dev (35%)
        address(0x11832F5B177C2764802f3bC20C3eBCA5b5b12906) // Marketing (20%)
    ];
    uint8[] public feePercentages = [45, 35, 20];
    ...
    constructor(
        ...
        changeAtomProtocolImplementation(address(leftSide));
...
abstract contract AtomProtocolImplementationPointer is Ownable {
