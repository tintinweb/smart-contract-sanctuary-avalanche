...
contract PriceFeeds_AVAX is ManagerTimelock {
    ...
    uint256 stalePeriod;
    address wethTokenAddress = 0x45f42F0dA25906e5741a74CE418623E00739cc9A; // WAVAX fuji testnet
    ...
    function _queryRateUSD(address token) internal view returns (uint256 rate, uint256 precision) {
