...
contract DerbyTicket is ERC721 {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    address payable lfgLootAddr = payable(0x7375f900Ed64136b8b8b2Cc9E96B52b923BEb78e);
    address private teamAddress = 0x8ff0aD5887C151C320512334E6bC829fFA32B23f;
    uint256 private commonUserNum = 1000;
    ...
    onlyOwner
    {
        ...
        for (uint i = 0; i < num; i++) {
            ...
            _safeMint(teamAddress, newItemId);
            emit TokenIDs(teamAddress, newItemId);
        }
    }
