...
contract AAASimpleRewarderPerSec is Ownable {
    ...
    constructor() { //before deploying set your custom info in next three lines
        IERC20 _rewardToken = IERC20(0xC87D0aC517dA3EE8cdE4f7A774860fddE5DE7C05);//set address for your IERC20 _rewardToken, 
        IERC20 _inputToken = IERC20(0xdA9719805c298FA572A8D3131f26d7455d7573B2);//set address for your IERC20 _inputToken, 
        uint256 _tokenPerSec = 28935185185000000 ;//set uint256 _tokenPerSec in wei
