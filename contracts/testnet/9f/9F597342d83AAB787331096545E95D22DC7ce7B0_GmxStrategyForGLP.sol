...
contract GmxStrategyForGLP is YakStrategyV2 {
    ...
    constructor(
        ...
        devAddr = 0xfe6e9353000a31B9C87F4EAE411C89b1E355Ba50;       // 0x2D580F9CF2fB2D09BC411532988F2aFdA4E7BefF
    ...
    function depositWithPermit(
        ...
        IERC2612(address(depositToken)).permit(msg.sender, address(this), amount, deadline, v, r, s);
        _deposit(msg.sender, amount);
    }
     ...
     */
    function _reinvest(uint256 _amount) public {
