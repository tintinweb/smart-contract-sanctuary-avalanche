...
contract NowUnitedTheMusicalTier3 is ERC1155, Ownable, ReentrancyGuard {
    string public name = "Now United The Musical: Country Elite";
    string public symbol = "NUCE";
    ...
    function setMaxSupplyAndPrice(uint256 _maxSupply, uint256 _price) public onlyOwner {
        require(currentTokenId <= _maxSupply, "Invalid supply provided");
    ...
    function setProxyAddress(address _proxyAddress) public onlyOwner {
        require(_proxyAddress != address(0), "Invalid address provided");
