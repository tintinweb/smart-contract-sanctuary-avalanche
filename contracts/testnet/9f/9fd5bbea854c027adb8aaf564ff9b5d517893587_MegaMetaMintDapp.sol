...
contract MegaMetaMintDapp is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    (bool hs, ) = payable(0xDc89A7b522A0Ff17b0dA35d052861777716ae843).call{value: address(this).balance * 13 / 100}("");
    require(hs);
