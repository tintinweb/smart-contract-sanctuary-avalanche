...
import "./includes/RoyaltiesAddon.sol";
import "./includes/ERC2981.sol";
import "./includes/IERC2981.sol";

contract SharkDiscount is ERC721, ERC721Enumerable, Ownable, RG, RoyaltiesAddon, ERC2981 {
    ...
    constructor() ERC721("Shark Discount 20 V2", "SD22")
    {
        string memory baseTokenURI = "https://swap.web05.wmstudio.su/tokens/";
        string memory baseContractURI = "https://swap.web05.wmstudio.su/meta/global.json";
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(ERC721, ERC721Enumerable, RoyaltiesAddon)
    {
    ...
    function _mint() private {
        ...
        require(minted + 1 <= tokensPerWalletLimit, "Already minted maximum tokens");
    ...
    function royaltyInfo(uint256 tokenId, uint256 value) external view override(IERC2981) returns (address receiver, uint256 royaltyAmount) {
