...
contract ClearingHouse is DecimalERC20, OwnerPausableUpgradeSafe, ReentrancyGuardUpgradeSafe, BlockContext {
    ...
    //◥◤◥◤◥◤◥◤◥◤◥◤◥◤◥◤ add state variables below ◥◤◥◤◥◤◥◤◥◤◥◤◥◤◥◤//
    mapping(address => bool) internal whitelist2;
    //◢◣◢◣◢◣◢◣◢◣◢◣◢◣◢◣ add state variables above ◢◣◢◣◢◣◢◣◢◣◢◣◢◣◢◣//
    uint256[50] private __gap;
    ...
    function updateOpenInterestNotional(IAmm _amm, SignedDecimal.signedDecimal memory _amount) internal {
        ...
        if (cap > 0) {
            ...
            if (_amount.toInt() > 0) {
                ...
                require(updatedOpenInterestNotional.toUint() <= cap || isWhitelisted(_msgSender()), "over limit");
            }
    ...
    function setInitMarginRatio(Decimal.decimal memory _maintenanceMarginRatio) public onlyOwner {
        initMarginRatio = _maintenanceMarginRatio;
    }
