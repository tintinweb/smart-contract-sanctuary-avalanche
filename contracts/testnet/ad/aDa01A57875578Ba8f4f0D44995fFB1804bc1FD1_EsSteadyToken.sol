...
contract EsSteadyToken is ERC20("Steadefi escrowed token", "esSTEADY"), Ownable {
  using EnumerableSet for EnumerableSet.AddressSet;
  ...
  /**
   * @dev returns if "account" is allowed to send/receive esSteady
   */
  ...
  /**
   * @dev Updates the tokenManager address
   */
