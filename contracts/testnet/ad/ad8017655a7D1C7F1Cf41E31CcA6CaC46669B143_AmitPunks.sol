...
contract AmitPunks is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public constant MAX_MAX_SUPPLY = 1000;
    ...
    constructor(
        ...
        updateUnrevealURI(_unrevealURI);
    }

    function mint(uint256 amount) public payable nonReentrant {
        require(amount > 0, "min 1 mint required");
        require(!paused, "Minting is paused!");
        require(amount <= maxPerTx, "max mint per session exceeded");
        ...
        if (msg.sender != owner()) {
            ...
            require(
                addressMinted[msg.sender] + amount <= maxPerWallet,
    ...
    function updateUnrevealURI(string memory _newURI) public onlyOwner {
    ...
    function updateMaxSupply(uint256 max_value) public onlyOwner {
        require(max_value > MAX_SUPPLY && max_value <= MAX_MAX_SUPPLY, "Invalid Max Value");
        MAX_SUPPLY = max_value;
    }
