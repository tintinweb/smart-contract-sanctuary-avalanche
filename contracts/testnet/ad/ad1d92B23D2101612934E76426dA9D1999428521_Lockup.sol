...
contract Lockup is Ownable {
    ...
    uint256 minInterval = 12 hours; // for test
    ...
    uint8 public unLockBoost = 10;
    uint8 public month1 = 15;
    uint8 public month3 = 18;
    uint8 public month6 = 20;
    uint8 public year1 = 25;
    uint8 public tieA = 30;
    uint8 public tieB = 35;
    uint8 public tieC = 38;
    uint8 public tieD = 40;
    ...
    constructor (){
        ...
        NFToken = IERC721Metadata(0xfAdD6d49EC6465f592b36Aa3EFcb3707e3133873);      // // Node NFT address
        ...
        FractionalNFT = IFractionalNFT(0x5b4e45ABD2b3060Eb61f068bf8fecC67DE51D0AF);
    ...
    function getBoost(int128 duration, uint256 amount) internal view returns (uint8) {
        if(duration < 0 && amount < 100 * 10 ** 9 * 10 ** 18) return 0;
        else if (duration < 0 && amount < 500 * 10 ** 9 * 10 ** 18  && amount > 100 * 10 ** 9 * 10 ** 18) return tieA;      // irreversable
