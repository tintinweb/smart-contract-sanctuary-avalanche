...
contract BridgesOfFateV3 is Ownable, ReentrancyGuard {
    ...
    function initialize(uint256 _startAT) public onlyOwner {
        ...
        //extre
        require(_startAT > block.timestamp,"Time must greater then current time.");
     ...
     * @param _nftId
     */
    function enteryFeeForSeriesOne(uint256 _nftId) public GameEndRules GameInitialized {
    ...
    */
    ...
    modifier GameEndRules() {
        ...
        // require(lastUpdateDayDifference <= TURN_PERIOD * 3, "Game Ended !");
