...
contract voyager is ERC721Enumerable, ERC721URIStorage, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer{
  ...
  constructor() ERC721("Voyager", "V") ClampedRandomizer(_maxMintable){
    ...
    _mintActive = false; 
    _privateSale = false;
    address1 = 0x8654FE925701a6cb66C1cBA2786eF4d3a68ad6fE;
  ...
  function mint(uint256 quantity) public payable {
    ...
    require(msg.value >= (_price * quantity), "Not enough AVAX sent.");
  	...
  	payable(address1).transfer(msg.value);
  ...
  function _privateMint(address to) private {
    _tokenIds.increment();
