...
// File contracts/interfaces/INFTCollection.sol

pragma solidity 0.8.11;

interface INFTCollection is IERC165Upgradeable {
    /**
    ...
    AccessControlUpgradeable
{
    ...
    mapping(address => INFTCollection.Mintables) public whitelistedUsers;
    address[] public winners;
    CountersUpgradeable.Counter internal _tokenIds;
    INFTCollection.Mode public mode;
...
contract ERC721NFTCollectionFactory is AccessControl {
    ...
    constructor(
        ...
        if (
            INFTCollection(_erc721NFCollectionImpl).supportsInterface(
                type(INFTCollection).interfaceId
            )
        ) {
        ...
        onlyRole(ADMIN_ROLE)
    {
        ...
        if (
            INFTCollection(ImpAdr).supportsInterface(
                type(INFTCollection).interfaceId
            )
        ) {
            address oldERC721NFTCollectionImpl = erc721NFTCollectionImpl;
...
contract ERC1155NFTCollectionFactory is AccessControl {
    ...
    constructor(
        ...
        if (
            INFTCollection(_erc1155NFCollectionImpl).supportsInterface(
                type(INFTCollection).interfaceId
            )
        ) {
...
// File lossless/contracts/interfaces/[email protected]
