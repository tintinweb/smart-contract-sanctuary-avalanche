...
contract FeeManagementMultiSig is FeeManagementMultiSigInterface {
        ...
        onlyUnfreezedFeeManagement
    {
        ...
        _whitelistManagerProposals[
            ...
            ID: _feeManagementProposalIndex,
            PROPOSALNAME: string.concat("UPDATE ", exemptionCategory_, " WHITELIST"),
            PROPOSER: msg.sender,
    ...
    // only unfreezed fee management
    function _onlyUnfreezedFeeManagement() internal view returns(bool) {
        // return fee management freeze status
        return AdminMultiSigInterface(_AdminMultiSigContractAddress).getFeeManagementFreezeStatus();
    }
}