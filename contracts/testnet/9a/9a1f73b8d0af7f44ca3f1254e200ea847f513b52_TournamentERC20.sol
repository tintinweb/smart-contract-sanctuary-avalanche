...
contract TournamentERC20 is Ownable, ITournament {
    ...
    function buy() external payable {
        ...
        if (SIDEPOTSHARE >  0) {
            rewardToken.transferFrom(msg.sender, address(SIDEPOT), ticketPrice * (SIDEPOTSHARE / 10000));
            
        }
         if (TEAM_SHARE >  0) {
            rewardToken.transferFrom(msg.sender, address(teamaddress), ticketPrice * (TEAM_SHARE / 10000));
