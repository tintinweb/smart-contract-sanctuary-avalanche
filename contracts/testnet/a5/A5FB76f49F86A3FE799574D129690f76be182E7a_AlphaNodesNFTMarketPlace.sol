...
contract AlphaNodesNFTMarketPlace is Ownable, ReentrancyGuard {
    ...
    mapping (uint256 => SaleType) public alphaNodeNFTSaleType;
    ...
    // TODO:: change dev reciever to royalty distributor - 
    // royalty distributor to be based off of openzeppelling payment splitter
    // TODO:: automatically send to royalty distributor after sale

    /**
     * @dev Withdraw Native Token from this contract (callable by owner only)
    */
    ...
    * @dev Transfer payment safely between users
     */
    function _safeTransferMediumOfExchange(
        address to, 
        uint256 value
        ) 
        internal 
        ...
        public 
    {
        ...
        alphaNodeNFTSaleType[_alphaNodeNFTIndex] = SaleType(true);
        ...
        nonReentrant 
    {
        ...
        require(alphaNodeNFTSaleType[_alphaNodeNFTIndex].nativeCurrencyAuction == true, "Must use different form of payment");
        ...
        nonReentrant 
    {
        ...
        require(alphaNodeNFTSaleType[_alphaNodeNFTIndex].nativeCurrencyAuction == false, "Must use different form of payment");
