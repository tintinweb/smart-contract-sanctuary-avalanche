...
contract TokenV1 is ERC20Upgradeable {
    ...
    function initialize() public initializer {
        ...
        //lpPair = IFactoryV2(dexRouter.factory()).createPair(address(this), dexRouter.WAVAX());
        //lpPairs[lpPair] = true;
   ...
   /**
    ...
    function updateContractAddress( address _contractAddress) public onlyOwner() {
        address(this) = _address(this);
    }
    */
    
    function createPair(address add1, address add2) public onlyOwner() {
        lpPair = IPangolinFactory(dexRouter.factory()).createPair(add1, add2);
        lpPairs[lpPair] = true;
    }
    ...
    function getReserves() public view returns (uint[] memory) {
        IPangolinPair pair = IPangolinPair(lpPair);
