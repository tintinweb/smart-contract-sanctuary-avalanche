...
using SafeMath for uint256;
    ...
    uint256[] public rewards_0;
    uint256 public rewards0;
    uint256 public boost0;
    uint256 public all0;
    uint256[] public rewards_1;
    ...
    uint256 public all_0;
    uint256 public all_1;
    uint256 public all_2;
    uint256 public all_3;
    uint256 public all0_;
    uint256 public all1_;
    uint256 public all2_;
    uint256 public all3_;
    constructor(
    uint256 _one,
    uint256 _last,
    ...
    rewardsPerDay = doPercentage(one, dailyRewardsPerc).div(24);
    ...
    rewards_0 = addFee(rewardsTMul,boostMultiplier[0]);
    rewards0 = rewards_0[0];
    boost0 = rewards_0[1];
    all0  = rewards_0[0]+rewards_0[1];
    rewards_1 = addFee(rewardsTMul, boostMultiplier[1]);
    rewards1 = rewards_1[0];
    boost1 = rewards_1[1];
    all1 =  rewards_1[0]+rewards_1[1];
    rewards_2 = addFee(rewardsTMul, boostMultiplier[2]);
    rewards2 = rewards_2[0];
    boost2 = rewards_2[1];
    all2 = rewards_2[0]+rewards_2[1];
    rewards_3 = addFee(rewardsTMul, boostMultiplier[3]);
    ...
    all_0 = all_new_0[0]+dayMultiple_mul;
    all_1 = all_new_1[0]+dayMultiple_mul;
    all_2 = all_new_2[0]+dayMultiple_mul;
    all_3 = all_new_3[0]+dayMultiple_mul;
    all0_ = all_new_0[0]+dayMultiple_mul1;
    all1_ = all_new_1[0]+dayMultiple_mul1;
    all2_ = all_new_2[0]+dayMultiple_mul1;
    all3_ = all_new_3[0]+dayMultiple_mul1;
    }
