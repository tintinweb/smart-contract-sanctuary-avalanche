...
contract ultra_beta is ERC20, Ownable, PaymentSplitter {
        ...
        PaymentSplitter(payees, shares)
    {
        ...
        emit Transfer(address(0), address(this), uint256(2100000)*(10**18));
    }
    function checkTier(address sendit) public view returns(uint){
