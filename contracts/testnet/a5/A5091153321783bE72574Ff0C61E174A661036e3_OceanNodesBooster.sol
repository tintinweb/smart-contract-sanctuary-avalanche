...
contract OceanNodesBooster is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Ocean Nodes Booster", "ONB") {
    setHiddenMetadataUri("ipfs://QmQNfKUzf5JkdfPFb2Jq75yJJXnLKGNoznjXgeT4fj9cPS/_metadata.json");
  }
