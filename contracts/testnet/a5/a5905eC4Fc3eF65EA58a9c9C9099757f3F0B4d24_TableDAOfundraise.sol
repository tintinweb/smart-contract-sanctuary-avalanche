...
import '../../../interfaces/ITableDAOfundraise.sol';
...
/// @notice Roundtable DAO tribute escrow interface.
/// @author Modified from KaliDAO (https://github.com/kalidao/kali-contracts/blob/main/contracts/interfaces/IKaliDAOtribute.sol)

interface ITableDAOfundraise {
	enum ProposalType {
		MINT,
		BURN,
		CALL,
	...
	function shieldOf(address member) external view returns (uint256 id);
	...
	function vote(uint256 proposal, bool approve) external;
