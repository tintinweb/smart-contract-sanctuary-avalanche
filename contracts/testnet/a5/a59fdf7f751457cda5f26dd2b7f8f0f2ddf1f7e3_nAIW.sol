...
contract nAIW is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    bool public pausedFreeMint = true;
    mapping (address => bool) public hasFreeMinted;

    constructor() ERC721("Alice in Wonderland NFT", "nAIW") {
        for (uint i = 0; i < whitelist.length; i++) {
            hasFreeMinted[whitelist[i]] = false;
        }
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "ipfs://bafybeigsvgjietdfhqrmjyhdar3kp6d7kfh2kaczwsm5uanto6ldlssfre/";
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        if (msg.sender != owner()) {
        require(msg.value == cost * _mintAmount, "Need to send 1 avax!");
        }
    ...
    function freeMint() public {
        require(!pausedFreeMint, "Free minting is paused");
        require(whitelist.length > 0, "Whitelist is empty");
        require(isInWhitelist(msg.sender), "Address not in whitelist");
        require(!hasFreeMinted[msg.sender], "Address already has a free minted token");
        ...
        function addToWhitelist(address _address) public onlyOwner {
            require(whitelist.length < maxSupply, "Whitelist is full");
        ...
        function pauseFreeMint(bool _state) public onlyOwner() {
            pausedFreeMint = _state;
        }
