...
library GasEstimation {
    ...
    function estimateGas(Data memory data) internal view returns (uint256 totalFee, bytes memory adapterParams) {
...
contract PingMock is NonblockingLzApp {
    ...
    function ping(
        ...
        if (defaultAdapterParams) {
            ...
            (totalFee, adapterParams) = GasEstimation.estimateGas(
                GasEstimation.Data(
                    address(lzEndpoint),
                    chainId,
                    _dstChainId,
