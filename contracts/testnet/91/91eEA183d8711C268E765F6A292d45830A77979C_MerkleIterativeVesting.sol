...
// File contracts/MerkleIterativeVesting.sol
...
contract MerkleIterativeVesting is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @notice function is doing a safe transfer and calculate the actual amount,
     * that passed to avoid deflationary tokens errors
     *
     * @param _from - the from address for the transfer
     * @param _to - the recipient of the transfer,
     * @param _amount - amount to transfer
     *
     * @return amount that was sent to contract
     */
    ...
    /**
     * @notice function is calculating user locked rewards
     *
     * @param amountEarned - amount that user unlocked
     * @param user - address of user
     *
     * @return totalLeftLockedForUser,claimAmountFromLocked
     * and burnAmount
     */
    function _getParams(
        ...
        returns(uint256, uint256, uint256)
    {
        ...
        return(totalLeftLockedForUser, claimAmountFromLocked, burnAmount);
    }
     ...
     *
     * @return claimable percent based on start time
     */
     ...
     * @param user - address of user
     * @param amount - amount of user
     * @param frontEnd - flag who is calling
     *
        ...
        )
    {
        ...
        if(_vestingHasStarted()){
            (amountEarned, nPortionsVested) = _withdrawCalculation(
                user,
                amount,
                frontEnd
            );
    ...
    /**
     * @notice function is checking if there is enough funds to pay user
     *
     * @param amount - that needs to be paid
     *
     * @return bool if we have enough to pay
     */
        ...
        nonReentrant
    {
        ...
        (
            ...
            burnAmount,
            nPortionsVested
        ) = getInfoOfUser(address(msg.sender), _amount, false);
