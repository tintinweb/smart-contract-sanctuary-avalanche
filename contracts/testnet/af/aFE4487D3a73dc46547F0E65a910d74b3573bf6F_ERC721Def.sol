...
contract ERC721Def is ERC721, ERC721Enumerable, Ownable {
     ...
     * @dev Mint batch
     */
    function mintBatch(address to_, uint256 startTokenId, uint256 endTokenId) public virtual onlyOwner {
        require(endTokenId >= startTokenId, "End token ID should be higher than start");
