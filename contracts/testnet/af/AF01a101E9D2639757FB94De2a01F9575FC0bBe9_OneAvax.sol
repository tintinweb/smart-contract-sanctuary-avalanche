...
contract OneAvax is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("</a><b>One Avax<b><a>", "ONE") {
    ...
    function purchase(uint256 amount) external payable {
        ...
        // require(totalSupply() + amount <= _maxSupply, "Purchase: Max supply reached");

        uint256 total_cost = _mintPrice * amount;
        require(msg.value >= total_cost, "Purchase: Incorrect payment");
    ...
    function getSvg(uint256 tokenId) private view returns (string memory) {
        ...
        svg = string(
            abi.encodePacked(
                '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" hheight="800px" width="800px">',
                "<style>",
                string(
                    Base64.decode(
                        "c3Zne2ZvbnQtZmFtaWx5OlJ1c3NvIE9uZSxzYW5zLXNlcmlmO3dpZHRoOjgwMHB4O2hlaWdodDo4MDBweDtjb2xvcjojZmZmfXRleHR7ZmlsbDojZmZmO2ZvbnQtc2l6ZToyMHB4fXN2ZyBkaXZ7Y29sb3I6I2ZmZjtmb250LXNpemU6OTBweH1mb3JlaWduT2JqZWN0e3RyYW5zbGF0ZTp0cmFuc2Zvcm1ZKDUwJSl9Cg=="
                    )
                ),
                "</style>",
                '<rect fill="#222" x="0" y="0" width="100%" height="100%" />',
                '<foreignObject x="100" y="100" width="800" height="800"><div xmlns="http://www.w3.org/1999/xhtml">',
                "1 AVAX",
                "</div></foreignObject>",
                '<text x="100" y="900" >',
