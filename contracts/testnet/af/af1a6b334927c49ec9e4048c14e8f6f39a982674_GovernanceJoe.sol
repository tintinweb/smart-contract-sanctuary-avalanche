...
contract GovernanceJoe {
    ...
    /// @param _veJoeAddress The address of veJOE staking contract
    /// @param _sJoeAddress The address of sJOE staking contract
    constructor(
        address _joeTokenAddress,
        address _veJoeAddress,
        address _sJoeAddress
    ) {
        if (_joeTokenAddress == address(0) || _veJoeAddress == address(0) || _sJoeAddress == address(0))
