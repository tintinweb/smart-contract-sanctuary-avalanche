...
contract prize is ERC721A, ERC721AQueryable, VRF, BatchReveal, Authorizable {
    ...
    constructor(
        ...
        ERC721A(name, symbol)
        VRF(431, uint32(maxMintable / REVEAL_BATCH_SIZE))
    {
    ...
    function mint() public onlyAuthorized {
