...
contract proxyDeployer is Owned {
    ...
    function getCollectionDetails(uint _pid)
        public
        view
        returns (CollectionDetails memory)
    {
        return CollectiondetailList[_pid];
    }
    function getCollectionDatas(address _collectionAddress)
        public
        view
        ...
        address[] memory )
    {
        ...
        return (collectionsList[_collectionAddress].Currency, data, _Address);
    }
