...
contract Minter is Ownable {
    ...
    function approve_auto_allocate_single(address _address) external onlyOwner returns(bool){
        ...
        uint256 _LP_Controller_Value = request.Amount.mul(request.LP_Controller._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _Founding_Team_Value = request.Amount.mul(request.Founding_Team._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_LP_Rewards_Value = request.Amount.mul(request.WACEO_LP_Rewards._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Operational_Value = request.Amount.mul(request.WACEO_Operational._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Dev_Value = request.Amount.mul(request.WACEO_Dev._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Regulations_Value = request.Amount.mul(request.WACEO_Regulations._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Unrekt_Value = request.Amount.mul(request.WACEO_Unrekt._amount).div(1000**IERC20(Waceo).decimals());   
    ...
    function approve_auto_allocate_double(address _address) external onlyOwner returns(bool){
        ...
        uint256 _LP_Controller_Value = _waceoAmount.mul(request.LP_Controller._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _Founding_Team_Value = _waceoAmount.mul(request.Founding_Team._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_LP_Rewards_Value = _waceoAmount.mul(request.WACEO_LP_Rewards._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Operational_Value = _waceoAmount.mul(request.WACEO_Operational._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Dev_Value = _waceoAmount.mul(request.WACEO_Dev._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Regulations_Value = _waceoAmount.mul(request.WACEO_Regulations._amount).div(1000**IERC20(Waceo).decimals());  
        uint256 _WACEO_Unrekt_Value = _waceoAmount.mul(request.WACEO_Unrekt._amount).div(1000**IERC20(Waceo).decimals());  
