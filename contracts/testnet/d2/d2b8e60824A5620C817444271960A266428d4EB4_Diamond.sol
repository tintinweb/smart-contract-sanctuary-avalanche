...
/**
 * @notice This contract is based on the diamond-3-hardhat original contract with the constructor from hardhat-deploy's version.
 */
contract Diamond {
    ...
    receive() external payable {
        ...
        // get facet from function selector
        address facet = ds
            .selectorToFacetAndPosition[bytes4(keccak256("receiveFallback()"))]
            .facetAddress;
        require(facet != address(0), "Diamond: receive fallback not defined");
