...
/// @title Distribution contract for Avat token
contract DistributionV2 is OwnableUpgradeable, PausableUpgradeable {
    using SafeMath for uint256;
    using SafeERC20Upgradeable for IMintableOwnableERC20;

    // address of the ERC20 token
    IMintableOwnableERC20 private _token;
    ...
    */
    ...
    /**
    * @notice Transfer the erc20 token owner to another address. BE CAREFUL, the contract will lose the ability to mint tokens
    * @param owner_ New owner address
    */
    function transferTokenOwnership(address owner_) external onlyOwner {
        _token.transferOwnership(owner_);
    }

    /**
    * @notice Function to set admin contract by owner
    * @param admin_ Address admin contract
    */
