...
contract PoolService is Ownable {
    ...
    event SwapTokensForExactTokens(address indexed sender, uint256 amountOut, uint256 amountInMax, address[] path, uint256 deadline, string router, uint256 amountFact);
    event SwapExactTokensForTokens(address indexed sender, uint256 amountIn, uint256 amountOutMin, address[] path, uint256 deadline, string router, uint256 amountFact);
    ...
    function _swap(
        ...
        if (exactTokensForTokens) {
            ...
            emit SwapTokensForExactTokens(msg.sender, amountOut, amountIn, path, deadline, router, amountOutGot);
        }
    }
