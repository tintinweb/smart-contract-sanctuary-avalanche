...
abstract contract Tokenomics is IERC20, IERC20Metadata {
    ...
    string internal constant SYMBOL = "KENA.7"; // CHANGE ME
...
abstract contract VerifiedAccount is NetworkFee {
    ...
    function transfer(address to, uint256 value) public virtual override onlyExistingAccount(to) returns (bool ok) {
        super.transfer(to, value);
        return true;
    }

    function approve(address spender, uint256 value) public virtual override onlyExistingAccount(spender) returns (bool ok) {
        super.approve(spender, value);
        return true;
    }

    function transferFrom(address from, address to, uint256 value) virtual public override onlyExistingAccount(to) returns (bool ok) {
