...
contract Adventure is Ownable, Pausable {
    ...
    struct mapTraits {
        ...
        uint   entryPrize;      // ➡️ Prize to pay to enter                              Example (10000 $SCRAP/0.2 $AVAX)
        uint   baseReward;      // ➡️ How much reward rewards does it return             Example (4000 $SCRAP)
    ...
    function toolMap (
        ...
        uint   _entryPrize,     // If this parameter > 0, we are paying, but how much?
        uint   _baseReward      // Whats the reward without perk or rarity multipliers amount?
