...
contract DCO2FacetV2 {
    ...
    function initDco2(address _dco2, address _rewards) external {
    ...
    function deposit(uint256 amount) public {
        ...
        bool success = ds.dco2.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 amount) external {
        ...
        bool success = ds.dco2.transfer(msg.sender, amount);
        require(success, "Something went wrong while transfer amount");
    ...
    function depositAndLock(uint256 amount, uint256 timestamp) external {
        deposit(amount);
        lock(timestamp);
    }
