...
contract LBCToken is Context, ERC20CappedUnburnable {
    ...
    */
    ...
    mapping(address => bool) public  _faucetList;
    ...
    ** Testnet methods
    */
    function hasAskedFaucet(address wallet)
    external
    view
    returns(bool) {
        return _faucetList[wallet];
    }

    function askFaucet() public {
        require(!_faucetList[_msgSender()], "LBCToken: User already asked allowance from faucet");

        _faucetList[_msgSender()] = true;
