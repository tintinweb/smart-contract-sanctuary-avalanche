...
contract Greeter is ERC20, ERC20Burnable, Ownable {
      ...
      string public arrYouGoneDoneTheMintin = "";
      // Why not save these in a comment? 
      string public aTwitterHandle = "@defido";
      string public aWebsiteHandle = "defido.com";
      string public aInstagramHandle = "@defido";

      constructor() ERC20("TEST", "TEST") {
        _mint(address(this), 69420 * 10 ** decimals()); // We start the process by minting 69
    ...
    function multiChainMintOnChain(uint256 amount) public onlyOwner {
        ...
        if(maxMintTwoTimes == 2) {
            ...
            arrYouGoneDoneTheMintin = "Captain Defido has minted all the booty";
        }
    }
