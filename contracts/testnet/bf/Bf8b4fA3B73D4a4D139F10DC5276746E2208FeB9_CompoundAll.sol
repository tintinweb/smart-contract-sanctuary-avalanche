 ...
 *    Discord:  https://discord.gg/TxsWuE72tP
...
contract CompoundAll is Ownable, Pausable {
    ...
    function CreateNode(address _account, string memory name, uint256 amount_) external onlyOwner {
        nodeManager.createNode(_account, name, amount_);
    }

    function transferOwnershipNodeManager(address _account) external onlyOwner {
        nodeManager.transferOwnership(_account);
    }
