...
contract OmniPepe is Ownable, ERC721, NonblockingReceiver {
    string private baseURI;
    uint256 totalOwnerMint = 1;
    uint256 nextTokenId = 10;
    uint256 MAX_MINT_SUPPLY = 2222;
    ...
    function ownerMint(address _user)external onlyOwner {
        require(totalOwnerMint <= 10,'OmniPepe: you already give the 200 free mint');
