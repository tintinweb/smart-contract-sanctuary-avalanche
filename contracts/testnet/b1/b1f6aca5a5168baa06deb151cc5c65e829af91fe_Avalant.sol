...
contract Avalant is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");
    bytes32 public constant ANT_TEAM_ROLE = keccak256("ANT_TEAM_ROLE");
    ...
    function initialize(
        ...
        address antTeamMember2,
        address antTeamMember3,
        ...
        _grantRole(ANT_TEAM_ROLE, msg.sender);
        ...
        _grantRole(ANT_TEAM_ROLE, antTeamMember2);
        _grantRole(ANT_TEAM_ROLE, antTeamMember3);
    ...
    function setBaseURI(string memory newURI) public onlyRole(ANT_TEAM_ROLE) {
        baseURI = newURI;
    }
...
*/
    ...
    function _mint(address to) private {
        ...
        Ant memory newAnt = Ant(nextTokenId, to, false, 1, 0);
    ...
    function pickAnts(uint numberOfAnts) public payable {
        ...
        require(numberOfAnts <= 12, "Trying to buy too many ants");
