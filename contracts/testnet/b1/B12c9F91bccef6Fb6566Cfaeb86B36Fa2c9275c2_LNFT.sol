...
contract LNFT is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    uint256 public constant tokensLimit = 20;

    uint256 private constant _itemPrice = 0.0003 ether;
    ...
    constructor(address riAddress_) ERC721("LNFT V1", "$LNFT V1")
    {
