    ...
    ERC2981Upgradeable
{
    ...
    function seedAllowlist(
        ...
        console.log(
            "%s %s",
            stampAllowlist[_addresses[0]].at(0),
            stampAllowlist[_addresses[0]].at(1)
        );
        console.log(
            "%s %s %s",
            stampAllowlist[_addresses[0]].at(2),
            stampAllowlist[_addresses[0]].at(3),
            stampAllowlist[_addresses[0]].at(4)
        );
    ...
    function burn(uint256 _id, uint256 _amount) external {
        ...
        if (balanceOf(_msgSender(), uint8(_id)) < _amount) {
            revert Launchpeg__AmountExceedsBalance(
                balanceOf(_msgSender(), uint8(_id))
            );
        }
