...
contract NodeManagerV4 is Initializable {
    ...
    function initialize(address[] memory addresses) public initializer {
        ...
        addTier("basic", 10 ether, 0.17 ether, 60, 0.001 ether);
    ...
    function claim() public {
        ...
        if (claimFee > 0) {
            ...
            uint256 feeAmount = (oldRewardsOfUser[msg.sender] * claimFee) / 10000;
        ...
        IERC20(tokenAddress).transferFrom(address(rewardsPoolAddress), address(msg.sender), oldRewardsOfUser[msg.sender]);
            ...
            for (uint32 i = 0; i < nodeIndice.length; i++) {
                ...
                if (nodeIndex > 0) {
                    ...
                    if (node.owner == msg.sender) {
                        ...
                        fee += getAmountOut(((tier.price * 3000) / 10000) * count);
                    }
                }
            }
        } else {
    ...
    function migrateRewardsFromOldVersion() public {
        ...
        require(!rewardMigrated[msg.sender], "Wallet reward have been migrated");
