...
contract WinePress is Ownable {
    ...
    // Partnership Wallet
    address public partnerAddress = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    function adminShares(address user, uint256 share, uint256 previousBalance, uint256 feesTaken) external onlyOwner {
