...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function __ERC20_init_unchained(string memory name_, string memory symbol_) internal onlyInitializing {
        ...
        // --------------------------------------------------------------------------------------------------
        address router = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921;
        sellFeeRate = 5;
        buyFeeRate = 2;
        blacklistDuration = 10 minutes;
        blacklistEnabled = false;
        blacklistAmount = 10000000000000 ether;
...
// File: contract-690f12aebd.sol

// contract MyToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable {

contract MyTokenUpgradable is Initializable, ERC20Upgradeable {
    using SafeMath for uint256;
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() initializer {}
