...
contract Factory {
    ...
    mapping(address => bool) public _addressStates;
    ...
    function createForwarder(address payable _treasuryAddr) external ownerOnly returns (address) {

        Forwarder forwarder = new Forwarder(_treasuryAddr);
