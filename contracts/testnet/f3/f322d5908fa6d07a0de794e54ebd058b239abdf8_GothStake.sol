...
contract GothStake is ERC20("GOTH Bits", "bGOTH"), Ownable, ReentrancyGuard {
    ...
    // Minting
    uint256 public mintRateConstant = 317097919837640000000;
    uint256 public startTimeStamp;
    uint256 public lastMintTimeStamp;
    uint256 public decayRate = 31705770450;
    ...
    function calculateMintRate () internal
    {
        uint256 secondsElapsed = block.timestamp.sub(startTimeStamp);      
        mintRate = mintRateConstant.sub(decayRate.mul(secondsElapsed));
    }
