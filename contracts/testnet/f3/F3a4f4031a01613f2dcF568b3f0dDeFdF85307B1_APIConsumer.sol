...
contract APIConsumer is ChainlinkClient, ConfirmedOwner {
    ...
    function requestPrice() public returns (bytes32 requestId) {
        ...
        req.add('get', 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH&tsyms=USD,EUR');
        ...
        req.add('path', 'ETH,USD'); // Chainlink nodes 1.0.0 and later support this format
