...
contract Fund is IFund, AgentRole, Initializable, FundStorage {
    ...
    function shareDividend(address[] calldata _address, uint256[] calldata _dividend, address _from, uint8[] calldata _key) public onlyAgent{
    ...
    function distributeAndBurn(address[] calldata _investors, uint256[] calldata _amount, uint256[] calldata _tokens) public onlyAgent{
        ...
        for(uint i = 0; i < _investors.length; i++){
            ...
            TransferHelper.safeTransfer(stableCoin, _investors[i], _amount[i]);
        }
    }
