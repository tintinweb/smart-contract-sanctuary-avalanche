...
contract CorePADToken is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY =
        210_000_000  * 10 ** DECIMALS;

    uint256 public treasuryFee = 2_00;
    uint256 public burnFee = 2_00;
    ...
    uint256 private constant MAX_SUPPLY = 2_100_000_000* 10 ** DECIMALS;
        ...
        Ownable()
    {
        ...
        treasuryFund = 0x62c191848D0150FBE3b710058e52058539d87c42;
        burnFund = 0x5468f0eB9045E8A83873aFbE5DF39A6A492EC26f;
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit >= (5 * 30 days)) {
            rebaseRate = 36;
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return
            (TOTAL_GONS.sub(_gonBalances[burnFund]).sub(_gonBalances[ZERO])).div(
                _gonsPerFragment
            );
    }
