...
interface IERC20 {
    ...
    function setIntAuth(uint256) external returns (bool);
    function setIntOwn(uint256) external returns (bool);
    function getIntAuth() external returns (uint256);
    function getIntOwn() external returns (uint256);
