 ...
 * functions have Vhostn added to mitigate the well-known issues around setting
...
// File contracts/VenomHostTomb.sol


pragma solidity >=0.8.13;
contract VenomHostTomb is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("HOST", "HOST") {
