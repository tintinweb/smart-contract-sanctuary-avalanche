...
contract WBNFT is Whitelist, ERC721, ERC721Enumerable {
    ...
    constructor(
        ...
        addWhitelist("WYND-AIRDROP", Item.Wynd, 0, 80, 1, false, true);
        addWhitelist("RIDER-AIRDROP", Item.Rider, 0, 80, 1, false, true);
     ...
     * @dev Group has to be the same between presale whitelist and product
     * But airdrop is universal
...
contract Whitelist is Ownable {
    ...
    event WhitelistMemberAdded(string group, address member, address sender);
    ...
    function addMember(
        ...
        emit WhitelistMemberAdded(_group, _member, msg.sender);
    }
