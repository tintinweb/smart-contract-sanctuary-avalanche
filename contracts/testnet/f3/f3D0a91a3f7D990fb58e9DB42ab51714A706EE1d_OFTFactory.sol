...
contract OFTFactory {
    ...
    function createOFT(
        ...
        require(_totalSupply > 0 && _decimals > 0);

        new OFT(_name, _symbol, _decimals, lzEndpoint, msg.sender, _totalSupply);
    }
...
contract OFTV2 is OFTWithFee {
    ...
    uint8 internal _sharedDecimals;
    ...
    constructor(
        ...
        _sharedDecimals = _decimals > 10 ? 6 : _decimals;
        require(_sharedDecimals <= _decimals);
...
abstract contract Fee is Ownable {
    ...
    constructor() {
        setProtocolFeeBp(50);
        treasury = address(0xdead); // TODO: (Must) Set to real Treasury before Mainnet deployment
        treasuryManager = address(0xdead); // TODO: (Must) Set to real Treasury Manager
    }
