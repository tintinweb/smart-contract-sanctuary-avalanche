    ...
    AccessControlUpgradeable
{
    ...
    function getTotalDays(
		...
		/**
			...
			*/
		function getPaidDays(uint256 _tokenId) public view returns (uint256 paidDays) {
    ...
    function setValue(uint256 _value) external onlyOwner {
        ...
        LIMITS_DAYS = _value * 1 days;
        emit SetLimitsDays(oldValue, _value);
    }
        ...
        onlyRole(ROLE_RESET_MAINTENANCE_FEE)
    {
        ...
        if (_yieldKeyType == 12) {
            ...
            for (uint256 i = 0; i < tokenIds.length; i++) {
                ...
                maintFee[tokenIds[i]].lastOwner = _msgSender();
