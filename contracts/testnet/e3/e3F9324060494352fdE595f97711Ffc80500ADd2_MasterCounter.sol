...
contract MasterCounter is ICounterDeployment, ReentrancyGuard {
    ...
    constructor(address _endpoint) {
        emit DebugEvent("Master: constructor() called");
        endpoint = ILayerZeroEndpoint(_endpoint);
        emit DebugEvent("Master: constructor() complete");
    }
    ...
    function updateCount(
        ...
        emit DebugEvent("Master: updateCount() called");
        /* switch (Operation) */
        if (/* case: */ Operation.ADD == _op)
        {
            counter[_satelliteCounterAddress] += _value;
            emit DebugEvent("Master: added value");
        }
        else if (/* case: */ Operation.SUB == _op)
        {
            counter[_satelliteCounterAddress] -= _value;
            emit DebugEvent("Master: subtracted value");
        }
        else if (/* case: */ Operation.MUL == _op)
        {
            counter[_satelliteCounterAddress] *= _value;
            emit DebugEvent("Master: multiplied value");
        }
        else /* default: */
        {
            emit DebugEvent("Master: invalid operation");
            require(false, "invalid operation");
        }
        emit DebugEvent("Master: updateCount() complete");
    }
    ...
    function getCount(
        ...
        emit DebugEvent("Master: getCount() called");
        count = counter[_satelliteCounterAddress];
        emit DebugEvent("Master: getCount() complete");
    }
    ...
    function send(
        ...
        emit DebugEvent("Master: send() called");
        ...
        emit DebugEvent("Master: send() complete");
    }
    ...
    function lzReceive(
        ...
        {
            emit DebugEvent("Master: invalid sending function");
            require(false, "invalid sending function");
        }
        emit DebugEvent("Master: lzRecieve() complete");
    }
