...
contract TroveManagerLiquidations is TroveManagerBase, ITroveManagerLiquidations {
    ...
    */
    ...
    /**
        @notice Update rewards tracking so future rewards go to Yeti Finance Treasury
        for the trove's asset that have been liquidated and moved to either the Stability Pool or Default Pool
     */
    ...
    returns (bool)
    {
        uint TCR = _computeCR(_entireSystemColl, _entireSystemDebt);
