...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function updateUSSTOAddress(address _USSTO) internal returns (bool) {
      ...
      /**   
     Set Fee details in STO 
     */
//     function setFeeDetailOnSTO(address feeAddress, uint256 feePercent,bool feeStatus) public onlyAdmin{
//         require(feeAddress != _feeAddress, "address already exist");
//         require(feePercent > 0 && feePercent < 100,"fee percent should be be b/w 1 and 100");
//         require(feeStatus,"feeStatus already set");
//         _feeAddress = feeAddress;
//         _feePercent = feePercent;
//         _feeStatus = feeStatus;
//     }
//    /**   
//     Set Fee Status in STO 
//      */
//     function setFeeStatus(bool feeStatus)public onlyAdmin{
//           _feeStatus = feeStatus;
//     }
}
    ...
    PostGoalCrowdsale
{
        ...
        RefundableCrowdsale(__goal)
    {
        ...
        //require(__rate == 1000 ether, "STO2");
        require(
