...
contract CyberGods_Game is Ownable, Pausable {
    ...
    mapping(uint256 => uint256) public playersInTiers; // mapping of player count per tier
    ...
    uint256 public aresBloodBoost = 2; // The boost provided to each Demi Gods by Ades Blood upgrade
    ...
    function _recruitWarriors(
        ...
        bool isNewPlayer = players[_toPlayer].attackUnlocksTime == 0;
