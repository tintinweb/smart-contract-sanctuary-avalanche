...
contract BERRY_CLUB is Ownable,SignVerify,ERC721Enumerable{
    ...
    uint256 priceDecrementTime = 45 seconds;
    ...
    uint256[30] private _firstCollection;
    uint256[40] private _secondCollection;
    ...
    */
    function dutchMint(uint256 _count) public
    {
        // address user = msg.sender;
        // require(
   ...
   */
    ...
    */
    ...
    function setCollectionData() internal {
        ...
        collection[1].collectionSupply = 30;
        collection[1].availableTokens = 30;   //  free

        collection[2].collectionSupply = 40;
        collection[2].availableTokens = 40;   //  Dutuch
