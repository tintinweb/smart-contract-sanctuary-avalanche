...
contract TreasuryContract is Initializable, ReentrancyGuardUpgradeable {
        ...
        nonReentrant
    {
        ...
        emit LogLockToken(msg.sender, token, amount);
    }
        ...
        nonReentrant
    {
        ...
        emit LogLockNft(msg.sender, collection, tokenId);
    }
