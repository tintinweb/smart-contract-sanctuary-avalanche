...
contract myntaconNFT is Ownable, ERC721Enumerable {
    ...
    constructor(string memory baseURI_) ERC721("Myntacon", "MYNT") { 
        baseURI = baseURI_;
    }
    receive() external payable {}
    function mint(uint256 numTokens) public payable{
        require(!paused , "Mint proccess now not avaliable. Try again later. Error #1");
        require(numTokens >= 1 , "Amount Errror #344");
        require(msg.value >= mintPrice * numTokens , "Mint price error #12");
