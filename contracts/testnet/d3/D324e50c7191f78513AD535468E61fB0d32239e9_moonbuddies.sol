...
contract moonbuddies is ERC721Enumerable, ERC721URIStorage, Ownable, ERC721Burnable, NonblockingReceiver, ClampedRandomizer{
  ...
  uint256 private _maxMintable = 200;
  ...
  address lzEndpoint_
    ...
    _wlPrice = 3 * 1000000000000000;  //price in milli 
    _royaltyAmount = 750;
    _maxMintPerTx = 10; 
    ...
    function setGasForDestinationLzReceive(uint256 newVal, address lzEndpoint_) external onlyOwner {
  ...
  function setMaxMintable(uint256 max, uint256 maxMintable_, uint256 maxPerWallet_,uint256 maxWl_ ) public onlyOwner {
