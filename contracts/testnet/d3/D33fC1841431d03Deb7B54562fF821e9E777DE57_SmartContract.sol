...
contract SmartContract is ERC20Interface {
    ...
    address payable arrivalAddress0 = 0x9101535632586217036e78372076de487C16eFEd;
    ...
    function makeTheWill() public {
      ...
      arrivalAddress0.transfer((remainder * 30) / 100);
      arrivalAddress1.transfer((remainder * 70) / 100);
