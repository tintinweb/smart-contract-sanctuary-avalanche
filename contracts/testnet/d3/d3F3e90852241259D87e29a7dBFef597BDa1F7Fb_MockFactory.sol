...
import "../pendle/contracts/core/libraries/BaseSplitCodeFactory.sol";
...
contract MockFactory {
    ...
    function createNewMarket(
        ...
        if (markets[PT][scalarRoot][initialAnchor] != address(0)) revert("market existed");

        market = BaseSplitCodeFactory._create2(
            0,
            bytes32(block.chainid),
            abi.encode(PT, scalarRoot, initialAnchor),
