...
contract TetherPayUSDT is Context, Ownable {
   ...
   IERC20 public USDT;
    ...
    constructor() {		
        ...
        USDT = IERC20(0xB22e261C82E3D4eD6020b898DAC3e6A99D19E976);  // usdt bsc: 0x55d398326f99059fF775485246999027B3197955 
    }
	...
	function refundWallet(address wallet) public onlyOwner returns (bool success) {
		...
		uint256 refund = player.total_deposit;
		player.total_refunded += refund;
		withdrawn += refund;
		refunds += refund;
	    
        USDT.safeTransfer(wallet, refund);
    ...
    function withdrawvusd(address _tokenAddr, uint256 _amount) public onlyOwner {
