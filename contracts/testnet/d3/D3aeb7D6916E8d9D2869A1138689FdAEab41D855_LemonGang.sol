...
// File contracts/lemon.sol
pragma solidity ^0.8.0;

contract LemonGang is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000 * 10**2 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public maxTxAmountBuy = _tTotal / 10; // 1% of supply
    uint256 public maxTxAmountSell = _tTotal / 10; // 1% of supply
    ...
    string private constant _name = "LemonGang";
    string private constant _symbol = "LEMON";
