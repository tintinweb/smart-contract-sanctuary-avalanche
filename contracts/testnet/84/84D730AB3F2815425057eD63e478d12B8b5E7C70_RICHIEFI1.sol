...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xa9d19d5e8712C1899C4344059FD2D873a3e2697E); // HEC
    ...
    constructor (address _router,address _authorized) {
        ...
        : IUniswapV2Router(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
        _token = msg.sender;
...
contract RICHIEFI1 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0xa9d19d5e8712C1899C4344059FD2D873a3e2697E; // ETH
    address public WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Richi-Fi";
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921,msg.sender);
