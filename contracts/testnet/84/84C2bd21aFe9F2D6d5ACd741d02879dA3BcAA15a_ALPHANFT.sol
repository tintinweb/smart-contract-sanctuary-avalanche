    ...
    AuthContract 
{
    ...
    ) ERC721("ALPHANodeNFT", "ALPHANODE") {
        powerManager = msg.sender;
        tokenMinter = msg.sender;
        _marketplaceAddress = msg.sender; // marketplaceAddress;
    ...
    * Token Minting.
    ...
    function createToken(
        ...
        _safeMint(nodeCreator, newItemId); 

        // TODO:: handle node type --- is this needed?
        alphaNodes[newItemId] = NodeAttributes({
            name: "",
...
contract AlphaNFTAttributeManagement is AlphaNFTAuthorizations {
    ...
    mapping(uint256 => NodeAttributes) public alphaNodes;
    ...
    *  Add, edit, remove Vanity attributes by token id
     */
    function toggleVanityStringAttribute(
        uint256 tokenId, 
    ...
    * Vanity Numeric Attributes Management
     */
    function toggleVanityNumericAttribute(
        uint256 tokenId, 
        string memory attributeName, 
        bool enabled
        ) 
    ...
    *  Add, edit, remove Game attributes by token id
     */
    function toggleGameStringAttribute(
        uint256 tokenId, 
        string memory attributeName, 
        bool enabled
        ) 
    ...
    * Game Numeric Attributes Management
     */
    function toggleGameNumericAttribute(
        uint256 tokenId, 
        string memory attributeName, 
        bool enabled
        ) 
