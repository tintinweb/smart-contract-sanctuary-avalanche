...
contract AvatarNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _baseUri, address _randomizer, uint256 _price) ERC721("AVATAR-BKWZ", "AVATAR") {
        baseUri = _baseUri;
    ...
    function mintAvatar(uint16 amount) external payable {
