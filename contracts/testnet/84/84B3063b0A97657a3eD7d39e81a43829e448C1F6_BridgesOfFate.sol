...
contract BridgesOfFate is Ownable {
    ...
    */
    ...
    function _overFlow(bytes32 _playerId,bool _jumpSide) public view returns(uint256,bool)  {
        GameStatus memory  _gameStatus = GameStatusInitialized[latestGameId];        
        ...
        // }
        return (totalNFTOnTitle[_gameStatus.stageNumber][_jumpSide],OverFlowPlayerStatus[_playerId]);
    }
