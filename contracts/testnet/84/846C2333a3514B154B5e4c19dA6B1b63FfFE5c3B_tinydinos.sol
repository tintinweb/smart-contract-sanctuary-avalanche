...
contract tinydinos is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint, uint _cost)
    ...
    function mint(uint8 quantity) external payable {
        require(quantity <= maxMintperWallet, "tiny dinos: You tried to buy too much NFTs");
        require(msg.value >= cost * quantity, "tiny dinos: You need to pay at least cost amount");
        require(
