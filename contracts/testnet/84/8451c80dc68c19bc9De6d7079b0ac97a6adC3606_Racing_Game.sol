...
contract Racing_Game is Ownable {
    ...
    mapping(uint256 => mapping(address => uint256)) booster1Usage;
    mapping(uint256 => mapping(address => uint256)) booster2Usage;
    ...
    uint256 constant booster1From = 10001;
    uint256 constant booster1To = 10500;
    uint8 constant booster1Cooldown = 2;

    uint256 constant booster2From = 11001;
    uint256 constant booster2To = 11200;
    uint8 constant booster2Cooldown = 3;
