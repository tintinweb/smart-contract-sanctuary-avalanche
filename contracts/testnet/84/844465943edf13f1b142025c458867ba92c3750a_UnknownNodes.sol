...
contract UnknownNodes is ERC20, Ownable, PaymentSplitter {
    ...
    function GiftNode(address account,string memory name) external onlyOwner {
         require(
        ...
        require(
            account != teamPool && account != rewardsPool,
            "NC:4"
        );
        nodeManager.giftNode(account, name);
    }    
