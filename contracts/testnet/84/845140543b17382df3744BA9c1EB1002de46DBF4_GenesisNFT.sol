...
contract GenesisNFT is ERC721Burnable, ERC721Rentable, ERC721URIStorage, ERC721Permit, IGenesisNFT, Creator, NonFungibleType, Withdrawable, ReentrancyGuard {
    ...
    function buyNFT(uint256 typeNFT_, uint256 quantity_) external payable override nonReentrant {
        ...
        if (typeInfo.paymentToken == address(0)) {
            ...
            __transfer(address(0), owner, total);
        } else {
            __transferFrom(typeInfo.paymentToken, account, owner, total);
        }
