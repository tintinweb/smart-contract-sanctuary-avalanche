...
// File: contracts/timelock25422.sol
...
contract TimeLockedWallet {
    ...
    function setCreator(address _creator) onlyOwner public {
        creator = _creator;
    }
    ...
    function info(address _tokenContract) public view returns(address, address, uint256, uint256, uint256) {
        ERC20 token = ERC20(_tokenContract);
        return (creator, owner, unlockDate, createdAt, token.balanceOf(address(this)));
    }
