...
contract Nomics is ERC20 {
    ...
    constructor(address _NORO, address _sNORO, address _staking)
        ERC20("Nomics", "NOMICS", 9)
    {
        NORO = _NORO;
        sNORO = _sNORO;
        staking = _staking;
    ...
    function unstakeTokens(uint256 _amount) internal {
        IERC20(sNORO).approve(staking, _amount);
        IMagStaking(staking).unstake(_amount, true);
    }

    /**
        @notice converts NORO to gNORO
        @param _amount uint
     */
    function deposit(uint256 _amount) public {
        ERC20(NORO).transferFrom(msg.sender, address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        ERC20(NORO).transfer(msg.sender, MagAmount);
    }
