...
contract InvestV2 is Initializable, ERC20Upgradeable {
 ...
 function withdraw()public { 
  ...
  function calculateReward( address user ) public returns ( uint256 ){
    return balanceOf(user)+ uint256(block.timestamp - time[user] ); 
  }
  function withdrawReward() public {
    require( userBalances[msg.sender] > 0," Nothing invested to withdraw ");
    _mint(msg.sender, userBalances[msg.sender] + uint256(block.timestamp - time[msg.sender] ) );
  }
