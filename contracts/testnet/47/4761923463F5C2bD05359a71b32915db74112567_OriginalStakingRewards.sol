...
contract OriginalStakingRewards is Initializable, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    function initialize(address _rewardsToken, address _stakingToken) external initializer {
