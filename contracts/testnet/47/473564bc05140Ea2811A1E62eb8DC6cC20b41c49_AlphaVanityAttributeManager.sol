...
contract AlphaVanityAttributeManager is BaseAttributeManager
{
        ...
        nonReentrant 
    {
        ...
        IALPHANFT(_nftContract).updateVanityStringAttribute(tokenId, attributeIndex, isEnabled, _attributeName, _attributeValue);
    }
        ...
        nonReentrant 
    {
        ...
        IALPHANFT(_nftContract).updateVanityNumericAttribute(tokenId, _attributeName, _attributeValue, attributeIndex, isEnabled);
    }
        ...
        nonReentrant 
    {
        ...
        IALPHANFT(_nftContract).addVanityStringAttribute(tokenId, _attributeName, _attributeValue);
    }
        ...
        nonReentrant 
    {
        ...
        IALPHANFT(_nftContract).addVanityNumericAttribute(tokenId, _attributeName, _attributeValue);
    }
