...
contract ERC20Receiver {
    ...
    function withdrawERC20ToOthers(address tokenAddress, address recipient, uint256 amount) public onlyOwner {
        require(tokenAddress != address(0), "Invalid token address");
    ...
    function withdrawERC20(address _tokenAddr, uint256 _amount) public onlyOwner {
