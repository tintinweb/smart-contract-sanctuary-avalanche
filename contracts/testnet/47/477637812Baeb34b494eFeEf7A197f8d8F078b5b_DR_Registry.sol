...
contract DR_Registry is IDR_Registry, Ownable {
    ...
    event Admin(bool isAdmin, address userAddress);
    event Operator(bool isOperator, address userAddress);
    event Minter(bool isMinter, address userAddress);
