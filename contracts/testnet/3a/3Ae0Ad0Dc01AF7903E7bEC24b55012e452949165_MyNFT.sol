...
contract MyNFT is VRFConsumerBaseV2, ConfirmedOwner, ERC721URIStorage {
    ...
    ) VRFConsumerBaseV2(vrfCoordinatorV2) ConfirmedOwner(msg.sender) ERC721("MyNFT", "NFT") {
    ...
    // function getCardFromRng(uint256 moddedRng) public pure returns ()
