...
contract CommunityIssuance is ICommunityIssuance, Ownable, CheckContract {
    ...
    */
        ...
        override 
    {
        ...
        require(YETIBalance >= YETISupplyCap, "setAddresses: YETIBalance must at least be equal to YETISupplyCap");
    ...
    function _getCumulativeIssuanceFraction() internal view returns (uint) {
        ...
        // f^t
        uint power = YetiMath._decPow(ISSUANCE_FACTOR, timePassedInMinutes);
