...
contract Vasiyet is ERC20Interface {
    ...
    address payable arrivalAddress = 0xe6B8312aC2731d1F606f4d6686aA60Fa0EAffEaf;
    ...
    function addBalance() public onlyOwner {}

    function makeTheWill() public payable {
      ...
      arrivalAddress.transfer(balance);
    }
