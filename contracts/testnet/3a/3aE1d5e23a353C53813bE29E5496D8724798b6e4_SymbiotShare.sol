...
// File contracts/SymbiotShare.sol
...
contract SymbiotShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SYMBIOT", "SYMBIOT") {
        _mint(msg.sender, 1 ether); // mint 1 EVTOMB Share for initial pools deployment
