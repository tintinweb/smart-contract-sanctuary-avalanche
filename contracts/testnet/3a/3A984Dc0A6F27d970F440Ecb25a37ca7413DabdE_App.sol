...
contract App {
    ...
    function buy(uint256 _player) public payable returns (uint256) {
    ...
    function swap(uint256 _player, uint256 _bricks) public returns (uint256) {
    ...
    function sell(uint256 _player, uint256 _coins) public payable returns (uint256) {
    ...
    function transfer(uint256 _player, uint256 _command) public returns (uint256) {
    ...
    function claim(uint256 _player, uint256 _type) public view returns (uint256) {
        if (_type == 1) {
