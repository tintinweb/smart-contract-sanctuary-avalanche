    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() external initializer {
        ...
        pricePerToken = 3049691513752325000;
        paymentAddr = owner();
    }
    ...
    {
        if (msg.sender != owner()) {
            /* makes it admin vulnerable */
            // require(msg.value > 0);
            require(amount * pricePerToken <= msg.value, "insufficient funds");
            require(
                msg.value == getTotalPrice(amount, true),
                "insufficient funds"
            );
            withdraw(msg.value);
        }
