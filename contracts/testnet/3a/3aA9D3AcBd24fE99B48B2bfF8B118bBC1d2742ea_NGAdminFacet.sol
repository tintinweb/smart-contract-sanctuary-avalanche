...
contract NGAdminFacet is WithStorage {
    ...
    function getSaleMode() public view returns (NFTCurrentSales _saleMode) {
    ...
    function setSaleMode(NFTCurrentSales _saleMode) public onlyAdmin {
        ...
        if (gameConstants().NFT_SALE_MODE == NFTCurrentSales.Whitelist) {
            gameConstants().NFT_SALE_WL_BOOST = true;
        }
    }
    function setWLBoostMode(bool _mode) public onlyAdmin {
        gameConstants().NFT_SALE_WL_BOOST = _mode;
    }
