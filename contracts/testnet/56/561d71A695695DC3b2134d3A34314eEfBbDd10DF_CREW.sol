...
contract CREW is ERC721Enumerable, ERC2981, AccessControl, Pausable {
    using Strings for uint256;
    ...
    address public royaltyAddress = address(0xf2D372Aee60b08A7dC91B1164fa93d10e823c598);
    ...
    function toggleReveal() external onlyRole(OPERATOR_ROLE) {
        revealed = !revealed;
    }
    ...
    function setRoyaltyAddress(address _royaltyAddress)
        ...
        onlyRole(OPERATOR_ROLE)
    {
        require(_royaltyAddress != address(0), 'withdrawAddress is zero');
