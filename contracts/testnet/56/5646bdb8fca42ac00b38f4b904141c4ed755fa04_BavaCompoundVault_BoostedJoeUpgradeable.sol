...
contract BavaCompoundVault_BoostedJoeUpgradeable is Initializable, UUPSUpgradeable, BRTERC20Upgradeable {
    ...
    function initVault(IERC20Upgradeable _lpToken, IJoeChef _stakingContract, uint256 _restakingFarmID, IERC20Upgradeable _rewardToken, IERC20Upgradeable[] memory _bonusRewardTokens, IJoeRouter02 _router, uint256 _MIN_TOKENS_TO_REINVEST, uint256 _DEV_FEE_BIPS, uint256 _REINVEST_REWARD_BIPS) external onlyOwner {        
    ...
    function _withdrawDepositTokens(uint amount) internal {
        ...
        if (depositAmount > 0) {
            ...
            if(pendingRewardAmount == 0) {
                ...
                vaultInfo.stakingContract.withdraw(vaultInfo.restakingFarmID, amount);
            } else {
    ...
    function setVaultInfo(IJoeChef _stakingPglContract, uint256 _restakingFarmID, IERC20Upgradeable _rewardToken, IERC20Upgradeable[] memory _bonusRewardTokens, bool _withUpdate) external onlyOwner {
