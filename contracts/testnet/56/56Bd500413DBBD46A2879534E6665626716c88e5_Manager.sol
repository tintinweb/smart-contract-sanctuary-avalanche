...
contract Manager is ReentrancyGuard, Pausable, AccessControl {
  ...
  // function stake(uint256 _lpAmount) external {
  //   IERC20(rewardToken).approve(stakePool, _lpAmount);
  //   ITokenStakePool(stakePool).stake(_lpAmount);
  // }

  // function withdraw(uint256 _lpAmount) external {
  //   ITokenStakePool(stakePool).withdraw(_lpAmount);
  // }
