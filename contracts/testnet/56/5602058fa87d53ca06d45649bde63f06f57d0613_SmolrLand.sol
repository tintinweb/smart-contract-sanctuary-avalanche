...
contract SmolrLand is ERC721Enumerable, Ownable, ReentrancyGuard, ERC2981 {
    using Strings for uint256;
    ...
    IERC721 public nft; // smolr joe contract

    uint256 public constant maxSupply = 140; // total land
    uint256 public price = 0 ether; // 0 AVAX

    string public _nonRevealedURI = "https://smolr.mypinata.cloud/ipfs/QmeTdYtHRXaUCf1gygXMwj5cqBSMauawZHe77fcxXGnFVJ/";
    string public baseURIExtended = "https://smolr.mypinata.cloud/ipfs/QmSY26u1xexEKm3JNYaxJHzGoa29HaB56uBnbQvqQt11zY/"; // base ipfs url
    string public extension = ".json"; // configurable extension

    bool public saleIsActive = false; // start closed
    bool public allowListActive = true; // start active
    bool public revealed = false;
    uint96 public tokenRoyalties = 700; // 7% royalty

    address royaltyPayout = 0x3eBc9E827E305d203Ee3B3597bab37C3b4da1147; // royalty payout

    mapping(address => bool) allowListMinters;

    // CONSTRUCTOR

    constructor() ERC721("SmolrLand", "SmolrLand") {
        ...
        nonReentrant
    {
        ...
        if(allowListActive){
            require(nft.balanceOf(msg.sender) > 0, "You don't own any Smolr Joes to mint");
