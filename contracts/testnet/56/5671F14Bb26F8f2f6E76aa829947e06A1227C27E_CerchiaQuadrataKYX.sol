...
contract CerchiaQuadrataKYX is ICerchiaQuadrataKYX {
	...
	function isBusinessInvestor() private returns (bool) {
		...
		// string memory trueValue = Strings.toHexString(uint256(keccak256("TRUE")), 32);
		// string memory falseValue = Strings.toHexString(uint256(keccak256("FALSE")), 32);
		// string memory readValue = Strings.toHexString(uint256(attributes[0].value), 32);
