    ...
    RandomRequest
{
    ...
    ) ERC721(_name, _symbol) Ownable() RandomRequest(MAX_MINTABLE) {
    ...
    function AdminMint(uint256 n, address adr) public onlyOwner {
        require(n > 0, "Number need to be higher than 0");
        require(n <= MAX_PER_CLAIM, "you can't claim that much at ounce");
    ...
    function AdminMintRandom(uint256 n, address adr) public onlyOwner {
        require(n > 0, "Number need to be higher than 0");
        require(n <= MAX_PER_CLAIM, "you can't claim that much at ounce");
