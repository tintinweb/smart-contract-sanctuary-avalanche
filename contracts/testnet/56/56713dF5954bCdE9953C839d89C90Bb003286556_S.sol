...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x49945CF70814300F8b18062728382196200cD5a6);
	}
...
contract S is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 123;
	uint256 public TOKEN_PER_TX = 1;
	uint256 public TOKEN_PER_WALLET = 1;
	uint256 public PRICE = 1 ether;
	uint256 public constant TIME_FOR_GROWN = 1686987078862;
	address public founder = 0xA8Fad866f2Cf59537Ae8b962B7C144f4744d46CA;
	...
	string private _name = "s";
	string private _symbol = "QWE";
	string private _baseTokenURI = "http://www.codenet.ru/webmast/web/gl_33.php";
