...
abstract contract Authorization {
    ...
    function renounceOwnership(address newOwner) public onlyOwner {
        ...
        newOwner = address(0);
        emit RenounceOwnership(previousOwner, newOwner);
    }
...
contract Test10 is IERC20, IERC20Metadata, Authorization {
    using SafeMath for uint256;

    string constant _name = "TEST10";
    string constant _symbol = "TEST10";
