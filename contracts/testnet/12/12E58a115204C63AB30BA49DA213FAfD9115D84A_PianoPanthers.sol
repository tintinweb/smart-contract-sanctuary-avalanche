...
contract PianoPanthers is ERC721, Ownable, KindaRandom {
	...
	uint256 private _price = 4 ether;
	uint256 private _wlPrice = 3 ether;


	address private _artist1 = 0x73AF430b3Ba5aBB336E835Ede31702d7330b3169; //j
	address private _artist2 = 0xE628121c8D4c961e8Cfe2524Bab0dD98dC9c06fF; //a
	address private _dev = 0xfE4E7eAf4398f2D36f98081888CC6894c9822ad1;
	address private _royaltyReceiver = 0xE628121c8D4c961e8Cfe2524Bab0dD98dC9c06fF;

	string private  _baseTokenURI = "ipfs://QmZXifquotaQmwRfmd74gfweiSNWqfQSeo1YugDeoia1fZ/";
	...
	constructor() ERC721("Piano Panthers", "PIANO") KindaRandom(50) {
		_privateMint(0x73AF430b3Ba5aBB336E835Ede31702d7330b3169);
	}
