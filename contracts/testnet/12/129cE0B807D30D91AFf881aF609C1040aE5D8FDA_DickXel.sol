...
contract DickXel is ERC721URIStorage, Ownable, ERC2981 {
  ...
  address royaltyPayout = 0x1eF9c13117ce9EDB4D1C9D5f50F0De8dc3B323d5;
  ...
  constructor() ERC721("DickXel", "DXL") {
    ...
    _price = 0 ether; // 1 AVAX mint price 
    _maxMintable = 30; // 10k max supply
    _royaltyAmount = 800; // 7% royalties
