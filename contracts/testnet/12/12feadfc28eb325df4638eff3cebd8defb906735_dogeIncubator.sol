...
// File: DogeMoon/AVAX-DogePurchase.sol
...
contract dogeIncubator is Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    function buyDoge(uint256 amount) payable public {
    ...
    function adminBuyDoges(address _receiver, uint256 amount) public onlyOwner {
        require(amount > 0, "Why would you want zero Doges?");
    ...
    function finishHatchingEgg(uint256 requestId, uint256[] memory randomWords) private {
        ...
        if(availableDoges.length > 1) {
            randomDoge = randomWords[0] % (availableDoges.length-1);
        }
    ...
    function fulfillRandomWords(
        ...
        finishHatchingEgg(requestId, randomWords);
    }
