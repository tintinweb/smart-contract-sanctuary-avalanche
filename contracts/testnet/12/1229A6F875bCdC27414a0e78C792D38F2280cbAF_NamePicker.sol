...
contract NamePicker {
    ...
    function addName(string memory _name) public onlyOwner {
        names.push(_name);
        nameCount++;
    }
    ...
    function removeName(string memory _name) public onlyOwner returns (bool) {
