  ...
  AccessControl
{
  ...
  // // Variables to store scores of the two teams
  // uint256 public redTeamScore;
  // uint256 public blueTeamScore;
  ...
  constructor(
    ...
    // can probably remove during deployment
    ...
    // fuji prices
    backgroundRollCost = 100000000000000; // 0.1 AVAX
    noseRollCost = 100000000000000; // 0.1 AVAX
    mouthRollCost = 100000000000000; // 0.1 AVAX
    eyeRollCost = 100000000000000; // 0.1 AVAX
    chestRollCost = 300000000000000; // 0.3 AVAX
    hairRollCost = 300000000000000; // 0.3 AVAX
    accessoryRollCost = 500000000000000; // 0.5 AVAX
    dustAmountToGift = 7000000000000; // 0.007 AVAX
    glitchRollCost = 1400000000000000; // 1.4 AVAX
    ...
    // dustAmountToGift = 7000000000000000; // 0.007 AVAX
...
*/
  ...
  function adminWithdraw() external onlyTeam {
    ...
    (bool success, bytes memory data) = admin.call{value: adminCut}('');
    (bool success2, bytes memory data2) = admin2.call{value: admin2Cut}('');
  ...
  function applyLevelBasedBonus(
    ...
    // Reduce the weights of the more common items to maintain a sum of 100,000
    uint256 totalReduction = totalBoost / 4; // Divide total boost among the 4 most common items
  ...
  // function getAccessoryWeightsForTesting()
  //   external
  //   view
  //   returns (uint256[] memory)
  // {
  //   return generateAccessoryWeights();
  // }

  // function getHairWeightsForTesting() external view returns (uint256[] memory) {
  //   return generateHairWeights();
  // }

  // function getMouthWeightsForTesting()
  //   external
  //   view
  //   returns (uint256[] memory)
  // {
  //   return generateMouthWeights();
  // }

  // function getNoseWeightsForTesting() external view returns (uint256[] memory) {
  //   return generateNoseWeights();
  // }

  // function getEyesWeightsForTesting() external view returns (uint256[] memory) {
  //   return generateEyeWeights();
  // }

  // function getChestWeightsForTesting()
  //   external
  //   view
  //   returns (uint256[] memory)
  // {
  //   return generateChestWeights();
  // }

  // function getBackgroundWeightsForTesting()
  //   external
  //   view
  //   returns (uint256[] memory)
  // {
  //   return generateBackgroundWeights();
  // }

  // function applyLevelBasedBonusForTesting(
  //   uint256[] calldata weights,
  //   uint256 playerLevel
  // ) external pure returns (uint256[] memory) {
  //   return applyLevelBasedBonus(weights, playerLevel);
  // }
}
