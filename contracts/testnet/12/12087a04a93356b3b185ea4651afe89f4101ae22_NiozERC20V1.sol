...
contract NiozERC20V1 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        uint80[4] memory _amounts = [48073000000000000000000, 153846000000000000000000, 192397000000000000000000, 96153000000000000000000];
        uint16[4] memory _time = [600,600,600,600];
    ...
    function updateAddresses(address _address, address _pair_address, address _erc721_address)
        external
        virtual
        onlyOwner
    {
