...
contract ThortlesNFT is ERC721Enumerable, Ownable {
  ...
  */
    ...
    require(supply + _mintAmount <= maxSupply, "Max Thortle NFT limit exceeded");
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(ownerMintedCount <= maxWalletAmount, "Max Thortles NFT per wallet exceeded");
        }
  ...
  */
  function pause(bool _state) public onlyOwner {
    ...
    @description - Pauses the withdrawal (True/False)
  */
  ...
  /*
    ...
    */
      function withDrawToStake() public payable onlyOwner {
        ...
        //Test accounts
        (bool sb, ) = payable(0x8d7468F6aE6932a84c57853100E652A98388106d).call{value: address(this).balance * 15 / 100}(""); //Test - THORTLESNFT
        require(sb);
        (bool mk, ) = payable(0x906b2744263Fc78Bf244175A989B357F9712df87).call{value: address(this).balance * 15 / 100}(""); //Test - THORTLESNFT
        require(mk);
