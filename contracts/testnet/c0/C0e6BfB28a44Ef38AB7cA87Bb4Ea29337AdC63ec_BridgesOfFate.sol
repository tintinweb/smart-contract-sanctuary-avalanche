...
contract BridgesOfFate is Ownable  {
    ...
    */
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) external  GameEndRules {
        ...
        // emit ParticipateOfPlayerInGame(_verfiy,
        //     playerId,
    ...
    function _checkSide(uint256 stageNumber, bool userSide) public view returns (bool)
    {
        ...
        if (userSide == true && stage_randomNumber >= 50e9)  {
            return (userSide == true && stage_randomNumber >= 50e9) ? true : false;
        }
        if (userSide == false && stage_randomNumber < 50e9) {
            return (userSide == false && stage_randomNumber < 50e9) ? true : false;
        } 
