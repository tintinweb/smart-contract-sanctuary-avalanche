...
import "@daoxy/os/contracts/common/EtherTokenConstant.sol";
import "@daoxy/os/contracts/common/IsContract.sol";
...
import "@daoxy/apps-vault/contracts/Vault.sol";


contract Finance is EtherTokenConstant, IsContract, DaoxyApp {
...
import "@daoxy/os/contracts/apps/DaoxyApp.sol";
import "@daoxy/os/contracts/common/DepositableStorage.sol";
import "@daoxy/os/contracts/common/EtherTokenConstant.sol";
import "@daoxy/os/contracts/common/SafeERC20.sol";
import "@daoxy/os/contracts/lib/token/ERC20.sol";


contract Vault is EtherTokenConstant, DaoxyApp, DepositableStorage {
    using SafeERC20 for ERC20;
    ...
    *      intercepted by the Proxy (see daoxyOS#281)
    */
    ...
    * @dev As an DaoxyApp it needs to be initialized in order for roles (`auth` and `authP`) to work
    */
