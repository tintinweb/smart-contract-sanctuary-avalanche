...
contract Letter is ERC721Upgradeable, OwnableUpgradeable, AccessControlUpgradeable {
    ...
    // Letter constants
    uint public constant MAX_TITLE_LEN = 64;
    uint public constant MAX_PAGE_LEN = 8192;
    uint public constant MAX_AUTHOR_LEN = 64;
...
contract LetterSubscriptions {

    uint public totalSubscribers;
    Letter public letter;

    constructor(address _letterAddress) {
        letter = Letter(_letterAddress);
    }

    function subscribe() public {
        totalSubscribers + 1;
        letter.addReader(msg.sender);
    }
