    ...
    AvaxToDollerUtils
{
    ...
    function _mintProperty(uint256 _propertyTypeIndex, string memory _name, string memory _tokenURI)
        internal
        propertyTypeExists(_propertyTypeIndex)
    {
        // create property
        uint256 tokenId = properties.create(_propertyTypeIndex, _name, _tokenURI);
        // Mint property
     ...
     */
    function presaleMint(uint256 _propertyTypeIndex, string memory _name, string memory _tokenURI)
        external
    {
        require(validPresale(), "The Property: Presale only!!");
        _mintProperty(_propertyTypeIndex, _name, _tokenURI);
    }
        ...
        returns (string memory)
    {
        ...
        return
            properties.get(tokenId).tokenURI;
    }
    ...
    {
        return
            getDollerInAvax(propertyTypes.get(_propertyTypeIndex).monthlyTax);
    }
    ...
    function initialize(address _pair)
        public
        initializer
    {
