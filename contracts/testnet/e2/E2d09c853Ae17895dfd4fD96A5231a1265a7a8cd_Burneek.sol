...
contract Burneek is ERC721A, Ownable , ERC2981 {
    //Mint Variables to be set by user
    uint256 public maxMintPerBatch = 0;
    ...
    address public OPA1 = 0x845a1c9Fd01aB9c3FAF144deCd3d83e7d8FF3B52;

    //Royalty Address
    address public royaltyAddress = 0x845a1c9Fd01aB9c3FAF144deCd3d83e7d8FF3B52;

    //URI
    string public baseURI = "ipfs://bafybeiawyhsh4hvvq62drq2luxqmif23y2whmpxovckc47f6w6nkzygjaq/";

    //Payout addresses
    mapping(address => uint256) private pendingBalances;
    address public immutable KPA = 0xb009dfBE748Cf46fa5aa88eE9Ab7743dAdeB13F3; //THIS IS OUR HARDCODED FEE ADDRESS 
     
    constructor() ERC721A("Burneek", "BRNK") {
...
// <------------------------------------- Main Functions ------------------------------------->
    ...
    function batchMint(uint256 amount) external payable {
        ...
        pendingBalances[OPA1] += (MINTPRICE * amount)/1;
    ...
    function withdrawMintFunds() public payable onlyOwner {
        ...
        uint256 owner1Payout = pendingBalances[OPA1];
        ...
        (bool success1, ) = payable(OPA1).call{value: owner1Payout}("");   
