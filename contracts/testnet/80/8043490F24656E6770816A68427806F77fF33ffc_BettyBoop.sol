...
contract BettyBoop is ERC721A, Ownable, ReentrancyGuard {
    //================================= Declarations ================================= //
    ...
    ) ERC721A("BettyBoop", "BBT", maxBatchSize_, collectionSize_) {
    ...
    function allowlistMint() external payable callerIsUser {
        ...
        require(price != 0, "allowlist not started");
        require(allowlist[msg.sender] > 0, "not eligible");
        require(totalSupply() + 1 <= collectionSize, "max supply");
