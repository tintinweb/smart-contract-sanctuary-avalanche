...
contract AvalantItems is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable {
    ...
    // to make the cooldown possible
    // mapping(uint => uint) public deequippedFromTime;
    //     uint8[4] public supplyItems;
    ...
    event ItemWithdrew(uint itemId, uint antId);
    ...
    // TODO equip item
    // TODO unequip item
    // TODO withdraw item -> cooldown 6 hours
    ...
    // <AdminStuff>
    function setMintPrice(uint _price) public onlyRole(DEFAULT_ADMIN_ROLE) {
...
contract Suga is Initializable, ERC20Upgradeable, AccessControlUpgradeable {
    ...
    // Version 1.2
    address public FARM_LP_CONTRACT;
    ...
    function setFarmLPContractAddress(address _LPFarmAddress) public onlyRole(DEFAULT_ADMIN_ROLE) {
        if (FARM_LP_CONTRACT != address(0)) {
            _revokeRole(ANT_CONTRACTS_ROLE, FARM_LP_CONTRACT);
        }
        FARM_LP_CONTRACT = _LPFarmAddress;
        _grantRole(ANT_CONTRACTS_ROLE, _LPFarmAddress);
    }
    // </AdminStuff>
