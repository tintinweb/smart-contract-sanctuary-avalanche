...
contract MetaciptaERC1155 is ERC1155, Admin, SignatureRecover, Pausable, ERC1155Burnable, ERC1155Supply, ERC1155URIStorage{
    ...
    function create(
        ...
        //only from platform
        bytes32 _hash = keccak256(abi.encodePacked(msg.sender, _initialOwner, address(this), _uri));
