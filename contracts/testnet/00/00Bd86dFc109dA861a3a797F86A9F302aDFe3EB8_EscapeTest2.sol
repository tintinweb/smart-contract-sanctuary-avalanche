...
contract EscapeTest2 is ERC1155, Ownable {
  ...
  uint public goldPriceWei = 0.01 ether;
  uint public MAXgold = 10;
  uint public silverPriceWei = 0.02 ether;
  uint public MAXsilver = 20;
  ...
  uint256 public saleState = 3;

  string private _contractUri = "ipfs://";

  string public name = "EscapeTest1155";
  string public symbol = "ETEST1155";
  ...
  function mint2(uint amount) public payable {
    require(saleState == 3, "Public mint is not open");
    /**
    * Sale 3:
    * Public. 5 per address.
  ...
  function _checkGOLDsupply(uint256 amount) internal {
    require(amount > 0 && amount <= MAXgold, "more than 10 golds minted");
    MAXgold -= amount;
  }

  function _checkSILVERsupply(uint256 amount) internal {
    require(amount > 0 && amount <= MAXsilver, "more than 20 silvers minted");
    MAXsilver -= amount;
  }
