...
// this a test
contract BSCBlockUpdaterBatch is Initializable, OwnableUpgradeable {
    ...
    function checkBlockHash(
        ...
        bytes32 merkleRoot = MerkleProofUpgradeable.processProof(
        ...
        uint256 affirm = batchSize < batchAffirm ? 0 : batchSize - batchAffirm;
        if (
