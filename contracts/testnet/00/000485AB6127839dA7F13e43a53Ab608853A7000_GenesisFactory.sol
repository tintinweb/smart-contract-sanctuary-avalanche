...
contract GenesisFactory is Initializable, OwnableUpgradeable, UUPSUpgradeable {
  ...
  mapping(address => uint) public bondIds;
  ...
  // TODO: should approve bond contract to call deposit function
  ...
  function _registerBond(address bondProxy, address nftProxy, address treasuryProxy) internal {
    bondIds[msg.sender] += 1;

    bondInfo[msg.sender][bondIds[msg.sender]] = BondInfo({
      bond: bondProxy,
      nft: nftProxy,
...
contract GenesisBond is Initializable, PolicyUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(
        ...
        require(_config[4] != address(0), "bondNft cannot be zero");
        bondNft = IGenesisBondNFT(_config[4]);
