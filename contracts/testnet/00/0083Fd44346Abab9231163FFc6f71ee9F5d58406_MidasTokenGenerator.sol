...
contract MidasTokenGenerator is Ownable {
  ...
  function updateWallets(address aw, address bw, address cw) public onlyOwner {
    _aw = aw;
    _bw = bw;
    _cw = cw;
  }

  function updatePercents(uint256 ap, uint256 bp, uint256 cp) public onlyOwner {
    _ap = ap;
    _bp = bp;
    _cp = cp;
  }
