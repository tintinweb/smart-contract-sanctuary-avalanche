...
import {
    AvalancheFeeCollectorInterface,
    WrappedInterface
} from "./interfaces/AvalancheFeeCollectorInterface.sol";

/**
 * @title   AvalancheFeeCollector
 * @author  OpenSea Protocol Team
 * @notice  AvalancheFeeCollector is a contract that is used as an
 ...
 */
contract AvalancheFeeCollector is
    BaseFeeCollector,
    AvalancheFeeCollectorInterface
{
    ...
    function name() external pure override returns (string memory) {
        ...
        return "avalanche-fee-collector";
    }
}
...
/**
 * @title   AvalancheFeeCollectorInterface
 * @author  OpenSea Protocol Team
 * @notice  AvalancheFeeCollectorInterface contains all external function
 *          interfaces for the fee collector implementation.
 */
interface AvalancheFeeCollectorInterface {
    /**
     * @notice Unwraps and withdraws the given amount of wrapped tokens from the
     *         provided contract address. Requires the caller to have the
     *         operator role, and the withdrawal wallet to be in the
