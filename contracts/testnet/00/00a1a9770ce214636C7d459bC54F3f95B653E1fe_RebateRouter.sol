...
contract RebateRouter {
    using SafeMath for uint256;
    IUniswapV2Factory public JoeFactory;

    constructor(address joeFactory) {
        JoeFactory = IUniswapV2Factory(joeFactory);
    }
    ...
    function getReserves(
        ...
        address pair = IUniswapV2Factory(JoeFactory).getPair(tokenA, tokenB);
