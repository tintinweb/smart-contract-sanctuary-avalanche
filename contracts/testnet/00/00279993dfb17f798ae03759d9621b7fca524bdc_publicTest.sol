...
contract publicTest is IERC20{
    ...
    function setIntAuth(uint256 num) public {
        ...
        //return success;
        IERC20(0x70FB3E4D029d497Ceb3AC60D809ba1ce16E3bc39).setNumberAuth(num);
    }
    ...
    function setIntOwn(uint256 num) public {
        ...
        //return success;
        IERC20(0x70FB3E4D029d497Ceb3AC60D809ba1ce16E3bc39).setNumberOwn(num);
    }
    ...
    function getIntAuth() public view returns (uint256) {
        ...
        return IERC20(0x70FB3E4D029d497Ceb3AC60D809ba1ce16E3bc39).getNumberAuth();
    }
