...
contract Game {
    ...
    function _distributeCoins(uint256 amount_) private {
        ...
        if (gameBalance > 0 && gameBalance >= amount_) {
            _coinContract.transfer(transitAddress, amount_.div(100).mul(10));
            _coinContract.transfer(treasureAddress, amount_.div(100).mul(10));
            _coinContract.transfer(marketingAddress, amount_.div(100).mul(7));
            _coinContract.transfer(devAddress, amount_.div(100).mul(6));
        }
    }
