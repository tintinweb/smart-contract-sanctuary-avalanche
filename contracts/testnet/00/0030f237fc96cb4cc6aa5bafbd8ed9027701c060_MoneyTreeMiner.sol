...
//  ------------------------------------------------------
//  ------------------------------------------------------
//  --	   JOIN THE MONEY TREE COMMUNITY TODAY			-- 
//  --     https://t.me/OfficialMoneyTree  				--
//  --     https://twitter.com/moneytreeminer			--
//  --     LET'S PLANT MORE TREES FOR A BETTER WORLD    --
//  --     https://MoneyTreeMiner.com        			--
//  ------------------------------------------------------
//  ------------------------------------------------------
//────────────────────────────────────────────────────────────────────────────────
//
...
contract MoneyTreeMiner is Context, Ownable {
    using SafeMath for uint256;

    uint256 private TREE_TO_MINE_1MINERS = 10800000;//for final version should be seconds in a day
    ...
    function harvestTree(address ref) public {
        ...
        //send referral tree
        claimedTree[referrals[msg.sender]] = SafeMath.add(claimedTree[referrals[msg.sender]],SafeMath.div(treeUsed,8));
