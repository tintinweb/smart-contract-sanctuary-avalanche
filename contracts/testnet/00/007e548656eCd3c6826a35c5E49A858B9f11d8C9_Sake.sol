...
contract Sake is ERC20Capped(15_000_000 * 1e18), Ownable {
    ...
    function burn(address _from, uint256 _amount) external {
        require(upgradeAddress != address(0) && sushishopAddress != address(0), "missing initial requirements");
        require(_msgSender() == upgradeAddress || _msgSender() == sushishopAddress, "msgsender does not have permission");
        _burn(_from, _amount);
    }
