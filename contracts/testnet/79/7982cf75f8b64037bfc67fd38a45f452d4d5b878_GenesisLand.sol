...
contract GenesisLand is ERC721URIStorage, Ownable {
  ...
  string private baseURI = "ipfs://QmNv2B91wwK5gMzxYPh2cSn4Ca9m6r4yfyQVcTR5FwT3DP/";
  ...
  event NewLand(address indexed owner, uint256 id, uint256 dna);
  ...
  function contractURI() public pure returns (string memory) {
    return "ipfs://QmNv2B91wwK5gMzxYPh2cSn4Ca9m6r4yfyQVcTR5FwT3DP/1.json";
  }
    ...
    mintCompliance(_mintAmount)
  {
    ...
    _setTokenURI(newLandID, _tokenURI);
    ...
    _tokenDetails[newLandID] = newLand;

    for (uint256 i = 1; i <= _mintAmount; i++) {
      addressMintedBalance[msg.sender]++;
    }

    emit NewLand(msg.sender, newLandID, randDna);
  }
  ...
  function updateMetadata(
    ...
    Land storage land = _tokenDetails[_tier];
    land.tokenURI = _uri;
