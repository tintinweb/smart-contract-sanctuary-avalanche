...
contract impactTrade is Initializable, OwnableUpgradeable {
    ...
    function saleToken(
        ...
        if (ids[3] == 721) {
            ...
            if (
                IERC1155Upgradeable(fromContract[1]).balanceOf(fromContract[0], ids[0]).sub(
                    ids[2]
                ) == 0
            ) {
                if (order_place[fromContract[0]][ids[0]].price > 0) {
    ...
    function _saleToken(
        ...
        address create;
        if (impact721 == fromContract[1] || impact1155 == fromContract[1]) {
            if (ids[3] == 721) {
        ...
        if (
            ...
            if (ldatas[5] != 0) {
                t.transferFrom(msg.sender, fromContract[0], ldatas[5].div(10**ldatas[1]));
            }
        }
    }
    ...
    function _acceptBId(
        ...
        ldatas[6] = pERCent(ids[1], serviceValue).add(ids[1]);
        address create;
        if (impact721 == _conAddr || impact1155 == _conAddr) {
            if (ids[3] == 721) {
                (create, ldatas[0]) = ImpactCollective721(impact721)
                    .getCreatorsAndRoyalty(ids[0]);
            } else {
    ...
    function minting(
        ...
        if (datas[1] == 721) {
            ...
            if (datas[3] > 0) {
                orderPlace(id_, datas[3], impact721, datas[1], "mint");
            } else {
            ...
            if (datas[3] > 0) {
                orderPlace(id_, datas[3], impact1155, datas[1], "mint");
            } else {
                emit OrderPlace(msg.sender, id_, datas[3]);
            }
        }
