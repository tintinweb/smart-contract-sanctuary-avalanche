...
Website: 
Telegram: 
Project descriptions: A revolutionary multichain farming system that is driven by the innovative concept that we describe as Perpetual Leveled Farming.
// Tax 9% {5% to liquidity + 4% to Marketing wallet}.
// Max Buy: 1% Total Supply; Max per Wallet: 2% Total Supply >> Remove after 15 minutes
*/ 
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract RocketLaunchV2 is Context , IERC20, Ownable {
    ...
    uint256 private _tTotal = 300 * 10**9 * 10**9; // 300 000.000.000
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Rocket Launch V15";
    string private _symbol = "ROCKET15";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0; //
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; // 5% to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _burnFee = 0;
    uint256 private _previousBurnFee = _burnFee;

    uint256 public _devFee = 4;  // 4% to marketing fee
    address public devWallet = 0xd1867987Db0f4D1dBCe7870E2895209C7a34b1c1; // development wallet
    ...
    uint256 public _maxTxAmount = 3 * 10**9 * 10**9; //1% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 6 * 10**9 * 10**9; //2% of total supply
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x60aE616a2155Ee3d9A68541Ba4544862310933d4); //v2 router
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0x60aE616a2155Ee3d9A68541Ba4544862310933d4, 'We can not exclude Pancake router.'); //v2
