...
contract DUAToken is ERC20, ERC20Burnable, AccessControl, ERC20Pausable {
    ...
    // we override to remove the blacklisted check before transfer
    ...
    // we override to remove the blacklisted check before minting
    ...
    // we override to remove the blacklisted check before burning
    ...
    // Self-destructs the adding minters, adding new admins, minting, burning and pausability functionality
