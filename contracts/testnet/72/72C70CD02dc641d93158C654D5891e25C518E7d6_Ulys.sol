...
contract Ulys is ERC20Burnable, Operator {
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("ulysse.finance", "ULYS") {
    ...
    function transferFrom(
        ...
        // bool _isUlysLiquidityPool = isUlysLiquidityPool(recipient)
    ...
    function _transferWithTax(
        ...
        uint256 taxAmount = amount.mul(1000).div(10000); // MEANS 10%
