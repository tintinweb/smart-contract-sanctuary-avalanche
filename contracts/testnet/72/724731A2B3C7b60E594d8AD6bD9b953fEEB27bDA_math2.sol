...
contract math2 {
		...
		function doPercentage(uint256 _x,uint256 perc) external view returns(uint256[3] memory){
			...
			uint256 _z = _y.mul(perc).div(10**percDec);
			return [range[0],_z,_z*(10**range[0])];
