...
contract RewardUpgradeableV1 is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function getKeyLevelBonusReward(uint time, uint[] memory tokenIDList) external view returns (uint) {
        ...
        if (_claimedKeyLevelBonusReward >= reward) return 0;
        return reward - _claimedKeyLevelBonusReward;
    }
...
contract TresrCoinUpgradeableV1 is ERC20Upgradeable {
    ...
    function initialize() initializer public {
        ...
        _mint(address(0xCeaf7780c54bc6815A8d5c3E10fdc965d0F26762), 100 * 10 ** 18);
        _mint(address(0xD797d3510e5074891546797f2Ab9105bd0e41bC3), 100 * 10 ** 18);
        _mint(address(0x44D0b410623a3CF03ae06F782C111F23fADedAdA), 100 * 10 ** 18);
...
contract NFKeyUpgradeableV1 is OwnableUpgradeable, ERC721URIStorageUpgradeable, ERC721EnumerableUpgradeable {
    ...
    function upgradeKey(uint tokenID) public {
        ...
        uint smarterAmount = getAmountUpgradeKey(currentTier);
