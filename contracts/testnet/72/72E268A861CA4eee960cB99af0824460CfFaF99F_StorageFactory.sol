...
contract StorageFactory {
    ...
    function cloneDeterministic(
        ...
        _initAndEmit(implementation.cloneDeterministic(salt), initialData, current);
    }
    ...
    function _initAndEmit(address instance, uint256 initialData, uint256 current) private {
        IStorage(instance).initialize(initialData);
