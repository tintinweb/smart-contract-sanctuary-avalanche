...
///@dev ERC1155Supply is used to be able to mint additional tokens in the future
...
contract AVAXGods is ERC1155, Ownable, ERC1155Supply {
    ...
    /// @dev GameToken struct is to store player token info
    struct GameToken {
    ...
    /// @dev Player struct is to store player info
    struct Player {
        ...
        uint256 playerMana; /// @param playerMana player mana; affected by battle results = Power
        uint256 playerHealth; /// @param playerHealth player health; affected by battle results
        bool inBattle; /// @param inBattle boolean to indicate wheather a player is in battle or not
    }

    /// @dev Battle struct is to store battle info
    struct Battle {
