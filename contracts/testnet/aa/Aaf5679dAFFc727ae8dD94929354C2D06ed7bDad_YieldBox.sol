    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier claimer(address _claimer) {
        if (presaleClaimer[_claimer] || Presale2.getYieldBoxAllocated(_claimer) == 0) {
    ...
    function claimPresaleYieldBox(address _claimer)
        ...
        whenNotPaused
    {
        uint256 amount = Presale2.getYieldBoxAllocated(_claimer);
    ...
    function create(address _stable) external nonReentrant whenNotPaused {
         ...
         * @dev update the logic based on: https://valifi-app.gitbook.io/valifi-whitepaper/fundamentals/the-valifi-engine-back-end
         */
