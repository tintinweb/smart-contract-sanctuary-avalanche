/**
 *Submitted for verification at testnet.snowtrace.io on 2023-04-30
*/
...
contract MalikSaqib is ERC721A, Ownable {

    uint256 _currentIndex = 0; //Make first tokenId = first json file.
    string baseExtension = ".json";
    uint256 _mintamount = 100; //It will be equal to quantity.
