...
contract GrainITO is Context, Ownable {
    ...
    address public constant grainAddress = 0x80AB4239C64e539360a6e8d041dc796F00331e56;
     ...
     */
    uint256 public vestingStartTimestamp = 1652709643;
    ...
    //User Functions
    function purchaseGrain(address to, uint256 amount) payable public{
        require(amount >= mincap, "Purchase amount too low");
        require(amount <= maxcap, "Purchase amount too high");
        require(msg.value * rate == amount, "Not enough AVAX");
    ...
    function getVestedPercent() private view returns(uint256){
