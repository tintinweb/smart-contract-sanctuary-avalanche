...
contract AdapterMock {
    ...
    // Random value between 1e18 and 10e18;
    /*
    function randomMint() internal view returns (uint256) {
        uint256 randomValue = uint256(keccak256(abi.encodePacked(msg.sender, block.timestamp))) % 10;
        randomValue = (randomValue + 1) * 1e18;
        return randomValue;
    }
    */
}
