...
contract BDCANFTs is ERC721Enumerable, ERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public constant tokenPrice = 0.001 ether; // 1000000000000000 ether 2000000000000000
    ...
    address private refundAddress = 0x9fb2B4410e3ea0e3C9B865D8b4D44F1eEb2e2cef;

    event HardJobsMinted(uint256 tokenId, address owner);

    address contractAddress;

    constructor(address marketplaceAddress) ERC721("BDCANFTs ", "BDNFTs") ReentrancyGuard() {
        contractAddress = marketplaceAddress;
        _setDefaultRoyalty(msg.sender, 100);
    }

    //nft: 0xB1BEC483F2bE654d05Fa0A5b228Cf07EaD0A3dc5
    // makret:  0x1E0F61E79804bA9E30577EbDB5883C5574bdF074

    // Rotalty
    /// ipfs://QmbMvxi77QVFTNooMg88TY7hDjWH2FyXoBJ6skaPsEUDwm/
    ...
    function presalehard(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            ...
            if (totalSupply() < MAX_TOKENS) {
                ...
                emit HardJobsMinted(id, msg.sender);
            }
        }
    }

    function minthard(uint256 numberOfTokens) external payable {
