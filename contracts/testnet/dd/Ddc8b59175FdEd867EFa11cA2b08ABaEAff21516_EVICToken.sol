...
contract EVICToken is ERC20, Operator {
    ...
    constructor(address _polWallet, address _wethAddress, address _router) ERC20("Ethereum Victory", "EVIC") {
		require(_polWallet != address(0), "!_polWallet");
		require(_wethAddress != address(0), "!_wethAddress");
		...
		address dexPair = IUniswapV2Factory(_dexRouter.factory()).createPair(address(this), _wethAddress);
