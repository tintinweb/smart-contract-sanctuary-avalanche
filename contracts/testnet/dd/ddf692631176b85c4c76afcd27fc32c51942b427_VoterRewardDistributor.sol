...
contract VoterRewardDistributor is IVoterRewardDistributor {
    ...
    */
    ...
    function addVoteStaker(address voteStaker) public {
        require(voting.balanceOf(voteStaker) > 0, "No voter found");

        //voteStaker already added
        // require(Voters[voteStaker] != voteStaker, "voteStaker Already Added");
        require(voterIndexes[msg.sender] != 0, "Vote staker already added");

        // if(voterIndexes[voteStaker] != voteStaker) {
        //     return;
        // }
