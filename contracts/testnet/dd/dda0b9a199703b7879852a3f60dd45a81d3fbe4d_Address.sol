...
// File: contracts/AvaxNFTools.sol
...
/**
 * @title AvaxNFTools contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract AvaxNFTools is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant nftoolsPrice = 10000000000000000; //0.01 Avax
    ...
    */
    function mintNFT(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_NFTS, "Purchase would exceed max supply of Apes");
        require(nftoolsPrice.mul(numberOfTokens) <= msg.value, "Avax value sent is not correct");
