...
contract beta_main is ERC20, Ownable {
	...
	//emit Transfer(address(this), treasury, supply.div((10000)/(uint256(10)*100)));
	//emit Transfer(address(this), rewardsPool, supply.div((10000)/(uint256(10)*100)));
	//emit Transfer(address(this), teamPool, supply.div((10000)/(uint256(10)*100)));
	//emit Transfer(address(this), owner(), supply.div((10000)/(uint256(50)*100)));
    }
