...
contract GenesisConvertV2 is ERC721Burnable, ERC721Permit, ERC721Rentable, ERC721URIStorage, IGenesisConvert, Withdrawable, ReentrancyGuard, Verifier {
    ...
    function convert(
        ...
        ERC721Burnable(genesisNFT).burn(tokenId_);
