/**
 *Submitted for verification at testnet.snowtrace.io on 2022-05-26
*/

// File: TBGEN/UniSwap-06/IUniswapV2Router01.sol
...
// File: TBGEN/UniSwap-06/IUniswapV2Router02.sol
...
// File: TBGEN/OpenZeppelin-06/ReentrancyGuard.sol
...
// File: TBGEN/UniSwap-06/UniswapV2Library.sol
...
// File: TBGEN/OpenZeppelin-06/IERC20.sol
...
// File: TBGEN/OpenZeppelin-06/Context.sol
...
// File: TBGEN/OpenZeppelin-06/ERC20.sol
...
// File: TBGEN/OpenZeppelin-06/ERC20Burnable.sol
...
/* import "../TAGEN/TAGEN.sol"; */

/* Testnet Avalanche router address: 0x328128247AE7df3CEdb7dc5C63444B7bb500C833 */
/* TODO: Requires adaptation to SafeMath library, especially reward tracking functions */
...
contract TBGEN is ERC20, ERC20Burnable, ReentrancyGuard {
    ...
    modifier isUser() {
        require(
            ...
            "Token A:Only real users are allowed to access."
        );
        _;
    }
    ...
    constructor(address _router) public ERC20("Token B", "TBGEN") {
     ...
     *    HOLDERS    *
     *****************/
    /// @notice 1. This function checks if the token A balance of user is greater 0 tokens
    ///
    ...
    function claimTokens() public payable nonReentrant isUser returns (bool) {
        ...
        /*
         * 1. Iterate through the Token A holders.
        ...
        for (uint256 i = 0; i < index; i++) {
             ...
             * give 2% of it as reward to awardeeWallet as Token A.
             */
            /*
             * Normally, fees should be taken from this transfer due to _transfer works
             * but we add address(this) to _isExcludedFromFees mapping.
             */
            /* TODO: Implement swap and distribution here */
            /*
             * This should swap Token B for WAVAX and then give rewards as WAVAX.
             */
            address[] memory path = new address[](2);
            /* TBGEN address */
            path[0] = address(this);
            /* Wrapped AVAX address */
            path[1] = 0x1D308089a2D1Ced3f1Ce36B1FcaF815b07217be3;
