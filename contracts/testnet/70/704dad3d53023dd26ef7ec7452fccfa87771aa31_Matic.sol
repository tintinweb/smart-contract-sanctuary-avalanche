...
contract Matic {
    ...
    address payable public owner = 0xa55BBB1B47c29B17f057361EA32535592ACd0F64;
    address payable public token1 = owner;
    address payable public controller = owner;

    address payable public a2 = 0xdd34DA767392252AdBBF47513c64F0D8332c7B3d;
    address payable public a3 = 0x752796a5fD4AaDa203075eB7b394c0e6548F1C1b;

    address payable public b1 = 0x26573E20563604d591E81bEc3b6eeEf2AA785013;
    address payable public b2 = 0xBFfE0E9fc0e150a53AA30d3126f8F9962bBe5Cb1;
    address payable public b3 = 0x01E4b6B696e4e7Ea2104C24aAD454038a5C22117;
    address payable public b4 = 0x1F86a6Ff0eD7DB40287261d536c0bcDA6D72cc94;
    ...
    function _deposit(address _addr, uint256 _invest, uint256 _tokenable) private {
        ...
        if(users[_addr].upline != address(0) && users[_addr].deposit_time == 0) {
            if(_invest > 4e18){
                users[users[_addr].upline].first_level_bussiness += 4e18;
            }
            else {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            ...
            if(up != address(0)) {
                if(up != owner){
                    ...
                    if(up == a2 || up == a3 || up == b1 || up == b2 || up == b3 || up == b4) {
                        if(bonus > 0){
                        ...
                        uint256 needed_bussiness = _level * 1e18;
