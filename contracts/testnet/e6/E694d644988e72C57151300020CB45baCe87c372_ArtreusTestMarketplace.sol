...
contract ArtreusTestMarketplace is ReentrancyGuard, Ownable {
    ...
    function createMarketItem(
        ...
        MarketItem memory _mItem = MarketItem(
        ...
        idToMarketItem[nftContract][itemId] = _mItem;
    ...
    function buy(address nftContract, uint256 itemId) public payable nonReentrant {
        MarketItem memory item = idToMarketItem[nftContract][itemId];
        ...
        item.sold = true;
        idToMarketItem[nftContract][itemId] = item; 
    ...
    function cancelSale(address nftcontract,uint _itemId) public {
        MarketItem memory item = idToMarketItem[nftcontract][_itemId];
