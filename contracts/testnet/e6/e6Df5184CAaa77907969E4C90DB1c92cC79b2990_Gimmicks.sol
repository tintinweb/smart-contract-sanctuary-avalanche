...
contract Gimmicks is ERC721Enumerable, Ownable {
    ...
    uint16 public constant totalNFTs = 1000;
    ...
    function mint(
        ...
        require(amount <= maxPerTransaction, "Cannot mint more than 5 in a single transaction");
        require(msg.value == (nftPrice * amount), "The price is invalid");
        require(saleStarted == true, "The sale is paused");
        require(nftId + amount <= totalNFTs, "Mint limit reached");
        ...
        for (uint8 i = 0; i < amount; i++) {
            metadataByTokenId[nftId] = metadataURI;
    ...
    function bridgeNFTs(
        ...
        require(nftId + amount <= totalNFTs, "Out of stock");
    ...
    function setNFTMetadata(uint256 tokenId, string memory metadataURI) public onlyOwner {
