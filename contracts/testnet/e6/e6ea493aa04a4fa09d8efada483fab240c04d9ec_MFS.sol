...
contract MFS is Context {

    address payable private FeeCollectorContract = payable(0x5944c0C03f4438c1Eb8a446CE030C9fCb41b0e3C);
...
contract Contract is Context, IERC20 { 
    ...
    address payable public constant feeCollector = payable(0x5944c0C03f4438c1Eb8a446CE030C9fCb41b0e3C); 
    ...
    function Token_Information() external view returns(string memory Token_Name,
        ...
        string memory Creator = "https://token.com/";
...
// Contract Created by https://Token.com
