...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x06761348bd3292463e48f1D1d488DF4186762B72;
...
contract IdmCoopAvax is Context, IERC20, Ownable {
    ...
    address private _RndWalletAddress = 0x9BcBaEc89CABAd306bC9dF0c2c9E49e5C3c41AB4;
    // address private _SuperinvestorWalletAddress = 0x9BcBaEc89CABAd306bC9dF0c2c9E49e5C3c41AB4;
    // address private huricaneRouter = 0x1912238a9DC285FfED8B8Ee048A49550686C1970;
   
    uint256 private constant MAX = ~uint256(0);
    // uint256 private _tTotal = 1000.000.000.000000000;
    uint256 private _tTotal = 1000000000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TOSII Token";
    string private _symbol = "TOSII";
    ...
    address public pair;
    IDEXRouter router;
    // uint256 public _maxAmount = 30000 * 10**_decimals; // 0.15% of total LP
    // uint256 public _maxWalletSize = 2 * 10**11 * 10**_decimals; // 2% of total supply
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _tTotal * 3 / 10000; 
    uint256 public _maxSellTxAmount = _tTotal * 3 / 10000; 
    uint256 public _maxWalletToken = ( _tTotal * 3 ) / 10000; 
    ...
    constructor () {
        ...
        router = IDEXRouter(0x7E3411B04766089cFaa52DB688855356A12f05D1);
    ...
    function setBuyTxLimitInPercent(uint256 maxBuyTxPercent) external onlyOwner {
        ...
        _maxBuyTxAmount = _tTotal.mul(maxBuyTxPercent).div(10000);
    }

    // Set max sell TX 
    function setSellTxLimitInPercent(uint256 maxSellTxPercent) external onlyOwner {
        require(maxSellTxPercent > 0, "Transfer amount must be greater than zero");
        _maxSellTxAmount = _tTotal.mul(maxSellTxPercent).div(10000);
    }

    // Setting the max wallet in Percentages
    // Note 1% equals 100
     function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
        _maxWalletToken = _tTotal.mul(maxWallPercent).div(10000);
    ...
    function checkMaxWallet(address recipient, uint256 amount) internal view {
        if (recipient != owner() && recipient != pair && recipient != _RndWalletAddress){
