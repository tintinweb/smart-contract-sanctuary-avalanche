    ...
    ERC2981PerTokenRoyalties
{
    ...
    constructor(address _royaltyRecipient) ERC721("madskullz2", "MADSKULLZ2") {
        royaltyRecipient = _royaltyRecipient;
    }

    function mint(string memory _tokenURI) public onlyOwner {
        _safeMint(msg.sender, counter);
        _setTokenRoyalty(counter, royaltyRecipient, 800);
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ERC2981Base, ERC721, ERC721Enumerable)
        returns (bool)
    {
