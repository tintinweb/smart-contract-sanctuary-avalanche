...
////import "./interfaces/ISunflowerMarket.sol";

contract SunflowerMarket is Initializable, OwnableUpgradeable, ISunflowerMarket {
    ...
    function setBeneficiary(address _beneficiary) public override onlyOwner {
