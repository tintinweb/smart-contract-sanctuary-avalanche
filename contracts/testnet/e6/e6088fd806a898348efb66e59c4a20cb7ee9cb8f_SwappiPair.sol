...
// File contracts/interfaces/ISwappiPair.sol
...
// File contracts/interfaces/ISwappiERC20.sol

pragma solidity >=0.5.0;

interface ISwappiERC20 {
    event Approval(address indexed owner, address indexed spender, uint value);
    event Transfer(address indexed from, address indexed to, uint value);
...
// File contracts/SwappiERC20.sol

pragma solidity =0.5.16;


contract SwappiERC20 is ISwappiERC20 {
    using SafeMath for uint;

    string public constant name = 'Swappi LPs';
    string public constant symbol = 'PPI-LP';
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(deadline >= block.timestamp, 'Swappi: EXPIRED');
...
// File contracts/interfaces/ISwappiFactory.sol
...
// File contracts/interfaces/ISwappiCallee.sol

pragma solidity >=0.5.0;

interface ISwappiCallee {
    function swappiCall(address sender, uint amount0, uint amount1, bytes calldata data) external;
}


// File contracts/SwappiPair.sol
