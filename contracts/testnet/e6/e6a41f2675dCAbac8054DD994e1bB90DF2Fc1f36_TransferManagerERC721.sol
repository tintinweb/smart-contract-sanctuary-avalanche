...
contract TransferManagerERC721 is ITransferManagerNFT {
    address public immutable BIG_FOOT_EXCHANGE;

    /**
     * @notice Constructor
     * @param _bigFootExchange address of the BigFoot exchange
     */
    constructor(address _bigFootExchange) {
        BIG_FOOT_EXCHANGE = _bigFootExchange;
    }
    ...
    function transferNonFungibleToken(
        ...
        require(msg.sender == BIG_FOOT_EXCHANGE, "Transfer: Only BigFoot Exchange");
