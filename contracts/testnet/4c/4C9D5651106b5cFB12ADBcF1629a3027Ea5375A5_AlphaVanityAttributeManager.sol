...
contract AlphaVanityAttributeManager is BaseAttributeManager
{
    using SafeERC20 for IERC20;
    
    uint256 _attributeUpdateCost = 5_000_000_000e9;
    uint256 _attributeCreationCost = 50_000_000_000e9;
    ...
    *   registers the token on the mapping, sets exists to true
    *
    ...
    * */
        ...
        nonReentrant 
    {
        ...
        require(IERC20(_erc20Token).balanceOf(msg.sender) >= _attributeUpdateCost, "Insufficient balance to update attribute.");
        
        IERC20(_erc20Token).safeTransferFrom(msg.sender, _feeReceiver, _attributeUpdateCost);
        
        updateVanityStringAttribute(tokenId, attributeIndex, isEnabled, _attributeName, _attributeValue);
    }
        ...
        nonReentrant 
    {
        ...
        updateVanityNumericAttribute(tokenId, _attributeName, _attributeValue, attributeIndex, isEnabled);
    }
        ...
        nonReentrant 
    {
        ...
        addVanityStringAttribute(tokenId, _attributeName, _attributeValue);
    }

    function addNumericAttribute(        
        string memory _attributeName,
        uint256 _attributeValue, 
        uint256 tokenId
        ) 
        ...
        nonReentrant 
    {
        ...
        addVanityNumericAttribute(tokenId, _attributeName, _attributeValue);
    }

    function setAttributeCreationCost(
        uint256 attributeCreationCost
        )
        external
        requireAdmin(msg.sender)
        nonReentrant
    {
        _attributeCreationCost = attributeCreationCost;
    }

    function setAttributeUpdateCost(
        uint256 attributeUpdateCost
        )
        external
        requireAdmin(msg.sender)
        nonReentrant
    {
        _attributeUpdateCost = attributeUpdateCost;
    }
    ...
    * Game Numeric Attributes Management
    ...
    modifier _tokenExists(uint256 tokenId) {
        require(tokenExists[tokenId] == true);
        _;
    }
