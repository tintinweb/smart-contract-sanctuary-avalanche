...
contract AccessManager is ERC1155, IERC2981, IAccessManager, Ownable {
	/*///////////////////////////////////////////////////////////////
													EVENTS
	//////////////////////////////////////////////////////////////*/
  ...
  //////////////////////////////////////////////////////////////*/
	...
	constructor(
		...
		// Add placeholder items for the 5 WL passes
		for (itemCount; itemCount < 6; ) {
	...
	function setShieldManager(address shieldManagerAddress) external onlyOwner {
		shieldManager = shieldManagerAddress;
	}
