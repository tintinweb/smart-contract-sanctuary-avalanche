...
contract FilaERC20V2 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function furmished(SellOrder memory _order, bytes memory _signature)
        external
        virtual
    {
        require(
        ...
        emit TokenFurmished(msg.sender, _order.tokenId, _order.id, _order.amount);
    }
}
