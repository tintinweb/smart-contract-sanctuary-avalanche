...
library SystemSettingsLib {
    ...
    function setIssuanceRatio(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 ratio) external {
    ...
    function setWaitingPeriodSecs(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _waitingPeriodSecs) external {
    ...
    function setFeePeriodDuration(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _feePeriodDuration) external {
    ...
    function setLiquidationDelay(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 time) external {
    ...
    function setLiquidationEscrowDuration(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 duration) external {
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, duration);
    }

    function setSnxLiquidationPenalty(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 penalty) external {
    ...
    function setSelfLiquidationPenalty(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 penalty) external {
        require(penalty <= MAX_LIQUIDATION_PENALTY, "penalty > MAX_LIQUIDATION_PENALTY");

        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, penalty);
    }

    function setLiquidationPenalty(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 penalty) external {
        require(penalty <= MAX_LIQUIDATION_PENALTY, "penalty > MAX_LIQUIDATION_PENALTY");

        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, penalty);
    }

    function setFlagReward(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 reward) external {
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, reward);
    }

    function setLiquidateReward(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 reward) external {
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, reward);
    }

    function setRateStalePeriod(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 period) external {
    ...
    function setMinimumStakeTime(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _seconds) external {
    ...
    function setDebtSnapshotStaleTime(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _seconds) external {
        flexibleStorage.setUIntValue(SETTINGS_CONTRACT_NAME, settingName, _seconds);
    }
    ...
    function setAtomicMaxVolumePerBlock(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _maxVolume) external {
    ...
    function setAtomicTwapWindow(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 _window) external {
    ...
    function setExchangeMaxDynamicFee(IFlexibleStorage flexibleStorage, bytes32 settingName, uint256 maxFee) external {
