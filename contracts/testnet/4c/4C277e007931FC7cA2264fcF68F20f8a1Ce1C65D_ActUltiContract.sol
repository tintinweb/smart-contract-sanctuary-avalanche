...
// File: contracts/ActUltiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ActUltiContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ACT Ulti";
    string public symbol = "ACTulti";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/Bb8CDbIjuQDm9ENTSmap/contract-metadata";
  }
