    ...
    ReentrancyGuardUpgradeable
{
    ...
    //     1. partId (don’t mint new token)
    // 2. threadUpgradeTokenId (burn this token if process with thread)
    // 3. threadUpgradeId
    // 4. messageHash & signature
    ...
    function updateComissionFee(uint256 _fee_percent) public onlyOwner {
        ...
        virtual
    {
        require(
            SignatureCheckerUpgradeable.isValidSignatureNow(
                ...
                !(FilaERC20Address.isVerified(_signature)),
        ...
        virtual
    {
        ...
        if (_order.isSendToWallet) {
            FilaERC20Address.mint(msg.sender, _order.amount);
        }
        ...
        virtual
    {
        ...
        require(_order.amount == msg.value  &&
                !isVerified[_signature] &&
                !(FilaERC20Address.isVerified(_signature)), "AlloyERC721: Prize is incorrect or invalid");
    ...
    function update(uint256 id, string memory _type) public onlyOwner {
        NFTtypes[id] = _type;
    }
}
