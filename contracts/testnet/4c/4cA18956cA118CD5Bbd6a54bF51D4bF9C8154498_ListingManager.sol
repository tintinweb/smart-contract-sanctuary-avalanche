...
contract ListingManager {
    ...
    event ListingCancelled(uint256 indexed index, uint256 indexed tokenId, address indexed lister, uint256 listingAmount);
    event ListingSettled(uint256 indexed index, uint256 indexed tokenId, address lister, uint256 listingAmount, address indexed buyer);
    event NewListing(uint256 indexed index, uint256 indexed tokenId, address indexed lister, uint256 listingAmount, uint256 expiry);
}