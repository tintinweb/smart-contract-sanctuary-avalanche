...
contract TraderJoeRouterFunctions {
    ...
    function swapExactNATIVEForTokens(uint256 _amountOutMin, Components.Path memory path, address _to, uint256 _deadline) public payable returns(uint256  amountOut){
    return amountOut;
    }
}
