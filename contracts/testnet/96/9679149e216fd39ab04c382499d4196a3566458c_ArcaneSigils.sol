...
contract ArcaneSigils is ERC20("Stable Coin", "STABLE"), Ownable {
    using SafeGothMath for uint256;

    /// @notice Total number of tokens
    uint256 public maxSupply = 1_000_000_000e18; // 1 Billion SIGIL's
    ...
    function delegateBySig(
        ...
        require(now <= expiry, "SIGIL::delegateBySig: signature expired");
