...
// Type imports
import {NFTCurrentSales} from "../NGTypes.sol";

contract NGGameStatsFacet is WithStorage {
    struct BasicGameStats {
        NFTCurrentSales gameMode;
        bool gamePaused;
        bool whitelisted;
        ...
        // Presale info
        uint256 nftPreSaleCurrent;
        uint256 nftPreSaleMaxBuy;
        uint256 nftPreSaleFinished;
        // Postsale Info
        uint256 nftPostSaleCurrent;
        uint256 nftPostSaleMaxBuy;
    }
    ...
    function getBasicGameStats() public view returns (BasicGameStats memory basicGameStats) {
        // Game Mode
        basicGameStats.gameMode = gameConstants().NFT_SALE_MODE;
        ...
        // PreSale Stuff
        // How many total PreSale NFTs has been bought
        basicGameStats.nftPreSaleCurrent = adss().totalPreSaleNFTBought;
        // The max amount of PreSale NFTs that can be bought
        basicGameStats.nftPreSaleMaxBuy = gameConstants().NFT_MAX_PRESALE_TIER;
        // A timestamp of when the PreSale will end
        basicGameStats.nftPreSaleFinished = gameConstants().NFT_PRESALE_END_TIME;
        
        // PostSale Stuff
        // How many total PostSale NFTs has been bought
        basicGameStats.nftPostSaleCurrent = adss().totalPostSaleNFTBought;
        // The max amount of PostSale NFTs that can be bought
        basicGameStats.nftPostSaleMaxBuy = gameConstants().NFT_MAX_POSTSALE_TIER;
    }
