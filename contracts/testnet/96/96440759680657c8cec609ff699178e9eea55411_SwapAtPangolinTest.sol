...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-periphery/interfaces/IWAVAX.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-periphery/interfaces/IERC20.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-periphery/libraries/SafeMath.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-core/interfaces/IPangolinPair.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-lib/libraries/TransferHelper.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-core/interfaces/IPangolinFactory.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-periphery/libraries/PangolinLibrary.sol
...
// File: https://github.com/pangolindex/exchange-contracts/blob/main/contracts/pangolin-periphery/PangolinRouter.sol
...
contract SwapAtPangolinTest {
    
  
   PangolinRouter internal router;
   AggregatorV3Interface internal AvaxUsdPriceFeed;
   address [] public AvaxShermixFujiPath ;//["0xd00ae08403B9bbb9124bB305C09058E32C39A48c", "0x7FB5b0137747Fb8AbE7eC2949D9b3365d2a35398"]; 
   uint256 deadline;
   
   
    
   constructor(address payable _router, address _AvaxUsdPriceFeed) public {
       router = PangolinRouter (_router);
       AvaxUsdPriceFeed = AggregatorV3Interface(_AvaxUsdPriceFeed); //"0x5498BB86BC934c8D34FDA08E81D444153d0D06aD"
    }
    
    function swapExactAVAXForTokens( uint amountOutMin, address[] memory _AvaxShermixFujiPath, address to, uint _deadline) public payable {
        uint256 AvaxUsdPrice = getLatestAvaxUsdPrice();// will return 8 decimals
        deadline = _deadline;
        AvaxShermixFujiPath = _AvaxShermixFujiPath; 
        uint256 i;
        for (i = 0; i < 1; i ++) {
            if ( (AvaxUsdPrice/100000000) > 40 ) {
                router.swapExactAVAXForTokens(amountOutMin, AvaxShermixFujiPath, to , deadline);
    ...
    (
      ...
      uint timeStamp,
      uint80 answeredInRound
    ) = AvaxUsdPriceFeed.latestRoundData();
