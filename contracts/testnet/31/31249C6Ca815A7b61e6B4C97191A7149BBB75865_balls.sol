    ...
    BatchReveal
{
    ...
    constructor() ERC721A("Pixlz", "PIX") VRF(431, 1) {
        customBaseURI = "ipfs://bafybeicxnbhuy65onmfsfyhqfcpaxmv36p7fpuf4so5lbozszlc6byagdq/";
        unrevealedURI = "unrevealed";
        royaltyAmount = 900;
        paused = true;
        merkleRoot =0x2e8f743a05845ab74b827c063d07c8c40b71643bb65cac853e0c6fa07fac42bc;
    }
    ...
    function setMaxValues(uint256 maxMintable_) public onlyOwner {
    ...
    function mint(bytes32[] calldata merkleProof) external {
        ...
        require(
            isWhitelisted(merkleProof, msg.sender),
    ...
    {
        return (owner(), ((_salePrice * royaltyAmount) / 10000));
    }
...
abstract contract BatchReveal {
    uint constant public TOKEN_LIMIT = 53;
    uint constant public REVEAL_BATCH_SIZE = 53;
