...
// File: contracts/talentscout6.sol
...
contract TalentScout is IERC20, AccessControl, Ownable {
    ...
    function swapBackAVAX(uint256 scoutAmount) internal swapping returns(uint256) {
    ...
    function _autoLiquify(uint256 liquidityFeeAmount) private {
