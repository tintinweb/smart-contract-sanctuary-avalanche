...
contract FishFarm is Context, Ownable {
    using SafeMath for uint256;

    uint256 private constant DEPOSIT_MAX_AMOUNT = 50000000 ether;
    uint256 private FISHING_STEP = 540000;
    uint256 private TAX_PERCENT = 7;
