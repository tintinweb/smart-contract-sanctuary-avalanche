...
contract BVICBoardroom is ShareWrapper, ContractGuard {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    ...
    uint256[] public supplyTiers = [1.5 ether, 25 ether, 50 ether, 75 ether, 100 ether];
    ...
    uint256 public minTokenToExpansion = 0.0675 ether;
    uint256 public minTokenSupplyToExpansion = 1.5 ether;
