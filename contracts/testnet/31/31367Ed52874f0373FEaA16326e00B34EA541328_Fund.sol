...
contract Fund is IFund, AgentRole, Initializable, FundStorage {
    ...
    function _addUserDividend(address _address, uint256 _dividend, uint256 _key) internal{
            if(_key == 0){
    ...
    function shareDividend(address[] calldata _address, uint256[] calldata _dividend, address _from, uint256[] calldata _key) public onlyAgent{
