...
// Testnet: 0x53daf53d2bc668f37bc99fd8fb635b3dc2213367
contract ChadDogeLab is Ownable {
    ...
    address constant public vialAddress = 0x7CDa987DDdEb39C96A699b8233686669380ec715; // TODO::: change later (test vial address)
    address constant public chadDogeAddress = 0x5Bc1E094bc935c685b99096A27352a72B02c4435; // TODO::: change later (test CD)

    // Claim process variables
    Range public vialFMetadataRange;
    mapping(uint256 => uint256) public vialFIds;
    mapping(uint256 => uint256) public usedChadDoges;
    ...
    function claimSuper(uint256 _vialID, uint256 _chadDogeID) external requireLabOpen {
        ...
        if (usedChadDoges[_chadDogeID] == 1) revert InvalidTokenId();
    ...
    function launchpegToLastTokenReveal(address _adr) external view returns (uint256) {
        return ILaunchpeg(superAddress).collectionSize() - 1;
    }
    ...
    function revealNextBatch(address _baseLaunchpeg, uint256 _totalSupply) external returns (bool) {
