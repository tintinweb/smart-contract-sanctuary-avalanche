...
contract ERC721PsiUpgradeableNFT is ERC721PsiRandomSeedRevealUpgradeable, ReentrancyGuardUpgradeable {
    ...
    ) ERC721PsiRandomSeedRevealUpgradeable(vrfCoordinator_, callbackGasLimit_, requestConfirmations_) {
    ...
    function reveal() external isTenantOwner {
