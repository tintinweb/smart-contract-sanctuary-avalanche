...
//    address payable[] private s_tickets;
    ...
    function enterRaffle() public payable {
        ...
        uint ticketsLeft = s_targetNumberOfTickets - s_tickets[s_raffleId].length;
        uint ticketsSold;
        uint256 change;
...
//            s_tickets.push(payable(msg.sender));
            ...
            if (s_tickets[s_raffleId].length + 1 > s_targetNumberOfTickets) {
    ...
    function setRaffleSafeAddress(address safeAddress) public onlyOwner {
