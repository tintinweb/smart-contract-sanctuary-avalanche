...
contract MarketPlaces is IERC721Receiver, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;
  Counters.Counter private _itemIds;
  Counters.Counter private _itemsSold;

  
  uint256 listFee = 0.0020 ether; // yuzde yapamak
  
  // ***yuzdelik ilk mintlen kisiye odencek
...
// 
  function saleNFT(uint256 tokenId, uint256 price) public payable nonReentrant {
