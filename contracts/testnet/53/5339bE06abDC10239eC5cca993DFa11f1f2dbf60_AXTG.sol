...
contract AXTG is ERC721URIStorage, ReentrancyGuard, Ownable { 
   ...
   address private adminWalletAddress = payable(0xB55341819D185F49B30a5A1c9CAD70E9eB3335f8);
    ...
    constructor() ERC721("Ape X Turco Genesis", "AXTG")
    {
        tokenCounter = 0;
    }

    function create( string memory picname, address payable transferAddress, bytes32 messageHash, bytes memory signature) public payable {
  ...
  function baseTokenURI( string memory picname) public pure returns (string memory) {
    return string(abi.encodePacked("https://apexturco.com:3333/metadatas/", picname ));
  }
	...
	function transferCrypto (address payable _to, uint _amount) public payable{ 
