...
using SafeMath for uint256;
    ...
    */
    ...
    function _finalization(bytes memory certificate) internal override{
        if (goalReached()) {
        ...
        super._finalization(certificate);
    }
...
abstract contract FinalizableCrowdsale is TimedCrowdsale {
     ...
     */
    function finalize(bytes memory data) public {
     ...
     * executed entirely.
     */
    function _finalization(bytes memory data) virtual internal {
...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    function changePropertyOwnerAddress(address payable newOwner)
        public
        onlyAdmin
    {
        _wallet = newOwner;
