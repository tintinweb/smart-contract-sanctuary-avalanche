...
contract Marketplace is GameFiat, Withdrawable {
    ...
    string public constant REVERT_NOT_A_OWNER_NFTS = "BuyNFT: caller is not the owner of NFTs";
    ...
    string public constant REVERT_APPROVE_NFTS = "BuyNFT: caller is not approve nfts";
    string public constant REVERT_INVALID_BUY_FIAT = "BuyNFT: Invalid buy fiat";
    string public constant REVERT_INSUFFICIENT_BALANCE = "BuyNFT: Insufficient balance";
