...
contract SnowballClaimedHolidayNFT is ERC721, Ownable{
    address public constant unclaimedNFT = 0x7d6B14A3ef0eB821f346FD446ebd56cF0575B7Aa;
    ...
    function mintAndBurn(uint256 qty) public {
        ...
        for (index = 0; index < qty; index++) {
            IERC721(unclaimedNFT).transferFrom(msgSender, address(this), userTokenList[index]);
