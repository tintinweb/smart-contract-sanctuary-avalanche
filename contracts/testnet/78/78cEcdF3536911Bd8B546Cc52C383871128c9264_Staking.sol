...
contract Staking is GlobalsAndUtils, Ownable, ReentrancyGuard, IERC721Receiver, Pausable {
    ...
    constructor(address _stakingToken, address _rewardingToken) {
        ...
        latestCampaignId = 1;
        latestStakeId = 242;
        penaltyAccumulated[latestStakeId] = 7488000000000000000000;
        totalStakedAmount = 611200000000000000000000;
        campaigns[latestCampaignId] = Campaign(2300, 1660546580, 1660560926, 0x422Ab9E31cC5cA8CA8266986FF4cd8fD18b68F1e);
