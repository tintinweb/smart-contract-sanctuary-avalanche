...
// File: contracts/ERC20TokenFactory.sol
...
contract ERC20TokenFactory{
    ...
    function createERC20Token(string calldata name, string calldata symbol, uint8 decimals, uint256 amount, bool mintable, address erc20Owner, address proxyAdmin) external returns (address) {
        ERC20UpgradeableProxy proxyToken = new ERC20UpgradeableProxy(logicImplement, proxyAdmin, "");
