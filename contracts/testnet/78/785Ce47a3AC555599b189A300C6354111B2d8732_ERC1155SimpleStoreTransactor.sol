...
/**
    @dev This contract will be used as a store for the ERC1155 tokens.
 */
contract ERC1155SimpleStoreTransactor is AccessControlEnumerable, Signable, Pausable {
    ...
    function buyTokens(GenericBuyV3Lib.GenericBuyV3 calldata buy) external whenNotPaused {
        require(maxTokensToBuy >= buy.amount, "!max_tokens_to_buy");
        ...
        IERC1155(nft).safeTransferFrom(multisig, msg.sender, buy.typeId, buy.amount, "");
        purchases[buy.purchaseId] = PurchaseInfo({
            typeId: buy.typeId,
            amount: buy.amount
        });
