...
contract CapitalCall is Context, Ownable, ICapitalCall,ERC1820Client {
        ...
        override
    {
        ...
        require(cc.addrToAmount[_msgSender()] < allowedInvestmentAmount,"CapitalCall: you have already made max investment");
        ...
        bool res = akusd.transferFrom(_msgSender(), address(this), _amount);
        require(res);
    }
        ...
        checkGoalReached(_id)
    {
        ...
        require(propertyAccount != address(0),"CapitalCall: property account address can not be zero");
        emit WithdrawnRaisedAmount(_id,cc.amountRaised);
        bool res = akusd.transfer(
            propertyAccount,
            cc.amountRaised
        );
        require(res);
