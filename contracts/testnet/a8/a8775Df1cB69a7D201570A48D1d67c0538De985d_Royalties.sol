...
contract Royalties is Ownable {
    ...
    uint256 public creatorRoyalties = 525; // percentage from total NFT price
    ...
    function getCreatorBalance() public view returns (uint256) {
        ...
        return (getTotalCollected() * _creatorRoyalties) / 10000 - creatorClaimed;
    }
    ...
    function getTokenTotalRoyalties() public view returns (uint256) {
        uint256 _communityRoyalties = (communityRoyalties * 100) /
            getTotalRoyalties();
        return
            ((getTotalCollected() * _communityRoyalties) / 10000) /
            collectionSize;
    }
