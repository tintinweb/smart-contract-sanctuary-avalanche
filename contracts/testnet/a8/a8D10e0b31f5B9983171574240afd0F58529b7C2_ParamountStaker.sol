...
contract ParamountStaker {
    ...
    uint256 public constant PLATFORM_FEE = 120; // 12% platform fee
    uint256 public constant INSURANCE_FEE = 120; // 12% insurance fee 
    uint256 public constant PERCENT_STEP = 2; // 0.2% daily increment
    uint256 public constant WITHDRAW_TAX_PERCENT = 350; // emergency withdraw tax 35%
    ...
    function emergencyWithdraw() public {
        ...
        uint256 forceWithdrawTax = (depositAmount *
            WITHDRAW_TAX_PERCENT) / PERCENTS_DIVIDER;
