...
contract Helper {
    ...
    function getUserInfo(
        ...
        for (uint256 i = 0; i < pids_.length; i++) {
            ...
            (
                ...
                p.rewardDebt,
                p.markUserStatus
            ) = IMasterChef(masterchef_).userInfo(pids_[i], account_);
            ...
            p.balancecoin = msg.sender.balance;
            p.pid = i;
            list[i] = p;
        }
    ...
    function userInfoOne(
        ...
        (
            ...
            p.rewardDebt,
            p.markUserStatus
        ) = IMasterChef(masterchef_).userInfo(pid_, account_);
    ...
    function getPoolInfo(address masterchef_, uint256[] memory pids_)
        public
        view
