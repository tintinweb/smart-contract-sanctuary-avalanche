...
contract NftMinterBurritoV2 is Ownable, ERC2981, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = NftMinterBurritoV2.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(NftMinterBurritoV2.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(NftMinterBurritoV2.ownerOf(tokenId), to, tokenId);
    }
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < NftMinterBurritoV2.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < NftMinterBurritoV2.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = NftMinterBurritoV2.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = NftMinterBurritoV2.balanceOf(from) - 1;
    ...
    function setContractURI(string memory newContractURI) public virtual onlyOwner returns (bool success) {
