...
contract USDTBank is Context, Ownable {
    uint256 public constant min = 3 ether;
    uint256 public constant max = 10000000 ether;
    ...
    constructor(address _teamwallet, address _mkt, address _dev) {
        ...
        tokenAdress = 0x5425890298aed601595a70AB815c96711a31Bc65; //@devmainnet using testnet for testing
