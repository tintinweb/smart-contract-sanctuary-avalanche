...
contract CryptoClowns is ERC721A, IERC2981, ReentrancyGuard, Ownable {
    uint256 maxMints = 10;
    uint256 maxFreeMints = 2;

    uint16 MAX_SUPPLY = 3333;
    uint256 public mintRate = 30000000000000000;
    
    bool public freeMintEnabled = false;
    uint public royaltyFeeInBips = 500;
    address royaltyAddress;
    bool public saleActive = false;
    string baseURI = "ipfs://QmaeDBK7Fg26tTj76KrEex7xJF9Uomn65ehjS2cdm2ME1K/";

    constructor() ERC721A("CryptoClowns", "CC") {
