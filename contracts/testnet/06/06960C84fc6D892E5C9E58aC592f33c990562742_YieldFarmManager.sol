...
contract YieldFarmManager is Ownable {
  ...
  function lpTokenAmount() public view returns (uint256) {
    (uint256 amount, ) = IMasterChefJoeV3(stakePool).userInfo(stakePoolId, address(this));
  ...
  function compound() external {
    ...
    IMasterChefJoeV3(stakePool).deposit(stakePoolId, 0);
  ...
  function _stake() internal {
    ...
    try IMasterChefJoeV3(stakePool).deposit(
      stakePoolId,
  ...
  function _unstake(uint256 _lpAmt) internal {
    IMasterChefJoeV3(stakePool).withdraw(stakePoolId, _lpAmt);
  }
