...
contract RemoteMarketplace is Ownable {
    ...
    // TODO: remove only for testing code
    address public queryBeneficiaryResult;
    address public queryPricingTokenAddressResult;
    uint256 public queryPriceResult;
    uint256 public queryFeeResult;
    uint256 public queryPurchaseIdResult;
    ...
    function handleQueryProjectResult(
        ...
        // TODO: remove only for testing code
        queryBeneficiaryResult = beneficiary;
        queryPricingTokenAddressResult = pricingTokenAddress;
        queryPriceResult = price;
        queryFeeResult = fee;
        queryPurchaseIdResult = purchaseId;
