...
contract DappiumDAOAdmin is SimpleGovernor, GovernorCounting, GovernorVotes, AccessControl {
    ...
    constructor(IVotes _token) SimpleGovernor("DappiumDAO") GovernorVotes(_token) {
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(PROPOSER_ROLE, msg.sender);
    }

    function addProposers(address[] memory _proposers) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
