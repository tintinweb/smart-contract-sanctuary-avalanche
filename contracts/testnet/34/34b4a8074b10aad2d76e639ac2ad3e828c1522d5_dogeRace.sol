...
contract dogeRace is Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    constructor(address _dogeAddress, address _biofiAddress, address payable _devWallet, uint256 _entryFee, address _dogeTraitsAddress, uint256 _speedTraitId, uint256 _enduranceTraitId, uint256 _luckTraitId) VRFConsumerBaseV2(vrfCoordinator) {
        ...
        TraitSettings memory traitSettings = TraitSettings(true, 40, 100, 40, 100, 25, 100);

        traitSettingsPerDoge[1] = traitSettings;
        traitSettingsPerDoge[2] = traitSettings;
        traitSettingsPerDoge[3] = traitSettings;
        traitSettingsPerDoge[4] = traitSettings;
        traitSettingsPerDoge[5] = traitSettings;
        traitSettingsPerDoge[6] = traitSettings;
        traitSettingsPerDoge[7] = traitSettings;
        traitSettingsPerDoge[8] = traitSettings;
        traitSettingsPerDoge[9] = traitSettings;
    ...
    function fulfillRandomWordsManual(
        ...
        for(uint256 i = 0; i < 9; i++) {
            ...
            for(uint256 j = 0; j < 9; j++) {
                ...
                uint256 winner = randomWords[i] % (totalTickets) + 1;
