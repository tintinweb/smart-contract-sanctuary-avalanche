...
import "./SongAlbumTradable.sol";

contract SongAlbumNFT is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new SongAlbumTradable contract
        ...
        returns (address)
    {
        ...
        SongAlbumTradable nft = new SongAlbumTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient
    ...
    /// @notice Method for registering existing SongAlbumTradable contract
    ...
    /// @notice Method for disabling existing SongAlbumTradable contract
    /// @param  tokenContractAddress Address of NFT contract
