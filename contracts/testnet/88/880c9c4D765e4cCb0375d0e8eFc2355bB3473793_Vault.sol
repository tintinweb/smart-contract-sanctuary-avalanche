...
contract Vault is ERC20, ReentrancyGuard, Pausable {
  ...
  function withdraw(uint256 _sharesAmt, uint256 _minTokenAReceive) external nonReentrant {
    ...
    _execute2(1, _withdrawValue, _targetLpValue, borrowA, borrowB, repayA, repayB);
  ...
  function _execute2(uint256 _depositOrWithdraw,
    uint256 _value,
    uint256 _targetLpValue,
    uint256 borrowA,
    uint256 borrowB,
  ...
  function _checkAndTransfer(
    ...
    // uint256 _equityChange = _equityBefore - getEquity();
