...
contract ArfERC721V1 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        __ERC721_init("Alloy Space ARF Beta", "ARF-BETA");
        __Ownable_init();
        __ReentrancyGuard_init();

        baseUri = "https://assets.alloy.space/token-uri-s2/";
        baseExtension = "-token-uri-s2.json";
        ...
        ARCAddress = Mintpeg(0x3E9818Beb5ADfFeFCAcaF6567A41681b9cabCbF6);
        
        NiozERC20Address = IERC20Upgradeable(
            0xB9eBa8deadd32519b0983214f8cf9D7ae6cf2212
        );

        JoepegsTokenAddress = Mintpeg(0xD01EC4A65237717B21c01aBe472599A4c5d64E50);
