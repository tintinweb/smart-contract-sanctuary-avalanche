...
// File contracts/VaporDEX/interfaces/IVaporDEXFactory.sol
...
// File contracts/VaporDEX/VaporDEXERC20.sol

pragma solidity ^0.8.12;

contract VaporDEXERC20 {
...
// File contracts/VaporDEX/libraries/Math.sol
...
// File contracts/VaporDEX/libraries/UQ112x112.sol
...
// File contracts/VaporDEX/interfaces/IERC20.sol
...
// File contracts/VaporDEX/interfaces/IVaporDEXCallee.sol
...
// File contracts/VaporDEX/VaporDEXPair.sol
...
contract VaporDEXPair is VaporDEXERC20 {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "VaporDEX: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "VaporDEX: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "VaporDEX: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0)
                IVaporDEXCallee(to).VaporDEXCall(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "VaporDEX: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
    ...
    function skim(address to) external lock {
        ...
        _safeTransfer(
            _token0,
            to,
            IERC20VaporDEX(_token0).balanceOf(address(this)) - reserve0
        );
        _safeTransfer(
            _token1,
            to,
            IERC20VaporDEX(_token1).balanceOf(address(this)) - reserve1
        );
    }
...
// File contracts/VaporDEX/VaporDEXFactory.sol
...
contract VaporDEXFactory is IVaporDEXFactory {
    ...
    function setFeeCollectorSetter(address _feeCollectorSetter)
        external
        override
    {
        require(msg.sender == feeCollectorSetter, "VaporDEX: FORBIDDEN");
