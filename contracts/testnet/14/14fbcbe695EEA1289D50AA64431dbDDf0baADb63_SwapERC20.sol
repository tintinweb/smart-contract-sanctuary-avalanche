...
contract SwapERC20 {
    ...
    // ) private returns (uint256 amountOut) {
    //    amountOut = swapExactInputSingle(amountIn, amountOutMinimum, tokenIn, tokenOut);
    //    IERC20Handler.depositERC20(tokenIn, amountIn, bundle_, network_, receiver, isWrapped);
