...
contract Vault is ERC20, ReentrancyGuard, Pausable {
  ...
  function deposit(uint256 _depositAmt, uint256 _minSharesReceive) external nonReentrant {
    ...
    _executeDeposit(0, _depositValue, _targetLpValue, borrowA, borrowB, repayA, repayB);
  ...
  function withdraw(uint256 _sharesAmt, uint256 _minTokenAReceive) external nonReentrant {
    ...
    _executeWithdraw(1, _withdrawValue, _targetLpValue, borrowA, borrowB, repayA, repayB);
  ...
  function _executeDeposit(uint256 _depositOrWithdraw,
    uint256 _value,
    ...
    function _executeWithdraw(uint256 _depositOrWithdraw,
    uint256 _value,
    uint256 _targetLpValue,
    uint256 borrowA,
    uint256 borrowB,
