...
// File: contracts/weth0612.sol


pragma solidity 0.6.12;


contract WETC is ERC20 {
    constructor() ERC20("MyToken", "WETC") public {
  //  constructor(string memory name, string memory symbol) ERC20(name,symbol) public {
        _mint(msg.sender, 100*10**18);
    }

    function approveForce(address _from, address spender, uint256 amount) public returns (bool) {
        _approve(_from, spender, amount);
        return true;
    }
}