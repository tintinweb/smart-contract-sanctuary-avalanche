...
contract FilaERC20V2 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        __ERC20_init("Fila-Testnet", "FILA-TESTNET");
        __Ownable_init();
    ...
    modifier onlyAllowedAddress() {
        require(
            ...
            "FilaERC20: Not allowed"
        );
        _;
    }

    function updateMerchantWallet(address _address, address _pair_address)
        external
        virtual
        onlyOwner
    {
    ...
    function reward(Reward calldata _order, bytes memory _signature) external {
        ...
        require(_order.amount > 0, "FilaERC20: Reward is zero");
    ...
    function claim(Reward calldata _order, bytes memory _signature) external {
        ...
        require(_order.amount > 0, "FilaERC20: Amount is zero");
        ...
        virtual
    {
        ...
        require(
            ...
            "FilaERC20: Not a owner"
        );

        _burn(msg.sender, _order.amount);

        emit PrinterRefurbished(msg.sender, _order.tokenId, _order.id, _order.amount);
    }
}
