...
/**
* @title SalvorCollection
*/
contract SalvorCollection is ERC721, ERC721Enumerable, ERC2981, ReentrancyGuard, Ownable {
    ...
    */
    ...
    constructor(address _receiver) ERC721("test", "TST") {
        maxCap = 10050;
        _setDefaultRoyalty(_receiver, 800);
    }
    ...
    */
    ...
    /**
    * @dev Toggle the public sale state.
    * @param _part The index of the whitelist part to update.
    * @param _isPublicSaleActivated The boolean value indicating whether the public sale is activated or not.
    */
    ...
    /**
    * @dev Toggle the whitelist sale state.
    * @param _part The index of the whitelist part to update.
    * @param _isWlSaleActivated The boolean value indicating whether the whitelist sale is activated or not.
    */
    ...
    /**
    * @dev Sets the maximum capacity and price for a specific public sale part.
    * @param part The index of the whitelist part to update.
    * @param _maxCap The new maximum capacity for the public sale part.
    * @param _price The new price for each token in the public sale part.
    */
    ...
    /**
    * @dev Sets the maximum capacity and price for a specific whitelist part.
    * @param part The index of the whitelist part to update.
    * @param _maxCap The new maximum capacity for the whitelist part.
    * @param _price The new price for each token in the whitelist part.
    */
    ...
    /**
    * @dev Set allowed token amounts for users in a specific whitelist
    * @param _part Index of the whitelist
    * @param _users Array of user addresses
    * @param _allowedAmounts Array of allowed token amounts for each user
    */
    ...
    /**
    * @dev Mint function for whitelist sales.
    * @param _part The whitelist part to mint from.
    ...
    */
    ...
    /**
    * @dev Mints a specified amount of tokens to the sender in the public sale.
