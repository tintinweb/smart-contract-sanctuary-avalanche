...
contract GamePool is Ownable, ReentrancyGuard {
    ...
    function fillRewardEth(uint weekNum) public payable onlyOwner {
        require(tokenAddress == address(0), "Use ERC20 reward");
    ...
    function getSharePercent() public returns (uint share) {
        ...
        share = (investorAmount * 100) / totalPool;
    }

    function claimAll() public nonReentrant returns (uint) {
