...
AVAX Space Miner
 Mine, Earn, Compound and Sell. 
  8% daily daily Rate
  7% Referral Bonus, will go directly to referrer wallet.
  3% stacking compound bonus every 12 hrs, max of 12 times(6days , 36% total bonus)
  48 hours cut off time. Earnings will stop when cut off time hits 0.
  0.1 AVAX minimum investment.
  100 AVAX max deposits per wallet.
