...
contract LynxDividendDistributor is ILynxDividendDistributor {
    ...
    IERC20 reflectionToken = IERC20(0xB6076C93701D6a07266c31066B298AeC6dd65c2d); // Test USDC Fuji Testnet
    address WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c; // Fuji Testnet
    IJoeRouter02 router;
    ...
    constructor (address _router) {
        router = _router != address(0) ? IJoeRouter02(_router) : IJoeRouter02(0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901); // Fuji Testnet
        _token = msg.sender;
    }
...
contract Lynx is IERC20, IERC20Metadata, LynxAuthorization {
    ...
    address public treasuryFeeReceiver = 0xF877eaa759D512D784288cb09E6D5c034551e5dD;
    address public devFeeReceiver = 0x92EfEff2546FBF02CfDc1bF570e2a5e7835b3662;

    address public reflectionToken = 0xB6076C93701D6a07266c31066B298AeC6dd65c2d; // Test USDC Fuji Testnet
    address public WAVAX = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c; // Fuji Testnet
    ...
    address ROUTERADDR = 0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901; // Fuji Testnet
