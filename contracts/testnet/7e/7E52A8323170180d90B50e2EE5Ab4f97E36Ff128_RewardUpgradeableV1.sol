...
contract RewardUpgradeableV1 is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function claimBonus(uint[] memory tokenIDList) public {
        ...
        TresrCoinUpgradeableV1(_tokenAddressContract).mint(msg.sender, amountReward, 2);
    }
    ...
    function claimBase(uint tokenID) public {
        ...
        TresrCoinUpgradeableV1(_tokenAddressContract).mint(msg.sender, reward, 1);
    }
...
contract TresrCoinUpgradeableV1 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function mint(address account, uint amount, uint typeAllocation) public onlyAdmin {
        if (typeAllocation == 1) {
            require(poolAllocation > 0, "TresrCoin: zero allocation");
            ...
            require(bonusPoolAllocation > 0, "TresrCoin: zero allocation");
