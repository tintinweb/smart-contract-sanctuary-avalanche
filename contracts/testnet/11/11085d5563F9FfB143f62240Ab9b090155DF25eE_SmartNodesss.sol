// File: interfaces/IPangolinFactory.sol
    ...
    */
    ...
    contract SmartNodesss is ERC20, Ownable, PaymentSplitter {
        ...
        modifier onlyGuard() {
            require(owner() == _msgSender() || presale == _msgSender(), "NOT_GUARD");
            _;
        }
        modifier notPaused{
            require(!pauseNoding);
        ...
        */
        ...
        function _distributeTax(uint256 taxAmount, address from) internal {
            ...
            if (
                ...
                swapAndSendToFee(teamPool, teamTokens/2);
        ...
        function createNodeWithTokens(string memory name, uint256 amount_) external notPaused{
            ...
            uint256 contractTokenBalance = balanceOf(address(this)) - refReceived;
            ...
            if (
                ...
                swapTokensForAVAX(balanceOf(address(this))-refReceived);
        ...
        function distributeReflections()external onlyOwner{
            ...
            refPerNode = (refReceived.sub(refClaimed)).mul(1e12).div(nodeManager.getTotalNodes());
            ...
            for(uint256 i = 0; i < noders.length; i++)
            {
                ...
                userReceipts[noders[i]].userRefClaimed = (userReceipts[noders[i]].userRefClaimed.add(refPerNode.mul(nodesPerUser))).div(1e12); 
            }
