...
interface IVesting {
    /// @notice Enumeration of vesting AllocationType
    /// @dev Enumeration of vesting AllocationType
    enum AllocationType {
        Seed,
        Private
    }
    ...
    /// @param allocationType thetype of vesting AllocationType
    event AddInvestors(
        address[] investors,
        uint256[] amounts,
    ...
    /// @param _investors the array of investors
    /// @param _amounts the amount of tokens
    /// @param _allocationType thetype of vesting AllocationType
    function addInvestors(
        address[] calldata _investors,
        uint256[] calldata _amounts,
        AllocationType _allocationType
...
contract Management is OwnableUpgradeable {
