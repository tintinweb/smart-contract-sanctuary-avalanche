...
contract NodeWhalesNFT is ERC721, Ownable {
  ...
  constructor() ERC721("Node Whales", "NWNFT") {
    mintPrice = 3000000;
    totalSupply = 0;
    maxSupply = 2500;
    maxPerWallet = 25;
    ...
    withdrawWallet = 0xb93D019199F57F5B38CA778E369f30F822f869e3;
  ...
  function setUSDCEAddress(address _usdceAddress) external onlyOwner {
  ...
  function mint(uint256 quantity_) public {
    ...
    require(
      ...
      "You can only mint 25 NFTs."
    );
    IERC20(usdceAddress).transferFrom(
      msg.sender,
      address(this),
      quantity_ * mintPrice
    );
  ...
  function whitelistMint(uint256 quantity_) public onlyOwner {
    require(isPublicMintEnabled, "Minting is inactive.");
    require(totalSupply + quantity_ <= maxSupply, "Sold out.");
