...
contract SwapEngine is ISwapEngine {
    ...
    function _execute() internal running {
        ...
        uint256 totalFeesCollected = _treasuryFeesCollected.add(_lrfFeesCollected).add(_safeExitFeesCollected);
        ...
        uint256 treasuryETH = amountETH.mul(_treasuryFeesCollected).div(totalFeesCollected);
        uint256 safeExitETH = amountETH.mul(_safeExitFeesCollected).div(totalFeesCollected);
