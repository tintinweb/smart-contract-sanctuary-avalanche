...
contract OERC1155 is ERC1155Supply, ONFT1155Core, IONFT1155 {
    constructor(
        string memory uri_,
        address endpoint_
    ) ERC1155(uri_) ONFT1155Core(endpoint_) {}
...
// File: contracts/OERC1155Wrapped.sol


pragma solidity ^0.8.0;


contract OERC1155Wrapped is OERC1155 {
    // Token name
