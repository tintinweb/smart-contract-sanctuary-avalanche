...
contract GAMENFT is ERC721, Ownable {
    ...
    uint256 public nftReserve = 0; // Reserve 0 NFTs for team & community (Used in giveaways, events etc...)
    ...
    function chooseTokenId() public virtual returns (uint256) {
        uint256 index = (_getRandom() % pendingCount) + 1;
        publicTokenId = _popPendingAtIndex(index);
