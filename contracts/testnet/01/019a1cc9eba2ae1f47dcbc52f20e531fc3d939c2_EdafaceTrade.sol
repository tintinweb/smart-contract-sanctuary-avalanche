...
contract EdafaceTrade is Initializable, OwnableUpgradeable {
    ...
    function orderPlace(
        ...
        require(_price > 0 || msg.sender == owner(), "Price Must be greater than zero");
    ...
    function batchListing(uint256 price, uint256[] memory tokenId, uint256 _type) public {
        for (uint256 i = 0; i < tokenId.length; i++) {
            orderPlace(tokenId[i], price, edaface1155, _type, "order");
        }
    }
