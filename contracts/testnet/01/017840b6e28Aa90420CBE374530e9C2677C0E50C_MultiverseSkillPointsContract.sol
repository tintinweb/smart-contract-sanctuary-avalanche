/**
 *Submitted for verification at testnet.snowtrace.io on 2022-12-29
*/
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 100, 2500) { }
    uint8 constant public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeifiph3pvq7uv2f2czwh6fhamuw2w45k5kfzd3sgihvnkz3j537ipa/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/vHKHizIemWtYK2722yY3/contract-metadata";
  }
...
// File: contracts/MultiverseSkillPointsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MultiverseSkillPointsContract is RamppERC721A {
    constructor() RamppERC721A("Multiverse SKILL Points", "SKILL"){}
}
