...
contract ERC20DriverFacet is IERC20Driver {
    ...
    function tranferToOtherChainERC20(
        ...
        LibERC20Driver.tranferToOtherChain(_transferedToken, _amount, _targetChainName, _recipient);
    }
    ...
    function tranferFromOtherChainERC20(
        ...
        LibERC20Driver.tranferFromOtherChain(
            _externalNonce,
            _originalChainName,
...
interface IERC20Driver {
    ...
    function balancesERC20(string calldata _originalChainName,
        string calldata _originalTokenAddress, address _account) external view returns (uint256);
}
...
import { LibValidatorController } from "./LibValidatorController.sol";
import { UniversalAddressUtils } from "../../utils/UniversalAddressUtils.sol";
    ...
    function tranferFromOtherChain(
        ...
        if (currentChainNameHash == targetChainNameHash) {
            ...
            if (currentChainNameHash == originalChainNameHash) {
                ...
                address issuedTokenAddress = getIssuedTokenAddressOrPublishTokenIfNotExists(
                    _originalChainName,
                    _originalTokenAddress,
                    _tokenCreateInfo
                );
...
library LibValidatorController {
    ...
    function enforceIsValidator() internal view {
        require(msg.sender == diamondStorage().validator, "LibValidatorController: Must be validator");
    }
