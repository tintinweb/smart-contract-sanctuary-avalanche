...
contract Land is ExtendERC721 {
    ...
    constructor() ExtendERC721("Dogeon Land", "DOGEL") {}
    ...
    function mint(address _to, string memory _metadataId)
        ...
        returns (uint256)
    {
        uint256 newLandId = increment();

        _mint(_to, newLandId);
        _setMetadata(newLandId, _metadataId);

        emit LandCreated(_to, newLandId, _metadataId);
