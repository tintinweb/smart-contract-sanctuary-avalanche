...
contract ParticleHolder {
    ...
    /// @dev Internal function to modify managers state
	/// @param _managers Approved addresses to execute the 'getParticlesFrom' function
    function addManagersInternal(address[] memory _managers) internal {
    ...
    /// @dev Public function to modify managers state
	/// @param _managers Approved addresses to execute the 'getParticlesFrom' function
    function addManagers(address[] memory _managers) public onlyManagers {
        addManagersInternal(_managers);
    }
