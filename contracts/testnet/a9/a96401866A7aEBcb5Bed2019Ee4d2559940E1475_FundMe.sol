...
contract FundMe {
    ...
    function fund() public payable {
        ...
        require(
            ...
            "You need to spend atleast 50$ worth of AVAX"
        );
    ...
    // Using AVAX/USD Avalanche Fuji price feed: 0x5498BB86BC934c8D34FDA08E81D444153d0D06aD
    ...
    function getPrice() public view returns (uint256) {
        ...
        return uint256(answer * 10**10); // make it 10^18 to match wei denomination
    }
