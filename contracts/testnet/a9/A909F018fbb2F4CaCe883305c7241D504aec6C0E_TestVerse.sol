...
contract TestVerse is ERC721, Ownable {
  ...
  constructor() ERC721("TestVerse", "TV") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House", 1,3,2,2,0,3));
    buildings.push(Building("Davids House", 2,5,4,10,0,6));
    buildings.push(Building("Gallery", 1,6,2,10,0,0));
    buildings.push(Building("House", 1,1,2,7,0,-7));
    buildings.push(Building("Cool House", 2,3,5,-2,0,4));
    buildings.push(Building("House", 3,7,2,-4,2,0));
    buildings.push(Building("Ghost House", 4,1,4,3,8,10));
    buildings.push(Building("Beeach House", 1,1,2,5,0,8));
    buildings.push(Building("Library", 3,5,6,-3,6,0));
    buildings.push(Building("House", 5,9,3,-2,0,1));
    buildings.push(Building("Ray House", 1,3,2,0,-4,5));
  }
