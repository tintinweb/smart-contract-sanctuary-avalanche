...
contract DefaultPool is Ownable, CheckContract, IDefaultPool, PoolBase2 {
     ...
     * @dev see notice
     * @return array of addresses of tokens, array of uint256 of amounts for each token
     */
    ...
    */
    ...
    function getVC() external view override returns (uint256 totalVC) {
        ...
        for (uint256 i; i < len; ++i) {
            ...
            totalVC = totalVC.add(controller.getValueVC(collateral, amount));
        }
    }
    ...
    function getVCforTCR() external view override returns (uint totalVC, uint totalVCforTCR) {
        ...
        for (uint256 i; i < len; ++i) {
            ...
            (uint256 VC, uint256 VCforTCR) = controller.getValueVCforTCR(collateral, amount);
    ...
    /**
     * @notice Debt that this DefaultPool holds.
     * @return uint256 YUSDDebt amount 
    */
        ...
        override
    {
        ...
        for (uint256 i; i < tokensLen; ++i) {
            ...
            if(thisAmounts != 0) {
                ...
                // reward. 
                if (controller.isWrapped(thisToken)) {
    ...
    /**
     * @notice Increases the YUSD Debt of this pool. 
     * @param _amount Amount to increase debt by
     */
    ...
    /**
     * @notice Decreases the YUSD Debt of this pool.
     * @param _amount amount to decrease debt by 
    */
    ...
    // --- 'require' functions ---
    /**
     * @notice basic modifier function that checks msg.sender is not an active pool 
     */
    ...
    /**
     * @notice basic modifier function that checks msg.sender is not a trove manager
     */
    ...
    /**
     * @notice basic modifier function that checks msg.sender is not a controller
     */
     ...
     * @param _tokens array of addressses
     * @param _amounts array of uint256s
     */
