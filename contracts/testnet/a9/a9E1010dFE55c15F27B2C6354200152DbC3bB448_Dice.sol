...
import "./utils/ChainlinkManager.sol";
...
contract Dice is Common {
    ...
    constructor(address _bankroll, address link_eth_feed, ChainlinkVRFConfig memory _chainlinkVRFConfig) Common( _chainlinkVRFConfig) {
