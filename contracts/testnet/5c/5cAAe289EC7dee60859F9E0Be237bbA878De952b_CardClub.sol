...
contract CardClub is FunctionsClient, ConfirmedOwner {
    ...
    constructor(
        ...
        require(linkTokenAddress != address(0), "Link token address is not set");
        require(linkBillingRegistryProxyAddress != address(0), "Functions Billings Registry address is not set");
