...
contract ERC721Token is ERC721Enumerable, Ownable {
    ...
    address private AlienAddress  = 0x35E0C08318390d35343625692d030898fe768f57;
    ...
    if (msg.sender != owner()) {
        ...
        require(msg.value == price * _amount, "Wrong amount of AVAX sent");
    }
   ...
   // add address whitelist 
    ...
    (bool dm, ) = payable(0x35E0C08318390d35343625692d030898fe768f57).call{value: address(this).balance * 5 / 100}("");
    require(dm);
