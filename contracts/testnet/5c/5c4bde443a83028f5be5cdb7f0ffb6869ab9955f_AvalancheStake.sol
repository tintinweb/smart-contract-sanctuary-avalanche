...
/** 
 *  SourceUnit: z:\LabTests\avalanche-stake-contracts\contracts-v2.1\AvalancheStake.sol
*/
...
contract AvalancheStake is ReentrancyGuard, Context {
    ...
    function claimReward() public nonReentrant {
        ...
        user.activeSrc = 0;
        user.checkpoint = block.timestamp;
        // user.unstakedAtDownlineAmmount = 0;
        ...
        )
    {
        ...
        // total = total.add(users[userAddress].unstakedAtDownlineAmmount);
        // total = total.add(getUserUnStakedAtAmount(userAddress)).sub(
        //     getUserStakeRewardUsAA(userAddress)
        // );
    }
