...
contract BNFTRegistry is IBNFTRegistry, Initializable, OwnableUpgradeable {
     ...
     */
    function setBNFTGenericImpl(address genericImpl)
        external
        override
        nonReentrant
        onlyOwner
    ...
    function batchUpgradeBNFT(address[] calldata nftAssets)
        external
        override
        nonReentrant
        onlyOwner
    ...
    function _createProxyAndInitWithImpl(address nftAsset, address bNftImpl)
        internal
        returns (address bNftProxy)
    {
