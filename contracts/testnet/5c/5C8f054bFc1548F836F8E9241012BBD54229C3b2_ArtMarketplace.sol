...
contract ArtMarketplace is OwnableUpgradeable, ReentrancyGuardUpgradeable, ERC721HolderUpgradeable, PausableUpgradeable {
    ...
    * @param _rewardGenerationRate ...
    * @param _initialFloorPrice ...
    * @param _floorPriceThresholdNodeCount ...
    * @param _lockDuration ...
    * @param _floorPriceIncreasePercentage ...
    * @param _commissionPercentage ...
    */
    ...
    */
    function withdrawNFT(address _lpAddress, uint256 _tokenId) external whenNotPaused nonReentrant {
        ...
        require(block.timestamp - listedNFT.startedAt > listedNFT.lockDuration, "The minimum withdrawal duration has not been met, the NFT cannot be withdrawn yet.");
    ...
    */
    function endRewardPeriod(address _lpAddress, uint256 _tokenId) public whenNotPaused {
        ...
        PoolInfo memory pool = pools[_lpAddress];
        require(block.timestamp - listedNFT.startedAt > listedNFT.lockDuration, "The NFT's reward period has not yet expired");
