...
contract AvaxBunnies is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  address[] private _team = [
        0xE148b181737BE24359Cd8b268487311e4172A032
    ];
    uint[] private _teamShares = [
        100
    ];
  constructor( bytes32 _merkleRoot, string memory _theBaseURI) ERC721('Avax Bunnies', 'AB') PaymentSplitter(_team, _teamShares){
