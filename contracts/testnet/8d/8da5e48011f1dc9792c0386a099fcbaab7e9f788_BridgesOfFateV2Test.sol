...
// File contracts/BridgesOfFateV3.sol
...
contract BridgesOfFateV2Test is Ownable, ReentrancyGuard {
    ...
    // uint256 public startPeriod = 0; // beacuse startPeriod period are noted in when Admin Game
     ...
     * @param _nftId
     */
    function entryFeeForSeriesOne(uint256 _nftId) public {
     ...
     */
    function entryFeeSeriesTwo(uint256 _nftId, uint256 _wrappedAmount) public {
        ...
        */
        ...
        PlayerTimeStatusAgainestDay[_member.day][playerId] =
         false;
        Player[playerId] = _member;
...
//         GameStatus memory _gameStatus   = GameStatusInitialized[0];
//         uint256[] memory ret;
