    ...
    PausableUpgradeable
{
    ...
    function initialize(address yielKeyLegendary, string memory _initURI)
        public
        initializer
    {
        __ERC721_init_unchained("Stakeing Legendary", "STKLeg");
        __Ownable_init();
        __Pausable_init();
        ...
        whenNotPaused
    {
        ...
        for (uint256 i; i < tokenIds.length; i++) {
            ...
            // Reset Maintenance Fee
						console.log("ERC721 VALIFi: Reset Maintenance Fee");
    ...
    /**
     * @dev Verify if the address is owner of one or several Yield-Keys Legendary
     * @param _wallet Wallet address of the owner
     * @return tokenIds Array of token Ids of Yield-Keys Legendary owned by the wallet
     */
    ...
    /**
     * @dev Verify is the address is owner of one or several Yield-Keys Legendary
     * @param _owner address to owner of the tokens
     * @return stakeTokenIds tokenIds Array of token Ids of Yield-Keys Legendary who the _owner address is the owner
     */
    ...
    function _beforeTokenTransfer(
        ...
        require(
            !paused(),
            "ERC721 VALIFi: can't staked or transfer any YieldKey Legendary while paused"
        );
        if (from != address(0)) {
            require(
