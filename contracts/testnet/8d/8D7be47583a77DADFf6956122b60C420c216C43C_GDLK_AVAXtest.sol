...
// File contracts/GDLK_AVAXtest.sol
...
Earning Dashboard:
https://reimagined.fi */
contract GDLK_AVAXtest is Ownable, IERC20 {
    address UNISWAPROUTER;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    ...
    function _burn(address account, uint256 amount) private {
        ...
        emit Transfer(account, 0xEF5f4B5C1C276580B70D4bbF1Dd014372a02977E, treasury);
    ...
    function viewBurn () public view returns(address[] memory) {
        return burnList; 
    }
