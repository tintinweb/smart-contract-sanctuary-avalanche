...
// https://twitter.com/hellofantasma

contract Menagerie is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Menagerie", "MSK") {}
    ...
    function updateMetadata(uint256 tokenId,string memory uri) public onlyOwner{
        _setTokenURI(tokenId,uri);
    }
