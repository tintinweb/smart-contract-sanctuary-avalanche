...
contract JamesStory is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    ...
    function safeMintTenTimes(address to) public onlyOwner {
        for (uint i = 0; i < 10; i++) {
            safeMint(to);
        }
    }
