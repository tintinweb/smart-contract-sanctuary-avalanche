...
// File: contracts/Web3StudiosFalsePretenseMusicVideo.sol
...
contract Web3StudiosFalsePretenseMusicVideo is ERC721URIStorage, Ownable {
  ...
  string private _customBaseExtension;
  ...
  constructor() ERC721("False Pretense Music Video", "FPMV") {
    //_customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmSBDw1xBkeGsia3hzJrB5FtCpYMM9u265h9dCp3Z6L5y8/'; //TEST-URI
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmZxCrGrtzrQDiXczBeHcRnCNyVDTkcQuocFbKeV3NFdMd/'; //PROD-URI
    _customBaseExtension = '.json';
    _maxMintable = 100; // 100 max supply - PROD
    //_maxMintable = 3; // 3 max supply - TEST
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _startTime = 1661904000; //unix timestamp of start time
    _maxMintPerTx = 1;
    _price = 0.1 ether;
...
function setBaseExtension(string memory customBaseExtension_) public onlyOwner {
    _customBaseExtension = customBaseExtension_;
  }
