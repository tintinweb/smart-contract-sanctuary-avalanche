...
contract TESTINsin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address public autoLiquidityReceiver=0x71df6db54fA3de641106c884bAa66948049040d2;
    address public marketingFeeReceiver=0x71df6db54fA3de641106c884bAa66948049040d2;

    string constant _name = "TESTINsin";
    string constant _symbol = "TESTINsin";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 9_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(99);
	uint256 public _maxWallet = _totalSupply.div(99); 
