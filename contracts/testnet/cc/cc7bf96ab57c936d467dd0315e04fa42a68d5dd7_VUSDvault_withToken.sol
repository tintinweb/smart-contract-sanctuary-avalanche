...
contract VUSDvault_withToken is Ownable {    
    ...
    uint256 public devRoyaltyForWithdraw = 200; // 20% of withdraw
    ...
    uint256 public devRoyaltyForWithdrawPrice = 25 * 10 ** 18; // ERC20 Token Price
    ...
    function setERC20TokenPrice(uint256 _price) public {
