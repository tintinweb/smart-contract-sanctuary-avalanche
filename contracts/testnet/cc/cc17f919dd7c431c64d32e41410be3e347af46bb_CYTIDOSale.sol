...
contract CYTIDOSale is Ownable  {

    /**
     * @dev Constructor FAQ:
     * @param token adress of token which is goes to sale on IDO
     * @param currency address of token which users will pay on IDO, and will be withdrawed by Owner in the _claimTime period
     * @param cap maximum of tokens to sale in IDO
     * @param _startTime currency deposit period start.
     * @param _releaseTime currency withdraw period start.
     * @param _claimTime token withdraw and owner withdrawIDO period start.
     * @param _endTime end of token withdraw period.
     */
    ...
    uint256 private minDepositValue = 10;
    uint256 private minWithdrawValue = 1;
    ...
    {
        require(claimTime <= block.timestamp && endTime > block.timestamp, "No time for claim");
