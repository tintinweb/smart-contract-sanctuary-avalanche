...
contract PolarWLsale is Crowdsale, TimedCrowdsale
{
    ...
    constructor(uint allocationCap_, uint hardCap_, uint numerator_, uint denominator_, address subject_, address token_, address MultisigWallet_, uint openingTime, uint closingTime, address distribPool)
