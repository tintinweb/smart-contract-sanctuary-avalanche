...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
    ...
    event RaffleEnter(address indexed player, RaffleState raffleState, uint32 ticketsSold, uint32 bonusTickets);
    ...
    function enterRaffle(string memory promo) public payable {
        ...
        if (s_campaigns[s_raffleId].length > 0) {
            bytes32 promoHash = keccak256(abi.encodePacked(promo));
        ...
        emit RaffleEnter(msg.sender, s_raffleState, realTickets, bonusTickets);
    }
