...
contract TestSwap {
    ...
    function getPair2222(address fv, address tokenX, address tokenY) public view returns(address pair) {
        pair = IJoeFactory(fv).getPair(tokenX, tokenY);
    }

    function getPair3333(address fv, address tokenX, address tokenY) external view returns(address pair) {
        pair = IJoeFactory(fv).getPair(tokenX, tokenY);
    }

    function getPair4444(address tokenX, address tokenY) external view returns(address pair) {
        pair = IJoeFactory(_factoryV1).getPair(tokenX, tokenY);
    }
...
--constructor-args "0x8e42f2f4101563bf679975178e880fd87d3efd4e" "0xf5c7d9733e5f53abcc1695820c4818c59b457c2c" "0x6b8e020098cd1b3ec9f811024bc24e51c660f768" "0x0000000000000000000000000000000000000000" "0x0000000000000000000000000000000000000000"

-》 0x80C6c077Fe650Bf30E6A49Ec5F729aa8303D8e86
