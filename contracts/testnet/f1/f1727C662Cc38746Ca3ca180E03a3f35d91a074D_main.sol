...
contract main is ERC20, Ownable {
    ...
    uint256 public marsFee;
    uint256 public transferFee;
    uint256 public supply;
    address public mars;
    address public _nodeManager;
    uint256 public _nodeAmount;
    ...
    constructor(
    	...
    	//
    	//	}
        treasury = 0xa541B695a103DFbfd9aeF05b96927F19f8DfF61d;//addresses[0];
        teamPool = 0x603c3b88eDE14645942eFE8CbED0213c1E1a8053;//addresses[1];
        rewardsPool = 0x29f56AB0b8e4060A13047E68eE073742F2e930Be;//addresses[2];
        mars = 0x542128bc3591BC580BC9e7421ebAF805EAfC457F;//addresses[3];
        _overseer = 0x9639D4D38C1a3AA2bCf8ED60A9Cd33F7281fA28A;//addresses[4];
        _overseer_ =  overseer(_overseer);
        feeToken = 0x6A19E766F7103B2Cc5E61D78457cBd8F0E8B7bFE;//addresses[5];
        _feeToken = IERC20(feeToken);
        _nodeManager = 0x28f3816A67d818344c66De0Ab3d559c4DE035F48;//addresses[6];
    	...
    	//}
        teamPoolFee = 20;//fees[0];
        rewardsFee = 10;//fees[1];
        treasuryFee = 20;//fees[2];
        marsFee = 50;//fees[3];
        liquidityPoolFee =10;// fees[4];
        cashoutFee = 10;//fees[5];
        rwSwap = 10;//fees[6];
        transferFee = 50;//fees[7];
    ...
    function logFees(uint256 _rewardsPoolFee, uint256 _TreasuryFee, uint256 _teamFee, uint256 marsFee, uint256 _transferFee, uint256 _NFTFee,uint256 _cashoutFee, uint256 _nodeFees, address _account, uint256 _rewards) private{
		...
		rndm_ls2 = [_rewardsPoolFee,_transferFee,_teamFee,_NFTFee,_TreasuryFee,_cashoutFee];
    		...
    		allFees[_account].mars += rndm_ls2[3];
   ...
   function Send_it(address _account, address destination, uint256 tokens) private {
    ...
    function createNodeWithTokens(string memory name) external {
        ...
        logFees(myLib.doPercentage(nodeAmount,rewardsFee),myLib.doPercentage(nodeAmount,teamPoolFee),myLib.doPercentage(nodeAmount,treasuryFee),Zero,Zero,Zero,Zero,Zero,sender,Zero);
