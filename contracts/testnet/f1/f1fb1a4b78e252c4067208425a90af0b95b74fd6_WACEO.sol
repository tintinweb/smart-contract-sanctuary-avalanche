...
abstract contract Distributed is ERC20, VaultOwned {
    ...
    function mint_IdoDistribution () external onlyVault returns(bool){
    ...
    function mint_AutoDistribution () external onlyVault returns(bool) {

      require(autoDistribution.totalAmount > 0, "AUTO_Distribution: Total distribution amount not set");
      ...
      uint256  _LP_Controller_Value = autoDistribution.totalAmount.mul(autoDistribution.LP_Controller._amount.div(10**9)).div(100);
      uint256  _Founding_Team_Value = autoDistribution.totalAmount.mul(autoDistribution.Founding_Team._amount.div(10**9)).div(100);
      uint256  _WACEO_LP_Rewards_Value = autoDistribution.totalAmount.mul(autoDistribution.WACEO_LP_Rewards._amount.div(10**9)).div(100);
      uint256  _WACEO_Operational_Value = autoDistribution.totalAmount.mul(autoDistribution.WACEO_Operational._amount.div(10**9)).div(100);
      uint256  _WACEO_Dev_Value = autoDistribution.totalAmount.mul(autoDistribution.WACEO_Dev._amount.div(10**9)).div(100);
      uint256  _WACEO_Regulations_Value = autoDistribution.totalAmount.mul(autoDistribution.WACEO_Regulations._amount.div(10**9)).div(100);
      uint256  _WACEO_Unrekt_Value = autoDistribution.totalAmount.mul(autoDistribution.WACEO_Unrekt._amount.div(10**9)).div(100); 
