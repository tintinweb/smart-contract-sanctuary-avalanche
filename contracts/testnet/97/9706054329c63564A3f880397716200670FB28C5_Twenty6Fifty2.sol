...
contract Twenty6Fifty2 is ERC721A, EnefteOwnership {
    ...
    uint64 public TOKEN_PRICE = 0.001 ether;
    ...
    */
    ...
    function setMultiplier(address _to, uint _tokenId, uint _tier) external onlyOwner {
        handMultiplier[_tokenId] = _tier;
        
        uint256 totalEmissions = calculateEmissions(_tokenId,1);
        foldStaking.deposit(totalEmissions,_to);
    }
