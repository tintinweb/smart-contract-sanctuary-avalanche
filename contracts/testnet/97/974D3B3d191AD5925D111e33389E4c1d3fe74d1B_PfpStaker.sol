...
contract PfpStaker is IPfpStaker, ReentrancyGuard, Owned, NFTreceiver {
	 ...
	 * @param roundtableFactory_ The address of the roundtable factory
	 */
	constructor(
		address deployer,
		address shieldContract_,
		address roundtableFactory_
	) Owned(deployer) {
	...
	/**
	 * @notice Set Roundtable Factory - this address can set stakers directly. This happens on multisig creation.
	 * @param roundtableFactory_ Address of multisig factory
	 */
