...
contract NFTRenting is Context{
    ...
    // checkIsRented
    function setForRent(string memory rentId, address nftAddress, uint256 nftId, uint256 price, uint256 period) public onlyTokenOwner(nftAddress, nftId){
        tokensForRents[rentId] = RentalInfo(nftAddress, nftId, _msgSender(), price, period);
