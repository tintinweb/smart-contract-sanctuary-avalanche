...
contract MoonFinance is IERC20 {
    ...
    uint256 public _holderFees = 900 ; // 900 = 9% 
    
    uint256 public _lpFeeTotal;
    uint256 public _marketingFeeTotal;
    
   
    address public marketingAddress  = 0x2501E79052e090de1529F9bc2EE761A89F62d82e;      // MarketingAddress
   ...
   function ExcludedFromFee(address account, bool permit) public onlyOwner {
    ...
    require(msg.value == tokenPrice * _amount , "payable value should me equal to tokens price" );
