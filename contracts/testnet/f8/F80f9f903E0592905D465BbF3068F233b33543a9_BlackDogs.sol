// SPDX-License-Identifier: MIT
    ...
    contract BlackDogs is ERC721, Ownable, ERC721Enumerable {
      ...
      event BlackDogsMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("BlackDogsNew", "BDS") {}
      ...
      function mintdogs(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit  BlackDogsMinted(id, msg.sender);
          }
        }
      }
    
      function presaleDogs(uint256 numberOfTokens) external payable {
