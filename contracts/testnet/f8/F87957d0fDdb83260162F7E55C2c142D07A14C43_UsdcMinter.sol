...
contract UsdcMinter is UUPSUpgradeable, AccessControlUpgradeable {
    ...
    event UsdcMinted(bool success, uint256 balBefore, uint256 balAfter);
    ...
    {
        uint256 balBefore = IERC20Upgradeable(usdc).balanceOf(reserveHandler);
        bool success = messageTransmitter.receiveMessage(message, attestation);
        uint256 balAfter = IERC20Upgradeable(usdc).balanceOf(reserveHandler);
