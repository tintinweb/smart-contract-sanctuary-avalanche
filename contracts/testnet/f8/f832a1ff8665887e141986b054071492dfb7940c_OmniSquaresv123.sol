...
contract ONFT is IONFT, NonblockingLzApp, ERC721 {
    string public baseTokenURI = "ipfs://QmcNTtHox74ueCMJYfkqntpb52sQ4ceZiqVfZXZaxLf6BA/";
...
contract UniversalONFT is ONFT {
    ...
    function mint(uint256 numberOfTokens) external payable {
        ...
        require(
          numberOfTokens == 1 || numberOfTokens == 2,
          "Can mint 2 tokens at a time"
        );
        require(
...
contract OmniSquaresv123 is UniversalONFT {
