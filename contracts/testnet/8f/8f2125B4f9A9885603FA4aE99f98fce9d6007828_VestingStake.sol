...
contract VestingStake {
     ...
     */
    function vestedAmount(uint256 timestamp) public view virtual timeReached(timestamp) returns (uint256) {
    ...
    function _vestingSchedule(uint256 totalAllocation) internal view virtual returns (uint256) {
        ...
        if (year == 1) {
            return 7920000 * (10**18);
        } else if (year == 2) {
            return 13200000 * (10**18);
        } else if (year == 3) {
            return 16800000 * (10**18);
        } else if (year == 4) {
            return 20400000 * (10**18);
        } else {
