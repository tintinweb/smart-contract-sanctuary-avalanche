...
contract CupidEggs is ERC721Enumerable, Ownable, ReentrancyGuard, ERC2981 {
    using Strings for uint256;
    ...
    IERC721 public nft; // cupid egg contract

    uint256 public constant maxSupply = 500; // total land
    uint256 public price = 0 ether; // 0 AVAX

    string public _nonRevealedURI = "https://smolr.mypinata.cloud/ipfs/QmRvRFUsEhgc45wVCXeAiKMd2LUGGEzVGPSzB64iCFp7a7";
    string public baseURIExtended = ""; // base ipfs url
    string public extension = ".json"; // configurable extension

    bool public saleIsActive = false; // 
    bool public allowListActive = true; // 
    bool public revealed = false;
    uint96 public tokenRoyalties = 800; // 

    address royaltyPayout = 0xE87D041184d98197f35aC5156b154755F7aC6C7d; // 3 wall

    mapping(address => bool) allowListMinters;

    // CONSTRUCTOR

    constructor() ERC721("Cupid Eggs", "CupidEggs") {
        internalMint(0x85E6cC88F3055b589eb1d4030863be2CFcc0763E); // a
        internalMint(0xB8cF11B8De281560884b4A23Efd69D9aACBf3f4d); // x
        internalMint(0x77414036Afb728b7346cD2c37a689e8C2269FCeF); // xp
        internalMint(0xA3d5ADa94Bb423F7c7Cbf83403D63aAB8278F8cF); // mf
    ...
    // owner mint to wallet
    function reserveTokens(address to)
        external
        onlyOwner
    {
        require(
        ...
        nonReentrant
    {
        ...
        if(allowListActive){
            require(nft.balanceOf(msg.sender) > 0, "Whitelist Not Granted");
            require(!allowListMinters[msg.sender], "Already minted on allow list");
        }
        require(numberOfTokens == 1, "Can only mint 1 token");
        require(
            totalSupply() < maxSupply,
        ...
        allowListMinters[msg.sender] = true;
    }
