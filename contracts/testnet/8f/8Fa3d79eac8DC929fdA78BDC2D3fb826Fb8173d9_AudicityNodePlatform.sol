...
contract AudicityNodePlatform is OwnableUpgradeable {
    ...
    function initialize(
        ...
        distributionPoolAddress = payable(0xc8E325421F1BAde2490A0eda102E2cad18D5BC11); //TODO CHANGE FOR REAL ADDRESSES
        treasuryAddress = payable(0xc8E325421F1BAde2490A0eda102E2cad18D5BC11); // TODO CHANGE FOR REAL ADDRESSES
        ...
        thirtyDaySeconds = 3000;
        sixtyDaySeconds = 6000;
        ninetyDaySeconds = 9000;
        // thirtyDaySeconds = 30 days;
        // sixtyDaySeconds = 60 days;
        // ninetyDaySeconds = 90 days;
    ...
    function compoundDistributions(uint256 nodeAmount) public {
        ...
        for (uint256 index = 0; index < nodeIds.length; index++) {
            NodeInfo storage nodeInfo = nodes[nodeIds[index]];
            console.log('nodeInfo.nextAvailableClaimTimestamp: ', nodeInfo.nextAvailableClaimTimestamp);
            console.log('block.timestamp: ', block.timestamp);
            console.log('nodeInfo.nextAvailableClaimTimestamp >= block.timestamp: ', nodeInfo.nextAvailableClaimTimestamp >= block.timestamp);
            if(nodeInfo.nextAvailableClaimTimestamp >= block.timestamp){
                console.log('insideContinue', nodeInfo.nextAvailableClaimTimestamp);
                distribution += _claimNodeDistribution(nodeIds[index], user);
                console.log('distributionInside', distribution);
        ...
        console.log('distributionTotal', distribution);
        console.log('compoundRequiredPayment', compoundRequiredPayment);
        distribution -= compoundRequiredPayment;
        console.log('distributionAfter', distribution);
