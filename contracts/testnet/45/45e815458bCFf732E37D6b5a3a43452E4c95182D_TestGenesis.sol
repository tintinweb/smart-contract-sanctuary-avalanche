    ...
    Withdrawable
{
    ...
    function buyNFT(uint256 typeNFT, uint256 quantity) external payable notContract nonReentrant {
        ...
        if (typeNonFungible.paymentToken == address(0)) {
            ...
            require(
                IERC20(typeNonFungible.paymentToken).transferFrom(account, feeBeneficiary, total),
