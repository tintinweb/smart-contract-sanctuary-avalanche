...
contract Bronze is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    uint256 public constant tokensLimit = 2000;

    uint256 private constant _itemPrice = 0.00001 ether;
    ...
    constructor(address riAddress_) ERC721("BRONZE NFT V1", "BRONZE V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://site.com/meta/bronze/";
        string memory baseContractURI = "https://site.com/meta/bronze/global.json";
