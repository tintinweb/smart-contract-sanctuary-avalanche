 ...
 */
contract AddressBook is DaoxyApp {
...
import "./IDaoxyApp.sol";
import "../common/UnstructuredStorage.sol";
import "../kernel/IKernel.sol";


contract AppStorage is IDaoxyApp {
    using UnstructuredStorage for bytes32;

    /* Hardcoded constants to save gas
    bytes32 internal constant KERNEL_POSITION = keccak256("daoxyOS.appStorage.kernel");
    bytes32 internal constant APP_ID_POSITION = keccak256("daoxyOS.appStorage.appId");
    */
