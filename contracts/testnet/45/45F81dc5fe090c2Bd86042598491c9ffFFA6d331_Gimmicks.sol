...
contract Gimmicks is ERC721Enumerable, Ownable, AccessControl {
    ...
    event DICPunchSent(address _from, uint256 _toTokenId, address _to, uint256 _tokenId, string _message);
    ...
    function sendDICPunch(
        ...
        emit DICPunchSent(msg.sender, toTokenId, to, tokenId, message);
    }
