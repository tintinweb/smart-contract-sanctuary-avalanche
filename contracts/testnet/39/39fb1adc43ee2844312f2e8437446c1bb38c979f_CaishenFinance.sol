...
contract CaishenFinance is ERC721A, Ownable, ReentrancyGuard, ERC2981 {
...
// ================== Variables Start =======================
  ...
  uint256 public wlprice = 1 ether;
  uint256 public supplyLimit = 5000;
  uint256 public wlsupplyLimit = 1500;
  ...
  address royaltyAddress = 0x6b101Fdb6eCCf0Bbc093f83E3F5A13507E257FA9;  
...
// ================== Withdraw Function Start =======================
  ...
  function withdraw() public onlyOwner nonReentrant {
      ...
      payable(0x6b101Fdb6eCCf0Bbc093f83E3F5A13507E257FA9 ).transfer(balance * 85 / 100); // 1
      payable(0x3452c37Dfb906F88d0bfE80e869b8A5aa8DD4786 ).transfer(balance * 15 / 100); // 2
  }
