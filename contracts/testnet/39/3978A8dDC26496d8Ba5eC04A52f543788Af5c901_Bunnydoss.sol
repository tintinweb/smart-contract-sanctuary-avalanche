...
import "hardhat/KindaRandom.sol";
import "@openzeppelin/contracts/token/ERC721/extensions/ERC721Burnable.sol";
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";

contract Bunnydoss is ERC721Burnable, Ownable, KindaRandom {
  ...
  address private _team1;
  address private _team2;
  address private _team3;
  address private _team4;
  ...
  mapping(uint256 => address) public burnedTokens;
  ...
  constructor() ERC721("Moo Milk", "Milk") KindaRandom(111) {
    _baseTokenURI = "https://metacardsclub.io/moomilk/json/";
    _baseExtension = ".json";
    _maxMintable = 14; // 111 max supply
    _royaltyAmount = 1000; // 5% royalties
    _mintActive = false; // start paused
    _isWl = true; // start on WL
    _maxMintPerTx = 10;
    _price = 0 ether;
    _wlPrice = 0.01 ether;
    
    _team1 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; // f
    _team2 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; // af
    _team3 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; // s
    _team4 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; // v
    _dev   = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9;

    _royaltyReceiver = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9;

    _privateMint(0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9);
  }
  ...
  function setWLOnly(bool status) public onlyOwner {
    _isWl = status;
  }

  function setTeam1(address team1_) public onlyOwner {
    _team1 = team1_;
  }

  function setTeam2(address team2_) public onlyOwner {
    _team2 = team2_;
  }

  function setTeam3(address team3_) public onlyOwner {
    _team3 = team3_;
  }

  function setTeam4(address team4_) public onlyOwner {
    _team4 = team4_;
  }

  function setDev(address dev_) public onlyOwner {
    _dev = dev_;
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    if( _isWl ) {
      require(whiteListed[msg.sender] == true, "Your wallet is not a white listed.");
      price = _wlPrice;
    }
    require(msg.value >= (quantity * price), "Not enough AVAX sent.");

    payable(_team1).transfer((msg.value * 325) / 1000);
    payable(_team2).transfer((msg.value * 325) / 1000);
    payable(_team3).transfer((msg.value * 100) / 1000);
    payable(_team3).transfer((msg.value * 100) / 1000);
    payable(_dev).transfer((msg.value * 150) / 1000);
  ...
  function _privateMint(address recipient) private {
    ...
    uint256 randomish = uint256(keccak256(abi.encodePacked(_tokenIds.current(), block.timestamp))) % (_maxMintable - _tokenIds.current());
  ...
  function _burn(uint256 tokenId) internal override(ERC721) {
    super._burn(tokenId);
    burnedTokens[tokenId] = _msgSender();
  }
}
