...
contract BigMoon is Context, IERC20 , Ownable {
    ...
    function setBeneficiaryAddress(address _adr) public onlyOwner {
        beneficiaryAddress = _adr;
    }

    function setBeneficiaryAddress(uint8 _percent) public onlyOwner {
        require(_percent<=100,"Must be less than 100 percent");
        feePercentage = _percent;
    }
