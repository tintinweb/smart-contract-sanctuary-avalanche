...
contract NabanaVesting is Initializable, OwnableUpgradeable {
    ...
    uint256 public unlockIntervalTime;

    bool public vestState;

    // addresses for vesting
    address private  managementAllocationWallet;
    address private  advisorsWallet;
    address private  influencersWallet;
    address private  strategicPartnersWallet;
    address private  rewardsIncentivesWallet;
    ...
    function initialize() public initializer  {
        ...
        managementAllocationWallet = 0x49E695A35bd65C735BB2b0033e77205b4C8cf02c;
        advisorsWallet = 0x20027f3D87D107d7a5A304A940f3A63F98E67298;
        influencersWallet = 0x3d574DE90E80b9Ce7CC48aC9520bDC9d19e549E4;
        strategicPartnersWallet = 0xA0f77506698e9e2F5919fbbC76c362a0e41555f3;
        rewardsIncentivesWallet = 0xa9E8627F2c78992de6aF3c76120625930E1A826F;
        reserveWallet = 0xFA38bFA8D5f3B4FB2E3B410F86a27776Ab3AAb4d;

        // distribution of tokens to vesters
        getVestings[managementAllocationWallet] = Vesting(
            managementAllocationWallet,
            5_000_000 * (10**18),
            4,
            36,
            25,
        ...
        getVestings[advisorsWallet] = Vesting(
            advisorsWallet,
            1_000_000 * (10**18),
            2,
            12,
        ...
        getVestings[influencersWallet] = Vesting(
            influencersWallet,
            1_000_000 * (10**18),
            4,
            6,
        ...
        getVestings[strategicPartnersWallet] = Vesting(
            strategicPartnersWallet,
            3_000_000 * (10**18),
            4,
            6,
            25,
        ...
        getVestings[rewardsIncentivesWallet] = Vesting(
            rewardsIncentivesWallet,
            5_000_000 * (10**18),
            100,
            2,
            1,
        ...
        getVestings[reserveWallet] = Vesting(
            reserveWallet,
            5_000_000 * (10**18),
            4,
            12,
    ...
    function updateNabana(address _nabana) external onlyOwner {
        require(
            address(nabana) != _nabana,
            "NabanaVesting: Nabana is already this address"
        );
    ...
    function updateVestingState(bool _vestState) external onlyOwner {
        require(
            ...
            "NabanaVesting: Stake State is already of this state"
        );
        vestState = _vestState;
    }
    ...
    function updatePermission(address _vester, bool _state) external onlyOwner {
        require(
            ...
            "NabanaVesting: Address is already of this state"
        );
        permitted[_vester] = _state;
    }
    ...
    function _claimVesting(
        address _walletAddress,
        uint256 _timestamp,
        uint256 _unlockValidator
        ...
        if (currentInterval < vesting.lockupIntervals) {
            ...
            if (currentInterval < vesting.totalIntervals) {
                uint256 unlockAmount = vesting
                    .amountToUnlock
                    .mul(vesting.percentageToUnlock)
                    .div(100);
    ...
    function claimVestings() external vestActive permission {
        ...
        require(
            timestamp > unlockTimeLast.add(unlockIntervalTime),
            "NabanaVesting: No unlocks currently available"
        );
        require(
            currentInterval < maxInterval,
            "NabanaVesting: Vesting complete"
        );

        uint256 unlockValidator;

        unlockValidator = _claimVesting(
            managementAllocationWallet,
            timestamp,
            unlockValidator
        );
