...
contract TrxFortune {
    ...
    uint256 public constant MIN_AMOUNT = 150e6;
    uint256[3] public REF_DEP_PERCENTS = [5_000, 3_000, 1_000];
    uint256[3] public REF_WID_PERCENTS = [1_500, 500, 100];
    uint256 public constant DEPOSIT_FEE = 10_00; // 10% deposit fee
    uint256 public constant WITHDRAW_FEE = 6_000; // 6% withdraw fee
    uint256 public constant P_WITHDRAW_FEE = 62_500; // 6% withdraw fee for owner
    uint256 public constant I_WITHDRAW_FEE = 37_500; // 4% withdraw fee for insurance
    uint256 public constant PERCENT_STEP = 200; // 0.2% daily increment
    uint256 public constant WITHDRAW_TAX_PERCENT = 35_000; // emergency withdraw tax 35%
    uint256 public constant P_WITHDRAW_TAX_PERCENT = 10_000; // emergency withdraw tax 10% for owner
    uint256 public constant I_WITHDRAW_TAX_PERCENT = 10_000; // emergency withdraw tax 10% for insurance
    uint256 public constant MAX_HOLD_PERCENT = 2_000; // 2% hold bonus
    ...
    constructor(
        ...
        INSURANCE_WALLET = payable(msg.sender);

        plans.push(Plan(16, 8_500));
        plans.push(Plan(28, 10_000));
        plans.push(Plan(0, 7_000));
        plans.push(Plan(16, 16_500));
        plans.push(Plan(28, 13_000));
    }
        ...
        returns (uint256)
    {
        ...
        uint256 timeMultiplier = block
            ...
            .div(TIME_STEP);
        timeMultiplier = timeMultiplier.mul(200); // +0.2% per day
