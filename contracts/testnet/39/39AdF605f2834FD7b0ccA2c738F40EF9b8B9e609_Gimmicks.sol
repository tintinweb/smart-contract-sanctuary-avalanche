...
contract Gimmicks is ERC721Enumerable, Ownable, AccessControl {
    ...
    function setNFTMetadata(uint256 tokenId, string memory metadataURI) public onlyRole(UPDATER_ROLE) {
