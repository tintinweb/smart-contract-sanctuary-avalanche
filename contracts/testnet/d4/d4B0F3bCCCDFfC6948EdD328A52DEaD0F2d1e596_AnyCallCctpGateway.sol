    ...
    IVault
{
    ...
    function sendMessage(
        ...
        uint256 amount = _sourceAmount(_message, _targetChainId);
    ...
    /**
     * @notice Receives the asset tokens from CCTP
     ...
     */
    function receiveAndTransferCctpAsset(
        bytes calldata _cctpMessage,
        bytes calldata _cctpAttestation,
        address _to
    ) external onlyManager {
    ...
    function _sourceAmount(
        ...
        uint256 targetAmount = targetMessage.targetSwapInfo.fromAmount;
