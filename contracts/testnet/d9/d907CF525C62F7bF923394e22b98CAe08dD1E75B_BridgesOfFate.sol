...
contract BridgesOfFate is Ownable {
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules NarrowingGameEndRules{
        ...
        if(totalNFTOnTile[_currentUserStage][_jumpSide] <= 0){                
           selectPreviousStageNFTAndCapacity(_currentUserStage);
            // OverFlowPlayerStatus[playerId] =  false;
        }
    ...
    function _selectSuccessSidePlayerId(bytes32[] memory _playerIDAtSpecifyStage, bool previousJumpSide) public  returns(bytes32[]  memory){
    ...
    function selectPreviousStageNFTAndCapacity(uint256 _currentUserStage) internal  {
        /*
        ...
        */
        ...
        if(_currentUserStage  > 0){
            ...
            _selectSuccessSidePlayerIdList =  _selectSuccessSidePlayerId(PlayerIDAtSpecifyStage,previousJumpSide);
            ...
            if(_selectSuccessSidePlayerIdList.length + 1 > TitleCapacityAgainestStage[_currentUserStage]){
