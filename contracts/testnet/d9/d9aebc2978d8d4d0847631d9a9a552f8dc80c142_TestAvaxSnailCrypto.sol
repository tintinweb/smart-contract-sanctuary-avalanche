/**
 *Submitted for verification at testnet.snowtrace.io on 2022-10-15
*/
...
contract TestAvaxSnailCrypto is ERC721A, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x40F262Fa1e8E59368749974157989452c3317B0C, 0xDBb6B4eCd987F9A7F1da340270B7A359be81c5c2];
    ...
    constructor(
        ...
        _setDefaultRoyalty(0x40F262Fa1e8E59368749974157989452c3317B0C, _royaltyAmount);
    }
