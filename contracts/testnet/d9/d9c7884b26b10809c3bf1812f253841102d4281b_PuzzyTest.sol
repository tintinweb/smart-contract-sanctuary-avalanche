...
// File: contracts/Puzzy.sol
    ...
    contract PuzzyTest is ERC721, Ownable, ERC721Enumerable {
      ...
      event PuzzyMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("PuzzyTest", "PTS") {}
      ...
      function mintPuzzy(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit PuzzyMinted(id, msg.sender);
          }
        }
      }
    
      function presalePuzzy(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmWdScDviQmLnreXGHWW42TvY1MTVCcBPriqnomcVf7CBS/hidden.json";
        }
