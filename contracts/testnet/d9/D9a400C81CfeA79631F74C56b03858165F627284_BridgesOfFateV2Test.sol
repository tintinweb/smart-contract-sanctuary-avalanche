...
contract BridgesOfFateV2Test is Ownable, ReentrancyGuard {
    ...
    mapping(uint256 => mapping(bytes32 => bool)) public PlayerTimeStatusAgainestDay;
    ...
    */
    ...
    modifier After24Hours(bytes32 playerId) {
        ...
        require(PlayerTimeStatusAgainestDay[_gameStatus.day][playerId] == false , "Already jumped in this 60 seconds.");
        require(timePeriod[_gameStatus.day] >= block.timestamp , "Jump Only 1 time in 60 seconds.");
        _;
    }
