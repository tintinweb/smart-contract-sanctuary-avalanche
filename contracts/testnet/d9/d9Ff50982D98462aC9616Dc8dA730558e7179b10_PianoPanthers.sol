...
contract PianoPanthers is ERC721, Ownable, KindaRandom {

	using Counters for Counters.Counter;
	using Strings for uint256;
	Counters.Counter private _tokenIds;

	uint256 private _maxMintable = 50;
	uint256 private _royaltyAmount = 800;
	uint256 private _maxMintPerTx = 10;
	uint256 private _price = 0.001 ether;
	uint256 private _wlPrice = 0.01 ether;


	address private _artist1 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; //j
	address private _artist2 = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9; //a
	address private _dev = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9;
	address private _royaltyReceiver = 0xE4BF05D3134c8C170a12E447AcA3B222a7A795B9;

	string private  _baseTokenURI = "ipfs://QmYgnbqoizmKSnfzmtPLVJQt73LjSTQDR1AgopaQMft3AC/";
	string private  _baseExtension = ".json";

	bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

	bool private _mintActive;
	bool private _wlMintActive = true;
	uint256 private _startTime = 1671042600;

	mapping(address => bool) public whiteListed;

	constructor() ERC721("Piano Panthers", "PIANO") KindaRandom(50) {
	...
	function setWlMintActive(bool status) public onlyOwner {
		_wlMintActive = status;
	}

	function setArtist1(address artist1_) public onlyOwner {
		_artist1 = artist1_;
	}

	function setArtist2(address artist2_) public onlyOwner {
		_artist2 = artist2_;
	}
	...
	function mint(uint256 quantity) public payable {
    	require(mintActive(), "Minting closed");
		require(quantity <= _maxMintPerTx, "Cannot mint that many at once.");

		uint256 price = _price;
		if( _wlMintActive ) {
			require(whiteListed[msg.sender] == true, "Not on WL");
      		price = _wlPrice;
		}
		require(msg.value >= (quantity * price), "Not enough AVAX");

		payable(_artist1).transfer((msg.value * 425) / 1000);
		payable(_artist2).transfer((msg.value * 425) / 1000);
