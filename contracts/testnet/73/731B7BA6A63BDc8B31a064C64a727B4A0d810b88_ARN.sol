...
contract ARN is YToken {
    uint256 public constant MAX_TOTAL_SUPPLY = 2_500_000 ether;
    ...
    constructor(
        ...
        _mint(_daoFund, 250_000 ether); // 10%
        _mint(_devFund, 250_000 ether); // 10%
        _mint(_treasuryFund, 250_000 ether); // 10%
        _mint(_reserve, MAX_TOTAL_SUPPLY - 750_002 ether);
    }
