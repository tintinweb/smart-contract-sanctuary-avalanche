...
// File: ERC721A/OtterSocietyMerkle.sol
...
contract OtterSocietyMerkle is ERC721A, OwnableNR, ReentrancyGuard, ERC2981 {
    ...
    function whitelistFreeMint(bytes32[] calldata _merkleProof, uint256 _quantity)
        external
        nonReentrant
        callerIsUser
        notPaused
