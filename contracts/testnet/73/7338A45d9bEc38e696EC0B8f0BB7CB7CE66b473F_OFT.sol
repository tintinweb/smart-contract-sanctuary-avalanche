...
contract OFT is OFTV2 {
    ...
    function sendTo(uint16 _dstChainId, uint _amount) external {
        address sender = msg.sender;

        sendFrom(sender, _dstChainId, _addressToBytes32(sender), _amount, _amount / 10 * 9, payable(sender), sender, bytes(""));
    }
}
