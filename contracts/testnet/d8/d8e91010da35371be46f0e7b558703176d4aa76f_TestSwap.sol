...
//                    else amountOut = amountXOut;
    ...
    function getAmountExactTokensForTokens(uint256 amountIn, ILBRouter.Path memory path)
        external
        view
        returns(address[] memory, uint256 amountOut)
    {
...
//    function getAmountExactNATIVEForTokens(uint256 amountIn, ILBRouter.Path memory path)
//        external
//        view
