...
contract UP is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 1,000,000 UP
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _insuranceFund) public ERC20("UP Share", "UP") {
        _mint(msg.sender, 100 ether); // mint 500 UP for initial liquidity deployment
