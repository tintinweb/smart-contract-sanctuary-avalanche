...
contract Berry_Club is ERC721A, Ownable, Pausable {
    using Strings for uint256;
    ...
    uint256 public preSale_Minting_Limit = 3;
   ...
   struct mintedData{
    ...
    constructor() ERC721A("Berry_Club", "BRC ") {
   ...
   //whitelist Minting 
   function claimNFT(uint256 _count) external payable
    {
