...
// File contracts/MGMToken.sol

pragma solidity ^0.8.0;

contract MGMToken is ERC20 {
    constructor(uint256 initialSupply) ERC20("MGMToken", "MGMT") {
        console.log("Minting initial amount of MGMTokens:", initialSupply);
        console.log("Minter:", msg.sender);
        _mint(msg.sender, initialSupply);
        transfer(msg.sender, initialSupply);
    }

    // allowing the owner to burn his precious MGMTokens
