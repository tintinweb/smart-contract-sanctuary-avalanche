...
contract iEZEERC20 is Divine {
  ...
  constructor() Divine( "iEZE", "iEZE", 9 ) {
    uint256 initialSupply_ = 1000000 * 1e9;
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer iEZE." );
  }
