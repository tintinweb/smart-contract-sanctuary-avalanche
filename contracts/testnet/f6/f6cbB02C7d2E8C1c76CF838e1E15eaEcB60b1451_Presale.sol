...
contract Presale is Ownable, ReentrancyGuard {
    ...
    function DepositBusd(uint256 _amount, uint256 _type) public nonReentrant {
        ...
        if (_type == 0) busd.safeTransferFrom(msg.sender, masterWallet, _amount);
        if (_type == 1) usdt.safeTransferFrom(msg.sender, masterWallet, _amount);
        if (_type == 2) usdc.safeTransferFrom(msg.sender, masterWallet, _amount);
