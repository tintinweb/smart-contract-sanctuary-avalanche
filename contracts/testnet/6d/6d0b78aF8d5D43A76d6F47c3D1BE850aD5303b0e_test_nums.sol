...
contract test_nums  {
    ...
    uint256 public newpoolFee256 = nodeAmount2.mul(teamPoolFee2.div(denom2));
    uint8 public newpoolFee8 = nodeAmount*(teamPoolFee/denom);
    uint256 public newpoolFee2568 = nodeAmount2*(teamPoolFee/denom);
