...
contract Ryu is Initializable, UUPSUpgradeable , ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, ERC2981PerTokenRoyalties {
    ...
    function initialize(
        ...
        __ERC721_init("Ryu NFTs testnet", "RYUTEST");
        __ERC721Enumerable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();


        baseUri = "ipfs://QmPozuvYwuznGpKeYSLvZpuDpJKJCFLRcmmtMzoYYdjvJe/";
