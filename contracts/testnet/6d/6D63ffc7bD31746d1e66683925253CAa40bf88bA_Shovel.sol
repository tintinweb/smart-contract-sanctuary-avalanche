...
contract Shovel is ERC721, Ownable {
    address public minter;
    uint public totalSupply;

    constructor() ERC721("Pixel Mine Shovel", "PMS") {
        minter = msg.sender;
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return "https://pixelmine.com/play/nfts/shovel";
    }


    function mint(address account, uint256 amount) public {
        require(amount == 1, "You can only collect one NFT Shovel");
        require(msg.sender == minter, "You are not the minter");
        require(totalSupply <= 1050, "Only 2000 shovels can be minted");
        require(balanceOf(account) < 1, "A Mine can only have 1 nft Shovel");
