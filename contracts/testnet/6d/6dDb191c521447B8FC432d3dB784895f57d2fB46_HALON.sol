...
contract HALON is ERC20Upgradeable, KeeperCompatibleInterface {
    ...
    function initialize() public virtual initializer {
        ...
        rewardYield = 500; // 0.05%
        rewardYieldDenominator = 1000000;
        ...
        minExtraDays = 7;
        maxExtraDays = 365;
        setRewarRatePerDay(0, 500);
        setRewarRatePerDay(1, 600);
        setRewarRatePerDay(2, 700);
        setRewarRatePerDay(3, 800);
        setRewarRatePerDay(4, 900);
    ...
    function claimAutoStakingReward() public {
        ...
        uint256 multiplier = one + one * calcRewardExtra / rewardYieldDenominator;
        power = multiplier;
        ...
        uint256 extra = balanceOf(msg.sender) * power / one;
    ...
    function unlock(uint32 _index) public {
        ...
        uint256 multiplier = one + one * duration * calcRewardExtra / rewardYieldDenominator;
        power = multiplier;
        for(uint i = 1;i<duration;i++) {
            power = power * multiplier / one;
        }
