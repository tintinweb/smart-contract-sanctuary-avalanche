...
// File: SpyFinancial/SpyFnlStaking.sol
...
contract SpyFnlStaking is Ownable, Pausable {
    IRewardToken public ESPContract;
    IERC721 public nft;

    uint256 public stakedTotal;
    uint256 public stakingStartTime;
    uint256 public constant stakingTime = 1 minutes;
    uint256 public dailyRewards = 10e18;
    ...
    constructor(address _nft_address, IRewardToken _ESP_token) {
        nft = IERC721(_nft_address);
        ESPContract = _ESP_token;
    }
    ...
    function calculateReward(uint256[] memory _tokenIds) public view returns(uint256){
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            if (
                ...
                reward +=  dailyRewards * stakedDays;
            }
        }
        return reward;
    }
    ...
    function _updateReward(uint256[] memory _tokenIds) internal {
        ...
        for (uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            if (
                ...
                stakedNFT.balance +=  dailyRewards * stakedDays;
    ...
    function claimReward(uint256[] memory _tokenIds) public whenNotPaused {
        ...
        if(reward > 0){
            ESPContract.mint(msg.sender, reward);
    ...
    function setESPToken(address _token_address)public onlyOwner(){
        ESPContract = IRewardToken(_token_address);
    }
