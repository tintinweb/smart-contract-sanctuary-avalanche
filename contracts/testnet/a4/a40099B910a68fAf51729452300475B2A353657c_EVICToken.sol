...
contract EVICToken is ERC20, Operator {
    ...
    constructor(address _polWallet) ERC20("Ethereum Victory", "EVIC") {
	...
	*/
    ...
    function _transfer(
		...
		require(!blackList[from], "Cannot transfer: in blacklist");
    ...
    */
	...
	function addToBlackList(address _address) external onlyTaxOffice returns (bool) {
        blackList[_address] = true;
        return true;
    }

    function removeFromBlackList(address _address) external onlyTaxOffice returns (bool) {
