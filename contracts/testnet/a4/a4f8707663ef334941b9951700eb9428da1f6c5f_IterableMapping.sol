...
contract Horde is Context, IERC20, IERC20Metadata {
...
contract ThorV2 is Horde, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount,
        address uniV2Router
    ) Horde("THOR v2", "THOR") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 15000000, "CONSTR: totalSupply must equal 20 million");
        require(swapAmount > 1, "CONSTR: Swap amount incorrect");
