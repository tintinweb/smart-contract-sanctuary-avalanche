...
contract AssetProtectionMultiSig is AssetProtectionMultiSigInterface {
    ...
    constructor(
        ...
        require(
            ...
            "Asset Protection Multi-Sig: Admin Multi-Sig should not be zero-address!"
        );
        ...
        for (uint256 i = 0; i < Signatories_.length; i++) {
            ...
            require(
                signatory != address(0),
                "Asset Protection Multi-Sig: Invalid signatory address!"
            );

            // require no duplicated signatory
            require(
                !_isAssetProtectionSignatory[signatory],
                "Asset Protection Multi-Sig: Duplicate signatory address!"
            );
