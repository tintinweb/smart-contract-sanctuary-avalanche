...
contract Mois is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public constant TIME_FOR_GROWN = 1688908694000;
	...
	string private _name = "mois";
	string private _symbol = "MOIS";
