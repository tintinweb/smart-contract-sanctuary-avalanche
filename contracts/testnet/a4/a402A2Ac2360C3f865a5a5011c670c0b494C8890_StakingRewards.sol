...
contract TimeLock {
    ...
    uint256 public constant MIN_DELAY = 3 hours; //7 days
    uint256 public constant MAX_DELAY = 14 hours; // 30 days
    uint256 public constant GRACE_PERIOD = 6 hours; // 14 days
