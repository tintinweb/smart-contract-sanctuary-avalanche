...
contract IDO is ReentrancyGuard, Ownable {
    ...
    uint256 public salePriceUsd = 12500000000000; //$0.0000125
    ...
    function saleLock(address _account, uint256 _scoutToLock) private {
        ...
        insertIdoLock(_account, m6Release, 180 days);
        insertIdoLock(_account, m8Release, 240 days);
        insertIdoLock(_account, m10Release, 300 days);
        insertIdoLock(_account, m12Release, 360 days);
        insertIdoLock(_account, m15Release, 450 days);
        insertIdoLock(_account, m18Release, 540 days);
        insertIdoLock(_account, m21Release, 630 days);
    }
    ...
    function insertIdoLock(
        ...
        require(
            totalIdoLockedAmount + _amount <= idoSupply,
    ...
    function releaseIdoAmount(uint256 lock_id) public {
        ...
        // require(talentScout != address(0), "Talent Scout not set");
     ...
     */
    function destroyIdo(uint256 amount) public onlyOwner {
