...
contract DegenToken is ERC20, Ownable, ERC20Burnable {
        ...
        uint256 public totalRedeemable = 0;
        ...
        function redeem(uint256 _item_id) public returns(string memory){
            ...
            return string(abi.encodePacked(redeemables[_item_id].name, " SUCCESSFULLY CLAIMED!"));
        }

        function addRedeemableItem(string memory _item_name, uint256 _item_requirement, string memory _item_description) public {
        ...
        function viewRedeemables() public view {
            for(uint256 a = 1; a <= totalRedeemable; a++) {
                console.log(string(abi.encodePacked(redeemables[a].name, " - ", redeemables[a].description, " (", Strings.toString(redeemables[a].required_amount), " DGN)")));
            }
        }
