...
contract cvgc is IBEP20, Ownable {

    string public constant name = "cvgc";
    string public constant symbol = "dfghfgh";
    uint8 public constant decimals = 11;

    
    mapping(address => uint256) balances;
    mapping(address => mapping (address => uint256)) allowed;
    uint256 totalSupply_ = 2222 *10 **decimals;
