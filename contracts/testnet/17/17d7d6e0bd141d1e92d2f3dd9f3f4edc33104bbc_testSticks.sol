    ...
    **/
    ...
    function cashOutScepter(uint256 amountSPTRtoSell, uint256 daysChosenLocked, string memory _stableChosen) public nonReentrant{
        ...
        if (daysChosenLocked ==0) //payout immediate.
        {
            ...
            scepterData.sptrTreasuryBal -= usdAmt / DECIMALS;
        }
    ...
    function buyScepter(uint256 amountSPTRtoBuy, string memory _stableChosen) public nonReentrant{
       ...
       // require(tokenStable.balanceOf(msg.sender) > amountSCPtoBuy, "You dont have that amount!");
        ...
        scepterData.sptrTreasuryBal += mathFuncs.decMul18(usdAmt,9500000000000000000) / DECIMALS;
        calcSPTRData();
    ...
    function wlBuyScepter(uint256 amountSPTRtoBuy, string memory _stableChosen) public nonReentrant{
        ...
        scepterData.sptrTreasuryBal += mathFuncs.decMul18(amountSPTRtoBuy,9500000000000000000) / DECIMALS;
   ...
   /* function getGrowthFactor() external view returns (uint256){
    ...
    function calcSPTRData() internal {
      ...
      // xDaysCircSupply = getCircSupplyXDays(); 
       ...
       scepterData.sptrBackingPrice = mathFuncs.decDiv18(scepterData.sptrTreasuryBal * DECIMALS,SPTR.totalSupply());
    ...
    function updateSPTRTreasuryBal(uint256 _totalAmt) public onlyOwner{ 
        scepterData.sptrTreasuryBal = _totalAmt;  
        calcSPTRData();
    } 
    ...
    function Launch() public onlyOwner{
        ...
        scepterData.sptrTreasuryBal = 86000;
        btonTreasuryBal = 0; 
        calcSPTRData();
        tradingEnabled = true;
