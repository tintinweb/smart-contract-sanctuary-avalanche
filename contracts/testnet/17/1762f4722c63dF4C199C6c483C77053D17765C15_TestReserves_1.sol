  ...
  ERC20
{
  ...
  function getTokenPrice() public view returns(uint[6] memory)
   ...
   function process() public whenNotPaused returns (uint) {
    ...
    function swapTokensForAVAX(uint tokenAmount) private {
        address[] memory path = new address[](2);
        path[0] = address(0x863ad4F88428151c0Ffa796456E445a978fb2c47);
        path[1] = joeRouter.WAVAX();
        _approve(address(joeRouter), address(this), tokenAmount);
