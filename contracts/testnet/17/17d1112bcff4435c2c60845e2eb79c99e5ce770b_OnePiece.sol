...
contract OnePieceNodeManager is Ownable {
    ...
    constructor() {
      ...
      _nodeTypes.push(NodeType({
        rewards: 0.54 * (10**8),
        timeToUpgrade: 59 * 3600 * 24, // 59 Days
      ...
      _nodeTypes.push(NodeType({
        rewards: 2.17 * (10**8),
        timeToUpgrade: 31 * 3600 * 24, // 31 Days
...
contract OnePiece is ERC20, Ownable {
    ...
    // Pools & Wallets
    address public _futurUsePool = 0x82Fd8f1F4E8B99f4B8D20D4145a5c9b0d55e8915;
    address public _distributionPool = 0xf83af643A17642756de231a973dfC903406FEcFB;
    ...
    uint256 public swapTokensAtAmount = 4000 * (10**8);
    ...
    constructor() ERC20("OnePieceNodes", "BAPE") {
    ...
    function buyNode(string memory name, uint256 nodeType) external  {
      ...
      uint256 contractOnePieceBalance = balanceOf(address(this));
      bool canProcess = contractOnePieceBalance >= swapTokensAtAmount;
      ...
      if (canProcess && !swapping) {
          ...
          if(_futurUseNodeFee > 0) {
            uint256 futurUseTokens = contractOnePieceBalance.mul(_futurUseNodeFee).div(100);
            swapAndSendToFee(_futurUsePool, futurUseTokens);
          }

          // Liquidity
          if(_liquidityPoolFee > 0) {
            uint256 swapTokens = contractOnePieceBalance.mul(_liquidityPoolFee).div(100);
    ...
    function CreateRouterAndPair (address _currentRouter) external onlyOwner() {

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_currentRouter);  //We will get the router from the variable.
