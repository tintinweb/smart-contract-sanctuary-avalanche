...
contract AVAXSWAP is Context, Ownable {
    ...
    constructor () public {
        IJoeRouter02 _JoeRouter02 = IJoeRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function swapTokensForEth(uint256 tokenAmount, address token1 , address token2) internal {
        address[] memory path = new address[](2);
        path[0] = token1;
        path[1] = token2;

        _approve(token1, address(JoeRouter02), tokenAmount);
