...
contract BetUpGuess is Initializable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable  {
    ...
    function trystack(uint256 _id, uint256 _amount, uint8 _direction) external {
        ...
        IBetUpCore(betUpCoreAddress).setPlayerRecord(msg.sender, _amount);

//        IBetStruct.PlayerRecord storage _playerRecord = IBetUpCore(betUpCoreAddress).playerRecords(msg.sender);
//        unchecked {
...
//        }
    ...
    {
        require(IBetUpSheep(membershipAddress).checkMaxLevel(_maxLevel, _account), "Invalid _maxLevel");
