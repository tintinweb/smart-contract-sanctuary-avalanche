...
/**
 * @title TokenSplitter
 * @notice It splits KLO to team/treasury/trading volume reward accounts based on shares.
 */
contract TokenSplitter is Ownable, ReentrancyGuard {
    ...
    IERC20 public immutable KLOToken;

    // Total KLO tokens distributed across all accounts
     ...
     * @param _KLOToken address of the KLO token
     */
    constructor(
        ...
        KLOToken = IERC20(_KLOToken);
    }

    /**
     * @notice Release KLO tokens to the account
    ...
    function releaseTokens(address account) external nonReentrant {
        ...
        uint256 totalTokensReceived = KLOToken.balanceOf(address(this)) + totalTokensDistributed;
        ...
        KLOToken.safeTransfer(account, pendingRewards);
    ...
    /**
     * @notice Retrieve amount of KLO tokens that can be transferred
     * @param account address of the account
     */
