...
// File: contracts/TheHexagonStaking.sol
...
contract TheHexagonNFTStaking is IERC721Receiver, Ownable, Pausable {
    ...
    address internal constant addrHoneyToken = 0xdC82EC49702b396f0ea9d6113B0ADEcbc1b93c41;
    address internal constant addrBeeToken = 0xC17901d7180b78C7647547B340309B8DEc91110D;
    ...
    uint256 public totalWinback;
    
    event Deposited(uint256 _tokenId);
    event Withdrawed(uint256 _tokenId, uint256 yield);
    event Claimed(uint256 _tokenId, uint256 amount);
    ...
    function deposit(uint256 _tokenId, uint256 _lockTimeMode) public {
        ...
        stakeOfTokenId[_tokenId] = Stake(block.timestamp, _lockTimeMode, msg.sender, true);
    ...
    function withdraw(uint256 _tokenId) public {
        ...
        stakeOfTokenId[_tokenId] = Stake(0, 0, address(0), false);
        honeyContract.transfer(msg.sender, yield);
        emit Withdrawed(_tokenId, yield);
    }
    ...
    function getIsStaker(uint256 _tokenId) public view returns(bool) { return stakeOfTokenId[_tokenId].staker == msg.sender; }
