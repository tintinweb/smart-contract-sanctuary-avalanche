...
contract CoinFlipGame is LetsRando {
    ...
    constructor(address _ecosystemAddress) LetsRando(_ecosystemAddress) payable {}
    ...
    function claim(uint256 _request) public returns (bool) {
        ...
        uint256 p = hasMinterAddress ? (1000 - _nftChance) / 2 : 500;
        uint256 q = hasMinterAddress ? (1000 - _nftChance) : 1000;

        bool won = (10 * Requests[_request].Result) > p;
        bool wonNft = (10 * Requests[_request].Result) > q;
