...
import "./SaleFactory_changes.sol";
import "@openzeppelin/contracts/utils/math/SafeMath.sol";
contract ProjectLaunchFactory is SaleFactory_changes {
  ...
  function createSale(
    ...
    _presale_details[8] = round2Mult[_options[0]];
    _community_details[8] = round3Mult[_options[0]];
    ...
    } else if (_options[0] <= 3 && _options[0] > 0) {
    ...
    IBEP20(_sale_token).approve(msg.sender, totalTokens + totalLiquidityTokens);
    IBEP20(_sale_token).transferFrom(msg.sender, address(_owner), totalTokens + totalLiquidityTokens);
    return address(sale);
  }
}
