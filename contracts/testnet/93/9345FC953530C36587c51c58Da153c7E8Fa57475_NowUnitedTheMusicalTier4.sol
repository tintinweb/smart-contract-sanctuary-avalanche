...
contract NowUnitedTheMusicalTier4 is ERC721, DefaultOperatorFilterer, Ownable {
    ...
    constructor(string memory _baseUri, address _primaryRecipient) ERC721("Now United The Musical: Global Diamond", "NUGD") {
        currentTokenId = 1;
        maxSupply = 300;
