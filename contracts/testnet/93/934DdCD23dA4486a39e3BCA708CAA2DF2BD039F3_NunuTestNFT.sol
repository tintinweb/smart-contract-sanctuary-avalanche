...
contract NunuTestNFT is ERC721, ERC721Enumerable, Ownable, IERC721Receiver {
    constructor() ERC721("NTMTNPT", "TMP") {}
    
    function mintNUNU(uint256 tokenId, address to) public onlyOwner {
        _safeMint(to, tokenId);
    }
