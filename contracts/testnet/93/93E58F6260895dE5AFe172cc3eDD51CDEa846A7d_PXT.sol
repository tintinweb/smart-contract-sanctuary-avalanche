...
contract PXT is ERC20Upgradeable, IBridgeToken {
    ...
    function initialize() public virtual initializer {
        ...
        usdtAddress = 0x6BFa5db24866541c8703f84eF36cC202bcd43322;
    ...
    function updateCreateNodeBeforeSellCheck(bool value) public virtual onlyOwner {
...
/*
        ...
        if (createNodeBeforeSellCheck && automatedMarketMakerPairs[to]) {
            ...
            uint256 minimunCreatedNodes = uint256(userTokenBalance / 20);

            /*
            require(
                userNodes >= minimunCreatedNodes,
