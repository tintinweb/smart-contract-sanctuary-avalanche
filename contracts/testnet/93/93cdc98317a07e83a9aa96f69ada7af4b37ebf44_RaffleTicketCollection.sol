...
// File: full-tokens/Airdrop1155.sol
...
contract RaffleTicketCollection is ERC1155, MultiAccessControl 
{
    
    uint256 private BRONZE = 1;
    uint256 private SILVER = 5;
    uint256 private GOLD = 10;

    string public name;
    string private _contractURI;

    constructor() public ERC1155("https://webazaar-meta-api.herokuapp.com/1155/detail/{id}")
    {
        _contractURI = "https://webazaar-meta-api.herokuapp.com/1155/detail/";
        name = "Raffle Ticket";
    }

    function mintBronze() public returns (bool)
    {
        _mint(msg.sender, BRONZE, 1 , "");
        return true;
    }

    function mintSilver() public returns (bool)
    {
        _mint(msg.sender, SILVER, 8 , "");
        return true;
    }

    function mintGold() public returns (bool)
    {
