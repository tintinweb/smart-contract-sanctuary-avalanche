...
contract DefaultHold is ICompliance, Ownable {
    ...
    function canTransfer(
        ...
        if(block.timestamp >= _holdRelease[msg.sender]
            || isTokenAgent(_from)) {
            return true;
        } else {
            return false;
     ...
     */
    function addTokenHold(address _token, uint256 _holdEnd) external onlyOwner {
