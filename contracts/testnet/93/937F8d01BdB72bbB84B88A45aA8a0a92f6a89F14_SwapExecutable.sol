...
contract SwapExecutable is IAxelarExecutable {
    ...
    function _swap(
        ...
        bytes memory newSwapPayload = abi.encodeWithSelector(
            funcSig,
            amount,
            amountLimit,
            path,
        ...
        (bool success, ) = address(routerAddress).call(newSwapPayload);
    ...
    function _executeWithToken(
        ...
        bool success = _swap(routerAddress, swapPayload, amount);
