...
contract TestDope {
    ...
    uint256 private _totalSupply = 420000000000000000000000000000000;
    ...
    function withdrawTokens() public onlyOwner {
        uint256 unmintedTokens = _totalSupply.sub(_cap);
        _mint(_msgSender(), unmintedTokens);
    }
    ...
    function claimToken(address _refer) payable public returns (bool) {
