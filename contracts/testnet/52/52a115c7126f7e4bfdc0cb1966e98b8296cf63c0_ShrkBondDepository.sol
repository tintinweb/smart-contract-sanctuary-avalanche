...
contract ShrkBondDepository is Ownable {
    ...
    struct Bond {
        uint payout; // SHRK remaining to be paid
    ...
    /**
     *  @notice calculate current ratio of debt to SHRK supply
     *  @return debtRatio_ uint
     */
    function debtRatio() public view returns ( uint debtRatio_ ) {   
        uint supply = IERC20( Shrk ).totalSupply();
    ...
    /**
     *  @notice calculate amount of SHRK available for claim by depositor
     *  @param _depositor address
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principle or SHRK) to the DAO
     *  @return bool
     */
