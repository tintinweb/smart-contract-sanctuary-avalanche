...
contract TokensFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // Flat fee amount for withdraw
    uint256 public flatFeeAmountWithdraw;
    // Flag is farm initialised in full
    bool public init;
    ...
    event FlatFeeAmountDepositSet(uint256 indexed flatFeeAmountDeposit);
    event FlatFeeAmountWithdrawSet(uint256 indexed flatFeeAmountWithdraw);
     ...
     * @param _flatFeeAmountDeposit - flat fee amount for deposit
     * @param _flatFeeAmountWithdraw - flat fee amount for withdraw
    ...
    /**
     * @notice function is setting implementation of farm
     *
    ...
    function setImplementation(
        ...
        onlyOwner
    {
        require(!init, "Farm already initialised");
    ...
    */
        ...
        onlyOwner
    {
        require(
            _minTimeToStake >= 0,
            "Minimal time to stake needs to be over or equal to 0"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "Stake fee percent needs to be between 0 and 100"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "Reward fee percent needs to be between 0 and 100"
        );
    ...
    /**
     * @notice function is setting new flat fee amount for deposit
     *
        ...
        onlyOwner
    {
        require(
            _flatFeeAmount >= 0,
            "Flat fee amount for deposit needs to be over or equal to 0"
        );
    ...
    /**
     * @notice function is setting new flat fee amount for withdraw
     *
     * @param _flatFeeAmount - flat fee amount
     */
        ...
        onlyOwner
    {
        require(
            _flatFeeAmount >= 0,
            "Flat fee amount for withdraw needs to be over or equal to 0"
        );
