...
contract Oracle is AccessControl {
    ...
    // Mapping of an assets to ChainLink price feed
    mapping(string => ChainLinkPriceFeed) public chainLinkPriceFeeds;
     ...
     * @param _assets Asset to look up tom i.e. AVAX, ETH, etc
     * @return price Price of an asset in USD, expressed in 1e8;
     */

    function getPriceFromChainLink(string memory _assets)
        external
        view
        returns (int256)
    {
        ...
        (, price, , , ) = chainLinkPriceFeeds[_assets].oracle.latestRoundData();
     ...
     */
    function getPriceFromBandOracle(string memory _assets)
        external
        view
        returns (uint256)
    {
    ...
    /**
     * Get multiple prices from Band Oracle
     * @param _assets Array of assets to look up tom i.e. AVAX, ETH, etc
     * @param _quotes Array of currencies to compare an asset with i.e. USD, EUR, etc
     */
    ...
    function updateChainLinkPriceFeeds(string memory _asset, address _address)
        external
        onlyRole(OWNER_ROLE)
    {
        chainLinkPriceFeeds[_asset].oracle = AggregatorV3Interface(_address);
    }
}
