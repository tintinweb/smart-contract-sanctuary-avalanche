...
//  |\   ____\|\   __  \|\   __  \|\   __  \|\___   ___\\   __  \|\   ___  \|\   ____\       //
//  \ \  \___|\ \  \|\  \ \  \|\  \ \  \|\  \|___ \  \_\ \  \|\  \ \  \\ \  \ \  \___|_      //
//   \ \_____  \ \   ____\ \   __  \ \   _  _\   \ \  \ \ \   __  \ \  \\ \  \ \_____  \     //
//    \|____|\  \ \  \___|\ \  \ \  \ \  \\  \|   \ \  \ \ \  \ \  \ \  \\ \  \|____|\  \    //
//      ____\_\  \ \__\    \ \__\ \__\ \__\\ _\    \ \__\ \ \__\ \__\ \__\\ \__\____\_\  \   //
...
contract StrongSpartans is Ownable, RoyaltiesAddon, ERC2981 {
    ...
    event welcomeToSpartans(uint256 indexed id);
    event NewPriceEvent(uint256 price);
    event NewMaxElement(uint256 max);

    constructor(string memory baseURI) ERC721("StrongSpartans", "SS"){
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 _tokenAmount, uint256 _nonce, bytes memory _signature) public payable saleIsOpen {
        ...
        address signerOwner = signatureWallet(wallet,_tokenAmount,_nonce,_signature);
        require(signerOwner == owner(), "Not authorized to mint");

        require(_usedNonces[_msgSender()] < _nonce, "Nonce already used.");
        _usedNonces[_msgSender()] = _nonce;
    ...
    function signatureWallet(address wallet, uint256 _tokenAmount, uint256 _nonce, bytes memory _signature) public pure returns (address){

        return ECDSA.recover(keccak256(abi.encode(wallet, _tokenAmount, _nonce)), _signature);
    ...
    function _mintAnElement(address _to, uint256 _tokenId) private {
        ...
        emit welcomeToSpartans(_tokenId);
    }
    ...
    function withdrawAll() public onlyOwner {
        (bool os, ) = payable(creatorAddress).call{value: address(this).balance}("");
        require(os);
    }
