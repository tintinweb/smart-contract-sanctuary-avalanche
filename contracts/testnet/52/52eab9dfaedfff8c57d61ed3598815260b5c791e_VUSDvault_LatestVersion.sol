...
contract VUSDvault_LatestVersion is Ownable {    
    ...
    mapping (address => uint256) public ERC20tokenBalancesByUser;
    ...
    {        
        ...
        ERC20tokenBalancesByUser[to] = ERC20tokenBalancesByUser[to].add(_amount);
        if(ERC20tokenBalancesByUser[from] >  _amount) ERC20tokenBalancesByUser[from] = ERC20tokenBalancesByUser[from].sub(_amount); 
        else ERC20tokenBalancesByUser[from] = 0;
