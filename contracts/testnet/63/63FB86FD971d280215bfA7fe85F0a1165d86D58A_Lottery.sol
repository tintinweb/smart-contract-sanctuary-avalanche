...
contract Lottery is Ownable, ReentrancyGuard {
     ...
     * @param _lotteryId lottery id
     */
    function enterLottery(uint256 _lotteryId) public nonReentrant {
        require(
        ...
        require(
            !lotteryUsers[_lotteryId][msg.sender],
            "Can't join 2 times with same account"
        );
        require(
        ...
        lotteries[_lotteryId].players.push(
            PlayerInfo({account: msg.sender, joinedTimestamp: block.timestamp})
        );
        lotteryUsers[_lotteryId][msg.sender] = true;
    ...
    function _drawWinners(uint256 _lotteryId) internal {
        ...
        for (
            ...
            lotteries[_lotteryId].winners.push(
                lotteryPlayers[indexOfWinner].account
            );
        }
