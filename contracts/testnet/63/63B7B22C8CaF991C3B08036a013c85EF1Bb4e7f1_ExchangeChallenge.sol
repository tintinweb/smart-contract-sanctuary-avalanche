...
abstract contract ERC20Challenge is Ownable, Challenge, IERC20Challenge {
    ...
    function addTokenChallenge(
        ...
        uint256 newBalance = challengeToken.balanceOf(address(this));
        require((newBalance - previousBalance) == escrowAmountAndFee, "Challenge Exchange: token transfer is not succeeded") ;
...
abstract contract Challenge is Ownable {
    ...
    address public primaryToken = 0xb54A2a3059A419Db76EC7833f69CA80e80A5e884; //WOM token address
