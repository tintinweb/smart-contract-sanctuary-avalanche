...
/* VARIABLES HERE */
    ...
    uint256 constant maxSupply = 3334;
    ...
    uint8 public ownedCounter = uint8(balanceOf(msg.sender));
    uint8 public actualmint=uint8(currentMint-1);
    ...
    address ARTIST = 0x94C4C8786acfBa27831198da661a895cbE3Ef7e3;
    
    mapping (address => uint8) internal adminMintCount;
    ...
    returns (string memory)
  {
    ...
    function _currentMint() public pure returns(uint8 totalmint){
        return totalmint;
    }
    ...
    function setCommunityWallet(address _communityWallet) private onlyOwner{
...
//whitelist = [""]
       ...
       function _withdraw(address _address, uint256 _amount) private {
        ...
        require (COMMUNITY_WALLET!=address(0), "Community wallet is not set"); 
        require(balance > 0);

        _withdraw(FOUNDER_1, (balance*43)/100);
        _withdraw(FOUNDER_2, (balance*43)/100);
        _withdraw(COMMUNITY_WALLET, (balance*9)/100);
