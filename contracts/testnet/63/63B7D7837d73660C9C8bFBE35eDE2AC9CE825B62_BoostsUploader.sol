...
contract BoostsUploader is Ownable {
    ...
    AttributesPets attributesPets;
    AttributesPets.Boost[101] private boosts;
    ...
    constructor(address _attributesPets) {
        ...
        boosts[40].productionSpeedByTimeWithoutTransfer = [15, 20, 25, 30];
        ...
        //Underground Snake
        boosts[97].productionSpeed = 25;
        boosts[97]. unstakeCooldownAugmentation = 200;

        //Underground Bull
        boosts[98].productionSpeed = 25;
        boosts[98].unstakeStealAugmentation = 50;
    ...
    AttributesPets.Boost[] boostsToSend;
    uint8[] petIds;
