...
contract MetaStocks is ERC20Upgradeable {
    ...
    function initializeContract() internal virtual {
        initAddressess();
        initContracts();
        setRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
        createPair(self(), getDexRouterManager().getNativeTokenAddress(43113));
        doInitialApproves();
...
interface IMetaStocksMultiDexRouter is IUniswapV2Router02, IJoeRouter02 {
    // ROUTER V1
    function factory()
        external
        pure
