...
contract CentralContract is MessageApp {
	...
	event IntentUser(address from, address to, uint64 dstChainId, uint256 value, bytes data);
	...
	function sendUserIntent(address from, address to, uint64 dstChainId, uint256 value, bytes calldata data) public {
		emit IntentUser(from, to, dstChainId, value, data);
	}
