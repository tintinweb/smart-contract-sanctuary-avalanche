...
using SafeMath for uint256;
    ...
    all_new1 = calcReward(dailyRewardsPerc,elapsed,timeStep, 0);
    all_new2 = calcReward(dailyRewardsPerc,elapsed,timeStep, boostMultiplier[0]);
    all_new3 = calcReward(dailyRewardsPerc,elapsed,timeStep, boostMultiplier[1]);
    all_new4 = calcReward(dailyRewardsPerc,elapsed,timeStep, boostMultiplier[2]);
    }
    function calcReward(uint256 _dailyRewardsPerc, uint256 _elapsed, uint256 _timeStep, uint256 _boost) public view returns (uint256[3] memory){
