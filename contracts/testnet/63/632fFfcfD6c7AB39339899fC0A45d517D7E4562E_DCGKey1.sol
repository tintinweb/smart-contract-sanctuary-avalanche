...
contract DCGKey1 is ERC721, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_) ERC721("DCG Key 1", "DCGKEY1") {
  ...
  {
    string memory tokenURI_ = "QmSGAfVx6azPGjXFhzPbjm2QZUnH7MiYYdh9AJEQNjiB8h";
