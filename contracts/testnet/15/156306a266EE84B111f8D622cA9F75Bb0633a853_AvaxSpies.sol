...
contract AvaxSpies is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    bool public airdropDistribution;
    ...
    function toggleAirdropDistribution() external onlyOwner {
        airdropDistribution = !airdropDistribution;
    }

    function airdropDistributionMint(uint256 amount, address devAddress) external onlyOwner nonReentrant {
        require(airdropDistribution, "Airdrop Distribution is inactive");
        require(totalSupply() + amount <= MAX_SUPPLY, "Amount exceeds supply!");
        _safeMint(devAddress, amount);
    }
}
