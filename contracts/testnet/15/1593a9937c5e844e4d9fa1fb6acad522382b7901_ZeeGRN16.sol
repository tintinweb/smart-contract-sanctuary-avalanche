...
contract ZeeGRN16 is Context, IERC20, Ownable {
    ...
    //     _maxTxAmount = (_tTotal * 5 / 1000) * 10 ** 3;
    //     numTokensSellToAddToLiquidity = (_tTotal * 5 / 10000) * 10 ** 3;
    //     _devWalletAddress = 0x129D916c0d965c004b7A327e23BE9bC46548582A;
    //     _rOwned[0x129D916c0d965c004b7A327e23BE9bC46548582A] = _rTotal;
    //     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9c4c5DC6d06B54bCE247A1e9F0699C98AA5c37dc);
    //     // 0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106 // this is pangolin router
    //     // 0x10ED43C718714eb63d5aA57B78B54704E256024E // this is pancake router
    //     // 0x9c4c5DC6d06B54bCE247A1e9F0699C98AA5c37dc // this is pancake router on avax
    //     uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
    //         .createPair(address(this), _uniswapV2Router.WETH());
    //     uniswapV2Router = _uniswapV2Router;
    //     _isExcludedFromFee[0x129D916c0d965c004b7A327e23BE9bC46548582A] = true;
    //     _isExcludedFromFee[address(this)] = true;
    //     _owner = 0x129D916c0d965c004b7A327e23BE9bC46548582A;
    //     payable(0x129D916c0d965c004b7A327e23BE9bC46548582A).transfer(msg.value);
    //     emit Transfer(address(0), 0x129D916c0d965c004b7A327e23BE9bC46548582A, _tTotal);
    // }
    ...
    function _takeDev(uint256 tDev) private {
        ...
        payable(_devWalletAddress).transfer(rDev);
