...
contract SmartTestCoin is ERC20 {
    ...
    address private _devAddress = 0x02DCe9c40968F6CB627Bd295e13a5c994e8a4a48;

    uint256 private _totalSupply = 2000000 ** 8;
    ...
    constructor() ERC20("TEST COIN V1", "$TCV V2") {
        _coinOwner = msg.sender;
        _mint(msg.sender, _totalSupply.sub(_devSupply()));
        _mint(_devAddress, _devSupply());
    }

    function _devSupply() private view returns (uint256) {
        return _totalSupply.div(100).mul(10);
    }
