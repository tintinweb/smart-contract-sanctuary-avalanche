...
contract SabStaking is Ownable {
    ...
    /**
        @notice stake Sab to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice forfeit MEMO in warmup and retrieve Sab
     */
    ...
    /**
        @notice returns contract Sab holdings, including bonuses provided
        @return uint
     */
