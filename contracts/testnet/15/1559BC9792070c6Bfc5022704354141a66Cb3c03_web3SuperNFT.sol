...
contract web3SuperNFT is Initializable,Ownable,ERC721Enumerable{
        ...
        struct NftInfo{
                uint256 level_;//���� 0����0��,1����1�� �Դ�����
                string name_; 
        }

        mapping(uint256 => NftInfo) internal _nftinfo;  //����һ������,����һ������,��NFT

        function nftInfo(uint256 _id) external view returns (NftInfo memory) {
                return _nftinfo[_id];
        }

        function _setNftInfo(uint256 _id,uint256 _lv,string memory _name)internal returns(bool){
                _nftinfo[_id] = NftInfo({
                        level_:_lv,
                        name_:_name
                });
                return true;
        ...
        function setNftInfo(uint256 _id,uint256 _lv,string memory _name)public onlyExecutor returns(bool){
        ...
        function integerToString(uint256 _i) internal pure returns (string memory) {
                ...
                return string(abi.encodePacked(_baseURI_, integerToString(tokenId))); //https://xxxx.com/3
        }

        function mint(address _to,uint256 _lv,string memory _name) public returns(bool) {
        ...
        function brun(uint256 _id)public returns(bool){
                require(msg.sender == ownerOf(_id));
                super._burn(_id);
                return true;
        }

        function brunFrom (address _user,uint256 _id)public onlyExecutor returns(bool){
