...
// L-License-Identifier: Unlicense
...
// L-License-Identifier: UNLICENSED
pragma solidity >=0.8.4;
...
contract CygnusCollateralControl is ICygnusCollateralControl, CygnusTerminal {
     ...
     *  @inheritdoc ICygnusCollateralControl
     */
    uint256 public constant override liquidationIncentiveMin = 1.00e18;

    /**
     *  @inheritdoc ICygnusCollateralControl
     */
    uint256 public constant override liquidationIncentiveMax = 1.50e18;
    ...
    constructor()
        /**
         *  @param collateralName Name of the Erc20 Cygnus Collateral token
         *  @param collateralSymbol Symbol of Erc20 Cygnus Collateral token
         *  @param decimals Decimals of the Erc20 Cygnus Collateral token (always 18)
         */
        CygnusTerminal(collateralName, collateralSymbol, collateralDecimals)
    {
    ...
    function setPriceOracle(ICygnusNebulaOracle newCygnusNebulaOracle) external override cygnusAdmin nonReentrant {
        // We update oracle in factory first, then when we need to update all pool oracles we run function there
...
contract CygnusCollateral is ICygnusCollateral, CygnusCollateralModel {
     ...
     *  @dev Overrides CygnusTerminal function
...
contract CygnusDeneb is ICygnusDeneb {
    ...
    function deployDeneb(
        ...
        address borrowDAITokenA,
        address borrowDAITokenB
    ) external override returns (address deneb) {
        ...
        deneb = address(new CygnusCollateral{ salt: keccak256(abi.encode(msg.sender, underlying)) }());
