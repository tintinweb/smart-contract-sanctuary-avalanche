...
import "./PreSalePoolV2.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/security/Pausable.sol";

contract PreSaleFactoryV2 is Ownable, Pausable {
    ...
    function registerPool(address _signer) external whenNotPaused returns (address pool) {
        pool = address(new PreSalePoolV2());
...
contract PreSalePoolV2 is Ownable, ReentrancyGuard, Pausable, BuniWhitelist {
    ...
    function claimTokens(
        ...
        // TBD: comment this line to allow crosschain claim
    ...
    function _forwardTokenFunds(
        ...
        SafeERC20.safeTransferFrom(IERC20(_token), msg.sender, _fundingWallet, _amount);
    }
