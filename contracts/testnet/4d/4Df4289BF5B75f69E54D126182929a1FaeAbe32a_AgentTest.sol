...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/EIP20Interface.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/ExponentialNoError.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/CarefulMath.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/Exponential.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/ErrorReporter.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/EIP20NonStandardInterface.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/InterestRateModel.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/ComptrollerInterface.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/QiTokenInterfaces.sol
...
contract QiDelegatorInterface is QiDelegationStorage {
    /**
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/QiToken.sol
 ...
 * @author Benqi
 */
contract QiToken is QiTokenInterface, Exponential, TokenErrorReporter {
    /**
     ...
     */
    function getAccountSnapshot(address account) external view returns (uint, uint, uint, uint) {
        uint qiTokenBalance = accountTokens[account];
        uint borrowBalance;
        ...
        return (uint(Error.NO_ERROR), qiTokenBalance, borrowBalance, exchangeRateMantissa);
    }
     ...
     * @return (uint, uint) An error code (0=success, otherwise a failure, see ErrorReporter.sol), and the actual repayment amount.
     */
    function liquidateBorrowInternal(address borrower, uint repayAmount, QiTokenInterface qiTokenCollateral) internal nonReentrant returns (uint, uint) {
        uint error = accrueInterest();
        if (error != uint(Error.NO_ERROR)) {
     ...
     * @return (uint, uint) An error code (0=success, otherwise a failure, see ErrorReporter.sol), and the actual repayment amount.
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, QiTokenInterface qiTokenCollateral) internal returns (uint, uint) {
        /* Fail if liquidate not allowed */
        uint allowed = comptroller.liquidateBorrowAllowed(address(this), address(qiTokenCollateral), liquidator, borrower, repayAmount);
        if (allowed != 0) {
        ...
        (uint amountSeizeError, uint seizeTokens) = comptroller.liquidateCalculateSeizeTokens(address(this), address(qiTokenCollateral), actualRepayAmount);
        ...
        emit LiquidateBorrow(liquidator, borrower, actualRepayAmount, address(qiTokenCollateral), seizeTokens);
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/PriceOracle.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/ComptrollerStorage.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/Unitroller.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/Governance/Qi.sol
...
// File: https://github.com/Benqi-fi/BENQI-Smart-Contracts/blob/master/Comptroller.sol
