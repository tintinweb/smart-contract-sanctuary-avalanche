...
contract BridgesOfFateV1Test is Ownable, ReentrancyGuard {
    ...
    uint256[] public RandomNumberAt;
    bool[] public safeSideAt;
    ...
    */
        ...
        After24Hours(playerId)
    {
        ...
        if (_gameStatus.GameLevel == 1) {
            ...
            if (randomNumber <= 0) {
                ...
                RandomNumber[dayCounter] = randomNumber; //Same Working on
                RandomNumberAt.push(randomNumber); //Same Working on
    ...
    function empty(bytes32 playerID) public {
        delete RandomNumberAt;
        delete safeSideAt;
