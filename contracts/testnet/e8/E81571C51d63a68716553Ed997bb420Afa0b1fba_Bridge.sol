...
contract Bridge is Ownable {
    ...
    function initiateBridge(address _token, uint256 _amount, string memory _chain) external {
        ...
        bridgeRequests[bridgeId] = BridgeRequest(msg.sender, _token, _amount, _chain, BridgeStatus.Initiated);
