...
// wooooooignore-License-Identifier: Unlicense
...
//wooooooignore-License-Identifier: Unlicensed
pragma solidity >=0.8.4;
...
// wooooooignore-License-Identifier: MIT
...
// wooooooignore-License-Identifier: GPL-3.0
pragma solidity >=0.8.4;
...
contract CygnusBorrowTracker is ICygnusBorrowTracker, CygnusBorrowInterest, CygnusBorrowApprove {
    ...
    function getBorrowBalance(address borrower) public view override returns (uint256) {
        ...
        return PRBMath.mulDiv(borrowSnapshot.principal, borrowIndex, borrowSnapshot.interestIndex);
    }
    ...
    function accrueInterest() public override updateBefore {
        ...
        uint256 interestAccumulated = PRBMath.mulDivFixedPoint(interestFactor, totalBorrowsStored);
        ...
        borrowIndex += (PRBMath.mulDivFixedPoint(interestFactor, borrowIndex));
...
contract CygnusBorrow is ICygnusBorrow, CygnusBorrowTracker {
    ...
    /**
     *  @notice STUDY THIS AND THE VAULT THING
     */
...
contract CygnusAlbireo is ICygnusAlbireo {
    /*  ═══════════════════════════════════════════════════════════════════════════════════════════════════════ 
            6. NON-CONSTANT FUNCTIONS
        ═══════════════════════════════════════════════════════════════════════════════════════════════════════  */
     ...
     */
    function deployAlbireo(address lpTokenPair, uint8 poolIndex) external override returns (address albireo) {
        albireo = address(new CygnusBorrow{ salt: keccak256(abi.encode(lpTokenPair, poolIndex)) }());
    }
}