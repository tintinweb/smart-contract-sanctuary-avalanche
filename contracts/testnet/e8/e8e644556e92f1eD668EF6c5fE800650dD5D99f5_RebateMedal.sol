    ...
    HasRouter
{
    ...
    modifier onlyAsset(address token) {
        require(
            ...
            "RebateMedal: token is not a bondable asset"
        );
        _;
    }
    ...
    function bond(
        ...
        require(amount > 0, "RebateMedal: invalid bond amount");
        ...
        LpToken.safeIncreaseAllowance(address(MedalToken), lpTokenAmount);
    ...
    function _verifyEnoughMainToken(
        ...
        require(
            ...
            "RebateMedal: not enough balance"
        );
    }
