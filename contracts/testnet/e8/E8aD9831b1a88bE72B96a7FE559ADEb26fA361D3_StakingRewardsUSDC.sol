...
contract StakingRewardsUSDC is 
    Pausable, 
    ReentrancyGuard,
    Ownable, 
    ERC1155Holder
{
        ...
        updateReward( _vault, epochEnd, msg.sender)
    {
        ...
        uint256 amountStake  = amount * 1e12;
        _totalSupply[_vault][epochEnd] = _totalSupply[_vault][epochEnd].add(amountStake);
        
        user[msg.sender][_vault][epochEnd].balance =  user[msg.sender][_vault][epochEnd].balance.add(amountStake);
            ...
            updateReward( _vault, epochEnd, msg.sender)
    {
        ...
        uint256 amountStake = amount * 1e12;
        _totalSupply[_vault][epochEnd] = _totalSupply[_vault][epochEnd].sub(amountStake);
        user[msg.sender][_vault][epochEnd].balance = user[msg.sender][_vault][epochEnd].balance.sub(amountStake);
        IERC1155(_vault).safeTransferFrom(
            address(this),
            msg.sender,
            epochEnd,
