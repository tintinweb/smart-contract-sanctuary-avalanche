/**
 *Submitted for verification at testnet.snowtrace.io on 2023-06-30
*/
...
contract TheMars is ERC20 {
  using SafeMath for uint256;
  mapping (address => uint256) private balances;
  mapping (address => mapping (address => uint256)) private allowed;
  string public constant name  = "The Mars";
  string public constant symbol = "MRST";
