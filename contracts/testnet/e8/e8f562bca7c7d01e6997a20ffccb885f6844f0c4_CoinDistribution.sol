...
contract CoinDistribution is Context, Ownable {
    ...
    constructor (address _coin,uint256 _swapRate,uint256 _withdrawStartTime,uint256 _totalCoinAmount) public {
        ...
        require(_totalCoinAmount>0,"totalCoinAmount error");
