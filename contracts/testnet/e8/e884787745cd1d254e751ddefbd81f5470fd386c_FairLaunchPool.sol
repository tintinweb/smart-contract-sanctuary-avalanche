...
// File: contracts/FairLaunchPool.sol
...
contract FairLaunchPool is Ownable {
    ...
    constructor(
        ...
        //investDecimals = ERC20(_investToken).decimals();
        //launchDecimals = iNRT(_nrt).decimals();
    ...
    function removeWhitelist(address _address) external onlyOwner {
        require(!saleEnabled, "sale has already started");
        require(numWhitelisted > 0, "There is nothing to remove");
    ...
    function invest(uint256 investAmount) public {
        ...
        iNRT(nrt).issue(msg.sender, issueAmount * 10 ** 18);
    ...
    function withdrawTreasury(uint256 amount) public onlyOwner {
        ...
        require(
            IERC20(investToken).transfer(admin, amount),
            "transfer failed"
        );
    }
