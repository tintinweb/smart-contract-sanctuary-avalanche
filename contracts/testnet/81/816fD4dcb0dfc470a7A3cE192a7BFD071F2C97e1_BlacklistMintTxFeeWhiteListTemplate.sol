...
// File contracts/templates/BlacklistMintTxFeeWhiteListTemplate.sol
    ...
    PausableWithWhitelistFeature
{
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(BlacklistFeature, PausableWithWhitelistFeature, TxFeeFeatureAlt) {
