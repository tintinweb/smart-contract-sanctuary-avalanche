...
contract Lottery is Ownable, Pausable, PullPayment, ReentrancyGuard {
		...
		nonReentrant
	{
		...
		uint256 dividentsAmount = _calcPercentage(ticketPrice, dividentsFee); //10%
	...
	function setDividentsSettings(uint256 intervalInSeconds) public onlyOwner {
