...
contract Stake is ERC20{
    ...
    function stakeTKN10(uint256 _stakeAmount) public returns(uint256 _sTokenAmount) {
        ...
        lockTime10[msg.sender] = block.timestamp.add(300); //(300 = 5 min),10 days, amount in seconds
...
//30 days staking
    function stakeTKN30(uint256 _stakeAmount) public returns(uint256 _sTokenAmount) {
        ...
        lockTime30[msg.sender] = block.timestamp.add(600); //(600 = 10 min),One month, amount in seconds
    ...
    function reStakeTKN30() public returns(uint256 _sTokenAmount) {
        ...
        lockTime30[msg.sender] = block.timestamp.add(600); //(600 = 10 min),10 days, amount in seconds
...
//60 days staking
    function stakeTKN60(uint256 _stakeAmount) public returns(uint256 _sTokenAmount) {
        ...
        lockTime60[msg.sender] = block.timestamp.add(900); //(900 = 15 min),Two month, amount in seconds
    ...
    function reStakeTKN60() public returns(uint256 _sTokenAmount) {
        ...
        lockTime60[msg.sender] = block.timestamp.add(900); //(900 = 15 min),60 days, amount in seconds
    ...
    function swapSTokenToToken(uint256 _swapAmount)public returns(uint256 _swapped) {
        require(_swapAmount <= _balances[msg.sender], "Not enought balanse of sTokens!");
        ...
        token.transfer(msg.sender, _swapAmount);
