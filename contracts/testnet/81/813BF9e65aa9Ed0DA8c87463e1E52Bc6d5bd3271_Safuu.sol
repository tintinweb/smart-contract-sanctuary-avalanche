...
contract Safuu is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Safuu", "SAFUU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xD6931D3427C0AE639A3C0816c38C0f2e2cCB0164;
        treasuryReceiver = 0xD6931D3427C0AE639A3C0816c38C0f2e2cCB0164; 
        safuuInsuranceFundReceiver = 0xD6931D3427C0AE639A3C0816c38C0f2e2cCB0164;
        firePit = 0xD6931D3427C0AE639A3C0816c38C0f2e2cCB0164;
