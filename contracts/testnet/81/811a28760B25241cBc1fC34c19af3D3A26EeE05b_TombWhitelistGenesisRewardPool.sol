...
// File: contracts/glad_core/beta/TombWhitelistGenesisRewardPool.sol
...
contract TombWhitelistGenesisRewardPool {
    ...
    // MAINNET
    uint256 public tombPerSecond = 20000 ether / uint256(1 days); // 20000 TOMB / (24h * 60min * 60s)
    ...
    constructor(
        ...
        if (_wl != address(0)) wl = IWhitelistMinimal(_wl);
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        require(wl.isWhitelisted(_sender), "Deposit: only whitelisted addresses can participate");
        PoolInfo storage pool = poolInfo[_pid];
