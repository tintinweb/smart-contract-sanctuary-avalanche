...
contract Ulys is ERC20Burnable, Operator {
    ...
    function _transferWithTax(
        ...
        require(this.transferFrom(msg.sender, address(this), taxAmount), "bruh");
        ...
        // tester si il faut approuver le router PAR le router ???

        // tester en envoyant les fonds du swap sur le contrat avant de faire le swap
