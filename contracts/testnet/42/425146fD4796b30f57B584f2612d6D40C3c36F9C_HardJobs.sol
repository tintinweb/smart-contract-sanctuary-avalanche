    ...
    RoyaltiesV2Impl
{
    ...
    uint256 public constant tokenPrice = 1; //  AVAX
    ...
    address private refundAddress = 0x8437510E0276271711B217EaecDF884F567AFe79;

    event HardJobsMinted(uint256 tokenId, address owner);

    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721("HardJobscoolyGirles", "HJS") ReentrancyGuard() {}
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        if (_royalties.length > 0) {
            return (
                ...
                (_salePrice * _royalties[0].value) / 100
                /*  1avax    * 250                  / 100  = 2.5  royalty 
                2.5% of the _salePrice should be sent to the receiver, we know that 2.5% of 45 Ether is 1.125 Ether. 
                However, Solidity will compute 1 Ether:
...
abstract contract AbstractRoyalties {
    ...
    function _saveRoyalties(uint256 id, LibPart.Part[] memory _royalties) internal {
        ...
        require(totalValue < 50, "Royalty total value should be < 10000");
