...
contract TokenCreator is Ownable {
  ...
  function createNewToken(
    ...
    TokenV1 newToken = new TokenV1(tokenOwner, tokenName, tokenSymbol, decimal, amountOfTokenWei, fees[5], fees[6], _feeWallet, routerAddress);
...
contract TokenV1 is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;
