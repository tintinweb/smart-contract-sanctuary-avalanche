...
contract EVICGenesis is ContractGuard, Ownable {
    ...
    uint256 public constant TOTAL_REWARD_POOL_4_NEXT_PHASE = 5.7375 ether; // 60% of (85% of 15 * 3/4)
    uint256 public constant TOTAL_REWARD_POOL_3_NEXT_PHASE = 0.478125 ether; // 5% of (85% of 15 * 3/4)
    ...
    uint256 public constant TOTAL_REWARD_POOL_0_NEXT_PHASE = 0.478125 ether; // 5% of (85% of 15 * 3/4)
