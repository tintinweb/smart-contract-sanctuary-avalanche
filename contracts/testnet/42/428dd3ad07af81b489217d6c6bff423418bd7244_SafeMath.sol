 ...
 * 
    Demeter
    The goddess of harvest is here to reward her people and defeat enemy gods.


  5%(Rewards Fee) + 2%(Liquidity fee) + 5%(Marketing fee)
  Total tax = 12% 
...
contract Demeter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Demeter V2";
    string constant _symbol = "DMTR";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 1%

    uint256 public _maxWalletToken = ( _totalSupply * 5/2 ) / 100; // 2.5%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x75965674Eda88eB1CA1474Ceb25aA5F77A6c7278; 
        ...
        marketingFeeReceiver = 0xd1867987Db0f4D1dBCe7870E2895209C7a34b1c1;
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountMETISReflection}() {} catch {}
        (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountMETISMarketing, gas: 30000}("");
    ...
    event AutoLiquify(uint256 amountMETIS, uint256 amountBOG);
