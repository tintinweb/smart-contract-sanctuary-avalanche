...
contract TheFryingPan is Ownable, IERC721Receiver, ReentrancyGuard {
	...
	function delBuildNumber3612111() internal pure {} //etherscan trick
	 ...
	 */
	function upgradeHideoutStakingLevel() external nonReentrant {
		// check if stakingLevelPerAddress is set. If not, set to default values
		if (!isStakingLevelPerAddressSet[msg.sender]) {
			stakingLevelPerAddress[msg.sender] = StakingLevel({
				hideoutLevel: 0, // default
	 ...
	 */
	function upgradePoliceStationStakingLevel() external nonReentrant {
		// check if stakingLevelPerAddress is set. If not, set to default values
		if (!isStakingLevelPerAddressSet[msg.sender]) {
			stakingLevelPerAddress[msg.sender] = StakingLevel({
				hideoutLevel: 0, // default
