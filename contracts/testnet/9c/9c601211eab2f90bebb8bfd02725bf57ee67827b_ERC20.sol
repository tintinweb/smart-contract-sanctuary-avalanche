...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    // array of addresses holding tokens
    ...
    function creationBasket(
        ...
        if (
            ...
            _mint(_feeRecipient, creationFeeAmount);
            // emit creation basket event
            emit creationBasketEvent(
                msg.sender,
                receiverAddress_,
        ...
        returns (bool)
    {
        ...
        if (
            ...
            uint256 redemptionFeeAmount = (amount_ * _redemptionFee) /
                (10**_feeDecimals);
            _transfer(senderAddress_, _feeRecipient, redemptionFeeAmount);
    ...
    function withdrawContractTokens() external onlyFeeRecipient {
        ...
        _transfer(address(this), _feeRecipient, balance_);
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 transferFeeAmout = (amount_ * _transferFee) /
                (10**_feeDecimals);
            if (_balances[_feeRecipient] == 0) 
                _holders.push(_feeRecipient);
            // udpate balances
            unchecked {
