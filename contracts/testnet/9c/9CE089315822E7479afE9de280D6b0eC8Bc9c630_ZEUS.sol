...
contract NODERewardManagement {
    ...
    function getNodePriceByType(uint32 nodeType) view external onlySentry returns(uint256){}
}
...
contract ZEUS is ERC20, PaymentSplitter {
    ...
    function createNodeWithTokens(string memory name, address referred_by, uint256 total, uint32 nodeType)
        public
    {
        ...
        for(uint256 i = 0; i <total; i++){
            string memory name_ = string(abi.encodePacked(name,'_',Strings.toString(i+1)));
    ...
    function compoundNode(uint256 created_at, string memory nodeName, uint32 nodeType) external {
