...
contract LuckyBox is ERC721Enumerable, ReentrancyGuard, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    string public _cid;
    string public _nonRevealedURI = "https://smolr.mypinata.cloud/ipfs/Qmaw6AnUKqcmKVQoSQTSMVsN6sWa1N8Li5VpK1ho2e3jG4";
    ...
    constructor() ERC721("Lucky Box", "BOX") {
    ...
    function mint(uint256 count) callerIsUser nonReentrant public payable {
        ...
        require(supply + count <= maxSupply,  "All Lucky Boxes have been minted");
        require(msg.value >= price * count, "Mint in 1 avax * count");
