...
contract EVICGenesis is ContractGuard, Ownable {
    ...
    uint256 public constant TOTAL_REWARD_POOL_4_NEXT_PHASE = 4.78125 ether; // 50% of (85% of 15 * 3/4)
    uint256 public constant TOTAL_REWARD_POOL_3_NEXT_PHASE = 0.7171875 ether; // 7.5% of (85% of 15 * 3/4)
    uint256 public constant TOTAL_REWARD_POOL_2_NEXT_PHASE = 1.434375 ether; // 15% of (85% of 15 * 3/4)
    uint256 public constant TOTAL_REWARD_POOL_1_NEXT_PHASE = 1.434375 ether; // 15% of (85% of 15 * 3/4)
    uint256 public constant TOTAL_REWARD_POOL_0_NEXT_PHASE = 1.1953125 ether; // 12.5% of (85% of 15 * 3/4)
