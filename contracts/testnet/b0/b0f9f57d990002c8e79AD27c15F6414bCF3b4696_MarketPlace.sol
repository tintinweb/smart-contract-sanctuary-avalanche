...
contract MarketPlace is Context, Ownable, Pausable, IERC721Receiver {
    uint256 public MAX_PRICE = 200000000000000; /// 2m AAA (Agarta token)
    Item[] public items;
    IERC20 nativeToken;
    ...
    constructor(IERC721Meta _nftContract, IERC20 _nativeToken, address benf) {
        nftContract = IERC721Meta(_nftContract);
