...
function addAddress(uint pollId, address _address) public {
  addressToMany[pollId].push(_address);
}
...
address[] memory existingAdd = addressToMany[pollId];
