...
contract Lottery is Ownable, Pausable, PullPayment, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (affiliateAddress != address(0)) {
            ...
            (bool s, ) = payable(nonAffiliateWallet).call{
        ...
        (bool success, ) = payable(insuranceBuyBackWallet).call{
            value: insuranceBuyBackAmount
        }("");
    ...
    function getWinnerEarnings() public view returns (uint256) {
        ...
        return
            _calcPercentage(
                address(this).balance - _royaltiesDeposits,
                prizeFee
            );
    }
    ...
    function setTicketPrice(uint256 maxTickets, uint256 newPrice)
        external
        onlyOwner
    {
