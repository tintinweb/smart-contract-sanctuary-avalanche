...
// Fuji: 0xb050324f8952c0cc976188b100db3174427199bb
contract SuperReveal is VRFConsumerBaseV2, Ownable {
    ...
    modifier onlyInitializerOrOwner() {
        if (owner() != msg.sender && initializerAddress != msg.sender) {
            revert Unauthorized();
        }
        _;
    }

    constructor(address _coordinator, bytes32 _keyHash, uint64 _subscriptionId) VRFConsumerBaseV2(_coordinator) {
