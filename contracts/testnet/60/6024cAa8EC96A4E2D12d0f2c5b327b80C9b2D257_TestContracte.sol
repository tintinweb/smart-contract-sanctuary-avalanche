...
// File contracts/TestContracte.sol
...
contract TestContracte is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    function devMint(uint256 numTokens) public onlyOwner {
