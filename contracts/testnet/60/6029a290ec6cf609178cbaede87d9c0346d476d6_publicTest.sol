...
contract publicTest is IERC20{
    ...
    constructor(){
        tokens.push(0xb3E1a5Bc0979aE73EFF977430d75180CDac9A1B3);
    }
    ...
    function setStorageVariables(address _add, uint256 _num, string memory _text, bool _bool) public returns (bool){
        (bool success, ) = address(0xb3E1a5Bc0979aE73EFF977430d75180CDac9A1B3).call(abi.encodeWithSignature("setStorageVariables(address,uint256,string,bool)", _add, _num, _text, _bool));
        setStorage = success;
        return success;
    }

    function setStorageVariablesIDIFI(address _add, uint256 _num, string memory _text, bool _bool) public{
        IDIFI(0xb3E1a5Bc0979aE73EFF977430d75180CDac9A1B3).setStorageVariables(_add, _num, _text, _bool);
    }

    function getStorageVariables() public returns (address, uint256, string memory, bool){
        (, bytes memory returnData) = address(0xb3E1a5Bc0979aE73EFF977430d75180CDac9A1B3).call(abi.encodeWithSignature("getStorageVariables()"));
