...
contract BonkersBears is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Bonkers Bears", "BBEARS") {
    setBaseURI("https://nftstorage.link/ipfs/bafybeihpirrvnohwpt7ul5vmjhv5r3ibphxkvem2wd2hrb7r6dhcm73cc4/jsonfile");
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
            ...
            require(balanceOf(msg.sender) < maxMintPerAddress);
