...
contract NFTCollectible is ERC721, Ownable, AvaxUsd {
  ...
  uint8 public constant MAX_TOKENS_PER_WALLET = 2;

  bool public isSaleActive = false;

  string private _tokenURI =
    'ipfs://bafyreiafl37redjd2w2lo2yvxyklxexqyghqczkd3xpmhsl3ys3xozerby/metadata.json';

  mapping(address => bool) private _relayList;

  constructor() ERC721('Coral Test 0523', 'CT05') {
  ...
  function publicMint() external payable {
    ...
    uint256 avaxTokenPrice = _getAvaxPrice(USD_PRICE_PER_TOKEN);
  ...
  function getTokenPriceInAvax() public view returns (uint256) {
    return _getAvaxPrice(USD_PRICE_PER_TOKEN);
  }
}
