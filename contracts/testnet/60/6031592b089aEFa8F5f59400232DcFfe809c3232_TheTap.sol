...
contract TheTap is OwnableUpgradeable  {
  ...
  function deposit(address _upline, uint256 _amount) external noBlackList {
  ...
  function claim() external noBlackList {
  ...
  function roll() external noBlackList {
  ...
  function airdrop(address _to, uint256 _amount) external noBlackList {
  ...
  //@dev Send specified DRIP amount supplying an upline referral
    function MultiSendairdrop(address[] memory _to, uint256 _amount) external noBlackList {
    address _addr = msg.sender;
