...
contract CyberGods_Game is Ownable, Pausable {
    ...
    // Events
    event AttackResult(address winner, address loser); // Emited when a player attacks another one
