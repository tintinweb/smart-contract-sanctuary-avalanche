...
contract DaoSwapper {
  ...
  IPangolinRouter internal PangonlinRouter;
  ...
  function swapExactAVAXForTokens() public payable {
      uint amountOutMin = getLatestPrice() * 10000000000 ; // decimal 8
      uint deadline = block.timestamp + 15; // using 'now' for convenience, for mainnet pass deadline from frontend!
    PangonlinRouter.swapAVAXForExactTokens{ value: msg.value }(amountOutMin, getPathForAvaxForshermix(), address(msg.sender), deadline);
