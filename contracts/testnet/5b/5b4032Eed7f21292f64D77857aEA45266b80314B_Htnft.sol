...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0xD1FB7870e6b1B7a2C2bF296712Ed3EeB9a3E7B09);
	}
...
contract Htnft is ERC721Enumerable, Ownable, ReentrancyGuard {
	...
	uint256 public constant TIME_FOR_GROWN = 1689782083000;
	address public founder = 0xD1FB7870e6b1B7a2C2bF296712Ed3EeB9a3E7B09;
	...
	string private _baseTokenURI = "https://lab.cryptodo.app/create?type=ERC721_CONTRACT&network=MANTLE";
