...
contract PENGUINPACKS is ClampedRandomizer, ERC721A, ERC2981, Ownable  {
    ...
    constructor() ERC721A("TESTPACKS", "TPKS") ClampedRandomizer(maxSupply){
    ...
    function internalMint(address to, uint256 quantity) internal {
         uint256 tokenId = _genClampedNonce() + quantity;
