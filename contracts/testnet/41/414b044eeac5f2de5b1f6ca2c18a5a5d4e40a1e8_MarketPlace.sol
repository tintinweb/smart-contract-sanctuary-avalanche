    ...
    Ownable
{
        ...
        nonReentrant
    {
        ...
        uint calculateServiceFee = msg.value * serviceFee / ROYALTY_MAX;
        uint calculateSellerReceipt = msg.value - calculateServiceFee;

        Address.sendValue(payable(_serviceWallet), calculateServiceFee);
        Address.sendValue(
            payable(idToListedToken[tokenId].owner),
            calculateSellerReceipt
        );
