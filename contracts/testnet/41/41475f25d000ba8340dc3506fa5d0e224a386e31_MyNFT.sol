...
contract MyNFT is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("star collection", "star") {
    _customBaseURI = 'https://gateway.pinata.cloud/ipfs/QmQhe7EjQspF2RkcximTTBC7aqpyg9L5MwUMpoD4mNkkkF';
    _price = 0.1 ether; // 0.1 AVAX mint price 
    _maxMintable = 2; // 2 max supply
  ...
  function royaltyInfo(
    ...
    return (owner(), ((_salePrice * _royaltyAmount) / 2));
  }
