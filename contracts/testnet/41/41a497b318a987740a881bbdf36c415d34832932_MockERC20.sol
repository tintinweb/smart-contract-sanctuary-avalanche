...
contract MockERC20 is Context, AccessControlEnumerable, ERC20, ERC20Pausable {
     ...
     */
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        require(hasRole(APPROVED_ROLE, _msgSender()), "MockERC20: must have approved role to transfer");
    ...
    function transferFrom(
        ...
        require(hasRole(APPROVED_ROLE, _msgSender()), "MockERC20: must have approved role to transferFrom");
