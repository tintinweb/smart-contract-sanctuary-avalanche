...
contract TalentScoutPresale is ReentrancyGuard, Ownable {
    ...
    function saleLock(address _account, uint256 _scoutToLock) private {
        ...
        talentScout.insertPresaleLock(_account, m6Release, 1 minutes);
        talentScout.insertPresaleLock(_account, m8Release, 2 minutes);
        talentScout.insertPresaleLock(_account, m9Release, 3 minutes);
        talentScout.insertPresaleLock(_account, m10Release, 4 minutes);
        talentScout.insertPresaleLock(_account, m11Release, 5 minutes);
        talentScout.insertPresaleLock(_account, m12Release, 6 minutes);
        talentScout.insertPresaleLock(_account, m15Release, 7 minutes);
        talentScout.insertPresaleLock(_account, m18Release, 8 minutes);
    }
