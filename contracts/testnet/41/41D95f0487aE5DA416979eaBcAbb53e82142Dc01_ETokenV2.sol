...
contract ETokenV2 is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, Lockable, MinterRole {
    constructor() ERC20("EToken2", "ET2") ERC20Permit("EToken2") {}
...
abstract contract MinterRole is Context {
    ...
    function _setMinterStatus(address account_, bool status_) private {
