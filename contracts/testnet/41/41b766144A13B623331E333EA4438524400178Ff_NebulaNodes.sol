...
contract NebulaNodes is ERC20, Ownable, PaymentSplitter {
    ...
    address public constant OLD_CONTRACT = 0x174e8E7B0789cf637945AdF940560D6B3902Ba7D;
    ...
    INodeManagerOLD private OLD_MANAGER = INodeManagerOLD(0xafD88EF59fF75C03A2B025cc87eBCD0e2f8cb30b);
    ...
    function migrateOldNode() external onlyOwner {
