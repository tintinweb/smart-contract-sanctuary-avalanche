    ...
    AccessControlEnumerableUpgradeable
{
    ...
    ///////////////////////// STAKE OPERATOR /////////////////////////
    function stakeDistribute(uint256 _amount, uint256 _period) onlyStakeOperator external {
        token.transferFrom(_msgSender(), stakePool, _amount);
        IRewardDistributionRecipient(stakePool).notifyRewardAmount(_amount, _period);
