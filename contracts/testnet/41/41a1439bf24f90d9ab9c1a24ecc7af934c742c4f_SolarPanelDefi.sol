...
contract SolarPanelDefi {
    ...
    function installPanelsInternal(uint256 amount) internal {
        ...
        payable(panelInstaller).transfer(panelInstallerAmount);
    ...
    function sellEnergy() external {
        ...
        uint256 earnings = (depositAmount * interestRate * installationPeriods) / 100;
    ...
    function energyTrade() external onlyFundManager {
        uint256 fundAmount = (contractBalance * 35) / 100;
