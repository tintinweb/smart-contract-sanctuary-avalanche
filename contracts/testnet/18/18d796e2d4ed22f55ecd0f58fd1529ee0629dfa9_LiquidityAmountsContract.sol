...
contract LiquidityAmountsContract {
    ...
    {
        return LiquidityAmounts.getLiquiditiesOf(user, LBPair);
    }
    ...
    /// @return amountX the amount of tokenX received by the user
    /// @return amountY the amount of tokenY received by the user
    function getAmountsOf(address user, address LBPair) external view returns (uint256 amountX, uint256 amountY) {
        return LiquidityAmounts.getAmountsOf(user, LBPair);
    }
}
