...
contract MoonDoge is ERC721, Ownable, IERC721Enumerable {
    ...
    * @param _encodedTraits  Encoded traits
    */
    function mint(
        address _to,
        ...
        tokenTraits[_currentTokenID] = _encodedTraits;
        _currentTokenID++;
    }
    
    /**
    * @dev Mint tokens for each id in _ids
    * @param _to             The addresses to mint tokens to
    * @param _encodedTraits  Array of encoded traits per token
    */
    function batchMint(
        address[] memory _to,
        ...
        for (uint256 i = 0; i < _to.length; i++) {
            _mint(_to[i], _currentTokenID);
            tokenTraits[_currentTokenID] = _encodedTraits[i];
            _currentTokenID++;
        }
    }
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < MoonDoge.totalSupply(), "ERC721Enumerable: global index out of bounds");
