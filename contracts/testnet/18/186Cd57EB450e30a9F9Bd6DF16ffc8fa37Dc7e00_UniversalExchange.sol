    ...
    ReentrancyGuard
{
    ...
    function buyTokens(
        ...
        emit TokensPurchased(id, quantity, price, buyer, seller, token);
    }
    ...
    function buyerOffer(
        ...
        emit OfferPlaced(id, quantity, price, buyer);
    }
    ...
    function counterSeller(
        ...
        emit Counter(id, listingOffer.quantity, price, listing.seller);
    }
    ...
    function counterBuyer(
        ...
        emit Counter(id, listingOffer.quantity, price, buyer);
    }
    ...
    function rejectCounter(
        ...
        emit RejectCounter(id, quantity, price, buyerWallet);
    }
    ...
    function cancelBuyer(
        ...
        emit BuyerOfferCanceled(quantity, price, listing.token, buyerWallet);
    }
