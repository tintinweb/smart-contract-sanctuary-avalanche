...
contract BLV_IDO is Ownable {
    ...
    */
       ...
       public 
    {
        ...
        else if(IBEP20(_token1) == USDT && IBEP20(_token1) == BUSD){
            buyUSDTtoBUSD(_tokenAmount);
        }

        else if(IBEP20(_token1) == USDT && IBEP20(_token1) == BLV){
            buyUSDTtoBLV(_tokenAmount);
        }

        else if(IBEP20(_token1) == BUSD && IBEP20(_token1) == BLV){
            buyBUSDtoBLV(_tokenAmount);
        }

        else if(IBEP20(_token1) == BLV && IBEP20(_token1) == BUSD){
            buyBLVtoBUSD(_tokenAmount);
        }

        else if(IBEP20(_token1) == BLV && IBEP20(_token1) == USDT){
