...
library PermitHelper {
    ...
    function erc20Permit(address asset_, uint256 assetValue_, uint256 deadline_, bytes calldata permitSignature_) internal {
    ...
    ERC721URIStorageUpgradeable
{
    ...
    function createStore(Store calldata store_, address paymentToken_, uint256 deadline_, bytes calldata permitSignature_, bytes calldata signature_) external {
        ...
        if (permitSignature_.length != 0) PermitHelper.erc20Permit(paymentToken_, amount, deadline_, permitSignature_);
