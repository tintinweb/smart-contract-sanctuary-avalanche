...
contract NftMarketplace is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        //c'est ici qu'il faut mettre le système de royalties pour les revente.
        s_royalties += msg.value / 10;
    ...
    function withdrawRoyalties() external isMarketOwner {
        uint256 royalties = s_royalties;
        if (s_royalties <= 0) {
            revert NoProceeds();
        }
        s_royalties = 0;
