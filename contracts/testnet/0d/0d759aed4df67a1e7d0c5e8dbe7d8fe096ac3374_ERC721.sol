...
contract KeepersOfArcadia is ERC721, ERC721Enumerable, ERC2981, Ownable {
    ...
    function setRoyaltyInfo(address _reciever, uint96 _royaltyFee) public onlyOwner {
        _setDefaultRoyalty(_reciever, _royaltyFee);
    }
