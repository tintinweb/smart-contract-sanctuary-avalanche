    ...
    ReentrancyGuard
{
        ...
        returns (uint256 sequence)
    {
        address msgSender = _msgSender();
        require(
            isTokenWhitelisted(_collateralDetail.collateralToken),
            "Token not whitelisted"
        );
        require(_collateralDetail.collateralAmount > 0, "Invalid amount");
        SafeERC20.safeTransferFrom(
            IERC20(_collateralDetail.collateralToken),
            msgSender,
            address(this),
        ...
        MessageHeader memory header = MessageHeader({
            payloadID: uint8(1),
            sender: _msgSender(),
            collateralAddress: _collateralDetail.collateralToken,
    ...
    function getLoanCrossChain(bytes calldata encodedVm) public {
        ...
        state.accountAssets[borrower].source.borrowed[borrowToken] += loanAmount;
