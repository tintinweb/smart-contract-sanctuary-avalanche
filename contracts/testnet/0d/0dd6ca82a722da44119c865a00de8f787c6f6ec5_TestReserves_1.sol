...
contract TestReserves_1 {
  ...
  function getToken0Price() public view returns(uint)
   ...
   function getAvax0Price() public view returns(uint)
  
   {
    IUniswapV2Pair pair = IUniswapV2Pair(address(0x0e0100Ab771E9288e0Aa97e11557E6654C3a9665));
    IERC20 token1 = IERC20(pair.token1()); // function `token1()`
    (uint Res0, uint Res1,) = pair.getReserves();
   ...
   function getAvax1Price() public view returns(uint)
