...
contract SabTreasury is Ownable {
    ...
    /**
        ...
        @return send_ uint
     */
    function deposit( uint _amount, address _token, uint _payout ) external returns ( uint send_ ) {
    ...
    function toggleAutoMint () external onlyOwner() {
