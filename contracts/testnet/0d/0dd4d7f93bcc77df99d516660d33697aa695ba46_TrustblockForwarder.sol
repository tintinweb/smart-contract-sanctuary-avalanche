...
import {ITrustblockForwarder} from "./interfaces/ITrustblockForwarder.sol";

/**
 * @title The Forwarder Implementation
 * @notice This implementation of the `ITrustblockForwarder` interface uses ERC-712 signatures and stored nonces for verification.
 */
contract TrustblockForwarder is ERC165, ITrustblockForwarder {
    ...
    /// @inheritdoc ITrustblockForwarder
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(ITrustblockForwarder).interfaceId ||
 ...
 */
interface ITrustblockForwarder is IERC165 {
    /**
