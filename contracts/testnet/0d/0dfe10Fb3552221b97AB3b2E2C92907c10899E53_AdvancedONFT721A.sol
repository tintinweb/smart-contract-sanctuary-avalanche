...
contract AdvancedONFT721A is ONFT721A {
    ...
    uint32 public startId;
    uint32 public maxId;
    uint32 public maxGlobalId;
    ...
    ) ONFT721A(_name, _symbol, 1, _lzEndpoint) {
        startId = _startId;
...
contract ONFT721A is ONFT721ACore, ERC721ASpecific, IONFT721A, DefaultOperatorFilterer{
    constructor(string memory _name, string memory _symbol, uint256 _minGasToTransfer, address _lzEndpoint) ERC721ASpecific(_name, _symbol) ONFT721ACore(_minGasToTransfer, _lzEndpoint) {}
