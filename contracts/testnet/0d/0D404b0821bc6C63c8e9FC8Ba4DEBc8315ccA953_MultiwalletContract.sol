...
contract MultiwalletContract is Ownable {
     ...
     */
    function multiwallet(address mAddress, RecipientType mType, uint256 amount) external onlyAllowed {
     ...
     */
    function multiwalletTransfer(address fromAddress, RecipientType fromType, address toAddress, RecipientType toType, uint256 amount) external onlyAllowed {
     ...
     */
    function deMultiwallet(address mAddress, RecipientType mType, uint256 amount) external onlyAllowed {
        _multiwallet[mType][mAddress] = _multiwallet[mType][mAddress] - amount;
     ...
     * @param amount   Amount to be deMultiwalleted(made claimable).
     */
    function unMultiwallet(address mAddress, RecipientType mType, uint256 amount) external onlyAllowed {
        _multiwallet[mType][mAddress] = _multiwallet[mType][mAddress] - amount;
     ...
     */
    function claim(RecipientType recipientType) external {
