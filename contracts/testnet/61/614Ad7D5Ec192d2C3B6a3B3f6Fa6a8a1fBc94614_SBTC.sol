...
contract SBTC is BaseERC1155, IRoyaltyChecker {
    ...
    function closeUnpaidFee(uint256[] memory sbtIds_) external payable returns (bool) {
...
interface IRoyaltyChecker {
    ...
    function closeUnpaidFee(uint256[] memory sbtIds) external payable returns (bool);
}
