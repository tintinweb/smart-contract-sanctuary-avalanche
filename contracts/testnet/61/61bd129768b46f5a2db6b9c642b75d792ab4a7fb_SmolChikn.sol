...
contract SmolChikn is ERC721URIStorage, Ownable {
  ...
  bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a; //don't change, this is standard royalty code

  bool private _mintActive;

  constructor() ERC721("Smol Chikn", "SmolChikn") {
    _customBaseURI = 'https://cdn.discordapp.com/attachments/970493400996515870/995431224195678348/breadNbutter_pixelated_pixel_art_dragon_egg_26fdc0ac-4199-4c09-b210-c49f5c1462b3.png';  ////////customize initial image here/////////
    _price = 0 ether; // 0 AVAX mint price 
    _maxMintable = 10000; // 10000 max supply
    _royaltyAmount = 690; // 6.9% royalties
    _mintActive = false; // we will start with the mint function paused
  }
...
//
 function OwnerOnlyFreeMintsAnytime(uint256 quantity) public payable onlyOwner { //
