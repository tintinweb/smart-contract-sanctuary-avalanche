...
contract MyContract {
    ...
    constructor () {
        ...
        //my testnet clone address 0xfa9F6dda6E5451EC12Dbb4da0E1910c549646538
            address(0xfa9F6dda6E5451EC12Dbb4da0E1910c549646538)
        );
    }
    ...
    function getRandAfter() external returns (uint) {
        require(latestRandomizingBlock > 0, "Run our getRandomNumber function first");
        require(witnet.isRandomized(latestRandomizingBlock) ==true, "Wait a few more minutes for Witnet Chain results to appear");
        randomness = uint(witnet.getRandomnessAfter(latestRandomizingBlock));
        return randomness;
    }    
}