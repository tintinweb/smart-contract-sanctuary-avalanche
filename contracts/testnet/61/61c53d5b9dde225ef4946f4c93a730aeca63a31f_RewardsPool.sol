...
contract RewardsPool {
        ...
        onlyAuthorized
    {
        ...
        IERC20(vpnd).transfer(gdm, dailyEmission());

        // dailyEmitted = currentBalance - balance();

        // dailyEmissions[transactionCounter] = dailyEmitted;
    }
    ...
    function dailyEmission() public view returns (uint256) {
        return (balance() * rewardsVelocity) / 1e20;
    }
