    ...
    UUPSUpgradeable
{
    ...
    function batchMint(address to_, uint256[] memory tokenIds_, string[] memory tokenUris_) external onlyRole(MINTER_ROLE) {
    ...
    function batchMint(address[] memory to_, uint256[] memory tokenIds_, string[] memory tokenUris_) external onlyRole(MINTER_ROLE) {
        uint256 length = tokenIds_.length;
    ...
    function _beforeTokenTransfer(address from_, address to_, uint256 tokenId_) internal override(ERC721Upgradeable, ERC721EnumerableUpgradeable) whenNotPaused {
