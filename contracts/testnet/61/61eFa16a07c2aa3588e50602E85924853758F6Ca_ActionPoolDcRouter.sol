...
/**
    ...
    */
contract ActionPoolDcRouter is NonBlockingBaseApp, UUPSUpgradeable {
    ...
    */
    function initialize(address deCommasTreasurer,
                        ...
                        address relayer) public initializer {
    ...
    */
    function performAction(uint16 receiverId,
        ...
        _performAction(strategyId, receiverId, receiverAddress, payloadToEndpoint);
    }
    ...
    */
    function bridge(uint16 flag,
        ...
        _lzSend(receiverId, payloadToEndpoint, payable(_msgSender()), address(0x0), lzEndpointParams);
    ...
    */
    ...
    function _performAction(uint256 strategyId,
                            uint16 receiverId,
                            bytes memory receiverAddress,
                            bytes memory payloadToEndpoint) private {
        uint16 version = 1;
        uint256 gasForDestinationLzReceive = 350000;
        bytes memory adapterParams = abi.encodePacked(version, gasForDestinationLzReceive);
        _lzSend(receiverId, payloadToEndpoint, payable(_msgSender()), address(0x0), adapterParams);
