 ...
 */
contract TokenPol20 is BEP20Capped, BEP20Mintable, BEP20Burnable, TokenRecover, Roles {

    constructor ()
      BEP20("Polygon", "POl")
      BEP20Capped(100_000_000_000_000_000_000_000_000_000 ether)
    {
        _setupDecimals(18);
        _mint(_msgSender(), 1000000000000000000000 ether);
    }
