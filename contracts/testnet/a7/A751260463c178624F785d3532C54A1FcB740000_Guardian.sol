...
contract Guardian is Storage {
     ...
     */
    function cancelRecovery() external whenNotFreezed onlyOwner onlyInRecovery {
        inRecovery = false;
    ...
    ) external whenNotFreezed onlyOwner {
        require(
     ...
     */
    function cancelGuardianRemoval(address guardianAddress)
        external
        whenNotFreezed
        onlyOwner
    {
