    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("TestPacking", "TPKS") ClampedRandomizer(maxSupply) {     
    ...
    //Overrides
     ...
     function internalMint(address to) internal {
         ...
         uint256 quantity = tokenId * packSize;
