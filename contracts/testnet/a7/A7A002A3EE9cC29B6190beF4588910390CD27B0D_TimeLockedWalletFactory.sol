...
contract TimeLockedWalletFactory {
    ...
    {
        TimeLockedWallet _newWallet = new TimeLockedWallet(_unlockDate);
...
contract TimeLockedWallet is Ownable{
    ...
    function withdraw() onlyOwner isUnlocked public {
        address payable _toSend = payable(msg.sender);
    ...
    function getContractInfo() public view 
        returns( address, uint256, uint256) {
            return (owner(), unlockedDate, address(this).balance);
    }
}
