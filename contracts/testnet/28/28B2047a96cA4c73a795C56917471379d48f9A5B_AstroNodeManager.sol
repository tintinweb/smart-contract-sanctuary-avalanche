...
contract AstroNodeManager is Ownable, Pausable {
    ...
    function compoundNode() public {
        ...
        updateClaims(msg.sender);
        if (astronauts[msg.sender].totalClaims > nodeCost) {
            astronauts[msg.sender].totalClaims -= nodeCost;
    ...
    function updateClaims(address _address) internal {
        ...
        if (timerFrom > 0)
            ...
            astronauts[_address].totalClaims = astronauts[_address].claimsNodes + astronauts[_address].claimsDonated;
            astronauts[_address].claimsNodes = 0;
            astronauts[_address].claimsDonated = 0;
    ...
    function claim() external {
		...
		uint256 reward = astronauts[msg.sender].totalClaims;
