...
// @3Sigma: This was just one idea on how Yeti staking could be implemented that we
// wrote up back in December. With the latest developments in ve token design
// which seem superior to the alternatives, we are writing a new staking mechanism.
// so this contract should be ignored.
...
contract sYETIToken is IERC20, Domain, BoringOwnable {
    ...
    uint256 private constant LOCK_TIME = 69 seconds;
