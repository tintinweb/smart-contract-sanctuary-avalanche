...
contract AddressBook is AddressBookInterface {
        ...
        onlyGreaterThanZero(expiration_)
    {
        ...
        if (
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE FEE MANAGEMENT",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE ADDRESS BOOK",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE ADMIN MULTISIG",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            if (
                ...
                // update in KYC
                KYCInterface(_KYCContractAddress)
                    .updateAdminMultiSigContractAddress(contractAddress_);

                // update in KYC Multi-Sig
                KYCMultiSigInterface(_KYCMultiSigContractAddress)
                    .updateAdminMultiSigContractAddress(contractAddress_);
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE SUPPLY MANAGEMENT MULTISIG",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE FEE MANAGEMENT MULTISIG",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE ASSET PROTECTION",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            if (
                ...
                // update contract address
                // update in Address book
                updateKYCContractAddress(contractAddress_, msg.sender);
            ...
            _updateContractAddressProposal[
                ...
                ID: _proposalIndex,
                PROPOSALNAME: "UPDATE KYC MULTISIG",
                PROPOSER: msg.sender,
                CONTRACTCATEGORY: contractCategory_,
                CONTRACTADDRESS: contractAddress_,
                ISEXECUTED: false,
            ...
            if (
                ...
                // update contract address
                // update in Address book
                updateKYCMultiSigContractAddress(contractAddress_, msg.sender);
        ...
        onlyValidAdminProposalIndex(proposalIndex_)
    {
        ...
        if (
            ...
            if (
                ...
                // update in ERC20
                ERC20Interface(_ERC20ContractAddress)
                    .updateAdminMultiSigContractAddress(
                        proposal.CONTRACTADDRESS
                    );
                ...
                // update contract address
                // update in Address book
                updateKYCContractAddress(proposal.CONTRACTADDRESS, msg.sender);
    ...
    function getUpdateContractAddressProposalDetail(uint256 proposalIndex_)
        external
        view
        returns (UpdateContractAddressProposal memory)
    {
        return _updateContractAddressProposal[proposalIndex_];
    }

    // Is update contract address proposal approver
    function IsUpdateContractAddressProposalApprover(
    ...
    function _onlyGreaterThanZero(uint256 value_) internal view virtual {
        // require value be greater than zero
        require(value_ > 0, "Address Book: Value should be greater than zero!");
    }
