    ...
    Pausable
{
    ...
    function holderMint(uint256 amount) external payable whenNotPaused {
        require(isHolder(), "MadSkullz: You are not a BabySkullz holder");
        require(
            step >= ContractSteps.OPEN_HOLDER,
            "MadSkullz: Failed to perform action during current step"
        );
    ...
    function whitelistMint(uint256 amount) external payable whenNotPaused {
        require(isWhitelist(), "MadSkullz: You are not whitelisted");
        require(
...
contract ONFT721 is ONFT721Core, ERC721, IONFT721 {
    ...
    function _debitFrom(
        ...
        require(
            ...
            "ONFT721: destination chain is not a trusted source"
        );
        _burn(_tokenId);
    }
