...
contract myMath{
	using SafeMath for uint256;
		...
		function EXTelimZero(uint256 _y) internal view returns(uint256){
			elimZero(_y);
			}
		...
		function EXTdecPercentage(uint256 _x,uint256 perc) external view returns(uint256,uint256[3] memory,uint256,uint256){
			decPercentage(_x,perc);
		}	
		function decPercentage(uint256 _x,uint256 perc) internal view returns(uint256,uint256[3] memory,uint256,uint256){
