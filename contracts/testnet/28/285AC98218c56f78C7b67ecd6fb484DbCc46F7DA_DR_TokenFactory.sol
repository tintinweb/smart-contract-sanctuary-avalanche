...
contract DR_TokenFactory {
    ...
    event NewTokenIssued(uint pos, string name, string symbol,DR_Token dr,address sale_address,IDR_Registry proxyregistry);
    ...
    function newToken(
        ...
        emit NewTokenIssued(projects.length, name,symbol,dr,sale_address,proxyregistry);
        //proxyregistry.
    }
