...
// File contracts/Token/SparkWorldToken.sol

pragma solidity 0.8.11;

// ToDo: best practice for safety when owner's key is exposed, also use access controls, check other tokens
contract SparkWorldToken is Ownable, ERC20 {
    ...
    // ToDo: Do we have tax on Transfers anymore? what should be the address for staking taxes?
