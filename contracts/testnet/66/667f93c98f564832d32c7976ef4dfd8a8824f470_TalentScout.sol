...
contract TalentScout is IERC20, AccessControl, Ownable {
    ...
    // in case of presale
        ...
        function _transferFrom(
            address sender, // ts address
            address recipient, // presale buyer
            uint256 amount // lockid
        ) internal virtual returns (bool) {
            require(balanceOf(sender) >= amount, "Insufficient Balance"); // if ts adress have amount or not
            //tax exempted
