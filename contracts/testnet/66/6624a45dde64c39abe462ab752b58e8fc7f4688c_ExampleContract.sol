...
contract ExampleContract {
  IPyth pyth;
  PythStructs.PriceFeed public open;
  PythStructs.PriceFeed public close;
  ...
  function getBtcUsdPrice(
    ...
    PythStructs.PriceFeed[] memory response = pyth.parsePriceFeedUpdates{ value: fee }(updateData, priceIds, 1683632626, 1683632638);
    open = response[0];
    close = response[1];
