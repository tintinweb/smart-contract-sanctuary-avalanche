...
contract TESTIN is IBEP20, Auth {
    ...
    //address BUSD = 0x83a283641C6B4DF383BCDDf807193284C84c5342;
    ...
    string constant _name = "HAHAHHAHAHA";
    string constant _symbol = "HAHAHHAHAHA";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 9_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.div(10) + 1;
	uint256 public _maxWallet = _totalSupply.div(10) + 1; 
