...
contract AvaxFortune{
    ...
    uint256[3] public REFERRAL_PERCENTS = [500, 300, 100];
    ...
    uint256 public constant PERCENT_STEP = 6; // 0.06% daily increment
    ...
    constructor(address payable _mount ) {
        ...
        plans.push(Plan(10, 800));
        plans.push(Plan(16, 750));
        plans.push(Plan(21, 700));
        plans.push(Plan(26, 800));
        plans.push(Plan(10, 800));
        plans.push(Plan(16, 750));
        plans.push(Plan(21, 700));
        plans.push(Plan(26, 800));  
    ...
    function withdraw(uint8 plan) public {
        ...
        totalAmount = totalAmount.sub(rFees);
    ...
    function emergencyWithdraw(uint256 index) public {
        ...
        require(plan > 5 && plan < 8, "only for locked packages");
