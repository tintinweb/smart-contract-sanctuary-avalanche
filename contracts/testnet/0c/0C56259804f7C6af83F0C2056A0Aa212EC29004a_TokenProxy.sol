...
contract ProxyFinal{
    ...
    function _upgradeTo(address newImplementation) internal {
        ...
        require(currentImplementation != newImplementation, 'OwnedUpgradeabilityProxy: INVALID UPGRADE');
    ...
    function _fallback() internal {
        ...
        require(_impl != address(0), 'OwnedUpgradeabilityProxy: INVALID IMPLEMENTATION');
        assembly {
            let ptr := mload(0x40)
