...
/* TODO: teamMint public sale'den kesilecek 4555-teamMint public salede satılacak */
/* TODO: Test if it requires fallback or recieve*/
/* TODO: Add NFT Royalty standard EIP-2981 */
/* TODO: Need placeholderTokenURI */
contract OtterSociety is ERC721A, OwnableNR, ReentrancyGuard, IERC2981 {
    using Strings for uint256;
    ...
    address payable marketDevWallet = payable(0x4AC2cf9b186b39EFb2eAe8AdC56dD4889333fe60);
    ...
    constructor() ERC721A("Otter Society", "OS") {
        ...
        royaltyRecipient = marketDevWallet;
    ...
    /// @notice Return royalty recipient and royalty amount.
    /// @dev Royalties are applied by marketplaces, aim of this function is to signal the marketplace
    /// and tell what's the royalty amount and who is the recipient.
    /// @param value value is given by the marketplace, it's the sellprice of the token.
