...
import "./SongAlbumSingleNFTTradable.sol";

contract SongAlbumSingleNFT is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new SongAlbumSingleNFTTradable contract
    ...
    function createNFTContract(string memory _name, string memory _symbol)
        ...
        returns (address)
    {
        require(msg.value >= platformFee, "Insufficient funds. Not enough ether to purchase NFTs.");
        (bool success,) = feeRecipient.call{value: msg.value}("");
        require(success, "Transfer failed");

        SongAlbumSingleNFTTradable nft = new SongAlbumSingleNFTTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient
    ...
    /// @notice Method for registering existing SongAlbumSingleNFTTradable contract
    ...
    /// @notice Method for disabling existing SongAlbumSingleNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title SongAlbumSingleNFTTradable
 * SongAlbumSingleNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract SongAlbumSingleNFTTradable is ERC721, Ownable {
    /// @dev Events of the contract
    event Minted(
        uint256 tokenId,
        address beneficiary,
