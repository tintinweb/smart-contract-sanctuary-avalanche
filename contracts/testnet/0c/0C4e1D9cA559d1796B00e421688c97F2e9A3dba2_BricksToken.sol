...
contract BricksToken is ERC20Upgradeable, OwnableUpgradeable, PaymentSplitterUpgradeable {
    using SafeMathUpgradeable for uint256;

    address public joePair;
    address public joeRouter; // TraderJoe Router
    ...
    uint16 public maxBalanceAmountRate;
    ...
    function initialize(
        ...
        __Ownable_init();
        __ERC20_init("Bricks Token", "BRICKS");
    ...
    function setMaxBalanceAmountRate(uint16 _maxBalanceAmountRate) external onlyOwner {
    ...
    function transferFrom(
        ...
        if (msg.sender == nodeManager && from == rewardsPool) { 
