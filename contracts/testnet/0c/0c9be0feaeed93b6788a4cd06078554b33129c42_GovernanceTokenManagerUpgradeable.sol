...
import "./utils/PowerUpgradeable.sol";
...
contract GovernanceTokenManagerUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, PowerUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, Blacklistable {
    ...
    */
     ...
     */
    function initialize (IERC20  arkiusTokenAddress,
    ...
    *
    */
    function buy(uint256 minReceived) external payable onlyMember nonReentrant whenNotPaused notBlacklisted {
 ...
 *
 * Split PowerUpgradable.sol out from BancorFormula.sol
 ...
 */
contract PowerUpgradeable is Initializable{
    ...
    */
    ...
    function __Power_init() internal initializer {
