    ...
    ClampedRandomizer
{
    ...
    uint256 private _maxRandomizer = 20100;
    ...
    function internalMint(address to, uint256 amount) internal {
        ...
        for (uint256 i = 1; i <= amount; i++) {  
            ...
            if (tokenID <= 1000) {  //5.85 chance to win the best prize
                contract1.mint(1,to);
                won[0] = true;
            } else if ( 1000 < tokenID && tokenID <= 4000) { //17.55 chance to win second best
                contract2.mint(1,to);
                won[1] = true;
            } else if ( 4000 < tokenID && tokenID <= 10000) { // chance to win third best
                contract3.mint(1,to);
                won[2] = true;
            }else if ( 10000 < tokenID && tokenID <= 20000) { // chance to win worst 
                contract4.mint(1,to);
                won[3] = true;
            }else if (20000 < tokenID && tokenID <= 20100){ // chance to win 1 avax
