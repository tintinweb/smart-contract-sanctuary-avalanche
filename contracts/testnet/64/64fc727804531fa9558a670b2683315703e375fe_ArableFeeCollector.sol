 ...
 */
contract ArableFeeCollector is Initializable, OwnableUpgradeable, IArableFeeCollector, ReentrancyGuardUpgradeable {
    using SafeERC20 for IERC20;
    address public addressRegistry;

    uint256 public epochStartBlock;
    uint256 public epochStartTime;
    // TODO: on mainnet, this should be configured to 1 week
    ...
    function initialize(address addressRegistry_, uint256 defaultFees_) external initializer {
    ...
    function increaseMinterRewards(
        ...
        address rewardToken,
        uint256 amount
    ) external override onlyAllowedProvider nonReentrant {
    ...
    function claimReward(address rewardToken) public override nonReentrant {
