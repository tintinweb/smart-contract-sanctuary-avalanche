...
contract TjSwapERC20 {
    using SafeERC20 for IERC20;

    IJoeRouter02 public swapRouter;
    IBridge public bridge;

    constructor(IJoeRouter02 router_, IBridge bridge_) {
        swapRouter = router_;
        bridge = bridge_;
    }

    function checkAllowance(IERC20 token, address to) internal {
    ...
    function safeTransferWithApprove(
        ...
        checkAllowance(tokenIn, routerAddress);
    }
    ...
    function swapExactInputSingleThenBridge(
        ...
        checkAllowance(tokenOut, address(bridge));
        bridge.depositERC20(
            address(tokenOut),
            amountOut,
            bundle_,
    ...
    function swapExactOutputMultiHopThenBridge(
        ...
        checkAllowance(IERC20(tokenOut), address(bridge));
        bridge.depositERC20(
            address(tokenOut),
            amountOut,
            bundle_,
