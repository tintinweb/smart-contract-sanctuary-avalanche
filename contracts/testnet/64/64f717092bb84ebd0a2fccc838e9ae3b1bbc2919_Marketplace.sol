...
contract Marketplace is Initializable, EIP712Upgradeable, ERC721HolderUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event Cancel(address indexed sender, address indexed collection, uint256 indexed tokenId, bytes32 hash, string salt);
    event MakeOffer(address indexed sender, address indexed collection, uint256 indexed tokenId, uint256 amount);
    event CancelOffer(address indexed sender, address indexed collection, uint256 indexed tokenId);
    event AcceptOffer(address indexed sender, address indexed collection, uint256 indexed tokenId, address _buyer, uint256 amount);
    event Redeem(address indexed sender, address indexed collection, uint256 indexed tokenId, uint256 value, string salt);
    event RejectOffer(address indexed sender, address indexed collection, uint256 indexed tokenId, address _buyer);
    ...
    function fund() external payable whenNotPaused nonReentrant paymentAccepted {
    ...
    function rejectOffer(address _nftContractAddress, uint256 _tokenId, address _buyer) external whenNotPaused nonReentrant {
        ...
        emit RejectOffer(msg.sender, _nftContractAddress, _tokenId, _buyer);
    }
