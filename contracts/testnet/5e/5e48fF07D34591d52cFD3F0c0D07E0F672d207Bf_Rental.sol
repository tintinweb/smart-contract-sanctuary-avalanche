...
contract Rental is Withdrawable {
    ...
    mapping(uint256 => RentalInfo) private _rentalInfoOf;
    ...
    function getRentalInfo(uint256 nftId) external view returns(RentalInfo memory) {
        return _rentalInfoOf[nftId];
    }
    ...
    function rent(address lender, uint256 orderId) external payable isNotRenting(lender, orderId) {
        ...
        _rentalInfoOf[rental.nftId] = rental;
