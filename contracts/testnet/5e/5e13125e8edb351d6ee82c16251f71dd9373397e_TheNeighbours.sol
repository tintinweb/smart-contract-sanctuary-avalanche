...
contract TheNeighbours is ERC20, ERC20Burnable, ERC20Pausable, Ownable {
    ...
    function _mint(address account, uint256 amount) internal virtual override {
        require(tokenMinted + amount <= cap, "The Neighbours: cap exceeded");
    ...
    function _transfer(
        ...
        require(
            ...
            "The Neighbours: User is blocked please contract admin"
        );
        if (msg.sender != owner() && !exempted[msg.sender] && conditionCheck) {
            require(
