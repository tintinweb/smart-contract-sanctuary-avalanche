    ...
    NonblockingLzAppUpgradeable
{
    ...
    function _getContractSymbolHash(
        ...
        return keccak256(abi.encodePacked(ITokenMonsterra(token).symbol()));
    }
    ...
    function addContractSupport(
        ...
        bytes32 keyMapping = _getContractSymbolHash(_contractAddress);
    ...
    function isContractSupport(
        address _contractAddress
    ) external view returns(bool) {
        bytes32 keyMapping = _getContractSymbolHash(_contractAddress);
        return contractSupportMapping[keyMapping].status ;
    }
