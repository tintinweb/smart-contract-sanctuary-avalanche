...
// File: contracts/PrivateRound.sol
...
contract PrivateRoundContract is Ownable {
    ...
    function _transferUnlocked(uint256 daysPast, address _receiver) internal{
        ...
        lastUnlockTime[_receiver] = lastUnlockTime[_receiver] + (daysPast * 1 minutes);
    ...
    function withdraw() external {
        ...
        uint256 daysPast = (block.timestamp - lastUnlockTime[msg.sender]) / (1 minutes);
