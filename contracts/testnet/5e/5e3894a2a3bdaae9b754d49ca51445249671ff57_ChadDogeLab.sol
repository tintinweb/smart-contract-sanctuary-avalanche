...
// Testnet: 0x5e3894a2a3bdaae9b754d49ca51445249671ff57
contract ChadDogeLab is Ownable {
    ...
    address constant public vialAddress = 0x81cCe5708dAc0b3909955b09542D588480b8c94d; // TODO::: change later (test vial address)
    address constant public chadDogeAddress = 0x5Ebe349fc4FaE368E356f5b173bC7aBbF6D14E39; // TODO::: change later (test CD)
    ...
    // reveal address, claim wallet, super address, public sale start id (2815)
    ...
    function getShuffledTokenId(address _baseLaunchpeg, uint256 tokenId) external view returns (uint256) {
        ...
        if (tokenId < publicSaleStartId) {
            ...
            if (reveal.tokenIdAvailable(tokenId)) {
                // public sale ids start after F vial range
                metadataTokenId = (vialFMetadataRange.max + 1) + reveal.getShuffledTokenId(tokenId);
            } else {
                return unrevealedMetadataId;
            }
        }
