...
contract JoeVoter is IJoeVoter, OwnableUpgradeable, ERC20Upgradeable, UUPSUpgradeable, ERC20BurnableUpgradeable {
    ...
    function initialize(
        ...
        stakingContract = IVeJoeStaking(_stakingContract);
        WAVAX = IWAVAX(0x52B654763F016dAF087d163c9EB6c7F486261019);             // 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7
        JOE = address(0x4D6acD96DCB80703680A4F1c1D5498C6E383Db06);              // 0x6e84a6216eA6dACC71eE8E6b0a5B7322EEbC0fDd
        veJOE = IERC20Upgradeable(0xf0803b27Fb4aBA4ADC5f48Dd6d8B60CBceb7c3b4);  // 0x3cabf341943Bc8466245e4d6F1ae0f8D071a1456
