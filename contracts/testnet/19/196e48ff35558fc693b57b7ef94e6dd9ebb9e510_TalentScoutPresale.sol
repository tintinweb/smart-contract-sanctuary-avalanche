...
contract TalentScoutPresale is ReentrancyGuard, Ownable, AccessControl {
    ...
    uint256 public presaleSupply = 100_000_000_000 * (10**18);
    ...
    constructor(
        ...
        // grantRole(CROWDSALE_ROLE, msg.sender);
        require(
...
function assignRole(address _account) public {
    grantRole(CROWDSALE_ROLE, _account);
}
    ...
    function saleLock(address _account, uint256 _scoutToLock) private {
        ...
        talentScout.insertPresaleLock(_account, m6Release, 180 days);
        talentScout.insertPresaleLock(_account, m8Release, 240 days);
        talentScout.insertPresaleLock(_account, m9Release, 270 days);
        talentScout.insertPresaleLock(_account, m10Release, 300 days);
        talentScout.insertPresaleLock(_account, m11Release, 330 days);
        talentScout.insertPresaleLock(_account, m12Release, 360 days);
        talentScout.insertPresaleLock(_account, m15Release, 450 days);
        talentScout.insertPresaleLock(_account, m18Release, 540 days);
    }
