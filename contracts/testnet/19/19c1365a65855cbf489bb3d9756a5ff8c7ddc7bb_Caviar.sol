...
contract Caviar is ERC20Burnable, Operator {
     ...
     */
    constructor() ERC20("FOOD FINANCE", "CAVIAR") {
        // Mints 5001 BASED to contract creator for initial pool setup

        _mint(msg.sender, 5001 ether);
