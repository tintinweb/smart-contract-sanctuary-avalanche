...
contract SeedContract {
    ...
    function Withdraw() public {
        ...
        //6 months cliff
		if(vestingCycles == 0){
			require(block.timestamp > constUnlockTime + 210 minutes , "Too early for unlocking tokens");
			constUnlockTime = constUnlockTime + 210 minutes;
            vestingCycles ++;
            return;
		}
		...
		if(vestingCycles > 0){
            if(lastUnlockTime[msg.sender] == 1665208800){
                lastUnlockTime[msg.sender] = 1665208800 + 1 minutes;
            }
