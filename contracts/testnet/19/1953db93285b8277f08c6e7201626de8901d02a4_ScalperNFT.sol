...
contract ScalperNFT is IScalperNFT, ERC721URIStorage, Ownable {
    ...
    // address of NFTScalping contract
    address private NFTScalpingAddress;
    ...
    /**
     * @dev Safely mints `tokenId` and transfers it to NFT Scalper.
     *
     * Requirements:
     *
     * - `tokenId` must not exist.
    ...
    /**
     * @dev set the address of NFTScalping contract.
     *
     * Requirements:
     *
     * - `_nftScalping` must not be zero address.
        ...
        onlyOwner
    {
        ...
        NFTScalpingAddress = _nftScalping;
    }
     ...
     * Requirements:
     *
     * - `_baseUri` must not be zero address.
     */
