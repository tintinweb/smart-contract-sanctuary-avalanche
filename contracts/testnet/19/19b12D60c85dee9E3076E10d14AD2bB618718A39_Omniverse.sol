...
contract Omniverse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Omniverse";
    string private _symbol = "Omni";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xfADBCeEf00C9d04cBBB95AB8270dC4143551C096);
    ...
    function setValues(uint256 _market_, uint256 _holders_, uint256 _burn_, uint256 _setliq_ ) public onlyOwner {
        ...
        _totalTaxIfBuying = (_marketingShare + _holders + _burn + _liquidityShare);
        _totalTaxIfSelling = (_marketingShare + _holders + _burn + _liquidityShare);

        _totalDistributionShares = _totalTaxIfBuying + _totalTaxIfSelling;
