...
// File: contracts/Underwhere_Gnomes.sol
...
contract Underwhere_Gnomes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Underwhere Gnomes", "GNOME") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x0B04db22eC26CA1Fa0393e394AFE9799f152dB8e).call{value: address(this).balance * 33 / 100}("");
    require(hs);
