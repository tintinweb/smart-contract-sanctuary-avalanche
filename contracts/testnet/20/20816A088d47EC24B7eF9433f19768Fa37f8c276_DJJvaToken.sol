...
contract DJJvaToken is ERC20Capped, AccessControl {
  bytes32 public constant MINTER_ROLE = keccak256('MINTER_ROLE');

  constructor(address minter) ERC20('Djj Test version avalanche token', 'DJJTva') ERC20Capped(30000000000000000000000) {
