 ...
 */
contract AaveVault is BaseBuildingBlock {
     ...
     */
    function setUserEMode(bytes memory _data) public {
     ...
     */
    function setCollateralAsset(bytes memory _data) public {
     ...
     */
    function repay(bytes memory _data) public payable {
     ...
     */
    function closePosition(bytes memory _data) public {
     ...
     **/
    function claimAllRewards(bytes memory _data) public {
     ...
     * @return The eMode id
     */
    function getUserEMode(address _user) public view returns (uint256) {
        return aaveLendingPool.getUserEMode(_user);
    }
    ...
    {
        return aaveLendingPool.getUserConfiguration(_user);
    }
    ...
    function getReservesList() public view returns (address[] memory) {
        return aaveLendingPool.getReservesList();
    }
        ...
        )
    {
        (
            ...
            ltv,
            healthFactor
        ) = aaveLendingPool.getUserAccountData(_user);
    }
