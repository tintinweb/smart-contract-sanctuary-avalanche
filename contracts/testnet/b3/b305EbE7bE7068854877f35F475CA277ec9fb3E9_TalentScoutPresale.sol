...
contract TalentScoutPresale is ReentrancyGuard, Ownable {
    ...
    function saleLock(address _account, uint256 _scoutToLock) private {
        ...
        talentScout.insertPresaleLock(_account, immediatelyReleased, 0);
        talentScout.insertPresaleLock(_account, m3Release, 90 days);
        talentScout.insertPresaleLock(_account, m9Release, 270 days);
        talentScout.insertPresaleLock(_account, m15Release, 450 days);
        talentScout.insertPresaleLock(_account, m21Release, 630 days);
    }
