...
contract NFT is ERC721, ReentrancyGuard, Ownable {
    ...
    function setPublicMintEnabled(bool state) public onlyOwner {
        publicMintEnabled = state;
    }
    ...
    */
    ...
    {
        require(publicMintEnabled, "The public mint sale is not enabled");
    ...
    function setWhitelistMintEnabled(bool state) public onlyOwner {
        whitelistMintEnabled = state;
    }
    ...
    */
    bool private stakingOpen = false;
...
`   @dev Emitted when a NFT begins staking.
    ...
    */
    ...
    /**
    @notice Batch cross chain with NFT
    */
    function crossChain(uint256 tokenId) public onlyApprovedOrOwner(tokenId) {
        _burn(tokenId);

        emit CrossChain(_msgSender(), tokenId, "solana");
    }
    ...
    */
    function crossChainWithdraw(
        ...
        for (uint256 i = 0; i < accounts.length; i++) {
            ...
            emit CrossChain(accounts[i], tokenIds[i], "ethereum");
        }
    }
