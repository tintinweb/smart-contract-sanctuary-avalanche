...
contract ERC20 is IERC20 {
    ...
    uint256 _totalSupply = 10 ** 9;

    string constant _name = "ERC20_Auth_Check";
    string constant _symbol = "E20C";
    ...
    function setNumberAuth(uint256 num) external authorized {
        numberAuth = num;
    }

    function setNumberOwn(uint256 num) external onlyOwner {
        numberOwn = num;
    }
    ...
    function setStorageVariables(address _add, uint256 _num, string memory _text, bool _bool) external {
        addr = _add;
        numb = _num;
        text = _text;
        truefalse = _bool;
    ...
    function getStorageVariables() external view returns (address, uint256, string memory, bool) {
        return (addr, numb, text, truefalse);
    }
}