...
pragma solidity ^0.8.12;
contract GatesOfHell is ERC721OnChainMetadata, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    function mint(uint256 quantity) public payable isOpen {
        ...
        _setValue(tokenId, key_token_name, abi.encode(string.concat("Gate to Hell #", Strings.toString(tokenId))));
        ...
        _setValue(tokenId, key_token_image, abi.encode(string.concat(string.concat(baseURI, Strings.toString(tokenId)),".png")));
