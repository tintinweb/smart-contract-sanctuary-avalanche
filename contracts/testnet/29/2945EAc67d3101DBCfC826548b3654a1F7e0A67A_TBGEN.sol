...
// File: contracts/IUniswapDependencies.sol
...
//TODO: Mainnet router address: 0x10ED43C718714eb63d5aA57B78B54704E256024E
/* import "./VendorA.sol"; */
/* import "./uniswap/uniswapInterfaces.sol"; */
/* import "./RewardsA.sol"; */
//https://ethereum.stackexchange.com/questions/118178/fail-with-error-transferhelper-transfer-from-failed-even-approved-in-contract
...
contract TAGEN is ERC20, ERC20Burnable, ReentrancyGuard {
     ...
     */
    constructor() ERC20("Token AAA", "PURPLE-AAA") {
...
contract TBGEN is ERC20, ERC20Burnable, ReentrancyGuard {
    ...
    constructor(address _tokenA) ERC20("Token BB", "PURPLE-BBBB") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x2D99ABD9008Dc933ff5c0CD271B88309593aB921
        );
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _tokenA);
        // set the rest of the contract variables
        uniswapV2Router = _uniswapV2Router;
        _mint(_msgSender(), AMOUNT_OF_TOKEN);
        tokenA = TAGEN(_tokenA);
        _owner = _msgSender();
        /* TODO: Debug */
        /* _isExcludedFromFee[_msgSender()] = true; */
        _isExcludedFromFee[address(this)] = true;
    ...
    function claimTokens() public payable nonReentrant isUser returns (bool) {
        ...
        /*
         * Create a liquidity pool to be used for giving out rewards.
         */
        addLiquidityRewards(sumOfBalances, tokenA.balanceOf(address(this)));
        swapExactTokensForTokens(sumOfBalances);
        /*
         * 1. Iterate through the Token A holders.
         * 2. Get balance of an awardeeWallet
         */
    ...
    function addLiquidityRewards(uint256 tokenAmount_B, uint256 tokenAmount_R)
        private
    {
        if (flagDebug == 0) {
            // approve token transfer to cover all possible scenarios
            _approve(address(this), address(uniswapV2Router), tokenAmount_B);

            // Add the liquidity as Token Rewards
    ...
    function swapExactTokensForTokens(uint256 sumOfBalances) private {
        _approve(address(this), address(uniswapV2Router), sumOfBalances);
