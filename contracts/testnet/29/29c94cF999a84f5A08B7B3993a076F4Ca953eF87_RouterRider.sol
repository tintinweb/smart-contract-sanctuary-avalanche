    ...
    UUPSUpgradeable
{
    ...
    */
        ...
        returns (string memory)
    {
        ...
        parts[0] = string(
            abi.encodePacked(
                '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" ><style>.base { display:flex; fill: white; font-family: fantasy; font-size: 100%;}</style><rect width="100%" height="100%" fill="',
                chainColor,
                '"/>'
            )
        );
        ...
        parts[2] = '<rect width="100%" height="10%" fill="red" x="0" y="90%"/>';
        parts[3] = string(
            abi.encodePacked(
                '<text x="15%" y="95%" text-anchor="middle" class="base">"',
                "Rabbit Rush : ",
                toString(tokenId),
                '"</text>'
            )
        ...
        parts[4] = string(
            abi.encodePacked(
                '<text x="85%" y="95%" text-anchor="middle" class="base">"',
                "Score : ",
                toString(riderMetadatas[tokenId].score),
                '"</text>'
            )
        );
        parts[5] = "</svg>";
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "Rabbit Rush #',
                        toString(tokenId),
                        '", "description": "Router Rabbit which rush to other chains", "image": "data:image/svg+xml;base64,',
