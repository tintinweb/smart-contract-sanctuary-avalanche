    ...
    ContractMetadata
{
    ...
    // Function to set the URI of the contract metadata
    function setContractMetadataURI(
        string memory newContractMetadataURI
    ) public onlyRole(DEFAULT_ADMIN_ROLE) {
        contractMetadataURI = newContractMetadataURI;
    }

    // Function to return the URI of the contract metadata
    ...
    function migrateV1Token(uint256 tokenId) public {
        ...
        oldPumpskinContract.safeTransferFrom(msg.sender, deployer, tokenId);
