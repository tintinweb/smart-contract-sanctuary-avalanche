...
contract LoadCrafting is ReentrancyGuard, Ownable {
    using ECDSA for bytes32;

    event Craft(
        address indexed crafter,
        uint256 indexed craftId,
        uint256 indexed dcarAmount
    );
    ...
    constructor(
        ...
        require(_priceHandler != address(0), "INVALID_TOKEN_ADDRESS");
        require(_rewardReceiver != address(0), "INVALID_TOKEN_ADDRESS");
        require(_dcarToken != address(0), "INVALID_TOKEN_ADDRESS");
        require(_resourceContract != address(0), "INVALID_TOKEN_ADDRESS");
    ...
    function craft(
        ...
        require(dcarAmount > 0, "INVALID_RESOURCE_COUNT");
