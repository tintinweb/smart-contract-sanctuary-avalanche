...
contract OverrideMatrix is AccessControl {
    ...
    constructor(address _usdt, address _token, address _noReferPlatform, address _feePlatform, address _initAcc) {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0x1E70736301b4ff85759fc4a487C7E2f9311F5B4B);
        // 0xb0A134D9ec5c6A3b975076777D13B64Da1484246
        _grantRole(SETENV_ROLE, 0x1E70736301b4ff85759fc4a487C7E2f9311F5B4B);
        // 0xb0A134D9ec5c6A3b975076777D13B64Da1484246
        _grantRole(REMOVE_ROLE, 0x1E70736301b4ff85759fc4a487C7E2f9311F5B4B);
        // 0xb0A134D9ec5c6A3b975076777D13B64Da1484246
        _grantRole(INIT_ROLE, 0x1E70736301b4ff85759fc4a487C7E2f9311F5B4B);

        USDToken = IERC20(_usdt); // 0xc2132d05d31c914a87c6611c10748aeb04b58e8f
        Token = IERC20(_token); // 0x23F0610cE12D16500544B9de5bd9f500c91aEAaE
