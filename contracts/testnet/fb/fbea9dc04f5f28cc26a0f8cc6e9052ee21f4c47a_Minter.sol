...
contract Minter is Ownable {
    ...
    function approve_basic_mint(address _address) external onlyOwner returns(bool){
        require(basic_mintRequests[_address].Active, "There are no requests from the sender account");
        require(basic_mintRequests[_address].Approved == false, "The request already approved");

        IWACEO(Waceo).mint(basic_mintRequests[_address].Recipient, basic_mintRequests[_address].Amount);
        basic_mintRequests[_address].Approved = true;
        return true;
    }
    ...
    function approve_auto_allocate_single(address _address) external onlyOwner returns(bool){
        require(single_autoAllocation_mintRequests[_address].Active, "There are no requests from the sender account");
        require(single_autoAllocation_mintRequests[_address].Approved == false, "The request already approved");
        
        uint256  _LP_Controller_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].LP_Controller._amount.div(10**9)).div(100);
        uint256  _Founding_Team_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].Founding_Team._amount.div(10**9)).div(100);
        uint256  _WACEO_LP_Rewards_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].WACEO_LP_Rewards._amount.div(10**9)).div(100);
        uint256  _WACEO_Operational_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].WACEO_Operational._amount.div(10**9)).div(100);
        uint256  _WACEO_Dev_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].WACEO_Dev._amount.div(10**9)).div(100);
        uint256  _WACEO_Regulations_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].WACEO_Regulations._amount.div(10**9)).div(100);
        uint256  _WACEO_Unrekt_Value = single_autoAllocation_mintRequests[_address].Amount.mul(single_autoAllocation_mintRequests[_address].WACEO_Unrekt._amount.div(10**9)).div(100); 
        
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].LP_Controller._address, _LP_Controller_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].Founding_Team._address, _Founding_Team_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].WACEO_LP_Rewards._address, _WACEO_LP_Rewards_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].WACEO_Operational._address, _WACEO_Operational_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].WACEO_Dev._address, _WACEO_Dev_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].WACEO_Regulations._address, _WACEO_Regulations_Value);
        IWACEO(Waceo).mint(single_autoAllocation_mintRequests[_address].WACEO_Unrekt._address, _WACEO_Unrekt_Value);
        single_autoAllocation_mintRequests[_address].Approved = true;
