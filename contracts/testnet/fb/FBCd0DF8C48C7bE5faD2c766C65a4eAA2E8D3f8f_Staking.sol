...
contract Staking is Ownable, IERC721Receiver, Pausable {
  ...
  uint256 public constant MAXIMUM_GLOBAL_token = 5000000000 ether;
  ...
  Pausable
{
  ...
  uint256 public marketingAgencyShare = 5;
    ...
    whenNotPaused
  {
    ...
    if (minted < PAID_TOKENS) {
      ...
      require(balanceOf(_msgSender()) + staking.getTokensOf(_msgSender()).length + amount <= 20, "Do not sell your house to buy our NFT please");
    } else {
      require(msg.value == 0);
    }
  ...
  function mintCost(uint256 tokenId) public view returns (uint256) {
    ...
    if (tokenId <= PAID_TOKENS + 20000) return 40000 ether;
  ...
  function setMarketingAgencyShare(uint256 _marketingAgencyShare) public onlyOwner {
  ...
  function setLiquidityPoolAddress(address _liquidityPoolAddress) public onlyOwner {
    ...
    function setMarketingAgencyWallet(address _marketingAgencyWallet) public onlyOwner {
