...
// SPDX-License-Identifier: MIT
// DirtyCajunRice Contracts (last updated v1.0.0) (token/ERC721/extensions/ERC721EnumerableV2.sol)
...
import "../../../utils/TokenMetadata.sol";
...
// SPDX-License-Identifier: MIT
// DirtyCajunRice Contracts (last updated v1.0.0) (utils/access/TokenMetadata.sol)
...
StandardAccessControl, PausableUpgradeable, UUPSUpgradeable {
    ...
    /// Contract
    ///
    function addCollection(uint256 collectionId, string memory name, Design[] memory designs) external onlyContract {
    ...
    function imageURISuffix(
        ...
        uint256 collectionId = _attributes.getValue(tokenId, 0, 0);
        return string(
            abi.encodePacked(_attributes.getTreeName(collectionId), "/", _attributes.getValue(tokenId, collectionId, 2))
        );
    }
...
interface I8BallCue is IERC721Upgradeable, I8BallCommon {
    ...
    function addCollection(uint256 collectionId, string memory name, Design[] memory designs) external;
