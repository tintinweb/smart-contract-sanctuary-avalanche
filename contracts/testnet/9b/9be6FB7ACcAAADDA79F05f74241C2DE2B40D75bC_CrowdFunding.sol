...
contract CrowdFunding {
    ...
    uint256 public maxDuration = 2592000 seconds;
    ...
    function createCampaign(address _owner, string memory _title, string memory _description, uint256 _target, uint256 _startAt, uint256 _deadline, string memory _image) public returns (uint256) {
        ...
        require(campaign.startAt >= block.timestamp, "The startAt must be a date in the future");
        require(campaign.deadline > campaign.startAt,"End time is less than Start time");
