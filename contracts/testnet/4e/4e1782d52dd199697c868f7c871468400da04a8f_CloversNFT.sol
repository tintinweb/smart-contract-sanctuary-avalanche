...
contract CloversNFT is ERC721Enumerable, Ownable {
    ...
    // public
    function mint(uint256 _mintAmount, string memory _ClovesType, address)
        public
        
    {
        ...
        require(
            clovseSupply + _mintAmount <= clovesMaxsupply,
        ...
        if(PaidInGold == true){
                _payNFTGOLD(price, _msgSender());
            }else{
                _payNFTUSDC(price, _msgSender());
            }
