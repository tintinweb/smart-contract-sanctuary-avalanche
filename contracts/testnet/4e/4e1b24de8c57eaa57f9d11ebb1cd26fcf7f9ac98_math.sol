...
using SafeMath for uint256;
    ...
    (dayMultiple0,dayMultiple1) = getMultiple(last,timeStep);
    rewardsTMul = dayMultiple0*rewardsPerDay;
    boostMultiplier = [100,125,150,175];
    rewards_ = addFee(rewardsTMul, boostMultiplier[0]);
    rewards1 = rewards_[0];
    boost1 = rewards_[1];
    all1  = rewards_[0]+rewards_[1];
    rewards_2 = addFee(rewardsTMul, boostMultiplier[1]);
    rewards2 = rewards_2[0];
    boost2 = rewards_2[1];
    all2 = rewards_2[0]+rewards_2[1];
    rewards_3 = addFee(rewardsTMul, boostMultiplier[2]);
    rewards3 = rewards_3[0];
    boost3 = rewards_3[1];
    all3  = rewards_3[0]+rewards_3[1];
    boost3 = rewards_3[1];
    rewards_4 = addFee(rewardsTMul, boostMultiplier[3]);
