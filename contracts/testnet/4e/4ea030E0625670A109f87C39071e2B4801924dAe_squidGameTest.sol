...
contract squidGameTest is Ownable {
    ...
    */
    ...
    function calculateBuyBackIn(uint256 _index) public returns (uint256) {
        uint256 days_ = this.dayDifferance(_index);
     ...
     */
    function dayDifferance(uint256 _admin_Counter) public view returns (uint256) {
        //Please use this after the testing and remove the para

        // adminCounter = _adminCounter.current();

        GameStatus memory _admin = GameStatusInitialized[_admin_Counter];
