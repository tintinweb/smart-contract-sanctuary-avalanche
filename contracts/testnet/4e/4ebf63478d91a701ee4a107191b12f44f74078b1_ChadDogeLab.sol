...
// Testnet: 0x4ebf63478d91a701ee4a107191b12f44f74078b1
contract ChadDogeLab is Ownable {
    ...
    modifier onlyProxyOrOwner() {
        if (owner() != msg.sender && superAddress != msg.sender) {
            revert Unauthorized();
        }
        _;
    }
    ...
    function revealNextBatch(address _baseLaunchpeg, uint256 _totalSupply) external onlyProxyOrOwner returns (bool) {
