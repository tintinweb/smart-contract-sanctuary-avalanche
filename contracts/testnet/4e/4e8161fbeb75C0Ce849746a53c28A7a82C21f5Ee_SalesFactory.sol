...
contract SalesFactory is Ownable, ReentrancyGuard {
    ...
    constructor (address avatTokenAddress_, address stakingAddress_, address signatory_) {
    ...
    function setAllocationStaking(address stakingAddress_) public onlyOwner {
        require(stakingAddress_ != address(0));
        stakingAddress = stakingAddress_;
    }


    function deploySale() external onlyOwner {
        SaleAvat sale = new SaleAvat(address(_avatTokenAddress), stakingAddress, msg.sender, address(_signatory));
...
contract SaleAvat is ReentrancyGuard {
    ...
    constructor (address avatAddress_, address stakingAddress_, address owner_, address signatory_) {
