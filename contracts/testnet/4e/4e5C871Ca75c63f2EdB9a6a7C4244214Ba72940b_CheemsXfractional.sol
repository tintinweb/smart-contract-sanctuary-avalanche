...
contract CheemsXfractional is ERC721URIStorage, Ownable {
    ...
    function getUserTotalAmount(address wallet) public view returns(uint) { // for test
        uint amount = 0;
        for(uint i = 0; i < 10; i++) {
    ...
    function getMintedTotalAmount() public view returns(uint) { // for test
        uint amount = 0;
        for(uint i = 0; i <= 10; i++) {
    ...
    function getMaxUserAmount() public view returns(uint) { // for test
        uint amount = 0;
        for(uint i = 0; i <= 10; i++) {
