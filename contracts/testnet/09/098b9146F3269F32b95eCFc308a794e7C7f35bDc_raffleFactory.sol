...
contract raffleFactory {
    ...
    event CreatedEdition(uint256 indexed editionId, address indexed creator, uint256 editionSize, address indexed editionContractAddress, uint256 minPlayers, uint256 salePrice, string imageUrl);
  ...
  struct Collection {
    ...
    function createEdition(
        ...
        emit CreatedEdition(newId, msg.sender,  _editionSize, newContract, _minPlayers, _salePrice, _imageUrl );
...
contract RaffleNft is ERC721Upgradeable, IEditionSingleMintable,  OwnableUpgradeable {
 ...
 // return balance in wei
    ...
    function pickWinner() external payable returns(uint256){
        ...
        require (totalSupply() >= editionSize, "Raffle must be sold out before picking winner");
        uint r = random();
