...
contract Badge is ERC1238 {
    ...
    function mint(
        ...
        if (_compareStringsbyBytes(role, "admin") == false || _compareStringsbyBytes(role, "user") == false) {
            revert("Invalid role");
        }
    ...
    function _compareStringsbyBytes(string memory a, string memory b) private pure returns (bool) {
