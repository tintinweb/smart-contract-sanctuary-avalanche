...
contract AvaDiceNFT is Context, Ownable, ERC721Enumerable, ERC721URIStorage, IERC2981Royalties {
    ...
    constructor(string memory name, string memory symbol, string memory _baseTokenURI, address _royaltyRecipient, address _dev) ERC721(name, symbol) {
