...
contract CounterCaller {
    ...
    // }
        ...
        function swapExactTokensForTokens(uint256 amountIn, uint256 amountOutMin, Components.Path memory path,address to,uint256 deadline) external returns (uint256){
