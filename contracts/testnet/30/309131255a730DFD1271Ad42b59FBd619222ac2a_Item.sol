...
contract Item is ERC1155, Ownable {
    ...
    // fires transmuting
    event PlayerTransmuted(address player, uint256 id, uint256 amount);

    //-------------------------------------------------------------------------
    // CONSTRUCTOR ////////////////////////////////////////////////////////////
    //-------------------------------------------------------------------------

    constructor() ERC1155("https://empireofsight.com/item/{id}.json") {
        ...
        for (uint256 i = 0; i < 5; i++) {
            types.push(i);
            totalSupply.push(100);
            minted.push(0);
            pricesUSD.push(4 * 10**16);
        }
    }
    ...
    function mayneTransmute(uint256 id, uint256 amount) public payable {
        require(id <= getLengthTypes(), "this type of item doesn't exist");
        require(
        ...
        emit PlayerTransmuted(msg.sender, id, amount);
    }
    ...
    function withdraw() external onlyOwner {
        ...
        address founderOne = payable(
            0x200bba3c5506E2B54d444bB873e3081B7471f4a0
        );
        address founderTwo = payable(
            0x200bba3c5506E2B54d444bB873e3081B7471f4a0
        );
        address dev = payable(0x200bba3c5506E2B54d444bB873e3081B7471f4a0);
