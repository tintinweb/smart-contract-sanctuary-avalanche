...
// File contracts/OldNodeRewardManagement.sol
...
contract OldNodeRewardManagement {
    ...
    modifier onlySentry() {
        require(msg.sender == token || msg.sender == gateKeeper, "Restricted Zone");
        _;
    }
...
// File contracts/GemNodesTestV2.sol
...
contract GemNodesTestV2 is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256 swapAmount
        //address uniV2Router
    ) ERC20("GemNodesTestV2", "GEM") PaymentSplitter(payees, shares) {
