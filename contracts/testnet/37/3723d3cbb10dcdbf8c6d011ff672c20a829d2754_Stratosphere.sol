...
error Stratosphere__NonExistentTokenURI();

contract Stratosphere is ERC721 {
    ...
    string public baseURI =
        "ipfs://bafkreiej7cpkw2u3mnz2ffeeheexnlskvou7xzbbl4fy73sanzcvtflh7e";

    constructor() ERC721("Stratosphere", "STRAT") {}
        ...
        returns (string memory)
    {
        if (ownerOf(tokenId) == address(0)) {
            revert Stratosphere__NonExistentTokenURI();
        }
