...
contract math {
	...
	uint256 public lastClaimTime = time - 1 minutes;
	...
	uint256[] public rewards = [10,1];
    	...
    	uint256 public timeStep = rewards[1].mul(1 minutes*1 minutes);
  	uint256[] public boostMultiplier = [Zero,_boosts[0],_boosts[1],_boosts[2]];
