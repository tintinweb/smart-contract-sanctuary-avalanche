...
contract Upgrade is ERC721Enumerable, Ownable, Pausable {
    ...
    constructor(Cocaine _cocaine, Diesel _diesel, string memory _BASE_URI) ERC721("Cartel Game Farmer Tools", "COCAINE-GAME-FARMER-TOOL") {
        ...
        levels[0] = Level({ supply: 0, maxSupply: 2500, priceCocaine: 5000 * 1e18, priceDiesel: 10 * 1e18, yield: 1 });
        levels[1] = Level({ supply: 0, maxSupply: 2200, priceCocaine: 15000 * 1e18, priceDiesel: 20 * 1e18, yield: 3 });
        levels[2] = Level({ supply: 0, maxSupply: 2000, priceCocaine: 25000 * 1e18, priceDiesel: 30 * 1e18, yield: 5 });
        currentLevelIndex = 2;
    }
...
contract HaciendaProgression is Context, Ownable, Pausable {
    ...
    // Constants
    uint256[20] public DIESEL_LEVELS = [0, baseCostUpgrade, 
    (baseCostUpgrade * 220)/100, 
    (baseCostUpgrade * 370)/100 , 
    (baseCostUpgrade * 560)/100 , 
    (baseCostUpgrade * 800)/100 , 
    (baseCostUpgrade * 1100)/100 , 
    (baseCostUpgrade * 1470)/100 , 
    (baseCostUpgrade * 1920)/100 , 
    (baseCostUpgrade * 2460)/100 , 
    (baseCostUpgrade * 3100)/100 , 
    (baseCostUpgrade * 3850)/100 , 
    (baseCostUpgrade * 4720)/100 , 
    (baseCostUpgrade * 5720)/100 , 
    (baseCostUpgrade * 6860)/100 , 
    (baseCostUpgrade * 8150)/100 , 
    (baseCostUpgrade * 9600)/100 , 
    (baseCostUpgrade * 11220)/100 , 
    (baseCostUpgrade * 13020)/100 , 
    (baseCostUpgrade * 15020)/100 ];
    ...
    // base cost for hacienda upgrades
    uint256 public baseCostUpgrade = 50 * 1e18;
    ...
    */
    ...
    function setBaseCostRespect(uint256 _baseCostRespect) external onlyOwner {
        ...
        function setBaseCostUpgrade(uint256 _baseCostUpgrade) external onlyOwner {
        baseCostUpgrade = _baseCostUpgrade;
    }
