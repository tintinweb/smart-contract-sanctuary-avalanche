...
contract ANATOLIA is ERC721Enumerable, IERC2981Royalties, Ownable {
    ...
    uint256 public itemFee = 0.1 ether;

    uint256[10000] public remainingIds;

    constructor(string memory baseTokenURI) ERC721("SUNAT", "SUNAT") {
