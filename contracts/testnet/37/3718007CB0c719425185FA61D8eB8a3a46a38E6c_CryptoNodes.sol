...
contract CryptoNodes {
    ...
    // Node attributes.
    bool nodespaused = false; // TODO: put on true on release
    uint8 constant NFTbonus = 125;
    uint8 constant nodePrice = 20;
    ...
    // uint256 nodeLvl1Yield = 125625 * 10**(tokenContract1.decimals() - 10);
    // uint256 nodeLvl1Yield = 15 * 10**(tokenContract1.decimals() - 2);
    // uint256 nodeLvl2Yield = 625 * 10**(tokenContract1.decimals() - 6);
    // uint256 nodeLvl2Yield = 6 * 10**(tokenContract1.decimals());
    ...
    constructor(AI _tokenContract1, IERC20 _tokenContract2, IERC721 _nftContract, address _owner) {
        ...
        nodeLvl1Yield = 125625 * 10**(tokendecimals - 10);
