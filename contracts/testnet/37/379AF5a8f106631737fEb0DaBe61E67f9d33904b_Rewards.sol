...
contract Rewards is ReentrancyGuard {
    ...
    constructor(TimeIsMoneyI timeIsMoney_, IERC20 token_, uint256 multiplier_, uint256 initialReward_, uint256 vestingPeriod_, uint256 claimDeadline_, address admin_) {
    ...
    function _rewardForAccount(address account) internal view returns (uint256) {
        ...
        require(block.timestamp > claimTimeL, "Rewards has not started yet.");
        timeBasedMultiplier = initialReward;
        uint256 timePassed = block.timestamp - claimTimeL;
