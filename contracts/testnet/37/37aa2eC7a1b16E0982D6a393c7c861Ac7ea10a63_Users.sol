...
contract Users is IUsers, Ownable, ReentrancyGuard{
    ...
    function updateProfile(
            ...
            string memory _bio, string memory _location, Zodiac _sign) external {
        ...
        if (users[msg.sender].status == Statuses.notRegistered) {
            ...
            users[msg.sender] = User(
                ...
                0, 0, 0, _interests, _bio, _location, _sign, 0, 0,
        ...
        emit UserProfileChange(_userName, _birthYear, _gender, Statuses.available, _fee, _interests, _bio, _location, _sign, regDateTime);
    }
