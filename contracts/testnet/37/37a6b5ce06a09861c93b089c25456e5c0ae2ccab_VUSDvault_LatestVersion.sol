...
contract VUSDvault_LatestVersion is Ownable {    
    ...
    uint256 public optibitAmountDR = 500; // optibit dr reward
    uint256 public optibitAmountIDR = 50; // optibit idr reward
    uint256 public optibitAmountPairing = 20; // optibit pairing reward
    uint256 public optibitClicks = 1; // optibit click reward
    ...
    //{        
        ...
        //totalSaveUserDataForDR[to] += _amount;
        //optibitTokenBalances[msg.sender] += 2000; // optibit tokens
    ...
    function saveUserDataforDR(address from, address to, uint256 _amount) public payable {
        ...
        totalSaveUserDataForDR[to] += _amount;
        optibitTokenBalances[msg.sender] += optibitAmountDR; // optibit tokens
    ...
    {        
        ...
        optibitTokenBalances[msg.sender] += optibitAmountIDR; // optibit tokens
    ...
    {        
        ...
        optibitTokenBalances[msg.sender] += optibitAmountPairing; // optibit tokens
    ...
    function saveClickAdsData(address to, uint256 _amount) public payable {  
        ...
        optibitTokenBalances[msg.sender] += optibitClicks; // optibit tokens
    ...
    function getOptibitTokenBalance(address _user) public view returns (uint256) {
        return optibitTokenBalances[_user];
    }
