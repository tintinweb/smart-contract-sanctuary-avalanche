...
contract GameAvaxDynamic is ChainlinkClient {
    ...
    constructor() {
        ...
        //Avalanche Fuji - Localhost node
        setChainlinkToken(address(0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846));
        oracle = address(0x62EF3d4F1B0bFF6bE46095bfbfb63991d737d9c7);
        jobId = "6dc42828e6e84ce49305bcbdf224689c";
    ...
    function reward(address _address) public {
        rewardPool = address(this).balance;
        if(rewardPool > 0.099 ether && score>=scoreTarget && statusPauseReward==false && players[_address].isPlaying){
