...
contract TokensFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function totalPending()
        ...
        returns (uint256)
    {
        if (block.timestamp <= startTime || firstDepositAt == 0) {
            return 0;
        }
    ...
    function finaliseDeposit(
        ...
        external
        onlyOwner
        validateStakeByStakeId(user, stakeId)
    {
        require(
            isInitialisedFully,
            "Farm is not fully initialised"
        ...
        require(
            depositRequest[user][stakeId].warmupExpiration < block.timestamp,
        ...
        payable
    {
        ...
        if(firstDepositAt == 0){
            firstDepositAt = block.timestamp;
        }
