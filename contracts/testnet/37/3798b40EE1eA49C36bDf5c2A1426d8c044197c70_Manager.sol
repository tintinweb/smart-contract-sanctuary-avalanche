...
contract Manager is ReentrancyGuard, Pausable, AccessControl {
  ...
  function equityInfo(address _vault) public view returns (uint256, uint256, uint256, uint256) {
    (
      uint256 tokenAAssetAmount,
      uint256 tokenBAssetAmount,
    ...
    uint256 tokenAEquityAmount = tokenAAssetAmount - tokenADebtAmount;
    uint256 tokenBEquityAmount = tokenBAssetAmount - tokenBDebtAmount;
    uint256 tokenAEquityValue = tokenAAssetValue - tokenADebtValue;
    uint256 tokenBEquityValue = tokenBAssetValue - tokenBDebtValue;

    return (tokenAEquityAmount, tokenBEquityAmount, tokenAEquityValue, tokenBEquityValue);
  }

  // Get vault's current position (asset) value
