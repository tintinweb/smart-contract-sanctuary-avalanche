...
import {WNT} from "oz-custom/contracts/presets/token/WNT.sol";

contract WrappedGEM is WNT {
    constructor() payable WNT("Wrapped GEM", "WGEM") {}
}

contract DAI is PMT {
    constructor() payable PMT("Dai Stablecoin", "DAI") {}
}

contract TBTCToken is PMT {
    constructor() payable PMT("tBTC", "TBTC") {}
}

contract USDC is PMT {
    constructor() payable PMT("USDC Coin", "USDC") {}
}

contract USDT is PMT {
    constructor() payable PMT("Tether USD", "USDT") {}
}

contract WrappedBTC is WNT {
    constructor() payable WNT("Wrapped BTC", "WBTC") {}
}
