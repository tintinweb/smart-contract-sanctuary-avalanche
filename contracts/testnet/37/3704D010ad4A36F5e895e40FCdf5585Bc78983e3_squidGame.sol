...
contract squidGame is ERC721Enumerable, Ownable {
     ...
     */
    function computeNextPlayerIdForHolder(address holder,uint256 _nftId,uint8 _sersionIndex)
        public
        view
        returns (bytes32)
    {
     ...
     */
    function computePlayerIdForAddressAndIndex(address holder, uint256 _nftId,uint8 _sersionIndex)
        public
        pure
        returns (bytes32)
    {
    ...
    */
    function partitionInGame(bool _chooes_side,bytes32 playerId)
        public
        GameInitialized
    {
        GameMember memory _member = Player[playerId];
    ...
    function checkProgres(bytes32 playerId) public returns (string memory, uint256) {
