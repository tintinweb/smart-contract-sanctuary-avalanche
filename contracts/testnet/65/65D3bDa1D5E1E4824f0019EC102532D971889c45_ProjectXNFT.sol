    ...
    VRFConsumerBaseV2
{
    ...
    constructor() ERC721("ProjectX NFT", "#PXT") VRFConsumerBaseV2(vrfCoordinator) {
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            ...
            _safeMint(msg.sender, s_randomWords[tokenId]);
            _setTokenRoyalty(s_randomWords[tokenId], owner(), contractRoyalties);
