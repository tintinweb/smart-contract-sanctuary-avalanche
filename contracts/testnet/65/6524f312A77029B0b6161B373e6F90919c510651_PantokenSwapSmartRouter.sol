...
interface IPantokenswapV2Exchange {
...
import "./IPantokenswapV2Exchange.sol";
import "../../openzeppelin/contractsV4.8.1/token/ERC20/IERC20.sol";

interface IPantokenswapV2Factory {
    function getPair(IERC20 tokenA, IERC20 tokenB) external view returns (IPantokenswapV2Exchange pair);
}
...
import "../interfaces/IPantokenswapV2Factory.sol";
import "../interfaces/IPantokenswapV2Exchange.sol";
import "./UniERC20.sol";
import "../../openzeppelin/contractsV4.8.1/token/ERC20/IERC20.sol";
import "../../openzeppelin/contractsV4.8.1/utils/math/Math.sol";

library PantokenswapV2ExchangeLib {
    using Math for uint256;
    using UniERC20 for IERC20;

    function getReturn(
        IPantokenswapV2Exchange exchange,
        IERC20 srcToken,
        IERC20 dstToken,
        uint256 amountIn
    )
...
import "../../openzeppelin/contractsV4.8.1/token/ERC20/IERC20.sol";
import "../../openzeppelin/contractsV4.8.1/token/ERC20/extensions/draft-IERC20Permit.sol";
...
import "../../openzeppelin/contractsV4.8.1/token/ERC20/IERC20.sol";
import "../../openzeppelin/contractsV4.8.1/token/ERC20/extensions/IERC20Metadata.sol";
...
import "../openzeppelin/contractsV4.8.1/security/ReentrancyGuard.sol";
...
import "./libraries/PantokenswapV2ExchangeLib.sol";

contract PantokenSwapSmartRouter is Ownable, ReentrancyGuard {
    using UniERC20 for IERC20;
    using SafeERC20 for IERC20;
    using PantokenswapV2ExchangeLib for IPantokenswapV2Exchange;
    ...
    address public immutable pantokenswapV2;
     ...
     * @param _pantokenFactory: address of the PantokenFactory
     * @param _stableswapFactory: address of the PantokenStableSwapFactory
     */
    constructor(
        address _WETHAddress,
        address _pantokenswapV2,
        address _stableswapFactory
    ) {
        weth = IWETH02(_WETHAddress);
        pantokenswapV2 = _pantokenswapV2;
    ...
    function _swapOnV2ExactIn(
        ...
        IPantokenswapV2Exchange exchange = IPantokenswapV2Factory(pantokenswapV2).getPair(srcTokenReal, dstTokenReal);
