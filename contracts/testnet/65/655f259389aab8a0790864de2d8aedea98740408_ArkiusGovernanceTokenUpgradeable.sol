...
contract ArkiusGovernanceTokenUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, IERC20Metadata, Blacklistable {
    ...
    function initialize(address blacklistContractAddress, address multisigAddress) public initializer {
        __Ownable_init();
     ...
     */
    function transfer(address recipient, uint256 amount) notBlacklisted public override returns (bool) {
     ...
     * - the caller must have a balance of at least `amount`.
     */
    function transferUnlock(address recipient, uint256 amount) notBlacklisted external override returns (bool) {
     ...
     */
    function approve(address spender, uint256 amount) notBlacklisted public override returns (bool) {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) notBlacklisted public override returns (bool) {
     ...
     * `amount`.
     */
    function transferFromUnlock(address sender, address recipient, uint256 amount) notBlacklisted external override returns (bool) {
     ...
     * - `spender` cannot be the zero address.
     */
    function increaseAllowance(address spender, uint256 addedValue) notBlacklisted external returns (bool) {
     ...
     * `subtractedValue`.
     */
    function decreaseAllowance(address spender, uint256 subtractedValue) notBlacklisted external returns (bool) {
     ...
     */
    function writeSnapshot() external notBlacklisted {
