...
contract BridgesOfFate is Ownable  {
    ...
    event ParticipateOfPlayerInGame(bytes32 playerId,uint256 stageGlobal,uint256 randomNumber, bool safeSide,bool jumpAt);
    ...
    */
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) external  GameEndRules {
        ...
        emit ParticipateOfPlayerInGame(playerId,_gameStatus.stageNumber,GameMap[_currentUserStage],_checkSide(GameMap[_currentUserStage],_jumpSide),_jumpSide);
        PlayerItem[playerId] = _member;
