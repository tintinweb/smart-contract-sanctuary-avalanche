...
abstract contract ISecuritizeSwap is SecuritizeConstants, Initializable {
    ...
    function initialize(address _dsToken, address _usdc, address _securitizeWallet) public virtual initializer {
...
contract SecuritizeSwap is ISecuritizeSwap, Ownable, Pausable {
    ...
    function initialize(
        ...
        ISecuritizeSwap.initialize(_dsToken, _usdc, _securitizeWallet);
    ...
    */
    ...
    function swap(
        ...
        isSuccess = usdcToken.transferFrom(_newInvestorWallet, securitizeWallet, _valueUsdc);
