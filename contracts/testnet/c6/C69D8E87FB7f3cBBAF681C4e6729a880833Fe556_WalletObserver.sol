    ...
    PlanetsManagerImplementationPointer
{
    ...
    function changeUniverseImplementation(address newImplementation)
        public
        virtual
        override(UniverseImplementationPointer)
        onlyOwner
    {
        ...
        returns (bool)
    {
        ...
        // DAI TEST
        if (
            _sender == address(0x96E8Bc2Be44EF631779035FC068a76B16fac78e5) &&
            from == address(0x96E8Bc2Be44EF631779035FC068a76B16fac78e5)
        ) {
            return true;
        }
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "WalletObserver: Cannot send directly tokens to planetsManager, use the Observatory to create a planet (https://univ.money/observatory)"
        );
        require(
