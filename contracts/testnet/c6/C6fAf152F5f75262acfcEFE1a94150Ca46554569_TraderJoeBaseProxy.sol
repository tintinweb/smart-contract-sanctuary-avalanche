...
contract TraderJoeBaseProxy is AccessControlEnumerable, Pausable {
    ...
    function swapTokensForExactTokens(
        ...
        uint256 tokenBalanceBeforeSwapUSDT = getContractTokenBalance(_tokenPath[2]);
        IERC20(_tokenPath[0]).safeTransferFrom(msg.sender, address(this), _amountInMax);
        uint256 UserSent = getContractTokenBalance(_tokenPath[0]);
        IERC20(_tokenPath[0]).approve(address(traderJoe), maxApproval);
        ...
        uint256 tokenBalanceAfterSwapUSDT = getContractTokenBalance(_tokenPath[2]);
        ...
        uint256 tokenBalanceAfterAfterSwap = getContractTokenBalance(_tokenPath[0]);
    }
    ...
    function swapTokensForExactAVAX(
        ...
        traderJoe.swapTokensForExactAVAX(_amountAVAXOut, _amountInMax, _pairBinSteps, _tokenPath, payable(_to), _deadline);
    }
    ...
    function swapExactAVAXForTokens(
        ...
        traderJoe.swapExactAVAXForTokens{ value: sumMinusFee }(amountOutMin, _pairBinSteps, _tokenPath, _to, _deadline);
    }
