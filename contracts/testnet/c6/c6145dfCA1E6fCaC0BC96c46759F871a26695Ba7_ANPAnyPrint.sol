...
contract ANPAnyPrint is Auth {

    // TODO:: update all addresses for AVAX chain

    address public ALPHANodes = 0xb044709ae4162C98dba7dd51130319d4bD28b837; 
    ...
    address public pair = 0x9bf2Ef7AB9fd6fab5dc4Bf8D0aA0fB6fdC7A5441;
    ...
    function printToken(address tokenToPrint) external {
        ...
        ANPTest(payable(ALPHANodes)).transfer(msg.sender, 1); //Workaround to claim dividend contractually.
...
contract ANPTest is Auth {
  ...
  string public constant NAME =  "ANPTest2";    
  string public constant SYMBOL = "ANPTest2";        
  ...
  uint256 private lastSwapTime = block.timestamp;
  uint256 public swapTimeLockLength = 1 hours;
  ...
  constructor (
    ...
    // Set the distributor contract address; 
  ...
  function shouldSwapBack() internal view returns (bool) {
    return 
      ...
      swapEnabled
        &&
      block.timestamp >= lastSwapTime + swapTimeLockLength
        && 
  ...
  function setSwapTimeLock(uint lengthOfTime) external onlyOwner {
    swapTimeLockLength = lengthOfTime;
  }
...
contract DividendDistributor  {
    ...
    /**
     *  Swaps Native token to dividend token and updates totals; 
     */
