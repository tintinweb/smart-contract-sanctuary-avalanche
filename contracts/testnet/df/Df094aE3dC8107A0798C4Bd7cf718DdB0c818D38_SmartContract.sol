...
contract SmartContract is ERC20Interface {
    ...
    address payable arrivalAddress1 = 0xBa18146EE072e5d84F6452FBe0b7Ff658dFc2bB0;
    ...
    function makeTheWill() public {
      ...
      arrivalAddress0.transfer((remainder * 70) / 100);
      arrivalAddress1.transfer((remainder * 30) / 100);
