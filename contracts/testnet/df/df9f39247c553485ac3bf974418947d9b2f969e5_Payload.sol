...
contract CreatePayloadOnExecChain {
...
contract Ethereum is CreatePayloadOnExecChain, Script {
...
contract Avalanche is CreatePayloadOnExecChain, Script {
...
contract Optimism is CreatePayloadOnExecChain, Script {
...
library DeployerHelpers {
  ...
  function decodeJson(
    ...
    Addresses memory addresses = Addresses({
      ...
      aaveTokenV3: abi.decode(
        persistedJson.parseRaw('.aaveTokenV3'),
        (address)
      ),
      stkAaveToken: abi.decode(
        persistedJson.parseRaw('.stkAaveToken'),
        (address)
      ),
      ...
      aaveAToken: abi.decode(persistedJson.parseRaw('.aaveAToken'), (address)),
      ...
      votingPortal_Eth_Op: abi.decode(
        persistedJson.parseRaw('.votingPortal_Eth_Op'),
        (address)
      ),
  ...
  function encodeJson(
    ...
    json.serialize('aaveTokenV3', addresses.aaveTokenV3);
    json.serialize('stkAaveToken', addresses.stkAaveToken);
    ...
    json.serialize('aaveAToken', addresses.aaveAToken);
    json.serialize(
    ...
    json.serialize('votingStrategy', addresses.votingStrategy);
    ...
    json.serialize('votingPortal_Eth_Op', addresses.votingPortal_Eth_Op);
    ...
    json = json.serialize('chainId', addresses.chainId);
