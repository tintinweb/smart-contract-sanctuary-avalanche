...
contract SingleStakingRewards is StakingRewards, ISingleStakingRewards {
        ...
        )
    {
        require(
            ...
            "SingleStakingRewards: NOT_ELKDEX_LP"
        );
    }
    ...
    function compoundSingleStakingRewards() external updateRewards(msg.sender) {
        ...
        require(
            ...
            "SingleStakingRewards: COMPOUND_IMPOSSIBLE"
        );
...
contract ElkSingleStakeFactory is ISingleStakeFactory, Ownable {
    ...
    function createNewSingleStake(
        ...
        require(
            ...
            "ElkSingleStakeFactory: FARM_EXISTS"
    ...
    function setManager(address _managerAddress) external override onlyOwner {
        require(
            ...
            "ElkSingleStakeFactory: ZERO_ADDRESS"
        );
    ...
    function _takeFee() private {
        require(
            ...
            "ElkSingleStakeFactory: INSUFFICIENT_BALANCE"
        );
    ...
    function setFee(uint256 _newFee) external onlyOwner {
        require(_newFee < maxFee, "ElkSingleStakeFactory: FEE_TOO_HIGH");
        fee = _newFee;
        emit FeeSet(_newFee);
    }
    ...
    function _overrideOwnership(address _farmAddress) private {
        ...
        require(creatorAddress != msg.sender, "ElkSingleStakeFactory: ALREADY_OVERRIDEN");
        require(creatorAddress != address(0), "ElkSingleStakeFactory: UNKNOWN_FARM");
