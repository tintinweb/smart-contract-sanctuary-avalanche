...
contract TestSwap {
    ...
    function setfindBestPathFromAmountIn(address[] calldata route, uint128 amountIn) external {
        ILBQuoter(lbQouter).findBestPathFromAmountIn(route,amountIn);
        num1 = 1;
    }

    function findBestPathFromAmountOut(address[] calldata route, uint128 amountOut) external {
        ILBQuoter(lbQouter).findBestPathFromAmountOut(route,amountOut);
        num2 = 1;
    }
...
//    }
    ...
    constructor(address _lbRouter, address _lbQouter) {
        lbRouter = _lbRouter;
        lbQouter = _lbQouter;
    }
}
...
-》 0x2471591d77bf55cA1dc971ebD97a1fd8e43833F4
...
--private-key=d8ed0c11b24e0a5b51c23be4ad596b852d57d96fd16082babcdee6cbfd8cf2c1 \
0x2471591d77bf55cA1dc971ebD97a1fd8e43833F4 \
"swapNATIVEForExactTokens(uint256,(uint256[],uint8[],address[]),address)" 100000 "([25,0],[2,0],[0xd00ae08403B9bbb9124bB305C09058E32C39A48c,0xB6076C93701D6a07266c31066B298AeC6dd65c2d,0xAb231A5744C8E6c45481754928cCfFFFD4aa0732])" 0x3c3061BcAa68F4263Ee297ba0AA1707eeF258Ca5
*/
