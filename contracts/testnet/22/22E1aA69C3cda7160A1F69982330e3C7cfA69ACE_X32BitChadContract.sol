...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1685628000;
...
abstract contract WithdrawableV2 is Teams {
  ...
  address[] public payableAddresses = [0x614AeaA88D3658E9E34f26677Fcd9D69cE2dBFA4];
  address public erc20Payable = 0x614AeaA88D3658E9E34f26677Fcd9D69cE2dBFA4;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  ...
  uint256 public EARLY_MINT_PRICE = 0.45 ether;
  uint256 public earlyMintTokenIdCap = 11;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeihdmy4hmhhfu5eo4lsqvzg5mqpkhxtvaqqq635bzk5ofghkf33unq/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/ZUoYpVF3Ul2KMGGAPSQD/contract-metadata";
  }
...
// File: contracts/X32BitChadContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X32BitChadContract is ERC721APlus {
    constructor() ERC721APlus("32bit Chad", "CHAD"){}
}
