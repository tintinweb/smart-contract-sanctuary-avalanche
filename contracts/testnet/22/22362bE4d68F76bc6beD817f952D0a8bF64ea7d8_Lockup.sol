...
contract Lockup is Ownable {
    ...
    constructor (){
        ...
        NFToken = IERC721Metadata(0x0292678591881793E8247E50E92315AD718261B3);      // // NFT token address
        ...
        StakeNFT = IERC721Metadata(0xfA0639a7968737d64d85967526864f98D91b256b);
    ...
    function unclaimedAllRewards(address user, int128 period, bool all) public view returns(uint256[] memory resVal) {
        require(doable(_msgSender()), "NA");
        resVal = new uint256[](userInfoList[user].length);
        bool exist;
        uint256 j = 0;
