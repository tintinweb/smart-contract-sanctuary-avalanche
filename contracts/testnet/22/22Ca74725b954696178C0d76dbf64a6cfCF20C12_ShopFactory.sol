    ...
    ERC721HolderUpgradeable
{
        ...
        external
    {
        ...
        for (uint256 i = 0; i < params.length; ++i) {
            ...
            require(params[i].ltvRate <= 7000, Errors.VL_CONFIGURATION_LTV_RATE_INVALID);
            require(params[i].interestRate <= 100000, Errors.VL_CONFIGURATION_INTEREST_RATE_INVALID);
...
library LiquidateLogic {
        ...
        )
    {
        ...
        // transfer repayPrincipal from borrower to shop
