...
contract VRF {
  ...
  /* ***************************************************************************
     ...
     * ***************************************************************************
     */
  function randomValueFromVRFProof(Proof memory proof, uint256 seed) public view returns (uint256 output) {
    verifyVRFProof(
      proof.pk,
      proof.gamma,
      proof.c,
  ...
  ERC677ReceiverInterface
{
  ...
  function decryptRandomWords(Proof memory proof, RequestCommitment memory rc) public view returns (uint256) {
    (,, uint256 randomness) = getRandomnessFromProof(proof, rc);
      return uint256(keccak256(abi.encode(randomness, 0)));
  }
