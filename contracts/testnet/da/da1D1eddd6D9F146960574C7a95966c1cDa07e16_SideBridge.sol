...
contract SideBridge is Initializable, OwnableUpgradeable, UUPSUpgradeable {
   ...
   _disableInitializers();
    ...
    function returnTokens (address _requester, uint _bridgedAmount, bytes32 _sideDepositHash , uint256 _chainId) verifyInitialization  external {
