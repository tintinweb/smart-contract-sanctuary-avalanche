...
contract BlacklistWhitelistCanSale is IBEP20, Ownable {

    string public constant name = "BlacklistWhitelistCanSale";
    string public constant symbol = "BW";
...
contract DEX is Ownable, BlacklistWhitelistCanSale  {
    ...
    constructor() {
        token = BlacklistWhitelistCanSale (address(this));
    }
