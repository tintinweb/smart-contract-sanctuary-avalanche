...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract ChartLemon is ERC20, Ownable  {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ChariLemon4", "CHARLEMON4") {
      ...
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7E3411B04766089cFaa52DB688855356A12f05D1); // huricane swap test net
        ...
        marketingWallet = 0x3704D22a097286396fBa90342edDB8D876309502; // set as marketing wallet
        burnWallet = 0xB9aB4e603B6e05A8411410d7F1cb17827407290F; // set as burn wallet
