...
contract MarginLoan is IMarginLoan {
        ...
        )
    {
     ...
     /**
    @notice it return the  pledged loan details of user  against specific property.
    @return banks of lender banks
    @return loanAmounts of loan amounts 
    @return interestRates of interest rate against each loan
    @param _user address of borrower
    @param _token property token adddress
    @param _bank lender bank address
     */
        ...
        returns (uint256[] memory ids, uint256[] memory loans)
    {
     ...
     /**
    @notice return pledged loans and its ids;
    @param _user address of borrower
    @param _token address property token
    @param _bank ledner bank address
     */
    function getTotalNoOfPledgeTokens(address _user, address _token, address _bank)
        external
        override
    ...
    @param _user address of borrower
    @param _token address of property
     */
    ...
    /**
    @notice it return the pledged loans length
    @param _user address of borrower
    @param _bank lender bak address
     */
    ...
    function updatePledgeLoan(
        ...
        MarginLoan storage newMarginLoan = marginLoan[user][id];
        if (caller == 2) {
            newMarginLoan.loanAmount = remainingAmount;
            newMarginLoan.noOfTokens = newMarginLoan.noOfTokens.sub(tokensSold);
    ...
    /**
    @notice upon loan payment in exchange it will update the loan status to complete
    @param _user address of borrower
    @param _bank lender bak address
    @param _tokenAddress property token address
     */
