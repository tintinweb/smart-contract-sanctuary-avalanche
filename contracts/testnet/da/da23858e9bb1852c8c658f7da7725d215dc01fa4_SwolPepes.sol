    ...
    ClampedRandomizer
{
    ...
    uint256 public whiteListAPrice = 1200000000000000000;
    uint256 public whiteListBPrice = 1500000000000000000;
    ...
    bool public whitelistedBOnly = true;
...
function removeWhiteListB(address[] memory _addressList) external onlyOwner {
    ...
    function updateWhitelistAStatus() external onlyOwner {
        whitelistedAOnly = !whitelistedAOnly;
        whitelistedBOnly = !whitelistedBOnly;
    }

    function updateWhitelistBStatus() external onlyOwner {
    whitelistedBOnly = !whitelistedBOnly;
    whitelistedAOnly = !whitelistedAOnly;
    }
