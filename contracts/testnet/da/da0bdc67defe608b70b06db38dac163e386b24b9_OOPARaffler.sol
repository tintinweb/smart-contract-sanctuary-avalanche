...
contract OOPARaffler is Ownable, VRFConsumer, ERC1155Holder {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        if (raffle.raffleType == RaffleType.ERC1155) {
            RaffleWinners[raffleID] = RaffleWinnersData(winners,raffle.raffledCollectionERC1155 , 0, raffle.raffledGoodERC1155, RaffleType.ERC1155, 0);
        }
        else if (raffle.raffleType == RaffleType.ERC721) {
            RaffleWinners[raffleID] = RaffleWinnersData(winners, raffle.raffledCollectionERC721, raffle.tokenIdERC721, 0, RaffleType.ERC721,0);
        }
