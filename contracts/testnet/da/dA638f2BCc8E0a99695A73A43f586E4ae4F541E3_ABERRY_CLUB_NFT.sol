...
contract ABERRY_CLUB_NFT is Ownable,SignVerify,ERC721Enumerable{
    ...
    uint256 public genesisPrice = 20 ether;
    ...
    bool public freeMintStarted = true;
    bool public auctionStarted = true;
    bool public publicStarted = true;
    bool public genesisStarted = true;
    ...
    mapping (uint256 => uint256) public tokenIdType; // store tokenIdType
    ...
    */
    ...
    function mintBreed(uint256 _id1,uint256 _id2, uint256 _nonce, bytes memory signature) public {
    ...
    function setSale(uint256 saleNo) public onlyOwner {
        if(saleNo == 1) {
    ...
    function withDrawKLAY () onlyOwner public onlyOwner
    {
    ...
    function addSigner
    (address _signer,BERRY_Staking _stakingAddress)
    public 
    onlyOwner
    {
