...
interface ITrueCurrency is IERC20, IReclaimerToken, IHasOwner, IPoRToken {
...
// Root file: contracts/avalanche/AvalancheTokenControllerV3.sol
...
// import {IOwnedUpgradeabilityProxy as IOwnedUpgradeabilityProxy} from "contracts/proxy/interface/IOwnedUpgradeabilityProxy.sol";

// import {IHasOwner as IHasOwner} from "contracts/true-currencies/interface/IHasOwner.sol";
// import {ITrueCurrency as ITrueCurrency} from "contracts/true-currencies/interface/ITrueCurrency.sol";

/** @title TokenController
 * @dev This contract allows us to split ownership of the ITrueCurrency contract
 * into two addresses. One, called the "owner" address, has unfettered control of the ITrueCurrency contract -
 * it can mint new tokens, transfer ownership of the contract, etc. However to make
 * extra sure that ITrueCurrency is never compromised, this owner key will not be used in
...
contract AvalancheTokenControllerV3 {
    ...
    // paused version of ITrueCurrency in Production
    ...
    */
    ...
    /**
     * @dev pause all pausable actions on ITrueCurrency, mints/burn/transfer/approve
     */
    ...
    /**
     * @dev Change the minimum and maximum amounts that ITrueCurrency users can
