...
// File contracts/interfaces/INFTBank.sol
...
// File contracts/NFT/NFTBank/NFTBankStorageStructure.sol
...
// File contracts/NFT/NFTBank/NFTBankProxy.sol
...
contract NFTBankProxy is NFTBankStorageStructure {
    ...
    function initialize(
        ...
        _setupRole(SUPER_ADMIN_ROLE, addresses[2]);
        _setupRole(ADMIN_ROLE, addresses[3]);
        _setupRole(FPL_ROLE, addresses[3]);
...
// File contracts/NFT/NFTBank/NFTBankFactory.sol
