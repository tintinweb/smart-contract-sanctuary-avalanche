    ...
    KeeperCompatible
{
 ...
 struct Pending {
  ...
  struct GameOptionsInfo {
    ...
    mapping(uint256 => bool) public isFinished;
        ...
        nonReentrant
    {
        ...
        emit GameStarted(count, block.timestamp);
        ...
        returns (bool upkeepNeeded, bytes memory checkedData)
    {
        ...
        for (uint256 i; i < participants.length; i++) {
            ...
            //     participants[i]
            // );
            if (participantsBalances[i] >= ticketPrice ) {
...
isFinished[count-1] = true;
    ...
    address private LINK = 0x0b9d5D9136855f6FEc3c0993feE6E9CE8a297846;
