    ...
    ClampedRandomizer
{
    ...
    address public royaltyAddress = 0x74647af470Fe67cFf8fa0fdA79F17d705Cc164E6;
    ...
    constructor(
        ...
        address _lzEndpoint
    ) ERC721("Hoplapopla", "HOP") ClampedRandomizer(maxSupply) {
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        require(
            mintedSupply + amount - 1 < maxSupply,
    ...
    function internalMint(address to) internal {
        uint256 tokenId = _genClampedNonce() + 1323;
        mintedSupply += 1;
        _safeMint(to, tokenId);
    }
