...
contract ManagerAdapter is IManagerAdapter, AdapterGuard, Reimbursable {
    ...
    function submitProposal(
        ...
        string memory origin = "ManagerAdapter.submitProposal";
        require(
        ...
        IVotingAdapter votingContract = IVotingAdapter(
        ...
        votingContract.startNewVotingForProposal(dao, proposalId, data, origin);
    }
        ...
        reimbursable(dao)
    {
        ...
        IVotingAdapter votingContract = IVotingAdapter(dao.votingAdapter(proposalId));
        require(address(votingContract) != address(0), "adapter not found");

        require(
            votingContract.voteResult(dao, proposalId) ==
                Foundance.VotingState.PASS,
