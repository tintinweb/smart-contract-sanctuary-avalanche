...
contract TheChocolateFactory is ERC721, Ownable, KindaRandom {

	using Counters for Counters.Counter;
	using Strings for uint256;
	Counters.Counter private _tokenIds;

	uint256 private _maxMintable = 250;
	uint256 private _royaltyAmount = 600;
	uint256 private _maxMintPerTx = 10;
	uint256 private _price = 3 ether;
	uint256 private _wlPrice = 3 ether;


	address private _team = 0xB84D65dfDdE82B7a0836f1b6fb2D169B3c51f127;
	address private _royaltyReceiver = 0xB84D65dfDdE82B7a0836f1b6fb2D169B3c51f127;

	string private  _baseTokenURI;
	string private  _unrevealedURI = "https://metacardsclub.io/tcf/json/unrevealed.json";
	...
	uint256 private _startTime = 1671480000;

	mapping(address => bool) public whiteListed;

	constructor() ERC721("The Chocolate Factory", "CHOC") KindaRandom(250) {
		_privateMint(0xB84D65dfDdE82B7a0836f1b6fb2D169B3c51f127);
	}
	...
	function blankBaseURI() external onlyOwner {
    	_baseTokenURI = "";
	}
