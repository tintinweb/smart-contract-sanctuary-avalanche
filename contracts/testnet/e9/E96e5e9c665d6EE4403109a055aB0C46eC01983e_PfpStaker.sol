...
contract PfpStaker is IPfpStaker, ReentrancyGuard, Ownable, NFTreceiver {
	/// ----------------------------------------------------------------------------------------
	/// EVENTS
	/// ----------------------------------------------------------------------------------------

	event ClaimWhitelist(address claimer, address destination);

	event CreateRoundtable(address founder, address destination);
	...
	constructor(address shieldContract_, address roundtableFactory_) {
		owner = msg.sender;
