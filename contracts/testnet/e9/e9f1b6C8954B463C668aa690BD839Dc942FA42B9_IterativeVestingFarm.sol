...
contract IterativeVestingFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable{
     ...
     * @param _earlyClaimAvailablePer - percentage of claiming after start
     * @param _beforeStartClaimPer - percentage of claiming before start
     * @param _initialFundPercent - initial fund percent that needs to be respected
