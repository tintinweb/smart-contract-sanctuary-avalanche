    ...
    IMessageHandler
{
    ...
    function sendMessage(
        ...
        (variables.useTargetExecutor, processingFee) = _decodeSettings(_settings);
    ...
    function _decodeSettings(
        bytes calldata _settings
    ) private pure returns (bool useTargetExecutor, uint256 processingFee) {
        return abi.decode(_settings, (bool, uint256));
    }
...
abstract contract SystemVersionId {
     ...
     */
    uint256 public constant SYSTEM_VERSION_ID = uint256(keccak256('Circle CCTP - Testnet'));
}