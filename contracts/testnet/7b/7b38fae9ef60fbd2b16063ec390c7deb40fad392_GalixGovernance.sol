    ...
    AccessControlEnumerableUpgradeable
{
    ...
    EnumerableSetUpgradeable.AddressSet private _rewardPools;

    event AdminTokenRecovery(address tokenRecovered, uint256 amount);
    event TokenMint(address daoFund, address rewardPool, uint256 daoFundAmount, uint256 rewardPoolAmount);
    event StakeDistribute(address operator, address galixStakePool, uint256 amount);
    ...
    function stakeDistribute(uint256 _amount) onlyStakeOperator external {
        ...
        emit StakeDistribute(_msgSender(), galixStakePool, _amount);
    }
