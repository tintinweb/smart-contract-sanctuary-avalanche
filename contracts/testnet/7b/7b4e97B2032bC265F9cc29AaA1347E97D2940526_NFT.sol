...
contract NFT is ERC721MintMore, Ownable { //, CollectionManager
    ...
    // TODO: predelat na private
    function mintAddDetails(uint _collectionID, string memory _name) public onlyOwner {
        uint[] memory prop;
        for (uint i = 0; i < collections[_collectionID].properties.length; i++) {
            ...
            prop[i] = collections[_collectionID].properties[i].basicCount;
        }
