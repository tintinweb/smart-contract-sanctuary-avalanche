...
contract ANPAnyPrint is Auth {
    ...
    address public USDC = 0x3C241d25a3668709d2B539773Bb16bE3BB9fACf1; // test with LPTT
    ...
    function printToken(address tokenToPrint) external {
        ...
        IERC20(USDC).transferFrom(msg.sender, address(this), available); // move USDC back to this contract from sender for swap to desired token
        ...
        IERC20(USDC).approve(routerAddress, available); //Approve the swap, only the amount available.
