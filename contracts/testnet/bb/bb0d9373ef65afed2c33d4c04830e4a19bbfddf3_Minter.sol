...
contract Minter is Ownable {
     ...
     */
     function mint_auto_allocate_double ( 
        ...
        uint256 _value = _amount.mul(10** IERC20(_token).decimals()).div(10** IERC20(Waceo).decimals());
        IERC20(_token).increaseAllowance(address(this), _value);
    ...
    function distribute_double_mint(address _address, bool _approve) external onlyOwner returns(bool){
        ...
        if(_approve){ 
            ...
            IERC20(request.token).transferFrom(msg.sender, LP_Helper, _value);
