...
contract SecuritizeRegistryProxy is ISecuritizeRegistryProxy, Ownable {
    ...
    constructor(address initialSecuritizeRegistry)
        onlyValidSecuritizeRegistry(initialSecuritizeRegistry)
    {
        securitizeRegistry = initialSecuritizeRegistry;
    }

    modifier onlyValidSecuritizeRegistry(address newSecuritizeRegistry) {
        require(
            newSecuritizeRegistry.isContract(),
    ...
    function setSecuritizeRegistry(address newSecuritizeRegistry)
        ...
        override
        onlyOwner
        onlyValidSecuritizeRegistry(newSecuritizeRegistry)
    {
        securitizeRegistry = newSecuritizeRegistry;
    }

    function onlyWhitelistedWallet(address wallet) public view override {
        require(
            ISecuritizeRegistry(securitizeRegistry).isWhitelisted(wallet),
...
interface ISecuritizeRegistryProxy {
    ...
    function onlyWhitelistedWallet(address wallet) external view;
}
