...
contract TokenExchange is Ownable {
    ...
    function deposit(address variant, uint256 amount) public payable {
        ...
        uint256 exchangeRate = tokenBVariants[variant].exchangeRate.mul(1000);
    ...
    function claim() public {
        ...
        UserBalances storage userBalance = balances[sender];
        userBalance.balance = userBalance.balance.sub(vestedAmount);

        bool success = IERC20(tokenA).transfer(sender, vestedAmount);
