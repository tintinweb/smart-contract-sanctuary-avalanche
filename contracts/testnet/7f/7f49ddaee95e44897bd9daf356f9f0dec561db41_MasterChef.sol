...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 bullReward = multiplier.mul(bullPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        bull.mint(devaddr, bullReward.div(devrate));
        bull.mint(address(bullbar), bullReward);
    ...
    function enterStaking(uint256 _amount) public {
        ...
        bullbar.mint(msg.sender, _amount);
    ...
    function leaveStaking(uint256 _amount) public {
        ...
        bullbar.burn(msg.sender, _amount);
    ...
    function safeBullTransfer(address _to, uint256 _amount) internal {
        bullbar.safeBullTransfer(_to, _amount);
    }
