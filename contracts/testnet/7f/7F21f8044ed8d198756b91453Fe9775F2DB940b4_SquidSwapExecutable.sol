...
abstract contract EuroExpressExecutable is IAxelarExecutable {
...
import {EuroExpressExecutable} from "./EuroExpressExecutable.sol";

contract SquidSwapExecutable is EuroExpressExecutable, Ownable {
    error InvalidTrade();
    ...
    constructor(address _gateway, address _gasReceiver)
        EuroExpressExecutable(_gateway)
        Ownable()
    {
