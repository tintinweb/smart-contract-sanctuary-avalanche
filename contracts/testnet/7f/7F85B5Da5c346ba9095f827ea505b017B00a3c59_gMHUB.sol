...
contract gMHUB is IgMHUB, ERC20 {
    ...
    constructor(address _migrator, address _sMHUB)
        ERC20("Governance MHUB", "gMHUB", 18)
    {
     ...
     * @param _sMHUB address
     */
    function migrate(address _staking, address _sMHUB) external override onlyApproved {
        ...
        require(_sMHUB != address(0), "Zero address found");
        sMHUB = IsMHUB(_sMHUB);
    }
    ...
    /**
     * @notice pull index from sMHUB token
     */
    ...
    /**
        @notice converts gMHUB amount to MHUB
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts MHUB amount to gMHUB
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gMHUB::getPriorVotes: not yet determined");
