...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x951D011dF6EB6073dDe12ca406C4f03a128c6110);
	}
...
contract Wiwitoken is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 3000;
	uint256 public TOKEN_PER_TX = 100;
	uint256 public TOKEN_PER_WALLET = 5;
	uint256 public PRICE = 5 ether;
	uint256 public constant TIME_FOR_GROWN = 1685472034431;
	address public founder = 0x951D011dF6EB6073dDe12ca406C4f03a128c6110;
	...
	string private _name = "wiwitoken";
	string private _symbol = "WIWI";
