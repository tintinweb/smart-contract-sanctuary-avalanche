...
contract LendingPool is ERC20, ReentrancyGuard, Pausable, AccessControl {
  ...
  */
  constructor(
    ...
    address _operator
      ...
      conversionFactor = _to18ConversionFactor(_asset);
  ...
  */
  function _mintShares(uint256 _assetAmount) internal returns (uint256) {
    ...
    uint256 shares = previousTotalValue == 0 ? _assetAmount.mul(conversionFactor) : _assetAmount.mul(totalSupply()).div(previousTotalValue);
