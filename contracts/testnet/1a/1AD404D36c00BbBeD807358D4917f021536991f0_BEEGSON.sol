...
contract BEEGSON is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC2981, ClampedRandomizer {
    constructor() 
        ERC721("BEEG SON", "BA") ClampedRandomizer(maxSupply) {
    ...
    uint price = 0;
    uint public whitelistTime= 	1671360647; // Sun Dec 18 2022 17:00:00 GMT+0000
    uint public publicTime= 1671384600; //Sun Dec 18 2022 17:30:00 GMT+0000
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        //mint limits
        require(whiteListedCount[msg.sender] < maxPerNonTeam, "You can have only 1 Beeg Son");
        ...
        if (block.timestamp >= publicTime)
        {
            require(publicCount[msg.sender] < maxPerNonTeam, "You can have only 1 Beeg Son");   
        }
