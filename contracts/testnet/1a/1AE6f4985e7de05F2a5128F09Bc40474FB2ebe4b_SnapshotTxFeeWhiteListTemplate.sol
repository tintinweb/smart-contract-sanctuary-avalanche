...
contract SnapshotTxFeeWhiteListTemplate is SnapshotFeature, PausableWithWhitelistFeature, TxFeeFeatureAlt {
    function initialize(
        string memory name_, 
    ...
    function _beforeTokenTransfer_hook(
        ...
        address to,
        uint256 amount
    )  internal virtual override(SnapshotFeature, PausableWithWhitelistFeature, TxFeeFeatureAlt) {
