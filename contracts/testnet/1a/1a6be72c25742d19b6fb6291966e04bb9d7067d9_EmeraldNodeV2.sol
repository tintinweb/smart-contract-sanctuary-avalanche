...
contract EmeraldNodeV2 is Initializable, OwnableUpgradeable {
    ...
    function buyNode(Order1 memory order, bytes memory signature) external returns(bool){
        uint256 _tier;
        uint256 nodeId;
        require(owner() == ECDSAUpgradeable.recover(order.key, signature), "EmeraldNodeV1: ERROR");
        require(referenceDetails1[msg.sender][order.ReferenceId] == false, "EmeraldNodeV1: ReferenceId is already used");
        ...
        referenceDetails1[msg.sender][order.ReferenceId] = true;
