...
contract SegMintExchangeDB is SegMintExchangeStructs {
    ...
    modifier onlySegMintExchangeDBAdmin() {
        ...
        require(
            msg.sender == _SegMintExchangeDBAdmin,
    ...
    function setSegMintExchangeDBAdmin(address SegMintExchangeDBAddress_)
        public
        onlyOwner
        notNullAddress(
            SegMintExchangeDBAddress_,
            "SegMint Exchange Database Address"
        )
    {
        _SegMintExchangeDBAdmin = SegMintExchangeDBAddress_;
    }
