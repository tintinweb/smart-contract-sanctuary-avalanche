...
// File: contracts/BananazV2.sol

pragma solidity ^0.8.4;

contract Humanoidz is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC2981, ClampedRandomizer {
    constructor() 
        ERC721("Humanoidz", "HMDZ") ClampedRandomizer(maxSupply) {
...
//    uint maxPerTeam = 2;
    ...
    address public royaltyAddress=0x1c8dF4Ec28B6b7aa82feE2A7acCc53458f83CB48;
    uint96 public royalty=1000;
    string public baseURI = "";
    string public unrevealedURI = "ipfs://bafybeiatlz2xtvlmfk4r33vm4seayytriie4u7lmkfahyym2xx5cwekpry/hidden.json";
    ...
    function mint(uint256 amount) public payable whenNotPaused {
	 ...
	 //supply limits
        ...
        require(supply + amount <= maxSupply, "No more Humanoidz");
        //transaction limits
        require(amount > 0,"mint nothing ? sure");
        require(amount <= maxPerTx, "Too many Humanoidz at once");
        if (price > 0) 
        {
            require(msg.value >= price * amount, "more avax");
        }
        //public mint
            require(publicCount[msg.sender] < maxPerNonTeam, "only 1 Humanoidz");   
