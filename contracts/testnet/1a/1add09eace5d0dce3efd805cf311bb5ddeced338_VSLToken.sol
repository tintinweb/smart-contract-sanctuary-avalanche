...
contract VSLToken is Ownable, IERC20
{
    ...
    bool private _buysellEnabled = true;               // Used to allow transfers and staking prior to buy/sell being enabled
    ...
    uint256 private _liquidityBuyTax = 10;               // (stored at 10x so 1% is 10)
    uint256 private _halfLiquidityBuyTax = 10;           // (stored at 10x so 0.5% is 5) - kept for math efficiency later (calc once)
    ...
    uint256 private _royaltyBuyTax = 50;               // (stored at 10x so 10% is 100)
