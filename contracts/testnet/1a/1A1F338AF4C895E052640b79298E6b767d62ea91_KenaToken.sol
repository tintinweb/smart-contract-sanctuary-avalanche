...
abstract contract Tokenomics is IERC20, IERC20Metadata {
    ...
    string internal constant SYMBOL = "KENA.4"; // CHANGE ME
    ...
    // --------------------- Burn Settings ------------------- //
    address internal burnAddress = 0xDeADCafe00000000000000000000000662607015;
...
abstract contract NetworkFee is Ownable, Presaleable, Tokenomics {
    using SafeMath for uint256;
