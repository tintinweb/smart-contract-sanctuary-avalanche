...
contract NomadToken is IERC20, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string private _name = "NOMAD Token";
    string private _symbol = "NMT";
    ...
    constructor(
        ...
        if (initialSupply > 0) {
            ...
            _mint(CommunintyFutureWallet, initialSupply.mul(5).div(100));
            ...
            _mint(MarketingWallet, initialSupply.mul(5).div(100));

            _mint(PresaleWallet, initialSupply.mul(15).div(100));

            _mint(SaleWallet, initialSupply.mul(15).div(100));
        }
    }
