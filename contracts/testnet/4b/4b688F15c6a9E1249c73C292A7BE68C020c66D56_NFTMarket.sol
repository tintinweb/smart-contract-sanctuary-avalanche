    ...
    NFTMarketAuction
{
        ...
        onlyValidMinPercentIncrement(minPercentIncrementInBasisPoints)
    {
        ...
        _duration = 30 minutes; // TODO change to 48 hours in prod
    }
    ...
    NFTMarketCore
{
    ...
    modifier onlyValidWallet(address wallet) {
        require(
            !wallet.isContract(),
            "NFTMarketReserveAuction: contract address"
        );
    ...
    function getFees(
        ...
        public
        view
        returns (uint256 creatorSecondaryMarketFee, uint256 ownerRew)
    {
        (, creatorSecondaryMarketFee, , ownerRew) = _getFees(
            nftContract,
            tokenId,
    ...
    {
        if (_getIsPrimary(nftContract, tokenId)) {
    ...
    function _distributeFunds(
        ...
        uint256 price,
        address aliceToken
    ) internal returns (uint256 creatorSecondaryMarketFee, uint256 ownerRew) {
        address creatorSecondaryMarketFeeTo;
        address ownerRewTo;
        (
    ...
    function markTokenFirstSaleCompleted(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            emit MarkedTokenFirstSaleCompleted(nftContract, tokenIds[i]);
        }
    }
