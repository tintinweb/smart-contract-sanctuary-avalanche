    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0x35E0C08318390d35343625692d030898fe768f57;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("SmolBurgers", "SMB") ClampedRandomizer(maxSupply) {     
