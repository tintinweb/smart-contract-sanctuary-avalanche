...
// Type imports
import {Hero, NGTCreateHeroArgs, NFTCurrentSales} from "../NGTypes.sol";
...
contract NGAdminFacet is WithStorage {
    ...
    function getSaleMode() public view onlyAdmin returns (NFTCurrentSales _saleMode) {
        return (gameConstants().NFT_SALE_MODE);
    }
    function setSaleMode(NFTCurrentSales _saleMode) public onlyAdmin {
        gameConstants().NFT_SALE_MODE = _saleMode;
    }
    ...
    function transfer(uint256 amount, address _receipt) public onlyAdmin {
        ...
        (bool sent, bytes memory data) = sentTo.call{value: amount}("");
