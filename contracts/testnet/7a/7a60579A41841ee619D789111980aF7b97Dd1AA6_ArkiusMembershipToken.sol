...
contract ArkiusMembershipToken is MembershipToken, Pausable {
    ...
    string public name = "Arkius Membership Token";
    ...
    constructor(string memory contractURI, 
                ...
                MembershipToken(contractURI, tokenURIPrefix, multisigAddress) {
     ...
     */
    function mint(string memory uri) whenNotPaused public {
...
import './ERC1155BaseMembership.sol';

contract MembershipToken is ERC1155BaseMembership {

    constructor(string memory contractURI,
                string memory tokenURIPrefix,
                address       multisigAddress) ERC1155BaseMembership(contractURI, tokenURIPrefix, multisigAddress) {
...
import './ERC1155Member.sol';

contract ERC1155BaseMembership is ERC1155Metadata_URI, HasContractURI, ERC1155Member {
...
contract ERC1155Member is Ownable, IERC1155, ERC165, CommonConstants {
