...
contract NGResourceCollectFacet is WithStorage {
    
    event CollectAllResources(uint256 indexed tokenId);
    ...
    function collectAllResources(uint256 tokenId) public notPaused resourceAddresses {
        ...
        if (resources.cashPending > 0) {
            ...
            hero.cashResource.unclaimedAmount = 0;
        }
        if (resources.woodPending > 0) {
            ...
            hero.woodResource.unclaimedAmount = 0;
        }
        if (resources.stonePending > 0) {
            ...
            hero.stoneResource.unclaimedAmount = 0;
        }
        if (resources.steelPending > 0) {
            ...
            hero.steelResource.unclaimedAmount = 0;
        }
        if (resources.oilPending > 0) {
            ...
            hero.oilResource.unclaimedAmount = 0;
        }

        gs().heros[tokenId] = hero;
        emit CollectAllResources(tokenId);
    }
