...
contract Token {
    ...
    string public name = "Six Pepe";
    string public symbol = "SPEPE";
    uint public decimals = 18;

    uint public taxRate = 250; // equivalent to 1.5 percent tax with two decimal precision
    uint public burnRate = 0; // “You fool this isn’t even my final form.”
    address public taxReceiver = 0x4e1AF94594ba1d417426dC9dE1ef401E5DFE7Fc6;
