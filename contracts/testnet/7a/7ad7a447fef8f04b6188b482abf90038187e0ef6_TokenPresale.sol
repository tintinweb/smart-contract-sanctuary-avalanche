...
contract TokenPresale {
    ...
    constructor() {
        owner = msg.sender;
    balances[owner] = totalSupply * (10 ** uint256(decimals)); // Multiply totalSupply by 10^decimals to account for decimal places
    ...
    function claimTokens() external {
        ...
        emit Transfer(address(0), msg.sender, claimAmount); // Emit the Transfer event from address(0) to the participant's address
    }
