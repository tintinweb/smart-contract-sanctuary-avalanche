...
contract CupidEggs is ERC721Enumerable, ReentrancyGuard, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    uint96 public tokenRoyalties = 750; 
    address public royaltyPayout = 0xE87D041184d98197f35aC5156b154755F7aC6C7d; 

    ///////// WL /////////
    uint256 public _maxWL_Mintable = 440; 
    mapping(address => bool) public whiteListed;
    bool public isWL = true;


    constructor() ERC721("Cupid Eggs", "CEGG") {
        internalMint(0x77414036Afb728b7346cD2c37a689e8C2269FCeF); // s
