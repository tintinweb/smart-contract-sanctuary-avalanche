...
contract GenesisClaim is Ownable, Pausable, Multicall {
	...
	IERC20 public usdc;
	IGenesisClaim721 public whitelistMintContract;
	...
	{
		whitelistMintContract = IGenesisClaim721(_whitelistMintContract);
		usdc = IERC20(_usdc);
	...
	function _purchase(uint256 _nftsToPurchase) internal {
		...
		whitelistMintContract.safeMint(msg.sender, _nftsToPurchase, presaleNFTUri);
	...
	function circulatingNFT() public view returns (uint256) {
		return whitelistMintContract.totalSupply();
	}
	...
	function setMintContract(address _minter) external onlyOwner {
		whitelistMintContract = IGenesisClaim721(_minter);
	}
