...
contract FilaERC20V2 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function stake(uint256 _tokenId, uint256 _printerId, uint256 _amount)
        external
        virtual
    {
        require(ERC721TokenAddress.ownerOf(_tokenId) == msg.sender, "FillaERC20: Not an owner");
        ...
        virtual
    {
        require(
            SignatureCheckerUpgradeable.isValidSignatureNow(
                ...
                _order.messageHash,
                _signature
            ) && !isVerified[_signature] && !(ERC721TokenAddress.isVerified(_signature)),
            "FillaERC20: Not allowed"
        );
    ...
    function mint(address _who, uint256 _amount) external virtual onlyAllowedAddress{
        _mint(_who, _amount);
    }
}
