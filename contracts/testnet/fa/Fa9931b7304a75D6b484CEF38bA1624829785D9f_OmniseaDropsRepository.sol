...
contract OmniseaDropsRepository is IOmniseaDropsRepository {
    ...
    function create(
        ...
        new OmniseaONFT721A(_params, _creator, dropsManager, _lzEndpoint, _minGasToTransfer);
    }
...
contract OmniseaONFT721A is ONFT721Core, IOmniseaONFT721A, ERC721A, ReentrancyGuard {
    ...
    modifier isBeforeMint() {
        require(_totalMinted() == preMintedToTeam);
        _;
    }
    ...
    constructor(
        ...
        require(endTime > block.timestamp && maxSupply > 0 && bytes(tokensURI).length > 0);
