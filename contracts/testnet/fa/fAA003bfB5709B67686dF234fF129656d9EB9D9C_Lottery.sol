...
contract Lottery {
	...
	function BuyTickets(uint256 numOfTicketsToBuy, uint256 value) public payable {
		require(
		    value == numOfTicketsToBuy * ticketPrice,
		    string.concat(
		        "the value must be ",
		        Strings.toString(numOfTicketsToBuy * ticketPrice),
		        " Ether for buying ",
		        Strings.toString(numOfTicketsToBuy),
		        " tickets."
		    )
		);
		require(
