...
contract CelerMessage is MessageApp {
    ...
    function calcFee(string calldata _message) public view returns (uint256) {
        bytes memory message = abi.encode(msg.sender, _message);
        return MessageBus(messageBus).calcFee(message);
    }
    ...
    function executeMessage(
        ...
        responseSourceChain = _srcChainId;
        responseSourceAddress = _srcContract;
...
contract MessageBusReceiver is Ownable {
    ...
    function verifyTransfer(
        ...
        if (_transfer.t == MsgDataTypes.TransferType.LqRelay) {
            ...
            _transfer.t == MsgDataTypes.TransferType.PegMint ||
            ...
            _transfer.t == MsgDataTypes.TransferType.PegV2Mint ||
            _transfer.t == MsgDataTypes.TransferType.PegV2Withdraw
        ) {
