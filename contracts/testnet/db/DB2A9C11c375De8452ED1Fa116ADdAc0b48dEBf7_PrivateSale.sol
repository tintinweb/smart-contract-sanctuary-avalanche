...
contract PrivateSale is Ownable {
    ...
    function buy(uint256 amount) public returns (uint256 result) {
        // require(msg.sender != address(0), "Address is zero.");
        // require(amount != 0, "Amount is zero.");
        // require(amount >= 5000000000000000000000, "Min amount is 5000.");
        // require(amount <= 250000000000000000000000, "Max amount is 250000.");
        // require(amount != 0, "Amount is zero.");

        result = amount;
        IERC20(USDT).transferFrom(msg.sender, multisig, result);
        // IERC20(XDX).transfer(msg.sender, result * rate);
        return result * rate;
    }
