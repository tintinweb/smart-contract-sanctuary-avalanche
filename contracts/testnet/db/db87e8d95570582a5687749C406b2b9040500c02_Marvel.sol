...
contract RewardManager {
    ...
    function _getNodeTypeRewardAmountOf(address account, uint256 typeNum)
        external
        view
        returns (uint256)
    {
...
contract Marvel is ERC20, Ownable, PaymentSplitter {
    ...
    function addNewNodeType(uint256 typeNum, uint256 nodePrice, uint256 rewardPerDay) public onlyOwner {
