...
// File: contracts/GovernanceStaking.sol
...
contract GovernanceStaking is Ownable, ReentrancyGuard {
    ...
    IERC20 public usdc;
    IERC20 public governanceRequiem;
    ...
    modifier onlyReserveFund() {
        require(reserveFund == msg.sender || owner() == msg.sender, "Governance Staking: caller is not the reserveFund");
        _;
    }

    constructor(IERC20 _usdc, IERC20 _governanceRequiem) Ownable() {
        usdc = _usdc;
        governanceRequiem = _governanceRequiem;
    ...
    function pendingReward(address _user) external view returns (uint256 pending) {
        ...
        uint256 supply = governanceRequiem.balanceOf(address(this));
    ...
    function deposit(uint256 amount, address to) public {
        ...
        governanceRequiem.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function withdraw(uint256 amount, address to) public {
        ...
        governanceRequiem.safeTransfer(to, amount);
