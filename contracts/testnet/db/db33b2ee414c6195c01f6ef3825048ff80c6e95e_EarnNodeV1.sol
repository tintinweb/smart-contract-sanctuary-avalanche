...
contract EarnNodeV1 is EarnNodeStorageV1 {
    ...
    */
    ...
    function viewNodeDetails(uint256 _nodeId) public view returns(
        ...
        uint256 number =  uint256(block.timestamp - LastClaimTime) / tierDetails[tierId].intervalTimestamp;
        uint256 rewardAmt = uint256(tierDetails[tierId].rewardRate * number);
