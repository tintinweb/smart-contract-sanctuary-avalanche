...
// @title:  Hamsterz Beach Club
// @desc:   4444 HAMSTERZ LIVING ON THE AVALANCHE BLOCKCHAIN
// @url:    https://hamsterzbeach.club
// @discord:   https://discord.gg/hamsterzbc
// @twitter: https://twitter.com/hamsterzbc
// @instagram:   https://www.instagram.com/hamsterzbc
...
contract HamsterzBeachClub is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public maxPresaleTokens = 2220; 
    uint256 public maxTokensPerWallet = 5; 
    uint256 public maxMintPerTxPresale = 5; 
    uint256 public maxMintPerTx = 5; 
    uint256 public tokensReserved = 132;
    uint256 public presalePrice = 0.75 ether;
    ...
    string public HBC_PROVENANCE;


    event TokenMinted(uint256 tokenId);

    constructor() ERC721("Hamsterz Beach Club", "HBC") {}
    ...
    */
     ...
     * Mints Hamsterz
     */
    function mintHamsterz(uint256 _amount) public payable {
