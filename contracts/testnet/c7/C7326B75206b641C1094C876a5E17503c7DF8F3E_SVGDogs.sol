...
// import "https://github.com/OpenZeppelin/openzeppelin-contracts/contracts/utils/Base64.sol";
...
contract SVGDogs is ERC721Enumerable {
    ...
    function mint(uint256 _color) public {
        require(_color > 0 && _color < 4 , "Color not n range");
        uint a1 = 0;
        uint a2 = 0;
        uint a3 = 0;
        if(_color == 1) {
