...
contract ArableOracle is Initializable, OwnableUpgradeable, IArableOracle, ReentrancyGuardUpgradeable {
    ...
    function registerPrice(address token_, uint256 price_) public override onlyAllowedProvider {
    ...
    ) public override onlyAllowedProvider {
