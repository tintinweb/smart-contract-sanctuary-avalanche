...
import "./OnAvaxArtTradable.sol";

contract OnAvaxArtFactory is Ownable {
    ...
    /// @notice Platform fee reciOnAvaxent
    ...
    */
    ...
    /// @notice Method for deploy new OnAvaxArtTradable contract
        ...
        returns (address)
    {
        ...
        OnAvaxArtTradable nft = new OnAvaxArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing OnAvaxArtTradable contract
    ...
    /// @notice Method for disabling existing OnAvaxArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
