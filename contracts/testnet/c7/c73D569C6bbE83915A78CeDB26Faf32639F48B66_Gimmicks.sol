...
contract Gimmicks is ERC721Enumerable, Ownable, AccessControl {
    ...
    function sendDICPunch(
        ...
        require(dicPunchesBalanceByTokenId[tokenId] >= 1, "Account doesn't have enough DICPunch");
        require(strlen(message) <= 280, "Message is too long");

        dicPunchesBalanceByTokenId[toTokenId]++;
        dicPunchesBalanceByTokenId[tokenId]--;
