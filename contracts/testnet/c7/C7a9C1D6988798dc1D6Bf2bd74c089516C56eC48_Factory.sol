...
contract Factory {
    ...
    * @param _avax Boolean where true is to handle avax, and false is to
    * handle other tokens.
    */
    function releaseFunds(IERC20 _token, bool _avax) onlyOwner public {
        if(!_avax) {
    ...
    * handle other tokens.
    */
    function flush(uint[] memory _ids, IERC20 _token, bool _avax) onlyManagement public {
    ...
    * handle other tokens.
    */
    function payoutAll(uint _id, IERC20 _token, bool _avax) external {
