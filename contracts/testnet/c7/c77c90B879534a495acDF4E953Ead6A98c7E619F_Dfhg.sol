/**
 *Submitted for verification at testnet.snowtrace.io on 2023-06-11
*/
...
abstract contract Ownable is Context {
	 ...
	 */
	constructor() {
		_setOwner(0x6fE170cfF5B72Ad1f952e9BF994b408fA468cB9f);
	}
...
contract Dfhg is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 346;
	uint256 public TOKEN_PER_TX = 346;
	uint256 public TOKEN_PER_WALLET = 343;
	uint256 public PRICE = 378 ether;
	uint256 public constant TIME_FOR_GROWN = 1689084000000;
	address public founder = 0x6fE170cfF5B72Ad1f952e9BF994b408fA468cB9f;
	...
	string private _name = "dfhg";
	string private _symbol = "GFD";
	string private _baseTokenURI = "https://lab.cryptodo.app/ru/create?type=ERC721_CONTRACT&network=AVALANCHE";
