...
contract Cvb is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 2;
	uint256 public TOKEN_PER_TX = 2;
	uint256 public TOKEN_PER_WALLET = 2;
	uint256 public PRICE = 2 ether;
	uint256 public constant TIME_FOR_GROWN = 1689344957775;
	...
	string private _name = "cvb";
	string private _symbol = "VCB";
