...
import "../utils/draft-ERC1155VotesUpgradeable.sol";
import "hardhat/console.sol";

/// @custom:security-contact [email protected]
contract BridgesNFT is
    Initializable,
    ERC1155Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function _afterTokenTransfer(
        ...
        uint256[] memory amounts,
        bytes memory data
    ) internal override(ERC1155Upgradeable, ERC1155VotesUpgradeable) {
 ...
 */
abstract contract ERC1155VotesUpgradeable is
    Initializable,
    ERC1155Upgradeable,
    VotesUpgradeable
{
    function __ERC1155Votes_init() internal onlyInitializing {}

    function __ERC1155Votes_init_unchained() internal onlyInitializing {}
    ...
    function _getVotingUnits(address account, uint256 id)
        internal
        view
        virtual
        override
    ...
    EIP712Upgradeable
{
     ...
     */
    function _getVotingUnits(address, uint256)
        internal
        view
        virtual
        returns (uint256);
