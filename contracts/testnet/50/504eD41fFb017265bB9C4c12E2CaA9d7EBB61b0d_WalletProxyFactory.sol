...
interface IWallet {
    function initWallet(address owner, uint256 _dailyWithdrawLimit) external;
}
...
contract WalletProxyFactory {
    ...
    /// @param _dailyWithdrawLimit Daily withdrawal limit of wallet
    ...
    function createWallet(
        ...
        IWallet(addr).initWallet(msg.sender, _dailyWithdrawLimit);
