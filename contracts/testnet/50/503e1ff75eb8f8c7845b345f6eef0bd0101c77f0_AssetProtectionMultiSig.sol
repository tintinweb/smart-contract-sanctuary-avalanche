...
contract AssetProtectionMultiSig is AssetProtectionMultiSigInterface {
        ...
        onlyGreaterThanZero(expiration_)
    {
        ...
        // add proposal
        _minSingatureProposal[_assetProtectionProposalIndex] = MinSignatureProposal({
            ID: _assetProtectionProposalIndex,
        ...
        // approve the proposal by admin sender
        _minSignatureApprovers[_assetProtectionProposalIndex][msg.sender] = true;
        ...
        if (_assetProtectionSignatories.length == 1) {
            ...
            // update is EXECUTED
            _minSingatureProposal[_assetProtectionProposalIndex].ISEXECUTED = true;
        ...
        onlyValidAssetProtectionIndex(assetProtectionProposalIndex_)
    {
        ...
        require(
            !(proposal.ISEXECUTED ||
                proposal.EXPIRATION > block.timestamp ||
                proposal.ISREVOKED ||
                _minSignatureApprovers[assetProtectionProposalIndex_][msg.sender]),
        ...
        _minSignatureApprovers[assetProtectionProposalIndex_][msg.sender] = true;
    ...
    function getMinSignatureProposalDetail(uint256 assetProtectionProposalIndex_)
        public
        view
