...
// File: Nobellium Source/Nobellium.sol
...
/* 
Discord: https://discord.com/invite/K7qzYs8swc
Twitter: https://twitter.com/NobeliumNodes
Website: https://nobelium.finance/
WhitePaper: https://nobeliumdao.gitbook.io/nobeliumdao/ 
*/
...
contract Nobelium is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
	...
	address public stakingPool = 0xC41c5F4293F3aac6041FDc2E6fef447324E5a07A;
    ...
    constructor(
    ...
    ) ERC20("Nobelium", "NOBEL") PaymentSplitter(payees, shares) {
        ...
        require(totalSupply() == 121500e18, "CONSTR: totalSupply must equal 20 million");
    ...
    function changeRewardsPerClaim(uint256 newPrice) public onlyOwner {
        nodeRewardManagement._changeRewardsPerClaim(newPrice);
    }

    function getRewardsPerClaim() public view returns (uint256) {
        return nodeRewardManagement.rewardsPerClaim();
    }
