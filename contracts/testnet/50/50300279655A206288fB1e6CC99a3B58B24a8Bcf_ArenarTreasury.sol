...
import "../interfaces/IArenarStaking.sol";

/*  ArenarTreasury.sol ============================================
    The contract is to store the reserve of Arenar Protocol
...
==================================================================== */
contract ArenarTreasury is Ownable {
    using SafeERC20 for IERC20;
    using Address for address;

    mapping(address => bool) public strategies;
    address[] public strategiesArray;
    IArenarStaking public staking;

    constructor(IArenarStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of ArenarTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the ArenarTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "ArenarTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "ArenarTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "ArenarTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "ArenarTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "ArenarTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "ArenarTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "ArenarTreasury::allocateFee: invalid amount");
