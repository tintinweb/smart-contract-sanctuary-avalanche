    ...
    ReentrancyGuard
{
    ...
    uint256 public constant aSHRIMPS = 222; // Amount of Shrimps
    ...
    modifier saleIsOpen() {
        require(_totalSupply() <= aSHRIMPS, "All Minted");
        if (_msgSender() != owner()) {
    ...
    function withdrawShrimpsBusiness() public payable nonReentrant {
