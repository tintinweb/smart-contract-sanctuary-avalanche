...
//        ILBRouter lbr = ILBRouter(lbRouter);
//        lbr.swapTokensForExactTokens()
    }

//Function: swapNATIVEForExactTokens(uint256, (uint256[],uint8[],address[]), address, uint256)
//#	Name	Type	Data
//1	amountOut	uint256	100000
//1	path.pairBinSteps	uint256	25,0
//1	path.versions	uint8[]	2,0
//1	path.tokenPath	address[]	0xd00ae08403B9bbb9124bB305C09058E32C39A48c,0xB6076C93701D6a07266c31066B298AeC6dd65c2d,0xAb231A5744C8E6c45481754928cCfFFFD4aa0732
//3	to	address	0x3c3061BcAa68F4263Ee297ba0AA1707eeF258Ca5
//4	deadline	uint256	1686821992
...
//        uint256 deadline
        ...
        ILBRouter lbr = ILBRouter(lbRouter);
        lbr.swapNATIVEForExactTokens(amountOut,path,to,block.timestamp + 100);
    }

    uint256 public myNumber;

    function setNumber(uint newValue) public returns (uint256) {
        myNumber = newValue;
        return myNumber;
    }
...
--etherscan-api-key 9PQXT9PPNZ36Z1ZX2U9UCHPPI7K1HD1FUK \
 --constructor-args "0xb4315e873dBcf96Ffd0acd8EA43f689D8c20fB30"
