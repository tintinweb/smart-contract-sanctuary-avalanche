...
contract BSCBlockUpdater is Initializable, OwnableUpgradeable, Merkle {
    ...
    function importNextValidatorSet(
        ...
        if (genesisBlockNumber != 0) {
            require(parsedInput.preValidatorSetHash == validatorSetHash[epoch--], "importNextValidatorSet:invalid preValidatorSetHash");
        }
    ...
    function importBlock(
        ...
        require(genesisBlockNumber != 0, "importBlock:uninitialized");
        ParsedInput memory parsedInput = _parseInput(inputs);
        uint256 epoch = parsedInput.lastBlockNumber / 200;
        require(parsedInput.preValidatorSetHash == validatorSetHash[epoch--], "importBlock:invalid preValidatorSetHash");
