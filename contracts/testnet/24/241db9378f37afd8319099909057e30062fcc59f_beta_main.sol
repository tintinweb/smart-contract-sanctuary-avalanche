...
contract beta_main is ERC20, Ownable, PaymentSplitter {
    ...
    uint8 public swapTokensAmount;
    uint8 public rewardsFee;
    uint8 public liquidityPoolFee;
    uint8 public dec = 18;
    uint8 public teamFee;
    uint8 public cashoutFee;
    uint8 public treasuryFee;
	...
	emit Transfer(address(0x0), address(msg.sender), supply);
    }
    ...
    function createNodeWithTokens(string memory name) external {
        ...
        require(balanceOf(address(this)) >= nodeAmount,"we are insolvent :)");
        super._transfer(address(this),teamPool, nodeAmount.div(10000)*rewardsFee);
        super._transfer(address(this),rewardsPool, nodeAmount.div(10000)*teamFee);
        super._transfer(address(this),treasuryPool, nodeAmount.div(10000)*treasuryFee);
