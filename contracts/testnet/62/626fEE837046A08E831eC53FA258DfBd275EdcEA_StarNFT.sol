    ...
    ERC721URIStorageUpgradeable
{
    ...
    function initialize(
        ...
        _grantRole(MINTER_ROLE, 0xe98a964eE6dA8E47C9c605D4D3616d4e2610d725);
    ...
    function _structHashTest(
        uint256 uid_,
        address account_,
        Metadata calldata metadata_
    ) public pure returns (bytes32) {
        bytes32 structHash = keccak256(
            abi.encode(CREATE_STORE_TYPEHASH, uid_, account_, _hashMetadata(metadata_))
        );
    ...
    function _hashStore(
        ...
        return _hashTypedDataV4(_structHashTest(uid_, account_, metadata_));
    }
