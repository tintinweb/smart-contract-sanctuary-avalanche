 ...
 */ 
 contract VaultChecker {
  ...
  uint256 actSupply;
  uint256 ratePreDep;
  uint256 totPreCollVault;
  uint256 totPreCollPos;
  uint256 numTokensPre;
  uint256 utilizationPre;
  uint256 coveragePre;
  uint256 lpTokenOut;
  uint256 ratePostDep;
  uint256 totPostCollPost;
  uint256 totDepCollPost;
  uint256 totPostCollPos;
  uint256 numTokensPost;
  uint256 utilizationPost;
  uint256 coveragePost;
  uint256 ratePostUpdtDep;
  uint256 totPostUpdtCollPost;
  uint256 totDepPostUpdtCollPost;
  uint256 totPostUpdtCollPos;
