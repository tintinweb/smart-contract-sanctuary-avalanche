...
contract YakAdapter is AdapterBase, Basic {
    ...
    constructor(address _adapterManager) AdapterBase(_adapterManager, "Yak") {}
...
interface IYakRouter {
    ...
    function TRUSTED_TOKENS(uint256) external view returns (address);
    ...
    function findBestPath(
        ...
        address _tokenOut,
        uint256 _maxSteps
    ) external view returns (FormattedOffer calldata);
    ...
    function findBestPathWithGas(
        ...
        uint256 _maxSteps,
        uint256 _gasPrice
    ) external view returns (FormattedOfferWithGas calldata);
    ...
    ) external view returns (Query calldata);
