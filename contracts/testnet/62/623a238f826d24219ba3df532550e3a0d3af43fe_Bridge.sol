...
contract Bridge {
    ...
    function addSupportedToken(string memory _name, string memory _symbol, address _tokenAddress) public onlyOwner {
    ...
    function deposit(uint256 _amount,uint _tokenID) public payable {
