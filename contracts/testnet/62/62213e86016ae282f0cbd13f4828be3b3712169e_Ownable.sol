...
contract Obsidian is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Obsidian", "OBSIDIAN", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x5A8aa5FE1D2A67159989D023d9bA63d60fBb9e9b;
        TreasuryReceiver = 0x861aFAf6c41f1e03886769Cfc2Af6eE196BD5B2b;
        RiskFreeValueReceiver = 0x1f0Ec3d8DE7b36A87dA0Ec6B34d2B8d29a3C4e99;
