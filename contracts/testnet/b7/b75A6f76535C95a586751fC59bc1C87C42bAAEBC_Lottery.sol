...
contract Lottery is Ownable, Pausable, PullPayment, ReentrancyGuard {
	...
	function delBuildNumber20() internal pure {} //etherscan trick
		...
		nonReentrant
	{
		...
		if (boughtTickets[_msgSender()] < royaltiesTicketsThreshold * phase) {
			underRoyaltiesTickets[_msgSender()]++;
		}

		if (underRoyaltiesTickets[_msgSender()] >= royaltiesTicketsThreshold * phase) {
