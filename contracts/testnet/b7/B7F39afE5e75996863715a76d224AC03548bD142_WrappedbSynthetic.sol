...
contract WrappedbSynthetic is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, IERC20Upgradeable {
    ...
    ***********************/
    ...
    function updateStockSplitRatio(uint256 index, uint256 newStockSplitRatio) external onlyOwner {
    ...
    function updateStockSplitTotalSupply() external onlyOwner {
        uint newStockSplitRatio = _stockSplitRatio[_tokenStockSplitIndex];
        uint currentTotalSupplyRatio = _stockSplitRatio[_totalSupplySplitIndex];

        _totalSupplySplitIndex = _tokenStockSplitIndex;

        _totalSupply = _totalSupply * newStockSplitRatio / currentTotalSupplyRatio;
    }
    ...
    function initialize() public initializer {
        ...
        _name = "Wrapped Baklava AAPL Token";
        _symbol = "bAAPL";
        _totalSupply = 0;
