...
contract UniswapRepayAdapter is BaseUniswapAdapter {
  ...
  function swapAndRepay(
    ...
    LENDING_POOL.repay_v2(debtAsset, amountToRepay, debtRateMode, msg.sender, 0, address(0));
  }
  ...
  function _swapAndRepay(
    ...
    LENDING_POOL.repay_v2(debtAsset, amount, rateMode, initiator, 0, address(0));
...
contract WETHGateway is IWETHGateway, Ownable {
  ...
  function repayETH(
    ...
    ILendingPool(lendingPool).repay_v2(address(WETH), msg.value, rateMode, onBehalfOf, 0, address(0));
...
contract LendingPool is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  function _executeBorrowV2(ExecuteBorrowParamsV2 memory vars) internal {
    ...
    if (vars._dstChainId == layerZeroMessenger.getRootChainId()) {
  ...
  function isRootChain() external view override returns (bool) {
    return _isRootChain;
  }
  ...
  struct ExecuteBorrowParamsAnotherChain {
    address asset;
    address user;
    address onBehalfOf;
    uint256 amount;
