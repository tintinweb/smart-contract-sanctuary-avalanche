...
contract BridgesOfFate is Ownable {
    ...
    event Comment4(uint256 _rcomment4);
        ...
        if(OverFlowPlayerStatus[playerId] == true){
            if(_currentUserStage  > 0){
                ...
                if(totalNFTOnTile[_currentUserStage - 1][previousJumpSide] > 0){
                    ...
                    playerIndex = generateRandomTicketNumbers(SelectUnholdPlayerId.length - 1,SelectUnholdPlayerId.length - 1,totalNFTOnTile[_currentUserStage - 1][previousJumpSide]);
                ...
                //     if(playerIndex[i] > 0){
                //         OverFlowPlayerStatus[SelectPlayerId[playerIndex[i]]] =  true;
                //     }else{
