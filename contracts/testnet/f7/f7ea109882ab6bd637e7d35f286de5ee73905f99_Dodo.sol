...
import {ERC721Enumerable} from "../lib/openzeppelin-contracts.git/contracts/token/ERC721/extensions/ERC721Enumerable.sol";
import "../lib/openzeppelin-contracts.git//contracts/access/Ownable.sol";
import "../lib/openzeppelin-contracts.git/contracts/utils/structs/EnumerableSet.sol";



contract Dodo is Ownable, ERC721Enumerable {
    string public baseURI;
    uint256 public nextTokenID;
    uint256 public MAX_MINT_PER_ADDRESS = 10000;
    ...
    function mint(address _receiver, uint256 mintNumber) external payable {
        ...
        if (msg.value < MINT_PRICE * mintNumber)
    ...
    function withdraw() external onlyOwner {
        (bool sent, ) = payable(owner()).call{value: address(this).balance}(abi.encode("AMMMCIKKKKK"));
