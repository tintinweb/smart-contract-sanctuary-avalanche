...
contract CUMZcontract is ERC721URIStorage, Ownable, ERC2981 {
  ...
  address royaltyPayout = 0xC546D837d53Fd5FBd901E767dBE10D141EC030C3;

  constructor() ERC721("Bottle of CumZ", "CUMZ") {
  ...
  /*function mintOwnerQuantity(uint256 quantity) public payable onlyOwner {
    require(msg.value >= (_price * quantity), "Not enough AVAX sent.");
   ...
   function minttoOtherQuantity(uint256 quantity, address recipient) public payable onlyOwner {
    require(msg.value >= (_price * quantity), "Not enough AVAX sent.");
