...
contract SalvorOperator is ERC721HolderUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    event BreedMini(uint256 indexed miniTokenId, uint256 indexed tokenId, uint256 rarityLevel, uint96 rate, bool isMinted);
    ...
    */
    ...
    function stakeSalvorForBreeding(uint256[] calldata _tokenIds) nonReentrant external payable {
    ...
    function receiveBreedingResult(uint256[] calldata _tokenIds) nonReentrant external {
    ...
    function rebreed(uint256[] calldata _tokenIds) nonReentrant external payable {
        uint256 len = _tokenIds.length;
        uint256 counter;
        uint256 requestId = ++requestIds;
        emit RndRequest(requestId, len);
    ...
    function upgradeSalvor(uint256 _tokenId, uint32 amount) nonReentrant external payable {
