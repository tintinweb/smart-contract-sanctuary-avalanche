...
contract amiciziaRituale is IERC721Receiver, Ownable {
    ...
    function setRareRewardWallet(address _address) public onlyOwner {
        rareRewardWallet = _address;
    }

    function setSuperRareRewardWallet(address _address) public onlyOwner {
        superRareRewardWallet = _address;
    }

    function setSpecialAndLegendaryRewardWallet(address _address) public onlyOwner {
        specialAndLegendaryRewardWallet = _address;
    }

    function setRareRitualisticInitialCount(uint256 _value) public onlyOwner {
        rareRitualisticCount = _value;
    }

    function setSuperRareRitualisticInitialCount(uint256 _value) public onlyOwner {
        superRareRitualisticCount = _value;
    }

    function setSpecialAndLegendaryRitualisticInitialCount(uint256 _value) public onlyOwner {
        specialAndLegendaryRitualisticCount = _value;
    }
