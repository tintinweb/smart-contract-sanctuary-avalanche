...
interface ILMS{
    function equilibre() external;
    function isEquilibrating() external view returns(bool);
}
...
contract OIL is ERC20Upgradeable, PetroAccessControl{
    ...
    address public uniswapV2Router;// = address(0x688d21b0B8Dc35971AF58cFF1F7Bf65639937860);
    address public uniswapV2Factory;// = address(0x2a496ec9e9bE22e66C61d4Eb9d316beaEE31A77b);
    address public WAVAX;
    address public LMSaddress;
     //= address(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
    function initialize() initializer public {
        __ERC20_init("OIL", "OIL");
        __PetroAccessControl_init();
        _mint(msg.sender, 42_000_000 * 1 ether);
        
        uniswapV2Router = address(0x688d21b0B8Dc35971AF58cFF1F7Bf65639937860);
        uniswapV2Factory = address(0x2a496ec9e9bE22e66C61d4Eb9d316beaEE31A77b);
        WAVAX = address(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Factory).createPair(address(this),WAVAX);
        stableStarted = false;
    }
    bool public stableStarted;
    ...
    function _transfer(address from,address to,uint256 amount) internal override {
        ...
        if(!ILMS(LMSaddress).isEquilibrating() && from != LMSaddress && stableStarted && (from == uniswapV2Pair || to == uniswapV2Pair)){
            ILMS(LMSaddress).equilibre();
        }
    }
    ...
    function burn(address _account, uint256 _amount) public onlyRole(REWARD_MANAGER_ROLE) {
    ...
    function setLMS(address _lms) public onlyRole(DEFAULT_ADMIN_ROLE){
        LMSaddress = _lms;
    }
    function openStable(bool _value) public {
        stableStarted = _value;
    }
}
...
contract PetroAccessControl is Initializable, AccessControlUpgradeable {
