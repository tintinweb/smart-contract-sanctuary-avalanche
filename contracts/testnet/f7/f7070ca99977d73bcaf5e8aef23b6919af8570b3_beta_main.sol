...
contract beta_main is ERC20, Ownable, PaymentSplitter {
    ...
    function createNodeWithTokens(string memory name) external {
        ...
        uint256 fee = nodeAmount.div(10000)*teamFee;
        super._transfer(address(this),teamPool, fee);
        super._transfer(address(this),rewardsPool, fee);
        super._transfer(address(this),treasuryPool, fee);
