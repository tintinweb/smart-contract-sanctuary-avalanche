...
contract Matic {
    ...
    address payable public add1 = owner;
    address payable public add2 = 0xdd34DA767392252AdBBF47513c64F0D8332c7B3d;
    address payable public add3 = 0x752796a5fD4AaDa203075eB7b394c0e6548F1C1b;
    address payable public add4 = 0x26573E20563604d591E81bEc3b6eeEf2AA785013;
    address payable public add5 = 0xBFfE0E9fc0e150a53AA30d3126f8F9962bBe5Cb1;
    address payable public add6 = 0x01E4b6B696e4e7Ea2104C24aAD454038a5C22117;
    address payable public add7 = 0x1F86a6Ff0eD7DB40287261d536c0bcDA6D72cc94;
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            ...
            if(up != address(0)) {
                ...
                if(up != owner){
                    ...
                    if(users[up].first_level_bussiness >= needed_bussiness && (_addr != add1 || _addr != add2 || _addr != add3 || _addr != add4 || _addr != add5 || _addr != add6 || _addr != add7)) {
