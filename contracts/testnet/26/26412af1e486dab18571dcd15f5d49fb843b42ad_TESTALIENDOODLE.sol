    ...
    ClampedRandomizer
{
    ...
    address  public royaltyAddress = 0xc8d9e35311d1E64C4A20172710a66e1b5d2dc527;
    ...
    uint256 public maxPerPerson = 444;
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Test AlienDoodle", "TAD") ClampedRandomizer(maxSupply) {     
