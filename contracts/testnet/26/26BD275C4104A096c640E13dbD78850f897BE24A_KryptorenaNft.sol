...
contract Kryptorena is VRFConsumerBaseV2, ConfirmedOwner {
    ...
    function triggerBattle() public {
        address p1H = 0x70997970C51812dc3A010C7d01b50e0d17dc79C8;
        address p2H = 0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC;
        uint256 p1A = 3;
        uint256 p1D = 4;
        uint256 p2A = 2;
        uint256 p2D = 3;
        initiateBattle(p1H, p2H, p1A, p1D, p2A, p2D);
    }

    KryptorenaBattle i_kryptorenaBattle;
    ...
    function initiateBattle(
        ...
        i_kryptorenaBattle.initiateBattle(p1, p2, p1a, p1d, p2a, p2d);
    }
