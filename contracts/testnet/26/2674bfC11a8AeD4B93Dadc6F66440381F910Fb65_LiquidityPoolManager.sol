...
import "../implementations/output/AviatorsImplementationPointer.sol";

contract LiquidityPoolManager is
    Ownable,
    OwnerRecovery,
    AviatorsImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x36f8AA0E708B9668115762D9D1450Cfd835454e7), // Treasury investments (30%)
        address(0x03D26F8713804a806e56e94595Aa019bF347406E), // Dev (30%)
        address(0x10AfC6fDDa9F5A1a4f1E5d9CDE6be66dDe4EB8AF), // Marketing (30%)
        address(0x96f69C4bF755146b4f82bdeE31cE0A35646778f2) // Donations (10%)
    ];
    ...
    constructor(
        ...
        changeAviatorsImplementation(address(leftSide));
...
abstract contract AviatorsImplementationPointer is Ownable {
