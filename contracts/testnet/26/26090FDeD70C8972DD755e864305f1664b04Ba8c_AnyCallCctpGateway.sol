    ...
    IVault
{
    ...
    function sendMessage(
        ...
        TransferHelper.safeApprove(asset, cctpTokenMessenger, amount);
        ...
        TransferHelper.safeApprove(asset, cctpTokenMessenger, 0);
    ...
    function anyExecute(
        ...
        (bytes memory _calldata, , bytes memory _message, bytes memory _attestation) = abi.decode(
            _data,
