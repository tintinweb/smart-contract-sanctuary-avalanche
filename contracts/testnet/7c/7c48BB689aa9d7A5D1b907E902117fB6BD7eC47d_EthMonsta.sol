    ...
    ReentrancyGuardUpgradeable
{
    ...
    address private _pair; // Address of the token pair on Uniswap
    address private _weth; // Wrapped Ether address

    bool private _inSwapAndLiquify;
    bool public tradingEnabled;

    uint256 private _accumulatedFees; // Accumulated fees
    ...
    function setPair(
        ...
        if (pairAddress == _pair) revert SamePairAddress();
        require(
            IUniswapV2Pair(pairAddress).totalSupply() > 0,
            "Invalid pair contract"
        );
        _pair = pairAddress;
    }
