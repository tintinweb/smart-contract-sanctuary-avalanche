    ...
    IBaseInstaller
{
        ...
        returns (Environment memory env, uint256 environmentId)
    {
        ...
        env = Environment({instances: new uint256[](0), environmentName: name});
    ...
    function _createInstance(
        ...
        EnvInstanceType memory instanceType,
...
interface IGameFiInstallerV1 is IBaseInstaller {
    struct InstallerV1Settings {
        ...
        bytes[] createPropertyData;
        bytes[] createCollectionData;
        // shops
...
interface IEnvTypes {
    ...
    // 1 - GAMEFI_CORE,
    // 2 - GAMEFI_SHOPS,
    // 3 - GAMEFI_MARKETPLACE,
    // 4 - GAMEFI_ROUTER
    struct EnvInstanceType {
        uint256 typeId;
    }
