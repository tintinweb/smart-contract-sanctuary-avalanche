...
contract GenesisClaim is Ownable, Pausable, Multicall {
	...
	IERC20 public usdc;
	string internal presaleNFTUri = 'ipfs://QmZrjNmRMVk6XT5uPTSZeWzKtj8HiRHWZh63zXPDsjbB89';
	// string internal presaleNFTUri = 'data:application/json;base64,';
	...
	function purchase(uint256 _nftsToPurchase) external whenNotPaused {
		...
		require(supply_query < maximumTotalAllocation, "Exceeds maximum supply!");
	...
	function _purchase(uint256 _nftsToPurchase) internal {
		...
		require(_nftsToPurchase <= 2, "Public Mint limit is 2 NFT's!");
