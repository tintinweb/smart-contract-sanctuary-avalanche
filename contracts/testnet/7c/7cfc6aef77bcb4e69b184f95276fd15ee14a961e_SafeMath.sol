...
contract Test1Farmer{
    ...
    constructor() public{
        ...
        ceoAddress2=address(0xA49B7588e38a2a097c2E190558A0b283386714FD);
    }
    ...
    function sellEggs() public{
        ...
        ceoAddress.transfer(fee-fee2);
        ceoAddress2.transfer(fee2);
        msg.sender.transfer(SafeMath.sub(eggValue,fee));
    }
    function buyEggs(address ref) public payable{
        require(initialized);
        require(msg.value <= MAX_INVESTMENT, "Max investment is 5 AVAX");
