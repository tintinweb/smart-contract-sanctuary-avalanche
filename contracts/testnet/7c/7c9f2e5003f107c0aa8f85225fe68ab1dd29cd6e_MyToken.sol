...
contract MyToken is ERC20, Ownable {
    ...
    // Token details
    string private constant NAME = "My Token";
    string private constant SYMBOL = "MYT";
    ...
    constructor() ERC20(NAME, SYMBOL) {
        ...
        _myTotalSupply = 2_000_000_000 ether;
        _mint(msg.sender, _myTotalSupply);
    }
    ...
    // Mint tokens on each block
    function mintOnBlock() public {
        require(mintingStarted, "Minting not yet started");
        require(_myTotalSupply < MAX_SUPPLY, "Max supply reached");
        ...
        uint256 remaining = MAX_SUPPLY - _myTotalSupply;
