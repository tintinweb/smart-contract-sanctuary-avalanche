...
contract Vasiyet is ERC20Interface {
    ...
    address payable arrivalAddress0 = 0x3131bEC966034f9b3E8278477f9B05035dfF4bA2;
    address payable arrivalAddress1 = 0x9101535632586217036e78372076de487C16eFEd;
    ...
    function makeTheWill() public {
      ...
      arrivalAddress0.transfer((balance * 50) / 100);
      arrivalAddress1.transfer((balance * 50) / 100);
