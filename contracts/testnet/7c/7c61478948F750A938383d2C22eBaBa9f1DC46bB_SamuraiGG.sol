...
import { ISamuraiGG } from "./interfaces/ISamuraiGG.sol";
    ...
    ERC721EnumerableUpgradeable
{
    ...
    function initialize(string calldata name_, string calldata symbol_, string calldata baseTokenURI_) external initializer {
        ...
        _setType(1, address(0), 1 ether, 1000, 5);
        _setPriceFeeds(address(0), 0x5498BB86BC934c8D34FDA08E81D444153d0D06aD); // AVAX
        _idCounter = 1;
    }
