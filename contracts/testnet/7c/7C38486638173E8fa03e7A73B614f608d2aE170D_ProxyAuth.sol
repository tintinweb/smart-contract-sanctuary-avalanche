...
import "../../interfaces/IVortexRegistry.sol";
import "../../interfaces/IVortexProxy.sol";
...
contract ProxyAuth is AdminAuth, CoreHelper {
    IVortexRegistry public constant registry = IVortexRegistry(REGISTRY_ADDR);
    ...
    function callExecute(
        ...
        IVortexProxy(_proxyAddr).execute{value: msg.value}(_contractAddr, _callData);
    }
}
...
abstract contract IVortexRegistry {
...
abstract contract IVortexProxy {
