...
// OpenZeppelin Contracts v4.4.1 (security/ReentrancyGuard.sol)
    ...
    function destroyPrivateSale(uint256 amount) external;
    function privateSaleSupply() external view returns (uint256);
...
contract PrometaVPrivateSale is ReentrancyGuard, Ownable {
    ...
    /* EXTERNAL OR PUBLIC */
        ...
        // allowance
        function approve(address spender, uint256 amount) external {
            prometaV.approve(spender, amount);
        }
        ...
        function claim() external payable {
            ...
            prometaV.transferFrom(address(this), msg.sender, _toClaim[msg.sender]);
