...
// ----------------- Role Checks -------------------- //
    ...
    modifier onlyOwnerAdminOrOperatorOrRedemptionAgent() {
        require(hasRole(OWNER_ROLE, msg.sender) || hasRole(ADMIN_ROLE, msg.sender) || hasRole(OPERATOR_ROLE, msg.sender)|| hasRole(REDEMPTION_AGENT_ROLE, msg.sender), "Unauthorized");
        _;
    }
...
// ----------------- Constructor -------------------- //
    ...
    function updateTokenURI(string memory _newURI) external onlyOwnerAdminOrOperatorOrRedemptionAgent {
