...
contract UpkeepIDConsumerExample {
  ...
  mapping (address => uint256) public registeredId;
  ...
  function registerAndPredictID(
    ...
    i_link.transferAndCall(registrar, 0.1 ether, bytes.concat(registerSig, payload));
    ...
    if (newNonce == oldNonce + 1) {
      ...
      registeredId[address(this)] = upkeepID;
    } else {
