...
contract BavaConvertLPToUSDC is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    struct LPTokenInfo {
        ...
        uint256 routerType;                                 // 0/1, 0 = Pangolin/TreaderJoe, 1 = KyberDMM 
    }

    event LiquidateLP(IPair indexed lpToken, address indexed account, uint256 lpAmount, uint256 USDAmount);
    ...
    function addLPToken(IPair _lpToken , IRouter _router, uint256 _routerType) external onlyOwner {        
