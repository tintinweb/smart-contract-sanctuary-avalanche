...
contract CrossVault is AccessControl, ReentrancyGuard {
    ...
    function dispatchCall(
        ...
        IERC20(FUJI_WETH).transferFrom(msg.sender, address(this), weth_to_be_paid);
        ...
        //     data
        // );
        (bool result, ) = GOERLI_INBOX.delegatecall(abi.encodeWithSignature("dispatch(uint32,bytes32,bytes)",
        GOERLI_DOMAIN,
        addressToBytes32(GOERLI_CONTROLLER_ADDRESS),
        data));
        require(result, "delegateCall fail");
        return true;
    }
}
