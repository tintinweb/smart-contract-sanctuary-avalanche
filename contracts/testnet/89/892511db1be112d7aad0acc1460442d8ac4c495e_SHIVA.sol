/**
 *Submitted for verification at testnet.snowtrace.io on 2022-12-23
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x668105c1605B4bc423eabF353B5eC020fBfCE298;
...
contract SHIVA is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x06E4C4836781303A66e58aC1bE8578b6c01fc9Da;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000000 * 10**9; //Total supply
    ...
    uint256 private numTokensSellToAddToLiquidity = 0 * 10**9; //Fee threshold for LP acquisition
    ...
    constructor () {
        ...
        // TradeJoe 0x60aE616a2155Ee3d9A68541Ba4544862310933d4
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x688d21b0B8Dc35971AF58cFF1F7Bf65639937860, 'We can not exclude Uniswap router.');
