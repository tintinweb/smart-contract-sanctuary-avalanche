...
// File: contracts/gladiator.sol
    ...
    contract Gladiator is ERC721, Ownable, ERC721Enumerable {
      ...
      string public baseURI = ""; // IPFS URI WILL BE SET SOLD OUT
      ...
      event GladiatorMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Gladiator", "GLD") {}
      ...
      function mintGladiator(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit GladiatorMinted(id, msg.sender);
          }
        }
      }
    
      function presaleGladiator(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmbutonYgd3Jec43jdG6CuCvDNW2zMSCCznGrk9vekC4sF/hidden.json";
        }
