...
contract GAMENFT is ERC721, Ownable {
    ...
    string public GAME_PROVENANCE = ""; // IPFS PROVENANCE TO BE ADDED WHEN SOLD OUT
    ...
    uint256 public nftReserve = 0; // Reserve 0 NFTs for team & community (Used in giveaways,nts etc...)
