...
interface IPantokenStableSwapDeployer {
...
interface IPantokenStableSwapLPFactory {
...
import "./interfaces/IPantokenStableSwap.sol";
import "./interfaces/IPantokenStableSwapLP.sol";
import "./interfaces/IPantokenStableSwapDeployer.sol";
import "./interfaces/IPantokenStableSwapLPFactory.sol";

contract PantokenStableSwapFactory is Ownable {
    ...
    IPantokenStableSwapLPFactory public immutable LPFactory;
    IPantokenStableSwapDeployer public immutable SwapTwoPoolDeployer;
    IPantokenStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        IPantokenStableSwapLPFactory _LPFactory,
        IPantokenStableSwapDeployer _SwapTwoPoolDeployer,
        IPantokenStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        IPantokenStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        IPantokenStableSwap swap = IPantokenStableSwap(_swapContract);
