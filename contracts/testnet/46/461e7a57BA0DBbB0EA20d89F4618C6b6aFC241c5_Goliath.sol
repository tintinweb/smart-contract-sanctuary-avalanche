...
contract Goliath is ERC20, Ownable {
    ...
    constructor() ERC20("Goliath", "Goliath") {
        ...
        marketingWallet = address(0xA0378e0b7d37B38043205b7139dBec6632351133); // set as marketing wallet
        devWallet = address(0xF38cbABE5a1ef0cFc72770BDCf4FFbD439C738Be); // set as dev wallet
        treasuryWallet = address(0x89501941D70c99988EAAbff3ACA524e370b4945b);
    ...
    function swapBack() private {
        ...
        uint256 ethForTreasury = ethBalance.mul(tokenForTreasury).div(
            totalTokensToSwap
        );
