...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;
...
contract MTTv2 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9; //Total supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "MTTv2";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xd7f655E3376cE2D7A2b08fF01Eb3B1023191A901);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x9086446fea5b06F5365Ba720F9E7DB4196eED6Fa, 'We can not exclude Uniswap router.');
