...
contract MVS1 is ERC721URIStorage, OperatorFilterer, ERC2981, Ownable {
  using Address for address;
  using Strings for uint256;
  using Counters for Counters.Counter;

  string private _myBaseURI = "ipfs://my_base_uri/";
  ...
  constructor() ERC721("Moth Valley S1 Gallery", "MVS1") {
    _registerForOperatorFiltering();
    _setDefaultRoyalty(0x90cBfc638B991fb240C687Cab76806439D2730D0, 200);
    operatorFilteringEnabled = true;
    _suitsContract = Suits(0xD98CD9DF4524BB0Ab71deA604F8Dc55110785c09); //TODO: change me!
  }
  ...
  function get(uint256 tokenA, uint256 tokenB) external {
    ...
    if (tokenA == 1 && tokenB == 1) {
      _setTokenURI(newItemId, "1");
    }
    if (tokenA == 1 && tokenB == 14) {
      _setTokenURI(newItemId, "2");
    }
    if (tokenA == 1 && tokenB == 27) {
      _setTokenURI(newItemId, "3");
    }
    if (tokenA == 1 && tokenB == 40) {
      _setTokenURI(newItemId, "4");
    }
  }
