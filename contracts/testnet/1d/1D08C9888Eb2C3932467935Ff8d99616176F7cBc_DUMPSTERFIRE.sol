...
contract DUMPSTERFIRE is ERC721URIStorage, Ownable {
    ...
    uint256 public _royaltyAmount = 5000; //50%
    ...
    constructor(
    ) ERC721("Dumpster Fire", "DUMPSTER") {
        ProceedsWallet = 0x000000000000000000000000000000000000dEaD;
        _customBaseURI = 'ipfs://bafybeifp6rvisp6bcaznuj3uqcc7on67wu3kgn6qgnhnazqkugqeuzcavy/';
        _royaltyAddress = 0x000000000000000000000000000000000000dEaD;
    }
    ...
    function mint(uint256 quantity) public payable {
        ...
        payable(ProceedsWallet).transfer(msg.value);
