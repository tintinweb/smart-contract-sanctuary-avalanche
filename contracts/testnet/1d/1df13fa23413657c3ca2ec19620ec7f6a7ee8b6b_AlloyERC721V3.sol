...
import "./AlloyERC721V2.sol";

contract AlloyERC721V3 is AlloyERC721V2 {
    ...
    //     );
    //     require(
    //         !isUpgradeMintable[_order.upgradeId],
    //         "AlloyERC721: Already minted"
    //     );

    //     tokenCounter += 1;
    //     NFTtypes[tokenCounter] = _order.upgradeType;
    //     isVerified[_signature] = true;
    //     isUpgradeMintable[_order.upgradeId] = true;
    ...
    //         "AlloyERC721: Already sold or minted or OFF"
    //     );
    ...
    function sellConsumable(
        ...
        require(!isConsumableSold[_order.Id], "AlloyERC721: Already sold");

        NiozERC20Address.mint(msg.sender, _order.amount);
        isVerified[_signature] = true;
        isConsumableSold[_order.Id] = true;
     ...
     */
    function burnTokens(uint256[] calldata _tokenIds) external virtual {
    ...
    function updateConstructMapping() external onlyOwner {}
}
...
interface IERC20Upgradeable {
     ...
     * Emits a {Transfer} event.
     */
    function safeTransfer(address _from, address _to, uint256 _amount) external;
    ...
    function isUnProcessedPartSold(
        uint256 _tokenId
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function mintPart(
        ...
        require(
            !NiozERC20Address.isUnProcessedPartSold(_order.partId) &&
                !isPartMintable[_order.partId] && !isProcessedPartMintable[_order.partId],
            "AlloyERC721: Already sold or minted"
        );
        ...
        _safeMint(msg.sender, tokenCounter);
        isVerified[_signature] = true;
        isPartMintable[_order.partId] = true;
    ...
    function processPart(
        ...
        require(
            !NiozERC20Address.isUnProcessedPartSold(_order.partId) &&
                !isProcessedPartMintable[_order.partId],
            "AlloyERC721: Already sold or minted"
        );
        ...
        NFTtypes[tokenCounter] = "PART";
        isVerified[_signature] = true;
        isProcessedPartMintable[_order.partId] = true;
