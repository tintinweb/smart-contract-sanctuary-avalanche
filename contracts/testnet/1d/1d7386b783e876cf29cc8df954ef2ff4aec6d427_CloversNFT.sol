...
contract CloversNFT is ERC721, Ownable {
        ...
        
    {
        ...
        for (uint256 i = 1; i <= _mintAmount; i++) {
            _incrementClovsSupply(_ClovesType);
    ...
    function _incrementClovsSupply (string memory _ClovesType) internal view returns (uint256) {
        ClovesInfo memory cloves = ClovesType[_ClovesType];
        uint256 LastSupply = cloves.supply;
        cloves.supply = LastSupply++;
        return cloves.supply;
    }
