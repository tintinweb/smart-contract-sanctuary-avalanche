...
contract CollateralVaultV2 is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    struct PoolInfo {
        ...
        uint256 liquidationPenalty;         // User's penalty rate for position liquidated(E.g:20%) decimals:1e18
        bool depositEnabled;            
    }
    ...
    *****************************/
    ...
    function setBorrowFees(uint256 _New_DEV_FEE_BIPS)external onlyOwner {
        require(_New_DEV_FEE_BIPS > 0 && _New_DEV_FEE_BIPS <= 10000,"Out of Range");
        DEV_FEE_BIPS = _New_DEV_FEE_BIPS;
        emit SetBorrowFees(msg.sender, _New_DEV_FEE_BIPS);
    }
