...
contract NFTSwapOfferManager {
    ...
    event NFTSwapOfferCancelled(uint256 index, uint256 tokenId, address offeree, uint256[] tokenIds);
    event NFTSwapOfferSettled(uint256 index, uint256 tokenId, address offeree, uint256[] tokenIds, address receiver);
    event NewNFTSwapOffer(uint256 index, uint256 tokenId, address offeree, uint256[] tokenIds, uint256 expiry);
}