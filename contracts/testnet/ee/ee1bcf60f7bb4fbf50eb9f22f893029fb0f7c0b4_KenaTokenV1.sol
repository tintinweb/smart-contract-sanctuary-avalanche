    ...
    OwnableUpgradeable
{
     ...
     * Using a vanity address as against a zero address so that it's easier
     * to recognize the wallet address in transactions.
     ...
     * The number in the last is a Planck's constant. If you know, you know ;)
     */
...
// THIS Contract is a spin-off and modification of CPUCoin, 
// which is a spin-off of mediarichio/ProxyToken
// CPU-coin github here: https://github.com/cpu-coin/CPUcoin  
    ...
    KenaTokenomics
{
    ...
    modifier whenTokenomicsCriteriaMet(
        ...
        require(_isAddressSafe(sender) && recipient != address(0), "Transfer is zero/burn address");
        ...
        if (!isInPresale) {
            if (
                ...
                revert("Tokens > 0.25% of total supply.");
            }
            if (
    ...
    function transferOwnership(address newOwner)
        ...
        onlyManager
    {
        require(_isAddressSafe(newOwner), "Ownable: new owner should not be zero/burn adddress");
...
contract KenaTokenV1 is KenaTokenGrant {
    ...
    function _takeTransactionFees(
        ...
        for (uint256 index = 0; index < feesCount; index++) {
            (FeeType name, uint256 value, address feeRecipient, ) = _getFee(index);
