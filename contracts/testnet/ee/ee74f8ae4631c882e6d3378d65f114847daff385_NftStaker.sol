...
contract NftStaker {
    ...
    constructor() {
        parentNFT = IERC721(0x7E209eCcD0814200D39474B9553e63E5590bBD07); // Change it to your NFT contract addr
    }
    ...
    function onERC721Received(address operator, address from, uint256 id, uint256 value, bytes calldata data) external returns (bytes4) { return
