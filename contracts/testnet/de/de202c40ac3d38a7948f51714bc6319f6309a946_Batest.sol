...
contract Batest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public feeWallet     = 0xAfDb78BB97f363602518424dd116f96A833c856f;
    address public pinkAntiBot_  = 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002;
    address public firstVerifier = 0xAfDb78BB97f363602518424dd116f96A833c856f;
    ...
    constructor() public ERC20("Batest", "ITESTT") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5db0735cf88F85E78ed742215090c465979B5006);
         // Create a uniswap pair for this new token
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), 0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Batest: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Batest: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Batest: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Batest: Automated market maker pair is already set to that value");
