...
contract Presale is Initializable {
    ...
    function initialize(address usdt_addr, address token_addr) public initializer {
        ...
        presalePrice = 1 * 10 ** 16; // presale 0.001 usdt
        paused = false;
    }
    ...
    function Buy(uint256 _amountUsdt) public whenNotPaused {
        ...
        uint256 amount = _amountUsdt.div(presalePrice).mul(1e18);
        require(limit[msg.sender].add(_amountUsdt) <= limitperwallet, "Limit exceeded");
