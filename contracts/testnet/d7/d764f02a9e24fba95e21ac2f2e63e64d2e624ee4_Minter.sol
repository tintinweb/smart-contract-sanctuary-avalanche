...
contract Minter is Ownable {
     ...
     */
    function tokenPriceInUSD(address _token, address _lp, uint256 _amount) public view returns ( uint256  value_) { 
        ...
        value_ = _tokenValueInUSD.mul(_amount).div(10** IERC20(Waceo).decimals());
    }
