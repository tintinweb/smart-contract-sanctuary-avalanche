...
interface IForceNFT {
    ...
    function retrieveStolenNFTs() external returns (uint256[] memory);
}
...
contract ForceNFT is ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    IERC20 public Token = IERC20(0xb6882EDDd548d2b9D356ab234a92351C7C62Bab0);
    ...
    function skip(uint256 _amount) external onlyOwner {
