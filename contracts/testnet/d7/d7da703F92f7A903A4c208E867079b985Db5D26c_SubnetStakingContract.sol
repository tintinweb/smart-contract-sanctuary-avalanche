...
contract SubnetStakingContract is Ownable {
    ...
    constructor(  ) payable {
        ...
        setTestnet(); // REMOVE THIS FOR MAINNET
    }

    function setTestnet() internal {
         MAX_AVAX_POSITION = 20*10**18;
         MIN_AVAX_PURCHASE = 1*10**17;
    ...
    function claimStakeRewards( uint256 _stakenumber ) public returns(uint256){
        ...
        require (  Stakes[_stakenumber]._receivedRewardSync < receivedRewardsCounter , "Already Synced" );
    ...
    function sendAVAXtoValidatorAddress() public onlyOwner{
        ...
        payable(validatorAddress).transfer( MAX_AVAX_POSITION );
    }
