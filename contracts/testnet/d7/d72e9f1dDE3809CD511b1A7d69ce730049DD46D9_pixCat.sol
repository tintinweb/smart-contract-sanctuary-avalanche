...
contract pixCat is ERC721Enumerable, ERC721URIStorage, Ownable, ERC721Burnable, ClampedRandomizer{
  ...
  uint256 private share1;
  uint256 private share2;
  address private royaltyAddress;
  uint256 public wlTime;
  uint256 public publicTime;
  bool public paused;

  constructor() ERC721("PixCat", "PIXCAT") ClampedRandomizer(_maxMintable){
    ...
    maxPerWallet = 555;
    paused = true;
    payoutAddress1 =0x93f54D755A063cE7bB9e6Ac47Eccc8e33411d706;
    payoutAddress2 =0x93f54D755A063cE7bB9e6Ac47Eccc8e33411d706;
    royaltyAddress =0x93f54D755A063cE7bB9e6Ac47Eccc8e33411d706;
    share1 = 20;
    share2 = 80;
    wlTime = 1661342400;
    publicTime = 1661351400;
  }
  ...
  function wlMintsAllowed(address _address) public view returns (uint){
  return whitelistMints[_address];
  }
  function setPayout(address devAddress, address artistAddress, uint256 devShare, uint256 artistShare) public onlyOwner{
    require(devAddress != address(0) && artistAddress != address(0), "address can't be null address");
    require(devShare + artistShare == 100, "shares must add up to 100");
    payoutAddress1 = devAddress;
    payoutAddress2 = artistAddress;
    share1 = devShare;
    share2 = artistShare;
  }
  ...
  function mint(uint256 quantity) public payable {
    ...
    payable(payoutAddress1).transfer(msg.value * share1/100);
    payable(payoutAddress2).transfer(msg.value * share2/100);
