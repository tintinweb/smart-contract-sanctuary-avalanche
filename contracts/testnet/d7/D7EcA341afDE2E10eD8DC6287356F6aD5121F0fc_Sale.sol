...
contract Sale is ReentrancyGuard {
    ...
    function init_sale (
        address _sale_token,
        uint32[] memory _sale_details,
        uint32[] memory _seed_details,
        uint32[] memory _seed_vesting,
        uint32[] memory _presale_details,
        uint32[] memory _presale_vesting,
        uint32[] memory _community_details,
        uint32[] memory _community_vesting,
        uint32[] memory _options
        ) public onlyOwner {
    ...
    function setSaleDetails(uint32 _sale_round, uint32[] memory _sale_input) private {
    ...
    function setSaleVesting(uint32 _sale_round, uint32[] memory _sale_vesting) private {
