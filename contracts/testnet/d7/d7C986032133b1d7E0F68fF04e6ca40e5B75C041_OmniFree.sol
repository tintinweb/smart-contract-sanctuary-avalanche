...
contract OmniFree is Ownable, ERC721A, NonblockingReceiver {
    ...
    uint256 public constant MAX_MINT_AVALANCHE = 20;
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint) ERC721A("OmniFREE", "OF") { 
        _owner = msg.sender;
    ...
    function mint(address _to, uint256 _count) external payable {
        ...
        require(supply + _count <= MAX_MINT_AVALANCHE, "Exceeds maximum supply");
