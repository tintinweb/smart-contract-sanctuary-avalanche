    ...
    ERC20SafeUpgradeable
{
    ...
    function stake(address depositor, address tokenAddress, uint256 amount) external virtual onlyRole(ERC20HANDLER_ROLE) {
    ...
    function unstake(address unstaker, address tokenAddress, uint256 amount) external virtual onlyRole(ERC20HANDLER_ROLE) {
        require(_contractToLP[tokenAddress] != address(0), "LP not created");
    ...
    function _setLiquidityPool(address contractAddress, address lpAddress) external virtual onlyRole(ERC20HANDLER_ROLE) {
