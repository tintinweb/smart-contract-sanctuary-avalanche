...
contract TrantorV2 is ERC20Upgradeable {
    ...
    function initialize(address proxyAddress) public initializer {
        ...
        lpPair = IUniswapV2Factory(_dexRouter.factory()).createPair(address(proxyAddress), _dexRouter.WAVAX());
        lpPairs[lpPair] = true;
