...
contract SDTCollection is ERC721URIStorage, ReentrancyGuard, Ownable {
    ...
    function createInvest(uint _listingID, uint _amount) public nonReentrant {
        ...
        require(IERC20(coinAddress).transferFrom(msg.sender, address(this), _amount * 10 ** 18), "STDCollection: invalid transferFrom");
    ...
    function payInvest(uint _listingID, uint _amount) public nonReentrant {
        ...
        require(SDTToken(currentListing.erc20Address).burn(msg.sender, _amount * 10 ** 18), "STDCollection: invalid burn");
        require(IERC20(coinAddress).transfer(msg.sender, payAmount * 10 ** 18), "STDCollection: invalid transferFrom");
    ...
    function withdrawal(uint _amount) public nonReentrant onlyOwner {
        require(IERC20(coinAddress).transfer(msg.sender, _amount * 10 ** 18), "STDCollection: invalid transferFrom");
