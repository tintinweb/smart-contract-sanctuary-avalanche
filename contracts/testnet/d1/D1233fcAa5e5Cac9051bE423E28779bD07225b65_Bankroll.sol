...
contract Bankroll is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    
     using SafeERC20 for IERC20;

    mapping(address => bool) public isGame; 
    mapping(address => bool) public isTokenAllowed;
    address[] public allowedTokens; //Can be used to iterate through all tokens in bankroll to determine it's value
    ...
    function isPlayerSuspendedInfo(
        ...
        return (isPlayerSuspended[player], suspendedTime[player]);
    }
