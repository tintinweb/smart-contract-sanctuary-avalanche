...
contract Lever is Router {
    ...
    function route(
        ...
        IERC20(_endingTokenAddress).transfer(to, amountOut);
    }
    ...
    function unRoute(
        ...
        IERC20(_endingTokenAddress).transfer(_fromUser, amountOut);
    }
}