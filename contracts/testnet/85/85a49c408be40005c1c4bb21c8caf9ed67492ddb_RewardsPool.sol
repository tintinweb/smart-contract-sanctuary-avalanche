...
/// @title RewardsPool
/// @author mektigboy
/// @notice VPND rewards pool
/// @dev Some functions require automation
contract RewardsPool {
    ...
    function updateVPNDAddress(address _vpnd) external onlyOwner {
        s_vpnd = _vpnd;
    ...
    function balances(uint256 _transactionId) public view returns (uint256) {
    ...
    function gdm() external view returns (address) {
        return s_gdm;
    }
    ...
    /// @notice Transfers tokens to specific address in case of emergency
