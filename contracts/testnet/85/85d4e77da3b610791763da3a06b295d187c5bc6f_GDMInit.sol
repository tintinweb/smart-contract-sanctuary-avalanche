...
contract GDMInit {
    function init() external {
        LDiamond.DiamondStorage storage diamondStroage_ = LDiamond.diamondStorage();
        
        diamondStroage_.supportedInterfaces[type(IERC165).interfaceId] = true;
        diamondStroage_.supportedInterfaces[type(IDiamondCut).interfaceId] = true;
        diamondStroage_.supportedInterfaces[type(IDiamondLoupe).interfaceId] = true;
        diamondStroage_.supportedInterfaces[type(IERC173).interfaceId] = true;
    }
}
