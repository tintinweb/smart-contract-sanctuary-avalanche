...
abstract contract BasicToken is Ownable, ERC20Basic {
    ...
    */
    ...
    function balanceOf(address _owner) virtual override public returns (uint balance) {
...
abstract contract StandardToken is BasicToken, ERC20 {
    ...
    */
    function transferFrom(address _from, address _to, uint _value) virtual override public onlyPayloadSize(3 * 32) {
    ...
    */
    function approve(address _spender, uint _value) virtual override public onlyPayloadSize(2 * 32) {
    ...
    function allowance(address _owner, address _spender) virtual override public returns (uint remaining) {
...
contract TetherToken is Pausable, StandardToken, BlackList {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function balanceOf(address who) override public returns (uint) {
        if (deprecated) {
    ...
    // Forward ERC20 methods to upgraded contract if this one is deprecated
    function allowance(address _owner, address _spender) override public returns (uint remaining) {
        if (deprecated) {
