    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier claimer(address _claimer) {
        if (
            ...
            revert("ERC721 ValiFi: Your are not elegible to claim YieldBoxes");
        }
        _;
    }
    ...
    /**
     * @dev This function allows to set the Token Base URI.
     */
    ...
    /**
     * @dev This function allows to get all prices per Token
    ...
    function _getVaLiFiPriceinStable() public view returns (uint256 price) {
