...
contract TokenFactory {
    ...
    function deployIdentity(address _initialManagementKey, bool _isLibrary) public returns (address _identity) {
        // require(tx.origin == msg.sender,"Only owner can call");
    ...
    function _initProxy(address identityRegistry,string memory _name,string memory _symbol,uint8 _decimals,uint _cap, string memory mappingValue) internal{
        ...
        // require(success,"upgrade failed");
        // success = false;
        (bool success,) = proxy.call(abi.encodeWithSelector(0xd44526bc, identityRegistry, compliance, _name, _symbol, _decimals, identity, _cap));
