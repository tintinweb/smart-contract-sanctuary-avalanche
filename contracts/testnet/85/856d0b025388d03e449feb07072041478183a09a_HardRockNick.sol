...
// $$ |  $$ |$$  __$$ |$$ |      $$ |  $$ |      $$ |  $$ |$$ |  $$ |$$ |      $$  _$$<        $$ |\$$$ |$$ |$$ |      $$  _$$<  
// $$ |  $$ |\$$$$$$$ |$$ |      \$$$$$$$ |      $$ |  $$ |\$$$$$$  |\$$$$$$$\ $$ | \$$\       $$ | \$$ |$$ |\$$$$$$$\ $$ | \$$\ 
// \__|  \__| \_______|\__|       \_______|      \__|  \__| \______/  \_______|\__|  \__|      \__|  \__|\__| \_______|\__|  \__|
//                                                                                                                             
// Hard Rock Nick Society NFT Contract
...
contract HardRockNick is ERC721, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Hard Rock Nick", "NICKS") {}

    string private _metadataDataURI =
        "ipfs://QmVj44v671SmaRQhGZGQndNQW2Gz4GYWBZAM16PbPX6bJd/";
    uint256 private _maxSupply = 1111;
    uint256 public _mintPrice = 50 ether;
    ...
    function updateSupply(uint256 SUPPLY) public onlyOwner {
        _maxSupply = SUPPLY;
    }
