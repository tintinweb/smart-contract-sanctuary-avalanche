...
contract StakePumpskin is Ownable, PermissionsEnumerable, ReentrancyGuard {
    ...
    TokenERC20 public pieToken;
    TokenERC20 public potionToken;
    TokenERC721 public pumpskinCollection;
    TokenERC1155 public powerupCollection;
    ...
    constructor(
        TokenERC20 _pieToken,
        TokenERC20 _potionToken,
        TokenERC721 _pumpskinCollection,
        TokenERC1155 _powerupCollection
    ) {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupOwner(msg.sender);
        potionToken = TokenERC20(_potionToken);
        pieToken = TokenERC20(_pieToken);
        pumpskinCollection = TokenERC721(_pumpskinCollection);
        powerupCollection = TokenERC1155(_powerupCollection);
    }
    ...
    function _stake(uint256 tid) internal {
        ...
        require(pumpskin.staker != address(0), "ALREADY STAKED");
