...
//                recipient = i + 1 == pairs.length ? to : pairs[i + 1];
                ...
                if (version == ILBRouter.Version.V1) {
                    ...
                    try ILBLegacyRouter(_legacyRouterV2).getSwapOut(
                        ILBLegacyPair(pair), amountOut, swapForY
...
//    function findBestPathFromAmountIn(address[] calldata route, uint128 amountIn) external view returns (ILBQuoter.Quote memory quote)
//    {
...
-》 0xf16CEdDfeE46e39e3dca708b109E87249707b669
...
cast call \
--rpc-url=https://api.avax-test.network/ext/bc/C/rpc \
0x39509a89FE58F31aB26F5cc566Ee8E767c45d1F6 \
