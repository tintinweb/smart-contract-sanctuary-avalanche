...
contract ETFZapper is ContractGuard  {
    ...
    function joinMulti(
        ...
        uint256 ratio = poolAmountOut / IERC20(ETFToken).totalSupply();
    ...
    function exitMulti(
        ...
        uint256 ratio = (poolAmountIn - exitFee) / IERC20(ETFToken).totalSupply();
        for (uint256 i = 0; i < tokens.length; i++) {
    ...
    function _getSwapAmountsForExit(
        ...
        uint256 amountInPool = ratio * usedBalance;
