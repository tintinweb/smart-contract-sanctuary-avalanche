...
contract NoahArkStaking is Ownable {
    ...
    /**
        @notice stake NRK to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    function settleWarmupInfo(address _user, uint _amount) external {
        ...
        require(claim.gons >= _unstakeGons, 'Insufficient balance' );
    ...
    */
    ...
    /**
        @notice returns the sNRK index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract NRK holdings, including bonuses provided
        @return uint
     */
