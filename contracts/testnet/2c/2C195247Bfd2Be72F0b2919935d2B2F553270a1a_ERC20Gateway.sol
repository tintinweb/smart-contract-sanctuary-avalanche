...
// File contracts/interfaces/IERC20Gateway.sol
...
contract ERC20Gateway is IERC20Gateway, TransactedEventHash {
    ...
    function withdraw(
        ...
        require(_withdrawAddress != address(0), '_withdrawAddress is zero');
    ...
    function isTransactedEventHash(bytes32 _eventHash)
        ...
        returns (bool)
    {
        return TransactedEventHash.isTransactedEventHash(_eventHash);
    }
    ...
    function setTransactedEventHash(bytes32 _eventHash, bool _desired)
        ...
        onlyRole(OPERATOR_ROLE)
    {
        TransactedEventHash.setTransactedEventHash(_eventHash, _desired);
    }
}