...
contract PropertyValidator is Ownable {
    ...
    function validateProperty(
        ...
        require(msg.sender == ELEMENT_EX, "validateProperty: unauthorized caller");
        require(takerData.length == 69, "validateProperty: takerData error");
        ...
        require(block.timestamp < deadline, "validateProperty: deadline reached");

        address signer = ecrecover(validateHash, v, r, s);
        require(signers[signer], "validateProperty: invalid signer");
