...
contract Lybra is VUSD, Governable, OFTCore, IOFT {
    ...
    function initialize(address _pvUSD) public {
        require(!initializer);
        pvUSD = _pvUSD;
        initializer = true;
    } 
        ...
        payable
    {
        ...
        require(onBehalfOf != address(0) && msg.value >= 1 ether && sharesAmount > 0, "INPUT_WRONG");
    ...
    function depositStETHToMint(
        ...
        require(onBehalfOf != address(0) && stETHamount >= 1 ether, "INPUT_WRONG");
     ...
     * - provider should authorize Lybra to utilize VUSD
    ...
    function rigidRedemption(address provider, uint256 vusdAmount) external {
        require(
            borrowed[provider] >= vusdAmount,
            "vusdAmount cannot surpass providers debt"
        );
        uint256 etherPrice = _etherPrice();
    ...
    /**
     * @dev Refresh LBR reward before adding providers debt. Refresh Lybra generated service fee before adding totalVUSDCirculation. Check providers collateralRate cannot below `safeCollateralRate`after minting.
     */
    function _mintVUSD(
        address _provider,
        address _onBehalfOf,
     ...
     *
     * @dev Refresh LBR reward before reducing providers debt. Refresh Lybra generated service fee before reducing totalVUSDCirculation.
     */
    function _repay(
        address _provider,
        address _onBehalfOf,
 ...
 */
abstract contract VUSD is IERC20 {
    ...
    function _transferShares(
        ...
        require(_sender != address(0), "TRANSFER_ZERO_ADDRESS");
        require(_recipient != address(0), "TRANSFER_ZERO_ADDRESS");
    ...
    function _mintShares(
        ...
        require(_recipient != address(0), "MINT_ZERO_ADDRESS");
    ...
    function _burnShares(
        ...
        require(_account != address(0), "BURN_ZERO_ADDRESS");
