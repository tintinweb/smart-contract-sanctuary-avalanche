...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160); // USDC reflection
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x3592A0C756833E182bdD80Ca0d6E4F123DC821a8);
        _token = msg.sender;
    }
...
contract ALPHA is IBEP20, Auth {
    ...
    /** Addresses */
    address USDC = 0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160;
    ...
    address public treasuryFeeReceiver =
        0xa7BA90d0c10f28c0975E920a25FF48eEd61A36Fa;
    ...
    constructor() Auth(msg.sender) {
        address _router = 0x3592A0C756833E182bdD80Ca0d6E4F123DC821a8;
...
// File: contracts/ALPHACompoundManager.sol
...
contract ALPHACompoundManager {
    ...
    address public ALPHANodes = 0xBd8CC663D763E3E52C7C7F90155DAD0918Ae7eEa;
    address public USDC = 0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160;
    address public WAVAX = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public routerAddress = 0x3592A0C756833E182bdD80Ca0d6E4F123DC821a8;
    IDEXRouter public router;
    ...
    function compoundDividend() external {
         ...
         */
        ALPHA(payable(ALPHANodes)).setFees(0, 0, 0, 0, feeDenominator);
         ...
         */
        uint256 taxFreeAlphaAmount = ALPHA(payable(ALPHANodes)).balanceOf(
            address(this)
         ...
         */
        ALPHA(payable(ALPHANodes)).transfer(msg.sender, taxFreeAlphaAmount);

        /**
         * Resetting the fees back to their normal amount.
         */
        ALPHA(payable(ALPHANodes)).setFees(
            liquidityFee,
            buybackFee,
            reflectionFee,
            treasuryFee,
