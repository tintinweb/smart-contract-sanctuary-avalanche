...
import "../interfaces/extraneous/IERC20Viewless.sol";
    ...
    IDelegator
{
    ...
    function setMidLayer(address _middleLayer) external override {
        _delegatecall(abi.encodeWithSelector(
    ...
    function setMasterCID(uint256 _cid) external override {
        _delegatecall(abi.encodeWithSelector(
    ...
    function balanceOf(address account) external override returns (uint256 balance) {
    ...
    function allowance(address owner, address spender) external override returns (uint256 _allowance) {
        bytes memory data = _delegatecall(abi.encodeWithSelector(
    ...
    function totalSupply() external override returns (uint256 total) {
        bytes memory data = _delegatecall(abi.encodeWithSelector(
...
abstract contract IERC20Viewless {
