...
contract BankV2 is Ownable, IERC721Receiver, Pausable {
    // maximum alpha score
    ...
    uint256 public MAXIMUM_GLOBAL_gold = 999999999999999999 ether;
    ...
    function setMaxGlobalGold(uint _maxGlobalGold) public onlyOwner {
        MAXIMUM_GLOBAL_gold = _maxGlobalGold;
    }
