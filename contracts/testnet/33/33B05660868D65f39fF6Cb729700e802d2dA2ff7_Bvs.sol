...
contract Bvs is ERC721Enumerable, Ownable, ReentrancyGuard {

	uint256 public TOKEN_MAX_AMOUNT = 34632;
	uint256 public TOKEN_PER_TX = 523;
	uint256 public TOKEN_PER_WALLET = 232;
	uint256 public PRICE = 234 ether;
	uint256 public constant TIME_FOR_GROWN = 1685910331775;
	...
	string private _name = "BVS";
	string private _symbol = "SHH";
