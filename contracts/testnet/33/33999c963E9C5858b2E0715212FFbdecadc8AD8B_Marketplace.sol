...
contract Marketplace is CollectionEnumerable, ReentrancyGuard, Ownable, ERC721Holder, ERC1155Holder {
     ...
     * @param thorV2Address - currency for payments
     * @param royaltyManagerAddress - royalty Manager
     */
    constructor(address thorV2Address, address royaltyManagerAddress) {
        thorToken = IERC20(thorV2Address);
