...
/**
 * @title PredictionGameV2
 * @dev The PredictionGameV2 contract is a prediction game contract.
 * @custom:a Alfredo Lopez / VALIFi
 */
contract PredictionGameV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Event for Each Bet Bear Placed
     * @param sender Address of the sender
     * @param epoch timestamp of the Bet Bear Position
     * @param amount Amount of the Bet Bear Position
     */
    event BetBear(
    ...
    /**
     * @dev Event for Each Bet Bull Placed
     * @param sender Address of the sender
     * @param epoch timestamp of the Bet Bull Position
     * @param amount Amount of the Bet Bull Position
     */
    event BetBull(
        address indexed sender,
        uint256 indexed epoch,
    ...
    /**
     * @dev Event for Each Claimed Reward
     * @param sender Address of the sender
     * @param epoch timestamp of the Claimed Reward
     * @param amount Amount of the Claimed Reward
     */
    event Claim(address indexed sender, uint256 indexed epoch, uint256 amount);

    /**
     * @dev Event for Each Round End
     * @param epoch timestamp of the Round End
     * @param roundId Id of the Round End
     * @param price Amount of the Round End
     */
    event EndRound(
        uint256 indexed epoch,
    ...
    /**
     * @dev Event for Each Lock Round
     * @param epoch timestamp of the Lock Round
     * @param roundId Id of the Lock Round
     * @param price Amount of the Lock Round
     */
    event LockRound(
        uint256 indexed epoch,
        uint256 indexed roundId,
