...
Discord: https://discord.io/PantherNodes
...
contract PantherNodes is ERC20, Ownable {
    ...
    ERC20("PantherNodes", "CLAW") {
        ...
        nftAddress = IERC20(_boosternftaddress);
        ...
        if (swapLiquifyEnabled) {
            ...
            if(nftActivated){
                ...
                if(((block.timestamp - last_booster_claim) >= 24 hours)){
                    uint256 numberboosternft = nftAddress.balanceOf(sender);
    ...
    function boosterNFT(address _addr) external onlyOwner() {
        nftAddress = IERC20(_addr);
    }
