...
//    function setPlayerAmount(address _player, uint256 _amount) external onlyRole(RECORD_MANAGER) {
//        playerRecords[_player].amount = _amount;
//    }
//
//    function setPlayerAccAmount(address _player, uint256 _accAmount) external onlyRole(RECORD_MANAGER) {
//        playerRecords[_player].accAmount = _accAmount;
//    }

    function setPlayerRecord(address _player, uint256 _amount) external onlyRole(RECORD_MANAGER) {
        playerRecords[_player].amount++;
        playerRecords[_player].accAmount += _amount;
    }
