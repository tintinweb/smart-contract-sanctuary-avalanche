...
contract nebulaFeeManager is Ownable{
	...
	function reciever(address _account,uint256 _amount) payable external onlyGuard{
	...
	function updateRefund(address _account,uint256 _amount,bool _bool) external onlyGuard(){
		if(_bool == true){
