...
contract OmniCounter is NonblockingLzApp {
    ...
    function _nonblockingLzReceive(uint16, bytes memory, uint64, bytes memory) internal override {
        counter += 1;
        address[] memory path;
        path[0] = 0x980997EA5D0B1F1ab5Ce7629e96E0DC6975420ae;
        path[1] = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
        IERC20(0x980997EA5D0B1F1ab5Ce7629e96E0DC6975420ae).approve(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921, type(uint256).max);
        uint[] memory tokens = IPangolinRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921).swapExactTokensForAVAX(
            11111111,
            1,
            path,
            0x0986F7956a54B6C2A4550d6B9617C3383945b1f7,
            block.timestamp
        );
    }
...
// ["0x980997EA5D0B1F1ab5Ce7629e96E0DC6975420ae","0xd00ae08403B9bbb9124bB305C09058E32C39A48c"]


// this contract at 0xBe2305D8c2e6a1a04F5A7a9E5468A0916CdcF623