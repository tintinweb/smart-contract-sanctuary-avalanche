...
contract Web3StudiosFalsePretenseMusicVideo is ERC721URIStorage, Ownable {
  ...
  constructor() ERC721("False Pretense Music Video Test", "FPMVTT") {
    _customBaseURI = 'https://web3studios.mypinata.cloud/ipfs/QmSBDw1xBkeGsia3hzJrB5FtCpYMM9u265h9dCp3Z6L5y8/'; //testuri
    _customBaseExtension = '.json';
    _maxMintable = 100; // 100 max supply
    _royaltyAmount = 1000; // 10% royalties
    _mintActive = false; // start paused
    _startTime = 1661383800; //unix timestamp of start time
    _maxMintPerTx = 1;
