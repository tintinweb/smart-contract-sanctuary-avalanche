...
contract BuyNFT is GameFiat, Withdrawable {
    event SetPrice(uint256 orderId, address nftAddress, uint256[] tokenIds, uint256 price, address[] fiat, address seller);
    ...
    constructor() {
        ...
        buyNFTSub = 0xbd24C892cEEf0429A1251EfA1f5cbA11577192a7;
        rentalContract=0xA2e17a21391fB777BdE2bde31Fe482c5Aeb70BEA;
    ...
    function setPriceFee(
        ...
        emit SetPrice(_orderId, _game, _tokenIds, _price, _fiat, _msgSender());
    }
