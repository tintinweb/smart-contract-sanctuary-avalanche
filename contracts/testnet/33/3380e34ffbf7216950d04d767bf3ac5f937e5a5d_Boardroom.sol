...
contract Boardroom is ShareWrapper, ContractGuard, ReentrancyGuard {
    ...
    function getEVTombPrice() external view returns (uint256) {
        return treasury.getEVTombPrice();
    }
    ...
    function stake(uint256 amount) public override onlyOneBlock updateReward(msg.sender) nonReentrant {
    ...
    function withdraw(uint256 amount) public override onlyOneBlock memberExists updateReward(msg.sender) nonReentrant {
    ...
    function claimReward() public updateReward(msg.sender) nonReentrant {
        ...
        if (reward > 0) {
            ...
            evtomb.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        evtomb.safeTransferFrom(msg.sender, address(this), amount);
