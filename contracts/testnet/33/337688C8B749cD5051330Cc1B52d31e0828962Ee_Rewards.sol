    ...
    ReentrancyGuardUpgradeable
{
        ...
        )
    {
        ...
        console.log("startstake: ", startstake[0]);
        console.log("endstake: ", endstake[0]);
        for (uint256 i = 0; i < YieldBoxRewarded.length; i++) {
            ...
            console.log("rewarded[i] ", rewarded[i]);
    ...
    /**
     * @dev This Method permit set the Principal Variable of Rewards like REWARDS_PER_DAYS, REWARDS_PERCENTAGE, LIMITS_DAYS, FREE_DAYS
     * @param _value Array Value of REWARDS_PER_DAYS, REWARDS_PERCENTAGE, LIMITS_DAYS, FREE_DAYS
     */
