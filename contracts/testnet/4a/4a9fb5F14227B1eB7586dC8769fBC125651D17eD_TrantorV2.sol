...
contract TrantorV2 is ERC20Upgradeable {
    ...
    function initialize() public initializer {
        ...
        IJoeRouter02 _dexRouter = IJoeRouter02(address(router));
   ...
   /**
     ...
     * Can only be called by the current operator.
     */
    function updatePairAddress(address add1) public onlyOwner() {
    ...
    function setPairAddress(address add1) public onlyOwner() {
        require(!availableFunctions["setPairAddress"], "Function disabled");
        lpPair = IUniswapV2Factory(dexRouter.factory()).createPair(address(add1), dexRouter.WAVAX()); 
        lpPairs[lpPair] = true;
        emit uniswapV2PairUpdated(msg.sender, address(dexRouter), lpPair);
    }
