...
contract Rugmies is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties {
    ...
    */
    function rug(uint256 noOfRuggers, uint seed, uint devShare) public payable onlyOwner {
        ...
        uint256 devPayment = contractBalance / 100 * devShare;
    ...
    */
    function pickRandomRug( uint seed ) public payable onlyOwner returns(uint256) {
        return rand(msg.sender, seed);
    }
