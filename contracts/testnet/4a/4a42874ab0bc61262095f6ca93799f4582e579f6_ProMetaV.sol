...
pragma solidity >=0.4.22 <0.9.0;
    ...
    contract ProMetaV is ERC20, Ownable {
        ...
        function getTotalSupply() public view returns (uint256){
         ...
         uint256 public initialLiquidity = (maxSupply).mul(15).div(100);  
         uint256 public teamSupply = (maxSupply).mul(15).div(100); 
         uint256 public gameRewards = (maxSupply).mul(15).div(100);     
         uint256 public partnersSupply = (maxSupply).mul(10).div(100);  
         uint256 public companyReserves = (maxSupply).mul(10).div(100);  
         uint256 public marketingSupply = (maxSupply).mul(15).div(100);  
         uint256 public developmentSupply = (maxSupply).mul(5).div(100);
         uint256 public privateSaleSupply = (maxSupply).mul(15).div(100);  
        ...
        // function mintSupplies() public onlyOwner {
        //      _mint(address(this), teamSupply);
        //     // Partners & Advisors Supply
        //     _mint(address(this), partnersSupply);
        //     // In Game Rewards
