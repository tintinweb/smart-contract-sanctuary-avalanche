...
contract FoundanceFactory{
    ...
    //CORE
    address daoFactoryAddress = 0xE2A9a1E5e6f86ACdbE1ce0FBD60716Ebfacb94A4;
    //EXTENSION
    address bankExtensionFactoryAddress = 0x21CDE10a468aC6D5deB470c04Ad9f34Eb2e4A54f;
    address erc20ExtensionFactoryAddress = 0x824a6D0A8516461ec2De149a9784AB621146e976;
    address memberExtensionFactoryAddress = 0x9a8172e2fbd1613c840Cb52bD1Eb7EeFCa22517F;
    address dynamicEquityExtensionFactoryAddress = 0x51Af0067500ffb987Ea548d7Acebb9DD4367d142;
    address vestedEquityExtensionFactoryAddress = 0x4c5677ef54025f4bb5cE8DD8F2f1FEF45211345e;
    address communityEquityExtensionFactoryAddress = 0xF3E447e80Ee36E5B131cE343E7D55472B9C57a6a;
    //ADAPTER
    address managerAdapterAddress = 0xa39D9d2a6F1E2b0Fe380543D1A97C5bA6D9AAb37;
    address votingAdapterAddress = 0x680aF6Bbd1fB29940a030095b482FEFC33A31075;
    address memberAdapterAddress = 0xf7b4d7d13CFCdBa1a6D2d19367973B28003fB7a7;
    address dynamicEquityAdapterAddress = 0x2b03E28090C27CB54dcBAC2cAb9BB53859B72341;
    address vestedEquityAdapterAddress = 0x83c34BCC3602A42562F28C5600e426F276FAa2Fb;
    address communityEquityAdapterAddress = 0x28Ad9530da76145026C932458a2D306106fB824D;
  ...
  Reimbursable
{
    ...
    //mapping(address => mapping(string => Foundance.VotingConfig)) public votingFunctionConfig;
    ...
    function voteCancel(DaoRegistry dao, bytes32 proposalId)
        external
    {
        Voting storage vote = voting[address(dao)][votingIndex[address(dao)][proposalId]];
        vote.votingState = Foundance.VotingState.NOT_PASS;
...
contract MemberAdapter is IMemberAdapter, Reimbursable, MemberGuard, AdapterGuard {
    ...
    function _submitRemoveMemberBadLeaverProposal(
        ...
        removeMemberBadLeaverProposal[address(dao)][proposalId] = RemoveMemberProposal(
    ...
    function _submitRemoveMemberResigneeProposal(
        ...
        removeMemberResigneeProposal[address(dao)][proposalId] = RemoveMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin, Foundance.VotingType.OPTIMISTIC);
    ...
    function submitSetMemberProposal(
        ...
        setMemberProposal[address(dao)][proposalId] = SetMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberConfig
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function submitSetMemberSetupProposal(
        ...
        setMemberSetupProposal[address(dao)][proposalId] = SetMemberSetupProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberConfig,
    ...
    function submitRemoveMemberProposal(
        ...
        removeMemberProposal[address(dao)][proposalId] = RemoveMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
...
contract DynamicEquityAdapter is IDynamicEquity, AdapterGuard, Reimbursable {
    ...
    mapping(address => mapping(address => bytes32)) public ongoingSetDynamicEquityMemberEpochProposal;
    ...
    function submitSetDynamicEquityProposal(
        ...
        setDynamicEquityProposal[address(dao)][proposalId] = SetDynamicEquityProposal(
            Foundance.ProposalStatus.NOT_STARTED,
    ...
    function submitSetDynamicEquityEpochProposal(
        ...
        setDynamicEquityEpochProposal[address(dao)][proposalId] = SetDynamicEquityEpochProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _unixTimestampInS
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin, Foundance.VotingType.OPTIMISTIC);
    ...
    function submitSetDynamicEquityMemberProposal(
        ...
        setDynamicEquityMemberProposal[address(dao)][proposalId] = SetDynamicEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _dynamicEquityMemberConfig
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function submitSetDynamicEquityMemberSuspendProposal(
        ...
        setDynamicEquityMemberSuspendProposal[address(dao)][proposalId] = SetDynamicEquityMemberSuspendProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress,
            _suspendUntil
        );
    ...
    function submitSetDynamicEquityMemberExpenseProposal(
        ...
        string memory origin = "DynamicEquityAdapter.submitSetDynamicEquityMemberExpenseProposal";
        setDynamicEquityMemberExpenseProposal[address(dao)][proposalId] = SetDynamicEquityMemberExpenseProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress,
            _expenseAmount,
            _authorizedUntil
        ...
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
        emit SubmitSetDynamicEquityMemberExpenseProposalEvent(address(dao), msg.sender, data, proposalId, _memberAddress, _expenseAmount, _authorizedUntil);
    }
    ...
    function submitSetDynamicEquityMemberEpochProposal(
        ...
        require(
            msg.sender == _dynamicEquityMemberConfig.memberAddress,
            "dynamicEquityAdpt::msg.sender differs from provided memberAddress"
        );
        ...
        require(
            dynamicEquity.getIsNotReviewPeriod(),
            "dynamicEquityAdpt::submitSetDynamicEquityMemberEpochProposal unavailable during review period"
        );
        bytes32 ongoingProposalId = ongoingSetDynamicEquityMemberEpochProposal[address(dao)][_dynamicEquityMemberConfig.memberAddress];
        require(
            ongoingProposalId == bytes32(0) ||
            (setDynamicEquityMemberEpochProposal[address(dao)][ongoingProposalId].status != Foundance.ProposalStatus.NOT_STARTED && 
            setDynamicEquityMemberEpochProposal[address(dao)][ongoingProposalId].status != Foundance.ProposalStatus.IN_PROGRESS),
            "dynamicEquityAdpt::member has unprocessed proposal"
        );
        ongoingSetDynamicEquityMemberEpochProposal[address(dao)][_dynamicEquityMemberConfig.memberAddress] = proposalId;
        setDynamicEquityMemberEpochProposal[address(dao)][proposalId] = SetDynamicEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _dynamicEquityMemberConfig
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function submitRemoveDynamicEquityMemberProposal(
        ...
        removeDynamicEquityMemberProposal[address(dao)][proposalId] = RemoveDynamicEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function submitRemoveDynamicEquityMemberEpochProposal(
        ...
        removeDynamicEquityMemberEpochProposal[address(dao)][proposalId] = RemoveDynamicEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function processSetDynamicEquityEpochProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        SetDynamicEquityEpochProposal storage proposal = setDynamicEquityEpochProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
        ...
        reimbursable(dao)
    {
        ...
        if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
            ...
            proposal.status == Foundance.ProposalStatus.DONE;
            emit ProcessSetDynamicEquityMemberSuspendProposalEvent(address(dao), msg.sender, proposalId,  proposal.memberAddress, proposal.suspendedUntil);
        } 
    }
    ...
    function processSetDynamicEquityMemberEpochProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        _processDynamicEquityMemberEpochProposal(dao,proposalId);
    }

    function processSetDynamicEquityMemberExpenseProposal(DaoRegistry dao, bytes32 proposalId, uint256 _expenseAmount)
        external
        override
        reimbursable(dao)
    {
        SetDynamicEquityMemberExpenseProposal storage proposal = setDynamicEquityMemberExpenseProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
        ...
        require(
            proposal.expenseAmount >= _expenseAmount,
        ...
        if(proposal.authorizedUntil <= block.timestamp){
            VotingAdapterLibrary._cancelProposal(dao,proposalId);
        }else{
            proposal.status = VotingAdapterLibrary._processProposal(dao,proposalId);
            if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
                BankExtension bank = BankExtension(
                ...
                proposal.status == Foundance.ProposalStatus.DONE;
                emit ProcessSetDynamicEquityMemberExpenseProposalEvent(address(dao), msg.sender, proposalId,  proposal.memberAddress, proposal.expenseAmount, _expenseAmount, proposal.authorizedUntil);
            }
        }
    }
    ...
    function processRemoveDynamicEquityMemberProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        RemoveDynamicEquityMemberProposal storage proposal = removeDynamicEquityMemberProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
    ...
    function processRemoveDynamicEquityMemberEpochProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        RemoveDynamicEquityMemberProposal storage proposal = removeDynamicEquityMemberEpochProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
    ...
    //ACT
     function actDynamicEquityMemberEpochCancel(DaoRegistry dao)
        external
        reimbursable(dao)
    {
        bytes32 ongoingProposalId = ongoingSetDynamicEquityMemberEpochProposal[address(dao)][msg.sender];
        require(
            ongoingProposalId != 0,
            "dynamicEquityAdpt::no ongoing proposaal"
        );
        SetDynamicEquityMemberProposal storage proposal = setDynamicEquityMemberEpochProposal[address(dao)][
            ongoingProposalId
        ];
        require(
            msg.sender == proposal.dynamicEquityMemberConfig.memberAddress,
            "dynamicEquityAdpt::msg.sender does not match memberAddress"
        );
        proposal.status = VotingAdapterLibrary._cancelProposal(dao, ongoingProposalId);
        ongoingSetDynamicEquityMemberEpochProposal[address(dao)][msg.sender] = 0;
        emit ActDynamicEquityMemberEpochProposalCancelEvent(address(dao), msg.sender, ongoingProposalId);
    }

    function actDynamicEquityEpochMemberProcess(DaoRegistry dao)
        internal
        reimbursable(dao)
    {
        ...
        for (uint256 i = 0; i < nbMembers; i++) {
            ...
            bytes32 ongoingProposalId = ongoingSetDynamicEquityMemberEpochProposal[address(dao)][memberAddress];
            if(ongoingProposalId!=0){
                _processDynamicEquityMemberEpochProposal(dao, ongoingProposalId);
            }
        }
    }

    function actDynamicEquityEpochDistribute(DaoRegistry dao)
        external
        override
        reimbursable(dao)
    {
        ...
        actDynamicEquityEpochMemberProcess(dao);
        while(distributionEpoch < blockTimestamp){
            for (uint256 i = 0; i < nbMembers; i++) {
                ...
                if(suspendedUntil < distributionEpoch){
                    ...
                    emit ActDynamicEquityMemberEpochDistributeEvent(address(dao), msg.sender, memberAddress, token, amount);
                }
            }
        ...
        emit ActDynamicEquityEpochDistributeEvent(address(dao), msg.sender, distributionEpoch);
    }
}
...
contract VestedEquityAdapter is IVestedEquity, AdapterGuard, Reimbursable {
    ...
    function submitSetVestedEquityMemberProposal(
        ...
        setVestedEquityMemberProposal[address(dao)][proposalId] = SetVestedEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _vestedEquityMemberConfig
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function submitRemoveVestedEquityMemberProposal(
        ...
        removeVestedEquityMemberProposal[address(dao)][proposalId] = RemoveVestedEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
    ...
    function processSetVestedEquityMemberProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        SetVestedEquityMemberProposal storage proposal = setVestedEquityMemberProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
    ...
    function processRemoveVestedEquityMemberProposal(DaoRegistry dao, bytes32 proposalId)
        ...
        reimbursable(dao)
    {
        RemoveVestedEquityMemberProposal storage proposal = removeVestedEquityMemberProposal[address(dao)][
            proposalId
        ];
        require(
            proposal.status == Foundance.ProposalStatus.NOT_STARTED,
        ...
        internal
    {
        ...
        emit ActVestedEquityMemberDistributeEvent(address(dao), msg.sender, _memberAddress, token, tokenAmountToDistributed);
    }
        ...
        external override reimbursable(dao)
    {
        ...
        if (memberAddress != address(0x0)) {
            _actVestedEquityMemberDistribute(dao, bank, vestedEquity, memberAddress, token);  
        }else{
            uint256 nbMembers = dao.getNbMembers();
            for (uint256 i = 0; i < nbMembers; i++) {
                address _memberAddress = dao.getMemberAddress(i);
                if(DaoLibrary.isNotReservedAddress(_memberAddress)){
                    _actVestedEquityMemberDistribute(dao, bank, vestedEquity, _memberAddress, token);          
                }
            }
        }
    }
...
contract CommunityEquityAdapter is ICommunityEquity, AdapterGuard, Reimbursable {
    ...
    mapping(bytes32 => mapping(address => bytes32)) public ongoingCommunityEquityDistribution;

    //EVENT
    event SubmitSetCommunityEquityProposalEvent(
        address _daoAddress, address _senderAddress, bytes _data, bytes32 _proposalId, bytes32 _communityEquityId, 
    ...
    event ProcessSetCommunityEquityProposalEvent(
        address _daoAddress, address _senderAddress, bytes32 _proposalId, bytes32 _communityEquityId, 
        Foundance.CommunityEquityConfig _communityEquityConfig, 
        Foundance.EpochConfig _epochConfig
    );
    ...
    event ActCommunityEquityMemberDistributeEvent(
        address _daoAddress, address _senderAddress, bytes32 _communityEquityId, 
        address _recipient, 
    ...
    function submitSetCommunityEquityProposal(
        ...
        setCommunityEquityProposal[address(dao)][proposalId] = SetCommunityEquityProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            communityEquityId,
        ...
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
        emit SubmitSetCommunityEquityProposalEvent(address(dao), msg.sender, data, proposalId, communityEquityId, _communityEquityConfig, _epochConfig);
    }
    ...
    function submitSetCommunityEquityMemberProposal(
        ...
        setCommunityEquityMemberProposal[address(dao)][proposalId] = SetCommunityEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            communityEquityId,
            _communityEquityMemberConfig
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
        emit SubmitSetCommunityEquityMemberProposalEvent(address(dao), msg.sender, data, proposalId, communityEquityId, _communityEquityMemberConfig);
    }
    ...
    function submitRemoveCommunityEquityProposal(
        ...
        removeCommunityEquityProposal[address(dao)][proposalId] = RemoveCommunityEquityProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            communityEquityId
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
        emit SubmitRemoveCommunityEquityProposalEvent(address(dao), msg.sender, data, proposalId, communityEquityId);
    }
    ...
    function submitRemoveCommunityEquityMemberProposal(
        ...
        removeCommunityEquityMemberProposal[address(dao)][proposalId] = RemoveCommunityEquityMemberProposal(
            Foundance.ProposalStatus.NOT_STARTED,
            communityEquityId,
            _memberAddress
        );
        VotingAdapterLibrary._submitProposal(dao, proposalId, data, origin);
        emit SubmitRemoveCommunityEquityMemberProposalEvent(address(dao), msg.sender, data, proposalId, communityEquityId, _memberAddress);
    } 
    ...
    function _processRemoveCommunityEquityTokens(
        ...
        Foundance.CommunityEquityConfig memory communityEquityConfig = communityEquity.getCommunityEquityConfig(communityEquityId); 
    ...
    function processSetCommunityEquityProposal(
        ...
        if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
            ...
            _processRemoveCommunityEquityTokens(dao, proposal.communityEquityId, communityEquity, bank);
            ...
            proposal.status == Foundance.ProposalStatus.DONE;
            emit ProcessSetCommunityEquityProposalEvent(address(dao), msg.sender, proposalId, proposal.communityEquityId, proposal.communityEquityConfig, proposal.epochConfig);
        }
    }
    ...
    function processSetCommunityEquityMemberProposal(
        ...
        if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
            ...
            proposal.status == Foundance.ProposalStatus.DONE;
            emit ProcessSetCommunityEquityMemberProposalEvent(address(dao), msg.sender, proposalId, proposal.communityEquityId, proposal.communityEquityMemberConfig);
        }
    }
    ...
    function processRemoveCommunityEquityProposal(
        ...
        if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
            ...
            proposal.status == Foundance.ProposalStatus.DONE;
            emit ProcessRemoveCommunityEquityProposalEvent(address(dao), msg.sender, proposalId, proposal.communityEquityId);
        }
    }
    ...
    function processRemoveCommunityEquityMemberProposal(
        ...
        if (proposal.status == Foundance.ProposalStatus.IN_PROGRESS) {
            ...
            proposal.status == Foundance.ProposalStatus.DONE;
            emit ProcessRemoveCommunityEquityMemberProposalEvent(address(dao), msg.sender, proposalId, proposal.communityEquityId, proposal.memberAddress);
        }
    }
    ...
    function actCommunityEquityMemberDistribute(
        ...
        require(
            communityEquity.getIsCommunityEquity(communityEquityId),
            "communityEquityAdpt::requires valid communityEquityId"
        );
        require(
            ongoingCommunityEquityDistribution[communityEquityId][address(dao)]==0,
            "communityEquityAdpt::has to wait until ongoingDistribution is done"
        );        
        address memberAddress = msg.sender;
        require(
            communityEquity.getIsCommunityEquityMember(communityEquityId, memberAddress),
            "communityEquityAdpt::msg.sender not allowed to distribute community equity"
        );
        Foundance.CommunityEquityMemberConfig memory communityEquityMemberConfig = communityEquity.getCommunityEquityMemberConfig(communityEquityId, memberAddress);
        require(
        ...
        ongoingCommunityEquityDistribution[communityEquityId][address(dao)] = distributionId;
        communityEquityConfig.tokenAmount -= amountToBeSent;
        ...
        communityEquity.setCommunityEquityMember(dao, communityEquityId, communityEquityMemberConfig);
        ongoingCommunityEquityDistribution[communityEquityId][address(dao)] = 0;
        emit ActCommunityEquityMemberDistributeEvent(address(dao), memberAddress, communityEquityId, recipient, amountToBeSent);
    }
    ...
    function actCommunityEquityEpochUpdate(
        ...
        require(
            ...
            "communityEquityAdpt::requires CommunityEquity.AllocationType.EPOCH"
        );
        Foundance.EpochConfig memory epochConfig = communityEquity.getCommunityEquityEpochConfig(communityEquityId);
        ...
        if(blockTimestamp > epochLastUpdated){
            ...
            _processRemoveCommunityEquityTokens(dao, communityEquityId, communityEquity, bank);
        ...
        emit ActCommunityEquityEpochUpdateEvent(address(dao), msg.sender, communityEquityId);
    }
}
...
library VotingAdapterLibrary {
    ...
    function _cancelProposal(
        ...
        IVotingAdapter votingAdapter = IVotingAdapter(dao.votingAdapter(proposalId));
        require(address(votingAdapter) != address(0), "votingAdpt::adapter not found");
        votingAdapter.voteCancel(dao, proposalId);
        return Foundance.ProposalStatus.FAILED;
    }
}
...
contract DynamicEquityExtension is IExtension {
    ...
    function getDynamicEquityMemberEpochAmountInternal(
        ...
        uint salaryEpoch = (dynamicEquityMemberEpochConfig.salary * dynamicEquityMemberEpochConfig.availability) / precisionFactor;
    ...
    function getIsNotReviewPeriod(
        ...
        return 
            (block.timestamp<epochConfig.epochLast+epochConfig.epochDuration-epochConfig.epochReview) ||
            (block.timestamp>epochConfig.epochLast+epochConfig.epochDuration)
        ;
    }
...
contract CommunityEquityExtension is IExtension {
    ...
    mapping(bytes32 => uint) communityEquityIndex;
    mapping(bytes32 => Foundance.CommunityEquityMemberConfig[]) public communityEquityMemberConfig;
    ...
    function removeCommunityEquityMember(
        ...
        require(
            ...
            "communityEquity::member not set"
        );
        communityEquityMemberIndex[communityEquityId][_memberAddress]==0;
    }
...
interface IDynamicEquity {
    ...
    function processSetDynamicEquityMemberExpenseProposal(DaoRegistry dao, bytes32 proposalId, uint256 _expenseAmount) external;
