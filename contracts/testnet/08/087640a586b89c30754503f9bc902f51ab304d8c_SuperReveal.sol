...
// Fuji: 0xd9d0b80e14128336b19e4d48ecee302d65870ddb
contract SuperReveal is VRFConsumerBaseV2, Ownable {
    bytes32 public constant keyHash = 0x354d2f95da55398f44b7cff77da56283d9c6c829a4bdf1bbcaf2ad6a4d081f61; // TODO::: FUJI
    address public constant vrfCoordinator = 0x2eD832Ba664535e5886b75D64C46EB9a228C2610; // TODO::: FUJI
    uint32 public constant callbackGasLimit = 1_000_000;
    uint16 public constant requestConfirmations = 3;
    uint64 private constant subscriptionId = 531; // TODO::: fuji

    uint256 public revealStartTime;
    uint256 public constant collectionSize = 2815;
    uint256 public constant rangeDepth = 563;
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) {
        revealStartTime = block.timestamp + 1 minutes; // TODO::: change
    }
    ...
    function hasBatchToReveal() public view returns (uint256) {
        ...
        if (block.timestamp < revealStartTime ||
            collectionSize <= batchToRange[prevBatch].startId + rangeDepth ||
    ...
    function revealNextBatch() external onlyOwner returns (bool) {
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        if (nextBatch > 0) {
            unchecked {
                startId = batchToRange[nextBatch - 1].startId + rangeDepth;
            }
        }
        batchToRange[nextBatch] = RevealedRange({
            startId: startId,
    ...
    function getShuffledTokenId(uint256 tokenId) external view returns (uint256) {
        uint256 batch = tokenId / rangeDepth;
        uint256 increment = tokenId % rangeDepth;
        if (tokenId != 0 && increment == 0) {
            batch++;
        }
