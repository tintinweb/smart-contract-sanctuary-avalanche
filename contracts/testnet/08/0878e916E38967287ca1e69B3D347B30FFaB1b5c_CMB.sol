...
contract CMB is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _owner) public initializer {
        ...
        usdcToken = USDCToken(0x5425890298aed601595a70AB815c96711a31Bc65);
    }
     ...
     *  Emit event {Paid}
     */
    function pay(uint256 paymentId, string memory currency) 
        external 
        payable 
        onlyValidPayment(paymentId) 
        ...
        onlyClient(paymentId) 
    {
        ...
        if (today - payment.firstPaidDate <= DAY_TO_SECOND * RIGHT_TO_CANCEL) {
            ...
            revert("This contract may be cancelled within 3 days of initialing payment");
        }
    }
