...
contract CoinFlip is VRFConsumerBaseV2, Ownable {
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords) internal override {
        ...
        if (winnings > 0) {
            ...
            _internalHandleWonGame(flipId, output);
        } else { 
            _internalHandleLostGame(flipId, output);
        }
    ...
    function getResults(uint256 gameId)   public view returns (CoinSide[] memory) {
        return flipById[gameId].result;
    }
