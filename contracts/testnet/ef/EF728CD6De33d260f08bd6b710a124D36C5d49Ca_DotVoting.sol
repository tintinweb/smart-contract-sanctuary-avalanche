...
import "@daoxy/apps-shared-minime/contracts/MiniMeToken.sol";

// TODO: Revert import path when changes get merged into daoxy/os
// import "@daoxy/os/contracts/common/ADynamicForwarder.sol";
import "./shared/common/ADynamicForwarder.sol";


contract DotVoting is ADynamicForwarder, DaoxyApp {
...
// TODO: Use @daoxy/os/contracts/ version when it gets merged
import "../evmscript/ScriptHelpers.sol";
// TODO: Research why using the @daoxy/os version breaks coverage
...
contract DaoxyApp is AppStorage, Autopetrified, VaultRecoverable, ReentrancyGuard, EVMScriptRunner, ACLSyntaxSugar {
