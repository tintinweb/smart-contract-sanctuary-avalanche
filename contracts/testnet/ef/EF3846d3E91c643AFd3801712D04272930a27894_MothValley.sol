    ...
    ReentrancyGuard
{
    ...
    bytes32 public root =
        0x52ad20bd23e1b1154de751015174bb63271b26015f3a88f0d6d2f2cd27f42dee;

    string public _contractBaseURI = "https://ipfs.w3bmint.xyz/ipfs/QmZmvdvJCoTH3Hobyyqg8DoQrzTHcxhZ5pxiuqt4p2Mkfn/";
    string public _contractURI = "ipfs://bafkreicpxgli7jh5sbotbceuvbtlaijhppjeww4ahlcsrqfr4c7l4oamzu";
    
    uint256 public maxSupply = 2222;
    uint256 public maxPublicMint = 1;
    bool public isRevealed = false;
    
    uint256 public whitelistStartTime = block.timestamp-1; //TODO: UPDATE THIS!
    uint256 public publicStartTime = block.timestamp-1; //TODO: UPDATE THIS!
    ...
    constructor()
        ERC721A("Moth Valley Pass", "MOTHV"){
        _setDefaultRoyalty(0xe6905bc5DAe05647cf81b3B62823BD670acD9a78, 900);
    }
	...
	*/
        ...
        returns (string memory)
    {
        ...
        if(!isRevealed){
            return string("ipfs://bafkreicpxgli7jh5sbotbceuvbtlaijhppjeww4ahlcsrqfr4c7l4oamzu");
        }

        return
            string(
                abi.encodePacked(_contractBaseURI, _tokenId.toString())
            );
    }
	...
	*/
    ...
    function setStartTimes(uint256 whitelist, uint256 publicSale)
        external
        onlyOwner
    {
