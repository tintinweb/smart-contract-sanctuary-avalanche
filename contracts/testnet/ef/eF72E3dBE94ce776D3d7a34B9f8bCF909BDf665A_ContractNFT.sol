...
contract ContractNFT is ERC721Enumerable, Ownable, RoyaltiesImpl, Pausable {
    ...
    constructor(string memory _initBaseURI, string memory _notRevealedURI, address _royaltiesAddress, uint _startTime, address _trsr) ERC721("fgsjgfj", "SEqdfgAM")
    {
...
contract TestTRS is ERC20, Ownable {
    ...
    constructor() ERC20("hgfd", "TqsdfqsRSR") {
