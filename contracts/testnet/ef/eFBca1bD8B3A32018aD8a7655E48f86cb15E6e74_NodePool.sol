...
contract NodePool is ContractGuard {
    ...
    uint256 public shareTokenPerSecond = 0.00134766 ether; // 42500 tokens / (365 days * 24h * 60min * 60s)
    ...
    function checkPoolDuplicate(IERC20 _token, uint256 _lockTime) internal view {
