...
contract PixelMine {
    ...
    address private _tokenAddress = 0x64FdB269781EF450F9dA8885b559B6De50006De6;

    address private _presaleHELMETMinter;
    address private _presaleShovelMinter;
    address private _minter;

    address private _helmetAddress = 0x620959745F37579b6117Ddf02a2DaCC2F34c3221;
    address private _shovelAddress = 0xE7a7505B899dbBA806Cdddb840f3163e73172019;
    address private _hammerAddress = 0x7416716921057Cf4e109a38AC5EB08892643B6de;
    address private _axeAddress = 0x8348b6B2D65A9c00a42F550D7780B531dBC4b668;
    address private _drillAddress = 0x25b58A2c128cdfF03740F1BD5A64Aa7Ffba5EC2b;
    ...
    function getHarvestSeconds(ORE _ore, address owner) private returns (uint) {
        ...
        if (_ore == ORE.Stone) {
            ...
            // 4 hours
            if (isAxeHolder != 0) return 2 * 60 * 60 / 4; 
            return 2 * 60 * 60;
            ...
            // 3 days
            if (isDrillHolder != 0) return 24 * 60 * 60 / 3; 
            return 3 * 24 * 60 * 60;
        }
    ...
    */
    ...
    function presaleMintHELMET() public payable {
        ...
        require(msg.value == 5 * 10 ** 18, "Unable to mint: Fixed Price 1 BNB");
        (bool sent,) = _AVAXLiquidityAddress.call{value: msg.value / 2}("");
    ...
    function presaleMintShovel() public payable {
        ...
        require(msg.value == 4 * 10 ** 18, "Unable to mint: Fixed Price 1 BNB");
        (bool sent,) = _AVAXLiquidityAddress.call{value: msg.value / 2}("");
        require(sent, "Failed to mint");
