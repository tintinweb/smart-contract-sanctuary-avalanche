...
// File: contracts/OriginMarketPlace.sol
    ...
    Ownable
{
    ...
    function acceptOffer(uint256 _nonce, address _token) external nonReentrant {
        ...
        require(
            idToListedToken[currentOffer.listingID].currentlyListed,
            "Item already has been bought"
        );
        require(block.timestamp < currentOffer.endBlock, "Offer Time Exceeds");
        require(
            idToListedToken[currentOffer.listingID].owner == msg.sender,
        ...
        delete (idToListedToken[currentOffer.listingID]);
