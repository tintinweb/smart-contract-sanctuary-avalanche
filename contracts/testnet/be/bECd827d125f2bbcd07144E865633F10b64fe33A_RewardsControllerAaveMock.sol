...
contract RewardsControllerAaveMock is RewardsDistributor, IRewardsControllerAave {
  ...
  function _claimRewards(
    ...
    require(amount <= entityRewardBalances[entity][reward], "Cannot claim more rewards than available.");
    require(amount <= IERC20(reward).balanceOf(address(this)), "Not enough rewards present in AAVE rewards controller (this).");
