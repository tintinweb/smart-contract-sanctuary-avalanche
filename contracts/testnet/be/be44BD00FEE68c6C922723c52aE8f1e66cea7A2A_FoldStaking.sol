...
contract FoldStaking is Ownable {
    ...
    function depositLP(uint256 _amount, address _lpAddress) public {
       ...
       if(allowedLPs[_lpAddress]){
            ...
            uint stakeAmount = lpFldValue * 10 / FOLD_TOKEN_PRECISION; // LP Bonus 10x
    ...
    function withdrawLP(uint256 _amount, address _lpAddress) public {
        ...
        if(allowedLPs[_lpAddress]){
            ...
            uint256 depositedPositionValue = totalLPDeposit * _amount / totalLPTokens; // Amount of staking shares this _amount is worth


            // Get the correct stakeAmount at time of deposit!
            uint stakeAmount = depositedPositionValue * 10 / FOLD_TOKEN_PRECISION; 
