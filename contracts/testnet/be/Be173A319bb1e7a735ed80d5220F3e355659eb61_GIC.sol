...
contract GIC is ERC1155Supply, Ownable {
    ...
    constructor(uint256 maxSupply_)
        ERC1155(
            "https://gateway.pinata.cloud/ipfs/bafybeigeinaoarw63mlfujvkxyhm4wmnsailfxenhvdxxkncerbrflqki4/{id}.json"
        )
    {
        name_ = "Gic Freemint";
        symbol_ = "GIC";
    ...
    function freeMint() public {
        if (msg.sender != tx.origin || balanceOf(msg.sender, DEFAULT) != 0 || balanceOf(msg.sender, GOLD) != 0)
            revert FreeMintLimit();
