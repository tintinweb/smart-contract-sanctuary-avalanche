...
// File: contracts/ActUltisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract ActUltisContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "ACT Ultis";
    string public symbol = "ACTultis";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/9xiGo8aiAVpCDRTw69mY/contract-metadata";
  }
