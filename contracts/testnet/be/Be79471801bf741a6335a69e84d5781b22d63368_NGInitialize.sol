...
contract NGInitialize is WithStorage {
    ...
    function init() external onlyAdmin {
        ...
        gameConstants().CASH_FACTOR = 1714702;
        gameConstants().WOOD_FACTOR = 4286755;
        gameConstants().STONE_FACTOR = 5715673;
        gameConstants().STEEL_FACTOR = 6858808;
        gameConstants().OIL_FACTOR = 8573510;
