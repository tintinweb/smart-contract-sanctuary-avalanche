...
contract PNSPM is ERC721, ERC721Enumerable, Ownable, ERC721Burnable  {
    ...
    constructor() ERC721("PNS Pioneer Medal", "PNS PM") {
        _tokenIdCounter.reset();
    }

    function safeMint(address to) public onlyOwner {
        require(totalSupply() < MAX_SUPPLY, "Exceed maximum supply");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "http://nft.pns.link/nft_asset/";
    }
}
