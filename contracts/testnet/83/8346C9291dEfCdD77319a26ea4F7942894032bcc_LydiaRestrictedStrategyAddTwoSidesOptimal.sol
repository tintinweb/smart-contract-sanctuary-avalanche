...
contract LydiaRestrictedStrategyAddTwoSidesOptimal is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  function execute(
    ...
    tokenInput[0] = ITridentRouter.TokenInput(baseToken, true, baseToken.myBalance());
    tokenInput[1] = ITridentRouter.TokenInput(farmingToken, true, farmingToken.myBalance());
