...
contract Oracle is AccessControl {
     ...
     * @param _asset Asset to look up to i.e. AVAX, ETH, etc
     * @return price Price of an asset in USD, expressed in 1e8;
     */
    function getPriceFromChainLink(string memory _asset)
        external
        view
        returns (int256)
    {
        ...
        (, price, , , ) = chainLinkPriceFeeds[_asset].oracle.latestRoundData();
    ...
    // TODO: throw error? if address is invalid
    /**
     * @param _asset Asset to add to `chainLinkPriceFeeds` mapping
     * @param _address Contract address for ChainLink Aggregator
     */
