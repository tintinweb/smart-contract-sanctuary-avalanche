...
contract AsterPremiumPass is ERC721A, ERC2981 , Ownable, Pausable, CantBeEvil(LicenseVersion.CBE_NECR_HS)  {
    using Strings for uint256;

    string private baseURI = "";

    uint256 public preCost = 1e16;
    uint256 public publicCost = 2e16;
    ...
    address constant private BULK_TRANSFER_ADDRESS = 0x159f524775D64be69A881EB6DA059c8c217Ad22c;
    address constant private DEFAULT_ROYALITY_ADDRESS = 0x159f524775D64be69A881EB6DA059c8c217Ad22c;
    ...
    constructor(
        ...
        _mintERC2309(BULK_TRANSFER_ADDRESS, 30);
        for (uint256 i; i < 3; ++i) {
            _initializeOwnershipAt(i * 10 + 1);
        }
    }
