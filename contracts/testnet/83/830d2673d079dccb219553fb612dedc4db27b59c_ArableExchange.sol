...
contract ArableExchange is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function swapSynths(
        ...
        if (tokenPurchaseTimestamp[outToken] + assetProtectionTime <= block.timestamp ||
