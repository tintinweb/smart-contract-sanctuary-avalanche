...
// File: contracts/HappyCampers.sol
...
contract HappyCampers is ERC721URIStorage, Ownable {
    ...
    function mint(uint256 quantity) public payable {
        ...
        payable(NFTsTransferWallet).transfer(msg.value);
    ...
    function setNFTsTransferWallet(address _NFTsTransferWallet)
        external
        onlyOwner
    {
        NFTsTransferWallet = _NFTsTransferWallet;
