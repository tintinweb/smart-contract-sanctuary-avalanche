...
contract LiquidatorRewards is ILiquidatorRewards, Owned, MixinSystemSettings, ReentrancyGuard {
    ...
    constructor(address _owner, address _resolver, bytes32 _collateralKey) public Owned(_owner) MixinSystemSettings(_resolver) {
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        newAddresses[4] = CONTRACT_REWARDESCROW_V2_MANAGER;
    ...
    function rewardRestitution(address _to, uint256 _amount, bytes32 _collateralKey) external onlySynthetix returns (bool) {
