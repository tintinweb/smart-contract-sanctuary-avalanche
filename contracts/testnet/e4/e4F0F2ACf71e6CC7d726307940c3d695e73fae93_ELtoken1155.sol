...
contract ELtoken1155 is ERC1155, Ownable {
    mapping(address => uint256[]) adrToIds;

    constructor(string memory uri_) ERC1155(uri_) {
        _mint(msg.sender, 0, 100, "");
        _mint(msg.sender, 1, 100, "");
        adrToIds[msg.sender].push(0);
        adrToIds[msg.sender].push(1);
    }
    ...
    function mint(
        ...
        _mint(to, id, amount, "");
        if (!isInArray(adrToIds[msg.sender], id)) {
            adrToIds[msg.sender].push(id);
        }
    }
