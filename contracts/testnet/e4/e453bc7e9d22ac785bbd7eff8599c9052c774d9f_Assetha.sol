...
contract Assetha is ERC721B, Ownable, NonblockingReceiver {
    ...
    uint256 public maxFreeMints = 15;
    uint256 public maxPreMints = 150;
    uint256 public tokensPerWhitelistedAddress = 2;

    uint256 private nextToken = 2001;
    uint256 private startIndex_ = 2001;
    uint256 private endIndex_ = 3500;
