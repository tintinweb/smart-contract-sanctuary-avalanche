...
//newest functions added for shuffle reveal
  ...
  function requestShuffleAndPayAvaxFee() external payable onlyOwner{//ask our Witnet contract for a random number
...
//onlyOwner setter functions
  function setPricePublicWei(uint _pricePublic) public onlyOwner { //https://eth-converter.com/
    pricePublic = _pricePublic;
  }

  function setPriceWLWei(uint _priceWL) public onlyOwner { //https://eth-converter.com/
    priceWL = _priceWL;
  }
