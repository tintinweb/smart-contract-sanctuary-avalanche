...
contract GatesOfHell is ERC721OnChainMetadata, Ownable {
    ...
    function mint(uint256 quantity) public payable isOpen {
        ...
        _setValue(tokenId, key_token_name, abi.encodePacked("Gate to Hell #", abi.encode(tokenId)));
        ...
        _setValue(tokenId, key_token_image, abi.encodePacked(abi.encodePacked(baseURI, abi.encode(tokenId)), ".png"));
