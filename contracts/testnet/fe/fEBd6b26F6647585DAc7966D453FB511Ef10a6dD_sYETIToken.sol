...
contract sYETIToken is IERC20, Domain, BoringOwnable {
    ...
    function buyBack(address routerAddress, uint256 YUSDToSell, uint256 YETIOutMin, address[] memory path) external onlyOwner {
        ...
        require(lastBuybackTime + 69 seconds < block.timestamp, "Must have 69 hours pass before another buyBack");
    ...
    function rebase() external {
        require(block.timestamp >= lastRebaseTime + 8 seconds, "Must have 8 hours pass before another rebase");
