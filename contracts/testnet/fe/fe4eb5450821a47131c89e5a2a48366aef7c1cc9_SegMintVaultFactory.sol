...
interface SegMintERC1155FeeManagementInterface {
  // get SegMint Vault Deploy Fee
  function getSegMintVaultDeployFee() external view returns (uint256);
...
contract SegMintVaultFactory {
    ...
    // update SegMint Fee Management Contract Address
    event setSegMintFeeManagementAddressEvent(
        address indexed Owner,
        address previousFeeManagementContractAddress,
        address indexed newSegMintFeeManagementContractAddress,
        uint256 indexed timestamp
    );
     ...
     */
    function deploySegMintVault() external payable onlyKYCAuthorized {
        // fee management contract 
        SegMintERC1155FeeManagementInterface _feeManagement = SegMintERC1155FeeManagementInterface(_SegMintERC1155FeeManagementAddress);
        // get deploy fees
        uint256 SegMintVaultDeployFee = _feeManagement.getSegMintVaultDeployFee();

        // check fees
        require(msg.value == SegMintVaultDeployFee, "SegMint Vault Factory: Incorrect Fees");
    ...
    // update SegMint FeeManagement address
    function setSegMintFeeManagementAddress(address SegMintFeeManagementContractAddress_)
        public
        onlyOwner
        notNullAddress(SegMintFeeManagementContractAddress_, "SegMint FeeManagement Address")
    {
        // previous address
        address previousFeeManagementContractAddress = _SegMintERC1155FeeManagementAddress;

        // update address
        _SegMintERC1155FeeManagementAddress = SegMintFeeManagementContractAddress_;
        // emit event
        emit setSegMintFeeManagementAddressEvent(
            msg.sender,
            previousFeeManagementContractAddress,
            SegMintFeeManagementContractAddress_,
            block.timestamp
        );
    }
    ...
    // get SegMint FeeManagement address
    function getSegMintFeeManagementAddress() public view returns (address) {
