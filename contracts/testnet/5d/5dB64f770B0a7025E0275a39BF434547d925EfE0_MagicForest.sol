...
contract MagicForest is Controllable, IERC721Receiver, Pausable, Restricted {
    ...
    // emergency rescue to allow unstaking without any checks but without $GLOW
    ...
    {
        if (skeleton.getTokenTraits(tokenId).isAdventurer) {
     ...
     */
    function setRescueEnabled(bool _enabled) external onlyController {
