...
contract Kings is ERC721URIStorage, Ownable, KindaRandom {
  ...
  constructor(uint256 startTime_) ERC721("Kings of the Jungle", "KINGS") KindaRandom(101) {
    _customBaseURI = 'https://nfts.bpi.network/kings/';
    _maxMintable = 101; // 101 max supply
    _royaltyAmount = 690; // 6.9% royalties
    _mintActive = true;
    _maxMintPerTx = 1;
    _price = 1 ether;
    _artist = 0x191F074d2dcD2d4C69E5fCd1Ab4E206C9AB6Fa78;
