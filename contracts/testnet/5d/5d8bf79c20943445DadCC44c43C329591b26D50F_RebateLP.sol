...
contract RebateLP is Operator, HasBlacklist, CanPause, HasPOL, HasFactory, HasRouter {
    ...
    function getLpAmount(address _tokenA, address _tokenB, uint256 _amountBDesired) public view returns (uint256) {
    ...
    function getEstimateLpAmountAddLp(
        ...
        return getLpAmount(_tokenA, _tokenB, _amountBDesired);
    }
