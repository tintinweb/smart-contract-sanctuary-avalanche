...
// File: contracts/AutenticacaoDigital.sol
...
contract AutenticacaoDigital is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("AutenticacaoDigital", "ADT") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://teste.autenticacaodigital.com/metadata/";
    }

    function safeMint(address to, string memory documentHash) public onlyOwner {
        uint256 tokenId = _tokenIdCounter.current(  );
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, documentHash);
    }
