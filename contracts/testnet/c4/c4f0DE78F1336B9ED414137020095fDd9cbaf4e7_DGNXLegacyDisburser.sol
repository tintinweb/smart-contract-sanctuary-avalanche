...
contract DGNXLegacyDisburser is ReentrancyGuard, Ownable {
    ...
    mapping(address => uint256) private lastPayoutBlock;
    ...
    function claimStart() external _isStarted _allowedToClaim {
        ...
        lastPayoutBlock[_msgSender()] = block.timestamp;
    ...
    function claim() external _isStarted _allowedToClaim {
        ...
        emit Claim(lastPayoutBlock[_msgSender()], _msgSender(), claimable);
    }
        ...
        )
    {
        ...
        uint256 _timeBehind = block.timestamp - lastPayoutBlock[_msgSender()];
