    ...
    IDelegator
{
    ...
    function changeOwner(address payable newOwner) external override {
        _delegatecall(abi.encodeWithSelector(
    ...
    function allowance(address owner, address spender) external view override returns (uint256 allowance) {
        bytes memory data = _staticcall(abi.encodeWithSelector(
