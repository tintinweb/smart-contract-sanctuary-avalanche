...
// File: contracts/timelock-factory.sol
...
interface TimeLock {
    function lock(address _to, uint _amount, uint _time) external;
    function unlock(address _from, uint _amount) external;
    function getLockedAmount(address _to) external;
    function getLockedTime(address _to) external;
    function getLocked(address _to) external;
    function getUnlockedAmount(address _from) external;
    function getUnlocked(address _from) external;
}
...
contract TimeLockedWalletFactory is Ownable {
    ...
    event Locked(address wallet, address from, address to, uint256 amount, uint256 lockedAt);
    event Unlocked(address wallet, address from, address to, uint256 amount, uint256 unlockedAt);
}