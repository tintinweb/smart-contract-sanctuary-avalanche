...
contract TestGenesis is ERC721, ERC721Burnable, Ownable, BusinessAddresses, Creator, NonFungibleType, TransferFee, ReentrancyGuard, Withdrawable {
    ...
    constructor() ERC721("TestGenesis", "TG") {
        ...
        _setGenesis(1, 0x0000000000000000000000000000000000000000, 100000000000000000, 500);
    ...
    function buyNFT(uint256 typeId, uint256 quantity) external payable notContract nonReentrant {
        address account = _msgSender();
        ...
        if (genesis.paymentToken == address(0)) {
            ...
            require(IERC20(genesis.paymentToken).transferFrom(account, feeBeneficiary, total), REVERT_INSUFFICIENT_BALANCE);
        }
