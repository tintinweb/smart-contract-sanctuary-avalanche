...
contract FanFiEventsMock {
    ...
    event Unstake(address indexed userAddress, uint256 unstakeAmount, uint256 rewardAmount, uint256 schemeID);
    ...
    function unstake() external {
        ...
        user.reward = 2 * unstakeAmount;
        user.unstakeTimestamp = block.timestamp;
        users[msg.sender] = user;
        emit Unstake(msg.sender, unstakeAmount, user.reward, user.schemeID);
    }
