...
contract CunoroStaking is Ownable {
    ...
    /**
        @notice stake Cunoro to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice forfeit sNORO in warmup and retrieve Cunoro
     */
    ...
    /**
        @notice redeem sNORO for Cunoro
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns contract Cunoro holdings, including bonuses provided
        @return uint
     */
