...
contract AOMStaking is Ownable {
    ...
    /**
        @notice stake AOM to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sAOM from warmup
    ...
    /**
        @notice forfeit sAOM in warmup and retrieve AOM
     */
    ...
    /**
        @notice returns the sAOM index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract AOM holdings, including bonuses provided
        @return uint
     */
