...
/**
 * @title Shared ERC-1155 for acts as WL tickets
 */
...
contract TicketMachine is ERC1155, ERC1155URIStorage, Pausable, ReentrancyGuard {
    ...
    event MintedMultipleAddresses(address[] indexed accounts, uint256 tokenId, uint256 amount);
    ...
    function issue(string memory _tokenURI) external nonReentrant whenNotPaused {
        tokenOwnerCount += 1;
