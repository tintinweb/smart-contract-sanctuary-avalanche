...
contract DiamondbankStaking is Ownable {
    ...
    /**
     * @notice adjustment APY
     * @param _distributor uint256
     */
    function adjustmentAPY(uint256 _distributor) external onlyManager() {
        epoch.distribute += _distributor;
    }

    /**
     * @notice reset fee wallet address
     * @param _feeWallet address
     */
    function resetFeeWallet(address _feeWallet) external onlyManager() {
     ...
     /**
     * @notice reset fee unstake fee
     * @param _unstakeFee fee uint256
     */
    ...
    /**
     * @notice reset unstake period
     * @param _unstakePeriod unstake period uint256
     */
