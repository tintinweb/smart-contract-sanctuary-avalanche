...
contract Ash is Ownable, ERC721, NonblockingReceiver {

    address public _owner;
    string private baseURI;
    uint256 public nextTokenId;
    uint256 public maxMint;
    uint256 GIFT_RESERVED = 10;

    uint gasForDestinationLzReceive = 350000;

    constructor(uint256 _nextTokenId , uint256 _maxMint , string memory baseURI_, address _layerZeroEndpoint) ERC721("testoflight", "tol") {
        _owner = msg.sender;
