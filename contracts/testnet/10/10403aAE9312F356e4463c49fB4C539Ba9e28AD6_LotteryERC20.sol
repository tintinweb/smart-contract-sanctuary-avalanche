...
import "./ILottery.sol";
import "./lottery/ILotteryERC20Immutables.sol";

/// @title The interface for a Lottery
/// @notice A Lottery
/// @dev The lottery interface is broken up into many smaller pieces
interface ILotteryERC20 is ILotteryERC20Immutables, ILottery {
...
/// @title Lottery ERC20 state that never changes
/// @notice These parameters are fixed for a lotter forever, i.e., the methods will always return the same values
interface ILotteryERC20Immutables {
    /// @notice The ERC20 token used for the lottery
...
import "./interfaces/ILotteryERC20.sol";
...
contract LotteryERC20 is ILotteryERC20, Ownable, Pausable, ReentrancyGuard, VRFConsumerBaseV2 {
    ...
    /// @inheritdoc ILotteryERC20Immutables
