...
contract TournamentERC20 is Ownable, ITournament {
    ...
    constructor ( address _token, uint256 _initialPeriodSeconds, uint256 _periodSeconds, uint256 _decaySeconds, uint256 _TotalBurn, uint256 _TotalWinnings, uint256 _ticketSize, uint256 _potShare, uint256 _burnShare, address _treasury) {
    ...
    function buy() external payable {
        ...
        require(claimed == true || block.timestamp < lastTs + PERIOD || lastTs != 0, "Winner hasn't claimed"); //Prevents buying ticket if winner hasn't claimed prize.
    ...
    function claimWinner() external {
        ...
        rewardToken.transfer(winner, finalPotSize);
