...
contract HumbleLuckBall is ParticipantVaultStorage, Context {
    ...
    event Elected(uint256 indexed cycleID, address indexed electedAddress, bool systemHold, uint256 amount);
    ...
    onlyAdmin {
        ...
        _rng.setNumberMax(uint64(_cyclesManager.getNumberOfParticipants()));
    ...
    function _runElections(uint256 nbTickets) internal {
        ...
        do {
            ...
            if (ticketNumber != 0) {
                ...
                emit Elected(cycleID, elected, systemHold, blockReward);
