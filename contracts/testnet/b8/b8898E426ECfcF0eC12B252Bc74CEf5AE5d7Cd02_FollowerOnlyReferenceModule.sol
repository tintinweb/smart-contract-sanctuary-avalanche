...
contract FollowerOnlyReferenceModule is FollowValidationModuleBase, IReferenceModule {
  ...
  /**
   * @notice Validates that the reactioner profile's owner is a follower.
   *
   * NOTE: We don't need to care what the pointed publication is in this context.
   */
  function processReaction(
    ...
    address reactionCreator = IERC721(HUB).ownerOf(profileId);
    _checkFollowValidity(profileIdPointed, reactionCreator);
  }
}
