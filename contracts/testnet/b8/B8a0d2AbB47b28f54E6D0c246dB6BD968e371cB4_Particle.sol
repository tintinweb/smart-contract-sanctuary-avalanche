...
{
    address public immutable particlesManager;
    ...
    constructor(address _particlesManager) ERC20("Particle Testnet", "PCTL") {
        require(
            _particlesManager != address(0),
        ...
        onlyParticlesManager
    {
        require(
            ...
            "Particle: Use liquidityReward to reward liquidity"
        );
        super._mint(account, amount);
    }

    function liquidityReward(uint256 amount) external onlyParticlesManager {
        require(
            address(liquidityPoolManager) != address(0),
            "Particle: LiquidityPoolManager is not set"
        );
    ...
    {
        super._mint(msg.sender, 5000000 * 10**18 );
    }
}
