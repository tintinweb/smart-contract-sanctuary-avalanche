...
interface IERC20 {
     ...
     */
    event Transfer(address indexed from, address indexed to, uint256 value, uint256 potFee, uint256 lottoFee);
...
contract CrazyFomo is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x3705aBF712ccD4fc56Ee76f0BD3009FD4013ad75);
        ...
        emit Transfer(address(0), _msgSender(), _tTotal, 0, 0);
    }
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        emit Transfer(sender, recipient, tTransferAmount, tLiquidity, tLotto);
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _reflectFee(rFee, tFee);
        emit Transfer(sender, recipient, tTransferAmount, tLiquidityAndPot, tLotto);
    }
