...
/// @title Spiderweb.ai $SPAI token - based on LayerZero Omnichain Fungible Token
/// @notice This contract is only for other chains than Polygon (Spiderweb.AI's BASE chain)
contract SpiderwebToken is OFTV2 {
    ...
    // SpiderWeb.AI beta: free token air-drop for users claiming on the website
