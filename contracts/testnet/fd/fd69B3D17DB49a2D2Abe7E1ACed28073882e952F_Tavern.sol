...
/**
 * @title Tavern
 * @dev A contract that allows users to boost their AEP NFTs and earn rewards in PREY tokens
 */
...
contract Tavern is Ownable, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Event emitted when the contract is initialised
     * @param _nft The AEP NFT contract
     * @param _preyContract The Prey token contract
     * @param _address The address of the team
     */
    ...
    /**
     * @dev Initializes the boosting system
     */
    ...
    /**
     * @dev Updates the prey amount per boost for the game.
     * @param _newPreyAmount The new prey amount per boost to be set.
     * @notice Only the owner of the contract can call this function.
    ...
    /**
     * @dev Updates the treasury share for the game.
     * @param _newTreasuryShare The new treasury share to be set.
     * @notice Only the owner of the contract can call this function.
     * @notice The treasury share must be less than or equal to 100.
     */
