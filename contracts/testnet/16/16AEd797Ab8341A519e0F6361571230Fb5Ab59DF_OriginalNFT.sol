...
contract OriginalNFT is ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    address USDCAddress;
    uint32 public preSaleStartTime = 222;
    uint32 public publicSaleStartTime = 333;
    ...
    event Mint(address indexed to, uint256[] indexed tokenIds);
    ...
    function presaleMint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount <= maxMintPerWallet, "Mint exceeds maximum");
        require(
            _mintAmount + totalMinted[_msgSender()] <= maxMintPerWallet,
            "Mint exceeds maximum"
        );
        require(supply + _mintAmount <= maxSupply, "Mint exceeds supply");
