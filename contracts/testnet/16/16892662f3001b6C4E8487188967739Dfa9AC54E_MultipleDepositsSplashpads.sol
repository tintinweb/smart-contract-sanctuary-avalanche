...
contract MultipleDepositsSplashpads {
    ...
    function getDeposit(uint256 _depositId) public view returns(uint256 id, uint256 deposit, address owner, uint256 payout, uint256 depositTime, uint256 withdrawTime, uint256 percentage, uint256 rewardsAvailable){
        ...
        withdrawTime = deposits[_depositId].withdrawTime;
    ...
    function roll(uint256 _depositId) external {
        ...
        //Add to deposit list
        deposits[depositsCount].id = depositsCount;
        deposits[depositsCount].deposit = rewards;
        deposits[depositsCount].owner = _addr;
        deposits[depositsCount].payout = 0;
        deposits[depositsCount].depositTime = block.timestamp;
        deposits[depositsCount].withdrawTime = block.timestamp;
    ...
    function claimAll() external {
        ...
        for (uint i = 0; i < users[_addr].depositsCount;i++){
    ...
    function rollAll() external {
        ...
        //Add to deposit list
        deposits[depositsCount].id = depositsCount;
        deposits[depositsCount].deposit = _totalrewards;
        deposits[depositsCount].owner = _addr;
        deposits[depositsCount].payout = 0;
        deposits[depositsCount].depositTime = block.timestamp;
        deposits[depositsCount].withdrawTime = block.timestamp;
