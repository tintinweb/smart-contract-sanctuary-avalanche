   ...
   mapping(uint256 => bytes32) public domainSeparators;
    ...
    function permit(
      ...
      assembly {
         ...
         // keccak256("PermitRequest(address owner,address spender,uint256 value,uint256 nonce,uint256 deadline)")
         mstore(memPtr, 0xd29cde10ed6b8be5cb943a2c58043b75079c2f75210f74bd1ee089f4be0ec4d2)
      ...
      console.log("permit", owner, spender, value);
    ...
    function _updateDomainSeparator() private returns (bytes32) {
        ...
        domainSeparators[getChainID()] = newDomainSeparator;
