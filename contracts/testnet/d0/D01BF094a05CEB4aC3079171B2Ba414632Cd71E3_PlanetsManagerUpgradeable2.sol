...
contract PlanetsManagerUpgradeable2 is
    Initializable,
    ERC721Upgradeable,
    ...
    LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    function initialize() external initializer {
        ...
        changeTierSystem(
            [10000, 105000, 110000, 120000, 130000, 140000],
    ...
    function createPlanetWithTokens(
        ...
        if (planetValue >= newTierLevel[2]) {
            logTier(newTierLevel[2], int256(planetValue));
            ...
            _planets[newPlanetId] = PlanetEntity({
                ...
                rewardMult: newTierLevel[2],
                planetValue: planetValue,
                totalClaimed: 0,
                exists: true
        });
        } else if (planetValue >= newTierLevel [1]) {
            logTier(newTierLevel[1], int256(planetValue));
            ...
            _planets[newPlanetId] = PlanetEntity({
                ...
                creationTime: currentTime,
                lastProcessingTimestamp: currentTime,
                rewardMult: newTierLevel[1],
                planetValue: planetValue,
                totalClaimed: 0,
                exists: true
        });
        } else {
            logTier(newTierLevel[0], int256(planetValue));
            ...
            _planets[newPlanetId] = PlanetEntity({
                ...
                creationTime: currentTime,
                lastProcessingTimestamp: currentTime,
                rewardMult: newTierLevel[0],
                planetValue: planetValue,
                totalClaimed: 0,
                exists: true
        });
        }
        // logTier(tierLevel[0], int256(planetValue)); -> fonction original
    ...
    function _increasetier (uint256 _planetId)
        public
        returns (uint256)
    {
        PlanetEntity storage planet = _planets[_planetId];
    ...
    function setTier(
        uint256[] memory _newtierlevel
    ) public onlyOwner {
        newTierLevel = _newtierlevel;
    }
