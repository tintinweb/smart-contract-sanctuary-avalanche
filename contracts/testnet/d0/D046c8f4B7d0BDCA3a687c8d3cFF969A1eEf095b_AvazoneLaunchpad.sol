	...
	function LevelLimit(uint256 level) public view returns (uint256){
        if(level == 0){
           return 0;
            ...
            return  (HardCap * level1multiplier) / 100;
        }
        else if(level == 2){
            return  (HardCap * level2multiplier) / 100;
        }
        else if(level == 3){
            return  (HardCap * level3multiplier) / 100;
        }
        else if(level == 4){
            return  (HardCap * level4multiplier) / 100;
        }
        else if(level == 5){
            return  (HardCap * level5multiplier) / 100;
        }
        else{
            return 0;
        }
