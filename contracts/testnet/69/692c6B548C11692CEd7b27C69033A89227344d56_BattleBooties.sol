...
⠄⠄⠄⣼⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣦⠙⡅⣿⠚⣡⣴⣿⣿⣿⡆⠄
⠄⠄⣰⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⠄⣱⣾⣿⣿⣿⣿⣿⣿⠄
⠄⢀⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⢸⣿⣿⣿⣿⣿⣿⣿⣿⠄      You ready to get some CAKE anon-kun?
⠄⣸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠣⣿⣿⣿⣿⣿⣿⣿⣿⣿⠄   
⠄⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠿⠛⠑⣿⣮⣝⣛⠿⠿⣿⣿⣿⣿⠄
⢠⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣶⠄⠄⠄⠄⣿⣿⣿⣿⣿⣿⣿⣿⣿⡟⠄
⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠇⠄⠄⠄⠄⢹⣿⣿⣿⣿⣿⣿⣿⣿⠁⠄
...
contract BattleBooties is ERC721URIStorage, Ownable{

    event MintBooty (address indexed minter, uint256 startWith, uint256 times);
   
    
    uint256 public totalBooties;
    ...
    function mintBooty(uint256 _times) payable public mintEnabled {
       
        require(_times >0 && _times <= maxBatch, "Incorrect mint count");
        require(totalBooties + _times <= totalCount, "too much");
        require(msg.value == _times * price, "value error");
        payable(owner()).transfer(msg.value);
        emit MintBooty(_msgSender(), totalBooties+1, _times);
        for(uint256 i=0; i< _times; i++){
            _mint(_msgSender(), 1 + totalBooties++);
        }
    } 
    ...
    function adminMintGiveaways(address _addr) public onlyOwner {
        require(totalBooties + 1 <= totalCount, "Mint amount will exceed total collection amount.");
        emit MintBooty(_addr, totalBooties+1, 1);
        _mint(_addr, 1 + totalBooties++);
    } 
