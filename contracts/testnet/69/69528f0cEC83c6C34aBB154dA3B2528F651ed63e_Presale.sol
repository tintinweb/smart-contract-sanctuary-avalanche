...
contract Presale{
     ...
     */
     ...
     address payable public owner;
      ...
      uint256 public limitperwallet=900000000000000000000;
  ...
  function unpause() onlyowner whenPaused public {
    ...
    function calculateSolisiumforWT(uint256 amount) public view returns(uint256) 
    {
    ...
    {   
        ...
        uint256 amount = calculateSolisiumforWT(_amount);
    ...
    {     require(checkContractBalance()>=amount,"contract have not enough balance");  
          owner.transfer(amount);
            ...
            function WithdrawSolisium(uint256 amount) public onlyowner
    {
