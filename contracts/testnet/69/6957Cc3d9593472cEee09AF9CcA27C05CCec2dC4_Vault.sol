...
contract Vault is ERC20, AccessControl, ReentrancyGuard, Pausable {
  ...
  function _execute(uint256 _depositOrWithdraw,
    ...
    workStruct.canBorrowValue = canBorrowValue;
    workStruct.canRepayValue = canRepayValue;
    workStruct.targetLpValue = _targetLpValue;
    workStruct.borrowA = borrowA;
    workStruct.borrowB = borrowB;
    workStruct.repayA = repayA;
    workStruct.repayB = repayB;
