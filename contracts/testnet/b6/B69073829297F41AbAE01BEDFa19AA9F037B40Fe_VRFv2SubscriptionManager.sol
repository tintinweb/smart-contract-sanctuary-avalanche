...
// File: docs.chain.link/samples/events/avasummit/VRFv2SubscriptionManager.sol
...
contract VRFv2SubscriptionManager is VRFConsumerBaseV2 {
    ...
    function modifyGasLimit(uint32 _gasLimit) external onlyOwner {
        callbackGasLimit = _gasLimit;
    }

    function modifyRequestNumbers(uint32 _numbers) external onlyOwner {
        numWords = _numbers;
    }
