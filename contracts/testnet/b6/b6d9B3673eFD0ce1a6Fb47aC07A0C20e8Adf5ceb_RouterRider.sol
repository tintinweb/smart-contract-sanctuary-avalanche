    ...
    UUPSUpgradeable
{
    ...
    */
    ...
    function SubmitTicket(
        ...
        bytes memory payload = abi.encode(
            riderId,
            toBytes(msg.sender), //TODO: after testing, can be be converted into string
    ...
    function iReceive(
    ...
    ) external isGateway returns (uint64 _rideNo, uint256 _riderId) {
        require(
        ...
        ) = abi.decode(packet, (uint256, string, RiderMetadata, string));
    ...
    function iAck(
        ...
        _burn(riderId);
        emit CrossChainReceived(eventIdentifier, rideNo, riderId);
    }
