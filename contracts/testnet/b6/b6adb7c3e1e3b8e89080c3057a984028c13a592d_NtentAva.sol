...
pragma solidity ^0.8.9;
contract NtentAva is CustomERC721Metadata {
    ...
    mapping(address => uint256[]) public addressTokensBurned;
    ...
    function getAddressTokensBurned(address _address) public view returns (uint256[] memory tokens)  {
        tokens = addressTokensBurned[_address];
    }
    ...
    function projectTokenInfo(uint256 _projectId) view public returns (address artistAddress, uint256 pricePerTokenInWei, uint256 invocations, uint256 maxInvocations, bool active, address purchaseContract,  address dataContract, address tokenUriContract, address transferContract, uint tokensBurned, bool acceptsMintPass, uint256 mintPassProjectId) {
        ...
        tokensBurned = projects[_projectId].tokensBurned;
