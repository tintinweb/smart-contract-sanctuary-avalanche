...
contract Manager is ReentrancyGuard, Pausable, AccessControl {
  ...
  function work(
    ...
    if (currentAssetValue(msg.sender) > _targetAssetValue) {
      ...
      if (lpWithdrawAmount > 0) {
        ...
        if (lpWithdrawAmount > vaults[msg.sender].lpTokenAmount) {
          lpWithdrawAmount = vaults[msg.sender].lpTokenAmount;
        }
    ...
    else if (currentAssetValue(msg.sender) < _targetAssetValue) {
