...
contract NodeWhalesNFT is ERC721, Ownable {
    ...
    constructor() payable ERC721('Node Whales', 'NWNFT'){
        mintPrice = 3 ether;
        totalSupply = 0;
        maxSupply = 2500;
        maxPerWallet = 25;
        ownerMint = 0;
        baseTokenUri = "ipfs://QmPfLYsysQJor55CuzpFynPHuWtzHmjFznzGjKAjat8VHk/";
    ...
    function getWalletMints() public view returns (uint256) {
        ...
        if(walletMints[msg.sender] >= 0){
            userMints = walletMints[msg.sender];
        }else{
            userMints = 0;
        }
        return userMints;
