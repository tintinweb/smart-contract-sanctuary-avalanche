...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    IUniswapV2Factory private constant joeFactory =
        IUniswapV2Factory(0xE4A575550C2b460d2307b82dCd7aFe84AD1484dd);

    IUniswapV2Router02 private constant joeRouter =
        IUniswapV2Router02(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
    ...
    constructor()
    {
        ...
        //allowedPairs
        allowedPairs[ITimeBondDepository(0x36C50eD85384270D54438eb4bFfC39e4E0FB02ad)] = 0xCFb4c25D660F9bC3AfC3264A064aE8c0d96D94E2;
        allowedPairs[ITimeBondDepository(0x08C85EC42B9aC58675E5d0e0e9A8164AD6fa383A)] = 0x338883049f56a75244d3323f87aDe344e42D41Dc;

        //allowedReserves
        allowedReserves[ITimeBondDepository(0x99b7C73F31F9818F3F3b42384Fa5FE66341589DC)] = 0xC835bE222d496fBD26f509d98bb65D6C7f6c83dA;
        allowedReserves[ITimeBondDepository(0xa349818C613A4634c9949f618528E67751ea1A6b)] = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
    }
