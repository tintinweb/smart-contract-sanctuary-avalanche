...
/**
    @dev to get ERC20 token balance in blockscout explorer (no read contract section for existing ERC20 token)
 */
contract UpgradeInfinityPoolLibrary is InfinityPool{


    
	function version() override external pure returns(uint)
    {
        return 19;
    }
