...
contract OneByOne721 is ERC721Enumerable, ERC721Burnable{
    using Counters for Counters.Counter;
// variables
    address public owner; // owner of the collectable
...
// constructor
    constructor(string memory _name, string memory _ticker) ERC721( _name, _ticker){ 
        owner = msg.sender; // set the owner of the collectable
    }   
// functions
/**
