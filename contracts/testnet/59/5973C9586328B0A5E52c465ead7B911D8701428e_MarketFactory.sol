...
contract MarketFactory is ERC1155 {
    ...
    function createItem (
        ...
        return _createItem(amount, _uri, _royaltyFee, nameList, valList, _type, _tier0, _privateUri, isEncrypt, user);
    }
    ...
    function _createTier0() external {
        ...
        tier0TokenId = _createItem(MAX, "", 2, nameList, valList, NFTtype.Tier0, 0, "", false, address(this));
    }
