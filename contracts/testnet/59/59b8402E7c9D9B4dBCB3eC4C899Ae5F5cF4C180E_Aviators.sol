...
{
    address public immutable aircraftsManager;
    ...
    constructor(address _aircraftsManager) ERC20("Aviators", "WINGS") {
        require(
            _aircraftsManager != address(0),
            "Implementations: AircraftsManager is not set"
        );
        aircraftsManager = _aircraftsManager;
        ...
        onlyAircraftsManager
    {
        require(
            ...
            "Aviators: Use liquidityReward to reward liquidity"
        );
        super._mint(account, amount);
    }

    function liquidityReward(uint256 amount) external onlyAircraftsManager {
        require(
            address(liquidityPoolManager) != address(0),
            "Aviators: LiquidityPoolManager is not set"
        );
