...
contract Register is IdCard, UserData {
    ...
    function signIn(
        ...
        _signIn(username, infoHash, referral, dappId, uri);
    }
...
abstract contract Peyment is ContDataCall, ERC721Uncollectible {
    ...
    function _deposit(uint256 userId, uint256 amount) internal {
        require(_exists(userId), "Payment: deposit to non existant IdCard");
...
abstract contract ContDataCall {
    ...
    /**
     * @dev ContData eternal address on Rinkeby testnet.
     */
    constructor() {
        ContData = IContData(0x3BE0d93764C266215FfEf5891f08D248eB16a6F2);
    }
