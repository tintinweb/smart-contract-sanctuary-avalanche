...
// File: contracts/OriginMarketPlaceLight.sol
...
contract OriginMarketPlaceLight is
    Initializable,
    ERC1155Receiver,
    IERC721Receiver,
    ...
    OwnableUpgradeable
{
    ...
    uint256 public serviceFee; // 2.5 %
    uint256 constant ROYALTY_MAX = 100 * 10 ** 18; // 10%

    function initialize( address _operator, address _serviceWallet) public initializer {
   ...
   event OfferingPlaced(
    ...
    function listItem(
        ...
        require(
            ...
            "Listing start date should be in the future or now"
        );
        require(
            startDate <= endDate,
