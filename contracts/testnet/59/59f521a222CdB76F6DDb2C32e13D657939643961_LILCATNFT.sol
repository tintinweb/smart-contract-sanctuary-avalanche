...
// File: contracts/LILCAT.sol


pragma solidity ^0.8.10;


contract LILCATNFT is ERC721A, Ownable {
    string  public baseURI;
    uint256 public freeMINT = 222;
    uint256 public supplyLILCAT = 1700;
    uint256 public maxLIL = 100;
    uint256 public price   = 0.3 ether;
    mapping(address => bool) private walletCount;


    constructor() ERC721A("LIL CAT NFT", "LCNFT", 100) {
    }
    ...
    function PublicMINT(uint256 count) public payable {
        require(totalSupply() + count < supplyLILCAT, "Excedes maxsupply.");
        require(totalSupply() + 1  > freeMINT, "Public sale isnot live yet.");
        require(count < maxLIL, "Exceeds max per transaction.");
    ...
    function setSupply(uint256 _newSupplyLILCAT) public onlyOwner {
        supplyLILCAT = _newSupplyLILCAT;
    }
