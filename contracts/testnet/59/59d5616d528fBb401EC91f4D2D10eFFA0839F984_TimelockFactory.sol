...
// File: @openzeppelin/contracts-upgradeable/token/ERC20/utils/TokenTimelockUpgradeable.sol
...
// File: factory-timelock/Timelock.sol
...
contract Timelock is TokenTimelockUpgradeable {
    ...
    function initialize(
        ...
        __TokenTimelock_init(IERC20Upgradeable(_erc20Address), _beneficiaryAddress, _releaseTime);
    }
...
// File: factory-timelock/TimelockFactory.sol
...
contract TimelockFactory {
    ...
    event CreateTimelock(
        address indexed _erc20Address,
         address indexed _beneficiaryAddress,
          uint256 _releaseTime
          );
    constructor() {
        tokenImplementation = address(new Timelock());
    }
    ...
    function createTimelock(
        ...
        Timelock(clone).initialize(_erc20Address, _beneficiaryAddress, _releaseTime);
        emit CreateTimelock(_erc20Address, _beneficiaryAddress, _releaseTime);
        return clone;
    } 
