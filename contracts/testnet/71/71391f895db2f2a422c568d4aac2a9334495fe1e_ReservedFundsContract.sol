...
// File: contracts/ReservedFunds.sol
...
contract ReservedFundsContract is Ownable {
    ...
    //180 days cliff
    uint256 constant clif = 10 minutes;
    //uint256 constant clif = 179 days;
    ...
    function addWhiteList(address user, uint256 amount) external onlyOwner {
        ...
        //11-7-22 15:00
        lastUnlockTime[user] = 1667829600 + clif;
    ...
    function withdraw() external {
        ...
        require(
            block.timestamp > lastUnlockTime[msg.sender] + 1 minutes,
