  ...
  function getTokenPrice() public view returns(uint[6] memory)
   {
    ...
    return [res0,res1,boo,now_val,low_val,high_val]; // return amount of token0 needed to buy token1
   }
   function process() onlyAuthorized whenNotPaused public returns (uint) {
