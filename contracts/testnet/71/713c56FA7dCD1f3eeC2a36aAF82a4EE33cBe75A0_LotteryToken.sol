...
interface ILotteryGame {
    ...
    /// @param _provableGasLimit gas limit
...
// File contracts/token/LotteryToken.sol
...
contract LotteryToken is ILotteryToken, Ownable, ERC20 {
        ...
        ERC20("Lotto", "LOTTO")
    {
        ...
        lotteries.push(
            Lottery(
                ...
                0, //uint256 governanceReward;
                0, //uint256 communityReward;
        ...
        returns (Lottery memory finishedLotteryGame)
    {
        ...
        uint256 totalRewards = _governanceReward + _communityReward;
        uint256 rewardPoolBalance = balanceOf(rewardPool) + totalRewards;
        ...
        emit Transfer(address(this), rewardPool, totalRewards);
