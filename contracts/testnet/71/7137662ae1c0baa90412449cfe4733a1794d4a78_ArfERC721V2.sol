...
contract ArfERC721V2 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    /**
     * @dev Emitted when user uses joepeg NFT and mint ARC & ARF.
     */
    ...
    function initialize() public initializer {
        ...
        ARCAddress = Mintpeg(0xB8F76dDcbaD297a1526F984306732fc6014Eb607);
        
        NiozERC20Address = IERC20Upgradeable(
            0x7c0AA72dbd7058D0Aee8bF99391B827A3AF04878
        );

        JoepegsTokenAddress = Mintpeg(0x01662e113655Ea1b7340420Cc16Fb0eC192b4367);
     ...
     */
    function mintARC() external virtual {
        require(
            checkEpochStatus[3] &&
     ...
     */
    function mintInternalARC(uint256 epoch_id) external {
        require(
        ...
        emit ARC_Internal_Minted(msg.sender, tokenId, 3);
    }
    ...
    function mintInternalARF(uint256 epoch_id) external {
        ...
        emit ARF_Internal_Minted(msg.sender, tokenCounter, 3);
    }
     ...
     */
    function mintEggnite() external virtual {
        require(
            (checkEpochStatus[4] &&
     ...
     *
     * Requirements:
     * - msg.sender must be have joepeg NFT.
     *
     * Emits a {ARC_ARF_Minted} event.
     */
    function Joepegs(uint256 _token_id) external virtual {
        ...
        JoepegsTokenAddress.transferFrom(msg.sender, address(this), _token_id);
     ...
     */
    function JoepegsMultiple(uint256[] calldata _token_id) external virtual {
        require(
            checkEpochStatus[5] &&
        ...
        for (uint256 i = 0; i < _token_id.length; i++) {
            ...
            JoepegsTokenAddress.burn(_token_id[i]);
...
contract ERC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return (_owners[tokenId] != address(0) && _owners[tokenId] != address(0x000000000000000000000000000000000000dEaD));
    }
