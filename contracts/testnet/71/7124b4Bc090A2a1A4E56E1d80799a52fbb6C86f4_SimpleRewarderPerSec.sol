...
/**
 * This is a sample contract to be used in the MasterChefPtp contract for partners to reward
...
contract SimpleRewarderPerSec is IRewarder, Ownable, ReentrancyGuard {
    ...
    IMasterPlatypus public immutable MP;
    ...
    function onPtpReward(address _user, uint256 _lpAmount) external override onlyMP nonReentrant returns (uint256) {
        updatePool();
