...
// https://medium.com/@NFTrade/nftrades-decentralized-creator-and-community-royalties-solution-6319119ed2f6
...
contract Royalties is Ownable {
    ...
    uint256 public communityRoyalties = 2; // percentage from total NFT price

    uint256 public collectionSize = 52000; // increase the collection size so we dont run in any issue in the future
    // TODO for testnet, replace tokenFeeAddress with the correct test address
    // mainnet 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7
    // testnet 0xd00ae08403B9bbb9124bB305C09058E32C39A48c
    address public tokenFeesAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7; // WAVAX
