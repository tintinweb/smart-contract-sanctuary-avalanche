...
contract MXV3 is OFTV2 {
    ...
    constructor(address _layerZeroEndpoint, uint _initialSupply, uint8 _sharedDecimals) OFTV2("MXV3", "MXV3", _sharedDecimals, _layerZeroEndpoint) {
        _mint(_msgSender(), _initialSupply);

        maxAmountPerBuy = _initialSupply.div(100); // 1%
    }
    ...
    function seRewardToken(address value) external onlyOwner {
        rewardToken = value;
    }

    function seTotalFees(uint256 value) external onlyOwner {
        totalFees = value;
    }

    function seFeesWallet(address payable wallet) external onlyOwner {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "MXV3: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        require(
            ...
            "MXV3: amount larger than allowed"
        );
        ...
        if (
            ...
            swapAndSendToFeesWallet(feeTokens);
    ...
    function swapAndSendToFeesWallet(uint256 tokens) private {
        ...
        IERC20(rewardToken).transfer(feesWalletAddress, newBalance);
    }
