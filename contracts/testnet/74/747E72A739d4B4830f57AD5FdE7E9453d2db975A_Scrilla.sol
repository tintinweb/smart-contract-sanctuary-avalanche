...
contract RewardDistributor is IRewardDistributor {
    ...
    uint256 public _minEth = 4000000000000000;
    ...
    function depositEth() external payable override onlyToken {
        uint256 amount = rewardTok.balanceOf(address(this));
...
contract Scrilla is IERC20, Ownable {
    ...
    uint256 private constant _totalSupply = 2_00_000_000_000 * 10 ** _decimals; //Token Decimals
    ...
    uint256 public swapLimit = 3 * (10 ** _decimals);
    ...
    function swapBack() internal swapping {
        ...
        if (totalFee > 0) {
            ...
            try
                distributor.depositEth{value: amountEth}()
            {} catch {}
