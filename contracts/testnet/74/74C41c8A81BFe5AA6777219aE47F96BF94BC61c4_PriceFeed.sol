 ...
 * contract
 *
 * PriceFeed contains logic for using old prices in the event of
...
contract PriceFeed is IPriceFeed {
    ...
    // --- Dependency setters ---
    bool private addressSet = false;
    function setAddresses(address _priceAggregatorAddress) external {
     ...
     * @dev Called by Yeti functions that require a current price.
    ...
    function _chainlinkPriceChangeAboveMax(
        ...
        uint256 minPrice = YetiMath._min(currentScaledPrice, prevScaledPrice);
        uint256 maxPrice = YetiMath._max(currentScaledPrice, prevScaledPrice);
