...
contract DAWOO is ERC721URIStorage, Ownable {
  ...
  function setPublicSaleStartTime(uint256 publicSaleStartTime) public {
    _publicSaleStartTime = publicSaleStartTime;
  }

  function getPublicSaleStartTime() external view returns (uint256) {
  ...
  function mint(uint256 quantity) public payable {
    ...
    require(block.timestamp >= _publicSaleStartTime, "Public mint not open yet");
