...
contract Referral is Ownable {
    ...
    mapping(address => uint256) public referrerTiers; // user <> tiers

    mapping(uint256 => Tier) public tiers;

    uint256 public tiersIndex = 0;

    mapping(address => bytes32) public referrals; // referred <> code
    mapping(bytes32 => address) public referralOwners; // code <> owner
    ...
    function setTier(address _referrer, uint256 _tierIndex) public onlyOwner {
        referrerTiers[_referrer] = _tierIndex;
