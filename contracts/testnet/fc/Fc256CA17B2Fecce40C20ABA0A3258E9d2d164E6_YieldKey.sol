    ...
    Random
{
    ...
    address private constant BUSD_ADDRESS =
    ...
    address private constant USDC_TESTNET_ADDRESS =
     ...
     */
    function addToWhitelist(address _address) external validAddress(_address) {
     ...
     */
    function getAmountKeys() internal view returns (uint256 _amountKeys) {
        ...
        )
    {
        ...
        rewarded = stakedYieldKeys[wallet][_tokenId].rewardClaimed;
    }
