...
contract TimeKek is ERC721, Ownable {
    ...
    function getSVGContent (uint256 index, uint256 num) internal view returns (string memory) {
    ...
    */
    ...
    function getNumbersFromAddress (address tokenOwner, uint256 tokenId) private returns (uint256[] memory randomNums) {
    ...
    function getColorSet (uint256 tokenId) private view returns (uint256[] memory colorWay) {
