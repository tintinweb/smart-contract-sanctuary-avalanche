...
contract SmolrLand is ERC721Enumerable, Ownable, ReentrancyGuard, ERC2981 {
    ...
    uint256 public constant maxSupply = 14; // total land
    uint256 public price = 0 ether; // 0 AVAX
    string public baseURIExtended = "https://smolr.mypinata.cloud/ipfs/QmTbqHMpFu8zTY5UCpPH1QR5dcpRjjKrFkhVe4Np2VS9nL/"; // base ipfs url
