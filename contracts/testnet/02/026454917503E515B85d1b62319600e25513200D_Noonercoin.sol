...
contract Noonercoin is ERC20{
   ...
   uint256 public _cycleTime = 86400;
   uint256 public _fundersAmount;
   ...
   uint256[] private randomVariableArray;
   uint256[] private previousCyclesBalance;
   ...
   uint256[] private previousSigmaValues;
   uint256[] private previousBurnValues;
  ...
  function getLastMintingTimeAndStartTimeDifference() public view returns (uint256) {
    ...
    function getBurnedValuesArray() internal returns(bool) {
        isNewCycleStart = false;
        noonerwei[adminAddress] = 0;
        for(indexs=1;indexs<=1;indexs++) {
            previousCyclesTotalTokens = noonercoin[adminAddress] + transferAmount;
