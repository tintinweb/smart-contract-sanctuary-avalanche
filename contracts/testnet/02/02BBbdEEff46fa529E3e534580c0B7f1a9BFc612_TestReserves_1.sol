  ...
  ERC20
{
  ...
  function getTokenPrice() public returns(uint[6] memory)
   {
    ...
    dec = (pair.decimals()); //decimal default: 18
   ...
   function process() public onlyAuthorized whenNotPaused returns (uint[2] memory) {
