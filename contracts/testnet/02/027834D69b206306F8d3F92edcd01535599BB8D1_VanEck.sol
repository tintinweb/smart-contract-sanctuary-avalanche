...
contract VanEck is Context, IERC20, IERC20Metadata {
        ...
        returns (bool)
    {
        ...
        if (
            basketType_.upper().compareTo("PAID") ||
            ...
            // return
            return true;
        } else if (basketType_.upper().compareTo("DEDUCT")) {
    ...
    function getAddressBook() public view returns (address) {
        return _AdminMultiSig.getAddressBookContractAddress();
    }
    ...
    function _onlyAddressBook() internal view {
        ...
        require(
            ...
            "ERC20: Sender is not Address Book!"
        );
    }
