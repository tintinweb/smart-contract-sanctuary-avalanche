...
contract SalvorNFTLast is ERC1155, EIP712, Ownable {
    ...
    constructor()
    ERC1155("https://salvor.io/api/items/{id}.json")
    ...
    function redeem(NFTVoucher calldata voucher) public payable returns (uint256) {
        ...
        _safeTransferFrom(signer, msg.sender, voucher.tokenId, voucher.amount, "");
