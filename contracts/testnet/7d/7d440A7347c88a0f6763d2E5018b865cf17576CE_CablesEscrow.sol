...
// File multisol-cablesescrow/ReentrancyGuard.sol
    ...
    **/
    function gasCompensation(
        ...
        if (makerEscrow.balance == 0) {
            compensation = (_gasAmountLeft - gasleft() + 27153) * tx.gasprice;
            ...
            compensation = (_gasAmountLeft - gasleft() + 27010) * tx.gasprice;
