...
contract VesaEstate is Context, Ownable {
    // address usdc = 0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E; //mainnet
    address usdc = 0x4178112C72E5d2B8f62bE0CbEd0D2bdb602C8143; //testnet
    ...
    uint256 private totalModuleCount = 0;
    ...
    */
    function compound(address _ref, uint256 _index) public {
        checkState();
    ...
    */
    ...
    /**
    * @dev Get user referral count.
    */
	function getUserReferralCount(address addr) public view returns(uint256) {
		return users[addr].refCount;
	}
