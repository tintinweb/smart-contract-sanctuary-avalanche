...
contract BetupV2 is Initializable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable {
    ...
    function getRewardOf(
        ...
        uint256 _maxLevel = IMembershipCard(membershipAddress).getMaxLevel(_receiver);
    ...
    function withdraw(
        ...
        uint256 _maxLevel = IMembershipCard(membershipAddress).getMaxLevel(msg.sender);
    ...
    function hashCloseData(ClosingData memory data, uint256 _index) private pure returns(bytes32) {
