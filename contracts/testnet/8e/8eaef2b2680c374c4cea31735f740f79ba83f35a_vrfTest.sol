...
// File: DogeMoon/AVAX-new/__AVAX-vrf-test.sol
...
contract vrfTest is Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    event Test(uint256 randomNumber);
    
    // requestId => isFulfilled address
    mapping (uint256 => bool) public requestFulfilled;
    

    mapping (uint256 => uint256) public vrfTestArray;
    uint256 public vrfTestArrayIndex = 0;
    ...
    function runVRF(uint32 amount) public onlyOwner {
    ...
    function finishVRF(uint256 requestId, uint256 randomNumber) private {
        
        vrfTestArray[vrfTestArrayIndex] = randomNumber;
        
        emit Test(randomNumber);
    ...
    function fulfillRandomWords(
        ...
        for(uint256 i=0; i<randomWords.length; i++) {
            finishVRF(requestId, randomWords[i]);
        }
    }
