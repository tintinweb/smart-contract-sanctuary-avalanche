...
contract CarbonCrowdsale is Ownable , ReentrancyGuard {
    ...
    constructor() {
        ...
        Carbon12 = IERC20(0xA53d43718D3EdF61B3E6023Ae4cfeE7cFF8cb3Ac);

        Tokendecimals = 18;
        paused = true;

        treasury = address(msg.sender);  //Presale Funds Receiver
        ...
        WBTC = IERC20(0x346Fa0872c15dD9C9BcFB4f81dc96febb8E757DE);
        WETH = IERC20(0xde08c581E057fF089ab6FCc39ea51C73FBF96929);
        USDC = IERC20(0x1Fe0DD1509d60AC5E2490755BCd8dF2fC006F984);
        USDT = IERC20(0xd28Ba46B06E88c8129EC1279CaEAbA5abFcC2685);
