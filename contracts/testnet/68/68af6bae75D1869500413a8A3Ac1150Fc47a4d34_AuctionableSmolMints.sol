...
contract AuctionableSmolMints is ERC721A, Ownable, ERC2981 {
...
// ♥♥      ♥♥ ♥♥ ♥♥   ♥♥♥♥    ♥♥        
    ...
    function initiateEnglishAuction(
        ...
        uint256 currentTokenId = totalSupply() + _startTokenId();
        approve(auctionHouse, currentTokenId);
...
contract SmolMints is ERC721A, Ownable, ERC2981 {
    ...
    constructor(address receiver, uint96 feeNumerator) ERC721A("Magicbirds Gen 2 - The Spacebirds", "MBIRDGEN2") {
        _setDefaultRoyalty(receiver, feeNumerator);
    }
...
// ░░░▀░░░▀▀▀░▀▀▀░░▀░▀░
        ...
        returns (bool)
    {
        ...
        return MerkleProof.verify(_merkleProof, merkleRoot, leaf) && !allowlistMinted[_minter];
    }
...
// ░▀░░▒▀░▀▀▀░▀░░▀░░▀░
    ...
    function allowlistMint(bytes32[] calldata _merkleProof) external {
        ...
        if (totalSupply() > MAX_SUPPLY) revert ExceedsMaxMint();
