...
import "./EarnNodeStorageV2.sol";

contract EarnNodeV2 is EarnNodeStorageV2 {
    ...
    */
    ...
    function buyNode(Order memory order, bytes memory signature) isBlacklistedAddress nonReentrant external returns(bool){
        ...
        require(nodeNameDetails[order.NodeName] == false, "EarnNodeV1: Name is already used");
        ...
        emit nodeCreated(nodeId, _tier, msg.sender, tierDetails[_tier].tierEMnodePrice, order.NodeName);

        nodeNameDetails[order.NodeName] = true;
...
contract EarnNodeStorageV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    mapping(string => bool) public nodeNameDetails;
    ...
    */
    event nodeCreated(uint256 nodeId, uint256 tierId, address nodeOwner, uint256 EmPrice, string nodeName);
