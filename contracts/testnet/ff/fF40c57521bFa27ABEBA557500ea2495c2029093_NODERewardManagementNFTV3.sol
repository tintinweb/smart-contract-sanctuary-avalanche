    ...
    ERC721
{
    ...
    function _createNodeForAddress(
        ...
        _nodeList.push(
            NodeEntity({
                owner: _owner,
                name: name_,
                nodePos: _nodesOfUser[_owner].length - 1,
        ...
        _tokenIdToNodeListIndex[_tokenIds.current()] = totalNodesCreated + 1;
    ...
    function _burn(uint256 tokenId) internal virtual {
        ...
        // nodePos of last node will change in nodeList after swapping _nodesOfUser
        _nodeList[_nodesOfUser[_owner][_nodesOfUser[_owner].length - 1]].nodePos = nodesOfUserIndex;

        _nodesOfUser[_owner][nodesOfUserIndex] = _nodesOfUser[_owner][
            _nodesOfUser[_owner].length - 1
        ];
        _nodesOfUser[_owner].pop();
    ...
    function tokenOfOwnerByIndex(
        ...
        return _nodeList[_nodesOfUser[owner][index]].tokenId;
    }
    ...
    function allNodesOfUser(address _owner) external view returns (uint[] memory)  {
