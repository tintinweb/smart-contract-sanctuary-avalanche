...
// File: contracts/CyberGods_Soldier.sol
...
contract CyberGods_Soldier is ERC721, Pausable, Ownable {
    ...
    constructor(string memory _BASE_URI)
        ERC721("CyberGods Soldiers", "CyberGods Soldiers")
    {
        // set base uri
        BASE_URI = _BASE_URI;
    }
