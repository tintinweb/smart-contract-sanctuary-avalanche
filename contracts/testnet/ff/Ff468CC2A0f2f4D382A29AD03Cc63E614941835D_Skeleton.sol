...
contract Skeleton is ERC721Enumerable, Pausable, Restricted {
    ...
    uint256 baseRangerUpgradePrice = 20000 ether;
    uint256[4] skeletonUpgradePricesByLevel = [50000 ether, 75000 ether, 100000 ether, 200000 ether];
     ...
     */
    function mintWithNFT(uint256[] memory tokenIds) 
        external
        payable
        whenNotPaused
        onlyEOA
    ...
    /**
     * Upgrades the level of the given token
        ...
        notBlacklisted
    {
        ...
        uint256 gemPrice = sklrgr.isRanger ? 
            baseRangerUpgradePrice * sklrgr.level :
            skeletonUpgradePricesByLevel[sklrgr.level - 1];
