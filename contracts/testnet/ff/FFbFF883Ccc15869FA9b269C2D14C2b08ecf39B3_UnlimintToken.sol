...
/** Thrown if at least one user in the blocklist during the transfer proccess */
error blocklisted();
...
/**
    @title Unlimint Stablecoin
*/
contract UnlimintToken is
    Initializable,
    ERC20Upgradeable,
    ...
    UUPSUpgradeable
{
    ...
    /** Blocklisted users who cannot recieve and transfer tokens */
