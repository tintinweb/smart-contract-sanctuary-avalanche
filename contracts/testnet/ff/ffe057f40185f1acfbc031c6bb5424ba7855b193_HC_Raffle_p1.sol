 ...
 */
 contract HC_NFT_Base is Ownable {    
    ...
    function addAllowedAddress(address _address, uint _allowedNFTCount) external onlyOwner {
        ...
        require( _allowedNFTCount + totalAllowedNFTCount <= MAX_SUPPLY, "Total NFT count cannot exceed MAX_SUPPLY." );
        ...
        addressIndices[_address] = allowedAddresses.length - 1;
        totalAllowedNFTCount = totalAllowedNFTCount + _allowedNFTCount;
    }
    ...
    function removeAllowedAddress(address _address) external onlyOwner {
        ...
        totalAllowedNFTCount = totalAllowedNFTCount - (allowedAddresses[ _index ].remainingBalance);
    ...
    function decreaseNFTAllowance() internal {
        uint256 _index = addressIndices[ msg.sender ];
        allowedAddresses[ _index ].remainingBalance = (allowedAddresses[ _index ].remainingBalance) - 1;
    }
