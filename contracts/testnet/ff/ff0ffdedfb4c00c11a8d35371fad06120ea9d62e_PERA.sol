...
library SafeMath {
    ...
    */
    ...
    uint public tradingCompFee = 0; // Transaction fee rate for trading competition reward pool (0.50% of each PERA transaction)
    uint public holderFee = 0;      // Transaction fee rate for holder rewards (0.75% of each PERA transaction)
    uint public liqproviderFee = 0; // Transaction fee rate for LP token staker rewards (0.75% of each PERA transaction)
