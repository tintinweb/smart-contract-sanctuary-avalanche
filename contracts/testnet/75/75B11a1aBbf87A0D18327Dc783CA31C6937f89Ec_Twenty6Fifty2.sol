    ...
    */
    ...
    function _afterTokenTransfers(
        ...
        if(from == address(0)){ //minted
            // Remove this, trigger deposit when multiplier is pushed, add to the "mint" function in Fold.
            // Auto call set modifiers when mint is fired, which triggers the mint of the fold tokens.
