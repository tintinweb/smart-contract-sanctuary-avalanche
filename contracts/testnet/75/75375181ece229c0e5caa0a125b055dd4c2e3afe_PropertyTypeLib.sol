...
library PropertyLib {
    ...
    function calculateReward(
        ...
        require(
            block.timestamp >= self.rewardCalculationTime && self.rewardCalculationTime != 0,
        ...
        console.log("Here is the timestamp", rewardProcessedTill);
        while (rewardProcessedTill <= block.timestamp) {
            ...
            console.log("rewardProcdessedTill", rewardProcessedTill);
            console.log(rewardProcessedTill <= block.timestamp);
