...
contract BridgesOfFate is Ownable {
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules NarrowingGameEndRules{
        ...
        if (GameMap[_currentStage] <= 0) {
            ...
            totalNFTOnTitle[_globalStageNumber][true] =   _randomFortitleCapacity(11 - _globalStageNumber);
            totalNFTOnTitle[_globalStageNumber][false] =   _randomFortitleCapacity(11 - _globalStageNumber);
