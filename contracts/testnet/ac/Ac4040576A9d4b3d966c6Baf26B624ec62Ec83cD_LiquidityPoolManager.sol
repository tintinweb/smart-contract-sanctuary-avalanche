    ...
    UniverseImplementationPointer
{
    ...
    address[] public feeAddresses = [
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d), // Treasury investments (30%)
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d), // Dev (30%)
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d), // Marketing (30%)
        address(0x57d26B22b8A1d64eB165a2847AAe17D5aEF1F44d) // Donations (10%)
    ];
...
//         address[2] memory path,
    ...
    constructor(
        ...
        pair = createPairWith(path1, path2);
        leftSide = IERC20(path1);
        rightSide = IERC20(path2);
    ...
    function createPairWith(address path1, address path2) private returns (IJoePair) {
        IJoeFactory factory = IJoeFactory(router.factory());
        address _pair;
        address _currentPair = factory.getPair(path1, path2);
        if (_currentPair != address(0)) {
            _pair = _currentPair;
        } else {
            _pair = factory.createPair(path1, path2);
        }
