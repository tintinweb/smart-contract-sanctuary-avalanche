...
// File: contracts/talent-scout1.sol
...
contract TalentScout is IERC20, AccessControl, Ownable {
    ...
    uint256 public initialBurn = 5_000_000_000_000 * (10**_decimals); // 50%
    ...
    uint256 public marketingSupply = 100_000_000_000 * (10**_decimals); // 1%
