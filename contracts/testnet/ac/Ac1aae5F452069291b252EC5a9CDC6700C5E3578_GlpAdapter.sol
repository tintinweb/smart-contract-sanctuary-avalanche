...
contract GlpAdapter is Initializable, Governable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    IAggregatorV3 private constant oracle = IAggregatorV3(0x7898AcCC83587C3C55116c5230C17a6Cd9C71bad);
    IERC20Upgradeable private constant glp = IERC20Upgradeable(0xb98C334C21B1e47dB0A5d5796f0F8Cb16d2d9DFA);
    IERC20Upgradeable private constant usdc = IERC20Upgradeable(0x056e7f6c7bf70F25cd3E51F4fc3a153204D6Df5c);
    IYakStrategyV2 private constant yrt = IYakStrategyV2(0x9F597342d83AAB787331096545E95D22DC7ce7B0);
    IWhitelistController public controller;
    IJonesGlpLeverageStrategy public strategy;
    IJonesGlpStableVault public stableVault;
    ...
    IJonesGlpVault public glpVault;
    ...
    function initialize(
        ...
        stableVault = IJonesGlpStableVault(_stableVault);
    ...
    function zapToGlpEth(bool _compound, bool _rebalance) external payable nonReentrant returns (uint256) {
        _onlyEOA();
        ...
        uint256 receipts = vaultRouter.depositGlp(mintedGlp, msg.sender, _compound, _rebalance);
    ...
    function redeemYrt(uint256 _shares, bool _compound)
        external
        nonReentrant
        returns (uint256)
    {
        ...
        glpVault.transferFrom(msg.sender, address(this), _shares);
        uint256 assetsReceived = vaultRouter.redeemGlp(_shares, _compound);

        IERC20Upgradeable(glp).approve(address(yrt), assetsReceived);
  ...
  // ============ Governor Functions ============
    ...
    function updateGlpVault(address _glpVault) external onlyRole(GOVERNOR_ROLE) {
        glpVault = IJonesGlpVault(_glpVault);
    }
