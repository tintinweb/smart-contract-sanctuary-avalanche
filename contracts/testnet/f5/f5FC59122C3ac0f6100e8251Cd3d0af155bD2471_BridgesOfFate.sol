...
contract BridgesOfFate is Ownable {
    ...
    mapping(uint256 => mapping(bool => uint256)) private totalNFTOnTitle; 
    ...
    function getAllNarrowingNumber() external view returns (bool) {
...
//         }
    ...
    */
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules NarrowingGameEndRules{
        ...
        if (GameMap[_currentStage] <= 0) {
            ...
            totalNFTOnTitle[_globalStageNumber][_jumpSide] =  _randomFortitleCapacity(11 - _globalStageNumber);
    ...
    */
    ...
    function buyBackInFee(bytes32 playerId) external GameEndRules {
        uint256 buyBackFee = calculateBuyBackIn();
