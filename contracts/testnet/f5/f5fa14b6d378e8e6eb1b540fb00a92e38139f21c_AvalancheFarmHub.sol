...
contract AvalancheFarmHub {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.3 ether; //0.3 AVAX
	...
	uint256 public constant BNB_PER_TICKET = 3e17; // 0.3 AVAX
	...
	constructor(address payable wallet, address payable _developer, address payable _marketing, IBEP20 BAF_TOKEN_ADDRESS) public {
        ...
        plans.push(Plan(25, 65)); // 6.5% per day for 25 days 
        plans.push(Plan(20, 80)); // 8% per day for 20 days 
        plans.push(Plan(18, 100)); // 10% per day for 18 days 
        plans.push(Plan(15, 150)); // 15% per day for 15 days 
