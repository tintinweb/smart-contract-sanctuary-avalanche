...
contract UVICBoardroom is ShareWrapper, ContractGuard {
    ...
    uint256[] public supplyTiers = [15 ether, 250 ether, 500 ether, 750 ether, 1000 ether, 2500 ether, 5000 ether, 10000 ether, 25000 ether];
    uint256[] public maxExpansionTiers = [450, 400, 350, 300, 250, 200, 150, 125, 100];
