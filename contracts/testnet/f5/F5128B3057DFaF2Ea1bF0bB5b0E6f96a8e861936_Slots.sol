...
contract ChainlinkVRFConfigManager is Ownable {
	...
	constructor(ChainlinkVRFConfig memory _chainlinkVRFConfig) {
		// ChainlinkVRF setup
		COORDINATOR = IVRFCoordinatorV2(_chainlinkVRFConfig.vrfCoordinator);
...
contract Common is ReentrancyGuard, ChainlinkVRFConfigManager{
    using SafeERC20 for IERC20;
    ...
    constructor(ChainlinkVRFConfig memory _chainlinkVRFConfig)ChainlinkVRFConfigManager(_chainlinkVRFConfig){}
    ...
    function _transferWager(
        ...
        (bool suspended, uint256 suspendedTime) = Bankroll.isPlayerSuspendedInfo(
            msg.sender
        );
        if (suspended) {
    ...
    function getVRFFee(uint256 gasAmount) public view returns (uint256 fee) {
        ...
        // uint256 answer = 18446744073709568065;
    ...
    function _requestRandomWords(
        ...
        s_requestId = VRFCoordinatorV2Interface(COORDINATOR)
            .requestRandomWords(
                keyHash,
                subscriptionId,
