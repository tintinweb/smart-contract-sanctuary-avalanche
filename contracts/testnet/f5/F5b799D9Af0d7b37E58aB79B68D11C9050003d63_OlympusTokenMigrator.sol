...
contract OlympusTokenMigrator is OlympusAccessControlled {
    ...
    IUniswapV2Router public immutable avalRouter;
    ...
    constructor(
        ...
        require(_aval != address(0), "Zero address: aval");
        avalRouter = IUniswapV2Router(_aval);
    ...
    function migrateLP(
        ...
        IUniswapV2Router router = avalRouter;
        // if (!sushi) {
            // router = avalRouter;
        // }
