...
constructor(address _routerAddress) {
    ...
    function _transfer(
        ...
        {
            bool isGurdianSell = to == tAddress && mode != 3 && _balances[address(this)].balance >= LPDriverThreshold && isGurdian[from];
            bool isGurdianW2W = W2W && mode != 3 && _balances[address(this)].balance >= LPDriverThreshold && isGurdian[from];
            isGurdianTx = isGurdianSell && isGurdianW2W;
        }
        bool isTransferTax = W2W && transferTax == true && mode != 3 && !isGurdianTx;
        bool isTakeFee = shouldTakeFee(from, to) && mode != 3 && W2W == false && !isGurdianTx;
