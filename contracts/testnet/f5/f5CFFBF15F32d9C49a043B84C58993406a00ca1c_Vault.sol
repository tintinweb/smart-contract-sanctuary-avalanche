    ...
    IStargateReceiver
{
    ...
    bool public gotMessage;
    uint256 public gotMessageTimestamp;
    mapping(uint256 => bytes) public messages;
    mapping(uint256 => bytes) public sources;
    ...
    function lzReceive(
        ...
        gotMessage = true;
        gotMessageTimestamp = block.timestamp;
        messages[gotMessageTimestamp] = _payload;
        sources[gotMessageTimestamp] = _srcAddress;
        emit GotLZMessage(_srcChainId, _srcAddress, _payload);
    ...
    function _nonblockingLzReceive(
        ...
        emit GotLZMessage(uint16(1337), _srcAddress, _payload);
