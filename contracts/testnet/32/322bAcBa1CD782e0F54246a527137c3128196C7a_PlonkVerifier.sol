...
contract PlonkVerifier {
    ...
    uint256 constant Qmx =
        12085320366708907399693290625762412262024972784099024188358809527203371036576;
    uint256 constant Qmy =
        6093257146767940634088459279083655256130921852687091651906683961759462538026;
    uint256 constant Qlx =
        7169935604793015744645189661889021562501760029334559150333317932733034725225;
    uint256 constant Qly =
        21526523137488380118528084047329808776271162094209528617546393851442841989192;
    uint256 constant Qrx =
        20846767162992834708239792633065394052363126077674110927692559114895132061534;
    uint256 constant Qry =
        6999005238202300285626024474615123280675530442385415482335316999770380144854;
    uint256 constant Qox =
        15196545500145064733384906682095170958020814215234371937047165919723232680761;
    uint256 constant Qoy =
        881424762268263958349944185710487576066510935841672245288771019857490605138;
    uint256 constant Qcx =
        19847422163697522237574907925453730703428423540548106139257391962798443410381;
    uint256 constant Qcy =
        15501632877612454213059871078540831009877467290764550162890680088526368601169;
    uint256 constant S1x =
        15366555883278008208089740797618787124272062249734202839640820271317476153518;
    uint256 constant S1y =
        420712529103472575704781518053784323845115547063297965499784361532006604315;
    uint256 constant S2x =
        1222073027010725738126852685066797868687278962160340938949515161734771462290;
    uint256 constant S2y =
        14737655157085191670891582469987176966073287137290747745412559018528483202336;
    uint256 constant S3x =
        5727202527759267105843427480451996752427843455166379066746899100759589250421;
    uint256 constant S3y =
        1521481518259645029680120450422078908935134996789710616816061991256891266938;
    uint256 constant k1 = 2;
    uint256 constant k2 = 3;
    uint256 constant X2x1 =
        3849104269192651205109513272799645963849636614474273616420723163066813582795;
    uint256 constant X2x2 =
        5290466933819206972439169539329851674190809769963508203621412325942081502891;
    uint256 constant X2y1 =
        14947352736838467302500700347482067643766515885717253543248980713182554146293;
    uint256 constant X2y2 =
        8061445035372971368346738626497745297713104632076851455999521878200500271960;
