    ...
    ERC721Holder
{
    ...
    function getFeeCollectors()
        ...
        view
        onlyOwner
        returns (FeeCollector[] memory)
    {
        FeeCollector[] memory feeCollectorArray = new FeeCollector[](
     ...
     */
    function addFeeCollector(address _wallet, uint256 _percentage)
        public
        onlyOwner
    {
        require(_percentage <= 30000, "ERR-10");

        _feeCollectors.push(
            FeeCollector({wallet: _wallet, percentage: _percentage})
        );

        uint256 index = _feeCollectors.length;

        emit FeeCollectorCreated(index, _wallet, _percentage);
    }
    ...
    function removeFeeCollector(address _wallet) public onlyOwner {
        ...
        emit FeeCollectorRemoved(_index, _wallet);
    }
