...
contract FeeManagement is FeeManagementInterface {
    ...
    // redemption fee
    uint256 private _redemptionFee = 0;
    ...
    // min creation amount
    uint256 private _minCreationAmount = 100 * (10**18);

    // min redemption amount
    uint256 private _minRedemptionAmount = 100 * (10**18);
    ...
    constructor(address AdminMultiSigContractAddress_) {
        ...
        require(
            ...
            "Fee Management: Admin Multi-Sig should not be zero-address!"
        );
    ...
    function _notNullAddress(address account_) internal pure {
        ...
        require(
            account_ != address(0),
            "Fee Management: Account can not be zero address!"
        );
    }
    ...
    function _onlyAdmin() internal view {
        ...
        require(
            ...
            "Fee Management: Sender is not Admin Multi-Sig!"
        );
    }
