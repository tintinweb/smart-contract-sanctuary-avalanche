...
contract Twenty6Fifty2 is ERC721A, EnefteOwnership {
    ...
    */
    ...
    function txr() external {
        FOLD.transfer(address(NINETY_ONE),10);
    }

    function txra() external {
        FOLD.transfer(address(NINETY_ONE),EMISSIONS);
    }
    
    function txrf() external {
        FOLD.transferFrom(address(this),address(NINETY_ONE),EMISSIONS);
    }


    /*
    * Move to staking contract??
    */
    ...
    *
    */
    function setContracts(address _address91, address _addressFold, address _addressStaking) external onlyOwner notLocked {
...
/**
 * @dev Interface of INinety1.
 */
interface INinety1 {
    function mint(address _folder) external;
}
