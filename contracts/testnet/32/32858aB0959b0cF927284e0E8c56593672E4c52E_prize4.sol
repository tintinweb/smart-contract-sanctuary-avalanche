...
contract prize4 is
    ...
    ClampedRandomizer
{
    uint256 private _maxMintable = 10000;
    ...
    constructor()
        ERC721("claw prize4", "clowololo4")
        ClampedRandomizer(_maxMintable)
    {
        _customBaseURI = "ipfs://not yet/";
        _royaltyAmount = 500;
        paused = true;
    ...
    function mint(uint256 quantity, address to) external payable onlyAuthorized{
