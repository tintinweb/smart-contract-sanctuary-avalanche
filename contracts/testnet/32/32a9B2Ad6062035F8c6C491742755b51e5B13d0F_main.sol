...
contract main is ERC20, Ownable {
    ...
    function MakeAllFeePayment() external{
        ...
        require(feeAmount >= queryERC20Balance(sender),"you dont have enough tokens to pay the minimum required allotment");
    ...
    function MakeAllFuturePayments() external{
    	...
    	require(_fees >= queryERC20Balance(sender),"you dont have enough tokens to pay all");
    	SendFeeToken(sender,treasury,_fees);
