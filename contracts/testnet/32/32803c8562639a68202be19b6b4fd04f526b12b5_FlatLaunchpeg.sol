...
// File contracts/interfaces/IBatchReveal.sol
...
// File contracts/interfaces/IFlatLaunchpeg.sol
...
interface IFlatLaunchpeg {
    ...
    function initialize(
        ...
        IBatchReveal.BatchReveal calldata _batchRevealData,
...
// File contracts/chainlink/VRFConsumerBaseV2Upgradable.sol
...
abstract contract VRFConsumerBaseV2Upgradable is Initializable {
     ...
     */
    function initializeVRFConsumer(address _vrfCoordinator)
        internal
        onlyInitializing
    {
...
// File contracts/LaunchpegErrors.sol
...
// File contracts/BatchReveal.sol
...
abstract contract BatchReveal is IBatchReveal, VRFConsumerBaseV2Upgradable {
    ...
    mapping(uint256 => uint256) public batchRequestId;
    ...
    /// @param _s_subscriptionId Chainlink subscription Id
    ...
    function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords)
        ...
        override
    {
        uint256 _batchNumber = batchRequestId[requestId];
...
// File contracts/interfaces/IBaseLaunchpeg.sol
...
// File contracts/BaseLaunchpeg.sol
    ...
    ERC2981Upgradeable
{
    ...
    function initializeBaseLaunchpeg(
        ...
        if (
            _batchRevealData.revealStartTime > block.timestamp + 8_640_000 ||
            _batchRevealData.revealInterval > 864_000
        ) {
        ...
        revealStartTime = _batchRevealData.revealStartTime;
        revealInterval = _batchRevealData.revealInterval;
    }
...
// File contracts/FlatLaunchpeg.sol
