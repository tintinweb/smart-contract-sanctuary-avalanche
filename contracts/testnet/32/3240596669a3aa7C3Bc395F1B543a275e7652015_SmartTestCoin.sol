...
contract SmartTestCoin is ERC20 {
    ...
    address private _gameAddress = 0xf9EC2F8733C828FC490A105Ea2B1767D804e6588;
    address private _marketingAddress = 0x69e07DbffFDDF108da0B24b0351a11f383a11E9b;
    address private _legendaryAddress = 0x2386D4318DA517b93D2E5cf902121F44162Fd48F;
    address private _epicAddress = 0x4d41a1998e04D9e74bA75d34DE4De413B300F88c;
    ...
    constructor() ERC20("TEST COIN V6", "$TCV V6") {
        _coinOwner = msg.sender;
        _mint(msg.sender, _totalSupply().sub(_teamSupply().add(_investorSupply()).add(_presaleSupply())));
