...
/** 
 *  SourceUnit: c:\SYNE\Lotto-Finance-SCs\contracts\reward\RewardDistribution.sol
*/
    ...
    KeeperCompatibleInterface
{
    ...
    function _availableReward(
        ...
        uint256 to = length - 1;
        (lottoRewards, gameRewards) = isGovReward ? _availableGovernanceReward(from, to, user)
