// SPDX-License-Identifier: MIT
    ...
    contract GovernanceToken is ERC20, Ownable{
        ...
        constructor(string memory name ,string memory symbol, ITokenismWhitelist _whitelist) ERC20(name, symbol) {
       ...
       // mapping(address=>address[]) private GovernanceTokenMinted;
        ...
        function mintGovernanceToken(address to) public  {
         //   require(GovernanceTokenMinted[to] != propertyAddress,"Already assign token");
            require(to != address(0), "Invalid address: cannot mint");
           // GovernanceTokenMinted[to] = propertyAddress;
            _mint(to, 1);
            emit tokenMint(to,1);
        }

        function burnGovernanceToken(address account) public {
            //delete GovernanceTokenMinted[account];
            _burn(account, 1);
