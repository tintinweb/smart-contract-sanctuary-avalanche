...
contract Skeleton is ERC721Enumerable, Pausable, Restricted {
    ...
    address payable adminAddress = payable(0x9F523A9d191704887Cf667b86d3B6Cd6eBE9D6e9); // TO CHECK
    ...
    // [2 ether, 0, 0, 0, 0] for real launch <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    uint256[5] private generationsPriceAVAX = [20 wei, 0, 0, 0, 0]; 
    uint256[5] private generationsPriceGLOW = [0, 20000 ether, 40000 ether, 60000 ether, 80000 ether];

    uint256 private sneakyMintPriceAVAX = 2 wei; // 0.2 ether for real launch <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    constructor(address _glow, address _traits) ERC721("caca", "caca") { // <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< ("Yield Hunt - Chapter 2", "???") for real launch 
        ...
        setState(true, true, true, true); // remove for real launch <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    }
