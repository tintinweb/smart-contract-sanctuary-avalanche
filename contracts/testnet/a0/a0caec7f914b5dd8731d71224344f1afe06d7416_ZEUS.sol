...
contract NODERewardManagement {
    ...
    function createNode(address account, string memory nodeName, address referred_by) public onlySentry {
        require(
    ...
    function _compoundNode(address account, uint256 created_at, string memory nodeName) 
    external onlySentry{
...
contract ZEUS is Ownable, PaymentSplitter {
    ...
    address public tokenAddress = 0x92C25Ac5748f6EC83651E3F254B6D6Caf40c6cfB;
    ...
    function createNodeWithTokens(string memory name, address referred_by) public {
        ...
        token.transferFrom(msg.sender, address(this), nodePrice);
        nodeRewardManager.createNode(msg.sender, name, referred_by);
    }
    ...
    function cashoutReward(uint256 blocktime) public {
        ...
        token.transfer(sender, rewardAmount);
    ...
    function withdrawReferralBonus() external {
       ...
       token.transferFrom(distributionPool, address(this), total);
        token.transfer(_msgSender(), total);
    }
