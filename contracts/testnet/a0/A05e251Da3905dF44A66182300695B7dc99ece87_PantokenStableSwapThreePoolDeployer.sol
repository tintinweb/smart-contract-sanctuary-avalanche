...
interface IPantokenStableSwapLP {
    /**
...
import "./interfaces/IPantokenStableSwapLP.sol";

contract PantokenStableSwapThreePool is Ownable, ReentrancyGuard {
    ...
    IPantokenStableSwapLP public token;
    ...
    function initialize(
        ...
        token = IPantokenStableSwapLP(_LP);
...
import "../openzeppelin/contractsV4.8.1/access/Ownable.sol";
import "./PantokenStableSwapThreePool.sol";

contract PantokenStableSwapThreePoolDeployer is Ownable {
    uint256 public constant N_COINS = 3;
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(PantokenStableSwapThreePool).creationCode;
        ...
        PantokenStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
