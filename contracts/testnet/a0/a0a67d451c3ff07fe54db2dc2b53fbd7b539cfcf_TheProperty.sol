    ...
    AvaxToDollerUtils
{
    ...
    function _mintProperty(uint256 _propertyTypeIndex, string memory _name, string memory _tokenURI, address tokenOwner)
        internal
        propertyTypeExists(_propertyTypeIndex)
    {
        // create property
     ...
     */
    function presaleMint(uint256 _propertyTypeIndex, string memory _name, string memory _tokenURI, address tokenOwner)
        external
    {
