...
contract VisionOfTheEmperor is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
    ...
    address public royaltyRecipient =
        0x27eCb5ff83A431a31c863D9fa452FAC91f05C3De;
    ...
    uint256 public whitelistSpots = 250;
  ...
  function removeWhitelistUsers(address[] calldata _users) public onlyOwner {
    ...
    function setWhitelistSpots(uint256 _newLimit) external onlyOwner {
