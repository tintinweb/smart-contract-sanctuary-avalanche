...
contract BridgeProxy is Initializable, NonblockingLzAppUpgradeable {
    ...
    mapping(uint16 srcChain => mapping(bytes srcAddr => mapping(uint64 nonce => DebitInfo))) public debitInfo;
    ...
    function sendTokens(
        ...
        debitInfo[lzEndpoint.getChainId()][_srcAddress][_nonce] = DebitInfo({
            to: _to,
            amount: _amount
        });
