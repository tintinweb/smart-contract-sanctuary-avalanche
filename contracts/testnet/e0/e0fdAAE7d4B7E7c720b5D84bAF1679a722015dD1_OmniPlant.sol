...
import "interfaces/ILayerZeroEndpoint.sol"; // faire un truc plus propre ici

contract OmniPlant is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    /// @notice Constructor for the OmniPlant NFT
    ...
    /// @notice Burn OmniPlant on source chain and mint on destination chain
    ...
    function traverseChains(
        ...
        require(msg.sender == ownerOf(_tokenId), "Message sender must own the OmniPlant.");
