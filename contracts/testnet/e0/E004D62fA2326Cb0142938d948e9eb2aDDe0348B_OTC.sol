...
contract OTC is Ownable {
    ...
    address public primaryTokenAddress = 0x726573a7774317DD108ACcb2720Ac9848581F01D;
    ...
    constructor (address _router, address _primaryTokenAddress) {
    ...
    function withdrawPrimaryToken(uint256 _amount) external {
        for(uint8 i = 0; i < secondaryTokens.length; i ++) {
        ...
        IERC20(primaryTokenAddress).transfer(treasuryWallet, _amount);
    }
