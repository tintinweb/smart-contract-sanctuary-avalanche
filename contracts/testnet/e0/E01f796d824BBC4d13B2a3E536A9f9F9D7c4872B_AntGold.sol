...
contract AntGold is Initializable, ERC20Upgradeable, AccessControlUpgradeable {
    ...
    function _unstakeAnt(uint tokenId) internal {
        Avalant a = Avalant(AVALANT_CONTRACT);
        require(a.ownerOf(tokenId) == msg.sender || hasRole(ANT_CONTRACTS_ROLE, msg.sender), "Not ur ant");
...
*/
    ...
    function _mint(address to) private {
        ...
        Ant memory newAnt = Ant(nextTokenId, to, 1, string(abi.encodePacked("Ant #", Strings.toString(nextTokenId))), 0);
    ...
    function pickAnts(uint numberOfAnts) public payable {
        ...
        payable(royaltiesAddr).transfer(msg.value);
    }
    ...
    function dig(uint _tokenId) public {
        ...
        // TODO call boss contract to know if we can dig
