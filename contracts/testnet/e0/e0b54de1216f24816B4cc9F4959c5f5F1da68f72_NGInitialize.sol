...
// Type imports
import {NFTCurrentSales, MSSpinWheelRewards,HeroStars} from "./NGTypes.sol";

struct InitArgs {
    bool START_PAUSED;
    string HERO_BASE_URI;
...
contract NGInitialize is WithStorage {
    ...
    function init(
        ...
        gameConstants().WHITELIST_TIER_1 = initArgs.WHITELIST_TIER_1;
        gameConstants().WHITELIST_TIER_2 = initArgs.WHITELIST_TIER_2;
        gameConstants().WHITELIST_TIER_3 = initArgs.WHITELIST_TIER_3;
        gameConstants().WHITELIST_TIER_4 = initArgs.WHITELIST_TIER_4;
        gameConstants().NFT_MAX_WHITELIST_TIER = 5000;
        gameConstants().NFT_MAX_PRESALE_TIER = 5000;
         
        gameConstants().NFT_SALE_AMOUNT_WL = initArgs.NFT_SALE_AMOUNT_WL;
        gameConstants().NFT_SALE_AMOUNT_PRE_SALE = initArgs.NFT_SALE_AMOUNT_PRE_SALE;
        gameConstants().NFT_SALE_AMOUNT = initArgs.NFT_SALE_AMOUNT;
        gameConstants().NFT_SALE_WL_BOOST = false;
        
        if (gameConstants().NFT_SALE_MODE != NFTCurrentSales.PostSale)
        {
            gameConstants().NFT_SALE_MODE = NFTCurrentSales.None;
        }
        ...
        gameConstants().UPGRADE_TIME_INIT_SECONDS = 900;
        gameConstants().UPGRADE_TIME_PER_LEVEL_FACTOR = 500;
        ...
        gameConstants().HERO_STARS_PRESALE = HeroStars(
            5001,    // Start Range
            10000,   // End Range
            10,      // 1 Star Chance
            5,       // 2 Star Chance
        ...
        gameConstants().HERO_STARS_POSTSALE = HeroStars(
            10001,    // Start Range
            0,       // End Range
            5,      // 1 Star Chance
            2,       // 2 Star Chance
    ...
    function initMaxNFTs(uint16 maxNFTS) external onlyAdmin {
