...
contract HamsaToken is ERC20 {
    ...
    string public nativeId;

    constructor(address _owner, string memory _nativeId, uint256 _totalSupply)
        ERC20("HamsaToken", "Hamsa")
    {
        ...
        business = _owner;
        _setupDecimals(6);
        _mint(business, _totalSupply);
    }

    // 重新erc20 burn方法, business有权限调用
    function burn(address account ,uint256 amount) public virtual {
        require(msg.sender == business, "only owner can burn");
