...
contract AGTestNFT is ERC721, AccessControl  {
    ...
    constructor() ERC721("AGTestNFT", "AGTT") {
		 _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
		 _grantRole(MINTER_ROLE, msg.sender);
	}

	function mint(address assignee) public onlyRole(MINTER_ROLE){
		_safeMint(assignee, _tokenIds.current());
		 _tokenIds.increment();
	}
