...
contract AvatarNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    constructor(string memory _baseUri, address _randomizer) ERC721("AVATAR-BKWZ", "AVATAR") {
        baseUri = _baseUri;
        if(_randomizer != address(0)) randomizer = _randomizer;
    }
    ...
    function mint() external returns (uint256) {
        ...
        _setTokenURI(newNftId, IRandomizer(randomizer).getRandomAvatar().toString());
