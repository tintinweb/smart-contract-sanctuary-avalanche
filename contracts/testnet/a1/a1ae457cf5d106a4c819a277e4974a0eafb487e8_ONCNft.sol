...
/** 
 *  SourceUnit: /Users/bijianing/Onc_nft/contracts/OncNft.sol
*/
...
contract ONCNft is Context, ERC1155, Ownable {
    using Strings for uint256;
    mapping(uint256 => string) public tokenURIs;
    uint256 public autoIncreaseTokenId = 0;
    ...
    function addToken(string memory uri) public onlyOwner {
        setURI(autoIncreaseTokenId, uri);
        autoIncreaseTokenId++;
    }
}