...
contract Gambit {
    ...
    function placeBet(string memory _betId, string memory _matchId, string memory _homeTeam, uint _homeTeamScore, string memory _awayTeam, uint _awayTeamScore) external payable {
        ...
        require(matches[_matchId].isActive, "Match is not active for betting");
    ...
    function createMatches () external onlyOwner {
        _matches.push(Match("637756e704ada23e06d852c1",8,1669111200,1669110300,"Argentina",0,false,"SaudiArabia",0,false,false,false,false,true,false));
        _matches.push(Match("637756e704ada23e06d852c2",6,1669122000,1669121100,"Denmark",0,false,"Tunisia",0,false,false,false,false,true,false));
        _matches.push(Match("637756e704ada23e06d852c3",7,1669132800,1669131900,"Mexico",0,false,"Poland",0,false,false,false,false,true,false));
    ...
    function updateMatchStatus(string memory _matchId, bool _isActive) public onlyOwner {
