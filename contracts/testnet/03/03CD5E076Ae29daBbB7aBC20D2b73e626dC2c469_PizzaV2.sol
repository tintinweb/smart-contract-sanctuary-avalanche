...
contract PizzaV2 is TestUpgradeable {
...
contract TestUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, ERC20BurnableUpgradeable {
   ...
   function withdraw(uint256 amount) public onlyOwner {
      require(
      IERC20Upgradeable(address(this)).balanceOf(address(this)) >= amount,
      "Withdraw: Insufficent balance."
      );
      IERC20Upgradeable(address(this)).transfer(address(msg.sender), amount);
   }
}
