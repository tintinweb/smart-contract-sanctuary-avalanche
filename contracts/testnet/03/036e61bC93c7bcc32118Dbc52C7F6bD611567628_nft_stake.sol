...
contract nft_stake {
    ...
    function whileTime(uint256[] memory _arr, uint256 _amount) public view returns(uint256) {
    ...
    function checkTier(address _account) public view returns (uint256[3] memory) {
    	...
    	uint256 _amount = stakes_1[_account].amount;
    	uint256[] memory arr_1 = stakingTime_1[_account];
    	ls[0] = whileTime(arr_1,_amount);
    	_amount = stakes_2[_account].amount;
    	arr_1 = stakingTime_2[_account];
    	ls[1] = whileTime(arr_1,_amount);
    	_amount = stakes_3[_account].amount;
    	arr_1 = stakingTime_3[_account];
    	ls[2] = whileTime(arr_1,_amount);
    	return ls;
    }
