...
contract L0 is Ownable, ERC721, ILayerZeroReceiver {

    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 8671;
    uint256 MAX_MINT_AVALANCHE = 9264;
    ...
    function mint(uint8 numTokens) external payable {
        ...
        require(nextTokenId + numTokens - 1 < MAX_MINT_AVALANCHE, "GG: Mint exceeds supply");
