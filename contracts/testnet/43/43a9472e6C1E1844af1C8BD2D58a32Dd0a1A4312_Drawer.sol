  ...
  function draw(
    ...
    for (uint256 i = 0; i < 7; i++) {
      attributes = string(
        abi.encodePacked(
          ...
          traits[i].name(),
          '","value":"',
          traits[i].getName(isMale, toString(pieces[6 - i]))
        )
      );
    }
    ...
    string memory merged = Base64.encode(
      abi.encodePacked(
        ...
        traits[0].getContent(isMale, toString(pieces[6])),
        traits[1].getContent(isMale, toString(pieces[5])),
        traits[2].getContent(isMale, toString(pieces[4])),
        traits[3].getContent(isMale, toString(pieces[3])),
        traits[4].getContent(isMale, toString(pieces[2])),
        traits[5].getContent(isMale, toString(pieces[1])),
        traits[6].getContent(isMale, toString(pieces[0])),
