...
contract VeArt is ERC721HolderUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialize(IERC20Upgradeable _art) public initializer {
        ...
        rewardARTGenerationRate = 7716049382716000;
    ...
    */
    ...
    function setDQConfiguration(address _collection, uint256 _duration, uint256 _withdrawDuration) external onlyOwner {
    ...
    */
    ...
    function stakeNFTToBoostVeART(address _collection, uint256[] calldata _tokenIds) external payable whenNotPaused nonReentrant {
        ...
        require(msg.value >= ((price * balanceOf(msg.sender)) / _totalSupply), "Insufficient payment provided for staking the NFT(s).");
    }
