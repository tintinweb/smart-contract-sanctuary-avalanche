...
contract FRZN is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 FRZN
    ...
    constructor(
        ...
        address _devFund
    ) public ERC20("Frozenblock share", "FRZN") {
        _mint(msg.sender, 1 ether); // mint 1 FRZN Share for initial pools deployment
