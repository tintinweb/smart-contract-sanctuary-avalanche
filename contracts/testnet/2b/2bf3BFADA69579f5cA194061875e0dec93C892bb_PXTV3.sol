...
contract PXTV3 is ERC20Upgradeable, IBridgeToken {
    ...
    function getAmountOutTokens(uint256 _amount) public view returns (uint256) {
        return getAmountOut(_amount);
    }
    ...
    function estimatePxtPrice(string memory network, uint256 amount)
    external
    view
    returns (uint256)
    {
 ...
 */
    function getLatestAvaxPrice() external view returns (uint256) {
