    ...
    ReentrancyGuard
{
    ...
    constructor(string memory _baseUri, address _randomizer)
        ERC721("AVATAR-BKWZ", "AVATAR")
    {
        ...
        presaleLimit = 10;
        // startTime = 1649620800;
        startTime = 1649166421;
        merkleRoot = 0x7ddf60413494b6bf67dc9fdcbfff87fd6b1ae96aa2fe7dd1791b9c0b6b4a130c;
    }
    ...
    function mint() internal returns (uint256) {
        ...
        require(_tokenIds.current() <= 1000, "Minting is already ended.");
        ...
        payable
    {
        ...
        (bool success, ) = manager.call{value: whitelistPrice * amount}("");
    ...
    function setPrice(uint256 _whitelistPrice, uint256 _publicSalePrice)
        internal
    {
