...
contract CollateralAggregator {
    ...
    function refreshCollateral(bytes32 collateralKey, address account, uint256 value) external {
...
contract LiquidatorRewardsAggregator {
    ...
    function refreshAccumulatedRewardsPerShare(bytes32 key, uint256 value) external {
        accumulatedRewardsPerShare[key] = value;
    }

    function refreshEntries(bytes32 currencyKey, address account, uint128 claimable, uint128 entryAccumulatedRewards) external {
        entries[currencyKey][account] = AccountRewardsEntry(claimable, entryAccumulatedRewards);
    }

    function refreshInitiated(bytes32 key, address account, bool value) external {
...
contract RewardEscrowV2Aggregator {
    ...
    function refreshTotalEscrowedBalance(bytes32 key, uint256 value) external {
        _totalEscrowedBalance[key] = value;
    }

    function refreshTotalEscrowedAccountBalance(bytes32 key, address account, uint256 value) external {
...
contract SynthAggregator {
    ...
    function refreshSynthTotalSupply(bytes32 key, uint256 value) external {
        _synthTotalSupply[key] = value;
    }

    function refreshSynthBalanceOf(bytes32 key, address account, uint value) external {
