...
// File: contracts/TalentScout/TalentScout_1.sol
...
contract TalentScout is IERC20, AccessControl, Ownable {
    ...
    /* INTERFACE INSTANCES FOR TALENT STAKING, VOTING, USDT AND WAVAX  CONRACTS */
        ...
        address _adminAddress)
    {
        ...
        // _allowances[address(this)][address(presale)] = MAX;
    ...
    /* ONLY OWNER FUNCTIONS */
        ...
        //     }
        //     voterRewardDistributor = IVoteRewardDistributor(_distributor);
        //     isFeeExempt[_distributor] = true;
        // }
        ...
        function setFees( uint256 _taxAmount ) external onlyOwner {
    ...
    /* EXTERNAL OR PUBLIC FUNCTIONS */
        ...
        function approveContract(address spender, uint256 amount) public returns (bool) {
    ...
    /* INTERNAL FUNCTIONS */
        ...
        //     require(!voting.weeklyvotes() == 0, "Need Atleast 1 vote to get the reward");
        //     _basicTransfer(_sender, address(voterRewardDistributor), voterRewardFeeAmount);
        //     voterRewardDistributor.depositRewardAmount(voterRewardFeeAmount/voting.weeklyvotes());
        // }
