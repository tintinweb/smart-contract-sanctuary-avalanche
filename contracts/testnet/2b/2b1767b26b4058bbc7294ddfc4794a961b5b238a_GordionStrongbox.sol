...
// File: AVAD/GordionStrongboxAvaDice.sol
...
contract GordionStrongbox {
    ...
    // function addOwner(address[] calldata _games) external onlyOwners {
    //     for(uint i = 0; i<_games.length; i++){
    //         isGame[_games[i]] = true;
    //     }
    // }

    // function removeOwner(address[] calldata _games) external onlyOwners {
    //     for(uint i = 0; i<_games.length; i++){
    //         isGame[_games[i]] = true;
    //     }
    // }
    ...
    function splitDividend() external onlyOwners {
        ...
        uint claimableNFTReward = claimableTotal/4;
        uint gainPerNFT = claimableNFTReward / 4444;
