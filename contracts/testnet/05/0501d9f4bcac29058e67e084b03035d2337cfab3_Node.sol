...
contract Node is Initializable, OwnableUpgradeable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    IERC20 public TOKEN;
    uint256[] public tierAllocPoints;
    ...
    function initialize(uint256 _startTime) public initializer {
        ...
        enabled = true;
        dev = msg.sender;
        tierAllocPoints = [1 ether, 1 ether, 1 ether];
        tierAmounts = [50 ether, 500 ether, 5000 ether];

    }

    function setTOKEN(IERC20 _newTOKENAddress) public onlyDev {
