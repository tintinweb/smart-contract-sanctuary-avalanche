...
contract AlphaSharesLaunchPadNFT is Initializable, ERC721A, IERC2981, OwnableUpgradeable, PaymentSplitterUpgradeable {
    ...
    function setRoyaltyFees(
        ...
        // maximum that fees can be is 12.5%
        require(
            newRoyaltyFee <= (newDenominator / 8),
            "Fees are too high."
        );
 ...
 */
contract ERC721A is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721, IERC721Metadata, IERC721Enumerable {
