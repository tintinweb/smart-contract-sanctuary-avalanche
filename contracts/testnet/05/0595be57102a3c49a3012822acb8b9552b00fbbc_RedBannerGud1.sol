...
// Change Name
contract RedBannerGud1 is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;

    // Change URI
    string public baseURI = "ipfs://QmZ7hn8377ZffVfqbJsGrSgMNsXzWQkU1JSSe2y1KDYwZs/";
    ...
    uint256 public royalty = 690; // (500 / 100 = 5% royalty)
    // Change Max Per TX
    ...
    constructor() ERC721A("Red Banner Gud", "RBGUD") {
    ...
    function updateMaxSupply(uint256 _newAmount) public onlyOwner {
        maxSupply = _newAmount;
    }

    function updateMaxPerTx(uint256 _newAmount) public onlyOwner {
        maxPerTx = _newAmount;
    }

    function updateMaxPerWallet(uint256 _newAmount) public onlyOwner {
