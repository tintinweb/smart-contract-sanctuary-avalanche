    ...
    Pausable
{
    ...
    constructor(
        ...
        for (uint256 i = 0; i < _creatorzAmount; i++) {
            _tokenIDMap[i] = getNextImageID(i);
    ...
    function claim(uint256 amount) public whenNotPaused {
        require(
            ...
            "MadSkullz: error code 1001"
        );
        require(amount <= remainingFreemints(), "MadSkullz: error code 1002");
    ...
    function holderMint(uint256 amount) external payable whenNotPaused {
        require(isHolder(), "MadSkullz: error code 1003");
        require(
            step >= ContractSteps.OPEN_HOLDER,
            "MadSkullz: error code 1001"
        );
    ...
    function whitelistMint(uint256 amount) external payable whenNotPaused {
        require(isWhitelist(), "MadSkullz: 1004");
        require(
    ...
    function _mint(uint256 amount) internal whenNotPaused {
        ...
        require(msg.value >= totalCost, "MadSkullz: error code 1005");
        require(
            MAX_SUPPLY - FREEMINT_AMOUNT - totalSupply() - amount > 0,
            "MadSkullz: error code 1006"
        );
        require(amount <= MAX_MINTABLE_PER_TX, "MadSkullz: error code 1007");
        require(amount > 0, "MadSkullz: error code 1008");
    ...
    function reveal(uint256 tokenId) external whenNotPaused returns (uint256) {
        require(_exists(tokenId), "MadSkullz: error code 1009");
        require(ownerOf(tokenId) == _msgSender(), "MadSkullz: error code 1010");
        require(!(reveals[tokenId]), "MadSkullz: error code 1011");
    ...
    function autoReveal() external onlyRole(ADMIN_ROLE) {
        require(step >= ContractSteps.SOLDOUT, "MadSkullz: error code 1012");
        require(!autoRevealed, "MadSkullz: error code 1013");
    ...
    {
        require(_exists(tokenId), "MadSkullz: error code 1014");
        require(step >= ContractSteps.SOLDOUT, "MadSkullz: error code 1015");
    ...
    function earnXp(uint256 tokenId, uint256 xp)
        ...
        onlyRole(XP_ROLE)
    {
        require(_exists(tokenId), "MadSkullz: error code 1016");
    ...
    function resetXp(uint256 tokenId) public whenNotPaused onlyRole(XP_ROLE) {
        require(_exists(tokenId), "MadSkullz: error code 1017");
    ...
    {
        require(_exists(tokenId), "MadSkullz: error code 1018");
