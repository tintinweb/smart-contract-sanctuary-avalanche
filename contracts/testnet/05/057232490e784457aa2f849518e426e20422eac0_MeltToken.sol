...
contract MeltToken is MintableToken {
    ...
    mapping (address => bool) private _lpAddresses;
    ...
    function calculateTransferTaxes(address _from, address _to, uint256 _value) public returns (uint256 adjustedValue, uint256 taxAmount) {
    ...
    function addLpAddress(address lpAddress) external onlyOwner() {
        _lpAddresses[lpAddress] = true;
    }

    function remoteLpAddress(address lpAddress) external onlyOwner() {
        _lpAddresses[lpAddress] = false;
    }
