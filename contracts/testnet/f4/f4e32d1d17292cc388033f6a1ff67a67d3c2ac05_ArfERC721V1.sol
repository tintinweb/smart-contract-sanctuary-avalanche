...
contract ArfERC721V1 is ERC721Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
   ...
   // Initialization
    function initialize() public initializer {
        ...
        ARCAddress = Mintpeg(0x645F8fc706a56DFB114b9688095f5813c45fc249);
        
        NiozERC20Address = IERC20Upgradeable(
            0xF3aeDB7B1A662a42Cd7B9952DA7c024736fd9917
        );
     ...
     */
    function Joepegs(uint256 _token_id) external virtual nonReentrant{
        require(
            checkEpochStatus[5] &&
