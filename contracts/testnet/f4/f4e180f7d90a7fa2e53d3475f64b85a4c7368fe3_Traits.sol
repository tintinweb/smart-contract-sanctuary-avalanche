        ...
        returns (string memory)
    {
        ...
        string memory metadata = string(
            abi.encodePacked(
                ...
                s.isFraudster ? "Fraudster #" : "Commissioner #",
                tokenId.toString(),
                '", "description": "SEC Games is a P2E NFT game on Avalanche. Players will be able to mint, stake and earn on their NFTs, whilst also being able to steal NFTs from other players!:  https://business.com ", "image": "',
                s.isFraudster ? abi.encodePacked('https://ipfs.io/ipfs/QmXcsj4jYGGxcQ767n4hokxaAjhdfdph6CLrGVp6nLLUfP/Fraudster', Strings.toString(fvc.getClassId(tokenId)), '.jpg') : abi.encodePacked('https://ipfs.io/ipfs/QmXcsj4jYGGxcQ767n4hokxaAjhdfdph6CLrGVp6nLLUfP/Commissioner', Strings.toString(fvc.getClassId(tokenId)), '.jpg'),
                '", "attributes":',
