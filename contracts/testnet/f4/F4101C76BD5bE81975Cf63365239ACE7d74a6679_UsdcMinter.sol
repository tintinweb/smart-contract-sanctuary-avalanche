...
contract UsdcMinter is UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(address _reserveHandler, address _voyagerExecuteHandler) external initializer {
    ...
    function setVoyagerExecuteHandler(address _voyagerExecuteHandler) external onlyRole(RESOURCE_SETTER) {
        voyagerExecuteHandler = _voyagerExecuteHandler;
    }
    ...
    function mintUsdcToReserveHandler(bytes memory message, bytes calldata attestation) external {
        ...
        require(balAfter > balBefore, "Balance after minting not greater than before it");
    }
}