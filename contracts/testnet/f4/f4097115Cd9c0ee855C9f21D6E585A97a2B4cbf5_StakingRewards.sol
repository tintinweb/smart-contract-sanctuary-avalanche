    ...
    ERC1155Holder
{
    ...
    function updateStakingReward(address _vaultFactory, uint256 _marketIndex, uint256 _epochEnd, uint256 _hedgeApr, uint256 _riskApr) external onlyOwner {
        VaultFactory vaultFactory = VaultFactory(_vaultFactory);
        ...
        if(OpenStaking[_insrToken][_epochEnd] == false || OpenStaking[_riskToken][_epochEnd] == false)
            revert StakingRewardsExist();
