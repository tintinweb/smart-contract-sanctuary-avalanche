...
contract rewardToken is Initializable,OwnableUpgradeable,UUPSUpgradeable, ERC20Upgradeable, ERC20BurnableUpgradeable, Authorizable  {
    uint256 public maxSupply;

    uint256 public price;
    address private constant devAddress = 0xc0e12AF01B0bf0a4Cdc2667AbB353B7b3B0b8F42;
    ...
    function initialize(string memory name, string memory symbol, uint maxSupply_) public initializer {
        __Ownable_init();
