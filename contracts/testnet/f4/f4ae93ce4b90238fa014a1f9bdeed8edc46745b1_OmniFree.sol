...
contract OmniFree is Ownable, ERC721A, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint, uint256 _nextTokenId, uint256 _maxTokenId, uint256 _price, uint256 _freeMint) ERC721A("OmniFREE", "OF") { 
        _owner = msg.sender;
