...
contract EmeraldNodeV1 is EmeraldNodeStorageV1 {
    ...
    */
    ...
    function initialize() public initializer {
        __Ownable_init();
        nodeCounter = 1;
        EmeraldCoin = IERC20Upgradeable(0xF126e2c45b87b5b0c0aA44bFE92f831b5F01de0C);
        nodeIds = [0, 5, 10, 15, 20, 25, 35, 45];
        count = 2;
    ...
    */
    ...
    function buyNode(Order memory order, bytes memory signature) external returns(bool){
        ...
        EmeraldCoin.safeTransfer(msg.sender, owner(), tierDetails[_tier].tierNodePrice);
...
contract EmeraldNodeStorageV1 is Initializable, OwnableUpgradeable {
