...
contract DaoSwapper {
    address public constant PANGOLIN_ROUTER_ADRESSE = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921 ;
    ...
    function swapExactAVAXForTokens() public payable {
        uint amountOutMin = getLatestPrice() * 1000000000;
    ...
    function getPathForAvaxForshermix() public view returns (address[] memory) {
