...
abstract contract WithdrawableV2 is Teams, Ramppable {
  ...
  address[] public payableAddresses = [0xFC85DECE8D1d9C826DD3c6aDEFb1766D546abe3a];
  address public erc20Payable = 0xFC85DECE8D1d9C826DD3c6aDEFb1766D546abe3a;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeif2wd4ejmxbixddullagcob5gh5rxoxmdh4ves3u7win22gkw6bvi/";
...
// File: contracts/RealltestContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract RealltestContract is RamppERC721A {
    constructor() RamppERC721A("Reall test", "RTST"){}
}
