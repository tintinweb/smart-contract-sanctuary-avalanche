...
contract OneMaskNFT is ERC721, Ownable, RolesAuthority {
    ...
    string[7] public layerNames = ["Background", "Shadow", "Aura", "Base", "Shirt", "Head", "Mask"];
    ...
    function tokenURI(
        ...
        require(ownerOf[_tokenId] != address(0), "tokenURI: does not exist");
