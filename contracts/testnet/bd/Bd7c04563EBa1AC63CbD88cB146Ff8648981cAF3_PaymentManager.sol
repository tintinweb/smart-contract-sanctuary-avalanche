...
* Every marketplace contract (auctions and marketplace) requests the PaymentManager to transfer commissions, royalties and revenue shares.
...
contract PaymentManager is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
	...
	*/
	function withdrawFailedCredits(address _address) external whenNotPaused nonReentrant {
		...
		(bool successfulWithdraw, ) = payable(_address).call{ value: amount, gas: 20000}("");
