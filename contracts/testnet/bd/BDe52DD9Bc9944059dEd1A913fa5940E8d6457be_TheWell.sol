...
contract TheWell is BEP20, Whitelist {
     ...
     */
    function addLiquidity(uint256 min_liquidity, uint256 max_tokens) onlyOwner public payable returns (uint256) {
     ...
     */
    function removeLiquidity(uint256 amount, uint256 min_bnb, uint256 min_tokens) onlyOwner public returns (uint256, uint256) {
