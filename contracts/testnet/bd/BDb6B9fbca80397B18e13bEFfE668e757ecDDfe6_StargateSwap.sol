...
contract StargateSwap is Initializable {
...
function swap(
    ...
    IERC20(bridgeToken).approve(stargateRouter, qty);
    ...
    IStargateRouter(stargateRouter).swap{value:msg.value}(
        ...
        IStargateRouter.lzTxObj(300000, 0, "0x"),       // default lzTxObj
        abi.encodePacked(msg.sender),         // destination address, the sgReceive() implementer
        bytes("")                                            // bytes payload
    );
}
}
