...
contract KyberNetworkCrytal is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor()
        ERC20("Kyber Network Crytal", "KNC")
        ERC20Permit("Kyber Network Crytal")
    {}
