...
contract EventLogger is Ownable, IEventLogger {
    ...
    event ChestOrdered(address indexed chest, address indexed buyer, uint256 amount);
    ...
    function reportChestOrdered(address buyer, uint256 amount) external {
        require(isReporter[msg.sender], "not a reporter");
        emit ChestOrdered(msg.sender, buyer, amount);
    }
}