...
interface BuyNFT {
    ...
    function getGame(address _game) external view returns (uint256, uint256, uint256);
...
contract BuyNFTSub is Ownable {
    ...
    string private constant REVERT_APPROVE_NFTS = "BuyNFTSub: caller is not approve nfts";
    string private constant REVERT_INVALID_BUY_FIAT = "BuyNFTSub: Invalid buy fiat";
    string private constant REVERT_INSUFFICIENT_BALANCE = "BuyNFTSub: Insufficient balance";
    string private constant REVERT_CAN_NOT_BUY_YOUR_ORDER = "BuyNFTSub: Can not buy your order";
    ...
    function _businessFees(
        ...
        (uint256 fee, uint256 limitFee, uint256 creatorFee) = buynft.getGame(game);
    ...
    function buy(
        ...
        require(maker != account, REVERT_CAN_NOT_BUY_YOUR_ORDER);
