...
contract TokenPresale {
    ...
    uint256 public tokenPrice = 1000000; // 1000000000000000000 wei = 1000000 TLP
    ...
    function claimTokens() external {
        ...
        emit Transfer(msg.sender, address(0), claimAmount);
    }
    ...
    function pay() external payable {
        ...
        uint256 tokenAmount = (weiAmount * tokenPrice) / 1000000000000000000;
