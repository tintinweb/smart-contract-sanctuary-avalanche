...
contract OYAC_STAKING is Ownable{
    ...
    function lockedSingleReward(address Add, uint256 Tid) public view returns(uint256) {
        ...
        for (uint256 i=0; i<LockedTokenid[Add].length; i++){
            ...
            if(LockedalreadyAwarded[LockedTokenid[Add][_index]] != true &&LockedTokenid[Add][_index] == Tid && LockedTokenid[Add][_index] > 0) {
...
// 0x0a2a308c5722B227B8eF8131Fc5b8448E6a8e665 gen1
// 0xa37a39D7809d77794370FAABE9Dc5B12d2D8cbaa token