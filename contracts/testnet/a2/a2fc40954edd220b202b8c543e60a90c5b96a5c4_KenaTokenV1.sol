...
abstract contract AntiScam is Manageable {
     ...
     */
    function blacklistAddress(address _user) public onlyManager {
    ...
    OwnableUpgradeable
{
    ...
    address internal constant BURN_ADDRESS =
        0xDeADCafe00000000000000000000000662607015;
    ...
    function transferFrom(
        ...
        _approve(
            ...
            true    // If transfer already happened, then override escrow until next approve event
        );
        return true;
    }
    ...
    function _approve(
        ...
        // Do not apply Escrow for revokes, owners or managers.
    ...
    /** @dev Modifier to check all applicable rules prior to tranfer or allowance 
    */ 
    ...
    modifier whenEconomicProtectionCriteriaMet(
        ...
        if (sender == manager() || recipient == manager()) {
            ...
            if (_isLiquidityPoolAddress(sender)) {
                ...
                // Do Nothing. Must be a Peer-toPeer transfer.
            }
        }
        _;
    }
...
// Copyright Attribution: 
// The Vetabiliy aspects is a modification of CPUCoin Vestable Contract, 
