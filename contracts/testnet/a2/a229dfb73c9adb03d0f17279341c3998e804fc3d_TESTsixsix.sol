...
contract TESTsixsix is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, Randomizer {
    ...
    uint public maxPerPerson = 5;
    uint public price = 200000000000000000;
    address public royaltyAddress = 0x8bee352e4D567477bEe2AD71f32Ae64Cf270dEa6;
    uint public royalty = 500;
    ...
    constructor(
        ...
        uint[] memory _fees
    ) ERC721("TESTsixsix", "TESTsixsix") Randomizer(maxSupply) {
