...
contract ArableLiquidation is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    function flagForLiquidation(address user) public onlyFlaggable(user) returns (uint256) {
