...
import "PantosBaseToken_extended.sol";
/**
 * @title Pantos-compatible Example Token
 */
contract MyToken is PantosBaseTokenExt {
    string private constant _NAME = "EMI TEST";
    string private constant _SYMBOL = "EMITEST";
    uint8 private constant _DECIMALS = 18;

    /// @dev msg.sender receives all existing tokens.
    constructor(uint256 initialSupply)
        PantosBaseTokenExt(_NAME, _SYMBOL, _DECIMALS)
    {
...
import "Ownable.sol";
import "ERC20.sol";
import "ERC20Burnable.sol"; /* NEU */
import "IPantosToken.sol";
/**
 * @title Pantos base token
 */
abstract contract PantosBaseTokenExt is IPantosToken, ERC20, ERC20Burnable, Ownable {
