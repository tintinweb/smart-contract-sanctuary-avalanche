...
contract MarvelAVAXStaker {
    ...
    uint256[BONUS_LINES_COUNT] public ref_bonuses = [50, 30, 20, 10, 5]; // 5%, 3%, 2%, 1%, 0.5%
    ...
    constructor(address payable wallet, address payable _developer, address payable _marketing) {
