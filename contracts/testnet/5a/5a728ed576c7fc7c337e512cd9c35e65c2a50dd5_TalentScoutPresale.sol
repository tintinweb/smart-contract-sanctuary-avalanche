...
contract TalentScoutPresale is ReentrancyGuard, Ownable {
    ...
    uint256 public buyerBalance;
      // buyers balance mapping


    uint256 public salePriceUsd = 350000000000; // $0.000035
...
// }
    ...
    function withdrawAVAXDeposit() public {
        require(_avaxDeposit[msg.sender] > 0, "No AVAX deposit to withdraw");
        payable(address(this)).transfer(_avaxDeposit[payable(msg.sender)]);
