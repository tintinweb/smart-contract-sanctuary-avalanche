...
contract SegMintERC1155WhitelistManagement is
    SegMintERC1155WhitelistInterface
{
    ///////////////////////
    ////   Libraries   ////
    ///////////////////////
    ...
    // get whitelist manager address
    function getWhitelistManagerAddress() public view returns (address) {
        ...
        if (_globalSegmintingWhitelistAddressesStatus[account_]) {
            for (
                ...
                if (_globalSegmintingWhitelistAddresses[i] == account_) {
                    ...
                    _globalSegmintingWhitelistAddressesStatus[account_] = false;
                    break;
                }
            }
        }
