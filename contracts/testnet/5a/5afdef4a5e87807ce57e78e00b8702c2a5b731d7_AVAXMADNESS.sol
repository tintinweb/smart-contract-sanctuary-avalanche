...
contract AVAXMADNESS {
	...
	uint[] public					REFERRAL_PERCENTS				= [30, 20, 10, 5, 1];	// 3% 2% 1% 0.5% 0.1%
	...
	constructor(address payable _walletProject, address payable _walletDev) {
		...
		PLANS.push( TPlan(10,10) ); //1% Daily 10 Days
		PLANS.push( TPlan(20,20) ); //2% Daily 20 Days
		PLANS.push( TPlan(30,30) ); //3% Daily 30 Days
		PLANS.push( TPlan(40,40) ); //4% Daily 40 Days
		PLANS.push( TPlan(50,45) ); //4.5% Daily 50 Days
		PLANS.push( TPlan(60,50) ); //5% Daily 60 Days
