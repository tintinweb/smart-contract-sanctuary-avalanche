...
contract BlockstarLockupStakingV2 is Ownable, ReentrancyGuard {
    ...
    function withdraw() external nonReentrant {
        ...
        require(token.balanceOf(address(this)) > total_amount , "Currently Withdraw not Avalible");
        require(total_amount > 0, "Withdraw amount must be greater than zero");
        token.transfer(address(msg.sender), total_amount);
        rewardtoken.transfer(address(msg.sender), total_reward);
