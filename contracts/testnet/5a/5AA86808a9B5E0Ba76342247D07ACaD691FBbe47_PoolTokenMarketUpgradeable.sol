/**
 *Submitted for verification at testnet.snowtrace.io on 2022-10-12
*/
  ...
  ERC20PermitUpgradeable
{
  ...
  /** 
  @notice Mints a number of pool token tokens for an address.
  ...
  @param amount Amount of pool token tokens to mint in wei.
  */
  function mint(address to, uint256 amount) external override onlyRole(MINTER_ROLE) {
    _mint(to, amount);
  }

  /// @notice Burns or destroys a number of held pool token tokens for an address.
  ...
  */
  function _beforeTokenTransfer(
    ...
    if (sender != market && sender != address(0)) {
      ...
      //       ie call settlePoolUserMints and settlePoolUserRedeems on the specific pools rather than all pools.
  ...
  /**
  @notice Gets the pool token token balance of the user in wei.
