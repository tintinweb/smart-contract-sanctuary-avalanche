...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xed31F1D1eCC0a47EF188804Ace0287e6a766A733];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 1105 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXBGeEQLDuz7Gt6chczQe78ms6u6N3nfAnh9gd5AFBv7i/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1105");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1105");
...
// File: contracts/MutantSkelliesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MutantSkelliesContract is RamppERC721A {
    constructor() RamppERC721A("Mutant Skellies", "MUTANTS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/VVY1RjnejFhmxjBVGkEs/contract-metadata";
    }
}
