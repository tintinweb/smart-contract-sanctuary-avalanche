...
contract EtherClockPublicController {
    ...
    function getNumbersFromAddress (address tokenOwner, uint256 tokenId) external returns (uint256[] memory randomNums) {
        return LibEtherClock.getNumbersFromAddress(tokenOwner,tokenId);
    }
