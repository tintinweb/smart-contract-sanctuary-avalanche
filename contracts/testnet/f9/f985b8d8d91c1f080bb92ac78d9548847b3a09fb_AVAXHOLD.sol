...
// SPDX-License-Identifier: MIT 
 ...
 .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |
| |      __      | || | ____   ____  | || |      __      | || |  ____  ____  | | | |  ____  ____  | || |     ____     | || |   _____      | || |  ________    | |
| |     /  \     | || ||_  _| |_  _| | || |     /  \     | || | |_  _||_  _| | | | | |_   ||   _| | || |   .'    `.   | || |  |_   _|     | || | |_   ___ `.  | |
| |    / /\ \    | || |  \ \   / /   | || |    / /\ \    | || |   \ \  / /   | | | |   | |__| |   | || |  /  .--.  \  | || |    | |       | || |   | |   `. \ | |
| |   / ____ \   | || |   \ \ / /    | || |   / ____ \   | || |    > `' <    | | | |   |  __  |   | || |  | |    | |  | || |    | |   _   | || |   | |    | | | |
| | _/ /    \ \_ | || |    \ ' /     | || | _/ /    \ \_ | || |  _/ /'`\ \_  | | | |  _| |  | |_  | || |  \  `--'  /  | || |   _| |__/ |  | || |  _| |___.' / | |
| ||____|  |____|| || |     \_/      | || ||____|  |____|| || | |____||____| | | | | |____||____| | || |   `.____.'   | || |  |________|  | || | |________.'  | |
| |              | || |              | || |              | || |              | | | |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------' 
 ...
 *
 *   - Basic interest rate: +6% every 24 hours - only for new deposits
...
contract AVAXHOLD {
	...
	uint256 constant public PERCENT_STEP = 60;
	...
	constructor(address payable marketing, address payable dev, address payable project, uint256 startDate)  {
		...
		startUNIX = startDate; // 1648065600 // Date and time (GMT): Wednesday, 23 March 2022 20:00:00
