...
contract RootsWarehouse is IRootsWarehouse {
  ...
  function processStorageRoot(
    ...
    /// @dev The path for an account in the state trie is the hash of its address
  ...
  function getStorage(
    ...
    /// @dev The path for a storage value is the hash of its slot
