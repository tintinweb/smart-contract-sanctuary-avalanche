...
contract Staking is Ownable {
    ...
    uint256 public lotteriesBalance;
    ...
    function runLottery() public onlyOwner {
        ...
        for(uint256 j=0;j<=_lotteryCounter;j++){
            lotteriesBalance += _lotteryInfo[j].totalUsersAmount;
        }


        (uint256 tokenBalance, , , , , , , , ) = DataProvider
            .getUserReserveData(asssetToken, address(this));
        uint256 rewardAmount = tokenBalance.sub(lotteriesBalance);
    ...
    function withdraw_(uint256 lotteryCounter_) public {
        ...
        _lotteryInfo[lotteryCounter_].totalUsersAmount -= _amount;
