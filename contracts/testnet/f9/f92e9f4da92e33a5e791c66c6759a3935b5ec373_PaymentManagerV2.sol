...
*/
contract PaymentManagerV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    */
    function setWalletPercentages(uint96 _veARTPercentage) external onlyOwner {
