...
contract SimpleNftLowerGas is ERC721, Ownable {
  ...
  constructor() ERC721("Akshay", "AKS") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
buildings.push(Building ("ZERO", 0,0,0,0,0,0));

buildings.push(Building ("House",1,3,2,2,0,3));

buildings.push(Building ("Jimmy House",2,5,4,10,8,6)); buildings.push(Building ("Gallery",1,6,2,10,0,0));

buildings.push(Building ("House",1,1,2,7,8,-7));

buildings.push(Building ("Cool House",2,3,1,-9,0,-9));

buildings.push(Building ("House", 1,3,3,-4,8,2));

buildings.push(Building ("Ray House",2,5,2,-2,0,5));

buildings.push(Building ("House",2,6,1,-18,8,4));
