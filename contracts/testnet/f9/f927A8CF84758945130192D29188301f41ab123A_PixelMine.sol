...
contract PixelMine {
    ...
    address private _tokenAddress = 0x81d51FF79fa902295459ACb62ba8195a8958c704;

    address private _presaleHELMETMinter;
    address private _presaleShovelMinter;
    address private _minter;

    address private _helmetAddress = 0xCbE8a5035b5C3351eB75b82ECF0795a71Cf7400f;
    address private _shovelAddress = 0xE8C9F076a00581EEFF16850c295Fa2f0676Cc01B;
    address private _hammerAddress = 0x5464B12Bfd3734137d8CA9Fb4f56C5deBF65589A;
    address private _axeAddress = 0x71577d0B5d483Fe0418B8B302ab058305Cf5959d;
    address private _drillAddress = 0xF1e14F94fd271Df314EcA735F84b7D44b833aDB2;
    ...
    address[] internal whitelist = [
        0x664a2c7fC71c0CbB03B9302Fb3B5876aEe1D76Db
    ];
    ...
    */
    ...
    function presaleMintHELMET() public payable {
        (bool _isExist, ) = isExistInWhitelist(msg.sender);
