...
contract TestCollection is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, IERC2981, ERC165Storage {
  ...
  constructor() ERC721("Test Collection", "TC") {
    mintCount = 0;
    price = 0.5 * 10**18;
    supply = 100;
    royaltyFee = 7;
  ...
  function mint(uint256 quantity) external payable {
    ...
    require(msg.value == price * quantity, "You are not sending the correct amount");
