...
contract Davos is DavosLike {
    ...
    // --- ERC20 Data ---
    string  public constant name     = "Davos Stablecoin";
    ...
    function add(uint x, uint y) internal pure returns (uint z) {
        unchecked {
            require((z = x + y) >= x, "Davos/add-overflow");
        }
    }
    function sub(uint x, uint y) internal pure returns (uint z) {
        unchecked {
            require((z = x - y) <= x, "Davos/sub-overflow");
        }
    }
                    ...
                    bool allowed, uint8 v, bytes32 r, bytes32 s) external
    {
        ...
        require(holder == ecrecover(digest, v, r, s), "Davos/invalid-permit");
