...
contract VaporNodes is ERC20, Ownable, PaymentSplitter {
    ...
    //islem basina max alim tutar
    uint256 public maxBuy = 500000000000000000000;
    //maximum cuzdandaki miktar
    uint256 public maxWallet = 1500000000000000000000;
    //node fiyati
    ...
    function createNodeWithTokens(string memory name) external {
        ...
        nodeManager.createNode(sender, name, NodePrice);
    }
