...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x1E646f66E50869b562656c214b9C9ebe39e8FF84;
...
abstract contract SEED is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000 * 10**18; //Total supply
    ...
    uint256 public _maxTxAmount = 100000000 * 10**18; //Max tx amount
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**18; //Fee threshold for LP acquisition
    ...
    constructor ()  {
        ...
        //Fuji IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
...
contract Arc is ERC20, ERC20Burnable, ERC20Permit, ERC20VotesComp, AccessControlEnumerable {
