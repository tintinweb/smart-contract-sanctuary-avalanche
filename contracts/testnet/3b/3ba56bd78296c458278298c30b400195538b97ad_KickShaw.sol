/**
 *Submitted for verification at testnet.snowtrace.io on 2022-08-28
*/
    ...
    ERC721Burnable
{
    ...
    //tracking all purchased json

    string [] public allPurchased;
...
uint256 feeZero = 1000000000000000;
uint256 feeOne =  2500000000000000;
...
function getAllPurchasedArray() public view returns (string[] memory) {
    return allPurchased;
}
...
function arrayupdater(string[] memory _link) public {

    for (uint256 i = 0; i < _link.length; i++){
            allPurchased.push(_link[i]);   
    }
...
function mintLeague(address _receiver, string[] memory _tokenURI, uint _index, string memory _league) public payable onlyOwner {
