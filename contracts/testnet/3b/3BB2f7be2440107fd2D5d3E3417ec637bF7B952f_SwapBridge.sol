...
contract SwapBridge {
    ...
    function wrapThenBridge(
        ...
        bytes memory gatewayCallerPayload,
        uint256 gasAmount
    ) external payable {
        ...
        bridge(
            gatewayCallerAddress,
            gatewayCallerPayload,
            wrapAmount,
            gasAmount
        );
    }
    ...
    function bridge(
        ...
        (
            ...
            address refundAddress
                ...
                gatewayCallerPayload,
                (string, string, bytes, string, address)
            );

        GatewayCaller gatewayCaller = GatewayCaller(gatewayCallerAddress);
        gatewayCaller.payGasAndCallContractWithToken{value: gasAmount}(
            destinationChain,
            destinationAddress,
            payload,
            symbol,
