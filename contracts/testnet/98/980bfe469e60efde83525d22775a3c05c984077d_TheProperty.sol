...
library PoolLib {
    ...
    function getDollerInAvax(pool storage self, uint _amount) view public returns (uint) {
        ...
        paths[0] = 0xd00ae08403B9bbb9124bB305C09058E32C39A48c;
        paths[1] = self.usdc;
    ...
    ReentrancyGuardUpgradeable
{
        ...
        nonReentrant
    {
        ...
        // console.log("Processed till", processedTill);
        // console.log("rentCleared", getTaxClearedTime(tokenId));

        // Charege the claim fees.
        uint256 claimCharges = calculateClaimFee(tokenId, reward);
        // console.log("claim Fee", claimCharges);
        reward -= claimCharges;
        // console.log("Claim deducted", reward);
