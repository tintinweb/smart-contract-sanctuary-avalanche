...
import {_getBalance, _simulateAndRevert} from "../functions/Utils.sol";
import {
    ExecWithSigs,
...
contract ExecWithSigsFacet is ExecWithSigsBase, BFacetOwner {
        ...
        external
    {
        ...
        _simulateAndRevert(_service, startGas, _data);
    }
    ...
    function simulateExecWithSigsFeeCollector(
        ...
        bytes memory encodedData = _encodeFeeCollector(_data, feeCollector);
        _simulateAndRevert(_service, startGas, encodedData);
    }
    ...
    function simulateExecWithSigsRelayContext(
        ...
        bytes memory encodedData = _encodeGelatoRelayContext(
            _data,
            feeCollector,
            _feeToken,
            _fee
...
function _simulateAndRevert(
    ...
    assembly {
        ...
        mstore(0x20, sub(_startGas, gas())) // store gas after success
