...
contract aa is ERC20Detailed, Auth {
    ...
    constructor() ERC20Detailed('aa', 'aa', uint8(DECIMALS)) Auth(msg.sender) {
    ...
    function _swapTokensForBNB(uint256 tokenAmount, address receiver)
    private
    {
