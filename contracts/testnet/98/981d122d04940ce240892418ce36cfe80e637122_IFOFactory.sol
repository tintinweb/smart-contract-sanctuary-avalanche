...
contract IFOFactory is IJoeIFOIFactory, Ownable2Step {
    ...
    function setImplementation(address implementation) external onlyOwner{
        if (implementation == address(0)) revert JoeIFOFactory__CannotBeNullAddress();
 ...
 */
 interface IJoeIFOIFactory {
    error JoeIFOFactory__NumPoolInvalid();
    error JoeIFOFactory__InvalidTokenSupply();
    ...
    error JoeIFOFactory__CannotBeNullAddress();
