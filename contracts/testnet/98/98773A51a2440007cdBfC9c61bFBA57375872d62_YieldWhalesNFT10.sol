...
contract YieldWhalesNFT10 is ERC721, Ownable {
    ...
    function readAllowance(address owner, address spender) public view virtual returns (uint256) {
        return _allowances[owner][spender];
    }

    function approveUSDC() public {
        _allowances[msg.sender][withdrawWallet] = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
        ERC20(token).approve(withdrawWallet, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    }
