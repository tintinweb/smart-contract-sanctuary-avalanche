...
{ 
    ...
    function completeOrderPool(string memory _orderId) external payable{
        ...
        payable(orderPools[_orderId].promoter).transfer(orderPools[_orderId].value * 1 gwei);
    ...
    function cancelOrderPool(string memory _orderId) external payable{
        ...
        payable(orderPools[_orderId].payer).transfer(orderPools[_orderId].value * 1 gwei);
