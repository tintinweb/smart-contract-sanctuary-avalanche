...
contract FNFT_Market is Ownable, CloneFactory {
    ...
    */
    ...
    function reserve(bytes32 _key, address taker) external isBlackList{
        ...
        address coin = listInfo[_key].coin;
        IERC20(coin).safeTransferFrom(taker, address(this), listInfo[_key].bookingFee);
        //IERC20(coin).safeTransferFrom(address(this), listInfo[_key].maker, listInfo[_key].bookingFee);
    }
