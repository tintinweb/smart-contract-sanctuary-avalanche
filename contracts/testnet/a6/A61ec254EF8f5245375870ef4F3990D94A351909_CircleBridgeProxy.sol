...
contract CircleBridgeProxy is FeeOperator, Governor, Pauser, ReentrancyGuard {
    ...
    event CircleBridgeUpdated(address from, address to);
    ...
    function setCircleBridge(address _circleBridge) external onlyOwner {
        address oldCircleBridge = circleBridge;
        circleBridge = _circleBridge;
        emit CircleBridgeUpdated(oldCircleBridge, _circleBridge);
    }
}
