...
contract TraderJoeBaseProxy is AccessControlEnumerable, Pausable {
    ...
    function setFeeInPercentage(uint256 _newFee) public {
        ...
        require(_newFee <= 100, "The fee cannot be bigger than 1%");
        fee = _newFee;
    }
    ...
    /// @notice Pause all swap operations. Requirements: the caller must have the `OWNER_ROLE`.
    function pause() public virtual {
        require(hasRole(OWNER_ROLE, _msgSender()), "Must have owner role to pause");
        _pause();
    }

    /// @notice Unpause all swap operations. Requirements: the caller must have the `OWNER_ROLE`.
