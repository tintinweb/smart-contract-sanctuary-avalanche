...
abstract contract ERC2981SpaceGen2T1Royalties is ERC165, IERC2981Royalties {
...
contract SpaceGen2Test1 is ERC721Enumerable, ERC2981SpaceGen2T1Royalties, Ownable {
  using Strings for uint256;
  ...
  string private _copyright = "Surreal Psychedelic Art Collective Experience The holder of this NFT has joint permissions along with the creators (Enebula and Giallo) to use the media included in this NFT for personal or commercial uses. These uses may not be disrespectful towards others. Please enjoy our artwork! Music and Animations by: Enebula Artwork by: Giallo";

  string public baseURI = "ipfs://QmerbF3eqnn4hfDGwxsGmXvtYeLzL12YZq2q3gsRCDP9LM/";
  string public baseExtension = ".json";
  uint256 public cost = 1 ether;
  uint256 public maxSupply = 49;
  uint256 public maxDevSupply = 10;
  ...
  constructor(
  ) ERC721("Surreal Psychedelic Art Collective Experience Gen 2 Test1", "S.P.A.C.E.2-TEST1") {
    setBaseURI("ipfs://QmerbF3eqnn4hfDGwxsGmXvtYeLzL12YZq2q3gsRCDP9LM/");
    _baseTokenURI = "";
  ...
  function tokenMinter(uint256 tokenId) public view returns(address){
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(ERC721Enumerable, ERC2981SpaceGen2T1Royalties)
        returns (bool)
    {
        return
            ERC721.supportsInterface(interfaceId) ||
            ERC2981SpaceGen2T1Royalties.supportsInterface(interfaceId);
    }
