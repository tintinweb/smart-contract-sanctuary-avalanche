    ...
    ReentrancyGuardUpgradeable
{
    ...
    function processPart(
        ...
        emit UpgradeBurned(msg.sender, _order.threadUpgradeId, _order.threadUpgradeTokenId, _order.partId, "UPGRADE");
    }

    function processPart(Order memory _order, bytes memory _signature)
        external
        virtual
        onlyMaster
    {
    ...
    function mintUpgrade(
        ...
        emit UpgradeMinted(msg.sender, _order.upgradeId, tokenCounter, _order.upgradeType);
    }
    ...
    function sellAlloyConstruct(SellOrder memory _order, bytes memory _signature)
        external
        virtual
        onlyMaster
    {
