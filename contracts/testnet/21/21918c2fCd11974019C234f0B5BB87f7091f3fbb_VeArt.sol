    ...
    */
    ...
    function stakeDqItems(address _collection, uint256[] calldata _tokenIds) external payable whenNotPaused nonReentrant {
        ...
        for (uint256 i; i < len; ++i) {
            ...
            dqBoostDuration[msg.sender] += dqRarityLevels[_collection][_tokenIds[i]] * dqPools[_collection].multiplier * 3600;
        ...
        require(msg.value >= (price * (((100000 * balanceOf(msg.sender)) / _totalSupply) / 1000)), "Insufficient payment provided for staking the NFT(s).");
    }
