    ...
    ClampedRandomizer
{
    ...
    constructor(address[] memory _devList,  uint256[] memory _fees) ERC721("Testest", "TKKS") ClampedRandomizer(maxSupply) {     
    ...
    function mint(uint256 amount) public payable whenNotPaused {
        ...
        uint256 quantity = amount * packSize;
