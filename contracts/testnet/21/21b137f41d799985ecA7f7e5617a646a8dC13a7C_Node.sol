...
contract Node {
    ...
    IERC20 public constant TOKEN = IERC20(0x9abe7b244D7BA6E18294D6510313767133E5c2FF);
    uint256[] public tierAllocPoints = [1 ether, 1 ether, 1 ether];
    uint256[] public tierAmounts = [25 ether, 250 ether, 2500 ether];
    struct User {
    ...
    constructor(uint256 _startTime) public {
        ...
        dripRate = 2400000; // 2.4% of contract balance will get dripped 
