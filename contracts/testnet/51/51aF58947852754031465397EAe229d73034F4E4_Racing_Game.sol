...
contract Racing_Game is Ownable {
    ...
    uint8 public minRacers = 3; // TODO: SHOULD BE AT LEAST 5 --- min number of unique addresses to participate in race
    ...
    uint256 public raceSignupDuration = 60; // TODO: 600 -- 10 min - how long we wait for other participants (note: if all places are filled, than game should immediately start)
    uint256 public raceDuration = 20; // TODO: 60 -- 1 min - duration of racing (raceStatus = 2)
    uint256 public delayBeforeAndAfterRacing = 10; // TODO: 30
