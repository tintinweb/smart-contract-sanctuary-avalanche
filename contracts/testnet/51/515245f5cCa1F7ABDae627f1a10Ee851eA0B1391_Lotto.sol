...
contract Lotto is ILotto, VRFConsumerBaseV2 {
    ...
    address public constant WINE = 0xb9E05B4C168B56F73940980aE6EF366354357009;

    // Burn GameFi Amounts
    uint256 public WINE_BURNED_PER_TEN_TICKETS = 50 * 10**18;
    ...
    address private constant vrfCoordinator = 0x2eD832Ba664535e5886b75D64C46EB9a228C2610;
     ...
     */
    //function setSubscriptionId(uint subscriptionId_) external onlyOwner {
     ...
     */
    function setWINEBurnedPerTenTickets(uint burnedPerTen) external onlyOwner {
        require(
            burnedPerTen > 0,
            'Cannot Be Zero'
        );

        WINE_BURNED_PER_TEN_TICKETS = burnedPerTen;
    }
    ...
    /**
        ...
        The amount transferred in depends on WINE_BURNED_PER_TEN_TICKETS
    ...
    function burnWINE(uint batches) external {
        ...
        // transfer in WINE
        uint received = _transferIn(IERC20(WINE), WINE_BURNED_PER_TEN_TICKETS * batches);
        require(
            received == WINE_BURNED_PER_TEN_TICKETS * batches,
