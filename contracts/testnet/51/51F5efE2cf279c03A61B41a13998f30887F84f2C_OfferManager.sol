...
contract OfferManager {
    ...
    event OfferCancelled(uint256 index, uint256 tokenId, address offeree, uint256 offerAmount);
    event OfferSettled(uint256 index, uint256 tokenId, address offeree, uint256 offerAmount, address receiver);
    event NewOffer(uint256 index, uint256 tokenId, address offeree, uint256 offerAmount, uint256 expiry);
}