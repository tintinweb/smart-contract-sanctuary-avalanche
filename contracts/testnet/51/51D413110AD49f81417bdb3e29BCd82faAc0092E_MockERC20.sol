...
import "../../px-vaults-contracts/contracts/tokens/BaseMinterPauserERC20.sol";

contract MockERC20 is BaseMinterPauserERC20 {
    string public CONTRACT_NAME = "Random ERC20 Token";
    string public CONTRACT_SYMBOL = "RTC";

    uint256 public WEI_TO_ETH = 1000000000000000000; //1,000,000,000,000,000,000
    uint256 public CONTRACT_INITIAL_SUPPLY = 20000000 * WEI_TO_ETH; //20,000,000,000,000,000,000,000,000

    address private _owner;

    constructor(address settingsAddress)
        BaseMinterPauserERC20(settingsAddress, CONTRACT_NAME, CONTRACT_SYMBOL)
    {
        _owner = msg.sender;
...
contract BaseMinterPauserERC20 is Base, Context, ERC20Burnable {
    ...
    ) Base(settingsAddress) ERC20(name, symbol) {}
