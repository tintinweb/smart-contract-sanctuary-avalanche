...
contract TresrCoinUpgradeableV1 is ERC20Upgradeable, OwnableUpgradeable {
    ...
    uint256 constant MAX_SUPPLY = 468_531_429 * 1e18;
    ...
    function mint(address account, uint _amount) public onlyAdmin {
        uint256 amount = _amount;
        require(amount != 0, "Tresr::amount is zero");

        if(totalSupply() + _amount >= MAX_SUPPLY) {
            amount = MAX_SUPPLY - totalSupply();
        }
        require(amount != 0, "Tresr::no more supply");
