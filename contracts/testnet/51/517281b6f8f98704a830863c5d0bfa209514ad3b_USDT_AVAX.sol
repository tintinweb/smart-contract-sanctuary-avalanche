...
contract USDT_AVAX is Initializable, ERC20PermitUpgradeable, OwnableUpgradeable, WithBlockedList {
  ...
  function initialize() public initializer {
    tetherDecimals = 6;
    __Ownable_init();
    __ERC20_init("TetherToken", "USDt");
    __ERC20Permit_init("TetherToken");
  }
