...
contract Exchange is IExchange, ReentrancyGuard {
    ...
    function sellTokens(uint256 _price, uint256 _quantity) nonReentrant public onlyAdminSeller {
        ...
        // uint256 DevTokens = token.propertyOwnerReserveDevTokens(); 
        // require(token.isPropertyOwnerExist(seller) && (DevTokens > token.balanceOf(seller)),"you can not sell token more than your reserve amount" );
