...
contract NodeManagerV82 is Initializable {
    ...
    */
    ...
    function buyGiftCard(
        ...
        //if (token != address(0xd00ae08403B9bbb9124bB305C09058E32C39A48c) && mode == 0) {
        if (address(token) != uniswapV2Router.WAVAX() && mode == 0) {
            IERC20(token).transferFrom(
                address(msg.sender),
                address(operationsPoolAddress),
                amount
            );
        } else if (address(token) == uniswapV2Router.WAVAX()) {
