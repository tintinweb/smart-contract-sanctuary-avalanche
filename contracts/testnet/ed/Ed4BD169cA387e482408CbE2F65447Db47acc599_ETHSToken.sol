...
contract ETHSToken is IBEP20, Auth {
    ...
    // TraderJoe router
    address public constant ROUTER = 0xadcBe444619dE95aeDD82245d0B422288b27C895;  
    ...
    mapping(address => uint256) private localVault;
    mapping(address => uint256) private localVaultCooldowns; 

    mapping(address => bool) private lpPairs;
    
    uint256 public charityCollected = 0;
    uint256 public charityCollectedTemp = 0;
    ...
    uint256 internal lastSwap = block.timestamp;
    uint256 internal swapInterval =  60*45; // 45 minutes
    uint256 internal swapThreshold = 2 * 10 ** _decimals;

    bool internal liquidityAdded = false;
    ...
    constructor() Auth(msg.sender) {
        ...
        launchEndTime = launchStartTime + (1 * 1 minutes);
    ...
    function nodeClaimTransfer(address recipient, uint256 amount) external onlyRewardsManager {
        ...
        charityCollected += charityCollected;
    ...
    function vaultDepositTransfer(uint256 amount) external {
        ...
        charityCollected += charityCollectedTemp;
    ...
    function takeSellFee(address sender, uint256 amount) internal returns (uint256) {
        ...
        charityCollectedTemp += charityCollected;
    ...
    function shouldSwapBack() public view returns (bool) {//debugging private
    ...
    function swapBack() internal swapping islaunchTime
    {
        ...
        ETHwToAVAX(amountToSwap + treasuryTax + marketingTax + charityCollected);
