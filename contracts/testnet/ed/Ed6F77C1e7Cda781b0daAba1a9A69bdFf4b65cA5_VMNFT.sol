...
contract VMNFT is ERC721, ReentrancyGuard, Ownable {
	...
	constructor() ERC721("Vending Machines NFT", "VMNFT") {
		paused = true;
		revealed = false;
		allowListings = true;
		...
		donationAddress = 0x4057F6d0C49358B88A318DCb230f7D3140fA78de;
        wavaxAddr = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
        swapAddress = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    ...
    function mintForSwap(uint256 amount) public onlyOwner{
        uint256 newSupply = supply.current() + amount;
        ...
        for (uint256 i = 0; i < amount; i++) {
			...
			_mint(swapAddress, supply.current());
		}
    }
