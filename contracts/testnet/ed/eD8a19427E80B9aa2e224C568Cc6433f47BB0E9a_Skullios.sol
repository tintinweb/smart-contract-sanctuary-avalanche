...
contract Skullios is ERC721URIStorage, Ownable {
    ...
    constructor() ERC721("Skullios", "SKLS") {
        _customBaseURI = "ipfs://bafybeifmcuucaz7cu6pia2fs4magxvoxs7kzcqddecgzycflsyth5cjmfu/";
        _price = 0.1 ether; // 1 AVAX mint price
        _maxMintable = 666; // 10k max supply
        _maxMintPerTx = 2;
        _royaltyAmount = 750; // 7% royalties
