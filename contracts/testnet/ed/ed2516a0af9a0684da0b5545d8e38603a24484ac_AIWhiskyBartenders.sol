...
pragma solidity 0.8.13;
    ...
    contract AIWhiskyBartenders is ERC721Enumerable, Ownable, IERC2981Royalties {
        using Strings for uint256;
        
        string public baseURI = "ipfs://QmdrPtP9YcXQPukxBJdRZeoyD27gbxV6aJbEpDAYcbut5Z/";
        ...
        constructor () ERC721("Ai Whisky Bartenders", "AIBARTENDERS") {
            setRoyalties(0x66215E345cA63f100a8eb9Eb277c08210f3578BF, 1000);
            for (uint256 i = 1; i<=10; i++) {
                _safeMint(0xe3fd98fCE709Fcb728935be524304378108B492c, i);
                }
            }
