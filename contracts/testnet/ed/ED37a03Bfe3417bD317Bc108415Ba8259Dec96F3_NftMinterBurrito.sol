...
contract NftMinterBurrito is Ownable, ERC2981, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = NftMinterBurrito.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(NftMinterBurrito.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(NftMinterBurrito.ownerOf(tokenId), to, tokenId);
    }
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < NftMinterBurrito.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < NftMinterBurrito.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = NftMinterBurrito.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = NftMinterBurrito.balanceOf(from) - 1;
    ...
    constructor(string memory name_, string memory symbol_, uint256 iPrice, string memory bURI, string[] memory endings_,  address oracle_) {
        _name = name_;
        _symbol = symbol_;
        baseURI_ = bURI;
        endings = endings_;
        price = iPrice+15000000000000000;
        maxPerWallet = 5;
        oracle = oracle_;
    ...
    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmUw1XGZuj84enaSgLuNDFWJcNQJPQDFV8cw9pa2xAMPmz";
    }
    ...
    function withraw(address payable _to, uint256 amount) public onlyOwner {
        _to.transfer(amount);
    }
    ...
    function getFish(uint256 index) view public returns (uint256){
        return shrimp[index];
    }

    function currentshrimp()view public returns (uint256){
        return shrimp.length;
    }
}