...
contract AvaxStake is ReentrancyGuard {
    ...
    function stake() external payable nonReentrant {
        ...
        // check if the staker is already staking
    ...
    function unstake() external onlyStaker {
        ...
        require(_to.send(stakes[msg.sender].amount), "Failed to send AVAX to the staker");
        ...
        ), "Failed to send RXG to the staker");
    ...
    function setPaychart(uint256[] calldata _payChart) external onlyOwner {
