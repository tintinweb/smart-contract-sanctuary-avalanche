...
contract MULTIFURY_NATIVE {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 0.1 ether; // 0.1 BNB
    ...
    uint256 public constant WITHDRAW_COOLDOWN = 1 days / 4; // claim 6 times per day
