...
contract ERC20Wrapper is ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function redeem(uint tokenId) public {
        ...
        _burn(tokenId);
        require(info.token.transfer(msg.sender, info.amount), "ERC20Wrapper: transfer failed");
    }
