...
contract RubyNode is ERC721Enumerable, Ownable {
    ...
    uint256 constant GATE_1 = 60;
    uint256 constant GATE_2 = 120;
    ...
    function mintNode() public payable {
        ...
        require(
           DAIToken.balanceOf(msg.sender) > rubyNodePrice * DECIMAL_MULTIPLIER,
           "Insuffucient DAI balance"
        );

        DAIToken.transferFrom(msg.sender, address(this), rubyNodePrice * DECIMAL_MULTIPLIER);
        supply.increment();
