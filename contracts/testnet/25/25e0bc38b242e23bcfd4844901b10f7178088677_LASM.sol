...
// File: contracts/Lasm_Token_avax.sol
...
contract LASM is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("LasMeta", "LASM") {
        ...
        // Joe Router address in Avalanche Mainnet
        // IJoeRouter02 _dexRouter = IJoeRouter02(0x8923E74ce9dDc5d47eDad39859Ad07ba11889936);

        // address _lpPair = IJoeFactory(_dexRouter.factory())
    ...
    function updateDexRouter(address newAddress) external onlyOwner {
        require(newAddress != address(dexRouter), "Lasm: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(dexRouter));

        dexRouter = IJoeRouter02(newAddress);

        address _lpPair = IJoeFactory(dexRouter.factory())
            .createPair(address(this), dexRouter.WAVAX());
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != lpPair, "Lasm: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
