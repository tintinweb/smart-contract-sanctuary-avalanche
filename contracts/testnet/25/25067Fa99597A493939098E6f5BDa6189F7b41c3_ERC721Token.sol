...
contract ERC721Token {
    ...
    function ownerAllTokens(address _owner) external view returns(uint[] memory) {
...
contract ERC721ByteCodeGenerator {
    ...
    function generate(
        ...
        return abi.encodePacked(type(ERC721Token).creationCode, abi.encode(_name, _symbol, _desc, owner, _proxyGen));
    }
