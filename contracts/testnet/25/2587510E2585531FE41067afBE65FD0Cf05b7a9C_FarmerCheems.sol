...
contract FarmerCheems is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    uint256 public stakeRequired = 4000000 * 10 ** 18;
    ...
    constructor() ERC721("Farmer Cheems", "Farmer Cheems") {
        EmergencyAddress = msg.sender;
        farmingPeriod =  90 days;
    ...
    function mintFarmers( uint256 _farm ) public payable {
        ...
        require ( msg.value == _tally, "Not enough Native Paid"); 
    ...
    function stakeCinu(  uint256 _timeperiod ) public  {
