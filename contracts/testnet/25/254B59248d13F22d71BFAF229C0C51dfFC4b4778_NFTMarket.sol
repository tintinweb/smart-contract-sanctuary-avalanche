...
contract NFTMarket {
    ...
    event ListForSale(address indexed seller, address indexed collection, uint256 tokenId, uint256 price);
    event UnlistForSale(address indexed seller, address indexed collection, uint256 tokenId);
    event Buy(address indexed buyer, address indexed collection, uint256 tokenId);
    ...
    function createAuction(
        ...
        emit CreateAuction(msg.sender, _nftAddress, _tokenId, _endTime, _minIncrement, _directBuyPrice, _startPrice);
        return true;
    }
    ...
    function unlistForSale(address collection, uint256 tokenId) external returns (bool) {
        require(collection != address(0));
        require(
            (IERC721(collection).ownerOf(tokenId) == msg.sender) ||
    ...
    function buy(address collection, uint256 tokenId) external payable returns (bool) {
