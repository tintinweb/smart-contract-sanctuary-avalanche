...
contract LydiaRestrictedStrategyPartialCloseMinimizeTrading is
  OwnableUpgradeSafe,
  ...
  IStrategy
{
  ...
  event LydiaRestrictedStrategyPartialCloseMinimizeTradingEvent(
  ...
  modifier onlyWhitelistedWorkers() {
    require(
      ...
      "LydiaRestrictedStrategyPartialCloseMinimizeTrading::onlyWhitelistedWorkers:: bad worker"
    );
    _;
  }
  ...
  function execute(
    ...
    require(
      ...
      "LydiaRestrictedStrategyPartialCloseMinimizeTrading::execute:: insufficient farming tokens received"
    );
    ...
    emit LydiaRestrictedStrategyPartialCloseMinimizeTradingEvent(baseToken, farmingToken, lpTokenToLiquidate, lessDebt);
  }
