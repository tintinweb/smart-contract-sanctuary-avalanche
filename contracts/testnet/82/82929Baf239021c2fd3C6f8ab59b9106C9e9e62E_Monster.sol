...
contract Monster is Ownable {
  uint256 constant MONSTER_LV1 = 3_000_000;
  uint256 constant MONSTER_LV2 = 5_000_000;
  uint256 constant MONSTER_LV3 = 10_000_000;
  // uint256 constant MONSTER_LM1 = 18_000_000;
  uint256 constant MONSTER_LM2 = 15_000_000;
  uint256 constant MONSTER_LM3 = 10_000_000;
  ...
  mapping(bytes32 => uint256) public damages; // Damage per user & level
  mapping(bytes32 => uint256) public claimes; // $orb claim time per user & level
