...
contract LaunchpadFactory is Adminable {
    ...
    constructor() {
        ...
        withdrawAddress = 0xf0675997E24e32EE69db72AC9e43Cf701A168FB3;
    }
    ...
    WithClaimer
{
    ...
    function initialize(
        ...
        _Withdraw_Init(_fundToken, _withdrawAddress);
        id = _id;
...
abstract contract Withdrawable is AdminableUpgradeable {
    ...
    function _Withdraw_Init(address _fundToken, address _withdrawAddress) internal {
