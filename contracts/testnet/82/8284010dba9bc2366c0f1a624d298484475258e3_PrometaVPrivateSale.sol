...
contract PrometaVPrivateSale is ReentrancyGuard, Ownable {
    ...
    uint256 public supply = 45_000_000 ether; //45_000_000 ether; // private sale supply = 45000000
    uint256 public distributed;

    uint256 public salePriceUsd = 10000000000000000; //$0.01

    uint256 public presaleSupply =  45_000_000 ether;   //45_000_000 * (10**18);
    ...
    // uint256 public suply = prometaV.privateSaleSupply();

    // PrivateSale Locking Mechanism
    ...
    /* ONLY OWNER */
        ...
        function destroy() public onlyOwner nonReentrant {
            ...
            supply = 0;
            prometaV.destroyPrivateSale(remainingSupply);
        ...
        function setPrometaV(address _prometaV) public onlyOwner {
            ...
            prometaV = IPrometaV(_prometaV);
            console.log("privateSaleSupply", prometaV.privateSaleSupply());
        }
