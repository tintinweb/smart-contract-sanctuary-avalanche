...
interface ICygnusAlbireo {
     ...
     *  @dev This constructor gets removed with `delete` refunding some gas, so values should always return 0
     */
...
contract CygnusTerminal is ICygnusTerminal, Erc20Permit {
    ...
    /**
     *  @notice Force update real balance to match totalBalance after mint and redeem functions
     */
    modifier update() {
        _;
        updateInternal();
...
contract CygnusCollateralControl is ICygnusCollateralControl, CygnusTerminal {
    ...
    {
        // Get pool parameters from collateral deployer
