...
contract BlingRewards is EIP712, Ownable {
    ...
    constructor() EIP712("BlingRewards", "1.0.0") {
    ...
    function claim(uint amount, bytes calldata signature) external {
        ...
        bling.transfer(msg.sender, amount);
    ...
    function withdrawBling() external onlyOwner {
        uint amount = bling.balanceOf(address(this));
        bling.transfer(msg.sender, amount);
    }
}