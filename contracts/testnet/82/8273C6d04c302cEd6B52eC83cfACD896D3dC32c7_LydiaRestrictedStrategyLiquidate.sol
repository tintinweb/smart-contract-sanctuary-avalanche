...
contract LydiaRestrictedStrategyLiquidate is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  modifier onlyWhitelistedWorkers() {
    require(okWorkers[msg.sender], "LydiaRestrictedStrategyLiquidate::onlyWhitelistedWorkers:: bad worker");
    _;
  }

  /// @dev Create a new liquidate strategy instance.
  /// @param _router The PancakeSwap Router smart contract.
  function initialize(ITridentRouter _router, IBentoBoxMinimal _bento) external initializer {
  ...
  function execute(
    ...
    router.burnLiquiditySingle(
      ...
      minBaseToken.add(debt)
    );
    // 4. Reset approve for safety reason
