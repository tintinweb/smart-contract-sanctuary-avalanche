...
// File contracts/interfaces/IOBridgeERC20.sol

// contracts/interfaces/IOBridgeERC20.so
...
// File contracts/OBridgeRouter.sol
pragma solidity ^0.8.1;
...
contract OBridgeRouter is Initializable, OwnableUpgradeable {
    ...
    function mintToken(address token, address to, uint256 amount) external onlyOwner returns (bool) {
