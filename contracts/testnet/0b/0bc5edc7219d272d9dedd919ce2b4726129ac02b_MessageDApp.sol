...
contract MessageDApp is CCIPReceiverInterface, OwnerIsCreator {
    event SentMessage(string msg);
    event ReceiveMessage(string msg);

    CCIPReceiverInterface internal s_offRampRouter;
    CCIPRouterInterface internal s_onRampRouter;
    address internal s_subscriptionManager;
    ...
    constructor(
        CCIPReceiverInterface offRampRouter,
        CCIPRouterInterface onRampRouter
    ) {
        s_offRampRouter = offRampRouter;
        s_onRampRouter = onRampRouter;
    }
    ...
    function SendMessage(string memory _data) public {
        ...
        s_onRampRouter.ccipSend(s_counterpartChainId, message);
    ...
    {
        return (s_offRampRouter, s_onRampRouter);
    }
    ...
    function setLinkAddress(address link) external onlyOwner {
     ...
     */
    modifier onlyRouter() {
        if (msg.sender != address(s_offRampRouter))
