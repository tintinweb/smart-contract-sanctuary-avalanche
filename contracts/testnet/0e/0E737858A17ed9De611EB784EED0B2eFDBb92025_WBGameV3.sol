    ...
    ReentrancyGuardUpgradeable
{
     ...
     * @param _data bytes32 of nest_id and elemental stone,
     */
    function payBreed(
        uint256 _cost,
        uint256 _parent1,
        ...
        emit BreedItemPaid(_msgSender(), _cost, _parent1, _parent2, _data);
    }
     ...
     * @param _childId bytes32 childId
    ...
    function breed(
        ...
        emit BreedItemMinted(_childId, childTokenId, _tokenURI, _msgSender());
    }
