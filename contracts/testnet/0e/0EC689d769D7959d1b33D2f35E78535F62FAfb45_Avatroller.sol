...
contract Avatroller is AvatrollerStorage, AvatrollerInterface, AvatrollerErrorReporter, ExponentialNoError {
    ...
    function isDeprecated(AToken aToken) public view returns (bool) {
        return markets[address(aToken)].collateralFactorMantissa == 0 && borrowGuardianPaused[address(aToken)] == true && aToken.reserveFactorMantissa() == 1e18;
    }
...
abstract contract PriceOracle {
     ...
     */
    function getUnderlyingPrice(AToken aToken) external view virtual returns (uint256);
}