    ...
    AccessControlEnumerableUpgradeable
{
    ...
    ///////////////////////// STAKE OPERATOR /////////////////////////
    function stakeDistribute(address _stakePool, uint256 _amount) onlyStakeOperator external {
        require(!_stakePools.contains(_stakePool), "_stakePool invalid");
        token.transferFrom(_msgSender(), _stakePool, _amount);
        emit StakeDistribute(_msgSender(), _stakePool, _amount);
    }
