...
contract beta_main is ERC20, Ownable, PaymentSplitter {
        ...
        PaymentSplitter(payees, shares)
    {
        ...
        teamPoolFee = _nodeAmount.mul((teamPoolFee).div(100))*(10**18);
        treasuryFee = _nodeAmount.mul((treasuryFee).div(100))*(10**18);
        rewardsFee = _nodeAmount.mul((rewardsFee).div(100))*(10**18);
