...
contract ERC721AxelarBridgedableFacet is IERC721AxelarBridgedableFacet {
    ...
    function moveToViaAxelar(
        ...
        IOmniteAxelarBridgeSender axelarSeneder = IOmniteAxelarBridgeSender(
            LibDiamond.systemContext().getContractAddress(
                "OMNITE_AXELAR_BRIDGE_SENDER"
            )
        );

        axelarSeneder.mintOnTargetChain{value: msg.value}(
            _chain,
            _destinationBridge,
            sender,
            sender,
