...
contract SmashMarblesArenaV2 is SmashMarblesStorageV1 {
    ...
    uint256 public marbleForArenacliam;
    uint256 public cliamedMarbleCount;
     ...
     * @dev upadate max NFT limit of tokens that available for mint
     *
     * @param _totalMarbles amount of marbles that use in whitelist and public sale
     *
     * Requirement : -
     *              only contract owner can call
     */
    function changeMarbleNFT(
        uint256 _totalMarbles,
        uint256 _marbleForArenacliam
    ) external virtual onlyOwner {
        maxNFTs = _totalMarbles;
        marbleForArenacliam = _marbleForArenacliam;
    }
        ...
        isblacklistedAddresses
    {
        ...
        require(
            (noOfTokens + tokenCounter - cliamedMarbleCount - 500) <= maxNFTs,
        ...
        isblacklistedAddresses
    {
        ...
        require(
            cliamedMarbleCount < marbleForArenacliam,
        ...
        onlyOwner
    {
        ...
        delete tokenArray;
        require(
            (_addresses.length + tokenCounter - cliamedMarbleCount - 500) <=
                maxNFTs,
