...
contract Bifrost is Ownable, PaymentSplitter {
    ...
    ERC20 thor = ERC20(0x8F47416CaE600bccF9530E9F3aeaA06bdD1Caa79);

    address public traderJoeV2Pair = 0x95189f25b4609120F72783E883640216E92732DA;
    ...
    IMasterOfCoin masterOfCoin =
        IMasterOfCoin(0x48cC0E6C5df9242aF624DE342b05182af0c49153);
        ...
        PaymentSplitter(payees, shares)
    {
        ...
        addTier("HEIMDALL", 0xbA4400C4619Cd15267c2FeCd4Dbc39d310CEe3f1, 1);
        addTier("FREYA", 0x79190a9c108F6cc1CE956eA8f7ba03cD4e3260b9, 5);
        addTier("THOR", 0x37DA69aa9b436D3Bf6cC7530E11Ef98A5a052441, 8);
        addTier("ODIN", 0x9C0200F3e9673BCfe6D80076aa976F446d74758A, 10);
    }
    ...
    function _verifyFeeStatus(string memory tierName) internal {
        ...
        for (uint256 i = 0; i < numberOfNodes; i++) {
            ...
            ) = nodeRewardManager._nodesOfUser(sender, i);
        ...
        external
    {
        ...
        for (uint256 i = 0; i < allTiers.length; i++) {
            ...
            NODERewardManagement nodeRewardManager = tier.manager;
            uint256 rewards = nodeRewardManager._cashoutAllNodesReward(sender);
    ...
    function restoreNode(
        ...
        NodeTier memory tier = tiers[tierName];
        NODERewardManagement nodeRewardManager = tier.manager;
        // node cash out when only node has available reward.
        if (nodeRewardManager._getNodeRewardAmountOf(msg.sender, blocktime) > 0) {
