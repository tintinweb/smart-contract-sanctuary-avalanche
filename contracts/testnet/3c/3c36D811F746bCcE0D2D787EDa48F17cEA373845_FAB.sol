...
contract FAB is ERC1155Supply, ERC1155Burnable, OperatorFilterer, ERC2981, Ownable {
	using Address for address;
	using Strings for uint256;   
		
	string public _baseURI = "ipfs://QmPEZGHQqUQpoTUknQ6ivxCRxQzyv3xgRJibHMnjCabeHC/";
	string public _contractURI = "ipfs://bafkreifrf7f66ro6vjc26qlp5o2pzvtpxvgarm5hvylcd5abyciya3feb4";
	...
	uint256 public publicSaleStartTime = block.timestamp - 1; //TODO: update it with correct UNIX
	uint256 public whitelistStartTime = block.timestamp - 1; //TODO: update it with correct UNIX
	uint256 public publicSaleEndTime = block.timestamp + 30 days; //TODO: update it with correct UNIX
	uint256 public whitelistEndTime = block.timestamp + 30 days; //TODO: update it with correct UNIX
	...
	constructor() ERC1155(_baseURI) {		
        ...
        _setDefaultRoyalty(0xE7a697036a3E9b229Fc70d837F0C95daeef8e3c4, 500); //TODO: set this to owner address 
	}
	 ...
	 * @param tokenID - the token ID you want to buy
	  ...
	  */
    function buyToken(uint256 tokenID, uint256 qty)
        external
        payable                
    {
        require(pricePerToken[tokenID] != 0, "price not set");
        require(qty * pricePerToken[tokenID] ==  msg.value, "exact amount needed");                
...
/**
    ...
    /**	 
	  ...
	  */
	function setPriceAndMaxSupply(uint256 tokenID, uint256 price, uint256 maxSupply) external onlyOwner {
