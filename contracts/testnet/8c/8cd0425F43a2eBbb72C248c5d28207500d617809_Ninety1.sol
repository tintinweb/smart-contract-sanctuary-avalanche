...
contract Ninety1 is ERC1155, EnefteOwnership {
    ...
    modifier onlyTwenty() {
        require(msg.sender == address(TWENTY), "Only twenty contract allowed.");
        _;
    }
    ...
    */
    ...
    function fold(uint _tokenId, uint _amount) external {
        require(balanceOf(msg.sender, _tokenId) >= _amount, "Not your token");
        FOLD.transfer(msg.sender,EMISSIONS);
    ...
    */
    function set2652(address _address) external onlyOwner notLocked {
        TWENTY = ITwenty6Fifty2(_address);
    }

    /**
    * @notice set the address for the $fold smart contract
    *
    * @param _address contract address
    */
    ...
    */
    ...
    function calculateEmissions(uint256[] memory ids, uint256[] memory amounts) internal view returns (uint256 totalEmissions) {
        ...
        for(uint i = 0;i < ids.length;i++){
            ...
            _emissions += (EMISSIONS * amount) * multiplier;
        }
        return _emissions;
    }
    ...
    constructor() ERC1155("https://enefte.info/n1/n1.php?token_id={id}") {
        setOwner(msg.sender);
        _name = "Ninety1";
        _symbol = "91";
    }
...
/**
 * @dev Interface of ITwenty6Fifty2.
 */
interface ITwenty6Fifty2 {
    function mint(uint _numerOfTokens) external;
}
