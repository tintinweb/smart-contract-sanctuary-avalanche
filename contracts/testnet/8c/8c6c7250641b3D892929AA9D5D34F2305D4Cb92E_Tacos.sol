...
contract Tacos is ERC721URIStorage, Ownable {
  ...
  constructor(address signer_) ERC721("Tacos", "TACO") {
    _customBaseURI = 'https://nfts.bpi.network/tacos/';
  ...
  function mint(uint256 quantity, bytes32 _salt, bytes memory _signature) public payable {

    bytes32 hash = keccak256(abi.encodePacked(msg.sender, _salt));
