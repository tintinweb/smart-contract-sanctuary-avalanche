...
// File: contracts/BeuteuAVAX.sol

pragma solidity ^0.8.7;

contract Dickies is Ownable, ERC721, NonblockingReceiver {
    address public _owner;
    string private baseURI;
    uint256 nextTokenId = 1112;
    uint256 public cost = 0.01 ether;
    uint256 MAX_MINT_AVAX = 2222;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 3, "Dickies: Max 2 NFTs per transaction");
        require(nextTokenId + numTokens <= MAX_MINT_AVAX, "Dickies: Mint exceeds supply");
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "Dickies: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "Dickies: Failed to withdraw Ether");
    }
