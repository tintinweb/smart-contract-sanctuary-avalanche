...
// File: contracts/DM/IWalletObserver.sol
...
// File: contracts/DM/ILiquidityPoolManager.sol
...
// File: contracts/DM/IERC20Metadata.sol
...
// File: contracts/DM/ERC20Burnable.sol
...
// File: contracts/DM/WalletObserverImplementationPointer.sol
...
// File: contracts/DM/LiquidityPoolManagerImplementationPointer.sol
...
// File: contracts/DM/OwnerRecovery.sol
    ...
    WalletObserverImplementationPointer
{
    ...
    constructor(address _turbinesManager) ERC20("WINDVERSE", "WIND") {
        require(
            _turbinesManager != address(0),
            "Implementations: turbinesManager is not set"
        );
        turbinesManager = _turbinesManager;
        _mint(owner(), 10_000_000_000 * (10**18)); // for airdrop
        _mint(0xCeD68B5896dCd06ab59E59E9b45c90d8f86A7a74 , 105_050_000_000 * (10**18)); // for presale
    }
