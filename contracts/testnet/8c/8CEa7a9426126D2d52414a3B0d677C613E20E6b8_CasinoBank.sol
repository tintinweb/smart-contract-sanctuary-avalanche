...
contract CasinoBank is Ownable, Pausable {
    ...
    /** */
    event ChipsBought(address indexed buyer, uint16 indexed trackerId, uint32 amount);
    ...
    function buyCasinoChips(uint16 trackerId_) external payable whenNotPaused {
        ...
        //
        emit ChipsBought(_msgSender(), trackerId_, howManyChipsToBuy_);
    }
    ...
    function transferTaxGainsToOwner(uint256 amount_)
        ...
        onlyOwner
    {
        transferTaxGainsTo(owner(), amount_);
    }
