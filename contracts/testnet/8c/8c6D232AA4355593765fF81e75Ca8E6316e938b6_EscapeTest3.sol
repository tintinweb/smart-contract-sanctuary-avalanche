...
contract EscapeTest3 is ERC1155, Ownable {
  ...
  string public name = "EscapeTest3";
  string public symbol = "ETEST3";
  ...
  function mint(uint passType, uint amount) public payable {
    require(saleState == 1, "Public mint is not open");
  ...
  function _internalMint(uint passType, uint amount) internal {
    ...
    if (passType >= 0) {
      ...
      _checkEditionSupply(amount);
      _checkEditionNum(passType);
    } else {
  ...
  function _checkEditionSupply(uint256 amount) internal {
    require(amount > 0 && amount <= MAXeditionToggle, "more than edition allowed");
    
  }

  function _checkEditionNum(uint passType) internal {
    require(passType > low, "wrong edition");
    require(passType < high, "wrong edition");
  }
  ...
  function incrementNumMinted(uint amount) internal {
    ...
    require(numMinted <= MAXeditionToggle, " Minting more than allowed for edition" );
  }
