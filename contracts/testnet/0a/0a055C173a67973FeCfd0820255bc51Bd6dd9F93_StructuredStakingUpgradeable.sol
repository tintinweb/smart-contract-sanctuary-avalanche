    ...
    ValidationNodesProviderFactoryC2Upgradable
{
    ...
    modifier onlyExistingPool(uint256 poolId) {
        require(poolId < stakingPoolsCount, "Staking: pool does not exist");
        _;
    }
    ...
    function finalizeStakingPool() external payable onlyOwner {
        onlyWhitelistedAddress(_msgSender());
    }
    ...
    function stake(uint256 poolId, uint256 amount) external payable {
        ...
        // TODO update rewards for the tx sender

        stakingPool.stakes[_msgSender()] += amount;
        stakingPool.totalStaked += amount;

        // TODO transfer AMOUNT of NFTs to the tx sender
    ...
    function claim(uint256 poolId) external {
        ...
        // TODO update and claim rewards + deposit for the tx sender
        // TODO transfer AMOUNT of NFTs from the tx sender

        emit Claimed(poolId, _msgSender(), 0);
    }
