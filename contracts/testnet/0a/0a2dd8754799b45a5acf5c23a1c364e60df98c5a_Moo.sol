    ...
    ReentrancyGuard
{
    ...
    uint256 public maxMintable = 222;
    ...
    uint256 public whitelistSaleStart = 1673373600; // 4th april 8pm CET

    uint256 public publicSaleStart = 1736532000; // 9th april 8pm CET

    mapping(address => uint256) private whitelistBalance;

    constructor() ERC721("Doggos Toys", "TOYS") {
        _tokenIds.increment();
    }
    ...
    function whitelistMint(address to, uint256 quantity) internal {
        require(
            whitelistSaleStart <= block.timestamp,
