...
contract Presale is Withdrawable {
    ...
    uint constant maxSupplyOnFirstStage = 1000 * (10 ** 8);
    uint public currentSupply = 0;

    Stage private _stage;

    uint256 private constant _coinPrice = 0.1 ether;
    ...
    function swap(bytes calldata signature) public payable {
        ...
        uint256 coins = msg.value.div(_coinPrice).mul(10 ** 8);
