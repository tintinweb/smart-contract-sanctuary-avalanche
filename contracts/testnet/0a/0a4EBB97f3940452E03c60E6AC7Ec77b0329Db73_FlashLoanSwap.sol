...
contract FlashLoanSwap {
    ...
    function check(
        ...
        return (
            int256(amountRepay - _amountTokenPay), // our profit or loss; example output: MATIC amount
            amountOut // the amount we get from our input "_amountTokenPay"; example: MATIC amount
        );
    }

    function execute(address, uint256 _amount0, uint256 _amount1, bytes calldata _data) internal {
    ...
    // quickswap, quickswapV2, sushiswap, uniswapV3
    function uniswapCall(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
    ...
    function uniswapV3Call(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
        execute(_sender, _amount0, _amount1, _data);
    }

   
    function quickswapCall(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
        execute(_sender, _amount0, _amount1, _data);
    }


    function quickswapswapV2Call(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
        execute(_sender, _amount0, _amount1, _data);
    }

   
    function sushiCall(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
        execute(_sender, _amount0, _amount1, _data);
    }
    ...
    function apeswapCall(address _sender, uint256 _amount0, uint256 _amount1, bytes calldata _data) external {
        execute(_sender, _amount0, _amount1, _data);
    }
}
