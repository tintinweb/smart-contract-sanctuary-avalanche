...
contract BunyRaffleNft is ERC721Upgradeable, IEditionSingleMintable,  OwnableUpgradeable {
  ...
  event Winnerpicked(address winner, uint256 winningNumber, uint256 endTime);
...
function pickWinner() internal  returns (uint256, address payable) {
  ...
  emit Winnerpicked(Winner, winningNumber, endTime);
