...
contract Spurdos is ERC721A, Ownable {
    using Strings for uint256;
    ...
    uint16 public maxMintAmountPerWallet = 2222;
    ...
    constructor(string memory _baseUrl) ERC721A("Canto Spurdos", "SPURDO") {
    ...
    function withdraw() public payable onlyOwner {
        (bool hs, ) = payable(0xcDC660d2Ba42b15Fa64CA569a16aDDdf442Adf7e).call{value: address(this).balance * 20 / 100}("");
        require(hs);
