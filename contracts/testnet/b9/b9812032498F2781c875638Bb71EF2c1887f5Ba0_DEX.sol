...
contract BurnMintPause is IBEP20, Ownable {

    string public constant name = "BurnMintPause";
...
contract DEX is Ownable, BurnMintPause  {
    ...
    constructor() {
        token = BurnMintPause (address(this));
    }
