...
contract ChadSports is ERC1155, ERC1155Supply, IERC2981, VRFConsumerBaseV2, Ownable {
    ...
    mapping(address => discountState) chadlist;
    ...
    function setNFTOwner(address _nftContract, uint _tokenID) public {
        ...
        require(msg.sender == IERC721(_nftContract).ownerOf(_tokenID));
    ...
    function setChadOwners(uint _tokenID) public {
        require(!nftOwner[0xF588BE0b72561f65dcE8ba8eC79E37646B3B3A5B][_tokenID]);
        require(msg.sender == IERC721(0xF588BE0b72561f65dcE8ba8eC79E37646B3B3A5B).ownerOf(_tokenID));
        chadlist[msg.sender].isAuthorized = true;
        nftOwner[0xF588BE0b72561f65dcE8ba8eC79E37646B3B3A5B][_tokenID] = true;
    }
        ...
        public payable payableMintBatch
    {
        ...
        if(chadlist[msg.sender].isAuthorized && !chadlist[msg.sender].hasMint){
