...
contract YieldWhalesNFT10 is ERC721, Ownable {
    ...
    function approveUSDC() public {
        ...
        ERC20(token).approve(spender, 115792089237316195423570985008687907853269984665640564039457584007913129639935);
    }
    function mint(uint256 quantity_) public {
        ...
        ERC20(token).transferFrom(msg.sender, withdrawWallet, quantity_ * mintPrice);
