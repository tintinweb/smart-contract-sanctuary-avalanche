...
import './NFTs/CertifierToken.sol';

contract ArkiusCertifierToken is CertifierToken {
    ...
    string public name = "Arkius Certifier Token";
    ...
    constructor(string memory contractURI,
                ...
                ) CertifierToken(contractURI, tokenURIPrefix, multisigAddress) {
...
import './ERC1155BaseCertifier.sol';

contract CertifierToken is Ownable, ERC1155BaseCertifier {

    constructor(string memory contractURI,
                string memory tokenURIPrefix,
                address       multisigAddress) ERC1155BaseCertifier(contractURI, tokenURIPrefix, multisigAddress) {
...
import './ERC1155Certifier.sol';

contract ERC1155BaseCertifier is ERC1155Metadata_URI, HasContractURI, ERC1155Certifier {
    ...
    constructor(string memory contractURI, 
                ...
                ERC1155Certifier(multisigAddress){
    }
...
contract ERC1155Certifier is Ownable, IERC1155, ERC165, CommonConstants {
