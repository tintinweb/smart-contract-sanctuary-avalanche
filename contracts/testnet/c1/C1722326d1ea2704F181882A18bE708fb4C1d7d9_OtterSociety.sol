...
contract OtterSociety is ERC721A, OwnableNR, ReentrancyGuard {
    ...
    function withdraw() external payable onlyOwnerAdmin {
        ...
        /* 10% goes to robbo */
        _withdraw(robboWallet, (fullBalance * 10) / 100);

        /* 10% goes to Warthu */
        _withdraw(warthuWallet, (fullBalance * 10) / 100);
        /* 10% goes to Skipper */
        ...
        /* 60% goes to Marketing & Development */
        _withdraw(marketDevWallet, (fullBalance * 60) / 100);
    }
