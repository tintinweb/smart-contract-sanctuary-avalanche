...
import {MerkleDistributor, IMerkleDistributorCore} from "./MerkleDistributor.sol";

///@dev Distributors needs to delegate to this contract in order to work.
contract ClaimHelper {
    MerkleDistributor immutable public ActiveDistributor;
    MerkleDistributor immutable public PassiveDistributor;
    IERC20 public constant weth = IERC20(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);

    constructor(address _activeDistributorAddress, address _passiveDistributorAddress) {
        ActiveDistributor = MerkleDistributor(_activeDistributorAddress);
        PassiveDistributor = MerkleDistributor(_passiveDistributorAddress);
    }
