...
contract MockERC1155 is ERC1155 {
    ...
    string public name = "Metaverse Tokens";
    uint256 private tokenIds;

    event TokenMinted(uint256 indexed tokenId, address marketplaceAddress);

    constructor(string memory uri_, address _marketplaceAddress) ERC1155(uri_) {
    ...
    function mint(
        ...
        tokenIds++;
        uint256 newTokenId = tokenIds; // Get the current counter value
