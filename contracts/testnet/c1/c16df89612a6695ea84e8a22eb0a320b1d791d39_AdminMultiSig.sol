...
contract AdminMultiSig is AdminMultiSigInterface {
    ...
    // get Address Book Proposal Detail
    function getAddressBookProposalDetail(uint256 adminProposalIndex_) external view returns (AddressBookProposal memory) {
        return _AddressBookProposals[adminProposalIndex_];
    }

    // is Address Book Proposal Approver
    function IsAddressBookProposalApprover(uint256 adminProposalIndex_, address account_) external view returns (bool) {
        return _AddressBookApprovers[adminProposalIndex_][account_];
    }
