// SPDX-License-Identifier: MIT LICENSE
    ...
    function withdraw() external onlyOwner {  
        ...
        function compileAttributes(uint256 tokenId) public view returns (string memory) {
            ...
            if (s.levelIndex == 3 && !s.isSlave) {
                metadata = "You had got the ultimate power, with the President Of The United Stated, you will be able to crush the ennemi ! In god we trust !";
            }
