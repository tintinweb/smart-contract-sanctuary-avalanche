...
contract BavaCompoundVault_BoostedJoeUpgradeable is Initializable, UUPSUpgradeable, BRTERC20Upgradeable {
    ...
    function setVaultInfo(address _stakingPglContract, uint256 _restakingFarmID, address _rewardToken, IERC20Upgradeable[] memory _bonusRewardTokens, bool _withUpdate) external onlyOwner {
