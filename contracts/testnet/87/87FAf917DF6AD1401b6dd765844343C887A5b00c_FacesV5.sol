...
contract FacesV5 is Ownable, ERC2981, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = FacesV5.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(FacesV5.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(FacesV5.ownerOf(tokenId), to, tokenId);
    }
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < FacesV5.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < FacesV5.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = FacesV5.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = FacesV5.balanceOf(from) - 1;
    ...
    function batchMint(uint256 quantity) public payable virtual returns (bool success){
        require(quantity <= 5, "Cannot mint more than 5 tokens at a time");
        require(maxwall[_msgSender()] < maxPerWallet, "Max NFT per wallet reached");
        require(quantity + maxwall[_msgSender()] <= maxPerWallet, "Max NFT per wallet reached");
