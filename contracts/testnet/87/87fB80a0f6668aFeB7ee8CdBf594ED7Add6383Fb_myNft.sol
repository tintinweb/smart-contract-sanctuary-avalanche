...
contract myNft is ERC721Enumerable, Ownable{
    ...
    function Mint() public {
        require(totalSupply()+ counter <= maxSupply, "limit reached");
        _mint(msg.sender, counter);
        minteddata.push(msg.sender);
        counter++;
    }
    ...
    function addWhitelister(address[] memory _users) public onlyOwner{
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory str){
        str = string(abi.encodePacked(_baseURI(), _tokenId.toString(), baseExtension));
    }
