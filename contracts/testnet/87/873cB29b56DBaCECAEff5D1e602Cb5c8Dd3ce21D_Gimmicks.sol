...
contract Gimmicks is ERC721Enumerable, Ownable, AccessControl {
    ...
    event DICPunchesSent(address _from, uint256 _toTokenId, address _to, uint256 _tokenId, uint256 _amount);
    ...
    function sendDICPunch(
        ...
        emit DICPunchesSent(msg.sender, toTokenId, to, tokenId, amount);
    }
