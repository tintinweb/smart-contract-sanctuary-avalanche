...
contract EntityContractUpgradeable is Initializable, UUPSUpgradeable, OwnableUpgradeable, Blacklistable {
     ...
     *
     */
    function initialize(IArkiusAttentionSeekerToken attentionSeekerContractAddress,
     ...
     * @param id Id of the entity.
     */
    function deleteEntity(uint256 id, address attentionSeekerAddress) external notBlacklisted {
        if(_msgSender() == campaignContractAddress){
