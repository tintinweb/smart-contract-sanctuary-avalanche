    ...
    UUPSUpgradeable
{
    ...
    */
    ...
    function RideCrossChain(
        ...
        //TODO: optimize this, as i sending encode, send solidityPacked
        require(
            uint256(bytes32(_requestMetadata[160:192])) == 3 &&
                keccak256(bytes(_requestMetadata[224:])) !=
                keccak256(abi.encodePacked("")),
            "invalid asm or ack"
        );
    ...
    function SubmitTicket(
        ...
        require(ownerOf(riderId) == msg.sender, "caller not owner of Rider");
        ...
        emit SubmittingTicket(chainId, msg.sender, riderId, _lotteryId);
    }
    ...
    function iReceive(
        ...
        // require(
        //     keccak256(abi.encodePacked(srcContractAddress)) ==
        ...
        (
            ...
            RiderMetadata memory _riderMetadata,
            bytes memory receiver
        ) = abi.decode(payload, (uint256, string, RiderMetadata, bytes));
        ...
        _safeMint(toAddress(receiver), riderId, tokenUri);
        ...
        return abi.encode(rideNo, riderId);
    }
     ...
     * @param execData it is abi.encoded data that's returned from iReceive function on dst chain
     */
    function iAck(
        ...
        bytes memory _payload = abi.decode(execData, (bytes));
    ...
    function toAddress(
        ...
        bytes20 _address;
        assembly {
            _address := mload(add(_bytes, 0x20))
        }
        contractAddress = address(_address);
    }
