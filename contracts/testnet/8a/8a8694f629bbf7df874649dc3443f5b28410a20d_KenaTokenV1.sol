    ...
    OwnableUpgradeable
{
    ...
    string internal constant SYMBOL = "KENA.62"; // CHANGE ME
    ...
    KenaTokenomics
{
    ...
    function initialize()
        public
        virtual
        override(KenaTokenomics, Manageable)
        initializer
    {
        super.initialize();
    ...
    function addGrantor(address account, bool isUniformGrantor)
        public
        onlyManager
    {
    ...
    function _getSumOfFees(
        ...
        if (_isWhaleSale) {
            return (OFF_RAMP_NETWORK_FEE +
                BURN_FEE +
                ANTI_WHALE_SALE_PENALTY_FEE + ANTI_WHALE_SALE_PENALTY_FEE) ;
        } else if (_isSale) {
