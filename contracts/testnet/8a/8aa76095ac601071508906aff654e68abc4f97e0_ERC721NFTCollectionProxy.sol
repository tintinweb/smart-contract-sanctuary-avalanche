...
interface IERC721NFTCollection is IERC165Upgradeable {
    ...
    error NotInWhitelistMode();
    error NotInPublicMode();
    ...
    error InvalidCount(uint256 sent, uint256 minRequired);
    ...
    function setWhitelistMode() external;

    function setCreatorMode() external;
    ...
    function getMintPrice(uint256 guaranteedMintCount, uint256 raceMintCount)
        external
        view
    ...
    AccessControlUpgradeable
{
    ...
    uint256 public mintStartDate; // mintExpirationTime is relative to this
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        returns (bool)
    {
        console.logBytes4(type(IERC721NFTCollection).interfaceId);
        return
