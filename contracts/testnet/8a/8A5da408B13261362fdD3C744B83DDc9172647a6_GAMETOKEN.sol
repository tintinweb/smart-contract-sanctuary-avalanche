...
contract GAMETOKEN is Context, ERC20, Ownable {
    ...
    uint256 private m_SellFeePercent = 2; // 2% Sell Fee.
    uint256 private m_BuyFeePercent = 2; // 2% Buy Fee.
    ...
    uint256 private m_DevPercent = 50; //5%
    ...
    function claim() external {
        ...
        uint256 claimAmount = amount.mul(m_ClaimRate.mul(10**3));
        require(
    ...
    function _payToll() private {
        ...
        bool overMinTokenBalanceForDisperseAvax = _tokenBalance >=
            m_NumOfTokensForDisperse;
        if (_readyToSwap() && overMinTokenBalanceForDisperseAvax) {
