    ...
    Ownable
{
        ...
        nonReentrant
    {
        ...
        idToListedToken[tokenId].endDate = 0;
         ...
         uint256 calculateServiceFee = msg.value * serviceFee / ROYALTY_MAX;
        uint256 calculateSellerReceipt = msg.value - calculateServiceFee;
        
        payable(_serviceWallet).transfer(calculateServiceFee);
        payable(idToListedToken[tokenId].owner).transfer(calculateSellerReceipt);
