...
// File: contracts/OSDemoCustom.sol
...
/* 0x8E806523fFa8e3a8f0380A6F889479C9Cab3F35c */
/* TODO: Understand this and we are gucci https://medium.com/@ItsCuzzo/using-merkle-trees-for-nft-whitelists-523b58ada3f9 */
/* TODO: Need placeholderTokenURI */
/* important!!! TODO: REMOVE RENOUNCEOWNERSHIP() FROM Ownable.sol !!!!!!!!!!!!!! important!!!*/
contract OtterSociety is ERC721A, Ownable {
    using Strings for uint256;

    /* tested & works as intended -- Crypto Spectres | 21kkfy */
    ...
    uint256 public constant WHITELIST_SALE_PRICE = 1.5 ether;
    /* tested & works as intended -- Crypto Spectres | 21kkfy */
    ...
    constructor() ERC721A("OS-BETA-13-04", "OS-B") {}
    ...
    function mint(uint256 _quantity) external payable callerIsUser {
        ...
        require(
            ...
            "Otter Society :: Already minted 3 times!"
        );
        require(
        ...
        callerIsUser
    {
        ...
        require(
            ...
            "Otter Society :: You are not whitelisted"
        );
    ...
    /* Mint a specific amount for the team. 20 in this case */
    /* tested & works as intended -- Crypto Spectres | 21kkfy */
    ...
    /* Changed default withdraw of SQB with Azuki's withdraw */
