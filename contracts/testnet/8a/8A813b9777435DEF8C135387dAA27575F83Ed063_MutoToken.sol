...
contract MutoToken is ERC20, Ownable {
    ...
    constructor(address _treasuryAddress) ERC20("MutoToken", "MT") {
        treasuryEthAddress = _treasuryAddress;
    }
    ...
    function buyTokens() public payable returns (uint256 tokenAmount) {
        ...
        bool sent = payable(treasuryEthAddress).send(msg.value);
    ...
    function treasuryMinter(address _minter, uint256 _amount) public {
