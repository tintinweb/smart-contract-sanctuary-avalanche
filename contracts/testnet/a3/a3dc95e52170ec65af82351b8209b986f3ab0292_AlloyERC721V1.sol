    ...
    ReentrancyGuardUpgradeable
{
    ...
    modifier onlyMaster() {
        require(
            msg.sender == address(NiozERC20Address),
    ...
    function mintPrinter(
        ...
        if (checkPrice[epoch_id][pool_id].NiozPrice > 0) {
            NiozERC20Address.safeTransfer(
                msg.sender,
                address(this),
                checkPrice[epoch_id][pool_id].NiozPrice
            );
