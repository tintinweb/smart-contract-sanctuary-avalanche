...
contract YieldFarmStakePoolManager {
  ...
  constructor(
    ...
    lpToken = _tokenA;
    // lpToken = IJoeOracle(joeOracle).lpToken(_tokenA, _tokenB);
  }
  ...
  function _stake() internal {
    ...
    ITokenStakePool(stakePool).stake(stakePoolId, IERC20(lpToken).balanceOf(address(this)));
  }
