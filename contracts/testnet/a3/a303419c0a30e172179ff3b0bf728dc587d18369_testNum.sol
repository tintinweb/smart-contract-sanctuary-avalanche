...
contract testNum is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 2_000_000_000_000; //1 Trillion
    ...
    // Pangolin testnet ROUTER
    address private _routerAddress = 0x2D99ABD9008Dc933ff5c0CD271B88309593aB921;

    address public burnAddress = 0x71Ff323b69baD6025FB0848Ce16ECdB3aE6493BB;
    address payable private _marketingWallet = payable(0x71Ff323b69baD6025FB0848Ce16ECdB3aE6493BB);
