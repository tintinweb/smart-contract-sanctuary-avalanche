...
contract Guardian is Storage {
    ...
    /* 
    Guardian required transactions 
    */
    ...
    function submitForGuardianApproval(
        ...
        transactionId = guardianRequiredTxCount;
        guardianTransactions[transactionId] = Transaction({
            destination: destination,
            value: value,
            data: data,
            executed: false
        });
        guardianRequiredTxCount += 1;
        return transactionId;
    }

    /// @notice to execute the transaction
    /// @param _txId id of tx to execute
    function executeGuardianRequiredTx(uint256 _txId)
        external
        onlyGuardian
        returns (bool)
    {
        Transaction storage txn = guardianTransactions[_txId];
