...
contract TransferManager {
    ...
    function getMessageHash(address _nft, address _from, address _to, string memory _userId, uint256 _tokenId, uint256 _nonce)
        public pure returns (bytes32)
    {
        return keccak256(abi.encodePacked(_nft, _from, _to, _userId, _tokenId, _nonce));
    }
    ...
    {
        bytes32 messageHash = getMessageHash(_nft, _from, _to, _userId, _tokenId, _nonce);
    ...
    function transferItem(address _nft, address _to, string memory _userId, uint256 _tokenId, uint256 _nonce, 
        ...
        require(verify(_nft, msg.sender, _to, _userId, _tokenId, _nonce, signature) == true, "Invalid signature");
