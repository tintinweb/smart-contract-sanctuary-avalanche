...
contract PangCoin is Context, IBEP20, Ownable {
     ...
     * @dev Throws if called by any account other than the owner.
     */
    modifier checklocker() {
        require(_locks[msg.sender] == false, "Locked: Account is locked");
        _;
    }
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) external checklocker returns (bool) {
    ...
    /**
     * @dev lock account, only owner can unlock
     */
    ...
    function _transfer(
        ...
        require(_locks[sender] == false, "Locked: Account is locked");
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(
            _newBalance <= _maximumSupply,
            "BEP20: mint amount exceeds maximum supply"
        );
    ...
    /**
     * @dev Lock account, only owner can lock
     */
