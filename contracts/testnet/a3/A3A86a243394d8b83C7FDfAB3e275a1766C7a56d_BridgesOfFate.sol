...
contract BridgesOfFate is OwnableUpgradeable {
    ...
    function participateInGame(bool _jumpSide, bytes32 playerId) public  GameEndRules PushBackBankingGameEndRules{
        ...
        if (_member.stage > 0) {
            require((_member.lastJumpSide == true && gameRandomNumber[_member.stage] >= 50) , "You are Failed" );
            require((_member.lastJumpSide == false && gameRandomNumber[_member.stage] < 50), "You are Failed" );
        }
