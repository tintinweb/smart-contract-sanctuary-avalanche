    ...
    IGameFiCoreV2
{
    ...
    modifier onlyAdminOrMinter() {
        require(
            ...
            "GameFiCoreV2: caller is not the admin/minter"
        );
        _;
    }
    ...
    function createCollection(
        ...
        delete _collection[2];
        _totalCollections.decrement();
        ...
        if (tokenStandart == TokenStandart.ERC20) {
            ...
            IGameFiTokenERC721(collectionInstance).initialize(name_, symbol_, tokenURI_, contractURI_, data);
            _checkSupportsInterface(collectionInstance, type(IGameFiTokenERC721).interfaceId);
        } else {
            IGameFiTokenERC1155(collectionInstance).initialize(name_, symbol_, tokenURI_, contractURI_, data);
