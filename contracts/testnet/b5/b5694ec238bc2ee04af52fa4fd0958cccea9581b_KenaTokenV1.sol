    ...
    OwnableUpgradeable
{
    ...
    string internal constant SYMBOL = "KENA.61"; // CHANGE ME
    ...
    KenaTokenomics
{
    ...
    function initialize() virtual public override (KenaTokenomics, Manageable) initializer {
        super.initialize();
    ...
    function addGrantor(address account, bool isUniformGrantor) public onlyManager {
     ...
     */
    function renounceOwnership() public virtual override view onlyManager {
     ...
     */
    function transferOwnership(address newOwner) public virtual override onlyManager {
