    ...
    clampedVRF
{
    ...
    constructor()
        ERC721("MoonBuddies", "MOOBS")
        clampedVRF(431,10,10)
    {
        ...
        payoutAddress2 = 0x8654FE925701a6cb66C1cBA2786eF4d3a68ad6fE;
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "msg.value not enough to cover messageFee"
        );
    ...
    function mint(uint256 quantity) public payable {
        require(publicSale() || privateSale(), "sale isn't active");
        if (privateSale()) {
