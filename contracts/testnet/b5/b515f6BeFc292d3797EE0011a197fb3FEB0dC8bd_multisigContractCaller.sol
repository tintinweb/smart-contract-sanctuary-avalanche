...
contract multisigContractCaller {
    ...
    constructor(address _multisigCaller1,address _multisigCaller2) public {
        multisigCaller1 = _multisigCaller1;
        multisigCaller2 = _multisigCaller2;

    }

    function rescueStuckTokens(address _TOKEN, uint256 amount) public {
        require(msg.sender == multisigCaller1  || msg.sender == multisigCaller2 , "MultisigContractCaller:: rescueStuckTokens: Call must come from MultisigContractCaller.");
