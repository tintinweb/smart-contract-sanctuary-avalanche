...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x1F7c00508E20B8eC84962C0AA235e5ff37C9DBF1); // Marketing Address
    address payable public devAddress = payable(0x1F7c00508E20B8eC84962C0AA235e5ff37C9DBF1); // Dev Address
    ...
    uint256 private minimumTokensBeforeSwap = 75 * 10**8 * 10**9; 
    uint256 private buyBackUpperLimit = 1 * 10**8 * 10**9;
    uint256 private minimumBeforeBuyBack = 1 * 10**8 * 10**9;
    ...
    constructor (string memory name_, string memory symbol_) {
        ...
        IJoeRouter02 _joeRouter02 = IJoeRouter02(0x5db0735cf88F85E78ed742215090c465979B5006);
        joePair = IJoeFactory(_joeRouter02.factory())
            .createPair(address(this), _joeRouter02.WAVAX());
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == joePair) {
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressAVAX(marketingAddress, half);

        //Send to Dev address
        transferToAddressAVAX(devAddress, otherHalf);
    ...
    function swapAVAXForTokens(uint256 amount) private {
        ...
        address[] memory path = new address[](2);
        path[0] = joeRouter02.WAVAX();
        path[1] = address(this);

        // make the swap
        joeRouter02.swapExactAVAXForTokensSupportingFeeOnTransferTokens{value: amount}(
    ...
    //to receive AVAX from joeRouter02 when swaping
