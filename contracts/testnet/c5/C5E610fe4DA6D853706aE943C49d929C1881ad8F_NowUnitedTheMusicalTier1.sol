...
contract NowUnitedTheMusicalTier1 is ERC1155, Ownable, ReentrancyGuard {
    string public name = "Now United The Musical: City Gold";
    string public symbol = "NUCG";
    ...
    {
        require(
            0 < _tokenId && _tokenId < currentTokenId,
            "NFT does not exist"
        );
        return
            string(
