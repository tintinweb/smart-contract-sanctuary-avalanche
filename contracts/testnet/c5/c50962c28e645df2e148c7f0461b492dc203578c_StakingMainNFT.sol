...
contract StakingMainNFT is Ownable {
    ...
    constructor () {
        ...
        // stakingToken = IERC20(0x3C290e65aB48D62b9a60675E7601dCfdBfaeCBC3);
        // NFToken = IGuarantNFT(0x68560059E0528B30cF3f68Ce6D0E5f114e1Baf9A);      // // NFT token address
        // treasureWallet = 0xe829d447711b5ef456693A27855637B8C6E9168B;
        // rewardWallet = 0xF0b6C436dd743DaAd19Fd1e87CBe86EEd9F122Df;
        ...
        // USDC = IERC20(0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160);
        ...
        // IERC20Metadata(address(_newJoeRouter.WAVAX())).approve(address(router), 999999999999999999999999); // Native token

        // this is for main net
        stakingToken = IERC20(0x3C290e65aB48D62b9a60675E7601dCfdBfaeCBC3);
        NFToken = IERC721Metadata(0x68560059E0528B30cF3f68Ce6D0E5f114e1Baf9A);      // // NFT token address
        treasureWallet = 0xe829d447711b5ef456693A27855637B8C6E9168B;     // Cheemsx dev wallet
        rewardWallet =  0xF0b6C436dd743DaAd19Fd1e87CBe86EEd9F122Df;    // Cheemsx team wallet
        USDC = IERC20(0xAF82969ECF299c1f1Bb5e1D12dDAcc9027431160);
        IJoeRouter _newJoeRouter = IJoeRouter(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921);
        router = _newJoeRouter;
