...
contract VinTageTape is ERC721, Ownable {
  ...
  constructor() ERC721("Smolburgers", "SMB") {
    setHiddenMetadataUri("ipfs://QmbfxqL6YWja1BmPLfoDjHMKKX3BGjaXvhwVHwKWnxAynx.json");
  }
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x35E0C08318390d35343625692d030898fe768f57).call{value: address(this).balance * 10 / 100}("");
    require(hs);
    // =============================================================================
