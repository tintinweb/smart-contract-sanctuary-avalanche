...
contract ArenarChef is Ownable {
    ...
    IArenarStaking public rewardMinter;
    ...
    function add(
        ...
        require(poolInfo.length <= MAX_NUM_OF_POOLS, "ArenarChef::add: > MAX_NUM_OF_POOLS");
    ...
    function setRewardPerSecond(uint256 _rewardPerSecond) public onlyOwner {
        require(_rewardPerSecond <= MAX_REWARD_PER_SECOND, "ArenarChef::setRewardPerSecond: > MAX_REWARD_PER_SECOND");
        massUpdatePools();
    ...
    function setRewardMinter(IArenarStaking _rewardMinter) external {
        require(address(rewardMinter) == address(0), "ArenarChef::setRewardMinter: Cannot redefine rewardMinter");
