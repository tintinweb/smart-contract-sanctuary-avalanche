...
// File: contracts/StreetBrawlerz/zones/KravMaga.sol
...
contract KravMaga is Zone {
        ...
        returns (uint256)
    {
        unchecked {
            return
                uint256(brawler.agility) *
                uint256(brawler.stamina) *
                uint256(brawler.intelligence) *
                uint256(brawler.strength) *
                uint256(brawler.level);
        }
    }
}