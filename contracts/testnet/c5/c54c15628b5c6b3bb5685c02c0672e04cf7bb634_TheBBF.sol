...
contract TheBBF is ERC721, Ownable {
    using Strings for uint256; 
    ...
    uint256 public constant MINT_NFT_FEE = 2 ether;
    ...
    address public ADMIN_WALLET = 0x6b9e5aCc6456AbAC9b68B73f062c54e48cD7d605;

    //total nft's are 610 and nft id is starting from 0
    constructor() ERC721("The BBF", "TBBF") {      
        BASE_URI_EXTENDED = "https://api.thespotnft.com/nft/";
        _totalSupply = 609;
    }
