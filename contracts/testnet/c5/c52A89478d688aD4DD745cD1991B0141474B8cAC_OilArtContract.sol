...
abstract contract Withdrawable is Teams {
  address[] public payableAddresses = [0x7C2DB5FEc208eEE09D41A008A3A33613eB589B60];
...
// File: contracts/OilArtContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;

contract OilArtContract is 
    ERC1155,
    Ownable,
    Teams,
    Pausable, 
    ...
    Allowlist
{
    ...
    string public name = "Oil ART";
    string public symbol = "OART";
  ...
  */
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/9Aw7WQRxQB7eBYlGyptO/contract-metadata";
  }
