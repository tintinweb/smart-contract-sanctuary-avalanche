...
contract FeeManager is Context, Ownable {
  ...
  uint256 public feeLiquidity = 200;
  uint256 public feeStakingPool = 300;
  uint256 public feeBurn = 400;
  uint256 public feeMarketing = 500;
  uint256 public feeDev = 600;

  uint256 public feeTotal;

  address payable public royaltyAddress = payable(0xEF0c0cCC6F249352B32290E47023E992f7E7592C);
  address payable public marketingAddress = payable(0xEF0c0cCC6F249352B32290E47023E992f7E7592C);
  ...
  address payable public lpTokensHolderAddress = payable(0x344Be1CB351E8904a5e65e5FC850Ace87Ef2dd17);
...
contract Presale {
  ...
  function buy() public payable {
    ...
    require(
      ...
      "msg.sender does not belong to any band (not whitelisted)"
    );
