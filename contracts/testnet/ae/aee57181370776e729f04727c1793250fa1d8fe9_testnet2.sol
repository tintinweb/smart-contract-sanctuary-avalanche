...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 savax = IBEP20 (0x45ea5d57BA80B5e3b0Ed502e9a08d568c96278F9);
...
contract testnet2 is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address savax = 0x45ea5d57BA80B5e3b0Ed502e9a08d568c96278F9; // usdc
    ...
    string constant _name = "testnet2";
