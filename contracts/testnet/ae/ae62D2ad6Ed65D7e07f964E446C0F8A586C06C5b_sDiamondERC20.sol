...
contract sDiamondERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("sDB", "sDB", 9) ERC20Permit() {
    ...
    /**
        @notice increases sDB supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sDB
