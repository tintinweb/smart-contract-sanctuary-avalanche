...
contract StoreOldRewards is Ownable, ReentrancyGuard {
    ...
    mapping(address => bool) isWhitelistUser;
    ...
    function addUserInfo(
        ...
        users[user] = UserInfo(amount, rewardDebt, pendingReward, hasPendingBefore13thNov, false);
        isWhitelistUser[user] = true;
        cntUsers++;
    }

    function requestReward(address userAddress) external {
        require(msg.sender == userAddress, "you are not authorized");
