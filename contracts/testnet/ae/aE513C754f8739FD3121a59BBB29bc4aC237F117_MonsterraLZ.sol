    ...
    NonblockingLzAppUpgradeable
{
    ...
    mapping(address => bytes32) public contractNameHash;
    ...
    function bridgeNft(
        ...
        bytes32 keyMapping = contractNameHash[_srcToken];
        require(
    ...
    function addTokenSupport(
        ...
        contractNameHash[_srcToken] = keyMapping;
    }

    function removeTokenSupport(string memory _name) external onlyOwner {
        bytes32 keyMapping = keccak256(abi.encodePacked(_name));
