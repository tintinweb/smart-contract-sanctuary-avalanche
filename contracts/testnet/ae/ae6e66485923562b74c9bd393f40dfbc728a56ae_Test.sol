...
contract Test {
    ...
    function xybkComputeK(uint256 _reserve0, uint256 _reserve1, uint256 _boost0, uint256 _boost1) public view returns (uint256 k, uint256 a, uint256 b) {
        ...
        a = term**2 + _reserve0.mul(_reserve1).div(denom);
        b = Math.sqrt(a);
        k = (b + term)**2;
    }
}