...
contract TokenExchange is Ownable {
    ...
    event TokenBVariantAdded(address indexed tokenB, uint256 exchangeRate, uint256[] vestingSchedule); 

    // Event triggered when a TokenB variant is updated
    event TokenBVariantUpdated(address indexed tokenB, uint256 exchangeRate, uint256[] vestingSchedule);
     ...
     */
    function deposit(string memory variant, uint256 amount) public {
        ...
        uint256 tokenAReceived = amount.mul(exchangeRate).div(1e18);
    ...
    // Withdraws all the Ether stored in this contract to the owner's address.
