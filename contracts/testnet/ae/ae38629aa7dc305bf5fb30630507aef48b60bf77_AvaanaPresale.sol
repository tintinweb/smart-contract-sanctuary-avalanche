...
contract AvaanaPresale is Owned {
    ...
    uint256 public endDate = 1654186567;
    ...
    function withdrawToken() public {
        require(block.timestamp > endDate ,"It's not time to withdraw.");
        require(userBalances[msg.sender] > 0 ,"There is no balance for withdrawal.");
        require(IToken(tokenAddress).transfer(msg.sender, userBalances[msg.sender]), "Insufficient balance of presale contract!");
    ...
    function buyToken() public payable {
        ...
        userBalances[msg.sender] = userBalances[msg.sender].add(tokenAmount);
    ...
    function tokenBalance() public view returns(uint256){
        uint256 tokenBal = IToken(tokenAddress).balanceOf(address(this));
        return tokenBal;
    }
