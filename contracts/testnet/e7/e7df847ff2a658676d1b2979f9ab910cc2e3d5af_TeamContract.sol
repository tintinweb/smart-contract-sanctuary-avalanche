...
// File: contracts/TeamContract.sol
...
contract TeamContract is Ownable {
    ...
    uint256 public lastUnlockTime = 1667829600;
...
event TransferSent(address indexed _destAddr,uint _amount);
    ...
    function unlock() external onlyMember{ 
        ...
        uint256 daysPast = (block.timestamp - lastUnlockTime) / (1 minutes);
    ...
    function _calculatePending(uint256 daysPast) internal{
            ...
            if(daysPast > 0){
                ...
                balance -= newTokens;
                lastUnlockTime = lastUnlockTime + (daysPast * 1 minutes);
