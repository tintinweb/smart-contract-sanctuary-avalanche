...
contract Lockup is Ownable {
    ...
    constructor (){
        ...
        NFToken = IERC721Metadata(0xbFd5B8d99fCFc5B84516ae3E381355684d28cd6E);      // // Node NFT address
        ...
        FractionalNFT = IFractionalNFT(0xd4d7af513fF9aB396A0E1EBCe48d674963Dcb993);
    ...
    function unStakeNFT(string memory name) public {
        ...
        IERC721(token).safeTransferFrom(address(this), _msgSender(), stakedUserList[_string2byte32(name)].NFTStakingId);
    }
