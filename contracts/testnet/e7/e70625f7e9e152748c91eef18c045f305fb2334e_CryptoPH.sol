...
contract CryptoPH is Ownable, ERC20, NonblockingLzApp, ReentrancyGuard {
    uint256 public counter;
    address private endpointAddress;
    ...
    constructor(address _endpoint) ERC20("CryptoPH", "CPH") NonblockingLzApp(_endpoint) {
        endpointAddress = _endpoint;
    }

    function crossChain(uint16 dstChainId) public payable nonReentrant {
        require(balanceOf(msg.sender) > 0, "NotEnoughBalance");
        ...
        (uint256 messageFee, ) = ILayerZeroEndpoint(endpointAddress).estimateFees(
            dstChainId,
            address(this),
            payload,
            false,
        ...
        require(msg.value > messageFee, "InsufficientGas");
    ...
    function _nonblockingLzReceive(
        ...
        emit ReceivedNFT(_srcChainId, from, counter);
    }
