    ...
    ReentrancyGuardUpgradeable
{
    ...
    {
        address _owner = IERC721(_erc721).ownerOf(_tokenId);
        if (
        ...
        nonReentrant
    {
        ...
        if (_auction.highestBidder != address(0)) {
            ...
            if (_auction.erc20Token == address(0)) {
                ...
                broker.transfer(brokerageAmount);
            } else {
                IERC20Upgradeable erc20Token = IERC20Upgradeable(
                    _auction.erc20Token
                );
                ...
                erc20Token.transfer(broker, brokerageAmount);
            }
            Token.safeTransferFrom(
                Token.ownerOf(_tokenId),
                _auction.highestBidder,
        ...
        nonReentrant
    {
        ...
        if (_auction.erc20Token == address(0)) {
            ...
            erc20Token.transferFrom(msg.sender, broker, brokerageAmount);
        }
    ...
    function putOnSale(
        ...
        address _erc721,
        address _erc20Token
    ) public erc20Allowed(_erc20Token) tokenOwnerOnly(_tokenId, _erc721) {
        {
            IERC721 Token = IERC721(_erc721);
