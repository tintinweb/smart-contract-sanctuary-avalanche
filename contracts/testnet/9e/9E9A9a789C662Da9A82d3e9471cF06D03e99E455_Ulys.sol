...
contract Ulys is ERC20Burnable, Operator {
    ...
    event TaxHappened(address sender, address recipient, uint256 taxAmount);

    event TransferFromHappened(address sender, address recipient);

    event TransferHappened(address sender, address recipient, uint256 taxAmount);
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        emit TransferHappened(msg.sender, recipient, amount);
    ...
    function transferFrom(
        ...
        emit TransferFromHappened(sender, recipient);
    ...
    function _transferWithTax(
        ...
        emit TaxHappened(sender, recipient, taxAmount);
