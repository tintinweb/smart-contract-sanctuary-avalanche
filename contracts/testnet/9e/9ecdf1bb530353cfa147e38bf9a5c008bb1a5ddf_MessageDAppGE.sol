...
import "./applications/CCIPConsumerOld.sol";

contract MessageDAppGE is CCIPConsumerOld, OwnerIsCreator {
    ...
    constructor(
        address router,
        address feeToken
    ) CCIPConsumerOld(router, feeToken) {
...
abstract contract CCIPConsumerOld is IAny2EVMMessageReceiver, IERC165 {
