...
contract CryptoSeals is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_SEALS = 10000;
    ...
    constructor() ERC721("CryptoSeals","SEAL")  {
        setBaseURI("https://cryptoseals.art/api/seal/");
