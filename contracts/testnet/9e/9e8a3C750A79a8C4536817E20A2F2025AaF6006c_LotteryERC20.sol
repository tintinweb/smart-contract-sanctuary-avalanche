...
contract LotteryERC20 is Ownable, Pausable, ReentrancyGuard {
    ...
    mapping(address => uint256) public royalityTickets; //total tickets you bought that count to royality
        ...
        nonReentrant
    {
        ...
        if (
            ...
            royalityTickets[_msgSender()] = royalityTickets[_msgSender()] + qty; //increase the total tickets that you own
        }

        if (
            royalityTickets[_msgSender()] + qty <
            royaltiesTicketsThreshold * phase
        ) {
        ...
        nonReentrant
    {
        ...
        royalityTickets[_msgSender()] = 0; //resets the amount of tickets the user has
    ...
    {
        if (
            royalityTickets[addr] == 0 ||
            totalTicketsBought == 0 ||
            _royaltiesDeposits == 0
        ) {
            return 0;
        }
        return (royalityTickets[addr] * _royaltiesDeposits) / totalTicketsBought;
    }
