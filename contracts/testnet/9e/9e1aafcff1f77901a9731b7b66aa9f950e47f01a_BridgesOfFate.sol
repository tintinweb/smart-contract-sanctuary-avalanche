...
contract BridgesOfFate is Ownable, ReentrancyGuard {
        ...
        GameEndRules
    {
        ...
        require(dayDifferance(block.timestamp, _member.lastJumpTime) <= 1,
        ...
        GameEndRules
    {
        ...
        require(_member.feeStatus == false, "Please Pay Entry Fee.");
    ...
    function _calculateReward() internal {
        ...
        uint256 _winners = (((_winnerRewarsdsPercent * _treasuryBalance)) / 100) / (winnersList.length);
        // 25% to owner wallet
