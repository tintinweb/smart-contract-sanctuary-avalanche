...
contract MonkeyTesting is ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, RandomRequest {
    using Strings for uint256;

    uint256 public constant MAX_MINTABLE = 5000; //  333 total for this launchpad
    uint256 public constant MAX_PER_CLAIM = 10;
    uint256 public constant ROYALTY_VALUE = 750; // 100 = 1%, 200 = 2% etc...

    address public constant KALAO = 0xc7B0a494eaE1aFf383f5D27DCBC67559392e5671;
