...
contract EtherDistributor {
    ...
    constructor(
        ...
        require(
            msg.value > _epochCapacity * (0.1 ether),
        ...
        uint256 deployedEthers = msg.value / (0.1 ether);
    ...
    function claim(uint256 epochNumber) public {
        ...
        (bool success, ) = msg.sender.call{
            value: min((share * (0.1 ether)), (volumeAtIndex * (0.1 ether)))
        }("");
        require(success, "Transfer failed.");
    }
