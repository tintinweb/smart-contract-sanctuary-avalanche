...
contract BBMock is  OwnableUpgradeable,  UUPSUpgradeable {

    uint256 public borrowBalance;
    uint256 public openPosit;
    address public lastBaseAsset;
    address private _actionPool;

    function initialize(bytes memory data) public initializer {
        __Ownable_init();
       // address endpoint = address(0x93f54D755A063cE7bB9e6Ac47Eccc8e33411d706);
        //__LzAppUpgradeable_init(endpoint); // fuji
      //  _actionPool = abi.decode(data,(address));
    }
