...
contract MarketplaceV2 is OwnableUpgradeable, PausableUpgradeable, ERC721Holder {
  ...
  /**
   * @notice Buy NFT from direct sales
   * @param _itemId Item ID
   */
  ...
  /**
   * @notice Approve swap by receiver of NFT
  ...
  /**
   * @notice Reject swap by receiver of NFT
   * @param _swapId Swap ID
   */
  ...
  /**
   * @notice Cancel swap by owner of NFT
   * @param _swapId Swap ID
   */
  ...
  /**
   * @notice Get all bids of the item
   * @param _itemId Item id
  ...
  /**
   * @notice Set ERC20 contract address
  ...
  /**
   * @notice Pause the public function
   */
  ...
  /**
   * @notice Unpause the public function
   */
  ...
  /**
   * @notice Owner can transfer NFT to the user for emergency purpose
   * @param _nftContractAddress NFT contract address
   * @param _tokenId Token id
  ...
  /**
   * @notice Emergency cancel(de-listing) sale item by admin
   * @notice This cancellation is remove NFT from storage but still owned by this contract
   * @notice So we need to transfer out manually by calling emergencyTransferTo() function
   * @param _itemId Item id
   */
  ...
  /**
   * @notice Set the address of publication fee
   * @param _wallet Wallet address
   */
  ...
  /**
   * @notice Get the address of publication fee
   * @return address
   */
