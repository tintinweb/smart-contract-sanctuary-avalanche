...
abstract contract BaseBridge is NonblockingLzApp {
    ...
    event SendPacket(address indexed account, uint16 indexed packetType, uint16 indexed dstChainId, uint64 nonce);
    event ReceivePacket(address indexed account, uint16 indexed packetType, uint16 indexed srcChainId, uint64 nonce);
    ...
    function _broadcast(
        ...
        emit SendPacket(account, packetType, dstChainId, outBoundNonce);
    }
...
contract SynthrBridgeLightChain is BaseBridge {
    ...
    function _nonblockingLzReceive(
        ...
        emit ReceivePacket(account, packetType, _srcChainId, _nonce);
    }
