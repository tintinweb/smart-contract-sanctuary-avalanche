...
contract VendorA is ReentrancyGuard, Ownable, TestPayable {
    ...
    constructor(address tokenAddress) {
        ...
        /* Allow this address to spend 10k Token */
        tokenAA.increaseAllowance(address(this), 10000000000000000000000);
    }
    ...
    function _withdrawBuy() public payable onlyOwner {
    ...
    function _burnToken(uint256 amount) external onlyVendorB(msg.sender) {
...
contract VendorB is ReentrancyGuard, Ownable, TestPayable {
    ...
    constructor(address tokenAddress, address payable _vendorA) {
        ...
        VendorBAddress = address(this);
        /* Allow this address to spend 10k Token */
        tokenB.increaseAllowance(address(this), 10000000000000000000000);
    }
    ...
    function _burnToken(uint256 dividend, uint256 divisor) internal {
        /* TODO: Vendor A doesn't have allowance to work with Vendor B's currencies, an internal call to VendorA.increaseAllowance is required.  */
        /* TODO: @dev https://testnet.snowtrace.io/tx/0x548b400b94e0ca359489922d440793079b8303ae0ae268041eb49bf83d6cc413 */
        /* Using msg.sender here, uses the VendorB's address and tries to burn tokenAA from Vendor B's address, desired result is */
        /* to burn tokenAA from VendorA's address. */
        uint256 balance = tokenB.balanceOf(VendorBAddress);
        uint256 amountToBeBurned = (balance * dividend) / divisor;
        /* Test below line if it works or not */

        tokenB.increaseAllowance(VendorBAddress, amountToBeBurned);
        tokenB.burnFrom(VendorBAddress, amountToBeBurned);
    }
    ...
    function _burnToken(uint256 amount) internal {
        tokenB.burnFrom(VendorBAddress, amount);
    }
}