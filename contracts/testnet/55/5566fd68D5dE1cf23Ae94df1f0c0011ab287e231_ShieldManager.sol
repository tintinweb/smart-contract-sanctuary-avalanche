...
contract ShieldManager is ThirdwebContract, ERC721, IShieldManager {
	...
	// Fees
	uint256 public epicFieldFee = 0.05 ether;
	uint256 public heroicFieldFee = 0.1 ether;
	uint256 public olympicFieldFee = 0.5 ether;
	uint256 public legendaryFieldFee = 1 ether;

	uint256 public epicHardwareFee = 0.1 ether;
	uint256 public doubleHardwareFee = 0.1 ether;
	uint256 public multiHardwareFee = 0.15 ether;

	// uint256 constant public publicMintPrice = 0.2 ether;
