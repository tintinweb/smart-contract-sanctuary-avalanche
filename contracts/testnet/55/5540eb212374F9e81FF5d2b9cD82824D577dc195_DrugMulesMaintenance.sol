...
contract DrugMules is ERC20("Staked Cocaine", "sCOCAINE"), Ownable, Pausable {
    ...
    uint256 public muledCocaine; // PIZZA pending withdrawal
    ...
    function stake(uint256 _amount) external whenNotPaused {
        ...
        cocaine.transferToFreezer(_msgSender(), _amount);
    }
...
contract Cocaine is ERC20("Cocaine", "COCAINE"), Ownable {
    ...
    uint256 public constant NUM_PROMOTIONAL_COCAINE = 500_000;
    uint256 public constant NUM_COCAINE_DIESEL_LP = 20_000_000;
    ...
    function setNumPizzaAvaxLp(uint256 _numPizzaAvaxLp) external onlyOwner {
        NUM_COCAINE_AVAX_LP = _numPizzaAvaxLp;
    }
    ...
    function transferToFreezer(address _from, uint256 _amount) external {
        ...
        require(_msgSender() == drugmulesAddress, "only the freezer contract can call transferToFreezer");
