...
contract PerpetualTokensFarm is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    mapping(address => bla[]) public withdrawRequest;
        ...
        returns (bla[] memory)
    {
        ...
        bla[] memory pendingWithdrawals = new bla[](noOfPendingWithdrawalsForUser);
        ...
        validateStakeByStakeId(msg.sender, stakeId)
    {
        ...
        if(coolDownPeriod[_epochId] != 0){
            ...
            bla memory lastRequest = withdrawRequest[msg.sender][lastRequestId];
