...
contract RangoCCTPFacet is IRango, ReentrancyGuard, IRangoCCTP {
    ...
    struct CCTPStorage {
        /// @notice address of TokenMessenger and MessageTransmitter contracts per dst domain id
        /// Ethereum: 0 and Avalanche: 1
        mapping(uint32 => address) tokenMessengerAddress;
        mapping(uint32 => address) messageTransmitterAddress;
    }
    ...
    function cctpSwapAndBridge(
        ...
        emit RangoBridgeInitiated(
            ...
            request.toToken,
            out,
            address(uint160(uint256(bridgeRequest.recipient))),
    ...
    function cctpBridge(
        ...
        emit RangoBridgeInitiated(
            ...
            address(uint160(uint256(request.recipient))),
