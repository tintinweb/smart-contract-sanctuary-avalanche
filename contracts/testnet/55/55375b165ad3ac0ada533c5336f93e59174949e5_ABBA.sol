...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/interfaces/IERC2981.sol
...
// File: github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/token/common/ERC2981.sol
...
contract ABBA is Ownable,IERC2981, ERC721URIStorage {
    ...
    constructor(
        ...
        createToken("ipfs://QmaSgrHxF5opsB34adFVvmjtPcfpwjw27tqGgjYPNzQEWt/0.json");
        royalty = royaltyFee;
    ...
    function setRoyaltyFee(uint256 _royalty) public onlyOwner {
    royalty = _royalty;
  }
