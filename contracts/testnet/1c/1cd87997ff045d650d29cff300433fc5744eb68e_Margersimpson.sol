...
contract Margersimpson is IBEP20, Auth {
    ...
    string constant _name = "Margesimpson";
    string constant _symbol = "MGS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 1000000000;
    uint256 public _maxWalletSize = (_totalSupply * 1) / 1000000000;  
    ...
    address private marketingFeeReceiver = 0xAc2C35Ac447B63dBC1231654f78BE280B1c742Af;
    address private buybackFeeReceiver = 0x02BA0AFeEF82086cbC38AD462b837C77F653867d;
