...
contract CaptainV3 is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable  {
    ...
    address private _royaltiesAddr = 0xFf6037e5F26CE054aF50856036f2D07e1Bd61AC2;  
    uint256 public royaltyPercentage = 1; // royalty based on sales price
    mapping(address => bool) public whiteList; // list of people who dont have to pay fee

    uint256 public mintFeeAmount = 0;
    ...
    function initialize() initializer public {
        __ERC721_init("CaptainV3", "CPT");
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __Pausable_init();
        __Ownable_init();
        __ERC721Burnable_init();
        __EIP712_init("CaptainV3", "1");
        __ERC721Votes_init();
    }
...
/*
    function _baseURI() internal pure override returns (string memory) {
      ...
      function togglePresaleState() external onlyOwner {
        ...
        require(saleIsActive == true, "not open");
...
function airdropTokens(uint256 numberOfToken, address toAddress) external onlyOwner {
