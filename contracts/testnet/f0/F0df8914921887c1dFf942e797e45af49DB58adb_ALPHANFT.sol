    ...
    ReentrancyGuard 
{
    ...
    string private uriFileExt = ".json";
    ...
    * Token Minting.
        ...
        returns (uint) 
    {
        ...
        // increment after setting newItemId
        _tokenIds.increment();
        ...
        returns (string memory)  
    {
        ...
        return string(abi.encodePacked(base, tokenId.toString(), uriFileExt));
    }

    function setDefaultTokenURIFileExt(
        string memory _uriFileExt
        ) 
        external 
        minterOnly 
    {
        uriFileExt = _uriFileExt;
    }
    ...
    */
    ...
    /**
    *  @dev On Chain Attribute Management, Vanity String, Vanity Numeric, Game String, Game Numeric
    */ 
