...
contract TrantorV2 is ERC20Upgradeable {
    ...
    function initialize(address router) public initializer {
        ...
        smoothingPoolAddress = msg.sender;
        transferTaxRate = 0;
        operationPoolFee = 0;
    ...
    address public smoothingPoolAddress;
    ...
    function setSmoothingPoolAddress(address account) public onlyOwner {
        require(!availableFunctions["setSmoothingPoolAddress"], "Function disabled");
        smoothingPoolAddress = account;
    }
   ...
   /**
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        ERC20Upgradeable(address(this)).approve(address(dexRouter), numTokensToSwap);
        ERC20Upgradeable(swapTokenAddress).approve(address(dexRouter), numTokensToSwap);
        ...
        payable(smoothingPoolAddress).transfer(amount2);
    }
