...
interface IERC20 {
    ...
    /**
     * @dev Returns the remaining number of tokens that `sp50ender` will be
...
// File: BigBurgNode.sol



contract BigBurgNode is ERC20, Ownable, PaymentSplitter {
