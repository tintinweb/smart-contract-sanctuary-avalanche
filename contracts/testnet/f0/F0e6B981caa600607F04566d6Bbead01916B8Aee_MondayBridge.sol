...
contract MondayBridge is NonblockingLzApp {
    ...
    function sendCrossChain(uint16 _dstChainId, uint _amount) public payable {
        ...
        (uint256 messageFee, ) = estimateSendFee(_dstChainId, msg.sender, _amount);
    ...
    function estimateSendFee(uint16 _dstChainId, address _toAddress, uint _amount) public view virtual returns (uint nativeFee, uint zroFee) {
