...
contract AUTOFARM {
	...
	IBEP20 public BUSD = IBEP20(0xB22e261C82E3D4eD6020b898DAC3e6A99D19E976); // busd mainnet: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    IBEP20 public BAF_TOKEN;

	uint256 constant public INVEST_MIN_AMOUNT = 0.01 ether; //0.01 BNB
	uint256 constant public PROJECT_FEE = 45; // 4.5%
	uint256 constant public DEVELOPER_FEE = 20; // 2%
	uint256 constant public MARKETING_FEE = 55; // 5.5%
	uint256 constant public PERCENTS_DIVIDER = 1000;
	uint256 constant public TIME_STEP = 1 days;
	
	uint256 constant public WITHDRAWAL_LOTTERY_FEE = 25; // 2.5%
	uint256 constant public STAKE_LOTTERY_FEE = 5; // 5%
	...
	uint256[] public REFERRAL_PERCENTS = [100, 50, 10, 10, 10, 4, 4, 4, 4, 4];
...
function invest(address payable referrer,uint8 plan) public payable {
	...
	function stakeBafTokens(uint256 bafAmount) public {
		...
		require(BAF_TOKEN.balanceOf(msg.sender) >= bafAmount, "Insuff. Token balance");
	...
	function sellBafTokens(uint256 amountToSell) public { 
		require(BAF_TOKEN.balanceOf(msg.sender) >= amountToSell, "Insuff. Token bal.");
    ...
    function claimBafTokens() public {
        ...
        require(user.bafTokensToClaim > 0, "Insuff. Token bal.");
  ...
  function getContractInfo() public view returns(uint256[] memory FeeHistory, uint256 lotteryTimer, uint256 tStaked, uint256 totalBafStaked, uint256 tBusdStaked, uint256 tReferralEarned) {
    ...
    function withdrawBUSD(IBEP20 _token) public onlyOwner {
