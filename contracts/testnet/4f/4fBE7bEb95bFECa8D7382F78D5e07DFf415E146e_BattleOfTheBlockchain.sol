...
contract BattleOfTheBlockchain is ERC721Enumerable, Ownable {
    ...
    uint256 public presaleNftPerAddress = 1;

    uint256 public nftPerAddress = 10;
    ...
    function mint(uint256 _mintAmount) external payable {
        ...
        if(block.timestamp <= preSaleOpenTime + preSaleDuration) {
            ...
            require(ownerMintedCount + _mintAmount <= nftPerAddress, "max NFT per address exceeded");
        }
    ...
    function setnftPerAddress(uint256 _limit) external onlyOwner {
