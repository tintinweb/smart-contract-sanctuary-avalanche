 ...
 */
contract YieldKey is ERC721Enumerable, ERC721Burnable, Claimable, Pausable, Random, AccessControl {
	 ...
	 */
    function mint(address _to, uint256 _mintAmount) external payable onlyRole(MINTER_ROLE) returns (uint256[] memory) {
