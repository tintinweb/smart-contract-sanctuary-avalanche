...
contract StonedSanta is ERC721Enumerable, Ownable, NonblockingReceiver {
  using Strings for uint256;
  ...
  uint256 public nextTokenId = 20;
  uint256 public maxPerTx = 10;
  uint256 gasForDestinationLzReceive = 350000;
  bool public paused = false;
  bool public pausedTraverse = false;
  ...
  uint256 public maxPerWallet = 20;              // Max amount of tokenIDs allowed to be minted by single wallet
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(nextTokenId + _mintAmount <= maxSupply, "Mint exceeds supply");
    ...
    for (uint256 i = 1; i <= _mintAmount; i++) {
      uint tokenId = _genClampedNonce() + nextTokenId;
