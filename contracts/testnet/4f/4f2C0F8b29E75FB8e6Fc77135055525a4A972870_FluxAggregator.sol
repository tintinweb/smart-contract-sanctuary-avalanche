...
contract FluxAggregator is AggregatorV2V3Interface, Owned {
   ...
   * @param _icosHttpLink Link from ICOS service meaning where we got the data from
   */
  constructor(
    address _link,
