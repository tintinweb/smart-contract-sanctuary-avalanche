...
contract superAaveErc20 is baseSuperToken,superAaveErc20Impl {
    ...
    address payable _swapHelper,address payable _feePool)
        baseSuperToken(multiSignature,origin0,origin1,_swapHelper,_feePool) superAaveErc20Impl(_stakeToken){
