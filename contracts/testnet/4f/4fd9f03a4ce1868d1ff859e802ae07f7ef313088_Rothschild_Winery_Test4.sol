...
contract Rothschild_Winery_Test4 {
    using SafeMath for uint256;

    uint256 public WINE_TO_HIRE_1MAKERS = 720000;
    ...
    function PRC_MARKET_WINE_DIVISOR(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
        require(value <= 50); /** 50 = 2% **/
        MARKET_WINE_DIVISOR = value;
    }
