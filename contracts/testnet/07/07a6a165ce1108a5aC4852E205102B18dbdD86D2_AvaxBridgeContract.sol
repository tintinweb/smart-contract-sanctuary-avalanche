...
contract AvaxBridgeContract is Ownable {
    ...
    address payable public system = payable(0x24EEc2380e2EcfA160B7Fe14738B66d7873c9523);
    ...
    constructor() {
        ...
        _processFees[4002] = 0.01 ether;
        supportedTargetChains[4002] = true;

        emit TargetChainAdded(4002, block.timestamp);
    }
