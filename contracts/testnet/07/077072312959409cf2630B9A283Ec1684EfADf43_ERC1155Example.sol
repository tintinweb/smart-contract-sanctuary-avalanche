...
contract ERC1155Example is ERC1155, Ownable {
    ...
    function mintRock() external payable {
        require(msg.value == price, "Invalid value");
        _mint(msg.sender, Rock, 1, "");
    }

    function mintPaper() external payable {
        require(msg.value == price, "Invalid value");
        _mint(msg.sender, Paper, 1, "");
    }

    function mintScissors() external payable {
        require(msg.value == price, "Invalid value");
        _mint(msg.sender, Scissors, 1, "");
    }

    function mintRockToRecipient(address recipient, uint16 quantity)
        external
        payable
    {
        require(msg.value == price * quantity, "Invalid value");
        _mint(recipient, Rock, quantity, "");
    }

    function mintPaperToRecipient(address recipient, uint16 quantity)
        external
        payable
    {
        require(msg.value == price * quantity, "Invalid value");
        _mint(recipient, Paper, quantity, "");
    }

    function mintScissorsToRecipient(address recipient, uint16 quantity)
        external
        payable
    {
        require(msg.value == price * quantity, "Invalid value");
        _mint(recipient, Scissors, quantity, "");
    }
