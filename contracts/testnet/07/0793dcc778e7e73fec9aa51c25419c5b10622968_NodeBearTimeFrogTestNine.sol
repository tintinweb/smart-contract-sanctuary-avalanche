...
contract NodeBearTimeFrogTestNine is
    ERC721Enumerable,
    Ownable,
    ERC2981PerTokenRoyalties
{
    ...
    uint256 public maxSupply = 11; //6969
    ...
    bool public onlyWhiteListPresale = true;
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        if (!whiteListAddresses[msg.sender] || !preSaleAddresses[msg.sender]) {
            require(
