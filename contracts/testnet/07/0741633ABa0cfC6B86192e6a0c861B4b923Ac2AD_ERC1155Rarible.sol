...
import "../../exchange-v2/lib/LibSignature.sol";
...
import "../../erc721/token/ERC165Upgradeable.sol";
import "../../erc721/rarible/LibRoyaltiesV2.sol";
import "../../erc721/rarible/RoyaltiesV2.sol";
...
import "../../erc721/rarible/AbstractRoyalties.sol";
import "../../erc721/rarible/RoyaltiesV2.sol";
...
import "../../erc721/erc-1271/ERC1271Validator.sol";
...
import "../../erc721/utils/StringsUpgradeable.sol";
import "../../erc721/LibURI.sol";
...
import "./token/RoyaltiesV2Impl.sol";
import "./token/RoyaltiesV2Upgradeable.sol";
import "./token/IERC1155LazyMint.sol";
import "./token/Mint1155Validator.sol";
import "./token/ERC1155BaseURI.sol";
...
abstract contract ERC1155Lazy is IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function mintAndTransfer(LibERC1155LazyMint.Mint1155Data memory data, address to, uint256 _amount) public override virtual {
        ...
        require(minter == msg.sender, "ERC1155: transfer caller is not approved12");
...
import "../erc721/token/OwnableUpgradeable.sol";
import "./token/ERC1155BurnableUpgradeable.sol";
import "./token/ERC1155DefaultApproval.sol";
import "./ERC1155Lazy.sol";
import "./token/HasContractURI.sol";
