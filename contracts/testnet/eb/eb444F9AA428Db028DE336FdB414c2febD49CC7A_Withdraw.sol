...
contract Withdraw is Ownable, Pausable {
    ...
    function create(uint256 _amount) external whenNotPaused {
        ...
        uint256 _requestId = requestCounter.current();
    ...
    function claim(uint256 _requestId, bytes memory _signature) external whenNotPaused {
        address _user = msg.sender;
