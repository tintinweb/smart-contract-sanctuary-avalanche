...
contract sArtix is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Artix", "sARTIX", 9) ERC20Permit() {
    ...
    /**
        @notice allows pools to be blocked from receiving, but not sending, sARTIX
    ...
    /**
        @notice increases sARTIX supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sARTIX
