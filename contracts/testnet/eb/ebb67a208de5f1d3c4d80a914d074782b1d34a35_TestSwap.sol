...
contract TestSwap {
    ...
    IJoeFactory public immutable _factoryV1;
    ILBLegacyFactory public immutable _legacyFactory;
    ILBFactory public immutable _factory;
    address public immutable _legacyRouterV2;
    ...
    function test1111(address pair, uint256 amountIn, bool swapForY) external view returns(uint256 amountOut) {
        try ILBLegacyRouter(_legacyRouterV2).getSwapOut(
            ILBLegacyPair(pair), amountIn, swapForY
...
//
                    (, amountOut, ) = ILBPair(pair).getSwapOut(uint128(amountOut), swapForY);
...
//                    else amountOut = amountXOut;
    ...
    ) external view returns(address[] memory, uint256 amountOut) {
        address[] memory pairs = _getPairs(path.pairBinSteps, path.versions, path.tokenPath);
        amountOut = _swapExactTokensForTokens(amountIn,pairs, path.versions, path.tokenPath);
...
//        address _lbQouter
        ...
        _legacyRouterV2 = legacyRouterV2; // 0x7b50046cec8252ca835b148b1edd997319120a12
...
--constructor-args "0x8e42f2f4101563bf679975178e880fd87d3efd4e" "0xf5c7d9733e5f53abcc1695820c4818c59b457c2c" "0x6b8e020098cd1b3ec9f811024bc24e51c660f768" "0x7b50046cec8252ca835b148b1edd997319120a12"

-》 0x7A72003F230FFBC351Bf193Ffdd4C95c666dD1f1


cast send \
--rpc-url=https://api.avax-test.network/ext/bc/C/rpc \
--private-key=d8ed0c11b24e0a5b51c23be4ad596b852d57d96fd16082babcdee6cbfd8cf2c1 \
0x2A7C9949B5C4056299670c89ceeEad83EEb51280 \
"getAmountExactTokensForTokens(uint256,uint256,(uint256[],uint8[],address[]))(address[],uint256)" 1000000 1780519 "([0,20],[0,2],[0xAb231A5744C8E6c45481754928cCfFFFD4aa0732,0xd00ae08403B9bbb9124bB305C09058E32C39A48c,0xB6076C93701D6a07266c31066B298AeC6dd65c2d])"
...
gas： https://testnet.snowtrace.io/address/0x2a7c9949b5c4056299670c89ceeead83eeb51280
query:
*/
