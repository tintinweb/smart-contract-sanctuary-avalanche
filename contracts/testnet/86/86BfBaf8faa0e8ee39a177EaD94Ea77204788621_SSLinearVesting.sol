...
contract SSLinearVesting is Ownable {
    ...
    function setAddressCredit(address _address, uint256 _tokens) public onlySpecialStaking returns (uint256){
        
        Sales[_address][claimCount[_address]].totalAllocation += _tokens;
        claimCount[_address]++;
