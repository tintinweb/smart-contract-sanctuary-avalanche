...
contract LasmVesting is Ownable {
    // Allocation distribution of the total supply.
    uint256 private constant E18                         = 10 ** 18;

    uint256 private constant LOCKED_ALLOCATION           = 240_000_000 * E18;
    ...
    uint256 private constant STAKING_ALLOCATION          = 160_000_000 * E18;
     ...
     */
    function initVestiingSchedule() public onlyOwner {
        ...
        _createSchedule(lockedWallet, Schedule({
            ...
            startTime            :  block.timestamp,
            allocation           :  LOCKED_ALLOCATION,
            duration             :  600,     // 36 Months (36 * 30 * 24 * 60 * 60)
            cliff                :  300,     // 24 Months (24 * 30 * 24 * 60 * 60)
            linear               :  300,     // 12 Months (12 * 30 * 24 * 60 * 60)
            lastClaimTime        :  0
        }));
        ...
        _createSchedule(managerWallet, Schedule({
            ...
            cliff                :  10368000,     // 4 Months (4 * 30 * 24 * 60 * 60)
        ...
        _createSchedule(developmentWallet, Schedule({
            ...
            duration             :  93312000,     // 36 Months (36 * 30 * 24 * 60 * 60)
            cliff                :  0,            // 0 Months
            linear               :  93312000,     // 36 Months (36 * 30 * 24 * 60 * 60)
            lastClaimTime        :  0
        }));
        ...
        _createSchedule(stakingRewardsWallet, Schedule({
            ...
            duration             :  124416000,    // 48 Months (48 * 30 * 24 * 60 * 60)
            cliff                :   31104000,    // 12 Months (12 * 30 * 24 * 60 * 60)
            linear               :   93312000,    // 36 Months (36 * 30 * 24 * 60 * 60)
            lastClaimTime        :  0
        }));
     ...
     */
    function claimByScheduleBeneficiary() external {
     ...
     */
    function claimByScheduleName(string memory _templateName) external {
        require(vestingToken != address(0), "Vesting: VESTINGTOKEN_NO__SET");
