...
contract Marketplace is Initializable, EIP712Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event CancelOffer(address indexed collection, uint256 indexed tokenId);
    event AcceptOffer(address indexed collection, uint256 indexed tokenId, address indexed _buyer, uint256 amount);
    event Redeem(address indexed collection, uint256 indexed tokenId, string salt, uint256 value);
    event RejectOffer(address indexed collection, uint256 indexed tokenId, address indexed _buyer);
        ...
        nonReentrant
    {
        ...
        emit CancelOffer(_nftContractAddress, _tokenId);
    }
