...
// File: bsc-library/contracts/Factory.sol
 ...
 * successful.
 * To use this library you can add a `using SafeBEP20 for Factory;` statement to your contract,
...
library SafeBEP20 {
     ...
     * {Factory-approve}, and its usage is discouraged.
     *
     ...
     */
    function _callOptionalReturn(Factory token, bytes memory data) private {
...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    // The reward token
    Factory public rewardToken;

    bool public isClaimable;

    // The staked token
    Factory public stakedToken;
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        ...
        Factory(_tokenAddress).safeTransfer(address(msg.sender), _tokenAmount);
