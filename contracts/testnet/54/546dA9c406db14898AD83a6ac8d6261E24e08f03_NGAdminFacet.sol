...
// Storage imports
import {WithStorage, AdminStatsStorage} from "../libraries/LibStorage.sol";
...
contract NGAdminFacet is WithStorage {
    ...
    function setNFTPreSaleEndTime(uint256 _time) public onlyAdmin {
        gameConstants().NFT_PRESALE_END_TIME = _time;
    }
    function setMaxNFTs(uint16 maxNFTS) external onlyAdmin {
