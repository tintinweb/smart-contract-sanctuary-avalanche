...
// File: DogeMoon/AVAX-new/AVAX-DogeRace.sol
...
contract dogeRace is Ownable, VRFConsumerBaseV2 {
    ...
    */
    ...
    function getRacePosition(uint256 raceId, uint256 position) public view returns(uint256) {
        require(races[raceId].isFinished == true, "Race is not finished");
            ...
            if(races[raceCounter].isSlotTaken[i] == false) {
                ...
                if(races[raceCounter].participantCount == 9) {
                    ...
                    if(subscriptionBalance < linkThreshold) {
                        require(LINKTOKEN.balanceOf(address(this)) >= linkThreshold, "Not enough LINK to execute transaction");
        ...
        for(uint256 i = 0; i < 9; i++) {
            ...
            for(uint256 j = 0; j < 9; j++) {
                if(dogeFinished[j] == false) {
                    ...
                    require(totalTickets > 0, "mod 0 error");
