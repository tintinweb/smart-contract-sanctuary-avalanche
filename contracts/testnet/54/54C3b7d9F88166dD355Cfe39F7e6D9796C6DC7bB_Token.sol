...
contract Token is ERC20Upgradeable {
   ...
   /**
    ...
    function setPairAddress() public onlyOwner() { 
        // set pair
        address get_pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(uniswapV2Router.WAVAX(), address(this));
        if (get_pair == address(0)) {
            uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(uniswapV2Router.WAVAX(), address(this));
        }
        else {
