...
contract Meowzards is ERC721, ERC2981, Ownable {
    using Strings for uint256;

    uint256 public constant MAX_TOKENS = 1273;
    ...
    constructor() ERC721("Meowzards", "MEOW") {
        baseUri = "ipfs://bafybeie6ufk3pjcj4cg6qlsj5vgoy7mqipuc6on3yrwjtyniynwp37k4cu/";
        for (uint256 i = 1; i <= TOKENS_RESERVED; ++i) {
            _safeMint(msg.sender, i);
        }
        totalSupply = TOKENS_RESERVED;
        _setDefaultRoyalty(_msgSender(), 712);
    }
    ...
    function whitelistmint(uint256 _numTokens) external payable {
        require(isWlSaleActive, "The whitelist sale is paused.");
        ...
        require(_numTokens * wlprice <= msg.value, "Insufficient funds.");
