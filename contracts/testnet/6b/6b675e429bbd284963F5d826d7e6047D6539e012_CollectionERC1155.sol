...
ERC1155URIStorageUpgradeable {
    ...
    function initialize1155(string memory _name, string memory _symbol, address receiver, uint256 amount, string memory tokenUri, bytes32 msgHash) initializer public {
        __name = _name;
        __symbol = _symbol;
        __ERC1155_init("");
        __Ownable_init();
    ...
    function create(
        ...
        _setURI(_id, _uri);
        royaltyHash[_id] = RoyaltyData(_initialOwner, msgHash);
    }
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        ...
        onlyOwner
    {
        require(exists(id) == true, "id is not exitst");
        ...
        onlyOwner
    {
        for(uint256 i=0; i< ids.length; i++){
            require(exists(ids[i]) == true, "id is not exitst");
        }
