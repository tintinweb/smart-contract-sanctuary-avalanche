...
contract SoulBond is AccessControl, ReentrancyGuard {
    ...
    constructor(
        ...
        soulAddress = 0x81582F803A17a4a454A80600e9185B42E32e0fcF;
        seanceAddress = 0xf9D9b96F213aCC6434f16fff5D932FA85cD179f3;

        // sets: soul & seance
        soul = IToken(0x81582F803A17a4a454A80600e9185B42E32e0fcF);
        seance = IToken(0xf9D9b96F213aCC6434f16fff5D932FA85cD179f3);

        // sets: liquidity pool addresses
        soul_avax = 0x5B1349FB153f0Bf672B55ea87707982aCf0b13d9;
        soul_usdc = 0xecB1BDc02eD102815B18269dF3306E7f5902eA8E;
        usdc_avax = 0x848991bc0e1e711575F4f169de6863b1EF1b5fE2;
        eth_avax = 0xa1999C9E06a0E04d479A57340B7D4dea323b4EbE;
        btc_avax = 0xef9777827a3581b64f5c7CB8954ccaE3cc2c46C0;
        usdc_dai = 0xB75AF3C1e9A4EcA4139fb130EC6F4643E9fB5508;
    } 
