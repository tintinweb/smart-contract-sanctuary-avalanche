...
contract XenJacket is ERC721, ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    bool public isLaunchedWL = false;

    constructor() ERC721("Xens' Jackets", "XEN") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.io/ipfs/QmfTUXsy7PmNWm2bHp4C4odPE792BuLugMjNRNiKhrp5Gm/";
    }
    ...
    function safGeMint1(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
    ...
    function safGeMint2(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint3(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint4(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint5(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint6(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint7(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint8(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safGeMint9(string memory uri) payable public whenLaunched nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
    ...
    function safeMint1(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId1 <= maxSupply1, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint2(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId2 <= maxSupply2, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint3(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId3 <= maxSupply3, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint4(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId4 <= maxSupply4, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint5(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId5 <= maxSupply5, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint6(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId6 <= maxSupply6, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint7(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId7 <= maxSupply7, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint8(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId8 <= maxSupply8, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint9(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId9 <= maxSupply9, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint10(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId10 <= maxSupply10, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint11(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId11 <= maxSupply11, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint12(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId12 <= maxSupply12, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint13(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId13 <= maxSupply13, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint14(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId14 <= maxSupply14, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint15(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId15 <= maxSupply15, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint16(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId16 <= maxSupply16, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint17(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId17 <= maxSupply17, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint18(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId18 <= maxSupply18, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint19(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId19 <= maxSupply19, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint20(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId20 <= maxSupply20, "Sold Out");
        alreadyMinted[msg.sender] = true;
    ...
    function safeMint21(string memory uri) payable public onlyWhitelist whenLaunchedWL nonReentrant {
        require(msg.value == (2 ether), "Please send 2 Avax");
        require(alreadyMinted[msg.sender] == false, "Already Minted");
        require(tokenId21 <= maxSupply21, "Sold Out");
        alreadyMinted[msg.sender] = true;
  ...
  function tokenURI(uint256 _tokenId) public view virtual override(ERC721, ERC721URIStorage) returns (string memory) {
    ...
    function setLaunchedWL() onlyOwner public {
    isLaunchedWL = true;
    }
    modifier whenLaunchedWL() {
      require(isLaunchedWL == true);
      _;
    }

    modifier onlyWhitelist() {
    require(whitelisted[msg.sender] == true, "You are not allowed to mint");
    _;
    }
}
