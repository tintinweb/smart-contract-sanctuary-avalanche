...
contract OneSplitRoot {
    ...
    IERC20Upgradeable internal constant BNB_ADDRESS = IERC20Upgradeable(0x0100000000000000000000000000000000000002);
    IWETH internal constant wbnb = IWETH(0xd00ae08403B9bbb9124bB305C09058E32C39A48c);
    ...
    IUniswapV2Factory internal constant pancakeSwap = IUniswapV2Factory(0xc35DADB65012eC5796536bD9864eD8773aBc74C4);
...
library UniversalERC20 {
    ...
    IERC20Upgradeable private constant ETH_ADDRESS = IERC20Upgradeable(0x0100000000000000000000000000000000000002);
