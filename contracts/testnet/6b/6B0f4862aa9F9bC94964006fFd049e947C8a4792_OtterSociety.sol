...
contract OtterSociety is ERC721A, OwnableNR, ReentrancyGuard, ERC2981 {
    ...
    constructor() ERC721A("Otter Society", "OTTER") {}
    ...
    function whitelistFreeMint(uint256 _quantity)
        external
        nonReentrant
        callerIsUser
        notPaused
    ...
    function addPreparedWhitelist() external onlyOwnerAdmin {
        //
        ...
        addUser(0x351F9821C4994888F4637987229cd185f46A7Da4);
        addUser(0x535370d93680d297367d36fB1F75ebFBbdF6af9e);
        addUser(0x5251440043a70650f00DC765C3DEb968d9Ac5500);
        addUser(0x6541CE23CD22D17C78dBCc9Ae3f652C81aA67814);
        addUser(0x023F4A66E223676315431289C76c77d52243F819);
        addUser(0xd3f6B35fd8Ecfff9B8B2A9f698b93Dd5D49E059C);
        addUser(0x1a24A785B4b957a0a9DB243669733890f599201D);
        addUser(0x213D1809C3261967A2e7B20fE4fBf56050Dbc631);
        addUser(0x0e0D6bDc9f37C409e5c6f7aDED50Cf562c80817e);
        addUser(0x88C9C25A8E51A9eF809F9b6563c21c8AC2Cd8Aa0);
        addUser(0x1bE9477296b1919E5E5ABbc7a7417D573f78445e);
        //Discord ID: 922113405987459072 VV
        /* addUser(0x81978e9a08f8375efa3c57bace13d71739c0c4b0); */
        addUser(0x15D7D0Ec2d48d18cEbF7f7e4cCcBEe44a3779569);
        addUser(0x7439F2526399beBf669857Cd5Eb1fA5fafAd1fbB);
        addUser(0x03753f665A0a2C7b5f2160633304910B088C29F0);
        addUser(0x3A1882b99e93f38501F6227699b35b8C84Fe101d);
        addUser(0xCE6E4F1dc56eE1bcB0546A021D884eCb4B22eC42);
        addUser(0x02478C1382dC9B43B6114f27F3f030e3cc942A10);
        addUser(0x36dFa307Dd190234b9A8B9afa66862FC73797E0A);
        addUser(0x74eaCd9744DAE8924E31f5082fB2657146917C52);
        addUser(0x65Dae672f7F85a59464c40407D45468cf5De83CF);
        addUser(0x1f7ec70E422A00D54E2bBe0AFcf09Fa72969cb21);
        addUser(0xab7f5B8Eaa30e9726aB90b6F4Cf90A3d5640293f);
        addUser(0xE7e5F42603Db30e253441061B1941A92DE49Cf82);
        addUser(0x990C021b67222bBf1d08AaCcA6D70f48AF5b740f);
        addUser(0x29C804500f4260CF8b012CD543Fc203879BA31B4);
        addUser(0x2f7722690C7C81B341fe5a3B94280Ace6927953D);
        addUser(0xEA01602c963034be8225Da73393fDeb2EE73cA39);
        addUser(0xf8EE7680a426D5416b6ddCe0f460CDcd78F70FB8);
        addUser(0x0A7c02dAD1FF35569a24d4F6ec33FF3CF7B8e696);
        addUser(0x03753f665A0a2C7b5f2160633304910B088C29F0);
    }
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        //suppress error
        _tokenId;
        return (robboWallet, (_salePrice * royaltyDividend) / 10000);
    }
