...
contract RebateTreasury is Operator {
    ...
    function bond(address token, uint256 amount, uint8 bondVestingInDays) external onlyAsset(token) {
    ...
    function shouldOpenBond() public view returns (bool) {
        ...
        return previousEpochMainPrice > mainTokenPriceOne*pegValue/100;
    }
