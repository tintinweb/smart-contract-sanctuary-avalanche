...
contract Market is NonblockingLzApp {
  ...
  function resetDebt(address _user) public onlyOwner {
    userDebtShare[_user] = 0;
    totalDebtShare = 0;
    totalDebtValue = 0;

    userDebtShareLocal[_user] = 0;
    totalDebtShareLocal = 0;
    totalDebtValueLocal = 0;
  }

  function resetCollateral(address _user) public onlyOwner {
    totalCollateralShare = 0;
