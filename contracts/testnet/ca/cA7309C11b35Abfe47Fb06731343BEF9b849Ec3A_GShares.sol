...
*/
contract GShares is ERC20Burnable, Operator {
    using SafeMath for uint256;
    ...
    constructor(address _communityFund, address _devFund, address _team1Fund) public ERC20(" Glamour Shares", "GShares") {
        _mint(msg.sender, 1 ether); // mint 1  Glamour Share for initial pools deployment
