...
contract B is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    uint256 internal constant maxNodes = 10;
    ...
    constructor(address riAddress_) ERC721("B NFT V1", "$BNFT V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://site.com/meta/bnft/";
        string memory baseContractURI = "https://site.com/meta/bnft/main.json";
