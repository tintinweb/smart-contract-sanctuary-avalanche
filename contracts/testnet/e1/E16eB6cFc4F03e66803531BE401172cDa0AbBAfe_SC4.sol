...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function buyOrder (string memory _destinationChain, string memory _destinationAddress, uint _amount, uint16 dstChainId, uint16 srcPoolId, uint16 dstPoolId) external payable{
        ...
        stableCoin.approve(stargateRouter, _amount);
        IStargateRouter(stargateRouter).swap{ value: msg.value / 2 }(
            dstChainId,
            srcPoolId,
            dstPoolId,
            payable(msg.sender),
            ...
            abi.encodePacked(_destinationAddress),
            bytes("")
        );
