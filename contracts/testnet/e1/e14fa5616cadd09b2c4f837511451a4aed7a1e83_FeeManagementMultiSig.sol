...
contract FeeManagementMultiSig is FeeManagementMultiSigInterface {
    ...
    constructor(address AddressBookContractAddress_) {
        ...
        require(
            ...
            "Fee Management Multi-Sig: Address Book should not be zero address!"
        );
        ...
        onlyGreaterThanZero(expiration_)
    {
        ...
        address[] memory _feeManagerSignatories = _AdminMultiSigContract()
        ...
        onlyValidFeeManagementIndex(feeManagementProposalIndex_)
    {
        ...
        if (
            proposal.APPROVALCOUNT >=
            _AdminMultiSigContract().getFeeManagementMinSignatures()
        ) {
        ...
        onlyGreaterThanZero(expiration_)
    {
        ...
        address[] memory _feeManagementSignatories = _AdminMultiSigContract()
            .getFeeManagementSignatories();
    ...
    function _onlyFeeManagers() internal view {
        // require sender be a fee manager
        require(
            _AdminMultiSigContract().IsFeeManagementSignatory(msg.sender),
