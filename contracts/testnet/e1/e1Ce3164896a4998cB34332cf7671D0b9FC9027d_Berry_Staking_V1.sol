...
///////////////////////////////////////////////////////////////
    ...
    function getReward(address _user, uint256 tokenId) public view returns(uint256){
        ...
        else if(NFT.getIdType(tokenId) == 0 || NFT.getIdType(tokenId) == 3 || NFT.getIdType(tokenId) == 4){
    ...
    function changetimeeeeeee(uint256 _time) public {
        finalTimeForDutchMint = _time;
        finalTimeForFreeMint = _time;
    }
}