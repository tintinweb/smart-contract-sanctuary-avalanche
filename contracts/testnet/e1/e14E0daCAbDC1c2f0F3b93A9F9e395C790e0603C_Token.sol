...
contract Token is ERC20Upgradeable {
    ...
    function initialize(address _proxy) public initializer {
        ...
        // to test uniswapPair
        //uniswapV2Router = IJoeRouter02(address(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921));
        tokenAddress = address(this);
        proxyAddress = address(_proxy);
        // uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(address(this), uniswapV2Router.WAVAX());
        // uniswapV2Pair2 = IUniswapV2Factory(uniswapV2Router.factory()).getPair(address(proxyAddress), uniswapV2Router.WAVAX());
        uniswapV2Router = IJoeRouter02(address(0x2D99ABD9008Dc933ff5c0CD271B88309593aB921));
        wavaxAddress = uniswapV2Router.WAVAX(); 
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), wavaxAddress); 
        //uniswapV2Pair2 = IUniswapV2Factory(uniswapV2Router.factory()).createPair(proxyAddress, wavaxAddress); 
    }
