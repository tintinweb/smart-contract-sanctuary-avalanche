...
contract RoyaltyBDAC is ERC721URIStorage,  ERC2981, Ownable, ReentrancyGuard{
  using Strings for uint256;
  using Counters for Counters.Counter;
  Counters.Counter private _tokenIds;

  uint256 public cost = 200000000000000000; //400000000000000000
  uint256 public maxSupply = 10;
  uint256 public prePersonMaxAmount = 2;
  ...
  constructor() ERC721("RoyaltyBDAC", "RBDAC")ReentrancyGuard() {
...
/// ipfs://QmbMvxi77QVFTNooMg88TY7hDjWH2FyXoBJ6skaPsEUDwm/
  ...
  function mintNFT(address to, uint256 mintAmount) public payable {
    if(msg.sender != owner()) {
      
      require(mintAmount > 0);
      require(mintAmount <= prePersonMaxAmount);
  ...
  function PremintNFT(address to, uint256 mintAmount) public payable {

    require(presaleIsActive, "Presale is not active");
    require(_presaleList[msg.sender], "You are not on the Presale List");
    require( mintAmount > 0 && mintAmount <= presaleMaxMint, "Cannot purchase this many tokens");
    ...
    returns(string memory)
    {
        ...
        if (isRevealed == false) {
            ...
            //ipfs://QmTpESq2goYakJGvQAqkBT94eH7ajUn2TTRnBqPw8ZnueB/
        }
