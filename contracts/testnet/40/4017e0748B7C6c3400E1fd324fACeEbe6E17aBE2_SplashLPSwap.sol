...
contract SplashLPSwap{
 ...
 function swapTokenToTOKEN(uint256 amount, address _tokenAddress) internal {
  ...
  function convertLp2USDT(uint256 _amount) external {
    require(_amount>0,"LP value should be greater than 0");
    lpToken.transferFrom(msg.sender,address(this),_amount);
     uint256 half = _amount/2;
    lpToken.approve(address(router),_amount);
    swapSplash2USDT(half,address(USDT));
   ...
   function removeLD( uint256 _tokenAmount) internal {
 ...
 function swapSplash2USDT(uint256 amount, address _tokenAddress) internal {
    // SWAP split % of ETH input to USDT
    address[] memory path = new address[](3);
...
//tokenAdress
//0xb4b6d17b2C0ca0dfb6AC37Bc0eC788817DCfFce4
//router
//0x2D99ABD9008Dc933ff5c0CD271B88309593aB921
//USDT
//0xD7F03FB7BD5e533E0c68A7903f89BD2828A34141
//LP token
//0x6DfBc6Bc21e75D66595A9C74f0A5b2034E77baF2