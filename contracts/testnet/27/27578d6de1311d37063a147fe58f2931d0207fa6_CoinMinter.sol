...
contract CoinMinter {
    ...
    uint256 private constant DEVELOPER_RATE = 40;
    uint256 private constant MARKETING_RATE = 0;
    uint256 private constant RESERVE_RATE = 900;
    ...
    uint256 private constant MAX_DEP = 360000000 ether;
    ...
    function withdraw() public {
        ...
        if(withdrawalAmount>0){ 
            ...
            recipient.transfer(withdrawalAmount.sub(reinvestAmount));
    ...
    function _calculateReferrerReward(uint256 _investment, uint256 _referrerCode) private {
        ...
        if (_referrerCode != 0) {
            ...
            if (_ref1 != 0) {
                ...
                address payable recipient = payable(address(uint160(uid2Investor[_ref1].addr)));
recipient.transfer(_refAmount);
            ...
            if (_ref2 != 0) {
               ...
               address payable recipient = payable(address(uint160(uid2Investor[_ref2].addr)));
recipient.transfer(_refAmount);
            ...
            if (_ref3 != 0) {
               ...
               address payable recipient = payable(address(uint160(uid2Investor[_ref3].addr)));
recipient.transfer(_refAmount);
            ...
            if (_ref4 != 0) {
                ...
                address payable recipient = payable(address(uint160(uid2Investor[_ref4].addr)));
recipient.transfer(_refAmount);
            ...
            if (_ref5 != 0) {
                ...
                address payable recipient = payable(address(uint160(uid2Investor[_ref5].addr)));
recipient.transfer(_refAmount);
