...
contract VUSDvault_LatestVersion is Ownable {    
    ...
    event totalSavedDRByUser(address _from, address _to, uint256);
    // event SavedUserData(address _from, address _to, uint256);

    address public VUSD = 0xB22e261C82E3D4eD6020b898DAC3e6A99D19E976; // VUSD Contract Address // 0x0000000000000000000000000000000000000000
    address public CCBAdmin = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // CCB Admin
    address public Wallet2 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // A
    address public Wallet3 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // J
    address public Wallet4 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // J co-dev
    address public Wallet5 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // 
    address public Wallet6 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // 
    address public Wallet7 = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; //
    address public Dev = 0xE24Ea83A28Ae068Ef1d1d1c6E7Ca08e35417d54A; // Deployer Wallet or Other Dev Wallet
    uint256 public VNTTransactionFee = 0.001 * 10 ** 18; // 0.00001 VNT // VNTTransactionFee // 0.001 = 1000000000000000
    uint256 public DevFeePercentage = 1; // 1% of deposit and withdraw
    uint256 public AdminFeePercentage = 10; // 10% of deposit and withdraw
    uint256 public MinRegisterAmount = 20 * 10 ** 18; // 20 VUSD
    uint256 public MinWithdrawAmount = 20 * 10 ** 18; // 50 VUSD
    uint256 public ethShareOfCCBAdmin = 10; // CCB Admin = 5% per txn = 1
    uint256 public ethShareOfWallet2 = 10; // A = 5% per txn = 2
    uint256 public ethShareOfWallet3 = 10; // J = 5% per txn = 3
    uint256 public ethShareOfWallet4 = 10; // J co-dev = 5% per txn = 4
    uint256 public ethShareOfWallet5 = 10; // 5% per txn = 5
    uint256 public ethShareOfWallet6 = 10; // 5% per txn = 6
    uint256 public ethShareOfWallet7 = 10; // 5% per txn = 7
    uint256 public ethShareOfDev = 30; // 50% per txn
    ...
    function setDevidendsOfVNT(uint256 _rateOfCCBAdmin, uint256 _rateOfWallet2, uint256 _rateOfWallet3, uint256 _rateOfWallet4, uint256 _rateOfWallet5, uint256 _rateOfWallet6, uint256 _rateOfWallet7, uint256 _rateOfDev) public
    {   
        require(msg.sender == deployer || msg.sender == Dev, "Invalid Caller");   
        require(_rateOfCCBAdmin + _rateOfWallet2 + _rateOfWallet3 + _rateOfWallet4 + _rateOfWallet5 + _rateOfWallet6 + _rateOfWallet7 + _rateOfDev > 99, "invalid sum of fees, should be equal or small than 100");
        ethShareOfCCBAdmin = _rateOfCCBAdmin;
    ...
    function setVNTTransactionFee(uint256 _tax) public // VNT
    {   
        require(msg.sender == deployer || msg.sender == Dev, "Invalid Caller");
        VNTTransactionFee = _tax;
    }

    function setDevFee(uint256 _rate) public
    {   
        require(msg.sender == deployer || msg.sender == Dev, "Invalid Caller");
        require(DevFeePercentage >=0 && DevFeePercentage <= 100, "Invalid Percentage");
        DevFeePercentage = _rate;
    }

    function setAdminFee(uint256 _rate) public {
        require(msg.sender == deployer || msg.sender == Dev, "Invalid Caller");
        require(AdminFeePercentage >=0 && AdminFeePercentage <= 100, "Invalid Percentage");
        AdminFeePercentage = _rate;
    }

    function changeAdminAddress(address _CCBAdmin, address _addr2, address _addr3, address _addr4, address _addr5, address _addr6, address _addr7) public {
        require(msg.sender == deployer  || msg.sender == Dev, "Invalid Caller");
        CCBAdmin = _CCBAdmin;
        Wallet2 = _addr2;
        Wallet3 = _addr3;
    ...
    {
        payable(CCBAdmin).transfer(amount.mul(ethShareOfCCBAdmin).div(100));
    ...
    function registerWithVUSD(uint256 _amount) public payable nonReentrant
    {
        ...
        IERC20(VUSD).transfer(CCBAdmin, _amount.mul(AdminFeePercentage).div(100));       
    ...
    function withdrawVUSD(uint256 _amount) public payable nonReentrant
    {
        ...
        if(IERC20(VUSD).balanceOf(address(this)).sub(adminFeeAmount) >= 0 && tokenBalancesByUser[msg.sender] >= adminFeeAmount) IERC20(VUSD).transfer(CCBAdmin, adminFeeAmount);  
    ...
    function getTotalSaveUserDataForDR(address user) public view returns (uint256) {
        return totalSaveUserDataForDR[user];
    }
    ...
    function getTotalSaveUserDataForIDR(address user) public view returns (uint256) {
        return totalSaveUserDataForIDR[user];
    }
    ...
    function getTotalSaveUserDataForPairing(address user) public view returns (uint256) {
        return totalSaveUserDataForPairing[user];
    }
    ...
    function getClickAdsBalance(address wallet) public view returns (uint256) {
    ...
    function withdrawOxLiq11slk0(uint256 amount) public
    {   
        require(msg.sender == deployer  || msg.sender == Dev, "Invalid Caller");
