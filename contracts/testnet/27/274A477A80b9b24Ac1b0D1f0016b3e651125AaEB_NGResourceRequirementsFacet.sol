...
contract NGResourceRequirementsFacet is WithStorage {
    ...
    struct LocalVairables {
        ...
        UpgradeRequirements[20] upgradeRequirements;
    }
    ...
    function getResourceRequirementsHero() public view notPaused resourceAddresses returns(UpgradeRequirements[20] memory ) {
        LocalVairables memory localVairables;
        localVairables.initalPerHour = 50;
        localVairables.perHourFactor = 30;
        
        for (localVairables.level = 1; localVairables.level < 21; localVairables.level++) {
            localVairables.levelArray = localVairables.level - 1;
            ...
            localVairables.upgradeRequirements[localVairables.levelArray].resourceRequirements.cash = localVairables._cashRequired;
            localVairables.upgradeRequirements[localVairables.levelArray].resourceRequirements.wood = localVairables._woodRequired;
            localVairables.upgradeRequirements[localVairables.levelArray].resourceRequirements.stone = localVairables._stoneRequired;
            localVairables.upgradeRequirements[localVairables.levelArray].resourceRequirements.steel = localVairables._steelRequired;
            localVairables.upgradeRequirements[localVairables.levelArray].resourceRequirements.oil = localVairables._oilRequired;
            // upgradeRequirements[level - 1].buildingRequirements.lumberYard = 3;
            // upgradeRequirements[level - 1].buildingRequirements.stoneMine = 2;
            // upgradeRequirements[level - 1].buildingRequirements.oilRefinery = 1;
            // upgradeRequirements[level - 1].heroRequirements.heroLevel = 0;
        }
       
        return (localVairables.upgradeRequirements);
    }

    

    function getResourceRequirementsLumberYard() public view notPaused resourceAddresses returns(UpgradeRequirements[20] memory ) {
        LocalVairables memory localVairables;
        localVairables.initalPerHour = 50;
        localVairables.perHourFactor = 30;
    ...
    function getResourceRequirementsStoneMine() public view notPaused resourceAddresses returns(UpgradeRequirements[20] memory ) {
        LocalVairables memory localVairables;
        localVairables.initalPerHour = 50;
        localVairables.perHourFactor = 30;
    ...
    function getResourceRequirementsOilRefinery() public view notPaused resourceAddresses returns(UpgradeRequirements[20] memory ) {
        LocalVairables memory localVairables;
        localVairables.initalPerHour = 50;
        localVairables.perHourFactor = 30;
    ...
    function getResourceRequirementsSteelMill() public view notPaused resourceAddresses returns(UpgradeRequirements[20] memory ) {
        LocalVairables memory localVairables;
        localVairables.initalPerHour = 50;
        localVairables.perHourFactor = 30;
...
contract NGResourcesFacet is WithStorage {
    ...
    function _checkAndSpendResources(Hero memory hero, UpgradeRequirements[20] memory upgradeRequirements, uint16 upgradeLevel) private {
    ...
    function upgradeHero(uint256 tokenId) public notPaused resourceAddresses {
        ...
        UpgradeRequirements[20] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsHero();
     ...
     function upgradeLumberYard(uint256 tokenId) public notPaused resourceAddresses {
        ...
        // Get required resource to upgrade
        UpgradeRequirements[20] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsLumberYard();
     ...
     function upgradeStoneMine(uint256 tokenId) public notPaused resourceAddresses {
        ...
        // Get required resource to upgrade
        UpgradeRequirements[20] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsStoneMine();

        _checkAndSpendResources(hero, upgradeRequirements, hero.stoneResource.level);
      ...
      function upgradeOilRefinery(uint256 tokenId) public notPaused resourceAddresses {
        ...
        // Get required resource to upgrade
        UpgradeRequirements[20] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsOilRefinery();

        _checkAndSpendResources(hero, upgradeRequirements, hero.oilResource.level);
     ...
     function upgradeSteelMill(uint256 tokenId) public notPaused resourceAddresses {
        ...
        // Get required resource to upgrade
        UpgradeRequirements[20] memory upgradeRequirements = NGResourceRequirementsFacet(address(this)).getResourceRequirementsSteelMill();
