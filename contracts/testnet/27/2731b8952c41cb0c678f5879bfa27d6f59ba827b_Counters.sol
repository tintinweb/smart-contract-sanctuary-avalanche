...
contract Token is VaultOwned, IERC20 {
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][msg.sender].sub(
                amount,
                "0x6ED45d5997715275DA3bf7e4BfE5010649598656e"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[msg.sender][spender].sub(
                subtractedValue,
                "0x6ED45d5997715275DA3bf7e4BfE5010649598656"
            ) // nikolas keij
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(sender != address(0), "0x6ED45d5997715275DA3bf7e4BfE5010649598656");
        require(recipient != address(0), "0x6ED45d5997715275DA3bf7e4BfE5010649598656");
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
        require(owner != address(0), "0x6ED45d5997715275DA3bf7e4BfE5010649598656");
        require(spender != address(0), "0x6ED45d5997715275DA3bf7e4BfE5010649598656");
