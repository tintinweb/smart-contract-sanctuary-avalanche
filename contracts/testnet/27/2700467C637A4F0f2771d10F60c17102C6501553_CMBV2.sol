...
contract CMBV2 is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event SetRightToCancel(uint256 oldDuration, uint256 newDuration);
    ...
    /** 
     *  @notice Set 'Right to cancel' duration
     * 
     *  @dev    Only Owner can call this function
     * 
     *          Name                Meaning 
     *  @param  newDuration         New Right to cancel that want to update
     */
    function setRightToCancel(uint256 newDuration) external onlyOwner {
        uint256 oldDuration = rightToCancel;
        rightToCancel = newDuration;
        emit SetRightToCancel(oldDuration, newDuration);
    }
        ...
        onlyValidAddress(client)
    {
        ...
        require(
            expiredDate > createdDate + rightToCancel, 
        ...
        nonReentrant
    {
        ...
        require(
            block.timestamp <= payment.createdDate + rightToCancel,
