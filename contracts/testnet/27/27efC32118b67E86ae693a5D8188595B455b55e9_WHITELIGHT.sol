...
contract FeeManager is Context, Ownable {
  ...
  uint256 public feeRoyalty = 0;
  uint256 public feeLiquidity = 100;
  uint256 public feeStakingPool = 0;
  ...
  address payable public royaltyAddress = payable(0);
  address payable public marketingAddress = payable(0);
  address payable public devAddress = payable(0);
  address payable public stakingPoolAddress = payable(0);
  address payable public lpTokensHolderAddress = payable(0);
