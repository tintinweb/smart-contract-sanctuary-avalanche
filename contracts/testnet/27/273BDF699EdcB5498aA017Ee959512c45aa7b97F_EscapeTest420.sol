...
contract EscapeTest420 is ERC1155, Ownable {
...
//set to 69 for shared max per wallet of any of the 10 editions slots, set to 2 for flexible per wallet address shared, set to 1 to use wallet tracking slots 1-10
  uint public CURRENT_WALLET_TRACK_LIST_MULTI_SALE = 0;
...
//sets price of each 10 current IDs minting
  ...
  string private _contractUri = "ipfs://QmajddUpE9bfgvSNbsZetabL1QmdbvYHBr9MXndFwF9iSW";

  string public name = "EscapeTest420";
  string public symbol = "ETEST420";
 ...
 address private BurnerEscapeContract5;
  ...
  constructor() public ERC1155("ipfs://Qmbx25wLkbdTQoCHpaqtPoDGRTVrNATyAHGsTrnk7KReeF/{id}.json") {}
...
//sets the max tokens allowed for that edition during mint
   function setmaxE1(uint newmaxE1, uint newmaxE2, uint newmaxE3, uint newmaxE4, uint newmaxE5, uint newmaxE6, uint newmaxE7, uint newmaxE8, uint newmaxE9, uint newmaxE10) public onlyOwner {
    maxE1 = newmaxE1;
    maxE2 = newmaxE2;
    maxE3 = newmaxE3;
    maxE4 = newmaxE4;
