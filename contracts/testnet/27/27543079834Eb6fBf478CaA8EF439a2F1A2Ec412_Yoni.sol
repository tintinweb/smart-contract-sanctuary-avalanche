    ...
    ReentrancyGuard
{
    ...
    event NewBid(address indexed sender, uint amount);
    ...
    function claim() public {
        ...
        if (isOver() && !beenRefunded[_msgSender()]) {
            uint256 refund = 0;
        ...
        for (
            uint256 i = 0;
            i < amountWon[_msgSender()] - amountMinted[_msgSender()];
            i++
        ) {
            amountMinted[_msgSender()]++;
            _mint(_msgSender(), 1);
        }
    }
