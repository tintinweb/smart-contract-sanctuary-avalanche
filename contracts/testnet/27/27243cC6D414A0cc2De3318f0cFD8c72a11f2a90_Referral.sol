...
contract Referral is Ownable {
    ...
    mapping(address => bytes32) public referredToCode;
    ...
    function createCode(bytes32 _code) public {
        ...
        require(codeLength <= 10, "Code lower than 11.");
        require(codeLength >= 3, "Code greater than 2.");
    ...
    function registerToReferralCode(bytes32 _code) public {
        ...
        for (uint256 index = 0; index < referrer.referreds.length; index++) {
            if (referrer.referreds[index] == msg.sender) {
        ...
        )
    {
        ...
        return (referral.code, referral.referreds, referral.tier);
    }

    function getReferredData(address _referred) public view returns (bytes32) {
