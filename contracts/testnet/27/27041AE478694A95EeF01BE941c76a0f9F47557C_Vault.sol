  ...
  function _moreCalc(uint256 canBorrowValue,
    ...
    uint256 repayB
        ...
        if (borrowA > 0 && borrowB > 0) {
          ...
          // _repayA = repayA == 0 ? 0 : (SAFE_MULTIPLIER - borrowRepayRatio) * canRepayValue / SAFE_MULTIPLIER;
          // _repayB = repayB == 0 ? 0 : (SAFE_MULTIPLIER - borrowRepayRatio) * canRepayValue / SAFE_MULTIPLIER;
