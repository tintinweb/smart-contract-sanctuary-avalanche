...
contract Pets is ERC721Enumerable, Pausable, Restricted {
        ...
        notBlacklisted
    {
        ...
        IERC20(limitedMints[index].collabToken).transferFrom(_msgSender(), address(this), limitedMints[index].collabTokenPrice);
        ...
        notBlacklisted
    {
        ...
        require(boostType == 1 || boostType == 3,     "This pet can't be associated to a wallet");
    ...
    * @param petToken The id of the pet you'd like to associate to the wallet
        ...
        notBlacklisted
    {
        ...
        uint8 boostType = getPetBoostType(petToken);
        require(boostType == 1 || boostType == 3,              "This pet can't be associated to a ranger");
