...
contract TokenManager {
        ...
        public
    {
        ...
        uint256 tokenRewards = _getNodeRewardAmountOf(account, _creationTime);
        node.lastClaimTime = block.timestamp;
        node.rewardAvailable -= tokenRewards;
        node.claimed += tokenRewards;
        ...
        public
    {
        ...
        for (uint256 i = 0; i < nodesCount; i++) {
            uint256 tokenRewards = _getNodeRewardAmountOf(account, nodes[i].creationTime);
