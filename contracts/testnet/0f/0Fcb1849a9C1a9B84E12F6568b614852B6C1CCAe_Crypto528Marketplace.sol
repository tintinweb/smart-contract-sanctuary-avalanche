...
contract Crypto528Marketplace is ReentrancyGuard, Ownable {
    ...
    uint256[] public levelUSDCPrices = [1000000, 50000000, 250000000, 500000000, 2500000000, 5000000000, 10000000000, 20000000000];
    uint256[] public levelUSDTPrices = [1 ether, 250 ether, 500 ether, 2500 ether, 5000 ether, 10000 ether, 20000 ether, 500000 ether];
