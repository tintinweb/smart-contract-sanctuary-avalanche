...
contract PXTVN is ERC20Upgradeable, KeeperCompatibleInterface {
    ...
    function initialize() public virtual initializer {
        ...
        bottomPrice = 10e18;
        topPrice = 100e18;
        currencyForBuy = 10e18;
        tokenForSell = 1000e18;
    ...
    function contractSwap() internal virtual swapping {
        ...
        super._transfer(address(this), devWallet, devFee);
        super._transfer(address(this), marketingWallet, marketingFee);
        super._transfer(address(this), DEAD, burnFee);
        uint256 halfLiquidityFee = liquidityFee / 2;
        swapTokensForAVAX(address(this), halfLiquidityFee);
        uint256 AvaxAmount = address(this).balance;
        addLiquidity(liquidityFee - halfLiquidityFee, AvaxAmount);
        console.log("AvaxAmount in swap", AvaxAmount);
        operationFee = 0;
        devFee = 0;
        marketingFee = 0;
        burnFee = 0;
