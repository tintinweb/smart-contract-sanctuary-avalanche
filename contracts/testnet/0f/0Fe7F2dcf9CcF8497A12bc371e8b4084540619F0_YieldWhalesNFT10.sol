...
contract YieldWhalesNFT10 is ERC721, Ownable {
    ...
    constructor() payable ERC721('Yield Whales', 'YWNFT10'){
        ...
        token = ERC20(0x5425890298aed601595a70AB815c96711a31Bc65);
    }

    // function transferFrom(uint amount_) external {
    //     token.transferFrom(msg.sender, withdrawWallet, amount_);
    // }
    
    function transfer(uint amount_) external {
