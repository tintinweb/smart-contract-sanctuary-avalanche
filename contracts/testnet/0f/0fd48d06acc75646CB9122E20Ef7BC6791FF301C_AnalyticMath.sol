...
contract AnalyticMath is IAnalyticMath {
    ...
    /**
      * @dev Compute (a / b) ^ (c / d)
    */
    function powF(uint256 a, uint256 b, uint256 c, uint256 d) external view override returns (uint256, uint256) { unchecked {
        if (a >= b)
...
interface IAnalyticMath {
    function powF(uint256 a, uint256 b, uint256 c, uint256 d) external view returns (uint256, uint256);
}
