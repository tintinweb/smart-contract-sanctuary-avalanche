...
contract GatesOfHell is ERC721OnChainMetadata, Ownable {
    ...
    function mint(uint256 quantity) public payable isOpen {
        ...
        _setValue(tokenId, key_token_name, abi.encode(abi.encodePacked("Gate to Hell #", tokenId)));
        ...
        _setValue(tokenId, key_token_image, abi.encode(abi.encodePacked(abi.encodePacked(baseURI, tokenId), ".png")));
